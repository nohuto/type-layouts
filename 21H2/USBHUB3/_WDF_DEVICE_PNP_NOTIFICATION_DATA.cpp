...
struct _anonymous_461// Size=0x8 (Id=461)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
};

struct _anonymous_462// Size=0x4 (Id=462)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _anonymous_463// Size=0x8 (Id=463)
{
    struct _anonymous_461 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_462 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_461 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=464)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_463 Data;// Offset=0x4 Size=0x8
};
