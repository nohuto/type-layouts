union _anonymous_533// Size=0x4 (Id=533)
{
...
struct _USB_DEVICE_CAPABILITY_USB20_EXTENSION_DESCRIPTOR// Size=0x7 (Id=534)
{
    ...
    union _anonymous_533 bmAttributes;// Offset=0x3 Size=0x4
};
