union _anonymous_589// Size=0x2 (Id=589)
{
...
struct _USB_DEVICE_CAPABILITY_PD_CONSUMER_PORT_DESCRIPTOR// Size=0x18 (Id=590)
{
    ...
    union _anonymous_589 bmCapabilities;// Offset=0x4 Size=0x2
