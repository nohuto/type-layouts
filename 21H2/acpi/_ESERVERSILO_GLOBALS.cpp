struct _OBP_SYSTEM_DOS_DEVICE_STATE// Size=0x6c (Id=695)
{
...
struct _OBJECT_NAMESPACE_LOOKUPTABLE// Size=0x260 (Id=753)
{
...
struct _OBP_SILODRIVERSTATE// Size=0x2e0 (Id=678)
{
...
struct _SEP_SILOSTATE// Size=0x30 (Id=563)
{
...
struct _SEP_RM_LSA_CONNECTION_STATE// Size=0x50 (Id=607)
{
...
struct _WNF_LOCK// Size=0x8 (Id=697)
{
    struct _EX_PUSH_LOCK PushLock;// Offset=0x0 Size=0x8
};

struct _WNF_SILODRIVERSTATE// Size=0x38 (Id=661)
{
...
struct _DBGK_SILOSTATE// Size=0x20 (Id=645)
{
...
struct _ESERVERSILO_GLOBALS// Size=0x4a0 (Id=553)
{
    ...
    unsigned char TzVirtualizationSupported;// Offset=0x419 Size=0x1
    void * ImgFileExecOptions;// Offset=0x420 Size=0x8
    struct _EX_TIMEZONE_STATE * ExTimeZoneState;// Offset=0x428 Size=0x8
    struct _UNICODE_STRING NtSystemRoot;// Offset=0x430 Size=0x10
    struct _UNICODE_STRING SiloRootDirectoryName;// Offset=0x440 Size=0x10
    struct _PSP_STORAGE * Storage;// Offset=0x450 Size=0x8
    enum _SERVERSILO_STATE State;// Offset=0x458 Size=0x4
    long ExitStatus;// Offset=0x45c Size=0x4
    struct _KEVENT * DeleteEvent;// Offset=0x460 Size=0x8
    struct _SILO_USER_SHARED_DATA * UserSharedData;// Offset=0x468 Size=0x8
    void * UserSharedSection;// Offset=0x470 Size=0x8
    struct _WORK_QUEUE_ITEM TerminateWorkItem;// Offset=0x478 Size=0x20
    unsigned char IsDownlevelContainer;// Offset=0x498 Size=0x1
};
