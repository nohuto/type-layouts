...
struct _anonymous_746// Size=0x18 (Id=746)
{
...
struct _anonymous_747// Size=0x20 (Id=747)
{
...
struct _anonymous_748// Size=0x28 (Id=748)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=749)
{
    struct _anonymous_743 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _anonymous_744 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _anonymous_746 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _anonymous_747 QueryOpen;// Offset=0x0 Size=0x20
    struct _anonymous_748 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=720)
{
