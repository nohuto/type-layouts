...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=423)
{
...
struct _KAPC_STATE// Size=0x30 (Id=374)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=396)
{
...
struct _KSEMAPHORE// Size=0x20 (Id=366)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=420)
{
...
struct _PS_PROPERTY_SET// Size=0x18 (Id=273)
{
...
struct _KLOCK_ENTRY_LOCK_STATE// Size=0x10 (Id=438)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
