...
struct _anonymous_131// Size=0x20 (Id=131)
{
    struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
    unsigned long Options;// Offset=0x8 Size=0x4
    unsigned short Reserved;// Offset=0x10 Size=0x2
...
struct _anonymous_132// Size=0x18 (Id=132)
{
...
struct _anonymous_134// Size=0x20 (Id=134)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_135// Size=0x10 (Id=135)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_137// Size=0x18 (Id=137)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _anonymous_141// Size=0x4 (Id=141)
{
    unsigned long Length;// Offset=0x0 Size=0x4
};
...
struct _anonymous_144// Size=0x20 (Id=144)
{
...
struct _anonymous_145// Size=0x18 (Id=145)
{
...
struct _anonymous_146// Size=0x20 (Id=146)
{
    unsigned long OutputBufferLength;// Offset=0x0 Size=0x4
    unsigned long InputBufferLength;// Offset=0x8 Size=0x4
...
struct _anonymous_149// Size=0x10 (Id=149)
{
...
struct _anonymous_152// Size=0x20 (Id=152)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_155// Size=0x20 (Id=155)
{
...
struct _anonymous_157// Size=0x8 (Id=157)
{
...
struct _anonymous_159// Size=0x1 (Id=159)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _anonymous_161// Size=0x4 (Id=161)
{
...
struct _anonymous_165// Size=0x10 (Id=165)
{
...
struct _anonymous_167// Size=0x4 (Id=167)
{
    enum _SYSTEM_POWER_STATE PowerState;// Offset=0x0 Size=0x4
};

struct _anonymous_168// Size=0x8 (Id=168)
{
    struct _POWER_SEQUENCE * PowerSequence;// Offset=0x0 Size=0x8
};

struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=368)
{
    union // Size=0x4 (Id=0)
    {
...
struct _anonymous_174// Size=0x20 (Id=174)
{
...
union _anonymous_175// Size=0x20 (Id=175)
{
    struct _anonymous_129 Create;// Offset=0x0 Size=0x20
    struct _anonymous_130 CreatePipe;// Offset=0x0 Size=0x20
    struct _anonymous_131 CreateMailslot;// Offset=0x0 Size=0x20
    struct _anonymous_132 Read;// Offset=0x0 Size=0x18
    struct _anonymous_132 Write;// Offset=0x0 Size=0x18
    struct _anonymous_134 QueryDirectory;// Offset=0x0 Size=0x20
    struct _anonymous_135 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _anonymous_137 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _anonymous_138 QueryFile;// Offset=0x0 Size=0x10
    struct _anonymous_139 SetFile;// Offset=0x0 Size=0x20
    struct _anonymous_140 QueryEa;// Offset=0x0 Size=0x20
    struct _anonymous_141 SetEa;// Offset=0x0 Size=0x4
    struct _anonymous_143 QueryVolume;// Offset=0x0 Size=0x10
    struct _anonymous_143 SetVolume;// Offset=0x0 Size=0x10
    struct _anonymous_144 FileSystemControl;// Offset=0x0 Size=0x20
    struct _anonymous_145 LockControl;// Offset=0x0 Size=0x18
    struct _anonymous_146 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _anonymous_147 QuerySecurity;// Offset=0x0 Size=0x10
    struct _anonymous_148 SetSecurity;// Offset=0x0 Size=0x10
    struct _anonymous_149 MountVolume;// Offset=0x0 Size=0x10
    struct _anonymous_149 VerifyVolume;// Offset=0x0 Size=0x10
    struct _anonymous_151 Scsi;// Offset=0x0 Size=0x8
    struct _anonymous_152 QueryQuota;// Offset=0x0 Size=0x20
    struct _anonymous_141 SetQuota;// Offset=0x0 Size=0x4
    struct _anonymous_154 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _anonymous_155 QueryInterface;// Offset=0x0 Size=0x20
    struct _anonymous_156 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _anonymous_157 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _anonymous_158 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _anonymous_159 SetLock;// Offset=0x0 Size=0x1
    struct _anonymous_161 QueryId;// Offset=0x0 Size=0x4
    struct _anonymous_163 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _anonymous_165 UsageNotification;// Offset=0x0 Size=0x10
    struct _anonymous_167 WaitWake;// Offset=0x0 Size=0x4
    struct _anonymous_168 PowerSequence;// Offset=0x0 Size=0x8
    struct _anonymous_171 Power;// Offset=0x0 Size=0x20
    struct _anonymous_172 StartDevice;// Offset=0x0 Size=0x10
    struct _anonymous_173 WMI;// Offset=0x0 Size=0x20
    struct _anonymous_174 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=176)
{
    ...
    union _anonymous_175 Parameters;// Offset=0x8 Size=0x20
