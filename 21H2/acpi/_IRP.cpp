union _anonymous_123// Size=0x8 (Id=123)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=88)
{
    union // Size=0x4 (Id=0)
    {
...
struct _anonymous_124// Size=0x10 (Id=124)
{
    union // Size=0x8 (Id=0)
    {
...
union _anonymous_125// Size=0x10 (Id=125)
{
    union // Size=0x10 (Id=0)
    {
        struct _anonymous_124 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=375)
{
...
struct _anonymous_126// Size=0x58 (Id=126)
{
...
union _anonymous_127// Size=0x58 (Id=127)
{
    union // Size=0x58 (Id=0)
    {
        struct _anonymous_126 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=128)
{
    ...
    union _anonymous_123 AssociatedIrp;// Offset=0x18 Size=0x8
