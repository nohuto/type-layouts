...
struct _PROCESSOR_IDLE_PREPARE_INFO// Size=0x58 (Id=696)
{
...
struct _PPM_SELECTION_MENU// Size=0x10 (Id=679)
{
    unsigned long Count;// Offset=0x0 Size=0x4
    struct _PPM_SELECTION_MENU_ENTRY * Entries;// Offset=0x8 Size=0x8
};

struct _PPM_COORDINATED_SELECTION// Size=0x18 (Id=711)
{
...
struct _PPM_IDLE_STATES// Size=0x428 (Id=602)
{
