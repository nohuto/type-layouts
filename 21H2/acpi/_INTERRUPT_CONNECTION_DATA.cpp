...
struct _anonymous_738// Size=0xc (Id=738)
{
...
union _anonymous_739// Size=0xc (Id=739)
{
    struct _anonymous_738 Msi;// Offset=0x0 Size=0xc
};

struct _INTERRUPT_REMAPPING_INFO// Size=0x10 (Id=740)
{
    ...
    union _anonymous_739 u;// Offset=0x4 Size=0xc
};

struct _anonymous_648// Size=0x8 (Id=648)
{
...
union _anonymous_682// Size=0x4 (Id=682)
{
    struct _anonymous_681 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _anonymous_683// Size=0x4 (Id=683)
{
    struct // Size=0x4 (Id=0)
    {
...
union _anonymous_684// Size=0x4 (Id=684)
{
    struct _anonymous_683 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_HT_INTR_INFO// Size=0x8 (Id=685)
{
    union _anonymous_682 LowPart;// Offset=0x0 Size=0x4
    union _anonymous_684 HighPart;// Offset=0x4 Size=0x4
};

struct _anonymous_650// Size=0x8 (Id=650)
{
    struct _INTERRUPT_HT_INTR_INFO IntrInfo;// Offset=0x0 Size=0x8
};

struct _anonymous_651// Size=0x4 (Id=651)
{
    enum HAL_APIC_DESTINATION_MODE DestinationMode;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_VECTOR_DATA// Size=0x58 (Id=652)
{
    ...
    struct _anonymous_648 ControllerInput;// Offset=0x38 Size=0x8
    unsigned long long HvDeviceId;// Offset=0x40 Size=0x8
    union // Size=0x58 (Id=0)
    {
        struct _anonymous_649 XapicMessage;// Offset=0x48 Size=0x10
        struct _anonymous_650 Hypertransport;// Offset=0x48 Size=0x8
        struct _anonymous_649 GenericMessage;// Offset=0x48 Size=0x10
        struct _anonymous_651 MessageRequest;// Offset=0x48 Size=0x4
    };
};

struct _INTERRUPT_CONNECTION_DATA// Size=0x60 (Id=724)
{
