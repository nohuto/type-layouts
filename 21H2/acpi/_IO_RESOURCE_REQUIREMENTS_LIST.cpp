...
struct _anonymous_623// Size=0x18 (Id=623)
{
...
struct _anonymous_625// Size=0x18 (Id=625)
{
...
struct _anonymous_631// Size=0x18 (Id=631)
{
...
struct _anonymous_632// Size=0x18 (Id=632)
{
...
struct _anonymous_633// Size=0x18 (Id=633)
{
...
union _anonymous_635// Size=0x18 (Id=635)
{
    union // Size=0x18 (Id=0)
    {
        struct _anonymous_623 Port;// Offset=0x0 Size=0x18
        struct _anonymous_623 Memory;// Offset=0x0 Size=0x18
        struct _anonymous_625 Interrupt;// Offset=0x0 Size=0x18
        struct _anonymous_626 Dma;// Offset=0x0 Size=0x8
        struct _anonymous_627 DmaV3;// Offset=0x0 Size=0x10
        struct _anonymous_623 Generic;// Offset=0x0 Size=0x18
        struct _anonymous_628 DevicePrivate;// Offset=0x0 Size=0xc
        struct _anonymous_629 BusNumber;// Offset=0x0 Size=0x10
        struct _anonymous_630 ConfigData;// Offset=0x0 Size=0xc
        struct _anonymous_631 Memory40;// Offset=0x0 Size=0x18
        struct _anonymous_632 Memory48;// Offset=0x0 Size=0x18
        struct _anonymous_633 Memory64;// Offset=0x0 Size=0x18
        struct _anonymous_634 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=636)
{
    ...
    union _anonymous_635 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=593)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=385)
{
