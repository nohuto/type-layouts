...
struct _anonymous_701// Size=0x8 (Id=701)
{
...
struct _anonymous_702// Size=0x8 (Id=702)
{
...
struct _ACPI_POWER_WAKE_INTERRUPT_REGISTRATION_ENTRY// Size=0x28 (Id=719)
{
...
union _anonymous_703// Size=0x28 (Id=703)
{
...
struct _anonymous_704// Size=0x58 (Id=704)
{
    enum _SYSTEM_POWER_STATE SystemPowerState;// Offset=0x0 Size=0x4
    ...
    union _anonymous_703 Registrations;// Offset=0x30 Size=0x28
};

struct _anonymous_705// Size=0x4 (Id=705)
{
    enum _SYSTEM_POWER_STATE EjectPowerState;// Offset=0x0 Size=0x4
};

union _anonymous_706// Size=0x58 (Id=706)
{
    union // Size=0x58 (Id=0)
    {
        struct _anonymous_701 DevicePowerRequest;// Offset=0x0 Size=0x8
        struct _anonymous_702 SystemPowerRequest;// Offset=0x0 Size=0x8
        struct _anonymous_704 WaitWakeRequest;// Offset=0x0 Size=0x58
        struct _anonymous_705 EjectPowerRequest;// Offset=0x0 Size=0x4
    };
};
...
struct _ACPI_POWER_REQUEST// Size=0x108 (Id=707)
{
    ...
    union _anonymous_706 u;// Offset=0x68 Size=0x58
