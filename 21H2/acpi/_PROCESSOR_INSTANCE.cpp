...
struct _RTL_RANGE_LIST// Size=0x20 (Id=516)
{
...
struct _anonymous_571// Size=0xc (Id=571)
{
...
struct _HAL_INTERRUPT_TARGET_INFORMATION// Size=0x18 (Id=573)
{
    ...
    union // Size=0xc (Id=0)
    {
        struct _anonymous_571 Apic;// Offset=0xc Size=0xc
        struct _anonymous_572 Irt;// Offset=0xc Size=0xc
    };
};

struct _PROCESSOR_SINK_INFO// Size=0x1c (Id=421)
{
