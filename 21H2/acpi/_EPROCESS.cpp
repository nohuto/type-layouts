...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=286)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=355)
{
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=452)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=496)
{
    union // Size=0x2 (Id=0)
    {
...
struct _MMSUPPORT_INSTANCE// Size=0xc0 (Id=395)
{
...
struct _MMSUPPORT_SHARED// Size=0x80 (Id=414)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=323)
{
    union // Size=0x1 (Id=0)
    {
...
struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=300)
{
...
struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=316)
{
