...
struct _anonymous_675// Size=0x4 (Id=675)
{
...
struct _FDO_DEVICE_EXTENSION// Size=0x80 (Id=676)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _anonymous_675 UPm1Status;// Offset=0x38 Size=0x4
    };
    struct _KDPC InterruptDpc;// Offset=0x40 Size=0x40
};

struct _PCI_FILTER_EXTENSION// Size=0x14 (Id=674)
{
...
struct _FILTER_DEVICE_EXTENSION// Size=0x58 (Id=654)
{
    struct WORK_QUEUE_CONTEXT WorkContext;// Offset=0x0 Size=0x30
...
struct _PDO_DEVICE_EXTENSION// Size=0x30 (Id=672)
{
    struct WORK_QUEUE_CONTEXT WorkContext;// Offset=0x0 Size=0x30
};
...
struct _PROCESSOR_DEVICE_EXTENSION// Size=0x38 (Id=598)
{
...
struct _MODULE_DEVICE_EXTENSION// Size=0x38 (Id=606)
{
    struct EXTENSION_WORKER WorkQueue;// Offset=0x0 Size=0x18
...
struct _EC_DEVICE_EXTENSION// Size=0x20 (Id=566)
{
    struct EXTENSION_WORKER WorkQueue;// Offset=0x0 Size=0x18
...
struct _PCI_ROOT_BUS_DSM_CAPABILITY_STRUCTURE// Size=0x10 (Id=589)
{
...
union _anonymous_642// Size=0x4 (Id=642)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PCI_ROOT_BUS_OSC_CONTROL_FIELD// Size=0x4 (Id=643)
{
    union _anonymous_642 u;// Offset=0x0 Size=0x4
};

struct _PCI_ROOT_EXTENSION// Size=0x98 (Id=556)
{
    struct EXTENSION_WORKER WorkQueue;// Offset=0x0 Size=0x18
...
struct _PROCESSOR_CONTAINER_EXTENSION// Size=0x58 (Id=491)
{
    struct EXTENSION_WORKER WorkQueue;// Offset=0x0 Size=0x18
...
struct _ACPI_POWER_INFO// Size=0xe8 (Id=680)
{
...
struct _anonymous_528// Size=0x8 (Id=528)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _ACPI_DEVICE_INFORMATION// Size=0x28 (Id=529)
{
    union // Size=0x8 (Id=0)
    {
    ...
    union // Size=0x8 (Id=0)
    {
        ...
        struct _anonymous_528 ClassCode;// Offset=0x20 Size=0x8
    };
};
...
struct _WAKE_EVENT_DEVICE_CONTEXT// Size=0x20 (Id=610)
{
...
struct _anonymous_447// Size=0x8 (Id=447)
{
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned long long Cap_Unused:12;// Offset=0x0 Size=0x8 BitOffset=0x34 BitSize=0xc
    };
};

struct _DEVICE_EXTENSION// Size=0x3c8 (Id=448)
{
    struct _ACPI_TRIAGE_INFO * TriageInfo;// Offset=0x0 Size=0x8
    union // Size=0x8 (Id=0)
    {
        unsigned long long Flags;// Offset=0x8 Size=0x8
        struct _anonymous_441 UFlags;// Offset=0x8 Size=0x8
    };
    ...
    union // Size=0x140 (Id=0)
    {
        ...
        struct FAN_EXTENSION Fan;// Offset=0xa0 Size=0xa0
        ...
        struct PEP_EXTENSION Pep;// Offset=0xa0 Size=0xa8
    };
    enum _ACPI_DEVICE_STATE DeviceState;// Offset=0x148 Size=0x4
    enum _ACPI_DEVICE_STATE PreviousState;// Offset=0x14c Size=0x4
    struct _ACPI_POWER_INFO PowerInfo;// Offset=0x150 Size=0xe8
    struct _ACPI_DEVICE_INFORMATION DeviceInformation;// Offset=0x238 Size=0x28
    struct _ObjData * FirmwareDependencies;// Offset=0x260 Size=0x8
    struct _THERMAL_COOLING_EXTENSION * CoolingExtension;// Offset=0x268 Size=0x8
    unsigned char CoolingEligible;// Offset=0x270 Size=0x1
    unsigned char KeepPowerResourceOnForResume;// Offset=0x271 Size=0x1
    unsigned long OperationRegionMask;// Offset=0x274 Size=0x4
    struct _CM_RESOURCE_LIST * ResourceList;// Offset=0x278 Size=0x8
    struct _CM_RESOURCE_LIST * TranslatedResourceList;// Offset=0x280 Size=0x8
    struct _ObjData * PnpResourceList;// Offset=0x288 Size=0x8
    unsigned long * ForceActiveBothInterrupts;// Offset=0x290 Size=0x8
    unsigned long ForceActiveBothInterruptsCount;// Offset=0x298 Size=0x4
    struct _LIST_ENTRY InterruptPolarityCacheListHead;// Offset=0x2a0 Size=0x10
    long OutstandingIrpCount;// Offset=0x2b0 Size=0x4
    long ReferenceCount;// Offset=0x2b4 Size=0x4
    long HibernatePathCount;// Offset=0x2b8 Size=0x4
    long PagingPathCount;// Offset=0x2bc Size=0x4
    long SpecialPathCount;// Offset=0x2c0 Size=0x4
    struct _KEVENT * RemoveEvent;// Offset=0x2c8 Size=0x8
    struct _NSObjRef * AcpiObject;// Offset=0x2d0 Size=0x8
    struct _DEVICE_OBJECT * DeviceObject;// Offset=0x2d8 Size=0x8
    struct _DEVICE_OBJECT * TargetDeviceObject;// Offset=0x2e0 Size=0x8
    struct _DEVICE_OBJECT * PhysicalDeviceObject;// Offset=0x2e8 Size=0x8
    struct _DEVICE_EXTENSION * ParentExtension;// Offset=0x2f0 Size=0x8
    struct _LIST_ENTRY ChildDeviceList;// Offset=0x2f8 Size=0x10
    struct _LIST_ENTRY SiblingDeviceList;// Offset=0x308 Size=0x10
    struct _LIST_ENTRY EjectDeviceHead;// Offset=0x318 Size=0x10
    struct _LIST_ENTRY EjectDeviceList;// Offset=0x328 Size=0x10
    struct _LIST_ENTRY NotificationListHead;// Offset=0x338 Size=0x10
    struct _LIST_ENTRY RemovedDevice;// Offset=0x348 Size=0x10
    unsigned long AcpiObjectName;// Offset=0x358 Size=0x4
    struct _KEVENT NotificationDispatchLock;// Offset=0x360 Size=0x18
    struct _WORK_QUEUE_ITEM * NotificationWorkItem;// Offset=0x378 Size=0x8
    unsigned char NotificationWorkerInProgress;// Offset=0x380 Size=0x1
    enum _CCA_METHOD_EVALUATION_STATE CcaEvaluationState;// Offset=0x384 Size=0x4
    void * NativeMethodHandle;// Offset=0x388 Size=0x8
    struct _DEVICE_RESET_CONTEXT * CurrentResetRequest;// Offset=0x390 Size=0x8
    unsigned long long SkDeviceToken;// Offset=0x398 Size=0x8
    struct _WAKE_EVENT_DEVICE_CONTEXT WakeEventDeviceContext;// Offset=0x3a0 Size=0x20
    union // Size=0x8 (Id=0)
    {
        unsigned long long AuxiliaryFlags;// Offset=0x3c0 Size=0x8
        struct _anonymous_447 AuxiliaryUFlags;// Offset=0x3c0 Size=0x8
    };
};
