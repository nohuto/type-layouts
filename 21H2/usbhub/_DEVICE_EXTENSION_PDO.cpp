...
union _USB_EXTENDED_PORT_ATTRIBUTES// Size=0x4 (Id=332)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=331)
{
    union // Size=0x4 (Id=0)
    {
...
struct _WMILIB_CONTEXT// Size=0x40 (Id=443)
{
...
union _USBHUB_PDO_FLAGS// Size=0x4 (Id=322)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _HUBPDO_CLEANUP_FLAGS// Size=0x4 (Id=387)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_DEVICE_FLAGS// Size=0x4 (Id=317)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _IO_CSQ// Size=0x40 (Id=328)
{
...
struct _HUB_TIMER_OBJECT// Size=0x50 (Id=321)
{
...
struct _USB_ID_STRING// Size=0x10 (Id=433)
{
...
struct _USB_INTERFACE_DESCRIPTOR// Size=0x9 (Id=446)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
...
struct _KSEMAPHORE// Size=0x20 (Id=371)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
union _MSOS20_FLAGS// Size=0x4 (Id=398)
{
...
struct _MSOS20_INFO// Size=0x40 (Id=363)
{
...
struct _MSOS20_DESCRIPTOR_SET_INFO// Size=0x8 (Id=346)
{
...
struct _D3COLD_SUPPORT_INTERFACE// Size=0x48 (Id=368)
{
...
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct _anonymous_140 features;// Offset=0x0 Size=0x4
};
