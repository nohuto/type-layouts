...
struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=336)
{
...
struct _IO_REMOVE_LOCK// Size=0x20 (Id=286)
{
...
union _USBHUB_FDO_FLAGS// Size=0x4 (Id=343)
{
...
union _USBHUB_FDO_FLAGS2// Size=0x4 (Id=417)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USBHUB_ERRATA_FLAGS// Size=0x4 (Id=293)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _USB_HUB_DESCRIPTOR// Size=0x47 (Id=432)
{
...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=299)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    struct // Size=0x4 (Id=0)
...
struct _HUB_GLOBAL_UXD_SETTINGS// Size=0x10 (Id=358)
{
...
struct _USB_TOPOLOGY_ADDRESS// Size=0x20 (Id=423)
{
