struct _URB_HEADER// Size=0x18 (Id=461)
{
...
struct _USBD_INTERFACE_INFORMATION// Size=0x30 (Id=416)
{
    unsigned short Length;// Offset=0x0 Size=0x2
...
struct _URB_SELECT_CONFIGURATION// Size=0x58 (Id=330)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
...
struct _URB_FRAME_LENGTH_CONTROL// Size=0x18 (Id=403)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
};
...
struct _URB_SET_FRAME_LENGTH// Size=0x20 (Id=289)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    long FrameLengthDelta;// Offset=0x18 Size=0x4
};

struct _URB_GET_CURRENT_FRAME_NUMBER// Size=0x20 (Id=283)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    unsigned long FrameNumber;// Offset=0x18 Size=0x4
};

struct _URB_HCD_AREA// Size=0x40 (Id=447)
{
    void * Reserved8[8];// Offset=0x0 Size=0x40
};

struct _URB_CONTROL_TRANSFER// Size=0x88 (Id=411)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
...
struct _URB_CONTROL_TRANSFER_EX// Size=0x88 (Id=288)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _URB_BULK_OR_INTERRUPT_TRANSFER// Size=0x80 (Id=421)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _USBD_ISO_PACKET_DESCRIPTOR// Size=0xc (Id=507)
{
...
struct _URB_ISOCH_TRANSFER// Size=0x98 (Id=471)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _URB_CONTROL_DESCRIPTOR_REQUEST// Size=0x88 (Id=362)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
...
struct _URB_CONTROL_GET_STATUS_REQUEST// Size=0x88 (Id=392)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long Reserved0;// Offset=0x20 Size=0x4
...
struct _URB_CONTROL_FEATURE_REQUEST// Size=0x88 (Id=298)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
...
struct _URB_CONTROL_VENDOR_OR_CLASS_REQUEST// Size=0x88 (Id=278)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _URB_CONTROL_GET_INTERFACE_REQUEST// Size=0x88 (Id=435)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long Reserved0;// Offset=0x20 Size=0x4
...
struct _URB_CONTROL_GET_CONFIGURATION_REQUEST// Size=0x88 (Id=455)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long Reserved0;// Offset=0x20 Size=0x4
...
struct _URB_OS_FEATURE_DESCRIPTOR_REQUEST// Size=0x88 (Id=444)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long Reserved0;// Offset=0x20 Size=0x4
...
struct _URB_OPEN_STATIC_STREAMS// Size=0x30 (Id=356)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
...
struct _URB_GET_ISOCH_PIPE_TRANSFER_PATH_DELAYS// Size=0x28 (Id=297)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
