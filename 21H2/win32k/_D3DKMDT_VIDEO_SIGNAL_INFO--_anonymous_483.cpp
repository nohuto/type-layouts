...
union _D3DKMDT_VIDEO_SIGNAL_INFO::_anonymous_483// Size=0x4 (Id=483)
{
    struct <unnamed-type-AdditionalSignalInfo>// Size=0x4 (Id=1401)
    {
    ...
    struct _D3DKMDT_VIDEO_SIGNAL_INFO::_anonymous_484::<unnamed-type-AdditionalSignalInfo> AdditionalSignalInfo;// Offset=0x0 Size=0x4
