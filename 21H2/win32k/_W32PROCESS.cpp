...
struct _RTL_BALANCED_LINKS// Size=0x20 (Id=518)
{
...
struct _RTL_AVL_TABLE// Size=0x68 (Id=508)
{
...
struct _W32PROCESS// Size=0x128 (Id=149)
{
    ...
    {
        int bChangedGdiGammaRamp:1;// Offset=0x120 Size=0x4 BitOffset=0x0 BitSize=0x1
        int bReadScreenBits:1;// Offset=0x120 Size=0x4 BitOffset=0x1 BitSize=0x1
        int bWroteScreenBits:1;// Offset=0x120 Size=0x4 BitOffset=0x2 BitSize=0x1
        int bGDILimitReachedAtLeastOnce:1;// Offset=0x120 Size=0x4 BitOffset=0x3 BitSize=0x1
    };
};
