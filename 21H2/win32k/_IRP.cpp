...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=360)
{
...
struct _IRP// Size=0xd0 (Id=89)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=3443)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=3461)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=3462)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=3473)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=3474)
            {
