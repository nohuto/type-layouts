...
struct _KDESCRIPTOR// Size=0x10 (Id=632)
{
...
struct _KSPECIAL_REGISTERS// Size=0xf0 (Id=558)
{
...
struct _CONTEXT// Size=0x4d0 (Id=441)
{
    ...
    union // Size=0x100 (Id=0)
    {
        ...
        union // Size=0x1 (Id=0)
        {
            ...
            struct // Size=0x1 (Id=0)
            {
                ...
                unsigned char BpbStateReserved:2;// Offset=0xf8 Size=0x1 BitOffset=0x5 BitSize=0x2
                unsigned char BpbDivideOnReturn:1;// Offset=0xf8 Size=0x1 BitOffset=0x7 BitSize=0x1
            };
        };
        union // Size=0x1 (Id=0)
        {
