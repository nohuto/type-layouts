union _EINFO// Size=0x8 (Id=468)
{
    struct <unnamed-type-s>// Size=0x8 (Id=2531)
    {
...
struct _OBJECTOWNER_S// Size=0x4 (Id=650)
{
...
union _OBJECTOWNER// Size=0x4 (Id=565)
{
...
{
    struct <unnamed-type-s>// Size=0x2 (Id=5570)
    {
        unsigned char fullType;// Offset=0x0 Size=0x1
        union <unnamed-type-u>// Size=0x1 (Id=5572)
        {
