...
struct _anonymous_438// Size=0x8 (Id=438)
{
...
union _anonymous_440// Size=0x8 (Id=440)
{
    struct _anonymous_438 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_439 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_438 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=248)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_440 Data;// Offset=0x4 Size=0x8
};
