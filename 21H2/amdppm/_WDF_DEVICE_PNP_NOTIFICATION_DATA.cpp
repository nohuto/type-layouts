...
struct _anonymous_448// Size=0x4 (Id=448)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _anonymous_449// Size=0x8 (Id=449)
{
    struct _anonymous_447 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_448 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_447 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=246)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_449 Data;// Offset=0x4 Size=0x8
};
