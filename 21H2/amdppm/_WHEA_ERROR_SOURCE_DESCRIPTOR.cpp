...
struct _WHEA_XPF_MCE_DESCRIPTOR// Size=0x398 (Id=481)
{
...
struct _WHEA_XPF_CMC_DESCRIPTOR// Size=0x3a4 (Id=443)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char NumberOfBanks;// Offset=0x3 Size=0x1
...
struct _anonymous_478// Size=0x4 (Id=478)
{
    struct // Size=0x4 (Id=0)
    {
...
union _anonymous_479// Size=0x4 (Id=479)
{
    struct _anonymous_478 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _WHEA_PCI_SLOT_NUMBER// Size=0x4 (Id=480)
{
    union _anonymous_479 u;// Offset=0x0 Size=0x4
};
...
union _AER_ENDPOINT_DESCRIPTOR_FLAGS// Size=0x2 (Id=458)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short UncorrectableErrorMaskRW:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_GENERIC_ERROR_DESCRIPTOR// Size=0x34 (Id=474)
{
    unsigned short Type;// Offset=0x0 Size=0x2
...
struct _WHEA_GENERIC_ERROR_DESCRIPTOR_V2// Size=0x50 (Id=455)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Reserved;// Offset=0x2 Size=0x1
    unsigned char Enabled;// Offset=0x3 Size=0x1
