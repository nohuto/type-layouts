...
struct GLOBALS// Size=0x838 (Id=422)
{
    ...
    long  ( * RegisterHiddenProcessorIdleStates)(struct _FDO_DATA * );// Offset=0x450 Size=0x8
    unsigned char SyntheticPsdAllowed;// Offset=0x458 Size=0x1
    enum <unnamed-enum-PerfStatesNative> PerfStatesOwner;// Offset=0x45c Size=0x4
    unsigned long HvDomainCount;// Offset=0x460 Size=0x4
    struct _PCC_INTERFACE_INTERNAL PccInterfaceInternal;// Offset=0x468 Size=0x58
    unsigned long Errata;// Offset=0x4c0 Size=0x4
    struct _PCC_INTERFACE_STANDARD PccInterface;// Offset=0x4c8 Size=0x80
    struct _KEVENT PccSubspacesMutableEvent;// Offset=0x548 Size=0x18
    struct WDFSPINLOCK__ * PccSubspacesSpinLock;// Offset=0x560 Size=0x8
    struct WDFWAITLOCK__ * PccSubspacesMutex;// Offset=0x568 Size=0x8
    struct _LIST_ENTRY PccSubspaces;// Offset=0x570 Size=0x10
    unsigned long PccSubspaceCount;// Offset=0x580 Size=0x4
    unsigned long PccRegisteredProcessors;// Offset=0x584 Size=0x4
    struct WDFSPINLOCK__ * PccMutex;// Offset=0x588 Size=0x8
    struct _IO_WORKITEM * PccCapWorker;// Offset=0x590 Size=0x8
    unsigned long PepRegisteredProcessors;// Offset=0x598 Size=0x4
    unsigned char PccCapUpdated;// Offset=0x59c Size=0x1
    unsigned char PccCapWorkerQueued;// Offset=0x59d Size=0x1
    struct _CPC_COMMAND_COMPLETION CpcCmdCompletion;// Offset=0x5a0 Size=0x18
    unsigned char AssertsDisabled;// Offset=0x5b8 Size=0x1
    unsigned long CoordinatedStateCount;// Offset=0x5bc Size=0x4
    struct _PLATFORM_IDLE_STATES * PlatformIdleStates;// Offset=0x5c0 Size=0x8
    struct _COORDINATED_IDLE_STATES * CoordinatedStates;// Offset=0x5c8 Size=0x8
    struct _COORDINATED_IDLE_STATES * LpiCoordinatedStates;// Offset=0x5d0 Size=0x8
    unsigned long * LpiStateIndexMapping;// Offset=0x5d8 Size=0x8
    struct _RUNTIME_LPI_STATE * LpiRuntimeState;// Offset=0x5e0 Size=0x8
    struct ACPI_PROCESSOR_CONTAINERS * ProcessorContainers;// Offset=0x5e8 Size=0x8
    struct _PREREGISTERED_VETO_LIST * VetoList;// Offset=0x5f0 Size=0x8
    struct _IO_WORKITEM * StateUpdateWorker;// Offset=0x5f8 Size=0x8
    unsigned char StateUpdateWorkerQueued;// Offset=0x600 Size=0x1
    unsigned long EfficiencyClasses;// Offset=0x604 Size=0x4
    unsigned long ProcessorCounts[2];// Offset=0x608 Size=0x8
    struct _PROC_ENERGY_MODEL EnergyModels[2];// Offset=0x610 Size=0x200
    unsigned long EnergyEnabledProcessors;// Offset=0x810 Size=0x4
    long long QpcFrequency;// Offset=0x818 Size=0x8
    unsigned long long CycleCounterFrequency;// Offset=0x820 Size=0x8
    enum _PROCESSOR_PRESENCE HiddenProcessorPresence;// Offset=0x828 Size=0x4
    unsigned long ProcessorCountIncludingHidden;// Offset=0x82c Size=0x4
    unsigned char SkipHiddenProcessorPoFxRegistration;// Offset=0x830 Size=0x1
    unsigned char ImplicitPlatformIdle;// Offset=0x831 Size=0x1
};
