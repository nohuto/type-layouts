struct PPM_DRIVER_INTERFACE// Size=0x100 (Id=598)
{
    ...
    long  ( * GetNativeCppcPerfControlHandler)(struct _CPC_RUNTIME_STATE * ,void  ( ** )(unsigned long long ,struct _PERF_CONTROL_STATE_SELECTION * ,unsigned char ,unsigned char ),void  ( ** )(unsigned long long ,struct _PERF_CONTROL_STATE_SELECTION * ,unsigned char ,unsigned char ),void  ( ** )(unsigned long long ,struct _PERF_CONTROL_STATE_SELECTION * ,unsigned char ,unsigned char ),unsigned long  ( ** )(unsigned long long ,unsigned long ,unsigned long ,unsigned long ,unsigned long ,unsigned long ,unsigned long ,unsigned long * ,unsigned long long * ),unsigned char * ,unsigned long * );// Offset=0xb0 Size=0x8
