...
struct _NDIS_OID_REQUEST_RESERVED// Size=0x60 (Id=315)
{
    ...
    union // Size=0x48 (Id=0)
    {
        ...
        struct _NDIS_OID_REQUEST_RESERVED::_anonymous_1064::<unnamed-type-CoNdis> CoNdis;// Offset=0x28 Size=0x20
    };
    union // Size=0x60 (Id=0)
    {
        ...
        struct _NDIS_OID_REQUEST_RESERVED::_anonymous_1069::<unnamed-type-IovContext> IovContext;// Offset=0x48 Size=0x10
        struct _NDIS_OID_REQUEST_RESERVED::_anonymous_1070::<unnamed-type-PMContext> PMContext;// Offset=0x48 Size=0x18
        struct _NDIS_OID_REQUEST_RESERVED::_anonymous_1071::<unnamed-type-OffloadParamsContext> OffloadParamsContext;// Offset=0x48 Size=0x1
    };
};
