...
struct _FILTER_PAUSE_RESTART_CONTEXT// Size=0x28 (Id=1740)
{
    struct _NDIS_FILTER_BLOCK * Filter;// Offset=0x0 Size=0x8
    int Status;// Offset=0x8 Size=0x4
    struct _KEVENT Event;// Offset=0x10 Size=0x18
    void _FILTER_PAUSE_RESTART_CONTEXT(struct _FILTER_PAUSE_RESTART_CONTEXT * );
    void _FILTER_PAUSE_RESTART_CONTEXT(struct _FILTER_PAUSE_RESTART_CONTEXT & );
    struct _FILTER_PAUSE_RESTART_CONTEXT & operator=(struct _FILTER_PAUSE_RESTART_CONTEXT * );
    struct _FILTER_PAUSE_RESTART_CONTEXT & operator=(struct _FILTER_PAUSE_RESTART_CONTEXT & );
};
