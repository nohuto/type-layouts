...
struct _IF_COUNTED_STRING_LH// Size=0x204 (Id=1197)
{
...
struct _GROUP_AFFINITY// Size=0x10 (Id=595)
{
...
struct _NDIS_NDK_CAPABILITIES// Size=0x38 (Id=1676)
{
...
struct _NDIS_NDK_REQUEST_PARAMETERS// Size=0x68 (Id=2015)
{
...
struct _NDIS_NDK_RESPONSE_PARAMETERS// Size=0x40 (Id=2010)
{
...
struct _NDIS_NDK_PARAMETERS// Size=0xa8 (Id=2009)
{
...
struct _NDIS_NIC_SWITCH_VPORT_PARAMETERS// Size=0x2f0 (Id=1991)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
...
struct _NDIS_VPORT_BLOCK// Size=0x388 (Id=1918)
{
    ...
    struct _NDIS_MINIPORT_RSS_PARAMETERS_CACHE * RssParametersBuffer;// Offset=0x378 Size=0x8
    struct _NDIS_RECEIVE_SCALE_PARAMETERS * CombinedNdisRSSParameters;// Offset=0x380 Size=0x8
};
