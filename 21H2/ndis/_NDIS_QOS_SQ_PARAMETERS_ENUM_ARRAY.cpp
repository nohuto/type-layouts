...
struct _NDIS_QOS_SQ_PARAMETERS_ENUM_ARRAY// Size=0x20 (Id=1735)
{
    ...
    union // Size=0x4 (Id=0)
    {
        unsigned long SqArrayOffset;// Offset=0x14 Size=0x4
        unsigned long SqParamsArrayOffset;// Offset=0x14 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long SqArrayNumElements;// Offset=0x18 Size=0x4
        unsigned long SqParamsArrayNumElements;// Offset=0x18 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long SqArrayElementSize;// Offset=0x1c Size=0x4
