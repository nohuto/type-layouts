...
struct _PENDING_STACK_EXPANSION_FALLBACK_WORK// Size=0x38 (Id=1215)
{
...
struct _NDIS_FILTER_PARTIAL_CHARACTERISTICS// Size=0x30 (Id=738)
{
...
struct _NDIS_FILTER_BLOCK// Size=0x3a0 (Id=450)
{
    union // Size=0xc0 (Id=0)
    {
        ...
        struct <unnamed-type-StackExpansionFallback>// Size=0x60 (Id=6124)
        {
    ...
    struct _PKTMON_COMPONENT_CONTEXT PktMonComp;// Offset=0x318 Size=0x38
