union _SLIST_HEADER// Size=0x10 (Id=72)
{
    ...
    struct <unnamed-type-HeaderX64>// Size=0x10 (Id=13049)
    {
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=70)
{
...
struct _LOOKASIDE_LIST_EX// Size=0x60 (Id=69)
{
    struct _GENERAL_LOOKASIDE_POOL L;// Offset=0x0 Size=0x60
};

struct _NDIS_NPAGED_LOOKASIDE_LIST// Size=0x100 (Id=1395)
{
