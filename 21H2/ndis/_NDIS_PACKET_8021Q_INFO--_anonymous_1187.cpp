union _NDIS_PACKET_8021Q_INFO::_anonymous_1187// Size=0x8 (Id=1187)
{
    struct <unnamed-type-TagHeader>// Size=0x4 (Id=9282)
    {
    ...
    struct _NDIS_PACKET_8021Q_INFO::_anonymous_1188::<unnamed-type-TagHeader> TagHeader;// Offset=0x0 Size=0x4
