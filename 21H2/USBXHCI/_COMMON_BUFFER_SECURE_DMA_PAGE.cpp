...
struct _XIL_COMMON_BUFFER_PAGE// Size=0x10 (Id=508)
{
...
struct _COMMON_BUFFER_SECURE_DMA_PAGE// Size=0x78 (Id=511)
{
    ...
    struct _anonymous_510 PageMdl;// Offset=0x20 Size=0x38
