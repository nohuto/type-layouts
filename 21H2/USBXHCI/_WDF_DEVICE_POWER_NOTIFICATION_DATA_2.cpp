...
struct _anonymous_687// Size=0x8 (Id=687)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _anonymous_688// Size=0x4 (Id=688)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _anonymous_689// Size=0x8 (Id=689)
{
    struct _anonymous_687 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_688 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_687 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=244)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_689 Data;// Offset=0x4 Size=0x8
};
