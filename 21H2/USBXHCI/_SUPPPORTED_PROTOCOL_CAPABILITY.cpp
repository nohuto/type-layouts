union _SUPPPORTED_PROTOCOL_CAPABILITY_REVISION// Size=0x4 (Id=1023)
{
...
union _SUPPPORTED_PROTOCOL_CAPABILITY_NAME_STRING// Size=0x4 (Id=1027)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    unsigned char NameString[4];// Offset=0x0 Size=0x4
};

union _SUPPPORTED_PROTOCOL_CAPABILITY_PORT_OFFSET_COUNT// Size=0x4 (Id=1011)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _SUPPPORTED_PROTOCOL_CAPABILITY_SLOT// Size=0x4 (Id=1019)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _SUPPPORTED_PROTOCOL_CAPABILITY// Size=0x10 (Id=991)
{
