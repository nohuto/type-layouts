...
struct _STATIC_STREAM_DATA// Size=0x68 (Id=541)
{
    void * TransferRingHandle;// Offset=0x0 Size=0x8
    struct _CRB Crb;// Offset=0x8 Size=0x60
};

struct _STATIC_STREAMS_DATA// Size=0x98 (Id=538)
{
    struct _ENDPOINT_DATA * EndpointData;// Offset=0x0 Size=0x8
    unsigned long NumberOfStreams;// Offset=0x8 Size=0x4
    unsigned long MaxPrimaryStreams;// Offset=0xc Size=0x4
    unsigned long PurgeCount;// Offset=0x10 Size=0x4
    long UpdateCount;// Offset=0x14 Size=0x4
    unsigned long HaltedCompletionCode;// Offset=0x18 Size=0x4
    struct _XIL_BUFFER_DATA * StreamContextArray;// Offset=0x20 Size=0x8
    struct TRUSTLET_OBJECT_HANDLE__ * SecureStreamContextArray;// Offset=0x28 Size=0x8
    struct _STATIC_STREAM_DATA StaticStreamData[1];// Offset=0x30 Size=0x68
};
