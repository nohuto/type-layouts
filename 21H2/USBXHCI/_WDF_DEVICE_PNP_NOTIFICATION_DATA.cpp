...
struct _anonymous_658// Size=0x8 (Id=658)
{
...
union _anonymous_660// Size=0x8 (Id=660)
{
    struct _anonymous_658 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_659 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_658 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=661)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_660 Data;// Offset=0x4 Size=0x8
};
