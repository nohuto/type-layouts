...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=645)
{
...
struct _PCI_DEVICE_INFORMATION// Size=0x38 (Id=691)
{
...
struct _ACPI_DEVICE_INFORMATION// Size=0xf (Id=930)
{
...
union _FRAME_SNAPSHOT// Size=0x8 (Id=852)
{
...
struct _FRAME_NUMBER_DATA// Size=0x10 (Id=630)
{
...
union _XHCI_TEST_MODE_FLAGS// Size=0x4 (Id=885)
{
...
struct _CONTROLLER_DATA// Size=0x338 (Id=484)
{
    ...
    unsigned char SupportForVTIOv2Onv1HostsEnabled;// Offset=0x24a Size=0x1
    unsigned char SupportForVTIOv2Onv2HostsEnabled;// Offset=0x24b Size=0x1
