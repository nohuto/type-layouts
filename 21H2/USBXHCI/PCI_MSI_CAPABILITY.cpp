...
union _PCI_MSI_MESSAGE_CONTROL// Size=0x2 (Id=1020)
{
...
struct _PCI_MSI_MESSAGE_ADDRESS// Size=0x4 (Id=1028)
{
...
struct _anonymous_972// Size=0x10 (Id=972)
{
...
struct PCI_MSI_CAPABILITY// Size=0x18 (Id=973)
{
    ...
    union _anonymous_970 MessageAddressLower;// Offset=0x4 Size=0x4
    union // Size=0xc (Id=0)
    {
        struct _anonymous_971 Option32Bit;// Offset=0x8 Size=0xc
        struct _anonymous_972 Option64Bit;// Offset=0x8 Size=0x10
    };
};
