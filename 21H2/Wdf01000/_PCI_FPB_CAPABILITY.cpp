...
struct _PCI_FPB_CAPABILITY_HEADER// Size=0x4 (Id=1726)
{
    struct _PCI_CAPABILITIES_HEADER Header;// Offset=0x0 Size=0x2
    unsigned short Reserved;// Offset=0x2 Size=0x2
};

union _PCI_FPB_CAPABILITIES_REGISTER// Size=0x4 (Id=2084)
{
...
union _PCI_FPB_RID_VECTOR_CONTROL2_REGISTER// Size=0x4 (Id=2108)
{
    struct // Size=0x4 (Id=0)
    {
...
union _PCI_FPB_MEM_HIGH_VECTOR_CONTROL1_REGISTER// Size=0x4 (Id=2052)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PCI_FPB_MEM_HIGH_VECTOR_CONTROL2_REGISTER// Size=0x4 (Id=2613)
{
...
struct _PCI_FPB_VECTOR_ACCESS_DATA_REGISTER// Size=0x4 (Id=1889)
{
    unsigned long VectorAccessData;// Offset=0x0 Size=0x4
};

struct _PCI_FPB_CAPABILITY// Size=0x24 (Id=3008)
{
