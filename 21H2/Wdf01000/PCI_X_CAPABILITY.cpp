...
struct PCI_X_CAPABILITY// Size=0x8 (Id=2733)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-Command>// Size=0x2 (Id=68200)
        {
            struct <unnamed-type-bits>// Size=0x2 (Id=68201)
            {
        ...
        union <unnamed-type-Status>// Size=0x4 (Id=68210)
        {
            struct <unnamed-type-bits>// Size=0x4 (Id=68211)
            {
