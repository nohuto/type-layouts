...
struct _WHEA_RECOVERY_CONTEXT// Size=0x20 (Id=2507)
{
    union // Size=0x10 (Id=0)
    {
        struct _WHEA_RECOVERY_CONTEXT::_anonymous_2509::<unnamed-type-MemoryError> MemoryError;// Offset=0x0 Size=0x10
        struct _WHEA_RECOVERY_CONTEXT::_anonymous_2508::<unnamed-type-PmemError> PmemError;// Offset=0x0 Size=0x8
