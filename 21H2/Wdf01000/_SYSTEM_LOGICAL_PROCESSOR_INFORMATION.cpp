...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=2066)
{
...
struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION// Size=0x20 (Id=2573)
{
    ...
    {
        struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION::_anonymous_2575::<unnamed-type-ProcessorCore> ProcessorCore;// Offset=0x10 Size=0x1
        struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION::_anonymous_2574::<unnamed-type-NumaNode> NumaNode;// Offset=0x10 Size=0x4
