...
union _PCI_EXPRESS_DPC_CAPS_REGISTER// Size=0x2 (Id=3066)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_DPC_CONTROL_REGISTER// Size=0x2 (Id=2101)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_DPC_STATUS_REGISTER// Size=0x2 (Id=2752)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_DPC_RP_PIO_STATUS_REGISTER// Size=0x4 (Id=2809)
{
...
union _PCI_EXPRESS_DPC_RP_PIO_MASK_REGISTER// Size=0x4 (Id=2398)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long CfgURCpl:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
union _PCI_EXPRESS_DPC_RP_PIO_SEVERITY_REGISTER// Size=0x4 (Id=2610)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long CfgURCpl:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
union _PCI_EXPRESS_DPC_RP_PIO_SYSERR_REGISTER// Size=0x4 (Id=1784)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long CfgURCpl:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
union _PCI_EXPRESS_DPC_RP_PIO_EXCEPTION_REGISTER// Size=0x4 (Id=2244)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long CfgURCpl:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
struct _PCI_EXPRESS_DPC_RP_PIO_HEADERLOG_REGISTER// Size=0x10 (Id=2996)
{
    unsigned long PioHeaderLogRegister[4];// Offset=0x0 Size=0x10
};

union _PCI_EXPRESS_DPC_RP_PIO_IMPSPECLOG_REGISTER// Size=0x4 (Id=1693)
{
    unsigned long PioImpSpecLog;// Offset=0x0 Size=0x4
};

struct _PCI_EXPRESS_DPC_RP_PIO_TLPPREFIXLOG_REGISTER// Size=0x10 (Id=1838)
{
    unsigned long PioTlpPrefixLogRegister[4];// Offset=0x0 Size=0x10
};

struct _PCI_EXPRESS_DPC_CAPABILITY// Size=0x44 (Id=2231)
{
