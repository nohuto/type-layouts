...
struct _PO_FX_COMPONENT_V2// Size=0x38 (Id=2646)
{
...
struct _PO_FX_DEVICE_V3// Size=0xa0 (Id=3003)
{
    ...
    unsigned long DirectedFxTimeoutInSeconds;// Offset=0x50 Size=0x4
    void * DeviceContext;// Offset=0x58 Size=0x8
    unsigned long ComponentCount;// Offset=0x60 Size=0x4
    struct _PO_FX_COMPONENT_V2 Components[1];// Offset=0x68 Size=0x38
};
