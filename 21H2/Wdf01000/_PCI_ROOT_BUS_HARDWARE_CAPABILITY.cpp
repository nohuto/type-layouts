...
struct _PCI_ROOT_BUS_OSC_SUPPORT_FIELD// Size=0x4 (Id=2028)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=12091)
        {
...
struct _PCI_ROOT_BUS_OSC_CONTROL_FIELD// Size=0x4 (Id=3000)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=12081)
        {
