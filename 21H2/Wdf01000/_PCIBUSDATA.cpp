struct _PCI_SLOT_NUMBER// Size=0x4 (Id=3051)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=12110)
        {
            struct <unnamed-type-bits>// Size=0x4 (Id=12111)
            {
...
struct _PCIBUSDATA// Size=0x50 (Id=2393)
{
