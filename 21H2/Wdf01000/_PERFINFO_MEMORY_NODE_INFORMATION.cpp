struct _PERFINFO_MEMORY_NODE_ENTRY// Size=0x4c (Id=2114)
{
...
struct _PERFINFO_MEMORY_NODE_INFORMATION// Size=0x54 (Id=2348)
{
    unsigned long PartitionId;// Offset=0x0 Size=0x4
    unsigned long Count;// Offset=0x4 Size=0x4
    struct _PERFINFO_MEMORY_NODE_ENTRY NodeEntry[1];// Offset=0x8 Size=0x4c
};
