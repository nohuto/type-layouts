union _BM_REQUEST_TYPE// Size=0x1 (Id=2861)
{
    struct _BM// Size=0x1 (Id=4944)
    {
...
struct _USB_DEFAULT_PIPE_SETUP_PACKET// Size=0x8 (Id=2164)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union _wIndex// Size=0x2 (Id=15967)
        {
            unsigned char LowByte;// Offset=0x0 Size=0x1
            unsigned char HiByte;// Offset=0x1 Size=0x1
            unsigned short W;// Offset=0x0 Size=0x2
