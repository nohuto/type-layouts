...
struct _anonymous_680// Size=0x18 (Id=680)
{
...
struct _anonymous_686// Size=0x10 (Id=686)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_690// Size=0x18 (Id=690)
{
...
union _anonymous_692// Size=0x18 (Id=692)
{
    union // Size=0x18 (Id=0)
    {
        struct _anonymous_680 Port;// Offset=0x0 Size=0x18
        struct _anonymous_680 Memory;// Offset=0x0 Size=0x18
        struct _anonymous_682 Interrupt;// Offset=0x0 Size=0x18
        struct _anonymous_683 Dma;// Offset=0x0 Size=0x8
        struct _anonymous_684 DmaV3;// Offset=0x0 Size=0x10
        struct _anonymous_680 Generic;// Offset=0x0 Size=0x18
        struct _anonymous_685 DevicePrivate;// Offset=0x0 Size=0xc
        struct _anonymous_686 BusNumber;// Offset=0x0 Size=0x10
        struct _anonymous_687 ConfigData;// Offset=0x0 Size=0xc
        struct _anonymous_688 Memory40;// Offset=0x0 Size=0x18
        struct _anonymous_689 Memory48;// Offset=0x0 Size=0x18
        struct _anonymous_690 Memory64;// Offset=0x0 Size=0x18
        struct _anonymous_691 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=693)
{
    ...
    union _anonymous_692 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=660)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=485)
{
