...
struct _anonymous_762// Size=0x18 (Id=762)
{
...
struct _anonymous_763// Size=0x20 (Id=763)
{
...
struct _anonymous_764// Size=0x28 (Id=764)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=765)
{
    struct _anonymous_759 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _anonymous_760 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _anonymous_762 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _anonymous_763 QueryOpen;// Offset=0x0 Size=0x20
    struct _anonymous_764 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=742)
{
