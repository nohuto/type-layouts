...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=374)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=451)
{
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=543)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=574)
{
    union // Size=0x2 (Id=0)
    {
...
struct _MMSUPPORT_INSTANCE// Size=0xc0 (Id=497)
{
...
struct _MMSUPPORT_SHARED// Size=0x80 (Id=516)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=416)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=116)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=409)
{
...
struct _EPROCESS// Size=0xa40 (Id=120)
{
    ...
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags3;// Offset=0xa30 Size=0x4
        struct _anonymous_119 MitigationFlags3Values;// Offset=0xa30 Size=0x4
    };
};
