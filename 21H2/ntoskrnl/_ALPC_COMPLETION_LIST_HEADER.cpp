struct _anonymous_1655// Size=0x8 (Id=1655)
{
...
union _anonymous_1656// Size=0x8 (Id=1656)
{
    struct _anonymous_1655 s1;// Offset=0x0 Size=0x8
    long long Value;// Offset=0x0 Size=0x8
};

struct _ALPC_COMPLETION_LIST_STATE// Size=0x8 (Id=1657)
{
    union _anonymous_1656 u1;// Offset=0x0 Size=0x8
};

struct _RTL_SRWLOCK// Size=0x8 (Id=1352)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _ALPC_COMPLETION_LIST_HEADER// Size=0x180 (Id=1415)
{
