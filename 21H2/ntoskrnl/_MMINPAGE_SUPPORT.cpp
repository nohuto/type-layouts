...
struct _MI_STORE_INPAGE_COMPLETE_FLAGS// Size=0x4 (Id=2023)
{
    union // Size=0x4 (Id=0)
    {
...
struct _MMINPAGE_FLAGS// Size=0x4 (Id=1498)
{
    struct // Size=0x4 (Id=0)
    {
...
union _anonymous_1266// Size=0x4 (Id=1266)
{
...
struct _MMINPAGE_SUPPORT_FLOW_THROUGH// Size=0x38 (Id=1634)
{
...
struct _MMINPAGE_SUPPORT// Size=0x1c0 (Id=1267)
{
    union // Size=0x10 (Id=0)
    {
    ...
    union _anonymous_1264 u2;// Offset=0x68 Size=0x30
    ...
    union _anonymous_1265 u3;// Offset=0xbc Size=0x4
    union _anonymous_1266 u1;// Offset=0xc0 Size=0x4
    union // Size=0x8 (Id=0)
    {
