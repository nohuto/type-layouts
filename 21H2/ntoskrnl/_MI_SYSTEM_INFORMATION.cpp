...
struct _MMSUBSECTION_FLAGS// Size=0x4 (Id=1711)
{
...
struct _SUBSECTION// Size=0x38 (Id=1045)
{
    ...
    union _anonymous_1043 u;// Offset=0x20 Size=0x4
    ...
    union _anonymous_1044 u1;// Offset=0x30 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _MSUBSECTION// Size=0x90 (Id=1824)
{
...
struct _MMSECTION_FLAGS// Size=0x4 (Id=895)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MMSECTION_FLAGS2// Size=0x4 (Id=1092)
{
...
union _anonymous_549// Size=0x4 (Id=549)
{
    unsigned long LongFlags;// Offset=0x0 Size=0x4
...
struct _anonymous_550// Size=0x10 (Id=550)
{
    union // Size=0x4 (Id=0)
    {
...
union _anonymous_551// Size=0x10 (Id=551)
{
    struct _anonymous_550 e2;// Offset=0x0 Size=0x10
};

union _anonymous_552// Size=0x8 (Id=552)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _CONTROL_AREA// Size=0x80 (Id=553)
{
    ...
    union _anonymous_548 u;// Offset=0x38 Size=0x4
    union _anonymous_549 u1;// Offset=0x3c Size=0x4
...
struct _MI_EXTENT_DELETION_WAIT_BLOCK// Size=0x20 (Id=1718)
{
...
struct _MI_DLL_OVERFLOW_AREA// Size=0x20 (Id=1433)
{
...
struct _MI_SECTION_WOW_STATE// Size=0x40 (Id=1507)
{
...
struct _MI_SECTION_STATE// Size=0x340 (Id=1236)
{
...
struct _MM_SYSTEM_PAGE_COUNTS// Size=0x10 (Id=1370)
{
...
struct _MI_SYSTEM_IMAGE_STATE// Size=0xa8 (Id=1149)
{
...
struct _MMSESSION// Size=0x20 (Id=974)
{
...
struct _MI_HUGE_SYSTEM_VIEW_HEAD// Size=0x10 (Id=1594)
{
...
struct _MI_SESSION_STATE// Size=0x10a8 (Id=1233)
{
...
struct _MI_PROCESS_STATE// Size=0x48 (Id=1137)
{
...
struct _HAL_NODE_RANGE// Size=0x10 (Id=1833)
{
...
struct _MI_SYSTEM_VA_STATE// Size=0x4c0 (Id=1410)
{
...
struct _MI_COMBINE_STATE// Size=0x20 (Id=1635)
{
...
struct _MI_PAGELIST_STATE// Size=0x88 (Id=1653)
{
    long ActiveSpinLock;// Offset=0x0 Size=0x4
    struct _RTL_AVL_TREE ActiveThreadTree;// Offset=0x8 Size=0x8
...
struct _MI_PARTITION_STATE// Size=0xc0 (Id=1168)
{
...
struct _MI_BAD_MEMORY_EVENT_ENTRY// Size=0x38 (Id=1840)
{
...
struct _MI_PROBE_RAISE_TRACKER// Size=0x44 (Id=1901)
{
...
struct _MI_ACCESS_LOG_STATE// Size=0x80 (Id=1376)
{
...
struct _MI_DEBUGGER_STATE// Size=0x118 (Id=1453)
{
...
struct _MI_STANDBY_STATE// Size=0x90 (Id=1623)
{
...
struct _MI_SYSTEM_PTE_TYPE// Size=0x60 (Id=556)
{
    struct _RTL_BITMAP_EX Bitmap;// Offset=0x0 Size=0x10
...
struct _MI_ULTRA_VA_CONTEXT// Size=0x40 (Id=1422)
{
...
struct _MI_SYSTEM_PTE_STATE// Size=0x200 (Id=1386)
{
...
struct _MI_IO_CACHE_STATS// Size=0x28 (Id=1960)
{
...
struct _MI_IO_PAGE_STATE// Size=0x68 (Id=1877)
{
...
struct _MI_PAGING_IO_STATE// Size=0xb0 (Id=1618)
{
...
struct _MI_COMMON_PAGE_STATE// Size=0xa8 (Id=1771)
{
...
struct _MI_SYSTEM_TRIM_STATE// Size=0x40 (Id=1359)
{
...
struct _MI_ENCLAVE_STATE// Size=0x48 (Id=1169)
{
...
struct _MM_PAGED_POOL_INFO// Size=0x18 (Id=1062)
{
...
struct _MMSUPPORT_SHARED// Size=0x80 (Id=1412)
{
...
struct _SYSPTES_HEADER// Size=0x118 (Id=1767)
{
...
struct _MI_SYSTEM_VA_ASSIGNMENT// Size=0x10 (Id=1990)
{
    void * BaseAddress;// Offset=0x0 Size=0x8
    unsigned long long NumberOfBytes;// Offset=0x8 Size=0x8
};

struct _MI_VISIBLE_STATE// Size=0xcc0 (Id=1821)
{
...
struct _MI_SYSTEM_INFORMATION// Size=0x32c0 (Id=1115)
{
