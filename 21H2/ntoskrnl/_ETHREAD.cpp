...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=1432)
{
...
struct _KAPC_STATE// Size=0x30 (Id=1337)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=1391)
{
...
struct _KAPC// Size=0x58 (Id=1293)
{
    unsigned char Type;// Offset=0x0 Size=0x1
    union // Size=0x1 (Id=0)
    {
...
struct _KTHREAD// Size=0x430 (Id=412)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    ...
    struct // Size=0x2 (Id=0)
    {
        ...
        unsigned char RunningNonRetpolineCode:1;// Offset=0x7f Size=0x1 BitOffset=0x0 BitSize=0x1
        unsigned char SpecCtrlSpare:7;// Offset=0x7f Size=0x1 BitOffset=0x1 BitSize=0x7
    };
    unsigned char SpecCtrl;// Offset=0x7f Size=0x1
...
union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=1424)
{
...
struct _PS_PROPERTY_SET// Size=0x18 (Id=1019)
{
...
struct _KLOCK_ENTRY_LOCK_STATE// Size=0x10 (Id=1454)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
union _KLOCK_ENTRY_BOOST_BITMAP// Size=0x4 (Id=940)
{
...
struct _KLOCK_ENTRY// Size=0x60 (Id=922)
{
...
struct _ETHREAD// Size=0x898 (Id=432)
{
