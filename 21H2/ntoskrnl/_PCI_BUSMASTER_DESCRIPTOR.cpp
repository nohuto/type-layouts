...
struct _anonymous_1174// Size=0x4 (Id=1174)
{
...
struct _anonymous_1175// Size=0x2 (Id=1175)
{
    unsigned char SecondaryBus;// Offset=0x0 Size=0x1
    unsigned char SubordinateBus;// Offset=0x1 Size=0x1
};

struct _PCI_BUSMASTER_DESCRIPTOR// Size=0xc (Id=1176)
{
    enum _PCI_BUSMASTER_RID_TYPE Type;// Offset=0x0 Size=0x4
    unsigned long Segment;// Offset=0x4 Size=0x4
    union // Size=0xc (Id=0)
    {
        struct _anonymous_1174 DeviceRid;// Offset=0x8 Size=0x4
        struct _anonymous_1174 BridgeRid;// Offset=0x8 Size=0x4
        struct _anonymous_1175 MultipleBridges;// Offset=0x8 Size=0x2
    };
};
