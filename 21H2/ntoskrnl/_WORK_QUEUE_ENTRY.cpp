...
struct _anonymous_707// Size=0x10 (Id=707)
{
...
struct _anonymous_709// Size=0x8 (Id=709)
{
...
struct _anonymous_711// Size=0x30 (Id=711)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
struct _anonymous_712// Size=0x68 (Id=712)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
union _anonymous_713// Size=0x68 (Id=713)
{
    struct _anonymous_707 Read;// Offset=0x0 Size=0x10
    struct _anonymous_708 Write;// Offset=0x0 Size=0x8
    struct _anonymous_709 Event;// Offset=0x0 Size=0x8
    struct _anonymous_710 Notification;// Offset=0x0 Size=0x4
    struct _anonymous_711 LowPriWrite;// Offset=0x0 Size=0x30
    struct _anonymous_712 AsyncRead;// Offset=0x0 Size=0x68
};

struct _WORK_QUEUE_ENTRY// Size=0x88 (Id=714)
{
    struct _LIST_ENTRY WorkQueueLinks;// Offset=0x0 Size=0x10
    union _anonymous_713 Parameters;// Offset=0x10 Size=0x68
