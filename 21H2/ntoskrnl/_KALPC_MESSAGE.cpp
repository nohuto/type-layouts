...
{
    struct _anonymous_809 s1;// Offset=0x0 Size=0x4
...
struct _KALPC_MESSAGE// Size=0x118 (Id=811)
{
    ...
    union _anonymous_810 u1;// Offset=0x28 Size=0x4
