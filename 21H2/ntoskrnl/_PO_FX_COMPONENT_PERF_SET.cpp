...
struct _PO_FX_COMPONENT_PERF_SET// Size=0x30 (Id=2049)
{
    ...
    {
        struct _anonymous_2047 Discrete;// Offset=0x20 Size=0x10
        struct _anonymous_2048 Range;// Offset=0x20 Size=0x10
    };
};
