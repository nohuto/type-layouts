...
struct _I386_LOADER_BLOCK// Size=0x10 (Id=1936)
{
...
struct _ARM_LOADER_BLOCK// Size=0x4 (Id=2005)
{
    unsigned long PlaceHolder;// Offset=0x0 Size=0x4
};

union _anonymous_1748// Size=0x10 (Id=1748)
{
...
struct _EFI_FIRMWARE_INFORMATION// Size=0x38 (Id=2012)
{
...
struct _PCAT_FIRMWARE_INFORMATION// Size=0x4 (Id=2019)
{
    unsigned long PlaceHolder;// Offset=0x0 Size=0x4
};

union _anonymous_1946// Size=0x38 (Id=1946)
{
...
struct _FIRMWARE_INFORMATION_LOADER_BLOCK// Size=0x40 (Id=1947)
{
    ...
    union _anonymous_1946 u;// Offset=0x8 Size=0x38
};

struct _LOADER_PARAMETER_BLOCK// Size=0x160 (Id=1749)
{
    ...
    union _anonymous_1748 u;// Offset=0xf8 Size=0x10
