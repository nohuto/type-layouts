...
struct _ETW_REF_CLOCK// Size=0x10 (Id=1339)
{
...
struct _KMUTANT// Size=0x38 (Id=1363)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _TOKEN_CONTROL// Size=0x28 (Id=1695)
{
...
struct _SECURITY_CLIENT_CONTEXT// Size=0x48 (Id=1146)
{
...
struct _ETW_STACK_TRACE_BLOCK// Size=0x80 (Id=1518)
{
...
struct _DISALLOWED_GUIDS// Size=0x10 (Id=1330)
{
...
struct _ETW_PARTITION_CONTEXT// Size=0x8 (Id=980)
{
    struct _EPARTITION * Partition;// Offset=0x0 Size=0x8
};

struct _WMI_LOGGER_CONTEXT// Size=0x530 (Id=849)
{
