...
struct _anonymous_796// Size=0x4 (Id=796)
{
...
union _anonymous_797// Size=0x4 (Id=797)
{
    struct _anonymous_796 s1;// Offset=0x0 Size=0x4
};

struct _KALPC_VIEW// Size=0x60 (Id=798)
{
    ...
    union _anonymous_797 u1;// Offset=0x48 Size=0x4
