...
struct _anonymous_443// Size=0x58 (Id=443)
{
...
union _anonymous_444// Size=0x58 (Id=444)
{
    union // Size=0x58 (Id=0)
    {
        struct _anonymous_443 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=445)
{
    ...
    union _anonymous_444 Tail;// Offset=0x78 Size=0x58
};
