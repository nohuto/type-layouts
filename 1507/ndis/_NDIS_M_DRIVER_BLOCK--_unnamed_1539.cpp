...
union _NDIS_M_DRIVER_BLOCK::_unnamed_1539// Size=0xf0 (Id=1539)
{
    struct _NDIS_MINIPORT_DRIVER_CHARACTERISTICS MiniportDriverCharacteristics;// Offset=0x0 Size=0x98
