struct _PD_BUFFER_VIRTUAL_SUBNET_INFO// Size=0x4 (Id=1716)
{
...
struct _PD_BUFFER_8021Q_INFO// Size=0x2 (Id=1667)
{
...
union _PD_BUFFER::_unnamed_1461// Size=0x30 (Id=1461)
{
    struct <unnamed-type-MetaDataV0>// Size=0x30 (Id=11287)
    {
        ...
        unsigned long RxGftExceptionPacket:1;// Offset=0xc Size=0x4 BitOffset=0x8 BitSize=0x1
        unsigned long RxGftCopyPacket:1;// Offset=0xc Size=0x4 BitOffset=0x9 BitSize=0x1
        unsigned long RxGftSamplePacket:1;// Offset=0xc Size=0x4 BitOffset=0xa BitSize=0x1
        unsigned long RxReserved1:5;// Offset=0xc Size=0x4 BitOffset=0xb BitSize=0x5
    ...
    struct _PD_BUFFER::_unnamed_1462::<unnamed-type-MetaDataV0> MetaDataV0;// Offset=0x0 Size=0x30
};
