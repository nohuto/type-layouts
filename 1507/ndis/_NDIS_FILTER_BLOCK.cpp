...
struct _PENDING_STACK_EXPANSION_FALLBACK_WORK// Size=0x38 (Id=1245)
{
...
struct _NDIS_FILTER_PARTIAL_CHARACTERISTICS// Size=0x30 (Id=897)
{
...
struct _NDIS_FILTER_BLOCK// Size=0x390 (Id=405)
{
    union // Size=0xc0 (Id=0)
    {
        ...
        class KPtr<Rtl::KString,KDeletePtr<Rtl::KString> > FilterInstanceName;// Offset=0x28 Size=0x8
        ...
        struct <unnamed-type-StackExpansionFallback>// Size=0x60 (Id=5583)
        {
    ...
    void  ( * InitiateOffloadCompleteHandler)(void * ,struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * );// Offset=0x288 Size=0x8
    void  ( * TerminateOffloadCompleteHandler)(void * ,struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * );// Offset=0x290 Size=0x8
    void  ( * UpdateOffloadCompleteHandler)(void * ,struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * );// Offset=0x298 Size=0x8
    void  ( * InvalidateOffloadCompleteHandler)(void * ,struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * );// Offset=0x2a0 Size=0x8
    void  ( * QueryOffloadCompleteHandler)(void * ,struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * );// Offset=0x2a8 Size=0x8
    void  ( * IndicateOffloadEventHandler)(void * ,struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * ,unsigned long );// Offset=0x2b0 Size=0x8
    void  ( * TcpOffloadSendCompleteHandler)(void * ,struct _NET_BUFFER_LIST * );// Offset=0x2b8 Size=0x8
    void  ( * TcpOffloadReceiveCompleteHandler)(void * ,struct _NET_BUFFER_LIST * );// Offset=0x2c0 Size=0x8
    void  ( * TcpOffloadDisconnectCompleteHandler)(void * ,struct _NET_BUFFER_LIST * );// Offset=0x2c8 Size=0x8
    void  ( * TcpOffloadForwardCompleteHandler)(void * ,struct _NET_BUFFER_LIST * );// Offset=0x2d0 Size=0x8
    void  ( * TcpOffloadEventHandler)(void * ,unsigned long ,unsigned long );// Offset=0x2d8 Size=0x8
    int  ( * TcpOffloadReceiveIndicateHandler)(void * ,struct _NET_BUFFER_LIST * ,int ,unsigned long * );// Offset=0x2e0 Size=0x8
    void  ( * InitiateOffloadHandler)(void * ,struct _NDIS_MINIPORT_OFFLOAD_BLOCK_LIST * );// Offset=0x2e8 Size=0x8
    void  ( * TerminateOffloadHandler)(void * ,struct _NDIS_MINIPORT_OFFLOAD_BLOCK_LIST * );// Offset=0x2f0 Size=0x8
    void  ( * UpdateOffloadHandler)(void * ,struct _NDIS_MINIPORT_OFFLOAD_BLOCK_LIST * );// Offset=0x2f8 Size=0x8
    void  ( * InvalidateOffloadHandler)(void * ,struct _NDIS_MINIPORT_OFFLOAD_BLOCK_LIST * );// Offset=0x300 Size=0x8
    void  ( * QueryOffloadHandler)(void * ,struct _NDIS_MINIPORT_OFFLOAD_BLOCK_LIST * );// Offset=0x308 Size=0x8
    int  ( * TcpOffloadReceiveReturnHandler)(void * ,struct _NET_BUFFER_LIST * );// Offset=0x310 Size=0x8
    struct NDIS_NBL_TRACKER_HANDLE__ * NblTracker;// Offset=0x318 Size=0x8
    struct _NDIS_FILTER_TASK_OFFLOAD * Offload;// Offset=0x320 Size=0x8
    struct _GUID InterfaceGuid;// Offset=0x328 Size=0x10
    unsigned long IfIndex;// Offset=0x338 Size=0x4
    struct _NDIS_IF_BLOCK * IfBlock;// Offset=0x340 Size=0x8
    void * NextDirectRequestHandle;// Offset=0x348 Size=0x8
    unsigned long DirectOidRequestCount;// Offset=0x350 Size=0x4
    struct _SINGLE_LIST_ENTRY WOLPatternList;// Offset=0x358 Size=0x8
    struct _SINGLE_LIST_ENTRY PMProtocolOffloadList;// Offset=0x360 Size=0x8
    struct _NDIS_PM_PARAMETERS PMCurrentParameters;// Offset=0x368 Size=0x14
    struct NDIS_BIND_FILTER_LINK * Bind;// Offset=0x380 Size=0x8
    void * VerifierContext;// Offset=0x388 Size=0x8
