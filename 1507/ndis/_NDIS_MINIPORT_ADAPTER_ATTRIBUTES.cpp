...
struct _NDIS_MINIPORT_ADD_DEVICE_REGISTRATION_ATTRIBUTES// Size=0x18 (Id=829)
{
...
struct _NDIS_MINIPORT_ADAPTER_REGISTRATION_ATTRIBUTES// Size=0x20 (Id=1459)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES// Size=0xe0 (Id=681)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_ADAPTER_OFFLOAD_ATTRIBUTES// Size=0x28 (Id=1175)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_ADAPTER_NATIVE_802_11_ATTRIBUTES// Size=0x40 (Id=1233)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_ADAPTER_HARDWARE_ASSIST_ATTRIBUTES// Size=0x60 (Id=1267)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_ADAPTER_NDK_ATTRIBUTES// Size=0x10 (Id=490)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_ADAPTER_PACKET_DIRECT_ATTRIBUTES// Size=0xc (Id=1645)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
...
union _NDIS_MINIPORT_ADAPTER_ATTRIBUTES// Size=0xe0 (Id=1280)
{
