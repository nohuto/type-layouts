...
struct _NDIS_MINIPORT_DRIVER_CHARACTERISTICS// Size=0x98 (Id=393)
{
...
struct _NDIS50_MINIPORT_CHARACTERISTICS// Size=0xb8 (Id=670)
{
...
struct _NDIS51_MINIPORT_CHARACTERISTICS// Size=0xf0 (Id=625)
{
...
struct _REFERENCE_EX// Size=0x18 (Id=799)
{
...
struct _NDIS_CO_CALL_MANAGER_OPTIONAL_HANDLERS// Size=0x90 (Id=591)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_M_DRIVER_BLOCK// Size=0x4e8 (Id=392)
{
    ...
    {
        struct _NDIS_MINIPORT_DRIVER_CHARACTERISTICS MiniportDriverCharacteristics;// Offset=0x70 Size=0x98
        struct _NDIS51_MINIPORT_CHARACTERISTICS MiniportCharacteristics;// Offset=0x70 Size=0xf0
    };
    class KPtr<_NDIS_MINIPORT_DRIVER_CHARACTERISTICS,KDeletePtr<_NDIS_MINIPORT_DRIVER_CHARACTERISTICS> > UnhookedCharacteristics;// Offset=0x160 Size=0x8
    ...
    struct _NDIS_MINIPORT_BLOCK * CompositeBusDefaultMiniport;// Offset=0x330 Size=0x8
    int  ( * OpenNDKAdapterHandler)(void * ,struct _NDIS_OPEN_NDK_ADAPTER_PARAMETERS * ,struct _NDK_ADAPTER ** );// Offset=0x338 Size=0x8
    void  ( * CloseNDKAdapterHandler)(void * ,struct _NDK_ADAPTER * );// Offset=0x340 Size=0x8
    void  ( * SysPowerNotifyHandler)(void * ,struct _NDIS_MINIPORT_SYSPOWER_NOTIFY * );// Offset=0x348 Size=0x8
    int  ( * IdleNotificationHandler)(void * ,unsigned char );// Offset=0x350 Size=0x8
    void  ( * CancelIdleNotificationHandler)(void * );// Offset=0x358 Size=0x8
    void  ( * ReenumerateFailedAdapterHandler)(void * );// Offset=0x360 Size=0x8
    long  ( * LiveDumpCallback)(void * ,long  ( * )(void * ,struct _GUID * ,void * ,unsigned long ),unsigned long ,unsigned long long ,unsigned long long ,unsigned long long ,unsigned long long ,void * );// Offset=0x368 Size=0x8
    ...
    long  ( * PDExtProviderSetupBufferFromMemoryHandle)(struct _PD_BUFFER * ,struct NDIS_PD_EXT_MEMORY_HANDLE__ * ,unsigned long ,unsigned long ,unsigned long * ,unsigned long * );// Offset=0x460 Size=0x8
    ...
    struct NDIS_SFA_HANDLE__ * SfaHandle;// Offset=0x478 Size=0x8
    long  ( * SfaRegisterClientHandler)(struct NDIS_SFA_HANDLE__ * ,struct NDIS_SFA_CLIENT_CONTEXT__ * ,struct _GUID * ,struct _UNICODE_STRING * ,struct _NDIS_SFA_CLIENT_DISPATCH * );// Offset=0x480 Size=0x8
    void  ( * SfaDeRegisterClientHandler)(struct NDIS_SFA_HANDLE__ * ,struct NDIS_SFA_CLIENT_CONTEXT__ * );// Offset=0x488 Size=0x8
    long  ( * SfaCreateContextHandler)(struct NDIS_SFA_HANDLE__ * ,unsigned long ,unsigned long );// Offset=0x490 Size=0x8
    long  ( * SfaDeleteContextHandler)(struct NDIS_SFA_HANDLE__ * ,unsigned long );// Offset=0x498 Size=0x8
    long  ( * SfaAddRuleHandler)(struct NDIS_SFA_HANDLE__ * ,unsigned long ,unsigned long ,unsigned long ,struct _NDIS_SFA_RULE_DESCRIPTOR * );// Offset=0x4a0 Size=0x8
    long  ( * SfaRemoveRuleHandler)(struct NDIS_SFA_HANDLE__ * ,unsigned long ,unsigned long );// Offset=0x4a8 Size=0x8
    long  ( * SfaGetMeterDataHandler)(struct NDIS_SFA_HANDLE__ * ,unsigned long ,unsigned long ,union _NDIS_SFA_GET_METER_DATA_FLAGS ,struct _NDIS_SFA_METER_DATA * );// Offset=0x4b0 Size=0x8
    long  ( * PDBMCreateDomain)(struct _NDIS_PD_BM_DOMAIN_PARAMETERS * ,struct NDIS_PD_BM_DOMAIN_HANDLE__ ** );// Offset=0x4b8 Size=0x8
    long  ( * PDBMAddMemberToDomain)(struct NDIS_PD_BM_DOMAIN_HANDLE__ * ,struct _NDIS_PD_BM_DOMAIN_MEMBER_PARAMETERS * ,struct NDIS_PD_BM_DOMAIN_MEMBER_HANDLE__ ** );// Offset=0x4c0 Size=0x8
    void  ( * PDBMRemoveMemberFromDomain)(struct NDIS_PD_BM_DOMAIN_MEMBER_HANDLE__ * );// Offset=0x4c8 Size=0x8
    void  ( * PDBMDeleteDomain)(struct NDIS_PD_BM_DOMAIN_HANDLE__ * );// Offset=0x4d0 Size=0x8
    long  ( * PDBMAllocateCommonBuffer)(struct NDIS_PD_BM_DOMAIN_HANDLE__ * ,unsigned long ,unsigned long ,unsigned long ,union _LARGE_INTEGER * ,void ** );// Offset=0x4d8 Size=0x8
    void  ( * PDBMFreeCommonBuffer)(struct NDIS_PD_BM_DOMAIN_HANDLE__ * ,unsigned long ,union _LARGE_INTEGER ,void * );// Offset=0x4e0 Size=0x8
    void ~_NDIS_M_DRIVER_BLOCK();
