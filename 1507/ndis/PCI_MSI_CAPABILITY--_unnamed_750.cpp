union PCI_MSI_CAPABILITY::_unnamed_750// Size=0x10 (Id=750)
{
    struct <unnamed-type-Option32Bit>// Size=0xc (Id=15110)
    {
    ...
    struct PCI_MSI_CAPABILITY::_unnamed_751::<unnamed-type-Option32Bit> Option32Bit;// Offset=0x0 Size=0xc
    struct <unnamed-type-Option64Bit>// Size=0x10 (Id=15116)
    {
    ...
    struct PCI_MSI_CAPABILITY::_unnamed_752::<unnamed-type-Option64Bit> Option64Bit;// Offset=0x0 Size=0x10
};
