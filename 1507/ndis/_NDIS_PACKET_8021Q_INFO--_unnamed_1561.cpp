union _NDIS_PACKET_8021Q_INFO::_unnamed_1561// Size=0x8 (Id=1561)
{
    struct <unnamed-type-TagHeader>// Size=0x4 (Id=8400)
    {
    ...
    struct _NDIS_PACKET_8021Q_INFO::_unnamed_1562::<unnamed-type-TagHeader> TagHeader;// Offset=0x0 Size=0x4
