union _PD_BUFFER::_unnamed_1464::<unnamed-type-MetaDataV0>::_unnamed_1464// Size=0x8 (Id=1464)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long RxGftExceptionPacket:1;// Offset=0x0 Size=0x4 BitOffset=0x8 BitSize=0x1
        unsigned long RxGftCopyPacket:1;// Offset=0x0 Size=0x4 BitOffset=0x9 BitSize=0x1
        unsigned long RxGftSamplePacket:1;// Offset=0x0 Size=0x4 BitOffset=0xa BitSize=0x1
        unsigned long RxReserved1:5;// Offset=0x0 Size=0x4 BitOffset=0xb BitSize=0x5
    ...
    unsigned long RxOffloads[2];// Offset=0x0 Size=0x8
};
