...
struct _NDIS_PORT_CHARACTERISTICS// Size=0x40 (Id=1672)
{
...
struct _NDIS_PORT// Size=0x60 (Id=1593)
{
    struct _NDIS_PORT * Next;// Offset=0x0 Size=0x8
    void * NdisReserved;// Offset=0x8 Size=0x8
    void * MiniportReserved;// Offset=0x10 Size=0x8
    void * ProtocolReserved;// Offset=0x18 Size=0x8
    struct _NDIS_PORT_CHARACTERISTICS PortCharacteristics;// Offset=0x20 Size=0x40
};
