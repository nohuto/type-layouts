union _NDIS_TCP_IP_CHECKSUM_NET_BUFFER_LIST_INFO::_unnamed_1584// Size=0x8 (Id=1584)
{
    struct <unnamed-type-Transmit>// Size=0x4 (Id=9867)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_NET_BUFFER_LIST_INFO::_unnamed_1585::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x4
    struct <unnamed-type-Receive>// Size=0x4 (Id=9876)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_NET_BUFFER_LIST_INFO::_unnamed_1586::<unnamed-type-Receive> Receive;// Offset=0x0 Size=0x4
