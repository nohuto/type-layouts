...
struct _NDIS_NIC_SWITCH_PARAMETERS// Size=0x224 (Id=1693)
{
...
struct _NDIS_NIC_SWITCH_BLOCK// Size=0x298 (Id=1574)
{
    ...
    struct _NDIS_NIC_SWITCH_PARAMETERS SwitchParameters;// Offset=0x64 Size=0x224
    unsigned long NumActiveDefaultVPortMacAddresses;// Offset=0x288 Size=0x4
    unsigned long NumActiveNonDefaultVPortMacAddresses;// Offset=0x28c Size=0x4
    unsigned long NumActiveDefaultVPortVlanIds;// Offset=0x290 Size=0x4
    unsigned long NumActiveNonDefaultVPortVlanIds;// Offset=0x294 Size=0x4
};
