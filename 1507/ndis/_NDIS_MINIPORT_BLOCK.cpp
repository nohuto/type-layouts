...
struct _UNICODE_STRING// Size=0x10 (Id=30)
{
...
struct _REFERENCE// Size=0x10 (Id=684)
{
...
struct _NDIS_PNP_CAPABILITIES// Size=0x10 (Id=1010)
{
...
struct _NDIS_PM_PARAMETERS// Size=0x14 (Id=505)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=675)
{
...
struct _NDIS_MINIPORT_WORK_ITEM// Size=0x18 (Id=1176)
{
...
struct _KBUGCHECK_CALLBACK_RECORD// Size=0x40 (Id=1415)
{
...
struct _NDIS_RECEIVE_SCALE_CAPABILITIES// Size=0x14 (Id=298)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_RESTART_GENERAL_ATTRIBUTES// Size=0x58 (Id=297)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_M_PERIODIC_RECEIVES// Size=0x90 (Id=621)
{
...
struct _NDIS_PCI_DEVICE_CUSTOM_PROPERTIES// Size=0x34 (Id=499)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_OFFLOAD_REG// Size=0x4 (Id=1108)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _NDIS_EVENT// Size=0x18 (Id=1023)
{
    struct _KEVENT Event;// Offset=0x0 Size=0x18
};

struct _NDIS_PM_ADMIN_CONFIG// Size=0x4 (Id=451)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _KSEMAPHORE// Size=0x20 (Id=1174)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=1087)
{
...
struct _IO_REMOVE_LOCK// Size=0x20 (Id=813)
{
...
struct _PROCESSOR_NUMBER// Size=0x4 (Id=1012)
{
...
struct _ULONG_REFERENCE// Size=0x10 (Id=905)
{
    unsigned long long SpinLock;// Offset=0x0 Size=0x8
...
struct _NDIS_D0_SIGNAL_WORK_ITEM// Size=0x58 (Id=771)
{
...
struct _VPCI_INVALIDATE_BLOCK_OUTPUT// Size=0x8 (Id=1235)
{
    unsigned long long BlockMask;// Offset=0x0 Size=0x8
};

struct _LUID// Size=0x8 (Id=155)
{
    unsigned long LowPart;// Offset=0x0 Size=0x4
    long HighPart;// Offset=0x4 Size=0x4
};

struct _IF_PHYSICAL_ADDRESS_LH// Size=0x22 (Id=509)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    unsigned char Address[32];// Offset=0x2 Size=0x20
};

struct _NDIS_MINIPORT_BLOCK// Size=0x1588 (Id=332)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    ...
    struct Ndis::BindEngine BindEngine;// Offset=0x1458 Size=0x88
    class Rtl::KNeutralLock<enum NDIS_MINIPORT_POLICY_OWNER> MiniportOwner;// Offset=0x14e0 Size=0x28
    bool PmInterruptedByPnp;// Offset=0x1508 Size=0x1
    bool DoNotBlockOnMiniportLock;// Offset=0x1509 Size=0x1
    struct NDIS_MINIPORT_HOOK_ADAPTER_HANDLE__ * HookAdapterHandle;// Offset=0x1510 Size=0x8
    struct _WORK_QUEUE_ITEM InterfaceUpdateWorkItem;// Offset=0x1518 Size=0x20
    bool InterfaceUpdateInProgress;// Offset=0x1538 Size=0x1
    bool MacAddressUpdateQueued;// Offset=0x1539 Size=0x1
    bool MtuUpdateQueued;// Offset=0x153a Size=0x1
    struct _IF_PHYSICAL_ADDRESS_LH PendingMacAddress;// Offset=0x153c Size=0x22
    unsigned long PendingMtuSize;// Offset=0x1560 Size=0x4
    struct RECORDER_LOG__ * BlackBoxHandle;// Offset=0x1568 Size=0x8
    struct _KEVENT * PowerCompleteEvent;// Offset=0x1570 Size=0x8
    long PowerCompleteStatus;// Offset=0x1578 Size=0x4
    struct _NDIS_PD_BLOCK * PDBlock;// Offset=0x1580 Size=0x8
