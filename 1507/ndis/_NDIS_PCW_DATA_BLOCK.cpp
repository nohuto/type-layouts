...
struct _NDIS_PCW_DATA_BLOCK// Size=0x100 (Id=1273)
{
    ...
    unsigned long OffsetToPerCpuDataBlocks;// Offset=0xd0 Size=0x4
    unsigned long PerCpuByteStride;// Offset=0xd4 Size=0x4
};
