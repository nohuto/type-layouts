...
struct _DISPATCHER_HEADER// Size=0x18 (Id=239)
{
    union // Size=0x4 (Id=0)
    {
...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=470)
{
...
struct _KAPC_STATE// Size=0x30 (Id=444)
{
...
union _ULARGE_INTEGER// Size=0x8 (Id=68)
{
    unsigned long LowPart;// Offset=0x0 Size=0x4
    unsigned long HighPart;// Offset=0x4 Size=0x4
...
struct _KTIMER// Size=0x40 (Id=441)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=256)
{
...
struct _GROUP_AFFINITY// Size=0x10 (Id=246)
{
...
struct _KLOCK_ENTRY_LOCK_STATE// Size=0x10 (Id=431)
{
    union // Size=0x8 (Id=0)
    {
...
struct _KLOCK_ENTRY// Size=0x60 (Id=315)
{
...
struct _CLIENT_ID// Size=0x10 (Id=469)
{
    void * UniqueProcess;// Offset=0x0 Size=0x8
    void * UniqueThread;// Offset=0x8 Size=0x8
};

struct _KSEMAPHORE// Size=0x20 (Id=456)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=233)
{
...
struct _ETHREAD// Size=0x7c0 (Id=94)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long ClonedThread:1;// Offset=0x6c0 Size=0x4 BitOffset=0x2 BitSize=0x1
            unsigned long KeyedEventInUse:1;// Offset=0x6c0 Size=0x4 BitOffset=0x3 BitSize=0x1
            unsigned long SelfTerminate:1;// Offset=0x6c0 Size=0x4 BitOffset=0x4 BitSize=0x1
            unsigned long RespectIoPriority:1;// Offset=0x6c0 Size=0x4 BitOffset=0x5 BitSize=0x1
            unsigned long ReservedSameThreadPassiveFlags:26;// Offset=0x6c0 Size=0x4 BitOffset=0x6 BitSize=0x1a
        };
    };
    union // Size=0x4 (Id=0)
    {
    ...
    struct _ESILO * Silo;// Offset=0x7b8 Size=0x8
};
