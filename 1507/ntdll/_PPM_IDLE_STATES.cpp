...
struct _PROCESSOR_IDLE_CONSTRAINTS// Size=0x30 (Id=530)
{
...
struct _PROCESSOR_IDLE_PREPARE_INFO// Size=0x58 (Id=564)
{
...
struct _PPM_SELECTION_MENU// Size=0x10 (Id=586)
{
    unsigned long Count;// Offset=0x0 Size=0x4
    struct _PPM_SELECTION_MENU_ENTRY * Entries;// Offset=0x8 Size=0x8
};

struct _PPM_COORDINATED_SELECTION// Size=0x18 (Id=568)
{
...
struct _PPM_VETO_ACCOUNTING// Size=0x28 (Id=575)
{
...
struct _PPM_IDLE_STATE// Size=0xf8 (Id=520)
{
...
struct _PPM_IDLE_STATES// Size=0x418 (Id=401)
{
    ...
    struct _KAFFINITY_EX PrimaryProcessorMask;// Offset=0x38 Size=0xa8
    struct _KAFFINITY_EX SecondaryProcessorMask;// Offset=0xe0 Size=0xa8
    void  ( * IdlePrepare)(struct _PROCESSOR_IDLE_PREPARE_INFO * );// Offset=0x188 Size=0x8
    long  ( * IdlePreExecute)(void * ,unsigned long ,unsigned long ,unsigned long ,unsigned long * );// Offset=0x190 Size=0x8
    long  ( * IdleExecute)(void * ,unsigned long ,unsigned long ,unsigned long ,unsigned long ,unsigned long * );// Offset=0x198 Size=0x8
    unsigned long  ( * IdlePreselect)(void * ,struct _PROCESSOR_IDLE_CONSTRAINTS * );// Offset=0x1a0 Size=0x8
    unsigned long  ( * IdleTest)(void * ,unsigned long ,unsigned long );// Offset=0x1a8 Size=0x8
    unsigned long  ( * IdleAvailabilityCheck)(void * ,unsigned long );// Offset=0x1b0 Size=0x8
    void  ( * IdleComplete)(void * ,unsigned long ,unsigned long ,unsigned long ,unsigned long * );// Offset=0x1b8 Size=0x8
    void  ( * IdleCancel)(void * ,unsigned long );// Offset=0x1c0 Size=0x8
    unsigned char  ( * IdleIsHalted)(void * );// Offset=0x1c8 Size=0x8
    unsigned char  ( * IdleInitiateWake)(void * );// Offset=0x1d0 Size=0x8
    struct _PROCESSOR_IDLE_PREPARE_INFO PrepareInfo;// Offset=0x1d8 Size=0x58
    struct _KAFFINITY_EX DeepIdleSnapshot;// Offset=0x230 Size=0xa8
    struct _PERFINFO_PPM_STATE_SELECTION * Tracing;// Offset=0x2d8 Size=0x8
    struct _PERFINFO_PPM_STATE_SELECTION * CoordinatedTracing;// Offset=0x2e0 Size=0x8
    struct _PPM_SELECTION_MENU ProcessorMenu;// Offset=0x2e8 Size=0x10
    struct _PPM_SELECTION_MENU CoordinatedMenu;// Offset=0x2f8 Size=0x10
    struct _PPM_COORDINATED_SELECTION CoordinatedSelection;// Offset=0x308 Size=0x18
    struct _PPM_IDLE_STATE State[1];// Offset=0x320 Size=0xf8
};
