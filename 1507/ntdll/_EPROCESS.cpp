...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=376)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=52)
{
...
struct _KPROCESS// Size=0x2d8 (Id=53)
{
    ...
    unsigned long long UserDirectoryTableBase;// Offset=0x278 Size=0x8
    unsigned char AddressPolicy;// Offset=0x280 Size=0x1
    unsigned char Spare2[71];// Offset=0x281 Size=0x47
...
struct _EX_FAST_REF// Size=0x8 (Id=85)
{
    union // Size=0x8 (Id=0)
    {
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=467)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=330)
{
...
struct _MMSUPPORT// Size=0x100 (Id=259)
{
...
struct _ALPC_PROCESS_CONTEXT// Size=0x20 (Id=283)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=466)
{
    union // Size=0x1 (Id=0)
    {
...
struct _EPROCESS// Size=0x7b0 (Id=97)
{
    ...
    void * Session;// Offset=0x400 Size=0x8
    ...
    void * Wow64Process;// Offset=0x428 Size=0x8
    ...
    unsigned char ImageFileName[15];// Offset=0x448 Size=0xf
    unsigned char PriorityClass;// Offset=0x457 Size=0x1
    void * SecurityPort;// Offset=0x458 Size=0x8
    struct _SE_AUDIT_PROCESS_CREATION_INFO SeAuditProcessCreationInfo;// Offset=0x460 Size=0x8
    struct _LIST_ENTRY JobLinks;// Offset=0x468 Size=0x10
    void * HighestUserAddress;// Offset=0x478 Size=0x8
    struct _LIST_ENTRY ThreadListHead;// Offset=0x480 Size=0x10
    unsigned long ActiveThreads;// Offset=0x490 Size=0x4
    unsigned long ImagePathHash;// Offset=0x494 Size=0x4
    unsigned long DefaultHardErrorProcessing;// Offset=0x498 Size=0x4
    long LastThreadExitStatus;// Offset=0x49c Size=0x4
    struct _EX_FAST_REF PrefetchTrace;// Offset=0x4a0 Size=0x8
    void * LockedPagesList;// Offset=0x4a8 Size=0x8
    union _LARGE_INTEGER ReadOperationCount;// Offset=0x4b0 Size=0x8
    union _LARGE_INTEGER WriteOperationCount;// Offset=0x4b8 Size=0x8
    union _LARGE_INTEGER OtherOperationCount;// Offset=0x4c0 Size=0x8
    union _LARGE_INTEGER ReadTransferCount;// Offset=0x4c8 Size=0x8
    union _LARGE_INTEGER WriteTransferCount;// Offset=0x4d0 Size=0x8
    union _LARGE_INTEGER OtherTransferCount;// Offset=0x4d8 Size=0x8
    unsigned long long CommitChargeLimit;// Offset=0x4e0 Size=0x8
    unsigned long long CommitCharge;// Offset=0x4e8 Size=0x8
    unsigned long long CommitChargePeak;// Offset=0x4f0 Size=0x8
    struct _MMSUPPORT Vm;// Offset=0x4f8 Size=0x100
    struct _LIST_ENTRY MmProcessLinks;// Offset=0x5f8 Size=0x10
    struct _RTL_AVL_TREE VadRoot;// Offset=0x608 Size=0x8
    unsigned long ModifiedPageCount;// Offset=0x610 Size=0x4
    long ExitStatus;// Offset=0x614 Size=0x4
    void * VadHint;// Offset=0x618 Size=0x8
    unsigned long long VadCount;// Offset=0x620 Size=0x8
    unsigned long long VadPhysicalPages;// Offset=0x628 Size=0x8
    unsigned long long VadPhysicalPagesLimit;// Offset=0x630 Size=0x8
    struct _ALPC_PROCESS_CONTEXT AlpcContext;// Offset=0x638 Size=0x20
    struct _LIST_ENTRY TimerResolutionLink;// Offset=0x658 Size=0x10
    struct _PO_DIAG_STACK_RECORD * TimerResolutionStackRecord;// Offset=0x668 Size=0x8
    unsigned long RequestedTimerResolution;// Offset=0x670 Size=0x4
    unsigned long SmallestTimerResolution;// Offset=0x674 Size=0x4
    union _LARGE_INTEGER ExitTime;// Offset=0x678 Size=0x8
    struct _INVERTED_FUNCTION_TABLE * InvertedFunctionTable;// Offset=0x680 Size=0x8
    struct _EX_PUSH_LOCK InvertedFunctionTableLock;// Offset=0x688 Size=0x8
    unsigned long ActiveThreadsHighWatermark;// Offset=0x690 Size=0x4
    unsigned long LargePrivateVadCount;// Offset=0x694 Size=0x4
    struct _EX_PUSH_LOCK ThreadListLock;// Offset=0x698 Size=0x8
    void * WnfContext;// Offset=0x6a0 Size=0x8
    unsigned long long Spare0;// Offset=0x6a8 Size=0x8
    unsigned char SignatureLevel;// Offset=0x6b0 Size=0x1
    unsigned char SectionSignatureLevel;// Offset=0x6b1 Size=0x1
    struct _PS_PROTECTION Protection;// Offset=0x6b2 Size=0x1
    unsigned char HangCount;// Offset=0x6b3 Size=0x1
    union // Size=0x4 (Id=0)
    {
        unsigned long Flags3;// Offset=0x6b4 Size=0x4
        struct // Size=0x4 (Id=0)
        {
            unsigned long Minimal:1;// Offset=0x6b4 Size=0x4 BitOffset=0x0 BitSize=0x1
            unsigned long ReplacingPageRoot:1;// Offset=0x6b4 Size=0x4 BitOffset=0x1 BitSize=0x1
            unsigned long DisableNonSystemFonts:1;// Offset=0x6b4 Size=0x4 BitOffset=0x2 BitSize=0x1
            unsigned long AuditNonSystemFontLoading:1;// Offset=0x6b4 Size=0x4 BitOffset=0x3 BitSize=0x1
            unsigned long Crashed:1;// Offset=0x6b4 Size=0x4 BitOffset=0x4 BitSize=0x1
            unsigned long JobVadsAreTracked:1;// Offset=0x6b4 Size=0x4 BitOffset=0x5 BitSize=0x1
            unsigned long VadTrackingDisabled:1;// Offset=0x6b4 Size=0x4 BitOffset=0x6 BitSize=0x1
            unsigned long AuxiliaryProcess:1;// Offset=0x6b4 Size=0x4 BitOffset=0x7 BitSize=0x1
            unsigned long SubsystemProcess:1;// Offset=0x6b4 Size=0x4 BitOffset=0x8 BitSize=0x1
            unsigned long IndirectCpuSets:1;// Offset=0x6b4 Size=0x4 BitOffset=0x9 BitSize=0x1
            unsigned long InPrivate:1;// Offset=0x6b4 Size=0x4 BitOffset=0xa BitSize=0x1
            unsigned long AddressPolicyFrozen:1;// Offset=0x6b4 Size=0x4 BitOffset=0xb BitSize=0x1
            unsigned long RestrictIndirectBranchPrediction:1;// Offset=0x6b4 Size=0x4 BitOffset=0xc BitSize=0x1
            unsigned long SpeculativeStoreBypassDisable:1;// Offset=0x6b4 Size=0x4 BitOffset=0xd BitSize=0x1
        };
    };
    long DeviceAsid;// Offset=0x6b8 Size=0x4
    void * SvmData;// Offset=0x6c0 Size=0x8
    struct _EX_PUSH_LOCK SvmProcessLock;// Offset=0x6c8 Size=0x8
    unsigned long long SvmLock;// Offset=0x6d0 Size=0x8
    struct _LIST_ENTRY SvmProcessDeviceListHead;// Offset=0x6d8 Size=0x10
    unsigned long long LastFreezeInterruptTime;// Offset=0x6e8 Size=0x8
    struct _PROCESS_DISK_COUNTERS * DiskCounters;// Offset=0x6f0 Size=0x8
    void * PicoContext;// Offset=0x6f8 Size=0x8
    unsigned long long TrustletIdentity;// Offset=0x700 Size=0x8
    unsigned long KeepAliveCounter;// Offset=0x708 Size=0x4
    unsigned long NoWakeKeepAliveCounter;// Offset=0x70c Size=0x4
    unsigned long HighPriorityFaultsAllowed;// Offset=0x710 Size=0x4
    struct _PROCESS_ENERGY_VALUES * EnergyValues;// Offset=0x718 Size=0x8
    void * VmContext;// Offset=0x720 Size=0x8
    struct _ESILO * Silo;// Offset=0x728 Size=0x8
    struct _LIST_ENTRY SiloEntry;// Offset=0x730 Size=0x10
    ...
    unsigned long long SecurityDomain;// Offset=0x7a0 Size=0x8
    unsigned long * PathRedirectionHashes;// Offset=0x7a8 Size=0x8
};
