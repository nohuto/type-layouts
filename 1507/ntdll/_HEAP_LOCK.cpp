struct _RTL_CRITICAL_SECTION// Size=0x28 (Id=184)
{
...
union _unnamed_182// Size=0x28 (Id=182)
{
    struct _RTL_CRITICAL_SECTION CriticalSection;// Offset=0x0 Size=0x28
};

struct _HEAP_LOCK// Size=0x28 (Id=183)
{
    union _unnamed_182 Lock;// Offset=0x0 Size=0x28
};
