struct _unnamed_220// Size=0x18 (Id=220)
{
...
struct _RTL_HEAP_WALK_ENTRY// Size=0x30 (Id=222)
{
    ...
    {
        struct _unnamed_220 Block;// Offset=0x18 Size=0x18
        struct _unnamed_221 Segment;// Offset=0x18 Size=0x18
    };
};
