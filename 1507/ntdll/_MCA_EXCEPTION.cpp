...
union _unnamed_269// Size=0x20 (Id=269)
{
    union // Size=0x20 (Id=0)
    {
        struct _unnamed_267 Mca;// Offset=0x0 Size=0x20
        struct _unnamed_268 Mce;// Offset=0x0 Size=0x10
    };
};

struct _MCA_EXCEPTION// Size=0x100 (Id=270)
{
    ...
    union _unnamed_269 u;// Offset=0x18 Size=0x20
