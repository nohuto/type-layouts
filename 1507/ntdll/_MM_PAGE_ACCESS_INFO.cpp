struct _unnamed_261// Size=0x4 (Id=261)
{
...
struct _unnamed_262// Size=0x4 (Id=262)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long FilePointerIndex:9;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x9
...
union _MM_PAGE_ACCESS_INFO_FLAGS// Size=0x4 (Id=263)
{
    struct _unnamed_261 File;// Offset=0x0 Size=0x4
    struct _unnamed_262 Private;// Offset=0x0 Size=0x4
};

struct _MM_PAGE_ACCESS_INFO// Size=0x8 (Id=240)
{
    union // Size=0x8 (Id=0)
    {
