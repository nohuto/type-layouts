struct _NT_TIB// Size=0x38 (Id=271)
{
...
struct _KDESCRIPTOR// Size=0x10 (Id=572)
{
...
struct _KSPECIAL_REGISTERS// Size=0xe0 (Id=465)
{
...
struct _CONTEXT// Size=0x4d0 (Id=399)
{
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=435)
{
...
struct _KTIMER_TABLE_ENTRY// Size=0x20 (Id=291)
{
...
struct _KTIMER_TABLE// Size=0x2200 (Id=287)
{
...
struct _KGATE// Size=0x18 (Id=281)
{
...
struct _PROC_IDLE_POLICY// Size=0x6 (Id=489)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=500)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=349)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=487)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=374)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROCESSOR_POWER_STATE// Size=0x1d0 (Id=328)
{
    ...
    unsigned char Class;// Offset=0x32 Size=0x1
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=386)
{
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=250)
{
...
struct _IOP_IRP_STACK_PROFILER// Size=0x54 (Id=387)
{
    unsigned long Profile[20];// Offset=0x0 Size=0x50
    unsigned long TotalIrps;// Offset=0x50 Size=0x4
};

struct _KSHARED_READY_QUEUE// Size=0x260 (Id=232)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _KPRCB// Size=0x7ec0 (Id=40)
{
    ...
    unsigned long PrcbPad40;// Offset=0x2cc0 Size=0x4
    ...
    unsigned long long TrappedSecurityDomain;// Offset=0x2d28 Size=0x8
    union // Size=0x2 (Id=0)
    {
        unsigned short BpbState;// Offset=0x2d30 Size=0x2
        struct // Size=0x2 (Id=0)
        {
            unsigned short BpbCpuIdle:1;// Offset=0x2d30 Size=0x2 BitOffset=0x0 BitSize=0x1
            unsigned short BpbFlushRsbOnTrap:1;// Offset=0x2d30 Size=0x2 BitOffset=0x1 BitSize=0x1
            unsigned short BpbIbpbOnReturn:1;// Offset=0x2d30 Size=0x2 BitOffset=0x2 BitSize=0x1
            unsigned short BpbIbpbOnTrap:1;// Offset=0x2d30 Size=0x2 BitOffset=0x3 BitSize=0x1
            unsigned short BpbReserved1:1;// Offset=0x2d30 Size=0x2 BitOffset=0x4 BitSize=0x1
            unsigned short BpbFlushRsbOnReturn:1;// Offset=0x2d30 Size=0x2 BitOffset=0x5 BitSize=0x1
            unsigned short BpbDivideOnReturn:1;// Offset=0x2d30 Size=0x2 BitOffset=0x6 BitSize=0x1
            unsigned short VerwOnNonKvaReturn:1;// Offset=0x2d30 Size=0x2 BitOffset=0x7 BitSize=0x1
            unsigned short FlushBhbOnTrap:1;// Offset=0x2d30 Size=0x2 BitOffset=0x8 BitSize=0x1
            unsigned short Spare:7;// Offset=0x2d30 Size=0x2 BitOffset=0x9 BitSize=0x7
        };
    };
    union // Size=0x1 (Id=0)
    {
        unsigned char BpbFeatures;// Offset=0x2d32 Size=0x1
        struct // Size=0x1 (Id=0)
        {
            unsigned char BpbClearOnIdle:1;// Offset=0x2d32 Size=0x1 BitOffset=0x0 BitSize=0x1
            unsigned char BpbEnabled:1;// Offset=0x2d32 Size=0x1 BitOffset=0x1 BitSize=0x1
            unsigned char BpbSmep:1;// Offset=0x2d32 Size=0x1 BitOffset=0x2 BitSize=0x1
            unsigned char BhbFlushSequence:2;// Offset=0x2d32 Size=0x1 BitOffset=0x3 BitSize=0x2
            unsigned char VerwOnIdle:1;// Offset=0x2d32 Size=0x1 BitOffset=0x5 BitSize=0x1
            unsigned char BpbFeaturesReserved:2;// Offset=0x2d32 Size=0x1 BitOffset=0x6 BitSize=0x2
        };
    };
    unsigned char BpbPad1[1];// Offset=0x2d33 Size=0x1
    unsigned short BpbCurrentSpecCtrl;// Offset=0x2d34 Size=0x2
    unsigned short BpbKernelSpecCtrl;// Offset=0x2d36 Size=0x2
    unsigned short BpbNmiSpecCtrl;// Offset=0x2d38 Size=0x2
    unsigned short BpbUserSpecCtrl;// Offset=0x2d3a Size=0x2
    unsigned char BpbPad[4];// Offset=0x2d3c Size=0x4
    ...
    unsigned long PrcbPad70[1];// Offset=0x5874 Size=0x4
    ...
    unsigned long PrcbPad81[29];// Offset=0x5b68 Size=0x74
    ...
    unsigned long long PrcbPad94[11];// Offset=0x6128 Size=0x58
    ...
    unsigned long long PrcbPad130[183];// Offset=0x68c8 Size=0x5b8
...
struct _KPCR// Size=0x8040 (Id=39)
{
