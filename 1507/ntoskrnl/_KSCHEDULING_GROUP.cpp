struct _KSCHEDULING_GROUP_POLICY// Size=0x8 (Id=1377)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KSCB// Size=0x198 (Id=1128)
{
    ...
    struct // Size=0x1 (Id=0)
    {
        ...
        unsigned char Spare1:3;// Offset=0x70 Size=0x1 BitOffset=0x5 BitSize=0x3
    };
    ...
    struct _LIST_ENTRY ReadyListHead[16];// Offset=0x78 Size=0x100
    struct _RTL_RB_TREE ChildScbQueue;// Offset=0x178 Size=0x10
    struct _KSCB * Parent;// Offset=0x188 Size=0x8
    struct _KSCB * Root;// Offset=0x190 Size=0x8
};

struct _KSCHEDULING_GROUP// Size=0x240 (Id=893)
{
    ...
    union // Size=0x10 (Id=0)
    {
        struct _LIST_ENTRY SchedulingGroupList;// Offset=0x28 Size=0x10
        struct _LIST_ENTRY Sibling;// Offset=0x28 Size=0x10
    };
    struct _KDPC * NotificationDpc;// Offset=0x38 Size=0x8
    struct _LIST_ENTRY ChildList;// Offset=0x40 Size=0x10
    struct _KSCHEDULING_GROUP * Parent;// Offset=0x50 Size=0x8
    struct _KSCB PerProcessor[1];// Offset=0x80 Size=0x198
};
