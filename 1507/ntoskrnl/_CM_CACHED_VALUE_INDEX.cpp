...
struct _CM_KEY_VALUE// Size=0x18 (Id=1006)
{
    unsigned short Signature;// Offset=0x0 Size=0x2
...
struct _SECURITY_DESCRIPTOR_RELATIVE// Size=0x14 (Id=1368)
{
...
struct _CM_KEY_SECURITY// Size=0x28 (Id=1427)
{
    unsigned short Signature;// Offset=0x0 Size=0x2
...
struct _CM_KEY_INDEX// Size=0x8 (Id=1214)
{
    unsigned short Signature;// Offset=0x0 Size=0x2
...
struct _CM_BIG_DATA// Size=0x8 (Id=1127)
{
    unsigned short Signature;// Offset=0x0 Size=0x2
    unsigned short Count;// Offset=0x2 Size=0x2
    unsigned long List;// Offset=0x4 Size=0x4
...
struct _CELL_DATA// Size=0x50 (Id=510)
{
    union _u u;// Offset=0x0 Size=0x50
};

union _unnamed_924// Size=0x50 (Id=924)
{
    union // Size=0x50 (Id=0)
    {
...
struct _CM_CACHED_VALUE_INDEX// Size=0x58 (Id=925)
{
    unsigned long CellIndex;// Offset=0x0 Size=0x4
    union _unnamed_924 Data;// Offset=0x8 Size=0x50
};
