...
struct _ALPC_PORT_ATTRIBUTES// Size=0x48 (Id=483)
{
...
struct _unnamed_405// Size=0x4 (Id=405)
{
...
union _unnamed_406// Size=0x4 (Id=406)
{
    struct _unnamed_405 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

struct _ALPC_PORT// Size=0x1d8 (Id=407)
{
    ...
    union _unnamed_406 u1;// Offset=0x1a0 Size=0x4
