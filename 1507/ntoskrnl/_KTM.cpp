...
struct _RTL_AVL_TABLE// Size=0x68 (Id=1453)
{
...
struct _KTMOBJECT_NAMESPACE// Size=0xa8 (Id=1282)
{
...
struct _unnamed_1373// Size=0x8 (Id=1373)
{
    unsigned int idxRecord;// Offset=0x0 Size=0x4
    unsigned long cidContainer;// Offset=0x4 Size=0x4
};

union _CLS_LSN// Size=0x8 (Id=1374)
{
    struct _unnamed_1373 offset;// Offset=0x0 Size=0x8
...
struct _KTM// Size=0x3c0 (Id=1250)
{
