...
struct _IOP_IRP_EXTENSION// Size=0x30 (Id=427)
{
    union // Size=0x2 (Id=0)
    {
    ...
    union // Size=0x24 (Id=0)
    {
        ...
        struct _IO_IRP_EXT_TRACK_OFFSET_HEADER * FsTrackOffsetBlob;// Offset=0x20 Size=0x8
    };
    long long FsTrackedOffset;// Offset=0x28 Size=0x8
};
