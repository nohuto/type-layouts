union _MI_FLAGS// Size=0x4 (Id=602)
{
    ...
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long ZeroNonCachedByConverting:1;// Offset=0x0 Size=0x4 BitOffset=0xd BitSize=0x1
        unsigned long ZeroWriteCombinedByConverting:1;// Offset=0x0 Size=0x4 BitOffset=0xe BitSize=0x1
        unsigned long ProtectedPagesEnabled:1;// Offset=0x0 Size=0x4 BitOffset=0xf BitSize=0x1
        unsigned long StrongCodeGuarantees:2;// Offset=0x0 Size=0x4 BitOffset=0x10 BitSize=0x2
        unsigned long HardCodeGuarantees:1;// Offset=0x0 Size=0x4 BitOffset=0x12 BitSize=0x1
        unsigned long StrongPageIdentity:1;// Offset=0x0 Size=0x4 BitOffset=0x13 BitSize=0x1
        unsigned long SecureRelocations:1;// Offset=0x0 Size=0x4 BitOffset=0x14 BitSize=0x1
        unsigned long KvaShadow:2;// Offset=0x0 Size=0x4 BitOffset=0x15 BitSize=0x2
    };
};

struct _MI_TRIAGE_DUMP_DATA// Size=0x38 (Id=945)
{
