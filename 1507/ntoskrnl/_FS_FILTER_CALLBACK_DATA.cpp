...
struct _unnamed_1332// Size=0x10 (Id=1332)
{
...
struct _unnamed_1334// Size=0x10 (Id=1334)
{
...
struct _unnamed_1335// Size=0x28 (Id=1335)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=1336)
{
    struct _unnamed_1329 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_1330 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_1332 AcquireForSectionSynchronization;// Offset=0x0 Size=0x10
    struct _unnamed_1334 NotifyStreamFileObject;// Offset=0x0 Size=0x10
    struct _unnamed_1335 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=1014)
{
