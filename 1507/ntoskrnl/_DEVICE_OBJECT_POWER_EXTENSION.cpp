...
struct _unnamed_934// Size=0x8 (Id=934)
{
    unsigned long IdleTime;// Offset=0x0 Size=0x4
    unsigned long NonIdleTime;// Offset=0x4 Size=0x4
};

union _unnamed_935// Size=0x8 (Id=935)
{
    struct _unnamed_934 Disk;// Offset=0x0 Size=0x8
};

struct _DEVICE_OBJECT_POWER_EXTENSION// Size=0x60 (Id=936)
{
    ...
    union _unnamed_935 Specific;// Offset=0x58 Size=0x8
};
