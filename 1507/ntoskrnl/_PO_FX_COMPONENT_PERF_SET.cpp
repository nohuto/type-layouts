...
struct _PO_FX_COMPONENT_PERF_SET// Size=0x30 (Id=1413)
{
    ...
    {
        struct _unnamed_1411 Discrete;// Offset=0x20 Size=0x10
        struct _unnamed_1412 Range;// Offset=0x20 Size=0x10
    };
};
