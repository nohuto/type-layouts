...
union _unnamed_414// Size=0x4 (Id=414)
{
    struct _unnamed_413 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

union _KALPC_DIRECT_EVENT// Size=0x8 (Id=424)
{
...
struct _KALPC_MESSAGE_ATTRIBUTES// Size=0x40 (Id=420)
{
...
struct _PORT_MESSAGE// Size=0x28 (Id=386)
{
...
struct _KALPC_MESSAGE// Size=0x108 (Id=415)
{
    ...
    union _unnamed_414 u1;// Offset=0x28 Size=0x4
    ...
    struct _KALPC_MESSAGE_ATTRIBUTES MessageAttributes;// Offset=0x68 Size=0x40
    void * DataUserVa;// Offset=0xa8 Size=0x8
    struct _ALPC_COMMUNICATION_INFO * CommunicationInfo;// Offset=0xb0 Size=0x8
    struct _ALPC_PORT * ConnectionPort;// Offset=0xb8 Size=0x8
    struct _ETHREAD * ServerThread;// Offset=0xc0 Size=0x8
    void * WakeReference;// Offset=0xc8 Size=0x8
    void * ExtensionBuffer;// Offset=0xd0 Size=0x8
    unsigned long long ExtensionBufferSize;// Offset=0xd8 Size=0x8
    struct _PORT_MESSAGE PortMessage;// Offset=0xe0 Size=0x28
};
