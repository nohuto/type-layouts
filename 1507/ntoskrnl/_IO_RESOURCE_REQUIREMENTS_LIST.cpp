...
struct _unnamed_751// Size=0x18 (Id=751)
{
...
struct _unnamed_753// Size=0x18 (Id=753)
{
...
struct _unnamed_755// Size=0x10 (Id=755)
{
...
struct _unnamed_757// Size=0x10 (Id=757)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_758// Size=0xc (Id=758)
{
...
struct _unnamed_759// Size=0x18 (Id=759)
{
...
struct _unnamed_760// Size=0x18 (Id=760)
{
...
struct _unnamed_761// Size=0x18 (Id=761)
{
...
union _unnamed_763// Size=0x18 (Id=763)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_751 Port;// Offset=0x0 Size=0x18
        struct _unnamed_751 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_753 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_754 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_755 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_751 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_756 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_757 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_758 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_759 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_760 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_761 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_762 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=764)
{
    ...
    union _unnamed_763 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=968)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=292)
{
