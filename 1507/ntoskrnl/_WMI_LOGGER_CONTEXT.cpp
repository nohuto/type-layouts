...
struct _ETW_BUFFER_QUEUE// Size=0x18 (Id=1105)
{
...
struct _ETW_REF_CLOCK// Size=0x10 (Id=894)
{
...
struct _DISALLOWED_GUIDS// Size=0x10 (Id=788)
{
    unsigned short Count;// Offset=0x0 Size=0x2
    struct _GUID * Guids;// Offset=0x8 Size=0x8
};

struct _WMI_LOGGER_CONTEXT// Size=0x398 (Id=445)
{
    ...
    struct _ETW_BUFFER_QUEUE BufferQueue;// Offset=0x40 Size=0x18
    struct _ETW_BUFFER_QUEUE OverflowQueue;// Offset=0x58 Size=0x18
    struct _LIST_ENTRY GlobalList;// Offset=0x70 Size=0x10
    struct _LIST_ENTRY ProviderBinaryList;// Offset=0x80 Size=0x10
    union // Size=0x8 (Id=0)
    {
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long SpareFlags1:1;// Offset=0x340 Size=0x4 BitOffset=0xf BitSize=0x1
    ...
    struct _RTL_BITMAP HookIdMap;// Offset=0x348 Size=0x10
    struct _ETW_STACK_CACHE * StackCache;// Offset=0x358 Size=0x8
    struct _ETW_PMC_SUPPORT * PmcData;// Offset=0x360 Size=0x8
    struct _LIST_ENTRY WinRtProviderBinaryList;// Offset=0x368 Size=0x10
    struct _WMI_BUFFER_HEADER ** ScratchArray;// Offset=0x378 Size=0x8
    struct _DISALLOWED_GUIDS DisallowedGuids;// Offset=0x380 Size=0x10
    struct _ESILO * ServerSilo;// Offset=0x390 Size=0x8
};
