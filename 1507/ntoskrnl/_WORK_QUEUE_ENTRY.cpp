...
struct _unnamed_358// Size=0x8 (Id=358)
{
...
struct _unnamed_360// Size=0x8 (Id=360)
{
    struct _KEVENT * Event;// Offset=0x0 Size=0x8
};

struct _unnamed_361// Size=0x4 (Id=361)
{
...
struct _unnamed_362// Size=0x30 (Id=362)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
union _unnamed_364// Size=0x58 (Id=364)
{
    struct _unnamed_358 Read;// Offset=0x0 Size=0x8
    struct _unnamed_359 Write;// Offset=0x0 Size=0x8
    struct _unnamed_360 Event;// Offset=0x0 Size=0x8
    struct _unnamed_361 Notification;// Offset=0x0 Size=0x4
    struct _unnamed_362 LowPriWrite;// Offset=0x0 Size=0x30
    struct _unnamed_363 AsyncRead;// Offset=0x0 Size=0x58
};

struct _WORK_QUEUE_ENTRY// Size=0x70 (Id=365)
{
    struct _LIST_ENTRY WorkQueueLinks;// Offset=0x0 Size=0x10
    union _unnamed_364 Parameters;// Offset=0x10 Size=0x58
