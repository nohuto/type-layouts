...
struct _MMPAGE_FILE_EXPANSION_FLAGS// Size=0x4 (Id=1407)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MMPAGE_FILE_EXPANSION// Size=0x60 (Id=1062)
{
...
struct _MMMOD_WRITER_LISTHEAD// Size=0x28 (Id=1069)
{
...
union _MI_RESERVATION_CLUSTER_INFO// Size=0x4 (Id=1252)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_MODWRITE_DATA// Size=0x40 (Id=1253)
{
...
struct _MI_PARTITION_MODWRITES// Size=0x2a0 (Id=880)
{
    ...
    long WriteAllPagefilePages;// Offset=0x150 Size=0x4
    long WriteAllMappedPages;// Offset=0x154 Size=0x4
    struct _KEVENT MappedPageWriterEvent;// Offset=0x158 Size=0x18
    struct _MI_MODWRITE_DATA ModWriteData;// Offset=0x170 Size=0x40
    struct _KEVENT RescanPageFilesEvent;// Offset=0x1b0 Size=0x18
    struct _MMMOD_WRITER_LISTHEAD PagingFileHeader;// Offset=0x1c8 Size=0x28
    struct _ETHREAD * ModifiedPageWriterThread;// Offset=0x1f0 Size=0x8
    struct _EX_RUNDOWN_REF ModifiedPageWriterRundown;// Offset=0x1f8 Size=0x8
    struct _WORK_QUEUE_ITEM PagefileScanWorkItem;// Offset=0x200 Size=0x20
    unsigned long PagefileScanCount;// Offset=0x220 Size=0x4
    long ClusterWritesDisabled[2];// Offset=0x224 Size=0x8
    unsigned char DelayMappedWrite;// Offset=0x22c Size=0x1
    unsigned long PagefileReservationsEnabled;// Offset=0x230 Size=0x4
    struct _EX_PUSH_LOCK PageFileCreationLock;// Offset=0x238 Size=0x8
    struct _WORK_QUEUE_ITEM TrimPagefileWorkItem;// Offset=0x240 Size=0x20
    unsigned long long LastTrimPagefileTime;// Offset=0x260 Size=0x8
    struct _WORK_QUEUE_ITEM WsSwapPagefileContractWorkItem;// Offset=0x268 Size=0x20
    long WsSwapPageFileContractionInProgress;// Offset=0x288 Size=0x4
    struct _EX_PUSH_LOCK WorkingSetSwapLock;// Offset=0x290 Size=0x8
    long WorkingSetInswapLock;// Offset=0x298 Size=0x4
};
...
struct _MI_PARTITION_STORES// Size=0x80 (Id=987)
{
    union _unnamed_986 WriteAllStoreHintedPages;// Offset=0x0 Size=0x4
...
struct _MMDEREFERENCE_SEGMENT_HEADER// Size=0x30 (Id=944)
{
...
struct _MI_PARTITION_SEGMENTS// Size=0x110 (Id=484)
{
...
struct _MI_PARTITION_COMMIT// Size=0x38 (Id=658)
{
...
struct _MI_PARTITION_ZEROING// Size=0x48 (Id=1134)
{
...
struct _MMWORKING_SET_EXPANSION_HEAD// Size=0x10 (Id=898)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
};
...
struct _unnamed_1089// Size=0x38 (Id=1089)
{
    struct _MDL Mdl;// Offset=0x0 Size=0x30
    unsigned long long Page[1];// Offset=0x30 Size=0x8
};

struct _MI_PAGEFILE_TRACES// Size=0x78 (Id=1090)
{
    ...
    struct _unnamed_1089 MdlHack;// Offset=0x40 Size=0x38
};

struct _MI_VISIBLE_PARTITION// Size=0x1100 (Id=498)
{
...
struct _MI_PARTITION// Size=0x25c0 (Id=224)
{
    struct _MI_PARTITION_CORE Core;// Offset=0x0 Size=0x168
    struct _MI_PARTITION_MODWRITES Modwriter;// Offset=0x168 Size=0x2a0
    struct _MI_PARTITION_STORES Store;// Offset=0x410 Size=0x80
    struct _MI_PARTITION_SEGMENTS Segments;// Offset=0x490 Size=0x110
    struct _MI_PARTITION_PAGE_LISTS PageLists;// Offset=0x5c0 Size=0xcc0
    struct _MI_PARTITION_COMMIT Commit;// Offset=0x1280 Size=0x38
    struct _MI_PARTITION_ZEROING Zeroing;// Offset=0x12b8 Size=0x48
    struct _MI_PAGE_COMBINING_SUPPORT PageCombine;// Offset=0x1300 Size=0x188
    void * WorkingSetControl;// Offset=0x1488 Size=0x8
    struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;// Offset=0x1490 Size=0x10
    struct _MI_VISIBLE_PARTITION Vp;// Offset=0x14c0 Size=0x1100
};
