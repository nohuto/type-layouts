...
union _unnamed_395// Size=0x4 (Id=395)
{
    struct _unnamed_394 s1;// Offset=0x0 Size=0x4
};
...
struct _KALPC_SECTION// Size=0x48 (Id=396)
{
    ...
    union _unnamed_395 u1;// Offset=0x30 Size=0x4
