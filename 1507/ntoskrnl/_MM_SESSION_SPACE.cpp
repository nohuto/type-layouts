struct _MM_SESSION_SPACE_FLAGS// Size=0x4 (Id=1398)
{
...
union _unnamed_1059// Size=0x4 (Id=1059)
{
...
struct _POOL_DESCRIPTOR// Size=0x1140 (Id=567)
{
...
struct _MM_SESSION_SPACE// Size=0x1f40 (Id=1061)
{
    long ReferenceCount;// Offset=0x0 Size=0x4
    union _unnamed_1059 u;// Offset=0x4 Size=0x4
    ...
    struct _ESILO * ServerSilo;// Offset=0x1f30 Size=0x8
