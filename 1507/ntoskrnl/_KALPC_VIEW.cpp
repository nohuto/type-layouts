...
union _unnamed_401// Size=0x4 (Id=401)
{
    struct _unnamed_400 s1;// Offset=0x0 Size=0x4
};

struct _KALPC_VIEW// Size=0x60 (Id=402)
{
    ...
    union _unnamed_401 u1;// Offset=0x48 Size=0x4
