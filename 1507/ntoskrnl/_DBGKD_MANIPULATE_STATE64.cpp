struct _DBGKD_READ_MEMORY64// Size=0x10 (Id=301)
{
...
struct _DBGKD_WRITE_MEMORY64// Size=0x10 (Id=303)
{
    unsigned long long TargetBaseAddress;// Offset=0x0 Size=0x8
    unsigned long TransferCount;// Offset=0x8 Size=0x4
...
struct _X86_DBGKD_CONTROL_SET// Size=0x10 (Id=1093)
{
    unsigned long TraceFlag;// Offset=0x0 Size=0x4
...
struct _IA64_DBGKD_CONTROL_SET// Size=0x14 (Id=954)
{
...
struct _ARM_DBGKD_CONTROL_SET// Size=0xc (Id=480)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
...
struct _ARM64_DBGKD_CONTROL_SET// Size=0x18 (Id=529)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
...
struct _ARMCE_DBGKD_CONTROL_SET// Size=0xc (Id=969)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
    unsigned long CurrentSymbolStart;// Offset=0x4 Size=0x4
    unsigned long CurrentSymbolEnd;// Offset=0x8 Size=0x4
...
struct _PPC_DBGKD_CONTROL_SET// Size=0xc (Id=674)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
    unsigned long CurrentSymbolStart;// Offset=0x4 Size=0x4
    unsigned long CurrentSymbolEnd;// Offset=0x8 Size=0x4
...
struct _DBGKD_ANY_CONTROL_SET// Size=0x1c (Id=477)
{
...
struct _DBGKD_CONTINUE2// Size=0x20 (Id=326)
{
    long ContinueStatus;// Offset=0x0 Size=0x4
    union // Size=0x1c (Id=0)
    {
...
struct _DBGKD_READ_WRITE_IO64// Size=0x10 (Id=307)
{
...
struct _DBGKD_READ_WRITE_IO_EXTENDED64// Size=0x20 (Id=309)
{
...
struct _DBGKD_QUERY_SPECIAL_CALLS// Size=0x4 (Id=927)
{
    unsigned long NumberOfSpecialCalls;// Offset=0x0 Size=0x4
};

struct _DBGKD_SET_SPECIAL_CALL64// Size=0x8 (Id=312)
{
    unsigned long long SpecialCall;// Offset=0x0 Size=0x8
};

struct _DBGKD_SET_INTERNAL_BREAKPOINT64// Size=0x10 (Id=314)
{
    unsigned long long BreakpointAddress;// Offset=0x0 Size=0x8
    unsigned long Flags;// Offset=0x8 Size=0x4
};

struct _DBGKD_GET_INTERNAL_BREAKPOINT64// Size=0x20 (Id=315)
{
    unsigned long long BreakpointAddress;// Offset=0x0 Size=0x8
    unsigned long Flags;// Offset=0x8 Size=0x4
...
struct _DBGKD_GET_VERSION64// Size=0x28 (Id=1159)
{
...
struct _DBGKD_SEARCH_MEMORY// Size=0x18 (Id=323)
{
    union // Size=0x8 (Id=0)
    {
...
struct _DBGKD_GET_SET_BUS_DATA// Size=0x14 (Id=1084)
{
...
struct _DBGKD_FILL_MEMORY// Size=0x10 (Id=624)
{
...
struct _DBGKD_QUERY_MEMORY// Size=0x18 (Id=682)
{
    unsigned long long Address;// Offset=0x0 Size=0x8
...
struct _DBGKD_SWITCH_PARTITION// Size=0x4 (Id=857)
{
    unsigned long Partition;// Offset=0x0 Size=0x4
};

struct _DBGKD_CONTEXT_EX// Size=0xc (Id=726)
{
...
struct _DBGKD_WRITE_CUSTOM_BREAKPOINT// Size=0x18 (Id=844)
{
    unsigned long long BreakPointAddress;// Offset=0x0 Size=0x8
...
union _unnamed_317// Size=0x28 (Id=317)
{
...
struct _DBGKD_MANIPULATE_STATE64// Size=0x38 (Id=318)
{
    ...
    union _unnamed_317 u;// Offset=0x10 Size=0x28
};
