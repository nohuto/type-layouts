...
struct _PROC_IDLE_STATE_ACCOUNTING// Size=0x3d8 (Id=1019)
{
    unsigned long long TotalTime;// Offset=0x0 Size=0x8
    ...
    struct _PPM_SELECTION_STATISTICS SelectionStatistics;// Offset=0x28 Size=0x70
    struct _PROC_IDLE_STATE_BUCKET IdleTimeBuckets[26];// Offset=0x98 Size=0x340
};

struct _PROC_IDLE_ACCOUNTING// Size=0x400 (Id=698)
{
    ...
    struct _PROC_IDLE_STATE_ACCOUNTING State[1];// Offset=0x28 Size=0x3d8
};
