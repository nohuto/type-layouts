...
struct _DUMP_INITIALIZATION_CONTEXT// Size=0x108 (Id=1420)
{
    ...
    union _unnamed_1418 DiskInfo;// Offset=0x8c Size=0x10
...
struct _DUMP_STACK_CONTEXT// Size=0x178 (Id=1361)
{
    ...
    unsigned short * ModulePrefix;// Offset=0x120 Size=0x8
