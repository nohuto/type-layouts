...
struct _IO_DRIVER_CREATE_CONTEXT// Size=0x20 (Id=153)
{
...
struct _OPEN_PACKET// Size=0xb8 (Id=438)
{
    ...
    enum _CREATE_FILE_TYPE CreateFileType;// Offset=0x70 Size=0x4
    void * MailslotOrPipeParameters;// Offset=0x78 Size=0x8
    unsigned char Override;// Offset=0x80 Size=0x1
    unsigned char QueryOnly;// Offset=0x81 Size=0x1
    unsigned char DeleteOnly;// Offset=0x82 Size=0x1
    unsigned char FullAttributes;// Offset=0x83 Size=0x1
    struct _DUMMY_FILE_OBJECT * LocalFileObject;// Offset=0x88 Size=0x8
    unsigned long InternalFlags;// Offset=0x90 Size=0x4
    char AccessMode;// Offset=0x94 Size=0x1
    struct _IO_DRIVER_CREATE_CONTEXT DriverCreateContext;// Offset=0x98 Size=0x20
};
