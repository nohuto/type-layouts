...
struct _unnamed_1004// Size=0x18 (Id=1004)
{
...
struct _POP_POWER_ACTION// Size=0x108 (Id=1005)
{
    ...
    struct _unnamed_1004 WakeAlarm[3];// Offset=0x60 Size=0x48
    unsigned char WakeAlarmPaused;// Offset=0xa8 Size=0x1
    unsigned long long WakeAlarmLastTime;// Offset=0xb0 Size=0x8
    struct SYSTEM_POWER_CAPABILITIES FilteredCapabilities;// Offset=0xb8 Size=0x4c
};
