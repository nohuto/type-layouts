struct _PPM_SELECTION_STATISTICS// Size=0x70 (Id=1338)
{
...
struct _PROC_IDLE_STATE_BUCKET// Size=0x20 (Id=1275)
{
...
struct _PLATFORM_IDLE_STATE_ACCOUNTING// Size=0x3e0 (Id=1254)
{
    ...
    struct _PPM_SELECTION_STATISTICS SelectionStatistics;// Offset=0x30 Size=0x70
    struct _PROC_IDLE_STATE_BUCKET IdleTimeBuckets[26];// Offset=0xa0 Size=0x340
};

struct _PLATFORM_IDLE_ACCOUNTING// Size=0x3f8 (Id=1168)
{
    unsigned long ResetCount;// Offset=0x0 Size=0x4
    unsigned long StateCount;// Offset=0x4 Size=0x4
    enum PPM_IDLE_BUCKET_TIME_TYPE TimeUnit;// Offset=0x8 Size=0x4
    unsigned long long StartTime;// Offset=0x10 Size=0x8
    struct _PLATFORM_IDLE_STATE_ACCOUNTING State[1];// Offset=0x18 Size=0x3e0
};
