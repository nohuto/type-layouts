...
struct _unnamed_1446// Size=0x8 (Id=1446)
{
...
union _unnamed_1447// Size=0x8 (Id=1447)
{
    union _ULARGE_INTEGER RemappedFormat;// Offset=0x0 Size=0x8
    struct _unnamed_1446 Msi;// Offset=0x0 Size=0x8
};

struct _INTERRUPT_REMAPPING_INFO// Size=0x10 (Id=1448)
{
    ...
    union _unnamed_1447 u;// Offset=0x8 Size=0x8
};

struct _unnamed_1401// Size=0x8 (Id=1401)
{
...
union _unnamed_1437// Size=0x4 (Id=1437)
{
    struct _unnamed_1436 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _unnamed_1438// Size=0x4 (Id=1438)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1439// Size=0x4 (Id=1439)
{
    struct _unnamed_1438 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_HT_INTR_INFO// Size=0x8 (Id=1440)
{
    union _unnamed_1437 LowPart;// Offset=0x0 Size=0x4
    union _unnamed_1439 HighPart;// Offset=0x4 Size=0x4
};

struct _unnamed_1403// Size=0x8 (Id=1403)
{
    struct _INTERRUPT_HT_INTR_INFO IntrInfo;// Offset=0x0 Size=0x8
};

struct _unnamed_1405// Size=0x4 (Id=1405)
{
    enum HAL_APIC_DESTINATION_MODE DestinationMode;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_VECTOR_DATA// Size=0x50 (Id=1406)
{
    ...
    struct _unnamed_1401 ControllerInput;// Offset=0x38 Size=0x8
    union // Size=0x50 (Id=0)
    {
        struct _unnamed_1402 XapicMessage;// Offset=0x40 Size=0x10
        struct _unnamed_1403 Hypertransport;// Offset=0x40 Size=0x8
        struct _unnamed_1402 GenericMessage;// Offset=0x40 Size=0x10
        struct _unnamed_1405 MessageRequest;// Offset=0x40 Size=0x4
    };
};

struct _INTERRUPT_CONNECTION_DATA// Size=0x58 (Id=1194)
{
