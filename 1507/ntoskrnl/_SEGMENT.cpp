struct _SEGMENT_FLAGS// Size=0x4 (Id=515)
{
    union // Size=0x2 (Id=0)
    {
    ...
    union // Size=0x1 (Id=0)
    {
        ...
        {
            unsigned char FloppyMedia:1;// Offset=0x2 Size=0x1 BitOffset=0x0 BitSize=0x1
...
struct _SEGMENT// Size=0x48 (Id=215)
{
    ...
    union _unnamed_213 u1;// Offset=0x30 Size=0x8
    union _unnamed_214 u2;// Offset=0x38 Size=0x8
