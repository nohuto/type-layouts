union _KIDTENTRY64// Size=0x10 (Id=1027)
{
...
struct _KTSS64// Size=0x68 (Id=815)
{
...
union _KGDTENTRY64// Size=0x10 (Id=272)
{
    unsigned short LimitLow;// Offset=0x0 Size=0x2
    unsigned short BaseLow;// Offset=0x2 Size=0x2
    union // Size=0x4 (Id=0)
    {
        struct _unnamed_270 Bytes;// Offset=0x4 Size=0x4
        struct _unnamed_271 Bits;// Offset=0x4 Size=0x4
    };
...
struct _unnamed_938// Size=0x4 (Id=938)
{
...
struct _unnamed_939// Size=0x4 (Id=939)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_940// Size=0x4 (Id=940)
{
    struct _unnamed_938 Bytes;// Offset=0x0 Size=0x4
    struct _unnamed_939 Bits;// Offset=0x0 Size=0x4
};

struct _KLDTENTRY// Size=0x8 (Id=941)
{
    unsigned short LimitLow;// Offset=0x0 Size=0x2
    unsigned short BaseLow;// Offset=0x2 Size=0x2
    union _unnamed_940 HighWord;// Offset=0x4 Size=0x4
};

struct _KIST_BASE_FRAME// Size=0x20 (Id=1289)
{
...
struct _KTRANSITION_STACK// Size=0x200 (Id=274)
{
...
struct _KPROCESSOR_DESCRIPTOR_AREA// Size=0x5000 (Id=273)
{
