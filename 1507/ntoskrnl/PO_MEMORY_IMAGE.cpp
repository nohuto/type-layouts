...
struct _PO_HIBER_PERF// Size=0x1e0 (Id=1383)
{
...
struct PO_MEMORY_IMAGE// Size=0x3b0 (Id=1379)
{
    ...
    unsigned char Feature_HibernateRelaxVBSPolicy_Enabled;// Offset=0x3ac Size=0x1
};
