struct _HEAP_UNPACKED_ENTRY// Size=0x10 (Id=487)
{
...
struct _HEAP_EXTENDED_ENTRY// Size=0x10 (Id=840)
{
...
struct _HEAP_ENTRY// Size=0x10 (Id=377)
{
    union // Size=0x10 (Id=0)
    {
...
struct _HEAP_SEGMENT// Size=0x70 (Id=378)
{
...
struct _HEAP_COUNTERS// Size=0x78 (Id=494)
{
...
struct _HEAP// Size=0x298 (Id=374)
{
    ...
    void * FrontEndHeap;// Offset=0x170 Size=0x8
    unsigned short FrontHeapLockCount;// Offset=0x178 Size=0x2
    unsigned char FrontEndHeapType;// Offset=0x17a Size=0x1
    unsigned char RequestedFrontEndHeapType;// Offset=0x17b Size=0x1
    unsigned short * FrontEndHeapUsageData;// Offset=0x180 Size=0x8
    unsigned short FrontEndHeapMaximumIndex;// Offset=0x188 Size=0x2
    unsigned char FrontEndHeapStatusBitmap[129];// Offset=0x18a Size=0x81
    struct _HEAP_COUNTERS Counters;// Offset=0x210 Size=0x78
    struct _HEAP_TUNING_PARAMETERS TuningParameters;// Offset=0x288 Size=0x10
};
