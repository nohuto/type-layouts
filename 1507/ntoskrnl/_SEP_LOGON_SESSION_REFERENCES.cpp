...
struct _SEP_LOWBOX_HANDLES_TABLE// Size=0x10 (Id=1118)
{
...
struct _OB_HANDLE_REVOCATION_BLOCK// Size=0x20 (Id=499)
{
...
struct _SEP_LOGON_SESSION_REFERENCES// Size=0xa8 (Id=456)
{
    ...
    struct _SEP_LOWBOX_HANDLES_TABLE LowBoxHandlesTable;// Offset=0x58 Size=0x10
    ...
    struct _ESILO * ServerSilo;// Offset=0xa0 Size=0x8
};
