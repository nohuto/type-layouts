...
struct _KTIMER2// Size=0x88 (Id=537)
{
    ...
    union // Size=0x30 (Id=0)
    {
        ...
        unsigned long long DueTime;// Offset=0x48 Size=0x8
    };
    unsigned long long MaximumDueTime;// Offset=0x50 Size=0x8
    ...
    union // Size=0x1 (Id=0)
    {
        ...
        struct // Size=0x1 (Id=0)
        {
            unsigned char Plain:1;// Offset=0x81 Size=0x1 BitOffset=0x0 BitSize=0x1
            ...
            unsigned char NoWakeFinite:1;// Offset=0x81 Size=0x1 BitOffset=0x4 BitSize=0x1
            unsigned char Unused:3;// Offset=0x81 Size=0x1 BitOffset=0x5 BitSize=0x3
        };
    };
};
