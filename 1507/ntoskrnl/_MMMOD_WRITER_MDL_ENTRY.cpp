...
union _unnamed_656// Size=0x10 (Id=656)
{
    struct _IO_STATUS_BLOCK IoStatus;// Offset=0x0 Size=0x10
};

struct _MODWRITER_FLAGS// Size=0x4 (Id=1033)
{
...
struct _MMMOD_WRITER_MDL_ENTRY// Size=0x108 (Id=657)
{
    struct _LIST_ENTRY Links;// Offset=0x0 Size=0x10
    union _unnamed_656 u;// Offset=0x10 Size=0x10
