...
struct _MMVAD_FLAGS// Size=0x4 (Id=616)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long Teb:1;// Offset=0x0 Size=0x4 BitOffset=0x10 BitSize=0x1
        unsigned long PrivateFixup:1;// Offset=0x0 Size=0x4 BitOffset=0x11 BitSize=0x1
        unsigned long ManySubsections:1;// Offset=0x0 Size=0x4 BitOffset=0x12 BitSize=0x1
        unsigned long Spare:12;// Offset=0x0 Size=0x4 BitOffset=0x13 BitSize=0xc
        unsigned long DeleteInProgress:1;// Offset=0x0 Size=0x4 BitOffset=0x1f BitSize=0x1
    };
};

union _unnamed_221// Size=0x4 (Id=221)
{
    unsigned long LongFlags;// Offset=0x0 Size=0x4
    struct _MMVAD_FLAGS VadFlags;// Offset=0x0 Size=0x4
};

struct _MMVAD_FLAGS1// Size=0x4 (Id=729)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MMVAD_SHORT// Size=0x40 (Id=223)
{
    ...
    union _unnamed_221 u;// Offset=0x30 Size=0x4
    union _unnamed_222 u1;// Offset=0x34 Size=0x4
    struct _MI_VAD_EVENT_BLOCK * EventList;// Offset=0x38 Size=0x8
};

struct _MMVAD_FLAGS2// Size=0x4 (Id=1267)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1064// Size=0x4 (Id=1064)
{
...
struct _MI_VAD_SEQUENTIAL_INFO// Size=0x8 (Id=1171)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _MMVAD// Size=0x88 (Id=1066)
{
    ...
    union _unnamed_1065 u4;// Offset=0x78 Size=0x8
