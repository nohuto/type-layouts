...
struct _unnamed_737// Size=0x8 (Id=737)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_738// Size=0x4 (Id=738)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_739// Size=0x8 (Id=739)
{
    struct _unnamed_737 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_738 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_737 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=216)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_739 Data;// Offset=0x4 Size=0x8
};
