union _KSE_XHCI_CONTROLLER_FLAGS// Size=0x8 (Id=386)
{
...
struct _CRASHDUMP_BUFFER_DATA// Size=0x18 (Id=452)
{
...
struct _CRASHDUMP_REGISTER_DATA// Size=0x40 (Id=447)
{
...
struct _CRASHDUMP_EVENTRING_DATA// Size=0x80 (Id=460)
{
...
struct _CRASHDUMP_COMMAND_DATA// Size=0x50 (Id=461)
{
    void * DumperHandle;// Offset=0x0 Size=0x8
    void * RegisterHandle;// Offset=0x8 Size=0x8
...
struct _USB_DEVICE_PORT_PATH// Size=0x24 (Id=420)
{
...
struct _CRASHDUMP_DATA// Size=0x270 (Id=459)
{
    struct _CRASHDUMP_REGISTER_DATA RegisterData;// Offset=0x0 Size=0x40
    struct _CRASHDUMP_EVENTRING_DATA EventRingData;// Offset=0x40 Size=0x80
    struct _CRASHDUMP_EVENTRING_DATA EventRingHibernateData;// Offset=0xc0 Size=0x80
    struct _CRASHDUMP_COMMAND_DATA CommandData;// Offset=0x140 Size=0x50
    unsigned long DeviceSlotCount;// Offset=0x190 Size=0x4
    struct _CRASHDUMP_BUFFER_DATA DeviceContextBaseBufferData;// Offset=0x198 Size=0x18
    struct _CRASHDUMP_BUFFER_DATA ControlTransferBuffer;// Offset=0x1b0 Size=0x18
    struct _CRASHDUMP_BUFFER_DATA InputDeviceContextBuffer;// Offset=0x1c8 Size=0x18
    void * CommonBufferHandle;// Offset=0x1e0 Size=0x8
    struct _LIST_ENTRY CommonBufferList;// Offset=0x1e8 Size=0x10
    unsigned long CommonBufferPageCount;// Offset=0x1f8 Size=0x4
    unsigned long CommonBufferUsedBytes;// Offset=0x1fc Size=0x4
    unsigned long CurrentBufferIndex;// Offset=0x200 Size=0x4
    enum _USB_DEVICE_SPEED DeviceSpeed;// Offset=0x204 Size=0x4
    enum _CRASHDUMP_PORT_TYPE RootPortType;// Offset=0x208 Size=0x4
    struct _USB_DEVICE_PORT_PATH PortPath;// Offset=0x20c Size=0x24
    struct _CRASHDUMP_USBDEVICE_DATA * DeviceArray;// Offset=0x230 Size=0x8
    struct _CRASHDUMP_USBDEVICE_DATA * TargetDevice;// Offset=0x238 Size=0x8
    enum _DUMP_POWER_DOWN_TYPE PowerDownType;// Offset=0x240 Size=0x4
    struct _CRASHDUMP_BUFFER_DATA DumpMiniportBuffer;// Offset=0x248 Size=0x18
    void * ControllerHandle;// Offset=0x260 Size=0x8
    unsigned char ControllerWasReset;// Offset=0x268 Size=0x1
    unsigned char HybridSleepSaveStateAllowed;// Offset=0x269 Size=0x1
    unsigned char DumpIgnoreNextPortReset;// Offset=0x26a Size=0x1
};
