...
struct _unnamed_595// Size=0x4 (Id=595)
{
    enum _WDF_DEVICE_POWER_POLICY_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_596// Size=0x8 (Id=596)
{
    struct _unnamed_594 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_595 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_594 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=218)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_596 Data;// Offset=0x4 Size=0x8
};
