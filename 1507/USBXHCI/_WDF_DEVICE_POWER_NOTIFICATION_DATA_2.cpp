...
struct _unnamed_531// Size=0x8 (Id=531)
{
...
union _unnamed_533// Size=0x8 (Id=533)
{
    struct _unnamed_531 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_532 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_531 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=534)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_533 Data;// Offset=0x4 Size=0x8
};
