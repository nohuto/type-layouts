...
union _unnamed_297// Size=0x4 (Id=297)
{
    struct _unnamed_296 Parallel;// Offset=0x0 Size=0x4
};

struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=298)
{
    ...
    union _unnamed_297 Settings;// Offset=0x50 Size=0x4
