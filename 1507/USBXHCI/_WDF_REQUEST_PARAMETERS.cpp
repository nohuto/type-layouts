...
struct _unnamed_272// Size=0x20 (Id=272)
{
...
union _unnamed_274// Size=0x20 (Id=274)
{
    struct _unnamed_75 Create;// Offset=0x0 Size=0x20
    struct _unnamed_271 Read;// Offset=0x0 Size=0x18
    struct _unnamed_271 Write;// Offset=0x0 Size=0x18
    struct _unnamed_272 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_273 Others;// Offset=0x0 Size=0x20
};

struct _WDF_REQUEST_PARAMETERS// Size=0x28 (Id=275)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned char MinorFunction;// Offset=0x2 Size=0x1
    enum _WDF_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    union _unnamed_274 Parameters;// Offset=0x8 Size=0x20
};
