...
struct _unnamed_243// Size=0x18 (Id=243)
{
...
struct _unnamed_245// Size=0x18 (Id=245)
{
...
union _unnamed_255// Size=0x18 (Id=255)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_243 Port;// Offset=0x0 Size=0x18
        struct _unnamed_243 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_245 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_246 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_247 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_243 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_248 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_249 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_250 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_251 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_252 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_253 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_254 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=256)
{
    ...
    union _unnamed_255 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=690)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=481)
{
