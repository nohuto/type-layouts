...
union _unnamed_467// Size=0x8 (Id=467)
{
    struct _unnamed_466 u;// Offset=0x0 Size=0x8
    unsigned long long asUlong64;// Offset=0x0 Size=0x8
};

struct _RAID_LOG_CONTROL// Size=0x10 (Id=468)
{
    unsigned long Revision;// Offset=0x0 Size=0x4
    union _unnamed_467 Enable;// Offset=0x8 Size=0x8
};
