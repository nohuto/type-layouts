...
struct _unnamed_156// Size=0x8 (Id=156)
{
...
union _unnamed_158// Size=0x10 (Id=158)
{
    struct _unnamed_156 Discrete;// Offset=0x0 Size=0x8
    struct _unnamed_157 Range;// Offset=0x0 Size=0x10
};

struct _STOR_POFX_COMPONENT_PERF_SET// Size=0x28 (Id=159)
{
    ...
    union _unnamed_158 PStates;// Offset=0x18 Size=0x10
};
