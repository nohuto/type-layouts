...
struct _unnamed_228// Size=0x6 (Id=228)
{
...
struct _STOR_LOCKED_LIST// Size=0x20 (Id=245)
{
...
struct _STOR_DICTIONARY// Size=0x30 (Id=176)
{
...
struct _RAID_RESOURCE_LIST// Size=0x10 (Id=260)
{
...
struct _MEMORY_REGION// Size=0x18 (Id=391)
{
...
struct _PORT_CONFIGURATION_INFORMATION// Size=0xe0 (Id=243)
{
...
struct _unnamed_246// Size=0x1 (Id=246)
{
    struct // Size=0x1 (Id=0)
    {
        ...
        unsigned char UnitControlListPopulated:1;// Offset=0x0 Size=0x1 BitOffset=0x2 BitSize=0x1
        unsigned char AdapterControlListPopulated:1;// Offset=0x0 Size=0x1 BitOffset=0x3 BitSize=0x1
    };
};

struct _UNIT_CONTROL_LIST// Size=0x10 (Id=392)
{
    unsigned long MaxControlType;// Offset=0x0 Size=0x4
    unsigned char SupportedTypeList[11];// Offset=0x4 Size=0xb
};

struct _ADAPTER_CONTROL_LIST// Size=0x18 (Id=336)
{
    unsigned long MaxControlType;// Offset=0x0 Size=0x4
    unsigned char SupportedTypeList[18];// Offset=0x4 Size=0x12
};

struct _RAID_MINIPORT// Size=0x128 (Id=247)
{
    ...
    struct _unnamed_246 Flags;// Offset=0xf8 Size=0x1
...
struct _BUS_INTERFACE_STANDARD// Size=0x40 (Id=314)
{
...
struct _RAID_BUS_INTERFACE// Size=0x48 (Id=297)
{
...
struct _RAID_DMA_ADAPTER// Size=0x20 (Id=271)
{
...
struct _RAID_MEMORY_REGION// Size=0x18 (Id=181)
{
    unsigned char * VirtualBase;// Offset=0x0 Size=0x8
    union _LARGE_INTEGER PhysicalBase;// Offset=0x8 Size=0x8
    unsigned long Length;// Offset=0x10 Size=0x4
...
struct _IO_CONT_RESOURCE_LIST// Size=0x80 (Id=388)
{
...
struct _STOR_NOTIFICATION_INFO// Size=0x20 (Id=417)
{
...
struct _STOR_IO_GATEWAY// Size=0x140 (Id=210)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _unnamed_231// Size=0x50 (Id=231)
{
    struct _RAID_DEFERRED_ELEMENT Timer;// Offset=0x0 Size=0x50
};

struct _unnamed_232// Size=0xb0 (Id=232)
{
...
struct _PORT_REGISTRY_INFO// Size=0x40 (Id=308)
{
...
struct _RAID_ADAPTER_PARAMETERS// Size=0x38 (Id=441)
{
...
struct _unnamed_234// Size=0x1 (Id=234)
{
    struct // Size=0x1 (Id=0)
    {
        ...
        unsigned char UnusedFlags:6;// Offset=0x0 Size=0x1 BitOffset=0x2 BitSize=0x6
    };
};
...
struct _SCSI_POWER_REQUEST_BLOCK// Size=0x58 (Id=495)
{
    unsigned short Length;// Offset=0x0 Size=0x2
...
struct _STORAGE_REQUEST_BLOCK// Size=0x80 (Id=204)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    unsigned char Function;// Offset=0x2 Size=0x1
    unsigned char SrbStatus;// Offset=0x3 Size=0x1
...
struct _RAID_POWER_CONTEXT// Size=0xb8 (Id=452)
{
...
struct _STORPORT_EXTENDED_FUNCTIONS// Size=0x58 (Id=344)
{
...
union _RAID_REDIRECTION_SUPPORT// Size=0x2 (Id=508)
{
    struct // Size=0x2 (Id=0)
    {
...
struct _PCI_HEADER_TYPE_0// Size=0x30 (Id=408)
{
...
struct _PCI_HEADER_TYPE_1// Size=0x30 (Id=470)
{
...
struct _PCI_HEADER_TYPE_2// Size=0x30 (Id=446)
{
    ...
    unsigned char SubordinateBus;// Offset=0xa Size=0x1
    unsigned char SecondaryLatency;// Offset=0xb Size=0x1
    struct _unnamed_445 Range[4];// Offset=0xc Size=0x20
    unsigned char InterruptLine;// Offset=0x2c Size=0x1
    unsigned char InterruptPin;// Offset=0x2d Size=0x1
    unsigned short BridgeControl;// Offset=0x2e Size=0x2
};

union _unnamed_353// Size=0x30 (Id=353)
{
...
struct _PCI_COMMON_HEADER// Size=0x40 (Id=354)
{
    ...
    union _unnamed_353 u;// Offset=0x10 Size=0x30
};

struct _STOR_POWER_SETTING_NOTIFICATION// Size=0x18 (Id=328)
{
...
struct _CRASHDUMP_FUNCTIONS_INTERFACE// Size=0x28 (Id=435)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
struct _RAID_ADAPTER_EXTENSION// Size=0x1580 (Id=236)
{
    ...
    struct _unnamed_228 Flags;// Offset=0x68 Size=0x6
    ...
    struct _unnamed_231 DeferredList;// Offset=0x4c0 Size=0x50
    struct _unnamed_232 DeferredPauseResumeContext;// Offset=0x510 Size=0xb0
    ...
    struct _unnamed_234 PerfOptFlags;// Offset=0x1163 Size=0x1
    ...
    unsigned short * SqmMiniportName;// Offset=0x12c0 Size=0x8
    unsigned short * SqmAdapterId;// Offset=0x12c8 Size=0x8
    ...
    struct _unnamed_235 TelemetryHierarchicalResetLunBucket[5];// Offset=0x1448 Size=0x3c
    struct _unnamed_235 TelemetryHierarchicalResetTargetBucket[5];// Offset=0x1484 Size=0x3c
    unsigned long long LastCSStateChange;// Offset=0x14c0 Size=0x8
    unsigned long long LastIOCoalescingOnStartTime;// Offset=0x14c8 Size=0x8
    unsigned long long IOCoalescingOnDuration;// Offset=0x14d0 Size=0x8
    unsigned long long FirstDPNRTimeAfterCS;// Offset=0x14d8 Size=0x8
    unsigned long long LastDPNRStartTime;// Offset=0x14e0 Size=0x8
    unsigned long long DPNRDurationInCS;// Offset=0x14e8 Size=0x8
    unsigned long long LastF1StartTime;// Offset=0x14f0 Size=0x8
    unsigned long long F1DurationInCS;// Offset=0x14f8 Size=0x8
    unsigned long long ActiveReferencesInCS;// Offset=0x1500 Size=0x8
    unsigned long long ActiveReferencesInCoalescing;// Offset=0x1508 Size=0x8
    unsigned long UnitTimeoutsInCS;// Offset=0x1510 Size=0x4
    unsigned long F0TransitionsSinceCSStateChange;// Offset=0x1514 Size=0x4
    unsigned long D0TransitionsSinceCSStateChange;// Offset=0x1518 Size=0x4
    unsigned long F0TransitionsLongSinceCSStateChange;// Offset=0x151c Size=0x4
    unsigned long D0TransitionsLongSinceCSStateChange;// Offset=0x1520 Size=0x4
    struct _GUID AdapterGuid;// Offset=0x1524 Size=0x10
    unsigned char TopologyInfoLogged;// Offset=0x1534 Size=0x1
    unsigned long MiniportFirmwareDataStructureVersion;// Offset=0x1538 Size=0x4
    struct _D3COLD_SUPPORT_INTERFACE * D3ColdInterface;// Offset=0x1540 Size=0x8
