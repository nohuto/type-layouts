...
struct _SECURITY_SUBJECT_CONTEXT// Size=0x20 (Id=531)
{
...
struct _LUID_AND_ATTRIBUTES// Size=0xc (Id=561)
{
    struct _LUID Luid;// Offset=0x0 Size=0x8
    unsigned long Attributes;// Offset=0x8 Size=0x4
};

struct _INITIAL_PRIVILEGE_SET// Size=0x2c (Id=550)
{
...
union _unnamed_520// Size=0x2c (Id=520)
{
...
struct _ACCESS_STATE// Size=0xa0 (Id=521)
{
    ...
    union _unnamed_520 Privileges;// Offset=0x50 Size=0x2c
