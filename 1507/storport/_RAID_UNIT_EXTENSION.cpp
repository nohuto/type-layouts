...
struct _STOR_ADDR_BTL8// Size=0x10 (Id=209)
{
...
struct _STOR_SCSI_ADDRESS// Size=0x4 (Id=182)
{
...
struct _STOR_SCSI_IDENTITY// Size=0x30 (Id=183)
{
...
struct _unnamed_212// Size=0x8 (Id=212)
{
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned long Reserved:15;// Offset=0x4 Size=0x4 BitOffset=0x0 BitSize=0xf
    };
};

union _unnamed_213// Size=0x4 (Id=213)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=298)
{
    union // Size=0x4 (Id=0)
    {
...
struct _RAID_POWER_STATE// Size=0x10 (Id=256)
{
...
struct _QUEUE_TAG_LIST// Size=0x80 (Id=178)
{
...
struct _EXTENDED_DEVICE_QUEUE// Size=0x70 (Id=193)
{
...
struct _IO_QUEUE// Size=0x88 (Id=192)
{
    ...
    struct _EXTENDED_DEVICE_QUEUE DeviceQueue;// Offset=0x10 Size=0x70
    unsigned long QueueChanged;// Offset=0x80 Size=0x4
};
...
struct _KTIMER// Size=0x40 (Id=282)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _RAID_DEFERRED_HEADER// Size=0x20 (Id=378)
{
...
struct _unnamed_457// Size=0x20 (Id=457)
{
...
struct _unnamed_458// Size=0x4 (Id=458)
{
    unsigned long Timeout;// Offset=0x0 Size=0x4
};

struct _unnamed_459// Size=0x4 (Id=459)
{
...
struct _unnamed_460// Size=0x18 (Id=460)
{
...
struct _unnamed_461// Size=0x8 (Id=461)
{
    struct _STOR_ASYNC_NOTIFY_CONTEXT * StorAsyncNotify;// Offset=0x0 Size=0x8
};

struct _RAID_DEFERRED_ELEMENT// Size=0x50 (Id=462)
{
    ...
    {
        struct _unnamed_456 Timer;// Offset=0x28 Size=0x10
        struct _unnamed_457 Error;// Offset=0x28 Size=0x20
        struct _unnamed_458 PauseDevice;// Offset=0x28 Size=0x4
        struct _unnamed_459 Busy;// Offset=0x28 Size=0x4
        struct _unnamed_459 DeviceBusy;// Offset=0x28 Size=0x4
        struct _unnamed_460 AdditionalTimer;// Offset=0x28 Size=0x18
        struct _unnamed_461 AsyncNotification;// Offset=0x28 Size=0x8
    };
};

struct _unnamed_215// Size=0x190 (Id=215)
{
...
struct _RAID_IO_RESOURCES// Size=0x20 (Id=220)
{
...
struct _RAID_UNIT_REGISTRY_PARAMETERS// Size=0x18 (Id=316)
{
...
struct _RAID_UNIT_ATTRIBUTES// Size=0x4 (Id=389)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _RAID_WORK_ITEM_CONTEXT// Size=0x10 (Id=342)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
    struct _IRP * Irp;// Offset=0x8 Size=0x8
};

struct _STOR_ASYNC_NOTIFY_CONTEXT// Size=0x18 (Id=386)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
...
struct _RAID_SHARED_WORK_ITEM_CONTEXT// Size=0x18 (Id=296)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
    struct _IRP * Irp;// Offset=0x8 Size=0x8
    unsigned long InUse;// Offset=0x10 Size=0x4
...
struct _RAID_TELEMETRY_ERROR_ENTRY// Size=0x20 (Id=556)
{
    ...
    unsigned long long LBA;// Offset=0x10 Size=0x8
    union _unnamed_555 u;// Offset=0x18 Size=0x4
};

struct _RAID_TELEMETRY_SAMPLED_ERROR_LOG// Size=0x168 (Id=492)
{
    unsigned long TotalErrors;// Offset=0x0 Size=0x4
    struct _RAID_TELEMETRY_ERROR_ENTRY LastError;// Offset=0x8 Size=0x20
    struct _RAID_TELEMETRY_ERROR_ENTRY SampledErrors[10];// Offset=0x28 Size=0x140
};

struct _RAID_TELEMETRY_UNIQUE_ERROR_LOG// Size=0xa0 (Id=385)
{
    struct _RAID_TELEMETRY_ERROR_ENTRY UniqueErrors[5];// Offset=0x0 Size=0xa0
};

struct _RAID_UNIT_EXTENSION// Size=0x940 (Id=219)
{
    ...
    struct _STOR_SCSI_IDENTITY Identity;// Offset=0x60 Size=0x30
    struct _unnamed_212 Flags;// Offset=0x90 Size=0x8
    union _unnamed_213 InterlockedFlags;// Offset=0x98 Size=0x4
    struct _KEVENT ZeroOutstandingEvent;// Offset=0xa0 Size=0x18
    struct _RAID_POWER_STATE Power;// Offset=0xb8 Size=0x10
    struct _STOR_EVENT_QUEUE * PendingQueue;// Offset=0xc8 Size=0x8
    struct _QUEUE_TAG_LIST TagList;// Offset=0x100 Size=0x80
    struct _IO_QUEUE IoQueue;// Offset=0x180 Size=0x88
    unsigned long MaxQueueDepth;// Offset=0x208 Size=0x4
    unsigned long OscData;// Offset=0x20c Size=0x4
    enum _STORAGE_POWERUP_REASON_TYPE PowerupReason;// Offset=0x210 Size=0x4
    struct ACPI_INTERFACE_STANDARD2 AcpiInterface;// Offset=0x218 Size=0x58
    long OutstandingCount;// Offset=0x270 Size=0x4
    unsigned long PagingPathCount;// Offset=0x274 Size=0x4
    unsigned long CrashDumpPathCount;// Offset=0x278 Size=0x4
    unsigned long HiberPathCount;// Offset=0x27c Size=0x4
    struct _KTIMER PendingTimer;// Offset=0x280 Size=0x40
    struct _KDPC PendingDpc;// Offset=0x2c0 Size=0x40
    struct _KTIMER PauseTimer;// Offset=0x300 Size=0x40
    struct _KDPC PauseTimerDpc;// Offset=0x340 Size=0x40
    struct _KDPC RestartDpc;// Offset=0x380 Size=0x40
    struct _RAID_MEMORY_REGION * CommonBufferVAs;// Offset=0x3c0 Size=0x8
    unsigned long CommonBufferSize;// Offset=0x3c8 Size=0x4
    unsigned long CommonBufferBlocks;// Offset=0x3cc Size=0x4
    unsigned long DefaultTimeout;// Offset=0x3d0 Size=0x4
    long ResetCount;// Offset=0x3d4 Size=0x4
    struct _unnamed_215 DeferredList;// Offset=0x3e0 Size=0x190
    struct _RAID_IO_RESOURCES ResetResources;// Offset=0x570 Size=0x20
    long ResetResourcesAcquired;// Offset=0x590 Size=0x4
    unsigned char SenseInfoSize;// Offset=0x594 Size=0x1
    unsigned char CallFreeDumpPtrSRB;// Offset=0x595 Size=0x1
    unsigned char DumpPowerReady;// Offset=0x596 Size=0x1
    unsigned char StackDumpPowerReady;// Offset=0x597 Size=0x1
    struct _EX_RUNDOWN_REF_CACHE_AWARE * PoFxRundownProtection;// Offset=0x598 Size=0x8
    struct _RAID_UNIT_POFX * PoFx;// Offset=0x5a0 Size=0x8
    struct _D3COLD_SUPPORT_INTERFACE * D3ColdInterface;// Offset=0x5a8 Size=0x8
    long PowerUpRequired;// Offset=0x5b0 Size=0x4
    long PowerDownRequired;// Offset=0x5b4 Size=0x4
    struct _IO_WORKITEM * HierarchicalResetWorkItem;// Offset=0x5b8 Size=0x8
    long HierarchicalResetWorkItemTimeoutCountdown;// Offset=0x5c0 Size=0x4
    long HierarchicalResetSrbTimeoutCountdown;// Offset=0x5c4 Size=0x4
    unsigned long HierarchicalResetAbortCount;// Offset=0x5c8 Size=0x4
    unsigned long long HierarchicalResetWorkItemSpinLock;// Offset=0x5d0 Size=0x8
    struct _RAID_UNIT_REGISTRY_PARAMETERS RegistryParameters;// Offset=0x5d8 Size=0x18
    struct _RAID_UNIT_ATTRIBUTES UnitAttributes;// Offset=0x5f0 Size=0x4
    struct _UNICODE_STRING VmLunPnpInterfaceName;// Offset=0x5f8 Size=0x10
    struct _RAID_WORK_ITEM_CONTEXT QuiesceDeviceWorkItem;// Offset=0x608 Size=0x10
    struct _STOR_ASYNC_NOTIFY_CONTEXT StorAsyncNotify;// Offset=0x618 Size=0x18
    struct _RAID_SHARED_WORK_ITEM_CONTEXT PowerWorkItem;// Offset=0x630 Size=0x18
    struct _unnamed_218 PendingPowerUpContext;// Offset=0x648 Size=0x10
    struct _SLIST_ENTRY PendingPowerUpListEntry;// Offset=0x660 Size=0x10
    struct _UNICODE_STRING SesPnpInterfaceName;// Offset=0x670 Size=0x10
    unsigned long long IoCountDelayedByLatencyCap;// Offset=0x680 Size=0x8
    struct _GUID DeviceGuid;// Offset=0x688 Size=0x10
    unsigned long long FirstDPNRTimeAfterCS;// Offset=0x698 Size=0x8
    unsigned long long LastF1StartTime;// Offset=0x6a0 Size=0x8
    unsigned long long F1DurationInCS;// Offset=0x6a8 Size=0x8
    unsigned long long LastDPNRStartTime;// Offset=0x6b0 Size=0x8
    unsigned long long DPNRDurationInCS;// Offset=0x6b8 Size=0x8
    unsigned long long ActiveReferencesInCS;// Offset=0x6c0 Size=0x8
    unsigned long long ActiveReferencesInCoalescing;// Offset=0x6c8 Size=0x8
    unsigned long UnitTimeoutsInCS;// Offset=0x6d0 Size=0x4
    unsigned long F0TransitionsSinceCSStateChange;// Offset=0x6d4 Size=0x4
    unsigned long D0TransitionsSinceCSStateChange;// Offset=0x6d8 Size=0x4
    unsigned long F0TransitionsLongSinceCSStateChange;// Offset=0x6dc Size=0x4
    unsigned long D0TransitionsLongSinceCSStateChange;// Offset=0x6e0 Size=0x4
    unsigned long StorpTraceLoggingPerformanceEnabled;// Offset=0x6e4 Size=0x4
    struct _RAID_TELEMETRY_PERF_BUCKET * TelemetryPerfBuckets;// Offset=0x6e8 Size=0x8
    union _LARGE_INTEGER TelemetryLastPerfCollectionTimeStamp;// Offset=0x6f0 Size=0x8
    struct _RAID_TELEMETRY_PERF_BUCKET * TelemetryPerfPreviousCounters;// Offset=0x6f8 Size=0x8
    unsigned long long TelemetryLock;// Offset=0x700 Size=0x8
    struct _RAID_TELEMETRY_SAMPLED_ERROR_LOG TelemetrySampledErrorLog;// Offset=0x708 Size=0x168
    struct _RAID_TELEMETRY_UNIQUE_ERROR_LOG TelemetryUniqueErrorLog;// Offset=0x870 Size=0xa0
    unsigned long PowerCycleCount;// Offset=0x910 Size=0x4
    union _LARGE_INTEGER InitialTimestamp;// Offset=0x918 Size=0x8
};
