...
struct _unnamed_49// Size=0x4 (Id=49)
{
    unsigned long Length;// Offset=0x0 Size=0x4
};
...
struct _unnamed_51// Size=0x10 (Id=51)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_62// Size=0x4 (Id=62)
{
...
struct _unnamed_65// Size=0x8 (Id=65)
{
    struct _DEVICE_CAPABILITIES * Capabilities;// Offset=0x0 Size=0x8
};

struct _unnamed_66// Size=0x8 (Id=66)
{
...
struct _unnamed_68// Size=0x1 (Id=68)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _unnamed_70// Size=0x4 (Id=70)
{
...
struct _unnamed_76// Size=0x4 (Id=76)
{
...
struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=383)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=257)
{
...
struct _unnamed_81// Size=0x10 (Id=81)
{
...
union _unnamed_84// Size=0x20 (Id=84)
{
    struct _unnamed_39 Create;// Offset=0x0 Size=0x20
    struct _unnamed_40 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_41 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_42 Read;// Offset=0x0 Size=0x18
    struct _unnamed_42 Write;// Offset=0x0 Size=0x18
    struct _unnamed_44 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_45 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_46 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_47 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_48 QueryEa;// Offset=0x0 Size=0x20
    struct _unnamed_49 SetEa;// Offset=0x0 Size=0x4
    struct _unnamed_51 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_51 SetVolume;// Offset=0x0 Size=0x10
    struct _unnamed_52 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_53 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_54 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_55 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_56 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_57 MountVolume;// Offset=0x0 Size=0x10
    struct _unnamed_57 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_58 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_60 QueryQuota;// Offset=0x0 Size=0x20
    struct _unnamed_49 SetQuota;// Offset=0x0 Size=0x4
    struct _unnamed_62 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_64 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_65 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_66 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_67 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_68 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_70 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_72 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_74 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_76 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_77 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_80 Power;// Offset=0x0 Size=0x20
    struct _unnamed_81 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_82 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_83 Others;// Offset=0x0 Size=0x20
};
...
struct _IO_STACK_LOCATION// Size=0x48 (Id=85)
{
    ...
    union _unnamed_84 Parameters;// Offset=0x8 Size=0x20
