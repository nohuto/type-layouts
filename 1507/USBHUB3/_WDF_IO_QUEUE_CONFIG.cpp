...
union _unnamed_271// Size=0x4 (Id=271)
{
    struct _unnamed_270 Parallel;// Offset=0x0 Size=0x4
};

struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=272)
{
    ...
    union _unnamed_271 Settings;// Offset=0x50 Size=0x4
