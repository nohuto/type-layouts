...
union _unnamed_465// Size=0x8 (Id=465)
{
    struct _unnamed_463 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_464 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_463 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=466)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_465 Data;// Offset=0x4 Size=0x8
};
