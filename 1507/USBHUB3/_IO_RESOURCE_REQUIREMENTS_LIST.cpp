...
struct _unnamed_215// Size=0x18 (Id=215)
{
...
struct _unnamed_219// Size=0x8 (Id=219)
{
...
struct _unnamed_223// Size=0xc (Id=223)
{
...
struct _unnamed_224// Size=0x18 (Id=224)
{
...
union _unnamed_228// Size=0x18 (Id=228)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_215 Port;// Offset=0x0 Size=0x18
        struct _unnamed_215 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_218 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_219 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_220 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_215 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_221 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_222 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_223 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_224 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_225 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_226 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_227 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=229)
{
    ...
    union _unnamed_228 u;// Offset=0x8 Size=0x18
};
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=366)
{
