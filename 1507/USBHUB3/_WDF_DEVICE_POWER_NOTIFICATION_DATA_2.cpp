...
struct _unnamed_409// Size=0x8 (Id=409)
{
...
union _unnamed_411// Size=0x8 (Id=411)
{
    struct _unnamed_409 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_410 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_409 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=189)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_411 Data;// Offset=0x4 Size=0x8
};
