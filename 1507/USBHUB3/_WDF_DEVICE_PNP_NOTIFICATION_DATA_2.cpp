...
struct _unnamed_592// Size=0x4 (Id=592)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_593// Size=0x8 (Id=593)
{
    struct _unnamed_591 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_592 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_591 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=188)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_593 Data;// Offset=0x4 Size=0x8
};
