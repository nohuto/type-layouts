union _unnamed_440// Size=0x2 (Id=440)
{
...
struct _USB_DEVICE_CAPABILITY_PD_CONSUMER_PORT_DESCRIPTOR// Size=0x18 (Id=441)
{
    ...
    union _unnamed_440 bmCapabilities;// Offset=0x4 Size=0x2
