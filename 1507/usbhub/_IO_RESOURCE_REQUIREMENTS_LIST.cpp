...
struct _unnamed_394// Size=0x10 (Id=394)
{
...
struct _unnamed_395// Size=0x10 (Id=395)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
union _unnamed_400// Size=0x18 (Id=400)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_389 Port;// Offset=0x0 Size=0x18
        struct _unnamed_389 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_392 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_393 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_394 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_389 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_318 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_395 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_396 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_397 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_398 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_399 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_324 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=401)
{
    ...
    union _unnamed_400 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=309)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=212)
{
