union _unnamed_32// Size=0x8 (Id=32)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=264)
{
    union // Size=0x4 (Id=0)
    {
...
struct _unnamed_33// Size=0x10 (Id=33)
{
    union // Size=0x8 (Id=0)
    {
...
union _unnamed_34// Size=0x10 (Id=34)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_33 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=271)
{
...
struct _unnamed_35// Size=0x50 (Id=35)
{
