...
struct _G_STATE_LOG_ENTRY// Size=0x20 (Id=178)
{
...
struct _STATE_CONTEXT// Size=0xb0 (Id=176)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=217)
{
    union // Size=0x4 (Id=0)
    {
...
struct _WMILIB_CONTEXT// Size=0x40 (Id=338)
{
...
struct _USB_DEVICE_DESCRIPTOR// Size=0x12 (Id=202)
{
...
union _USBHUB_PDO_FLAGS// Size=0x4 (Id=362)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_DEVICE_FLAGS// Size=0x4 (Id=333)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long BillboardArrivalEventSent:1;// Offset=0x0 Size=0x4 BitOffset=0x13 BitSize=0x1
        unsigned long FailGetStatusRequest:1;// Offset=0x0 Size=0x4 BitOffset=0x14 BitSize=0x1
        unsigned long Reserved:11;// Offset=0x0 Size=0x4 BitOffset=0x15 BitSize=0xb
    };
};

struct _IO_CSQ// Size=0x40 (Id=286)
{
...
struct _HUB_TIMER_OBJECT// Size=0x50 (Id=220)
{
...
struct _USB_ID_STRING// Size=0x10 (Id=327)
{
...
struct _USB_INTERFACE_DESCRIPTOR// Size=0x9 (Id=288)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
...
struct _KSEMAPHORE// Size=0x20 (Id=341)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _USB_HUB_DEVICE_UXD_SETTINGS// Size=0x44 (Id=260)
{
...
union _MSOS20_FLAGS// Size=0x4 (Id=361)
{
...
struct _MSOS20_INFO// Size=0x38 (Id=308)
{
...
struct _MSOS20_DESCRIPTOR_SET_INFO// Size=0x8 (Id=251)
{
...
struct _D3COLD_SUPPORT_INTERFACE// Size=0x48 (Id=354)
{
...
struct _unnamed_127// Size=0x4 (Id=127)
{
    struct // Size=0x4 (Id=0)
    {
...
union _USB_DUAL_ROLE_FEATURES// Size=0x4 (Id=128)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct _unnamed_127 features;// Offset=0x0 Size=0x4
};

struct _DEVICE_EXTENSION_PDO// Size=0xbd0 (Id=160)
{
    ...
    unsigned short * DeviceUsbRegPath;// Offset=0x470 Size=0x8
    ...
    unsigned short * PnPDeviceDescription;// Offset=0x8b8 Size=0x8
    ...
    struct _USB_INTERFACE_DESCRIPTOR CompatIdInterfaceDescriptor;// Offset=0x960 Size=0x9
    wchar_t DeviceDescription[40];// Offset=0x96a Size=0x50
    struct _MS_EXT_CONFIG_DESC * MsExtConfigDesc;// Offset=0x9c0 Size=0x8
    union _LARGE_INTEGER Stat_PdoEnumeratedAt;// Offset=0x9c8 Size=0x8
    union _LARGE_INTEGER Stat_PdoCreatedAt;// Offset=0x9d0 Size=0x8
    union _LARGE_INTEGER Stat_Pdo_SetD0_StartAt;// Offset=0x9d8 Size=0x8
    union _LARGE_INTEGER Stat_Pdo_SetD0_CompleteAt;// Offset=0x9e0 Size=0x8
    struct _KSEMAPHORE UxdLock;// Offset=0x9e8 Size=0x20
    struct _USB_HUB_DEVICE_UXD_SETTINGS UxdSettings;// Offset=0xa08 Size=0x44
    struct _UNICODE_STRING PhysicalDeviceObjectName;// Offset=0xa50 Size=0x10
    struct _USB_PORT_PATH PortPath;// Offset=0xa60 Size=0x1c
    struct _GUID ContainerID;// Offset=0xa7c Size=0x10
    unsigned char ContainerIDValid;// Offset=0xa8c Size=0x1
    unsigned char DeviceSelectiveSuspended;// Offset=0xa8d Size=0x1
    unsigned long InPathCount;// Offset=0xa90 Size=0x4
    unsigned char IsBootDevice;// Offset=0xa94 Size=0x1
    unsigned char ResetCompleteWithoutFailingIO;// Offset=0xa95 Size=0x1
    unsigned long BootDeviceConnectChangeBitExpected;// Offset=0xa98 Size=0x4
    unsigned long BootDeviceConnectBitExpected;// Offset=0xa9c Size=0x4
    void * ExBootDeviceHandle;// Offset=0xaa0 Size=0x8
    struct _KEVENT BootDeviceArrivalEvent;// Offset=0xaa8 Size=0x18
    struct _IRP * PendingResetPortAsyncIrp;// Offset=0xac0 Size=0x8
    struct _IRP * PendingResetNotificationRequestIrp;// Offset=0xac8 Size=0x8
    unsigned long HibernateCount;// Offset=0xad0 Size=0x4
    union _USB_DEVICE_SQM_PROPERTIES SqmProperties;// Offset=0xad4 Size=0x4
    unsigned long long GlobalListStateLock;// Offset=0xad8 Size=0x8
    enum _GLOBAL_LIST_ENTRY_STATE GlobalListState;// Offset=0xae0 Size=0x4
    unsigned long EnumFailureMsgId;// Offset=0xae4 Size=0x4
    struct _MSOS20_INFO MsOs20Info;// Offset=0xae8 Size=0x38
    struct _MSOS20_DESCRIPTOR_SET_INFO CachedMsOs20DeviceInfo;// Offset=0xb20 Size=0x8
    struct _KEVENT DriverNotFoundLock;// Offset=0xb28 Size=0x18
    struct _KEVENT D3ColdReconnectEvent;// Offset=0xb40 Size=0x18
    struct _KEVENT D3ColdLock;// Offset=0xb58 Size=0x18
    long D3ColdReconnectTimeout;// Offset=0xb70 Size=0x4
    struct _D3COLD_SUPPORT_INTERFACE D3ColdFilter;// Offset=0xb78 Size=0x48
    union _USB_DUAL_ROLE_FEATURES UsbDualRoleFeatures;// Offset=0xbc0 Size=0x4
    unsigned long long UcmConnectorId;// Offset=0xbc8 Size=0x8
};
