...
{
    struct _unnamed_496 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_497 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_496 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=228)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_498 Data;// Offset=0x4 Size=0x8
};
