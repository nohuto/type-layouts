...
struct _unnamed_362// Size=0x4 (Id=362)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};
...
{
    struct _unnamed_361 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_362 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_361 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=364)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_363 Data;// Offset=0x4 Size=0x8
};
