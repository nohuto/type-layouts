union _unnamed_68// Size=0x8 (Id=68)
{
...
union _unnamed_70// Size=0x10 (Id=70)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_69 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=423)
{
...
struct _IRP// Size=0xd0 (Id=74)
{
    ...
    union _unnamed_68 AssociatedIrp;// Offset=0x18 Size=0x8
    ...
    union _unnamed_70 Overlay;// Offset=0x58 Size=0x10
