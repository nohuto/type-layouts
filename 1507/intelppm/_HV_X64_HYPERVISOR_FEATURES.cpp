union _HV_PARTITION_PRIVILEGE_MASK// Size=0x8 (Id=332)
{
...
struct _HV_X64_HYPERVISOR_FEATURES// Size=0x10 (Id=331)
{
    ...
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned int Reserved1:14;// Offset=0xc Size=0x4 BitOffset=0x12 BitSize=0xe
    };
};
