struct _PCI_COMMON_HEADER// Size=0x40 (Id=1979)
{
    union // Size=0x10 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x30 (Id=9839)
        {
            struct _PCI_HEADER_TYPE_0// Size=0x30 (Id=9840)
            {
            ...
            struct _PCI_HEADER_TYPE_1// Size=0x30 (Id=9855)
            {
            ...
            struct _PCI_HEADER_TYPE_2// Size=0x30 (Id=9879)
            {
                ...
                unsigned char SubordinateBus;// Offset=0xa Size=0x1
                unsigned char SecondaryLatency;// Offset=0xb Size=0x1
                struct <unnamed-type-Range>// Size=0x8 (Id=9888)
                {
