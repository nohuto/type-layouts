...
struct _WNODE_HEADER// Size=0x30 (Id=2052)
{
...
struct _STRING64// Size=0x10 (Id=1516)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    unsigned short MaximumLength;// Offset=0x2 Size=0x2
...
struct _WMI_LOGGER_INFORMATION// Size=0xb0 (Id=3095)
{
    union // Size=0xa8 (Id=0)
    {
        ...
        unsigned long Wow;// Offset=0x50 Size=0x4
        union // Size=0x8 (Id=0)
        {
        ...
        unsigned long SpareUlong;// Offset=0xa4 Size=0x4
        union <unnamed-type-DUMMYUNIONNAME10>// Size=0x8 (Id=22471)
        {
            void * LoggerExtension;// Offset=0x0 Size=0x8
            unsigned long long LoggerExtension64;// Offset=0x0 Size=0x8
        };
        union _WMI_LOGGER_INFORMATION::<unnamed-type-DUMMYUNIONNAME10> DUMMYUNIONNAME10;// Offset=0xa8 Size=0x8
    };
};
