struct FxRequestBuffer// Size=0x20 (Id=555)
{
    union // Size=0x107 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x18 (Id=61405)
        {
            struct <unnamed-type-Memory>// Size=0x10 (Id=61406)
            {
