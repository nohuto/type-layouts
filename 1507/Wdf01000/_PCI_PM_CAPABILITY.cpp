...
struct _PCI_PMC// Size=0x2 (Id=1916)
{
    union // Size=0x1 (Id=0)
    {
        ...
        struct _PM_SUPPORT// Size=0x1 (Id=10584)
        {
...
struct _PCI_PMCSR// Size=0x2 (Id=1773)
{
...
struct _PCI_PMCSR_BSE// Size=0x1 (Id=3140)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _PCI_PM_CAPABILITY// Size=0x8 (Id=2226)
{
    union // Size=0x6 (Id=0)
    {
        struct _PCI_CAPABILITIES_HEADER Header;// Offset=0x0 Size=0x2
        union <unnamed-type-PMC>// Size=0x2 (Id=10566)
        {
