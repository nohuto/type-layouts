...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=169)
{
...
struct _IRP// Size=0xd0 (Id=855)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=8543)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=8560)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=8561)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=8572)
        {
            struct <unnamed-type-Overlay>// Size=0x50 (Id=8573)
            {
