struct _unnamed_195// Size=0x20 (Id=195)
{
    ...
    unsigned short * wlocale;// Offset=0x8 Size=0x8
    int * refcount;// Offset=0x10 Size=0x8
    int * wrefcount;// Offset=0x18 Size=0x8
};

struct threadlocaleinfostruct// Size=0x160 (Id=196)
{
    ...
    struct _unnamed_195 lc_category[6];// Offset=0x48 Size=0xc0
    ...
    unsigned short * ctype1;// Offset=0x138 Size=0x8
