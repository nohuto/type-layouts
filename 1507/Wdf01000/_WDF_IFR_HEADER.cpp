...
struct _WDF_IFR_OFFSET// Size=0x4 (Id=520)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=16348)
        {
            struct <unnamed-type-s>// Size=0x4 (Id=16349)
            {
...
struct _WDF_IFR_HEADER// Size=0x48 (Id=428)
{
