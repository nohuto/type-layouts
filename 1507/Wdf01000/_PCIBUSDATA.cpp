struct _PCI_SLOT_NUMBER// Size=0x4 (Id=3621)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=10643)
        {
            struct <unnamed-type-bits>// Size=0x4 (Id=10644)
            {
...
struct _PCIBUSDATA// Size=0x50 (Id=1835)
{
