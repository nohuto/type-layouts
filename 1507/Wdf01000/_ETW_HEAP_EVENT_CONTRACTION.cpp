struct _WMI_TRACE_PACKET// Size=0x4 (Id=2185)
{
...
struct _SYSTEM_TRACE_HEADER// Size=0x20 (Id=3204)
{
    union // Size=0x4 (Id=0)
    {
...
struct _ETW_HEAP_EVENT_CONTRACTION// Size=0x5c (Id=2141)
{
    struct _SYSTEM_TRACE_HEADER Header;// Offset=0x0 Size=0x20
    void * HeapHandle;// Offset=0x20 Size=0x8
    unsigned long long DeCommitSize;// Offset=0x28 Size=0x8
    void * DeCommitAddress;// Offset=0x30 Size=0x8
    unsigned long long FreeSpace;// Offset=0x38 Size=0x8
    unsigned long long CommittedSpace;// Offset=0x40 Size=0x8
    unsigned long long ReservedSpace;// Offset=0x48 Size=0x8
    unsigned long NoOfUCRs;// Offset=0x50 Size=0x4
    unsigned long long AllocatedSpace;// Offset=0x54 Size=0x8
};
