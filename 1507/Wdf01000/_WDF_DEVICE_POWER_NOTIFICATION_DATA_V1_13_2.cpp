...
struct _WDF_DEVICE_POWER_NOTIFICATION_DATA_V1_13// Size=0xc (Id=3468)
{
    union // Size=0x4 (Id=0)
    {
        enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
        union <unnamed-type-Data>// Size=0x8 (Id=15386)
        {
            struct <unnamed-type-EnterState>// Size=0x8 (Id=15387)
            {
            ...
            struct <unnamed-type-PostProcessState>// Size=0x4 (Id=15391)
            {
                enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
            };
            ...
            struct <unnamed-type-LeaveState>// Size=0x8 (Id=15394)
            {
                enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
                enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
            };
