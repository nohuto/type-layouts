...
union _WDF_USB_CONTROL_SETUP_PACKET// Size=0x8 (Id=398)
{
    struct <unnamed-type-Packet>// Size=0x8 (Id=18715)
    {
        union <unnamed-type-bm>// Size=0x1 (Id=18716)
        {
            struct <unnamed-type-Request>// Size=0x1 (Id=18717)
            {
        ...
        union <unnamed-type-wValue>// Size=0x2 (Id=18726)
        {
            struct <unnamed-type-Bytes>// Size=0x2 (Id=18727)
            {
        ...
        union <unnamed-type-wIndex>// Size=0x2 (Id=18733)
        {
            struct <unnamed-type-Bytes>// Size=0x2 (Id=18734)
            {
                unsigned char LowByte;// Offset=0x0 Size=0x1
                unsigned char HiByte;// Offset=0x1 Size=0x1
            };
    ...
    struct <unnamed-type-Generic>// Size=0x8 (Id=18742)
    {
...
struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_11// Size=0x20 (Id=2113)
{
    union // Size=0x8 (Id=0)
    {
        long UsbdStatus;// Offset=0x0 Size=0x4
        enum _WDF_USB_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
        union <unnamed-type-Parameters>// Size=0x18 (Id=19239)
        {
            struct <unnamed-type-DeviceString>// Size=0x10 (Id=19240)
            {
            ...
            struct <unnamed-type-DeviceControlTransfer>// Size=0x18 (Id=19246)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            ...
            struct <unnamed-type-DeviceUrb>// Size=0x8 (Id=19251)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            };
            ...
            struct <unnamed-type-PipeWrite>// Size=0x18 (Id=19254)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            ...
            struct <unnamed-type-PipeRead>// Size=0x18 (Id=19259)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
                unsigned long long Length;// Offset=0x8 Size=0x8
                unsigned long long Offset;// Offset=0x10 Size=0x8
            ...
            struct <unnamed-type-PipeUrb>// Size=0x8 (Id=19264)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            };
