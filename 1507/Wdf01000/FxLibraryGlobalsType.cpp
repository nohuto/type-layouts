struct _OSVERSIONINFOEXW// Size=0x11c (Id=866)
{
...
struct _FX_DRIVER_TRACKER_CACHE_AWARE// Size=0x18 (Id=748)
{
    union // Size=0x14d (Id=0)
    {
        struct _FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=7495)
        {
            struct _FX_DRIVER_GLOBALS * FxDriverGlobals;// Offset=0x0 Size=0x8
        };
        struct FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=7498)
        {
        };// Offset=0x0 Size=0x8
        long Initialize();
        void Uninitialize();
...
struct _WMI_WDF_NOTIFY_ROUTINES// Size=0x20 (Id=409)
{
...
struct FxLibraryGlobalsType// Size=0x298 (Id=1038)
{
