struct _ARBITER_TEST_ALLOCATION_PARAMETERS// Size=0x18 (Id=2465)
{
...
struct _ARBITER_RETEST_ALLOCATION_PARAMETERS// Size=0x18 (Id=2918)
{
    struct _LIST_ENTRY * ArbitrationList;// Offset=0x0 Size=0x8
    unsigned long AllocateFromCount;// Offset=0x8 Size=0x4
    struct _CM_PARTIAL_RESOURCE_DESCRIPTOR * AllocateFrom;// Offset=0x10 Size=0x8
...
struct _ARBITER_BOOT_ALLOCATION_PARAMETERS// Size=0x8 (Id=1784)
{
    struct _LIST_ENTRY * ArbitrationList;// Offset=0x0 Size=0x8
};

struct _ARBITER_QUERY_ALLOCATED_RESOURCES_PARAMETERS// Size=0x8 (Id=2622)
{
    struct _CM_PARTIAL_RESOURCE_LIST ** AllocatedResources;// Offset=0x0 Size=0x8
};

struct _ARBITER_QUERY_CONFLICT_PARAMETERS// Size=0x20 (Id=2453)
{
...
struct _ARBITER_QUERY_ARBITRATE_PARAMETERS// Size=0x8 (Id=2424)
{
    struct _LIST_ENTRY * ArbitrationList;// Offset=0x0 Size=0x8
};

struct _ARBITER_ADD_RESERVED_PARAMETERS// Size=0x8 (Id=3081)
{
    struct _DEVICE_OBJECT * ReserveDevice;// Offset=0x0 Size=0x8
};

struct _ARBITER_PARAMETERS// Size=0x20 (Id=3452)
{
    union // Size=0x20 (Id=0)
    {
        union <unnamed-type-Parameters>// Size=0x20 (Id=4806)
        {
