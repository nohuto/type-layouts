...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=1996)
{
...
struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION// Size=0x20 (Id=2048)
{
    ...
    {
        struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION::_unnamed_2050::<unnamed-type-ProcessorCore> ProcessorCore;// Offset=0x10 Size=0x1
        struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION::_unnamed_2049::<unnamed-type-NumaNode> NumaNode;// Offset=0x10 Size=0x4
