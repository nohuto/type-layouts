...
struct _WAIT_CONTEXT_BLOCK// Size=0x48 (Id=114)
{
...
struct _KDEVICE_QUEUE// Size=0x28 (Id=58)
{
...
struct _DEVICE_OBJECT// Size=0x150 (Id=120)
{
    short Type;// Offset=0x0 Size=0x2
    ...
    union _unnamed_119 Queue;// Offset=0x50 Size=0x48
