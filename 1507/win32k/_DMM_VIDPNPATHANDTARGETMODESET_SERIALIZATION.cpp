...
struct _D3DKMDT_VIDPN_PRESENT_PATH_SCALING_SUPPORT// Size=0x4 (Id=491)
{
...
struct _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION_SUPPORT// Size=0x4 (Id=477)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned int Identity:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
struct _D3DKMDT_VIDPN_PRESENT_PATH_TRANSFORMATION// Size=0x10 (Id=352)
{
...
struct _D3DKMDT_2DREGION// Size=0x8 (Id=336)
{
...
struct _D3DKMDT_COLOR_COEFF_DYNAMIC_RANGES// Size=0x10 (Id=513)
{
...
struct _D3DKMDT_VIDPN_PRESENT_PATH_COPYPROTECTION_SUPPORT// Size=0x4 (Id=525)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _D3DKMDT_VIDPN_PRESENT_PATH_COPYPROTECTION// Size=0x10c (Id=480)
{
...
struct _D3DKMDT_VIDPN_PRESENT_PATH// Size=0x168 (Id=284)
{
...
struct _D3DDDI_RATIONAL// Size=0x8 (Id=350)
{
...
struct _D3DKMDT_VIDEO_SIGNAL_INFO// Size=0x38 (Id=254)
{
    ...
    union // Size=0x4 (Id=0)
    {
        struct _D3DKMDT_VIDEO_SIGNAL_INFO::_unnamed_256::<unnamed-type-AdditionalSignalInfo> AdditionalSignalInfo;// Offset=0x30 Size=0x4
...
struct _D3DKMDT_VIDPN_TARGET_MODE// Size=0x48 (Id=248)
{
    unsigned int Id;// Offset=0x0 Size=0x4
    struct _D3DKMDT_VIDEO_SIGNAL_INFO VideoSignalInfo;// Offset=0x8 Size=0x38
    enum _D3DKMDT_MODE_PREFERENCE Preference;// Offset=0x40 Size=0x4
};

struct _DMM_VIDPNTARGETMODESET_SERIALIZATION// Size=0x50 (Id=285)
{
    unsigned char NumModes;// Offset=0x0 Size=0x1
    struct _D3DKMDT_VIDPN_TARGET_MODE ModeSerialization[1];// Offset=0x8 Size=0x48
};

struct _DMM_VIDPNPATHANDTARGETMODESET_SERIALIZATION// Size=0x1b8 (Id=147)
{
    struct _D3DKMDT_VIDPN_PRESENT_PATH PathInfo;// Offset=0x0 Size=0x168
    struct _DMM_VIDPNTARGETMODESET_SERIALIZATION TargetModeSet;// Offset=0x168 Size=0x50
};
