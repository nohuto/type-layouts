...
struct _D3DKMDT_FREQUENCY_RANGE// Size=0x20 (Id=451)
{
...
struct _D3DKMDT_MONITOR_FREQUENCY_RANGE// Size=0x30 (Id=240)
{
    union // Size=0x28 (Id=0)
    {
        ...
        union <unnamed-type-Constraint>// Size=0x8 (Id=1133)
        {
