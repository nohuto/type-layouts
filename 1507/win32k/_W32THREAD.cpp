...
struct _TLSPRITESTATE// Size=0xa8 (Id=215)
{
...
struct _W32THREAD// Size=0x178 (Id=117)
{
    ...
    unsigned long long RefCountInc;// Offset=0x158 Size=0x8
    unsigned long long RefCountDec;// Offset=0x160 Size=0x8
    void * pUmfdTls;// Offset=0x168 Size=0x8
    void * psoUMPDTmpSrc;// Offset=0x170 Size=0x8
};
