struct _EX_PUSH_LOCK// Size=0x8 (Id=72)
{
    union // Size=0x8 (Id=0)
    {
...
struct _RTL_BALANCED_LINKS// Size=0x20 (Id=522)
{
...
struct _RTL_AVL_TABLE// Size=0x68 (Id=459)
{
...
struct _W32PROCESS// Size=0x128 (Id=116)
{
    ...
    unsigned long long RefCountInc;// Offset=0x118 Size=0x8
    unsigned long long RefCountDec;// Offset=0x120 Size=0x8
};
