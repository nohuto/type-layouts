...
union _D3DKMDT_VIDEO_SIGNAL_INFO::_unnamed_255// Size=0x4 (Id=255)
{
    struct <unnamed-type-AdditionalSignalInfo>// Size=0x4 (Id=1194)
    {
    ...
    struct _D3DKMDT_VIDEO_SIGNAL_INFO::_unnamed_256::<unnamed-type-AdditionalSignalInfo> AdditionalSignalInfo;// Offset=0x0 Size=0x4
