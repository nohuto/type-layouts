...
struct _CM_PARTIAL_RESOURCE_DESCRIPTOR// Size=0x14 (Id=546)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x10 (Id=754)
        {
            ...
            struct <unnamed-type-MessageInterrupt>// Size=0x10 (Id=770)
            {
                struct _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-MessageInterrupt>::_unnamed_553::<unnamed-type-Raw> Raw;// Offset=0x0 Size=0x10
                struct _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-MessageInterrupt>::_unnamed_554::<unnamed-type-Translated> Translated;// Offset=0x0 Size=0x10
            };
            ...
            struct <unnamed-type-DmaV3>// Size=0xc (Id=783)
            {
                unsigned long Channel;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-DevicePrivate>// Size=0xc (Id=791)
            {
            ...
            struct <unnamed-type-BusNumber>// Size=0xc (Id=795)
            {
            ...
            struct <unnamed-type-DeviceSpecificData>// Size=0xc (Id=800)
            {
...
struct _CM_PARTIAL_RESOURCE_LIST// Size=0x1c (Id=541)
{
...
struct _CM_FULL_RESOURCE_DESCRIPTOR// Size=0x24 (Id=516)
{
...
struct _CM_RESOURCE_LIST// Size=0x28 (Id=475)
{
