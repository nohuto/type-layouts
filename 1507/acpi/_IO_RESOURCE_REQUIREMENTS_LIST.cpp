...
struct _unnamed_539// Size=0x10 (Id=539)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_542// Size=0x18 (Id=542)
{
...
union _unnamed_544// Size=0x18 (Id=544)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_534 Port;// Offset=0x0 Size=0x18
        struct _unnamed_534 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_536 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_537 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_538 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_534 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_378 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_539 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_540 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_541 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_542 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_543 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_384 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=545)
{
    ...
    union _unnamed_544 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=364)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=186)
{
