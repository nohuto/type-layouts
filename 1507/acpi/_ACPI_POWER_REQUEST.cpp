...
struct _ACPI_POWER_REQUEST_DEPENDENCY// Size=0x20 (Id=607)
{
...
struct _ACPI_POWER_WAKE_INTERRUPT_REGISTRATION_ENTRY// Size=0x28 (Id=615)
{
...
union _unnamed_581// Size=0x28 (Id=581)
{
...
struct _unnamed_582// Size=0x58 (Id=582)
{
    enum _SYSTEM_POWER_STATE SystemPowerState;// Offset=0x0 Size=0x4
    ...
    union _unnamed_581 Registrations;// Offset=0x30 Size=0x28
};
...
union _unnamed_584// Size=0x58 (Id=584)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_579 DevicePowerRequest;// Offset=0x0 Size=0x8
        struct _unnamed_580 SystemPowerRequest;// Offset=0x0 Size=0x8
        struct _unnamed_582 WaitWakeRequest;// Offset=0x0 Size=0x58
        struct _unnamed_583 EjectPowerRequest;// Offset=0x0 Size=0x4
    };
};
...
struct _ACPI_POWER_REQUEST// Size=0x108 (Id=585)
{
    ...
    union _unnamed_584 u;// Offset=0x68 Size=0x58
