...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=438)
{
...
struct _KAPC_STATE// Size=0x30 (Id=408)
{
...
struct _KLOCK_ENTRY_LOCK_STATE// Size=0x10 (Id=390)
{
    union // Size=0x8 (Id=0)
    {
...
struct _KLOCK_ENTRY// Size=0x60 (Id=265)
{
...
struct _CLIENT_ID// Size=0x10 (Id=437)
{
    void * UniqueProcess;// Offset=0x0 Size=0x8
    void * UniqueThread;// Offset=0x8 Size=0x8
};

struct _KSEMAPHORE// Size=0x20 (Id=420)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=184)
{
...
struct _PS_PROPERTY_SET// Size=0x18 (Id=241)
{
