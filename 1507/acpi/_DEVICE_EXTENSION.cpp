...
struct _unnamed_430// Size=0x4 (Id=430)
{
...
struct _FDO_DEVICE_EXTENSION// Size=0x80 (Id=431)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_430 UPm1Status;// Offset=0x38 Size=0x4
    };
    struct _KDPC InterruptDpc;// Offset=0x40 Size=0x40
};

struct _PCI_FILTER_EXTENSION// Size=0x14 (Id=576)
{
...
struct _FILTER_DEVICE_EXTENSION// Size=0x58 (Id=483)
{
    struct WORK_QUEUE_CONTEXT WorkContext;// Offset=0x0 Size=0x30
...
struct _PDO_DEVICE_EXTENSION// Size=0x30 (Id=530)
{
    struct WORK_QUEUE_CONTEXT WorkContext;// Offset=0x0 Size=0x30
};

struct _PROCESSOR_DEVICE_EXTENSION// Size=0x28 (Id=449)
{
...
struct _MODULE_DEVICE_EXTENSION// Size=0x38 (Id=371)
{
    struct EXTENSION_WORKER WorkQueue;// Offset=0x0 Size=0x18
...
struct _EC_DEVICE_EXTENSION// Size=0x20 (Id=487)
{
    struct EXTENSION_WORKER WorkQueue;// Offset=0x0 Size=0x18
...
struct _PCI_ROOT_BUS_DSM_CAPABILITY_STRUCTURE// Size=0x10 (Id=492)
{
...
struct _PCI_ROOT_BUS_OSC_CONTROL_FIELD// Size=0x4 (Id=518)
{
    union _unnamed_517 u;// Offset=0x0 Size=0x4
};

struct _PCI_ROOT_EXTENSION// Size=0x98 (Id=482)
{
    struct EXTENSION_WORKER WorkQueue;// Offset=0x0 Size=0x18
...
struct _ACPI_POWER_INFO// Size=0xe8 (Id=444)
{
...
struct _unnamed_548// Size=0x8 (Id=548)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _ACPI_DEVICE_INFORMATION// Size=0x28 (Id=549)
{
    union // Size=0x8 (Id=0)
    {
    ...
    union // Size=0x8 (Id=0)
    {
        ...
        struct _unnamed_548 ClassCode;// Offset=0x20 Size=0x8
    };
};
...
struct _unnamed_357// Size=0x8 (Id=357)
{
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned long long Prop_Unused:2;// Offset=0x0 Size=0x8 BitOffset=0x1e BitSize=0x2
        ...
        unsigned long long Cap_Unused:27;// Offset=0x0 Size=0x8 BitOffset=0x25 BitSize=0x1b
    };
};

struct _DEVICE_EXTENSION// Size=0x390 (Id=358)
{
    union // Size=0x8 (Id=0)
    {
        unsigned long long Flags;// Offset=0x0 Size=0x8
        struct _unnamed_351 UFlags;// Offset=0x0 Size=0x8
    };
    unsigned long Signature;// Offset=0x8 Size=0x4
    unsigned long DebugFlags;// Offset=0xc Size=0x4
    struct IRP_DISPATCH_TABLE * DispatchTable;// Offset=0x10 Size=0x8
    union // Size=0x98 (Id=0)
    {
        struct WORK_QUEUE_CONTEXT WorkContext;// Offset=0x18 Size=0x30
        struct _FDO_DEVICE_EXTENSION Fdo;// Offset=0x18 Size=0x80
        struct _FILTER_DEVICE_EXTENSION Filter;// Offset=0x18 Size=0x58
        struct _PDO_DEVICE_EXTENSION Pdo;// Offset=0x18 Size=0x30
        struct EXTENSION_WORKER WorkQueue;// Offset=0x98 Size=0x18
    };
    union // Size=0x138 (Id=0)
    {
        struct BUTTON_EXTENSION Button;// Offset=0x98 Size=0x30
        struct THERMAL_EXTENSION Thermal;// Offset=0x98 Size=0x48
        struct FAN_EXTENSION Fan;// Offset=0x98 Size=0xa0
        struct LINK_NODE_EXTENSION LinkNode;// Offset=0x98 Size=0x60
        struct DOCK_EXTENSION Dock;// Offset=0x98 Size=0x30
        struct _PROCESSOR_DEVICE_EXTENSION Processor;// Offset=0x98 Size=0x28
        struct _MODULE_DEVICE_EXTENSION Module;// Offset=0x98 Size=0x38
        struct _EC_DEVICE_EXTENSION Ec;// Offset=0x98 Size=0x20
        struct _PCI_ROOT_EXTENSION PciRoot;// Offset=0x98 Size=0x98
        enum _ACPI_DEVICE_STATE DeviceState;// Offset=0x138 Size=0x4
    };
    enum _ACPI_DEVICE_STATE PreviousState;// Offset=0x13c Size=0x4
    struct _ACPI_POWER_INFO PowerInfo;// Offset=0x140 Size=0xe8
    struct _ACPI_DEVICE_INFORMATION DeviceInformation;// Offset=0x228 Size=0x28
    struct _ObjData * FirmwareDependencies;// Offset=0x250 Size=0x8
    struct _THERMAL_COOLING_EXTENSION * CoolingExtension;// Offset=0x258 Size=0x8
    unsigned char CoolingEligible;// Offset=0x260 Size=0x1
    unsigned long OperationRegionMask;// Offset=0x264 Size=0x4
    struct _CM_RESOURCE_LIST * ResourceList;// Offset=0x268 Size=0x8
    struct _CM_RESOURCE_LIST * TranslatedResourceList;// Offset=0x270 Size=0x8
    struct _ObjData * PnpResourceList;// Offset=0x278 Size=0x8
    unsigned long * ForceActiveBothInterrupts;// Offset=0x280 Size=0x8
    unsigned long ForceActiveBothInterruptsCount;// Offset=0x288 Size=0x4
    struct _LIST_ENTRY InterruptPolarityCacheListHead;// Offset=0x290 Size=0x10
    long OutstandingIrpCount;// Offset=0x2a0 Size=0x4
    long ReferenceCount;// Offset=0x2a4 Size=0x4
    long HibernatePathCount;// Offset=0x2a8 Size=0x4
    long PagingPathCount;// Offset=0x2ac Size=0x4
    long SpecialPathCount;// Offset=0x2b0 Size=0x4
    struct _KEVENT * RemoveEvent;// Offset=0x2b8 Size=0x8
    struct _NSObjRef * AcpiObject;// Offset=0x2c0 Size=0x8
    struct _DEVICE_OBJECT * DeviceObject;// Offset=0x2c8 Size=0x8
    struct _DEVICE_OBJECT * TargetDeviceObject;// Offset=0x2d0 Size=0x8
    struct _DEVICE_OBJECT * PhysicalDeviceObject;// Offset=0x2d8 Size=0x8
    struct _DEVICE_EXTENSION * ParentExtension;// Offset=0x2e0 Size=0x8
    struct _LIST_ENTRY ChildDeviceList;// Offset=0x2e8 Size=0x10
    struct _LIST_ENTRY SiblingDeviceList;// Offset=0x2f8 Size=0x10
    struct _LIST_ENTRY EjectDeviceHead;// Offset=0x308 Size=0x10
    struct _LIST_ENTRY EjectDeviceList;// Offset=0x318 Size=0x10
    struct _LIST_ENTRY NotificationListHead;// Offset=0x328 Size=0x10
    struct _LIST_ENTRY RemovedDevice;// Offset=0x338 Size=0x10
    unsigned long AcpiObjectName;// Offset=0x348 Size=0x4
    struct _KEVENT NotificationDispatchLock;// Offset=0x350 Size=0x18
    struct _WORK_QUEUE_ITEM * NotificationWorkItem;// Offset=0x368 Size=0x8
    unsigned char NotificationWorkerInProgress;// Offset=0x370 Size=0x1
    enum _CCA_METHOD_EVALUATION_STATE CcaEvaluationState;// Offset=0x374 Size=0x4
    void * NativeMethodHandle;// Offset=0x378 Size=0x8
    struct _DEVICE_RESET_CONTEXT * CurrentResetRequest;// Offset=0x380 Size=0x8
    union // Size=0x8 (Id=0)
    {
        unsigned long long AuxiliaryFlags;// Offset=0x388 Size=0x8
        struct _unnamed_357 AuxiliaryUFlags;// Offset=0x388 Size=0x8
    };
};
