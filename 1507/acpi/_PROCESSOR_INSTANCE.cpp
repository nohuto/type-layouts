...
struct _RTL_RANGE_LIST// Size=0x20 (Id=316)
{
...
struct _PROCESSOR_NUMBER// Size=0x4 (Id=180)
{
...
struct _unnamed_452// Size=0xc (Id=452)
{
...
struct _HAL_INTERRUPT_TARGET_INFORMATION// Size=0x18 (Id=454)
{
    ...
    union // Size=0xc (Id=0)
    {
        struct _unnamed_452 Apic;// Offset=0xc Size=0xc
        struct _unnamed_453 Irt;// Offset=0xc Size=0xc
    };
};

struct _PROCESSOR_SINK_INFO// Size=0x1c (Id=347)
{
    unsigned long ApicId;// Offset=0x0 Size=0x4
    struct _HAL_INTERRUPT_TARGET_INFORMATION TargetInfo;// Offset=0x4 Size=0x18
};

struct _PROCESSOR_INSTANCE// Size=0x70 (Id=181)
{
