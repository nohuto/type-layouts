...
struct INPUT_STATE// Size=0xb8 (Id=480)
{
    ...
    struct _INTERRUPT_VECTOR_DATA CurrentInputState;// Offset=0x10 Size=0x50
    struct _INTERRUPT_VECTOR_DATA PossibleInputState;// Offset=0x60 Size=0x50
    unsigned char CurrentlyHalReserved;// Offset=0xb0 Size=0x1
    unsigned char PossiblyHalReserved;// Offset=0xb1 Size=0x1
};
