struct FxRequestBuffer// Size=0x20 (Id=555)
{
    union // Size=0x107 (Id=0)
    {
        void FxRequestBuffer();// Offset=0x0 Size=0x15
        long ValidateMemoryDescriptor(struct _FX_DRIVER_GLOBALS * ,struct _WDF_MEMORY_DESCRIPTOR * ,unsigned long );// Offset=0x0 Size=0xc4
        ...
        unsigned long GetBufferLength();// Offset=0x0 Size=0x89
        ...
        void AssignValues(void ** ,struct _MDL ** ,unsigned long * );// Offset=0x0 Size=0x107
        enum FxRequestBufferType DataType;// Offset=0x0 Size=0x4
        union <unnamed-type-u>// Size=0x18 (Id=59458)
        {
            struct <unnamed-type-Memory>// Size=0x10 (Id=59459)
            {
