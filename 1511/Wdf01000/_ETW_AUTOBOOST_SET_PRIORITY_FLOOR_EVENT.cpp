struct _ETW_AUTOBOOST_SET_PRIORITY_FLOOR_EVENT// Size=0x10 (Id=2671)
{
    ...
    union // Size=0x1 (Id=0)
    {
        ...
        {
            char NewIoPriorityFloor:4;// Offset=0xe Size=0x1 BitOffset=0x0 BitSize=0x4
            char OldIoPriority:4;// Offset=0xe Size=0x1 BitOffset=0x4 BitSize=0x4
        };
    ...
    union // Size=0x1 (Id=0)
    {
        struct // Size=0x1 (Id=0)
        {
            ...
            unsigned char BoostedOutstandingIrps:1;// Offset=0xf Size=0x1 BitOffset=0x2 BitSize=0x1
            unsigned char Reserved:5;// Offset=0xf Size=0x1 BitOffset=0x3 BitSize=0x5
        };
