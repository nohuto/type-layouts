...
struct _IRP// Size=0xd0 (Id=856)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=8771)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=8788)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=8789)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=8800)
        {
            struct <unnamed-type-Overlay>// Size=0x50 (Id=8801)
            {
