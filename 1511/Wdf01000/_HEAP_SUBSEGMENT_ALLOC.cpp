...
struct _HEAP_EVENT_SUBSEGMENT_ALLOC_FREE// Size=0x20 (Id=1538)
{
...
struct _HEAP_SUBSEGMENT_ALLOC// Size=0x40 (Id=2180)
{
    struct _SYSTEM_TRACE_HEADER Header;// Offset=0x0 Size=0x20
    struct _HEAP_EVENT_SUBSEGMENT_ALLOC_FREE Event;// Offset=0x20 Size=0x20
};
