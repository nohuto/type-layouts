struct _OSVERSIONINFOEXW// Size=0x11c (Id=867)
{
...
struct _KBUGCHECK_REASON_CALLBACK_RECORD// Size=0x30 (Id=509)
{
...
struct _FX_DRIVER_TRACKER_CACHE_AWARE// Size=0x18 (Id=749)
{
    union // Size=0x14b (Id=0)
    {
        struct _FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=7719)
        {
            struct _FX_DRIVER_GLOBALS * FxDriverGlobals;// Offset=0x0 Size=0x8
        };
        struct FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=7722)
        {
        };// Offset=0x0 Size=0x8
        long Initialize();
        void Uninitialize();
...
struct _WMI_WDF_NOTIFY_ROUTINES// Size=0x20 (Id=410)
{
...
struct FxLibraryGlobalsType// Size=0x298 (Id=1039)
{
