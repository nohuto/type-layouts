...
union _PCI_EXPRESS_TPH_REQUESTER_CAPABILITY_REGISTER// Size=0x4 (Id=2468)
{
...
union _PCI_EXPRESS_TPH_REQUESTER_CONTROL_REGISTER// Size=0x4 (Id=2600)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PCI_EXPRESS_TPH_REQUESTER_CAPABILITY// Size=0xc (Id=2341)
{
