...
struct _WDF_DRIVER_GLOBALS// Size=0x38 (Id=865)
{
...
struct _FX_DRIVER_GLOBALS// Size=0x1e0 (Id=543)
{
    ...
    union // Size=0x2ad (Id=0)
    {
        ...
        unsigned long FxEnhancedVerifierOptions;// Offset=0x188 Size=0x4
        unsigned long FxVerifierDbgWaitForSignalTimeoutInSec;// Offset=0x18c Size=0x4
        unsigned long DbgWaitForWakeInterruptIsrTimeoutInSec;// Offset=0x190 Size=0x4
