...
struct _ETW_TP_EVENT_CALLBACK_CANCEL// Size=0x50 (Id=1686)
{
    struct _SYSTEM_TRACE_HEADER Header;// Offset=0x0 Size=0x20
    void * PoolId;// Offset=0x20 Size=0x8
    void * TaskId;// Offset=0x28 Size=0x8
    void * Callback;// Offset=0x30 Size=0x8
    void * Context;// Offset=0x38 Size=0x8
    void * SubProcessTag;// Offset=0x40 Size=0x8
    unsigned long CancelCount;// Offset=0x48 Size=0x4
};
