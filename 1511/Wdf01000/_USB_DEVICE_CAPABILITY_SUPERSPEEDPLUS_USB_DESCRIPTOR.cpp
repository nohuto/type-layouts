union _USB_DEVICE_CAPABILITY_SUPERSPEEDPLUS_SPEED// Size=0x4 (Id=2237)
{
...
struct _USB_DEVICE_CAPABILITY_SUPERSPEEDPLUS_USB_DESCRIPTOR// Size=0x10 (Id=2004)
{
    union // Size=0x8 (Id=0)
    {
        ...
        union <unnamed-type-bmAttributes>// Size=0x4 (Id=14335)
        {
        ...
        union <unnamed-type-wFunctionalitySupport>// Size=0x2 (Id=14341)
        {
