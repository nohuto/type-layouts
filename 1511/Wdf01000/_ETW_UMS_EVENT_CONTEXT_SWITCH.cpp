...
struct _ETW_UMS_EVENT_CONTEXT_SWITCH// Size=0x38 (Id=3677)
{
    struct _SYSTEM_TRACE_HEADER Header;// Offset=0x0 Size=0x20
    unsigned long ScheduledThreadId;// Offset=0x20 Size=0x4
    unsigned long SwitchCount;// Offset=0x24 Size=0x4
    unsigned long KernelYieldCount;// Offset=0x28 Size=0x4
    unsigned long MixedYieldCount;// Offset=0x2c Size=0x4
    unsigned long YieldCount;// Offset=0x30 Size=0x4
};
