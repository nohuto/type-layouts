...
struct _WDF_IO_FORWARD_PROGRESS_RESERVED_POLICY_SETTINGS// Size=0x8 (Id=708)
{
    union // Size=0x8 (Id=0)
    {
        union <unnamed-type-Policy>// Size=0x8 (Id=17021)
        {
            struct <unnamed-type-ExaminePolicy>// Size=0x8 (Id=17022)
            {
...
struct _WDF_IO_QUEUE_FORWARD_PROGRESS_POLICY_V1_11// Size=0x28 (Id=1614)
{
