...
union FxPnpStateAndCaps// Size=0x4 (Id=1153)
{
    struct <unnamed-type-ByEnum>// Size=0x4 (Id=54684)
    {
    ...
    struct FxPnpStateAndCaps::<unnamed-type-ByEnum> ByEnum;// Offset=0x0 Size=0x4
