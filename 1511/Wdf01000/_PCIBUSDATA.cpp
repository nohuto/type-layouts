struct _PCI_SLOT_NUMBER// Size=0x4 (Id=3807)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=10912)
        {
            struct <unnamed-type-bits>// Size=0x4 (Id=10913)
            {
...
struct _PCIBUSDATA// Size=0x50 (Id=1866)
{
