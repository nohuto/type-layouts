struct _USB_SUPERSPEED_ENDPOINT_COMPANION_DESCRIPTOR// Size=0x6 (Id=2513)
{
    union // Size=0x3 (Id=0)
    {
        ...
        union <unnamed-type-bmAttributes>// Size=0x1 (Id=14502)
        {
            unsigned char AsUchar;// Offset=0x0 Size=0x1
            struct <unnamed-type-Bulk>// Size=0x1 (Id=14504)
            {
            ...
            struct <unnamed-type-Isochronous>// Size=0x1 (Id=14508)
            {
