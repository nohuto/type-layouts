...
struct _D3DKMDT_FREQUENCY_RANGE// Size=0x20 (Id=452)
{
...
struct _D3DKMDT_MONITOR_FREQUENCY_RANGE// Size=0x30 (Id=241)
{
    union // Size=0x28 (Id=0)
    {
        ...
        union <unnamed-type-Constraint>// Size=0x8 (Id=1131)
        {
...
struct _DMM_MONITORFREQUENCYRANGESET_SERIALIZATION// Size=0x38 (Id=140)
{
