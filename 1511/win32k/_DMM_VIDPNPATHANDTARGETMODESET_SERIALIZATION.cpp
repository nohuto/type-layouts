...
struct _D3DKMDT_VIDPN_PRESENT_PATH_SCALING_SUPPORT// Size=0x4 (Id=490)
{
...
struct _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION_SUPPORT// Size=0x4 (Id=476)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned int Identity:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
struct _D3DKMDT_VIDPN_PRESENT_PATH_TRANSFORMATION// Size=0x10 (Id=353)
{
...
struct _D3DKMDT_2DREGION// Size=0x8 (Id=337)
{
...
struct _D3DKMDT_COLOR_COEFF_DYNAMIC_RANGES// Size=0x10 (Id=512)
{
...
struct _D3DKMDT_VIDPN_PRESENT_PATH_COPYPROTECTION_SUPPORT// Size=0x4 (Id=523)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _D3DKMDT_VIDPN_PRESENT_PATH_COPYPROTECTION// Size=0x10c (Id=479)
{
...
struct _D3DKMDT_VIDPN_PRESENT_PATH// Size=0x168 (Id=285)
{
...
struct _D3DDDI_RATIONAL// Size=0x8 (Id=351)
{
...
struct _D3DKMDT_VIDEO_SIGNAL_INFO// Size=0x38 (Id=255)
{
    ...
    union // Size=0x4 (Id=0)
    {
        struct _D3DKMDT_VIDEO_SIGNAL_INFO::_unnamed_257::<unnamed-type-AdditionalSignalInfo> AdditionalSignalInfo;// Offset=0x30 Size=0x4
...
struct _D3DKMDT_VIDPN_TARGET_MODE// Size=0x48 (Id=249)
{
...
struct _DMM_VIDPNTARGETMODESET_SERIALIZATION// Size=0x50 (Id=286)
{
