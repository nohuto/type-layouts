union _unnamed_98// Size=0x8 (Id=98)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=70)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=351)
{
...
struct _unnamed_101// Size=0x58 (Id=101)
{
...
union _unnamed_102// Size=0x58 (Id=102)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_101 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=103)
{
    ...
    union _unnamed_98 AssociatedIrp;// Offset=0x18 Size=0x8
