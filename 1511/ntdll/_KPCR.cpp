struct _NT_TIB// Size=0x38 (Id=282)
{
...
struct _KDESCRIPTOR// Size=0x10 (Id=579)
{
...
struct _KSPECIAL_REGISTERS// Size=0xe0 (Id=471)
{
...
struct _CONTEXT// Size=0x4d0 (Id=405)
{
...
struct _KPROCESSOR_STATE// Size=0x5b0 (Id=373)
{
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=441)
{
...
struct _KTIMER_TABLE_ENTRY// Size=0x20 (Id=296)
{
...
struct _KTIMER_TABLE// Size=0x2200 (Id=292)
{
...
struct _KGATE// Size=0x18 (Id=286)
{
...
struct _PROC_IDLE_POLICY// Size=0x6 (Id=495)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=332)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=355)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=493)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=380)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROCESSOR_POWER_STATE// Size=0x1d0 (Id=334)
{
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=392)
{
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=262)
{
...
struct _IOP_IRP_STACK_PROFILER// Size=0x54 (Id=393)
{
    unsigned long Profile[20];// Offset=0x0 Size=0x50
    unsigned long TotalIrps;// Offset=0x50 Size=0x4
};

struct _KSHARED_READY_QUEUE// Size=0x260 (Id=244)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _KPRCB// Size=0x6900 (Id=40)
{
    ...
    unsigned short LdtSelector;// Offset=0x2cc0 Size=0x2
    unsigned short PrcbPad40;// Offset=0x2cc2 Size=0x2
    ...
    unsigned long PrcbPad41[22];// Offset=0x2d28 Size=0x58
    ...
    struct _SINGLE_LIST_ENTRY AbSelfIoBoostsList;// Offset=0x63f0 Size=0x8
    struct _SINGLE_LIST_ENTRY AbPropagateBoostsList;// Offset=0x63f8 Size=0x8
    struct _KDPC AbDpc;// Offset=0x6400 Size=0x40
    struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerCurrent;// Offset=0x6440 Size=0x54
    struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerPrevious;// Offset=0x6494 Size=0x54
    struct _KSHARED_READY_QUEUE LocalSharedReadyQueue;// Offset=0x6500 Size=0x260
    struct _KTIMER_EXPIRATION_TRACE TimerExpirationTrace[16];// Offset=0x6760 Size=0x100
    unsigned long TimerExpirationTraceCount;// Offset=0x6860 Size=0x4
    void * ExSaPageArray;// Offset=0x6868 Size=0x8
    struct _REQUEST_MAILBOX * Mailbox;// Offset=0x6880 Size=0x8
    struct _REQUEST_MAILBOX RequestMailbox[1];// Offset=0x68c0 Size=0x40
};

struct _KPCR// Size=0x6a80 (Id=39)
{
    ...
    struct _KPRCB Prcb;// Offset=0x180 Size=0x6900
};
