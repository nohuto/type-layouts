...
struct _HEAP_UNPACKED_ENTRY// Size=0x10 (Id=251)
{
...
struct _HEAP_EXTENDED_ENTRY// Size=0x10 (Id=378)
{
...
struct _HEAP_ENTRY// Size=0x10 (Id=192)
{
    union // Size=0x10 (Id=0)
    {
...
struct _EXCEPTION_RECORD// Size=0x98 (Id=374)
{
...
struct _HEAP_FAILURE_INFORMATION// Size=0x6e0 (Id=284)
{
    ...
    struct _HEAP_ENTRY * PreviousBlock;// Offset=0x38 Size=0x8
    struct _HEAP_ENTRY * NextBlock;// Offset=0x40 Size=0x8
    struct _HEAP_ENTRY ExpectedEncodedEntry;// Offset=0x48 Size=0x10
    struct _HEAP_ENTRY ExpectedDecodedEntry;// Offset=0x58 Size=0x10
    void * StackTrace[32];// Offset=0x68 Size=0x100
    unsigned char HeapMajorVersion;// Offset=0x168 Size=0x1
    unsigned char HeapMinorVersion;// Offset=0x169 Size=0x1
    struct _EXCEPTION_RECORD ExceptionRecord;// Offset=0x170 Size=0x98
    struct _CONTEXT ContextRecord;// Offset=0x210 Size=0x4d0
};
