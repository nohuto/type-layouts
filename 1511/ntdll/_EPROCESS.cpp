...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=473)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=336)
{
...
struct _MMSUPPORT// Size=0xf8 (Id=271)
{
...
struct _ALPC_PROCESS_CONTEXT// Size=0x20 (Id=288)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=472)
{
    union // Size=0x1 (Id=0)
    {
...
struct _EPROCESS// Size=0x788 (Id=94)
{
    ...
    struct _MMSUPPORT Vm;// Offset=0x500 Size=0xf8
    struct _LIST_ENTRY MmProcessLinks;// Offset=0x5f8 Size=0x10
    unsigned long ModifiedPageCount;// Offset=0x608 Size=0x4
    long ExitStatus;// Offset=0x60c Size=0x4
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long ProhibitRemoteImageMap:1;// Offset=0x6b4 Size=0x4 BitOffset=0xb BitSize=0x1
            unsigned long ProhibitLowILImageMap:1;// Offset=0x6b4 Size=0x4 BitOffset=0xc BitSize=0x1
            unsigned long SignatureMitigationOptIn:1;// Offset=0x6b4 Size=0x4 BitOffset=0xd BitSize=0x1
        };
    };
    ...
    unsigned long long SequenceNumber;// Offset=0x728 Size=0x8
    unsigned long long CreateInterruptTime;// Offset=0x730 Size=0x8
    unsigned long long CreateUnbiasedInterruptTime;// Offset=0x738 Size=0x8
    unsigned long long TotalUnbiasedFrozenTime;// Offset=0x740 Size=0x8
    unsigned long long LastAppStateUpdateTime;// Offset=0x748 Size=0x8
    struct // Size=0x8 (Id=0)
    {
        unsigned long long LastAppStateUptime:61;// Offset=0x750 Size=0x8 BitOffset=0x0 BitSize=0x3d
        unsigned long long LastAppState:3;// Offset=0x750 Size=0x8 BitOffset=0x3d BitSize=0x3
    };
    unsigned long long SharedCommitCharge;// Offset=0x758 Size=0x8
    struct _EX_PUSH_LOCK SharedCommitLock;// Offset=0x760 Size=0x8
    struct _LIST_ENTRY SharedCommitLinks;// Offset=0x768 Size=0x10
    union // Size=0x788 (Id=0)
    {
        unsigned long long AllowedCpuSets;// Offset=0x778 Size=0x8
        unsigned long long DefaultCpuSets;// Offset=0x780 Size=0x8
        unsigned long long * AllowedCpuSetsIndirect;// Offset=0x778 Size=0x8
        unsigned long long * DefaultCpuSetsIndirect;// Offset=0x780 Size=0x8
    };
};
