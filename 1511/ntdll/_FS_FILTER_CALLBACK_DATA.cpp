...
struct _unnamed_564// Size=0x8 (Id=564)
{
...
struct _unnamed_566// Size=0x10 (Id=566)
{
...
struct _unnamed_569// Size=0x28 (Id=569)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=570)
{
    struct _unnamed_563 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_564 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_566 AcquireForSectionSynchronization;// Offset=0x0 Size=0x10
    struct _unnamed_568 NotifyStreamFileObject;// Offset=0x0 Size=0x10
    struct _unnamed_569 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=451)
{
