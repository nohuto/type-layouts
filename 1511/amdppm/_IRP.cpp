union _unnamed_69// Size=0x8 (Id=69)
{
...
union _unnamed_71// Size=0x10 (Id=71)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_70 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=424)
{
...
struct _unnamed_72// Size=0x58 (Id=72)
{
...
union _unnamed_73// Size=0x58 (Id=73)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_72 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=74)
{
    ...
    union _unnamed_69 AssociatedIrp;// Offset=0x18 Size=0x8
