...
struct _unnamed_283// Size=0x18 (Id=283)
{
...
struct _unnamed_285// Size=0x20 (Id=285)
{
...
union _unnamed_286// Size=0x20 (Id=286)
{
    struct _unnamed_75 Create;// Offset=0x0 Size=0x20
    struct _unnamed_283 Read;// Offset=0x0 Size=0x18
    struct _unnamed_283 Write;// Offset=0x0 Size=0x18
    struct _unnamed_284 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_285 Others;// Offset=0x0 Size=0x20
};

struct _WDF_REQUEST_PARAMETERS// Size=0x28 (Id=287)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned char MinorFunction;// Offset=0x2 Size=0x1
    enum _WDF_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    union _unnamed_286 Parameters;// Offset=0x8 Size=0x20
};
