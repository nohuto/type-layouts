...
struct _RUNTIME_IDLE_CONTEXT// Size=0x18 (Id=494)
{
    union // Size=0xc (Id=0)
    {
...
struct _RUNTIME_IDLE_STATE// Size=0x48 (Id=456)
{
    ...
    void  ( * Handler)(struct _RUNTIME_IDLE_CONTEXT * );// Offset=0x18 Size=0x8
...
struct _RUNTIME_IDLE_STATES// Size=0x88 (Id=428)
{
