struct _PEP_PROCESSOR_IDLE_DEPENDENCY// Size=0x10 (Id=462)
{
    union // Size=0x8 (Id=0)
    {
...
struct _PEP_PLATFORM_IDLE_STATE// Size=0x30 (Id=559)
{
    union // Size=0x8 (Id=0)
    {
...
struct _PEP_PPM_QUERY_PLATFORM_STATE// Size=0x38 (Id=525)
{
