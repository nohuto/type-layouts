...
struct _PROCESSOR_PERF_STATES// Size=0x198 (Id=535)
{
    ...
    void  ( * PerfControlReadFeedback)(void  ( * )());// Offset=0x150 Size=0x8
    void  ( * PerfControlAcquirePerformance)(void  ( * )());// Offset=0x158 Size=0x8
    void  ( * PerfControlCommitPerformance)(void  ( * )());// Offset=0x160 Size=0x8
    void  ( * ParkPreference)(unsigned char ,unsigned long long ,unsigned long ,struct _KAFFINITY_EX * ,struct _KAFFINITY_EX * ,struct _KAFFINITY_EX * ,struct _KAFFINITY_EX * );// Offset=0x168 Size=0x8
    void  ( * ParkMask)(unsigned long long ,struct _KAFFINITY_EX * );// Offset=0x170 Size=0x8
    void  ( * PerfCheckComplete)(unsigned long long ,unsigned long long );// Offset=0x178 Size=0x8
    struct _PROCESSOR_FEEDBACK_COUNTER * FeedbackCounters;// Offset=0x180 Size=0x8
    struct _PROCESSOR_PERF_INFO * Processors;// Offset=0x188 Size=0x8
    unsigned long long * CounterContexts;// Offset=0x190 Size=0x8
};
