...
struct _PROCESSOR_IDLE_STATE_EX// Size=0x20 (Id=595)
{
...
struct _PROCESSOR_IDLE_STATES_EX// Size=0x90 (Id=591)
{
    ...
    long  ( * IdleExecute)(void * ,unsigned long ,unsigned long ,unsigned long ,unsigned long * );// Offset=0x48 Size=0x8
