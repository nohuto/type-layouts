...
struct _unnamed_362// Size=0x8 (Id=362)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_363// Size=0x4 (Id=363)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_364// Size=0x8 (Id=364)
{
    struct _unnamed_362 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_363 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_362 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=365)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_364 Data;// Offset=0x4 Size=0x8
};
