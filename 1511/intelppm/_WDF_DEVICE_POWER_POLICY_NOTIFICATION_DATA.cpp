...
{
    struct _unnamed_410 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_411 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_410 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=413)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_412 Data;// Offset=0x4 Size=0x8
};
