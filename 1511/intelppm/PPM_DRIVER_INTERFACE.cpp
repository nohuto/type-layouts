struct PPM_DRIVER_INTERFACE// Size=0xd0 (Id=399)
{
    ...
    void  ( * ComputeEnergy)(unsigned long ,unsigned long long ,unsigned long long ,unsigned long ,unsigned long long * );// Offset=0xa0 Size=0x8
