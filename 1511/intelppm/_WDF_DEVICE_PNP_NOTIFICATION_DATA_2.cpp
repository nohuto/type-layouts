...
struct _unnamed_498// Size=0x8 (Id=498)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_499// Size=0x4 (Id=499)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_500// Size=0x8 (Id=500)
{
    struct _unnamed_498 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_499 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_498 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=501)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_500 Data;// Offset=0x4 Size=0x8
};
