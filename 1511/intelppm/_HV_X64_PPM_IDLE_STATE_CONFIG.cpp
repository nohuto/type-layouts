...
union _HV_X64_PPM_IDLE_STATE_CONFIG// Size=0x8 (Id=423)
{
    ...
    struct _unnamed_420 Hlt;// Offset=0x0 Size=0x8
    struct _unnamed_421 Io;// Offset=0x0 Size=0x8
    struct _unnamed_422 Mwait;// Offset=0x0 Size=0x8
};
