...
struct _PROCESSOR_NUMBER// Size=0x4 (Id=141)
{
...
struct _STOR_EVENT_QUEUE_ENTRY// Size=0x38 (Id=201)
{
...
struct _unnamed_202// Size=0x28 (Id=202)
{
...
union _unnamed_203// Size=0x18 (Id=203)
{
...
struct _EXTENDED_REQUEST_BLOCK// Size=0x310 (Id=204)
{
    ...
    struct _unnamed_202 SrbData;// Offset=0xb0 Size=0x28
    ...
    union _unnamed_203 u;// Offset=0x298 Size=0x18
...
struct _IO_RESOURCE_ENTRY// Size=0x420 (Id=258)
{
    union // Size=0x10 (Id=0)
    {
        struct _SLIST_ENTRY Entry;// Offset=0x0 Size=0x10
        unsigned long HashIndex;// Offset=0x0 Size=0x4
        struct _EXTENDED_REQUEST_BLOCK Xrb;// Offset=0x10 Size=0x310
    };
    unsigned char SenseInfoBuffer[256];// Offset=0x320 Size=0x100
