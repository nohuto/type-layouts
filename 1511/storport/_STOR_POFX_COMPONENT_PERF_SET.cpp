...
union _unnamed_159// Size=0x10 (Id=159)
{
    struct _unnamed_157 Discrete;// Offset=0x0 Size=0x8
    struct _unnamed_158 Range;// Offset=0x0 Size=0x10
};

struct _STOR_POFX_COMPONENT_PERF_SET// Size=0x28 (Id=160)
{
    ...
    union _unnamed_159 PStates;// Offset=0x18 Size=0x10
};
