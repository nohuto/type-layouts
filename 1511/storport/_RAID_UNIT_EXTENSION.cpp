...
struct _STOR_ADDR_BTL8// Size=0x10 (Id=212)
{
...
struct _STOR_SCSI_ADDRESS// Size=0x4 (Id=183)
{
...
struct _STOR_SCSI_IDENTITY// Size=0x30 (Id=184)
{
...
struct _unnamed_215// Size=0x8 (Id=215)
{
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned long Reserved:14;// Offset=0x4 Size=0x4 BitOffset=0x0 BitSize=0xe
    };
};
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=300)
{
    union // Size=0x4 (Id=0)
    {
...
struct _RAID_POWER_STATE// Size=0x10 (Id=259)
{
...
struct _QUEUE_TAG_LIST// Size=0x80 (Id=179)
{
...
struct _EXTENDED_DEVICE_QUEUE// Size=0x88 (Id=196)
{
...
struct _IO_QUEUE// Size=0xa0 (Id=195)
{
...
struct _KTIMER// Size=0x40 (Id=283)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _RAID_DEFERRED_HEADER// Size=0x20 (Id=380)
{
...
struct _unnamed_460// Size=0x4 (Id=460)
{
    unsigned long Timeout;// Offset=0x0 Size=0x4
};

struct _unnamed_461// Size=0x4 (Id=461)
{
...
struct _unnamed_462// Size=0x18 (Id=462)
{
...
struct _unnamed_463// Size=0x8 (Id=463)
{
    struct _STOR_ASYNC_NOTIFY_CONTEXT * StorAsyncNotify;// Offset=0x0 Size=0x8
};

struct _RAID_DEFERRED_ELEMENT// Size=0x50 (Id=464)
{
    ...
    {
        struct _unnamed_458 Timer;// Offset=0x28 Size=0x10
        struct _unnamed_459 Error;// Offset=0x28 Size=0x20
        struct _unnamed_460 PauseDevice;// Offset=0x28 Size=0x4
        struct _unnamed_461 Busy;// Offset=0x28 Size=0x4
        struct _unnamed_461 DeviceBusy;// Offset=0x28 Size=0x4
        struct _unnamed_462 AdditionalTimer;// Offset=0x28 Size=0x18
        struct _unnamed_463 AsyncNotification;// Offset=0x28 Size=0x8
    };
};

struct _unnamed_218// Size=0x190 (Id=218)
{
...
struct _RAID_IO_RESOURCES// Size=0x20 (Id=223)
{
...
struct _RAID_UNIT_REGISTRY_PARAMETERS// Size=0x18 (Id=318)
{
...
struct _RAID_UNIT_ATTRIBUTES// Size=0x4 (Id=391)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _UNICODE_STRING// Size=0x10 (Id=292)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    unsigned short MaximumLength;// Offset=0x2 Size=0x2
...
struct _RAID_WORK_ITEM_CONTEXT// Size=0x10 (Id=344)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
    struct _IRP * Irp;// Offset=0x8 Size=0x8
};

struct _STOR_ASYNC_NOTIFY_CONTEXT// Size=0x18 (Id=388)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
...
struct _RAID_SHARED_WORK_ITEM_CONTEXT// Size=0x18 (Id=298)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
    struct _IRP * Irp;// Offset=0x8 Size=0x8
    unsigned long InUse;// Offset=0x10 Size=0x4
...
union _unnamed_558// Size=0x4 (Id=558)
{
    unsigned long Quantity;// Offset=0x0 Size=0x4
    unsigned long Position;// Offset=0x0 Size=0x4
};

struct _RAID_TELEMETRY_ERROR_ENTRY// Size=0x28 (Id=559)
{
    ...
    union _unnamed_558 u;// Offset=0x20 Size=0x4
};

struct _RAID_TELEMETRY_SAMPLED_ERROR_LOG// Size=0x1c0 (Id=497)
{
    unsigned long TotalErrors;// Offset=0x0 Size=0x4
    struct _RAID_TELEMETRY_ERROR_ENTRY LastError;// Offset=0x8 Size=0x28
    struct _RAID_TELEMETRY_ERROR_ENTRY SampledErrors[10];// Offset=0x30 Size=0x190
};

struct _RAID_TELEMETRY_UNIQUE_ERROR_LOG// Size=0xc8 (Id=387)
{
    struct _RAID_TELEMETRY_ERROR_ENTRY UniqueErrors[5];// Offset=0x0 Size=0xc8
};

struct _RAID_UNIT_QOS// Size=0x30 (Id=481)
{
...
struct _RAID_UNIT_EXTENSION// Size=0xa40 (Id=222)
{
    ...
    struct _unnamed_215 Flags;// Offset=0x90 Size=0x8
    union _unnamed_216 InterlockedFlags;// Offset=0x98 Size=0x4
    ...
    struct _unnamed_218 DeferredList;// Offset=0x3f0 Size=0x190
    ...
    struct _unnamed_221 PendingPowerUpContext;// Offset=0x658 Size=0x10
    ...
    unsigned long long FirstDPNRTimeAfterCS;// Offset=0x6a8 Size=0x8
    unsigned long long LastF1StartTime;// Offset=0x6b0 Size=0x8
    unsigned long long F1DurationInCS;// Offset=0x6b8 Size=0x8
    unsigned long long LastDPNRStartTime;// Offset=0x6c0 Size=0x8
    unsigned long long DPNRDurationInCS;// Offset=0x6c8 Size=0x8
    unsigned long long ActiveReferencesInCS;// Offset=0x6d0 Size=0x8
    unsigned long long ActiveReferencesInCoalescing;// Offset=0x6d8 Size=0x8
    unsigned long UnitTimeoutsInCS;// Offset=0x6e0 Size=0x4
    unsigned long F0TransitionsSinceCSStateChange;// Offset=0x6e4 Size=0x4
    unsigned long D0TransitionsSinceCSStateChange;// Offset=0x6e8 Size=0x4
    unsigned long F0TransitionsLongSinceCSStateChange;// Offset=0x6ec Size=0x4
    unsigned long D0TransitionsLongSinceCSStateChange;// Offset=0x6f0 Size=0x4
    unsigned long long UnresponsiveRequests;// Offset=0x6f8 Size=0x8
    unsigned long long QosGuaranteeFailures;// Offset=0x700 Size=0x8
    unsigned long long TimeoutsInGateway;// Offset=0x708 Size=0x8
    unsigned long long TimeoutsInLunQueue;// Offset=0x710 Size=0x8
    unsigned long TimeoutsInMiniport;// Offset=0x718 Size=0x4
    unsigned long PeriodicMaxDeviceCountAtSwTimeout;// Offset=0x71c Size=0x4
    unsigned long StorpTraceLoggingPerformanceEnabled;// Offset=0x720 Size=0x4
    struct _RAID_TELEMETRY_PERF_BUCKET * TelemetryPerfBuckets;// Offset=0x728 Size=0x8
    union _LARGE_INTEGER TelemetryLastPerfCollectionTimeStamp;// Offset=0x730 Size=0x8
    struct _RAID_TELEMETRY_PERF_BUCKET * TelemetryPerfPreviousCounters;// Offset=0x738 Size=0x8
    unsigned long long TelemetryLock;// Offset=0x740 Size=0x8
    struct _RAID_TELEMETRY_SAMPLED_ERROR_LOG TelemetrySampledErrorLog;// Offset=0x748 Size=0x1c0
    struct _RAID_TELEMETRY_UNIQUE_ERROR_LOG TelemetryUniqueErrorLog;// Offset=0x908 Size=0xc8
    unsigned long PowerCycleCount;// Offset=0x9d0 Size=0x4
    union _LARGE_INTEGER InitialTimestamp;// Offset=0x9d8 Size=0x8
    struct _RAID_UNIT_QOS Qos;// Offset=0x9e0 Size=0x30
    unsigned long long LastHierarchicalResetEndTime;// Offset=0xa10 Size=0x8
};
