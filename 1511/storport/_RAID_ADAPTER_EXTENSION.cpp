...
struct _unnamed_224// Size=0x6 (Id=224)
{
...
struct _STOR_LOCKED_LIST// Size=0x20 (Id=248)
{
...
struct _STOR_DICTIONARY// Size=0x30 (Id=177)
{
...
struct _RAID_RESOURCE_LIST// Size=0x10 (Id=263)
{
...
struct _MEMORY_REGION// Size=0x18 (Id=393)
{
...
struct _PORT_CONFIGURATION_INFORMATION// Size=0xe0 (Id=246)
{
...
struct _RAID_MINIPORT// Size=0x128 (Id=250)
{
    ...
    struct _unnamed_249 Flags;// Offset=0xf8 Size=0x1
...
struct _BUS_INTERFACE_STANDARD// Size=0x40 (Id=316)
{
...
struct _RAID_BUS_INTERFACE// Size=0x48 (Id=299)
{
...
struct _RAID_MEMORY_REGION// Size=0x18 (Id=182)
{
    unsigned char * VirtualBase;// Offset=0x0 Size=0x8
    union _LARGE_INTEGER PhysicalBase;// Offset=0x8 Size=0x8
    unsigned long Length;// Offset=0x10 Size=0x4
...
struct _IO_CONT_RESOURCE_LIST// Size=0x80 (Id=390)
{
...
struct _STOR_NOTIFICATION_INFO// Size=0x20 (Id=419)
{
...
struct _STOR_IO_GATEWAY// Size=0x140 (Id=213)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _RAID_DEFERRED_QUEUE// Size=0x80 (Id=197)
{
...
struct _unnamed_227// Size=0x50 (Id=227)
{
    struct _RAID_DEFERRED_ELEMENT Timer;// Offset=0x0 Size=0x50
};

struct _unnamed_228// Size=0xb0 (Id=228)
{
...
struct _PORT_REGISTRY_INFO// Size=0x40 (Id=310)
{
...
struct _RAID_ADAPTER_PARAMETERS// Size=0x38 (Id=443)
{
...
struct _unnamed_230// Size=0x1 (Id=230)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _SCSI_POWER_REQUEST_BLOCK// Size=0x58 (Id=500)
{
    unsigned short Length;// Offset=0x0 Size=0x2
...
struct _STORAGE_REQUEST_BLOCK// Size=0x80 (Id=207)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    unsigned char Function;// Offset=0x2 Size=0x1
    unsigned char SrbStatus;// Offset=0x3 Size=0x1
...
struct _RAID_POWER_CONTEXT// Size=0xb8 (Id=454)
{
...
struct _STORPORT_EXTENDED_FUNCTIONS// Size=0x58 (Id=346)
{
...
union _RAID_REDIRECTION_SUPPORT// Size=0x2 (Id=513)
{
    struct // Size=0x2 (Id=0)
    {
...
struct _PCI_HEADER_TYPE_0// Size=0x30 (Id=410)
{
...
struct _unnamed_447// Size=0x8 (Id=447)
{
    unsigned long Base;// Offset=0x0 Size=0x4
    unsigned long Limit;// Offset=0x4 Size=0x4
};

struct _PCI_HEADER_TYPE_2// Size=0x30 (Id=448)
{
    ...
    unsigned char SubordinateBus;// Offset=0xa Size=0x1
    unsigned char SecondaryLatency;// Offset=0xb Size=0x1
    struct _unnamed_447 Range[4];// Offset=0xc Size=0x20
    unsigned char InterruptLine;// Offset=0x2c Size=0x1
    unsigned char InterruptPin;// Offset=0x2d Size=0x1
    unsigned short BridgeControl;// Offset=0x2e Size=0x2
};

union _unnamed_355// Size=0x30 (Id=355)
{
...
struct _PCI_COMMON_HEADER// Size=0x40 (Id=356)
{
    ...
    union _unnamed_355 u;// Offset=0x10 Size=0x30
};

struct _STOR_POWER_SETTING_NOTIFICATION// Size=0x18 (Id=330)
{
...
struct _CRASHDUMP_FUNCTIONS_INTERFACE// Size=0x28 (Id=437)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
struct _RAID_ADAPTER_EXTENSION// Size=0x1600 (Id=232)
{
    ...
    struct _unnamed_224 Flags;// Offset=0x68 Size=0x6
    ...
    struct _unnamed_227 DeferredList;// Offset=0x4c0 Size=0x50
    struct _unnamed_228 DeferredPauseResumeContext;// Offset=0x510 Size=0xb0
    ...
    struct _unnamed_230 PerfOptFlags;// Offset=0x1163 Size=0x1
    ...
    struct _unnamed_231 TelemetryHierarchicalResetLunBucket[5];// Offset=0x145c Size=0x3c
    struct _unnamed_231 TelemetryHierarchicalResetTargetBucket[5];// Offset=0x1498 Size=0x3c
    ...
    unsigned long MiniportFirmwareDataStructureVersion;// Offset=0x1544 Size=0x4
    struct _D3COLD_SUPPORT_INTERFACE * D3ColdInterface;// Offset=0x1548 Size=0x8
    void * ProtocolCommandEffects;// Offset=0x1550 Size=0x8
