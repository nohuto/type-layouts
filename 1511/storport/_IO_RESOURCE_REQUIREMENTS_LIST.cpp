...
struct _unnamed_539// Size=0x18 (Id=539)
{
...
struct _unnamed_541// Size=0x18 (Id=541)
{
...
struct _unnamed_543// Size=0x10 (Id=543)
{
...
struct _unnamed_544// Size=0x10 (Id=544)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_546// Size=0x18 (Id=546)
{
...
struct _unnamed_548// Size=0x18 (Id=548)
{
...
union _unnamed_549// Size=0x18 (Id=549)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_539 Port;// Offset=0x0 Size=0x18
        struct _unnamed_539 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_541 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_542 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_543 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_539 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_428 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_544 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_545 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_546 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_547 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_548 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_434 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=550)
{
    ...
    union _unnamed_549 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=417)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=297)
{
