union _unnamed_350// Size=0x4 (Id=350)
{
...
struct _USB_DEVICE_CAPABILITY_USB20_EXTENSION_DESCRIPTOR// Size=0x7 (Id=351)
{
    ...
    union _unnamed_350 bmAttributes;// Offset=0x3 Size=0x4
};
