...
struct _USB_ACPI_ATTRIBUTES// Size=0x1c (Id=305)
{
    struct _ACPI_UPC_PACKAGE UpcPackage;// Offset=0x0 Size=0xc
    struct _ACPI_PLD_BUFFER PldBuffer;// Offset=0xc Size=0x10
};
