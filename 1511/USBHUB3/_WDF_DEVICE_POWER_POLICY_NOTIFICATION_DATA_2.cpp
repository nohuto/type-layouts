...
union _unnamed_480// Size=0x8 (Id=480)
{
    struct _unnamed_478 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_479 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_478 LeaveState;// Offset=0x0 Size=0x8
};
...
struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=191)
{
    ...
    union _unnamed_480 Data;// Offset=0x4 Size=0x8
};
