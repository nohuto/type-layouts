...
struct _SECURITY_SUBJECT_CONTEXT// Size=0x20 (Id=662)
{
...
struct _LUID_AND_ATTRIBUTES// Size=0xc (Id=676)
{
    struct _LUID Luid;// Offset=0x0 Size=0x8
    unsigned long Attributes;// Offset=0x8 Size=0x4
};

struct _INITIAL_PRIVILEGE_SET// Size=0x2c (Id=669)
{
...
union _unnamed_654// Size=0x2c (Id=654)
{
...
struct _ACCESS_STATE// Size=0xa0 (Id=655)
{
    ...
    union _unnamed_654 Privileges;// Offset=0x50 Size=0x2c
