...
struct _unnamed_609// Size=0x8 (Id=609)
{
...
union _unnamed_611// Size=0x8 (Id=611)
{
    struct _unnamed_609 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_610 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_609 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=612)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_611 Data;// Offset=0x4 Size=0x8
};
