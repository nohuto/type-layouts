union _WHEA_REVISION// Size=0x2 (Id=416)
{
...
union _WHEA_TIMESTAMP// Size=0x8 (Id=535)
{
...
union _WHEA_ERROR_RECORD_HEADER_FLAGS// Size=0x4 (Id=569)
{
    struct // Size=0x4 (Id=0)
    {
...
union _WHEA_PERSISTENCE_INFO// Size=0x8 (Id=664)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WHEA_ERROR_RECORD_HEADER// Size=0x80 (Id=418)
{
...
union _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_VALIDBITS// Size=0x1 (Id=558)
{
...
union _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_FLAGS// Size=0x4 (Id=470)
{
    struct // Size=0x4 (Id=0)
    {
