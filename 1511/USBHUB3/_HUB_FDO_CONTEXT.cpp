union _HUB_FLAGS// Size=0x4 (Id=638)
{
...
union _USB_30_PORT_STATUS// Size=0x2 (Id=585)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_PORT_STATUS// Size=0x2 (Id=506)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
...
union _USB_20_PORT_CHANGE// Size=0x2 (Id=594)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_30_PORT_CHANGE// Size=0x2 (Id=593)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_PORT_CHANGE// Size=0x2 (Id=573)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
...
union _USB_PORT_STATUS_AND_CHANGE// Size=0x4 (Id=495)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
...
struct _HUBUCX_ROOTHUB_INFO// Size=0x18 (Id=634)
{
...
struct _HUB_INFORMATION// Size=0x70 (Id=551)
{
    ...
    struct _HUBUCX_ROOTHUB_INFO RootHubInfo;// Offset=0x38 Size=0x18
    struct _ROOTHUB_20PORT_INFO ** RootHub20PortInfoPointerArray;// Offset=0x50 Size=0x8
    struct _ROOTHUB_30PORT_INFO_EX ** RootHub30PortInfoPointerArray;// Offset=0x58 Size=0x8
    unsigned short NumberOf20Ports;// Offset=0x60 Size=0x2
    unsigned short First20PortNumber;// Offset=0x62 Size=0x2
    unsigned short Last20PortNumber;// Offset=0x64 Size=0x2
    unsigned short NumberOf30Ports;// Offset=0x66 Size=0x2
    unsigned short First30PortNumber;// Offset=0x68 Size=0x2
    unsigned short Last30PortNumber;// Offset=0x6a Size=0x2
    unsigned long SuperSpeedPlusIsochBurstCount;// Offset=0x6c Size=0x4
};
...
struct _USB_TOPOLOGY_ADDRESS// Size=0x20 (Id=577)
{
...
struct _HUB_PARENT_INTERFACE// Size=0x88 (Id=443)
{
...
struct _HUB_CONTROLLERSTACK_INTERFACE// Size=0xf0 (Id=336)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
struct _USB_BUS_INTERFACE_USBDI_V3// Size=0x60 (Id=411)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=504)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    struct // Size=0x4 (Id=0)
...
union _CONTROLLER_FLAGS// Size=0x4 (Id=603)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_HUB_STATUS// Size=0x2 (Id=674)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_HUB_CHANGE// Size=0x2 (Id=677)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_HUB_STATUS_AND_CHANGE// Size=0x4 (Id=641)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
...
struct _CONTROL_REQUEST// Size=0xa8 (Id=519)
{
...
struct _HUB_INTERRUPT_REQUEST// Size=0xb8 (Id=398)
{
    struct WDFREQUEST__ * WdfRequest;// Offset=0x0 Size=0x8
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=384)
{
    union // Size=0x4 (Id=0)
    {
...
struct _USB_HUB_DESCRIPTOR// Size=0x47 (Id=607)
{
...
struct _USB_30_HUB_DESCRIPTOR// Size=0xc (Id=615)
{
...
union _HUB_DESCRIPTOR// Size=0x47 (Id=523)
{
...
struct _STATE_LOG// Size=0xc (Id=505)
{
...
struct _SM_CONTEXT// Size=0x420 (Id=489)
{
...
union _HSM_MUX_FLAGS// Size=0x4 (Id=601)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _HSM_MUX_CONTEXT// Size=0x50 (Id=526)
{
...
struct _USB_RESET_FLAGS// Size=0x4 (Id=567)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _USB_DEVICE_DESCRIPTOR// Size=0x12 (Id=422)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
...
union _PARENT_HUB_FLAGS// Size=0x4 (Id=525)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _HUB_INFO_FROM_PARENT// Size=0x48 (Id=502)
{
...
struct _HUB_FDO_CONTEXT// Size=0x9f8 (Id=328)
{
    ...
    struct _HUB_INFORMATION HubInformation;// Offset=0x28 Size=0x70
    struct _UCX_CONTROLLER_INFO ControllerInfo;// Offset=0x98 Size=0x1c
    struct _HUB_PARENT_INTERFACE HubParentInterface;// Offset=0xb8 Size=0x88
    struct _HUB_CONTROLLERSTACK_INTERFACE HubControllerStackInterface;// Offset=0x140 Size=0xf0
    struct _USB_BUS_INTERFACE_USBDI_V3 UsbdBusInterface;// Offset=0x230 Size=0x60
    struct _DEVICE_CAPABILITIES DeviceCapabilities;// Offset=0x290 Size=0x40
    union _CONTROLLER_FLAGS ControllerFlags;// Offset=0x2d0 Size=0x4
    union _USB_HUB_STATUS_AND_CHANGE HubStatusAndChange;// Offset=0x2d4 Size=0x4
    union _USB_HUB_STATUS_AND_CHANGE OldHubStatusAndChange;// Offset=0x2d8 Size=0x4
    enum _USB_HUB_FEATURE_SELECTOR CurrentFeatureSelector;// Offset=0x2dc Size=0x4
    enum _HSM_EVENT CurrentHubChangeEvent;// Offset=0x2e0 Size=0x4
    union _USB_DEVICE_STATUS HubDeviceStatus;// Offset=0x2e4 Size=0x2
    struct _CONTROL_REQUEST HubControlRequest;// Offset=0x2e8 Size=0xa8
    struct _HUB_INTERRUPT_REQUEST StatusChangeInterruptRequest;// Offset=0x390 Size=0xb8
    struct _KEVENT PnPPowerEvent;// Offset=0x448 Size=0x18
    long PnPPowerStatus;// Offset=0x460 Size=0x4
    union _HUB_DESCRIPTOR HubDescriptor;// Offset=0x464 Size=0x47
    struct _USB_CONFIGURATION_DESCRIPTOR * ConfigurationDescriptor;// Offset=0x4b0 Size=0x8
    struct _SM_CONTEXT HsmContext;// Offset=0x4b8 Size=0x420
    struct _HSM_MUX_CONTEXT MuxContext;// Offset=0x8d8 Size=0x50
    struct WDFQUEUE__ * DeviceControlQueue;// Offset=0x928 Size=0x8
    struct _USB_RESET_FLAGS ResetFlags;// Offset=0x930 Size=0x4
    struct _GUID CurrentActivityId;// Offset=0x934 Size=0x10
    struct _LIST_ENTRY ListEntry;// Offset=0x948 Size=0x10
    struct _HUB_INFO_FROM_PARENT HubInfoFromParent;// Offset=0x958 Size=0x48
    struct RECORDER_LOG__ * IfrLog;// Offset=0x9a0 Size=0x8
    struct WDFREQUEST__ * PdoGetPortStatusRequest;// Offset=0x9a8 Size=0x8
    struct WDFWMIINSTANCE__ * WmiNotificationHandle;// Offset=0x9b0 Size=0x8
    struct _UNICODE_STRING HubSymbolicLinkNameUnicode;// Offset=0x9b8 Size=0x10
    void * SelectiveSuspendSetting;// Offset=0x9c8 Size=0x8
    void * SelectiveSuspendTimeoutPowerSetting;// Offset=0x9d0 Size=0x8
    unsigned long CurrentIdleTimeout;// Offset=0x9d8 Size=0x4
    struct _PORT_CONTEXT * GetPortStatusTargetPortContext;// Offset=0x9e0 Size=0x8
    unsigned long HardwareVerifierFlags;// Offset=0x9e8 Size=0x4
    unsigned long HubFailureMsgId;// Offset=0x9ec Size=0x4
    enum _WDF_POWER_DEVICE_STATE CurrentWdfPowerDeviceState;// Offset=0x9f0 Size=0x4
    unsigned short OldwTotalLength;// Offset=0x9f4 Size=0x2
};
