...
union _INTERFACE_FLAGS// Size=0x4 (Id=587)
{
...
union _ENDPOINT_FLAGS// Size=0x4 (Id=434)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _PIPE_HANDLE// Size=0x40 (Id=339)
{
...
struct _INTERFACE_HANDLE// Size=0x68 (Id=337)
{
    ...
    struct _PIPE_HANDLE PipeHandle[1];// Offset=0x28 Size=0x40
};
