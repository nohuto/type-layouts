union _unnamed_455// Size=0x2 (Id=455)
{
...
struct _USB_DEVICE_CAPABILITY_PD_CONSUMER_PORT_DESCRIPTOR// Size=0x18 (Id=456)
{
    ...
    union _unnamed_455 bmCapabilities;// Offset=0x4 Size=0x2
