union _unnamed_547// Size=0x4 (Id=547)
{
...
struct _USB_DEVICE_CAPABILITY_USB20_EXTENSION_DESCRIPTOR// Size=0x7 (Id=548)
{
    ...
    union _unnamed_547 bmAttributes;// Offset=0x3 Size=0x4
};
