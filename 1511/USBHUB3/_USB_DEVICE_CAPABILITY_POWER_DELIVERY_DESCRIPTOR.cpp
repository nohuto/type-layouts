union _unnamed_441// Size=0x4 (Id=441)
{
...
struct _USB_DEVICE_CAPABILITY_POWER_DELIVERY_DESCRIPTOR// Size=0x12 (Id=442)
{
    ...
    union _unnamed_441 bmAttributes;// Offset=0x4 Size=0x4
