struct _BOS_DESC_SET_INFO// Size=0x40 (Id=356)
{
    ...
    unsigned char DiscardContainerID;// Offset=0x28 Size=0x1
    unsigned char ChargingPolicySupported;// Offset=0x29 Size=0x1
