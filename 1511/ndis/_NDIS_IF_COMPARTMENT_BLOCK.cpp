...
struct _NDIS_NSI_COMPARTMENT_RW// Size=0x658 (Id=564)
{
...
struct _NDIS_IF_COMPARTMENT_BLOCK// Size=0x6b0 (Id=450)
{
    ...
    struct _NDIS_NSI_COMPARTMENT_RW LoopbackInfo;// Offset=0x40 Size=0x658
    struct _NDIS_IF_BLOCK * LoopbackIf;// Offset=0x698 Size=0x8
    struct _KEVENT * AsyncEvent;// Offset=0x6a0 Size=0x8
    struct _EJOB * JobObject;// Offset=0x6a8 Size=0x8
};
