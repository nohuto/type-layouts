struct in_addr// Size=0x4 (Id=130)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-S_un>// Size=0x4 (Id=13097)
        {
            struct <unnamed-type-S_un_b>// Size=0x4 (Id=13098)
            {
            ...
            struct <unnamed-type-S_un_w>// Size=0x4 (Id=13104)
            {
