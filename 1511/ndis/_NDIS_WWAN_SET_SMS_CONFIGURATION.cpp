...
struct _WWAN_SET_SMS_CONFIGURATION// Size=0x14 (Id=1542)
{
    char ScAddress[16];// Offset=0x0 Size=0x10
    enum _WWAN_SMS_FORMAT SmsFormat;// Offset=0x10 Size=0x4
};

struct _NDIS_WWAN_SET_SMS_CONFIGURATION// Size=0x18 (Id=1432)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    struct _WWAN_SET_SMS_CONFIGURATION SetSmsConfiguration;// Offset=0x4 Size=0x14
};
