union PCI_MSI_CAPABILITY::_unnamed_751// Size=0x10 (Id=751)
{
    struct <unnamed-type-Option32Bit>// Size=0xc (Id=14900)
    {
    ...
    struct PCI_MSI_CAPABILITY::_unnamed_752::<unnamed-type-Option32Bit> Option32Bit;// Offset=0x0 Size=0xc
    struct <unnamed-type-Option64Bit>// Size=0x10 (Id=14906)
    {
    ...
    struct PCI_MSI_CAPABILITY::_unnamed_753::<unnamed-type-Option64Bit> Option64Bit;// Offset=0x0 Size=0x10
};
