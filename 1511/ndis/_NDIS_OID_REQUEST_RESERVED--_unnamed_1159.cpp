union _NDIS_OID_REQUEST_RESERVED::_unnamed_1159// Size=0x18 (Id=1159)
{
    ...
    struct <unnamed-type-IovContext>// Size=0x10 (Id=8303)
    {
    ...
    struct <unnamed-type-PMContext>// Size=0x18 (Id=8309)
    {
