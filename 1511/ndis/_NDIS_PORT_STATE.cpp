...
struct _NDIS_PORT_STATE// Size=0x30 (Id=1194)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    enum _NET_IF_MEDIA_CONNECT_STATE MediaConnectState;// Offset=0x4 Size=0x4
    unsigned long long XmitLinkSpeed;// Offset=0x8 Size=0x8
    unsigned long long RcvLinkSpeed;// Offset=0x10 Size=0x8
    enum _NET_IF_DIRECTION_TYPE Direction;// Offset=0x18 Size=0x4
    enum _NDIS_PORT_CONTROL_STATE SendControlState;// Offset=0x1c Size=0x4
    enum _NDIS_PORT_CONTROL_STATE RcvControlState;// Offset=0x20 Size=0x4
    enum _NDIS_PORT_AUTHORIZATION_STATE SendAuthorizationState;// Offset=0x24 Size=0x4
    enum _NDIS_PORT_AUTHORIZATION_STATE RcvAuthorizationState;// Offset=0x28 Size=0x4
