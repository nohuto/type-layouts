...
struct _SECURITY_SUBJECT_CONTEXT// Size=0x20 (Id=966)
{
...
struct _INITIAL_PRIVILEGE_SET// Size=0x2c (Id=1553)
{
...
struct _PRIVILEGE_SET// Size=0x14 (Id=568)
{
    unsigned long PrivilegeCount;// Offset=0x0 Size=0x4
    unsigned long Control;// Offset=0x4 Size=0x4
...
struct _ACCESS_STATE// Size=0xa0 (Id=103)
{
    union // Size=0x50 (Id=0)
    {
        ...
        union <unnamed-type-Privileges>// Size=0x2c (Id=1898)
        {
