union _NDIS_PACKET_8021Q_INFO::_unnamed_1557// Size=0x8 (Id=1557)
{
    struct <unnamed-type-TagHeader>// Size=0x4 (Id=8384)
    {
    ...
    struct _NDIS_PACKET_8021Q_INFO::_unnamed_1558::<unnamed-type-TagHeader> TagHeader;// Offset=0x0 Size=0x4
