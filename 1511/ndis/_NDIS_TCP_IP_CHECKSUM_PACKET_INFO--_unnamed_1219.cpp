union _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_unnamed_1219// Size=0x4 (Id=1219)
{
    struct <unnamed-type-Transmit>// Size=0x4 (Id=9887)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_unnamed_1220::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x4
    struct <unnamed-type-Receive>// Size=0x4 (Id=9894)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_unnamed_1221::<unnamed-type-Receive> Receive;// Offset=0x0 Size=0x4
