...
struct _WWAN_SET_CONTEXT_STATE// Size=0x4e0 (Id=1556)
{
...
struct _NDIS_WWAN_SET_CONTEXT_STATE// Size=0x4e4 (Id=1398)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    struct _WWAN_SET_CONTEXT_STATE SetContextState;// Offset=0x4 Size=0x4e0
};
