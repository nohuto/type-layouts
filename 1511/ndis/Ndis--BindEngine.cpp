struct Ndis::BindEngine// Size=0x78 (Id=417)
{
    void BindEngine(struct Ndis::BindEngine & );
    void BindEngine();
    union // Size=0x7e5 (Id=0)
    {
        void ~BindEngine();// Offset=0x0 Size=0x5c
        ...
        void ApplyBindChanges(enum CallRunMode );// Offset=0x0 Size=0x5b
        void SetDirty();
        ...
        void LockBindings();
        void UnlockBindings();
        void UpdateBindings(class KLockThisExclusive & );// Offset=0x0 Size=0xfd
        bool Iterate();// Offset=0x0 Size=0x7e5
        void ApplyRules();
        void UpdateBindingsWorkItem();// Offset=0x0 Size=0x76
