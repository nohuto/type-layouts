struct _KSYSTEM_TIME// Size=0xc (Id=780)
{
...
struct _XSTATE_FEATURE// Size=0x8 (Id=799)
{
    unsigned long Offset;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
};

struct _XSTATE_CONFIGURATION// Size=0x330 (Id=652)
{
...
struct _KUSER_SHARED_DATA// Size=0x708 (Id=11)
{
    ...
    unsigned char Reserved12[3];// Offset=0x2ed Size=0x3
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long SpareBits:23;// Offset=0x2f0 Size=0x4 BitOffset=0x9 BitSize=0x17
        };
    };
    ...
    unsigned long Reserved8;// Offset=0x37c Size=0x4
