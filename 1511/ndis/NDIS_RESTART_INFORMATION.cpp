struct _NDIS_RESTART_ATTRIBUTES// Size=0x20 (Id=297)
{
...
struct _NDIS_PROTOCOL_RESTART_PARAMETERS// Size=0x38 (Id=302)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct NDIS_RESTART_INFORMATION// Size=0xe0 (Id=293)
{
    ...
    class Rtl::KArray<unsigned char> FilterInstanceBuffer;// Offset=0xc8 Size=0x18
    void NDIS_RESTART_INFORMATION(struct NDIS_RESTART_INFORMATION & );
    void NDIS_RESTART_INFORMATION();
    void ~NDIS_RESTART_INFORMATION();
    struct NDIS_RESTART_INFORMATION & operator=(struct NDIS_RESTART_INFORMATION & );
