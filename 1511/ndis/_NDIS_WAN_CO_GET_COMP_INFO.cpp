struct _NDIS_WAN_COMPRESS_INFO// Size=0x34 (Id=1241)
{
    ...
    {
        struct _NDIS_WAN_COMPRESS_INFO::_unnamed_1593::<unnamed-type-Proprietary> Proprietary;// Offset=0x10 Size=0x24
        struct _NDIS_WAN_COMPRESS_INFO::_unnamed_1594::<unnamed-type-Public> Public;// Offset=0x10 Size=0x20
    };
};

struct _NDIS_WAN_CO_GET_COMP_INFO// Size=0x68 (Id=1421)
{
