...
struct _NDIS_CO_CLIENT_OPTIONAL_HANDLERS// Size=0xa0 (Id=802)
{
...
struct _NDIS_PROTOCOL_BLOCK// Size=0x3d8 (Id=304)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    ...
    void _NDIS_PROTOCOL_BLOCK(struct _NDIS_PROTOCOL_BLOCK & );
    void _NDIS_PROTOCOL_BLOCK();
    void ~_NDIS_PROTOCOL_BLOCK();
    struct _NDIS_PROTOCOL_BLOCK & operator=(struct _NDIS_PROTOCOL_BLOCK & );
