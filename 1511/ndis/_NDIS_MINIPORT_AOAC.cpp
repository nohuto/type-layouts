...
struct _NDIS_AOAC_COMPONENT_REF_TIME// Size=0x10 (Id=1540)
{
    unsigned long long TotalRefTime;// Offset=0x0 Size=0x8
    unsigned long long CurrentRefStartTime;// Offset=0x8 Size=0x8
};

struct _NDIS_MINIPORT_CS_TRAFFIC_STATS// Size=0x30 (Id=594)
{
...
struct _NDIS_MINIPORT_AOAC// Size=0x3b0 (Id=534)
{
