...
struct _NDIS_IRP_WORK_ITEM// Size=0x30 (Id=1010)
{
...
struct _NDIS_SS_IDLE_FLAGS// Size=0x4 (Id=1083)
{
    union // Size=0x4 (Id=0)
    {
...
struct _NDIS_SS_STOP_FLAGS// Size=0x4 (Id=1327)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _NDIS_SS_CONTROL_OPS// Size=0x4 (Id=1486)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _NBL_QUEUE// Size=0x10 (Id=169)
{
...
union _NDIS_SS_RESUME_REASON// Size=0x4 (Id=848)
{
...
struct _NDIS_SELECTIVE_SUSPEND// Size=0x2a8 (Id=687)
{
    ...
    struct _NDIS_WORK_ITEM IdleTimerWorkItem;// Offset=0x110 Size=0x50
    struct _NDIS_WORK_ITEM IdleCancelWorkItem;// Offset=0x160 Size=0x50
    struct _NDIS_IRP_WORK_ITEM ResumeWorkItem;// Offset=0x1b0 Size=0x30
    struct _NDIS_SS_IDLE_FLAGS Flags;// Offset=0x1e0 Size=0x4
    struct _NDIS_SS_STOP_FLAGS StopFlags;// Offset=0x1e4 Size=0x4
    struct _NDIS_SS_CONTROL_OPS PendingControlOps;// Offset=0x1e8 Size=0x4
    long PendingPnPEventCount;// Offset=0x1ec Size=0x4
    long PendingSendNblCount;// Offset=0x1f0 Size=0x4
    long PendingCancelSendCount;// Offset=0x1f4 Size=0x4
    long PendingDirectOidCount;// Offset=0x1f8 Size=0x4
    long PendingCancelDirectOidCount;// Offset=0x1fc Size=0x4
    long PendingPnPOpCount;// Offset=0x200 Size=0x4
    struct _NBL_QUEUE PendingSendNblQueue;// Offset=0x208 Size=0x10
    struct _NBL_QUEUE PendingReceiveNblQueue;// Offset=0x218 Size=0x10
    long PendingReceiveReturnCount;// Offset=0x228 Size=0x4
    struct _LIST_ENTRY PendingDirectOidQueue;// Offset=0x230 Size=0x10
    struct _NDIS_OID_CACHE_ENTRY * OidCacheArray;// Offset=0x240 Size=0x8
    struct NDIS_NBL_TRACKER_HANDLE__ * QueuedSendNblTracker;// Offset=0x248 Size=0x8
    struct NDIS_NBL_TRACKER_HANDLE__ * QueuedReceiveReturnNblTracker;// Offset=0x250 Size=0x8
    unsigned short LastUnexpectedFailureLine[2];// Offset=0x258 Size=0x4
    union _NDIS_SS_RESUME_REASON LastResumeReason;// Offset=0x25c Size=0x4
    unsigned long LastResumeContext;// Offset=0x260 Size=0x4
    union _NDIS_SS_RESUME_REASON LastBusyEvent;// Offset=0x264 Size=0x4
    unsigned long LastBusyContext;// Offset=0x268 Size=0x4
    unsigned long SuspendCount;// Offset=0x26c Size=0x4
    union _LARGE_INTEGER LastSuspendTime;// Offset=0x270 Size=0x8
    union _LARGE_INTEGER LastCancelTime;// Offset=0x278 Size=0x8
    unsigned long long LastResumeLatencyMs;// Offset=0x280 Size=0x8
    unsigned long long TotalResumeLatencyMs;// Offset=0x288 Size=0x8
    unsigned long long LastSuspendIntervalMs;// Offset=0x290 Size=0x8
    unsigned long long TotalSuspendedTimeMs;// Offset=0x298 Size=0x8
    enum _NDIS_DEVICE_POWER_STATE LastRequestedIdlePowerState;// Offset=0x2a0 Size=0x4
};
