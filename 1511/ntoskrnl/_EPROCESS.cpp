...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=853)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=499)
{
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=1062)
{
...
struct _ALPC_PROCESS_CONTEXT// Size=0x20 (Id=583)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=1060)
{
    union // Size=0x1 (Id=0)
    {
...
struct _EPROCESS// Size=0x798 (Id=99)
{
    ...
    struct _MMSUPPORT Vm;// Offset=0x500 Size=0x100
    struct _LIST_ENTRY MmProcessLinks;// Offset=0x600 Size=0x10
    struct _RTL_AVL_TREE VadRoot;// Offset=0x610 Size=0x8
    unsigned long ModifiedPageCount;// Offset=0x618 Size=0x4
    long ExitStatus;// Offset=0x61c Size=0x4
    void * VadHint;// Offset=0x620 Size=0x8
    unsigned long long VadCount;// Offset=0x628 Size=0x8
    unsigned long long VadPhysicalPages;// Offset=0x630 Size=0x8
    unsigned long long VadPhysicalPagesLimit;// Offset=0x638 Size=0x8
    struct _ALPC_PROCESS_CONTEXT AlpcContext;// Offset=0x640 Size=0x20
    struct _LIST_ENTRY TimerResolutionLink;// Offset=0x660 Size=0x10
    struct _PO_DIAG_STACK_RECORD * TimerResolutionStackRecord;// Offset=0x670 Size=0x8
    unsigned long RequestedTimerResolution;// Offset=0x678 Size=0x4
    unsigned long SmallestTimerResolution;// Offset=0x67c Size=0x4
    union _LARGE_INTEGER ExitTime;// Offset=0x680 Size=0x8
    struct _INVERTED_FUNCTION_TABLE * InvertedFunctionTable;// Offset=0x688 Size=0x8
    struct _EX_PUSH_LOCK InvertedFunctionTableLock;// Offset=0x690 Size=0x8
    unsigned long ActiveThreadsHighWatermark;// Offset=0x698 Size=0x4
    unsigned long LargePrivateVadCount;// Offset=0x69c Size=0x4
    struct _EX_PUSH_LOCK ThreadListLock;// Offset=0x6a0 Size=0x8
    void * WnfContext;// Offset=0x6a8 Size=0x8
    unsigned long long Spare0;// Offset=0x6b0 Size=0x8
    unsigned char SignatureLevel;// Offset=0x6b8 Size=0x1
    unsigned char SectionSignatureLevel;// Offset=0x6b9 Size=0x1
    struct _PS_PROTECTION Protection;// Offset=0x6ba Size=0x1
    unsigned char HangCount;// Offset=0x6bb Size=0x1
    union // Size=0x4 (Id=0)
    {
        unsigned long Flags3;// Offset=0x6bc Size=0x4
        struct // Size=0x4 (Id=0)
        {
            unsigned long Minimal:1;// Offset=0x6bc Size=0x4 BitOffset=0x0 BitSize=0x1
            unsigned long ReplacingPageRoot:1;// Offset=0x6bc Size=0x4 BitOffset=0x1 BitSize=0x1
            unsigned long DisableNonSystemFonts:1;// Offset=0x6bc Size=0x4 BitOffset=0x2 BitSize=0x1
            unsigned long AuditNonSystemFontLoading:1;// Offset=0x6bc Size=0x4 BitOffset=0x3 BitSize=0x1
            unsigned long Crashed:1;// Offset=0x6bc Size=0x4 BitOffset=0x4 BitSize=0x1
            unsigned long JobVadsAreTracked:1;// Offset=0x6bc Size=0x4 BitOffset=0x5 BitSize=0x1
            unsigned long VadTrackingDisabled:1;// Offset=0x6bc Size=0x4 BitOffset=0x6 BitSize=0x1
            unsigned long AuxiliaryProcess:1;// Offset=0x6bc Size=0x4 BitOffset=0x7 BitSize=0x1
            unsigned long SubsystemProcess:1;// Offset=0x6bc Size=0x4 BitOffset=0x8 BitSize=0x1
            unsigned long IndirectCpuSets:1;// Offset=0x6bc Size=0x4 BitOffset=0x9 BitSize=0x1
            unsigned long InPrivate:1;// Offset=0x6bc Size=0x4 BitOffset=0xa BitSize=0x1
            unsigned long ProhibitRemoteImageMap:1;// Offset=0x6bc Size=0x4 BitOffset=0xb BitSize=0x1
            unsigned long ProhibitLowILImageMap:1;// Offset=0x6bc Size=0x4 BitOffset=0xc BitSize=0x1
            unsigned long SignatureMitigationOptIn:1;// Offset=0x6bc Size=0x4 BitOffset=0xd BitSize=0x1
            unsigned long RestrictIndirectBranchPrediction:1;// Offset=0x6bc Size=0x4 BitOffset=0xe BitSize=0x1
            unsigned long AddressPolicyFrozen:1;// Offset=0x6bc Size=0x4 BitOffset=0xf BitSize=0x1
        };
    };
    long DeviceAsid;// Offset=0x6c0 Size=0x4
    void * SvmData;// Offset=0x6c8 Size=0x8
    struct _EX_PUSH_LOCK SvmProcessLock;// Offset=0x6d0 Size=0x8
    unsigned long long SvmLock;// Offset=0x6d8 Size=0x8
    struct _LIST_ENTRY SvmProcessDeviceListHead;// Offset=0x6e0 Size=0x10
    unsigned long long LastFreezeInterruptTime;// Offset=0x6f0 Size=0x8
    struct _PROCESS_DISK_COUNTERS * DiskCounters;// Offset=0x6f8 Size=0x8
    void * PicoContext;// Offset=0x700 Size=0x8
    unsigned long long TrustletIdentity;// Offset=0x708 Size=0x8
    unsigned long KeepAliveCounter;// Offset=0x710 Size=0x4
    unsigned long NoWakeKeepAliveCounter;// Offset=0x714 Size=0x4
    unsigned long HighPriorityFaultsAllowed;// Offset=0x718 Size=0x4
    struct _PROCESS_ENERGY_VALUES * EnergyValues;// Offset=0x720 Size=0x8
    void * VmContext;// Offset=0x728 Size=0x8
    unsigned long long SequenceNumber;// Offset=0x730 Size=0x8
    unsigned long long CreateInterruptTime;// Offset=0x738 Size=0x8
    unsigned long long CreateUnbiasedInterruptTime;// Offset=0x740 Size=0x8
    unsigned long long TotalUnbiasedFrozenTime;// Offset=0x748 Size=0x8
    unsigned long long LastAppStateUpdateTime;// Offset=0x750 Size=0x8
    struct // Size=0x8 (Id=0)
    {
        unsigned long long LastAppStateUptime:61;// Offset=0x758 Size=0x8 BitOffset=0x0 BitSize=0x3d
        unsigned long long LastAppState:3;// Offset=0x758 Size=0x8 BitOffset=0x3d BitSize=0x3
    };
    unsigned long long SharedCommitCharge;// Offset=0x760 Size=0x8
    struct _EX_PUSH_LOCK SharedCommitLock;// Offset=0x768 Size=0x8
    struct _LIST_ENTRY SharedCommitLinks;// Offset=0x770 Size=0x10
    union // Size=0x790 (Id=0)
    {
        unsigned long long AllowedCpuSets;// Offset=0x780 Size=0x8
        unsigned long long DefaultCpuSets;// Offset=0x788 Size=0x8
        unsigned long long * AllowedCpuSetsIndirect;// Offset=0x780 Size=0x8
        unsigned long long * DefaultCpuSetsIndirect;// Offset=0x788 Size=0x8
    };
    unsigned long long SecurityDomain;// Offset=0x790 Size=0x8
};
