...
struct _HVIEW_MAP_PIN_LOG_ENTRY// Size=0x48 (Id=1384)
{
...
struct _HVIEW_MAP_PIN_LOG// Size=0x488 (Id=1197)
{
...
struct _HVIEW_MAP// Size=0x4b0 (Id=795)
{
...
struct _DUAL// Size=0x278 (Id=1178)
{
...
struct _HHIVE// Size=0xa68 (Id=780)
{
...
struct _CM_WORKITEM// Size=0x28 (Id=786)
{
...
struct _CM_DIRTY_VECTOR_LOG_ENTRY// Size=0x48 (Id=989)
{
    struct _ETHREAD * Thread;// Offset=0x0 Size=0x8
    enum _CM_DIRTY_VECTOR_OPERATION Operation;// Offset=0x8 Size=0x4
    union _unnamed_988 Data;// Offset=0xc Size=0x8
    void * Stack[6];// Offset=0x18 Size=0x30
};

struct _CM_DIRTY_VECTOR_LOG// Size=0x488 (Id=736)
{
    unsigned long Next;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
...
struct _HIVE_WRITE_WAIT_QUEUE// Size=0x18 (Id=717)
{
...
struct _CMHIVE// Size=0x17a8 (Id=691)
{
