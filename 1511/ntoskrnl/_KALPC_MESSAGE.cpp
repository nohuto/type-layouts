...
union _KALPC_DIRECT_EVENT// Size=0x8 (Id=438)
{
...
struct _KALPC_MESSAGE_ATTRIBUTES// Size=0x40 (Id=434)
{
...
struct _KALPC_MESSAGE// Size=0x108 (Id=429)
{
    ...
    union _unnamed_428 u1;// Offset=0x28 Size=0x4
