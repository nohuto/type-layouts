...
struct _CM_KEY_VALUE// Size=0x18 (Id=1013)
{
    unsigned short Signature;// Offset=0x0 Size=0x2
...
struct _SECURITY_DESCRIPTOR_RELATIVE// Size=0x14 (Id=1382)
{
...
struct _CM_KEY_SECURITY// Size=0x28 (Id=1441)
{
    unsigned short Signature;// Offset=0x0 Size=0x2
...
struct _CM_KEY_INDEX// Size=0x8 (Id=1228)
{
    unsigned short Signature;// Offset=0x0 Size=0x2
...
struct _CM_BIG_DATA// Size=0x8 (Id=1134)
{
    unsigned short Signature;// Offset=0x0 Size=0x2
    unsigned short Count;// Offset=0x2 Size=0x2
    unsigned long List;// Offset=0x4 Size=0x4
...
struct _CELL_DATA// Size=0x50 (Id=524)
{
    union _u u;// Offset=0x0 Size=0x50
};

union _unnamed_932// Size=0x50 (Id=932)
{
    union // Size=0x50 (Id=0)
    {
        struct _CELL_DATA CellData;// Offset=0x0 Size=0x50
        unsigned long long List[1];// Offset=0x0 Size=0x8
    };
};

struct _CM_CACHED_VALUE_INDEX// Size=0x58 (Id=933)
{
    unsigned long CellIndex;// Offset=0x0 Size=0x4
    union _unnamed_932 Data;// Offset=0x8 Size=0x50
};
