struct _NT_TIB// Size=0x38 (Id=564)
{
...
struct _KDESCRIPTOR// Size=0x10 (Id=1372)
{
...
struct _KSPECIAL_REGISTERS// Size=0xe0 (Id=1057)
{
...
struct _CONTEXT// Size=0x4d0 (Id=598)
{
...
struct _KPROCESSOR_STATE// Size=0x5b0 (Id=842)
{
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=1001)
{
...
struct _KTIMER_TABLE_ENTRY// Size=0x20 (Id=278)
{
...
struct _KTIMER_TABLE// Size=0x2200 (Id=277)
{
...
struct _PROC_IDLE_POLICY// Size=0x6 (Id=1127)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=1148)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=759)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=1126)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=851)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROCESSOR_POWER_STATE// Size=0x1d0 (Id=683)
{
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=873)
{
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=264)
{
...
struct _IOP_IRP_STACK_PROFILER// Size=0x54 (Id=875)
{
    unsigned long Profile[20];// Offset=0x0 Size=0x50
    unsigned long TotalIrps;// Offset=0x50 Size=0x4
};

struct _KSHARED_READY_QUEUE// Size=0x260 (Id=281)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _KPRCB// Size=0x7ec0 (Id=40)
{
    ...
    union // Size=0x1 (Id=0)
    {
        ...
        struct // Size=0x1 (Id=0)
        {
            unsigned char BpbIbrsPresent:1;// Offset=0x2d30 Size=0x1 BitOffset=0x0 BitSize=0x1
            unsigned char BpbStibpPresent:1;// Offset=0x2d30 Size=0x1 BitOffset=0x1 BitSize=0x1
            unsigned char BpbSmepPresent:1;// Offset=0x2d30 Size=0x1 BitOffset=0x2 BitSize=0x1
            unsigned char BpbSimulateIbrs:1;// Offset=0x2d30 Size=0x1 BitOffset=0x3 BitSize=0x1
            unsigned char BpbSimulateIbpb:1;// Offset=0x2d30 Size=0x1 BitOffset=0x4 BitSize=0x1
            unsigned char BpbReserved:3;// Offset=0x2d30 Size=0x1 BitOffset=0x5 BitSize=0x3
        };
    };
    unsigned char BpbPad[7];// Offset=0x2d31 Size=0x7
