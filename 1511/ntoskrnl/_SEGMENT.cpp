struct _SEGMENT_FLAGS// Size=0x4 (Id=529)
{
    union // Size=0x2 (Id=0)
    {
...
union _unnamed_225// Size=0x8 (Id=225)
{
...
struct _SEGMENT// Size=0x48 (Id=227)
{
    ...
    union _unnamed_225 u1;// Offset=0x30 Size=0x8
    union _unnamed_226 u2;// Offset=0x38 Size=0x8
