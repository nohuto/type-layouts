...
struct _SYSTEM_POWER_POLICY// Size=0xe8 (Id=1058)
{
...
struct _POP_POWER_SETTING_VALUES// Size=0x13c (Id=1329)
{
    ...
    unsigned char OffloadedAudio;// Offset=0x12d Size=0x1
    unsigned char NonOffloadedAudio;// Offset=0x12e Size=0x1
    unsigned char FullscreenVideoPlayback;// Offset=0x12f Size=0x1
    unsigned long EsBatteryThreshold;// Offset=0x130 Size=0x4
    unsigned char EsUserAwaySetting;// Offset=0x134 Size=0x1
    unsigned long WiFiInStandby;// Offset=0x138 Size=0x4
};
