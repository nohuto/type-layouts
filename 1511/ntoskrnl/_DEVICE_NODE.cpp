...
struct _PO_DEVICE_NOTIFY// Size=0x68 (Id=1019)
{
    ...
    unsigned short * DeviceName;// Offset=0x48 Size=0x8
    unsigned short * DriverName;// Offset=0x50 Size=0x8
...
struct _unnamed_294// Size=0x20 (Id=294)
{
...
struct _DEVICE_NODE// Size=0x2c8 (Id=295)
{
    ...
    union _unnamed_291 OverUsed1;// Offset=0x210 Size=0x8
    union _unnamed_292 OverUsed2;// Offset=0x218 Size=0x8
    ...
    struct _unnamed_294 DockInfo;// Offset=0x238 Size=0x20
