...
struct _IO_DRIVER_CREATE_CONTEXT// Size=0x28 (Id=158)
{
...
struct _OPEN_PACKET// Size=0xc0 (Id=452)
{
    ...
    struct _IO_DRIVER_CREATE_CONTEXT DriverCreateContext;// Offset=0x98 Size=0x28
};
