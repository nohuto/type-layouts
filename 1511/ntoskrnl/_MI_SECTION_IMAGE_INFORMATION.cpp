struct _SECTION_IMAGE_INFORMATION// Size=0x40 (Id=1194)
{
...
struct _MI_EXTRA_IMAGE_INFORMATION// Size=0x8 (Id=589)
{
    unsigned long SizeOfHeaders;// Offset=0x0 Size=0x4
    unsigned long SizeOfImage;// Offset=0x4 Size=0x4
};

struct _MI_SECTION_IMAGE_INFORMATION// Size=0x48 (Id=522)
{
