...
struct _unnamed_1463// Size=0x8 (Id=1463)
{
...
union _unnamed_1464// Size=0x8 (Id=1464)
{
    union _ULARGE_INTEGER RemappedFormat;// Offset=0x0 Size=0x8
    struct _unnamed_1463 Msi;// Offset=0x0 Size=0x8
};

struct _INTERRUPT_REMAPPING_INFO// Size=0x10 (Id=1465)
{
    ...
    union _unnamed_1464 u;// Offset=0x8 Size=0x8
};
...
union _unnamed_1452// Size=0x4 (Id=1452)
{
    struct _unnamed_1451 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _unnamed_1453// Size=0x4 (Id=1453)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1454// Size=0x4 (Id=1454)
{
    struct _unnamed_1453 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_HT_INTR_INFO// Size=0x8 (Id=1455)
{
    union _unnamed_1452 LowPart;// Offset=0x0 Size=0x4
    union _unnamed_1454 HighPart;// Offset=0x4 Size=0x4
};
...
struct _unnamed_1419// Size=0x4 (Id=1419)
{
    enum HAL_APIC_DESTINATION_MODE DestinationMode;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_VECTOR_DATA// Size=0x58 (Id=1420)
{
    ...
    struct _unnamed_1415 ControllerInput;// Offset=0x38 Size=0x8
    unsigned long long HvDeviceId;// Offset=0x40 Size=0x8
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_1416 XapicMessage;// Offset=0x48 Size=0x10
        struct _unnamed_1417 Hypertransport;// Offset=0x48 Size=0x8
        struct _unnamed_1416 GenericMessage;// Offset=0x48 Size=0x10
        struct _unnamed_1419 MessageRequest;// Offset=0x48 Size=0x4
    };
};

struct _INTERRUPT_CONNECTION_DATA// Size=0x60 (Id=1203)
{
