...
struct _unnamed_414// Size=0x4 (Id=414)
{
...
union _unnamed_415// Size=0x4 (Id=415)
{
    struct _unnamed_414 s1;// Offset=0x0 Size=0x4
};

struct _KALPC_VIEW// Size=0x60 (Id=416)
{
    ...
    union _unnamed_415 u1;// Offset=0x48 Size=0x4
