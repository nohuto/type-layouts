...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=75)
{
    union // Size=0x4 (Id=0)
    {
...
struct _MMINPAGE_FLAGS// Size=0x4 (Id=1209)
{
...
union _unnamed_1181// Size=0x4 (Id=1181)
{
...
struct _MMINPAGE_SUPPORT_FLOW_THROUGH// Size=0x38 (Id=1402)
{
...
struct _MMINPAGE_SUPPORT// Size=0x1b0 (Id=1182)
{
    ...
    struct _KAPC_STATE ApcState;// Offset=0x68 Size=0x30
    ...
    union _unnamed_1180 u3;// Offset=0xb8 Size=0x4
    union _unnamed_1181 u1;// Offset=0xbc Size=0x4
    ...
    struct _MDL Mdl;// Offset=0x100 Size=0x30
    union // Size=0x80 (Id=0)
    {
        unsigned long long Page[16];// Offset=0x130 Size=0x80
        struct _MMINPAGE_SUPPORT_FLOW_THROUGH FlowThrough;// Offset=0x130 Size=0x38
    };
};
