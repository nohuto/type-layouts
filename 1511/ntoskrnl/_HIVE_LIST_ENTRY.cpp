...
struct _HIVE_LIST_ENTRY// Size=0x98 (Id=596)
{
    unsigned short * FileName;// Offset=0x0 Size=0x8
    unsigned short * BaseName;// Offset=0x8 Size=0x8
    unsigned short * RegRootName;// Offset=0x10 Size=0x8
    ...
    struct _UNICODE_STRING FilePath;// Offset=0x88 Size=0x10
};
