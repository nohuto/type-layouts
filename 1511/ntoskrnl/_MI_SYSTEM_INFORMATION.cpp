...
struct _MI_POOL_FAILURE_REASONS// Size=0x2c (Id=1443)
{
...
struct _MI_POOL_STATE// Size=0xf8 (Id=1327)
{
...
struct _MSUBSECTION// Size=0x70 (Id=1061)
{
...
struct _MMSECTION_FLAGS// Size=0x4 (Id=1089)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_231// Size=0x10 (Id=231)
{
    struct _unnamed_230 e2;// Offset=0x0 Size=0x10
};

struct _CONTROL_AREA// Size=0x78 (Id=232)
{
    ...
    union _unnamed_228 u;// Offset=0x38 Size=0x4
    union _unnamed_229 u1;// Offset=0x3c Size=0x4
    ...
    union _unnamed_231 u2;// Offset=0x58 Size=0x10
...
struct _MI_CROSS_PARTITION_CHARGES// Size=0x28 (Id=965)
{
...
struct _MI_SECTION_STATE// Size=0x280 (Id=910)
{
    ...
    unsigned long long UnusedSubsectionPagedPool;// Offset=0x28 Size=0x8
    unsigned long UnusedSegmentForceFree;// Offset=0x30 Size=0x4
    unsigned long DataSectionProtectionMask;// Offset=0x34 Size=0x4
    void * HighSectionBase;// Offset=0x38 Size=0x8
    struct _MSUBSECTION PhysicalSubsection;// Offset=0x40 Size=0x70
    struct _CONTROL_AREA PhysicalControlArea;// Offset=0xb0 Size=0x78
    struct _MMPFN * DanglingExtentsPages;// Offset=0x128 Size=0x8
    long DanglingExtentsLock;// Offset=0x130 Size=0x4
    struct _WORK_QUEUE_ITEM DanglingExtentsWorkItem;// Offset=0x138 Size=0x20
    unsigned char DanglingExtentsWorkerActive;// Offset=0x158 Size=0x1
    struct _RTL_AVL_TREE PageFileSectionHead;// Offset=0x160 Size=0x8
    long PageFileSectionListSpinLock;// Offset=0x168 Size=0x4
    struct _MI_CROSS_PARTITION_CHARGES SharedSegmentCharges;// Offset=0x170 Size=0x28
    struct _MI_CROSS_PARTITION_CHARGES SharedPageCombineCharges;// Offset=0x198 Size=0x28
    unsigned long ImageBias;// Offset=0x1c0 Size=0x4
    struct _EX_PUSH_LOCK RelocateBitmapsLock;// Offset=0x1c8 Size=0x8
    struct _RTL_BITMAP ImageBitMap;// Offset=0x1d0 Size=0x10
    unsigned long ImageBias64Low;// Offset=0x1e0 Size=0x4
    unsigned long ImageBias64High;// Offset=0x1e4 Size=0x4
    struct _RTL_BITMAP ImageBitMap64Low;// Offset=0x1e8 Size=0x10
    struct _RTL_BITMAP ImageBitMap64High;// Offset=0x1f8 Size=0x10
    struct _RTL_BITMAP ImageBitMapWow64Dll;// Offset=0x208 Size=0x10
    void * ApiSetSection;// Offset=0x218 Size=0x8
    void * ApiSetSchema;// Offset=0x220 Size=0x8
    unsigned long long ApiSetSchemaSize;// Offset=0x228 Size=0x8
    unsigned long LostDataFiles;// Offset=0x230 Size=0x4
    unsigned long LostDataPages;// Offset=0x234 Size=0x4
    unsigned long ImageFailureReason;// Offset=0x238 Size=0x4
    struct _SECTION * CfgBitMapSection32;// Offset=0x240 Size=0x8
    struct _CONTROL_AREA * CfgBitMapControlArea32;// Offset=0x248 Size=0x8
    struct _SECTION * CfgBitMapSection64;// Offset=0x250 Size=0x8
    struct _CONTROL_AREA * CfgBitMapControlArea64;// Offset=0x258 Size=0x8
    unsigned long ImageCfgFailure;// Offset=0x260 Size=0x4
    long ImageValidationFailed;// Offset=0x264 Size=0x4
};
...
struct _KMUTANT// Size=0x38 (Id=556)
{
...
struct _MM_SYSTEM_PAGE_COUNTS// Size=0x10 (Id=1264)
{
...
struct _MI_SYSTEM_IMAGE_STATE// Size=0xc0 (Id=1161)
{
    ...
    struct _MMPTE * ErrataPte;// Offset=0xb0 Size=0x8
    unsigned long ErrataPteMapped;// Offset=0xb8 Size=0x4
};
...
struct _MI_SESSION_STATE// Size=0x88 (Id=871)
{
...
struct _MI_PROCESS_STATE// Size=0x60 (Id=857)
{
...
struct _MI_HARDWARE_STATE// Size=0xb8 (Id=832)
{
    ...
    unsigned long FlushTbForAttributeChange;// Offset=0x60 Size=0x4
    unsigned long FlushCacheForAttributeChange;// Offset=0x64 Size=0x4
    unsigned long FlushCacheForPageAttributeChange;// Offset=0x68 Size=0x4
    unsigned long CacheFlushPromoteThreshold;// Offset=0x6c Size=0x4
    unsigned long long FlushTbThreshold;// Offset=0x70 Size=0x8
    unsigned char AttributeChangeRequiresReZero;// Offset=0x78 Size=0x1
    struct _MI_ZERO_COST_COUNTS ZeroCostCounts[2];// Offset=0x80 Size=0x20
    unsigned long long PrimaryPfns;// Offset=0xa0 Size=0x8
    unsigned long long HighestPossiblePhysicalPage;// Offset=0xa8 Size=0x8
    unsigned char GlobalBitPolarity[2];// Offset=0xb0 Size=0x2
};
...
struct _MI_DYNAMIC_BITMAP// Size=0x50 (Id=1405)
{
...
struct _MI_SYSTEM_VA_STATE// Size=0x2c0 (Id=847)
{
...
struct _MI_COMBINE_STATE// Size=0x1a0 (Id=951)
{
...
struct _MI_PARTITION_STATE// Size=0x60 (Id=1074)
{
...
struct _MI_ACCESS_LOG_STATE// Size=0x80 (Id=1111)
{
...
struct _MI_DEBUGGER_STATE// Size=0x118 (Id=856)
{
...
struct _MI_STANDBY_STATE// Size=0xc0 (Id=1110)
{
...
struct _MI_QUEUED_DEADSTACK_WORKITEM// Size=0x28 (Id=1398)
{
    struct _WORK_QUEUE_ITEM WorkItem;// Offset=0x0 Size=0x20
    long Active;// Offset=0x20 Size=0x4
};

struct _MI_SYSTEM_PTE_STATE// Size=0x180 (Id=1233)
{
...
struct _MI_IO_CACHE_STATS// Size=0x20 (Id=1435)
{
...
struct _MI_IO_PAGE_STATE// Size=0x58 (Id=1339)
{
...
struct _MI_PAGING_IO_STATE// Size=0x50 (Id=1171)
{
...
struct _MI_COMMON_PAGE_STATE// Size=0x98 (Id=1083)
{
    ...
    unsigned long long PageTableOfZeroes;// Offset=0x78 Size=0x8
    struct _MMPTE PdeOfZeroes;// Offset=0x80 Size=0x8
    unsigned long long PageTableOfOnes;// Offset=0x88 Size=0x8
    struct _MMPTE PdeOfOnes;// Offset=0x90 Size=0x8
};

struct _MI_SYSTEM_TRIM_STATE// Size=0x40 (Id=971)
{
...
struct _MI_RESAVAIL_TRACKER// Size=0x380 (Id=977)
{
    ...
    unsigned long long AllocateHotRemove;// Offset=0x218 Size=0x8
    unsigned long long FreeHotAdd;// Offset=0x220 Size=0x8
    unsigned long long AllocateBoot;// Offset=0x228 Size=0x8
    unsigned long long FreeLoaderBlock;// Offset=0x230 Size=0x8
    unsigned long long AllocateNonPagedSpecialPool;// Offset=0x238 Size=0x8
    unsigned long long FreeNonPagedSpecialPoolError;// Offset=0x240 Size=0x8
    unsigned long long FreeNonPagedSpecialPool;// Offset=0x248 Size=0x8
    unsigned long long AllocateSharedSegmentPage;// Offset=0x250 Size=0x8
    unsigned long long FreeSharedSegmentPage;// Offset=0x258 Size=0x8
    unsigned long long AllocateZeroPage;// Offset=0x260 Size=0x8
    unsigned long long FreeZeroPage;// Offset=0x268 Size=0x8
    unsigned long long AllocateForPo;// Offset=0x270 Size=0x8
    unsigned long long AllocateForPoForce;// Offset=0x278 Size=0x8
    unsigned long long FreeForPo;// Offset=0x280 Size=0x8
    unsigned long long AllocateThreadHardFaultBehavior;// Offset=0x288 Size=0x8
    unsigned long long FreeThreadHardFaultBehavior;// Offset=0x290 Size=0x8
    unsigned long long ObtainFaultCharges;// Offset=0x298 Size=0x8
    unsigned long long FreeFaultCharges;// Offset=0x2a0 Size=0x8
    unsigned long long AllocateStoreCharges;// Offset=0x2a8 Size=0x8
    unsigned long long FreeStoreCharges;// Offset=0x2b0 Size=0x8
    unsigned long long ObtainLockedPageCharge;// Offset=0x2c0 Size=0x8
    unsigned long long FreeLockedPageCharge;// Offset=0x300 Size=0x8
    unsigned long long AllocateStore;// Offset=0x308 Size=0x8
    unsigned long long FreeStore;// Offset=0x310 Size=0x8
    unsigned long long AllocateSystemImageProtos;// Offset=0x318 Size=0x8
    unsigned long long FreeSystemImageProtos;// Offset=0x320 Size=0x8
    unsigned long long AllocateModWriterCharge;// Offset=0x328 Size=0x8
    unsigned long long FreeModWriterCharge;// Offset=0x330 Size=0x8
    unsigned long long AllocateMappedWriterCharge;// Offset=0x338 Size=0x8
    unsigned long long FreeMappedWriterCharge;// Offset=0x340 Size=0x8
    unsigned long long AllocateRegistryCharges;// Offset=0x348 Size=0x8
    unsigned long long FreeRegistryCharges;// Offset=0x350 Size=0x8
};
...
struct _SYSPTES_HEADER// Size=0x118 (Id=514)
{
...
struct _MI_VISIBLE_STATE// Size=0x640 (Id=746)
{
    ...
    unsigned long long PagefileHashPages;// Offset=0x488 Size=0x8
    struct _SYSPTES_HEADER PteHeader;// Offset=0x490 Size=0x118
    struct _MI_SPECIAL_POOL * SessionSpecialPool;// Offset=0x5a8 Size=0x8
    unsigned long long SystemVaTypeCount[14];// Offset=0x5b0 Size=0x70
};

struct _MI_SYSTEM_INFORMATION// Size=0x1bc0 (Id=739)
{
    ...
    struct _MI_SESSION_STATE Sessions;// Offset=0x440 Size=0x88
    struct _MI_PROCESS_STATE Processes;// Offset=0x4d0 Size=0x60
    struct _MI_HARDWARE_STATE Hardware;// Offset=0x530 Size=0xb8
    struct _MI_SYSTEM_VA_STATE SystemVa;// Offset=0x600 Size=0x2c0
    struct _MI_COMBINE_STATE PageCombines;// Offset=0x8c0 Size=0x1a0
    struct _MI_PARTITION_STATE Partitions;// Offset=0xa60 Size=0x60
    struct _MI_SHUTDOWN_STATE Shutdowns;// Offset=0xac0 Size=0x80
    ...
    struct _MI_COMMON_PAGE_STATE CommonPages;// Offset=0x10b0 Size=0x98
    struct _MI_SYSTEM_TRIM_STATE Trims;// Offset=0x1180 Size=0x40
    struct _MI_RESAVAIL_TRACKER ResTrack;// Offset=0x11c0 Size=0x380
