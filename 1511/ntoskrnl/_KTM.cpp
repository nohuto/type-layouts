...
struct _RTL_BALANCED_LINKS// Size=0x20 (Id=1400)
{
...
struct _KTMOBJECT_NAMESPACE_LINK// Size=0x28 (Id=1049)
{
...
struct _RTL_AVL_TABLE// Size=0x68 (Id=1470)
{
...
struct _KTMOBJECT_NAMESPACE// Size=0xa8 (Id=1296)
{
...
struct _unnamed_1387// Size=0x8 (Id=1387)
{
    unsigned int idxRecord;// Offset=0x0 Size=0x4
    unsigned long cidContainer;// Offset=0x4 Size=0x4
};

union _CLS_LSN// Size=0x8 (Id=1388)
{
    struct _unnamed_1387 offset;// Offset=0x0 Size=0x8
...
struct _KTM// Size=0x3c0 (Id=1263)
{
