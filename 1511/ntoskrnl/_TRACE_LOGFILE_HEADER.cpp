struct _unnamed_455// Size=0x4 (Id=455)
{
...
struct _TIME_FIELDS// Size=0x10 (Id=454)
{
...
struct _RTL_TIME_ZONE_INFORMATION// Size=0xac (Id=792)
{
...
struct _TRACE_LOGFILE_HEADER// Size=0x118 (Id=456)
{
    unsigned long BufferSize;// Offset=0x0 Size=0x4
    union // Size=0x4 (Id=0)
    {
        unsigned long Version;// Offset=0x4 Size=0x4
        struct _unnamed_455 VersionDetail;// Offset=0x4 Size=0x4
    };
    ...
    unsigned short * LoggerName;// Offset=0x38 Size=0x8
    unsigned short * LogFileName;// Offset=0x40 Size=0x8
