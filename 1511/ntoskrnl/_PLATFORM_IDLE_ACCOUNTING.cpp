struct _PPM_SELECTION_STATISTICS// Size=0x78 (Id=1354)
{
    ...
    struct _PPM_VETO_ACCOUNTING * PreVetoAccounting;// Offset=0x70 Size=0x8
};

struct _PROC_IDLE_STATE_BUCKET// Size=0x20 (Id=1288)
{
...
struct _PLATFORM_IDLE_STATE_ACCOUNTING// Size=0x3e8 (Id=1267)
{
    ...
    struct _PPM_SELECTION_STATISTICS SelectionStatistics;// Offset=0x30 Size=0x78
    struct _PROC_IDLE_STATE_BUCKET IdleTimeBuckets[26];// Offset=0xa8 Size=0x340
};

struct _PLATFORM_IDLE_ACCOUNTING// Size=0x400 (Id=1176)
{
    ...
    enum PPM_IDLE_BUCKET_TIME_TYPE TimeUnit;// Offset=0xc Size=0x4
    unsigned long long StartTime;// Offset=0x10 Size=0x8
    struct _PLATFORM_IDLE_STATE_ACCOUNTING State[1];// Offset=0x18 Size=0x3e8
};
