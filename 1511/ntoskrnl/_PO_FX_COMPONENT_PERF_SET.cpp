...
struct _PO_FX_COMPONENT_PERF_SET// Size=0x30 (Id=1427)
{
    ...
    {
        struct _unnamed_1425 Discrete;// Offset=0x20 Size=0x10
        struct _unnamed_1426 Range;// Offset=0x20 Size=0x10
    };
};
