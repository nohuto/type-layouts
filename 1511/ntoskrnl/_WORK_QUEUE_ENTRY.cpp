...
struct _unnamed_373// Size=0x8 (Id=373)
{
...
struct _unnamed_375// Size=0x4 (Id=375)
{
...
struct _unnamed_376// Size=0x30 (Id=376)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
struct _unnamed_377// Size=0x58 (Id=377)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
union _unnamed_378// Size=0x58 (Id=378)
{
    struct _unnamed_372 Read;// Offset=0x0 Size=0x8
    struct _unnamed_373 Write;// Offset=0x0 Size=0x8
    struct _unnamed_374 Event;// Offset=0x0 Size=0x8
    struct _unnamed_375 Notification;// Offset=0x0 Size=0x4
    struct _unnamed_376 LowPriWrite;// Offset=0x0 Size=0x30
    struct _unnamed_377 AsyncRead;// Offset=0x0 Size=0x58
};

struct _WORK_QUEUE_ENTRY// Size=0x70 (Id=379)
{
    struct _LIST_ENTRY WorkQueueLinks;// Offset=0x0 Size=0x10
    union _unnamed_378 Parameters;// Offset=0x10 Size=0x58
    unsigned char Function;// Offset=0x68 Size=0x1
};
