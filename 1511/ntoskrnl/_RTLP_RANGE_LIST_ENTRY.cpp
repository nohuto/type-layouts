struct _unnamed_1136// Size=0x10 (Id=1136)
{
...
struct _unnamed_1137// Size=0x10 (Id=1137)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
};

struct _RTLP_RANGE_LIST_ENTRY// Size=0x38 (Id=1138)
{
    unsigned long long Start;// Offset=0x0 Size=0x8
    unsigned long long End;// Offset=0x8 Size=0x8
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_1136 Allocated;// Offset=0x10 Size=0x10
        struct _unnamed_1137 Merged;// Offset=0x10 Size=0x10
    };
