...
struct _unnamed_763// Size=0x18 (Id=763)
{
...
struct _unnamed_764// Size=0x8 (Id=764)
{
...
struct _unnamed_769// Size=0x18 (Id=769)
{
...
struct _unnamed_770// Size=0x18 (Id=770)
{
...
struct _unnamed_771// Size=0x18 (Id=771)
{
...
union _unnamed_773// Size=0x18 (Id=773)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_761 Port;// Offset=0x0 Size=0x18
        struct _unnamed_761 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_763 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_764 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_765 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_761 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_766 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_767 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_768 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_769 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_770 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_771 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_772 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=774)
{
    ...
    union _unnamed_773 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=975)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=306)
{
