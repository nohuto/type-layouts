struct _DBGKD_READ_MEMORY32// Size=0xc (Id=316)
{
...
struct _DBGKD_WRITE_MEMORY32// Size=0xc (Id=318)
{
    unsigned long TargetBaseAddress;// Offset=0x0 Size=0x4
    unsigned long TransferCount;// Offset=0x4 Size=0x4
...
struct _DBGKD_WRITE_BREAKPOINT32// Size=0x8 (Id=320)
{
...
struct _DBGKD_READ_WRITE_IO32// Size=0xc (Id=322)
{
...
struct _DBGKD_READ_WRITE_IO_EXTENDED32// Size=0x18 (Id=324)
{
    unsigned long DataSize;// Offset=0x0 Size=0x4
...
struct _DBGKD_SET_SPECIAL_CALL32// Size=0x4 (Id=325)
{
    unsigned long SpecialCall;// Offset=0x0 Size=0x4
};

struct _DBGKD_SET_INTERNAL_BREAKPOINT32// Size=0x8 (Id=327)
{
    unsigned long BreakpointAddress;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
};

struct _DBGKD_GET_INTERNAL_BREAKPOINT32// Size=0x1c (Id=330)
{
    unsigned long BreakpointAddress;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
...
struct _DBGKD_GET_VERSION32// Size=0x28 (Id=865)
{
...
struct _DBGKD_MANIPULATE_STATE32// Size=0x34 (Id=334)
{
    ...
    union _unnamed_333 u;// Offset=0xc Size=0x28
};
