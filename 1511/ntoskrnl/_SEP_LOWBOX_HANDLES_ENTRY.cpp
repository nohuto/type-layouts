...
struct _RTL_DYNAMIC_HASH_TABLE_ENTRY// Size=0x18 (Id=1002)
{
    struct _LIST_ENTRY Linkage;// Offset=0x0 Size=0x10
    unsigned long long Signature;// Offset=0x10 Size=0x8
};

struct _SEP_LOWBOX_HANDLES_ENTRY// Size=0x38 (Id=750)
{
    ...
    unsigned long HandleCount;// Offset=0x28 Size=0x4
    void ** Handles;// Offset=0x30 Size=0x8
};
