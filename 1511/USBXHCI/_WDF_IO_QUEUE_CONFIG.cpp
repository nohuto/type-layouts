...
union _unnamed_298// Size=0x4 (Id=298)
{
    struct _unnamed_297 Parallel;// Offset=0x0 Size=0x4
};

struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=299)
{
    ...
    union _unnamed_298 Settings;// Offset=0x50 Size=0x4
