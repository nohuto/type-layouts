...
struct _unnamed_738// Size=0x8 (Id=738)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_739// Size=0x4 (Id=739)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_740// Size=0x8 (Id=740)
{
    struct _unnamed_738 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_739 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_738 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=217)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_740 Data;// Offset=0x4 Size=0x8
};
