...
struct _COMMON_BUFFER_CALLBACK_DATA// Size=0x30 (Id=635)
{
...
struct _TRANSFERRING_COUNTER// Size=0x28 (Id=477)
{
...
union _ISOCH_DATA_FLAGS// Size=0x4 (Id=817)
{
...
struct _ISOCH_DATA// Size=0x188 (Id=753)
{
    ...
    struct WDFTIMER__ * WdfRingEmptyTimer;// Offset=0x110 Size=0x8
    union _ISOCH_DATA_FLAGS Flags;// Offset=0x118 Size=0x4
    unsigned char DpcRunning;// Offset=0x11c Size=0x1
    unsigned char RingDoorbellOnFirstTD;// Offset=0x11d Size=0x1
    unsigned char IsochPure;// Offset=0x11e Size=0x1
    unsigned long CommonBufferAcquireAttemptCount;// Offset=0x120 Size=0x4
    long ContinueMapping;// Offset=0x124 Size=0x4
    long RequestsAvailable;// Offset=0x128 Size=0x4
    long TransferRingEmptyEventReceived;// Offset=0x12c Size=0x4
    long LateDetected;// Offset=0x130 Size=0x4
    unsigned long PacketsPerFrame;// Offset=0x134 Size=0x4
    unsigned long NextTransferStartFrame;// Offset=0x138 Size=0x4
    unsigned long FrameNumberOfLastTDInSchedule;// Offset=0x13c Size=0x4
    struct _ISOCH_STAGE_DATA * CurrentStage;// Offset=0x140 Size=0x8
    unsigned long PendingStageCount;// Offset=0x148 Size=0x4
    struct _LIST_ENTRY PendingTransferList;// Offset=0x150 Size=0x10
    struct _LIST_ENTRY WaitingForCancelCallbackTransferList;// Offset=0x160 Size=0x10
    struct _LIST_ENTRY CompletionTransferList;// Offset=0x170 Size=0x10
    unsigned long EstimatedTrbsPerTD;// Offset=0x180 Size=0x4
};
