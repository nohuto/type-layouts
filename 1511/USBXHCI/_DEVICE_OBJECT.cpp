...
struct _WAIT_CONTEXT_BLOCK// Size=0x48 (Id=698)
{
...
union _unnamed_120// Size=0x48 (Id=120)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
    struct _WAIT_CONTEXT_BLOCK Wcb;// Offset=0x0 Size=0x48
};

struct _KDEVICE_QUEUE// Size=0x28 (Id=648)
{
...
struct _DEVICE_OBJECT// Size=0x150 (Id=121)
{
    short Type;// Offset=0x0 Size=0x2
    ...
    union _unnamed_120 Queue;// Offset=0x50 Size=0x48
