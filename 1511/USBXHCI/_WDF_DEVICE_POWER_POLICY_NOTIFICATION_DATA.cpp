...
union _unnamed_597// Size=0x8 (Id=597)
{
    struct _unnamed_595 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_596 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_595 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=598)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_597 Data;// Offset=0x4 Size=0x8
};
