...
struct _unnamed_616// Size=0x10 (Id=616)
{
...
struct _unnamed_327// Size=0x2 (Id=327)
{
    unsigned char LowByte;// Offset=0x0 Size=0x1
    unsigned char HiByte;// Offset=0x1 Size=0x1
};

union _unnamed_328// Size=0x2 (Id=328)
{
    struct _unnamed_327 Bytes;// Offset=0x0 Size=0x2
    unsigned short Value;// Offset=0x0 Size=0x2
};

struct _unnamed_329// Size=0x8 (Id=329)
{
    union _unnamed_326 bm;// Offset=0x0 Size=0x1
    unsigned char bRequest;// Offset=0x1 Size=0x1
    union _unnamed_328 wValue;// Offset=0x2 Size=0x2
    union _unnamed_328 wIndex;// Offset=0x4 Size=0x2
...
union _WDF_USB_CONTROL_SETUP_PACKET// Size=0x8 (Id=331)
{
    struct _unnamed_329 Packet;// Offset=0x0 Size=0x8
    struct _unnamed_330 Generic;// Offset=0x0 Size=0x8
};
...
union _unnamed_619// Size=0x18 (Id=619)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_616 DeviceString;// Offset=0x0 Size=0x10
        struct _unnamed_617 DeviceControlTransfer;// Offset=0x0 Size=0x18
        struct _unnamed_618 DeviceUrb;// Offset=0x0 Size=0x8
        struct _unnamed_277 PipeWrite;// Offset=0x0 Size=0x18
        struct _unnamed_277 PipeRead;// Offset=0x0 Size=0x18
        struct _unnamed_618 PipeUrb;// Offset=0x0 Size=0x8
    };
};

struct _WDF_USB_REQUEST_COMPLETION_PARAMS// Size=0x20 (Id=620)
{
    long UsbdStatus;// Offset=0x0 Size=0x4
    enum _WDF_USB_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    union _unnamed_619 Parameters;// Offset=0x8 Size=0x18
};
