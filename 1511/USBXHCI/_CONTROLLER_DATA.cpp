...
struct _PCI_DEVICE_INFORMATION// Size=0x30 (Id=612)
{
...
struct _ACPI_DEVICE_INFORMATION// Size=0xf (Id=664)
{
...
union _FRAME_SNAPSHOT// Size=0x8 (Id=787)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _FRAME_NUMBER_DATA// Size=0x10 (Id=751)
{
...
struct _CONTROLLER_DATA// Size=0x1a0 (Id=385)
{
    ...
    enum UCX_CONTROLLER_PARENT_BUS_TYPE ParentBusType;// Offset=0x94 Size=0x4
    ...
    union _KSE_XHCI_CONTROLLER_FLAGS DeviceFlags;// Offset=0xe8 Size=0x8
    unsigned long long InternalDeviceFlags;// Offset=0xf0 Size=0x8
    struct WDFTIMER__ * WdfTimer;// Offset=0xf8 Size=0x8
    struct WDFWORKITEM__ * TelemetryReportWorkItem;// Offset=0x100 Size=0x8
    unsigned long long TelemetryHistory;// Offset=0x108 Size=0x8
    unsigned char ForwardProgressEnabled;// Offset=0x110 Size=0x1
    unsigned long SpecialFileStatus;// Offset=0x114 Size=0x4
    enum _WDF_POWER_DEVICE_STATE CurrentWdfPowerDeviceState;// Offset=0x118 Size=0x4
    unsigned char ControllerSaveStateFailed;// Offset=0x11c Size=0x1
    unsigned char ControllerGone;// Offset=0x11d Size=0x1
    unsigned long ResetCount;// Offset=0x120 Size=0x4
    unsigned long ResetInterval;// Offset=0x124 Size=0x4
    long ResetLock;// Offset=0x128 Size=0x4
    enum _SYSTEM_POWER_ACTION SystemPowerAction;// Offset=0x12c Size=0x4
    void * HibernateContext;// Offset=0x130 Size=0x8
    struct _FRAME_NUMBER_DATA FrameNumberData;// Offset=0x138 Size=0x10
    unsigned long long HardwareVerifierFlags;// Offset=0x148 Size=0x8
    struct _BUFFER_DATA * ScratchTransferBufferData;// Offset=0x150 Size=0x8
    enum _S0IdleStatus ControllerS0IdleStatus;// Offset=0x158 Size=0x4
    unsigned char WaitWakeQueued;// Offset=0x15c Size=0x1
    struct _CONTROLLER_COUNTER Counter;// Offset=0x160 Size=0x8
    struct _TEST_CONFIGURATION TestConfiguration;// Offset=0x168 Size=0x10
    struct WDFWORKITEM__ * IdleTimeoutUpdateWorkItem;// Offset=0x178 Size=0x8
    unsigned long LastSetIdleTimeout;// Offset=0x180 Size=0x4
    struct POHANDLE__ * PoHandle;// Offset=0x188 Size=0x8
    void * LPEEnterExitCallbackHandle;// Offset=0x190 Size=0x8
    unsigned char WdfPowerReferenceForDebuggerAcquired;// Offset=0x198 Size=0x1
};
