...
struct _unnamed_532// Size=0x8 (Id=532)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_533// Size=0x4 (Id=533)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_534// Size=0x8 (Id=534)
{
    struct _unnamed_532 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_533 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_532 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=218)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_534 Data;// Offset=0x4 Size=0x8
};
