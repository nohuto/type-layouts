...
union _CONTROL_FLAGS// Size=0x4 (Id=820)
{
...
struct _CONTROL_DATA// Size=0x150 (Id=804)
{
    ...
    struct WDFDPC__ * WdfDpcForCanceledOnQueueTransferCompletion;// Offset=0x118 Size=0x8
    struct WDFTIMER__ * WdfTimerForTransferTimeout;// Offset=0x120 Size=0x8
    struct _CONTROL_TRANSFER_DATA * TransferData;// Offset=0x128 Size=0x8
    union _CONTROL_FLAGS Flags;// Offset=0x130 Size=0x4
    unsigned long OutstandingEventCountAfterStop;// Offset=0x134 Size=0x4
    struct _LIST_ENTRY CanceledOnQueueTransferList;// Offset=0x138 Size=0x10
