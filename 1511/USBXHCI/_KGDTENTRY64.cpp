struct _unnamed_755// Size=0x4 (Id=755)
{
...
struct _unnamed_756// Size=0x4 (Id=756)
{
...
union _KGDTENTRY64// Size=0x10 (Id=757)
{
    unsigned short LimitLow;// Offset=0x0 Size=0x2
    unsigned short BaseLow;// Offset=0x2 Size=0x2
    union // Size=0x4 (Id=0)
    {
        struct _unnamed_755 Bytes;// Offset=0x4 Size=0x4
        struct _unnamed_756 Bits;// Offset=0x4 Size=0x4
    };
