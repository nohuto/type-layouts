...
struct _ENDPOINT_UPDATE_DATA// Size=0x68 (Id=503)
{
...
struct _ENDPOINT_STATIC_STREAMS_CONFIGURE// Size=0x8 (Id=506)
{
    struct _STATIC_STREAMS_DATA * StaticStreamsData;// Offset=0x0 Size=0x8
};

struct _ENDPOINT_RESET_DATA// Size=0x60 (Id=582)
{
    struct _ENDPOINT_DATA * EndpointData;// Offset=0x0 Size=0x8
    struct _BUFFER_DATA * InputBufferData;// Offset=0x8 Size=0x8
...
struct _USBDEVICE_ENDPOINTS_CONFIGURE_DATA// Size=0x2 (Id=638)
{
...
struct _CONTROL_TRANSFER_DATA// Size=0x98 (Id=627)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
...
struct _STAGE_QUEUE_HEADER// Size=0x8 (Id=796)
{
...
struct _BULK_STAGE_DATA// Size=0x80 (Id=724)
{
...
struct _BULK_STAGE_QUEUE// Size=0x90 (Id=779)
{
    struct _STAGE_QUEUE_HEADER Header;// Offset=0x0 Size=0x8
    struct _BULK_STAGE_DATA StageArray[1];// Offset=0x10 Size=0x80
};

struct _BULK_TRANSFER_DATA// Size=0x100 (Id=497)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
    unsigned char Initialized;// Offset=0x10 Size=0x1
    struct WDFREQUEST__ * WdfRequest;// Offset=0x18 Size=0x8
