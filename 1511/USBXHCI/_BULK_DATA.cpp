...
union _BULK_DATA_FLAGS// Size=0x4 (Id=721)
{
...
struct _BULK_DATA// Size=0x170 (Id=563)
{
    ...
    unsigned char ImmediateDataEnabled;// Offset=0x110 Size=0x1
    union _BULK_DATA_FLAGS Flags;// Offset=0x114 Size=0x4
    unsigned char DpcRunning;// Offset=0x118 Size=0x1
    unsigned long CommonBufferAcquireAttemptCount;// Offset=0x11c Size=0x4
    long ContinueMapping;// Offset=0x120 Size=0x4
    long RequestsAvailable;// Offset=0x124 Size=0x4
    unsigned long MaxPendingStages;// Offset=0x128 Size=0x4
    unsigned long PendingStageCount;// Offset=0x12c Size=0x4
    unsigned long OutstandingEventCountAfterStop;// Offset=0x130 Size=0x4
    struct _BULK_STAGE_DATA * CurrentStage;// Offset=0x138 Size=0x8
    struct _LIST_ENTRY PendingTransferList;// Offset=0x140 Size=0x10
    struct _LIST_ENTRY WaitingForCancelCallbackTransferList;// Offset=0x150 Size=0x10
    struct _LIST_ENTRY CompletionTransferList;// Offset=0x160 Size=0x10
};
