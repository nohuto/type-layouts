union _unnamed_668// Size=0x2 (Id=668)
{
...
struct _USB_DEVICE_CAPABILITY_PD_CONSUMER_PORT_DESCRIPTOR// Size=0x18 (Id=669)
{
    ...
    union _unnamed_668 bmCapabilities;// Offset=0x4 Size=0x2
