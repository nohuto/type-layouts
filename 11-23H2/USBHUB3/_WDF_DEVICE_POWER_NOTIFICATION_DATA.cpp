...
struct _unnamed_545// Size=0x4 (Id=545)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_546// Size=0x8 (Id=546)
{
    struct _unnamed_544 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_545 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_544 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=547)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_546 Data;// Offset=0x4 Size=0x8
};
