...
union _unnamed_511// Size=0x8 (Id=511)
{
    struct _unnamed_509 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_510 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_509 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=205)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_511 Data;// Offset=0x4 Size=0x8
};
