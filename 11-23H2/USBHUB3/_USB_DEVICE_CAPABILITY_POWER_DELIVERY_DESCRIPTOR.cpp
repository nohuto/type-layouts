union _unnamed_786// Size=0x4 (Id=786)
{
...
struct _USB_DEVICE_CAPABILITY_POWER_DELIVERY_DESCRIPTOR// Size=0x12 (Id=787)
{
    ...
    union _unnamed_786 bmAttributes;// Offset=0x4 Size=0x4
