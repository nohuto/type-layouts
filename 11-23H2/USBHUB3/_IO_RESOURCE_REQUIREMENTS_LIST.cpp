...
struct _unnamed_234// Size=0x8 (Id=234)
{
...
union _unnamed_243// Size=0x18 (Id=243)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_230 Port;// Offset=0x0 Size=0x18
        struct _unnamed_230 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_233 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_234 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_235 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_230 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_236 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_237 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_238 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_239 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_240 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_241 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_242 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=244)
{
    ...
    union _unnamed_243 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=829)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=664)
{
