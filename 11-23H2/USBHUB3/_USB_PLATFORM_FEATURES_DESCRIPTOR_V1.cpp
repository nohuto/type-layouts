...
struct _USB_PLATFORM_FEATURES_DESCRIPTOR_V1// Size=0x1a (Id=808)
{
    ...
    unsigned char VendorCmdCode;// Offset=0x15 Size=0x1
    unsigned long USBFeatures;// Offset=0x16 Size=0x4
};
