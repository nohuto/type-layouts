union _unnamed_605// Size=0x4 (Id=605)
{
...
struct _USB_DEVICE_CAPABILITY_USB20_EXTENSION_DESCRIPTOR// Size=0x7 (Id=606)
{
    ...
    union _unnamed_605 bmAttributes;// Offset=0x3 Size=0x4
};
