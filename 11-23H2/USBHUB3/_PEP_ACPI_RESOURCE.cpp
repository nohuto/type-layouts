...
struct _PEP_ACPI_IO_MEMORY_RESOURCE// Size=0x20 (Id=431)
{
...
union _PEP_ACPI_RESOURCE_FLAGS// Size=0x4 (Id=657)
{
...
struct _PEP_ACPI_INTERRUPT_RESOURCE// Size=0x20 (Id=433)
{
    enum _PEP_ACPI_RESOURCE_TYPE Type;// Offset=0x0 Size=0x4
...
struct _PEP_ACPI_GPIO_RESOURCE// Size=0x48 (Id=436)
{
    enum _PEP_ACPI_RESOURCE_TYPE Type;// Offset=0x0 Size=0x4
...
struct _PEP_ACPI_SPB_RESOURCE// Size=0x28 (Id=468)
{
    enum _PEP_ACPI_RESOURCE_TYPE Type;// Offset=0x0 Size=0x4
    union _PEP_ACPI_RESOURCE_FLAGS Flags;// Offset=0x4 Size=0x4
...
struct _PEP_ACPI_SPB_I2C_RESOURCE// Size=0x30 (Id=437)
{
...
struct _PEP_ACPI_SPB_SPI_RESOURCE// Size=0x38 (Id=439)
{
    struct _PEP_ACPI_SPB_RESOURCE SpbCommon;// Offset=0x0 Size=0x28
    unsigned long ConnectionSpeed;// Offset=0x28 Size=0x4
...
struct _PEP_ACPI_SPB_UART_RESOURCE// Size=0x38 (Id=438)
{
    struct _PEP_ACPI_SPB_RESOURCE SpbCommon;// Offset=0x0 Size=0x28
...
struct _PEP_ACPI_EXTENDED_ADDRESS// Size=0x48 (Id=440)
{
    enum _PEP_ACPI_RESOURCE_TYPE Type;// Offset=0x0 Size=0x4
    union _PEP_ACPI_RESOURCE_FLAGS Flags;// Offset=0x4 Size=0x4
...
union _PEP_ACPI_RESOURCE// Size=0x48 (Id=430)
{
    enum _PEP_ACPI_RESOURCE_TYPE Type;// Offset=0x0 Size=0x4
