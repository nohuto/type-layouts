...
struct _unnamed_518// Size=0x8 (Id=518)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_519// Size=0x4 (Id=519)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_520// Size=0x8 (Id=520)
{
    struct _unnamed_518 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_519 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_518 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=203)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_520 Data;// Offset=0x4 Size=0x8
};
