struct _unnamed_456// Size=0x4 (Id=456)
{
...
union _MM_PAGE_ACCESS_INFO_FLAGS// Size=0x4 (Id=458)
{
    struct _unnamed_456 File;// Offset=0x0 Size=0x4
    struct _unnamed_457 Private;// Offset=0x0 Size=0x4
};

struct _MM_PAGE_ACCESS_INFO// Size=0x8 (Id=453)
{
    union // Size=0x8 (Id=0)
    {
