union _unnamed_137// Size=0x8 (Id=137)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=104)
{
    union // Size=0x4 (Id=0)
    {
...
union _unnamed_140// Size=0x10 (Id=140)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_139 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=508)
{
...
struct _unnamed_141// Size=0x58 (Id=141)
{
...
union _unnamed_142// Size=0x58 (Id=142)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_141 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=143)
{
    ...
    union _unnamed_137 AssociatedIrp;// Offset=0x18 Size=0x8
