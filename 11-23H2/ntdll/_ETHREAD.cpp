...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=558)
{
...
struct _KAPC_STATE// Size=0x30 (Id=507)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=533)
{
...
union _KERNEL_SHADOW_STACK_LIMIT// Size=0x8 (Id=356)
{
...
struct _KTHREAD// Size=0x480 (Id=90)
{
    ...
    unsigned char Spare23[3];// Offset=0x205 Size=0x3
    ...
    unsigned char Spare31[1];// Offset=0x463 Size=0x1
...
struct _KSEMAPHORE// Size=0x20 (Id=497)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=553)
{
...
struct _KLOCK_ENTRY_LOCK_STATE// Size=0x10 (Id=574)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
union _KLOCK_ENTRY_BOOST_BITMAP// Size=0x8 (Id=342)
{
    unsigned long long AllFields;// Offset=0x0 Size=0x8
...
struct _KLOCK_ENTRY// Size=0x60 (Id=332)
{
    union // Size=0x10 (Id=0)
    {
...
struct _GROUP_AFFINITY// Size=0x10 (Id=336)
{
...
struct _ETHREAD// Size=0x910 (Id=124)
{
    ...
    unsigned char LastSoftParkElectionQos;// Offset=0x670 Size=0x1
    unsigned char LastSoftParkElectionWorkloadType;// Offset=0x671 Size=0x1
    unsigned char LastSoftParkElectionRunningType;// Offset=0x672 Size=0x1
    unsigned char Spare1;// Offset=0x673 Size=0x1
    ...
    unsigned long long LastSoftParkElectionGeneration;// Offset=0x8f8 Size=0x8
