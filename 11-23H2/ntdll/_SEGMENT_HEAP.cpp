struct _RTL_HEAP_MEMORY_LIMIT_DATA// Size=0x20 (Id=349)
{
...
union _RTL_RUN_ONCE// Size=0x8 (Id=387)
{
...
struct _HEAP_OPPORTUNISTIC_LARGE_PAGE_STATS// Size=0x10 (Id=646)
{
...
struct _RTL_HP_SEG_ALLOC_POLICY// Size=0x18 (Id=479)
{
...
struct _HEAP_RUNTIME_MEMORY_STATS// Size=0x58 (Id=302)
{
...
struct _RTL_HP_HEAP_VA_CALLBACKS_ENCODED// Size=0x20 (Id=411)
{
...
union _unnamed_300// Size=0x1 (Id=300)
{
    struct // Size=0x1 (Id=0)
    {
        ...
        unsigned char LargeHeapFirstSegment:1;// Offset=0x0 Size=0x1 BitOffset=0x5 BitSize=0x1
    };
...
struct _HEAP_SEG_CONTEXT// Size=0xc0 (Id=301)
{
    ...
    union _unnamed_300 Flags;// Offset=0xd Size=0x1
...
struct _HEAP_VS_DELAY_FREE_CONTEXT// Size=0x10 (Id=439)
{
    union _SLIST_HEADER ListHead;// Offset=0x0 Size=0x10
};

struct _HEAP_SUBALLOCATOR_CALLBACKS// Size=0x28 (Id=243)
{
...
struct _unnamed_389// Size=0x4 (Id=389)
{
...
struct _RTL_HP_VS_CONFIG// Size=0x4 (Id=390)
{
    struct _unnamed_389 Flags;// Offset=0x0 Size=0x4
};

struct _HEAP_VS_CONTEXT// Size=0xc0 (Id=291)
{
...
struct _RTL_HP_LFH_CONFIG// Size=0x4 (Id=465)
{
...
struct _SEGMENT_HEAP// Size=0x840 (Id=306)
{
    ...
    unsigned char * ReservedRegionEnd;// Offset=0x100 Size=0x8
    struct _RTL_HP_HEAP_VA_CALLBACKS_ENCODED CallbacksEncoded;// Offset=0x108 Size=0x20
    struct _HEAP_SEG_CONTEXT SegContexts[2];// Offset=0x140 Size=0x180
    struct _HEAP_VS_CONTEXT VsContext;// Offset=0x2c0 Size=0xc0
    struct _HEAP_LFH_CONTEXT LfhContext;// Offset=0x380 Size=0x4c0
};
