...
struct _unnamed_147// Size=0x18 (Id=147)
{
...
struct _unnamed_152// Size=0x18 (Id=152)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _unnamed_160// Size=0x18 (Id=160)
{
...
struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=499)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=471)
{
...
{
    struct _unnamed_144 Create;// Offset=0x0 Size=0x20
    struct _unnamed_145 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_146 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_147 Read;// Offset=0x0 Size=0x18
    struct _unnamed_147 Write;// Offset=0x0 Size=0x18
    struct _unnamed_149 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_150 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_152 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_153 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_154 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_155 QueryEa;// Offset=0x0 Size=0x20
    struct _unnamed_156 SetEa;// Offset=0x0 Size=0x4
    struct _unnamed_158 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_158 SetVolume;// Offset=0x0 Size=0x10
    struct _unnamed_159 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_160 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_161 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_162 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_163 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_164 MountVolume;// Offset=0x0 Size=0x18
    ...
    struct _unnamed_156 SetQuota;// Offset=0x0 Size=0x4
