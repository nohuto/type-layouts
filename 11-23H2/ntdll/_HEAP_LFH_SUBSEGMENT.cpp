...
union _HEAP_LFH_SUBSEGMENT_DELAY_FREE// Size=0x8 (Id=602)
{
...
struct _HEAP_LFH_SUBSEGMENT_ENCODED_OFFSETS// Size=0x4 (Id=286)
{
    union // Size=0x4 (Id=0)
    {
...
struct _HEAP_LFH_SUBSEGMENT// Size=0x38 (Id=287)
{
