struct _NT_TIB// Size=0x38 (Id=539)
{
...
struct _KSPECIAL_REGISTERS// Size=0xf0 (Id=706)
{
...
struct _CONTEXT// Size=0x4d0 (Id=607)
{
...
struct _KPROCESSOR_STATE// Size=0x5c0 (Id=506)
{
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=431)
{
...
struct _KSTATIC_AFFINITY_BLOCK// Size=0x420 (Id=319)
{
...
struct _KSOFTWARE_INTERRUPT_BATCH// Size=0x110 (Id=443)
{
...
struct _KGATE// Size=0x18 (Id=462)
{
...
struct _PROC_IDLE_POLICY// Size=0x6 (Id=743)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=641)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=614)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=621)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=714)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROC_PERF_CHECK_CONTEXT// Size=0x48 (Id=638)
{
...
struct _PROCESSOR_POWER_STATE// Size=0x238 (Id=586)
{
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=494)
{
    unsigned char Level;// Offset=0x0 Size=0x1
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=631)
{
...
struct _IOP_IRP_STACK_PROFILER// Size=0x54 (Id=605)
{
    unsigned long Profile[20];// Offset=0x0 Size=0x50
    unsigned long TotalIrps;// Offset=0x50 Size=0x4
};

struct _KSECURE_FAULT_INFORMATION// Size=0x18 (Id=416)
{
...
struct _KTIMER_EXPIRATION_TRACE// Size=0x10 (Id=613)
{
...
struct _KCLOCK_TIMER_DEADLINE_ENTRY// Size=0x10 (Id=444)
{
...
struct _KCLOCK_TICK_TRACE// Size=0x28 (Id=394)
{
...
struct _KCLOCK_INCREMENT_TRACE// Size=0x20 (Id=643)
{
...
struct _KCLOCK_TIMER_STATE// Size=0x518 (Id=344)
{
...
struct _MACHINE_FRAME// Size=0x28 (Id=742)
{
...
struct _MACHINE_CHECK_CONTEXT// Size=0x50 (Id=562)
{
...
struct _KLOCK_QUEUE_HANDLE// Size=0x18 (Id=540)
{
