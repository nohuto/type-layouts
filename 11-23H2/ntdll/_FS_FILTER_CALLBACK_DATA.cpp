...
struct _unnamed_809// Size=0x18 (Id=809)
{
...
struct _unnamed_810// Size=0x20 (Id=810)
{
...
struct _unnamed_811// Size=0x28 (Id=811)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=812)
{
    struct _unnamed_806 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_807 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_809 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _unnamed_810 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_811 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=789)
{
