...
struct _PROCESSOR_IDLE_CONSTRAINTS// Size=0x30 (Id=749)
{
...
struct _PROCESSOR_IDLE_PREPARE_INFO// Size=0x58 (Id=775)
{
...
struct _PPM_SELECTION_MENU// Size=0x10 (Id=765)
{
    unsigned long Count;// Offset=0x0 Size=0x4
    struct _PPM_SELECTION_MENU_ENTRY * Entries;// Offset=0x8 Size=0x8
};

struct _PPM_COORDINATED_SELECTION// Size=0x18 (Id=782)
{
...
struct _PPM_VETO_ACCOUNTING// Size=0x28 (Id=787)
{
...
struct _PPM_IDLE_STATE// Size=0x158 (Id=752)
{
...
struct _PPM_IDLE_STATES// Size=0x5b0 (Id=709)
{
    ...
    unsigned long long InitiateWakeStamp;// Offset=0x40 Size=0x8
    long PreviousStatus;// Offset=0x48 Size=0x4
    unsigned long PreviousCancelReason;// Offset=0x4c Size=0x4
    struct _KAFFINITY_EX PrimaryProcessorMask;// Offset=0x50 Size=0x108
    struct _KAFFINITY_EX SecondaryProcessorMask;// Offset=0x158 Size=0x108
    void  ( * IdlePrepare)(struct _PROCESSOR_IDLE_PREPARE_INFO * );// Offset=0x260 Size=0x8
    long  ( * IdlePreExecute)(void * ,unsigned long ,unsigned long ,unsigned long ,unsigned long * );// Offset=0x268 Size=0x8
    long  ( * IdleExecute)(void * ,unsigned long long ,unsigned long ,unsigned long ,unsigned long ,unsigned long ,unsigned long * );// Offset=0x270 Size=0x8
    unsigned long  ( * IdlePreselect)(void * ,struct _PROCESSOR_IDLE_CONSTRAINTS * );// Offset=0x278 Size=0x8
    unsigned long  ( * IdleTest)(void * ,unsigned long ,unsigned long );// Offset=0x280 Size=0x8
    unsigned long  ( * IdleAvailabilityCheck)(void * ,unsigned long );// Offset=0x288 Size=0x8
    void  ( * IdleComplete)(void * ,unsigned long ,unsigned long ,unsigned long ,unsigned long * );// Offset=0x290 Size=0x8
    void  ( * IdleCancel)(void * ,unsigned long );// Offset=0x298 Size=0x8
    unsigned char  ( * IdleIsHalted)(void * );// Offset=0x2a0 Size=0x8
    unsigned char  ( * IdleInitiateWake)(void * );// Offset=0x2a8 Size=0x8
    struct _PROCESSOR_IDLE_PREPARE_INFO PrepareInfo;// Offset=0x2b0 Size=0x58
    struct _KAFFINITY_EX DeepIdleSnapshot;// Offset=0x308 Size=0x108
    struct _PERFINFO_PPM_STATE_SELECTION * Tracing;// Offset=0x410 Size=0x8
    struct _PERFINFO_PPM_STATE_SELECTION * CoordinatedTracing;// Offset=0x418 Size=0x8
    struct _PPM_SELECTION_MENU ProcessorMenu;// Offset=0x420 Size=0x10
    struct _PPM_SELECTION_MENU CoordinatedMenu;// Offset=0x430 Size=0x10
    struct _PPM_COORDINATED_SELECTION CoordinatedSelection;// Offset=0x440 Size=0x18
    struct _PPM_IDLE_STATE State[1];// Offset=0x458 Size=0x158
};
