...
struct _TLSPRITESTATE// Size=0xa8 (Id=352)
{
...
struct _W32THREAD// Size=0x188 (Id=161)
{
    ...
    {
        unsigned int bEnableEngUpdateDeviceSurface:1;// Offset=0x148 Size=0x4 BitOffset=0x0 BitSize=0x1
        unsigned int bIncludeSprites:1;// Offset=0x148 Size=0x4 BitOffset=0x1 BitSize=0x1
        unsigned int bEnableAppContainerRendering:1;// Offset=0x148 Size=0x4 BitOffset=0x2 BitSize=0x1
        unsigned int bSnapWindowScreenAccess:1;// Offset=0x148 Size=0x4 BitOffset=0x3 BitSize=0x1
        unsigned int bGdiEngMode:1;// Offset=0x148 Size=0x4 BitOffset=0x4 BitSize=0x1
    };
    ...
    void * psoUMPDTmpSrc;// Offset=0x180 Size=0x8
};
