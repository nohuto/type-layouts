...
struct _WHEA_NOTIFICATION_DESCRIPTOR// Size=0x1c (Id=379)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x18 (Id=6261)
        {
...
struct _WHEA_PCI_SLOT_NUMBER// Size=0x4 (Id=284)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=6335)
        {
            struct <unnamed-type-bits>// Size=0x4 (Id=6336)
            {
...
struct _WHEA_ERROR_SOURCE_DESCRIPTOR// Size=0x3cc (Id=137)
{
    union // Size=0x28 (Id=0)
    {
        ...
        union <unnamed-type-Info>// Size=0x3a4 (Id=6061)
        {
