struct _NDIS_PM_PACKET_PATTERN// Size=0x18 (Id=895)
{
...
struct _NDIS_PM_COUNTED_STRING// Size=0x84 (Id=2006)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    wchar_t String[65];// Offset=0x2 Size=0x82
};

struct _NDIS_PM_WOL_PATTERN// Size=0xc4 (Id=1651)
{
    union // Size=0x9c (Id=0)
    {
        ...
        union _WOL_PATTERN// Size=0x28 (Id=10003)
        {
            struct _IPV4_TCP_SYN_WOL_PACKET_PARAMETERS// Size=0x10 (Id=10004)
            {
            ...
            struct _IPV6_TCP_SYN_WOL_PACKET_PARAMETERS// Size=0x28 (Id=10011)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
            ...
            struct _EAPOL_REQUEST_ID_MESSAGE_WOL_PACKET_PARAMETERS// Size=0x4 (Id=10018)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
            };
            ...
            struct _WOL_BITMAP_PATTERN// Size=0x14 (Id=10021)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
...
struct _NDIS_PM_PROTOCOL_OFFLOAD// Size=0x100 (Id=1461)
{
    union // Size=0x9c (Id=0)
    {
        struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
        ...
        union _PROTOCOL_OFFLOAD_PARAMETERS// Size=0x60 (Id=9935)
        {
...
union _NDIS_PACKET_PATTERN_ENTRY::_unnamed_1846// Size=0x100 (Id=1846)
{
