...
struct _NDIS_MINIPORT_ADD_DEVICE_REGISTRATION_ATTRIBUTES// Size=0x18 (Id=1072)
{
...
struct _NDIS_MINIPORT_ADAPTER_REGISTRATION_ATTRIBUTES// Size=0x20 (Id=1038)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES// Size=0xe0 (Id=1428)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_ADAPTER_OFFLOAD_ATTRIBUTES// Size=0x28 (Id=1627)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_ADAPTER_NATIVE_802_11_ATTRIBUTES// Size=0x40 (Id=1414)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_ADAPTER_HARDWARE_ASSIST_ATTRIBUTES// Size=0x60 (Id=991)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_ADAPTER_NDK_ATTRIBUTES// Size=0x10 (Id=1221)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_ADAPTER_PACKET_DIRECT_ATTRIBUTES// Size=0xc (Id=785)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
...
union _NDIS_MINIPORT_ADAPTER_ATTRIBUTES// Size=0xe0 (Id=903)
{
