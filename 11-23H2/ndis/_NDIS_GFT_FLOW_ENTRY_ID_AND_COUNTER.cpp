...
struct _NDIS_GFT_COUNTER_VALUE// Size=0x28 (Id=1172)
{
    union // Size=0x4 (Id=0)
    {
        enum _NDIS_GFT_COUNTER_TYPE CounterType;// Offset=0x0 Size=0x4
        union <unnamed-type-CounterValue>// Size=0x20 (Id=6871)
        {
...
struct _NDIS_GFT_FLOW_ENTRY_ID_AND_COUNTER// Size=0x30 (Id=992)
{
