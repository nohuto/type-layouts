...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=1128)
{
...
struct _KAPC// Size=0x58 (Id=1067)
{
...
struct _IRP// Size=0xd0 (Id=100)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=4807)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=4826)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=4827)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=4840)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=4841)
            {
