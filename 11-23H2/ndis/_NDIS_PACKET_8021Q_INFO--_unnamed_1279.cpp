union _NDIS_PACKET_8021Q_INFO::_unnamed_1279// Size=0x8 (Id=1279)
{
    struct <unnamed-type-TagHeader>// Size=0x4 (Id=9593)
    {
    ...
    struct _NDIS_PACKET_8021Q_INFO::_unnamed_1280::<unnamed-type-TagHeader> TagHeader;// Offset=0x0 Size=0x4
