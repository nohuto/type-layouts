...
union _DMA_COMMON_BUFFER_EXTENDED_CONFIGURATION::_unnamed_846// Size=0x20 (Id=846)
{
    struct <unnamed-type-LogicalAddressLimits>// Size=0x10 (Id=3196)
    {
        union _LARGE_INTEGER MinimumAddress;// Offset=0x0 Size=0x8
        union _LARGE_INTEGER MaximumAddress;// Offset=0x8 Size=0x8
    };
    struct _DMA_COMMON_BUFFER_EXTENDED_CONFIGURATION::_unnamed_847::<unnamed-type-LogicalAddressLimits> LogicalAddressLimits;// Offset=0x0 Size=0x10
    struct <unnamed-type-SubSection>// Size=0x10 (Id=3200)
    {
        unsigned long long Offset;// Offset=0x0 Size=0x8
        unsigned long Length;// Offset=0x8 Size=0x4
    };
    struct _DMA_COMMON_BUFFER_EXTENDED_CONFIGURATION::_unnamed_848::<unnamed-type-SubSection> SubSection;// Offset=0x0 Size=0x10
