union _NDIS_IPSEC_OFFLOAD_V2_NET_BUFFER_LIST_INFO::_unnamed_1820// Size=0x8 (Id=1820)
{
    union // Size=0x8 (Id=0)
    {
        struct <unnamed-type-Transmit>// Size=0x8 (Id=7494)
        {
            void * OffloadHandle;// Offset=0x0 Size=0x8
        };
        struct _NDIS_IPSEC_OFFLOAD_V2_NET_BUFFER_LIST_INFO::_unnamed_1821::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x8
        struct <unnamed-type-Receive>// Size=0x4 (Id=7497)
        {
        ...
        struct _NDIS_IPSEC_OFFLOAD_V2_NET_BUFFER_LIST_INFO::_unnamed_1822::<unnamed-type-Receive> Receive;// Offset=0x0 Size=0x4
    };
};
