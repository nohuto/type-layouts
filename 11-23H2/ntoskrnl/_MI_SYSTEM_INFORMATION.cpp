...
struct _MI_ACCESS_VIOLATION_RANGE// Size=0x28 (Id=2200)
{
...
struct _MI_POOL_STATE// Size=0xa0 (Id=1947)
{
...
struct _MMSUBSECTION_FLAGS// Size=0x4 (Id=1908)
{
...
struct _MI_SUBSECTION_ENTRY1// Size=0x4 (Id=1369)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _SUBSECTION// Size=0x38 (Id=1171)
{
    ...
    union _unnamed_1169 u;// Offset=0x20 Size=0x4
    ...
    union _unnamed_1170 u1;// Offset=0x30 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _unnamed_1448// Size=0x8 (Id=1448)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _unnamed_1449// Size=0x8 (Id=1449)
{
    unsigned long long PrototypePtesFlags;// Offset=0x0 Size=0x8
};

union _unnamed_1450// Size=0x8 (Id=1450)
{
    struct _unnamed_1448 e1;// Offset=0x0 Size=0x8
    struct _unnamed_1449 e2;// Offset=0x0 Size=0x8
};

struct _MI_PROTOTYPE_PTES_NODE// Size=0x20 (Id=1451)
{
    struct _RTL_BALANCED_NODE Node;// Offset=0x0 Size=0x18
    union _unnamed_1450 u1;// Offset=0x18 Size=0x8
};

struct _MSUBSECTION// Size=0x98 (Id=2031)
{
...
struct _MMSECTION_FLAGS// Size=0x4 (Id=1001)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MMSECTION_FLAGS2// Size=0x4 (Id=1228)
{
...
struct _unnamed_1523// Size=0x8 (Id=1523)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _unnamed_1524// Size=0x8 (Id=1524)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long Tradable:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _MI_ACTIVE_PFN// Size=0x8 (Id=1525)
{
    union // Size=0x8 (Id=0)
    {
        struct _unnamed_1523 Leaf;// Offset=0x0 Size=0x8
        struct _unnamed_1524 PageTable;// Offset=0x0 Size=0x8
...
struct _MMPTE_HARDWARE// Size=0x8 (Id=1121)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _MMPTE_PROTOTYPE// Size=0x8 (Id=1567)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long Valid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _MMPTE_SOFTWARE// Size=0x8 (Id=1394)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long Valid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _MMPTE_TIMESTAMP// Size=0x8 (Id=1659)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _MMPTE_TRANSITION// Size=0x8 (Id=1978)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long Valid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _MMPTE_SUBSECTION// Size=0x8 (Id=1115)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long Valid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _MMPTE_LIST// Size=0x8 (Id=1755)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long Valid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _MIPFNBLINK// Size=0x8 (Id=1864)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _KGATE// Size=0x18 (Id=1350)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
};

struct _MI_EXTENT_DELETION_WAIT_BLOCK// Size=0x20 (Id=1915)
{
...
struct _MI_DLL_OVERFLOW_AREA// Size=0x20 (Id=1613)
{
...
struct _MI_SECTION_WOW_STATE// Size=0x40 (Id=1677)
{
...
struct _MI_SECTION_STATE// Size=0x380 (Id=1381)
{
...
struct _MI_SESSION_STATE// Size=0x30 (Id=1378)
{
...
struct _MI_PROCESS_STATE// Size=0x48 (Id=1275)
{
...
struct _MI_DYNAMIC_BITMAP// Size=0x48 (Id=1751)
{
...
struct _MMWSL_INSTANCE// Size=0x28 (Id=1574)
{
...
struct _MI_SYSTEM_VA_STATE// Size=0x540 (Id=1582)
{
    ...
    unsigned long VaRegionShadowed[8];// Offset=0x284 Size=0x20
    unsigned long TopLevelPteLockBits[32];// Offset=0x2a4 Size=0x80
    long DeleteKvaLock;// Offset=0x324 Size=0x4
    struct _MI_WSLE * WsleArrays[8];// Offset=0x328 Size=0x40
    void * PagableHyperSpace;// Offset=0x368 Size=0x8
    void * HyperSpaceEnd;// Offset=0x370 Size=0x8
    unsigned long long PagableHyperSpaceBytes;// Offset=0x378 Size=0x8
    unsigned long long PageTableCommitmentOffset[2];// Offset=0x380 Size=0x10
    struct _KEVENT FreeSystemCacheVa;// Offset=0x390 Size=0x18
    unsigned long long SystemVaLock;// Offset=0x3a8 Size=0x8
    unsigned long long SystemCacheViewLock;// Offset=0x3b0 Size=0x8
    struct _MMWSL_INSTANCE SystemWorkingSetList[8];// Offset=0x3b8 Size=0x140
    unsigned long long SelfmapLock[4];// Offset=0x4f8 Size=0x20
};

struct _MI_COMBINE_STATE// Size=0x20 (Id=1824)
{
...
struct _MI_PAGELIST_STATE// Size=0x110 (Id=1848)
{
    long ActiveSpinLock;// Offset=0x0 Size=0x4
    struct _RTL_AVL_TREE ActiveThreadTree;// Offset=0x8 Size=0x8
...
struct _MI_PARTITION_STATE// Size=0xac0 (Id=1311)
{
...
struct _MI_BAD_MEMORY_EVENT_ENTRY// Size=0x38 (Id=2050)
{
...
struct _MI_PROBE_RAISE_TRACKER// Size=0x40 (Id=2123)
{
...
struct _MI_FORCED_COMMITS// Size=0x8 (Id=2080)
{
...
struct _MI_RESAVAIL_FAILURES// Size=0x8 (Id=2110)
{
    unsigned long Wrap;// Offset=0x0 Size=0x4
    unsigned long NoCharge;// Offset=0x4 Size=0x4
};

struct _MI_ERROR_STATE// Size=0x100 (Id=1967)
{
...
struct _MI_ACCESS_LOG_STATE// Size=0x80 (Id=1543)
{
...
struct _MI_DEBUGGER_STATE// Size=0x118 (Id=1635)
{
...
struct _MI_STANDBY_STATE// Size=0x1a0 (Id=1815)
{
...
struct _NPAGED_LOOKASIDE_LIST// Size=0x80 (Id=815)
{
...
struct _MI_ULTRA_VA_CONTEXT// Size=0x40 (Id=1597)
{
...
struct _MI_HUGE_SYSTEM_VIEW_HEAD// Size=0x10 (Id=1774)
{
...
struct _MI_SYSTEM_PTE_STATE// Size=0x1280 (Id=1554)
{
...
struct _MI_PAGEFILE_METADATA_LAYOUT// Size=0x8 (Id=2128)
{
    unsigned long EntryInBytes;// Offset=0x0 Size=0x4
    unsigned long OwningPteOffset;// Offset=0x4 Size=0x4
};

struct _MI_PAGING_IO_STATE// Size=0xb0 (Id=1813)
{
...
struct _MI_COMMON_PAGE_STATE// Size=0xa8 (Id=1970)
{
...
struct _MI_SYSTEM_TRIM_STATE// Size=0x40 (Id=1516)
{
...
struct _MI_HOT_PATCH_PROCESS_CONTEXT// Size=0x18 (Id=1854)
{
...
struct _MI_HOT_PATCH_STATE// Size=0x60 (Id=1475)
{
...
struct _MI_ENCLAVE_STATE// Size=0x48 (Id=1312)
{
...
struct _MM_PAGED_POOL_INFO// Size=0x18 (Id=1188)
{
...
struct _MMSUPPORT_AGGREGATION// Size=0x20 (Id=1276)
{
...
struct _SYSPTES_HEADER// Size=0x118 (Id=1964)
{
...
struct _MI_SYSTEM_VA_ASSIGNMENT// Size=0x10 (Id=2219)
{
    void * BaseAddress;// Offset=0x0 Size=0x8
    unsigned long long NumberOfBytes;// Offset=0x8 Size=0x8
};

struct _MI_VISIBLE_STATE// Size=0xd00 (Id=2028)
{
...
struct _MI_SYSTEM_INFORMATION// Size=0x5180 (Id=1257)
{
    ...
    struct _MI_SYSTEM_VA_STATE SystemVa;// Offset=0x1880 Size=0x540
    struct _MI_COMBINE_STATE PageCombines;// Offset=0x1dc0 Size=0x20
    struct _MI_PAGELIST_STATE PageLists;// Offset=0x1de0 Size=0x110
    struct _MI_PARTITION_STATE Partitions;// Offset=0x1f00 Size=0xac0
    struct _MI_SHUTDOWN_STATE Shutdowns;// Offset=0x29c0 Size=0x78
    struct _MI_ERROR_STATE Errors;// Offset=0x2a38 Size=0x100
    struct _MI_ACCESS_LOG_STATE AccessLog;// Offset=0x2b40 Size=0x80
    struct _MI_DEBUGGER_STATE Debugger;// Offset=0x2bc0 Size=0x118
    struct _MI_STANDBY_STATE Standby;// Offset=0x2ce0 Size=0x1a0
    struct _MI_SYSTEM_PTE_STATE SystemPtes;// Offset=0x2e80 Size=0x1280
    struct _MI_IO_PAGE_STATE IoPages;// Offset=0x4100 Size=0xc0
    struct _MI_PAGING_IO_STATE PagingIo;// Offset=0x41c0 Size=0xb0
    struct _MI_COMMON_PAGE_STATE CommonPages;// Offset=0x4270 Size=0xa8
    struct _MI_SYSTEM_TRIM_STATE Trims;// Offset=0x4340 Size=0x40
    struct _MI_SYSTEM_ACCELERATORS Accelerators;// Offset=0x4380 Size=0x28
    struct _MI_HOT_PATCH_STATE HotPatch;// Offset=0x43a8 Size=0x60
    struct _MI_ENCLAVE_STATE Enclaves;// Offset=0x4408 Size=0x48
    unsigned long long Cookie;// Offset=0x4450 Size=0x8
    void ** BootRegistryRuns;// Offset=0x4458 Size=0x8
    long ZeroingDisabled;// Offset=0x4460 Size=0x4
    unsigned char FullyInitialized;// Offset=0x4464 Size=0x1
    unsigned char SafeBooted;// Offset=0x4465 Size=0x1
    struct _tlgProvider_t * TraceLogging;// Offset=0x4468 Size=0x8
    struct _MI_VISIBLE_STATE Vs;// Offset=0x4480 Size=0xd00
};
