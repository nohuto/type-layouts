struct _PPM_SELECTION_STATISTICS// Size=0x88 (Id=1927)
{
...
struct _PROC_IDLE_STATE_BUCKET// Size=0x20 (Id=2161)
{
...
struct _PLATFORM_IDLE_STATE_ACCOUNTING// Size=0x3f8 (Id=1758)
{
    ...
    struct _PPM_SELECTION_STATISTICS SelectionStatistics;// Offset=0x30 Size=0x88
    struct _PROC_IDLE_STATE_BUCKET IdleTimeBuckets[26];// Offset=0xb8 Size=0x340
};

struct _PLATFORM_IDLE_ACCOUNTING// Size=0x410 (Id=1013)
{
    ...
    struct _PLATFORM_IDLE_STATE_ACCOUNTING State[1];// Offset=0x18 Size=0x3f8
};
