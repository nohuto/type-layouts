struct _DBGKD_READ_MEMORY64// Size=0x10 (Id=732)
{
...
struct _DBGKD_WRITE_MEMORY64// Size=0x10 (Id=734)
{
    unsigned long long TargetBaseAddress;// Offset=0x0 Size=0x8
    unsigned long TransferCount;// Offset=0x8 Size=0x4
...
struct _X86_DBGKD_CONTROL_SET// Size=0x10 (Id=1607)
{
    unsigned long TraceFlag;// Offset=0x0 Size=0x4
...
struct _IA64_DBGKD_CONTROL_SET// Size=0x14 (Id=1769)
{
...
struct _ARM_DBGKD_CONTROL_SET// Size=0xc (Id=1453)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
...
struct _ARM64_DBGKD_CONTROL_SET// Size=0x18 (Id=1643)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
...
struct _ARMCE_DBGKD_CONTROL_SET// Size=0xc (Id=1193)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
    unsigned long CurrentSymbolStart;// Offset=0x4 Size=0x4
    unsigned long CurrentSymbolEnd;// Offset=0x8 Size=0x4
...
struct _PPC_DBGKD_CONTROL_SET// Size=0xc (Id=1906)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
    unsigned long CurrentSymbolStart;// Offset=0x4 Size=0x4
    unsigned long CurrentSymbolEnd;// Offset=0x8 Size=0x4
...
struct _DBGKD_ANY_CONTROL_SET// Size=0x1c (Id=1034)
{
...
struct _DBGKD_CONTINUE2// Size=0x20 (Id=757)
{
    long ContinueStatus;// Offset=0x0 Size=0x4
    union // Size=0x1c (Id=0)
    {
...
struct _DBGKD_READ_WRITE_IO64// Size=0x10 (Id=738)
{
...
struct _DBGKD_READ_WRITE_IO_EXTENDED64// Size=0x20 (Id=740)
{
...
struct _DBGKD_QUERY_SPECIAL_CALLS// Size=0x4 (Id=1011)
{
    unsigned long NumberOfSpecialCalls;// Offset=0x0 Size=0x4
};

struct _DBGKD_SET_SPECIAL_CALL64// Size=0x8 (Id=743)
{
    unsigned long long SpecialCall;// Offset=0x0 Size=0x8
};

struct _DBGKD_SET_INTERNAL_BREAKPOINT64// Size=0x10 (Id=745)
{
    unsigned long long BreakpointAddress;// Offset=0x0 Size=0x8
    unsigned long Flags;// Offset=0x8 Size=0x4
};

struct _DBGKD_GET_INTERNAL_BREAKPOINT64// Size=0x20 (Id=746)
{
    unsigned long long BreakpointAddress;// Offset=0x0 Size=0x8
    unsigned long Flags;// Offset=0x8 Size=0x4
...
struct _DBGKD_GET_VERSION64// Size=0x28 (Id=1794)
{
...
struct _DBGKD_SEARCH_MEMORY// Size=0x18 (Id=754)
{
    union // Size=0x8 (Id=0)
    {
...
struct _DBGKD_GET_SET_BUS_DATA// Size=0x14 (Id=1053)
{
...
struct _DBGKD_FILL_MEMORY// Size=0x10 (Id=1913)
{
...
struct _DBGKD_QUERY_MEMORY// Size=0x18 (Id=1140)
{
    unsigned long long Address;// Offset=0x0 Size=0x8
...
struct _DBGKD_SWITCH_PARTITION// Size=0x4 (Id=1762)
{
    unsigned long Partition;// Offset=0x0 Size=0x4
};

struct _DBGKD_CONTEXT_EX// Size=0xc (Id=1821)
{
...
struct _DBGKD_WRITE_CUSTOM_BREAKPOINT// Size=0x18 (Id=1139)
{
    unsigned long long BreakPointAddress;// Offset=0x0 Size=0x8
...
union _unnamed_748// Size=0x28 (Id=748)
{
...
struct _DBGKD_MANIPULATE_STATE64// Size=0x38 (Id=749)
{
    ...
    union _unnamed_748 u;// Offset=0x10 Size=0x28
};
