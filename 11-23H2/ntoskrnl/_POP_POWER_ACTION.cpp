...
struct _unnamed_1730// Size=0x18 (Id=1730)
{
...
struct _POP_POWER_ACTION// Size=0x1d0 (Id=1732)
{
    ...
    struct _unnamed_1730 WakeAlarm[3];// Offset=0x68 Size=0x48
    ...
    unsigned long WatchdogTimeout;// Offset=0x1b0 Size=0x4
    struct _KTHREAD * ActionWorkerThread;// Offset=0x1b8 Size=0x8
    struct _KTHREAD * PromoteActionWorkerThread;// Offset=0x1c0 Size=0x8
    struct _KTHREAD * UnlockAfterSleepWorkerThread;// Offset=0x1c8 Size=0x8
};
