...
union _unnamed_2016// Size=0x10 (Id=2016)
{
    struct _IO_STATUS_BLOCK IoStatus;// Offset=0x0 Size=0x10
};

struct _MODWRITER_FLAGS// Size=0x4 (Id=2036)
{
...
struct _MMMOD_WRITER_MDL_ENTRY// Size=0x108 (Id=2017)
{
    struct _LIST_ENTRY Links;// Offset=0x0 Size=0x10
    union _unnamed_2016 u;// Offset=0x10 Size=0x10
