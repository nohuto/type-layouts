...
struct _unnamed_2304// Size=0x18 (Id=2304)
{
...
struct _unnamed_2305// Size=0x20 (Id=2305)
{
...
struct _unnamed_2306// Size=0x28 (Id=2306)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=2307)
{
    struct _unnamed_2301 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_2302 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_2304 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _unnamed_2305 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_2306 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=2288)
{
