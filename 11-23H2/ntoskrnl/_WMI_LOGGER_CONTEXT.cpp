...
struct _ETW_BUFFER_QUEUE// Size=0x10 (Id=938)
{
...
struct _ETW_REF_CLOCK// Size=0x10 (Id=1488)
{
...
struct _SECURITY_QUALITY_OF_SERVICE// Size=0xc (Id=223)
{
...
struct _SECURITY_CLIENT_CONTEXT// Size=0x48 (Id=1282)
{
...
struct _ETW_STACK_TRACE_BLOCK// Size=0xa0 (Id=1691)
{
...
struct _DISALLOWED_GUIDS// Size=0x10 (Id=1479)
{
...
struct _ETW_PARTITION_CONTEXT// Size=0x8 (Id=1102)
{
    struct _EPARTITION * Partition;// Offset=0x0 Size=0x8
};

struct _WMI_LOGGER_CONTEXT// Size=0x540 (Id=947)
{
    ...
    struct _ETW_STACK_TRACE_BLOCK StackTraceBlock;// Offset=0x340 Size=0xa0
    struct _RTL_BITMAP HookIdMap;// Offset=0x3e0 Size=0x10
    struct _ETW_STACK_CACHE * StackCache;// Offset=0x3f0 Size=0x8
    struct _ETW_PMC_SUPPORT * PmcData;// Offset=0x3f8 Size=0x8
    struct _ETW_LBR_SUPPORT * LbrData;// Offset=0x400 Size=0x8
    struct _ETW_IPT_SUPPORT * IptData;// Offset=0x408 Size=0x8
    struct _LIST_ENTRY BinaryTrackingList;// Offset=0x410 Size=0x10
    struct _WMI_BUFFER_HEADER ** ScratchArray;// Offset=0x420 Size=0x8
    struct _DISALLOWED_GUIDS DisallowedGuids;// Offset=0x428 Size=0x10
    struct PERIODIC_CAPTURE_STATE_CONTEXT * PeriodicCaptureStateContext;// Offset=0x438 Size=0x8
    struct _ETW_SOFT_RESTART_CONTEXT * SoftRestartContext;// Offset=0x440 Size=0x8
    struct _ETW_SILODRIVERSTATE * SiloState;// Offset=0x448 Size=0x8
    struct _WORK_QUEUE_ITEM CompressionWorkItem;// Offset=0x450 Size=0x20
    long CompressionWorkItemState;// Offset=0x470 Size=0x4
    struct _EX_PUSH_LOCK CompressionLock;// Offset=0x478 Size=0x8
    struct _WMI_BUFFER_HEADER * CompressionTarget;// Offset=0x480 Size=0x8
    void * CompressionWorkspace;// Offset=0x488 Size=0x8
    long CompressionOn;// Offset=0x490 Size=0x4
    unsigned long CompressionRatioGuess;// Offset=0x494 Size=0x4
    unsigned long PartialBufferCompressionLevel;// Offset=0x498 Size=0x4
    enum ETW_COMPRESSION_RESUMPTION_MODE CompressionResumptionMode;// Offset=0x49c Size=0x4
    struct _SINGLE_LIST_ENTRY PlaceholderList;// Offset=0x4a0 Size=0x8
    struct _KDPC CompressionDpc;// Offset=0x4a8 Size=0x40
    union _LARGE_INTEGER LastBufferSwitchTime;// Offset=0x4e8 Size=0x8
    union _LARGE_INTEGER BufferWriteDuration;// Offset=0x4f0 Size=0x8
    union _LARGE_INTEGER BufferCompressDuration;// Offset=0x4f8 Size=0x8
    long long ReferenceQpcDelta;// Offset=0x500 Size=0x8
    struct _ETW_EVENT_CALLBACK_CONTEXT * CallbackContext;// Offset=0x508 Size=0x8
    union _LARGE_INTEGER * LastDroppedTime;// Offset=0x510 Size=0x8
    union _LARGE_INTEGER * FlushingLastDroppedTime;// Offset=0x518 Size=0x8
    long long FlushingSequenceNumber;// Offset=0x520 Size=0x8
    struct _ETW_PARTITION_CONTEXT PartitionContext;// Offset=0x528 Size=0x8
    struct _MDL * BufferMdl;// Offset=0x530 Size=0x8
};
