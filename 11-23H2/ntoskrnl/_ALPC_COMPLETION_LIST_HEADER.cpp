struct _unnamed_1850// Size=0x8 (Id=1850)
{
...
union _unnamed_1851// Size=0x8 (Id=1851)
{
    struct _unnamed_1850 s1;// Offset=0x0 Size=0x8
    long long Value;// Offset=0x0 Size=0x8
};

struct _ALPC_COMPLETION_LIST_STATE// Size=0x8 (Id=1586)
{
    union _unnamed_1851 u1;// Offset=0x0 Size=0x8
};

struct _RTL_SRWLOCK// Size=0x8 (Id=1509)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _ALPC_COMPLETION_LIST_HEADER// Size=0x180 (Id=1587)
{
