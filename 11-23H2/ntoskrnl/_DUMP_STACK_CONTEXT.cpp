...
struct _unnamed_2186// Size=0x8 (Id=2186)
{
...
struct _unnamed_2187// Size=0x10 (Id=2187)
{
    struct _GUID DiskId;// Offset=0x0 Size=0x10
};

union _unnamed_2188// Size=0x10 (Id=2188)
{
    struct _unnamed_2186 Mbr;// Offset=0x0 Size=0x8
    struct _unnamed_2187 Gpt;// Offset=0x0 Size=0x10
};

struct _DUMP_INITIALIZATION_CONTEXT// Size=0x108 (Id=2190)
{
    ...
    union _unnamed_2188 DiskInfo;// Offset=0x8c Size=0x10
...
struct _DUMP_STACK_CONTEXT// Size=0x178 (Id=2133)
{
