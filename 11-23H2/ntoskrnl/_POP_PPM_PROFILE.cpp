...
union _PPM_POLICY_SETTINGS_MASK// Size=0x8 (Id=1078)
{
    ...
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned long FrequencyCap:1;// Offset=0x4 Size=0x4 BitOffset=0xa BitSize=0x1
        unsigned long ThreadPolicy:1;// Offset=0x4 Size=0x4 BitOffset=0xb BitSize=0x1
        unsigned long ShortThreadPolicy:1;// Offset=0x4 Size=0x4 BitOffset=0xc BitSize=0x1
        unsigned long IdleStateMax:1;// Offset=0x4 Size=0x4 BitOffset=0xd BitSize=0x1
        unsigned long ResponsivenessDisableThreshold:1;// Offset=0x4 Size=0x4 BitOffset=0xe BitSize=0x1
        unsigned long ResponsivenessEnableThreshold:1;// Offset=0x4 Size=0x4 BitOffset=0xf BitSize=0x1
        unsigned long ResponsivenessDisableTime:1;// Offset=0x4 Size=0x4 BitOffset=0x10 BitSize=0x1
        unsigned long ResponsivenessEnableTime:1;// Offset=0x4 Size=0x4 BitOffset=0x11 BitSize=0x1
        unsigned long ResponsivenessEppCeiling:1;// Offset=0x4 Size=0x4 BitOffset=0x12 BitSize=0x1
        unsigned long ResponsivenessPerfFloor:1;// Offset=0x4 Size=0x4 BitOffset=0x13 BitSize=0x1
        unsigned long SoftParkLatency:1;// Offset=0x4 Size=0x4 BitOffset=0x14 BitSize=0x1
        unsigned long ShortThreadRuntimeThreshold:1;// Offset=0x4 Size=0x4 BitOffset=0x15 BitSize=0x1
        unsigned long ShortThreadArchClassUpperThreshold:1;// Offset=0x4 Size=0x4 BitOffset=0x16 BitSize=0x1
        unsigned long ShortThreadArchClassLowerThreshold:1;// Offset=0x4 Size=0x4 BitOffset=0x17 BitSize=0x1
        unsigned long LongThreadArchClassUpperThreshold:1;// Offset=0x4 Size=0x4 BitOffset=0x18 BitSize=0x1
        unsigned long LongThreadArchClassLowerThreshold:1;// Offset=0x4 Size=0x4 BitOffset=0x19 BitSize=0x1
        unsigned long ModuleUnparkPolicy:1;// Offset=0x4 Size=0x4 BitOffset=0x1a BitSize=0x1
        unsigned long ComplexUnparkPolicy:1;// Offset=0x4 Size=0x4 BitOffset=0x1b BitSize=0x1
        unsigned long SmtUnparkPolicy:1;// Offset=0x4 Size=0x4 BitOffset=0x1c BitSize=0x1
        unsigned long LatencyHintEpp:1;// Offset=0x4 Size=0x4 BitOffset=0x1d BitSize=0x1
        unsigned long Spare:2;// Offset=0x4 Size=0x4 BitOffset=0x1e BitSize=0x2
    };
};
...
struct _PPM_ENGINE_SETTINGS// Size=0x1b8 (Id=778)
{
    ...
    unsigned char LatencyHintEpp[2];// Offset=0x4f Size=0x2
    unsigned char LatencyHintUnpark[2];// Offset=0x51 Size=0x2
    ...
    unsigned char HeteroDecreaseThreshold[2][64];// Offset=0xa1 Size=0x80
    unsigned char HeteroIncreaseThreshold[2][64];// Offset=0x121 Size=0x80
    unsigned char Class0FloorPerformance;// Offset=0x1a1 Size=0x1
    unsigned char Class1InitialPerformance;// Offset=0x1a2 Size=0x1
    unsigned long ShortThreadRuntimeThreshold;// Offset=0x1a4 Size=0x4
    enum _KHETERO_CPU_POLICY ThreadPolicies[2];// Offset=0x1a8 Size=0x8
    unsigned char ArchClassLowerThreshold[2];// Offset=0x1b0 Size=0x2
    unsigned char ArchClassUpperThreshold[2];// Offset=0x1b2 Size=0x2
    unsigned char ModuleUnparkPolicy;// Offset=0x1b4 Size=0x1
    unsigned char ComplexUnparkPolicy;// Offset=0x1b5 Size=0x1
    unsigned char SmtUnparkPolicy;// Offset=0x1b6 Size=0x1
};

struct _POP_PPM_PROFILE// Size=0x3c0 (Id=777)
{
    ...
    struct _PPM_ENGINE_SETTINGS Settings[2];// Offset=0x28 Size=0x370
    unsigned long long StartTime;// Offset=0x398 Size=0x8
    unsigned long long Count;// Offset=0x3a0 Size=0x8
    unsigned long long MaxDuration;// Offset=0x3a8 Size=0x8
    unsigned long long MinDuration;// Offset=0x3b0 Size=0x8
    unsigned long long TotalDuration;// Offset=0x3b8 Size=0x8
};
