struct _HAL_INTEL_ENLIGHTENMENT_INFORMATION// Size=0x248 (Id=255)
{
    ...
    long  ( * GetSintMessage)(unsigned char ,void ** );// Offset=0x1f8 Size=0x8
    long  ( * RestoreTime)(unsigned int ,unsigned long long ,unsigned long long );// Offset=0x200 Size=0x8
    long  ( * SetRootFaultReportingReady)();// Offset=0x208 Size=0x8
    long  ( * ConfigureDeviceDomain)(struct _HAL_HV_DMA_DOMAIN_INFO * ,struct _HAL_HV_DMA_DOMAIN_CONFIG * );// Offset=0x210 Size=0x8
    long  ( * UnblockDefaultDma)();// Offset=0x218 Size=0x8
    long  ( * FlushDeviceDomain)(struct _HAL_HV_DMA_DOMAIN_INFO * );// Offset=0x220 Size=0x8
    long  ( * FlushDeviceDomainVaList)(struct _HAL_HV_DMA_DOMAIN_INFO * ,unsigned long ,struct _KTB_FLUSH_VA * );// Offset=0x228 Size=0x8
    long  ( * GetHybridPassthroughReservedRegions)(struct _HAL_HV_DMA_HYBRID_PASSTHROUGH_RESERVED_REGIONS * );// Offset=0x230 Size=0x8
    long  ( * ReserveDeviceDomainAttachment)(unsigned long long ,struct _HAL_HV_DMA_DOMAIN_INFO * );// Offset=0x238 Size=0x8
    long  ( * UnreserveDeviceDomainAttachment)(unsigned long long );// Offset=0x240 Size=0x8
};
