...
struct _IOMMU_RESERVED_DEVICE// Size=0x38 (Id=279)
{
    ...
    unsigned long RegionCount;// Offset=0x18 Size=0x4
    struct _EXT_IOMMU_RESERVED_MEMORY_REGION Regions[1];// Offset=0x20 Size=0x18
};
