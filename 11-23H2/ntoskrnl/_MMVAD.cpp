...
struct _MMVAD_FLAGS// Size=0x4 (Id=1035)
{
...
struct _MM_PRIVATE_VAD_FLAGS// Size=0x4 (Id=1064)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long Lock:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
        ...
        unsigned long Graphics:1;// Offset=0x0 Size=0x4 BitOffset=0x19 BitSize=0x1
        unsigned long Enclave:1;// Offset=0x0 Size=0x4 BitOffset=0x1a BitSize=0x1
        unsigned long ShadowStack:1;// Offset=0x0 Size=0x4 BitOffset=0x1b BitSize=0x1
        unsigned long PhysicalMemoryPfnsReferenced:1;// Offset=0x0 Size=0x4 BitOffset=0x1c BitSize=0x1
    };
};

struct _MM_GRAPHICS_VAD_FLAGS// Size=0x4 (Id=1182)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long Lock:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
        ...
        unsigned long FixedLargePageSize:1;// Offset=0x0 Size=0x4 BitOffset=0x17 BitSize=0x1
        unsigned long ZeroFillPagesOptional:1;// Offset=0x0 Size=0x4 BitOffset=0x18 BitSize=0x1
        unsigned long GraphicsAlwaysSet:1;// Offset=0x0 Size=0x4 BitOffset=0x19 BitSize=0x1
        unsigned long GraphicsUseCoherentBus:1;// Offset=0x0 Size=0x4 BitOffset=0x1a BitSize=0x1
        unsigned long GraphicsNoCache:1;// Offset=0x0 Size=0x4 BitOffset=0x1b BitSize=0x1
        unsigned long GraphicsPageProtection:3;// Offset=0x0 Size=0x4 BitOffset=0x1c BitSize=0x3
    };
};

struct _MM_SHARED_VAD_FLAGS// Size=0x4 (Id=1343)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long Lock:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
union _unnamed_645// Size=0x4 (Id=645)
{
...
struct _MMVAD_FLAGS1// Size=0x4 (Id=1063)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_647// Size=0x8 (Id=647)
{
    union // Size=0x8 (Id=0)
    {
        unsigned long long EventListULongPtr;// Offset=0x0 Size=0x8
        struct // Size=0x1 (Id=0)
        {
            unsigned char StartingVpnHigher:4;// Offset=0x0 Size=0x1 BitOffset=0x0 BitSize=0x4
        };
    };
};

struct _MMVAD_SHORT// Size=0x40 (Id=648)
{
    union // Size=0x10 (Id=0)
    {
    ...
    union _unnamed_645 u;// Offset=0x30 Size=0x4
    union _unnamed_646 u1;// Offset=0x34 Size=0x4
    union _unnamed_647 u5;// Offset=0x38 Size=0x8
};

struct _MMVAD_FLAGS2// Size=0x4 (Id=1878)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1879// Size=0x4 (Id=1879)
{
...
struct _MI_VAD_SEQUENTIAL_INFO// Size=0x8 (Id=2207)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _MMVAD// Size=0x88 (Id=1881)
{
    ...
    union _unnamed_1880 u4;// Offset=0x78 Size=0x8
