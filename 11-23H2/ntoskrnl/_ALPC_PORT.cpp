...
struct _ALPC_PORT_ATTRIBUTES// Size=0x48 (Id=1152)
{
...
struct _unnamed_896// Size=0x4 (Id=896)
{
...
union _unnamed_897// Size=0x4 (Id=897)
{
    struct _unnamed_896 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

struct _ALPC_PORT// Size=0x1d8 (Id=898)
{
    ...
    union _unnamed_897 u1;// Offset=0x1a0 Size=0x4
