struct _MI_PARTITION_FLAGS// Size=0x4 (Id=2007)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long SpecialPurposeMemoryPartition:1;// Offset=0x0 Size=0x4 BitOffset=0x7 BitSize=0x1
    };
};

union _unnamed_1555// Size=0x4 (Id=1555)
{
...
struct _MI_PARTITION_CORE// Size=0x1e0 (Id=1556)
{
    unsigned short PartitionId;// Offset=0x0 Size=0x2
    union _unnamed_1555 u;// Offset=0x4 Size=0x4
    ...
    struct _KEVENT ConductorNeededEvent;// Offset=0x80 Size=0x18
    void * SystemThreadHandles[6];// Offset=0x98 Size=0x30
    struct _EPARTITION * PartitionObject;// Offset=0xc8 Size=0x8
    struct _EX_PUSH_LOCK PartitionSystemThreadsLock;// Offset=0xd0 Size=0x8
    struct _EX_PUSH_LOCK DynamicMemoryPushLock;// Offset=0xd8 Size=0x8
    long DynamicMemoryLock;// Offset=0xe0 Size=0x4
    unsigned char PfnUnmapActive;// Offset=0xe4 Size=0x1
    struct _KEVENT TemporaryMemoryEvent;// Offset=0xe8 Size=0x18
    void * RootDirectory;// Offset=0x100 Size=0x8
    void * KernelObjectsDirectory;// Offset=0x108 Size=0x8
    struct _KEVENT * MemoryEvents[11];// Offset=0x110 Size=0x58
    void * MemoryEventHandles[11];// Offset=0x168 Size=0x58
    unsigned long long TotalHugeIoRanges;// Offset=0x1c0 Size=0x8
    unsigned long long NonChargedSecurePages;// Offset=0x1c8 Size=0x8
    union _SLIST_HEADER FreeKernelShadowStackCacheEntries;// Offset=0x1d0 Size=0x10
};
...
struct _MMMOD_WRITER_LISTHEAD// Size=0x28 (Id=2015)
{
...
union _MI_RESERVATION_CLUSTER_INFO// Size=0x4 (Id=2104)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_MODWRITE_DATA// Size=0x40 (Id=2105)
{
...
struct _MI_RESTRICTED_MODWRITES// Size=0x3 (Id=2204)
{
...
struct _MI_PARTITION_MODWRITES// Size=0x2c0 (Id=1905)
{
...
union _unnamed_1143// Size=0x4 (Id=1143)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_PARTITION_STORES// Size=0xb0 (Id=1144)
{
    union _unnamed_1143 WriteAllStoreSwapPages;// Offset=0x0 Size=0x4
    ...
    struct _KEVENT * RundownWrites;// Offset=0x20 Size=0x8
    long EvictFlushLock;// Offset=0x28 Size=0x4
    struct _ETHREAD * EvictionThread;// Offset=0x30 Size=0x8
    struct _KEVENT EvictEvent;// Offset=0x38 Size=0x18
    struct _KEVENT EvictThreadExitEvent;// Offset=0x50 Size=0x18
    union _SLIST_HEADER WriteSupportSListHead;// Offset=0x70 Size=0x10
    struct _KEVENT EvictFlushCompleteEvent;// Offset=0x80 Size=0x18
    struct _RTL_BITMAP * ModifiedWriteFailedBitmap;// Offset=0x98 Size=0x8
    struct _EPROCESS * StoreProcess;// Offset=0xa0 Size=0x8
    long MemoryConditionsLock;// Offset=0xa8 Size=0x4
    unsigned long DeleteStoredPages;// Offset=0xac Size=0x4
};
...
struct _MI_STANDBY_LOOKASIDE// Size=0x200 (Id=2077)
{
    unsigned long long Array[64];// Offset=0x0 Size=0x200
};

struct _MI_DECAY_TIMER_LINKAGE// Size=0x8 (Id=1816)
{
    struct // Size=0x8 (Id=0)
    {
...
union _unnamed_1435// Size=0x8 (Id=1435)
{
    unsigned long long Long;// Offset=0x0 Size=0x8
    struct _MI_DECAY_TIMER_LINKAGE e1;// Offset=0x0 Size=0x8
};

struct _MI_DECAY_TIMER_LINK// Size=0x8 (Id=1436)
{
    union _unnamed_1435 u1;// Offset=0x0 Size=0x8
};

struct _MI_LDW_WORK_CONTEXT// Size=0x38 (Id=1633)
{
...
struct _MI_AVAILABLE_PAGE_WAIT_STATES// Size=0x20 (Id=1658)
{
...
struct _MI_PARTITION_PAGE_LISTS// Size=0x3640 (Id=1433)
{
...
struct _MI_PARTITION_COMMIT// Size=0x40 (Id=1780)
{
...
struct _MI_PARTITION_ZEROING// Size=0x48 (Id=1741)
{
...
struct _MI_PAGE_COMBINING_SUPPORT// Size=0x190 (Id=1456)
{
...
struct _MMWORKING_SET_EXPANSION_HEAD// Size=0x10 (Id=1187)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
};

struct _MI_SPECIAL_PURPOSE_MEMORY_STATE// Size=0x38 (Id=1233)
{
...
struct _unnamed_1568// Size=0x38 (Id=1568)
{
    struct _MDL Mdl;// Offset=0x0 Size=0x30
    unsigned long long Page[1];// Offset=0x30 Size=0x8
};

struct _MI_PAGEFILE_TRACES// Size=0x80 (Id=1569)
{
    ...
    struct _unnamed_1568 MdlHack;// Offset=0x48 Size=0x38
};

struct _MI_VISIBLE_PARTITION// Size=0x1380 (Id=1261)
{
    ...
    unsigned long long SlabAllocatorPagesUncharged;// Offset=0x348 Size=0x8
    unsigned long long BootSlabPages;// Offset=0x350 Size=0x8
    unsigned long long SecureKernelPagesFromNonChargedSlabs;// Offset=0x358 Size=0x8
    unsigned long long KernelShadowStackPages;// Offset=0x360 Size=0x8
    unsigned long ChargeCommitmentFailures[4];// Offset=0x368 Size=0x10
    long PageFileTraceIndex;// Offset=0x378 Size=0x4
    struct _MI_PAGEFILE_TRACES PageFileTraces[32];// Offset=0x380 Size=0x1000
};

struct _MI_PARTITION// Size=0x5600 (Id=650)
{
    struct _MI_PARTITION_CORE Core;// Offset=0x0 Size=0x1e0
    struct _MI_PARTITION_MODWRITES Modwriter;// Offset=0x1e0 Size=0x2c0
    struct _MI_PARTITION_STORES Store;// Offset=0x4a0 Size=0xb0
    struct _MI_PARTITION_SEGMENTS Segments;// Offset=0x580 Size=0x440
    struct _MI_PARTITION_PAGE_LISTS PageLists;// Offset=0x9c0 Size=0x3640
    struct _MI_PARTITION_COMMIT Commit;// Offset=0x4000 Size=0x40
    struct _MI_PARTITION_ZEROING Zeroing;// Offset=0x4040 Size=0x48
    struct _MI_PAGE_COMBINING_SUPPORT PageCombine;// Offset=0x4088 Size=0x190
    void * WorkingSetControl;// Offset=0x4218 Size=0x8
    struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;// Offset=0x4220 Size=0x10
    struct _MI_SPECIAL_PURPOSE_MEMORY_STATE SpecialPurposeMemory;// Offset=0x4230 Size=0x38
    unsigned long SessionDetachTimeStamp;// Offset=0x4268 Size=0x4
    unsigned long long LastPeriodicTelemetryLogTime;// Offset=0x4270 Size=0x8
    struct _MI_VISIBLE_PARTITION Vp;// Offset=0x4280 Size=0x1380
};
