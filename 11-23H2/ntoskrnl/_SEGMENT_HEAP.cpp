...
union _RTL_RUN_ONCE// Size=0x8 (Id=1155)
{
...
struct _HEAP_OPPORTUNISTIC_LARGE_PAGE_STATS// Size=0x10 (Id=1872)
{
...
struct _RTL_HP_SEG_ALLOC_POLICY// Size=0x18 (Id=1404)
{
...
struct _HEAP_RUNTIME_MEMORY_STATS// Size=0x58 (Id=854)
{
...
struct _RTL_HP_HEAP_VA_CALLBACKS_ENCODED// Size=0x20 (Id=1225)
{
...
union _unnamed_852// Size=0x1 (Id=852)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _HEAP_SEG_CONTEXT// Size=0xc0 (Id=853)
{
    ...
    union _unnamed_852 Flags;// Offset=0xd Size=0x1
...
struct _HEAP_VS_DELAY_FREE_CONTEXT// Size=0x10 (Id=1295)
{
    union _SLIST_HEADER ListHead;// Offset=0x0 Size=0x10
};

struct _HEAP_SUBALLOCATOR_CALLBACKS// Size=0x28 (Id=820)
{
...
struct _unnamed_1158// Size=0x4 (Id=1158)
{
...
struct _RTL_HP_VS_CONFIG// Size=0x4 (Id=1159)
{
    struct _unnamed_1158 Flags;// Offset=0x0 Size=0x4
};

struct _HEAP_VS_CONTEXT// Size=0xc0 (Id=843)
{
...
struct _RTL_HP_LFH_CONFIG// Size=0x4 (Id=1362)
{
...
struct _SEGMENT_HEAP// Size=0x840 (Id=858)
{
