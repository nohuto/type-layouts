struct _RTL_CRITICAL_SECTION// Size=0x28 (Id=1387)
{
...
union _unnamed_864// Size=0x68 (Id=864)
{
    struct _RTL_CRITICAL_SECTION CriticalSection;// Offset=0x0 Size=0x28
    struct _ERESOURCE Resource;// Offset=0x0 Size=0x68
};

struct _HEAP_LOCK// Size=0x68 (Id=865)
{
    union _unnamed_864 Lock;// Offset=0x0 Size=0x68
};
