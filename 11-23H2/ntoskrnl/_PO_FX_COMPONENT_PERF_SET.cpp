...
struct _PO_FX_COMPONENT_PERF_SET// Size=0x30 (Id=2293)
{
    ...
    {
        struct _unnamed_2291 Discrete;// Offset=0x20 Size=0x10
        struct _unnamed_2292 Range;// Offset=0x20 Size=0x10
    };
};
