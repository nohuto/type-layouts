...
struct _unnamed_891// Size=0x4 (Id=891)
{
...
union _unnamed_892// Size=0x4 (Id=892)
{
    struct _unnamed_891 s1;// Offset=0x0 Size=0x4
};

struct _KALPC_VIEW// Size=0x60 (Id=893)
{
    ...
    union _unnamed_892 u1;// Offset=0x48 Size=0x4
