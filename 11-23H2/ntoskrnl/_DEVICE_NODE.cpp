...
struct _PO_DEVICE_NOTIFY// Size=0x68 (Id=1166)
{
...
union _unnamed_708// Size=0x8 (Id=708)
{
...
union _unnamed_709// Size=0x8 (Id=709)
{
    struct _DEVICE_NODE * NextResourceDeviceNode;// Offset=0x0 Size=0x8
};

struct _unnamed_711// Size=0x20 (Id=711)
{
...
struct _PO_DIRECTED_DRIPS_STATE// Size=0x38 (Id=1137)
{
...
struct _PNP_PROBLEM_CODE_LOG_ENTRY// Size=0x18 (Id=1726)
{
...
struct _DEVICE_NODE// Size=0x388 (Id=713)
{
    ...
    union _unnamed_708 OverUsed1;// Offset=0x210 Size=0x8
    union _unnamed_709 OverUsed2;// Offset=0x218 Size=0x8
    ...
    struct _unnamed_711 DockInfo;// Offset=0x238 Size=0x20
