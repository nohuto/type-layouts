...
struct _IMAGE_SECURITY_CONTEXT// Size=0x8 (Id=1808)
{
    union // Size=0x8 (Id=0)
    {
...
union _unnamed_1199// Size=0x8 (Id=1199)
{
...
struct _MI_IMAGE_SECURITY_REFERENCE// Size=0x40 (Id=1200)
{
    ...
    union _unnamed_1199 u1;// Offset=0x30 Size=0x8
