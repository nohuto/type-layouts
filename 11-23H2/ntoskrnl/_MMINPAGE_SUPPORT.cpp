...
struct _MI_STORE_INPAGE_COMPLETE_FLAGS// Size=0x4 (Id=2314)
{
    union // Size=0x4 (Id=0)
    {
...
union _unnamed_2216// Size=0x4 (Id=2216)
{
...
struct _MMINPAGE_SUPPORT_FLOW_THROUGH// Size=0x38 (Id=2267)
{
...
struct _MMINPAGE_SUPPORT// Size=0x1c0 (Id=2217)
{
    union // Size=0x10 (Id=0)
    {
    ...
    union _unnamed_2214 u2;// Offset=0x68 Size=0x30
    ...
    union _unnamed_2215 u3;// Offset=0xbc Size=0x4
    union _unnamed_2216 u1;// Offset=0xc0 Size=0x4
    union // Size=0x8 (Id=0)
    {
