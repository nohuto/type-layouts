struct _IOMMU_DMA_LOGICAL_ADDRESS_TOKEN_MAPPED_SEGMENT// Size=0x18 (Id=423)
{
...
union _unnamed_392// Size=0x8 (Id=392)
{
    void * VirtualAddress;// Offset=0x0 Size=0x8
    struct _unnamed_391 Flags;// Offset=0x0 Size=0x8
};

struct _HALP_DMA_TRANSLATION_ENTRY// Size=0x48 (Id=393)
{
    ...
    union _unnamed_392 u;// Offset=0x30 Size=0x8
