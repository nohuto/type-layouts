struct _unnamed_885// Size=0x4 (Id=885)
{
...
union _unnamed_886// Size=0x4 (Id=886)
{
    struct _unnamed_885 s1;// Offset=0x0 Size=0x4
};
...
struct _KALPC_SECTION// Size=0x48 (Id=887)
{
    ...
    union _unnamed_886 u1;// Offset=0x30 Size=0x4
