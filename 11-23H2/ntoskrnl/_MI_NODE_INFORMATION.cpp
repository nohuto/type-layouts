struct _MI_FREE_LARGE_PAGES// Size=0x430 (Id=2243)
{
...
struct _MI_REBUILD_LARGE_PAGE_TIMER// Size=0x28 (Id=2085)
{
...
struct _unnamed_2063// Size=0x4 (Id=2063)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_PAGE_COLORS// Size=0x10 (Id=2131)
{
...
struct _CACHED_KSTACK_LIST// Size=0x20 (Id=2159)
{
...
struct _MI_NODE_NUMBER_ZERO_BASED// Size=0x4 (Id=2078)
{
    unsigned long ZeroBased;// Offset=0x0 Size=0x4
};

union _unnamed_2115// Size=0x4 (Id=2115)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_SLAB_ALLOCATOR_CONTEXT// Size=0x108 (Id=2116)
{
    ...
    union _unnamed_2115 Flags;// Offset=0x58 Size=0x4
...
struct _MI_NODE_INFORMATION// Size=0x6340 (Id=2064)
{
    ...
    struct _unnamed_2063 Flags;// Offset=0x59d8 Size=0x4
