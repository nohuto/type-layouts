struct HAL_PRIVATE_DISPATCH// Size=0x4f0 (Id=1239)
{
    ...
    long  ( * HalStartProfileInterruptEx)(enum _KPROFILE_SOURCE ,unsigned long * ,unsigned long * ,struct _HAL_PMC_COUNTERS ** );// Offset=0x4b8 Size=0x8
