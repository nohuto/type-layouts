...
union _unnamed_89// Size=0x10 (Id=89)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_88 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=564)
{
...
struct _unnamed_90// Size=0x58 (Id=90)
{
...
union _unnamed_91// Size=0x58 (Id=91)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_90 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=92)
{
    ...
    union _unnamed_86 AssociatedIrp;// Offset=0x18 Size=0x8
