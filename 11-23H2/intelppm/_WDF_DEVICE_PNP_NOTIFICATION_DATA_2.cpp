...
struct _unnamed_452// Size=0x8 (Id=452)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_453// Size=0x4 (Id=453)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_454// Size=0x8 (Id=454)
{
    struct _unnamed_452 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_453 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_452 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=260)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_454 Data;// Offset=0x4 Size=0x8
};
