...
struct _unnamed_286// Size=0x18 (Id=286)
{
...
struct _unnamed_292// Size=0x10 (Id=292)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
union _unnamed_298// Size=0x18 (Id=298)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_286 Port;// Offset=0x0 Size=0x18
        struct _unnamed_286 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_288 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_289 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_290 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_286 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_291 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_292 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_293 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_294 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_295 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_296 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_297 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=299)
{
    ...
    union _unnamed_298 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=1011)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=839)
{
