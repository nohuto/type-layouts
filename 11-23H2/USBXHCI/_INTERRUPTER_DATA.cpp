struct _INTERRUPTER_COUNTER// Size=0x38 (Id=580)
{
...
struct _INTERRUPTER_FLAGS// Size=0x4 (Id=946)
{
...
struct _INTERRUPTER_DATA// Size=0xe0 (Id=519)
{
    ...
    void * EventRingLock;// Offset=0xd0 Size=0x8
    unsigned char EventRingLockRequiresPassiveLevel;// Offset=0xd8 Size=0x1
};
