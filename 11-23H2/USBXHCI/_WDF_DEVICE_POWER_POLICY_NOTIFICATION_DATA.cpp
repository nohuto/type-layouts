...
struct _unnamed_657// Size=0x8 (Id=657)
{
...
union _unnamed_659// Size=0x8 (Id=659)
{
    struct _unnamed_657 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_658 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_657 LeaveState;// Offset=0x0 Size=0x8
};
...
struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=260)
{
    ...
    union _unnamed_659 Data;// Offset=0x4 Size=0x8
};
