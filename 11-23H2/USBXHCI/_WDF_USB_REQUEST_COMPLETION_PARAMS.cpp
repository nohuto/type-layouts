...
struct _unnamed_791// Size=0x10 (Id=791)
{
...
union _unnamed_794// Size=0x18 (Id=794)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_791 DeviceString;// Offset=0x0 Size=0x10
        struct _unnamed_792 DeviceControlTransfer;// Offset=0x0 Size=0x18
        struct _unnamed_793 DeviceUrb;// Offset=0x0 Size=0x8
        struct _unnamed_319 PipeWrite;// Offset=0x0 Size=0x18
        struct _unnamed_319 PipeRead;// Offset=0x0 Size=0x18
        struct _unnamed_793 PipeUrb;// Offset=0x0 Size=0x8
    };
};

struct _WDF_USB_REQUEST_COMPLETION_PARAMS// Size=0x20 (Id=795)
{
    long UsbdStatus;// Offset=0x0 Size=0x4
    enum _WDF_USB_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    union _unnamed_794 Parameters;// Offset=0x8 Size=0x18
};
