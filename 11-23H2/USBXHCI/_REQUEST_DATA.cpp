...
struct _ENDPOINT_UPDATE_DATA// Size=0x78 (Id=909)
{
...
struct _ENDPOINT_STATIC_STREAMS_CONFIGURE// Size=0x8 (Id=807)
{
    struct _STATIC_STREAMS_DATA * StaticStreamsData;// Offset=0x0 Size=0x8
};

struct _ENDPOINT_RESET_DATA// Size=0x70 (Id=754)
{
    struct _ENDPOINT_DATA * EndpointData;// Offset=0x0 Size=0x8
    struct _XIL_BUFFER_DATA * InputBufferData;// Offset=0x8 Size=0x8
...
struct _USBDEVICE_ENDPOINTS_CONFIGURE_DATA// Size=0x2 (Id=802)
{
...
struct _STAGE_QUEUE_HEADER// Size=0x8 (Id=1000)
{
...
struct _ISOCH_STAGE_DATA// Size=0xd0 (Id=981)
{
    ...
    struct _unnamed_917 PreallocatedScatterGatherList;// Offset=0xa8 Size=0x28
};

struct _ISOCH_STAGE_QUEUE// Size=0x280 (Id=948)
{
    struct _STAGE_QUEUE_HEADER Header;// Offset=0x0 Size=0x8
    struct _ISOCH_STAGE_DATA StageArray[3];// Offset=0x10 Size=0x270
};

struct _ISOCH_TRANSFER_DATA// Size=0x300 (Id=630)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
    unsigned char Initialized;// Offset=0x10 Size=0x1
    struct WDFREQUEST__ * WdfRequest;// Offset=0x18 Size=0x8
...
struct _BULK_STAGE_DATA// Size=0xd0 (Id=1030)
{
...
struct _BULK_STAGE_QUEUE// Size=0xe0 (Id=1024)
{
    struct _STAGE_QUEUE_HEADER Header;// Offset=0x0 Size=0x8
    struct _BULK_STAGE_DATA StageArray[1];// Offset=0x10 Size=0xd0
};

struct _BULK_TRANSFER_DATA// Size=0x160 (Id=863)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
    unsigned char Initialized;// Offset=0x10 Size=0x1
    struct WDFREQUEST__ * WdfRequest;// Offset=0x18 Size=0x8
...
union _REQUEST_DATA// Size=0x300 (Id=557)
{
