...
struct _unnamed_700// Size=0x8 (Id=700)
{
...
union _unnamed_702// Size=0x8 (Id=702)
{
    struct _unnamed_700 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_701 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_700 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=259)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_702 Data;// Offset=0x4 Size=0x8
};
