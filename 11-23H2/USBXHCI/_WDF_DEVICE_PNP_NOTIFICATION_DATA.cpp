...
struct _unnamed_669// Size=0x8 (Id=669)
{
...
union _unnamed_671// Size=0x8 (Id=671)
{
    struct _unnamed_669 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_670 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_669 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=672)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_671 Data;// Offset=0x4 Size=0x8
};
