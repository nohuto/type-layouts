struct _PCI_CAPABILITIES_HEADER// Size=0x2 (Id=1047)
{
    unsigned char CapabilityID;// Offset=0x0 Size=0x1
    unsigned char Next;// Offset=0x1 Size=0x1
};

union _PCI_MSI_MESSAGE_CONTROL// Size=0x2 (Id=1044)
{
...
struct _PCI_MSI_MESSAGE_ADDRESS// Size=0x4 (Id=1053)
{
...
struct _unnamed_992// Size=0x10 (Id=992)
{
...
struct PCI_MSI_CAPABILITY// Size=0x18 (Id=993)
{
    ...
    union _unnamed_990 MessageAddressLower;// Offset=0x4 Size=0x4
    union // Size=0xc (Id=0)
    {
        struct _unnamed_991 Option32Bit;// Offset=0x8 Size=0xc
        struct _unnamed_992 Option64Bit;// Offset=0x8 Size=0x10
    };
};
