struct _PCI_CAPABILITIES_HEADER// Size=0x2 (Id=818)
{
    unsigned char CapabilityID;// Offset=0x0 Size=0x1
    unsigned char Next;// Offset=0x1 Size=0x1
};

struct _PCI_MSI_MESSAGE_CONTROL// Size=0x2 (Id=817)
{
...
struct _PCI_MSI_MESSAGE_ADDRESS// Size=0x4 (Id=824)
{
...
struct _unnamed_778// Size=0xc (Id=778)
{
...
struct _unnamed_779// Size=0x10 (Id=779)
{
...
struct PCI_MSI_CAPABILITY// Size=0x18 (Id=780)
{
    ...
    union _unnamed_777 MessageAddressLower;// Offset=0x4 Size=0x4
    union // Size=0xc (Id=0)
    {
        struct _unnamed_778 Option32Bit;// Offset=0x8 Size=0xc
        struct _unnamed_779 Option64Bit;// Offset=0x8 Size=0x10
    };
};
