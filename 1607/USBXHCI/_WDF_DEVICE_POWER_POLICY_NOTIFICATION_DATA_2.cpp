...
union _unnamed_532// Size=0x8 (Id=532)
{
    struct _unnamed_530 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_531 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_530 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=533)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_532 Data;// Offset=0x4 Size=0x8
};
