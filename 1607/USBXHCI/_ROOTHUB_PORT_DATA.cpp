union _CONTROLLER_USB_20_HARDWARE_LPM_FLAGS// Size=0x1 (Id=775)
{
...
struct _ROOTHUB_PORT_DATA// Size=0x38 (Id=580)
{
    ...
    unsigned long long ReadModifyWriteLock;// Offset=0x10 Size=0x8
