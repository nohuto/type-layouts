...
struct _unnamed_540// Size=0x4 (Id=540)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};
...
{
    struct _unnamed_539 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_540 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_539 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=217)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_541 Data;// Offset=0x4 Size=0x8
};
