...
struct _OBJECT_DIRECTORY// Size=0x160 (Id=508)
{
    ...
    unsigned long SessionId;// Offset=0x140 Size=0x4
    void * NamespaceEntry;// Offset=0x148 Size=0x8
    void * SessionObject;// Offset=0x150 Size=0x8
    unsigned long Flags;// Offset=0x158 Size=0x4
};
