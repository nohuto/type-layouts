...
struct _MIPFNBLINK// Size=0x8 (Id=1179)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _MMPFNENTRY1// Size=0x1 (Id=738)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _MMPFNENTRY3// Size=0x1 (Id=770)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _unnamed_213// Size=0x2 (Id=213)
{
...
union _unnamed_215// Size=0x4 (Id=215)
{
    unsigned short ReferenceCount;// Offset=0x0 Size=0x2
    struct _MMPFNENTRY1 e1;// Offset=0x2 Size=0x1
    struct _MMPFNENTRY3 e3;// Offset=0x3 Size=0x1
    struct _unnamed_213 e2;// Offset=0x0 Size=0x2
    struct _unnamed_214 e4;// Offset=0x0 Size=0x4
};

union _unnamed_216// Size=0x8 (Id=216)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _MMPFN// Size=0x30 (Id=217)
{
    ...
    union _unnamed_215 u3;// Offset=0x20 Size=0x4
    ...
    union _unnamed_216 u4;// Offset=0x28 Size=0x8
};
