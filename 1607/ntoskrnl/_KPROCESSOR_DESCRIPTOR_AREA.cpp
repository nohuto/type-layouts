union _KIDTENTRY64// Size=0x10 (Id=708)
{
...
struct _KTSS64// Size=0x68 (Id=936)
{
...
struct _unnamed_288// Size=0x4 (Id=288)
{
...
union _KGDTENTRY64// Size=0x10 (Id=290)
{
    unsigned short LimitLow;// Offset=0x0 Size=0x2
    unsigned short BaseLow;// Offset=0x2 Size=0x2
    union // Size=0x4 (Id=0)
    {
        struct _unnamed_288 Bytes;// Offset=0x4 Size=0x4
        struct _unnamed_289 Bits;// Offset=0x4 Size=0x4
    };
...
struct _KLDTENTRY// Size=0x8 (Id=848)
{
    unsigned short LimitLow;// Offset=0x0 Size=0x2
    unsigned short BaseLow;// Offset=0x2 Size=0x2
    union _unnamed_847 HighWord;// Offset=0x4 Size=0x4
};

struct _KIST_BASE_FRAME// Size=0x20 (Id=1355)
{
...
struct _KTRANSITION_STACK// Size=0x200 (Id=292)
{
...
struct _KPROCESSOR_DESCRIPTOR_AREA// Size=0x5000 (Id=291)
{
