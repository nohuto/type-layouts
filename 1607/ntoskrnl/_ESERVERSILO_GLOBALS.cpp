struct _OBP_SYSTEM_DOS_DEVICE_STATE// Size=0x6c (Id=677)
{
...
struct _OBJECT_NAMESPACE_LOOKUPTABLE// Size=0x260 (Id=533)
{
...
struct _OBP_SILODRIVERSTATE// Size=0x2e0 (Id=509)
{
...
struct _SEP_SILOSTATE// Size=0x20 (Id=839)
{
...
struct _SEP_RM_LSA_CONNECTION_STATE// Size=0x50 (Id=659)
{
...
struct _WNF_LOCK// Size=0x8 (Id=1063)
{
    struct _EX_PUSH_LOCK PushLock;// Offset=0x0 Size=0x8
};

struct _WNF_SILODRIVERSTATE// Size=0x38 (Id=679)
{
...
struct _SILO_USER_SHARED_DATA// Size=0x20 (Id=721)
{
...
struct _ESERVERSILO_GLOBALS// Size=0x430 (Id=372)
{
