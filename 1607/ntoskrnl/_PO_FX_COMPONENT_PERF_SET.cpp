...
struct _PO_FX_COMPONENT_PERF_SET// Size=0x30 (Id=1526)
{
    ...
    {
        struct _unnamed_1524 Discrete;// Offset=0x20 Size=0x10
        struct _unnamed_1525 Range;// Offset=0x20 Size=0x10
    };
};
