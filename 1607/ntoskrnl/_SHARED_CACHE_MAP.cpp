...
struct _PRIVATE_CACHE_MAP_FLAGS// Size=0x4 (Id=1136)
{
...
struct _PRIVATE_CACHE_MAP// Size=0x78 (Id=730)
{
    union // Size=0x2 (Id=0)
    {
...
struct _SHARED_CACHE_MAP// Size=0x210 (Id=381)
{
    short NodeTypeCode;// Offset=0x0 Size=0x2
