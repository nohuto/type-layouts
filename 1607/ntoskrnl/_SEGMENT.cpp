struct _SEGMENT_FLAGS// Size=0x4 (Id=1246)
{
    union // Size=0x2 (Id=0)
    {
...
struct _SEGMENT// Size=0x48 (Id=223)
{
    ...
    union _unnamed_221 u1;// Offset=0x30 Size=0x8
    union _unnamed_222 u2;// Offset=0x38 Size=0x8
