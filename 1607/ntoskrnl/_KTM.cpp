...
struct _RTL_BALANCED_LINKS// Size=0x20 (Id=1269)
{
...
struct _KTMOBJECT_NAMESPACE_LINK// Size=0x28 (Id=1280)
{
...
struct _RTL_AVL_TABLE// Size=0x68 (Id=1219)
{
...
struct _KTMOBJECT_NAMESPACE// Size=0xa8 (Id=1413)
{
...
struct _unnamed_1263// Size=0x8 (Id=1263)
{
    unsigned int idxRecord;// Offset=0x0 Size=0x4
    unsigned long cidContainer;// Offset=0x4 Size=0x4
};

union _CLS_LSN// Size=0x8 (Id=1264)
{
    struct _unnamed_1263 offset;// Offset=0x0 Size=0x8
...
struct _KTM// Size=0x3c0 (Id=1201)
{
