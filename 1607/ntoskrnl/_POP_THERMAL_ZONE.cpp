...
struct _POP_POLICY_DEVICE// Size=0x40 (Id=1231)
{
...
struct _THERMAL_INFORMATION_EX// Size=0x58 (Id=901)
{
...
struct _THERMAL_POLICY// Size=0x18 (Id=922)
{
...
struct _POP_RW_LOCK// Size=0x10 (Id=379)
{
...
struct _POP_THERMAL_TELEMETRY_TRACKER// Size=0x160 (Id=1046)
{
...
struct _POP_THERMAL_ZONE// Size=0x358 (Id=762)
{
    ...
    struct _POP_THERMAL_TELEMETRY_TRACKER TelemetryTracker;// Offset=0x1e8 Size=0x160
    struct _UNICODE_STRING Description;// Offset=0x348 Size=0x10
};
