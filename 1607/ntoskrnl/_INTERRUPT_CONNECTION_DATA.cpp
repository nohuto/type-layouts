...
struct _unnamed_1528// Size=0x8 (Id=1528)
{
...
union _unnamed_1529// Size=0x8 (Id=1529)
{
    union _ULARGE_INTEGER RemappedFormat;// Offset=0x0 Size=0x8
    struct _unnamed_1528 Msi;// Offset=0x0 Size=0x8
};

struct _INTERRUPT_REMAPPING_INFO// Size=0x10 (Id=1530)
{
    ...
    union _unnamed_1529 u;// Offset=0x8 Size=0x8
};
...
union _unnamed_1489// Size=0x4 (Id=1489)
{
    struct _unnamed_1488 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _unnamed_1490// Size=0x4 (Id=1490)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1491// Size=0x4 (Id=1491)
{
    struct _unnamed_1490 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_HT_INTR_INFO// Size=0x8 (Id=1492)
{
    union _unnamed_1489 LowPart;// Offset=0x0 Size=0x4
    union _unnamed_1491 HighPart;// Offset=0x4 Size=0x4
};
...
struct _INTERRUPT_CONNECTION_DATA// Size=0x60 (Id=1316)
{
