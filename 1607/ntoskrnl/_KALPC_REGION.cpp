...
union _unnamed_424// Size=0x4 (Id=424)
{
    struct _unnamed_423 s1;// Offset=0x0 Size=0x4
};

struct _KALPC_REGION// Size=0x58 (Id=425)
{
    ...
    union _unnamed_424 u1;// Offset=0x30 Size=0x4
