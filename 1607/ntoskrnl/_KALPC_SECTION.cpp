...
union _unnamed_421// Size=0x4 (Id=421)
{
    struct _unnamed_420 s1;// Offset=0x0 Size=0x4
};
...
struct _KALPC_SECTION// Size=0x48 (Id=422)
{
    ...
    union _unnamed_421 u1;// Offset=0x30 Size=0x4
