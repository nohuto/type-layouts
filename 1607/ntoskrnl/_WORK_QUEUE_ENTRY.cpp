...
struct _unnamed_387// Size=0x4 (Id=387)
{
...
struct _unnamed_388// Size=0x30 (Id=388)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
struct _unnamed_389// Size=0x68 (Id=389)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
union _unnamed_390// Size=0x68 (Id=390)
{
    struct _unnamed_384 Read;// Offset=0x0 Size=0x10
    struct _unnamed_385 Write;// Offset=0x0 Size=0x8
    struct _unnamed_386 Event;// Offset=0x0 Size=0x8
    struct _unnamed_387 Notification;// Offset=0x0 Size=0x4
    struct _unnamed_388 LowPriWrite;// Offset=0x0 Size=0x30
    struct _unnamed_389 AsyncRead;// Offset=0x0 Size=0x68
};

struct _WORK_QUEUE_ENTRY// Size=0x80 (Id=391)
{
    struct _LIST_ENTRY WorkQueueLinks;// Offset=0x0 Size=0x10
    union _unnamed_390 Parameters;// Offset=0x10 Size=0x68
