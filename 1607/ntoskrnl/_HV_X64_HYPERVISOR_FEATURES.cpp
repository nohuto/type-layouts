union _HV_PARTITION_PRIVILEGE_MASK// Size=0x8 (Id=280)
{
...
struct _HV_X64_HYPERVISOR_FEATURES// Size=0x10 (Id=279)
{
    ...
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned int Reserved1:12;// Offset=0xc Size=0x4 BitOffset=0x14 BitSize=0xc
    };
};
