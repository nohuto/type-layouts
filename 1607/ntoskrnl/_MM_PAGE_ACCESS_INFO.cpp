struct _unnamed_775// Size=0x4 (Id=775)
{
...
union _MM_PAGE_ACCESS_INFO_FLAGS// Size=0x4 (Id=777)
{
    struct _unnamed_775 File;// Offset=0x0 Size=0x4
    struct _unnamed_776 Private;// Offset=0x0 Size=0x4
};

struct _MM_PAGE_ACCESS_INFO// Size=0x8 (Id=772)
{
    union // Size=0x8 (Id=0)
    {
