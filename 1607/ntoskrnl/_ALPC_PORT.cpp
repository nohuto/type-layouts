...
struct _ALPC_PORT_ATTRIBUTES// Size=0x48 (Id=628)
{
...
union _unnamed_432// Size=0x4 (Id=432)
{
    struct _unnamed_431 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

struct _ALPC_PORT// Size=0x1d8 (Id=433)
{
    ...
    union _unnamed_432 u1;// Offset=0x1a0 Size=0x4
