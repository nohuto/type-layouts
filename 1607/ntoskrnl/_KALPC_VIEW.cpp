...
struct _unnamed_426// Size=0x4 (Id=426)
{
...
union _unnamed_427// Size=0x4 (Id=427)
{
    struct _unnamed_426 s1;// Offset=0x0 Size=0x4
};

struct _KALPC_VIEW// Size=0x60 (Id=428)
{
    ...
    union _unnamed_427 u1;// Offset=0x48 Size=0x4
