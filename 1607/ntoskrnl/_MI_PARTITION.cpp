struct _MI_PARTITION_FLAGS// Size=0x4 (Id=1314)
{
...
union _unnamed_934// Size=0x4 (Id=934)
{
...
struct _MI_PARTITION_CORE// Size=0x160 (Id=935)
{
    unsigned short PartitionId;// Offset=0x0 Size=0x2
    union _unnamed_934 u;// Offset=0x4 Size=0x4
    ...
    unsigned char PfnUnmapActive;// Offset=0x70 Size=0x1
    unsigned long long PfnUnmapCount;// Offset=0x78 Size=0x8
    void * PfnUnmapWaitList;// Offset=0x80 Size=0x8
    struct _PHYSICAL_MEMORY_DESCRIPTOR * MemoryRuns;// Offset=0x88 Size=0x8
    struct _KEVENT ExitEvent;// Offset=0x90 Size=0x18
    void * SystemThreadHandles[5];// Offset=0xa8 Size=0x28
    void * PartitionObject;// Offset=0xd0 Size=0x8
    void * PartitionObjectHandle;// Offset=0xd8 Size=0x8
    ...
    struct _KEVENT * MemoryEvents[11];// Offset=0x108 Size=0x58
};
...
struct _MMMOD_WRITER_LISTHEAD// Size=0x28 (Id=1319)
{
...
union _MI_RESERVATION_CLUSTER_INFO// Size=0x4 (Id=1508)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_MODWRITE_DATA// Size=0x40 (Id=1402)
{
...
struct _MI_PARTITION_MODWRITES// Size=0x2c0 (Id=1214)
{
    ...
    unsigned char TransitionInserted;// Offset=0xea Size=0x1
...
union _unnamed_1237// Size=0x4 (Id=1237)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_PARTITION_STORES// Size=0x90 (Id=1238)
{
    union _unnamed_1237 WriteAllStoreHintedPages;// Offset=0x0 Size=0x4
...
struct _MI_LDW_WORK_CONTEXT// Size=0x38 (Id=988)
{
...
struct _MI_AVAILABLE_PAGE_WAIT_STATES// Size=0x20 (Id=1009)
{
    struct _KEVENT Event;// Offset=0x0 Size=0x18
    unsigned long EventSets;// Offset=0x18 Size=0x4
};

struct _MI_LARGE_PAGE_CANDIDATES// Size=0x208 (Id=976)
{
...
struct _MI_PARTITION_PAGE_LISTS// Size=0xf40 (Id=894)
{
    ...
    void * MirrorListLocks;// Offset=0xad0 Size=0x8
    struct _MI_LARGE_PAGE_CANDIDATES LargePageCandidates[2];// Offset=0xad8 Size=0x410
    struct _WORK_QUEUE_ITEM RebuildLargePageWorkItem;// Offset=0xee8 Size=0x20
    unsigned char RebuildLargePageActive;// Offset=0xf08 Size=0x1
    long LargePageRebuildLock;// Offset=0xf0c Size=0x4
    unsigned char LargePfnBitMapsReady;// Offset=0xf10 Size=0x1
    struct _RTL_BITMAP_EX LargePfnBitMap[2];// Offset=0xf18 Size=0x20
};

struct _MI_PARTITION_COMMIT// Size=0x80 (Id=1103)
{
...
struct _MI_PARTITION_ZEROING// Size=0x60 (Id=1069)
{
...
struct _MMWORKING_SET_EXPANSION_HEAD// Size=0x10 (Id=1224)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
};
...
struct _MI_PARTITION// Size=0x2c00 (Id=866)
{
    struct _MI_PARTITION_CORE Core;// Offset=0x0 Size=0x160
    struct _MI_PARTITION_MODWRITES Modwriter;// Offset=0x160 Size=0x2c0
    struct _MI_PARTITION_STORES Store;// Offset=0x420 Size=0x90
    struct _MI_PARTITION_SEGMENTS Segments;// Offset=0x4c0 Size=0x200
    struct _MI_PARTITION_PAGE_LISTS PageLists;// Offset=0x6c0 Size=0xf40
    struct _MI_PARTITION_COMMIT Commit;// Offset=0x1600 Size=0x80
    struct _MI_PARTITION_ZEROING Zeroing;// Offset=0x1680 Size=0x60
    struct _MI_PAGE_COMBINING_SUPPORT PageCombine;// Offset=0x16e0 Size=0x188
    void * WorkingSetControl;// Offset=0x1868 Size=0x8
    struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;// Offset=0x1870 Size=0x10
    struct _MI_VISIBLE_PARTITION Vp;// Offset=0x1880 Size=0x1380
};
