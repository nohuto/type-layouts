...
struct _RTL_BALANCED_LINKS// Size=0x20 (Id=417)
{
...
struct _RTL_AVL_TABLE// Size=0x68 (Id=406)
{
...
struct _W32PROCESS// Size=0x120 (Id=124)
{
    ...
    {
        unsigned long GdiInitializeCalloutExecuted:1;// Offset=0x11c Size=0x4 BitOffset=0x0 BitSize=0x1
    };
};
