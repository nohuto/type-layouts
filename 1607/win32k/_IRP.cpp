...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=288)
{
...
struct _IRP// Size=0xd0 (Id=79)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=3080)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=3097)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=3098)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=3109)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=3110)
            {
