...
struct _unnamed_354// Size=0x8 (Id=354)
{
...
union _unnamed_356// Size=0x8 (Id=356)
{
    struct _unnamed_354 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_355 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_354 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=357)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_356 Data;// Offset=0x4 Size=0x8
};
