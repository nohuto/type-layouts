...
struct _DIFFERENTIAL_FEEDBACK_STATE// Size=0x40 (Id=451)
{
...
struct _CPC_RUNTIME_STATE// Size=0x148 (Id=358)
{
    ...
    unsigned char PerformanceReductionTolerancePresent;// Offset=0x60 Size=0x1
    unsigned char GuaranteedPerformancePresent;// Offset=0x61 Size=0x1
    unsigned char PccUsedForRead;// Offset=0x62 Size=0x1
    unsigned char PccUsedForGuaranteedNotify;// Offset=0x63 Size=0x1
    unsigned char PccUsedForHighestNotify;// Offset=0x64 Size=0x1
    unsigned char PccUsedForWrite;// Offset=0x65 Size=0x1
    unsigned char NativeInterruptEnabled;// Offset=0x66 Size=0x1
    struct ACPI_CPC * Cpc;// Offset=0x68 Size=0x8
    struct _GEN_ADDR SingleRegisterAddress;// Offset=0x70 Size=0xc
    unsigned long long SingleRegisterPreserveMask;// Offset=0x80 Size=0x8
    struct _DIFFERENTIAL_FEEDBACK_STATE DeliveredFeedback;// Offset=0x88 Size=0x40
    struct _DIFFERENTIAL_FEEDBACK_STATE HardwareFeedback;// Offset=0xc8 Size=0x40
    struct _KDPC NativeInterruptDpc;// Offset=0x108 Size=0x40
};
