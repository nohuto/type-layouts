struct _unnamed_554// Size=0x4 (Id=554)
{
...
union _PCC_OUTPUT_BUFFER// Size=0x4 (Id=556)
{
    struct _unnamed_554 GetAverageFrequency;// Offset=0x0 Size=0x4
    struct _unnamed_555 SetDesiredFrequency;// Offset=0x0 Size=0x4
};
