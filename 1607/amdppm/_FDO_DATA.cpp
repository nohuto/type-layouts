...
struct _ACPI_INTERFACE_STANDARD// Size=0x58 (Id=469)
{
...
struct _GEN_ADDR// Size=0xc (Id=387)
{
...
struct _WMILIB_CONTEXT// Size=0x40 (Id=539)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=392)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KTIMER// Size=0x40 (Id=521)
{
...
struct _CAP_LOG_STATE// Size=0x98 (Id=343)
{
...
struct _FDO_DATA// Size=0x488 (Id=335)
{
    ...
    unsigned char HiddenProcessor;// Offset=0x42 Size=0x1
    unsigned long HiddenProcessorId;// Offset=0x44 Size=0x4
    ...
    long  ( * SetPStateHidden)(unsigned long ,unsigned long long ,unsigned long long ,unsigned long long );// Offset=0x118 Size=0x8
    long  ( * SetTStateHidden)(unsigned long ,unsigned long long ,unsigned long long ,unsigned long long );// Offset=0x120 Size=0x8
    void  ( * PStateFeedback)(void * ,unsigned char ,unsigned long long * ,unsigned long long * );// Offset=0x128 Size=0x8
    void  ( * GetFFHThrottleState)(unsigned long long * );// Offset=0x130 Size=0x8
    void  ( * BoostPolicyHandler)(unsigned long long ,unsigned long );// Offset=0x138 Size=0x8
    void  ( * BoostModeHandler)(unsigned long long ,unsigned long );// Offset=0x140 Size=0x8
    struct _PROC_ENERGY_ESTIMATION_COUNTERS * EstimationCounters;// Offset=0x148 Size=0x8
    unsigned char EfficiencyClass;// Offset=0x150 Size=0x1
    unsigned long long HighestPerformance;// Offset=0x158 Size=0x8
    unsigned long long NominalPerformance;// Offset=0x160 Size=0x8
    unsigned long long LowestNonlinearPerformance;// Offset=0x168 Size=0x8
    unsigned long long LowestPerformance;// Offset=0x170 Size=0x8
    struct ACPI_CTRL_STATUS PCT;// Offset=0x178 Size=0x18
    struct ACPI_PSS * PSS;// Offset=0x190 Size=0x8
    struct ACPI_PSS * XPSS;// Offset=0x198 Size=0x8
    unsigned long PPC;// Offset=0x1a0 Size=0x4
    struct ACPI_xSD * PSD;// Offset=0x1a8 Size=0x8
    struct ACPI_CTRL_STATUS PTC;// Offset=0x1b0 Size=0x18
    struct ACPI_TSS * TSS;// Offset=0x1c8 Size=0x8
    unsigned long TPC;// Offset=0x1d0 Size=0x4
    struct ACPI_xSD * TSD;// Offset=0x1d8 Size=0x8
    struct ACPI_CST * CST;// Offset=0x1e0 Size=0x8
    struct _ACPI_CSD * CSD;// Offset=0x1e8 Size=0x8
    struct ACPI_xSD * XSD;// Offset=0x1f0 Size=0x8
    struct _PERF_DOMAIN_ENTRY * PerfDomain;// Offset=0x1f8 Size=0x8
    struct _LIST_ENTRY PerfDomainLink;// Offset=0x200 Size=0x10
    struct ACPI_PCCP * Pccp;// Offset=0x210 Size=0x8
    struct ACPI_CPC * CPC;// Offset=0x218 Size=0x8
    struct _WMILIB_CONTEXT WmiLibInfo;// Offset=0x220 Size=0x40
    struct WMI_EVENT AcpiNotify80;// Offset=0x260 Size=0x10
    struct WMI_EVENT AcpiNotify81;// Offset=0x270 Size=0x10
    struct WMI_EVENT AcpiNotify82;// Offset=0x280 Size=0x10
    struct _RUNTIME_IDLE_STATES * RuntimeIdleStates;// Offset=0x290 Size=0x8
    unsigned char IdleStatesInitilized;// Offset=0x298 Size=0x1
    struct _IDLE_STATE_ENTRIES * IdleStateEntries;// Offset=0x2a0 Size=0x8
    unsigned long ThermalCap;// Offset=0x2a8 Size=0x4
    unsigned long PccCap;// Offset=0x2ac Size=0x4
    union _LARGE_INTEGER CapStart;// Offset=0x2b0 Size=0x8
    union _LARGE_INTEGER CapDuration;// Offset=0x2b8 Size=0x8
    unsigned long PpcChanges;// Offset=0x2c0 Size=0x4
    unsigned long TpcChanges;// Offset=0x2c4 Size=0x4
    unsigned long PccCapChanges;// Offset=0x2c8 Size=0x4
    struct _CAP_LOG_STATE CapQuickLog;// Offset=0x2d0 Size=0x98
    struct _CAP_LOG_STATE CapLongLog;// Offset=0x368 Size=0x98
    struct _PROCESSOR_PACKAGE * Package;// Offset=0x400 Size=0x8
    struct _LIST_ENTRY PackageLink;// Offset=0x408 Size=0x10
    unsigned long FeaturesPresent;// Offset=0x418 Size=0x4
    unsigned long FeaturesAccessed;// Offset=0x41c Size=0x4
    unsigned long FeaturesInvalidated;// Offset=0x420 Size=0x4
    struct POHANDLE__ * FxHandle;// Offset=0x428 Size=0x8
    unsigned long PepFeedbackCounterCount;// Offset=0x430 Size=0x4
    unsigned long PepIdleStateCount;// Offset=0x434 Size=0x4
    unsigned char PepPerformanceSupported;// Offset=0x438 Size=0x1
    unsigned char PepParkingSupported;// Offset=0x439 Size=0x1
    struct _PEP_PPM_QUERY_IDLE_STATES * PepIdleStates;// Offset=0x440 Size=0x8
    struct _PEP_PPM_QUERY_IDLE_STATES_V2 * PepIdleStatesV2;// Offset=0x448 Size=0x8
    struct _UNICODE_STRING * IdleStateNames;// Offset=0x450 Size=0x8
    struct _IO_WORKITEM * IdleStateUpdateWorkItem;// Offset=0x458 Size=0x8
    unsigned char IdleStatesWorkerQueued;// Offset=0x460 Size=0x1
    unsigned char IdleStateUpdates;// Offset=0x461 Size=0x1
    long PerformanceStateWorkerQueued;// Offset=0x464 Size=0x4
    struct _IO_WORKITEM * PerformanceStateUpdateWorkItem;// Offset=0x468 Size=0x8
    struct _PEP_PERFORMANCE_STATE * PepPerfStates;// Offset=0x470 Size=0x8
    struct _PEP_PERF_RUNTIME_STATE * PepPerfRuntimeState;// Offset=0x478 Size=0x8
    struct ACPI_xSD * PepDomain;// Offset=0x480 Size=0x8
};
