...
struct _STOR_POFX_COMPONENT_IDLE_STATE// Size=0x20 (Id=299)
{
...
struct _STOR_POFX_COMPONENT// Size=0x40 (Id=296)
{
    unsigned long Version;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
...
struct _STOR_POFX_DEVICE_V3// Size=0x58 (Id=298)
{
    unsigned long Version;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
    ...
    union // Size=0x4 (Id=0)
    {
        unsigned long UnitMinIdleTimeoutInMS;// Offset=0x10 Size=0x4
        unsigned long AdapterIdleTimeoutInMS;// Offset=0x10 Size=0x4
    };
    unsigned long MinimumPowerCyclePeriodInMS;// Offset=0x14 Size=0x4
    struct _STOR_POFX_COMPONENT Components[1];// Offset=0x18 Size=0x40
};
