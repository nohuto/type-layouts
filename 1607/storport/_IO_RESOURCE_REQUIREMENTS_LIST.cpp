...
struct _unnamed_555// Size=0x8 (Id=555)
{
...
struct _unnamed_558// Size=0xc (Id=558)
{
...
struct _unnamed_559// Size=0x18 (Id=559)
{
...
struct _unnamed_560// Size=0x18 (Id=560)
{
...
struct _unnamed_561// Size=0x18 (Id=561)
{
...
union _unnamed_562// Size=0x18 (Id=562)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_552 Port;// Offset=0x0 Size=0x18
        struct _unnamed_552 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_554 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_555 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_556 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_552 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_527 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_557 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_558 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_559 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_560 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_561 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_533 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=563)
{
    ...
    union _unnamed_562 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=520)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=407)
{
