struct _unnamed_515// Size=0x8 (Id=515)
{
...
union _unnamed_516// Size=0x8 (Id=516)
{
    struct _unnamed_515 u;// Offset=0x0 Size=0x8
    unsigned long long asUlong64;// Offset=0x0 Size=0x8
};

struct _RAID_LOG_CONTROL// Size=0x10 (Id=514)
{
    unsigned long Revision;// Offset=0x0 Size=0x4
    union _unnamed_516 Enable;// Offset=0x8 Size=0x8
};
