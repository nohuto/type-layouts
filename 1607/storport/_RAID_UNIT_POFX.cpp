...
union _unnamed_290// Size=0x4 (Id=290)
{
...
struct _RAID_UNIT_POFX// Size=0x98 (Id=291)
{
    ...
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long IoCoalescingOn:1;// Offset=0x20 Size=0x4 BitOffset=0x8 BitSize=0x1
        unsigned long OnBatteryPower:1;// Offset=0x20 Size=0x4 BitOffset=0x9 BitSize=0x1
        unsigned long Reserved0:22;// Offset=0x20 Size=0x4 BitOffset=0xa BitSize=0x16
    };
    ...
    long PendingRequests;// Offset=0x38 Size=0x4
    ...
    unsigned long long ActiveReferences;// Offset=0x60 Size=0x8
    ...
    union _unnamed_290 InterlockedFlags;// Offset=0x94 Size=0x4
};
