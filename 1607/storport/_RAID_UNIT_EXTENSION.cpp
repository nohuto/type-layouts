...
struct _STOR_ADDR_BTL8// Size=0x10 (Id=221)
{
...
struct _STOR_SCSI_IDENTITY// Size=0x38 (Id=192)
{
...
struct _unnamed_224// Size=0x8 (Id=224)
{
...
struct _QUEUE_TAG_LIST// Size=0x80 (Id=187)
{
...
struct _EXTENDED_DEVICE_QUEUE// Size=0x88 (Id=205)
{
...
struct _IO_QUEUE// Size=0xa0 (Id=204)
{
...
struct _unnamed_227// Size=0x190 (Id=227)
{
...
struct _RAID_IO_RESOURCES// Size=0x20 (Id=232)
{
...
struct _RAID_UNIT_REGISTRY_PARAMETERS// Size=0x18 (Id=332)
{
...
struct _RAID_WORK_ITEM_CONTEXT// Size=0x10 (Id=380)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
    struct _IRP * Irp;// Offset=0x8 Size=0x8
};

struct _STOR_ASYNC_NOTIFY_CONTEXT// Size=0x18 (Id=345)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
...
struct _TELEMETRY_UNIT_EXTENSION// Size=0x3 (Id=327)
{
    unsigned char CriticalEventsLogged;// Offset=0x0 Size=0x1
    unsigned char SmartPredictFailure;// Offset=0x1 Size=0x1
    unsigned char NvmeCriticalWarning;// Offset=0x2 Size=0x1
};

union _unnamed_457// Size=0x4 (Id=457)
{
    unsigned long Quantity;// Offset=0x0 Size=0x4
    unsigned long Position;// Offset=0x0 Size=0x4
};

struct _RAID_TELEMETRY_ERROR_ENTRY// Size=0x28 (Id=458)
{
    ...
    union _unnamed_457 u;// Offset=0x20 Size=0x4
};

struct _RAID_TELEMETRY_SAMPLED_ERROR_LOG// Size=0x1c0 (Id=476)
{
...
struct _RAID_TELEMETRY_UNIQUE_ERROR_LOG// Size=0xc8 (Id=426)
{
    struct _RAID_TELEMETRY_ERROR_ENTRY UniqueErrors[5];// Offset=0x0 Size=0xc8
};

struct _RAID_UNIT_QOS// Size=0x30 (Id=545)
{
...
struct _RAID_UNIT_EXTENSION// Size=0xa40 (Id=231)
{
    ...
    struct _unnamed_224 Flags;// Offset=0x98 Size=0x8
    union _unnamed_225 InterlockedFlags;// Offset=0xa0 Size=0x4
    ...
    struct _unnamed_227 DeferredList;// Offset=0x3f0 Size=0x190
    ...
    struct _unnamed_230 PendingPowerUpContext;// Offset=0x658 Size=0x10
    ...
    struct _TELEMETRY_UNIT_EXTENSION TelemetryExtension;// Offset=0x6a8 Size=0x3
    ...
    unsigned long long TelemetryLock;// Offset=0x758 Size=0x8
    struct _RAID_TELEMETRY_SAMPLED_ERROR_LOG TelemetrySampledErrorLog;// Offset=0x760 Size=0x1c0
    struct _RAID_TELEMETRY_UNIQUE_ERROR_LOG TelemetryUniqueErrorLog;// Offset=0x920 Size=0xc8
    unsigned long PowerCycleCount;// Offset=0x9e8 Size=0x4
    union _LARGE_INTEGER InitialTimestamp;// Offset=0x9f0 Size=0x8
    struct _RAID_UNIT_QOS Qos;// Offset=0x9f8 Size=0x30
    unsigned long long LastHierarchicalResetEndTime;// Offset=0xa28 Size=0x8
};
