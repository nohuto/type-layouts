...
struct _unnamed_233// Size=0x6 (Id=233)
{
...
struct _STOR_LOCKED_LIST// Size=0x20 (Id=259)
{
...
struct _STOR_DICTIONARY// Size=0x30 (Id=185)
{
...
struct _RAID_POWER_STATE// Size=0x10 (Id=270)
{
...
struct _RAID_RESOURCE_LIST// Size=0x10 (Id=274)
{
...
struct _BUS_INTERFACE_STANDARD// Size=0x40 (Id=577)
{
...
struct _RAID_BUS_INTERFACE// Size=0x48 (Id=547)
{
...
struct _RAID_DMA_ADAPTER// Size=0x20 (Id=283)
{
...
struct _RAID_MEMORY_REGION// Size=0x18 (Id=190)
{
    unsigned char * VirtualBase;// Offset=0x0 Size=0x8
    union _LARGE_INTEGER PhysicalBase;// Offset=0x8 Size=0x8
    unsigned long Length;// Offset=0x10 Size=0x4
...
struct _IO_CONT_RESOURCE_LIST// Size=0x80 (Id=357)
{
...
struct _STOR_NOTIFICATION_INFO// Size=0x20 (Id=358)
{
...
struct _STOR_IO_GATEWAY// Size=0x140 (Id=222)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _RAID_DEFERRED_QUEUE// Size=0x80 (Id=206)
{
...
struct _unnamed_237// Size=0xb0 (Id=237)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=355)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KTIMER// Size=0x40 (Id=294)
{
...
struct _PORT_REGISTRY_INFO// Size=0x40 (Id=401)
{
...
struct _RAID_ADAPTER_PARAMETERS// Size=0x38 (Id=498)
{
...
struct _unnamed_239// Size=0x1 (Id=239)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _SCSI_POWER_REQUEST_BLOCK// Size=0x58 (Id=455)
{
    unsigned short Length;// Offset=0x0 Size=0x2
...
struct _STORAGE_REQUEST_BLOCK// Size=0x80 (Id=216)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    unsigned char Function;// Offset=0x2 Size=0x1
    unsigned char SrbStatus;// Offset=0x3 Size=0x1
...
struct _RAID_POWER_CONTEXT// Size=0xb8 (Id=373)
{
...
struct _STORPORT_EXTENDED_FUNCTIONS// Size=0x58 (Id=306)
{
...
union _RAID_REDIRECTION_SUPPORT// Size=0x2 (Id=481)
{
    struct // Size=0x2 (Id=0)
    {
...
struct _PCI_HEADER_TYPE_0// Size=0x30 (Id=442)
{
...
struct _PCI_HEADER_TYPE_1// Size=0x30 (Id=549)
{
...
struct _PCI_HEADER_TYPE_2// Size=0x30 (Id=571)
{
    ...
    unsigned char SubordinateBus;// Offset=0xa Size=0x1
    unsigned char SecondaryLatency;// Offset=0xb Size=0x1
    struct _unnamed_570 Range[4];// Offset=0xc Size=0x20
    unsigned char InterruptLine;// Offset=0x2c Size=0x1
    unsigned char InterruptPin;// Offset=0x2d Size=0x1
    unsigned short BridgeControl;// Offset=0x2e Size=0x2
};

union _unnamed_392// Size=0x30 (Id=392)
{
...
struct _PCI_COMMON_HEADER// Size=0x40 (Id=393)
{
    ...
    union _unnamed_392 u;// Offset=0x10 Size=0x30
};

struct _STOR_POWER_SETTING_NOTIFICATION// Size=0x18 (Id=482)
{
...
struct _CRASHDUMP_FUNCTIONS_INTERFACE// Size=0x28 (Id=480)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
struct _RAID_RPMB_CAPABILITIES// Size=0x38 (Id=347)
{
...
struct _RAID_SHARED_WORK_ITEM_CONTEXT// Size=0x18 (Id=431)
{
...
struct _RAID_ADAPTER_EXTENSION// Size=0x1680 (Id=241)
{
    ...
    struct _unnamed_233 Flags;// Offset=0x68 Size=0x6
    ...
    struct _unnamed_236 DeferredList;// Offset=0x4c0 Size=0x50
    struct _unnamed_237 DeferredPauseResumeContext;// Offset=0x510 Size=0xb0
    ...
    struct _unnamed_239 PerfOptFlags;// Offset=0x1163 Size=0x1
    ...
    struct _unnamed_240 TelemetryHierarchicalResetLunBucket[5];// Offset=0x145c Size=0x3c
    struct _unnamed_240 TelemetryHierarchicalResetTargetBucket[5];// Offset=0x1498 Size=0x3c
    ...
    struct _RAID_SHARED_WORK_ITEM_CONTEXT IoResourceWorkItem;// Offset=0x1640 Size=0x18
};
