union _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_unnamed_1686// Size=0x4 (Id=1686)
{
    struct <unnamed-type-Transmit>// Size=0x4 (Id=10223)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_unnamed_1687::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x4
    struct <unnamed-type-Receive>// Size=0x4 (Id=10230)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_unnamed_1688::<unnamed-type-Receive> Receive;// Offset=0x0 Size=0x4
