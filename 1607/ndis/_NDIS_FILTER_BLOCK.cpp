...
struct _REFERENCE_EX// Size=0x18 (Id=1107)
{
...
struct _PENDING_STACK_EXPANSION_FALLBACK_WORK// Size=0x38 (Id=985)
{
...
struct _NDIS_FILTER_BLOCK// Size=0x390 (Id=415)
{
    union // Size=0xc0 (Id=0)
    {
        ...
        struct <unnamed-type-StackExpansionFallback>// Size=0x60 (Id=5816)
        {
