union _NDIS_PACKET_8021Q_INFO::_unnamed_960// Size=0x8 (Id=960)
{
    struct <unnamed-type-TagHeader>// Size=0x4 (Id=8695)
    {
    ...
    struct _NDIS_PACKET_8021Q_INFO::_unnamed_961::<unnamed-type-TagHeader> TagHeader;// Offset=0x0 Size=0x4
