...
struct _GENERIC_MAPPING// Size=0x10 (Id=1308)
{
...
struct _OBJECT_TYPE_INITIALIZER// Size=0x78 (Id=476)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    union // Size=0x1 (Id=0)
    {
        unsigned char ObjectTypeFlags;// Offset=0x2 Size=0x1
    ...
    union // Size=0x1 (Id=0)
    {
        unsigned char ObjectTypeFlags2;// Offset=0x3 Size=0x1
        struct // Size=0x1 (Id=0)
        {
...
struct _EX_PUSH_LOCK// Size=0x8 (Id=77)
{
    union // Size=0x8 (Id=0)
    {
...
struct _OBJECT_TYPE// Size=0xd8 (Id=113)
{
