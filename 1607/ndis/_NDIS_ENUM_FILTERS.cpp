...
struct _NDIS_FILTER_INTERFACE// Size=0x40 (Id=720)
{
...
struct _NDIS_ENUM_FILTERS// Size=0x50 (Id=513)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
    unsigned long NumberOfFilters;// Offset=0x8 Size=0x4
    unsigned long OffsetFirstFilter;// Offset=0xc Size=0x4
    struct _NDIS_FILTER_INTERFACE Filter[1];// Offset=0x10 Size=0x40
};
