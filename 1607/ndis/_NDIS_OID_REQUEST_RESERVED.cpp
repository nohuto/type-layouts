...
struct _NDIS_OID_REQUEST_FLAGS// Size=0x4 (Id=712)
{
...
struct _NDIS_OID_REQUEST_RESERVED// Size=0x60 (Id=411)
{
    ...
    union // Size=0x48 (Id=0)
    {
        ...
        struct _NDIS_OID_REQUEST_RESERVED::_unnamed_851::<unnamed-type-CoNdis> CoNdis;// Offset=0x28 Size=0x20
    };
    union // Size=0x60 (Id=0)
    {
        ...
        struct _NDIS_OID_REQUEST_RESERVED::_unnamed_855::<unnamed-type-IovContext> IovContext;// Offset=0x48 Size=0x10
        struct _NDIS_OID_REQUEST_RESERVED::_unnamed_856::<unnamed-type-PMContext> PMContext;// Offset=0x48 Size=0x18
    };
};
