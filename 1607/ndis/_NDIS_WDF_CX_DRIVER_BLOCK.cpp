...
struct _NDIS_WDF_CX_CHARACTERISTICS// Size=0x40 (Id=389)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    long  ( * EvtCxPowerReference)(void * ,unsigned char );// Offset=0x8 Size=0x8
...
struct _NDIS_WDF_CX_DRIVER_BLOCK// Size=0x68 (Id=409)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    ...
    struct _NDIS_WDF_CX_CHARACTERISTICS Chars;// Offset=0x20 Size=0x40
    unsigned long ClientCount;// Offset=0x60 Size=0x4
    enum _NDIS_WDF_CX_DRIVER_STATE State;// Offset=0x64 Size=0x1
};
