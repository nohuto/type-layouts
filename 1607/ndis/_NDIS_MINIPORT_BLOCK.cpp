...
struct _UNICODE_STRING// Size=0x10 (Id=33)
{
...
struct _REFERENCE// Size=0x10 (Id=824)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=635)
{
    union // Size=0x4 (Id=0)
    {
...
union _ULARGE_INTEGER// Size=0x8 (Id=12)
{
    ...
    struct <unnamed-type-u>// Size=0x8 (Id=12651)
    {
        unsigned long LowPart;// Offset=0x0 Size=0x4
        unsigned long HighPart;// Offset=0x4 Size=0x4
    };
...
struct _KTIMER// Size=0x40 (Id=1182)
{
...
struct _SINGLE_LIST_ENTRY// Size=0x8 (Id=27)
{
...
struct _NDIS_TIMER// Size=0x80 (Id=1019)
{
...
struct _NDIS_PM_WAKE_UP_CAPABILITIES// Size=0xc (Id=750)
{
...
struct _NDIS_PNP_CAPABILITIES// Size=0x10 (Id=707)
{
    unsigned long Flags;// Offset=0x0 Size=0x4
    struct _NDIS_PM_WAKE_UP_CAPABILITIES WakeUpCapabilities;// Offset=0x4 Size=0xc
};

struct _NDIS_PM_CAPABILITIES// Size=0x3c (Id=512)
{
...
struct _NDIS_PM_PARAMETERS// Size=0x14 (Id=521)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=566)
{
...
struct _NDIS_MINIPORT_WORK_ITEM// Size=0x18 (Id=1086)
{
...
struct _WORK_QUEUE_ITEM// Size=0x20 (Id=75)
{
...
struct _KBUGCHECK_CALLBACK_RECORD// Size=0x40 (Id=532)
{
...
struct _NDIS_MINIPORT_HANDLERS// Size=0xb8 (Id=478)
{
...
struct _NDIS_RECEIVE_SCALE_CAPABILITIES// Size=0x14 (Id=307)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_RESTART_GENERAL_ATTRIBUTES// Size=0x58 (Id=306)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_M_PERIODIC_RECEIVES// Size=0x90 (Id=882)
{
...
struct _NDIS_MINIPORT_OFFLOAD_REG// Size=0x4 (Id=682)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _NDIS_EVENT// Size=0x18 (Id=879)
{
...
struct _NDIS_PM_ADMIN_CONFIG// Size=0x4 (Id=771)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _KSEMAPHORE// Size=0x20 (Id=809)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
union _NET_LUID_LH// Size=0x8 (Id=357)
{
    unsigned long long Value;// Offset=0x0 Size=0x8
    struct <unnamed-type-Info>// Size=0x8 (Id=11347)
    {
...
struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=662)
{
...
struct _IO_REMOVE_LOCK// Size=0x20 (Id=480)
{
...
struct _ULONG_REFERENCE// Size=0x10 (Id=943)
{
    unsigned long long SpinLock;// Offset=0x0 Size=0x8
...
struct _VPCI_INVALIDATE_BLOCK_OUTPUT// Size=0x8 (Id=561)
{
    unsigned long long BlockMask;// Offset=0x0 Size=0x8
};

struct _LUID// Size=0x8 (Id=38)
{
    unsigned long LowPart;// Offset=0x0 Size=0x4
    long HighPart;// Offset=0x4 Size=0x4
};

struct _IF_PHYSICAL_ADDRESS_LH// Size=0x22 (Id=1244)
{
    unsigned short Length;// Offset=0x0 Size=0x2
...
struct _NDIS_MINIPORT_BLOCK// Size=0x1708 (Id=342)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    ...
    unsigned long FilterPnPFlags;// Offset=0xa80 Size=0x4
    unsigned long SupportedStatistics;// Offset=0xa84 Size=0x4
    unsigned long cDpcSendCompletes;// Offset=0xa88 Size=0x4
    unsigned long cDpcRcvIndications;// Offset=0xa8c Size=0x4
    unsigned long cDpcRcvIndicationCalls;// Offset=0xa90 Size=0x4
    unsigned long cDpcNbSendCompletes;// Offset=0xa94 Size=0x4
    unsigned long cDpcNblSendCompletes;// Offset=0xa98 Size=0x4
    unsigned long cDpcNblIndications;// Offset=0xa9c Size=0x4
    unsigned long cDpcMaxPacketsIndicated;// Offset=0xaa0 Size=0x4
    unsigned long cDpcTotalDpcCount;// Offset=0xaa4 Size=0x4
    struct _NDIS_RECEIVE_SCALE_CAPABILITIES RecvScaleCapabilities;// Offset=0xaa8 Size=0x14
    struct _NDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES * GeneralAttributes;// Offset=0xac0 Size=0x8
    struct _LIST_ENTRY PortList;// Offset=0xac8 Size=0x10
    unsigned char * AllocatedPortIndices;// Offset=0xad8 Size=0x8
    unsigned long AllocatedPortIndicesLength;// Offset=0xae0 Size=0x4
    unsigned long NumberOfPorts;// Offset=0xae4 Size=0x4
    unsigned long NumberOfActivePorts;// Offset=0xae8 Size=0x4
    unsigned long long MiniportXmitLinkSpeed;// Offset=0xaf0 Size=0x8
    unsigned long long MiniportRcvLinkSpeed;// Offset=0xaf8 Size=0x8
    struct _NDIS_TIMER InitModeTimeoutTimer;// Offset=0xb00 Size=0x80
    struct _NDIS_WORK_ITEM InitModeTimeoutWorkItem;// Offset=0xb80 Size=0x50
    struct _KEVENT InitModeTimeoutTimerQueuedEvent;// Offset=0xbd0 Size=0x18
    unsigned long DataBackFillSize;// Offset=0xbe8 Size=0x4
    unsigned long ContextBackFillSize;// Offset=0xbec Size=0x4
    struct _NDIS_RESTART_GENERAL_ATTRIBUTES TopFilterRestartAttributes;// Offset=0xbf0 Size=0x58
    struct _NDIS_RECEIVE_SCALE_CAPABILITIES TopRecvScaleCapabilities;// Offset=0xc48 Size=0x14
    unsigned long NsiOpenReferences;// Offset=0xc5c Size=0x4
    void * ProcessingOpen;// Offset=0xc60 Size=0x8
    struct _KEVENT * NsiRequestsCompletedEvent;// Offset=0xc68 Size=0x8
    enum _DEVICE_POWER_STATE QueryPowerDeviceState;// Offset=0xc70 Size=0x4
    unsigned char MinimumNdisMajorVersion;// Offset=0xc74 Size=0x1
    unsigned char MinimumNdisMinorVersion;// Offset=0xc75 Size=0x1
    struct _NDIS_MINIPORT_STATS * BottomIfStats;// Offset=0xc78 Size=0x8
    struct _NDIS_M_PERIODIC_RECEIVES PeriodicReceiveQueue;// Offset=0xc80 Size=0x90
    struct PNDIS_PER_PROCESSOR_SLOT__ * PeriodicReceivesNblCountIndex;// Offset=0xd10 Size=0x8
    enum _NDIS_PORT_CONTROL_STATE DefaultSendControlState;// Offset=0xd18 Size=0x4
    enum _NDIS_PORT_CONTROL_STATE DefaultRcvControlState;// Offset=0xd1c Size=0x4
    enum _NDIS_PORT_AUTHORIZATION_STATE DefaultSendAuthorizationState;// Offset=0xd20 Size=0x4
    enum _NDIS_PORT_AUTHORIZATION_STATE DefaultRcvAuthorizationState;// Offset=0xd24 Size=0x4
    enum _NDIS_PORT_CONTROL_STATE DefaultPortSendControlState;// Offset=0xd28 Size=0x4
    enum _NDIS_PORT_CONTROL_STATE DefaultPortRcvControlState;// Offset=0xd2c Size=0x4
    enum _NDIS_PORT_AUTHORIZATION_STATE DefaultPortSendAuthorizationState;// Offset=0xd30 Size=0x4
    enum _NDIS_PORT_AUTHORIZATION_STATE DefaultPortRcvAuthorizationState;// Offset=0xd34 Size=0x4
    struct _NDIS_PCI_DEVICE_CUSTOM_PROPERTIES PciDeviceCustomProperties;// Offset=0xd38 Size=0x34
    void  ( * TopNdis5PacketIndicateHandler)(void * ,struct _NDIS_PACKET ** ,unsigned int );// Offset=0xd70 Size=0x8
    unsigned long * ndisSupportedOidList;// Offset=0xd78 Size=0x8
    unsigned long ndisSupportedOidListLength;// Offset=0xd80 Size=0x4
    unsigned long MsiIntCount;// Offset=0xd84 Size=0x4
    struct _WORK_QUEUE_ITEM MiniportDpcWorkItem;// Offset=0xd88 Size=0x20
    unsigned long long InvalidFrames;// Offset=0xda8 Size=0x8
    long PagingPathCount;// Offset=0xdb0 Size=0x4
    struct _LIST_ENTRY ReceiveQueueList;// Offset=0xdb8 Size=0x10
    unsigned char * AllocatedQueueIndices;// Offset=0xdc8 Size=0x8
    unsigned long AllocatedQueueIndicesLength;// Offset=0xdd0 Size=0x4
    unsigned long NumReceiveQueues;// Offset=0xdd4 Size=0x4
    struct _LIST_ENTRY ReceiveFilterList;// Offset=0xdd8 Size=0x10
    unsigned char * AllocatedReceiveFilterIndices;// Offset=0xde8 Size=0x8
    unsigned long AllocatedReceiveFilterIndicesLength;// Offset=0xdf0 Size=0x4
    unsigned long NumReceiveFilters;// Offset=0xdf4 Size=0x4
    unsigned long EnabledReceiveFilterTypes;// Offset=0xdf8 Size=0x4
    unsigned long EnabledReceiveQueueTypes;// Offset=0xdfc Size=0x4
    struct _NDIS_RECEIVE_FILTER_CAPABILITIES * ReceiveFilterHwCapabilities;// Offset=0xe00 Size=0x8
    struct _NDIS_RECEIVE_FILTER_CAPABILITIES * ReceiveFilterCurrentCapabilities;// Offset=0xe08 Size=0x8
    struct _NDIS_RECEIVE_FILTER_CAPABILITIES * TopReceiveFilterCurrentCapabilities;// Offset=0xe10 Size=0x8
    struct _NDIS_NIC_SWITCH_CAPABILITIES * NicSwitchHwCapabilities;// Offset=0xe18 Size=0x8
    struct _NDIS_NIC_SWITCH_CAPABILITIES * NicSwitchCurrentCapabilities;// Offset=0xe20 Size=0x8
    struct _NDIS_NIC_SWITCH_CAPABILITIES * TopNicSwitchCurrentCapabilities;// Offset=0xe28 Size=0x8
    struct _LIST_ENTRY SharedMemoryBlockList;// Offset=0xe30 Size=0x10
    int  ( * AllocateSharedMemoryHandler)(void * ,struct _NDIS_SHARED_MEMORY_PARAMETERS * ,void ** );// Offset=0xe40 Size=0x8
    void  ( * FreeSharedMemoryHandler)(void * ,void * );// Offset=0xe48 Size=0x8
    void * AllocateSharedMemoryContext;// Offset=0xe50 Size=0x8
    struct PCI_MSI_CAPABILITY MsiCaps;// Offset=0xe58 Size=0x18
    struct PCI_MSIX_CAPABILITY MsiXCaps;// Offset=0xe70 Size=0xc
    unsigned long long NumberOfIndirectionTableChanges;// Offset=0xe80 Size=0x8
    unsigned int PciDeviceSriovSupport;// Offset=0xe88 Size=0x4
    union // Size=0x1 (Id=0)
    {
        unsigned char BeginSavedFields;// Offset=0xe8c Size=0x1
        unsigned long NumUserOpens;// Offset=0xe8c Size=0x4
    };
    struct _NDIS_MINIPORT_OFFLOAD_REG OffloadRegistry;// Offset=0xe90 Size=0x4
    unsigned short MediaDisconnectTimeOut;// Offset=0xe94 Size=0x2
    unsigned short SGMapRegistersNeeded;// Offset=0xe96 Size=0x2
    unsigned long DriverVerifyFlags;// Offset=0xe98 Size=0x4
    unsigned long  ( * SetBusData)(void * ,unsigned long ,void * ,unsigned long ,unsigned long );// Offset=0xea0 Size=0x8
    unsigned long  ( * GetBusData)(void * ,unsigned long ,void * ,unsigned long ,unsigned long );// Offset=0xea8 Size=0x8
    void * BusDataContext;// Offset=0xeb0 Size=0x8
    enum _INTERFACE_TYPE BusType;// Offset=0xeb8 Size=0x4
    unsigned long BusNumber;// Offset=0xebc Size=0x4
    unsigned long SlotNumber;// Offset=0xec0 Size=0x4
    struct _NDIS_EVENT OpenReadyEvent;// Offset=0xec8 Size=0x18
    unsigned long NumAdminOpens;// Offset=0xee0 Size=0x4
    struct _NDIS_M_DRIVER_BLOCK * DriverHandle;// Offset=0xee8 Size=0x8
    struct _NDIS_BIND_PATHS * BindPaths;// Offset=0xef0 Size=0x8
    enum _NDIS_PHYSICAL_MEDIUM MiniportPhysicalMediumType;// Offset=0xef8 Size=0x4
    void * SecurityDescriptor;// Offset=0xf00 Size=0x8
    struct _UNICODE_STRING BaseName;// Offset=0xf08 Size=0x10
    struct _UNICODE_STRING MiniportName;// Offset=0xf18 Size=0x10
    struct _DEVICE_OBJECT * DeviceObject;// Offset=0xf28 Size=0x8
    struct _DEVICE_OBJECT * PhysicalDeviceObject;// Offset=0xf30 Size=0x8
    struct _DEVICE_OBJECT * NextDeviceObject;// Offset=0xf38 Size=0x8
    struct _NDIS_MINIPORT_BLOCK * NextGlobalMiniport;// Offset=0xf40 Size=0x8
    struct _UNICODE_STRING * pAdapterInstanceName;// Offset=0xf48 Size=0x8
    unsigned long PnPCapabilities;// Offset=0xf50 Size=0x4
    enum _DEVICE_POWER_STATE CurrentDevicePowerState;// Offset=0xf54 Size=0x4
    unsigned long long PowerStateLock;// Offset=0xf58 Size=0x8
    enum _DEVICE_POWER_STATE DriverPowerState;// Offset=0xf60 Size=0x4
    enum _DEVICE_POWER_STATE PrevDriverPowerState;// Offset=0xf64 Size=0x4
    struct _NET_BUFFER_LIST * LowPowerRcvReturnNbls;// Offset=0xf68 Size=0x8
    unsigned long PendingReturnNBLCount;// Offset=0xf70 Size=0x4
    unsigned char SurpriseRemoveFlushedRcvReturnQueue;// Offset=0xf74 Size=0x1
    struct NDIS_NBL_TRACKER_HANDLE__ * LowPowerRcvReturnNblTracker;// Offset=0xf78 Size=0x8
    struct _NDIS_PM_ADMIN_CONFIG PMAdminConfig;// Offset=0xf80 Size=0x4
    struct _KSEMAPHORE PMPatternSemaphore;// Offset=0xf88 Size=0x20
    struct _KSEMAPHORE PMOffloadSemaphore;// Offset=0xfa8 Size=0x20
    void * BusInterface;// Offset=0xfc8 Size=0x8
    unsigned short InstanceNumber;// Offset=0xfd0 Size=0x2
    void * ConfigurationHandle;// Offset=0xfd8 Size=0x8
    struct _GUID InterfaceGuid;// Offset=0xfe0 Size=0x10
    union _NET_LUID_LH NetLuid;// Offset=0xff0 Size=0x8
    unsigned char IfBlockAvailable;// Offset=0xff8 Size=0x1
    struct _NDIS_IF_BLOCK * IfBlock;// Offset=0x1000 Size=0x8
    struct _KEVENT * IfBlockPointerRefZeroEvent;// Offset=0x1008 Size=0x8
    unsigned int IfIndex;// Offset=0x1010 Size=0x4
    enum _NET_IF_ADMIN_STATUS AdminStatus;// Offset=0x1014 Size=0x4
    enum _NET_IF_OPER_STATUS OperStatus;// Offset=0x1018 Size=0x4
    unsigned long OperStatusFlags;// Offset=0x101c Size=0x4
    union // Size=0x8 (Id=0)
    {
        int  ( * SendHandler)(void * ,struct _NDIS_PACKET * ,unsigned int );// Offset=0x1020 Size=0x8
        int  ( * WanSendHandler)(void * ,void * ,struct _NDIS_WAN_PACKET * );// Offset=0x1020 Size=0x8
    };
    struct NDIS_NBL_TRACKER_HANDLE__ * NblTracker;// Offset=0x1028 Size=0x8
    struct _DEVICE_RESET_INTERFACE_STANDARD * ReenumerateSelfInterface;// Offset=0x1030 Size=0x8
    struct _NDIS_MINIPORT_OFFLOAD * Offload;// Offset=0x1038 Size=0x8
    void * NDKBlock;// Offset=0x1040 Size=0x8
    void * AddDeviceContext;// Offset=0x1048 Size=0x8
    struct _IO_REMOVE_LOCK RemoveLock;// Offset=0x1050 Size=0x20
    struct _UNICODE_STRING DevinterfaceNetSymbolicLinkName;// Offset=0x1070 Size=0x10
    unsigned long PhysicalMediumInInf;// Offset=0x1080 Size=0x4
    class KPtr<Rtl::KString,KDeletePtr<Rtl::KString> > ExportName;// Offset=0x1088 Size=0x8
    class KPtr<Rtl::KString,KDeletePtr<Rtl::KString> > FilterClass;// Offset=0x1090 Size=0x8
    void * StatusProcessingThread;// Offset=0x1098 Size=0x8
    unsigned long StatusProcessingDbgX;// Offset=0x10a0 Size=0x4
    struct _UNICODE_STRING FdoName;// Offset=0x10a8 Size=0x10
    struct _KEVENT PowerD0CompleteEvent;// Offset=0x10b8 Size=0x18
    long LastD0CompleteStatus;// Offset=0x10d0 Size=0x4
    enum _NDIS_MINIPORT_EVENT LastD0Reason;// Offset=0x10d4 Size=0x2
    unsigned long DirectOidRequestCount;// Offset=0x10d8 Size=0x4
    struct _KEVENT * AllDirectRequestsCompletedEvent;// Offset=0x10e0 Size=0x8
    struct _NDIS_HD_SPLIT_CURRENT_CONFIG * HDSplitCurrentConfig;// Offset=0x10e8 Size=0x8
    void * MSIXConfigContext;// Offset=0x10f0 Size=0x8
    long  ( * SetMSIXTableEntry)(void * ,unsigned long ,unsigned long );// Offset=0x10f8 Size=0x8
    long  ( * MaskMSIXTableEntry)(void * ,unsigned long );// Offset=0x1100 Size=0x8
    long  ( * UnmaskMSIXTableEntry)(void * ,unsigned long );// Offset=0x1108 Size=0x8
    struct _WORK_QUEUE_ITEM DevicePowerStateWorkItem;// Offset=0x1110 Size=0x20
    struct _WORK_QUEUE_ITEM SystemPowerStateWorkItem;// Offset=0x1130 Size=0x20
    struct _NDIS_RECEIVE_QUEUE_BLOCK * DefaultReceiveQueue;// Offset=0x1150 Size=0x8
    unsigned long MaxNumRssProcessors;// Offset=0x1158 Size=0x4
    struct _PROCESSOR_NUMBER RssBaseProcessor;// Offset=0x115c Size=0x4
    struct _PROCESSOR_NUMBER RssMaxProcessor;// Offset=0x1160 Size=0x4
    enum _NDIS_RSS_PROFILE RssProfile;// Offset=0x1164 Size=0x4
    unsigned short NumaNodeId;// Offset=0x1168 Size=0x2
    unsigned short * NumaDistances;// Offset=0x1170 Size=0x8
    struct _UNICODE_STRING * pModifiedInstanceName;// Offset=0x1178 Size=0x8
    unsigned long SyncFlags;// Offset=0x1180 Size=0x4
    unsigned long WSyncFlags;// Offset=0x1184 Size=0x4
    unsigned long InterlockedFlags;// Offset=0x1188 Size=0x4
    struct _ULONG_REFERENCE Ref;// Offset=0x1190 Size=0x10
    struct _NDIS_SELECTIVE_SUSPEND * SelectiveSuspend;// Offset=0x11a0 Size=0x8
    struct _NDIS_MINIPORT_AOAC * AoAc;// Offset=0x11a8 Size=0x8
    enum _NDIS_PM_WAKE_REASON_TYPE LastWakeReason;// Offset=0x11b0 Size=0x4
    struct NDIS_EVENT_LOG_HANDLE__ * PnpEventLog;// Offset=0x11b8 Size=0x8
    struct _NDIS_D0_SIGNAL_WORK_ITEM D0CompleteSignalWorkItem;// Offset=0x11c0 Size=0x58
    struct _NDIS_PHYSICAL_PERFORMANCE_COUNTERS * PhysicalPerformanceCounters;// Offset=0x1218 Size=0x8
    union _LARGE_INTEGER TimeOfInitialization;// Offset=0x1220 Size=0x8
    union _LARGE_INTEGER LastSystemSleepTime;// Offset=0x1228 Size=0x8
    unsigned long long TotalSystemSleepTimeMs;// Offset=0x1230 Size=0x8
    struct _NDIS_SRIOV_CAPABILITIES * SriovHwCapabilities;// Offset=0x1238 Size=0x8
    struct _NDIS_SRIOV_CAPABILITIES * SriovCurrentCapabilities;// Offset=0x1240 Size=0x8
    unsigned long long InvalidateBlockMask;// Offset=0x1248 Size=0x8
    struct _IRP * InvalidateBlockIoctlPf;// Offset=0x1250 Size=0x8
    struct _IRP * InvalidateBlockIoctlVf;// Offset=0x1258 Size=0x8
    struct _VPCI_INVALIDATE_BLOCK_OUTPUT InvalidateBlockVfParams;// Offset=0x1260 Size=0x8
    struct _KEVENT InvalidateBlockEvent;// Offset=0x1268 Size=0x18
    unsigned short InvalidateVfId;// Offset=0x1280 Size=0x2
    unsigned char InvalidateBlockCancelling;// Offset=0x1282 Size=0x1
    struct _NDIS_PF_BLOCK * PFBlock;// Offset=0x1288 Size=0x8
    unsigned long NumSwitches;// Offset=0x1290 Size=0x4
    struct _LIST_ENTRY NicSwitchList;// Offset=0x1298 Size=0x10
    unsigned long NumAllocatedVFs;// Offset=0x12a8 Size=0x4
    struct _LIST_ENTRY VFList;// Offset=0x12b0 Size=0x10
    unsigned long NumActiveVPorts;// Offset=0x12c0 Size=0x4
    struct _LIST_ENTRY VPortList;// Offset=0x12c8 Size=0x10
    unsigned char * AllocatedVPortIndices;// Offset=0x12d8 Size=0x8
    unsigned long AllocatedVPortIndicesLength;// Offset=0x12e0 Size=0x4
    unsigned long  ( * SetVirtualFunctionData)(void * ,unsigned short ,void * ,unsigned long ,unsigned long );// Offset=0x12e8 Size=0x8
    unsigned long  ( * GetVirtualFunctionData)(void * ,unsigned short ,void * ,unsigned long ,unsigned long );// Offset=0x12f0 Size=0x8
    long  ( * EnableVirtualization)(void * ,unsigned short ,unsigned char ,unsigned char ,unsigned char );// Offset=0x12f8 Size=0x8
    long  ( * GetVirtualDeviceLocation)(void * ,unsigned short ,unsigned short * ,unsigned char * ,unsigned char * );// Offset=0x1300 Size=0x8
    long  ( * GetVirtualFunctionProbedBars)(void * ,unsigned long * );// Offset=0x1308 Size=0x8
    void * VirtInterfaceContext;// Offset=0x1310 Size=0x8
    struct _UNICODE_STRING DevinterfaceVirtSymbolicLinkName;// Offset=0x1318 Size=0x10
    void  ( * VpciInterfaceDereference)(void * );// Offset=0x1328 Size=0x8
    long  ( * WriteVfConfigBlock)(void * ,unsigned long ,void * ,unsigned long );// Offset=0x1330 Size=0x8
    long  ( * ReadVfConfigBlock)(void * ,unsigned long ,void * ,unsigned long );// Offset=0x1338 Size=0x8
    void * VpciInterfaceContext;// Offset=0x1340 Size=0x8
    unsigned int VfSerialNumber;// Offset=0x1348 Size=0x4
    struct _LUID SriovLuid;// Offset=0x134c Size=0x8
    struct NDIS_REFCOUNT_HANDLE__ * RefCountTracker;// Offset=0x1358 Size=0x8
    struct NDIS_REFCOUNT_HANDLE__ * NsiRefCountTracker;// Offset=0x1360 Size=0x8
    struct _NDIS_QOS_CAPABILITIES * QosHwCapabilities;// Offset=0x1368 Size=0x8
    struct _NDIS_QOS_CAPABILITIES * QosCurrentCapabilities;// Offset=0x1370 Size=0x8
    struct _NDIS_QOS_PARAMETERS * QosOperationalParameters;// Offset=0x1378 Size=0x8
    unsigned long QosOperationalParametersBufferSize;// Offset=0x1380 Size=0x4
    struct _NDIS_QOS_PARAMETERS * QosRemoteParameters;// Offset=0x1388 Size=0x8
    unsigned long QosRemoteParametersBufferSize;// Offset=0x1390 Size=0x4
    unsigned long long DeviceFlags;// Offset=0x1398 Size=0x8
    void * VerifierContext;// Offset=0x13a0 Size=0x8
    struct _WORK_QUEUE_ITEM SurpriseRemovalWorkItem;// Offset=0x13a8 Size=0x20
    struct Ndis::BindStack Bindings;// Offset=0x13c8 Size=0x90
    struct Ndis::BindEngine BindEngine;// Offset=0x1458 Size=0x78
    class Rtl::KNeutralLock<enum NDIS_MINIPORT_POLICY_OWNER> MiniportOwner;// Offset=0x14d0 Size=0x28
    bool PmInterruptedByPnp;// Offset=0x14f8 Size=0x1
    bool DoNotBlockOnMiniportLock;// Offset=0x14f9 Size=0x1
    bool PoFxDStateReportingEnabled;// Offset=0x14fa Size=0x1
    struct NDIS_MINIPORT_HOOK_ADAPTER_HANDLE__ * HookAdapterHandle;// Offset=0x1500 Size=0x8
    struct _WORK_QUEUE_ITEM InterfaceUpdateWorkItem;// Offset=0x1508 Size=0x20
    bool InterfaceUpdateInProgress;// Offset=0x1528 Size=0x1
    bool MacAddressUpdateQueued;// Offset=0x1529 Size=0x1
    bool MtuUpdateQueued;// Offset=0x152a Size=0x1
    struct _IF_PHYSICAL_ADDRESS_LH PendingMacAddress;// Offset=0x152c Size=0x22
    unsigned long PendingMtuSize;// Offset=0x1550 Size=0x4
    struct RECORDER_LOG__ * BlackBoxHandle;// Offset=0x1558 Size=0x8
    struct _KEVENT * PowerCompleteEvent;// Offset=0x1560 Size=0x8
    long PowerCompleteStatus;// Offset=0x1568 Size=0x4
    struct _POWER_WORK_ITEM DevicePowerOnWorkItem;// Offset=0x1570 Size=0x58
    struct _POWER_WORK_ITEM DevicePowerDownWorkItem;// Offset=0x15c8 Size=0x58
    struct _NDIS_PD_BLOCK * PDBlock;// Offset=0x1620 Size=0x8
    void * PdcHandle;// Offset=0x1628 Size=0x8
    struct _NDIS_TIMER PdcTaskClientDisableTimer;// Offset=0x1630 Size=0x80
    struct _NDIS_WORK_ITEM PdcTaskClientDisableWorkItem;// Offset=0x16b0 Size=0x50
    long PdcTaskClientMode;// Offset=0x1700 Size=0x4
    unsigned long ModernStandbyWoLMagicPacketEnable;// Offset=0x1704 Size=0x4
