union _SLIST_HEADER// Size=0x10 (Id=64)
{
    unsigned long long Alignment;// Offset=0x0 Size=0x8
    unsigned long long Region;// Offset=0x8 Size=0x8
    struct <unnamed-type-HeaderX64>// Size=0x10 (Id=12263)
    {
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=62)
{
...
struct _LOOKASIDE_LIST_EX// Size=0x60 (Id=60)
{
    struct _GENERAL_LOOKASIDE_POOL L;// Offset=0x0 Size=0x60
};

struct _NDIS_NPAGED_LOOKASIDE_LIST// Size=0x100 (Id=1211)
{
    struct _LOOKASIDE_LIST_EX List;// Offset=0x0 Size=0x60
    union _SLIST_HEADER BackupList;// Offset=0x80 Size=0x10
    union _SLIST_HEADER * AllocListPtr;// Offset=0xc0 Size=0x8
    union _SLIST_HEADER * FreeListPtr;// Offset=0xc8 Size=0x8
    unsigned long long ListSwapLock;// Offset=0xd0 Size=0x8
    unsigned char Initialized;// Offset=0xd8 Size=0x1
};
