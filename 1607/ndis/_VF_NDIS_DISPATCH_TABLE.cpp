...
struct _VF_DISPATCH_TABLE_HEADER// Size=0x8 (Id=1047)
{
    enum _VF_DISPATCH_TABLE_TYPE Type;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
};

struct _VF_NDIS_DISPATCH_TABLE// Size=0xa0 (Id=407)
{
    struct _VF_DISPATCH_TABLE_HEADER Header;// Offset=0x0 Size=0x8
    long  ( * NdisAllocateVerifierContext)(struct _DEVICE_OBJECT * ,void * ,void ** ,void ** );// Offset=0x8 Size=0x8
