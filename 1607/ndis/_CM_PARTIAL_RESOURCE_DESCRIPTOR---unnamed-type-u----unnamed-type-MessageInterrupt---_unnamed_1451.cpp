union _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-MessageInterrupt>::_unnamed_1451// Size=0x10 (Id=1451)
{
    struct <unnamed-type-Raw>// Size=0x10 (Id=2048)
    {
    ...
    struct <unnamed-type-Translated>// Size=0x10 (Id=2054)
    {
