union _NDIS_OID_REQUEST_RESERVED::_unnamed_852// Size=0x18 (Id=852)
{
    ...
    struct <unnamed-type-IovContext>// Size=0x10 (Id=8603)
    {
        struct _NDIS_VF_BLOCK * VFBlock;// Offset=0x0 Size=0x8
        struct _NDIS_VPORT_BLOCK * VPortBlock;// Offset=0x8 Size=0x8
    };
    struct _NDIS_OID_REQUEST_RESERVED::_unnamed_855::<unnamed-type-IovContext> IovContext;// Offset=0x0 Size=0x10
    struct <unnamed-type-PMContext>// Size=0x18 (Id=8609)
    {
    ...
    struct _NDIS_OID_REQUEST_RESERVED::_unnamed_856::<unnamed-type-PMContext> PMContext;// Offset=0x0 Size=0x18
};
