...
struct _NDIS_TIMER_ENTRY// Size=0xd0 (Id=1222)
{
    struct _NDIS_TIMER_ENTRY * NextTimer;// Offset=0x0 Size=0x8
    struct _LIST_ENTRY GlobalLink;// Offset=0x8 Size=0x10
    void * Handle;// Offset=0x18 Size=0x8
    struct _KTIMER Timer;// Offset=0x20 Size=0x40
    struct _KDPC Dpc;// Offset=0x60 Size=0x40
    unsigned long AllocationTag;// Offset=0xa0 Size=0x4
    void  ( * TimerFunction)(void * ,void * ,void * ,void * );// Offset=0xa8 Size=0x8
    void * DefaultFunctionContext;// Offset=0xb0 Size=0x8
    void * FunctionContext;// Offset=0xb8 Size=0x8
    struct _NDIS_MINIPORT_BLOCK * Miniport;// Offset=0xc0 Size=0x8
    unsigned char Periodic;// Offset=0xc8 Size=0x1
    void _NDIS_TIMER_ENTRY(struct _NDIS_TIMER_ENTRY * );
    void _NDIS_TIMER_ENTRY(struct _NDIS_TIMER_ENTRY & );
    struct _NDIS_TIMER_ENTRY & operator=(struct _NDIS_TIMER_ENTRY * );
    struct _NDIS_TIMER_ENTRY & operator=(struct _NDIS_TIMER_ENTRY & );
};
