...
struct _QUEUED_CLOSE// Size=0x28 (Id=1293)
{
...
struct _NDIS_SPIN_LOCK// Size=0x10 (Id=129)
{
...
struct _NDIS_COMMON_OPEN_BLOCK// Size=0x3f8 (Id=346)
{
    union // Size=0x8 (Id=0)
    {
    ...
    void  ( * InitiateOffloadCompleteHandler)(void * ,struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * );// Offset=0x248 Size=0x8
    void  ( * TerminateOffloadCompleteHandler)(void * ,struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * );// Offset=0x250 Size=0x8
    void  ( * UpdateOffloadCompleteHandler)(void * ,struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * );// Offset=0x258 Size=0x8
    void  ( * InvalidateOffloadCompleteHandler)(void * ,struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * );// Offset=0x260 Size=0x8
    void  ( * QueryOffloadCompleteHandler)(void * ,struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * );// Offset=0x268 Size=0x8
    void  ( * IndicateOffloadEventHandler)(void * ,struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * ,unsigned long );// Offset=0x270 Size=0x8
    void  ( * TcpOffloadSendCompleteHandler)(void * ,struct _NET_BUFFER_LIST * );// Offset=0x278 Size=0x8
    void  ( * TcpOffloadReceiveCompleteHandler)(void * ,struct _NET_BUFFER_LIST * );// Offset=0x280 Size=0x8
    void  ( * TcpOffloadDisconnectCompleteHandler)(void * ,struct _NET_BUFFER_LIST * );// Offset=0x288 Size=0x8
    void  ( * TcpOffloadForwardCompleteHandler)(void * ,struct _NET_BUFFER_LIST * );// Offset=0x290 Size=0x8
    void  ( * TcpOffloadEventHandler)(void * ,unsigned long ,unsigned long );// Offset=0x298 Size=0x8
    int  ( * TcpOffloadReceiveIndicateHandler)(void * ,struct _NET_BUFFER_LIST * ,int ,unsigned long * );// Offset=0x2a0 Size=0x8
    struct NDIS_NBL_TRACKER_HANDLE__ * NblTracker;// Offset=0x2a8 Size=0x8
    struct NDIS_REFCOUNT_HANDLE__ * RefCountTracker;// Offset=0x2b0 Size=0x8
    unsigned long long RefCountLock;// Offset=0x2b8 Size=0x8
    unsigned long ProtocolMajorVersion;// Offset=0x2c0 Size=0x4
    void ** IfBlock;// Offset=0x2c8 Size=0x8
    struct _NDIS_SPIN_LOCK PnPStateLock;// Offset=0x2d0 Size=0x10
    enum _NDIS_NDIS5_DRIVER_STATE PnPState;// Offset=0x2e0 Size=0x4
    int OutstandingSends;// Offset=0x2e4 Size=0x4
    struct _NDIS_EVENT PauseEvent;// Offset=0x2e8 Size=0x18
    int  ( * Ndis5WanSendHandler)(void * ,void * ,void * );// Offset=0x300 Size=0x8
    void  ( * ProtSendCompleteHandler)(void * ,struct _NDIS_PACKET * ,int );// Offset=0x308 Size=0x8
    void  ( * OidRequestCompleteHandler)(void * ,struct _NDIS_OID_REQUEST * ,int );// Offset=0x310 Size=0x8
    struct _NDIS_OPEN_OFFLOAD * Offload;// Offset=0x318 Size=0x8
    struct _NDIS_STATUS_UNBIND_WORKITEM * StatusUnbindWorkItem;// Offset=0x320 Size=0x8
    unsigned long long DpcStartCycle;// Offset=0x328 Size=0x8
    struct PNDIS_PER_PROCESSOR_SLOT__ * ReceivedAPacketSlot;// Offset=0x330 Size=0x8
    int  ( * DirectOidRequestHandler)(void * ,struct _NDIS_OID_REQUEST * );// Offset=0x338 Size=0x8
    struct _LIST_ENTRY ReceiveQueueList;// Offset=0x340 Size=0x10
    unsigned long NumReceiveQueues;// Offset=0x350 Size=0x4
    struct _LIST_ENTRY SharedMemoryBlockList;// Offset=0x358 Size=0x10
    int  ( * AllocateSharedMemoryHandler)(void * ,struct _NDIS_SHARED_MEMORY_PARAMETERS * ,void ** );// Offset=0x368 Size=0x8
    void  ( * FreeSharedMemoryHandler)(void * ,void * );// Offset=0x370 Size=0x8
    void * AllocateSharedMemoryContext;// Offset=0x378 Size=0x8
    unsigned long NumAllocatedVFs;// Offset=0x380 Size=0x4
    struct _LIST_ENTRY VFList;// Offset=0x388 Size=0x10
    unsigned long NumActiveVPorts;// Offset=0x398 Size=0x4
    struct _LIST_ENTRY VPortList;// Offset=0x3a0 Size=0x10
    unsigned long AoAcReferences;// Offset=0x3b0 Size=0x4
    struct NDIS_BIND_PROTOCOL_LINK * Bind;// Offset=0x3b8 Size=0x8
    struct _WORK_QUEUE_ITEM UnsolicitedUnbindComplete;// Offset=0x3c0 Size=0x20
    struct _KEVENT * UnsolicitedUnbindEvent;// Offset=0x3e0 Size=0x8
    bool PendingLegacyUnbind;// Offset=0x3e8 Size=0x1
    struct _KEVENT * WaitNetPnpEvent;// Offset=0x3f0 Size=0x8
