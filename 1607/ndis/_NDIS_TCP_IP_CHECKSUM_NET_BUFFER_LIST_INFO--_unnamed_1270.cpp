union _NDIS_TCP_IP_CHECKSUM_NET_BUFFER_LIST_INFO::_unnamed_1270// Size=0x8 (Id=1270)
{
    struct <unnamed-type-Transmit>// Size=0x4 (Id=10169)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_NET_BUFFER_LIST_INFO::_unnamed_1271::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x4
    struct <unnamed-type-Receive>// Size=0x4 (Id=10178)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_NET_BUFFER_LIST_INFO::_unnamed_1272::<unnamed-type-Receive> Receive;// Offset=0x0 Size=0x4
