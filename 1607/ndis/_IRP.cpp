...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=72)
{
    union // Size=0x4 (Id=0)
    {
...
struct _IRP// Size=0xd0 (Id=79)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=4007)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=4024)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=4025)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=4036)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=4037)
            {
