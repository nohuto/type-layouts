...
struct _NDIS_SS_STOP_FLAGS// Size=0x4 (Id=1011)
{
    union // Size=0x4 (Id=0)
    {
...
struct _NDIS_AOAC_COMPONENT_REF_TIME// Size=0x10 (Id=1641)
{
    unsigned long long TotalRefTime;// Offset=0x0 Size=0x8
    unsigned long long CurrentRefStartTime;// Offset=0x8 Size=0x8
};

struct _NDIS_MINIPORT_CS_TRAFFIC_STATS// Size=0x30 (Id=923)
{
...
struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS// Size=0x2c (Id=1097)
{
...
struct _NDIS_MINIPORT_AOAC// Size=0x3e0 (Id=770)
{
    ...
    struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS CsSpuriousWakeStats;// Offset=0x3b0 Size=0x2c
