...
struct _HEAP_LFH_SUBSEGMENT_OWNER// Size=0x38 (Id=222)
{
...
struct _HEAP_LFH_BUCKET// Size=0x70 (Id=224)
{
    ...
    unsigned long ContentionCount;// Offset=0x58 Size=0x4
    unsigned char * ProcAffinityMapping;// Offset=0x60 Size=0x8
    struct _HEAP_LFH_AFFINITY_SLOT ** AffinitySlots;// Offset=0x68 Size=0x8
};
