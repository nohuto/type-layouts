struct _unnamed_352// Size=0x4 (Id=352)
{
...
union _MM_PAGE_ACCESS_INFO_FLAGS// Size=0x4 (Id=354)
{
    struct _unnamed_352 File;// Offset=0x0 Size=0x4
    struct _unnamed_353 Private;// Offset=0x0 Size=0x4
};

struct _MM_PAGE_ACCESS_INFO// Size=0x8 (Id=349)
{
    union // Size=0x8 (Id=0)
    {
