struct _RTL_CRITICAL_SECTION// Size=0x28 (Id=196)
{
...
union _unnamed_194// Size=0x28 (Id=194)
{
    struct _RTL_CRITICAL_SECTION CriticalSection;// Offset=0x0 Size=0x28
};

struct _HEAP_LOCK// Size=0x28 (Id=195)
{
    union _unnamed_194 Lock;// Offset=0x0 Size=0x28
};
