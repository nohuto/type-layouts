...
union _MCI_STATS// Size=0x8 (Id=601)
{
    struct _unnamed_600 MciStatus;// Offset=0x0 Size=0x8
    unsigned long long QuadPart;// Offset=0x0 Size=0x8
};

union _MCI_ADDR// Size=0x8 (Id=590)
{
...
struct _unnamed_522// Size=0x20 (Id=522)
{
...
union _unnamed_524// Size=0x20 (Id=524)
{
    union // Size=0x20 (Id=0)
    {
        struct _unnamed_522 Mca;// Offset=0x0 Size=0x20
        struct _unnamed_523 Mce;// Offset=0x0 Size=0x10
    };
};

struct _MCA_EXCEPTION// Size=0x100 (Id=525)
{
    ...
    union _unnamed_524 u;// Offset=0x18 Size=0x20
