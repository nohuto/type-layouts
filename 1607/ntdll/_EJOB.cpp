...
struct _KWAIT_CHAIN// Size=0x8 (Id=502)
{
    struct _SINGLE_LIST_ENTRY Head;// Offset=0x0 Size=0x8
};

struct _OWNER_ENTRY// Size=0x10 (Id=447)
{
...
struct _ERESOURCE// Size=0x68 (Id=378)
{
...
struct _PROCESS_DISK_COUNTERS// Size=0x28 (Id=272)
{
...
struct _WNF_STATE_NAME// Size=0x8 (Id=510)
{
    unsigned long Data[2];// Offset=0x0 Size=0x8
};

struct _PS_WAKE_INFORMATION// Size=0x38 (Id=392)
{
...
struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=331)
{
...
struct _EPROCESS_VALUES// Size=0x58 (Id=285)
{
...
struct _JOB_RATE_CONTROL_HEADER// Size=0x28 (Id=294)
{
...
struct _PS_IO_CONTROL_ENTRY// Size=0x38 (Id=359)
{
...
struct _EJOB// Size=0x608 (Id=166)
{
