...
struct _SLIST_ENTRY// Size=0x10 (Id=68)
{
    struct _SLIST_ENTRY * Next;// Offset=0x0 Size=0x8
};

union _HEAP_LFH_SUBSEGMENT_DELAY_FREE// Size=0x8 (Id=461)
{
...
struct _HEAP_LFH_SUBSEGMENT_ENCODED_OFFSETS// Size=0x4 (Id=226)
{
    union // Size=0x4 (Id=0)
    {
...
struct _HEAP_LFH_SUBSEGMENT// Size=0x40 (Id=227)
{
