...
struct _unnamed_561// Size=0x8 (Id=561)
{
...
struct _unnamed_567// Size=0x18 (Id=567)
{
...
struct _unnamed_568// Size=0x18 (Id=568)
{
...
union _unnamed_570// Size=0x18 (Id=570)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_558 Port;// Offset=0x0 Size=0x18
        struct _unnamed_558 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_560 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_561 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_562 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_558 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_563 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_564 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_565 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_566 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_567 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_568 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_569 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=571)
{
    ...
    union _unnamed_570 u;// Offset=0x8 Size=0x18
};
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=401)
{
