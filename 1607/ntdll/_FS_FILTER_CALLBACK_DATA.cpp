struct _unnamed_626// Size=0x10 (Id=626)
{
...
struct _unnamed_631// Size=0x10 (Id=631)
{
...
struct _unnamed_632// Size=0x28 (Id=632)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=633)
{
    struct _unnamed_626 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_627 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_629 AcquireForSectionSynchronization;// Offset=0x0 Size=0x10
    struct _unnamed_631 NotifyStreamFileObject;// Offset=0x0 Size=0x10
    struct _unnamed_632 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=610)
{
