struct _RTL_SRWLOCK// Size=0x8 (Id=230)
{
    union // Size=0x8 (Id=0)
    {
...
union _RTL_RUN_ONCE// Size=0x8 (Id=305)
{
    void * Ptr;// Offset=0x0 Size=0x8
    unsigned long long Value;// Offset=0x0 Size=0x8
    struct // Size=0x8 (Id=0)
...
struct _HEAP_VS_CONTEXT// Size=0x68 (Id=231)
{
...
struct _HEAP_LFH_SUBSEGMENT_CACHE// Size=0x70 (Id=537)
{
    union _SLIST_HEADER SLists[7];// Offset=0x0 Size=0x70
};

struct _HEAP_LFH_CONTEXT// Size=0x4d0 (Id=223)
{
...
struct _SEGMENT_HEAP// Size=0x5f0 (Id=238)
{
    ...
    union _RTL_RUN_ONCE StackTraceInitVar;// Offset=0x88 Size=0x8
    struct _RTL_SRWLOCK ContextExtendLock;// Offset=0x90 Size=0x8
    unsigned char * AllocatedBase;// Offset=0x98 Size=0x8
    unsigned char * UncommittedBase;// Offset=0xa0 Size=0x8
    unsigned char * ReservedLimit;// Offset=0xa8 Size=0x8
    struct _HEAP_VS_CONTEXT VsContext;// Offset=0xb0 Size=0x68
    struct _HEAP_LFH_CONTEXT LfhContext;// Offset=0x120 Size=0x4d0
};
