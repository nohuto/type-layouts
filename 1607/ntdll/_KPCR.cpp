struct _NT_TIB// Size=0x38 (Id=420)
{
...
struct _KSPECIAL_REGISTERS// Size=0xe0 (Id=543)
{
...
struct _XSAVE_FORMAT// Size=0x200 (Id=528)
{
...
struct _CONTEXT// Size=0x4d0 (Id=465)
{
...
struct _KPROCESSOR_STATE// Size=0x5b0 (Id=393)
{
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=333)
{
...
struct _KTIMER_TABLE_ENTRY// Size=0x20 (Id=579)
{
...
struct _KTIMER_TABLE// Size=0x2200 (Id=535)
{
...
struct _KGATE// Size=0x18 (Id=357)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=491)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=471)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=475)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=550)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROCESSOR_POWER_STATE// Size=0x1d0 (Id=451)
{
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=382)
{
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=484)
{
...
struct _IOP_IRP_STACK_PROFILER// Size=0x54 (Id=463)
{
    unsigned long Profile[20];// Offset=0x0 Size=0x50
    unsigned long TotalIrps;// Offset=0x50 Size=0x4
};

struct _KSHARED_READY_QUEUE// Size=0x260 (Id=419)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
