union _unnamed_104// Size=0x8 (Id=104)
{
...
union _unnamed_106// Size=0x10 (Id=106)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_105 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=395)
{
...
struct _unnamed_107// Size=0x58 (Id=107)
{
...
union _unnamed_108// Size=0x58 (Id=108)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_107 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=109)
{
    ...
    union _unnamed_104 AssociatedIrp;// Offset=0x18 Size=0x8
