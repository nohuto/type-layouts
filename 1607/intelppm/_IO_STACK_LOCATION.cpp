...
struct _unnamed_78// Size=0x18 (Id=78)
{
...
struct _unnamed_101// Size=0x1 (Id=101)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _unnamed_103// Size=0x4 (Id=103)
{
...
struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=435)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=411)
{
...
union _unnamed_117// Size=0x20 (Id=117)
{
    struct _unnamed_75 Create;// Offset=0x0 Size=0x20
    struct _unnamed_76 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_77 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_78 Read;// Offset=0x0 Size=0x18
    struct _unnamed_78 Write;// Offset=0x0 Size=0x18
    struct _unnamed_80 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_81 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_82 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_83 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_85 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_86 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_87 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_88 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_89 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_90 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_91 MountVolume;// Offset=0x0 Size=0x10
    struct _unnamed_91 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_93 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_95 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_97 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_98 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_99 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_100 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_101 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_103 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_105 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_107 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_109 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_110 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_113 Power;// Offset=0x0 Size=0x20
    struct _unnamed_114 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_115 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_116 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=118)
{
    ...
    union _unnamed_117 Parameters;// Offset=0x8 Size=0x20
