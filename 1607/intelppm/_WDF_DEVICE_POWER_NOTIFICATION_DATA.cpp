...
struct _unnamed_379// Size=0x4 (Id=379)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_380// Size=0x8 (Id=380)
{
    struct _unnamed_378 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_379 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_378 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=230)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_380 Data;// Offset=0x4 Size=0x8
};
