union _WHEA_ARM_PROCESSOR_ERROR_INFORMATION_VALID_BITS// Size=0x2 (Id=2539)
{
    struct // Size=0x2 (Id=0)
    {
        ...
        unsigned short PhysicalFaultAddresss:1;// Offset=0x0 Size=0x2 BitOffset=0x4 BitSize=0x1
        unsigned short Reserved:11;// Offset=0x0 Size=0x2 BitOffset=0x5 BitSize=0xb
    };
    unsigned short AsUSHORT;// Offset=0x0 Size=0x2
};

struct _WHEA_ARM_PROCESSOR_ERROR_INFORMATION// Size=0x20 (Id=2704)
{
    ...
    unsigned long long PhysicalFaultAddresss;// Offset=0x18 Size=0x8
};
