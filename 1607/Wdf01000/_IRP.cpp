...
struct _IRP// Size=0xd0 (Id=831)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=9310)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=9327)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=9328)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=9339)
        {
            struct <unnamed-type-Overlay>// Size=0x50 (Id=9340)
            {
