...
struct _WDF_IO_FORWARD_PROGRESS_RESERVED_POLICY_SETTINGS// Size=0x8 (Id=793)
{
    union // Size=0x8 (Id=0)
    {
        union <unnamed-type-Policy>// Size=0x8 (Id=18202)
        {
            struct <unnamed-type-ExaminePolicy>// Size=0x8 (Id=18203)
            {
...
struct _WDF_IO_QUEUE_FORWARD_PROGRESS_POLICY_V1_15// Size=0x28 (Id=2319)
{
