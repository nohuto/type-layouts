...
struct _WDF_DRIVER_GLOBALS// Size=0x38 (Id=1227)
{
...
struct _FX_DRIVER_GLOBALS// Size=0x1e0 (Id=818)
{
    unsigned long AddRef(void * ,long ,char * );
    union // Size=0x2ad (Id=0)
    {
        unsigned long Release(void * ,long ,char * );// Offset=0x0 Size=0x2a
        ...
        unsigned char IsCorrectVersionRegistered(struct _UNICODE_STRING * );// Offset=0x0 Size=0x274
        void RegisterClientVersion(struct _UNICODE_STRING * );// Offset=0x0 Size=0x2ad
        ...
        void WaitForSignal(class MxEvent * ,char * ,void * ,unsigned long ,unsigned long );// Offset=0x0 Size=0x7a
        ...
        unsigned char FxRequestParentOptimizationOn;// Offset=0x145 Size=0x1
        unsigned char FxDsfOn;// Offset=0x146 Size=0x1
        unsigned char FxForceLogsInMiniDump;// Offset=0x147 Size=0x1
        unsigned char FxTrackDriverForMiniDumpLog;// Offset=0x148 Size=0x1
        unsigned char IsUserModeDriver;// Offset=0x149 Size=0x1
        unsigned long RemoveLockOptionFlags;// Offset=0x14c Size=0x4
        unsigned long BugCheckDriverInfoIndex;// Offset=0x150 Size=0x4
        struct _KBUGCHECK_REASON_CALLBACK_RECORD BugCheckCallbackRecord;// Offset=0x158 Size=0x30
        long WdfLogHeaderRefCount;// Offset=0x188 Size=0x4
        unsigned long FxEnhancedVerifierOptions;// Offset=0x18c Size=0x4
        unsigned long FxVerifierDbgWaitForSignalTimeoutInSec;// Offset=0x190 Size=0x4
        unsigned long DbgWaitForWakeInterruptIsrTimeoutInSec;// Offset=0x194 Size=0x4
        struct _FX_TELEMETRY_CONTEXT * TelemetryContext;// Offset=0x198 Size=0x8
        struct _WDF_DRIVER_GLOBALS Public;// Offset=0x1a0 Size=0x38
