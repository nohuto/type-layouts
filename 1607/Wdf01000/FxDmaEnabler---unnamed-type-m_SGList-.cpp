...
union _SLIST_HEADER// Size=0x10 (Id=133)
{
    unsigned long long Alignment;// Offset=0x0 Size=0x8
    unsigned long long Region;// Offset=0x8 Size=0x8
    struct _unnamed_132 HeaderX64;// Offset=0x0 Size=0x10
};

struct _SINGLE_LIST_ENTRY// Size=0x8 (Id=131)
{
...
struct _GENERAL_LOOKASIDE// Size=0x80 (Id=104)
{
...
struct _NPAGED_LOOKASIDE_LIST// Size=0x80 (Id=152)
{
    struct _GENERAL_LOOKASIDE L;// Offset=0x0 Size=0x80
};

union FxDmaEnabler::<unnamed-type-m_SGList>// Size=0x80 (Id=1194)
{
    union // Size=0x80 (Id=0)
    {
        struct <unnamed-type-ScatterGatherProfile>// Size=0x80 (Id=31886)
        {
        ...
        struct <unnamed-type-SystemProfile>// Size=0x8 (Id=31889)
        {
