...
struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_13// Size=0x20 (Id=3563)
{
    union // Size=0x8 (Id=0)
    {
        long UsbdStatus;// Offset=0x0 Size=0x4
        enum _WDF_USB_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
        union <unnamed-type-Parameters>// Size=0x18 (Id=21524)
        {
            struct <unnamed-type-DeviceString>// Size=0x10 (Id=21525)
            {
            ...
            struct <unnamed-type-DeviceControlTransfer>// Size=0x18 (Id=21531)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            ...
            struct <unnamed-type-DeviceUrb>// Size=0x8 (Id=21536)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            };
            ...
            struct <unnamed-type-PipeWrite>// Size=0x18 (Id=21539)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            ...
            struct <unnamed-type-PipeRead>// Size=0x18 (Id=21544)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
                unsigned long long Length;// Offset=0x8 Size=0x8
                unsigned long long Offset;// Offset=0x10 Size=0x8
            ...
            struct <unnamed-type-PipeUrb>// Size=0x8 (Id=21549)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            };
