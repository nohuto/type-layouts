struct FxRequestBuffer// Size=0x20 (Id=317)
{
    union // Size=0xc4 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x18 (Id=64722)
        {
            struct <unnamed-type-Memory>// Size=0x10 (Id=64723)
            {
