struct _IMAGE_LOAD_CONFIG_CODE_INTEGRITY// Size=0xc (Id=4449)
{
...
struct _IMAGE_LOAD_CONFIG_DIRECTORY64// Size=0xd0 (Id=4448)
{
    ...
    unsigned long long HybridMetadataPointer;// Offset=0xc8 Size=0x8
};
