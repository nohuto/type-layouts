struct _SID_IDENTIFIER_AUTHORITY// Size=0x6 (Id=4411)
{
    unsigned char Value[6];// Offset=0x0 Size=0x6
};

struct _SID// Size=0xc (Id=4412)
{
...
struct _FILE_GET_QUOTA_INFORMATION// Size=0x14 (Id=4415)
{
    unsigned long NextEntryOffset;// Offset=0x0 Size=0x4
    unsigned long SidLength;// Offset=0x4 Size=0x4
    struct _SID Sid;// Offset=0x8 Size=0xc
};
