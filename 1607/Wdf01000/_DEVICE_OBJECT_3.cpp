...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=130)
{
...
struct _WAIT_CONTEXT_BLOCK// Size=0x48 (Id=163)
{
...
union _unnamed_181// Size=0x48 (Id=181)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
    struct _WAIT_CONTEXT_BLOCK Wcb;// Offset=0x0 Size=0x48
};

struct _KDEVICE_QUEUE// Size=0x28 (Id=112)
{
...
struct _KEVENT// Size=0x18 (Id=111)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
};

struct _DEVICE_OBJECT// Size=0x150 (Id=729)
{
    union // Size=0x4d (Id=0)
    {
        ...
        union <unnamed-type-Queue>// Size=0x48 (Id=6270)
        {
            struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
            struct _WAIT_CONTEXT_BLOCK Wcb;// Offset=0x0 Size=0x48
        };
