union _BM_REQUEST_TYPE// Size=0x1 (Id=3686)
{
    struct _BM// Size=0x1 (Id=5400)
    {
...
struct _USB_DEFAULT_PIPE_SETUP_PACKET// Size=0x8 (Id=2334)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union _wIndex// Size=0x2 (Id=15182)
        {
            unsigned char LowByte;// Offset=0x0 Size=0x1
            unsigned char HiByte;// Offset=0x1 Size=0x1
            unsigned short W;// Offset=0x0 Size=0x2
