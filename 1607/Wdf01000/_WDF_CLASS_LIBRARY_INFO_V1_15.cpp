struct _WDF_CLASS_VERSION_V1_15// Size=0xc (Id=3764)
{
...
struct _WDF_CLASS_LIBRARY_INFO_V1_15// Size=0x30 (Id=3626)
{
    unsigned long Size;// Offset=0x0 Size=0x4
    struct _WDF_CLASS_VERSION_V1_15 Version;// Offset=0x4 Size=0xc
