...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=2149)
{
...
struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION// Size=0x20 (Id=3188)
{
    ...
    {
        struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION::_unnamed_3190::<unnamed-type-ProcessorCore> ProcessorCore;// Offset=0x10 Size=0x1
        struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION::_unnamed_3189::<unnamed-type-NumaNode> NumaNode;// Offset=0x10 Size=0x4
