...
struct _WDF_IO_QUEUE_CONFIG_V1_17// Size=0x60 (Id=1845)
{
    union // Size=0x50 (Id=0)
    {
        ...
        union <unnamed-type-Settings>// Size=0x4 (Id=18333)
        {
            struct <unnamed-type-Parallel>// Size=0x4 (Id=18334)
            {
                unsigned long NumberOfPresentedRequests;// Offset=0x0 Size=0x4
            };
            struct _WDF_IO_QUEUE_CONFIG_V1_17::<unnamed-type-Settings>::<unnamed-type-Parallel> Parallel;// Offset=0x0 Size=0x4
        };
        union _WDF_IO_QUEUE_CONFIG_V1_17::<unnamed-type-Settings> Settings;// Offset=0x50 Size=0x4
    };
