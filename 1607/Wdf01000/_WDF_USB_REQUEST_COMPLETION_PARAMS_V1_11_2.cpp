...
struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_11// Size=0x20 (Id=3767)
{
    union // Size=0x8 (Id=0)
    {
        long UsbdStatus;// Offset=0x0 Size=0x4
        enum _WDF_USB_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
        union <unnamed-type-Parameters>// Size=0x18 (Id=21493)
        {
            struct <unnamed-type-DeviceString>// Size=0x10 (Id=21494)
            {
            ...
            struct <unnamed-type-DeviceControlTransfer>// Size=0x18 (Id=21500)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            ...
            struct <unnamed-type-DeviceUrb>// Size=0x8 (Id=21505)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            };
            ...
            struct <unnamed-type-PipeWrite>// Size=0x18 (Id=21508)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            ...
            struct <unnamed-type-PipeRead>// Size=0x18 (Id=21513)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
                unsigned long long Length;// Offset=0x8 Size=0x8
                unsigned long long Offset;// Offset=0x10 Size=0x8
            ...
            struct <unnamed-type-PipeUrb>// Size=0x8 (Id=21518)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            };
