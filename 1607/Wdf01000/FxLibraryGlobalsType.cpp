struct _OSVERSIONINFOEXW// Size=0x11c (Id=614)
{
...
struct _KBUGCHECK_REASON_CALLBACK_RECORD// Size=0x30 (Id=705)
{
...
struct _FX_DRIVER_TRACKER_CACHE_AWARE// Size=0x18 (Id=1245)
{
    union // Size=0x14d (Id=0)
    {
        struct _FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=8190)
        {
        ...
        struct FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=8204)
        {
        };// Offset=0x0 Size=0x8
        long Initialize();
        void Uninitialize();
        long Register(struct _FX_DRIVER_GLOBALS * );// Offset=0x0 Size=0x14d
...
struct _WMI_WDF_NOTIFY_ROUTINES// Size=0x20 (Id=1007)
{
...
struct FxLibraryGlobalsType// Size=0x298 (Id=1264)
{
