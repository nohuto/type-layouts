...
struct _WDF_DMA_ENABLER_CONFIG_V1_17// Size=0x50 (Id=1761)
{
    ...
    unsigned long AddressWidthOverride;// Offset=0x40 Size=0x4
    unsigned long WdmDmaVersionOverride;// Offset=0x44 Size=0x4
