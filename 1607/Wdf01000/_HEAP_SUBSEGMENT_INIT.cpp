...
struct _HEAP_SUBSEGMENT_INIT// Size=0x44 (Id=3644)
{
    struct _SYSTEM_TRACE_HEADER Header;// Offset=0x0 Size=0x20
    void * HeapHandle;// Offset=0x20 Size=0x8
    void * SubSegment;// Offset=0x28 Size=0x8
    unsigned long long BlockSize;// Offset=0x30 Size=0x8
    unsigned long long BlockCount;// Offset=0x38 Size=0x8
    unsigned long AffinityIndex;// Offset=0x40 Size=0x4
};
