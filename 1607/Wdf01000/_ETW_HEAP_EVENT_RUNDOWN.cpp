...
struct _ETW_HEAP_EVENT_RUNDOWN_RANGE// Size=0x10 (Id=4065)
{
    void * Address;// Offset=0x0 Size=0x8
    unsigned long long Size;// Offset=0x8 Size=0x8
};

struct _ETW_HEAP_EVENT_RUNDOWN// Size=0x48 (Id=3082)
{
    ...
    struct _ETW_HEAP_EVENT_RUNDOWN_RANGE Ranges[1];// Offset=0x38 Size=0x10
};
