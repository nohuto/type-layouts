...
struct _WDF_IFR_OFFSET// Size=0x4 (Id=437)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=17894)
        {
            struct <unnamed-type-s>// Size=0x4 (Id=17895)
            {
...
struct _WDF_IFR_HEADER// Size=0x48 (Id=456)
{
