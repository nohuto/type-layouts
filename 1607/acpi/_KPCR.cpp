struct _NT_TIB// Size=0x38 (Id=342)
{
...
struct _KDESCRIPTOR// Size=0x10 (Id=556)
{
...
struct _KSPECIAL_REGISTERS// Size=0xe0 (Id=504)
{
...
struct _CONTEXT// Size=0x4d0 (Id=403)
{
...
struct _KPROCESSOR_STATE// Size=0x5b0 (Id=316)
{
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=261)
{
...
struct _KTIMER_TABLE_ENTRY// Size=0x20 (Id=561)
{
...
struct _KTIMER_TABLE// Size=0x2200 (Id=498)
{
...
struct _KGATE// Size=0x18 (Id=280)
{
...
struct _PROC_IDLE_POLICY// Size=0x6 (Id=540)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=442)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=410)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=414)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=515)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROCESSOR_POWER_STATE// Size=0x1d0 (Id=386)
{
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=305)
{
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=432)
{
...
struct _IOP_IRP_STACK_PROFILER// Size=0x54 (Id=402)
{
    unsigned long Profile[20];// Offset=0x0 Size=0x50
    unsigned long TotalIrps;// Offset=0x50 Size=0x4
};

struct _KSHARED_READY_QUEUE// Size=0x260 (Id=341)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _KPRCB// Size=0x7ec0 (Id=40)
{
    ...
    union // Size=0x1 (Id=0)
    {
        unsigned char BpbFeatures;// Offset=0x2d38 Size=0x1
        struct // Size=0x1 (Id=0)
        {
            unsigned char BpbClearOnIdle:1;// Offset=0x2d38 Size=0x1 BitOffset=0x0 BitSize=0x1
            unsigned char BpbEnabled:1;// Offset=0x2d38 Size=0x1 BitOffset=0x1 BitSize=0x1
            unsigned char BpbSmep:1;// Offset=0x2d38 Size=0x1 BitOffset=0x2 BitSize=0x1
            unsigned char BpbFeaturesReserved:5;// Offset=0x2d38 Size=0x1 BitOffset=0x3 BitSize=0x5
        };
    };
    union // Size=0x1 (Id=0)
    {
        unsigned char BpbState;// Offset=0x2d39 Size=0x1
        struct // Size=0x1 (Id=0)
        {
            unsigned char BpbCpuIdle:1;// Offset=0x2d39 Size=0x1 BitOffset=0x0 BitSize=0x1
            unsigned char BpbFlushRsbOnTrap:1;// Offset=0x2d39 Size=0x1 BitOffset=0x1 BitSize=0x1
            unsigned char BpbIbpbOnReturn:1;// Offset=0x2d39 Size=0x1 BitOffset=0x2 BitSize=0x1
            unsigned char BpbIbpbOnTrap:1;// Offset=0x2d39 Size=0x1 BitOffset=0x3 BitSize=0x1
            unsigned char BpbStateReserved:4;// Offset=0x2d39 Size=0x1 BitOffset=0x4 BitSize=0x4
        };
    };
    unsigned char BpbCurrentSpecCtrl;// Offset=0x2d3a Size=0x1
    unsigned char BpbKernelSpecCtrl;// Offset=0x2d3b Size=0x1
    unsigned char BpbNmiSpecCtrl;// Offset=0x2d3c Size=0x1
    unsigned char BpbUserSpecCtrl;// Offset=0x2d3d Size=0x1
    unsigned char BpbPad[2];// Offset=0x2d3e Size=0x2
