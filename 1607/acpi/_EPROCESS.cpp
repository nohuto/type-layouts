...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=243)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=299)
{
...
struct _EX_FAST_REF// Size=0x8 (Id=90)
{
    union // Size=0x8 (Id=0)
    {
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=383)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

union _unnamed_334// Size=0x8 (Id=334)
{
    void * InstancedWorkingSet;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=406)
{
    union // Size=0x2 (Id=0)
    {
...
struct _MMSUPPORT_INSTANCE// Size=0xc0 (Id=335)
{
...
struct _MMSUPPORT_FULL// Size=0x110 (Id=258)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=272)
{
    union // Size=0x1 (Id=0)
    {
...
struct _EPROCESS// Size=0x7c0 (Id=100)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long MemoryDisambiguationDisable:1;// Offset=0x6cc Size=0x4 BitOffset=0x19 BitSize=0x1
        };
    };
