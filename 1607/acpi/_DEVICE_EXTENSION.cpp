struct _unnamed_374// Size=0x8 (Id=374)
{
...
struct _FDO_DEVICE_EXTENSION// Size=0x80 (Id=574)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_573 UPm1Status;// Offset=0x38 Size=0x4
    };
    struct _KDPC InterruptDpc;// Offset=0x40 Size=0x40
};

struct _PCI_FILTER_EXTENSION// Size=0x14 (Id=572)
{
...
struct _FILTER_DEVICE_EXTENSION// Size=0x58 (Id=554)
{
    struct WORK_QUEUE_CONTEXT WorkContext;// Offset=0x0 Size=0x30
...
struct _PDO_DEVICE_EXTENSION// Size=0x30 (Id=571)
{
    struct WORK_QUEUE_CONTEXT WorkContext;// Offset=0x0 Size=0x30
};
...
struct _MODULE_DEVICE_EXTENSION// Size=0x38 (Id=513)
{
    struct EXTENSION_WORKER WorkQueue;// Offset=0x0 Size=0x18
...
struct _EC_DEVICE_EXTENSION// Size=0x20 (Id=478)
{
    struct EXTENSION_WORKER WorkQueue;// Offset=0x0 Size=0x18
...
struct _ACPI_DEVICE_INFORMATION// Size=0x28 (Id=444)
{
    union // Size=0x8 (Id=0)
    {
    ...
    union // Size=0x8 (Id=0)
    {
        ...
        struct _unnamed_443 ClassCode;// Offset=0x20 Size=0x8
    };
};
...
struct _unnamed_380// Size=0x8 (Id=380)
{
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned long long Prop_Unused:1;// Offset=0x0 Size=0x8 BitOffset=0x1f BitSize=0x1
...
struct _DEVICE_EXTENSION// Size=0x398 (Id=381)
{
    ...
    union // Size=0x140 (Id=0)
    {
        ...
        struct _PROCESSOR_DEVICE_EXTENSION Processor;// Offset=0xa0 Size=0x28
    ...
    union // Size=0x8 (Id=0)
    {
        unsigned long long AuxiliaryFlags;// Offset=0x390 Size=0x8
        struct _unnamed_380 AuxiliaryUFlags;// Offset=0x390 Size=0x8
    };
};
