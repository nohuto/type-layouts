...
struct _unnamed_113// Size=0x18 (Id=113)
{
...
struct _unnamed_117// Size=0x10 (Id=117)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_120// Size=0x4 (Id=120)
{
    unsigned long Length;// Offset=0x0 Size=0x4
};
...
struct _unnamed_138// Size=0x1 (Id=138)
{
...
struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=311)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=287)
{
...
union _unnamed_154// Size=0x20 (Id=154)
{
    struct _unnamed_110 Create;// Offset=0x0 Size=0x20
    struct _unnamed_111 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_112 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_113 Read;// Offset=0x0 Size=0x18
    struct _unnamed_113 Write;// Offset=0x0 Size=0x18
    struct _unnamed_115 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_116 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_117 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_118 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_119 QueryEa;// Offset=0x0 Size=0x20
    struct _unnamed_120 SetEa;// Offset=0x0 Size=0x4
    struct _unnamed_122 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_122 SetVolume;// Offset=0x0 Size=0x10
    struct _unnamed_123 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_124 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_125 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_126 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_127 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_128 MountVolume;// Offset=0x0 Size=0x10
    struct _unnamed_128 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_130 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_131 QueryQuota;// Offset=0x0 Size=0x20
    struct _unnamed_120 SetQuota;// Offset=0x0 Size=0x4
    struct _unnamed_133 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_134 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_135 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_136 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_137 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_138 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_140 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_142 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_144 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_146 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_147 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_150 Power;// Offset=0x0 Size=0x20
    struct _unnamed_151 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_152 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_153 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=155)
{
    ...
    union _unnamed_154 Parameters;// Offset=0x8 Size=0x20
