...
struct _KWAIT_CHAIN// Size=0x8 (Id=459)
{
    struct _SINGLE_LIST_ENTRY Head;// Offset=0x0 Size=0x8
};

struct _OWNER_ENTRY// Size=0x10 (Id=382)
{
...
struct _ERESOURCE// Size=0x68 (Id=302)
{
...
struct _PROCESS_DISK_COUNTERS// Size=0x28 (Id=207)
{
...
struct _WNF_STATE_NAME// Size=0x8 (Id=470)
{
    unsigned long Data[2];// Offset=0x0 Size=0x8
};

struct _PS_WAKE_INFORMATION// Size=0x38 (Id=315)
{
...
struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=259)
{
...
struct _EPROCESS_VALUES// Size=0x58 (Id=219)
{
...
struct _JOB_RATE_CONTROL_HEADER// Size=0x28 (Id=224)
{
...
struct _PS_IO_CONTROL_ENTRY// Size=0x38 (Id=282)
{
