...
struct _unnamed_526// Size=0x18 (Id=526)
{
...
struct _unnamed_528// Size=0x18 (Id=528)
{
...
struct _unnamed_532// Size=0x10 (Id=532)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_534// Size=0x18 (Id=534)
{
...
struct _unnamed_535// Size=0x18 (Id=535)
{
...
union _unnamed_538// Size=0x18 (Id=538)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_526 Port;// Offset=0x0 Size=0x18
        struct _unnamed_526 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_528 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_529 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_530 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_526 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_531 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_532 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_533 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_534 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_535 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_536 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_537 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=539)
{
    ...
    union _unnamed_538 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=502)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=324)
{
