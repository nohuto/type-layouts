...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=360)
{
...
struct _KAPC_STATE// Size=0x30 (Id=317)
{
...
struct _KTIMER// Size=0x40 (Id=429)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=336)
{
...
struct _KLOCK_ENTRY_LOCK_STATE// Size=0x10 (Id=371)
{
    union // Size=0x8 (Id=0)
    {
...
struct _KLOCK_ENTRY// Size=0x60 (Id=201)
{
...
struct _CLIENT_ID// Size=0x10 (Id=206)
{
    void * UniqueProcess;// Offset=0x0 Size=0x8
    void * UniqueThread;// Offset=0x8 Size=0x8
};

struct _KSEMAPHORE// Size=0x20 (Id=309)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=357)
{
...
struct _PS_PROPERTY_SET// Size=0x18 (Id=231)
{
