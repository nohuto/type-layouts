...
struct _IRP// Size=0xd0 (Id=87)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=3435)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=3453)
        {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=3465)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=3466)
            {
