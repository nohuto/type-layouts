union _KGDTENTRY64// Size=0x10 (Id=324)
{
    unsigned short LimitLow;// Offset=0x0 Size=0x2
    unsigned short BaseLow;// Offset=0x2 Size=0x2
    union // Size=0x4 (Id=0)
    {
        struct _KGDTENTRY64::_anonymous_327::_anonymous_327::<unnamed-type-Bytes> Bytes;// Offset=0x4 Size=0x4
        struct _KGDTENTRY64::_anonymous_328::_anonymous_328::<unnamed-type-Bits> Bits;// Offset=0x4 Size=0x4
    };
