struct _SEGMENT_FLAGS// Size=0x4 (Id=1745)
{
    union // Size=0x2 (Id=0)
    {
        struct // Size=0x2 (Id=0)
        {
            ...
            unsigned short Spare0:1;// Offset=0x0 Size=0x2 BitOffset=0xa BitSize=0x1
            unsigned short SessionDriverProtos:1;// Offset=0x0 Size=0x2 BitOffset=0xb BitSize=0x1
    ...
    union // Size=0x1 (Id=0)
    {
        ...
        {
            unsigned char Spare:1;// Offset=0x2 Size=0x1 BitOffset=0x0 BitSize=0x1
...
union _anonymous_545// Size=0x8 (Id=545)
{
    union // Size=0x8 (Id=0)
    {
...
struct _SEGMENT// Size=0x48 (Id=547)
{
    ...
    union _anonymous_545 u1;// Offset=0x30 Size=0x8
    union _anonymous_546 u2;// Offset=0x38 Size=0x8
