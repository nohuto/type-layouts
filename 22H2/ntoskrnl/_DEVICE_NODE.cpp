...
struct _PO_DEVICE_NOTIFY// Size=0x68 (Id=1039)
{
...
union _anonymous_621// Size=0x8 (Id=621)
{
...
union _anonymous_622// Size=0x8 (Id=622)
{
    struct _DEVICE_NODE * NextResourceDeviceNode;// Offset=0x0 Size=0x8
};

struct _anonymous_624// Size=0x20 (Id=624)
{
...
struct _PO_DIRECTED_DRIPS_STATE// Size=0x38 (Id=1011)
{
...
struct _DEVICE_NODE// Size=0x310 (Id=626)
{
    ...
    union _anonymous_621 OverUsed1;// Offset=0x210 Size=0x8
    union _anonymous_622 OverUsed2;// Offset=0x218 Size=0x8
    ...
    struct _anonymous_624 DockInfo;// Offset=0x238 Size=0x20
