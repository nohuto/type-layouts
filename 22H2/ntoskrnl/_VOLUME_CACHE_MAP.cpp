...
struct _DIRTY_PAGE_STATISTICS// Size=0x18 (Id=977)
{
...
struct _DIRTY_PAGE_THRESHOLDS// Size=0x38 (Id=1086)
{
...
struct _LOG_HANDLE_CONTEXT// Size=0x98 (Id=719)
{
    void * LogHandle;// Offset=0x0 Size=0x8
    void  ( * FlushToLsnRoutine)(void * ,union _LARGE_INTEGER );// Offset=0x8 Size=0x8
    void  ( * QueryLogHandleInfoRoutine)(void * ,wchar_t * );// Offset=0x10 Size=0x8
...
struct _VOLUME_CACHE_MAP// Size=0xd0 (Id=702)
{
