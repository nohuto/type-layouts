struct _PPM_SELECTION_STATISTICS// Size=0x80 (Id=1735)
{
    ...
    struct _PPM_VETO_ACCOUNTING * PreVetoAccounting;// Offset=0x78 Size=0x8
};

struct _PROC_IDLE_STATE_BUCKET// Size=0x20 (Id=1937)
{
...
struct _PLATFORM_IDLE_STATE_ACCOUNTING// Size=0x3f0 (Id=1578)
{
    ...
    struct _PPM_SELECTION_STATISTICS SelectionStatistics;// Offset=0x30 Size=0x80
    struct _PROC_IDLE_STATE_BUCKET IdleTimeBuckets[26];// Offset=0xb0 Size=0x340
};

struct _PLATFORM_IDLE_ACCOUNTING// Size=0x408 (Id=905)
{
    ...
    struct _PLATFORM_IDLE_STATE_ACCOUNTING State[1];// Offset=0x18 Size=0x3f0
};
