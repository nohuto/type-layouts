...
struct _PROCESS_DISK_COUNTERS// Size=0x28 (Id=937)
{
...
struct _WNF_STATE_NAME// Size=0x8 (Id=518)
{
    unsigned long Data[2];// Offset=0x0 Size=0x8
};

struct _PS_JOB_WAKE_INFORMATION// Size=0x48 (Id=1497)
{
...
struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=1136)
{
...
struct _EPROCESS_VALUES// Size=0x68 (Id=978)
{
...
struct _JOB_RATE_CONTROL_HEADER// Size=0x28 (Id=1002)
{
...
struct _PS_IO_CONTROL_ENTRY// Size=0x38 (Id=1210)
{
...
union _JOBOBJECT_ENERGY_TRACKING_STATE// Size=0x8 (Id=968)
{
    unsigned long long Value;// Offset=0x0 Size=0x8
...
struct _EJOB// Size=0x640 (Id=451)
{
