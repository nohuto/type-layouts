...
struct _PO_HIBER_PERF// Size=0x1f8 (Id=2015)
{
...
struct PO_MEMORY_IMAGE// Size=0x3e0 (Id=1904)
{
    ...
    unsigned char Feature_HibernateRelaxVBSPolicy_Enabled;// Offset=0x3db Size=0x1
};
