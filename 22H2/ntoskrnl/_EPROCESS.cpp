...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=1052)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=1259)
{
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=1465)
{
...
struct _ALPC_PROCESS_CONTEXT// Size=0x20 (Id=1230)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=1188)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=436)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=1111)
{
...
struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=1159)
{
    struct _RTL_AVL_TREE Tree;// Offset=0x0 Size=0x8
    struct _EX_PUSH_LOCK Lock;// Offset=0x8 Size=0x8
};

struct _anonymous_439// Size=0x4 (Id=439)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _EPROCESS// Size=0xa40 (Id=440)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _anonymous_439 MitigationFlags3Values;// Offset=0xa30 Size=0x4
    };
};
