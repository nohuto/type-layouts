...
struct _anonymous_1806// Size=0xc (Id=1806)
{
...
union _anonymous_1807// Size=0xc (Id=1807)
{
    struct _anonymous_1806 Msi;// Offset=0x0 Size=0xc
};

struct _INTERRUPT_REMAPPING_INFO// Size=0x10 (Id=1808)
{
    ...
    union _anonymous_1807 u;// Offset=0x4 Size=0xc
};

struct _anonymous_1312// Size=0x8 (Id=1312)
{
...
struct _anonymous_1318// Size=0x4 (Id=1318)
{
    struct // Size=0x4 (Id=0)
    {
...
union _anonymous_1319// Size=0x4 (Id=1319)
{
    struct _anonymous_1318 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _anonymous_1320// Size=0x4 (Id=1320)
{
    struct // Size=0x4 (Id=0)
    {
...
union _anonymous_1321// Size=0x4 (Id=1321)
{
    struct _anonymous_1320 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_HT_INTR_INFO// Size=0x8 (Id=1322)
{
    union _anonymous_1319 LowPart;// Offset=0x0 Size=0x4
    union _anonymous_1321 HighPart;// Offset=0x4 Size=0x4
};

struct _anonymous_1314// Size=0x8 (Id=1314)
{
    struct _INTERRUPT_HT_INTR_INFO IntrInfo;// Offset=0x0 Size=0x8
};

struct _anonymous_1316// Size=0x4 (Id=1316)
{
    enum HAL_APIC_DESTINATION_MODE DestinationMode;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_VECTOR_DATA// Size=0x58 (Id=1317)
{
    ...
    struct _anonymous_1312 ControllerInput;// Offset=0x38 Size=0x8
    unsigned long long HvDeviceId;// Offset=0x40 Size=0x8
    union // Size=0x58 (Id=0)
    {
        struct _anonymous_1313 XapicMessage;// Offset=0x48 Size=0x10
        struct _anonymous_1314 Hypertransport;// Offset=0x48 Size=0x8
        struct _anonymous_1313 GenericMessage;// Offset=0x48 Size=0x10
        struct _anonymous_1316 MessageRequest;// Offset=0x48 Size=0x4
    };
};

struct _INTERRUPT_CONNECTION_DATA// Size=0x60 (Id=1805)
{
