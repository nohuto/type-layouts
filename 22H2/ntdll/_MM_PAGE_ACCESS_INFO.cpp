struct _anonymous_422// Size=0x4 (Id=422)
{
...
struct _anonymous_423// Size=0x4 (Id=423)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long FilePointerIndex:9;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x9
...
union _MM_PAGE_ACCESS_INFO_FLAGS// Size=0x4 (Id=424)
{
    struct _anonymous_422 File;// Offset=0x0 Size=0x4
    struct _anonymous_423 Private;// Offset=0x0 Size=0x4
};

struct _MM_PAGE_ACCESS_INFO// Size=0x8 (Id=419)
{
    union // Size=0x8 (Id=0)
    {
