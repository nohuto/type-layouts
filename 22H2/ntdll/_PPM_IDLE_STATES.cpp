...
struct _PPM_SELECTION_MENU// Size=0x10 (Id=718)
{
    unsigned long Count;// Offset=0x0 Size=0x4
    struct _PPM_SELECTION_MENU_ENTRY * Entries;// Offset=0x8 Size=0x8
};

struct _PPM_COORDINATED_SELECTION// Size=0x18 (Id=735)
{
...
struct _PPM_VETO_ACCOUNTING// Size=0x28 (Id=740)
{
...
struct _PPM_IDLE_STATE// Size=0xf8 (Id=705)
{
...
struct _PPM_IDLE_STATES// Size=0x428 (Id=665)
{
