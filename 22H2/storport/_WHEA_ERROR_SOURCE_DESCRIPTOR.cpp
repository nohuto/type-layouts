...
union _XPF_MC_BANK_FLAGS// Size=0x1 (Id=615)
{
...
struct _WHEA_XPF_MC_BANK_DESCRIPTOR// Size=0x1c (Id=588)
{
...
union _WHEA_NOTIFICATION_FLAGS// Size=0x2 (Id=652)
{
...
struct _WHEA_XPF_NMI_DESCRIPTOR// Size=0x3 (Id=591)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
};
...
struct _WHEA_ERROR_SOURCE_CONFIGURATION_DD// Size=0x18 (Id=567)
{
