union _anonymous_34// Size=0x8 (Id=34)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=561)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=229)
{
...
struct _anonymous_37// Size=0x50 (Id=37)
{
...
union _anonymous_38// Size=0x58 (Id=38)
{
    union // Size=0x58 (Id=0)
    {
        struct _anonymous_37 Overlay;// Offset=0x0 Size=0x50
...
struct _IRP// Size=0xd0 (Id=39)
{
    ...
    union _anonymous_34 AssociatedIrp;// Offset=0x18 Size=0x8
