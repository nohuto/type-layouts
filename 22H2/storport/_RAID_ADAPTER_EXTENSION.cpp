...
struct _anonymous_269// Size=0x8 (Id=269)
{
    ...
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned char PdcIdleResiliencyEngaged:1;// Offset=0x7 Size=0x1 BitOffset=0x0 BitSize=0x1
    };
};
...
struct _UNIT_CONTROL_LIST// Size=0x14 (Id=585)
{
...
struct _BUS_INTERFACE_STANDARD// Size=0x40 (Id=683)
{
...
struct _RAID_BUS_INTERFACE// Size=0x48 (Id=653)
{
...
struct _RAID_ADAPTER_PARAMETERS// Size=0x38 (Id=601)
{
...
union _RAID_REDIRECTION_SUPPORT// Size=0x2 (Id=578)
{
...
struct _PCI_HEADER_TYPE_1// Size=0x30 (Id=655)
{
...
struct _anonymous_676// Size=0x8 (Id=676)
{
    unsigned long Base;// Offset=0x0 Size=0x4
    unsigned long Limit;// Offset=0x4 Size=0x4
};

struct _PCI_HEADER_TYPE_2// Size=0x30 (Id=677)
{
    ...
    unsigned char SubordinateBus;// Offset=0xa Size=0x1
    unsigned char SecondaryLatency;// Offset=0xb Size=0x1
    struct _anonymous_676 Range[4];// Offset=0xc Size=0x20
    unsigned char InterruptLine;// Offset=0x2c Size=0x1
    unsigned char InterruptPin;// Offset=0x2d Size=0x1
    unsigned short BridgeControl;// Offset=0x2e Size=0x2
};
...
struct _STOR_POWER_SETTING_NOTIFICATION// Size=0x18 (Id=579)
{
...
struct _CRASHDUMP_FUNCTIONS_INTERFACE// Size=0x28 (Id=576)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
struct _RAID_ADAPTER_EXTENSION// Size=0x1740 (Id=278)
{
    ...
    struct _anonymous_269 Flags;// Offset=0x68 Size=0x8
    ...
    void * PdcIdleResiliencyEngagedHandle;// Offset=0x1718 Size=0x8
};
