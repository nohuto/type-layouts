...
struct _anonymous_661// Size=0x8 (Id=661)
{
...
struct _anonymous_663// Size=0x10 (Id=663)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_664// Size=0xc (Id=664)
{
...
struct _anonymous_667// Size=0x18 (Id=667)
{
...
union _anonymous_668// Size=0x18 (Id=668)
{
    union // Size=0x18 (Id=0)
    {
        struct _anonymous_658 Port;// Offset=0x0 Size=0x18
        struct _anonymous_658 Memory;// Offset=0x0 Size=0x18
        struct _anonymous_660 Interrupt;// Offset=0x0 Size=0x18
        struct _anonymous_661 Dma;// Offset=0x0 Size=0x8
        struct _anonymous_662 DmaV3;// Offset=0x0 Size=0x10
        struct _anonymous_658 Generic;// Offset=0x0 Size=0x18
        struct _anonymous_632 DevicePrivate;// Offset=0x0 Size=0xc
        struct _anonymous_663 BusNumber;// Offset=0x0 Size=0x10
        struct _anonymous_664 ConfigData;// Offset=0x0 Size=0xc
        struct _anonymous_665 Memory40;// Offset=0x0 Size=0x18
        struct _anonymous_666 Memory48;// Offset=0x0 Size=0x18
        struct _anonymous_667 Memory64;// Offset=0x0 Size=0x18
...
struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=669)
{
    ...
    union _anonymous_668 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=625)
{
