...
struct _NDIS_GFP_ETHERNET_HEADER_FIELDS// Size=0x14 (Id=799)
{
...
struct _NDIS_GFP_IPV4_SRC_AND_DEST_ADDRESS_WILDCARD_MATCH// Size=0x18 (Id=1125)
{
...
union _NDIS_GFP_IP_SRC_AND_DEST_ADDRESS_WILDCARD_MATCH// Size=0x30 (Id=1526)
{
...
struct _NDIS_GFP_TRANSPORT_PORT_WILDCARD_MATCH// Size=0x8 (Id=1080)
{
    enum _NDIS_GFP_WILDCARD_MATCH_TYPE MatchType;// Offset=0x0 Size=0x4
...
struct _NDIS_GFP_TRANSPORT_SRC_AND_DEST_PORT_WILDCARD_MATCH// Size=0x10 (Id=1640)
{
...
struct _NDIS_GFP_HEADER_GROUP_WILDCARD_MATCH// Size=0x78 (Id=1313)
{
    union // Size=0x5e (Id=0)
    {
        ...
        union <unnamed-type-TransportOrEncapsulation>// Size=0x14 (Id=6438)
        {
            struct <unnamed-type-UdpHeader>// Size=0x10 (Id=6439)
            {
            ...
            struct <unnamed-type-TcpHeader>// Size=0x14 (Id=6442)
            {
            ...
            struct <unnamed-type-IcmpHeader>// Size=0x2 (Id=6446)
            {
                unsigned char Type;// Offset=0x0 Size=0x1
            ...
            struct <unnamed-type-Encapsulation>// Size=0x8 (Id=6450)
            {
