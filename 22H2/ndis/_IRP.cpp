...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=80)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=1035)
{
...
struct _IRP// Size=0xd0 (Id=87)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=4430)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=4448)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=4449)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=4460)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=4461)
            {
