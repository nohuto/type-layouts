union _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_anonymous_1964// Size=0x4 (Id=1964)
{
    struct <unnamed-type-Transmit>// Size=0x4 (Id=10735)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_anonymous_1965::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x4
    struct <unnamed-type-Receive>// Size=0x4 (Id=10742)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_anonymous_1966::<unnamed-type-Receive> Receive;// Offset=0x0 Size=0x4
