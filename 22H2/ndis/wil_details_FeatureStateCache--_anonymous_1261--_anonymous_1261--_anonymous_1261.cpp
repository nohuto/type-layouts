struct wil_details_FeatureStateCache::_anonymous_1261::_anonymous_1261::_anonymous_1261// Size=0x4 (Id=1261)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned int isVariant:1;// Offset=0x0 Size=0x4 BitOffset=0xb BitSize=0x1
