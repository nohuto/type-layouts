struct _NDIS_PM_PACKET_PATTERN// Size=0x18 (Id=794)
{
...
struct _NDIS_PM_WOL_PATTERN// Size=0xc4 (Id=1568)
{
    union // Size=0x9c (Id=0)
    {
        ...
        union _WOL_PATTERN// Size=0x28 (Id=9700)
        {
            struct _IPV4_TCP_SYN_WOL_PACKET_PARAMETERS// Size=0x10 (Id=9701)
            {
            ...
            struct _IPV6_TCP_SYN_WOL_PACKET_PARAMETERS// Size=0x28 (Id=9708)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
            ...
            struct _EAPOL_REQUEST_ID_MESSAGE_WOL_PACKET_PARAMETERS// Size=0x4 (Id=9715)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
            };
            ...
            struct _WOL_BITMAP_PATTERN// Size=0x14 (Id=9718)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
...
union _NDIS_PACKET_PATTERN_ENTRY::_anonymous_1756// Size=0x100 (Id=1756)
{
