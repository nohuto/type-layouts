...
struct _anonymous_257// Size=0x18 (Id=257)
{
...
struct _anonymous_258// Size=0x20 (Id=258)
{
...
struct _anonymous_259// Size=0x20 (Id=259)
{
...
union _anonymous_260// Size=0x20 (Id=260)
{
    struct _anonymous_39 Create;// Offset=0x0 Size=0x20
    struct _anonymous_257 Read;// Offset=0x0 Size=0x18
    struct _anonymous_257 Write;// Offset=0x0 Size=0x18
    struct _anonymous_258 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _anonymous_259 Others;// Offset=0x0 Size=0x20
};

struct _WDF_REQUEST_PARAMETERS// Size=0x28 (Id=261)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned char MinorFunction;// Offset=0x2 Size=0x1
    enum _WDF_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    union _anonymous_260 Parameters;// Offset=0x8 Size=0x20
};
