...
struct _anonymous_300// Size=0x20 (Id=300)
{
...
union _anonymous_302// Size=0x20 (Id=302)
{
    ...
    struct _anonymous_300 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _anonymous_301 Others;// Offset=0x0 Size=0x20
};

struct _WDF_REQUEST_PARAMETERS// Size=0x28 (Id=303)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned char MinorFunction;// Offset=0x2 Size=0x1
    enum _WDF_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    union _anonymous_302 Parameters;// Offset=0x8 Size=0x20
};
