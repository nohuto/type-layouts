...
union _anonymous_649// Size=0x8 (Id=649)
{
    struct _anonymous_647 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_648 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_647 LeaveState;// Offset=0x0 Size=0x8
};
...
struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=245)
{
    ...
    union _anonymous_649 Data;// Offset=0x4 Size=0x8
};
