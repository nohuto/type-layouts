...
struct _anonymous_468// Size=0x8 (Id=468)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _anonymous_469// Size=0x4 (Id=469)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _anonymous_470// Size=0x8 (Id=470)
{
    struct _anonymous_468 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_469 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_468 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=471)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_470 Data;// Offset=0x4 Size=0x8
};
