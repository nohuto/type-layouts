union _anonymous_464// Size=0x4 (Id=464)
{
...
struct _USB_DEVICE_CAPABILITY_USB20_EXTENSION_DESCRIPTOR// Size=0x7 (Id=465)
{
    ...
    union _anonymous_464 bmAttributes;// Offset=0x3 Size=0x4
};
