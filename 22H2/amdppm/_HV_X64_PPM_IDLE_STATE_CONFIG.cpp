...
union _HV_X64_PPM_IDLE_STATE_CONFIG// Size=0x8 (Id=624)
{
    ...
    struct _anonymous_621 Hlt;// Offset=0x0 Size=0x8
    struct _anonymous_622 Io;// Offset=0x0 Size=0x8
    struct _anonymous_623 Mwait;// Offset=0x0 Size=0x8
};
