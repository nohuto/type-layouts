union _unnamed_73// Size=0x8 (Id=73)
{
...
union _unnamed_75// Size=0x10 (Id=75)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_74 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=466)
{
...
struct _unnamed_76// Size=0x58 (Id=76)
{
...
union _unnamed_77// Size=0x58 (Id=77)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_76 Overlay;// Offset=0x0 Size=0x58
...
struct _IRP// Size=0xd0 (Id=78)
{
    ...
    union _unnamed_73 AssociatedIrp;// Offset=0x18 Size=0x8
