...
struct _unnamed_571// Size=0x8 (Id=571)
{
...
union _HV_X64_PPM_IDLE_STATE_CONFIG// Size=0x8 (Id=573)
{
    ...
    struct _unnamed_570 Hlt;// Offset=0x0 Size=0x8
    struct _unnamed_571 Io;// Offset=0x0 Size=0x8
    struct _unnamed_572 Mwait;// Offset=0x0 Size=0x8
};
