...
struct _PPM_DRIVER_DISPATCH_TABLE// Size=0xf8 (Id=441)
{
    ...
    long  ( * ReadHiddenProcessorMsr)(unsigned long ,unsigned long ,unsigned long long * );// Offset=0xc8 Size=0x8
    long  ( * WriteHiddenProcessorMsr)(unsigned long ,unsigned long ,unsigned long long ,unsigned long long );// Offset=0xd0 Size=0x8
    long  ( * ReadHiddenProcessorIoPort)(unsigned long ,unsigned short ,unsigned short ,unsigned long * );// Offset=0xd8 Size=0x8
    long  ( * WriteHiddenProcessorIoPort)(unsigned long ,unsigned short ,unsigned short ,unsigned long ,unsigned long );// Offset=0xe0 Size=0x8
    unsigned long  ( * QueryPackageId)(unsigned long );// Offset=0xe8 Size=0x8
    unsigned long  ( * QueryPackageProcessorCount)(unsigned long );// Offset=0xf0 Size=0x8
};
...
struct _PCC_INTERFACE_INTERNAL// Size=0x58 (Id=498)
{
...
union _unnamed_527// Size=0x4 (Id=527)
{
...
struct _PCC_INTERFACE_STANDARD// Size=0x80 (Id=528)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
    ...
    union _unnamed_527 Flags;// Offset=0x54 Size=0x4
...
union _PROC_POWER_COORDINATES// Size=0x4 (Id=392)
{
...
struct _PROC_ENERGY_COUNTER// Size=0xc (Id=424)
{
    union // Size=0x4 (Id=0)
    {
...
struct _PROC_ENERGY_MODEL// Size=0x100 (Id=386)
{
...
struct GLOBALS// Size=0x7b8 (Id=361)
{
    ...
    struct _PROC_ENERGY_MODEL EnergyModels[2];// Offset=0x5a0 Size=0x200
    unsigned long EnergyEnabledProcessors;// Offset=0x7a0 Size=0x4
    long long QpcFrequency;// Offset=0x7a8 Size=0x8
    unsigned long long CycleCounterFrequency;// Offset=0x7b0 Size=0x8
};
