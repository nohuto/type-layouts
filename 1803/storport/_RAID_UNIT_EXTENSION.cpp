...
struct _STOR_ADDR_BTL8// Size=0x10 (Id=230)
{
...
struct _STOR_SCSI_IDENTITY// Size=0x38 (Id=198)
{
...
struct _QUEUE_TAG_LIST// Size=0x80 (Id=193)
{
...
struct _EXTENDED_DEVICE_QUEUE// Size=0xa8 (Id=211)
{
...
struct _IO_QUEUE// Size=0xc0 (Id=210)
{
...
struct _unnamed_251// Size=0x190 (Id=251)
{
...
struct _RAID_IO_RESOURCES// Size=0x20 (Id=255)
{
...
struct _RAID_UNIT_REGISTRY_PARAMETERS// Size=0x18 (Id=352)
{
...
struct _RAID_UNIT_ATTRIBUTES// Size=0x4 (Id=506)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _RAID_WORK_ITEM_CONTEXT// Size=0x10 (Id=409)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
    struct _IRP * Irp;// Offset=0x8 Size=0x8
};

struct _STOR_ASYNC_NOTIFY_CONTEXT// Size=0x18 (Id=368)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
...
union _unnamed_491// Size=0x4 (Id=491)
{
    unsigned long Quantity;// Offset=0x0 Size=0x4
    unsigned long Position;// Offset=0x0 Size=0x4
};

struct _RAID_TELEMETRY_ERROR_ENTRY// Size=0x28 (Id=492)
{
    ...
    union _unnamed_491 u;// Offset=0x20 Size=0x4
};

struct _RAID_TELEMETRY_SAMPLED_ERROR_LOG// Size=0x1c8 (Id=511)
{
...
struct _RAID_TELEMETRY_UNIQUE_ERROR_LOG// Size=0xc8 (Id=459)
{
    struct _RAID_TELEMETRY_ERROR_ENTRY UniqueErrors[5];// Offset=0x0 Size=0xc8
};

struct _RAID_UNIT_QOS// Size=0x30 (Id=585)
{
...
struct _RAID_UNIT_EXTENSION// Size=0xac0 (Id=254)
{
    ...
    struct _unnamed_248 Flags;// Offset=0x98 Size=0x8
    union _unnamed_249 InterlockedFlags;// Offset=0xa0 Size=0x4
    ...
    struct _unnamed_251 DeferredList;// Offset=0x410 Size=0x190
    ...
    struct _unnamed_253 PendingPowerUpContext;// Offset=0x678 Size=0x10
