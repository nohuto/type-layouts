...
struct _unnamed_592// Size=0x18 (Id=592)
{
...
struct _unnamed_597// Size=0x10 (Id=597)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_598// Size=0xc (Id=598)
{
...
struct _unnamed_601// Size=0x18 (Id=601)
{
...
union _unnamed_602// Size=0x18 (Id=602)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_592 Port;// Offset=0x0 Size=0x18
        struct _unnamed_592 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_594 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_595 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_596 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_592 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_567 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_597 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_598 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_599 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_600 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_601 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_573 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=603)
{
    ...
    union _unnamed_602 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=560)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=440)
{
