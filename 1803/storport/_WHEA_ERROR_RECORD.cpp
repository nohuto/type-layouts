...
union _WHEA_ERROR_RECORD_HEADER_VALIDBITS// Size=0x4 (Id=509)
{
...
union _WHEA_TIMESTAMP// Size=0x8 (Id=528)
{
...
union _WHEA_ERROR_RECORD_HEADER_FLAGS// Size=0x4 (Id=608)
{
    struct // Size=0x4 (Id=0)
    {
...
union _WHEA_PERSISTENCE_INFO// Size=0x8 (Id=535)
{
    struct // Size=0x8 (Id=0)
    {
...
union _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_VALIDBITS// Size=0x1 (Id=496)
{
...
union _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_FLAGS// Size=0x4 (Id=469)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR// Size=0x48 (Id=122)
{
