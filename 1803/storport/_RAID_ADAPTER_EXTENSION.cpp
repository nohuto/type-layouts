...
struct _STOR_LOCKED_LIST// Size=0x20 (Id=281)
{
...
struct _STOR_DICTIONARY// Size=0x30 (Id=191)
{
...
struct _RAID_POWER_STATE// Size=0x10 (Id=287)
{
...
struct _RAID_RESOURCE_LIST// Size=0x10 (Id=291)
{
...
struct _MEMORY_REGION// Size=0x18 (Id=470)
{
...
struct _PORT_CONFIGURATION_INFORMATION// Size=0xe0 (Id=279)
{
...
struct _unnamed_282// Size=0x1 (Id=282)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _RAID_MINIPORT// Size=0x128 (Id=283)
{
    ...
    struct _unnamed_282 Flags;// Offset=0xf8 Size=0x1
...
struct _BUS_INTERFACE_STANDARD// Size=0x40 (Id=617)
{
...
struct _RAID_BUS_INTERFACE// Size=0x48 (Id=587)
{
...
struct _RAID_DMA_ADAPTER// Size=0x20 (Id=219)
{
...
struct _RAID_MEMORY_REGION// Size=0x18 (Id=196)
{
    unsigned char * VirtualBase;// Offset=0x0 Size=0x8
    union _LARGE_INTEGER PhysicalBase;// Offset=0x8 Size=0x8
    unsigned long Length;// Offset=0x10 Size=0x4
...
struct _STOR_NOTIFICATION_INFO// Size=0x20 (Id=383)
{
...
struct _STOR_IO_GATEWAY// Size=0x140 (Id=231)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _RAID_DEFERRED_QUEUE// Size=0x80 (Id=212)
{
...
struct _RAID_DEFERRED_HEADER// Size=0x20 (Id=433)
{
...
struct _STOR_SCSI_ADDRESS// Size=0x4 (Id=197)
{
...
struct _unnamed_357// Size=0x20 (Id=357)
{
...
struct _unnamed_359// Size=0x4 (Id=359)
{
...
struct _RAID_DEFERRED_ELEMENT// Size=0x50 (Id=362)
{
    ...
    {
        struct _unnamed_356 Timer;// Offset=0x28 Size=0x10
        struct _unnamed_357 Error;// Offset=0x28 Size=0x20
        struct _unnamed_358 PauseDevice;// Offset=0x28 Size=0x4
        struct _unnamed_359 Busy;// Offset=0x28 Size=0x4
        struct _unnamed_359 DeviceBusy;// Offset=0x28 Size=0x4
        struct _unnamed_360 AdditionalTimer;// Offset=0x28 Size=0x18
        struct _unnamed_361 AsyncNotification;// Offset=0x28 Size=0x8
    };
};

struct _unnamed_237// Size=0x50 (Id=237)
{
    struct _RAID_DEFERRED_ELEMENT Timer;// Offset=0x0 Size=0x50
};

struct _unnamed_238// Size=0xb0 (Id=238)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=379)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KTIMER// Size=0x40 (Id=309)
{
...
struct _PORT_REGISTRY_INFO// Size=0x40 (Id=434)
{
...
struct _RAID_ADAPTER_PARAMETERS// Size=0x38 (Id=538)
{
...
struct _unnamed_240// Size=0x1 (Id=240)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _SCSI_POWER_REQUEST_BLOCK// Size=0x58 (Id=489)
{
    unsigned short Length;// Offset=0x0 Size=0x2
...
struct _STORAGE_REQUEST_BLOCK// Size=0x80 (Id=225)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    unsigned char Function;// Offset=0x2 Size=0x1
    unsigned char SrbStatus;// Offset=0x3 Size=0x1
...
struct _RAID_POWER_CONTEXT// Size=0xb8 (Id=401)
{
...
struct _STORPORT_EXTENDED_FUNCTIONS// Size=0x58 (Id=324)
{
...
union _RAID_REDIRECTION_SUPPORT// Size=0x2 (Id=516)
{
...
struct _PCI_HEADER_TYPE_0// Size=0x30 (Id=475)
{
...
struct _PCI_HEADER_TYPE_1// Size=0x30 (Id=589)
{
...
struct _unnamed_610// Size=0x8 (Id=610)
{
    unsigned long Base;// Offset=0x0 Size=0x4
    unsigned long Limit;// Offset=0x4 Size=0x4
};

struct _PCI_HEADER_TYPE_2// Size=0x30 (Id=611)
{
    ...
    unsigned char SubordinateBus;// Offset=0xa Size=0x1
    unsigned char SecondaryLatency;// Offset=0xb Size=0x1
    struct _unnamed_610 Range[4];// Offset=0xc Size=0x20
    unsigned char InterruptLine;// Offset=0x2c Size=0x1
    unsigned char InterruptPin;// Offset=0x2d Size=0x1
    unsigned short BridgeControl;// Offset=0x2e Size=0x2
};

union _unnamed_422// Size=0x30 (Id=422)
{
...
struct _PCI_COMMON_HEADER// Size=0x40 (Id=423)
{
    ...
    union _unnamed_422 u;// Offset=0x10 Size=0x30
};

struct _STOR_POWER_SETTING_NOTIFICATION// Size=0x18 (Id=517)
{
...
struct _CRASHDUMP_FUNCTIONS_INTERFACE// Size=0x28 (Id=515)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
struct _STOR_ADDRESS// Size=0x10 (Id=143)
{
...
struct _RAID_RPMB_CAPABILITIES// Size=0x38 (Id=370)
{
...
struct _RAID_CRYPTO_KEY_TABLE// Size=0x18 (Id=386)
{
...
struct _RAID_SHARED_WORK_ITEM_CONTEXT// Size=0x18 (Id=464)
{
...
struct _RAID_ADAPTER_EXTENSION// Size=0x16c0 (Id=242)
{
    ...
    struct _unnamed_233 Flags;// Offset=0x68 Size=0x7
    ...
    struct _unnamed_237 DeferredList;// Offset=0x4c0 Size=0x50
    struct _unnamed_238 DeferredPauseResumeContext;// Offset=0x510 Size=0xb0
    ...
    struct _unnamed_240 PerfOptFlags;// Offset=0x1163 Size=0x1
    ...
    struct _unnamed_241 TelemetryHierarchicalResetLunBucket[5];// Offset=0x145c Size=0x3c
    struct _unnamed_241 TelemetryHierarchicalResetTargetBucket[5];// Offset=0x1498 Size=0x3c
    ...
    unsigned long ZoneOutOfOrderWriteCount;// Offset=0x1670 Size=0x4
    unsigned long ZoneDeviceErrors;// Offset=0x1674 Size=0x4
    unsigned long ZoneWriteOverflowEntries;// Offset=0x1678 Size=0x4
    struct _RAID_SHARED_WORK_ITEM_CONTEXT IoResourceWorkItem;// Offset=0x1680 Size=0x18
};
