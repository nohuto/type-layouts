...
union _unnamed_556// Size=0x8 (Id=556)
{
    struct _unnamed_555 u;// Offset=0x0 Size=0x8
    unsigned long long asUlong64;// Offset=0x0 Size=0x8
};

struct _RAID_LOG_CONTROL// Size=0x10 (Id=554)
{
    unsigned long Revision;// Offset=0x0 Size=0x4
    union _unnamed_556 Enable;// Offset=0x8 Size=0x8
};
