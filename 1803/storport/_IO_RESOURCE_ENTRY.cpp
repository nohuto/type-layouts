...
struct _PROCESSOR_NUMBER// Size=0x4 (Id=147)
{
...
struct _STOR_EVENT_QUEUE_ENTRY// Size=0x38 (Id=216)
{
...
struct _unnamed_220// Size=0x28 (Id=220)
{
...
union _unnamed_221// Size=0x18 (Id=221)
{
...
struct _EXTENDED_REQUEST_BLOCK// Size=0x320 (Id=222)
{
    ...
    struct _unnamed_220 SrbData;// Offset=0xb0 Size=0x28
    ...
    union _unnamed_221 u;// Offset=0x298 Size=0x18
...
struct _IO_RESOURCE_ENTRY// Size=0x440 (Id=286)
{
    ...
    struct _EXTENDED_REQUEST_BLOCK Xrb;// Offset=0x20 Size=0x320
    unsigned char SenseInfoBuffer[256];// Offset=0x340 Size=0x100
