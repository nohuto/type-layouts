union _unnamed_658// Size=0x4 (Id=658)
{
...
struct _USB_DEVICE_CAPABILITY_POWER_DELIVERY_DESCRIPTOR// Size=0x12 (Id=659)
{
    ...
    union _unnamed_658 bmAttributes;// Offset=0x4 Size=0x4
