union _unnamed_556// Size=0x2 (Id=556)
{
...
struct _USB_DEVICE_CAPABILITY_PD_CONSUMER_PORT_DESCRIPTOR// Size=0x18 (Id=557)
{
    ...
    union _unnamed_556 bmCapabilities;// Offset=0x4 Size=0x2
