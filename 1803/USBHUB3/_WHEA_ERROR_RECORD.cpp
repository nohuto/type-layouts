union _WHEA_REVISION// Size=0x2 (Id=533)
{
...
union _WHEA_TIMESTAMP// Size=0x8 (Id=654)
{
...
union _WHEA_ERROR_RECORD_HEADER_FLAGS// Size=0x4 (Id=712)
{
    struct // Size=0x4 (Id=0)
    {
...
union _WHEA_PERSISTENCE_INFO// Size=0x8 (Id=672)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WHEA_ERROR_RECORD_HEADER// Size=0x80 (Id=576)
{
...
union _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_VALIDBITS// Size=0x1 (Id=608)
{
...
union _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_FLAGS// Size=0x4 (Id=585)
{
    struct // Size=0x4 (Id=0)
    {
