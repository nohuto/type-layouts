...
union _unnamed_275// Size=0x4 (Id=275)
{
    struct _unnamed_274 Parallel;// Offset=0x0 Size=0x4
};

struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=276)
{
    ...
    union _unnamed_275 Settings;// Offset=0x50 Size=0x4
