...
struct _unnamed_219// Size=0x18 (Id=219)
{
...
struct _unnamed_222// Size=0x18 (Id=222)
{
...
struct _unnamed_225// Size=0xc (Id=225)
{
...
struct _unnamed_230// Size=0x18 (Id=230)
{
...
union _unnamed_232// Size=0x18 (Id=232)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_219 Port;// Offset=0x0 Size=0x18
        struct _unnamed_219 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_222 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_223 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_224 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_219 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_225 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_226 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_227 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_228 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_229 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_230 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_231 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=233)
{
    ...
    union _unnamed_232 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=698)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=552)
{
