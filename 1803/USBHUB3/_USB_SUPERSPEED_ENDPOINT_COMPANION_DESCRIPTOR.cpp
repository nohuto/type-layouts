struct _unnamed_451// Size=0x1 (Id=451)
{
...
struct _unnamed_452// Size=0x1 (Id=452)
{
    struct // Size=0x1 (Id=0)
    {
...
union _unnamed_453// Size=0x1 (Id=453)
{
    ...
    struct _unnamed_451 Bulk;// Offset=0x0 Size=0x1
    struct _unnamed_452 Isochronous;// Offset=0x0 Size=0x1
};

struct _USB_SUPERSPEED_ENDPOINT_COMPANION_DESCRIPTOR// Size=0x6 (Id=454)
{
    ...
    union _unnamed_453 bmAttributes;// Offset=0x3 Size=0x1
