...
struct _unnamed_440// Size=0x8 (Id=440)
{
...
union _unnamed_442// Size=0x8 (Id=442)
{
    struct _unnamed_440 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_441 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_440 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=194)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_442 Data;// Offset=0x4 Size=0x8
};
