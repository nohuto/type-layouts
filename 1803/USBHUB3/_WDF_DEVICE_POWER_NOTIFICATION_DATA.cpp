...
struct _unnamed_466// Size=0x8 (Id=466)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_467// Size=0x4 (Id=467)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_468// Size=0x8 (Id=468)
{
    struct _unnamed_466 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_467 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_466 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=469)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_468 Data;// Offset=0x4 Size=0x8
};
