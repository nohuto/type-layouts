union _EINFO// Size=0x8 (Id=406)
{
    struct <unnamed-type-s>// Size=0x8 (Id=2359)
    {
...
union _UPPER_HANDLE_BITS// Size=0x2 (Id=290)
{
    struct <unnamed-type-s>// Size=0x2 (Id=5034)
    {
        unsigned char fullType;// Offset=0x0 Size=0x1
        union <unnamed-type-u>// Size=0x1 (Id=5036)
        {
...
struct _ENTRY// Size=0x18 (Id=278)
{
