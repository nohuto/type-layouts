...
struct _RTL_BALANCED_LINKS// Size=0x20 (Id=450)
{
...
struct _RTL_AVL_TABLE// Size=0x68 (Id=439)
{
...
struct _W32PROCESS// Size=0x128 (Id=131)
{
    ...
    {
        unsigned int GdiInitializeCalloutExecuted:1;// Offset=0x124 Size=0x4 BitOffset=0x0 BitSize=0x1
    };
};
