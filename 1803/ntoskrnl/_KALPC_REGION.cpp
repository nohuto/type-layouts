...
union _unnamed_461// Size=0x4 (Id=461)
{
    struct _unnamed_460 s1;// Offset=0x0 Size=0x4
};

struct _KALPC_REGION// Size=0x58 (Id=462)
{
    ...
    union _unnamed_461 u1;// Offset=0x30 Size=0x4
