...
struct _MMSUBSECTION_FLAGS// Size=0x4 (Id=1373)
{
...
struct _SUBSECTION// Size=0x38 (Id=700)
{
    ...
    union _unnamed_698 u;// Offset=0x20 Size=0x4
    ...
    union _unnamed_699 u1;// Offset=0x30 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _MSUBSECTION// Size=0x90 (Id=1520)
{
...
struct _MMSECTION_FLAGS// Size=0x4 (Id=555)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MMSECTION_FLAGS2// Size=0x4 (Id=746)
{
...
union _unnamed_241// Size=0x4 (Id=241)
{
    unsigned long LongFlags;// Offset=0x0 Size=0x4
    struct _MMSECTION_FLAGS2 Flags;// Offset=0x0 Size=0x4
};

struct _EX_FAST_REF// Size=0x8 (Id=95)
{
    union // Size=0x8 (Id=0)
    {
...
struct _unnamed_242// Size=0x10 (Id=242)
{
    union // Size=0x4 (Id=0)
    {
...
union _unnamed_243// Size=0x10 (Id=243)
{
    struct _unnamed_242 e2;// Offset=0x0 Size=0x10
};
...
struct _CONTROL_AREA// Size=0x80 (Id=245)
{
    ...
    union _unnamed_240 u;// Offset=0x38 Size=0x4
    union _unnamed_241 u1;// Offset=0x3c Size=0x4
...
struct _MI_SECTION_STATE// Size=0x280 (Id=886)
{
    ...
    unsigned char DanglingExtentsWorkerActive;// Offset=0x190 Size=0x1
    unsigned char PurgingExtentsNeedWatchdog;// Offset=0x191 Size=0x1
    struct _RTL_AVL_TREE PrototypePtesTree;// Offset=0x198 Size=0x8
    long PrototypePtesTreeSpinLock;// Offset=0x1a0 Size=0x4
    unsigned long ImageBias;// Offset=0x1a4 Size=0x4
    struct _EX_PUSH_LOCK RelocateBitmapsLock;// Offset=0x1a8 Size=0x8
    struct _RTL_BITMAP ImageBitMap;// Offset=0x1b0 Size=0x10
    unsigned long ImageBias64Low;// Offset=0x1c0 Size=0x4
    unsigned long ImageBias64High;// Offset=0x1c4 Size=0x4
    struct _RTL_BITMAP ImageBitMap64Low;// Offset=0x1c8 Size=0x10
    struct _RTL_BITMAP ImageBitMap64High;// Offset=0x1d8 Size=0x10
    struct _RTL_BITMAP ImageBitMapWow64Dll;// Offset=0x1e8 Size=0x10
    void * ApiSetSection;// Offset=0x1f8 Size=0x8
    void * ApiSetSchema;// Offset=0x200 Size=0x8
    unsigned long long ApiSetSchemaSize;// Offset=0x208 Size=0x8
    unsigned long LostDataFiles;// Offset=0x210 Size=0x4
    unsigned long LostDataPages;// Offset=0x214 Size=0x4
    unsigned long ImageFailureReason;// Offset=0x218 Size=0x4
    struct _SECTION * CfgBitMapSection32;// Offset=0x220 Size=0x8
    struct _CONTROL_AREA * CfgBitMapControlArea32;// Offset=0x228 Size=0x8
    struct _SECTION * CfgBitMapSection64;// Offset=0x230 Size=0x8
    struct _CONTROL_AREA * CfgBitMapControlArea64;// Offset=0x238 Size=0x8
    struct _RTL_BITMAP_EX KernelCfgBitMap;// Offset=0x240 Size=0x10
    struct _EX_PUSH_LOCK KernelCfgBitMapLock;// Offset=0x250 Size=0x8
    unsigned long ImageCfgFailure;// Offset=0x258 Size=0x4
    unsigned long ImageChecksumBreakpoint;// Offset=0x25c Size=0x4
    unsigned long ImageSizeBreakpoint;// Offset=0x260 Size=0x4
...
struct _MM_SYSTEM_PAGE_COUNTS// Size=0x10 (Id=1036)
{
...
struct _MI_SYSTEM_IMAGE_STATE// Size=0xc0 (Id=804)
{
...
struct _MMSESSION// Size=0x20 (Id=633)
{
...
struct _MI_SESSION_STATE// Size=0x88 (Id=883)
{
...
struct _MI_PROCESS_STATE// Size=0x48 (Id=793)
{
...
struct _MI_HARDWARE_STATE// Size=0x140 (Id=1423)
{
    ...
    unsigned long LargePageColors[3];// Offset=0x58 Size=0xc
    unsigned long FlushTbForAttributeChange;// Offset=0x64 Size=0x4
    unsigned long FlushCacheForAttributeChange;// Offset=0x68 Size=0x4
    unsigned long FlushCacheForPageAttributeChange;// Offset=0x6c Size=0x4
    unsigned long CacheFlushPromoteThreshold;// Offset=0x70 Size=0x4
    ...
    void * EnclaveMetadataPage;// Offset=0x100 Size=0x8
    struct _RTL_BITMAP * EnclaveMetadataBitMap;// Offset=0x108 Size=0x8
    struct _EX_PUSH_LOCK EnclaveMetadataEntryLock;// Offset=0x110 Size=0x8
    long EnclaveMetadataPageLock;// Offset=0x118 Size=0x4
    unsigned long long VsmKernelPageCount;// Offset=0x120 Size=0x8
    unsigned long long ColorCount[3];// Offset=0x128 Size=0x18
};
...
struct _MI_PAGELIST_STATE// Size=0x28 (Id=1314)
{
    long ActiveSpinLock;// Offset=0x0 Size=0x4
    struct _RTL_AVL_TREE ActiveThreadTree;// Offset=0x8 Size=0x8
...
struct _MI_PARTITION_STATE// Size=0x60 (Id=823)
{
...
struct _MI_BAD_MEMORY_EVENT_ENTRY// Size=0x38 (Id=1533)
{
...
struct _MI_PROBE_RAISE_TRACKER// Size=0x44 (Id=1589)
{
...
struct _MI_ACCESS_LOG_STATE// Size=0x80 (Id=1042)
{
...
struct _MI_DEBUGGER_STATE// Size=0x118 (Id=1122)
{
...
union _SLIST_HEADER// Size=0x10 (Id=71)
{
    ...
    struct _unnamed_70 HeaderX64;// Offset=0x0 Size=0x10
};
...
struct _MI_STANDBY_STATE// Size=0x90 (Id=1285)
{
...
struct _GENERAL_LOOKASIDE// Size=0x80 (Id=89)
{
    union // Size=0x10 (Id=0)
    {
...
struct _NPAGED_LOOKASIDE_LIST// Size=0x80 (Id=75)
{
...
struct _MI_ULTRA_VA_CONTEXT// Size=0x40 (Id=1093)
{
...
struct _MI_SYSTEM_PTE_STATE// Size=0x200 (Id=1052)
{
...
struct _MI_IO_CACHE_STATS// Size=0x28 (Id=1650)
{
...
struct _MI_IO_PAGE_STATE// Size=0x68 (Id=1567)
{
...
struct _MI_PAGING_IO_STATE// Size=0x50 (Id=1283)
{
...
struct _MI_COMMON_PAGE_STATE// Size=0xa8 (Id=1431)
{
...
struct _MI_SYSTEM_TRIM_STATE// Size=0x40 (Id=1025)
{
...
struct _MI_SYSTEM_INFORMATION// Size=0x2080 (Id=769)
{
    struct _MI_POOL_STATE Pools;// Offset=0x0 Size=0x148
    struct _MI_SECTION_STATE Sections;// Offset=0x180 Size=0x280
    struct _MI_SYSTEM_IMAGE_STATE SystemImages;// Offset=0x400 Size=0xc0
    struct _MI_SESSION_STATE Sessions;// Offset=0x4c0 Size=0x88
    struct _MI_PROCESS_STATE Processes;// Offset=0x548 Size=0x48
    struct _MI_HARDWARE_STATE Hardware;// Offset=0x590 Size=0x140
    struct _MI_SYSTEM_VA_STATE SystemVa;// Offset=0x700 Size=0x500
    struct _MI_COMBINE_STATE PageCombines;// Offset=0xc00 Size=0x18
    struct _MI_PAGELIST_STATE PageLists;// Offset=0xc18 Size=0x28
    struct _MI_PARTITION_STATE Partitions;// Offset=0xc40 Size=0x60
    struct _MI_SHUTDOWN_STATE Shutdowns;// Offset=0xca0 Size=0x78
    struct _MI_ERROR_STATE Errors;// Offset=0xd18 Size=0xc8
    struct _MI_ACCESS_LOG_STATE AccessLog;// Offset=0xe00 Size=0x80
    struct _MI_DEBUGGER_STATE Debugger;// Offset=0xe80 Size=0x118
    struct _MI_STANDBY_STATE Standby;// Offset=0xfa0 Size=0x90
    struct _MI_SYSTEM_PTE_STATE SystemPtes;// Offset=0x1040 Size=0x200
    struct _MI_IO_PAGE_STATE IoPages;// Offset=0x1240 Size=0x68
    struct _MI_PAGING_IO_STATE PagingIo;// Offset=0x12b0 Size=0x50
    struct _MI_COMMON_PAGE_STATE CommonPages;// Offset=0x1300 Size=0xa8
    struct _MI_SYSTEM_TRIM_STATE Trims;// Offset=0x13c0 Size=0x40
    unsigned long long Cookie;// Offset=0x1400 Size=0x8
    void ** BootRegistryRuns;// Offset=0x1408 Size=0x8
    long ZeroingDisabled;// Offset=0x1410 Size=0x4
    unsigned char FullyInitialized;// Offset=0x1414 Size=0x1
    unsigned char SafeBooted;// Offset=0x1415 Size=0x1
    struct _TlgProvider_t * TraceLogging;// Offset=0x1418 Size=0x8
    struct _MI_VISIBLE_STATE Vs;// Offset=0x1440 Size=0xc40
};
