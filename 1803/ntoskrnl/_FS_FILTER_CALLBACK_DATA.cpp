...
struct _unnamed_1748// Size=0x10 (Id=1748)
{
...
struct _unnamed_1750// Size=0x10 (Id=1750)
{
...
struct _unnamed_1751// Size=0x20 (Id=1751)
{
...
struct _unnamed_1752// Size=0x28 (Id=1752)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=1753)
{
    struct _unnamed_1745 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_1746 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_1748 AcquireForSectionSynchronization;// Offset=0x0 Size=0x10
    struct _unnamed_1750 NotifyStreamFileObject;// Offset=0x0 Size=0x10
    struct _unnamed_1751 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_1752 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=1732)
{
