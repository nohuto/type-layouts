...
struct _SEP_CACHED_HANDLES_TABLE// Size=0x10 (Id=1248)
{
...
struct _OB_HANDLE_REVOCATION_BLOCK// Size=0x20 (Id=738)
{
...
struct _SEP_LOGON_SESSION_REFERENCES// Size=0xc0 (Id=532)
{
