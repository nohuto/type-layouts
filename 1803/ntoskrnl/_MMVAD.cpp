...
struct _MMVAD_FLAGS// Size=0x4 (Id=583)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long Enclave:1;// Offset=0x0 Size=0x4 BitOffset=0x10 BitSize=0x1
        unsigned long PageSize64K:1;// Offset=0x0 Size=0x4 BitOffset=0x11 BitSize=0x1
        unsigned long RfgControlStack:1;// Offset=0x0 Size=0x4 BitOffset=0x12 BitSize=0x1
        unsigned long Spare:8;// Offset=0x0 Size=0x4 BitOffset=0x13 BitSize=0x8
...
struct _MMVAD_FLAGS1// Size=0x4 (Id=604)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MMVAD_SHORT// Size=0x40 (Id=251)
{
    ...
    union _unnamed_249 u;// Offset=0x30 Size=0x4
    union _unnamed_250 u1;// Offset=0x34 Size=0x4
    struct _MI_VAD_EVENT_BLOCK * EventList;// Offset=0x38 Size=0x8
};

struct _MMVAD_FLAGS2// Size=0x4 (Id=1344)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1345// Size=0x4 (Id=1345)
{
...
struct _MI_VAD_SEQUENTIAL_INFO// Size=0x8 (Id=1676)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _MMVAD// Size=0x88 (Id=1347)
{
    ...
    union _unnamed_1346 u4;// Offset=0x78 Size=0x8
