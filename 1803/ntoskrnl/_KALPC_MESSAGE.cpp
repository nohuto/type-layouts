...
union _unnamed_477// Size=0x4 (Id=477)
{
    struct _unnamed_476 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

union _KALPC_DIRECT_EVENT// Size=0x8 (Id=488)
{
...
struct _KALPC_MESSAGE// Size=0x118 (Id=478)
{
    ...
    union _unnamed_477 u1;// Offset=0x28 Size=0x4
