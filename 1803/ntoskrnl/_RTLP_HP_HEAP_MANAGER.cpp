struct _RTL_CSPARSE_BITMAP// Size=0x40 (Id=425)
{
...
struct _RTLP_HP_ALLOC_TRACKER// Size=0x48 (Id=434)
{
...
struct _RTL_SPARSE_ARRAY// Size=0x50 (Id=427)
{
...
struct _HEAP_VAMGR_VASPACE// Size=0x60 (Id=430)
{
...
struct _HEAP_VAMGR_ALLOCATOR// Size=0x30 (Id=428)
{
...
struct _HEAP_VAMGR_CTX// Size=0x3040 (Id=1003)
{
...
union _RTL_RUN_ONCE// Size=0x8 (Id=684)
{
...
struct _RTLP_HP_METADATA_HEAP_CTX// Size=0x10 (Id=1028)
{
...
struct _RTLP_HP_HEAP_MANAGER// Size=0x30d0 (Id=433)
{
    ...
    struct _RTL_HP_SUB_ALLOCATOR_CONFIGS SubAllocConfigs;// Offset=0x30c0 Size=0x10
};
