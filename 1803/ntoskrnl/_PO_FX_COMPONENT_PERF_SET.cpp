...
struct _PO_FX_COMPONENT_PERF_SET// Size=0x30 (Id=1737)
{
    ...
    {
        struct _unnamed_1735 Discrete;// Offset=0x20 Size=0x10
        struct _unnamed_1736 Range;// Offset=0x20 Size=0x10
    };
};
