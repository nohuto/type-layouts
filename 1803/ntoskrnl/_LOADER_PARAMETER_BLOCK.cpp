...
struct _EFI_FIRMWARE_INFORMATION// Size=0x38 (Id=1700)
{
...
struct _PCAT_FIRMWARE_INFORMATION// Size=0x4 (Id=1706)
{
    unsigned long PlaceHolder;// Offset=0x0 Size=0x4
};

union _unnamed_1635// Size=0x38 (Id=1635)
{
...
struct _FIRMWARE_INFORMATION_LOADER_BLOCK// Size=0x40 (Id=1636)
{
    ...
    union _unnamed_1635 u;// Offset=0x8 Size=0x38
};

struct _LOADER_PARAMETER_BLOCK// Size=0x160 (Id=1409)
{
    ...
    union _unnamed_1408 u;// Offset=0xf8 Size=0x10
