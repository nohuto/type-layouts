...
struct _IOP_FILE_OBJECT_EXTENSION// Size=0x58 (Id=499)
{
    unsigned long FoExtFlags;// Offset=0x0 Size=0x4
    void * FoExtPerTypeExtension[9];// Offset=0x8 Size=0x48
    enum _IOP_PRIORITY_HINT FoIoPriorityHint;// Offset=0x50 Size=0x4
};
