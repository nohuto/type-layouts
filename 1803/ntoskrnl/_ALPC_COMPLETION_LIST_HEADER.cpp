struct _unnamed_1316// Size=0x8 (Id=1316)
{
...
union _unnamed_1317// Size=0x8 (Id=1317)
{
    struct _unnamed_1316 s1;// Offset=0x0 Size=0x8
    long long Value;// Offset=0x0 Size=0x8
};

struct _ALPC_COMPLETION_LIST_STATE// Size=0x8 (Id=1318)
{
    union _unnamed_1317 u1;// Offset=0x0 Size=0x8
};

struct _RTL_SRWLOCK// Size=0x8 (Id=1187)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _ALPC_COMPLETION_LIST_HEADER// Size=0x180 (Id=1088)
{
