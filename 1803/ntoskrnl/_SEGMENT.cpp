struct _SEGMENT_FLAGS// Size=0x4 (Id=1405)
{
    union // Size=0x2 (Id=0)
    {
...
struct _SEGMENT// Size=0x48 (Id=239)
{
    ...
    union _unnamed_237 u1;// Offset=0x30 Size=0x8
    union _unnamed_238 u2;// Offset=0x38 Size=0x8
