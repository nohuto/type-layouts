...
struct _POP_POLICY_DEVICE// Size=0x40 (Id=1391)
{
...
struct _THERMAL_INFORMATION_EX// Size=0x5c (Id=1012)
{
...
struct _THERMAL_POLICY// Size=0x18 (Id=1040)
{
...
struct _KTIMER2// Size=0x88 (Id=879)
{
    ...
    union // Size=0x1 (Id=0)
    {
        ...
        struct // Size=0x1 (Id=0)
        {
            ...
            unsigned char Unused1:4;// Offset=0x81 Size=0x1 BitOffset=0x4 BitSize=0x4
        };
    };
...
struct _POP_RW_LOCK// Size=0x10 (Id=398)
{
...
struct _POP_THERMAL_TELEMETRY_TRACKER// Size=0x160 (Id=1191)
{
    unsigned char AccountingDisabled;// Offset=0x0 Size=0x1
    unsigned long long LastPassiveUpdateTime;// Offset=0x8 Size=0x8
    unsigned long long TotalPassiveTime[21];// Offset=0x10 Size=0xa8
    unsigned long long PassiveTimeSnap[21];// Offset=0xb8 Size=0xa8
};

struct _POP_THERMAL_ZONE// Size=0x368 (Id=825)
{
    ...
    struct _POP_THERMAL_TELEMETRY_TRACKER TelemetryTracker;// Offset=0x1f8 Size=0x160
    struct _UNICODE_STRING Description;// Offset=0x358 Size=0x10
};
