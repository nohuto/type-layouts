...
struct _unnamed_1653// Size=0x8 (Id=1653)
{
...
struct _unnamed_1654// Size=0x10 (Id=1654)
{
    struct _GUID DiskId;// Offset=0x0 Size=0x10
};

union _unnamed_1655// Size=0x10 (Id=1655)
{
    struct _unnamed_1653 Mbr;// Offset=0x0 Size=0x8
    struct _unnamed_1654 Gpt;// Offset=0x0 Size=0x10
};

struct _DUMP_INITIALIZATION_CONTEXT// Size=0x108 (Id=1657)
{
    ...
    union _unnamed_1655 DiskInfo;// Offset=0x8c Size=0x10
...
struct _DUMP_STACK_CONTEXT// Size=0x178 (Id=1599)
{
