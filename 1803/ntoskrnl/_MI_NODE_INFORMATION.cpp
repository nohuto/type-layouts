struct _MI_FREE_LARGE_PAGES// Size=0x110 (Id=1698)
{
...
struct _MI_REBUILD_LARGE_PAGE_TIMER// Size=0x28 (Id=1566)
{
...
struct _MMPFNLIST_SHORT// Size=0x18 (Id=1672)
{
...
struct _MI_PAGE_COLORS// Size=0x10 (Id=1598)
{
    unsigned long PageSize[4];// Offset=0x0 Size=0x10
};

struct _MI_NODE_INFORMATION// Size=0x7c0 (Id=1547)
{
    ...
    struct _unnamed_1546 Flags;// Offset=0x760 Size=0x4
