...
union _POP_FX_COMPONENT_FLAGS// Size=0x8 (Id=392)
{
...
struct _POP_FX_COMPONENT// Size=0x150 (Id=1400)
{
    ...
    struct _POP_FX_ACCOUNTING Accounting;// Offset=0xc8 Size=0x80
    struct _POP_FX_PERF_INFO * Performance;// Offset=0x148 Size=0x8
};
