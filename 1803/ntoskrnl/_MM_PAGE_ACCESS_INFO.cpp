struct _unnamed_849// Size=0x4 (Id=849)
{
...
struct _unnamed_850// Size=0x4 (Id=850)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long FilePointerIndex:9;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x9
...
union _MM_PAGE_ACCESS_INFO_FLAGS// Size=0x4 (Id=851)
{
    struct _unnamed_849 File;// Offset=0x0 Size=0x4
    struct _unnamed_850 Private;// Offset=0x0 Size=0x4
};

struct _MM_PAGE_ACCESS_INFO// Size=0x8 (Id=845)
{
    union // Size=0x8 (Id=0)
    {
