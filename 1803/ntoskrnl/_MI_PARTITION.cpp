...
struct _MI_PARTITION_CORE// Size=0x1a8 (Id=1054)
{
    unsigned short PartitionId;// Offset=0x0 Size=0x2
    union _unnamed_1053 u;// Offset=0x4 Size=0x4
...
struct _MMPAGE_FILE_EXPANSION_FLAGS// Size=0x4 (Id=1671)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1180// Size=0x4 (Id=1180)
{
    unsigned long LongFlags;// Offset=0x0 Size=0x4
    struct _MMPAGE_FILE_EXPANSION_FLAGS Flags;// Offset=0x0 Size=0x4
};

struct _MMPAGE_FILE_EXPANSION// Size=0x58 (Id=1181)
{
    ...
    union _unnamed_1180 u1;// Offset=0x4c Size=0x4
...
struct _MMMOD_WRITER_LISTHEAD// Size=0x28 (Id=1490)
{
...
union _MI_RESERVATION_CLUSTER_INFO// Size=0x4 (Id=1708)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_MODWRITE_DATA// Size=0x40 (Id=1579)
{
...
struct _EX_RUNDOWN_REF// Size=0x8 (Id=188)
{
    union // Size=0x8 (Id=0)
    {
...
struct _MI_RESTRICTED_MODWRITES// Size=0x3 (Id=1673)
{
...
struct _MI_PARTITION_MODWRITES// Size=0x2c0 (Id=1370)
{
...
struct _MI_PARTITION_STORES// Size=0x90 (Id=674)
{
    union _unnamed_673 WriteAllStoreHintedPages;// Offset=0x0 Size=0x4
...
struct _KSEMAPHORE// Size=0x20 (Id=322)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

struct _MMDEREFERENCE_SEGMENT_HEADER// Size=0x50 (Id=1543)
{
...
struct _KTIMER// Size=0x40 (Id=1278)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _MI_CROSS_PARTITION_CHARGES// Size=0x20 (Id=1574)
{
...
struct _MI_PARTITION_SEGMENTS// Size=0x340 (Id=1143)
{
    ...
    unsigned long long UnusedSegmentPagedPool;// Offset=0x158 Size=0x8
    struct _LIST_ENTRY UnusedSegmentList;// Offset=0x160 Size=0x10
    struct _LIST_ENTRY UnusedSubsectionList;// Offset=0x170 Size=0x10
    ...
    struct _MI_PTE_CHAIN_HEAD FreeSystemCache;// Offset=0x1b0 Size=0x18
    struct _KEVENT CloneDereferenceEvent;// Offset=0x1c8 Size=0x18
    ...
    struct _MI_CROSS_PARTITION_CHARGES SharedCharges[7];// Offset=0x218 Size=0xe0
    struct _KEVENT * SharedChargesDrainEvent;// Offset=0x2f8 Size=0x8
    struct _KEVENT * ControlAreasDrainEvent;// Offset=0x300 Size=0x8
    struct _KEVENT * CloneHeaderDrainEvent;// Offset=0x308 Size=0x8
    struct _EX_RUNDOWN_REF_CACHE_AWARE * ProbeRundownReference;// Offset=0x310 Size=0x8
};
...
struct _MI_DECAY_TIMER_LINKAGE// Size=0x8 (Id=1286)
{
    struct // Size=0x8 (Id=0)
    {
...
union _unnamed_941// Size=0x8 (Id=941)
{
    unsigned long long Long;// Offset=0x0 Size=0x8
    struct _MI_DECAY_TIMER_LINKAGE e1;// Offset=0x0 Size=0x8
};

struct _MI_DECAY_TIMER_LINK// Size=0x8 (Id=942)
{
    union _unnamed_941 u1;// Offset=0x0 Size=0x8
};

struct _MI_LDW_WORK_CONTEXT// Size=0x38 (Id=1120)
{
...
struct _MI_AVAILABLE_PAGE_WAIT_STATES// Size=0x20 (Id=1146)
{
...
struct _MI_LARGE_PAGE_CANDIDATES// Size=0x208 (Id=1105)
{
...
struct _MI_PARTITION_PAGE_LISTS// Size=0xfc0 (Id=940)
{
...
struct _MI_PARTITION_COMMIT// Size=0x80 (Id=1254)
{
...
struct _MI_PARTITION_ZEROING// Size=0x68 (Id=1217)
{
...
struct _MI_PAGE_COMBINING_SUPPORT// Size=0x188 (Id=957)
{
...
struct _MMWORKING_SET_EXPANSION_HEAD// Size=0x10 (Id=714)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
};
...
struct _MI_PARTITION// Size=0x2cc0 (Id=253)
{
    ...
    struct _MI_PARTITION_PAGE_LISTS PageLists;// Offset=0x840 Size=0xfc0
    struct _MI_PARTITION_COMMIT Commit;// Offset=0x1800 Size=0x80
    struct _MI_PARTITION_ZEROING Zeroing;// Offset=0x1880 Size=0x68
    struct _MI_PAGE_COMBINING_SUPPORT PageCombine;// Offset=0x18e8 Size=0x188
    void * WorkingSetControl;// Offset=0x1a70 Size=0x8
    struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;// Offset=0x1a78 Size=0x10
    struct _MI_VISIBLE_PARTITION Vp;// Offset=0x1ac0 Size=0x1200
};
