struct _OBP_SYSTEM_DOS_DEVICE_STATE// Size=0x6c (Id=731)
{
...
struct _OBJECT_NAMESPACE_LOOKUPTABLE// Size=0x260 (Id=572)
{
...
struct _OBP_SILODRIVERSTATE// Size=0x2e0 (Id=546)
{
...
struct _SEP_SILOSTATE// Size=0x30 (Id=528)
{
...
struct _SEP_RM_LSA_CONNECTION_STATE// Size=0x50 (Id=711)
{
...
struct _WNF_LOCK// Size=0x8 (Id=1210)
{
    struct _EX_PUSH_LOCK PushLock;// Offset=0x0 Size=0x8
};

struct _WNF_SILODRIVERSTATE// Size=0x38 (Id=733)
{
...
struct _DBGK_SILOSTATE// Size=0x20 (Id=601)
{
...
struct _ESERVERSILO_GLOBALS// Size=0x480 (Id=390)
{
