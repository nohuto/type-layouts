...
struct _PO_DEVICE_NOTIFY// Size=0x68 (Id=693)
{
...
union _unnamed_314// Size=0x8 (Id=314)
{
...
union _unnamed_315// Size=0x8 (Id=315)
{
...
struct _DEVICE_NODE// Size=0x2d8 (Id=319)
{
    ...
    union _unnamed_314 OverUsed1;// Offset=0x210 Size=0x8
    union _unnamed_315 OverUsed2;// Offset=0x218 Size=0x8
    ...
    struct _unnamed_317 DockInfo;// Offset=0x238 Size=0x20
