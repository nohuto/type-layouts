...
struct _unnamed_1618// Size=0x10 (Id=1618)
{
    struct _GUID BlockedDriverGuid;// Offset=0x0 Size=0x10
};

struct _unnamed_1619// Size=0x2 (Id=1619)
{
    wchar_t ParentId[1];// Offset=0x0 Size=0x2
};

struct _unnamed_1620// Size=0x20 (Id=1620)
{
...
union _unnamed_1621// Size=0x20 (Id=1621)
{
    union // Size=0x20 (Id=0)
    {
        struct _unnamed_1612 DeviceClass;// Offset=0x0 Size=0x14
        struct _unnamed_1613 TargetDevice;// Offset=0x0 Size=0x2
        struct _unnamed_1613 InstallDevice;// Offset=0x0 Size=0x2
        struct _unnamed_1614 CustomNotification;// Offset=0x0 Size=0x10
        struct _unnamed_1615 ProfileNotification;// Offset=0x0 Size=0x8
        struct _unnamed_1616 PowerNotification;// Offset=0x0 Size=0x8
        struct _unnamed_1617 VetoNotification;// Offset=0x0 Size=0x8
        struct _unnamed_1618 BlockedDriverNotification;// Offset=0x0 Size=0x10
        struct _unnamed_1619 InvalidIDNotification;// Offset=0x0 Size=0x2
        struct _unnamed_1620 PowerSettingNotification;// Offset=0x0 Size=0x20
        struct _unnamed_1613 PropertyChangeNotification;// Offset=0x0 Size=0x2
        struct _unnamed_1613 DeviceInstanceNotification;// Offset=0x0 Size=0x2
    };
};

struct _PLUGPLAY_EVENT_BLOCK// Size=0x50 (Id=1622)
{
    ...
    union _unnamed_1621 u;// Offset=0x30 Size=0x20
};

struct _PNP_DEVICE_EVENT_ENTRY// Size=0xc0 (Id=1116)
{
