...
struct _HVP_VIEW_MAP// Size=0x38 (Id=831)
{
...
struct _FREE_DISPLAY// Size=0x18 (Id=1195)
{
...
struct _DUAL// Size=0x278 (Id=695)
{
...
struct _HHIVE// Size=0x600 (Id=255)
{
...
struct _CM_WORKITEM// Size=0x28 (Id=854)
{
...
struct _CM_DIRTY_VECTOR_LOG// Size=0x488 (Id=826)
{
...
struct _HIVE_WRITE_WAIT_QUEUE// Size=0x18 (Id=835)
{
...
struct _CMHIVE// Size=0x12f8 (Id=265)
{
    ...
    unsigned char * FlushLogEntry;// Offset=0x6a8 Size=0x8
    unsigned long FlushLogEntrySize;// Offset=0x6b0 Size=0x4
    unsigned long FlushHiveTruncated;// Offset=0x6b4 Size=0x4
    unsigned char FlushBaseBlockDirty;// Offset=0x6b8 Size=0x1
    ...
    struct _HIVE_WRITE_WAIT_QUEUE FlushQueue;// Offset=0x1088 Size=0x18
    struct _HIVE_WRITE_WAIT_QUEUE ReconcileQueue;// Offset=0x10a0 Size=0x18
    union // Size=0x4 (Id=0)
    {
        unsigned long FlushFlags;// Offset=0x10b8 Size=0x4
        struct // Size=0x4 (Id=0)
        {
            unsigned long FlushActive:1;// Offset=0x10b8 Size=0x4 BitOffset=0x0 BitSize=0x1
            unsigned long ReconcileActive:1;// Offset=0x10b8 Size=0x4 BitOffset=0x1 BitSize=0x1
            unsigned long PrimaryFilePurged:1;// Offset=0x10b8 Size=0x4 BitOffset=0x2 BitSize=0x1
            unsigned long DiskFileBad:1;// Offset=0x10b8 Size=0x4 BitOffset=0x3 BitSize=0x1
        };
    };
    unsigned long PrimaryFileSizeBeforeLastFlush;// Offset=0x10bc Size=0x4
    long ReferenceCount;// Offset=0x10c0 Size=0x4
    long UnloadHistoryIndex;// Offset=0x10c4 Size=0x4
    unsigned long UnloadHistory[128];// Offset=0x10c8 Size=0x200
    unsigned long BootStart;// Offset=0x12c8 Size=0x4
    unsigned long UnaccessedStart;// Offset=0x12cc Size=0x4
    unsigned long UnaccessedEnd;// Offset=0x12d0 Size=0x4
    unsigned long LoadedKeyCount;// Offset=0x12d4 Size=0x4
    unsigned long HandleClosePending;// Offset=0x12d8 Size=0x4
    struct _EX_PUSH_LOCK HandleClosePendingEvent;// Offset=0x12e0 Size=0x8
    unsigned char FinalFlushSucceeded;// Offset=0x12e8 Size=0x1
    struct _CMP_VOLUME_CONTEXT * VolumeContext;// Offset=0x12f0 Size=0x8
};
