...
struct _unnamed_1463// Size=0x18 (Id=1463)
{
...
struct _unnamed_1465// Size=0x18 (Id=1465)
{
...
struct _unnamed_1467// Size=0x10 (Id=1467)
{
...
struct _unnamed_1469// Size=0x10 (Id=1469)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_1470// Size=0xc (Id=1470)
{
...
struct _unnamed_1471// Size=0x18 (Id=1471)
{
...
struct _unnamed_1472// Size=0x18 (Id=1472)
{
...
struct _unnamed_1473// Size=0x18 (Id=1473)
{
...
union _unnamed_1475// Size=0x18 (Id=1475)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_1463 Port;// Offset=0x0 Size=0x18
        struct _unnamed_1463 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_1465 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_1466 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_1467 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_1463 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_1468 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_1469 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_1470 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_1471 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_1472 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_1473 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_1474 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=1476)
{
    ...
    union _unnamed_1475 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=994)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=329)
{
