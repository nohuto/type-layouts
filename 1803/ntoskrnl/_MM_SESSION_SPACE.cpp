struct _MM_SESSION_SPACE_FLAGS// Size=0x4 (Id=656)
{
...
union _unnamed_569// Size=0x4 (Id=569)
{
...
struct _POOL_DESCRIPTOR// Size=0x1140 (Id=868)
{
...
struct _MI_SESSION_DRIVER_UNLOAD// Size=0x8 (Id=848)
{
    union // Size=0x8 (Id=0)
    {
...
struct _MM_SESSION_SPACE// Size=0x5000 (Id=571)
{
    long ReferenceCount;// Offset=0x0 Size=0x4
    union _unnamed_569 u;// Offset=0x4 Size=0x4
