...
struct _ETW_BUFFER_QUEUE// Size=0x10 (Id=508)
{
...
struct _ETW_REF_CLOCK// Size=0x10 (Id=1001)
{
...
struct _ETW_STACK_TRACE_BLOCK// Size=0x80 (Id=1173)
{
...
struct _DISALLOWED_GUIDS// Size=0x10 (Id=988)
{
    unsigned short Count;// Offset=0x0 Size=0x2
    struct _GUID * Guids;// Offset=0x8 Size=0x8
};

struct _PERIODIC_CAPTURE_STATE_GUIDS// Size=0x10 (Id=1135)
{
...
struct _WMI_LOGGER_CONTEXT// Size=0x510 (Id=518)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long SpareFlags2:5;// Offset=0x340 Size=0x4 BitOffset=0x1b BitSize=0x5
        };
    };
    union // Size=0x4 (Id=0)
    {
