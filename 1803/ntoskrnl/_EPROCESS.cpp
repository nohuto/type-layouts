...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=707)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=914)
{
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=1137)
{
...
struct _ALPC_PROCESS_CONTEXT// Size=0x20 (Id=880)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=842)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=1075)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WNF_STATE_NAME// Size=0x8 (Id=552)
{
    unsigned long Data[2];// Offset=0x0 Size=0x8
};

struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=792)
{
    unsigned long HighEdgeFilter;// Offset=0x0 Size=0x4
    unsigned long LowEdgeFilter;// Offset=0x4 Size=0x4
};

struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=762)
{
...
struct _EPROCESS// Size=0x848 (Id=110)
{
