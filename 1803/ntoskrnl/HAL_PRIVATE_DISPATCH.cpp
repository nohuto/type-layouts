struct HAL_PRIVATE_DISPATCH// Size=0x480 (Id=757)
{
    ...
    long  ( * HalGetHiddenProcessorPowerInterface)(struct _HIDDEN_PROCESSOR_POWER_INTERFACE * );// Offset=0x458 Size=0x8
    unsigned long  ( * HalGetHiddenProcessorPackageId)(unsigned long );// Offset=0x460 Size=0x8
    unsigned long  ( * HalGetHiddenPackageProcessorCount)(unsigned long );// Offset=0x468 Size=0x8
    long  ( * HalGetHiddenProcessorApicIdByIndex)(unsigned long ,unsigned long * );// Offset=0x470 Size=0x8
    long  ( * HalRegisterHiddenProcessorIdleState)(unsigned long ,unsigned long long );// Offset=0x478 Size=0x8
};
