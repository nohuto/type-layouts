struct _RTL_CRITICAL_SECTION// Size=0x28 (Id=893)
{
...
union _unnamed_437// Size=0x68 (Id=437)
{
    struct _RTL_CRITICAL_SECTION CriticalSection;// Offset=0x0 Size=0x28
    struct _ERESOURCE Resource;// Offset=0x0 Size=0x68
};

struct _HEAP_LOCK// Size=0x68 (Id=438)
{
    union _unnamed_437 Lock;// Offset=0x0 Size=0x68
};
