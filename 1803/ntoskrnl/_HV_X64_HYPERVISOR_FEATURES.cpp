union _HV_PARTITION_PRIVILEGE_MASK// Size=0x8 (Id=304)
{
...
struct _HV_X64_HYPERVISOR_FEATURES// Size=0x10 (Id=303)
{
    ...
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned int Reserved1:6;// Offset=0xc Size=0x4 BitOffset=0x1a BitSize=0x6
    };
};
