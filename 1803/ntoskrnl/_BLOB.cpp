...
struct _SLIST_ENTRY// Size=0x10 (Id=73)
{
    struct _SLIST_ENTRY * Next;// Offset=0x0 Size=0x8
};

struct _unnamed_454// Size=0x1 (Id=454)
{
...
union _unnamed_455// Size=0x1 (Id=455)
{
    struct _unnamed_454 s1;// Offset=0x0 Size=0x1
...
struct _BLOB// Size=0x30 (Id=456)
{
    ...
    union _unnamed_455 u1;// Offset=0x10 Size=0x1
