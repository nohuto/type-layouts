...
union _unnamed_458// Size=0x4 (Id=458)
{
    struct _unnamed_457 s1;// Offset=0x0 Size=0x4
};
...
struct _KALPC_SECTION// Size=0x48 (Id=459)
{
    ...
    union _unnamed_458 u1;// Offset=0x30 Size=0x4
