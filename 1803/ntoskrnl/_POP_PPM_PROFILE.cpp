...
union _PPM_POLICY_SETTINGS_MASK// Size=0x8 (Id=619)
{
    ...
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned long Spare:18;// Offset=0x4 Size=0x4 BitOffset=0xe BitSize=0x12
    };
};
...
struct _PPM_ENGINE_SETTINGS// Size=0xa80 (Id=387)
{
    ...
    unsigned char IdleStateMax;// Offset=0x6e Size=0x1
    unsigned char HeteroDecreaseTime;// Offset=0x6f Size=0x1
    unsigned char HeteroIncreaseTime;// Offset=0x70 Size=0x1
    unsigned char HeteroDecreaseThreshold[1280];// Offset=0x71 Size=0x500
    unsigned char HeteroIncreaseThreshold[1280];// Offset=0x571 Size=0x500
    unsigned char Class0FloorPerformance;// Offset=0xa71 Size=0x1
    unsigned char Class1InitialPerformance;// Offset=0xa72 Size=0x1
    enum _KHETERO_CPU_POLICY ThreadPolicies[2];// Offset=0xa74 Size=0x8
};

struct _POP_PPM_PROFILE// Size=0x1550 (Id=385)
{
    ...
    struct _PPM_ENGINE_SETTINGS Settings[2];// Offset=0x28 Size=0x1500
    unsigned long long StartTime;// Offset=0x1528 Size=0x8
    unsigned long long Count;// Offset=0x1530 Size=0x8
    unsigned long long MaxDuration;// Offset=0x1538 Size=0x8
    unsigned long long MinDuration;// Offset=0x1540 Size=0x8
    unsigned long long TotalDuration;// Offset=0x1548 Size=0x8
};
