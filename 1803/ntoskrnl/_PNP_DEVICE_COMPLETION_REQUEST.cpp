...
struct _PNP_DEVICE_COMPLETION_REQUEST// Size=0x80 (Id=1172)
{
    ...
    struct _FAST_MUTEX PnpDeviceCompletionQueueWatchdogLock;// Offset=0x40 Size=0x38
    struct _PNP_WATCHDOG * Watchdog;// Offset=0x78 Size=0x8
};
