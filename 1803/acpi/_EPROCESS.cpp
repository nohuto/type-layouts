...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=259)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=60)
{
...
struct _KPROCESS// Size=0x2d8 (Id=63)
{
    ...
    union _unnamed_62 SecureState;// Offset=0x2d0 Size=0x8
};
...
struct _EX_RUNDOWN_REF// Size=0x8 (Id=190)
{
    union // Size=0x8 (Id=0)
    {
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=403)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=430)
{
    union // Size=0x2 (Id=0)
    {
...
struct _MMSUPPORT_INSTANCE// Size=0xc0 (Id=353)
{
...
struct _MMSUPPORT_SHARED// Size=0x50 (Id=372)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=287)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=108)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WNF_STATE_NAME// Size=0x8 (Id=498)
{
    unsigned long Data[2];// Offset=0x0 Size=0x8
};

struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=277)
{
    unsigned long HighEdgeFilter;// Offset=0x0 Size=0x4
    unsigned long LowEdgeFilter;// Offset=0x4 Size=0x4
};

struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=270)
{
...
struct _EPROCESS// Size=0x848 (Id=111)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_109 MitigationFlagsValues;// Offset=0x828 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x82c Size=0x4
        struct _unnamed_110 MitigationFlags2Values;// Offset=0x82c Size=0x4
    };
