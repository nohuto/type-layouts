...
struct _RTL_RANGE_LIST// Size=0x20 (Id=462)
{
...
struct _HAL_INTERRUPT_TARGET_INFORMATION// Size=0x18 (Id=514)
{
    ...
    union // Size=0xc (Id=0)
    {
        struct _unnamed_512 Apic;// Offset=0xc Size=0xc
        struct _unnamed_513 Irt;// Offset=0xc Size=0xc
    };
};

struct _PROCESSOR_SINK_INFO// Size=0x1c (Id=378)
{
    unsigned long ApicId;// Offset=0x0 Size=0x4
    struct _HAL_INTERRUPT_TARGET_INFORMATION TargetInfo;// Offset=0x4 Size=0x18
};

struct _PROCESSOR_INSTANCE// Size=0x70 (Id=206)
{
