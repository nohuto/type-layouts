...
struct _ACPI_POWER_REQUEST_DEPENDENCY// Size=0x20 (Id=639)
{
...
struct _unnamed_633// Size=0x8 (Id=633)
{
...
struct _ACPI_POWER_WAKE_INTERRUPT_REGISTRATION_ENTRY// Size=0x28 (Id=649)
{
...
union _unnamed_634// Size=0x28 (Id=634)
{
...
struct _unnamed_635// Size=0x58 (Id=635)
{
    enum _SYSTEM_POWER_STATE SystemPowerState;// Offset=0x0 Size=0x4
    ...
    union _unnamed_634 Registrations;// Offset=0x30 Size=0x28
};

struct _unnamed_636// Size=0x4 (Id=636)
{
    enum _SYSTEM_POWER_STATE EjectPowerState;// Offset=0x0 Size=0x4
};

union _unnamed_637// Size=0x58 (Id=637)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_632 DevicePowerRequest;// Offset=0x0 Size=0x8
        struct _unnamed_633 SystemPowerRequest;// Offset=0x0 Size=0x8
        struct _unnamed_635 WaitWakeRequest;// Offset=0x0 Size=0x58
        struct _unnamed_636 EjectPowerRequest;// Offset=0x0 Size=0x4
    };
};
...
struct _ACPI_POWER_REQUEST// Size=0x108 (Id=638)
{
    ...
    union _unnamed_637 u;// Offset=0x68 Size=0x58
