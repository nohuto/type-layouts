...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=380)
{
...
struct _KAPC_STATE// Size=0x30 (Id=336)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=354)
{
...
struct _RTL_BALANCED_NODE// Size=0x18 (Id=38)
{
...
struct _KLOCK_ENTRY_LOCK_STATE// Size=0x10 (Id=391)
{
    union // Size=0x8 (Id=0)
    {
...
union _KLOCK_ENTRY_BOOST_BITMAP// Size=0x4 (Id=223)
{
...
struct _KLOCK_ENTRY// Size=0x60 (Id=214)
{
...
struct _KTHREAD// Size=0x5f0 (Id=64)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _KSEMAPHORE// Size=0x20 (Id=328)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=377)
{
