...
struct _PROC_PERF_QOS_CLASS_POLICY// Size=0x1c (Id=552)
{
...
struct _PERF_CONTROL_STATE_SELECTION// Size=0x28 (Id=553)
{
...
struct _PROC_PERF_DOMAIN// Size=0x2b8 (Id=526)
{
    ...
    struct _PROC_PERF_QOS_CLASS_POLICY QosPolicies[4];// Offset=0x16c Size=0x70
    unsigned long QosDisableReasons[4];// Offset=0x1dc Size=0x10
    unsigned long QosEquivalencyMasks[4];// Offset=0x1ec Size=0x10
    unsigned char QosSupported;// Offset=0x1fc Size=0x1
    unsigned long SelectionGeneration;// Offset=0x200 Size=0x4
    struct _PERF_CONTROL_STATE_SELECTION QosSelection[4];// Offset=0x208 Size=0xa0
    unsigned long long PerfChangeTime;// Offset=0x2a8 Size=0x8
    unsigned long PerfChangeIntervalCount;// Offset=0x2b0 Size=0x4
    unsigned char Force;// Offset=0x2b4 Size=0x1
};
