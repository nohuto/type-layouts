struct _NT_TIB// Size=0x38 (Id=360)
{
...
union _KPRCBFLAG// Size=0x4 (Id=303)
{
...
struct _KDESCRIPTOR// Size=0x10 (Id=592)
{
...
struct _KSPECIAL_REGISTERS// Size=0xf0 (Id=533)
{
...
struct _CONTEXT// Size=0x4d0 (Id=427)
{
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=279)
{
...
struct _KTIMER_TABLE_ENTRY// Size=0x20 (Id=597)
{
...
struct _KTIMER_TABLE// Size=0x2200 (Id=527)
{
...
struct _KGATE// Size=0x18 (Id=296)
{
...
struct _PROC_IDLE_POLICY// Size=0x6 (Id=572)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=404)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=434)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=440)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=544)
{
...
struct _PROCESSOR_POWER_STATE// Size=0x200 (Id=408)
{
    ...
    unsigned char LongPriorQosPeriod;// Offset=0x1a3 Size=0x1
    ...
    unsigned long QosEquivalencyMask;// Offset=0x1f8 Size=0x4
};

struct _KTIMER// Size=0x40 (Id=458)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=324)
{
...
struct _KAFFINITY_EX// Size=0xa8 (Id=341)
{
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=461)
{
...
struct _KPRCB// Size=0x7ec0 (Id=44)
{
    ...
    union // Size=0x100 (Id=0)
    {
        ...
        union // Size=0x2 (Id=0)
        {
            unsigned short BpbState;// Offset=0xf8 Size=0x2
            struct // Size=0x2 (Id=0)
            {
                unsigned short BpbIbrsPresent:1;// Offset=0xf8 Size=0x2 BitOffset=0x0 BitSize=0x1
                unsigned short BpbStibpPresent:1;// Offset=0xf8 Size=0x2 BitOffset=0x1 BitSize=0x1
                unsigned short BpbSmepPresent:1;// Offset=0xf8 Size=0x2 BitOffset=0x2 BitSize=0x1
                unsigned short BpbSimulateSpecCtrl:1;// Offset=0xf8 Size=0x2 BitOffset=0x3 BitSize=0x1
                unsigned short BpbSimulateIbpb:1;// Offset=0xf8 Size=0x2 BitOffset=0x4 BitSize=0x1
                unsigned short BpbIbpbPresent:1;// Offset=0xf8 Size=0x2 BitOffset=0x5 BitSize=0x1
                unsigned short BpbCpuIdle:1;// Offset=0xf8 Size=0x2 BitOffset=0x6 BitSize=0x1
                unsigned short BpbClearSpecCtrlOnIdle:1;// Offset=0xf8 Size=0x2 BitOffset=0x7 BitSize=0x1
                unsigned short BpbHTDisabled:1;// Offset=0xf8 Size=0x2 BitOffset=0x8 BitSize=0x1
                unsigned short BpbUserToUserOnly:1;// Offset=0xf8 Size=0x2 BitOffset=0x9 BitSize=0x1
                unsigned short BpbReserved:6;// Offset=0xf8 Size=0x2 BitOffset=0xa BitSize=0x6
            };
        };
        unsigned char BpbSpecCtrlValue;// Offset=0xfa Size=0x1
        unsigned char BpbCtxSwapSetValue;// Offset=0xfb Size=0x1
        unsigned char BpbPad[4];// Offset=0xfc Size=0x4
    ...
    unsigned long long PrcbPad35[2];// Offset=0x2db0 Size=0x10
    ...
    void * MmFlushList;// Offset=0x5cf8 Size=0x8
    ...
    unsigned long long PrcbPad86;// Offset=0x6138 Size=0x8
    ...
    unsigned long long PrcbPad111[7];// Offset=0x6438 Size=0x38
    ...
    struct _KLOCK_QUEUE_HANDLE SelfmapLockHandle[4];// Offset=0x6980 Size=0x60
    unsigned char PrcbPad135[1184];// Offset=0x69e0 Size=0x4a0
...
struct _KPCR// Size=0x8040 (Id=43)
{
