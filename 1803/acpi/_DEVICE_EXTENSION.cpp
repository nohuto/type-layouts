...
struct _FDO_DEVICE_EXTENSION// Size=0x80 (Id=609)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_608 UPm1Status;// Offset=0x38 Size=0x4
    };
    struct _KDPC InterruptDpc;// Offset=0x40 Size=0x40
};

struct _PCI_FILTER_EXTENSION// Size=0x14 (Id=607)
{
...
struct _FILTER_DEVICE_EXTENSION// Size=0x58 (Id=589)
{
    struct WORK_QUEUE_CONTEXT WorkContext;// Offset=0x0 Size=0x30
...
struct _PDO_DEVICE_EXTENSION// Size=0x30 (Id=606)
{
    struct WORK_QUEUE_CONTEXT WorkContext;// Offset=0x0 Size=0x30
};
...
struct _PROCESSOR_DEVICE_EXTENSION// Size=0x38 (Id=534)
{
...
struct _EC_DEVICE_EXTENSION// Size=0x20 (Id=507)
{
    struct EXTENSION_WORKER WorkQueue;// Offset=0x0 Size=0x18
...
struct _PCI_ROOT_BUS_DSM_CAPABILITY_STRUCTURE// Size=0x10 (Id=528)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=260)
{
    union // Size=0x4 (Id=0)
    {
...
union _unnamed_577// Size=0x4 (Id=577)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PCI_ROOT_BUS_OSC_CONTROL_FIELD// Size=0x4 (Id=578)
{
    union _unnamed_577 u;// Offset=0x0 Size=0x4
};

struct _PCI_ROOT_EXTENSION// Size=0x98 (Id=497)
{
    struct EXTENSION_WORKER WorkQueue;// Offset=0x0 Size=0x18
...
struct _PROCESSOR_CONTAINER_EXTENSION// Size=0x58 (Id=426)
{
    struct EXTENSION_WORKER WorkQueue;// Offset=0x0 Size=0x18
...
struct _ACPI_POWER_INFO// Size=0xe8 (Id=612)
{
...
struct _WAKE_EVENT_DEVICE_CONTEXT// Size=0x20 (Id=545)
{
...
struct _unnamed_400// Size=0x8 (Id=400)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _DEVICE_EXTENSION// Size=0x3c0 (Id=401)
{
    ...
    union // Size=0x8 (Id=0)
    {
        ...
        struct _unnamed_400 AuxiliaryUFlags;// Offset=0x3b8 Size=0x8
    };
};
