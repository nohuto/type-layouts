struct _unnamed_448// Size=0x4 (Id=448)
{
...
struct FAN_EXTENSION// Size=0xa0 (Id=449)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_448 UFlags;// Offset=0x20 Size=0x4
    };
    struct _LIST_ENTRY Link;// Offset=0x28 Size=0x10
    struct _LIST_ENTRY IrpList;// Offset=0x38 Size=0x10
    struct _NSObjRef * FstMethod;// Offset=0x48 Size=0x8
    struct _ObjData FanStatus;// Offset=0x50 Size=0x28
    unsigned long PriorControl;// Offset=0x78 Size=0x4
    unsigned char FanEngaged;// Offset=0x7c Size=0x1
    unsigned long Stamp;// Offset=0x80 Size=0x4
    struct _KEVENT StopEvent;// Offset=0x88 Size=0x18
};
