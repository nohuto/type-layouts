...
struct _unnamed_677// Size=0x10 (Id=677)
{
...
struct _unnamed_678// Size=0x20 (Id=678)
{
...
struct _unnamed_679// Size=0x28 (Id=679)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=680)
{
    struct _unnamed_672 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_673 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_675 AcquireForSectionSynchronization;// Offset=0x0 Size=0x10
    struct _unnamed_677 NotifyStreamFileObject;// Offset=0x0 Size=0x10
    struct _unnamed_678 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_679 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=650)
{
