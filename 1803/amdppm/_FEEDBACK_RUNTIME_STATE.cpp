struct _DIFFERENTIAL_FEEDBACK_STATE// Size=0x40 (Id=479)
{
...
struct _FEEDBACK_RUNTIME_STATE// Size=0x50 (Id=355)
{
    struct _FDO_DATA * DevExt;// Offset=0x0 Size=0x8
    struct _DIFFERENTIAL_FEEDBACK_STATE HardwareFeedback;// Offset=0x8 Size=0x40
    unsigned long NominalFrequency;// Offset=0x48 Size=0x4
};
