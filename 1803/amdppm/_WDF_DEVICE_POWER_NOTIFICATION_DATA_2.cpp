...
union _unnamed_401// Size=0x8 (Id=401)
{
    struct _unnamed_399 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_400 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_399 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=238)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_401 Data;// Offset=0x4 Size=0x8
};
