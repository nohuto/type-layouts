...
struct _unnamed_381// Size=0x8 (Id=381)
{
...
union _unnamed_383// Size=0x8 (Id=383)
{
    struct _unnamed_381 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_382 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_381 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=237)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_383 Data;// Offset=0x4 Size=0x8
};
