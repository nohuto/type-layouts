union PCI_MSI_CAPABILITY::_unnamed_1306// Size=0x10 (Id=1306)
{
    struct <unnamed-type-Option32Bit>// Size=0xc (Id=16526)
    {
    ...
    struct PCI_MSI_CAPABILITY::_unnamed_1307::<unnamed-type-Option32Bit> Option32Bit;// Offset=0x0 Size=0xc
    struct <unnamed-type-Option64Bit>// Size=0x10 (Id=16532)
    {
    ...
    struct PCI_MSI_CAPABILITY::_unnamed_1308::<unnamed-type-Option64Bit> Option64Bit;// Offset=0x0 Size=0x10
};
