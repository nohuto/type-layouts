...
struct _REFERENCE// Size=0x10 (Id=459)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=723)
{
    union // Size=0x4 (Id=0)
    {
...
union _ULARGE_INTEGER// Size=0x8 (Id=73)
{
    ...
    struct <unnamed-type-u>// Size=0x8 (Id=14000)
    {
        unsigned long LowPart;// Offset=0x0 Size=0x4
        unsigned long HighPart;// Offset=0x4 Size=0x4
    };
...
struct _KTIMER// Size=0x40 (Id=1310)
{
...
struct _NDIS_TIMER// Size=0x80 (Id=460)
{
...
struct _NDIS_PM_WAKE_UP_CAPABILITIES// Size=0xc (Id=857)
{
...
struct _NDIS_PNP_CAPABILITIES// Size=0x10 (Id=462)
{
    unsigned long Flags;// Offset=0x0 Size=0x4
    struct _NDIS_PM_WAKE_UP_CAPABILITIES WakeUpCapabilities;// Offset=0x4 Size=0xc
};

struct _NDIS_PM_CAPABILITIES// Size=0x3c (Id=464)
{
...
struct _NDIS_PM_PARAMETERS// Size=0x14 (Id=465)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=466)
{
...
struct _NDIS_MINIPORT_WORK_ITEM// Size=0x18 (Id=1218)
{
...
struct _KBUGCHECK_CALLBACK_RECORD// Size=0x40 (Id=467)
{
...
struct _NDIS_RECEIVE_SCALE_CAPABILITIES// Size=0x14 (Id=319)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_RESTART_GENERAL_ATTRIBUTES// Size=0x58 (Id=328)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_M_PERIODIC_RECEIVES// Size=0x90 (Id=471)
{
...
struct _NDIS_PCI_DEVICE_CUSTOM_PROPERTIES// Size=0x34 (Id=472)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_OFFLOAD_REG// Size=0x4 (Id=475)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _NDIS_EVENT// Size=0x18 (Id=476)
{
...
struct _NDIS_PM_ADMIN_CONFIG// Size=0x4 (Id=478)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _KSEMAPHORE// Size=0x20 (Id=480)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
union _NET_LUID_LH// Size=0x8 (Id=387)
{
    unsigned long long Value;// Offset=0x0 Size=0x8
    struct <unnamed-type-Info>// Size=0x8 (Id=12630)
    {
...
struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=749)
{
...
struct _IO_REMOVE_LOCK// Size=0x20 (Id=481)
{
...
struct _PROCESSOR_NUMBER// Size=0x4 (Id=483)
{
...
struct _ULONG_REFERENCE// Size=0x10 (Id=484)
{
    unsigned long long SpinLock;// Offset=0x0 Size=0x8
...
struct _NDIS_D0_SIGNAL_WORK_ITEM// Size=0x58 (Id=485)
{
...
struct _VPCI_INVALIDATE_BLOCK_OUTPUT// Size=0x8 (Id=486)
{
...
struct _NDIS_MINIPORT_BLOCK// Size=0x16b8 (Id=364)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    ...
    struct _NDIS_REQUEST * LastRequest;// Offset=0x730 Size=0x8
    void * FakeMac;// Offset=0x738 Size=0x8
    unsigned long LockDbg;// Offset=0x740 Size=0x4
    unsigned long LockDbgX;// Offset=0x744 Size=0x4
    ...
    unsigned long RecvLockDbg;// Offset=0x7e8 Size=0x4
    void  ( * NextSendPacketsHandler)(void * ,struct _NDIS_PACKET ** ,unsigned int );// Offset=0x7f0 Size=0x8
    void  ( * FinalSendPacketsHandler)(void * ,struct _NDIS_PACKET ** ,unsigned int );// Offset=0x7f8 Size=0x8
    struct _NDIS_FILTER_BLOCK * LowestFilter;// Offset=0x800 Size=0x8
    struct _NDIS_FILTER_BLOCK * HighestFilter;// Offset=0x808 Size=0x8
    void * ShutdownContext;// Offset=0x810 Size=0x8
    void  ( * ShutdownHandler)(void * );// Offset=0x818 Size=0x8
    struct _KBUGCHECK_CALLBACK_RECORD BugcheckCallbackRecord;// Offset=0x820 Size=0x40
    void  ( * TopIndicateNetBufferListsHandler)(void * ,struct _NET_BUFFER_LIST * ,unsigned long ,unsigned long ,unsigned long );// Offset=0x860 Size=0x8
    void  ( * TopIndicateLoopbackNetBufferListsHandler)(void * ,struct _NET_BUFFER_LIST * ,unsigned long ,unsigned long ,unsigned long );// Offset=0x868 Size=0x8
    void  ( * Ndis5PacketIndicateHandler)(void * ,struct _NDIS_PACKET ** ,unsigned int );// Offset=0x870 Size=0x8
    void  ( * MiniportReturnPacketHandler)(void * ,struct _NDIS_PACKET * );// Offset=0x878 Size=0x8
    void * MiniportReturnPacketContext;// Offset=0x880 Size=0x8
    void  ( * SynchronousReturnPacketHandler)(void * ,struct _NDIS_PACKET * );// Offset=0x888 Size=0x8
    void * SynchronousReturnPacketContext;// Offset=0x890 Size=0x8
    struct _LIST_ENTRY OidRequestList;// Offset=0x898 Size=0x10
    struct _NDIS_OID_REQUEST * PendingOidRequest;// Offset=0x8a8 Size=0x8
    struct _NDIS_OID_REQUEST * ProcessedOidRequest;// Offset=0x8b0 Size=0x8
    struct _NDIS_OID_REQUEST * HookedOidRequest;// Offset=0x8b8 Size=0x8
    void * NextCoOidRequestHandle;// Offset=0x8c0 Size=0x8
    unsigned long Ndis6ProtocolsBound;// Offset=0x8c8 Size=0x4
    unsigned long PmodeOpen6;// Offset=0x8cc Size=0x4
    enum _NDIS_MINIPORT_STATE State;// Offset=0x8d0 Size=0x4
    struct _KEVENT * AsyncOpCompletionEvent;// Offset=0x8d8 Size=0x8
    int AsyncOpCompletionStatus;// Offset=0x8e0 Size=0x4
    unsigned long long MaxXmitLinkSpeed;// Offset=0x8e8 Size=0x8
    unsigned long long MaxRcvLinkSpeed;// Offset=0x8f0 Size=0x8
    unsigned long SupportedPacketFilters;// Offset=0x8f8 Size=0x4
    struct _NDIS_MINIPORT_HANDLERS NoFilter;// Offset=0x900 Size=0xb8
    struct _NDIS_MINIPORT_HANDLERS Next;// Offset=0x9b8 Size=0xb8
    unsigned char ReceivePathEnabled;// Offset=0xa70 Size=0x1
    unsigned char NormalTopReceive;// Offset=0xa71 Size=0x1
    enum _NDIS_SEND_PATH_TYPE SendPathType;// Offset=0xa74 Size=0x4
    enum _NDIS_SEND_PATH_TYPE SavedSendPathType;// Offset=0xa78 Size=0x4
    unsigned char SavedReceivePathEnabled;// Offset=0xa7c Size=0x1
    unsigned long TimestampFlags;// Offset=0xa80 Size=0x4
    unsigned long FilterPnPFlags;// Offset=0xa84 Size=0x4
    unsigned long SupportedStatistics;// Offset=0xa88 Size=0x4
    struct _NDIS_RECEIVE_SCALE_CAPABILITIES RecvScaleCapabilities;// Offset=0xa8c Size=0x14
    struct _NDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES * GeneralAttributes;// Offset=0xaa0 Size=0x8
    struct _LIST_ENTRY PortList;// Offset=0xaa8 Size=0x10
    unsigned char * AllocatedPortIndices;// Offset=0xab8 Size=0x8
    unsigned long AllocatedPortIndicesLength;// Offset=0xac0 Size=0x4
    unsigned long NumberOfPorts;// Offset=0xac4 Size=0x4
    unsigned long NumberOfActivePorts;// Offset=0xac8 Size=0x4
    unsigned long long MiniportXmitLinkSpeed;// Offset=0xad0 Size=0x8
    unsigned long long MiniportRcvLinkSpeed;// Offset=0xad8 Size=0x8
    struct _NDIS_TIMER InitModeTimeoutTimer;// Offset=0xae0 Size=0x80
    struct _NDIS_WORK_ITEM InitModeTimeoutWorkItem;// Offset=0xb60 Size=0x50
    struct _KEVENT InitModeTimeoutTimerQueuedEvent;// Offset=0xbb0 Size=0x18
    unsigned long DataBackFillSize;// Offset=0xbc8 Size=0x4
    unsigned long ContextBackFillSize;// Offset=0xbcc Size=0x4
    struct _NDIS_RESTART_GENERAL_ATTRIBUTES TopFilterRestartAttributes;// Offset=0xbd0 Size=0x58
    struct _NDIS_RECEIVE_SCALE_CAPABILITIES TopRecvScaleCapabilities;// Offset=0xc28 Size=0x14
    unsigned long NsiOpenReferences;// Offset=0xc3c Size=0x4
    void * ProcessingOpen;// Offset=0xc40 Size=0x8
    struct _KEVENT * NsiRequestsCompletedEvent;// Offset=0xc48 Size=0x8
    enum _DEVICE_POWER_STATE QueryPowerDeviceState;// Offset=0xc50 Size=0x4
    unsigned char MinimumNdisMajorVersion;// Offset=0xc54 Size=0x1
    unsigned char MinimumNdisMinorVersion;// Offset=0xc55 Size=0x1
    struct _NDIS_MINIPORT_STATS * BottomIfStats;// Offset=0xc58 Size=0x8
    struct _NDIS_M_PERIODIC_RECEIVES PeriodicReceiveQueue;// Offset=0xc60 Size=0x90
    struct PNDIS_PER_PROCESSOR_SLOT__ * PeriodicReceivesNblCountIndex;// Offset=0xcf0 Size=0x8
    enum _NDIS_PORT_CONTROL_STATE DefaultSendControlState;// Offset=0xcf8 Size=0x4
    enum _NDIS_PORT_CONTROL_STATE DefaultRcvControlState;// Offset=0xcfc Size=0x4
    enum _NDIS_PORT_AUTHORIZATION_STATE DefaultSendAuthorizationState;// Offset=0xd00 Size=0x4
    enum _NDIS_PORT_AUTHORIZATION_STATE DefaultRcvAuthorizationState;// Offset=0xd04 Size=0x4
    enum _NDIS_PORT_CONTROL_STATE DefaultPortSendControlState;// Offset=0xd08 Size=0x4
    enum _NDIS_PORT_CONTROL_STATE DefaultPortRcvControlState;// Offset=0xd0c Size=0x4
    enum _NDIS_PORT_AUTHORIZATION_STATE DefaultPortSendAuthorizationState;// Offset=0xd10 Size=0x4
    enum _NDIS_PORT_AUTHORIZATION_STATE DefaultPortRcvAuthorizationState;// Offset=0xd14 Size=0x4
    struct _NDIS_PCI_DEVICE_CUSTOM_PROPERTIES PciDeviceCustomProperties;// Offset=0xd18 Size=0x34
    void  ( * TopNdis5PacketIndicateHandler)(void * ,struct _NDIS_PACKET ** ,unsigned int );// Offset=0xd50 Size=0x8
    unsigned long * ndisSupportedOidList;// Offset=0xd58 Size=0x8
    unsigned long ndisSupportedOidListLength;// Offset=0xd60 Size=0x4
    unsigned long MsiIntCount;// Offset=0xd64 Size=0x4
    struct _WORK_QUEUE_ITEM MiniportDpcWorkItem;// Offset=0xd68 Size=0x20
    unsigned long long InvalidFrames;// Offset=0xd88 Size=0x8
    long PagingPathCount;// Offset=0xd90 Size=0x4
    struct _LIST_ENTRY ReceiveQueueList;// Offset=0xd98 Size=0x10
    unsigned char * AllocatedQueueIndices;// Offset=0xda8 Size=0x8
    unsigned long AllocatedQueueIndicesLength;// Offset=0xdb0 Size=0x4
    unsigned long NumReceiveQueues;// Offset=0xdb4 Size=0x4
    struct _LIST_ENTRY ReceiveFilterList;// Offset=0xdb8 Size=0x10
    unsigned char * AllocatedReceiveFilterIndices;// Offset=0xdc8 Size=0x8
    unsigned long AllocatedReceiveFilterIndicesLength;// Offset=0xdd0 Size=0x4
    unsigned long NumReceiveFilters;// Offset=0xdd4 Size=0x4
    unsigned long EnabledReceiveFilterTypes;// Offset=0xdd8 Size=0x4
    unsigned long EnabledReceiveQueueTypes;// Offset=0xddc Size=0x4
    struct _NDIS_RECEIVE_FILTER_CAPABILITIES * ReceiveFilterHwCapabilities;// Offset=0xde0 Size=0x8
    struct _NDIS_RECEIVE_FILTER_CAPABILITIES * ReceiveFilterCurrentCapabilities;// Offset=0xde8 Size=0x8
    struct _NDIS_RECEIVE_FILTER_CAPABILITIES * TopReceiveFilterCurrentCapabilities;// Offset=0xdf0 Size=0x8
    struct _NDIS_NIC_SWITCH_CAPABILITIES * NicSwitchHwCapabilities;// Offset=0xdf8 Size=0x8
    struct _NDIS_NIC_SWITCH_CAPABILITIES * NicSwitchCurrentCapabilities;// Offset=0xe00 Size=0x8
    struct _NDIS_NIC_SWITCH_CAPABILITIES * TopNicSwitchCurrentCapabilities;// Offset=0xe08 Size=0x8
    struct _LIST_ENTRY SharedMemoryBlockList;// Offset=0xe10 Size=0x10
    int  ( * AllocateSharedMemoryHandler)(void * ,struct _NDIS_SHARED_MEMORY_PARAMETERS * ,void ** );// Offset=0xe20 Size=0x8
    void  ( * FreeSharedMemoryHandler)(void * ,void * );// Offset=0xe28 Size=0x8
    void * AllocateSharedMemoryContext;// Offset=0xe30 Size=0x8
    struct PCI_MSI_CAPABILITY MsiCaps;// Offset=0xe38 Size=0x18
    struct PCI_MSIX_CAPABILITY MsiXCaps;// Offset=0xe50 Size=0xc
    unsigned long long NumberOfIndirectionTableChanges;// Offset=0xe60 Size=0x8
    unsigned int PciDeviceSriovSupport;// Offset=0xe68 Size=0x4
    union // Size=0x1 (Id=0)
    {
        unsigned char BeginSavedFields;// Offset=0xe6c Size=0x1
        unsigned long NumUserOpens;// Offset=0xe6c Size=0x4
    };
    struct _NDIS_MINIPORT_OFFLOAD_REG OffloadRegistry;// Offset=0xe70 Size=0x4
    unsigned short MediaDisconnectTimeOut;// Offset=0xe74 Size=0x2
    unsigned short SGMapRegistersNeeded;// Offset=0xe76 Size=0x2
    unsigned long DriverVerifyFlags;// Offset=0xe78 Size=0x4
    unsigned long  ( * SetBusData)(void * ,unsigned long ,void * ,unsigned long ,unsigned long );// Offset=0xe80 Size=0x8
    unsigned long  ( * GetBusData)(void * ,unsigned long ,void * ,unsigned long ,unsigned long );// Offset=0xe88 Size=0x8
    void * BusDataContext;// Offset=0xe90 Size=0x8
    enum _INTERFACE_TYPE BusType;// Offset=0xe98 Size=0x4
    unsigned long BusNumber;// Offset=0xe9c Size=0x4
    unsigned long SlotNumber;// Offset=0xea0 Size=0x4
    struct _NDIS_EVENT OpenReadyEvent;// Offset=0xea8 Size=0x18
    unsigned long NumAdminOpens;// Offset=0xec0 Size=0x4
    struct _NDIS_M_DRIVER_BLOCK * DriverHandle;// Offset=0xec8 Size=0x8
    struct _NDIS_BIND_PATHS * BindPaths;// Offset=0xed0 Size=0x8
    enum _NDIS_PHYSICAL_MEDIUM MiniportPhysicalMediumType;// Offset=0xed8 Size=0x4
    void * SecurityDescriptor;// Offset=0xee0 Size=0x8
    struct _UNICODE_STRING BaseName;// Offset=0xee8 Size=0x10
    struct _UNICODE_STRING MiniportName;// Offset=0xef8 Size=0x10
    struct _DEVICE_OBJECT * DeviceObject;// Offset=0xf08 Size=0x8
    struct _DEVICE_OBJECT * PhysicalDeviceObject;// Offset=0xf10 Size=0x8
    struct _DEVICE_OBJECT * NextDeviceObject;// Offset=0xf18 Size=0x8
    struct _NDIS_MINIPORT_BLOCK * NextGlobalMiniport;// Offset=0xf20 Size=0x8
    struct _UNICODE_STRING * pAdapterInstanceName;// Offset=0xf28 Size=0x8
    unsigned long PnPCapabilities;// Offset=0xf30 Size=0x4
    enum _DEVICE_POWER_STATE CurrentDevicePowerState;// Offset=0xf34 Size=0x4
    unsigned long long PowerStateLock;// Offset=0xf38 Size=0x8
    enum _DEVICE_POWER_STATE DriverPowerState;// Offset=0xf40 Size=0x4
    enum _DEVICE_POWER_STATE PrevDriverPowerState;// Offset=0xf44 Size=0x4
    struct _NET_BUFFER_LIST * LowPowerRcvReturnNbls;// Offset=0xf48 Size=0x8
    unsigned long PendingReturnNBLCount;// Offset=0xf50 Size=0x4
    unsigned char SurpriseRemoveFlushedRcvReturnQueue;// Offset=0xf54 Size=0x1
    struct NDIS_NBL_TRACKER_HANDLE__ * LowPowerRcvReturnNblTracker;// Offset=0xf58 Size=0x8
    struct _NDIS_PM_ADMIN_CONFIG PMAdminConfig;// Offset=0xf60 Size=0x4
    struct _KSEMAPHORE PMPatternSemaphore;// Offset=0xf68 Size=0x20
    struct _KSEMAPHORE PMOffloadSemaphore;// Offset=0xf88 Size=0x20
    void * BusInterface;// Offset=0xfa8 Size=0x8
    unsigned short InstanceNumber;// Offset=0xfb0 Size=0x2
    void * ConfigurationHandle;// Offset=0xfb8 Size=0x8
    struct _GUID InterfaceGuid;// Offset=0xfc0 Size=0x10
    union _NET_LUID_LH NetLuid;// Offset=0xfd0 Size=0x8
    unsigned char IfBlockAvailable;// Offset=0xfd8 Size=0x1
    struct _NDIS_IF_BLOCK * IfBlock;// Offset=0xfe0 Size=0x8
    struct _KEVENT * IfBlockPointerRefZeroEvent;// Offset=0xfe8 Size=0x8
    unsigned int IfIndex;// Offset=0xff0 Size=0x4
    enum _NET_IF_ADMIN_STATUS AdminStatus;// Offset=0xff4 Size=0x4
    enum _NET_IF_OPER_STATUS OperStatus;// Offset=0xff8 Size=0x4
    unsigned long OperStatusFlags;// Offset=0xffc Size=0x4
    union // Size=0x8 (Id=0)
    {
        int  ( * SendHandler)(void * ,struct _NDIS_PACKET * ,unsigned int );// Offset=0x1000 Size=0x8
        int  ( * WanSendHandler)(void * ,void * ,struct _NDIS_WAN_PACKET * );// Offset=0x1000 Size=0x8
    };
    struct NDIS_NBL_TRACKER_HANDLE__ * NblTracker;// Offset=0x1008 Size=0x8
    struct _DEVICE_RESET_INTERFACE_STANDARD * ReenumerateSelfInterface;// Offset=0x1010 Size=0x8
    struct _NDIS_MINIPORT_OFFLOAD * Offload;// Offset=0x1018 Size=0x8
    void * NDKBlock;// Offset=0x1020 Size=0x8
    void * AddDeviceContext;// Offset=0x1028 Size=0x8
    struct _IO_REMOVE_LOCK RemoveLock;// Offset=0x1030 Size=0x20
    struct _UNICODE_STRING DevinterfaceNetSymbolicLinkName;// Offset=0x1050 Size=0x10
    unsigned long PhysicalMediumInInf;// Offset=0x1060 Size=0x4
    class wistd::unique_ptr<Rtl::KString,wistd::default_delete<Rtl::KString> > ExportName;// Offset=0x1068 Size=0x8
    class wistd::unique_ptr<Rtl::KString,wistd::default_delete<Rtl::KString> > FilterClass;// Offset=0x1070 Size=0x8
    void * StatusProcessingThread;// Offset=0x1078 Size=0x8
    unsigned long StatusProcessingDbgX;// Offset=0x1080 Size=0x4
    struct _UNICODE_STRING FdoName;// Offset=0x1088 Size=0x10
    struct _KEVENT PowerD0CompleteEvent;// Offset=0x1098 Size=0x18
    long LastD0CompleteStatus;// Offset=0x10b0 Size=0x4
    enum _NDIS_MINIPORT_EVENT LastD0Reason;// Offset=0x10b4 Size=0x2
    unsigned long DirectOidRequestCount;// Offset=0x10b8 Size=0x4
    struct _KEVENT * AllDirectRequestsCompletedEvent;// Offset=0x10c0 Size=0x8
    struct _NDIS_HD_SPLIT_CURRENT_CONFIG * HDSplitCurrentConfig;// Offset=0x10c8 Size=0x8
    void * MSIXConfigContext;// Offset=0x10d0 Size=0x8
    long  ( * SetMSIXTableEntry)(void * ,unsigned long ,unsigned long );// Offset=0x10d8 Size=0x8
    long  ( * MaskMSIXTableEntry)(void * ,unsigned long );// Offset=0x10e0 Size=0x8
    long  ( * UnmaskMSIXTableEntry)(void * ,unsigned long );// Offset=0x10e8 Size=0x8
    struct _WORK_QUEUE_ITEM DevicePowerStateWorkItem;// Offset=0x10f0 Size=0x20
    struct _WORK_QUEUE_ITEM SystemPowerStateWorkItem;// Offset=0x1110 Size=0x20
    struct _NDIS_RECEIVE_QUEUE_BLOCK * DefaultReceiveQueue;// Offset=0x1130 Size=0x8
    unsigned long MaxNumRssProcessors;// Offset=0x1138 Size=0x4
    struct _PROCESSOR_NUMBER RssBaseProcessor;// Offset=0x113c Size=0x4
    struct _PROCESSOR_NUMBER RssMaxProcessor;// Offset=0x1140 Size=0x4
    enum _NDIS_RSS_PROFILE RssProfile;// Offset=0x1144 Size=0x4
    unsigned short NumaNodeId;// Offset=0x1148 Size=0x2
    unsigned short * NumaDistances;// Offset=0x1150 Size=0x8
    struct _UNICODE_STRING * pModifiedInstanceName;// Offset=0x1158 Size=0x8
    unsigned long SyncFlags;// Offset=0x1160 Size=0x4
    unsigned long WSyncFlags;// Offset=0x1164 Size=0x4
    unsigned long InterlockedFlags;// Offset=0x1168 Size=0x4
    struct _ULONG_REFERENCE Ref;// Offset=0x1170 Size=0x10
    struct _NDIS_SELECTIVE_SUSPEND * SelectiveSuspend;// Offset=0x1180 Size=0x8
    struct _NDIS_MINIPORT_AOAC * AoAc;// Offset=0x1188 Size=0x8
    enum _NDIS_PM_WAKE_REASON_TYPE LastWakeReason;// Offset=0x1190 Size=0x4
    struct NDIS_EVENT_LOG_HANDLE__ * PnpEventLog;// Offset=0x1198 Size=0x8
    struct _NDIS_D0_SIGNAL_WORK_ITEM D0CompleteSignalWorkItem;// Offset=0x11a0 Size=0x58
    struct _NDIS_PHYSICAL_PERFORMANCE_COUNTERS * PhysicalPerformanceCounters;// Offset=0x11f8 Size=0x8
    union _LARGE_INTEGER TimeOfInitialization;// Offset=0x1200 Size=0x8
    union _LARGE_INTEGER LastSystemSleepTime;// Offset=0x1208 Size=0x8
    unsigned long long TotalSystemSleepTimeMs;// Offset=0x1210 Size=0x8
    struct _NDIS_SRIOV_CAPABILITIES * SriovHwCapabilities;// Offset=0x1218 Size=0x8
    struct _NDIS_SRIOV_CAPABILITIES * SriovCurrentCapabilities;// Offset=0x1220 Size=0x8
    unsigned long long InvalidateBlockMask;// Offset=0x1228 Size=0x8
    struct _IRP * InvalidateBlockIoctlPf;// Offset=0x1230 Size=0x8
    struct _IRP * InvalidateBlockIoctlVf;// Offset=0x1238 Size=0x8
    struct _VPCI_INVALIDATE_BLOCK_OUTPUT InvalidateBlockVfParams;// Offset=0x1240 Size=0x8
    struct _KEVENT InvalidateBlockEvent;// Offset=0x1248 Size=0x18
    unsigned short InvalidateVfId;// Offset=0x1260 Size=0x2
    unsigned char InvalidateBlockCancelling;// Offset=0x1262 Size=0x1
    struct _NDIS_PF_BLOCK * PFBlock;// Offset=0x1268 Size=0x8
    unsigned long NumSwitches;// Offset=0x1270 Size=0x4
    struct _LIST_ENTRY NicSwitchList;// Offset=0x1278 Size=0x10
    unsigned long NumAllocatedVFs;// Offset=0x1288 Size=0x4
    struct _LIST_ENTRY VFList;// Offset=0x1290 Size=0x10
    unsigned long NumActiveVPorts;// Offset=0x12a0 Size=0x4
    struct _LIST_ENTRY VPortList;// Offset=0x12a8 Size=0x10
    unsigned char * AllocatedVPortIndices;// Offset=0x12b8 Size=0x8
    unsigned long AllocatedVPortIndicesLength;// Offset=0x12c0 Size=0x4
    unsigned long  ( * SetVirtualFunctionData)(void * ,unsigned short ,void * ,unsigned long ,unsigned long );// Offset=0x12c8 Size=0x8
    unsigned long  ( * GetVirtualFunctionData)(void * ,unsigned short ,void * ,unsigned long ,unsigned long );// Offset=0x12d0 Size=0x8
    long  ( * EnableVirtualization)(void * ,unsigned short ,unsigned char ,unsigned char ,unsigned char );// Offset=0x12d8 Size=0x8
    long  ( * GetVirtualDeviceLocation)(void * ,unsigned short ,unsigned short * ,unsigned char * ,unsigned char * );// Offset=0x12e0 Size=0x8
    long  ( * GetVirtualFunctionProbedBars)(void * ,unsigned long * );// Offset=0x12e8 Size=0x8
    void * VirtInterfaceContext;// Offset=0x12f0 Size=0x8
    struct _UNICODE_STRING DevinterfaceVirtSymbolicLinkName;// Offset=0x12f8 Size=0x10
    void  ( * VpciInterfaceDereference)(void * );// Offset=0x1308 Size=0x8
    long  ( * WriteVfConfigBlock)(void * ,unsigned long ,void * ,unsigned long );// Offset=0x1310 Size=0x8
    long  ( * ReadVfConfigBlock)(void * ,unsigned long ,void * ,unsigned long );// Offset=0x1318 Size=0x8
    void * VpciInterfaceContext;// Offset=0x1320 Size=0x8
    unsigned int VfSerialNumber;// Offset=0x1328 Size=0x4
    struct _LUID SriovLuid;// Offset=0x132c Size=0x8
    struct NDIS_REFCOUNT_HANDLE__ * RefCountTracker;// Offset=0x1338 Size=0x8
    struct NDIS_REFCOUNT_HANDLE__ * NsiRefCountTracker;// Offset=0x1340 Size=0x8
    struct _NDIS_QOS_CAPABILITIES * QosHwCapabilities;// Offset=0x1348 Size=0x8
    struct _NDIS_QOS_CAPABILITIES * QosCurrentCapabilities;// Offset=0x1350 Size=0x8
    struct _NDIS_QOS_PARAMETERS * QosOperationalParameters;// Offset=0x1358 Size=0x8
    unsigned long QosOperationalParametersBufferSize;// Offset=0x1360 Size=0x4
    struct _NDIS_QOS_PARAMETERS * QosRemoteParameters;// Offset=0x1368 Size=0x8
    unsigned long QosRemoteParametersBufferSize;// Offset=0x1370 Size=0x4
    unsigned long long DeviceFlags;// Offset=0x1378 Size=0x8
    void * VerifierContext;// Offset=0x1380 Size=0x8
    struct _WORK_QUEUE_ITEM SurpriseRemovalWorkItem;// Offset=0x1388 Size=0x20
    struct Ndis::BindStack Bindings;// Offset=0x13a8 Size=0x68
    struct Ndis::BindEngine BindEngine;// Offset=0x1410 Size=0x78
    class Rtl::KNeutralLock<enum NDIS_MINIPORT_POLICY_OWNER> MiniportOwner;// Offset=0x1488 Size=0x28
    bool PmInterruptedByPnp;// Offset=0x14b0 Size=0x1
    bool DoNotBlockOnMiniportLock;// Offset=0x14b1 Size=0x1
    bool PoFxDStateReportingEnabled;// Offset=0x14b2 Size=0x1
    struct NDIS_MINIPORT_HOOK_ADAPTER_HANDLE__ * HookAdapterHandle;// Offset=0x14b8 Size=0x8
    struct _WORK_QUEUE_ITEM InterfaceUpdateWorkItem;// Offset=0x14c0 Size=0x20
    bool InterfaceUpdateInProgress;// Offset=0x14e0 Size=0x1
    bool MacAddressUpdateQueued;// Offset=0x14e1 Size=0x1
    bool MtuUpdateQueued;// Offset=0x14e2 Size=0x1
    struct _IF_PHYSICAL_ADDRESS_LH PendingMacAddress;// Offset=0x14e4 Size=0x22
    unsigned long PendingMtuSize;// Offset=0x1508 Size=0x4
    wchar_t * PnPInstanceId;// Offset=0x1510 Size=0x8
    struct RECORDER_LOG__ * BlackBoxHandle;// Offset=0x1518 Size=0x8
    struct _KEVENT * PowerCompleteEvent;// Offset=0x1520 Size=0x8
    long PowerCompleteStatus;// Offset=0x1528 Size=0x4
    struct WORKITEM_WITH_IRP DevicePowerOnWorkItem;// Offset=0x1530 Size=0x28
    struct WORKITEM_WITH_IRP DevicePowerDownWorkItem;// Offset=0x1558 Size=0x28
    class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,-1,std::nullptr_t> > > PendingOidWatchdog;// Offset=0x1580 Size=0x8
    class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,-1,std::nullptr_t> > > HookedOidWatchdog;// Offset=0x1588 Size=0x8
    class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,-1,std::nullptr_t> > > ReenumerateWatchdog;// Offset=0x1590 Size=0x8
    struct _NDIS_PD_BLOCK * PDBlock;// Offset=0x1598 Size=0x8
    void * PdcHandle;// Offset=0x15a0 Size=0x8
    struct _NDIS_TIMER PdcTaskClientDisableTimer;// Offset=0x15a8 Size=0x80
    struct _NDIS_WORK_ITEM PdcTaskClientDisableWorkItem;// Offset=0x1628 Size=0x50
    long PdcTaskClientMode;// Offset=0x1678 Size=0x4
    unsigned long ModernStandbyWoLMagicPacketEnable;// Offset=0x167c Size=0x4
    struct _NDIS_RSS_DPC_WORKER_CONTEXT * RssV2Context;// Offset=0x1680 Size=0x8
    long RssV2CompletionCount;// Offset=0x1688 Size=0x4
    struct _KEVENT RssV2CompletionEvent;// Offset=0x1690 Size=0x18
    struct _LIST_ENTRY SynchronousOidCalls;// Offset=0x16a8 Size=0x10
