...
struct PCI_MSI_CAPABILITY// Size=0x18 (Id=473)
{
    union // Size=0x4 (Id=0)
    {
        struct _PCI_CAPABILITIES_HEADER Header;// Offset=0x0 Size=0x2
        struct _PCI_MSI_MESSAGE_CONTROL// Size=0x2 (Id=16509)
        {
        ...
        union <unnamed-type-MessageAddressLower>// Size=0x4 (Id=16517)
        {
            struct _PCI_MSI_MESSAGE_ADDRESS// Size=0x4 (Id=16518)
            {
    ...
    union // Size=0xc (Id=0)
    {
        struct PCI_MSI_CAPABILITY::_unnamed_1307::<unnamed-type-Option32Bit> Option32Bit;// Offset=0x8 Size=0xc
        struct PCI_MSI_CAPABILITY::_unnamed_1308::<unnamed-type-Option64Bit> Option64Bit;// Offset=0x8 Size=0x10
    };
};
