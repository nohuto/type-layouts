struct _NDIS_PM_PACKET_PATTERN// Size=0x18 (Id=711)
{
...
struct _NDIS_PM_PROTOCOL_OFFLOAD// Size=0xf0 (Id=1318)
{
    union // Size=0x9c (Id=0)
    {
        struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
        ...
        union _PROTOCOL_OFFLOAD_PARAMETERS// Size=0x50 (Id=10156)
        {
            struct _IPV4_ARP_PARAMETERS// Size=0x14 (Id=10157)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
            ...
            struct _IPV6_NS_PARAMETERS// Size=0x4c (Id=10164)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
            ...
            struct _DOT11_RSN_REKEY_PARAMETERS// Size=0x30 (Id=10172)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
...
union _NDIS_PACKET_PATTERN_ENTRY::_unnamed_1699// Size=0xf0 (Id=1699)
{
