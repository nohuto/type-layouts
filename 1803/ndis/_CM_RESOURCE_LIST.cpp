...
struct _CM_PARTIAL_RESOURCE_DESCRIPTOR// Size=0x14 (Id=1129)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x10 (Id=2203)
        {
            ...
            struct <unnamed-type-MessageInterrupt>// Size=0x10 (Id=2218)
            {
                struct _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-MessageInterrupt>::_unnamed_1626::<unnamed-type-Raw> Raw;// Offset=0x0 Size=0x10
                struct _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-MessageInterrupt>::_unnamed_1627::<unnamed-type-Translated> Translated;// Offset=0x0 Size=0x10
            };
            ...
            struct <unnamed-type-DmaV3>// Size=0xc (Id=2231)
            {
                unsigned long Channel;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-DevicePrivate>// Size=0xc (Id=2239)
            {
            ...
            struct <unnamed-type-BusNumber>// Size=0xc (Id=2243)
            {
            ...
            struct <unnamed-type-DeviceSpecificData>// Size=0xc (Id=2248)
            {
...
struct _CM_PARTIAL_RESOURCE_LIST// Size=0x1c (Id=1522)
{
...
struct _CM_FULL_RESOURCE_DESCRIPTOR// Size=0x24 (Id=887)
{
...
struct _CM_RESOURCE_LIST// Size=0x28 (Id=1057)
{
