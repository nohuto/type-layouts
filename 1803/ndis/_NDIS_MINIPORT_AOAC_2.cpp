...
struct _NDIS_SS_STOP_FLAGS// Size=0x4 (Id=1137)
{
    union // Size=0x4 (Id=0)
    {
...
struct _NDIS_AOAC_COMPONENT_REF_TIME// Size=0x10 (Id=1855)
{
    unsigned long long TotalRefTime;// Offset=0x0 Size=0x8
    unsigned long long CurrentRefStartTime;// Offset=0x8 Size=0x8
};

struct _NDIS_MINIPORT_CS_TRAFFIC_STATS// Size=0x30 (Id=1040)
{
...
struct _NDIS_MINIPORT_AOAC// Size=0x490 (Id=877)
{
