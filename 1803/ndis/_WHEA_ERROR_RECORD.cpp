...
union _WHEA_ERROR_RECORD_HEADER_VALIDBITS// Size=0x4 (Id=594)
{
...
union _WHEA_TIMESTAMP// Size=0x8 (Id=539)
{
...
union _WHEA_ERROR_RECORD_HEADER_FLAGS// Size=0x4 (Id=682)
{
    struct // Size=0x4 (Id=0)
    {
...
union _WHEA_PERSISTENCE_INFO// Size=0x8 (Id=918)
{
    struct // Size=0x8 (Id=0)
    {
...
union _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_VALIDBITS// Size=0x1 (Id=1149)
{
...
union _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_FLAGS// Size=0x4 (Id=1064)
{
    struct // Size=0x4 (Id=0)
    {
