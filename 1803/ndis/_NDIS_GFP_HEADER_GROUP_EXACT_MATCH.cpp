...
struct _NDIS_GFP_HEADER_GROUP_EXACT_MATCH// Size=0x58 (Id=1354)
{
    union // Size=0x4e (Id=0)
    {
        ...
        union <unnamed-type-IPAddress>// Size=0x20 (Id=6577)
        {
            struct <unnamed-type-IPv4Address>// Size=0x8 (Id=6578)
            {
            ...
            struct <unnamed-type-IPv6Address>// Size=0x20 (Id=6582)
            {
        ...
        union <unnamed-type-TransportOrEncapsulation>// Size=0x8 (Id=6589)
        {
