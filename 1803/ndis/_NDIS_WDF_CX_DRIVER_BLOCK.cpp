...
struct _NDIS_WDF_CX_CHARACTERISTICS// Size=0x68 (Id=419)
{
...
struct _NDIS_WDF_CX_DRIVER_BLOCK// Size=0x90 (Id=442)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    ...
    struct _NDIS_WDF_CX_CHARACTERISTICS Chars;// Offset=0x20 Size=0x68
    unsigned long ClientCount;// Offset=0x88 Size=0x4
    enum _NDIS_WDF_CX_DRIVER_STATE State;// Offset=0x8c Size=0x1
};
