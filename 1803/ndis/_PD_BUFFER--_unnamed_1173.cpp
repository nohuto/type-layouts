...
union _PD_BUFFER::_unnamed_1173// Size=0x30 (Id=1173)
{
    struct <unnamed-type-MetaDataV0>// Size=0x30 (Id=12914)
    {
    ...
    struct _PD_BUFFER::_unnamed_1174::<unnamed-type-MetaDataV0> MetaDataV0;// Offset=0x0 Size=0x30
};
