...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=942)
{
...
struct _IRP// Size=0xd0 (Id=83)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=4284)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=4302)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=4303)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=4314)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=4315)
            {
