...
struct _NDIS_OID_REQUEST_FLAGS// Size=0x4 (Id=806)
{
...
struct _NDIS_OID_REQUEST_RESERVED// Size=0x60 (Id=443)
{
    ...
    union // Size=0x48 (Id=0)
    {
        ...
        struct _NDIS_OID_REQUEST_RESERVED::_unnamed_963::<unnamed-type-CoNdis> CoNdis;// Offset=0x28 Size=0x20
    };
    union // Size=0x60 (Id=0)
    {
        ...
        struct _NDIS_OID_REQUEST_RESERVED::_unnamed_967::<unnamed-type-IovContext> IovContext;// Offset=0x48 Size=0x10
        struct _NDIS_OID_REQUEST_RESERVED::_unnamed_968::<unnamed-type-PMContext> PMContext;// Offset=0x48 Size=0x18
    };
};
