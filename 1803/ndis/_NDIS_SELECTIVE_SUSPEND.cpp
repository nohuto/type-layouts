...
struct _NDIS_IRP_WORK_ITEM// Size=0x30 (Id=864)
{
...
struct _NDIS_SS_IDLE_FLAGS// Size=0x4 (Id=784)
{
    union // Size=0x4 (Id=0)
    {
...
struct _NDIS_SS_CONTROL_OPS// Size=0x4 (Id=792)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _NBL_QUEUE// Size=0x10 (Id=178)
{
...
union _NDIS_SS_RESUME_REASON// Size=0x4 (Id=1233)
{
...
struct _NDIS_NAPS_TELEMETRY_REASON_DATA// Size=0x10 (Id=1828)
{
...
struct _NDIS_NAPS_TELEMETRY_OID_DATA// Size=0xc (Id=1849)
{
    unsigned short WakeCount;// Offset=0x0 Size=0x2
    unsigned short BusyCount;// Offset=0x2 Size=0x2
...
struct _NDIS_NAPS_TELEMETRY_DATA// Size=0x390 (Id=1517)
{
...
struct _NDIS_SELECTIVE_SUSPEND// Size=0x650 (Id=779)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
    unsigned long IdleTimeout;// Offset=0x8 Size=0x4
    unsigned long IdleTimeoutScreenOff;// Offset=0xc Size=0x4
