struct Ndis::BindEngine// Size=0x78 (Id=487)
{
    void BindEngine(struct Ndis::BindEngine & );
    void BindEngine();
    union // Size=0x8a4 (Id=0)
    {
        ...
        void EndPolicyUpdates();// Offset=0x0 Size=0xfc
        void ApplyBindChanges(enum CallRunMode ,bool );// Offset=0x0 Size=0xe1
        void SetDirty();
        ...
        bool Iterate();// Offset=0x0 Size=0x8a4
        void ApplyRules();// Offset=0x0 Size=0x1bf
