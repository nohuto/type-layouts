...
struct _NDIS_GFT_HEADER_GROUP_TRANSPOSITION// Size=0x58 (Id=1561)
{
    union // Size=0x4f (Id=0)
    {
        ...
        union <unnamed-type-IPAddress>// Size=0x20 (Id=6868)
        {
            struct <unnamed-type-IPv4Address>// Size=0x8 (Id=6869)
            {
            ...
            struct <unnamed-type-IPv6Address>// Size=0x20 (Id=6873)
            {
        ...
        union <unnamed-type-TransportOrEncapsulation>// Size=0x8 (Id=6881)
        {
