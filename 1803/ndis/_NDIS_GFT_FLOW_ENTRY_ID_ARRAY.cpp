...
struct _NDIS_GFT_FLOW_ENTRY_ID_ARRAY// Size=0x1c (Id=1615)
{
    union // Size=0x10 (Id=0)
    {
        ...
        union <unnamed-type-IdArray>// Size=0xc (Id=6825)
        {
            struct <unnamed-type-FlowEntryIdArray>// Size=0xc (Id=6826)
            {
            ...
            struct <unnamed-type-FlowEntryIdAndCounterArray>// Size=0xc (Id=6831)
            {
