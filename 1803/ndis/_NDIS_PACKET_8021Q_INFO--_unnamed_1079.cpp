union _NDIS_PACKET_8021Q_INFO::_unnamed_1079// Size=0x8 (Id=1079)
{
    struct <unnamed-type-TagHeader>// Size=0x4 (Id=9707)
    {
    ...
    struct _NDIS_PACKET_8021Q_INFO::_unnamed_1080::<unnamed-type-TagHeader> TagHeader;// Offset=0x0 Size=0x4
