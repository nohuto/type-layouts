struct _NDIS_RESTART_ATTRIBUTES// Size=0x20 (Id=325)
{
...
struct _NDIS_PROTOCOL_RESTART_PARAMETERS// Size=0x38 (Id=320)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct NDIS_RESTART_INFORMATION// Size=0xe0 (Id=318)
{
