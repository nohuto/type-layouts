...
struct PCI_X_CAPABILITY// Size=0x8 (Id=3250)
{
    union // Size=0x4 (Id=0)
    {
        struct _PCI_CAPABILITIES_HEADER Header;// Offset=0x0 Size=0x2
        union <unnamed-type-Command>// Size=0x2 (Id=73325)
        {
            struct <unnamed-type-bits>// Size=0x2 (Id=73326)
            {
        ...
        union <unnamed-type-Status>// Size=0x4 (Id=73335)
        {
            struct <unnamed-type-bits>// Size=0x4 (Id=73336)
            {
