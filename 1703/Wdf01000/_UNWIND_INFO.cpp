struct _unnamed_303// Size=0x2 (Id=303)
{
...
union _UNWIND_CODE// Size=0x2 (Id=304)
{
    ...
    struct _unnamed_303 EpilogueCode;// Offset=0x0 Size=0x2
    unsigned short FrameOffset;// Offset=0x0 Size=0x2
};

struct _UNWIND_INFO// Size=0x6 (Id=312)
{
    struct // Size=0x1 (Id=0)
    {
