...
union _SLIST_HEADER// Size=0x10 (Id=132)
{
    unsigned long long Alignment;// Offset=0x0 Size=0x8
    unsigned long long Region;// Offset=0x8 Size=0x8
    struct _unnamed_131 HeaderX64;// Offset=0x0 Size=0x10
};
...
struct _NPAGED_LOOKASIDE_LIST// Size=0x80 (Id=151)
{
    struct _GENERAL_LOOKASIDE L;// Offset=0x0 Size=0x80
};

union FxDmaEnabler::<unnamed-type-m_SGList>// Size=0x80 (Id=1190)
{
    union // Size=0x80 (Id=0)
    {
        struct <unnamed-type-ScatterGatherProfile>// Size=0x80 (Id=32870)
        {
        ...
        struct <unnamed-type-SystemProfile>// Size=0x8 (Id=32873)
        {
