...
union _WDF_USB_CONTROL_SETUP_PACKET// Size=0x8 (Id=930)
{
    struct <unnamed-type-Packet>// Size=0x8 (Id=22021)
    {
        union <unnamed-type-bm>// Size=0x1 (Id=22022)
        {
            struct <unnamed-type-Request>// Size=0x1 (Id=22023)
            {
        ...
        union <unnamed-type-wValue>// Size=0x2 (Id=22032)
        {
            struct <unnamed-type-Bytes>// Size=0x2 (Id=22033)
            {
        ...
        union <unnamed-type-wIndex>// Size=0x2 (Id=22039)
        {
            struct <unnamed-type-Bytes>// Size=0x2 (Id=22040)
            {
                unsigned char LowByte;// Offset=0x0 Size=0x1
                unsigned char HiByte;// Offset=0x1 Size=0x1
            };
    ...
    struct <unnamed-type-Generic>// Size=0x8 (Id=22048)
    {
...
struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_11// Size=0x20 (Id=3148)
{
    union // Size=0x8 (Id=0)
    {
        long UsbdStatus;// Offset=0x0 Size=0x4
        enum _WDF_USB_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
        union <unnamed-type-Parameters>// Size=0x18 (Id=22695)
        {
            struct <unnamed-type-DeviceString>// Size=0x10 (Id=22696)
            {
            ...
            struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_11::<unnamed-type-Parameters>::<unnamed-type-DeviceString> DeviceString;// Offset=0x0 Size=0x10
            struct <unnamed-type-DeviceControlTransfer>// Size=0x18 (Id=22702)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
                union _WDF_USB_CONTROL_SETUP_PACKET SetupPacket;// Offset=0x8 Size=0x8
                unsigned long Length;// Offset=0x10 Size=0x4
            };
            struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_11::<unnamed-type-Parameters>::<unnamed-type-DeviceControlTransfer> DeviceControlTransfer;// Offset=0x0 Size=0x18
            struct <unnamed-type-DeviceUrb>// Size=0x8 (Id=22707)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            };
            struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_11::<unnamed-type-Parameters>::<unnamed-type-DeviceUrb> DeviceUrb;// Offset=0x0 Size=0x8
            struct <unnamed-type-PipeWrite>// Size=0x18 (Id=22710)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
                unsigned long long Length;// Offset=0x8 Size=0x8
                unsigned long long Offset;// Offset=0x10 Size=0x8
            };
            struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_11::<unnamed-type-Parameters>::<unnamed-type-PipeWrite> PipeWrite;// Offset=0x0 Size=0x18
            struct <unnamed-type-PipeRead>// Size=0x18 (Id=22715)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
                unsigned long long Length;// Offset=0x8 Size=0x8
                unsigned long long Offset;// Offset=0x10 Size=0x8
            };
            struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_11::<unnamed-type-Parameters>::<unnamed-type-PipeRead> PipeRead;// Offset=0x0 Size=0x18
            struct <unnamed-type-PipeUrb>// Size=0x8 (Id=22720)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            };
            struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_11::<unnamed-type-Parameters>::<unnamed-type-PipeUrb> PipeUrb;// Offset=0x0 Size=0x8
        };
    };
    union _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_11::<unnamed-type-Parameters> Parameters;// Offset=0x8 Size=0x18
};
