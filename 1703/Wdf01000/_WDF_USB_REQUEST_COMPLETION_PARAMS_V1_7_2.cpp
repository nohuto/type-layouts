...
struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_7// Size=0x20 (Id=1809)
{
    union // Size=0x8 (Id=0)
    {
        long UsbdStatus;// Offset=0x0 Size=0x4
        enum _WDF_USB_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
        union <unnamed-type-Parameters>// Size=0x18 (Id=22881)
        {
            struct <unnamed-type-DeviceString>// Size=0x10 (Id=22882)
            {
            ...
            struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_7::<unnamed-type-Parameters>::<unnamed-type-DeviceString> DeviceString;// Offset=0x0 Size=0x10
            struct <unnamed-type-DeviceControlTransfer>// Size=0x18 (Id=22888)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
                union _WDF_USB_CONTROL_SETUP_PACKET SetupPacket;// Offset=0x8 Size=0x8
                unsigned long Length;// Offset=0x10 Size=0x4
            };
            struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_7::<unnamed-type-Parameters>::<unnamed-type-DeviceControlTransfer> DeviceControlTransfer;// Offset=0x0 Size=0x18
            struct <unnamed-type-DeviceUrb>// Size=0x8 (Id=22893)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            };
            struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_7::<unnamed-type-Parameters>::<unnamed-type-DeviceUrb> DeviceUrb;// Offset=0x0 Size=0x8
            struct <unnamed-type-PipeWrite>// Size=0x18 (Id=22896)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
                unsigned long long Length;// Offset=0x8 Size=0x8
                unsigned long long Offset;// Offset=0x10 Size=0x8
            };
            struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_7::<unnamed-type-Parameters>::<unnamed-type-PipeWrite> PipeWrite;// Offset=0x0 Size=0x18
            struct <unnamed-type-PipeRead>// Size=0x18 (Id=22901)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
                unsigned long long Length;// Offset=0x8 Size=0x8
                unsigned long long Offset;// Offset=0x10 Size=0x8
            };
            struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_7::<unnamed-type-Parameters>::<unnamed-type-PipeRead> PipeRead;// Offset=0x0 Size=0x18
            struct <unnamed-type-PipeUrb>// Size=0x8 (Id=22906)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            };
            struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_7::<unnamed-type-Parameters>::<unnamed-type-PipeUrb> PipeUrb;// Offset=0x0 Size=0x8
        };
    };
    union _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_7::<unnamed-type-Parameters> Parameters;// Offset=0x8 Size=0x18
};
