union _WHEA_ERROR_PACKET_FLAGS// Size=0x4 (Id=787)
{
...
union _WHEA_PROCESSOR_GENERIC_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=4368)
{
...
struct _WHEA_PROCESSOR_GENERIC_ERROR_SECTION// Size=0xc0 (Id=1744)
{
...
union _WHEA_MEMORY_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=4192)
{
    struct // Size=0x8 (Id=0)
    {
...
union _WHEA_ERROR_STATUS// Size=0x8 (Id=3599)
{
...
struct _WHEA_MEMORY_ERROR_SECTION// Size=0x49 (Id=1644)
{
...
union _WHEA_NMI_ERROR_SECTION_FLAGS// Size=0x4 (Id=2418)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _WHEA_NMI_ERROR_SECTION// Size=0xc (Id=2533)
{
    unsigned char Data[8];// Offset=0x0 Size=0x8
    union _WHEA_NMI_ERROR_SECTION_FLAGS Flags;// Offset=0x8 Size=0x4
};

union _WHEA_PCIEXPRESS_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=2474)
{
    struct // Size=0x8 (Id=0)
    {
...
union _WHEA_PCIEXPRESS_VERSION// Size=0x4 (Id=1931)
{
...
union _WHEA_PCIEXPRESS_COMMAND_STATUS// Size=0x4 (Id=4215)
{
...
struct _WHEA_PCIEXPRESS_DEVICE_ID// Size=0x10 (Id=1960)
{
...
union _WHEA_PCIEXPRESS_BRIDGE_CONTROL_STATUS// Size=0x4 (Id=1713)
{
...
struct _WHEA_PCIEXPRESS_ERROR_SECTION// Size=0xd0 (Id=3721)
{
...
union _WHEA_PCIXBUS_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=3273)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long ErrorStatus:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
union _WHEA_PCIXBUS_ID// Size=0x2 (Id=2286)
{
...
union _WHEA_PCIXBUS_COMMAND// Size=0x8 (Id=3021)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WHEA_PCIXBUS_ERROR_SECTION// Size=0x48 (Id=2661)
{
...
union _WHEA_PCIXDEVICE_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=2539)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long ErrorStatus:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_PCIXDEVICE_ID// Size=0x10 (Id=1976)
{
    unsigned short VendorId;// Offset=0x0 Size=0x2
    unsigned short DeviceId;// Offset=0x2 Size=0x2
    struct // Size=0x8 (Id=0)
...
struct _WHEA_PCIXDEVICE_ERROR_SECTION// Size=0x38 (Id=3357)
{
...
struct _WHEA_ERROR_PACKET_V1// Size=0x119 (Id=3176)
{
    union // Size=0x40 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0xd0 (Id=25604)
        {
