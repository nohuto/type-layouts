...
struct _WDF_DRIVER_GLOBALS// Size=0x38 (Id=1222)
{
...
struct _FX_DRIVER_GLOBALS// Size=0x1f0 (Id=807)
{
    unsigned long AddRef(void * ,long ,char * );
    union // Size=0x2bf (Id=0)
    {
        ...
        void RegisterClientVersion(struct _UNICODE_STRING * );// Offset=0x0 Size=0x2bf
