union _KGDTENTRY64// Size=0x10 (Id=4676)
{
    unsigned short LimitLow;// Offset=0x0 Size=0x2
    unsigned short BaseLow;// Offset=0x2 Size=0x2
    union // Size=0x4 (Id=0)
    {
        struct _KGDTENTRY64::_unnamed_4678::_unnamed_4678::<unnamed-type-Bytes> Bytes;// Offset=0x4 Size=0x4
        struct _KGDTENTRY64::_unnamed_4677::_unnamed_4677::<unnamed-type-Bits> Bits;// Offset=0x4 Size=0x4
    };
