struct _WMI_CONTEXTSWAP// Size=0x18 (Id=2882)
{
    ...
    union // Size=0x1 (Id=0)
    {
        struct // Size=0x1 (Id=0)
        {
            ...
            unsigned char OldThreadBamEppImportant:1;// Offset=0xd Size=0x1 BitOffset=0x1 BitSize=0x1
            unsigned char NewThreadBamEppImportant:1;// Offset=0xd Size=0x1 BitOffset=0x2 BitSize=0x1
            unsigned char Reserved:5;// Offset=0xd Size=0x1 BitOffset=0x3 BitSize=0x5
        };
