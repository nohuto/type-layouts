struct _WDFCX_PNPPOWER_EVENT_CALLBACKS// Size=0xc8 (Id=421)
{
...
struct CxPnpPowerCallbacksInit// Size=0xd0 (Id=838)
{
    struct _WDFCX_PNPPOWER_EVENT_CALLBACKS Callbacks;// Offset=0x0 Size=0xc8
    unsigned char Set;// Offset=0xc8 Size=0x1
};
