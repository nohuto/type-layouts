...
struct _KEVENT// Size=0x18 (Id=110)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
};

struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=1118)
{
...
struct _IO_REMOVE_LOCK// Size=0x20 (Id=722)
{
...
struct FxWdmDeviceExtension// Size=0x28 (Id=809)
{
    struct _IO_REMOVE_LOCK IoRemoveLock;// Offset=0x0 Size=0x20
    unsigned long RemoveLockOptionFlags;// Offset=0x20 Size=0x4
    void FxWdmDeviceExtension(struct FxWdmDeviceExtension * );
    void FxWdmDeviceExtension(struct FxWdmDeviceExtension & );
    struct FxWdmDeviceExtension & operator=(struct FxWdmDeviceExtension * );
    struct FxWdmDeviceExtension & operator=(struct FxWdmDeviceExtension & );
};
