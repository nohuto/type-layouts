...
struct _USBD_INTERFACE_V1// Size=0x98 (Id=4654)
{
...
struct _USBD_HANDLE_INFO// Size=0xb8 (Id=4653)
{
    enum _SIG Sig;// Offset=0x0 Size=0x4
    struct _USBD_INTERFACE_V1 Interface;// Offset=0x8 Size=0x98
    struct _DEVICE_OBJECT * TargetDeviceObject;// Offset=0xa0 Size=0x8
    unsigned long CoreStackUsbdInterfaceVersion;// Offset=0xa8 Size=0x4
    long ReferenceCount;// Offset=0xac Size=0x4
    unsigned char IsCoreStackUsbdInterfaceVersion600AndDeviceHighSpeed;// Offset=0xb0 Size=0x1
    unsigned char PendingDelete;// Offset=0xb1 Size=0x1
};
