...
struct _ETW_HEAP_EVENT_CREATE// Size=0x44 (Id=2303)
{
    ...
    unsigned long long ReserveSize;// Offset=0x2c Size=0x8
    unsigned long long CommitSize;// Offset=0x34 Size=0x8
    unsigned long long AllocatedSize;// Offset=0x3c Size=0x8
};
