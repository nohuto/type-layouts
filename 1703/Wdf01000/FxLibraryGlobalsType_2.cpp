struct _OSVERSIONINFOEXW// Size=0x11c (Id=605)
{
...
struct _LIST_ENTRY// Size=0x10 (Id=125)
{
...
struct _KBUGCHECK_REASON_CALLBACK_RECORD// Size=0x30 (Id=692)
{
...
struct _FX_DRIVER_TRACKER_CACHE_AWARE// Size=0x18 (Id=1241)
{
    union // Size=0x14b (Id=0)
    {
        struct _FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=8552)
        {
        ...
        struct FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=8566)
        {
        };// Offset=0x0 Size=0x8
        long Initialize();
        void Uninitialize();
        long Register(struct _FX_DRIVER_GLOBALS * );// Offset=0x0 Size=0x14b
...
struct _WMI_WDF_NOTIFY_ROUTINES// Size=0x20 (Id=998)
{
...
struct FxLibraryGlobalsType// Size=0x298 (Id=1261)
{
    ...
    struct _OSVERSIONINFOEXW OsVersionInfo;// Offset=0xa8 Size=0x11c
    class MxLockNoDynam FxDriverGlobalsListLock;// Offset=0x1c8 Size=0x10
    struct _LIST_ENTRY FxDriverGlobalsList;// Offset=0x1d8 Size=0x10
    unsigned long BugCheckDriverInfoIndex;// Offset=0x1e8 Size=0x4
    unsigned long BugCheckDriverInfoCount;// Offset=0x1ec Size=0x4
    struct _FX_DUMP_DRIVER_INFO_ENTRY * BugCheckDriverInfo;// Offset=0x1f0 Size=0x8
    struct _KBUGCHECK_REASON_CALLBACK_RECORD BugCheckCallbackRecord;// Offset=0x1f8 Size=0x30
    unsigned char ProcessorGroupSupport;// Offset=0x228 Size=0x1
    unsigned char InternalTracingInitialized;// Offset=0x229 Size=0x1
    struct _FX_DRIVER_TRACKER_CACHE_AWARE DriverTracker;// Offset=0x230 Size=0x18
    struct _FX_DRIVER_GLOBALS * BestDriverForDumpLog;// Offset=0x248 Size=0x8
    unsigned char PassiveLevelInterruptSupport;// Offset=0x250 Size=0x1
    unsigned char IsUserModeFramework;// Offset=0x251 Size=0x1
    unsigned char StaticallyLinked;// Offset=0x252 Size=0x1
    unsigned char MachineSleepStates[3];// Offset=0x253 Size=0x3
    void * VerifierSectionHandle;// Offset=0x258 Size=0x8
    long VerifierSectionHandleRefCount;// Offset=0x260 Size=0x4
    struct _WMI_WDF_NOTIFY_ROUTINES * PerfTraceRoutines;// Offset=0x268 Size=0x8
    struct _WMI_WDF_NOTIFY_ROUTINES DummyPerfTraceRoutines;// Offset=0x270 Size=0x20
    unsigned char IfrDisabled;// Offset=0x290 Size=0x1
    unsigned char SleepStudyDisabled;// Offset=0x291 Size=0x1
