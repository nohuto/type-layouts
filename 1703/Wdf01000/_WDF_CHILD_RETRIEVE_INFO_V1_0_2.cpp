...
struct _WDF_CHILD_RETRIEVE_INFO_V1_0// Size=0x28 (Id=4206)
{
    unsigned long Size;// Offset=0x0 Size=0x4
    struct _WDF_CHILD_IDENTIFICATION_DESCRIPTION_HEADER_V1_0 * IdentificationDescription;// Offset=0x8 Size=0x8
    struct _WDF_CHILD_ADDRESS_DESCRIPTION_HEADER_V1_0 * AddressDescription;// Offset=0x10 Size=0x8
