struct _WDF_CLASS_VERSION_V1_19// Size=0xc (Id=4609)
{
...
struct _WDF_CLASS_LIBRARY_INFO_V1_19// Size=0x30 (Id=2226)
{
    unsigned long Size;// Offset=0x0 Size=0x4
    struct _WDF_CLASS_VERSION_V1_19 Version;// Offset=0x4 Size=0xc
