...
struct _WAIT_CONTEXT_BLOCK// Size=0x48 (Id=162)
{
...
struct _KDEVICE_QUEUE// Size=0x28 (Id=111)
{
...
struct _DEVICE_OBJECT// Size=0x150 (Id=715)
{
    union // Size=0x4d (Id=0)
    {
        ...
        union <unnamed-type-Queue>// Size=0x48 (Id=6583)
        {
