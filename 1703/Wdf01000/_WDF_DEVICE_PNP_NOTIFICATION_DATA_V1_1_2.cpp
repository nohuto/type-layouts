...
struct _WDF_DEVICE_PNP_NOTIFICATION_DATA_V1_1// Size=0xc (Id=4411)
{
    union // Size=0x4 (Id=0)
    {
        enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
        union <unnamed-type-Data>// Size=0x8 (Id=17078)
        {
            struct <unnamed-type-EnterState>// Size=0x8 (Id=17079)
            {
            ...
            struct <unnamed-type-PostProcessState>// Size=0x4 (Id=17083)
            {
                enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
            };
            ...
            struct <unnamed-type-LeaveState>// Size=0x8 (Id=17086)
            {
                enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
                enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
            };
