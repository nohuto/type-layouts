...
struct _MMVAD_FLAGS// Size=0x4 (Id=547)
{
...
struct _MMVAD_SHORT// Size=0x40 (Id=238)
{
    ...
    union _unnamed_236 u;// Offset=0x30 Size=0x4
    union _unnamed_237 u1;// Offset=0x34 Size=0x4
    struct _MI_VAD_EVENT_BLOCK * EventList;// Offset=0x38 Size=0x8
};

struct _MMVAD_FLAGS2// Size=0x4 (Id=1234)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1212// Size=0x4 (Id=1212)
{
...
struct _MI_VAD_SEQUENTIAL_INFO// Size=0x8 (Id=1499)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _MMVAD// Size=0x88 (Id=1214)
{
    ...
    union _unnamed_1213 u4;// Offset=0x78 Size=0x8
