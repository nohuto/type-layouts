...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=659)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=841)
{
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=1013)
{
...
struct _ALPC_PROCESS_CONTEXT// Size=0x20 (Id=808)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=772)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=957)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=729)
{
    unsigned long HighEdgeFilter;// Offset=0x0 Size=0x4
    unsigned long LowEdgeFilter;// Offset=0x4 Size=0x4
};

struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=703)
{
...
struct _EPROCESS// Size=0x820 (Id=103)
{
