...
struct _SLIST_ENTRY// Size=0x10 (Id=70)
{
    struct _SLIST_ENTRY * Next;// Offset=0x0 Size=0x8
};

struct _unnamed_415// Size=0x1 (Id=415)
{
...
union _unnamed_416// Size=0x1 (Id=416)
{
    struct _unnamed_415 s1;// Offset=0x0 Size=0x1
...
struct _BLOB// Size=0x30 (Id=417)
{
    ...
    union _unnamed_416 u1;// Offset=0x10 Size=0x1
