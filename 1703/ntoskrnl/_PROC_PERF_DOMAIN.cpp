...
struct _PERF_CONTROL_STATE_SELECTION// Size=0x28 (Id=1414)
{
...
struct _PROC_PERF_DOMAIN// Size=0x1e8 (Id=1292)
{
    ...
    unsigned char AllowVirtualHeterogeneity;// Offset=0x165 Size=0x1
    unsigned char InitiateAllProcessors;// Offset=0x166 Size=0x1
    unsigned char AutonomousMode;// Offset=0x167 Size=0x1
    unsigned long DesiredPercent;// Offset=0x168 Size=0x4
    unsigned long MaxPolicyPercent;// Offset=0x16c Size=0x4
    unsigned long MaxEquivalentFrequencyPercent;// Offset=0x170 Size=0x4
    unsigned long MinPolicyPercent;// Offset=0x174 Size=0x4
    unsigned long GuaranteedPercent;// Offset=0x178 Size=0x4
    unsigned long SelectionGeneration;// Offset=0x17c Size=0x4
    unsigned long BackgroundSelectionGeneration;// Offset=0x180 Size=0x4
    struct _PERF_CONTROL_STATE_SELECTION Selection;// Offset=0x188 Size=0x28
    struct _PERF_CONTROL_STATE_SELECTION BackgroundSelection;// Offset=0x1b0 Size=0x28
    unsigned long long PerfChangeTime;// Offset=0x1d8 Size=0x8
    unsigned long PerfChangeIntervalCount;// Offset=0x1e0 Size=0x4
    unsigned char Force;// Offset=0x1e4 Size=0x1
    unsigned char ProvideGuidance;// Offset=0x1e5 Size=0x1
    unsigned char Update;// Offset=0x1e6 Size=0x1
    unsigned char Apply;// Offset=0x1e7 Size=0x1
};
