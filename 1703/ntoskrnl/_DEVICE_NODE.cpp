...
struct _PO_DEVICE_NOTIFY// Size=0x68 (Id=644)
{
...
union _unnamed_293// Size=0x8 (Id=293)
{
...
union _unnamed_294// Size=0x8 (Id=294)
{
...
struct _DEVICE_NODE// Size=0x2d0 (Id=297)
{
    ...
    union _unnamed_293 OverUsed1;// Offset=0x210 Size=0x8
    union _unnamed_294 OverUsed2;// Offset=0x218 Size=0x8
    ...
    struct _unnamed_296 DockInfo;// Offset=0x238 Size=0x20
