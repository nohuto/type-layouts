union _unnamed_107// Size=0x8 (Id=107)
{
...
union _unnamed_109// Size=0x10 (Id=109)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_108 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=893)
{
...
struct _unnamed_110// Size=0x58 (Id=110)
{
...
union _unnamed_111// Size=0x58 (Id=111)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_110 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=112)
{
    ...
    union _unnamed_107 AssociatedIrp;// Offset=0x18 Size=0x8
