...
struct _TIME_FIELDS// Size=0x10 (Id=464)
{
...
struct _RTL_TIME_ZONE_INFORMATION// Size=0xac (Id=1120)
{
...
struct _TRACE_LOGFILE_HEADER// Size=0x118 (Id=466)
{
    unsigned long BufferSize;// Offset=0x0 Size=0x4
    union // Size=0x4 (Id=0)
    {
        unsigned long Version;// Offset=0x4 Size=0x4
        struct _unnamed_465 VersionDetail;// Offset=0x4 Size=0x4
    };
