...
union _MM_PAGE_ACCESS_INFO_FLAGS// Size=0x4 (Id=780)
{
    struct _unnamed_778 File;// Offset=0x0 Size=0x4
    struct _unnamed_779 Private;// Offset=0x0 Size=0x4
};

struct _MM_PAGE_ACCESS_INFO// Size=0x8 (Id=775)
{
    union // Size=0x8 (Id=0)
    {
