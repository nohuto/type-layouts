struct _NT_TIB// Size=0x38 (Id=953)
{
...
struct _KDESCRIPTOR// Size=0x10 (Id=1454)
{
...
struct _KSPECIAL_REGISTERS// Size=0xf0 (Id=1371)
{
...
struct _CONTEXT// Size=0x4d0 (Id=691)
{
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=515)
{
...
struct _KTIMER_TABLE_ENTRY// Size=0x20 (Id=285)
{
...
struct _KTIMER_TABLE// Size=0x2200 (Id=284)
{
...
struct _RTL_RB_TREE// Size=0x10 (Id=37)
{
...
struct _PROC_IDLE_POLICY// Size=0x6 (Id=1426)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=1179)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=1100)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=1117)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=1387)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROCESSOR_POWER_STATE// Size=0x1d8 (Id=1017)
{
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=860)
{
...
struct _KAFFINITY_EX// Size=0xa8 (Id=58)
{
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=271)
{
...
struct _IOP_IRP_STACK_PROFILER// Size=0x54 (Id=1071)
{
    unsigned long Profile[20];// Offset=0x0 Size=0x50
    unsigned long TotalIrps;// Offset=0x50 Size=0x4
};

struct _KSHARED_READY_QUEUE// Size=0x270 (Id=288)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _KPRCB// Size=0x7ec0 (Id=42)
{
    ...
    unsigned long long PrcbPad04[6];// Offset=0x90 Size=0x30
    ...
    unsigned long PrcbPad10;// Offset=0xec Size=0x4
    union // Size=0x100 (Id=0)
    {
        ...
        union // Size=0x1 (Id=0)
        {
            ...
            struct // Size=0x1 (Id=0)
            {
                ...
                unsigned char BpbStateReserved:4;// Offset=0xf8 Size=0x1 BitOffset=0x4 BitSize=0x4
            };
        };
        union // Size=0x1 (Id=0)
        {
        ...
        unsigned char BpbPad[2];// Offset=0xfe Size=0x2
        unsigned long long PrcbPad11[2];// Offset=0xf0 Size=0x10
    };
    struct _KPROCESSOR_STATE ProcessorState;// Offset=0x100 Size=0x5c0
    unsigned long ProcessorSignature;// Offset=0x6c0 Size=0x4
    unsigned long PrcbPad11a;// Offset=0x6c4 Size=0x4
    unsigned long long PrcbPad12[5];// Offset=0x6c8 Size=0x28
    ...
    unsigned long PrcbPad41[20];// Offset=0x2db0 Size=0x50
    ...
    unsigned char PrcbPad80[5];// Offset=0x5b9b Size=0x5
    unsigned long DpcTimeCount;// Offset=0x5ba0 Size=0x4
    unsigned long DpcTimeLimit;// Offset=0x5ba4 Size=0x4
    unsigned long PeriodicCount;// Offset=0x5ba8 Size=0x4
    unsigned long PeriodicBias;// Offset=0x5bac Size=0x4
    unsigned long AvailableTime;// Offset=0x5bb0 Size=0x4
    unsigned long KeExceptionDispatchCount;// Offset=0x5bb4 Size=0x4
    unsigned long ReadyThreadCount;// Offset=0x5bb8 Size=0x4
    ...
    unsigned long long ReadyQueueExpectedRunTime;// Offset=0x5c00 Size=0x8
    unsigned long PrcbPad81[21];// Offset=0x5c08 Size=0x54
    unsigned long DpcWatchdogProfileSingleDpcThreshold;// Offset=0x5c5c Size=0x4
    long MmSpinLockOrdering;// Offset=0x5c60 Size=0x4
    unsigned long PageColor;// Offset=0x5c64 Size=0x4
    unsigned long NodeColor;// Offset=0x5c68 Size=0x4
    unsigned long NodeShiftedColor;// Offset=0x5c6c Size=0x4
    unsigned long SecondaryColorMask;// Offset=0x5c70 Size=0x4
    unsigned long PrcbPad83;// Offset=0x5c74 Size=0x4
    unsigned long long CycleTime;// Offset=0x5c78 Size=0x8
    unsigned long long Cycles[4][2];// Offset=0x5c80 Size=0x40
    unsigned long PrcbPad84[16];// Offset=0x5cc0 Size=0x40
    unsigned long CcFastMdlReadNoWait;// Offset=0x5d00 Size=0x4
    unsigned long CcFastMdlReadWait;// Offset=0x5d04 Size=0x4
    unsigned long CcFastMdlReadNotPossible;// Offset=0x5d08 Size=0x4
    unsigned long CcMapDataNoWait;// Offset=0x5d0c Size=0x4
    unsigned long CcMapDataWait;// Offset=0x5d10 Size=0x4
    unsigned long CcPinMappedDataCount;// Offset=0x5d14 Size=0x4
    unsigned long CcPinReadNoWait;// Offset=0x5d18 Size=0x4
    unsigned long CcPinReadWait;// Offset=0x5d1c Size=0x4
    unsigned long CcMdlReadNoWait;// Offset=0x5d20 Size=0x4
    unsigned long CcMdlReadWait;// Offset=0x5d24 Size=0x4
    unsigned long CcLazyWriteHotSpots;// Offset=0x5d28 Size=0x4
    unsigned long CcLazyWriteIos;// Offset=0x5d2c Size=0x4
    unsigned long CcLazyWritePages;// Offset=0x5d30 Size=0x4
    unsigned long CcDataFlushes;// Offset=0x5d34 Size=0x4
    unsigned long CcDataPages;// Offset=0x5d38 Size=0x4
    unsigned long CcLostDelayedWrites;// Offset=0x5d3c Size=0x4
    unsigned long CcFastReadResourceMiss;// Offset=0x5d40 Size=0x4
    unsigned long CcCopyReadWaitMiss;// Offset=0x5d44 Size=0x4
    unsigned long CcFastMdlReadResourceMiss;// Offset=0x5d48 Size=0x4
    unsigned long CcMapDataNoWaitMiss;// Offset=0x5d4c Size=0x4
    unsigned long CcMapDataWaitMiss;// Offset=0x5d50 Size=0x4
    unsigned long CcPinReadNoWaitMiss;// Offset=0x5d54 Size=0x4
    unsigned long CcPinReadWaitMiss;// Offset=0x5d58 Size=0x4
    unsigned long CcMdlReadNoWaitMiss;// Offset=0x5d5c Size=0x4
    unsigned long CcMdlReadWaitMiss;// Offset=0x5d60 Size=0x4
    unsigned long CcReadAheadIos;// Offset=0x5d64 Size=0x4
    long MmCacheTransitionCount;// Offset=0x5d68 Size=0x4
    long MmCacheReadCount;// Offset=0x5d6c Size=0x4
    long MmCacheIoCount;// Offset=0x5d70 Size=0x4
    unsigned long PrcbPad91[3];// Offset=0x5d74 Size=0xc
    struct _PROCESSOR_POWER_STATE PowerState;// Offset=0x5d80 Size=0x1d8
    struct _LIST_ENTRY ScbList;// Offset=0x5f58 Size=0x10
    struct _KDPC ForceIdleDpc;// Offset=0x5f68 Size=0x40
    unsigned long PrcbPad92[18];// Offset=0x5fa8 Size=0x48
    unsigned long KeAlignmentFixupCount;// Offset=0x5ff0 Size=0x4
    struct _KDPC DpcWatchdogDpc;// Offset=0x5ff8 Size=0x40
    struct _KTIMER DpcWatchdogTimer;// Offset=0x6038 Size=0x40
    struct _CACHE_DESCRIPTOR Cache[5];// Offset=0x6078 Size=0x3c
    unsigned long CacheCount;// Offset=0x60b4 Size=0x4
    unsigned long CachedCommit;// Offset=0x60b8 Size=0x4
    unsigned long CachedResidentAvailable;// Offset=0x60bc Size=0x4
    void * HyperPte;// Offset=0x60c0 Size=0x8
    void * WheaInfo;// Offset=0x60c8 Size=0x8
    void * EtwSupport;// Offset=0x60d0 Size=0x8
    union _SLIST_HEADER InterruptObjectPool;// Offset=0x60e0 Size=0x10
    union _SLIST_HEADER HypercallPageList;// Offset=0x60f0 Size=0x10
    void * HypercallCachedPages;// Offset=0x6100 Size=0x8
    void * VirtualApicAssist;// Offset=0x6108 Size=0x8
    unsigned long long * StatisticsPage;// Offset=0x6110 Size=0x8
    struct _KAFFINITY_EX PackageProcessorSet;// Offset=0x6118 Size=0xa8
    unsigned long PackageId;// Offset=0x61c0 Size=0x4
    unsigned long PrcbPad86[31];// Offset=0x61c4 Size=0x7c
    unsigned long long SharedReadyQueueMask;// Offset=0x6240 Size=0x8
    struct _KSHARED_READY_QUEUE * SharedReadyQueue;// Offset=0x6248 Size=0x8
    unsigned long SharedQueueScanOwner;// Offset=0x6250 Size=0x4
    unsigned long ScanSiblingIndex;// Offset=0x6254 Size=0x4
    unsigned long long CoreProcessorSet;// Offset=0x6258 Size=0x8
    unsigned long long ScanSiblingMask;// Offset=0x6260 Size=0x8
    unsigned long long LLCMask;// Offset=0x6268 Size=0x8
    unsigned long long CacheProcessorMask[5];// Offset=0x6270 Size=0x28
    struct _PROCESSOR_PROFILE_CONTROL_AREA * ProcessorProfileControlArea;// Offset=0x6298 Size=0x8
    void * ProfileEventIndexAddress;// Offset=0x62a0 Size=0x8
    void ** DpcWatchdogProfile;// Offset=0x62a8 Size=0x8
    void ** DpcWatchdogProfileCurrentEmptyCapture;// Offset=0x62b0 Size=0x8
    unsigned long long PrcbPad94[9];// Offset=0x62b8 Size=0x48
    struct _SYNCH_COUNTERS SynchCounters;// Offset=0x6300 Size=0xb8
    unsigned long long PteBitCache;// Offset=0x63b8 Size=0x8
    unsigned long PteBitOffset;// Offset=0x63c0 Size=0x4
    struct _FILESYSTEM_DISK_COUNTERS FsCounters;// Offset=0x63c8 Size=0x10
    unsigned char VendorString[13];// Offset=0x63d8 Size=0xd
    unsigned char PrcbPad100[2];// Offset=0x63e5 Size=0x2
    unsigned char PendingVirtualLittle;// Offset=0x63e7 Size=0x1
    unsigned long long FeatureBits;// Offset=0x63e8 Size=0x8
    unsigned long PrcbPad110;// Offset=0x63f0 Size=0x4
    union _LARGE_INTEGER UpdateSignature;// Offset=0x63f8 Size=0x8
    struct _CONTEXT * Context;// Offset=0x6400 Size=0x8
    unsigned long ContextFlagsInit;// Offset=0x6408 Size=0x4
    struct _XSAVE_AREA * ExtendedState;// Offset=0x6410 Size=0x8
    void * IsrStack;// Offset=0x6418 Size=0x8
    struct _KENTROPY_TIMING_STATE EntropyTimingState;// Offset=0x6420 Size=0x150
    unsigned long long PrcbPad111;// Offset=0x6570 Size=0x8
    unsigned long long PrcbPad112[7];// Offset=0x6578 Size=0x38
    struct _SINGLE_LIST_ENTRY AbSelfIoBoostsList;// Offset=0x65b0 Size=0x8
    struct _SINGLE_LIST_ENTRY AbPropagateBoostsList;// Offset=0x65b8 Size=0x8
    struct _KDPC AbDpc;// Offset=0x65c0 Size=0x40
    struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerCurrent;// Offset=0x6600 Size=0x54
    struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerPrevious;// Offset=0x6654 Size=0x54
    struct _KSHARED_READY_QUEUE LocalSharedReadyQueue;// Offset=0x66c0 Size=0x270
    struct _KTIMER_EXPIRATION_TRACE TimerExpirationTrace[16];// Offset=0x6930 Size=0x100
    unsigned long TimerExpirationTraceCount;// Offset=0x6a30 Size=0x4
    void * ExSaPageArray;// Offset=0x6a38 Size=0x8
    struct _KSECURE_FAULT_INFORMATION SecureFault;// Offset=0x6a40 Size=0x10
    struct _REQUEST_MAILBOX * Mailbox;// Offset=0x6a80 Size=0x8
    unsigned long long PrcbPad130[7];// Offset=0x6a88 Size=0x38
    unsigned char PrcbPad135[960];// Offset=0x6ac0 Size=0x3c0
...
struct _KPCR// Size=0x8040 (Id=41)
{
