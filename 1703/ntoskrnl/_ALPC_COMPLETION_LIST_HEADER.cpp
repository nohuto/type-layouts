struct _unnamed_1182// Size=0x8 (Id=1182)
{
...
union _unnamed_1183// Size=0x8 (Id=1183)
{
    struct _unnamed_1182 s1;// Offset=0x0 Size=0x8
    long long Value;// Offset=0x0 Size=0x8
};

struct _ALPC_COMPLETION_LIST_STATE// Size=0x8 (Id=967)
{
    union _unnamed_1183 u1;// Offset=0x0 Size=0x8
};

struct _RTL_SRWLOCK// Size=0x8 (Id=1056)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _ALPC_COMPLETION_LIST_HEADER// Size=0x180 (Id=968)
{
