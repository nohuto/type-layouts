struct _SEGMENT_FLAGS// Size=0x4 (Id=1270)
{
    union // Size=0x2 (Id=0)
    {
...
union _unnamed_224// Size=0x8 (Id=224)
{
    union // Size=0x8 (Id=0)
    {
...
struct _SEGMENT// Size=0x48 (Id=226)
{
    ...
    union _unnamed_224 u1;// Offset=0x30 Size=0x8
    union _unnamed_225 u2;// Offset=0x38 Size=0x8
