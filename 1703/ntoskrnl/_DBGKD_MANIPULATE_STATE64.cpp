struct _DBGKD_READ_MEMORY64// Size=0x10 (Id=317)
{
...
struct _DBGKD_WRITE_MEMORY64// Size=0x10 (Id=319)
{
    unsigned long long TargetBaseAddress;// Offset=0x0 Size=0x8
    unsigned long TransferCount;// Offset=0x8 Size=0x4
...
struct _X86_DBGKD_CONTROL_SET// Size=0x10 (Id=979)
{
    unsigned long TraceFlag;// Offset=0x0 Size=0x4
...
struct _IA64_DBGKD_CONTROL_SET// Size=0x14 (Id=1110)
{
...
struct _ARM_DBGKD_CONTROL_SET// Size=0xc (Id=865)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
...
struct _ARM64_DBGKD_CONTROL_SET// Size=0x18 (Id=1007)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
...
struct _ARMCE_DBGKD_CONTROL_SET// Size=0xc (Id=671)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
    unsigned long CurrentSymbolStart;// Offset=0x4 Size=0x4
    unsigned long CurrentSymbolEnd;// Offset=0x8 Size=0x4
...
struct _PPC_DBGKD_CONTROL_SET// Size=0xc (Id=1237)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
    unsigned long CurrentSymbolStart;// Offset=0x4 Size=0x4
    unsigned long CurrentSymbolEnd;// Offset=0x8 Size=0x4
...
struct _DBGKD_ANY_CONTROL_SET// Size=0x1c (Id=546)
{
...
struct _DBGKD_CONTINUE2// Size=0x20 (Id=342)
{
    long ContinueStatus;// Offset=0x0 Size=0x4
    union // Size=0x1c (Id=0)
    {
...
struct _DBGKD_READ_WRITE_IO64// Size=0x10 (Id=323)
{
...
struct _DBGKD_READ_WRITE_IO_EXTENDED64// Size=0x20 (Id=325)
{
...
struct _DBGKD_QUERY_SPECIAL_CALLS// Size=0x4 (Id=528)
{
    unsigned long NumberOfSpecialCalls;// Offset=0x0 Size=0x4
};

struct _DBGKD_SET_SPECIAL_CALL64// Size=0x8 (Id=328)
{
    unsigned long long SpecialCall;// Offset=0x0 Size=0x8
};

struct _DBGKD_SET_INTERNAL_BREAKPOINT64// Size=0x10 (Id=330)
{
    unsigned long long BreakpointAddress;// Offset=0x0 Size=0x8
    unsigned long Flags;// Offset=0x8 Size=0x4
};

struct _DBGKD_GET_INTERNAL_BREAKPOINT64// Size=0x20 (Id=331)
{
    unsigned long long BreakpointAddress;// Offset=0x0 Size=0x8
    unsigned long Flags;// Offset=0x8 Size=0x4
...
struct _DBGKD_GET_VERSION64// Size=0x28 (Id=1129)
{
...
struct _DBGKD_SEARCH_MEMORY// Size=0x18 (Id=339)
{
    union // Size=0x8 (Id=0)
    {
...
struct _DBGKD_GET_SET_BUS_DATA// Size=0x14 (Id=561)
{
...
struct _DBGKD_FILL_MEMORY// Size=0x10 (Id=1244)
{
...
struct _DBGKD_QUERY_MEMORY// Size=0x18 (Id=625)
{
    unsigned long long Address;// Offset=0x0 Size=0x8
...
struct _DBGKD_SWITCH_PARTITION// Size=0x4 (Id=1103)
{
    unsigned long Partition;// Offset=0x0 Size=0x4
};

struct _DBGKD_CONTEXT_EX// Size=0xc (Id=1157)
{
...
struct _DBGKD_WRITE_CUSTOM_BREAKPOINT// Size=0x18 (Id=624)
{
    unsigned long long BreakPointAddress;// Offset=0x0 Size=0x8
...
union _unnamed_333// Size=0x28 (Id=333)
{
...
struct _DBGKD_MANIPULATE_STATE64// Size=0x38 (Id=334)
{
    ...
    union _unnamed_333 u;// Offset=0x10 Size=0x28
};
