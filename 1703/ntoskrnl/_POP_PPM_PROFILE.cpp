...
union _PPM_POLICY_SETTINGS_MASK// Size=0x8 (Id=579)
{
    ...
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned long Spare:21;// Offset=0x4 Size=0x4 BitOffset=0xb BitSize=0x15
    };
};

struct _PPM_ENGINE_SETTINGS// Size=0x578 (Id=361)
{
    ...
    unsigned char HeteroDecreaseThreshold[640];// Offset=0x70 Size=0x280
    unsigned char HeteroIncreaseThreshold[640];// Offset=0x2f0 Size=0x280
    unsigned char Class0FloorPerformance;// Offset=0x570 Size=0x1
    unsigned char Class1InitialPerformance;// Offset=0x571 Size=0x1
};

struct _POP_PPM_PROFILE// Size=0xb40 (Id=360)
{
    ...
    struct _PPM_ENGINE_SETTINGS Settings[2];// Offset=0x28 Size=0xaf0
    unsigned long long StartTime;// Offset=0xb18 Size=0x8
    unsigned long long Count;// Offset=0xb20 Size=0x8
    unsigned long long MaxDuration;// Offset=0xb28 Size=0x8
    unsigned long long MinDuration;// Offset=0xb30 Size=0x8
    unsigned long long TotalDuration;// Offset=0xb38 Size=0x8
};
