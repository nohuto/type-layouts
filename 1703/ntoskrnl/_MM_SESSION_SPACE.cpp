struct _MM_SESSION_SPACE_FLAGS// Size=0x4 (Id=610)
{
...
union _unnamed_534// Size=0x4 (Id=534)
{
...
struct _FAST_MUTEX// Size=0x38 (Id=64)
{
...
struct _POOL_DESCRIPTOR// Size=0x1140 (Id=797)
{
...
struct _MI_SESSION_DRIVER_UNLOAD// Size=0x8 (Id=777)
{
    union // Size=0x8 (Id=0)
    {
...
struct _MM_SESSION_SPACE// Size=0x4000 (Id=536)
{
    long ReferenceCount;// Offset=0x0 Size=0x4
    union _unnamed_534 u;// Offset=0x4 Size=0x4
