...
struct _unnamed_437// Size=0x4 (Id=437)
{
...
union _unnamed_438// Size=0x4 (Id=438)
{
    struct _unnamed_437 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

union _KALPC_DIRECT_EVENT// Size=0x8 (Id=448)
{
...
struct _PORT_MESSAGE// Size=0x28 (Id=410)
{
...
struct _KALPC_MESSAGE// Size=0x118 (Id=439)
{
    ...
    union _unnamed_438 u1;// Offset=0x28 Size=0x4
