union _ENERGY_STATE_DURATION// Size=0x8 (Id=934)
{
...
struct _PROCESS_ENERGY_VALUES// Size=0x110 (Id=707)
{
...
union _TIMELINE_BITMAP// Size=0x8 (Id=1101)
{
    unsigned long long Value;// Offset=0x0 Size=0x8
...
struct _PROCESS_ENERGY_VALUES_EXTENSION// Size=0x48 (Id=995)
{
...
struct _PROCESS_EXTENDED_ENERGY_VALUES// Size=0x158 (Id=187)
{
    struct _PROCESS_ENERGY_VALUES Base;// Offset=0x0 Size=0x110
    struct _PROCESS_ENERGY_VALUES_EXTENSION Extension;// Offset=0x110 Size=0x48
};
