...
struct _PROCESSOR_IDLE_CONSTRAINTS// Size=0x30 (Id=631)
{
...
struct _PROCESSOR_IDLE_PREPARE_INFO// Size=0x58 (Id=1066)
{
...
struct _PPM_SELECTION_MENU// Size=0x10 (Id=868)
{
    unsigned long Count;// Offset=0x0 Size=0x4
    struct _PPM_SELECTION_MENU_ENTRY * Entries;// Offset=0x8 Size=0x8
};

struct _PPM_COORDINATED_SELECTION// Size=0x18 (Id=1199)
{
...
struct _PPM_VETO_ACCOUNTING// Size=0x28 (Id=1287)
{
...
struct _PPM_IDLE_STATE// Size=0xf8 (Id=668)
{
...
struct _PPM_IDLE_STATES// Size=0x428 (Id=563)
{
