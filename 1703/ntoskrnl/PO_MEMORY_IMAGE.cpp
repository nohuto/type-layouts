...
struct _PO_HIBER_PERF// Size=0x1f8 (Id=1429)
{
...
struct PO_MEMORY_IMAGE// Size=0x3d8 (Id=1139)
{
    ...
    unsigned long SiLogOffset;// Offset=0x290 Size=0x4
    ...
    unsigned long long HvCr3;// Offset=0x368 Size=0x8
    ...
    unsigned long long HalEntryPointPhysical;// Offset=0x390 Size=0x8
