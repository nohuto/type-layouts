...
struct _unnamed_1487// Size=0x8 (Id=1487)
{
...
struct _unnamed_1488// Size=0x10 (Id=1488)
{
    struct _GUID DiskId;// Offset=0x0 Size=0x10
};

union _unnamed_1489// Size=0x10 (Id=1489)
{
    struct _unnamed_1487 Mbr;// Offset=0x0 Size=0x8
    struct _unnamed_1488 Gpt;// Offset=0x0 Size=0x10
};

struct _DUMP_INITIALIZATION_CONTEXT// Size=0x108 (Id=1491)
{
    ...
    union _unnamed_1489 DiskInfo;// Offset=0x8c Size=0x10
...
struct _DUMP_STACK_CONTEXT// Size=0x178 (Id=1447)
{
