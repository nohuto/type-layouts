union _MI_FLAGS// Size=0x4 (Id=743)
{
    ...
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long SlatKernelCodeProtected:1;// Offset=0x0 Size=0x4 BitOffset=0x15 BitSize=0x1
        unsigned long BootDebuggerActive:1;// Offset=0x0 Size=0x4 BitOffset=0x16 BitSize=0x1
        unsigned long AccessBitFenceRequired:1;// Offset=0x0 Size=0x4 BitOffset=0x17 BitSize=0x1
    };
};

struct _MI_TRIAGE_DUMP_DATA// Size=0x38 (Id=1410)
{
