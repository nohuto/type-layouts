...
struct _PO_FX_COMPONENT_PERF_SET// Size=0x30 (Id=1550)
{
    ...
    {
        struct _unnamed_1548 Discrete;// Offset=0x20 Size=0x10
        struct _unnamed_1549 Range;// Offset=0x20 Size=0x10
    };
};
