struct _unnamed_418// Size=0x4 (Id=418)
{
...
union _unnamed_419// Size=0x4 (Id=419)
{
    struct _unnamed_418 s1;// Offset=0x0 Size=0x4
};
...
struct _KALPC_SECTION// Size=0x48 (Id=420)
{
    ...
    union _unnamed_419 u1;// Offset=0x30 Size=0x4
