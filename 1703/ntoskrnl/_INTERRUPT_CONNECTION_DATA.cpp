...
struct _unnamed_1512// Size=0x4 (Id=1512)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1513// Size=0x4 (Id=1513)
{
    struct _unnamed_1512 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _unnamed_1514// Size=0x4 (Id=1514)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1515// Size=0x4 (Id=1515)
{
    struct _unnamed_1514 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_HT_INTR_INFO// Size=0x8 (Id=1516)
{
    union _unnamed_1513 LowPart;// Offset=0x0 Size=0x4
    union _unnamed_1515 HighPart;// Offset=0x4 Size=0x4
};

struct _unnamed_1440// Size=0x8 (Id=1440)
{
    struct _INTERRUPT_HT_INTR_INFO IntrInfo;// Offset=0x0 Size=0x8
};

struct _unnamed_1442// Size=0x4 (Id=1442)
{
    enum HAL_APIC_DESTINATION_MODE DestinationMode;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_VECTOR_DATA// Size=0x58 (Id=1443)
{
    ...
    struct _unnamed_1438 ControllerInput;// Offset=0x38 Size=0x8
    unsigned long long HvDeviceId;// Offset=0x40 Size=0x8
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_1439 XapicMessage;// Offset=0x48 Size=0x10
        struct _unnamed_1440 Hypertransport;// Offset=0x48 Size=0x8
        struct _unnamed_1439 GenericMessage;// Offset=0x48 Size=0x10
        struct _unnamed_1442 MessageRequest;// Offset=0x48 Size=0x4
    };
};

struct _INTERRUPT_CONNECTION_DATA// Size=0x60 (Id=1341)
{
