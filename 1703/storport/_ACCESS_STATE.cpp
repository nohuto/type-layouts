...
struct _SECURITY_SUBJECT_CONTEXT// Size=0x20 (Id=588)
{
...
struct _LUID_AND_ATTRIBUTES// Size=0xc (Id=587)
{
...
struct _PRIVILEGE_SET// Size=0x14 (Id=584)
{
    unsigned long PrivilegeCount;// Offset=0x0 Size=0x4
    unsigned long Control;// Offset=0x4 Size=0x4
...
union _unnamed_576// Size=0x2c (Id=576)
{
...
struct _ACCESS_STATE// Size=0xa0 (Id=577)
{
    ...
    union _unnamed_576 Privileges;// Offset=0x50 Size=0x2c
