...
struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=575)
{
    ...
    union _unnamed_574 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=532)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=420)
{
