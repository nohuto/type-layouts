...
struct _STORPORT_DUMP_ADAPTER_DATA// Size=0x110 (Id=249)
{
    unsigned long Version;// Offset=0x0 Size=0x4
    struct _PORT_CONFIGURATION_INFORMATION ConfigInfo;// Offset=0x8 Size=0xe0
    void * MappedAddressList;// Offset=0xe8 Size=0x8
    unsigned short HiberFileHybridPriority;// Offset=0xf0 Size=0x2
    unsigned long MemoryBlockSize;// Offset=0xf4 Size=0x4
    void * MemoryBlock;// Offset=0xf8 Size=0x8
    unsigned char Initialized;// Offset=0x100 Size=0x1
    void * DevExt;// Offset=0x108 Size=0x8
};
