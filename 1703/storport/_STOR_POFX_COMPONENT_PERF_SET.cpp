...
{
    struct _unnamed_160 Discrete;// Offset=0x0 Size=0x8
    struct _unnamed_161 Range;// Offset=0x0 Size=0x10
};

struct _STOR_POFX_COMPONENT_PERF_SET// Size=0x28 (Id=163)
{
    ...
    union _unnamed_162 PStates;// Offset=0x18 Size=0x10
};
