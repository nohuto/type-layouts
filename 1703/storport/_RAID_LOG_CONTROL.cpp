struct _unnamed_527// Size=0x8 (Id=527)
{
...
union _unnamed_528// Size=0x8 (Id=528)
{
    struct _unnamed_527 u;// Offset=0x0 Size=0x8
    unsigned long long asUlong64;// Offset=0x0 Size=0x8
};

struct _RAID_LOG_CONTROL// Size=0x10 (Id=529)
{
    unsigned long Revision;// Offset=0x0 Size=0x4
    union _unnamed_528 Enable;// Offset=0x8 Size=0x8
};
