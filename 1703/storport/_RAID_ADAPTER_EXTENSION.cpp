...
struct _unnamed_235// Size=0x6 (Id=235)
{
...
struct _STOR_LOCKED_LIST// Size=0x20 (Id=267)
{
...
struct _STOR_DICTIONARY// Size=0x30 (Id=184)
{
...
struct _RAID_RESOURCE_LIST// Size=0x10 (Id=282)
{
...
struct _MEMORY_REGION// Size=0x18 (Id=450)
{
...
struct _PORT_CONFIGURATION_INFORMATION// Size=0xe0 (Id=265)
{
...
struct _unnamed_268// Size=0x1 (Id=268)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _RAID_MINIPORT// Size=0x128 (Id=269)
{
    ...
    struct _unnamed_268 Flags;// Offset=0xf8 Size=0x1
...
struct _BUS_INTERFACE_STANDARD// Size=0x40 (Id=589)
{
...
struct _RAID_BUS_INTERFACE// Size=0x48 (Id=559)
{
...
struct _RAID_DMA_ADAPTER// Size=0x20 (Id=212)
{
...
struct _RAID_MEMORY_REGION// Size=0x18 (Id=189)
{
    unsigned char * VirtualBase;// Offset=0x0 Size=0x8
    union _LARGE_INTEGER PhysicalBase;// Offset=0x8 Size=0x8
    unsigned long Length;// Offset=0x10 Size=0x4
...
struct _IO_CONT_RESOURCE_LIST// Size=0x80 (Id=367)
{
...
struct _STOR_NOTIFICATION_INFO// Size=0x20 (Id=368)
{
...
struct _STOR_IO_GATEWAY// Size=0x140 (Id=224)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _RAID_DEFERRED_QUEUE// Size=0x80 (Id=205)
{
...
struct _unnamed_238// Size=0x50 (Id=238)
{
...
struct _PORT_REGISTRY_INFO// Size=0x40 (Id=414)
{
...
struct _RAID_ADAPTER_PARAMETERS// Size=0x38 (Id=510)
{
...
struct _unnamed_241// Size=0x1 (Id=241)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _SCSI_POWER_REQUEST_BLOCK// Size=0x58 (Id=468)
{
    unsigned short Length;// Offset=0x0 Size=0x2
...
struct _STORAGE_REQUEST_BLOCK// Size=0x80 (Id=218)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    unsigned char Function;// Offset=0x2 Size=0x1
    unsigned char SrbStatus;// Offset=0x3 Size=0x1
...
struct _RAID_POWER_CONTEXT// Size=0xb8 (Id=385)
{
...
struct _STORPORT_EXTENDED_FUNCTIONS// Size=0x58 (Id=312)
{
...
union _RAID_REDIRECTION_SUPPORT// Size=0x2 (Id=494)
{
    struct // Size=0x2 (Id=0)
    {
...
struct _PCI_HEADER_TYPE_0// Size=0x30 (Id=455)
{
...
struct _PCI_HEADER_TYPE_1// Size=0x30 (Id=561)
{
...
struct _unnamed_582// Size=0x8 (Id=582)
{
    unsigned long Base;// Offset=0x0 Size=0x4
    unsigned long Limit;// Offset=0x4 Size=0x4
};

struct _PCI_HEADER_TYPE_2// Size=0x30 (Id=583)
{
    ...
    unsigned char SubordinateBus;// Offset=0xa Size=0x1
    unsigned char SecondaryLatency;// Offset=0xb Size=0x1
    struct _unnamed_582 Range[4];// Offset=0xc Size=0x20
    unsigned char InterruptLine;// Offset=0x2c Size=0x1
    unsigned char InterruptPin;// Offset=0x2d Size=0x1
    unsigned short BridgeControl;// Offset=0x2e Size=0x2
};

union _unnamed_404// Size=0x30 (Id=404)
{
...
struct _PCI_COMMON_HEADER// Size=0x40 (Id=405)
{
    ...
    union _unnamed_404 u;// Offset=0x10 Size=0x30
};

struct _STOR_POWER_SETTING_NOTIFICATION// Size=0x18 (Id=495)
{
...
struct _CRASHDUMP_FUNCTIONS_INTERFACE// Size=0x28 (Id=493)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
struct _STOR_ADDRESS// Size=0x10 (Id=140)
{
...
struct _RAID_RPMB_CAPABILITIES// Size=0x38 (Id=357)
{
...
struct _RAID_CRYPTO_KEY_TABLE// Size=0x18 (Id=371)
{
...
struct _RAID_ADAPTER_EXTENSION// Size=0x1680 (Id=243)
{
    ...
    struct _unnamed_235 Flags;// Offset=0x68 Size=0x6
    ...
    struct _unnamed_238 DeferredList;// Offset=0x4c0 Size=0x50
    struct _unnamed_239 DeferredPauseResumeContext;// Offset=0x510 Size=0xb0
    ...
    struct _unnamed_241 PerfOptFlags;// Offset=0x1163 Size=0x1
    ...
    struct _unnamed_242 TelemetryHierarchicalResetLunBucket[5];// Offset=0x145c Size=0x3c
    struct _unnamed_242 TelemetryHierarchicalResetTargetBucket[5];// Offset=0x1498 Size=0x3c
