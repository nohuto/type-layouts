...
struct _OWNER_ENTRY// Size=0x10 (Id=394)
{
...
struct _ERESOURCE// Size=0x68 (Id=312)
{
...
struct _PROCESS_DISK_COUNTERS// Size=0x28 (Id=212)
{
...
struct _PS_JOB_WAKE_INFORMATION// Size=0x48 (Id=399)
{
...
struct _EPROCESS_VALUES// Size=0x58 (Id=226)
{
...
struct _JOB_RATE_CONTROL_HEADER// Size=0x28 (Id=231)
{
...
struct _PS_IO_CONTROL_ENTRY// Size=0x38 (Id=291)
{
...
union _JOBOBJECT_ENERGY_TRACKING_STATE// Size=0x8 (Id=223)
{
    unsigned long long Value;// Offset=0x0 Size=0x8
...
struct _EJOB// Size=0x610 (Id=170)
{
    ...
    struct _EX_PUSH_LOCK IoControlLock;// Offset=0x5d0 Size=0x8
    unsigned long long SiloHardReferenceCount;// Offset=0x5d8 Size=0x8
    struct _WORK_QUEUE_ITEM RundownWorkItem;// Offset=0x5e0 Size=0x20
    void * MemoryPartitionObject;// Offset=0x600 Size=0x8
    union _JOBOBJECT_ENERGY_TRACKING_STATE EnergyTrackingState;// Offset=0x608 Size=0x8
};
