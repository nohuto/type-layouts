union _unnamed_108// Size=0x8 (Id=108)
{
...
union _unnamed_110// Size=0x10 (Id=110)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_109 AsynchronousParameters;// Offset=0x0 Size=0x10
...
struct _unnamed_111// Size=0x58 (Id=111)
{
...
union _unnamed_112// Size=0x58 (Id=112)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_111 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=113)
{
    ...
    union _unnamed_108 AssociatedIrp;// Offset=0x18 Size=0x8
