...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=371)
{
...
struct _KAPC_STATE// Size=0x30 (Id=326)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=346)
{
...
struct _KLOCK_ENTRY_LOCK_STATE// Size=0x10 (Id=383)
{
    union // Size=0x8 (Id=0)
    {
...
union _KLOCK_ENTRY_BOOST_BITMAP// Size=0x4 (Id=215)
{
...
struct _KLOCK_ENTRY// Size=0x60 (Id=206)
{
...
struct _KTHREAD// Size=0x5e8 (Id=61)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    ...
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long BamEppImportant:1;// Offset=0x78 Size=0x4 BitOffset=0x2 BitSize=0x1
            ...
            unsigned long TerminateRequestReason:2;// Offset=0x78 Size=0x4 BitOffset=0x11 BitSize=0x2
            unsigned long ProcessStackCountDecremented:1;// Offset=0x78 Size=0x4 BitOffset=0x13 BitSize=0x1
            unsigned long RestrictedGuiThread:1;// Offset=0x78 Size=0x4 BitOffset=0x14 BitSize=0x1
            unsigned long ThreadFlagsSpare:3;// Offset=0x78 Size=0x4 BitOffset=0x15 BitSize=0x3
    ...
    long Spare22;// Offset=0x5e4 Size=0x4
};
...
struct _CLIENT_ID// Size=0x10 (Id=211)
{
    void * UniqueProcess;// Offset=0x0 Size=0x8
    void * UniqueThread;// Offset=0x8 Size=0x8
};

struct _KSEMAPHORE// Size=0x20 (Id=319)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=368)
{
...
struct _EX_RUNDOWN_REF// Size=0x8 (Id=182)
{
    union // Size=0x8 (Id=0)
    {
...
struct _PS_PROPERTY_SET// Size=0x18 (Id=238)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
    unsigned long long Lock;// Offset=0x10 Size=0x8
};

struct _ETHREAD// Size=0x810 (Id=107)
{
    struct _KTHREAD Tcb;// Offset=0x0 Size=0x5e8
    union _LARGE_INTEGER CreateTime;// Offset=0x5e8 Size=0x8
    union // Size=0x8 (Id=0)
    {
        union _LARGE_INTEGER ExitTime;// Offset=0x5f0 Size=0x8
        struct _LIST_ENTRY KeyedWaitChain;// Offset=0x5f0 Size=0x10
    };
    void * ChargeOnlySession;// Offset=0x600 Size=0x8
    union // Size=0x10 (Id=0)
    {
    ...
    void * LegacyPowerObject;// Offset=0x698 Size=0x8
    struct _LIST_ENTRY ThreadListEntry;// Offset=0x6a0 Size=0x10
    struct _EX_RUNDOWN_REF RundownProtect;// Offset=0x6b0 Size=0x8
    struct _EX_PUSH_LOCK ThreadLock;// Offset=0x6b8 Size=0x8
    unsigned long ReadClusterSize;// Offset=0x6c0 Size=0x4
    long MmLockOrdering;// Offset=0x6c4 Size=0x4
    union // Size=0x4 (Id=0)
    {
        unsigned long CrossThreadFlags;// Offset=0x6c8 Size=0x4
        struct // Size=0x4 (Id=0)
        {
            unsigned long Terminated:1;// Offset=0x6c8 Size=0x4 BitOffset=0x0 BitSize=0x1
            unsigned long ThreadInserted:1;// Offset=0x6c8 Size=0x4 BitOffset=0x1 BitSize=0x1
            unsigned long HideFromDebugger:1;// Offset=0x6c8 Size=0x4 BitOffset=0x2 BitSize=0x1
            unsigned long ActiveImpersonationInfo:1;// Offset=0x6c8 Size=0x4 BitOffset=0x3 BitSize=0x1
            unsigned long HardErrorsAreDisabled:1;// Offset=0x6c8 Size=0x4 BitOffset=0x4 BitSize=0x1
            unsigned long BreakOnTermination:1;// Offset=0x6c8 Size=0x4 BitOffset=0x5 BitSize=0x1
            unsigned long SkipCreationMsg:1;// Offset=0x6c8 Size=0x4 BitOffset=0x6 BitSize=0x1
            unsigned long SkipTerminationMsg:1;// Offset=0x6c8 Size=0x4 BitOffset=0x7 BitSize=0x1
            unsigned long CopyTokenOnOpen:1;// Offset=0x6c8 Size=0x4 BitOffset=0x8 BitSize=0x1
            unsigned long ThreadIoPriority:3;// Offset=0x6c8 Size=0x4 BitOffset=0x9 BitSize=0x3
            unsigned long ThreadPagePriority:3;// Offset=0x6c8 Size=0x4 BitOffset=0xc BitSize=0x3
            unsigned long RundownFail:1;// Offset=0x6c8 Size=0x4 BitOffset=0xf BitSize=0x1
            unsigned long UmsForceQueueTermination:1;// Offset=0x6c8 Size=0x4 BitOffset=0x10 BitSize=0x1
            unsigned long IndirectCpuSets:1;// Offset=0x6c8 Size=0x4 BitOffset=0x11 BitSize=0x1
            unsigned long DisableDynamicCodeOptOut:1;// Offset=0x6c8 Size=0x4 BitOffset=0x12 BitSize=0x1
            unsigned long ExplicitCaseSensitivity:1;// Offset=0x6c8 Size=0x4 BitOffset=0x13 BitSize=0x1
            unsigned long PicoNotifyExit:1;// Offset=0x6c8 Size=0x4 BitOffset=0x14 BitSize=0x1
            unsigned long DbgWerUserReportActive:1;// Offset=0x6c8 Size=0x4 BitOffset=0x15 BitSize=0x1
            unsigned long ReservedCrossThreadFlags:10;// Offset=0x6c8 Size=0x4 BitOffset=0x16 BitSize=0xa
        };
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long SameThreadPassiveFlags;// Offset=0x6cc Size=0x4
        struct // Size=0x4 (Id=0)
        {
            unsigned long ActiveExWorker:1;// Offset=0x6cc Size=0x4 BitOffset=0x0 BitSize=0x1
            unsigned long MemoryMaker:1;// Offset=0x6cc Size=0x4 BitOffset=0x1 BitSize=0x1
            unsigned long StoreLockThread:2;// Offset=0x6cc Size=0x4 BitOffset=0x2 BitSize=0x2
            unsigned long ClonedThread:1;// Offset=0x6cc Size=0x4 BitOffset=0x4 BitSize=0x1
            unsigned long KeyedEventInUse:1;// Offset=0x6cc Size=0x4 BitOffset=0x5 BitSize=0x1
            unsigned long SelfTerminate:1;// Offset=0x6cc Size=0x4 BitOffset=0x6 BitSize=0x1
            unsigned long RespectIoPriority:1;// Offset=0x6cc Size=0x4 BitOffset=0x7 BitSize=0x1
            unsigned long ActivePageLists:1;// Offset=0x6cc Size=0x4 BitOffset=0x8 BitSize=0x1
            unsigned long ReservedSameThreadPassiveFlags:23;// Offset=0x6cc Size=0x4 BitOffset=0x9 BitSize=0x17
        };
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long SameThreadApcFlags;// Offset=0x6d0 Size=0x4
        struct // Size=0x2 (Id=0)
        {
            unsigned char OwnsProcessAddressSpaceExclusive:1;// Offset=0x6d0 Size=0x1 BitOffset=0x0 BitSize=0x1
            unsigned char OwnsProcessAddressSpaceShared:1;// Offset=0x6d0 Size=0x1 BitOffset=0x1 BitSize=0x1
            unsigned char HardFaultBehavior:1;// Offset=0x6d0 Size=0x1 BitOffset=0x2 BitSize=0x1
            unsigned char StartAddressInvalid:1;// Offset=0x6d0 Size=0x1 BitOffset=0x3 BitSize=0x1
            unsigned char EtwCalloutActive:1;// Offset=0x6d0 Size=0x1 BitOffset=0x4 BitSize=0x1
            unsigned char SuppressSymbolLoad:1;// Offset=0x6d0 Size=0x1 BitOffset=0x5 BitSize=0x1
            unsigned char Prefetching:1;// Offset=0x6d0 Size=0x1 BitOffset=0x6 BitSize=0x1
            unsigned char OwnsVadExclusive:1;// Offset=0x6d0 Size=0x1 BitOffset=0x7 BitSize=0x1
            unsigned char SystemPagePriorityActive:1;// Offset=0x6d1 Size=0x1 BitOffset=0x0 BitSize=0x1
            unsigned char SystemPagePriority:3;// Offset=0x6d1 Size=0x1 BitOffset=0x1 BitSize=0x3
        };
    };
    unsigned char CacheManagerActive;// Offset=0x6d4 Size=0x1
    unsigned char DisablePageFaultClustering;// Offset=0x6d5 Size=0x1
    unsigned char ActiveFaultCount;// Offset=0x6d6 Size=0x1
    unsigned char LockOrderState;// Offset=0x6d7 Size=0x1
    unsigned long long AlpcMessageId;// Offset=0x6d8 Size=0x8
    union // Size=0x8 (Id=0)
    {
        void * AlpcMessage;// Offset=0x6e0 Size=0x8
        unsigned long AlpcReceiveAttributeSet;// Offset=0x6e0 Size=0x4
    };
    struct _LIST_ENTRY AlpcWaitListEntry;// Offset=0x6e8 Size=0x10
    long ExitStatus;// Offset=0x6f8 Size=0x4
    unsigned long CacheManagerCount;// Offset=0x6fc Size=0x4
    unsigned long IoBoostCount;// Offset=0x700 Size=0x4
    unsigned long IoQoSBoostCount;// Offset=0x704 Size=0x4
    unsigned long IoQoSThrottleCount;// Offset=0x708 Size=0x4
    struct _LIST_ENTRY BoostList;// Offset=0x710 Size=0x10
    struct _LIST_ENTRY DeboostList;// Offset=0x720 Size=0x10
    unsigned long long BoostListLock;// Offset=0x730 Size=0x8
    unsigned long long IrpListLock;// Offset=0x738 Size=0x8
    void * ReservedForSynchTracking;// Offset=0x740 Size=0x8
    struct _SINGLE_LIST_ENTRY CmCallbackListHead;// Offset=0x748 Size=0x8
    struct _GUID * ActivityId;// Offset=0x750 Size=0x8
    struct _SINGLE_LIST_ENTRY SeLearningModeListHead;// Offset=0x758 Size=0x8
    void * VerifierContext;// Offset=0x760 Size=0x8
    unsigned long KernelStackReference;// Offset=0x768 Size=0x4
    void * AdjustedClientToken;// Offset=0x770 Size=0x8
    void * WorkOnBehalfThread;// Offset=0x778 Size=0x8
    struct _PS_PROPERTY_SET PropertySet;// Offset=0x780 Size=0x18
    void * PicoContext;// Offset=0x798 Size=0x8
    unsigned long long UserFsBase;// Offset=0x7a0 Size=0x8
    unsigned long long UserGsBase;// Offset=0x7a8 Size=0x8
    struct _THREAD_ENERGY_VALUES * EnergyValues;// Offset=0x7b0 Size=0x8
    void * CmDbgInfo;// Offset=0x7b8 Size=0x8
    union // Size=0x8 (Id=0)
    {
        unsigned long long SelectedCpuSets;// Offset=0x7c0 Size=0x8
        unsigned long long * SelectedCpuSetsIndirect;// Offset=0x7c0 Size=0x8
    };
    struct _EJOB * Silo;// Offset=0x7c8 Size=0x8
    struct _UNICODE_STRING * ThreadName;// Offset=0x7d0 Size=0x8
    struct _CONTEXT * SetContextState;// Offset=0x7d8 Size=0x8
    unsigned long LastExpectedRunTime;// Offset=0x7e0 Size=0x4
    struct _LIST_ENTRY OwnerEntryListHead;// Offset=0x7e8 Size=0x10
    unsigned long long DisownedOwnerEntryListLock;// Offset=0x7f8 Size=0x8
    struct _LIST_ENTRY DisownedOwnerEntryListHead;// Offset=0x800 Size=0x10
};
