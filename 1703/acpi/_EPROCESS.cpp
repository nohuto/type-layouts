...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=250)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=59)
{
...
struct _KPROCESS// Size=0x2d8 (Id=60)
{
    ...
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long PpmPolicy:2;// Offset=0x1b8 Size=0x4 BitOffset=0x6 BitSize=0x2
            unsigned long ActiveGroupsMask:20;// Offset=0x1b8 Size=0x4 BitOffset=0x8 BitSize=0x14
            unsigned long VaSpaceDeleted:1;// Offset=0x1b8 Size=0x4 BitOffset=0x1c BitSize=0x1
            long ReservedFlags:3;// Offset=0x1b8 Size=0x4 BitOffset=0x1d BitSize=0x3
        };
...
struct _EX_FAST_REF// Size=0x8 (Id=92)
{
    union // Size=0x8 (Id=0)
    {
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=395)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

union _unnamed_344// Size=0x8 (Id=344)
{
    void * InstancedWorkingSet;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=420)
{
    union // Size=0x2 (Id=0)
    {
...
struct _MMSUPPORT_INSTANCE// Size=0xc8 (Id=345)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=281)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=103)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WNF_STATE_NAME// Size=0x8 (Id=485)
{
    unsigned long Data[2];// Offset=0x0 Size=0x8
};

struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=268)
{
    unsigned long HighEdgeFilter;// Offset=0x0 Size=0x4
    unsigned long LowEdgeFilter;// Offset=0x4 Size=0x4
};

struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=261)
{
...
struct _EPROCESS// Size=0x820 (Id=104)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long DisableDynamicCodeAllowRemoteDowngrade:1;// Offset=0x6cc Size=0x4 BitOffset=0x17 BitSize=0x1
            unsigned long LoaderIntegrityContinuityEnabled:1;// Offset=0x6cc Size=0x4 BitOffset=0x18 BitSize=0x1
            unsigned long LoaderIntegrityContinuityAudit:1;// Offset=0x6cc Size=0x4 BitOffset=0x19 BitSize=0x1
            unsigned long ControlFlowGuardExportSuppressionEnabled:1;// Offset=0x6cc Size=0x4 BitOffset=0x1a BitSize=0x1
            unsigned long FatalAccessTerminationRequested:1;// Offset=0x6cc Size=0x4 BitOffset=0x1b BitSize=0x1
            unsigned long DisableSystemAllowedCpuSet:1;// Offset=0x6cc Size=0x4 BitOffset=0x1c BitSize=0x1
            unsigned long ControlFlowGuardStrict:1;// Offset=0x6cc Size=0x4 BitOffset=0x1d BitSize=0x1
        };
    };
    ...
    unsigned long HighPriorityFaultsAllowed;// Offset=0x720 Size=0x4
    struct _PO_PROCESS_ENERGY_CONTEXT * EnergyContext;// Offset=0x728 Size=0x8
    void * VmContext;// Offset=0x730 Size=0x8
    unsigned long long SequenceNumber;// Offset=0x738 Size=0x8
    unsigned long long CreateInterruptTime;// Offset=0x740 Size=0x8
    unsigned long long CreateUnbiasedInterruptTime;// Offset=0x748 Size=0x8
    unsigned long long TotalUnbiasedFrozenTime;// Offset=0x750 Size=0x8
    unsigned long long LastAppStateUpdateTime;// Offset=0x758 Size=0x8
    struct // Size=0x8 (Id=0)
    {
        unsigned long long LastAppStateUptime:61;// Offset=0x760 Size=0x8 BitOffset=0x0 BitSize=0x3d
        unsigned long long LastAppState:3;// Offset=0x760 Size=0x8 BitOffset=0x3d BitSize=0x3
    };
    unsigned long long SharedCommitCharge;// Offset=0x768 Size=0x8
    struct _EX_PUSH_LOCK SharedCommitLock;// Offset=0x770 Size=0x8
    struct _LIST_ENTRY SharedCommitLinks;// Offset=0x778 Size=0x10
    union // Size=0x798 (Id=0)
    {
        unsigned long long AllowedCpuSets;// Offset=0x788 Size=0x8
        unsigned long long DefaultCpuSets;// Offset=0x790 Size=0x8
        unsigned long long * AllowedCpuSetsIndirect;// Offset=0x788 Size=0x8
        unsigned long long * DefaultCpuSetsIndirect;// Offset=0x790 Size=0x8
    };
    void * DiskIoAttribution;// Offset=0x798 Size=0x8
    void * DxgProcess;// Offset=0x7a0 Size=0x8
    unsigned long Win32KFilterSet;// Offset=0x7a8 Size=0x4
    union _PS_INTERLOCKED_TIMER_DELAY_VALUES ProcessTimerDelay;// Offset=0x7b0 Size=0x8
    unsigned long KTimerSets;// Offset=0x7b8 Size=0x4
    unsigned long KTimer2Sets;// Offset=0x7bc Size=0x4
    unsigned long ThreadTimerSets;// Offset=0x7c0 Size=0x4
    unsigned long long VirtualTimerListLock;// Offset=0x7c8 Size=0x8
    struct _LIST_ENTRY VirtualTimerListHead;// Offset=0x7d0 Size=0x10
    union // Size=0x8 (Id=0)
    {
        struct _WNF_STATE_NAME WakeChannel;// Offset=0x7e0 Size=0x8
        struct _PS_PROCESS_WAKE_INFORMATION WakeInfo;// Offset=0x7e0 Size=0x30
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long Flags4;// Offset=0x810 Size=0x4
        struct // Size=0x4 (Id=0)
        {
            unsigned long PicoCreated:1;// Offset=0x810 Size=0x4 BitOffset=0x0 BitSize=0x1
            unsigned long RestrictSetThreadContext:1;// Offset=0x810 Size=0x4 BitOffset=0x1 BitSize=0x1
            unsigned long AddressPolicyFrozen:1;// Offset=0x810 Size=0x4 BitOffset=0x2 BitSize=0x1
            unsigned long RestrictIndirectBranchPrediction:1;// Offset=0x810 Size=0x4 BitOffset=0x3 BitSize=0x1
            unsigned long SpeculativeStoreBypassDisable:1;// Offset=0x810 Size=0x4 BitOffset=0x4 BitSize=0x1
        };
    };
    unsigned long long SecurityDomain;// Offset=0x818 Size=0x8
};
