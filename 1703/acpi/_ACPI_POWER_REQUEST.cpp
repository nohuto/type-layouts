...
struct _ACPI_POWER_REQUEST_DEPENDENCY// Size=0x20 (Id=622)
{
...
struct _unnamed_616// Size=0x8 (Id=616)
{
...
struct _unnamed_619// Size=0x4 (Id=619)
{
    enum _SYSTEM_POWER_STATE EjectPowerState;// Offset=0x0 Size=0x4
};

union _unnamed_620// Size=0x58 (Id=620)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_615 DevicePowerRequest;// Offset=0x0 Size=0x8
        struct _unnamed_616 SystemPowerRequest;// Offset=0x0 Size=0x8
        struct _unnamed_618 WaitWakeRequest;// Offset=0x0 Size=0x58
        struct _unnamed_619 EjectPowerRequest;// Offset=0x0 Size=0x4
    };
};
...
struct _ACPI_POWER_REQUEST// Size=0x108 (Id=621)
{
    ...
    union _unnamed_620 u;// Offset=0x68 Size=0x58
