struct _NT_TIB// Size=0x38 (Id=352)
{
...
struct _KDESCRIPTOR// Size=0x10 (Id=575)
{
...
struct _KSPECIAL_REGISTERS// Size=0xf0 (Id=520)
{
...
struct _CONTEXT// Size=0x4d0 (Id=417)
{
...
struct _KPROCESSOR_STATE// Size=0x5c0 (Id=325)
{
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=270)
{
...
union _ULARGE_INTEGER// Size=0x8 (Id=75)
{
    unsigned long LowPart;// Offset=0x0 Size=0x4
    unsigned long HighPart;// Offset=0x4 Size=0x4
...
struct _KTIMER_TABLE_ENTRY// Size=0x20 (Id=580)
{
...
struct _KTIMER_TABLE// Size=0x2200 (Id=514)
{
...
struct _KGATE// Size=0x18 (Id=289)
{
...
struct _KTIMER// Size=0x40 (Id=445)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=315)
{
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=448)
{
...
struct _IOP_IRP_STACK_PROFILER// Size=0x54 (Id=415)
{
    unsigned long Profile[20];// Offset=0x0 Size=0x50
    unsigned long TotalIrps;// Offset=0x50 Size=0x4
};

struct _KSHARED_READY_QUEUE// Size=0x270 (Id=351)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _KPRCB// Size=0x7ec0 (Id=42)
{
    ...
    unsigned long long SharedReadyQueueMask;// Offset=0x61c0 Size=0x8
    struct _KSHARED_READY_QUEUE * SharedReadyQueue;// Offset=0x61c8 Size=0x8
    unsigned long SharedQueueScanOwner;// Offset=0x61d0 Size=0x4
    unsigned long ScanSiblingIndex;// Offset=0x61d4 Size=0x4
    unsigned long long CoreProcessorSet;// Offset=0x61d8 Size=0x8
    unsigned long long ScanSiblingMask;// Offset=0x61e0 Size=0x8
    unsigned long long LLCMask;// Offset=0x61e8 Size=0x8
    unsigned long long CacheProcessorMask[5];// Offset=0x61f0 Size=0x28
    struct _PROCESSOR_PROFILE_CONTROL_AREA * ProcessorProfileControlArea;// Offset=0x6218 Size=0x8
    void * ProfileEventIndexAddress;// Offset=0x6220 Size=0x8
    void ** DpcWatchdogProfile;// Offset=0x6228 Size=0x8
    void ** DpcWatchdogProfileCurrentEmptyCapture;// Offset=0x6230 Size=0x8
    unsigned long long PrcbPad94[9];// Offset=0x6238 Size=0x48
    struct _SYNCH_COUNTERS SynchCounters;// Offset=0x6280 Size=0xb8
    unsigned long long PteBitCache;// Offset=0x6338 Size=0x8
    unsigned long PteBitOffset;// Offset=0x6340 Size=0x4
    struct _FILESYSTEM_DISK_COUNTERS FsCounters;// Offset=0x6348 Size=0x10
    unsigned char VendorString[13];// Offset=0x6358 Size=0xd
    unsigned char PrcbPad100[2];// Offset=0x6365 Size=0x2
    unsigned char PendingVirtualLittle;// Offset=0x6367 Size=0x1
    unsigned long long FeatureBits;// Offset=0x6368 Size=0x8
    unsigned long PrcbPad110;// Offset=0x6370 Size=0x4
    union _LARGE_INTEGER UpdateSignature;// Offset=0x6378 Size=0x8
    struct _CONTEXT * Context;// Offset=0x6380 Size=0x8
    unsigned long ContextFlagsInit;// Offset=0x6388 Size=0x4
    struct _XSAVE_AREA * ExtendedState;// Offset=0x6390 Size=0x8
    void * IsrStack;// Offset=0x6398 Size=0x8
    struct _KENTROPY_TIMING_STATE EntropyTimingState;// Offset=0x63a0 Size=0x150
    unsigned long long PrcbPad111;// Offset=0x64f0 Size=0x8
    unsigned long long PrcbPad112[7];// Offset=0x64f8 Size=0x38
    struct _SINGLE_LIST_ENTRY AbSelfIoBoostsList;// Offset=0x6530 Size=0x8
    struct _SINGLE_LIST_ENTRY AbPropagateBoostsList;// Offset=0x6538 Size=0x8
    struct _KDPC AbDpc;// Offset=0x6540 Size=0x40
    struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerCurrent;// Offset=0x6580 Size=0x54
    struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerPrevious;// Offset=0x65d4 Size=0x54
    struct _KSHARED_READY_QUEUE LocalSharedReadyQueue;// Offset=0x6640 Size=0x270
    struct _KTIMER_EXPIRATION_TRACE TimerExpirationTrace[16];// Offset=0x68b0 Size=0x100
    unsigned long TimerExpirationTraceCount;// Offset=0x69b0 Size=0x4
    void * ExSaPageArray;// Offset=0x69b8 Size=0x8
    struct _KSECURE_FAULT_INFORMATION SecureFault;// Offset=0x69c0 Size=0x10
    struct _REQUEST_MAILBOX * Mailbox;// Offset=0x6a00 Size=0x8
    unsigned long long PrcbPad130[7];// Offset=0x6a08 Size=0x38
    unsigned char PrcbPad135[1088];// Offset=0x6a40 Size=0x440
