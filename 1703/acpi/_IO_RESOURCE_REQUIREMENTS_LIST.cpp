...
struct _unnamed_550// Size=0x10 (Id=550)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_551// Size=0xc (Id=551)
{
...
struct _unnamed_552// Size=0x18 (Id=552)
{
...
struct _unnamed_553// Size=0x18 (Id=553)
{
...
struct _unnamed_554// Size=0x18 (Id=554)
{
...
union _unnamed_556// Size=0x18 (Id=556)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_544 Port;// Offset=0x0 Size=0x18
        struct _unnamed_544 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_546 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_547 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_548 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_544 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_549 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_550 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_551 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_552 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_553 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_554 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_555 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=557)
{
    ...
    union _unnamed_556 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=518)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=333)
{
