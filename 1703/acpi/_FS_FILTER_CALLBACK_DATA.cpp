...
struct _unnamed_656// Size=0x8 (Id=656)
{
...
struct _unnamed_661// Size=0x20 (Id=661)
{
...
struct _unnamed_662// Size=0x28 (Id=662)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=663)
{
    struct _unnamed_655 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_656 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_658 AcquireForSectionSynchronization;// Offset=0x0 Size=0x10
    struct _unnamed_660 NotifyStreamFileObject;// Offset=0x0 Size=0x10
    struct _unnamed_661 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_662 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=633)
{
