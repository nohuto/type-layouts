...
struct _unnamed_117// Size=0x18 (Id=117)
{
...
struct _unnamed_137// Size=0x4 (Id=137)
{
...
struct _unnamed_142// Size=0x1 (Id=142)
{
...
struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=321)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=297)
{
...
union _unnamed_158// Size=0x20 (Id=158)
{
    struct _unnamed_114 Create;// Offset=0x0 Size=0x20
    struct _unnamed_115 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_116 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_117 Read;// Offset=0x0 Size=0x18
    struct _unnamed_117 Write;// Offset=0x0 Size=0x18
    struct _unnamed_119 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_120 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_121 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_122 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_123 QueryEa;// Offset=0x0 Size=0x20
    struct _unnamed_124 SetEa;// Offset=0x0 Size=0x4
    struct _unnamed_126 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_126 SetVolume;// Offset=0x0 Size=0x10
    struct _unnamed_127 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_128 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_129 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_130 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_131 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_132 MountVolume;// Offset=0x0 Size=0x10
    struct _unnamed_132 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_134 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_135 QueryQuota;// Offset=0x0 Size=0x20
    struct _unnamed_124 SetQuota;// Offset=0x0 Size=0x4
    struct _unnamed_137 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_138 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_139 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_140 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_141 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_142 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_144 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_146 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_148 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_150 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_151 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_154 Power;// Offset=0x0 Size=0x20
    struct _unnamed_155 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_156 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_157 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=159)
{
    ...
    union _unnamed_158 Parameters;// Offset=0x8 Size=0x20
