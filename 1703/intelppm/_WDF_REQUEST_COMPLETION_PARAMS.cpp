...
union _unnamed_296// Size=0x8 (Id=296)
{
    void * Ptr;// Offset=0x0 Size=0x8
    unsigned long long Value;// Offset=0x0 Size=0x8
};

struct _unnamed_297// Size=0x20 (Id=297)
{
    union _unnamed_296 Argument1;// Offset=0x0 Size=0x8
    union _unnamed_296 Argument2;// Offset=0x8 Size=0x8
    union _unnamed_296 Argument3;// Offset=0x10 Size=0x8
    union _unnamed_296 Argument4;// Offset=0x18 Size=0x8
};
...
union _unnamed_300// Size=0x30 (Id=300)
{
    ...
    {
        struct _unnamed_292 Write;// Offset=0x0 Size=0x18
        struct _unnamed_292 Read;// Offset=0x0 Size=0x18
        struct _unnamed_295 Ioctl;// Offset=0x0 Size=0x30
        struct _unnamed_297 Others;// Offset=0x0 Size=0x20
