union _unnamed_71// Size=0x8 (Id=71)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=63)
{
    union // Size=0x4 (Id=0)
    {
...
union _unnamed_73// Size=0x10 (Id=73)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_72 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=458)
{
...
union _unnamed_75// Size=0x58 (Id=75)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_74 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=76)
{
    ...
    union _unnamed_71 AssociatedIrp;// Offset=0x18 Size=0x8
