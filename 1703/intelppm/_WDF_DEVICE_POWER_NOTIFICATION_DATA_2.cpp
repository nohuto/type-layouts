...
struct _unnamed_393// Size=0x8 (Id=393)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_394// Size=0x4 (Id=394)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_395// Size=0x8 (Id=395)
{
    struct _unnamed_393 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_394 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_393 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=234)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_395 Data;// Offset=0x4 Size=0x8
};
