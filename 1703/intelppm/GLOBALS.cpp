...
struct _KAFFINITY_EX// Size=0xa8 (Id=463)
{
...
struct _PPM_DRIVER_DISPATCH_TABLE// Size=0xf8 (Id=435)
{
    ...
    long  ( * SetProcessorPep)(void * );// Offset=0x88 Size=0x8
    ...
    unsigned long  ( * QueryPackageId)(unsigned long );// Offset=0xc8 Size=0x8
    unsigned long  ( * QueryPackageProcessorCount)(unsigned long );// Offset=0xd0 Size=0x8
    long  ( * ReadHiddenProcessorMsr)(unsigned long ,unsigned long ,unsigned long long * );// Offset=0xd8 Size=0x8
    long  ( * WriteHiddenProcessorMsr)(unsigned long ,unsigned long ,unsigned long long ,unsigned long long );// Offset=0xe0 Size=0x8
    long  ( * ReadHiddenProcessorIoPort)(unsigned long ,unsigned short ,unsigned short ,unsigned long * );// Offset=0xe8 Size=0x8
    long  ( * WriteHiddenProcessorIoPort)(unsigned long ,unsigned short ,unsigned short ,unsigned long ,unsigned long );// Offset=0xf0 Size=0x8
};
...
struct _PCC_INTERFACE_INTERNAL// Size=0x58 (Id=489)
{
...
struct _PCC_INTERFACE_STANDARD// Size=0x80 (Id=519)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
    ...
    union _unnamed_518 Flags;// Offset=0x54 Size=0x4
...
struct _PROC_ENERGY_COUNTER// Size=0xc (Id=418)
{
    union // Size=0x4 (Id=0)
    {
...
struct _PROC_ENERGY_MODEL// Size=0xd8 (Id=381)
{
    unsigned long PowerEnvelope;// Offset=0x0 Size=0x4
    unsigned long NumberOfCounters;// Offset=0x4 Size=0x4
    struct _PROC_ENERGY_COUNTER EnergyCounters[16];// Offset=0x8 Size=0xc0
    void  ( * ComputeEnergy)(unsigned long ,unsigned long long ,unsigned long long ,unsigned long ,unsigned long long * );// Offset=0xc8 Size=0x8
    void  ( * SnapEnergyCounters)(unsigned long ,unsigned char ,unsigned char );// Offset=0xd0 Size=0x8
};

struct GLOBALS// Size=0x768 (Id=356)
{
    ...
    struct PPM_DRIVER_INTERFACE DrvInterface;// Offset=0x120 Size=0xf0
    struct _PPM_DRIVER_DISPATCH_TABLE PpmDispatchTable;// Offset=0x210 Size=0xf8
    struct _KAFFINITY_EX ProcessorsEnumerated;// Offset=0x308 Size=0xa8
    long  ( * RegisterIdleStates)(struct _FDO_DATA * );// Offset=0x3b0 Size=0x8
    long  ( * RegisterPStates)(struct _FDO_DATA * );// Offset=0x3b8 Size=0x8
    long  ( * RegisterPerfCap)(struct _FDO_DATA * );// Offset=0x3c0 Size=0x8
    long  ( * RegisterPerfFeedback)(struct _FDO_DATA * );// Offset=0x3c8 Size=0x8
    long  ( * RegisterLegacyPcc)(struct _FDO_DATA * );// Offset=0x3d0 Size=0x8
    long  ( * RegisterCpc)(struct _FDO_DATA * );// Offset=0x3d8 Size=0x8
    long  ( * RegisterPepPerf)(struct _FDO_DATA * );// Offset=0x3e0 Size=0x8
    long  ( * GetProcessorIndex)(struct _FDO_DATA * );// Offset=0x3e8 Size=0x8
    long  ( * RegisterPackage)(struct _FDO_DATA * );// Offset=0x3f0 Size=0x8
    struct _EVENT_DESCRIPTOR * SummaryEvent;// Offset=0x3f8 Size=0x8
    struct _EVENT_DESCRIPTOR * Summary2Event;// Offset=0x400 Size=0x8
    struct _EVENT_DESCRIPTOR * IdleStatesErrorEvent;// Offset=0x408 Size=0x8
    struct _EVENT_DESCRIPTOR * PerfStatesErrorEvent;// Offset=0x410 Size=0x8
    struct _EVENT_DESCRIPTOR * ThrottleStatesErrorEvent;// Offset=0x418 Size=0x8
    struct _EVENT_DESCRIPTOR * CapInfoEvent;// Offset=0x420 Size=0x8
    unsigned char SyntheticPsdAllowed;// Offset=0x428 Size=0x1
    enum <unnamed-enum-PerfStatesNative> PerfStatesOwner;// Offset=0x42c Size=0x4
    unsigned long HvDomainCount;// Offset=0x430 Size=0x4
    struct _PCC_INTERFACE_INTERNAL PccInterfaceInternal;// Offset=0x438 Size=0x58
    unsigned long Errata;// Offset=0x490 Size=0x4
    struct _PCC_INTERFACE_STANDARD PccInterface;// Offset=0x498 Size=0x80
    struct _PCC_SUBSPACE_REGISTRATION * PccSubspace;// Offset=0x518 Size=0x8
    unsigned long PccRegisteredProcessors;// Offset=0x520 Size=0x4
    void  ( * PccCallback)();// Offset=0x528 Size=0x8
    struct WDFSPINLOCK__ * PccMutex;// Offset=0x530 Size=0x8
    struct _IO_WORKITEM * PccCapWorker;// Offset=0x538 Size=0x8
    unsigned long PepRegisteredProcessors;// Offset=0x540 Size=0x4
    unsigned char PccCapUpdated;// Offset=0x544 Size=0x1
    unsigned char PccCapWorkerQueued;// Offset=0x545 Size=0x1
    unsigned char AssertsDisabled;// Offset=0x546 Size=0x1
    unsigned long CoordinatedStateCount;// Offset=0x548 Size=0x4
    struct _PLATFORM_IDLE_STATES * PlatformIdleStates;// Offset=0x550 Size=0x8
    struct _COORDINATED_IDLE_STATES * CoordinatedStates;// Offset=0x558 Size=0x8
    struct _COORDINATED_IDLE_STATES * LpiCoordinatedStates;// Offset=0x560 Size=0x8
    unsigned long * LpiStateIndexMapping;// Offset=0x568 Size=0x8
    struct _RUNTIME_LPI_STATE * LpiRuntimeState;// Offset=0x570 Size=0x8
    struct ACPI_PROCESSOR_CONTAINERS * ProcessorContainers;// Offset=0x578 Size=0x8
    struct _PREREGISTERED_VETO_LIST * VetoList;// Offset=0x580 Size=0x8
    struct _IO_WORKITEM * StateUpdateWorker;// Offset=0x588 Size=0x8
    unsigned char StateUpdateWorkerQueued;// Offset=0x590 Size=0x1
    unsigned long EfficiencyClasses;// Offset=0x594 Size=0x4
    unsigned long ProcessorCounts[2];// Offset=0x598 Size=0x8
    struct _PROC_ENERGY_MODEL EnergyModels[2];// Offset=0x5a0 Size=0x1b0
    unsigned long EnergyEnabledProcessors;// Offset=0x750 Size=0x4
    long long QpcFrequency;// Offset=0x758 Size=0x8
    unsigned long long CycleCounterFrequency;// Offset=0x760 Size=0x8
};
