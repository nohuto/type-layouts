...
struct _ACPI_PROCESSOR_CONTAINER// Size=0x28 (Id=553)
{
...
struct ACPI_PROCESSOR_CONTAINERS// Size=0x30 (Id=532)
{
    unsigned long Count;// Offset=0x0 Size=0x4
    struct _ACPI_PROCESSOR_CONTAINER ProcessorContainers[1];// Offset=0x8 Size=0x28
};
