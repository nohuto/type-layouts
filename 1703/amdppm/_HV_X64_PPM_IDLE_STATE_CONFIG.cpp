...
union _HV_X64_PPM_IDLE_STATE_CONFIG// Size=0x8 (Id=564)
{
    ...
    struct _unnamed_561 Hlt;// Offset=0x0 Size=0x8
    struct _unnamed_562 Io;// Offset=0x0 Size=0x8
    struct _unnamed_563 Mwait;// Offset=0x0 Size=0x8
};
