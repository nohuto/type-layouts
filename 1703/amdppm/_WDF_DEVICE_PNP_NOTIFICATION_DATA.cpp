...
union _unnamed_378// Size=0x8 (Id=378)
{
    struct _unnamed_376 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_377 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_376 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=233)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_378 Data;// Offset=0x4 Size=0x8
};
