...
struct _unnamed_299// Size=0x4 (Id=299)
{
...
{
    struct _unnamed_299 Parallel;// Offset=0x0 Size=0x4
};

struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=301)
{
    ...
    union _unnamed_300 Settings;// Offset=0x50 Size=0x4
