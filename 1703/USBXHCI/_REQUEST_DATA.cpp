...
struct _ENDPOINT_UPDATE_DATA// Size=0x68 (Id=714)
{
...
struct _ENDPOINT_STATIC_STREAMS_CONFIGURE// Size=0x8 (Id=639)
{
    struct _STATIC_STREAMS_DATA * StaticStreamsData;// Offset=0x0 Size=0x8
};

struct _ENDPOINT_RESET_DATA// Size=0x60 (Id=597)
{
    struct _ENDPOINT_DATA * EndpointData;// Offset=0x0 Size=0x8
    struct _BUFFER_DATA * InputBufferData;// Offset=0x8 Size=0x8
...
struct _USBDEVICE_ENDPOINTS_CONFIGURE_DATA// Size=0x2 (Id=635)
{
...
struct _CONTROL_TRANSFER_DATA// Size=0x98 (Id=721)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
...
union _REQUEST_DATA// Size=0x200 (Id=448)
{
