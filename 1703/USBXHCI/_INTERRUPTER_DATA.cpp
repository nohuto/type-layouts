struct _INTERRUPTER_COUNTER// Size=0x38 (Id=474)
{
...
struct _INTERRUPTER_FLAGS// Size=0x4 (Id=738)
{
...
struct _INTERRUPTER_DATA// Size=0xd8 (Id=411)
{
    ...
    struct _BUFFER_DATA * CurrentBufferData;// Offset=0x90 Size=0x8
    struct _BUFFER_DATA * EventRingTableBufferData;// Offset=0x98 Size=0x8
