...
struct _STATIC_STREAM_DATA// Size=0x58 (Id=440)
{
    void * TransferRingHandle;// Offset=0x0 Size=0x8
    struct _CRB Crb;// Offset=0x8 Size=0x50
};

struct _STATIC_STREAMS_DATA// Size=0x80 (Id=437)
{
    ...
    struct _BUFFER_DATA * StreamContextArray;// Offset=0x20 Size=0x8
    struct _STATIC_STREAM_DATA StaticStreamData[1];// Offset=0x28 Size=0x58
};
