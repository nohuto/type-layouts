...
union _unnamed_258// Size=0x18 (Id=258)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_246 Port;// Offset=0x0 Size=0x18
        struct _unnamed_246 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_248 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_249 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_250 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_246 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_251 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_252 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_253 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_254 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_255 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_256 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_257 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=259)
{
    ...
    union _unnamed_258 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=789)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=659)
{
