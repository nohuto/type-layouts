...
struct _unnamed_625// Size=0x10 (Id=625)
{
...
struct _unnamed_328// Size=0x1 (Id=328)
{
...
union _unnamed_329// Size=0x1 (Id=329)
{
    struct _unnamed_328 Request;// Offset=0x0 Size=0x1
...
union _unnamed_331// Size=0x2 (Id=331)
{
    struct _unnamed_330 Bytes;// Offset=0x0 Size=0x2
    unsigned short Value;// Offset=0x0 Size=0x2
};

struct _unnamed_332// Size=0x8 (Id=332)
{
    union _unnamed_329 bm;// Offset=0x0 Size=0x1
    unsigned char bRequest;// Offset=0x1 Size=0x1
    union _unnamed_331 wValue;// Offset=0x2 Size=0x2
    union _unnamed_331 wIndex;// Offset=0x4 Size=0x2
    unsigned short wLength;// Offset=0x6 Size=0x2
};

struct _unnamed_333// Size=0x8 (Id=333)
{
    unsigned char Bytes[8];// Offset=0x0 Size=0x8
};

union _WDF_USB_CONTROL_SETUP_PACKET// Size=0x8 (Id=334)
{
    struct _unnamed_332 Packet;// Offset=0x0 Size=0x8
    struct _unnamed_333 Generic;// Offset=0x0 Size=0x8
};

struct _unnamed_626// Size=0x18 (Id=626)
{
    struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
...
struct _unnamed_627// Size=0x8 (Id=627)
{
    struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
};
...
union _unnamed_628// Size=0x18 (Id=628)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_625 DeviceString;// Offset=0x0 Size=0x10
        struct _unnamed_626 DeviceControlTransfer;// Offset=0x0 Size=0x18
        struct _unnamed_627 DeviceUrb;// Offset=0x0 Size=0x8
        struct _unnamed_279 PipeWrite;// Offset=0x0 Size=0x18
        struct _unnamed_279 PipeRead;// Offset=0x0 Size=0x18
        struct _unnamed_627 PipeUrb;// Offset=0x0 Size=0x8
    };
};

struct _WDF_USB_REQUEST_COMPLETION_PARAMS// Size=0x20 (Id=629)
{
    long UsbdStatus;// Offset=0x0 Size=0x4
    enum _WDF_USB_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    union _unnamed_628 Parameters;// Offset=0x8 Size=0x18
};
