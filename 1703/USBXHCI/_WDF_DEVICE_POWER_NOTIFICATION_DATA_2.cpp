...
struct _unnamed_565// Size=0x8 (Id=565)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_566// Size=0x4 (Id=566)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_567// Size=0x8 (Id=567)
{
    struct _unnamed_565 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_566 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_565 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=568)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_567 Data;// Offset=0x4 Size=0x8
};
