...
struct _unnamed_80// Size=0x18 (Id=80)
{
...
struct _unnamed_87// Size=0x10 (Id=87)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_89// Size=0x18 (Id=89)
{
...
struct _unnamed_92// Size=0x10 (Id=92)
{
    unsigned long SecurityInformation;// Offset=0x0 Size=0x4
...
struct _unnamed_97// Size=0x4 (Id=97)
{
...
struct _unnamed_100// Size=0x8 (Id=100)
{
    struct _DEVICE_CAPABILITIES * Capabilities;// Offset=0x0 Size=0x8
};

struct _unnamed_101// Size=0x8 (Id=101)
{
...
struct _unnamed_103// Size=0x1 (Id=103)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _unnamed_105// Size=0x4 (Id=105)
{
...
struct _unnamed_112// Size=0x8 (Id=112)
{
    struct _POWER_SEQUENCE * PowerSequence;// Offset=0x0 Size=0x8
};

struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=648)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=612)
{
...
union _unnamed_119// Size=0x20 (Id=119)
{
    struct _unnamed_77 Create;// Offset=0x0 Size=0x20
    struct _unnamed_78 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_79 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_80 Read;// Offset=0x0 Size=0x18
    struct _unnamed_80 Write;// Offset=0x0 Size=0x18
    struct _unnamed_82 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_83 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_84 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_85 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_87 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_88 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_89 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_90 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_91 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_92 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_93 MountVolume;// Offset=0x0 Size=0x10
    struct _unnamed_93 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_95 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_97 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_99 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_100 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_101 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_102 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_103 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_105 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_107 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_109 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_111 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_112 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_115 Power;// Offset=0x0 Size=0x20
    struct _unnamed_116 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_117 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_118 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=120)
{
    ...
    union _unnamed_119 Parameters;// Offset=0x8 Size=0x20
