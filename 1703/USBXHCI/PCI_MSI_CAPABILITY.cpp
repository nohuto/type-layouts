...
struct _PCI_MSI_MESSAGE_CONTROL// Size=0x2 (Id=818)
{
...
struct _unnamed_779// Size=0xc (Id=779)
{
...
struct _unnamed_780// Size=0x10 (Id=780)
{
...
struct PCI_MSI_CAPABILITY// Size=0x18 (Id=781)
{
    ...
    union _unnamed_778 MessageAddressLower;// Offset=0x4 Size=0x4
    union // Size=0xc (Id=0)
    {
        struct _unnamed_779 Option32Bit;// Offset=0x8 Size=0xc
        struct _unnamed_780 Option64Bit;// Offset=0x8 Size=0x10
    };
};
