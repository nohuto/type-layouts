union _unnamed_362// Size=0x4 (Id=362)
{
...
struct _USB_DEVICE_CAPABILITY_USB20_EXTENSION_DESCRIPTOR// Size=0x7 (Id=363)
{
    ...
    union _unnamed_362 bmAttributes;// Offset=0x3 Size=0x4
};
