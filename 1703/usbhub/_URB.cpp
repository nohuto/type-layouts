struct _URB_HEADER// Size=0x18 (Id=360)
{
...
struct _URB_PIPE_REQUEST// Size=0x28 (Id=354)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
...
struct _URB_HCD_AREA// Size=0x40 (Id=347)
{
...
struct _USBD_ISO_PACKET_DESCRIPTOR// Size=0xc (Id=404)
{
...
struct _URB_ISOCH_TRANSFER// Size=0x98 (Id=369)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _URB_CONTROL_GET_CONFIGURATION_REQUEST// Size=0x88 (Id=355)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long Reserved0;// Offset=0x20 Size=0x4
