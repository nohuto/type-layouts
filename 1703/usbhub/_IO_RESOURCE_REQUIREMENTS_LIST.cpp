...
struct _unnamed_377// Size=0x8 (Id=377)
{
...
struct _unnamed_380// Size=0x10 (Id=380)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
union _unnamed_386// Size=0x18 (Id=386)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_373 Port;// Offset=0x0 Size=0x18
        struct _unnamed_373 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_376 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_377 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_378 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_373 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_379 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_380 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_381 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_382 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_383 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_384 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_385 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=387)
{
    ...
    union _unnamed_386 u;// Offset=0x8 Size=0x18
};
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=294)
{
