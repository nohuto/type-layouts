struct _KSYSTEM_TIME// Size=0xc (Id=259)
{
...
struct _XSTATE_FEATURE// Size=0x8 (Id=468)
{
    unsigned long Offset;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
};

struct _XSTATE_CONFIGURATION// Size=0x330 (Id=262)
{
...
struct _KUSER_SHARED_DATA// Size=0x708 (Id=13)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long SpareBits:22;// Offset=0x2f0 Size=0x4 BitOffset=0xa BitSize=0x16
        };
    };
