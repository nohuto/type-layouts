...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=74)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=302)
{
...
struct _IRP// Size=0xd0 (Id=81)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=3136)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=3154)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=3155)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=3166)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=3167)
            {
            ...
            struct _IRP::<unnamed-type-Tail>::<unnamed-type-Overlay> Overlay;// Offset=0x0 Size=0x58
