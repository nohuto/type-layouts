union _EINFO// Size=0x8 (Id=389)
{
    struct <unnamed-type-s>// Size=0x8 (Id=2277)
    {
...
struct _OBJECTOWNER_S// Size=0x4 (Id=551)
{
...
union _OBJECTOWNER// Size=0x4 (Id=471)
{
    struct _OBJECTOWNER_S Share;// Offset=0x0 Size=0x4
    unsigned long ulObj;// Offset=0x0 Size=0x4
};

union _UPPER_HANDLE_BITS// Size=0x2 (Id=276)
{
    struct <unnamed-type-s>// Size=0x2 (Id=4807)
    {
        unsigned char fullType;// Offset=0x0 Size=0x1
        union <unnamed-type-u>// Size=0x1 (Id=4809)
        {
...
struct _ENTRY// Size=0x18 (Id=265)
{
