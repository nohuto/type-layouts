union _unnamed_628// Size=0x4 (Id=628)
{
...
struct _USB_DEVICE_CAPABILITY_POWER_DELIVERY_DESCRIPTOR// Size=0x12 (Id=629)
{
    ...
    union _unnamed_628 bmAttributes;// Offset=0x4 Size=0x4
