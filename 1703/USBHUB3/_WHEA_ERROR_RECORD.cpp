union _WHEA_REVISION// Size=0x2 (Id=515)
{
...
union _WHEA_ERROR_RECORD_HEADER_VALIDBITS// Size=0x4 (Id=610)
{
...
union _WHEA_ERROR_RECORD_HEADER_FLAGS// Size=0x4 (Id=677)
{
    struct // Size=0x4 (Id=0)
    {
...
union _WHEA_PERSISTENCE_INFO// Size=0x8 (Id=642)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WHEA_ERROR_RECORD_HEADER// Size=0x80 (Id=556)
{
...
union _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_VALIDBITS// Size=0x1 (Id=584)
{
...
union _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_FLAGS// Size=0x4 (Id=565)
{
    struct // Size=0x4 (Id=0)
    {
