...
struct _unnamed_428// Size=0x4 (Id=428)
{
    enum _WDF_DEVICE_POWER_POLICY_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_429// Size=0x8 (Id=429)
{
    struct _unnamed_427 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_428 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_427 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=191)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_429 Data;// Offset=0x4 Size=0x8
};
