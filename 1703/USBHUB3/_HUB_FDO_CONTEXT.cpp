...
union _HUB_FLAGS_EXT// Size=0x4 (Id=595)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_20_PORT_STATUS// Size=0x2 (Id=662)
{
...
union _USB_30_PORT_STATUS// Size=0x2 (Id=652)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_PORT_STATUS// Size=0x2 (Id=546)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
...
union _USB_20_PORT_CHANGE// Size=0x2 (Id=646)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_30_PORT_CHANGE// Size=0x2 (Id=631)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_PORT_CHANGE// Size=0x2 (Id=598)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
...
union _USB_PORT_STATUS_AND_CHANGE// Size=0x4 (Id=581)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
...
struct _HUB_INFORMATION// Size=0x78 (Id=564)
{
...
struct _UCX_CONTROLLER_PCI_INFORMATION// Size=0x18 (Id=644)
{
...
struct _UCX_CONTROLLER_ACPI_INFORMATION// Size=0xf (Id=395)
{
...
struct _UCX_CONTROLLER_MAUSB_INFORMATION// Size=0x18 (Id=680)
{
...
struct _UCX_CONTROLLER_INFO// Size=0x20 (Id=568)
{
...
struct _USB_TOPOLOGY_ADDRESS// Size=0x20 (Id=589)
{
...
struct _HUB_PARENT_INTERFACE// Size=0x88 (Id=541)
{
...
struct _HUB_CONTROLLERSTACK_INTERFACE// Size=0xf8 (Id=339)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
struct _USB_BUS_INTERFACE_USBDI_V3// Size=0x60 (Id=485)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=425)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    struct // Size=0x4 (Id=0)
...
union _CONTROLLER_FLAGS// Size=0x4 (Id=597)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_HUB_STATUS// Size=0x2 (Id=542)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_HUB_CHANGE// Size=0x2 (Id=465)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_HUB_STATUS_AND_CHANGE// Size=0x4 (Id=460)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
...
union _USB_DEVICE_STATUS// Size=0x2 (Id=410)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
struct _USB_HUB_DESCRIPTOR// Size=0x47 (Id=614)
{
...
union _HUB_DESCRIPTOR// Size=0x47 (Id=571)
{
...
struct _USB_RESET_FLAGS// Size=0x4 (Id=477)
{
    struct // Size=0x4 (Id=0)
    {
...
union _PARENT_HUB_FLAGS// Size=0x4 (Id=620)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _HUB_INFO_FROM_PARENT// Size=0x48 (Id=403)
{
...
struct _HUB_FDO_CONTEXT// Size=0xa18 (Id=331)
{
    ...
    struct _HUB_CONTROLLERSTACK_INTERFACE HubControllerStackInterface;// Offset=0x150 Size=0xf8
    struct _USB_BUS_INTERFACE_USBDI_V3 UsbdBusInterface;// Offset=0x248 Size=0x60
    struct _DEVICE_CAPABILITIES DeviceCapabilities;// Offset=0x2a8 Size=0x40
    union _CONTROLLER_FLAGS ControllerFlags;// Offset=0x2e8 Size=0x4
    union _USB_HUB_STATUS_AND_CHANGE HubStatusAndChange;// Offset=0x2ec Size=0x4
    union _USB_HUB_STATUS_AND_CHANGE OldHubStatusAndChange;// Offset=0x2f0 Size=0x4
    enum _USB_HUB_FEATURE_SELECTOR CurrentFeatureSelector;// Offset=0x2f4 Size=0x4
    enum _HSM_EVENT CurrentHubChangeEvent;// Offset=0x2f8 Size=0x4
    union _USB_DEVICE_STATUS HubDeviceStatus;// Offset=0x2fc Size=0x2
    struct _CONTROL_REQUEST HubControlRequest;// Offset=0x300 Size=0xa8
    struct _HUB_INTERRUPT_REQUEST StatusChangeInterruptRequest;// Offset=0x3a8 Size=0xb8
    struct _KEVENT PnPPowerEvent;// Offset=0x460 Size=0x18
    long PnPPowerStatus;// Offset=0x478 Size=0x4
    union _HUB_DESCRIPTOR HubDescriptor;// Offset=0x47c Size=0x47
    struct _USB_CONFIGURATION_DESCRIPTOR * ConfigurationDescriptor;// Offset=0x4c8 Size=0x8
    struct _SM_CONTEXT HsmContext;// Offset=0x4d0 Size=0x420
    struct _HSM_MUX_CONTEXT MuxContext;// Offset=0x8f0 Size=0x50
    struct WDFQUEUE__ * DeviceControlQueue;// Offset=0x940 Size=0x8
    struct _USB_RESET_FLAGS ResetFlags;// Offset=0x948 Size=0x4
    struct _GUID CurrentActivityId;// Offset=0x94c Size=0x10
    struct _LIST_ENTRY ListEntry;// Offset=0x960 Size=0x10
    struct _HUB_INFO_FROM_PARENT HubInfoFromParent;// Offset=0x970 Size=0x48
    struct RECORDER_LOG__ * IfrLog;// Offset=0x9b8 Size=0x8
    struct WDFREQUEST__ * PdoGetPortStatusRequest;// Offset=0x9c0 Size=0x8
    struct WDFWMIINSTANCE__ * WmiNotificationHandle;// Offset=0x9c8 Size=0x8
    struct _UNICODE_STRING HubSymbolicLinkNameUnicode;// Offset=0x9d0 Size=0x10
    void * SelectiveSuspendSetting;// Offset=0x9e0 Size=0x8
    void * SelectiveSuspendTimeoutPowerSetting;// Offset=0x9e8 Size=0x8
    unsigned long CurrentIdleTimeout;// Offset=0x9f0 Size=0x4
    struct _PORT_CONTEXT * GetPortStatusTargetPortContext;// Offset=0x9f8 Size=0x8
    unsigned long HardwareVerifierFlags;// Offset=0xa00 Size=0x4
    unsigned long HubFailureMsgId;// Offset=0xa04 Size=0x4
    enum _WDF_POWER_DEVICE_STATE CurrentWdfPowerDeviceState;// Offset=0xa08 Size=0x4
    unsigned short OldwTotalLength;// Offset=0xa0c Size=0x2
    struct POHANDLE__ * PoHandle;// Offset=0xa10 Size=0x8
};
