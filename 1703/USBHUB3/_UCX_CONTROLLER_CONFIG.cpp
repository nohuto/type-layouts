...
struct _UCX_CONTROLLER_CONFIG// Size=0xd0 (Id=305)
{
    ...
    void * Reserved1;// Offset=0x10 Size=0x8
    ...
    void * Reserved2;// Offset=0x30 Size=0x8
    void * Reserved3;// Offset=0x38 Size=0x8
    void * Reserved4;// Offset=0x40 Size=0x8
