union _unnamed_489// Size=0x4 (Id=489)
{
...
struct _USB_DEVICE_CAPABILITY_USB20_EXTENSION_DESCRIPTOR// Size=0x7 (Id=490)
{
    ...
    union _unnamed_489 bmAttributes;// Offset=0x3 Size=0x4
};
