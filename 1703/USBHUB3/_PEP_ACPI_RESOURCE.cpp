...
union _PEP_ACPI_RESOURCE_FLAGS// Size=0x4 (Id=530)
{
...
struct _PEP_ACPI_INTERRUPT_RESOURCE// Size=0x20 (Id=367)
{
    enum _PEP_ACPI_RESOURCE_TYPE Type;// Offset=0x0 Size=0x4
...
struct _PEP_ACPI_GPIO_RESOURCE// Size=0x48 (Id=370)
{
    enum _PEP_ACPI_RESOURCE_TYPE Type;// Offset=0x0 Size=0x4
...
struct _PEP_ACPI_SPB_RESOURCE// Size=0x28 (Id=397)
{
    enum _PEP_ACPI_RESOURCE_TYPE Type;// Offset=0x0 Size=0x4
    union _PEP_ACPI_RESOURCE_FLAGS Flags;// Offset=0x4 Size=0x4
...
struct _PEP_ACPI_SPB_I2C_RESOURCE// Size=0x30 (Id=371)
{
...
struct _PEP_ACPI_SPB_SPI_RESOURCE// Size=0x38 (Id=373)
{
    struct _PEP_ACPI_SPB_RESOURCE SpbCommon;// Offset=0x0 Size=0x28
    unsigned long ConnectionSpeed;// Offset=0x28 Size=0x4
...
struct _PEP_ACPI_SPB_UART_RESOURCE// Size=0x38 (Id=372)
{
    struct _PEP_ACPI_SPB_RESOURCE SpbCommon;// Offset=0x0 Size=0x28
...
struct _PEP_ACPI_EXTENDED_ADDRESS// Size=0x48 (Id=374)
{
    enum _PEP_ACPI_RESOURCE_TYPE Type;// Offset=0x0 Size=0x4
    union _PEP_ACPI_RESOURCE_FLAGS Flags;// Offset=0x4 Size=0x4
