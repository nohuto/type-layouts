union _PDO_FLAGS// Size=0x4 (Id=603)
{
...
struct _ISM_STATE_LOG// Size=0x8 (Id=506)
{
...
struct _ISM_CONTEXT// Size=0xc0 (Id=421)
{
...
struct _D3COLD_SUPPORT_INTERFACE// Size=0x48 (Id=523)
{
...
struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=481)
{
...
struct _IO_REMOVE_LOCK// Size=0x20 (Id=408)
{
    struct _IO_REMOVE_LOCK_COMMON_BLOCK Common;// Offset=0x0 Size=0x20
};

struct _HUB_PDO_CONTEXT// Size=0x1c0 (Id=345)
{
    ...
    void * IdleResiliencyCallbackHandle;// Offset=0x198 Size=0x8
    struct _IO_REMOVE_LOCK RemoveLock;// Offset=0x1a0 Size=0x20
};
