union _unnamed_538// Size=0x2 (Id=538)
{
...
struct _USB_DEVICE_CAPABILITY_PD_CONSUMER_PORT_DESCRIPTOR// Size=0x18 (Id=539)
{
    ...
    union _unnamed_538 bmCapabilities;// Offset=0x4 Size=0x2
