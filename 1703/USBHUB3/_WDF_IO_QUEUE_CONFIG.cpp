...
union _unnamed_272// Size=0x4 (Id=272)
{
    struct _unnamed_271 Parallel;// Offset=0x0 Size=0x4
};

struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=273)
{
    ...
    union _unnamed_272 Settings;// Offset=0x50 Size=0x4
