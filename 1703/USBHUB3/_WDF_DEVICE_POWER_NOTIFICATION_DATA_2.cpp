...
struct _unnamed_453// Size=0x8 (Id=453)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_454// Size=0x4 (Id=454)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_455// Size=0x8 (Id=455)
{
    struct _unnamed_453 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_454 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_453 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=190)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_455 Data;// Offset=0x4 Size=0x8
};
