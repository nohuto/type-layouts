union _NDIS_PACKET_8021Q_INFO::_unnamed_1000// Size=0x8 (Id=1000)
{
    struct <unnamed-type-TagHeader>// Size=0x4 (Id=8819)
    {
    ...
    struct _NDIS_PACKET_8021Q_INFO::_unnamed_1001::<unnamed-type-TagHeader> TagHeader;// Offset=0x0 Size=0x4
