union _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_unnamed_1725// Size=0x4 (Id=1725)
{
    struct <unnamed-type-Transmit>// Size=0x4 (Id=10358)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_unnamed_1726::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x4
    struct <unnamed-type-Receive>// Size=0x4 (Id=10365)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_unnamed_1727::<unnamed-type-Receive> Receive;// Offset=0x0 Size=0x4
