struct _KPRCB::_unnamed_1465::_unnamed_1465// Size=0x10 (Id=1465)
{
    ...
    union // Size=0x1 (Id=0)
    {
        ...
        struct // Size=0x1 (Id=0)
        {
            ...
            unsigned char BpbStateReserved:4;// Offset=0x8 Size=0x1 BitOffset=0x4 BitSize=0x4
        };
    };
    union // Size=0x1 (Id=0)
    {
    ...
    unsigned char BpbPad[2];// Offset=0xe Size=0x2
};
