...
union _WHEA_ERROR_RECORD_HEADER_VALIDBITS// Size=0x4 (Id=578)
{
...
union _WHEA_TIMESTAMP// Size=0x8 (Id=531)
{
...
union _WHEA_ERROR_RECORD_HEADER_FLAGS// Size=0x4 (Id=652)
{
    struct // Size=0x4 (Id=0)
    {
...
union _WHEA_PERSISTENCE_INFO// Size=0x8 (Id=858)
{
    struct // Size=0x8 (Id=0)
    {
...
union _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_VALIDBITS// Size=0x1 (Id=1062)
{
...
union _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_FLAGS// Size=0x4 (Id=986)
{
    struct // Size=0x4 (Id=0)
    {
