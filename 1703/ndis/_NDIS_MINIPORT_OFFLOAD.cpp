...
struct _NDIS_TCP_IP_CHECKSUM_OFFLOAD// Size=0x20 (Id=1108)
{
    union // Size=0x18 (Id=0)
    {
        struct <unnamed-type-IPv4Transmit>// Size=0x8 (Id=10325)
        {
        ...
        struct <unnamed-type-IPv4Receive>// Size=0x8 (Id=10333)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
            unsigned long IpOptionsSupported:2;// Offset=0x4 Size=0x4 BitOffset=0x0 BitSize=0x2
            unsigned long TcpOptionsSupported:2;// Offset=0x4 Size=0x4 BitOffset=0x2 BitSize=0x2
        ...
        struct <unnamed-type-IPv6Transmit>// Size=0x8 (Id=10341)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
        ...
        struct <unnamed-type-IPv6Receive>// Size=0x8 (Id=10348)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
            unsigned long IpExtensionHeadersSupported:2;// Offset=0x4 Size=0x4 BitOffset=0x0 BitSize=0x2
            unsigned long TcpOptionsSupported:2;// Offset=0x4 Size=0x4 BitOffset=0x2 BitSize=0x2
...
struct _NDIS_TCP_LARGE_SEND_OFFLOAD_V1// Size=0x10 (Id=1022)
{
    union // Size=0x10 (Id=0)
    {
        struct <unnamed-type-IPv4>// Size=0x10 (Id=10409)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
...
struct _NDIS_IPSEC_OFFLOAD_V1// Size=0x1c (Id=1425)
{
    union // Size=0x18 (Id=0)
    {
        struct <unnamed-type-Supported>// Size=0x14 (Id=6507)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
        ...
        struct <unnamed-type-IPv4AH>// Size=0x4 (Id=6514)
        {
        ...
        struct <unnamed-type-IPv4ESP>// Size=0x4 (Id=6522)
        {
...
struct _NDIS_TCP_LARGE_SEND_OFFLOAD_V2// Size=0x1c (Id=1482)
{
    union // Size=0xc (Id=0)
    {
        struct <unnamed-type-IPv4>// Size=0xc (Id=10416)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
            unsigned long MaxOffLoadSize;// Offset=0x4 Size=0x4
            unsigned long MinSegmentCount;// Offset=0x8 Size=0x4
        ...
        struct <unnamed-type-IPv6>// Size=0x10 (Id=10421)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
            unsigned long MaxOffLoadSize;// Offset=0x4 Size=0x4
            unsigned long MinSegmentCount;// Offset=0x8 Size=0x4
...
struct _NDIS_TCP_RECV_SEG_COALESCE_OFFLOAD// Size=0x2 (Id=1357)
{
    union // Size=0x1 (Id=0)
    {
        struct <unnamed-type-IPv4>// Size=0x1 (Id=10442)
        {
        ...
        struct <unnamed-type-IPv6>// Size=0x1 (Id=10445)
        {
            unsigned char Enabled;// Offset=0x0 Size=0x1
        };
    };
...
struct _NDIS_ENCAPSULATED_PACKET_TASK_OFFLOAD// Size=0x8 (Id=1636)
{
...
struct _NDIS_ENCAPSULATED_PACKET_TASK_OFFLOAD_V2// Size=0x14 (Id=1666)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x4 (Id=0)
        ...
        unsigned long MaxHeaderSizeSupported;// Offset=0x4 Size=0x4
        union _ENCAPSULATION_PROTOCOL_INFO// Size=0x4 (Id=5791)
        {
            struct _VXLAN_INFO// Size=0x4 (Id=5792)
            {
...
struct _NDIS_RFC6877_464XLAT_OFFLOAD// Size=0x8 (Id=1117)
{
    enum _NDIS_RFC6877_464XLAT_OFFLOAD_OPTIONS XlatOffload;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
};

struct _NDIS_OFFLOAD// Size=0xbc (Id=863)
{
...
struct _NDIS_OFFLOAD_ENCAPSULATION// Size=0x1c (Id=1340)
{
    union // Size=0x10 (Id=0)
    {
        struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
        struct <unnamed-type-IPv4>// Size=0xc (Id=8590)
        {
        ...
        struct <unnamed-type-IPv6>// Size=0xc (Id=8595)
        {
            unsigned long Enabled;// Offset=0x0 Size=0x4
            unsigned long EncapsulationType;// Offset=0x4 Size=0x4
            unsigned long HeaderSize;// Offset=0x8 Size=0x4
...
struct _NDIS_TCP_CONNECTION_OFFLOAD// Size=0x14 (Id=1687)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_TCP_CONNECTION_OFFLOAD_PARAMETERS// Size=0x3c (Id=1230)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_OFFLOAD// Size=0x4c8 (Id=934)
{
