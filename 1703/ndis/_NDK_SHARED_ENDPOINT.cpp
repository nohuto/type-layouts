...
struct _NDK_OBJECT_HEADER_RESERVED_BLOCK// Size=0x20 (Id=1579)
{
    void * rf[4];// Offset=0x0 Size=0x20
};

struct _NDK_OBJECT_HEADER// Size=0x28 (Id=1216)
{
...
struct _NDK_SHARED_ENDPOINT// Size=0x30 (Id=1348)
{
    struct _NDK_OBJECT_HEADER Header;// Offset=0x0 Size=0x28
    struct _NDK_SHARED_ENDPOINT_DISPATCH * Dispatch;// Offset=0x28 Size=0x8
};
