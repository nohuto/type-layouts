...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=73)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=876)
{
...
struct _IRP// Size=0xd0 (Id=81)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=4047)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=4065)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=4066)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=4077)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=4078)
            {
