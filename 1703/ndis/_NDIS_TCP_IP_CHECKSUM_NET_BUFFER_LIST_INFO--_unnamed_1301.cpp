union _NDIS_TCP_IP_CHECKSUM_NET_BUFFER_LIST_INFO::_unnamed_1301// Size=0x8 (Id=1301)
{
    struct <unnamed-type-Transmit>// Size=0x4 (Id=10304)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_NET_BUFFER_LIST_INFO::_unnamed_1302::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x4
    struct <unnamed-type-Receive>// Size=0x4 (Id=10313)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_NET_BUFFER_LIST_INFO::_unnamed_1303::<unnamed-type-Receive> Receive;// Offset=0x0 Size=0x4
