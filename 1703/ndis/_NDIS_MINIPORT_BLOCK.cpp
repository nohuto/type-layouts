...
struct _REFERENCE// Size=0x10 (Id=455)
{
...
struct _NDIS_PM_WAKE_UP_CAPABILITIES// Size=0xc (Id=798)
{
...
struct _NDIS_PNP_CAPABILITIES// Size=0x10 (Id=458)
{
    unsigned long Flags;// Offset=0x0 Size=0x4
    struct _NDIS_PM_WAKE_UP_CAPABILITIES WakeUpCapabilities;// Offset=0x4 Size=0xc
};

struct _NDIS_PM_CAPABILITIES// Size=0x3c (Id=460)
{
...
struct _NDIS_PM_PARAMETERS// Size=0x14 (Id=461)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=462)
{
...
struct _NDIS_MINIPORT_WORK_ITEM// Size=0x18 (Id=1125)
{
...
struct _KBUGCHECK_CALLBACK_RECORD// Size=0x40 (Id=463)
{
...
struct _NDIS_MINIPORT_HANDLERS// Size=0xb8 (Id=464)
{
...
struct _NDIS_M_PERIODIC_RECEIVES// Size=0x90 (Id=467)
{
...
struct _NDIS_PCI_DEVICE_CUSTOM_PROPERTIES// Size=0x34 (Id=468)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_OFFLOAD_REG// Size=0x4 (Id=471)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _NDIS_EVENT// Size=0x18 (Id=473)
{
...
struct _NDIS_PM_ADMIN_CONFIG// Size=0x4 (Id=474)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _KSEMAPHORE// Size=0x20 (Id=475)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=711)
{
...
struct _IO_REMOVE_LOCK// Size=0x20 (Id=318)
{
...
struct _ULONG_REFERENCE// Size=0x10 (Id=478)
{
    unsigned long long SpinLock;// Offset=0x0 Size=0x8
...
struct _NDIS_D0_SIGNAL_WORK_ITEM// Size=0x58 (Id=479)
{
...
struct _VPCI_INVALIDATE_BLOCK_OUTPUT// Size=0x8 (Id=480)
{
    unsigned long long BlockMask;// Offset=0x0 Size=0x8
};

struct _LUID// Size=0x8 (Id=40)
{
    unsigned long LowPart;// Offset=0x0 Size=0x4
    long HighPart;// Offset=0x4 Size=0x4
};

struct _IF_PHYSICAL_ADDRESS_LH// Size=0x22 (Id=486)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    unsigned char Address[32];// Offset=0x2 Size=0x20
};

struct _POWER_WORK_ITEM// Size=0x58 (Id=487)
{
    struct _NDIS_WORK_ITEM WorkItem;// Offset=0x0 Size=0x50
    struct _IRP * pIrp;// Offset=0x50 Size=0x8
};

struct _NDIS_MINIPORT_BLOCK// Size=0x16d0 (Id=369)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    ...
    struct _NDIS_RECEIVE_SCALE_CAPABILITIES RecvScaleCapabilities;// Offset=0xa88 Size=0x14
    ...
    struct _POWER_WORK_ITEM DevicePowerOnWorkItem;// Offset=0x1528 Size=0x58
    struct _POWER_WORK_ITEM DevicePowerDownWorkItem;// Offset=0x1580 Size=0x58
    class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,-1,std::nullptr_t> > > PendingOidWatchdog;// Offset=0x15d8 Size=0x8
    class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,-1,std::nullptr_t> > > HookedOidWatchdog;// Offset=0x15e0 Size=0x8
    struct _NDIS_PD_BLOCK * PDBlock;// Offset=0x15e8 Size=0x8
    void * PdcHandle;// Offset=0x15f0 Size=0x8
    struct _NDIS_TIMER PdcTaskClientDisableTimer;// Offset=0x15f8 Size=0x80
    struct _NDIS_WORK_ITEM PdcTaskClientDisableWorkItem;// Offset=0x1678 Size=0x50
    long PdcTaskClientMode;// Offset=0x16c8 Size=0x4
    unsigned long ModernStandbyWoLMagicPacketEnable;// Offset=0x16cc Size=0x4
