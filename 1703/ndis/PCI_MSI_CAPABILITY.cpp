...
struct PCI_MSI_CAPABILITY// Size=0x18 (Id=469)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-MessageAddressLower>// Size=0x4 (Id=15307)
        {
            struct _PCI_MSI_MESSAGE_ADDRESS// Size=0x4 (Id=15308)
            {
    ...
    union // Size=0xc (Id=0)
    {
        struct PCI_MSI_CAPABILITY::_unnamed_1213::<unnamed-type-Option32Bit> Option32Bit;// Offset=0x8 Size=0xc
        struct PCI_MSI_CAPABILITY::_unnamed_1214::<unnamed-type-Option64Bit> Option64Bit;// Offset=0x8 Size=0x10
    };
};
