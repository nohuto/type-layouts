struct _OFFLOAD_STATE_HEADER// Size=0x8 (Id=1048)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long RecognizedOptions;// Offset=0x4 Size=0x4
};

struct _TCP_OFFLOAD_STATE_DELEGATED// Size=0x80 (Id=1345)
{
    union // Size=0x58 (Id=0)
    {
        ...
        struct <unnamed-type-KeepAlive>// Size=0x8 (Id=12531)
        {
        ...
        struct <unnamed-type-Retransmit>// Size=0x8 (Id=12535)
        {
