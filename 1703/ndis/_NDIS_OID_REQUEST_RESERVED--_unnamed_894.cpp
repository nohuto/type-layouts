...
union _NDIS_OID_REQUEST_RESERVED::_unnamed_894// Size=0x20 (Id=894)
{
    struct _KEVENT Event;// Offset=0x0 Size=0x18
    void * NdisVcHandle;// Offset=0x18 Size=0x8
    struct <unnamed-type-CoNdis>// Size=0x20 (Id=8712)
    {
    ...
    struct _NDIS_OID_REQUEST_RESERVED::_unnamed_896::<unnamed-type-CoNdis> CoNdis;// Offset=0x0 Size=0x20
};
