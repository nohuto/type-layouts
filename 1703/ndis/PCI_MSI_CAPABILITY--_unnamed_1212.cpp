union PCI_MSI_CAPABILITY::_unnamed_1212// Size=0x10 (Id=1212)
{
    struct <unnamed-type-Option32Bit>// Size=0xc (Id=15316)
    {
    ...
    struct PCI_MSI_CAPABILITY::_unnamed_1213::<unnamed-type-Option32Bit> Option32Bit;// Offset=0x0 Size=0xc
    struct <unnamed-type-Option64Bit>// Size=0x10 (Id=15322)
    {
    ...
    struct PCI_MSI_CAPABILITY::_unnamed_1214::<unnamed-type-Option64Bit> Option64Bit;// Offset=0x0 Size=0x10
};
