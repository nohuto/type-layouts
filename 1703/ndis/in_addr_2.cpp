struct in_addr// Size=0x4 (Id=146)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-S_un>// Size=0x4 (Id=13734)
        {
            struct <unnamed-type-S_un_b>// Size=0x4 (Id=13735)
            {
            ...
            struct <unnamed-type-S_un_w>// Size=0x4 (Id=13741)
            {
