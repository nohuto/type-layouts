...
struct _NDIS_WWAN_READY_INFO// Size=0x60 (Id=1030)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    struct _WWAN_READY_INFO ReadyInfo;// Offset=0x4 Size=0x5c
};
