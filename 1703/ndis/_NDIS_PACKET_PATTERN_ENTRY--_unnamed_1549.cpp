struct _NDIS_PM_PACKET_PATTERN// Size=0x18 (Id=677)
{
...
struct _NDIS_PM_COUNTED_STRING// Size=0x84 (Id=1686)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    wchar_t String[65];// Offset=0x2 Size=0x82
};

struct _NDIS_PM_WOL_PATTERN// Size=0xc4 (Id=1378)
{
    union // Size=0x9c (Id=0)
    {
        ...
        union _WOL_PATTERN// Size=0x28 (Id=9195)
        {
...
struct _NDIS_PM_PROTOCOL_OFFLOAD// Size=0xf0 (Id=1221)
{
    union // Size=0x9c (Id=0)
    {
        struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
        ...
        union _PROTOCOL_OFFLOAD_PARAMETERS// Size=0x50 (Id=9139)
        {
            struct _IPV4_ARP_PARAMETERS// Size=0x14 (Id=9140)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
            ...
            struct _IPV6_NS_PARAMETERS// Size=0x4c (Id=9147)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
            ...
            struct _DOT11_RSN_REKEY_PARAMETERS// Size=0x30 (Id=9155)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
...
union _NDIS_PACKET_PATTERN_ENTRY::_unnamed_1549// Size=0xf0 (Id=1549)
{
