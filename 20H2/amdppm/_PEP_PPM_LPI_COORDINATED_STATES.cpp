union _anonymous_735// Size=0x4 (Id=735)
{
...
struct _anonymous_736// Size=0x4 (Id=736)
{
    struct // Size=0x4 (Id=0)
    {
...
union _anonymous_737// Size=0x4 (Id=737)
{
    unsigned long AsUlong;// Offset=0x0 Size=0x4
    struct _anonymous_736 Arm;// Offset=0x0 Size=0x4
};
...
struct _PEP_PPM_LPI_REGISTER// Size=0x10 (Id=745)
{
...
union _anonymous_738// Size=0x10 (Id=738)
{
...
struct _PEP_PPM_COORDINATED_LPI_STATE// Size=0x60 (Id=739)
{
    unsigned long MinResidency;// Offset=0x0 Size=0x4
    unsigned long WakeupLatency;// Offset=0x4 Size=0x4
    union _anonymous_735 Flags;// Offset=0x8 Size=0x4
    union _anonymous_737 ArchContextFlags;// Offset=0xc Size=0x4
    unsigned long ResidencyCounterFrequency;// Offset=0x10 Size=0x4
    unsigned char IntegerEntryMethod;// Offset=0x14 Size=0x1
    union _anonymous_738 EntryMethod;// Offset=0x18 Size=0x10
...
struct _PEP_PPM_LPI_COORDINATED_STATES// Size=0x68 (Id=727)
{
