struct _anonymous_684// Size=0x18 (Id=684)
{
...
struct _PROC_ENERGY_ESTIMATION_COUNTERS// Size=0x88 (Id=685)
{
    unsigned long NumberOfActiveCounters;// Offset=0x0 Size=0x4
    void * PmcHandle;// Offset=0x8 Size=0x8
    struct _anonymous_684 CounterState[4];// Offset=0x10 Size=0x60
