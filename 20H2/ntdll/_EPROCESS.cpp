...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=372)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=450)
{
...
struct _KPROCESS// Size=0x438 (Id=70)
{
    ...
    union _anonymous_69 SecureState;// Offset=0x3e0 Size=0x8
...
struct _EX_FAST_REF// Size=0x8 (Id=103)
{
    union // Size=0x8 (Id=0)
    {
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=542)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=573)
{
    union // Size=0x2 (Id=0)
    {
...
struct _MMSUPPORT_INSTANCE// Size=0xc0 (Id=496)
{
...
struct _MMSUPPORT_SHARED// Size=0x80 (Id=515)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=415)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=507)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=387)
{
...
struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=408)
{
    struct _RTL_AVL_TREE Tree;// Offset=0x0 Size=0x8
    struct _EX_PUSH_LOCK Lock;// Offset=0x8 Size=0x8
};

struct _EPROCESS// Size=0xa40 (Id=119)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _anonymous_117 MitigationFlagsValues;// Offset=0x9d0 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x9d4 Size=0x4
        struct _anonymous_118 MitigationFlags2Values;// Offset=0x9d4 Size=0x4
    };
    ...
    struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES DynamicEnforcedCetCompatibleRanges;// Offset=0xa10 Size=0x10
    unsigned long DisabledComponentFlags;// Offset=0xa20 Size=0x4
    unsigned long * PathRedirectionHashes;// Offset=0xa28 Size=0x8
};
