...
struct _anonymous_761// Size=0x18 (Id=761)
{
...
struct _anonymous_762// Size=0x20 (Id=762)
{
...
struct _anonymous_763// Size=0x28 (Id=763)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=764)
{
    struct _anonymous_758 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _anonymous_759 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _anonymous_761 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _anonymous_762 QueryOpen;// Offset=0x0 Size=0x20
    struct _anonymous_763 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=741)
{
