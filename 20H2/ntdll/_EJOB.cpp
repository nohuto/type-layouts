...
struct _OWNER_ENTRY// Size=0x10 (Id=540)
{
...
struct _ERESOURCE// Size=0x68 (Id=454)
{
...
struct _KAFFINITY_EX// Size=0xa8 (Id=482)
{
...
struct _PROCESS_DISK_COUNTERS// Size=0x28 (Id=319)
{
...
struct _WNF_STATE_NAME// Size=0x8 (Id=624)
{
    unsigned long Data[2];// Offset=0x0 Size=0x8
};

struct _PS_JOB_WAKE_INFORMATION// Size=0x48 (Id=551)
{
...
struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=397)
{
...
struct _EPROCESS_VALUES// Size=0x68 (Id=335)
{
...
struct _JOB_RATE_CONTROL_HEADER// Size=0x28 (Id=344)
{
...
struct _PS_IO_CONTROL_ENTRY// Size=0x38 (Id=429)
{
...
struct _WORK_QUEUE_ITEM// Size=0x20 (Id=92)
{
...
union _JOBOBJECT_ENERGY_TRACKING_STATE// Size=0x8 (Id=331)
{
    unsigned long long Value;// Offset=0x0 Size=0x8
...
struct _EJOB// Size=0x640 (Id=186)
{
    ...
    struct _EPROCESS_VALUES Accounting;// Offset=0x460 Size=0x68
    ...
    struct _GUID ContainerTelemetryId;// Offset=0x4e8 Size=0x10
    struct _ESERVERSILO_GLOBALS * ServerSiloGlobals;// Offset=0x4f8 Size=0x8
    struct _PS_PROPERTY_SET PropertySet;// Offset=0x500 Size=0x18
    struct _PSP_STORAGE * Storage;// Offset=0x518 Size=0x8
    struct _JOB_NET_RATE_CONTROL * NetRateControl;// Offset=0x520 Size=0x8
    union // Size=0x4 (Id=0)
    {
        unsigned long JobFlags;// Offset=0x528 Size=0x4
        struct // Size=0x4 (Id=0)
        {
            unsigned long CloseDone:1;// Offset=0x528 Size=0x4 BitOffset=0x0 BitSize=0x1
            unsigned long MultiGroup:1;// Offset=0x528 Size=0x4 BitOffset=0x1 BitSize=0x1
            unsigned long OutstandingNotification:1;// Offset=0x528 Size=0x4 BitOffset=0x2 BitSize=0x1
            unsigned long NotificationInProgress:1;// Offset=0x528 Size=0x4 BitOffset=0x3 BitSize=0x1
            unsigned long UILimits:1;// Offset=0x528 Size=0x4 BitOffset=0x4 BitSize=0x1
            unsigned long CpuRateControlActive:1;// Offset=0x528 Size=0x4 BitOffset=0x5 BitSize=0x1
            unsigned long OwnCpuRateControl:1;// Offset=0x528 Size=0x4 BitOffset=0x6 BitSize=0x1
            unsigned long Terminating:1;// Offset=0x528 Size=0x4 BitOffset=0x7 BitSize=0x1
            unsigned long WorkingSetLock:1;// Offset=0x528 Size=0x4 BitOffset=0x8 BitSize=0x1
            unsigned long JobFrozen:1;// Offset=0x528 Size=0x4 BitOffset=0x9 BitSize=0x1
            unsigned long Background:1;// Offset=0x528 Size=0x4 BitOffset=0xa BitSize=0x1
            unsigned long WakeNotificationAllocated:1;// Offset=0x528 Size=0x4 BitOffset=0xb BitSize=0x1
            unsigned long WakeNotificationEnabled:1;// Offset=0x528 Size=0x4 BitOffset=0xc BitSize=0x1
            unsigned long WakeNotificationPending:1;// Offset=0x528 Size=0x4 BitOffset=0xd BitSize=0x1
            unsigned long LimitNotificationRequired:1;// Offset=0x528 Size=0x4 BitOffset=0xe BitSize=0x1
            unsigned long ZeroCountNotificationRequired:1;// Offset=0x528 Size=0x4 BitOffset=0xf BitSize=0x1
            unsigned long CycleTimeNotificationRequired:1;// Offset=0x528 Size=0x4 BitOffset=0x10 BitSize=0x1
            unsigned long CycleTimeNotificationPending:1;// Offset=0x528 Size=0x4 BitOffset=0x11 BitSize=0x1
            unsigned long TimersVirtualized:1;// Offset=0x528 Size=0x4 BitOffset=0x12 BitSize=0x1
            unsigned long JobSwapped:1;// Offset=0x528 Size=0x4 BitOffset=0x13 BitSize=0x1
            unsigned long ViolationDetected:1;// Offset=0x528 Size=0x4 BitOffset=0x14 BitSize=0x1
            unsigned long EmptyJobNotified:1;// Offset=0x528 Size=0x4 BitOffset=0x15 BitSize=0x1
            unsigned long NoSystemCharge:1;// Offset=0x528 Size=0x4 BitOffset=0x16 BitSize=0x1
            unsigned long DropNoWakeCharges:1;// Offset=0x528 Size=0x4 BitOffset=0x17 BitSize=0x1
            unsigned long NoWakeChargePolicyDecided:1;// Offset=0x528 Size=0x4 BitOffset=0x18 BitSize=0x1
            unsigned long NetRateControlActive:1;// Offset=0x528 Size=0x4 BitOffset=0x19 BitSize=0x1
            unsigned long OwnNetRateControl:1;// Offset=0x528 Size=0x4 BitOffset=0x1a BitSize=0x1
            unsigned long IoRateControlActive:1;// Offset=0x528 Size=0x4 BitOffset=0x1b BitSize=0x1
            unsigned long OwnIoRateControl:1;// Offset=0x528 Size=0x4 BitOffset=0x1c BitSize=0x1
            unsigned long DisallowNewProcesses:1;// Offset=0x528 Size=0x4 BitOffset=0x1d BitSize=0x1
            unsigned long Silo:1;// Offset=0x528 Size=0x4 BitOffset=0x1e BitSize=0x1
            unsigned long ContainerTelemetryIdSet:1;// Offset=0x528 Size=0x4 BitOffset=0x1f BitSize=0x1
        };
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long JobFlags2;// Offset=0x52c Size=0x4
        struct // Size=0x4 (Id=0)
        {
            unsigned long ParentLocked:1;// Offset=0x52c Size=0x4 BitOffset=0x0 BitSize=0x1
            unsigned long EnableUsermodeSiloThreadImpersonation:1;// Offset=0x52c Size=0x4 BitOffset=0x1 BitSize=0x1
            unsigned long DisallowUsermodeSiloThreadImpersonation:1;// Offset=0x52c Size=0x4 BitOffset=0x2 BitSize=0x1
        };
    };
    struct _PROCESS_EXTENDED_ENERGY_VALUES * EnergyValues;// Offset=0x530 Size=0x8
    unsigned long long SharedCommitCharge;// Offset=0x538 Size=0x8
    unsigned long DiskIoAttributionUserRefCount;// Offset=0x540 Size=0x4
    unsigned long DiskIoAttributionRefCount;// Offset=0x544 Size=0x4
    union // Size=0x8 (Id=0)
    {
        void * DiskIoAttributionContext;// Offset=0x548 Size=0x8
        struct _EJOB * DiskIoAttributionOwnerJob;// Offset=0x548 Size=0x8
    };
    struct _JOB_RATE_CONTROL_HEADER IoRateControlHeader;// Offset=0x550 Size=0x28
    struct _PS_IO_CONTROL_ENTRY GlobalIoControl;// Offset=0x578 Size=0x38
    long IoControlStateLock;// Offset=0x5b0 Size=0x4
    struct _RTL_RB_TREE VolumeIoControlTree;// Offset=0x5b8 Size=0x10
    unsigned long long IoRateOverQuotaHistory;// Offset=0x5c8 Size=0x8
    unsigned long IoRateCurrentGeneration;// Offset=0x5d0 Size=0x4
    unsigned long IoRateLastQueryGeneration;// Offset=0x5d4 Size=0x4
    unsigned long IoRateGenerationLength;// Offset=0x5d8 Size=0x4
    unsigned long IoRateOverQuotaNotifySequenceId;// Offset=0x5dc Size=0x4
    unsigned long long LastThrottledIoTime;// Offset=0x5e0 Size=0x8
    struct _EX_PUSH_LOCK IoControlLock;// Offset=0x5e8 Size=0x8
    long long SiloHardReferenceCount;// Offset=0x5f0 Size=0x8
    struct _WORK_QUEUE_ITEM RundownWorkItem;// Offset=0x5f8 Size=0x20
    void * PartitionObject;// Offset=0x618 Size=0x8
    struct _EJOB * PartitionOwnerJob;// Offset=0x620 Size=0x8
    union _JOBOBJECT_ENERGY_TRACKING_STATE EnergyTrackingState;// Offset=0x628 Size=0x8
    unsigned long long KernelWaitTime;// Offset=0x630 Size=0x8
    unsigned long long UserWaitTime;// Offset=0x638 Size=0x8
};
