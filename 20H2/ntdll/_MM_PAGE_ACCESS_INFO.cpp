struct _anonymous_421// Size=0x4 (Id=421)
{
...
union _MM_PAGE_ACCESS_INFO_FLAGS// Size=0x4 (Id=423)
{
    struct _anonymous_421 File;// Offset=0x0 Size=0x4
    struct _anonymous_422 Private;// Offset=0x0 Size=0x4
};

struct _MM_PAGE_ACCESS_INFO// Size=0x8 (Id=418)
{
    union // Size=0x8 (Id=0)
    {
