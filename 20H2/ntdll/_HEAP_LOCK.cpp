struct _RTL_CRITICAL_SECTION// Size=0x28 (Id=237)
{
...
union _anonymous_235// Size=0x28 (Id=235)
{
    struct _RTL_CRITICAL_SECTION CriticalSection;// Offset=0x0 Size=0x28
};

struct _HEAP_LOCK// Size=0x28 (Id=236)
{
    union _anonymous_235 Lock;// Offset=0x0 Size=0x28
};
