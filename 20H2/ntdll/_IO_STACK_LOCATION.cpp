struct _anonymous_128// Size=0x20 (Id=128)
{
...
struct _anonymous_129// Size=0x20 (Id=129)
{
    struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
    unsigned long Options;// Offset=0x8 Size=0x4
...
struct _anonymous_131// Size=0x18 (Id=131)
{
...
struct _anonymous_133// Size=0x20 (Id=133)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_136// Size=0x18 (Id=136)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _anonymous_137// Size=0x10 (Id=137)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
};

struct _anonymous_138// Size=0x20 (Id=138)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
...
struct _anonymous_139// Size=0x20 (Id=139)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_142// Size=0x10 (Id=142)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    enum _FSINFOCLASS FsInformationClass;// Offset=0x8 Size=0x4
};

struct _anonymous_143// Size=0x20 (Id=143)
{
...
struct _anonymous_144// Size=0x18 (Id=144)
{
...
struct _anonymous_145// Size=0x20 (Id=145)
{
    unsigned long OutputBufferLength;// Offset=0x0 Size=0x4
    unsigned long InputBufferLength;// Offset=0x8 Size=0x4
...
struct _anonymous_158// Size=0x1 (Id=158)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _anonymous_160// Size=0x4 (Id=160)
{
...
struct _anonymous_166// Size=0x4 (Id=166)
{
    enum _SYSTEM_POWER_STATE PowerState;// Offset=0x0 Size=0x4
};

struct _anonymous_167// Size=0x8 (Id=167)
{
    struct _POWER_SEQUENCE * PowerSequence;// Offset=0x0 Size=0x8
};

struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=465)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=437)
{
...
struct _anonymous_171// Size=0x10 (Id=171)
{
...
struct _anonymous_172// Size=0x20 (Id=172)
{
...
struct _anonymous_173// Size=0x20 (Id=173)
{
...
union _anonymous_174// Size=0x20 (Id=174)
{
    struct _anonymous_128 Create;// Offset=0x0 Size=0x20
    struct _anonymous_129 CreatePipe;// Offset=0x0 Size=0x20
    struct _anonymous_130 CreateMailslot;// Offset=0x0 Size=0x20
    struct _anonymous_131 Read;// Offset=0x0 Size=0x18
    struct _anonymous_131 Write;// Offset=0x0 Size=0x18
    struct _anonymous_133 QueryDirectory;// Offset=0x0 Size=0x20
    struct _anonymous_134 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _anonymous_136 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _anonymous_137 QueryFile;// Offset=0x0 Size=0x10
    struct _anonymous_138 SetFile;// Offset=0x0 Size=0x20
    struct _anonymous_139 QueryEa;// Offset=0x0 Size=0x20
    struct _anonymous_140 SetEa;// Offset=0x0 Size=0x4
    struct _anonymous_142 QueryVolume;// Offset=0x0 Size=0x10
    struct _anonymous_142 SetVolume;// Offset=0x0 Size=0x10
    struct _anonymous_143 FileSystemControl;// Offset=0x0 Size=0x20
    struct _anonymous_144 LockControl;// Offset=0x0 Size=0x18
    struct _anonymous_145 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _anonymous_146 QuerySecurity;// Offset=0x0 Size=0x10
    struct _anonymous_147 SetSecurity;// Offset=0x0 Size=0x10
    struct _anonymous_148 MountVolume;// Offset=0x0 Size=0x10
    struct _anonymous_148 VerifyVolume;// Offset=0x0 Size=0x10
    struct _anonymous_150 Scsi;// Offset=0x0 Size=0x8
    struct _anonymous_151 QueryQuota;// Offset=0x0 Size=0x20
    struct _anonymous_140 SetQuota;// Offset=0x0 Size=0x4
    struct _anonymous_153 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _anonymous_154 QueryInterface;// Offset=0x0 Size=0x20
    struct _anonymous_155 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _anonymous_156 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _anonymous_157 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _anonymous_158 SetLock;// Offset=0x0 Size=0x1
    struct _anonymous_160 QueryId;// Offset=0x0 Size=0x4
    struct _anonymous_162 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _anonymous_164 UsageNotification;// Offset=0x0 Size=0x10
    struct _anonymous_166 WaitWake;// Offset=0x0 Size=0x4
    struct _anonymous_167 PowerSequence;// Offset=0x0 Size=0x8
    struct _anonymous_170 Power;// Offset=0x0 Size=0x20
    struct _anonymous_171 StartDevice;// Offset=0x0 Size=0x10
    struct _anonymous_172 WMI;// Offset=0x0 Size=0x20
    struct _anonymous_173 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=175)
{
    ...
    union _anonymous_174 Parameters;// Offset=0x8 Size=0x20
