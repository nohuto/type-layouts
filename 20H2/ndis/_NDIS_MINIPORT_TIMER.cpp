...
struct _NDIS_MINIPORT_TIMER// Size=0xa0 (Id=1005)
{
    struct _KTIMER Timer;// Offset=0x0 Size=0x40
    struct _KDPC Dpc;// Offset=0x40 Size=0x40
    void  ( * MiniportTimerFunction)(void * ,void * ,void * ,void * );// Offset=0x80 Size=0x8
    void * MiniportTimerContext;// Offset=0x88 Size=0x8
    struct _NDIS_MINIPORT_BLOCK * Miniport;// Offset=0x90 Size=0x8
    struct _NDIS_MINIPORT_TIMER * NextTimer;// Offset=0x98 Size=0x8
    void _NDIS_MINIPORT_TIMER(struct _NDIS_MINIPORT_TIMER * );
    void _NDIS_MINIPORT_TIMER(struct _NDIS_MINIPORT_TIMER & );
    struct _NDIS_MINIPORT_TIMER & operator=(struct _NDIS_MINIPORT_TIMER * );
    struct _NDIS_MINIPORT_TIMER & operator=(struct _NDIS_MINIPORT_TIMER & );
};
