union _NDIS_PACKET_8021Q_INFO::_anonymous_1184// Size=0x8 (Id=1184)
{
    struct <unnamed-type-TagHeader>// Size=0x4 (Id=9378)
    {
    ...
    struct _NDIS_PACKET_8021Q_INFO::_anonymous_1185::<unnamed-type-TagHeader> TagHeader;// Offset=0x0 Size=0x4
