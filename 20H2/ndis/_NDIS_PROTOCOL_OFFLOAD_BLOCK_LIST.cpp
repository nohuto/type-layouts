...
struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST// Size=0x98 (Id=1056)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * NextBlock;// Offset=0x8 Size=0x8
    struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * DependentBlockList;// Offset=0x10 Size=0x8
    int Status;// Offset=0x18 Size=0x4
    void * NdisReserved[3];// Offset=0x20 Size=0x18
    struct _NDIS_OFFLOAD_HANDLE * OffloadHandle;// Offset=0x38 Size=0x8
