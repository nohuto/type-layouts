struct _KPRCB::_anonymous_1662::_anonymous_1662::_anonymous_1662::_anonymous_1662// Size=0x1 (Id=1662)
{
    struct // Size=0x1 (Id=0)
    {
        ...
        unsigned char BpbStateReserved:3;// Offset=0x0 Size=0x1 BitOffset=0x5 BitSize=0x3
    };
};
