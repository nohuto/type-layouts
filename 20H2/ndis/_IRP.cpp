...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=1033)
{
...
struct _IRP// Size=0xd0 (Id=89)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=4434)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=4452)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=4453)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=4464)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=4465)
            {
