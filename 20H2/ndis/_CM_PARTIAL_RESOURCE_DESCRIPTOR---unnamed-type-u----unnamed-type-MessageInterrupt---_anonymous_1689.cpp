union _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-MessageInterrupt>::_anonymous_1689// Size=0x10 (Id=1689)
{
    struct <unnamed-type-Raw>// Size=0x10 (Id=2372)
    {
    ...
    struct <unnamed-type-Translated>// Size=0x10 (Id=2378)
    {
