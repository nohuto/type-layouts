union PCI_MSI_CAPABILITY::_anonymous_1227// Size=0x10 (Id=1227)
{
    struct <unnamed-type-Option32Bit>// Size=0xc (Id=16469)
    {
    ...
    struct PCI_MSI_CAPABILITY::_anonymous_1228::<unnamed-type-Option32Bit> Option32Bit;// Offset=0x0 Size=0xc
    struct <unnamed-type-Option64Bit>// Size=0x10 (Id=16475)
    {
    ...
    struct PCI_MSI_CAPABILITY::_anonymous_1229::<unnamed-type-Option64Bit> Option64Bit;// Offset=0x0 Size=0x10
};
