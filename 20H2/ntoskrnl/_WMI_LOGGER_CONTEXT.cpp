...
struct _ETW_BUFFER_QUEUE// Size=0x10 (Id=839)
{
...
struct _ETW_REF_CLOCK// Size=0x10 (Id=1338)
{
...
struct _KMUTANT// Size=0x38 (Id=1362)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _TOKEN_CONTROL// Size=0x28 (Id=1694)
{
...
struct _SECURITY_CLIENT_CONTEXT// Size=0x48 (Id=1145)
{
...
struct _ETW_STACK_TRACE_BLOCK// Size=0x80 (Id=1517)
{
...
struct _DISALLOWED_GUIDS// Size=0x10 (Id=1329)
{
...
struct _WMI_LOGGER_CONTEXT// Size=0x530 (Id=848)
{
    ...
    struct PERIODIC_CAPTURE_STATE_CONTEXT * PeriodicCaptureStateContext;// Offset=0x428 Size=0x8
    struct _ETW_SOFT_RESTART_CONTEXT * SoftRestartContext;// Offset=0x430 Size=0x8
    struct _ETW_SILODRIVERSTATE * SiloState;// Offset=0x438 Size=0x8
    struct _WORK_QUEUE_ITEM CompressionWorkItem;// Offset=0x440 Size=0x20
    long CompressionWorkItemState;// Offset=0x460 Size=0x4
    struct _EX_PUSH_LOCK CompressionLock;// Offset=0x468 Size=0x8
    struct _WMI_BUFFER_HEADER * CompressionTarget;// Offset=0x470 Size=0x8
    void * CompressionWorkspace;// Offset=0x478 Size=0x8
    long CompressionOn;// Offset=0x480 Size=0x4
    unsigned long CompressionRatioGuess;// Offset=0x484 Size=0x4
    unsigned long PartialBufferCompressionLevel;// Offset=0x488 Size=0x4
    enum ETW_COMPRESSION_RESUMPTION_MODE CompressionResumptionMode;// Offset=0x48c Size=0x4
    struct _SINGLE_LIST_ENTRY PlaceholderList;// Offset=0x490 Size=0x8
    struct _KDPC CompressionDpc;// Offset=0x498 Size=0x40
    union _LARGE_INTEGER LastBufferSwitchTime;// Offset=0x4d8 Size=0x8
    union _LARGE_INTEGER BufferWriteDuration;// Offset=0x4e0 Size=0x8
    union _LARGE_INTEGER BufferCompressDuration;// Offset=0x4e8 Size=0x8
    long long ReferenceQpcDelta;// Offset=0x4f0 Size=0x8
    struct _ETW_EVENT_CALLBACK_CONTEXT * CallbackContext;// Offset=0x4f8 Size=0x8
    union _LARGE_INTEGER * LastDroppedTime;// Offset=0x500 Size=0x8
    union _LARGE_INTEGER * FlushingLastDroppedTime;// Offset=0x508 Size=0x8
    long long FlushingSequenceNumber;// Offset=0x510 Size=0x8
    struct _ETW_PARTITION_CONTEXT PartitionContext;// Offset=0x518 Size=0x8
    struct _MDL * BufferMdl;// Offset=0x520 Size=0x8
};
