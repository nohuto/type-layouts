...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=1431)
{
...
struct _KAPC_STATE// Size=0x30 (Id=1336)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=1390)
{
...
struct _KAPC// Size=0x58 (Id=1292)
{
    unsigned char Type;// Offset=0x0 Size=0x1
...
struct _KTHREAD// Size=0x430 (Id=412)
{
    ...
    unsigned long long EndPadding[5];// Offset=0x408 Size=0x28
};
...
struct _KSEMAPHORE// Size=0x20 (Id=630)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=1423)
{
...
struct _EX_RUNDOWN_REF// Size=0x8 (Id=457)
{
    union // Size=0x8 (Id=0)
    {
...
struct _PS_PROPERTY_SET// Size=0x18 (Id=1017)
{
...
struct _KLOCK_ENTRY_LOCK_STATE// Size=0x10 (Id=1453)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
union _KLOCK_ENTRY_BOOST_BITMAP// Size=0x4 (Id=939)
{
...
struct _KLOCK_ENTRY// Size=0x60 (Id=921)
{
