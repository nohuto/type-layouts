struct _anonymous_1195// Size=0x4 (Id=1195)
{
...
union _MM_PAGE_ACCESS_INFO_FLAGS// Size=0x4 (Id=1197)
{
    struct _anonymous_1195 File;// Offset=0x0 Size=0x4
    struct _anonymous_1196 Private;// Offset=0x0 Size=0x4
};

struct _MM_PAGE_ACCESS_INFO// Size=0x8 (Id=1190)
{
    union // Size=0x8 (Id=0)
    {
