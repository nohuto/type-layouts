...
struct _MM_GRAPHICS_VAD_FLAGS// Size=0x4 (Id=1055)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long Lock:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
struct _MM_SHARED_VAD_FLAGS// Size=0x4 (Id=1199)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long Lock:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
union _anonymous_556// Size=0x4 (Id=556)
{
...
struct _MMVAD_SHORT// Size=0x40 (Id=558)
{
    union // Size=0x10 (Id=0)
    {
    ...
    union _anonymous_556 u;// Offset=0x30 Size=0x4
    union _anonymous_557 u1;// Offset=0x34 Size=0x4
    struct _MI_VAD_EVENT_BLOCK * EventList;// Offset=0x38 Size=0x8
};

struct _MMVAD_FLAGS2// Size=0x4 (Id=1705)
{
    struct // Size=0x4 (Id=0)
    {
...
union _anonymous_1681// Size=0x4 (Id=1681)
{
...
struct _MI_VAD_SEQUENTIAL_INFO// Size=0x8 (Id=1984)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _MMVAD// Size=0x88 (Id=1683)
{
    ...
    union _anonymous_1682 u4;// Offset=0x78 Size=0x8
