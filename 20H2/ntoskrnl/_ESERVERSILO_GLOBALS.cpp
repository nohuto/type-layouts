struct _OBP_SYSTEM_DOS_DEVICE_STATE// Size=0x6c (Id=1077)
{
...
struct _OBJECT_NAMESPACE_LOOKUPTABLE// Size=0x260 (Id=911)
{
...
struct _OBP_SILODRIVERSTATE// Size=0x2e0 (Id=875)
{
...
struct _SEP_SILOSTATE// Size=0x30 (Id=858)
{
...
struct _SEP_RM_LSA_CONNECTION_STATE// Size=0x50 (Id=1054)
{
...
struct _WNF_LOCK// Size=0x8 (Id=880)
{
    struct _EX_PUSH_LOCK PushLock;// Offset=0x0 Size=0x8
};

struct _WNF_SILODRIVERSTATE// Size=0x38 (Id=889)
{
...
struct _DBGK_SILOSTATE// Size=0x20 (Id=943)
{
...
struct _ESERVERSILO_GLOBALS// Size=0x4a0 (Id=692)
{
