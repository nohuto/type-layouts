struct _HAL_INTEL_ENLIGHTENMENT_INFORMATION// Size=0x1f8 (Id=242)
{
    ...
    long  ( * MapDeviceLogicalRange)(struct _HAL_HV_DMA_DOMAIN_INFO * ,unsigned long ,unsigned long long ,unsigned long long * ,unsigned long long * ,unsigned char );// Offset=0x1b0 Size=0x8
    ...
    long  ( * GetSintMessage)(unsigned char ,void ** );// Offset=0x1e0 Size=0x8
    long  ( * RestoreTime)(unsigned int ,unsigned long long ,unsigned long long );// Offset=0x1e8 Size=0x8
    long  ( * SetRootFaultReportingReady)();// Offset=0x1f0 Size=0x8
};
