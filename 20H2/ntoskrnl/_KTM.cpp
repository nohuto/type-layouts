...
struct _RTL_BALANCED_LINKS// Size=0x20 (Id=1771)
{
...
struct _KTMOBJECT_NAMESPACE_LINK// Size=0x28 (Id=1782)
{
...
struct _RTL_AVL_TABLE// Size=0x68 (Id=1713)
{
...
struct _KTMOBJECT_NAMESPACE// Size=0xa8 (Id=1901)
{
...
struct _anonymous_1764// Size=0x8 (Id=1764)
{
    unsigned int idxRecord;// Offset=0x0 Size=0x4
    unsigned long cidContainer;// Offset=0x4 Size=0x4
};

union _CLS_LSN// Size=0x8 (Id=1765)
{
    struct _anonymous_1764 offset;// Offset=0x0 Size=0x8
...
struct _KTM// Size=0x3c0 (Id=1690)
{
