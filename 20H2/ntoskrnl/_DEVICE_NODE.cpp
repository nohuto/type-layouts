...
struct _PO_DEVICE_NOTIFY// Size=0x68 (Id=1037)
{
...
struct _anonymous_623// Size=0x20 (Id=623)
{
...
struct _DEVICE_NODE// Size=0x310 (Id=625)
{
    ...
    union _anonymous_620 OverUsed1;// Offset=0x210 Size=0x8
    union _anonymous_621 OverUsed2;// Offset=0x218 Size=0x8
    ...
    struct _anonymous_623 DockInfo;// Offset=0x238 Size=0x20
