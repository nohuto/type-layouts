struct _RTL_CSPARSE_BITMAP// Size=0x40 (Id=727)
{
...
struct _RTLP_HP_ALLOC_TRACKER// Size=0x50 (Id=736)
{
...
struct _RTL_SPARSE_ARRAY// Size=0x50 (Id=729)
{
...
struct _HEAP_VAMGR_VASPACE// Size=0x860 (Id=732)
{
...
struct _HEAP_VAMGR_ALLOCATOR// Size=0x30 (Id=730)
{
...
struct _HEAP_VAMGR_CTX// Size=0x3840 (Id=1340)
{
...
union _RTL_RUN_ONCE// Size=0x8 (Id=1027)
{
...
struct _RTLP_HP_METADATA_HEAP_CTX// Size=0x10 (Id=1360)
{
    struct _SEGMENT_HEAP * Heap;// Offset=0x0 Size=0x8
    union _RTL_RUN_ONCE InitOnce;// Offset=0x8 Size=0x8
};

struct _RTL_HP_LFH_CONFIG// Size=0x4 (Id=1215)
{
...
struct _anonymous_1030// Size=0x4 (Id=1030)
{
...
struct _RTL_HP_VS_CONFIG// Size=0x4 (Id=1031)
{
    struct _anonymous_1030 Flags;// Offset=0x0 Size=0x4
};

struct _RTL_HP_SUB_ALLOCATOR_CONFIGS// Size=0x8 (Id=1501)
{
    struct _RTL_HP_LFH_CONFIG LfhConfigs;// Offset=0x0 Size=0x4
    struct _RTL_HP_VS_CONFIG VsConfigs;// Offset=0x4 Size=0x4
};

struct _RTLP_HP_HEAP_MANAGER// Size=0x38d0 (Id=735)
{
...
struct _EX_HEAP_SESSION_STATE// Size=0x38f0 (Id=1064)
{
