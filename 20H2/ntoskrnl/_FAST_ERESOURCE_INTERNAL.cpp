...
struct _KWAIT_CHAIN// Size=0x8 (Id=1161)
{
    void * Head;// Offset=0x0 Size=0x8
};

struct _FAST_ERESOURCE_INTERNAL// Size=0x68 (Id=1565)
{
    struct _LIST_ENTRY SystemResourcesList;// Offset=0x0 Size=0x10
    void * ReservedPointer;// Offset=0x10 Size=0x8
    ...
    struct _KWAIT_CHAIN ExclusiveWaiters;// Offset=0x28 Size=0x8
    struct _LIST_ENTRY OwnerEntryListHead;// Offset=0x30 Size=0x10
    ...
    void * ReservedWin64OnlyPointer;// Offset=0x50 Size=0x8
    union // Size=0x8 (Id=0)
    {
