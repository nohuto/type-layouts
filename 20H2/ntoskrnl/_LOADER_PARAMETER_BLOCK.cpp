...
struct _EFI_FIRMWARE_INFORMATION// Size=0x38 (Id=2011)
{
...
struct _PCAT_FIRMWARE_INFORMATION// Size=0x4 (Id=2018)
{
    unsigned long PlaceHolder;// Offset=0x0 Size=0x4
};

union _anonymous_1945// Size=0x38 (Id=1945)
{
...
struct _FIRMWARE_INFORMATION_LOADER_BLOCK// Size=0x40 (Id=1946)
{
    ...
    union _anonymous_1945 u;// Offset=0x8 Size=0x38
};

struct _LOADER_PARAMETER_BLOCK// Size=0x160 (Id=1748)
{
    ...
    union _anonymous_1747 u;// Offset=0xf8 Size=0x10
