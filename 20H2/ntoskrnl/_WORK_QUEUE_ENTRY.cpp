...
struct _anonymous_710// Size=0x30 (Id=710)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
struct _anonymous_711// Size=0x68 (Id=711)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
union _anonymous_712// Size=0x68 (Id=712)
{
    struct _anonymous_706 Read;// Offset=0x0 Size=0x10
    struct _anonymous_707 Write;// Offset=0x0 Size=0x8
    struct _anonymous_708 Event;// Offset=0x0 Size=0x8
    struct _anonymous_709 Notification;// Offset=0x0 Size=0x4
    struct _anonymous_710 LowPriWrite;// Offset=0x0 Size=0x30
    struct _anonymous_711 AsyncRead;// Offset=0x0 Size=0x68
};

struct _WORK_QUEUE_ENTRY// Size=0x88 (Id=713)
{
    struct _LIST_ENTRY WorkQueueLinks;// Offset=0x0 Size=0x10
    union _anonymous_712 Parameters;// Offset=0x10 Size=0x68
