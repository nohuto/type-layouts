...
union _anonymous_1631// Size=0x10 (Id=1631)
{
    struct _IO_STATUS_BLOCK IoStatus;// Offset=0x0 Size=0x10
};

struct _MODWRITER_FLAGS// Size=0x4 (Id=1827)
{
...
struct _MMMOD_WRITER_MDL_ENTRY// Size=0x108 (Id=1632)
{
    struct _LIST_ENTRY Links;// Offset=0x0 Size=0x10
    union _anonymous_1631 u;// Offset=0x10 Size=0x10
