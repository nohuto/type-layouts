...
{
    struct _anonymous_808 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

union _KALPC_DIRECT_EVENT// Size=0x8 (Id=820)
{
...
struct _KALPC_MESSAGE// Size=0x118 (Id=810)
{
    ...
    union _anonymous_809 u1;// Offset=0x28 Size=0x4
