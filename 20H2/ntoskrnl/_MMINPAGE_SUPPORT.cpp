...
struct _SLIST_ENTRY// Size=0x10 (Id=22)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=417)
{
    union // Size=0x4 (Id=0)
    {
...
struct _MI_STORE_INPAGE_COMPLETE_FLAGS// Size=0x4 (Id=2022)
{
    union // Size=0x4 (Id=0)
    {
...
union _anonymous_1265// Size=0x4 (Id=1265)
{
...
struct _MMINPAGE_SUPPORT_FLOW_THROUGH// Size=0x38 (Id=1633)
{
...
struct _MMINPAGE_SUPPORT// Size=0x1c0 (Id=1266)
{
    union // Size=0x10 (Id=0)
    {
    ...
    union _anonymous_1263 u2;// Offset=0x68 Size=0x30
    ...
    union _anonymous_1264 u3;// Offset=0xbc Size=0x4
    union _anonymous_1265 u1;// Offset=0xc0 Size=0x4
    union // Size=0x8 (Id=0)
    {
        struct _FILE_OBJECT * FilePointer;// Offset=0xc8 Size=0x8
        struct _MMPAGING_FILE * PagingFile;// Offset=0xc8 Size=0x8
    };
    union // Size=0x8 (Id=0)
    {
