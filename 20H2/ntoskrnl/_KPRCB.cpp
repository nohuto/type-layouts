union _KPRCBFLAG// Size=0x4 (Id=1221)
{
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=156)
{
...
struct _KSTATIC_AFFINITY_BLOCK// Size=0x2a0 (Id=891)
{
...
struct _KTIMER_TABLE_ENTRY// Size=0x20 (Id=612)
{
...
struct _PROC_IDLE_POLICY// Size=0x6 (Id=1891)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=1651)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=1578)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=1594)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=1843)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROC_PERF_CHECK_CONTEXT// Size=0x40 (Id=1647)
{
...
struct _PROCESSOR_POWER_STATE// Size=0x200 (Id=1480)
{
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=1290)
{
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=596)
{
...
struct _anonymous_387// Size=0x38 (Id=387)
{
...
struct _MACHINE_CHECK_CONTEXT// Size=0x50 (Id=1434)
{
...
struct _KPRCB// Size=0xaf00 (Id=388)
{
    ...
    union // Size=0x100 (Id=0)
    {
        ...
        union // Size=0x1 (Id=0)
        {
            ...
            struct // Size=0x1 (Id=0)
            {
                ...
                unsigned char BpbFlushRsbOnReturn:1;// Offset=0xf8 Size=0x1 BitOffset=0x5 BitSize=0x1
                unsigned char BpbFlushRsbOnRetpolineExit:1;// Offset=0xf8 Size=0x1 BitOffset=0x6 BitSize=0x1
                unsigned char BpbStateReserved:1;// Offset=0xf8 Size=0x1 BitOffset=0x7 BitSize=0x1
            };
        };
        union // Size=0x1 (Id=0)
        {
    ...
    union // Size=0x6d8 (Id=0)
    {
        ...
        union // Size=0x1 (Id=0)
        {
            ...
            struct // Size=0x1 (Id=0)
            {
                ...
                unsigned char BpbTrappedFlushRsbOnReturn:1;// Offset=0x6d2 Size=0x1 BitOffset=0x5 BitSize=0x1
                unsigned char BpbTrappedFlushRsbOnRetpolineExit:1;// Offset=0x6d2 Size=0x1 BitOffset=0x6 BitSize=0x1
                unsigned char BpbTrappedBpbStateReserved:1;// Offset=0x6d2 Size=0x1 BitOffset=0x7 BitSize=0x1
            };
        };
        union // Size=0x1 (Id=0)
        {
    ...
    struct _anonymous_387 StibpPairingTrace;// Offset=0x8738 Size=0x38
