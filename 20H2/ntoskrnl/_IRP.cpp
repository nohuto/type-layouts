union _anonymous_31// Size=0x8 (Id=31)
{
...
struct _anonymous_32// Size=0x10 (Id=32)
{
    union // Size=0x8 (Id=0)
    {
...
union _anonymous_33// Size=0x10 (Id=33)
{
    union // Size=0x10 (Id=0)
    {
        struct _anonymous_32 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=186)
{
...
struct _anonymous_442// Size=0x58 (Id=442)
{
...
union _anonymous_443// Size=0x58 (Id=443)
{
    union // Size=0x58 (Id=0)
    {
        struct _anonymous_442 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=444)
{
    ...
    union _anonymous_31 AssociatedIrp;// Offset=0x18 Size=0x8
