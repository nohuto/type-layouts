...
struct _anonymous_1511// Size=0x8 (Id=1511)
{
    unsigned long IdleTime;// Offset=0x0 Size=0x4
    unsigned long NonIdleTime;// Offset=0x4 Size=0x4
};

union _anonymous_1512// Size=0x8 (Id=1512)
{
    struct _anonymous_1511 Disk;// Offset=0x0 Size=0x8
};

struct _DEVICE_OBJECT_POWER_EXTENSION// Size=0x60 (Id=1513)
{
    ...
    union _anonymous_1512 Specific;// Offset=0x58 Size=0x8
};
