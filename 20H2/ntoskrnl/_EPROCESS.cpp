...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=1050)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=1258)
{
...
struct _KPROCESS// Size=0x438 (Id=411)
{
    ...
    union _anonymous_410 SecureState;// Offset=0x3e0 Size=0x8
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=1464)
{
...
struct _ALPC_PROCESS_CONTEXT// Size=0x20 (Id=1229)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=1187)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=1406)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=1109)
{
...
struct _anonymous_437// Size=0x4 (Id=437)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _anonymous_438// Size=0x4 (Id=438)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=1158)
{
    struct _RTL_AVL_TREE Tree;// Offset=0x0 Size=0x8
    struct _EX_PUSH_LOCK Lock;// Offset=0x8 Size=0x8
};

struct _EPROCESS// Size=0xa40 (Id=439)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _anonymous_437 MitigationFlagsValues;// Offset=0x9d0 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x9d4 Size=0x4
        struct _anonymous_438 MitigationFlags2Values;// Offset=0x9d4 Size=0x4
    };
