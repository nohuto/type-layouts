struct _CMSI_RW_LOCK// Size=0x8 (Id=1114)
{
...
struct _FREE_DISPLAY// Size=0x18 (Id=1540)
{
...
struct _DUAL// Size=0x278 (Id=1038)
{
...
struct _HHIVE// Size=0x600 (Id=562)
{
...
struct _CM_WORKITEM// Size=0x28 (Id=1202)
{
...
struct _CM_DIRTY_VECTOR_LOG_ENTRY// Size=0x48 (Id=1273)
{
    struct _ETHREAD * Thread;// Offset=0x0 Size=0x8
    enum _CM_DIRTY_VECTOR_OPERATION Operation;// Offset=0x8 Size=0x4
    union _anonymous_1272 Data;// Offset=0xc Size=0x8
    void * Stack[6];// Offset=0x18 Size=0x30
};

struct _CM_DIRTY_VECTOR_LOG// Size=0x488 (Id=1171)
{
