...
struct _HEAP_OPPORTUNISTIC_LARGE_PAGE_STATS// Size=0x10 (Id=1674)
{
...
struct _RTL_HP_SEG_ALLOC_POLICY// Size=0x18 (Id=1254)
{
...
struct _HEAP_RUNTIME_MEMORY_STATS// Size=0x58 (Id=759)
{
...
union _anonymous_757// Size=0x1 (Id=757)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _HEAP_SEG_CONTEXT// Size=0xc0 (Id=758)
{
    ...
    union _anonymous_757 Flags;// Offset=0xd Size=0x1
...
struct _HEAP_VS_DELAY_FREE_CONTEXT// Size=0x10 (Id=1154)
{
    union _SLIST_HEADER ListHead;// Offset=0x0 Size=0x10
};

struct _HEAP_SUBALLOCATOR_CALLBACKS// Size=0x28 (Id=725)
{
...
struct _HEAP_VS_CONTEXT// Size=0xc0 (Id=748)
{
...
struct _SEGMENT_HEAP// Size=0x800 (Id=763)
{
