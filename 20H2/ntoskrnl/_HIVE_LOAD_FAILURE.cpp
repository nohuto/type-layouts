...
struct _anonymous_572// Size=0xc (Id=572)
{
...
struct _anonymous_573// Size=0x18 (Id=573)
{
...
struct _anonymous_574// Size=0x8 (Id=574)
{
    void * CheckStack;// Offset=0x0 Size=0x8
};

struct _anonymous_575// Size=0x20 (Id=575)
{
...
struct _anonymous_576// Size=0x18 (Id=576)
{
...
struct _anonymous_577// Size=0x10 (Id=577)
{
...
struct _anonymous_579// Size=0x4 (Id=579)
{
    unsigned long FileOffset;// Offset=0x0 Size=0x4
};

struct _anonymous_1493// Size=0x8 (Id=1493)
{
    long Status;// Offset=0x0 Size=0x4
    unsigned long Point;// Offset=0x4 Size=0x4
};

struct _CM_PARSE_DEBUG_INFO// Size=0x50 (Id=1494)
{
    ...
    struct _anonymous_1493 FailurePoints[4];// Offset=0x2c Size=0x20
};

struct _HIVE_LOAD_FAILURE// Size=0x1b0 (Id=580)
{
    ...
    struct _anonymous_572 Locations[8];// Offset=0xc Size=0x60
    struct _anonymous_572 RecoverableLocations[8];// Offset=0x6c Size=0x60
    struct _anonymous_573 RegistryIO;// Offset=0xd0 Size=0x18
    struct _anonymous_574 CheckRegistry2;// Offset=0xe8 Size=0x8
    struct _anonymous_575 CheckKey;// Offset=0xf0 Size=0x20
    struct _anonymous_576 CheckValueList;// Offset=0x110 Size=0x18
    struct _anonymous_577 CheckHive;// Offset=0x128 Size=0x10
    struct _anonymous_577 CheckHive1;// Offset=0x138 Size=0x10
    struct _anonymous_578 CheckBin;// Offset=0x148 Size=0x10
    struct _anonymous_579 RecoverData;// Offset=0x158 Size=0x4
