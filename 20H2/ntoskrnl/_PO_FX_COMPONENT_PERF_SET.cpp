...
struct _PO_FX_COMPONENT_PERF_SET// Size=0x30 (Id=2048)
{
    ...
    {
        struct _anonymous_2046 Discrete;// Offset=0x20 Size=0x10
        struct _anonymous_2047 Range;// Offset=0x20 Size=0x10
    };
};
