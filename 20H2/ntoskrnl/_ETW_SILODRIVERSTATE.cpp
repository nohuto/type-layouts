...
struct _ETW_LAST_ENABLE_INFO// Size=0x10 (Id=1670)
{
...
struct _TRACE_ENABLE_INFO// Size=0x20 (Id=1366)
{
...
struct _ETW_GUID_ENTRY// Size=0x1a8 (Id=1143)
{
...
struct _ETW_HASH_BUCKET// Size=0x38 (Id=950)
{
...
struct _ETW_PRIV_HANDLE_DEMUX_TABLE// Size=0x20 (Id=1459)
{
...
struct _ETW_COUNTERS// Size=0x10 (Id=1299)
{
...
struct _ETW_SYSTEM_LOGGER// Size=0x2 (Id=1412)
{
    unsigned char LoggerId;// Offset=0x0 Size=0x1
    unsigned char ClockType;// Offset=0x1 Size=0x1
};

struct _PERFINFO_GROUPMASK// Size=0x20 (Id=456)
{
    unsigned long Masks[8];// Offset=0x0 Size=0x20
};

struct _ETW_SYSTEM_LOGGER_SETTINGS// Size=0x174 (Id=1261)
{
...
struct _ETW_SILODRIVERSTATE// Size=0x1220 (Id=855)
{
