struct _MI_PARTITION_FLAGS// Size=0x4 (Id=1802)
{
...
union _anonymous_1386// Size=0x4 (Id=1386)
{
...
struct _MI_PARTITION_CORE// Size=0x1b8 (Id=1387)
{
    unsigned short PartitionId;// Offset=0x0 Size=0x2
    union _anonymous_1386 u;// Offset=0x4 Size=0x4
...
struct _MMPAGE_FILE_EXPANSION_FLAGS// Size=0x4 (Id=1978)
{
    struct // Size=0x4 (Id=0)
    {
...
union _anonymous_1523// Size=0x4 (Id=1523)
{
    unsigned long LongFlags;// Offset=0x0 Size=0x4
    struct _MMPAGE_FILE_EXPANSION_FLAGS Flags;// Offset=0x0 Size=0x4
};

struct _MMPAGE_FILE_EXPANSION// Size=0x58 (Id=1524)
{
    ...
    union _anonymous_1523 u1;// Offset=0x4c Size=0x4
...
struct _MMMOD_WRITER_LISTHEAD// Size=0x28 (Id=1810)
{
...
union _MI_RESERVATION_CLUSTER_INFO// Size=0x4 (Id=1888)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_MODWRITE_DATA// Size=0x40 (Id=1889)
{
...
struct _MI_RESTRICTED_MODWRITES// Size=0x3 (Id=1981)
{
...
struct _MI_PARTITION_MODWRITES// Size=0x2c0 (Id=1707)
{
...
union _anonymous_1015// Size=0x4 (Id=1015)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_PARTITION_STORES// Size=0x90 (Id=1016)
{
    union _anonymous_1015 WriteAllStoreHintedPages;// Offset=0x0 Size=0x4
...
struct _MMDEREFERENCE_SEGMENT_HEADER// Size=0x50 (Id=1848)
{
...
struct _MI_PTE_CHAIN_HEAD// Size=0x18 (Id=1938)
{
...
struct _MI_CROSS_PARTITION_CHARGES// Size=0x20 (Id=1883)
{
...
struct _MI_PARTITION_SEGMENTS// Size=0x340 (Id=1481)
{
...
struct _MI_DECAY_TIMER_LINKAGE// Size=0x8 (Id=1623)
{
    struct // Size=0x8 (Id=0)
    {
...
union _anonymous_1284// Size=0x8 (Id=1284)
{
    unsigned long long Long;// Offset=0x0 Size=0x8
    struct _MI_DECAY_TIMER_LINKAGE e1;// Offset=0x0 Size=0x8
};

struct _MI_DECAY_TIMER_LINK// Size=0x8 (Id=1285)
{
    union _anonymous_1284 u1;// Offset=0x0 Size=0x8
};

struct _MI_LDW_WORK_CONTEXT// Size=0x38 (Id=1450)
{
...
struct _MI_AVAILABLE_PAGE_WAIT_STATES// Size=0x20 (Id=1484)
{
...
struct _MI_PARTITION_PAGE_LISTS// Size=0xfc0 (Id=1282)
{
...
struct _MI_PARTITION_COMMIT// Size=0x40 (Id=1599)
{
...
struct _MI_PARTITION_ZEROING// Size=0xb0 (Id=1562)
{
...
struct _MI_PAGE_COMBINING_SUPPORT// Size=0x190 (Id=1303)
{
...
struct _MMWORKING_SET_EXPANSION_HEAD// Size=0x10 (Id=1059)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
};
...
struct _anonymous_1397// Size=0x38 (Id=1397)
{
    struct _MDL Mdl;// Offset=0x0 Size=0x30
    unsigned long long Page[1];// Offset=0x30 Size=0x8
};

struct _MI_PAGEFILE_TRACES// Size=0x78 (Id=1398)
{
    ...
    struct _anonymous_1397 MdlHack;// Offset=0x40 Size=0x38
};

struct _MI_VISIBLE_PARTITION// Size=0x1200 (Id=1117)
{
...
struct _MI_PARTITION// Size=0x2d00 (Id=560)
{
