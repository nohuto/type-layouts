...
struct _ISRDPCSTATS_SEQUENCE// Size=0x28 (Id=2006)
{
...
struct _ISRDPCSTATS// Size=0x60 (Id=1743)
{
...
struct _KINTERRUPT// Size=0x120 (Id=1325)
{
    ...
    void * PhysicalDeviceObject;// Offset=0x118 Size=0x8
};
