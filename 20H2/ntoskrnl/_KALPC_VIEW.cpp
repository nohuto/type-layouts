...
union _anonymous_796// Size=0x4 (Id=796)
{
    struct _anonymous_795 s1;// Offset=0x0 Size=0x4
};

struct _KALPC_VIEW// Size=0x60 (Id=797)
{
    ...
    union _anonymous_796 u1;// Offset=0x48 Size=0x4
