...
struct _anonymous_1962// Size=0x8 (Id=1962)
{
...
struct _anonymous_1963// Size=0x10 (Id=1963)
{
    struct _GUID DiskId;// Offset=0x0 Size=0x10
};

union _anonymous_1964// Size=0x10 (Id=1964)
{
    struct _anonymous_1962 Mbr;// Offset=0x0 Size=0x8
    struct _anonymous_1963 Gpt;// Offset=0x0 Size=0x10
};

struct _DUMP_INITIALIZATION_CONTEXT// Size=0x108 (Id=1966)
{
    ...
    union _anonymous_1964 DiskInfo;// Offset=0x8c Size=0x10
...
struct _DUMP_STACK_CONTEXT// Size=0x178 (Id=1910)
{
