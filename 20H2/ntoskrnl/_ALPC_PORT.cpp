...
struct _ALPC_PORT_ATTRIBUTES// Size=0x48 (Id=1024)
{
...
struct _anonymous_800// Size=0x4 (Id=800)
{
...
union _anonymous_801// Size=0x4 (Id=801)
{
    struct _anonymous_800 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

struct _ALPC_PORT// Size=0x1d8 (Id=802)
{
    ...
    union _anonymous_801 u1;// Offset=0x1a0 Size=0x4
