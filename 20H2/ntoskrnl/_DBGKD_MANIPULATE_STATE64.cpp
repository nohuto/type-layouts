struct _DBGKD_READ_MEMORY64// Size=0x10 (Id=642)
{
...
struct _DBGKD_WRITE_MEMORY64// Size=0x10 (Id=644)
{
    unsigned long long TargetBaseAddress;// Offset=0x0 Size=0x8
    unsigned long TransferCount;// Offset=0x8 Size=0x4
...
struct _X86_DBGKD_CONTROL_SET// Size=0x10 (Id=1429)
{
    unsigned long TraceFlag;// Offset=0x0 Size=0x4
...
struct _IA64_DBGKD_CONTROL_SET// Size=0x14 (Id=1588)
{
...
struct _ARM_DBGKD_CONTROL_SET// Size=0xc (Id=1300)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
...
struct _ARM64_DBGKD_CONTROL_SET// Size=0x18 (Id=1460)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
...
struct _ARMCE_DBGKD_CONTROL_SET// Size=0xc (Id=1065)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
    unsigned long CurrentSymbolStart;// Offset=0x4 Size=0x4
    unsigned long CurrentSymbolEnd;// Offset=0x8 Size=0x4
...
struct _PPC_DBGKD_CONTROL_SET// Size=0xc (Id=1708)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
    unsigned long CurrentSymbolStart;// Offset=0x4 Size=0x4
    unsigned long CurrentSymbolEnd;// Offset=0x8 Size=0x4
...
struct _DBGKD_ANY_CONTROL_SET// Size=0x1c (Id=925)
{
...
struct _DBGKD_CONTINUE2// Size=0x20 (Id=667)
{
    long ContinueStatus;// Offset=0x0 Size=0x4
    union // Size=0x1c (Id=0)
    {
...
struct _DBGKD_READ_WRITE_IO64// Size=0x10 (Id=648)
{
...
struct _DBGKD_READ_WRITE_IO_EXTENDED64// Size=0x20 (Id=650)
{
...
struct _DBGKD_QUERY_SPECIAL_CALLS// Size=0x4 (Id=902)
{
    unsigned long NumberOfSpecialCalls;// Offset=0x0 Size=0x4
};

struct _DBGKD_SET_SPECIAL_CALL64// Size=0x8 (Id=653)
{
    unsigned long long SpecialCall;// Offset=0x0 Size=0x8
};

struct _DBGKD_SET_INTERNAL_BREAKPOINT64// Size=0x10 (Id=655)
{
    unsigned long long BreakpointAddress;// Offset=0x0 Size=0x8
    unsigned long Flags;// Offset=0x8 Size=0x4
};

struct _DBGKD_GET_INTERNAL_BREAKPOINT64// Size=0x20 (Id=656)
{
    unsigned long long BreakpointAddress;// Offset=0x0 Size=0x8
    unsigned long Flags;// Offset=0x8 Size=0x4
...
struct _DBGKD_GET_VERSION64// Size=0x28 (Id=1606)
{
...
struct _DBGKD_SEARCH_MEMORY// Size=0x18 (Id=664)
{
    union // Size=0x8 (Id=0)
    {
...
struct _DBGKD_GET_SET_BUS_DATA// Size=0x14 (Id=941)
{
...
struct _DBGKD_FILL_MEMORY// Size=0x10 (Id=1715)
{
...
struct _DBGKD_QUERY_MEMORY// Size=0x18 (Id=1012)
{
    unsigned long long Address;// Offset=0x0 Size=0x8
...
struct _DBGKD_SWITCH_PARTITION// Size=0x4 (Id=1581)
{
    unsigned long Partition;// Offset=0x0 Size=0x4
};

struct _DBGKD_CONTEXT_EX// Size=0xc (Id=1628)
{
...
struct _DBGKD_WRITE_CUSTOM_BREAKPOINT// Size=0x18 (Id=1011)
{
    unsigned long long BreakPointAddress;// Offset=0x0 Size=0x8
...
union _anonymous_658// Size=0x28 (Id=658)
{
...
struct _DBGKD_MANIPULATE_STATE64// Size=0x38 (Id=659)
{
    unsigned long ApiNumber;// Offset=0x0 Size=0x4
    unsigned short ProcessorLevel;// Offset=0x4 Size=0x2
    unsigned short Processor;// Offset=0x6 Size=0x2
    long ReturnStatus;// Offset=0x8 Size=0x4
    union _anonymous_658 u;// Offset=0x10 Size=0x28
};
