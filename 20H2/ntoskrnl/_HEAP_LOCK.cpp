struct _RTL_CRITICAL_SECTION// Size=0x28 (Id=1241)
{
...
union _anonymous_768// Size=0x68 (Id=768)
{
    struct _RTL_CRITICAL_SECTION CriticalSection;// Offset=0x0 Size=0x28
    struct _ERESOURCE Resource;// Offset=0x0 Size=0x68
};

struct _HEAP_LOCK// Size=0x68 (Id=769)
{
    union _anonymous_768 Lock;// Offset=0x0 Size=0x68
};
