...
union _CONTROL_FLAGS// Size=0x4 (Id=957)
{
...
struct _CONTROL_DATA// Size=0x180 (Id=952)
{
    ...
    struct WDFDPC__ * WdfDpcForCanceledOnQueueTransferCompletion;// Offset=0x148 Size=0x8
    struct WDFTIMER__ * WdfTimerForTransferTimeout;// Offset=0x150 Size=0x8
    struct _CONTROL_TRANSFER_DATA * TransferData;// Offset=0x158 Size=0x8
    union _CONTROL_FLAGS Flags;// Offset=0x160 Size=0x4
    unsigned long OutstandingEventCountAfterStop;// Offset=0x164 Size=0x4
    struct _LIST_ENTRY CanceledOnQueueTransferList;// Offset=0x168 Size=0x10
    unsigned char DpcRunning;// Offset=0x178 Size=0x1
};
