...
union _anonymous_325// Size=0x4 (Id=325)
{
    struct _anonymous_324 Parallel;// Offset=0x0 Size=0x4
};

struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=326)
{
    ...
    union _anonymous_325 Settings;// Offset=0x50 Size=0x4
