struct _PCI_CAPABILITIES_HEADER// Size=0x2 (Id=1020)
{
    unsigned char CapabilityID;// Offset=0x0 Size=0x1
    unsigned char Next;// Offset=0x1 Size=0x1
};

union _PCI_MSI_MESSAGE_CONTROL// Size=0x2 (Id=1019)
{
...
struct _PCI_MSI_MESSAGE_ADDRESS// Size=0x4 (Id=1027)
{
...
struct _anonymous_971// Size=0x10 (Id=971)
{
...
struct PCI_MSI_CAPABILITY// Size=0x18 (Id=972)
{
    ...
    union _anonymous_969 MessageAddressLower;// Offset=0x4 Size=0x4
    union // Size=0xc (Id=0)
    {
        struct _anonymous_970 Option32Bit;// Offset=0x8 Size=0xc
        struct _anonymous_971 Option64Bit;// Offset=0x8 Size=0x10
    };
};
