...
struct _anonymous_685// Size=0x8 (Id=685)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _anonymous_686// Size=0x4 (Id=686)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _anonymous_687// Size=0x8 (Id=687)
{
    struct _anonymous_685 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_686 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_685 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=244)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_687 Data;// Offset=0x4 Size=0x8
};
