...
struct _XIL_COMMON_BUFFER_PAGE// Size=0x10 (Id=507)
{
...
struct _COMMON_BUFFER_SECURE_DMA_PAGE// Size=0x78 (Id=510)
{
    ...
    struct _anonymous_509 PageMdl;// Offset=0x20 Size=0x38
