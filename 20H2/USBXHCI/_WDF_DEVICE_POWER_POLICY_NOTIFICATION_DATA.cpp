...
struct _anonymous_646// Size=0x4 (Id=646)
{
    enum _WDF_DEVICE_POWER_POLICY_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _anonymous_647// Size=0x8 (Id=647)
{
    struct _anonymous_645 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_646 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_645 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=648)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_647 Data;// Offset=0x4 Size=0x8
};
