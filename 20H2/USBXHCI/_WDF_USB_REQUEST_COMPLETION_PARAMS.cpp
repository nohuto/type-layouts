...
struct _anonymous_769// Size=0x10 (Id=769)
{
...
struct _anonymous_770// Size=0x18 (Id=770)
{
    struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
...
union _anonymous_772// Size=0x18 (Id=772)
{
    union // Size=0x18 (Id=0)
    {
        struct _anonymous_769 DeviceString;// Offset=0x0 Size=0x10
        struct _anonymous_770 DeviceControlTransfer;// Offset=0x0 Size=0x18
        struct _anonymous_771 DeviceUrb;// Offset=0x0 Size=0x8
        struct _anonymous_304 PipeWrite;// Offset=0x0 Size=0x18
        struct _anonymous_304 PipeRead;// Offset=0x0 Size=0x18
        struct _anonymous_771 PipeUrb;// Offset=0x0 Size=0x8
    };
};

struct _WDF_USB_REQUEST_COMPLETION_PARAMS// Size=0x20 (Id=773)
{
    long UsbdStatus;// Offset=0x0 Size=0x4
    enum _WDF_USB_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    union _anonymous_772 Parameters;// Offset=0x8 Size=0x18
};
