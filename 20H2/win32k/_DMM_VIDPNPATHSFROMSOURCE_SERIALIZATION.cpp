...
struct _D3DKMDT_GRAPHICS_RENDERING_FORMAT// Size=0x20 (Id=444)
{
...
struct _D3DKMDT_VIDPN_SOURCE_MODE// Size=0x28 (Id=419)
{
    union // Size=0x8 (Id=0)
    {
        unsigned int Id;// Offset=0x0 Size=0x4
        enum _D3DKMDT_VIDPN_SOURCE_MODE_TYPE Type;// Offset=0x4 Size=0x4
        union <unnamed-type-Format>// Size=0x20 (Id=1524)
        {
