...
struct _D3DKMDT_MONITOR_SOURCE_MODE// Size=0x60 (Id=389)
{
    unsigned int Id;// Offset=0x0 Size=0x4
    struct _D3DKMDT_VIDEO_SIGNAL_INFO VideoSignalInfo;// Offset=0x8 Size=0x38
    enum _D3DKMDT_COLOR_BASIS ColorBasis;// Offset=0x40 Size=0x4
    struct _D3DKMDT_COLOR_COEFF_DYNAMIC_RANGES ColorCoeffDynamicRanges;// Offset=0x44 Size=0x10
    enum _D3DKMDT_MONITOR_CAPABILITIES_ORIGIN Origin;// Offset=0x54 Size=0x4
    enum _D3DKMDT_MODE_PREFERENCE Preference;// Offset=0x58 Size=0x4
};
...
struct _DMM_MONITOR_SOURCE_MODE_SERIALIZATION// Size=0x68 (Id=378)
{
    struct _D3DKMDT_MONITOR_SOURCE_MODE Info;// Offset=0x0 Size=0x60
    enum _D3DKMDT_MONITOR_TIMING_TYPE TimingType;// Offset=0x60 Size=0x4
};

struct _DMM_MONITORSOURCEMODESET_SERIALIZATION// Size=0x70 (Id=188)
{
    unsigned int NumModes;// Offset=0x0 Size=0x4
    struct _DMM_MONITOR_SOURCE_MODE_SERIALIZATION ModeSerialization[1];// Offset=0x8 Size=0x68
};
