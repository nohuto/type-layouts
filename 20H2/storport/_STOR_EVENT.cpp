struct _anonymous_569// Size=0x4 (Id=569)
{
...
struct _STOR_DISPATCHER_HEADER// Size=0x18 (Id=570)
{
    union // Size=0x4 (Id=0)
    {
        struct _anonymous_569 Data;// Offset=0x0 Size=0x4
...
struct _STOR_EVENT// Size=0x18 (Id=188)
{
