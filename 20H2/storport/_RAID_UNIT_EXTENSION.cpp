...
struct _RAID_UNIT_REGISTRY_PARAMETERS// Size=0x18 (Id=389)
{
...
struct _RAID_UNIT_ATTRIBUTES// Size=0x4 (Id=563)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _RAID_WORK_ITEM_CONTEXT// Size=0x10 (Id=454)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
    struct _IRP * Irp;// Offset=0x8 Size=0x8
};

struct _STOR_ASYNC_NOTIFY_CONTEXT// Size=0x18 (Id=405)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
...
struct _anonymous_380// Size=0x4 (Id=380)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _TELEMETRY_UNIT_EXTENSION// Size=0x8 (Id=381)
{
    struct _anonymous_380 Flags;// Offset=0x0 Size=0x4
    unsigned char NvmeCriticalWarning;// Offset=0x4 Size=0x1
    unsigned char DeviceHealthPollCount;// Offset=0x5 Size=0x1
};

struct _RAID_TELEMETRY_NODE_COUNTERS// Size=0x18 (Id=371)
{
...
struct _RAID_TELEMETRY_ERROR_ENTRY// Size=0x28 (Id=548)
{
    ...
    union _anonymous_547 u;// Offset=0x20 Size=0x4
};

struct _RAID_TELEMETRY_SAMPLED_ERROR_LOG// Size=0x1c8 (Id=571)
{
...
struct _RAID_TELEMETRY_UNIQUE_ERROR_LOG// Size=0x190 (Id=510)
{
    struct _RAID_TELEMETRY_ERROR_ENTRY UniqueErrors[10];// Offset=0x0 Size=0x190
};

struct _RAID_UNIT_QOS// Size=0x30 (Id=649)
{
...
struct _RAID_UNIT_EXTENSION// Size=0xd40 (Id=267)
{
    ...
    unsigned long ActiveReferenceOnAdapter;// Offset=0xd20 Size=0x4
};
