...
union _WDF_USB_CONTROL_SETUP_PACKET// Size=0x8 (Id=920)
{
    struct <unnamed-type-Packet>// Size=0x8 (Id=17763)
    {
        union <unnamed-type-bm>// Size=0x1 (Id=17764)
        {
            struct <unnamed-type-Request>// Size=0x1 (Id=17765)
            {
        ...
        union <unnamed-type-wValue>// Size=0x2 (Id=17774)
        {
            struct <unnamed-type-Bytes>// Size=0x2 (Id=17775)
            {
        ...
        union <unnamed-type-wIndex>// Size=0x2 (Id=17781)
        {
            struct <unnamed-type-Bytes>// Size=0x2 (Id=17782)
            {
                unsigned char LowByte;// Offset=0x0 Size=0x1
                unsigned char HiByte;// Offset=0x1 Size=0x1
            };
    ...
    struct <unnamed-type-Generic>// Size=0x8 (Id=17790)
    {
...
struct _WDF_USB_REQUEST_COMPLETION_PARAMS// Size=0x20 (Id=1127)
{
    union // Size=0x8 (Id=0)
    {
        long UsbdStatus;// Offset=0x0 Size=0x4
        enum _WDF_USB_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
        union <unnamed-type-Parameters>// Size=0x18 (Id=17854)
        {
            struct <unnamed-type-DeviceString>// Size=0x10 (Id=17855)
            {
            ...
            struct <unnamed-type-DeviceControlTransfer>// Size=0x18 (Id=17861)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            ...
            struct <unnamed-type-PipeRead>// Size=0x18 (Id=17874)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
                unsigned long long Length;// Offset=0x8 Size=0x8
                unsigned long long Offset;// Offset=0x10 Size=0x8
            ...
            struct <unnamed-type-PipeUrb>// Size=0x8 (Id=17879)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            };
