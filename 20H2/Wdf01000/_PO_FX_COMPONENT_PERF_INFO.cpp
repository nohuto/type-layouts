...
struct _PO_FX_COMPONENT_PERF_SET// Size=0x30 (Id=1706)
{
    ...
    {
        struct _PO_FX_COMPONENT_PERF_SET::_anonymous_3004::<unnamed-type-Discrete> Discrete;// Offset=0x20 Size=0x10
        struct _PO_FX_COMPONENT_PERF_SET::_anonymous_3003::<unnamed-type-Range> Range;// Offset=0x20 Size=0x10
    };
};

struct _PO_FX_COMPONENT_PERF_INFO// Size=0x38 (Id=2604)
{
