...
union _MCG_STATUS// Size=0x8 (Id=2680)
{
...
struct _MCI_STATUS_BITS_COMMON// Size=0x8 (Id=2411)
{
...
struct _MCI_STATUS_AMD_BITS// Size=0x8 (Id=1977)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long McaErrorCode:16;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x10
...
struct _MCI_STATUS_INTEL_BITS// Size=0x8 (Id=1683)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long McaErrorCode:16;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x10
...
union _MCI_STATUS// Size=0x8 (Id=1814)
{
...
struct _WHEA_AMD_EXTENDED_REGISTERS// Size=0xc0 (Id=2196)
{
...
union _MCG_CAP// Size=0x8 (Id=2054)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WHEA_XPF_MCA_SECTION// Size=0x110 (Id=2526)
{
