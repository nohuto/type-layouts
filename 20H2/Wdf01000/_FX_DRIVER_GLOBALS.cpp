...
struct _KBUGCHECK_REASON_CALLBACK_RECORD// Size=0x30 (Id=645)
{
...
struct _WDF_DRIVER_GLOBALS// Size=0x38 (Id=1270)
{
...
struct _FX_DRIVER_GLOBALS// Size=0x1f0 (Id=769)
{
    unsigned long AddRef(void * ,long ,char * );
    union // Size=0x317 (Id=0)
    {
        unsigned long Release(void * ,long ,char * );// Offset=0x0 Size=0x31
        ...
        unsigned char IsCorrectVersionRegistered(struct _UNICODE_STRING * );// Offset=0x0 Size=0x1f3
