struct _anonymous_192// Size=0x4 (Id=192)
{
...
union _anonymous_193// Size=0x4 (Id=193)
{
    struct _anonymous_192 Bits;// Offset=0x0 Size=0x4
    long CookieOffset;// Offset=0x0 Size=0x4
};

struct _GS_HANDLER_DATA// Size=0xc (Id=194)
{
    union _anonymous_193 u;// Offset=0x0 Size=0x4
