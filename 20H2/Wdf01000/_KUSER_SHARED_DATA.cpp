struct _KSYSTEM_TIME// Size=0xc (Id=2352)
{
...
struct _XSTATE_FEATURE// Size=0x8 (Id=1762)
{
    unsigned long Offset;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
};

struct _XSTATE_CONFIGURATION// Size=0x338 (Id=2701)
{
...
struct _KUSER_SHARED_DATA// Size=0x720 (Id=2353)
{
    union // Size=0x30c (Id=0)
    {
        ...
        union <unnamed-type-UserCetAvailableEnvironments>// Size=0x4 (Id=10200)
        {
        ...
        union _KUSER_SHARED_DATA::<unnamed-type-UserCetAvailableEnvironments> UserCetAvailableEnvironments;// Offset=0x30c Size=0x4
    };
    ...
    struct _XSTATE_CONFIGURATION XState;// Offset=0x3d8 Size=0x338
    struct _KSYSTEM_TIME FeatureConfigurationChangeStamp;// Offset=0x710 Size=0xc
    unsigned long Spare;// Offset=0x71c Size=0x4
};
