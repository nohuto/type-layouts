...
union _WHEA_XPF_PROCINFO_VALIDBITS// Size=0x8 (Id=2822)
{
...
union _WHEA_XPF_CACHE_CHECK// Size=0x8 (Id=2383)
{
    struct // Size=0x8 (Id=0)
    {
...
union _WHEA_XPF_TLB_CHECK// Size=0x8 (Id=1748)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long TransactionTypeValid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
union _WHEA_XPF_BUS_CHECK// Size=0x8 (Id=2758)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long TransactionTypeValid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
