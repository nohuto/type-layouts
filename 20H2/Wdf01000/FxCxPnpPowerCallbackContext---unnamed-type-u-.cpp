union FxCxPnpPowerCallbackContext::<unnamed-type-u>// Size=0x18 (Id=1373)
{
    union // Size=0x18 (Id=0)
    {
        struct <unnamed-type-Generic>// Size=0x18 (Id=25294)
        {
        ...
        struct <unnamed-type-PrepareHardware>// Size=0x18 (Id=25299)
        {
        ...
        struct <unnamed-type-ReleaseHardware>// Size=0x10 (Id=25304)
        {
        ...
        struct <unnamed-type-D0Entry>// Size=0x18 (Id=25308)
        {
        ...
        struct <unnamed-type-SmIoRestart>// Size=0x18 (Id=25322)
        {
            long  ( * PreCallback)(struct WDFDEVICE__ * );// Offset=0x0 Size=0x8
            long  ( * PostCallback)(struct WDFDEVICE__ * );// Offset=0x8 Size=0x8
            void  ( * CleanupCallback)(struct WDFDEVICE__ * );// Offset=0x10 Size=0x8
        ...
        struct <unnamed-type-SmIoRestartEx>// Size=0x18 (Id=25327)
        {
            long  ( * PreCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x0 Size=0x8
            long  ( * PostCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x8 Size=0x8
            void  ( * CleanupCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x10 Size=0x8
        ...
        struct <unnamed-type-ArmWakeFromSx>// Size=0x18 (Id=25365)
        {
            long  ( * PreCallback)(struct WDFDEVICE__ * );// Offset=0x0 Size=0x8
            long  ( * PostCallback)(struct WDFDEVICE__ * );// Offset=0x8 Size=0x8
            void  ( * CleanupCallback)(struct WDFDEVICE__ * );// Offset=0x10 Size=0x8
        ...
        struct <unnamed-type-ArmWakeFromSxWithReason>// Size=0x18 (Id=25370)
        {
        ...
        struct <unnamed-type-D0EntryPostHardwareEnabled>// Size=0x18 (Id=25383)
        {
            long  ( * PreCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x0 Size=0x8
            long  ( * PostCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x8 Size=0x8
            void  ( * CleanupCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x10 Size=0x8
        ...
        struct <unnamed-type-D0ExitPreHardwareDisabled>// Size=0x10 (Id=25388)
        {
            long  ( * PreCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x0 Size=0x8
            long  ( * PostCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x8 Size=0x8
        };
