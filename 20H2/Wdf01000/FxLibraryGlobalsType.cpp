struct _OSVERSIONINFOEXW// Size=0x11c (Id=542)
{
...
struct _FX_DRIVER_TRACKER_CACHE_AWARE// Size=0x18 (Id=1290)
{
    union // Size=0x1ee (Id=0)
    {
        struct _FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=7928)
        {
        ...
        struct FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=7942)
        {
        };// Offset=0x0 Size=0x8
        long Initialize();
        void Uninitialize();
...
struct FxLibraryGlobalsType// Size=0x2a8 (Id=1314)
{
