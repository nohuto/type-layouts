...
union _PCI_EXPRESS_DPC_CAPS_REGISTER// Size=0x2 (Id=3005)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_DPC_CONTROL_REGISTER// Size=0x2 (Id=2045)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_DPC_STATUS_REGISTER// Size=0x2 (Id=2692)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_DPC_RP_PIO_STATUS_REGISTER// Size=0x4 (Id=2749)
{
...
union _PCI_EXPRESS_DPC_RP_PIO_MASK_REGISTER// Size=0x4 (Id=2340)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long CfgURCpl:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
union _PCI_EXPRESS_DPC_RP_PIO_SEVERITY_REGISTER// Size=0x4 (Id=2551)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long CfgURCpl:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
union _PCI_EXPRESS_DPC_RP_PIO_SYSERR_REGISTER// Size=0x4 (Id=1728)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long CfgURCpl:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
union _PCI_EXPRESS_DPC_RP_PIO_EXCEPTION_REGISTER// Size=0x4 (Id=2188)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long CfgURCpl:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
struct _PCI_EXPRESS_DPC_RP_PIO_HEADERLOG_REGISTER// Size=0x10 (Id=2934)
{
    unsigned long PioHeaderLogRegister[4];// Offset=0x0 Size=0x10
};

union _PCI_EXPRESS_DPC_RP_PIO_IMPSPECLOG_REGISTER// Size=0x4 (Id=1638)
{
    unsigned long PioImpSpecLog;// Offset=0x0 Size=0x4
};

struct _PCI_EXPRESS_DPC_RP_PIO_TLPPREFIXLOG_REGISTER// Size=0x10 (Id=1782)
{
    unsigned long PioTlpPrefixLogRegister[4];// Offset=0x0 Size=0x10
};

struct _PCI_EXPRESS_DPC_CAPABILITY// Size=0x44 (Id=2175)
{
    ...
    unsigned short DpcErrSrcId;// Offset=0xa Size=0x2
