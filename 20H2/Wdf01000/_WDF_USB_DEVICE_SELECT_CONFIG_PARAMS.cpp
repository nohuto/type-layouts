...
struct _WDF_USB_DEVICE_SELECT_CONFIG_PARAMS// Size=0x20 (Id=1209)
{
    union // Size=0x8 (Id=0)
    {
        unsigned long Size;// Offset=0x0 Size=0x4
        enum _WdfUsbTargetDeviceSelectConfigType Type;// Offset=0x4 Size=0x4
        union <unnamed-type-Types>// Size=0x18 (Id=17801)
        {
            struct <unnamed-type-Descriptor>// Size=0x18 (Id=17802)
            {
            ...
            struct <unnamed-type-Urb>// Size=0x8 (Id=17807)
            {
            ...
            struct <unnamed-type-SingleInterface>// Size=0x10 (Id=17810)
            {
            ...
            struct <unnamed-type-MultiInterface>// Size=0x18 (Id=17815)
            {
