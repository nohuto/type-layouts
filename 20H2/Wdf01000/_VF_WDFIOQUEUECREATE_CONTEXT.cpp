struct _VF_COMMON_CONTEXT_HEADER// Size=0x8 (Id=3042)
{
...
struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=1178)
{
    union // Size=0x50 (Id=0)
    {
        ...
        union <unnamed-type-Settings>// Size=0x4 (Id=17189)
        {
            struct <unnamed-type-Parallel>// Size=0x4 (Id=17190)
            {
...
struct _VF_WDFIOQUEUECREATE_CONTEXT// Size=0x68 (Id=3039)
{
