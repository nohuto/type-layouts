...
struct _G_STATE_LOG_ENTRY// Size=0x20 (Id=191)
{
...
struct _STATE_CONTEXT// Size=0xb0 (Id=189)
{
...
union _USB_EXTENDED_PORT_ATTRIBUTES// Size=0x4 (Id=282)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=281)
{
    union // Size=0x4 (Id=0)
    {
...
struct _WMILIB_CONTEXT// Size=0x40 (Id=387)
{
...
struct _USB_DEVICE_DESCRIPTOR// Size=0x12 (Id=215)
{
...
union _USBHUB_PDO_FLAGS// Size=0x4 (Id=272)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _HUBPDO_CLEANUP_FLAGS// Size=0x4 (Id=334)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_DEVICE_FLAGS// Size=0x4 (Id=267)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _IO_CSQ// Size=0x40 (Id=278)
{
...
struct _HUB_TIMER_OBJECT// Size=0x50 (Id=271)
{
...
struct _USB_ID_STRING// Size=0x10 (Id=377)
{
...
struct _USB_INTERFACE_DESCRIPTOR// Size=0x9 (Id=390)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
...
struct _USB_HUB_DEVICE_UXD_SETTINGS// Size=0x44 (Id=256)
{
...
union _MSOS20_FLAGS// Size=0x4 (Id=345)
{
...
struct _MSOS20_INFO// Size=0x40 (Id=312)
{
...
struct _MSOS20_DESCRIPTOR_SET_INFO// Size=0x8 (Id=296)
{
...
struct _D3COLD_SUPPORT_INTERFACE// Size=0x48 (Id=317)
{
...
struct _unnamed_140// Size=0x4 (Id=140)
{
    struct // Size=0x4 (Id=0)
    {
...
union _USB_DUAL_ROLE_FEATURES// Size=0x4 (Id=141)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct _unnamed_140 features;// Offset=0x0 Size=0x4
};

struct _DEVICE_EXTENSION_PDO// Size=0xbf8 (Id=173)
{
