...
struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=286)
{
...
union _USBHUB_FDO_FLAGS// Size=0x4 (Id=293)
{
...
union _USBHUB_FDO_FLAGS2// Size=0x4 (Id=362)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _USB_HUB_DESCRIPTOR// Size=0x47 (Id=376)
{
...
struct _KTIMER// Size=0x40 (Id=375)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _HUB_GLOBAL_UXD_SETTINGS// Size=0x10 (Id=307)
{
...
struct _USB_TOPOLOGY_ADDRESS// Size=0x20 (Id=367)
{
