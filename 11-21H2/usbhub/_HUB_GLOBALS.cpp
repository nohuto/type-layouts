...
enum _HUB_WAKE_C_ACTION
{
    HUB_WAKE_C_WinXP_Compatible=0,
    HUB_WAKE_C_Always=1,
    HUB_WAKE_C_Never=2,
    HUB_WAKE_C_UserControl=3
};
...
struct _HUB_GLOBALS// Size=0x1b8 (Id=397)
{
    unsigned long long PdoStateLock;// Offset=0x0 Size=0x8
    struct _KEVENT HubFdoOmniListLock;// Offset=0x8 Size=0x18
    struct _LIST_ENTRY HubFdoOmniListHead;// Offset=0x20 Size=0x10
    unsigned long GlobalReplicantWaitTime;// Offset=0x30 Size=0x4
    unsigned long GlobalMaxReplicantRetry;// Offset=0x34 Size=0x4
    unsigned long GlobalDisableSelectiveSuspendUI;// Offset=0x38 Size=0x4
    enum _HUB_WAKE_C_ACTION GlobalWakeOnConnectUI;// Offset=0x3c Size=0x4
    unsigned long GlobalUsbDebugModeEnabled;// Offset=0x40 Size=0x4
    unsigned long GlobalDebugBreakOnHubException;// Offset=0x44 Size=0x4
    unsigned long GlobalExceptionLogLimit;// Offset=0x48 Size=0x4
    unsigned long GlobalDebugLevel;// Offset=0x4c Size=0x4
    unsigned long GlobalEnableTestPoints;// Offset=0x50 Size=0x4
    unsigned long GlobalUseIoErrorLog;// Offset=0x54 Size=0x4
    unsigned long GlobalDisableHardReset;// Offset=0x58 Size=0x4
    unsigned long GlobalMaxHardResetRetries;// Offset=0x5c Size=0x4
    unsigned long GlobalMsOsDescriptorMode;// Offset=0x60 Size=0x4
    unsigned long ResetPortTimeoutInMilliseconds;// Offset=0x64 Size=0x4
    unsigned long GlobalLogNPages;// Offset=0x68 Size=0x4
    unsigned long GlobalDebugBreakOnReplicant;// Offset=0x6c Size=0x4
    unsigned long GlobalDebugBreakOnEnumFailure;// Offset=0x70 Size=0x4
    unsigned long GlobalDefaultHubPowerUpTime;// Offset=0x74 Size=0x4
    unsigned long GlobalEnableDiagnosticMode;// Offset=0x78 Size=0x4
    void * CurrentPdoPnpContext;// Offset=0x80 Size=0x8
    struct _STATE_CONTEXT GlobalHubContext;// Offset=0x88 Size=0xb0
    struct _LIST_ENTRY HubPowerCtxListHead;// Offset=0x138 Size=0x10
    unsigned long DebugExtVersion;// Offset=0x148 Size=0x4
    unsigned long GlobalDisableUxdSupport;// Offset=0x14c Size=0x4
    unsigned long GlobalEnableExtendedValidation;// Offset=0x150 Size=0x4
    unsigned long GlobalForceResetOnResume;// Offset=0x154 Size=0x4
    unsigned long GlobalDisableOnSoftRemove;// Offset=0x158 Size=0x4
    unsigned long GlobalDisableFastResume;// Offset=0x15c Size=0x4
    unsigned long GlobalFailSelectiveSuspend;// Offset=0x160 Size=0x4
    unsigned long long EtwRegHandle;// Offset=0x168 Size=0x8
    unsigned long EtwLoggingEnabled;// Offset=0x170 Size=0x4
    unsigned long long HubIsrListSpin;// Offset=0x178 Size=0x8
    struct _LIST_ENTRY HubIsrListHead;// Offset=0x180 Size=0x10
    struct _KEVENT HubIsrWorkerQueued;// Offset=0x190 Size=0x18
    unsigned char SQMSurpriseRemovalUnplug;// Offset=0x1a8 Size=0x1
    unsigned long GlobalDisableFastEnumeration;// Offset=0x1ac Size=0x4
    unsigned long IdleTimeout;// Offset=0x1b0 Size=0x4
    unsigned long GlobalUseEnhancedTimer;// Offset=0x1b4 Size=0x4
};
