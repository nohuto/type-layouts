...
union _unnamed_285// Size=0x4 (Id=285)
{
    struct _unnamed_284 Parallel;// Offset=0x0 Size=0x4
};

struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=286)
{
    ...
    union _unnamed_285 Settings;// Offset=0x50 Size=0x4
