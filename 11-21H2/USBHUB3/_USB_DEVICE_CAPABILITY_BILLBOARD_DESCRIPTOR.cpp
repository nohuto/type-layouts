union _unnamed_583// Size=0x2 (Id=583)
{
...
struct _USB_DEVICE_CAPABILITY_BILLBOARD_DESCRIPTOR// Size=0x30 (Id=585)
{
    ...
    union _unnamed_583 VconnPower;// Offset=0x6 Size=0x2
    unsigned char bmConfigured[32];// Offset=0x8 Size=0x20
    unsigned long bReserved;// Offset=0x28 Size=0x4
    struct _unnamed_584 AlternateMode[1];// Offset=0x2c Size=0x4
};
