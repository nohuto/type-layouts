...
struct _unnamed_460// Size=0x8 (Id=460)
{
...
union _unnamed_462// Size=0x8 (Id=462)
{
    struct _unnamed_460 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_461 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_460 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=204)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_462 Data;// Offset=0x4 Size=0x8
};
