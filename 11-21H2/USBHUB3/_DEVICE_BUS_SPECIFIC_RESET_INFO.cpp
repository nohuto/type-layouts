...
union _DEVICE_BUS_SPECIFIC_RESET_TYPE// Size=0x8 (Id=510)
{
    struct _unnamed_508 Pci;// Offset=0x0 Size=0x8
    struct _unnamed_509 Acpi;// Offset=0x0 Size=0x8
    unsigned long long AsULONGLONG;// Offset=0x0 Size=0x8
};

struct _DEVICE_BUS_SPECIFIC_RESET_INFO// Size=0x18 (Id=571)
{
