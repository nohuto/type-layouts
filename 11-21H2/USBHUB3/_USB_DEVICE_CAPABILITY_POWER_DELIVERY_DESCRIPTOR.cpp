union _unnamed_720// Size=0x4 (Id=720)
{
...
struct _USB_DEVICE_CAPABILITY_POWER_DELIVERY_DESCRIPTOR// Size=0x12 (Id=721)
{
    ...
    union _unnamed_720 bmAttributes;// Offset=0x4 Size=0x4
