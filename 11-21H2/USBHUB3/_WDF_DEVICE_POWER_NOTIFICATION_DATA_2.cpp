...
struct _unnamed_491// Size=0x8 (Id=491)
{
...
union _unnamed_493// Size=0x8 (Id=493)
{
    struct _unnamed_491 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_492 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_491 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=494)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_493 Data;// Offset=0x4 Size=0x8
};
