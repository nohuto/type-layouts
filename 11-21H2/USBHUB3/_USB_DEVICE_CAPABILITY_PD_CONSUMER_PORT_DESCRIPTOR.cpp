union _unnamed_607// Size=0x2 (Id=607)
{
...
struct _USB_DEVICE_CAPABILITY_PD_CONSUMER_PORT_DESCRIPTOR// Size=0x18 (Id=608)
{
    ...
    union _unnamed_607 bmCapabilities;// Offset=0x4 Size=0x2
