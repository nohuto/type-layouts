union _unnamed_33// Size=0x8 (Id=33)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=686)
{
    union // Size=0x4 (Id=0)
    {
...
union _unnamed_36// Size=0x10 (Id=36)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_35 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=594)
{
...
struct _unnamed_37// Size=0x50 (Id=37)
{
