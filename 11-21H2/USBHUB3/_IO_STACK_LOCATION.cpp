...
struct _unnamed_43// Size=0x18 (Id=43)
{
...
struct _unnamed_48// Size=0x18 (Id=48)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _unnamed_50// Size=0x20 (Id=50)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
...
struct _unnamed_52// Size=0x4 (Id=52)
{
    unsigned long Length;// Offset=0x0 Size=0x4
};
...
struct _unnamed_54// Size=0x10 (Id=54)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_56// Size=0x18 (Id=56)
{
...
struct _unnamed_68// Size=0x8 (Id=68)
{
...
struct _unnamed_70// Size=0x20 (Id=70)
{
...
struct _unnamed_71// Size=0x1 (Id=71)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _unnamed_73// Size=0x4 (Id=73)
{
...
struct _unnamed_77// Size=0x10 (Id=77)
{
...
struct _unnamed_80// Size=0x8 (Id=80)
{
    struct _POWER_SEQUENCE * PowerSequence;// Offset=0x0 Size=0x8
};

struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=592)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=563)
{
...
struct _unnamed_84// Size=0x10 (Id=84)
{
...
union _unnamed_87// Size=0x20 (Id=87)
{
    struct _unnamed_40 Create;// Offset=0x0 Size=0x20
    struct _unnamed_41 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_42 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_43 Read;// Offset=0x0 Size=0x18
    struct _unnamed_43 Write;// Offset=0x0 Size=0x18
    struct _unnamed_45 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_46 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_48 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_49 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_50 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_51 QueryEa;// Offset=0x0 Size=0x20
    struct _unnamed_52 SetEa;// Offset=0x0 Size=0x4
    struct _unnamed_54 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_54 SetVolume;// Offset=0x0 Size=0x10
    struct _unnamed_55 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_56 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_57 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_58 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_59 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_60 MountVolume;// Offset=0x0 Size=0x10
    struct _unnamed_60 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_62 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_63 QueryQuota;// Offset=0x0 Size=0x20
    struct _unnamed_52 SetQuota;// Offset=0x0 Size=0x4
    struct _unnamed_65 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_67 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_68 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_69 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_70 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_71 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_73 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_75 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_77 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_79 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_80 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_83 Power;// Offset=0x0 Size=0x20
    struct _unnamed_84 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_85 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_86 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=88)
{
    ...
    union _unnamed_87 Parameters;// Offset=0x8 Size=0x20
