...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=308)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=382)
{
...
union _unnamed_86// Size=0x8 (Id=86)
{
    unsigned long long SecureHandle;// Offset=0x0 Size=0x8
    struct _unnamed_85 Flags;// Offset=0x0 Size=0x8
};

struct _KPROCESS// Size=0x438 (Id=87)
{
    ...
    union _unnamed_86 SecureState;// Offset=0x3e0 Size=0x8
...
struct _EX_FAST_REF// Size=0x8 (Id=119)
{
    union // Size=0x8 (Id=0)
    {
...
struct _RTL_AVL_TREE// Size=0x8 (Id=53)
{
    struct _RTL_BALANCED_NODE * Root;// Offset=0x0 Size=0x8
};

struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=484)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=509)
{
    union // Size=0x2 (Id=0)
    {
...
struct _MMSUPPORT_INSTANCE// Size=0xc0 (Id=422)
{
...
struct _MMSUPPORT_SHARED// Size=0x80 (Id=441)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=351)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=131)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=323)
{
...
union _KE_PROCESS_CONCURRENCY_COUNT// Size=0x4 (Id=626)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _KE_IDEAL_PROCESSOR_ASSIGNMENT_BLOCK// Size=0x118 (Id=290)
{
...
struct _EPROCESS// Size=0xb80 (Id=134)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_132 MitigationFlagsValues;// Offset=0x9d0 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x9d4 Size=0x4
        struct _unnamed_133 MitigationFlags2Values;// Offset=0x9d4 Size=0x4
    };
