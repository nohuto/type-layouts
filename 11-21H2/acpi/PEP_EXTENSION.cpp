...
struct _FAST_MUTEX// Size=0x38 (Id=93)
{
...
struct PEP_EXTENSION// Size=0xa8 (Id=531)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long Rserved:29;// Offset=0x54 Size=0x4 BitOffset=0x3 BitSize=0x1d
        };
    };
    ...
    unsigned char WorkerQueued;// Offset=0x60 Size=0x1
    enum _MONITOR_DISPLAY_STATE ConsoleDisplayState;// Offset=0x64 Size=0x4
    enum _USER_ACTIVITY_PRESENCE GlobalUserPresence;// Offset=0x68 Size=0x4
    void * IrEngagedRegistration;// Offset=0x70 Size=0x8
    void * ConsoleDisplayStateRegistration;// Offset=0x78 Size=0x8
    void * UserPresenceRegistration;// Offset=0x80 Size=0x8
    void * LowPowerEpochRegistration;// Offset=0x88 Size=0x8
    struct _KEVENT StopEvent;// Offset=0x90 Size=0x18
};
