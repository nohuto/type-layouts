...
struct _ACPI_POWER_REQUEST_DEPENDENCY// Size=0x20 (Id=749)
{
...
struct _ACPI_POWER_WAKE_INTERRUPT_REGISTRATION_ENTRY// Size=0x28 (Id=759)
{
...
union _unnamed_744// Size=0x28 (Id=744)
{
...
struct _unnamed_745// Size=0x58 (Id=745)
{
    enum _SYSTEM_POWER_STATE SystemPowerState;// Offset=0x0 Size=0x4
    ...
    union _unnamed_744 Registrations;// Offset=0x30 Size=0x28
};

struct _unnamed_746// Size=0x4 (Id=746)
{
    enum _SYSTEM_POWER_STATE EjectPowerState;// Offset=0x0 Size=0x4
};

union _unnamed_747// Size=0x58 (Id=747)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_742 DevicePowerRequest;// Offset=0x0 Size=0x8
        struct _unnamed_743 SystemPowerRequest;// Offset=0x0 Size=0x8
        struct _unnamed_745 WaitWakeRequest;// Offset=0x0 Size=0x58
        struct _unnamed_746 EjectPowerRequest;// Offset=0x0 Size=0x4
    };
};
...
struct _ACPI_POWER_REQUEST// Size=0x108 (Id=748)
{
    ...
    union _unnamed_747 u;// Offset=0x68 Size=0x58
