union _unnamed_138// Size=0x8 (Id=138)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=105)
{
    union // Size=0x4 (Id=0)
    {
...
union _unnamed_141// Size=0x10 (Id=141)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_140 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=403)
{
...
struct _unnamed_142// Size=0x58 (Id=142)
{
...
union _unnamed_143// Size=0x58 (Id=143)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_142 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=144)
{
    ...
    union _unnamed_138 AssociatedIrp;// Offset=0x18 Size=0x8
