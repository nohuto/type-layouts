union _PS_TRUSTLET_ATTRIBUTE_ACCESSRIGHTS// Size=0x1 (Id=318)
{
...
struct _PS_TRUSTLET_ATTRIBUTE_TYPE// Size=0x4 (Id=75)
{
    union // Size=0x4 (Id=0)
    {
...
struct _PS_TRUSTLET_ATTRIBUTE_HEADER// Size=0x8 (Id=74)
{
