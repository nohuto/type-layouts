struct _NT_TIB// Size=0x38 (Id=429)
{
...
union _KPRCBFLAG// Size=0x4 (Id=367)
{
...
struct _KDESCRIPTOR// Size=0x10 (Id=699)
{
...
struct _KSPECIAL_REGISTERS// Size=0xf0 (Id=635)
{
...
struct _CONTEXT// Size=0x4d0 (Id=505)
{
...
union _SLIST_HEADER// Size=0x10 (Id=97)
{
    unsigned long long Alignment;// Offset=0x0 Size=0x8
    unsigned long long Region;// Offset=0x8 Size=0x8
    struct _unnamed_96 HeaderX64;// Offset=0x0 Size=0x10
};
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=337)
{
...
struct _KSTATIC_AFFINITY_BLOCK// Size=0x420 (Id=244)
{
...
struct _KSOFTWARE_INTERRUPT_BATCH// Size=0x110 (Id=344)
{
...
union _ULARGE_INTEGER// Size=0x8 (Id=103)
{
    unsigned long LowPart;// Offset=0x0 Size=0x4
    unsigned long HighPart;// Offset=0x4 Size=0x4
...
struct _KTIMER_TABLE_ENTRY// Size=0x20 (Id=704)
{
...
struct _KGATE// Size=0x18 (Id=360)
{
...
struct _PROC_IDLE_POLICY// Size=0x6 (Id=680)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=558)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=513)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=521)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=647)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROC_PERF_CHECK_CONTEXT// Size=0x48 (Id=555)
{
    ...
    unsigned short LatestAffinitizedPercent;// Offset=0x38 Size=0x2
    unsigned short AveragePerformancePercent;// Offset=0x3a Size=0x2
    unsigned long RelativePerformance;// Offset=0x3c Size=0x4
    unsigned char NtProcessor;// Offset=0x40 Size=0x1
};
...
struct _PROCESSOR_POWER_STATE// Size=0x230 (Id=489)
{
...
struct _KTIMER// Size=0x40 (Id=541)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=390)
{
    unsigned char Level;// Offset=0x0 Size=0x1
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=544)
{
...
struct _unnamed_58// Size=0x38 (Id=58)
{
...
struct _IOP_IRP_STACK_PROFILER// Size=0x54 (Id=503)
{
    unsigned long Profile[20];// Offset=0x0 Size=0x50
    unsigned long TotalIrps;// Offset=0x50 Size=0x4
};

struct _KSECURE_FAULT_INFORMATION// Size=0x18 (Id=320)
{
...
union _KPRIORITY_STATE// Size=0x1 (Id=259)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KHETERO_STATE// Size=0x1 (Id=714)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _KSHARED_READY_QUEUE// Size=0x2b0 (Id=428)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _KTIMER_EXPIRATION_TRACE// Size=0x10 (Id=512)
{
...
struct _KCLOCK_TIMER_DEADLINE_ENTRY// Size=0x10 (Id=345)
{
...
struct _KCLOCK_TICK_TRACE// Size=0x28 (Id=302)
{
...
struct _KCLOCK_INCREMENT_TRACE// Size=0x20 (Id=563)
{
...
struct _KCLOCK_TIMER_STATE// Size=0x518 (Id=265)
{
...
struct _MACHINE_FRAME// Size=0x28 (Id=679)
{
...
struct _MACHINE_CHECK_CONTEXT// Size=0x50 (Id=457)
{
...
struct _KPRCB// Size=0xbf00 (Id=59)
{
    ...
    unsigned long PrcbPad93[9];// Offset=0x33dc Size=0x24
    ...
    void * HyperPte;// Offset=0x8580 Size=0x8
    ...
    struct _KTIMER DpcWatchdogTimer;// Offset=0x8618 Size=0x40
    ...
    unsigned long PackageId;// Offset=0x8818 Size=0x4
    unsigned long DieId;// Offset=0x881c Size=0x4
    unsigned long PrcbPad87[8];// Offset=0x8820 Size=0x20
    ...
    unsigned long long PrcbPad97[3];// Offset=0x8880 Size=0x18
    ...
    struct _unnamed_58 StibpPairingTrace;// Offset=0x8b38 Size=0x38
    ...
    struct _KSHARED_READY_QUEUE LocalSharedReadyQueue;// Offset=0x8c80 Size=0x2b0
    unsigned long long PrcbPad125[2];// Offset=0x8f30 Size=0x10
    unsigned long TimerExpirationTraceCount;// Offset=0x8f40 Size=0x4
    unsigned long PrcbPad127;// Offset=0x8f44 Size=0x4
    struct _KTIMER_EXPIRATION_TRACE TimerExpirationTrace[16];// Offset=0x8f48 Size=0x100
    unsigned long long PrcbPad128[7];// Offset=0x9048 Size=0x38
    struct _KCLOCK_TIMER_STATE ClockTimerState;// Offset=0x9080 Size=0x518
    unsigned char PrcbPad129[40];// Offset=0x9598 Size=0x28
    struct _REQUEST_MAILBOX * Mailbox;// Offset=0x95c0 Size=0x8
    unsigned long long PrcbPad130[7];// Offset=0x95c8 Size=0x38
    struct _MACHINE_CHECK_CONTEXT McheckContext[2];// Offset=0x9600 Size=0xa0
    unsigned long long TransitionShadowStack;// Offset=0x96a0 Size=0x8
    unsigned long long KernelShadowStackInitial;// Offset=0x96a8 Size=0x8
    unsigned long long * IstShadowStacksTable;// Offset=0x96b0 Size=0x8
    void * CachedShadowStack;// Offset=0x96b8 Size=0x8
    struct _KLOCK_QUEUE_HANDLE SelfmapLockHandle[4];// Offset=0x96c0 Size=0x60
    unsigned long long PrcbPad134a[4];// Offset=0x9720 Size=0x20
    struct _KAFFINITY_EX DieProcessorSet;// Offset=0x9740 Size=0x108
    unsigned char CoresPerPhysicalDie;// Offset=0x9848 Size=0x1
    unsigned char LogicalProcessorsPerModule;// Offset=0x9849 Size=0x1
    unsigned char PrcbPad136a[6];// Offset=0x984a Size=0x6
    unsigned char PrcbPad137[64];// Offset=0x9850 Size=0x40
    struct _KAFFINITY_EX ModuleProcessorSet;// Offset=0x9890 Size=0x108
    struct _KCORE_CONTROL_BLOCK LocalCoreControlBlock;// Offset=0x9998 Size=0x48
    unsigned char PrcbPad138[1120];// Offset=0x99e0 Size=0x460
    unsigned char PrcbPad138a[64];// Offset=0x9e40 Size=0x40
    ...
    unsigned long long PrcbPad141[504];// Offset=0xaec0 Size=0xfc0
    unsigned char PrcbPad141a[64];// Offset=0xbe80 Size=0x40
    struct _REQUEST_MAILBOX RequestMailbox[1];// Offset=0xbec0 Size=0x40
};

struct _KPCR// Size=0xc080 (Id=57)
{
