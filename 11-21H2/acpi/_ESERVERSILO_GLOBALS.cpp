...
struct _OBP_SYSTEM_DOS_DEVICE_STATE// Size=0x6c (Id=736)
{
...
struct _OBJECT_NAMESPACE_LOOKUPTABLE// Size=0x260 (Id=791)
{
...
struct _OBP_SILODRIVERSTATE// Size=0x2e0 (Id=720)
{
...
struct _SEP_SILOSTATE// Size=0x30 (Id=595)
{
...
struct _SEP_RM_LSA_CONNECTION_STATE// Size=0x50 (Id=646)
{
...
struct _WNF_LOCK// Size=0x8 (Id=738)
{
    struct _EX_PUSH_LOCK PushLock;// Offset=0x0 Size=0x8
};

struct _WNF_SILODRIVERSTATE// Size=0x38 (Id=702)
{
...
struct _DBGK_SILOSTATE// Size=0x20 (Id=686)
{
...
struct _CPTABLEINFO// Size=0x40 (Id=730)
{
...
struct _RTL_NLS_STATE// Size=0xb8 (Id=648)
{
...
struct _ESERVERSILO_GLOBALS// Size=0x560 (Id=584)
{
