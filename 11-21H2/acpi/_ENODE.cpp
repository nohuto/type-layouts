struct _unnamed_81// Size=0x1 (Id=81)
{
...
struct _KNODE// Size=0x118 (Id=82)
{
    ...
    struct _unnamed_81 Flags;// Offset=0xa Size=0x1
...
struct _ENODE// Size=0x140 (Id=115)
{
    struct _KNODE Ncb;// Offset=0x0 Size=0x118
    struct _WORK_QUEUE_ITEM HotAddProcessorWorkItem;// Offset=0x118 Size=0x20
};
