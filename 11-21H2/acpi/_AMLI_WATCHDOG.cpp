...
struct _AMLI_WATCHDOG// Size=0xa8 (Id=697)
{
    struct _ctxt * AmliContext;// Offset=0x0 Size=0x8
    void * DeviceContext;// Offset=0x8 Size=0x8
    unsigned long WatchdogAction;// Offset=0x10 Size=0x4
    struct _KDPC WatchdogDpc;// Offset=0x18 Size=0x40
    unsigned char WatchdogEnabled;// Offset=0x58 Size=0x1
    unsigned long long WatchdogStart;// Offset=0x60 Size=0x8
    struct _KTIMER WatchdogTimer;// Offset=0x68 Size=0x40
};
