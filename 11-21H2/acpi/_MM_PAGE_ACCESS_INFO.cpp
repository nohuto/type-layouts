...
union _MM_PAGE_ACCESS_INFO_FLAGS// Size=0x4 (Id=355)
{
    struct _unnamed_353 File;// Offset=0x0 Size=0x4
    struct _unnamed_354 Private;// Offset=0x0 Size=0x4
};

struct _MM_PAGE_ACCESS_INFO// Size=0x8 (Id=352)
{
    union // Size=0x8 (Id=0)
    {
