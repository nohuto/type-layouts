...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=1262)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=1214)
{
...
struct _KPROCESS// Size=0x438 (Id=1219)
{
    ...
    union _unnamed_1217 SecureState;// Offset=0x3e0 Size=0x8
...
struct _EX_FAST_REF// Size=0x8 (Id=1257)
{
    union // Size=0x8 (Id=0)
    {
...
struct _RTL_AVL_TREE// Size=0x8 (Id=1247)
{
    struct _RTL_BALANCED_NODE * Root;// Offset=0x0 Size=0x8
};

struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=1192)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=966)
{
    union // Size=0x2 (Id=0)
    {
...
struct _MMSUPPORT_INSTANCE// Size=0xc0 (Id=1254)
{
...
struct _MMSUPPORT_SHARED// Size=0x80 (Id=1140)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=1185)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=1027)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=1106)
{
...
struct _unnamed_1029// Size=0x4 (Id=1029)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _unnamed_1031// Size=0x4 (Id=1031)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=1186)
{
    struct _RTL_AVL_TREE Tree;// Offset=0x0 Size=0x8
    struct _EX_PUSH_LOCK Lock;// Offset=0x8 Size=0x8
};

struct _EPROCESS// Size=0xb80 (Id=1036)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_1029 MitigationFlagsValues;// Offset=0x9d0 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x9d4 Size=0x4
        struct _unnamed_1031 MitigationFlags2Values;// Offset=0x9d4 Size=0x4
    };
