struct wil_details_FeatureDescriptor// Size=0x30 (Id=1250)
{
    ...
    unsigned char variant;// Offset=0x20 Size=0x1
    enum wil_FeatureVariantPayloadKind payloadKind;// Offset=0x24 Size=0x4
    unsigned int payload;// Offset=0x28 Size=0x4
};
