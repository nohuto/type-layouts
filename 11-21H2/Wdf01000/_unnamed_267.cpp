struct _unnamed_217// Size=0x20 (Id=217)
{
...
struct _unnamed_220// Size=0x20 (Id=220)
{
    struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
    unsigned long Options;// Offset=0x8 Size=0x4
...
struct _unnamed_221// Size=0x20 (Id=221)
{
    struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
    unsigned long Options;// Offset=0x8 Size=0x4
    unsigned short Reserved;// Offset=0x10 Size=0x2
...
struct _unnamed_225// Size=0x20 (Id=225)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_231// Size=0x20 (Id=231)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
...
struct _unnamed_232// Size=0x20 (Id=232)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_233// Size=0x4 (Id=233)
{
    unsigned long Length;// Offset=0x0 Size=0x4
};
...
struct _unnamed_236// Size=0x20 (Id=236)
{
...
struct _unnamed_237// Size=0x18 (Id=237)
{
...
struct _unnamed_238// Size=0x20 (Id=238)
{
    unsigned long OutputBufferLength;// Offset=0x0 Size=0x4
    unsigned long InputBufferLength;// Offset=0x8 Size=0x4
...
struct _unnamed_244// Size=0x20 (Id=244)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_245// Size=0x4 (Id=245)
{
    enum _DEVICE_RELATION_TYPE Type;// Offset=0x0 Size=0x4
};

struct _unnamed_247// Size=0x20 (Id=247)
{
...
struct _unnamed_253// Size=0x1 (Id=253)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _unnamed_255// Size=0x4 (Id=255)
{
    enum BUS_QUERY_ID_TYPE IdType;// Offset=0x0 Size=0x4
};

struct _unnamed_257// Size=0x10 (Id=257)
{
...
struct _unnamed_260// Size=0x4 (Id=260)
{
    enum _SYSTEM_POWER_STATE PowerState;// Offset=0x0 Size=0x4
};

struct _unnamed_261// Size=0x8 (Id=261)
{
    struct _POWER_SEQUENCE * PowerSequence;// Offset=0x0 Size=0x8
};

struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=281)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=302)
{
...
struct _unnamed_265// Size=0x20 (Id=265)
{
...
union _unnamed_267// Size=0x20 (Id=267)
{
    struct _unnamed_217 Create;// Offset=0x0 Size=0x20
    struct _unnamed_220 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_221 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_223 Read;// Offset=0x0 Size=0x18
    struct _unnamed_223 Write;// Offset=0x0 Size=0x18
    struct _unnamed_225 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_226 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_229 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_230 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_231 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_232 QueryEa;// Offset=0x0 Size=0x20
    struct _unnamed_233 SetEa;// Offset=0x0 Size=0x4
    struct _unnamed_235 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_235 SetVolume;// Offset=0x0 Size=0x10
    struct _unnamed_236 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_237 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_238 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_239 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_240 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_241 MountVolume;// Offset=0x0 Size=0x10
    struct _unnamed_241 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_243 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_244 QueryQuota;// Offset=0x0 Size=0x20
    struct _unnamed_233 SetQuota;// Offset=0x0 Size=0x4
    struct _unnamed_245 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_247 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_249 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_250 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_252 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_253 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_255 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_257 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_259 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_260 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_261 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_262 Power;// Offset=0x0 Size=0x20
    struct _unnamed_264 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_265 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_266 Others;// Offset=0x0 Size=0x20
};
