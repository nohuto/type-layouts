...
union _PCI_EXPRESS_DPC_CAPS_REGISTER// Size=0x2 (Id=3485)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_DPC_CONTROL_REGISTER// Size=0x2 (Id=1639)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_DPC_ERROR_SOURCE_ID// Size=0x2 (Id=3196)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_DPC_RP_PIO_STATUS_REGISTER// Size=0x4 (Id=3135)
{
...
union _PCI_EXPRESS_DPC_RP_PIO_MASK_REGISTER// Size=0x4 (Id=2257)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long CfgURCpl:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
union _PCI_EXPRESS_DPC_RP_PIO_SEVERITY_REGISTER// Size=0x4 (Id=2736)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long CfgURCpl:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
union _PCI_EXPRESS_DPC_RP_PIO_SYSERR_REGISTER// Size=0x4 (Id=771)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long CfgURCpl:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
union _PCI_EXPRESS_DPC_RP_PIO_EXCEPTION_REGISTER// Size=0x4 (Id=1925)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long CfgURCpl:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
struct _PCI_EXPRESS_DPC_RP_PIO_HEADERLOG_REGISTER// Size=0x10 (Id=3395)
{
    unsigned long PioHeaderLogRegister[4];// Offset=0x0 Size=0x10
};

union _PCI_EXPRESS_DPC_RP_PIO_IMPSPECLOG_REGISTER// Size=0x4 (Id=358)
{
    unsigned long PioImpSpecLog;// Offset=0x0 Size=0x4
};

struct _PCI_EXPRESS_DPC_RP_PIO_TLPPREFIXLOG_REGISTER// Size=0x10 (Id=1009)
{
    unsigned long PioTlpPrefixLogRegister[4];// Offset=0x0 Size=0x10
};

struct _PCI_EXPRESS_DPC_CAPABILITY// Size=0x44 (Id=1900)
{
