...
struct _SECURITY_SUBJECT_CONTEXT// Size=0x20 (Id=168)
{
...
struct _LUID_AND_ATTRIBUTES// Size=0xc (Id=199)
{
    struct _LUID Luid;// Offset=0x0 Size=0x8
    unsigned long Attributes;// Offset=0x8 Size=0x4
};

struct _INITIAL_PRIVILEGE_SET// Size=0x2c (Id=195)
{
...
struct _PRIVILEGE_SET// Size=0x14 (Id=174)
{
    unsigned long PrivilegeCount;// Offset=0x0 Size=0x4
    unsigned long Control;// Offset=0x4 Size=0x4
...
union _unnamed_209// Size=0x2c (Id=209)
{
...
struct _ACCESS_STATE// Size=0xa0 (Id=723)
{
    union // Size=0x50 (Id=0)
    {
        ...
        union <unnamed-type-Privileges>// Size=0x2c (Id=4590)
        {
            struct _INITIAL_PRIVILEGE_SET InitialPrivilegeSet;// Offset=0x0 Size=0x2c
            struct _PRIVILEGE_SET PrivilegeSet;// Offset=0x0 Size=0x14
        };
