...
struct FxPkgPnp::PnpProcessEventInner::__l19::TRANSITION// Size=0x8 (Id=3732)
{
    enum _WDF_DEVICE_PNP_STATE State;// Offset=0x0 Size=0x4
    enum FxPnpEvent Event;// Offset=0x4 Size=0x4
};
