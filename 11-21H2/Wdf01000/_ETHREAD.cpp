...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=1101)
{
...
struct _KAPC_STATE// Size=0x30 (Id=871)
{
...
struct _SINGLE_LIST_ENTRY// Size=0x8 (Id=286)
{
...
struct _KTIMER// Size=0x40 (Id=1996)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=1783)
{
...
union _KERNEL_SHADOW_STACK_LIMIT// Size=0x8 (Id=1297)
{
...
struct _KTHREAD// Size=0x480 (Id=858)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    ...
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long Spare1:1;// Offset=0x74 Size=0x4 BitOffset=0x8 BitSize=0x1
            ...
            unsigned long Spare2:1;// Offset=0x74 Size=0x4 BitOffset=0x10 BitSize=0x1
            ...
            unsigned long IsolationWidth:1;// Offset=0x74 Size=0x4 BitOffset=0x18 BitSize=0x1
            unsigned long Reserved:7;// Offset=0x74 Size=0x4 BitOffset=0x19 BitSize=0x7
        };
    ...
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long ThreadFlagsSpare:1;// Offset=0x78 Size=0x4 BitOffset=0x1 BitSize=0x1
    ...
    unsigned long long Spare19;// Offset=0x1f8 Size=0x8
    union // Size=0x4 (Id=0)
    {
    ...
    unsigned char HgsFeedbackClass;// Offset=0x204 Size=0x1
    unsigned char Spare21[3];// Offset=0x205 Size=0x3
    ...
    unsigned long long EndPadding[4];// Offset=0x460 Size=0x20
};
...
struct _KSEMAPHORE// Size=0x20 (Id=3134)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=1161)
{
...
struct _KLOCK_ENTRY_LOCK_STATE// Size=0x10 (Id=1210)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
union _KLOCK_ENTRY_BOOST_BITMAP// Size=0x8 (Id=1077)
{
    unsigned long long AllFields;// Offset=0x0 Size=0x8
...
struct _KLOCK_ENTRY// Size=0x60 (Id=1232)
{
    union // Size=0x10 (Id=0)
    {
...
struct _ETHREAD// Size=0x8f0 (Id=1095)
{
