...
struct _AsActivatorSubtask// Size=0x10 (Id=1053)
{
    unsigned long ClientId;// Offset=0x0 Size=0x4
    unsigned long Reserved[2];// Offset=0x4 Size=0x8
    unsigned short TaskId;// Offset=0xc Size=0x2
...
struct _AsConnection// Size=0x10 (Id=1283)
{
...
struct _AsSocSubsystem// Size=0x10 (Id=1289)
{
...
struct _AsPreVeto// Size=0x10 (Id=1244)
{
...
struct _AsPdcPhaseBlockerGroup// Size=0x10 (Id=838)
{
...
struct _AsPdcPhaseBlockerGroupClient// Size=0x10 (Id=1238)
{
    unsigned long BlockerGroupSignature;// Offset=0x0 Size=0x4
    unsigned char BlockerGroupDesc;// Offset=0x4 Size=0x1
...
union _SLEEPSTUDY_BLOCKER_GUID// Size=0x10 (Id=1183)
{
