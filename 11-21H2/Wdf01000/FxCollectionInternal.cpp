...
struct FxCollectionInternal// Size=0x18 (Id=2675)
{
    union // Size=0xd4 (Id=0)
    {
        ...
        unsigned long Count();
        unsigned char Add(struct _FX_DRIVER_GLOBALS * ,class FxObject * );// Offset=0x0 Size=0xd4
        ...
        class FxCollectionEntry * AllocateEntry(struct _FX_DRIVER_GLOBALS * );
