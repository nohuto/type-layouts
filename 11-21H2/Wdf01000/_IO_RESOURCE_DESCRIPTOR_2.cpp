...
struct _unnamed_186// Size=0xc (Id=186)
{
...
struct _unnamed_187// Size=0x18 (Id=187)
{
...
struct _unnamed_190// Size=0x18 (Id=190)
{
...
struct _unnamed_191// Size=0x18 (Id=191)
{
...
union _unnamed_192// Size=0x18 (Id=192)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_175 Port;// Offset=0x0 Size=0x18
        struct _unnamed_175 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_179 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_182 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_184 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_175 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_154 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_185 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_186 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_187 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_190 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_191 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_162 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=1523)
{
    union // Size=0x8 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x18 (Id=9819)
        {
            struct <unnamed-type-Port>// Size=0x18 (Id=9820)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                unsigned long Alignment;// Offset=0x4 Size=0x4
                union _LARGE_INTEGER MinimumAddress;// Offset=0x8 Size=0x8
            ...
            struct <unnamed-type-Memory>// Size=0x18 (Id=9826)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                unsigned long Alignment;// Offset=0x4 Size=0x4
                union _LARGE_INTEGER MinimumAddress;// Offset=0x8 Size=0x8
            ...
            struct <unnamed-type-Interrupt>// Size=0x18 (Id=9832)
            {
                unsigned long MinimumVector;// Offset=0x0 Size=0x4
                unsigned long MaximumVector;// Offset=0x4 Size=0x4
                enum _IRQ_DEVICE_POLICY AffinityPolicy;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-Generic>// Size=0x18 (Id=9849)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                unsigned long Alignment;// Offset=0x4 Size=0x4
                union _LARGE_INTEGER MinimumAddress;// Offset=0x8 Size=0x8
            ...
            struct <unnamed-type-ConfigData>// Size=0xc (Id=9864)
            {
                unsigned long Priority;// Offset=0x0 Size=0x4
                unsigned long Reserved1;// Offset=0x4 Size=0x4
                unsigned long Reserved2;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-Memory40>// Size=0x18 (Id=9869)
            {
                unsigned long Length40;// Offset=0x0 Size=0x4
                unsigned long Alignment40;// Offset=0x4 Size=0x4
                union _LARGE_INTEGER MinimumAddress;// Offset=0x8 Size=0x8
            ...
            struct <unnamed-type-Memory48>// Size=0x18 (Id=9875)
            {
                unsigned long Length48;// Offset=0x0 Size=0x4
                unsigned long Alignment48;// Offset=0x4 Size=0x4
                union _LARGE_INTEGER MinimumAddress;// Offset=0x8 Size=0x8
            ...
            struct <unnamed-type-Memory64>// Size=0x18 (Id=9881)
            {
                unsigned long Length64;// Offset=0x0 Size=0x4
                unsigned long Alignment64;// Offset=0x4 Size=0x4
                union _LARGE_INTEGER MinimumAddress;// Offset=0x8 Size=0x8
            ...
            struct <unnamed-type-Connection>// Size=0xc (Id=9887)
            {
                unsigned char Class;// Offset=0x0 Size=0x1
                unsigned char Type;// Offset=0x1 Size=0x1
                unsigned char Reserved1;// Offset=0x2 Size=0x1
