...
struct _IO_STACK_LOCATION// Size=0x48 (Id=857)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-Parameters>// Size=0x20 (Id=9946)
        {
            struct <unnamed-type-Create>// Size=0x20 (Id=9947)
            {
            ...
            struct <unnamed-type-CreatePipe>// Size=0x20 (Id=9955)
            {
                struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
                unsigned long Options;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-CreateMailslot>// Size=0x20 (Id=9963)
            {
                struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
                unsigned long Options;// Offset=0x8 Size=0x4
                unsigned short Reserved;// Offset=0x10 Size=0x2
            ...
            struct <unnamed-type-Read>// Size=0x18 (Id=9971)
            {
            ...
            struct <unnamed-type-Write>// Size=0x18 (Id=9977)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                unsigned long Key;// Offset=0x8 Size=0x4
                unsigned long Flags;// Offset=0xc Size=0x4
            ...
            struct <unnamed-type-QueryDirectory>// Size=0x20 (Id=9983)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-NotifyDirectory>// Size=0x10 (Id=9989)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-NotifyDirectoryEx>// Size=0x18 (Id=9993)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                unsigned long CompletionFilter;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-QueryFile>// Size=0x10 (Id=9998)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-SetFile>// Size=0x20 (Id=10002)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-QueryEa>// Size=0x20 (Id=10011)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-SetVolume>// Size=0x10 (Id=10024)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                enum _FSINFOCLASS FsInformationClass;// Offset=0x8 Size=0x4
            };
            struct _IO_STACK_LOCATION::<unnamed-type-Parameters>::<unnamed-type-SetVolume> SetVolume;// Offset=0x0 Size=0x10
            struct <unnamed-type-FileSystemControl>// Size=0x20 (Id=10028)
            {
            ...
            struct <unnamed-type-LockControl>// Size=0x18 (Id=10034)
            {
            ...
            struct <unnamed-type-DeviceIoControl>// Size=0x20 (Id=10039)
            {
                unsigned long OutputBufferLength;// Offset=0x0 Size=0x4
                unsigned long InputBufferLength;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-QuerySecurity>// Size=0x10 (Id=10045)
            {
            ...
            struct <unnamed-type-SetSecurity>// Size=0x10 (Id=10049)
            {
                unsigned long SecurityInformation;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-MountVolume>// Size=0x10 (Id=10053)
            {
            ...
            struct <unnamed-type-QueryQuota>// Size=0x20 (Id=10065)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-SetQuota>// Size=0x4 (Id=10072)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            };
            struct _IO_STACK_LOCATION::<unnamed-type-Parameters>::<unnamed-type-SetQuota> SetQuota;// Offset=0x0 Size=0x4
            struct <unnamed-type-QueryDeviceRelations>// Size=0x4 (Id=10075)
            {
            ...
            struct <unnamed-type-QueryInterface>// Size=0x20 (Id=10078)
            {
            ...
            struct <unnamed-type-DeviceCapabilities>// Size=0x8 (Id=10086)
            {
            ...
            struct <unnamed-type-FilterResourceRequirements>// Size=0x8 (Id=10090)
            {
            ...
            struct <unnamed-type-ReadWriteConfig>// Size=0x20 (Id=10094)
            {
            ...
            struct <unnamed-type-SetLock>// Size=0x1 (Id=10100)
            {
            ...
            struct <unnamed-type-QueryId>// Size=0x4 (Id=10103)
            {
            ...
            struct <unnamed-type-QueryDeviceText>// Size=0x10 (Id=10106)
            {
            ...
            struct <unnamed-type-UsageNotification>// Size=0x10 (Id=10110)
            {
            ...
            struct <unnamed-type-WaitWake>// Size=0x4 (Id=10115)
            {
            ...
            struct <unnamed-type-PowerSequence>// Size=0x8 (Id=10118)
            {
            ...
            struct <unnamed-type-Power>// Size=0x20 (Id=10122)
            {
            ...
            struct <unnamed-type-StartDevice>// Size=0x10 (Id=10129)
            {
            ...
            struct <unnamed-type-WMI>// Size=0x20 (Id=10133)
            {
            ...
            struct <unnamed-type-Others>// Size=0x20 (Id=10139)
            {
