struct _OSVERSIONINFOEXW// Size=0x11c (Id=1354)
{
...
struct _FX_DRIVER_TRACKER_CACHE_AWARE// Size=0x18 (Id=2948)
{
    union // Size=0x182 (Id=0)
    {
        struct _FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=8867)
        {
            struct _FX_DRIVER_GLOBALS * FxDriverGlobals;// Offset=0x0 Size=0x8
        };
        struct FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=8870)
        {
        };// Offset=0x0 Size=0x8
        long Initialize();
        void Uninitialize();
        long Register(struct _FX_DRIVER_GLOBALS * );// Offset=0x0 Size=0x182
...
struct _WMI_WDF_NOTIFY_ROUTINES// Size=0x20 (Id=2332)
{
...
struct FxLibraryGlobalsType// Size=0x2a8 (Id=2991)
{
    ...
    unsigned char UseWdfTimerForPofx;// Offset=0x2a4 Size=0x1
};
