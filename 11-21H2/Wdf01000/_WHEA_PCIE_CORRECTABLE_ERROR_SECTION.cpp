struct _WHEA_PCIE_CORRECTABLE_ERROR_SECTION_HEADER// Size=0x4 (Id=3104)
{
    unsigned short Version;// Offset=0x0 Size=0x2
    unsigned short Count;// Offset=0x2 Size=0x2
};

union _WHEA_PCIE_CORRECTABLE_ERROR_DEVICES_VALIDBITS// Size=0x8 (Id=2401)
{
...
struct _WHEA_PCIE_CORRECTABLE_ERROR_DEVICES// Size=0x9c (Id=391)
{
...
struct _WHEA_PCIE_CORRECTABLE_ERROR_SECTION// Size=0xa0 (Id=559)
{
