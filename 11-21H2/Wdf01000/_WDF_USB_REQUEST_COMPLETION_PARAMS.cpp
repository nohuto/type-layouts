...
union _WDF_USB_CONTROL_SETUP_PACKET// Size=0x8 (Id=2187)
{
    struct <unnamed-type-Packet>// Size=0x8 (Id=21725)
    {
        union <unnamed-type-bm>// Size=0x1 (Id=21726)
        {
            struct <unnamed-type-Request>// Size=0x1 (Id=21727)
            {
        ...
        union <unnamed-type-wValue>// Size=0x2 (Id=21736)
        {
            struct <unnamed-type-Bytes>// Size=0x2 (Id=21737)
            {
        ...
        union <unnamed-type-wIndex>// Size=0x2 (Id=21743)
        {
            struct <unnamed-type-Bytes>// Size=0x2 (Id=21744)
            {
                unsigned char LowByte;// Offset=0x0 Size=0x1
                unsigned char HiByte;// Offset=0x1 Size=0x1
            };
    ...
    struct <unnamed-type-Generic>// Size=0x8 (Id=21752)
    {
...
struct _WDF_USB_REQUEST_COMPLETION_PARAMS// Size=0x20 (Id=2607)
{
    union // Size=0x8 (Id=0)
    {
        long UsbdStatus;// Offset=0x0 Size=0x4
        enum _WDF_USB_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
        union <unnamed-type-Parameters>// Size=0x18 (Id=21816)
        {
            struct <unnamed-type-DeviceString>// Size=0x10 (Id=21817)
            {
            ...
            struct <unnamed-type-DeviceControlTransfer>// Size=0x18 (Id=21823)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            ...
            struct <unnamed-type-PipeRead>// Size=0x18 (Id=21836)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
                unsigned long long Length;// Offset=0x8 Size=0x8
                unsigned long long Offset;// Offset=0x10 Size=0x8
            ...
            struct <unnamed-type-PipeUrb>// Size=0x8 (Id=21841)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            };
