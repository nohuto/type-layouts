...
struct _WDF_IFR_OFFSET// Size=0x4 (Id=273)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=20986)
        {
            struct <unnamed-type-s>// Size=0x4 (Id=20987)
            {
...
struct _WDF_IFR_HEADER// Size=0x48 (Id=743)
{
