struct _PCI_SLOT_NUMBER// Size=0x4 (Id=3466)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=14091)
        {
            struct <unnamed-type-bits>// Size=0x4 (Id=14092)
            {
...
struct _PCIBUSDATA// Size=0x50 (Id=2248)
{
