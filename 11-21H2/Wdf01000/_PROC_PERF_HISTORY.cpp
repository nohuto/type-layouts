struct _PROC_PERF_HISTORY_ENTRY// Size=0xc (Id=822)
{
    ...
    unsigned char TaggedPercent[4];// Offset=0x7 Size=0x4
};

struct _PROC_PERF_HISTORY// Size=0x34 (Id=1063)
{
    ...
    unsigned long TaggedPercentTotal[4];// Offset=0x18 Size=0x10
    struct _PROC_PERF_HISTORY_ENTRY HistoryList[1];// Offset=0x28 Size=0xc
};
