...
struct _OBP_SYSTEM_DOS_DEVICE_STATE// Size=0x6c (Id=614)
{
...
struct _OBP_SILODRIVERSTATE// Size=0x2e0 (Id=737)
{
...
struct _SEP_SILOSTATE// Size=0x30 (Id=754)
{
...
struct _SEP_RM_LSA_CONNECTION_STATE// Size=0x50 (Id=793)
{
...
struct _WNF_SILODRIVERSTATE// Size=0x38 (Id=783)
{
...
struct _DBGK_SILOSTATE// Size=0x20 (Id=695)
{
...
struct _RTL_NLS_STATE// Size=0xb8 (Id=681)
{
...
struct _ESERVERSILO_GLOBALS// Size=0x558 (Id=1126)
{
    ...
    struct _EX_TIMEZONE_STATE * ExTimeZoneState;// Offset=0x4e0 Size=0x8
    struct _UNICODE_STRING NtSystemRoot;// Offset=0x4e8 Size=0x10
    struct _UNICODE_STRING SiloRootDirectoryName;// Offset=0x4f8 Size=0x10
    struct _PSP_STORAGE * Storage;// Offset=0x508 Size=0x8
    enum _SERVERSILO_STATE State;// Offset=0x510 Size=0x4
    long ExitStatus;// Offset=0x514 Size=0x4
    struct _KEVENT * DeleteEvent;// Offset=0x518 Size=0x8
    struct _SILO_USER_SHARED_DATA * UserSharedData;// Offset=0x520 Size=0x8
    void * UserSharedSection;// Offset=0x528 Size=0x8
    struct _WORK_QUEUE_ITEM TerminateWorkItem;// Offset=0x530 Size=0x20
    unsigned char IsDownlevelContainer;// Offset=0x550 Size=0x1
};
