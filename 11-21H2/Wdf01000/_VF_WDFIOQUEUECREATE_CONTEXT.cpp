struct _VF_COMMON_CONTEXT_HEADER// Size=0x8 (Id=451)
{
...
struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=910)
{
    union // Size=0x50 (Id=0)
    {
        ...
        union <unnamed-type-Settings>// Size=0x4 (Id=21140)
        {
            struct <unnamed-type-Parallel>// Size=0x4 (Id=21141)
            {
...
struct _VF_WDFIOQUEUECREATE_CONTEXT// Size=0x68 (Id=445)
{
