...
struct _KBUGCHECK_REASON_CALLBACK_RECORD// Size=0x30 (Id=1620)
{
...
struct _WDF_DRIVER_GLOBALS// Size=0x38 (Id=2897)
{
...
struct _FX_DRIVER_GLOBALS// Size=0x200 (Id=1899)
{
    ...
    {
        void SetVerifierState(unsigned char );// Offset=0x0 Size=0x40
        ...
        unsigned char IsCorrectVersionRegistered(struct _UNICODE_STRING * );// Offset=0x0 Size=0x1b2
        void RegisterClientVersion(struct _UNICODE_STRING * );// Offset=0x0 Size=0x317
        ...
        void WaitForSignal(class MxEvent * ,char * ,void * ,unsigned long ,unsigned long );// Offset=0x0 Size=0x81
        ...
        struct FxObjectDebugLeakDetection * FxVerifyLeakDetection;// Offset=0x150 Size=0x8
