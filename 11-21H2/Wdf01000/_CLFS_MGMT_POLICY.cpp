...
struct _CLFS_MGMT_POLICY// Size=0x18 (Id=2347)
{
    union // Size=0x10 (Id=0)
    {
        ...
        union <unnamed-type-PolicyParameters>// Size=0x8 (Id=5191)
        {
            struct <unnamed-type-MaximumSize>// Size=0x4 (Id=5192)
            {
            ...
            struct <unnamed-type-GrowthRate>// Size=0x8 (Id=5201)
            {
            ...
            struct <unnamed-type-LogTail>// Size=0x8 (Id=5205)
            {
            ...
            struct <unnamed-type-AutoShrink>// Size=0x4 (Id=5209)
            {
            ...
            struct <unnamed-type-AutoGrow>// Size=0x4 (Id=5212)
            {
            ...
            struct <unnamed-type-NewContainerPrefix>// Size=0x4 (Id=5215)
            {
            ...
            struct <unnamed-type-NewContainerSuffix>// Size=0x8 (Id=5219)
            {
            ...
            struct <unnamed-type-NewContainerExtension>// Size=0x4 (Id=5222)
            {
