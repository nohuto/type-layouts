...
struct _PCI_EXPRESS_ATS_CAPABILITY_REGISTER// Size=0x2 (Id=989)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_ATS_CONTROL_REGISTER// Size=0x2 (Id=3138)
{
    struct // Size=0x2 (Id=0)
    {
...
struct _PCI_EXPRESS_ATS_CAPABILITY// Size=0x8 (Id=3125)
{
