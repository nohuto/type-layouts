...
struct _unnamed_875// Size=0x18 (Id=875)
{
...
struct _unnamed_877// Size=0x18 (Id=877)
{
...
struct _unnamed_878// Size=0x8 (Id=878)
{
...
struct _unnamed_880// Size=0x10 (Id=880)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_881// Size=0xc (Id=881)
{
...
struct _unnamed_882// Size=0x18 (Id=882)
{
...
struct _unnamed_884// Size=0x18 (Id=884)
{
...
union _unnamed_885// Size=0x18 (Id=885)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_875 Port;// Offset=0x0 Size=0x18
        struct _unnamed_875 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_877 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_878 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_879 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_875 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_849 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_880 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_881 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_882 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_883 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_884 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_855 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=886)
{
    ...
    union _unnamed_885 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=842)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=627)
{
