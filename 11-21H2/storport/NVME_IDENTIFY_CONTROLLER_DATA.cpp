struct _unnamed_264// Size=0x1 (Id=264)
{
    struct // Size=0x1 (Id=0)
    {
        unsigned char MultiPCIePorts:1;// Offset=0x0 Size=0x1 BitOffset=0x0 BitSize=0x1
...
struct _unnamed_265// Size=0x4 (Id=265)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long Reserved2:12;// Offset=0x0 Size=0x4 BitOffset=0xf BitSize=0xc
        unsigned long ZoneInformation:1;// Offset=0x0 Size=0x4 BitOffset=0x1b BitSize=0x1
        unsigned long Reserved3:4;// Offset=0x0 Size=0x4 BitOffset=0x1c BitSize=0x4
    };
};

struct _unnamed_266// Size=0x4 (Id=266)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _unnamed_267// Size=0x2 (Id=267)
{
...
struct _unnamed_268// Size=0x2 (Id=268)
{
    struct // Size=0x2 (Id=0)
    {
...
struct _unnamed_269// Size=0x1 (Id=269)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _unnamed_270// Size=0x1 (Id=270)
{
    struct // Size=0x1 (Id=0)
    {
        ...
        unsigned char Reserved0:1;// Offset=0x0 Size=0x1 BitOffset=0x5 BitSize=0x1
...
struct _unnamed_271// Size=0x1 (Id=271)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _unnamed_272// Size=0x1 (Id=272)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _unnamed_273// Size=0x4 (Id=273)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _unnamed_274// Size=0x2 (Id=274)
{
    struct // Size=0x2 (Id=0)
    {
...
struct _unnamed_275// Size=0x4 (Id=275)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _unnamed_276// Size=0x1 (Id=276)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _unnamed_278// Size=0x2 (Id=278)
{
    struct // Size=0x2 (Id=0)
    {
...
struct _unnamed_279// Size=0x2 (Id=279)
{
    struct // Size=0x2 (Id=0)
    {
...
struct _unnamed_280// Size=0x1 (Id=280)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _unnamed_281// Size=0x1 (Id=281)
{
    struct // Size=0x1 (Id=0)
    {
...
struct NVME_IDENTIFY_CONTROLLER_DATA// Size=0x1000 (Id=284)
{
    ...
    struct _unnamed_264 CMIC;// Offset=0x4c Size=0x1
    ...
    struct _unnamed_265 OAES;// Offset=0x5c Size=0x4
    struct _unnamed_266 CTRATT;// Offset=0x60 Size=0x4
    struct _unnamed_267 RRLS;// Offset=0x64 Size=0x2
    ...
    unsigned char Reserved0_1[106];// Offset=0x86 Size=0x6a
    unsigned char ReservedForManagement[16];// Offset=0xf0 Size=0x10
    struct _unnamed_268 OACS;// Offset=0x100 Size=0x2
    unsigned char ACL;// Offset=0x102 Size=0x1
    unsigned char AERL;// Offset=0x103 Size=0x1
    struct _unnamed_269 FRMW;// Offset=0x104 Size=0x1
    struct _unnamed_270 LPA;// Offset=0x105 Size=0x1
    unsigned char ELPE;// Offset=0x106 Size=0x1
    unsigned char NPSS;// Offset=0x107 Size=0x1
    struct _unnamed_271 AVSCC;// Offset=0x108 Size=0x1
    struct _unnamed_272 APSTA;// Offset=0x109 Size=0x1
    ...
    struct _unnamed_273 RPMBS;// Offset=0x138 Size=0x4
    ...
    struct _unnamed_274 HCTMA;// Offset=0x142 Size=0x2
    unsigned short MNTMT;// Offset=0x144 Size=0x2
    unsigned short MXTMT;// Offset=0x146 Size=0x2
    struct _unnamed_275 SANICAP;// Offset=0x148 Size=0x4
    ...
    struct _unnamed_276 ANACAP;// Offset=0x157 Size=0x1
    ...
    unsigned char Reserved1[156];// Offset=0x164 Size=0x9c
    struct _unnamed_277 SQES;// Offset=0x200 Size=0x1
    struct _unnamed_277 CQES;// Offset=0x201 Size=0x1
    unsigned short MAXCMD;// Offset=0x202 Size=0x2
    unsigned long NN;// Offset=0x204 Size=0x4
    struct _unnamed_278 ONCS;// Offset=0x208 Size=0x2
    struct _unnamed_279 FUSES;// Offset=0x20a Size=0x2
    struct _unnamed_280 FNA;// Offset=0x20c Size=0x1
    struct _unnamed_281 VWC;// Offset=0x20d Size=0x1
    unsigned short AWUN;// Offset=0x20e Size=0x2
    unsigned short AWUPF;// Offset=0x210 Size=0x2
    struct _unnamed_271 NVSCC;// Offset=0x212 Size=0x1
    struct _unnamed_282 NWPC;// Offset=0x213 Size=0x1
    unsigned short ACWU;// Offset=0x214 Size=0x2
    unsigned char Reserved4[2];// Offset=0x216 Size=0x2
    struct _unnamed_283 SGLS;// Offset=0x218 Size=0x4
    unsigned long MNAN;// Offset=0x21c Size=0x4
    unsigned char Reserved6[224];// Offset=0x220 Size=0xe0
    unsigned char SUBNQN[256];// Offset=0x300 Size=0x100
    unsigned char Reserved7[768];// Offset=0x400 Size=0x300
    unsigned char Reserved8[256];// Offset=0x700 Size=0x100
