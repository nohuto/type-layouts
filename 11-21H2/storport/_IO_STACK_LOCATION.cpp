...
struct _unnamed_43// Size=0x20 (Id=43)
{
    struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
    unsigned long Options;// Offset=0x8 Size=0x4
    unsigned short Reserved;// Offset=0x10 Size=0x2
...
struct _unnamed_44// Size=0x18 (Id=44)
{
...
struct _unnamed_47// Size=0x10 (Id=47)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_49// Size=0x18 (Id=49)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _unnamed_53// Size=0x4 (Id=53)
{
    unsigned long Length;// Offset=0x0 Size=0x4
};
...
struct _unnamed_59// Size=0x10 (Id=59)
{
...
struct _unnamed_68// Size=0x20 (Id=68)
{
...
struct _unnamed_69// Size=0x8 (Id=69)
{
    struct _DEVICE_CAPABILITIES * Capabilities;// Offset=0x0 Size=0x8
};

struct _unnamed_70// Size=0x8 (Id=70)
{
...
struct _unnamed_72// Size=0x1 (Id=72)
{
...
struct _unnamed_78// Size=0x10 (Id=78)
{
...
struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=609)
{
    union // Size=0x4 (Id=0)
    {
...
struct _unnamed_87// Size=0x20 (Id=87)
{
...
union _unnamed_88// Size=0x20 (Id=88)
{
    struct _unnamed_41 Create;// Offset=0x0 Size=0x20
    struct _unnamed_42 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_43 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_44 Read;// Offset=0x0 Size=0x18
    struct _unnamed_44 Write;// Offset=0x0 Size=0x18
    struct _unnamed_46 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_47 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_49 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_50 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_51 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_52 QueryEa;// Offset=0x0 Size=0x20
    struct _unnamed_53 SetEa;// Offset=0x0 Size=0x4
    struct _unnamed_55 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_55 SetVolume;// Offset=0x0 Size=0x10
    struct _unnamed_56 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_57 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_58 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_59 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_60 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_61 MountVolume;// Offset=0x0 Size=0x10
    struct _unnamed_61 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_62 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_64 QueryQuota;// Offset=0x0 Size=0x20
    struct _unnamed_53 SetQuota;// Offset=0x0 Size=0x4
    struct _unnamed_66 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_68 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_69 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_70 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_71 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_72 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_74 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_76 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_78 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_80 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_81 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_84 Power;// Offset=0x0 Size=0x20
    struct _unnamed_85 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_86 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_87 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=89)
{
    ...
    union _unnamed_88 Parameters;// Offset=0x8 Size=0x20
