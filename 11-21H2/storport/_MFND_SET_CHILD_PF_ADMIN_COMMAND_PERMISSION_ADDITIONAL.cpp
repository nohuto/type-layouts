struct _MFND_SET_CHILD_PF_ADMIN_COMMAND_PERMISSION_ENTRY// Size=0x10 (Id=442)
{
...
struct _MFND_SET_CHILD_PF_ADMIN_COMMAND_PERMISSION_ADDITIONAL// Size=0x20 (Id=441)
{
    unsigned long Version;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
    unsigned long Flags;// Offset=0x8 Size=0x4
