struct _unnamed_838// Size=0x8 (Id=838)
{
...
union _unnamed_839// Size=0x8 (Id=839)
{
    struct _unnamed_838 u;// Offset=0x0 Size=0x8
    unsigned long long asUlong64;// Offset=0x0 Size=0x8
};

struct _RAID_LOG_CONTROL// Size=0x10 (Id=840)
{
    unsigned long Revision;// Offset=0x0 Size=0x4
    union _unnamed_839 Enable;// Offset=0x8 Size=0x8
};
