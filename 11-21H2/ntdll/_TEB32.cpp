struct _NT_TIB32// Size=0x1c (Id=584)
{
...
struct _GDI_TEB_BATCH32// Size=0x4e0 (Id=392)
{
...
struct _TEB32// Size=0x1018 (Id=309)
{
    ...
    unsigned long SystemReserved1[26];// Offset=0x10c Size=0x68
