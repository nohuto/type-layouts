...
struct _unnamed_796// Size=0x8 (Id=796)
{
...
struct _unnamed_799// Size=0x20 (Id=799)
{
...
struct _unnamed_800// Size=0x28 (Id=800)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=801)
{
    struct _unnamed_795 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_796 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_798 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _unnamed_799 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_800 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=778)
{
