struct _unnamed_145// Size=0x20 (Id=145)
{
...
struct _unnamed_147// Size=0x20 (Id=147)
{
    struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
    unsigned long Options;// Offset=0x8 Size=0x4
    unsigned short Reserved;// Offset=0x10 Size=0x2
...
struct _unnamed_148// Size=0x18 (Id=148)
{
...
struct _unnamed_150// Size=0x20 (Id=150)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_153// Size=0x18 (Id=153)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _unnamed_160// Size=0x20 (Id=160)
{
...
struct _unnamed_161// Size=0x18 (Id=161)
{
...
struct _unnamed_162// Size=0x20 (Id=162)
{
    unsigned long OutputBufferLength;// Offset=0x0 Size=0x4
    unsigned long InputBufferLength;// Offset=0x8 Size=0x4
...
struct _unnamed_164// Size=0x10 (Id=164)
{
    unsigned long SecurityInformation;// Offset=0x0 Size=0x4
...
struct _unnamed_167// Size=0x8 (Id=167)
{
    struct _SCSI_REQUEST_BLOCK * Srb;// Offset=0x0 Size=0x8
};

struct _unnamed_168// Size=0x20 (Id=168)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_170// Size=0x4 (Id=170)
{
...
struct _unnamed_175// Size=0x1 (Id=175)
{
...
struct _unnamed_179// Size=0x10 (Id=179)
{
...
struct _unnamed_181// Size=0x10 (Id=181)
{
...
struct _unnamed_183// Size=0x4 (Id=183)
{
...
struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=487)
{
    union // Size=0x4 (Id=0)
    {
...
struct _unnamed_189// Size=0x20 (Id=189)
{
...
struct _unnamed_190// Size=0x20 (Id=190)
{
...
union _unnamed_191// Size=0x20 (Id=191)
{
    struct _unnamed_145 Create;// Offset=0x0 Size=0x20
    struct _unnamed_146 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_147 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_148 Read;// Offset=0x0 Size=0x18
    struct _unnamed_148 Write;// Offset=0x0 Size=0x18
    struct _unnamed_150 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_151 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_153 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_154 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_155 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_156 QueryEa;// Offset=0x0 Size=0x20
    struct _unnamed_157 SetEa;// Offset=0x0 Size=0x4
    struct _unnamed_159 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_159 SetVolume;// Offset=0x0 Size=0x10
    struct _unnamed_160 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_161 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_162 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_163 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_164 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_165 MountVolume;// Offset=0x0 Size=0x10
    struct _unnamed_165 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_167 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_168 QueryQuota;// Offset=0x0 Size=0x20
    struct _unnamed_157 SetQuota;// Offset=0x0 Size=0x4
    struct _unnamed_170 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_171 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_172 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_173 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_174 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_175 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_177 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_179 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_181 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_183 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_184 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_187 Power;// Offset=0x0 Size=0x20
    struct _unnamed_188 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_189 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_190 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=192)
{
    ...
    union _unnamed_191 Parameters;// Offset=0x8 Size=0x20
