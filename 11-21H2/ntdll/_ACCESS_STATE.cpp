...
struct _LUID_AND_ATTRIBUTES// Size=0xc (Id=545)
{
    struct _LUID Luid;// Offset=0x0 Size=0x8
    unsigned long Attributes;// Offset=0x8 Size=0x4
};

struct _INITIAL_PRIVILEGE_SET// Size=0x2c (Id=496)
{
...
struct _PRIVILEGE_SET// Size=0x14 (Id=490)
{
    unsigned long PrivilegeCount;// Offset=0x0 Size=0x4
    unsigned long Control;// Offset=0x4 Size=0x4
...
union _unnamed_121// Size=0x2c (Id=121)
{
...
struct _ACCESS_STATE// Size=0xa0 (Id=122)
{
    ...
    union _unnamed_121 Privileges;// Offset=0x50 Size=0x2c
