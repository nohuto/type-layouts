...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=567)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=597)
{
    union // Size=0x2 (Id=0)
    {
...
struct _MMSUPPORT_INSTANCE// Size=0xc0 (Id=517)
{
...
struct _MMSUPPORT_SHARED// Size=0x80 (Id=536)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=438)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=528)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=406)
{
...
union _KE_PROCESS_CONCURRENCY_COUNT// Size=0x4 (Id=684)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _KE_IDEAL_PROCESSOR_ASSIGNMENT_BLOCK// Size=0x118 (Id=368)
{
    ...
    union _unnamed_367 AssignmentFlags;// Offset=0xc Size=0x4
    struct _KAFFINITY_EX IdealProcessorSets;// Offset=0x10 Size=0x108
};

struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=429)
{
...
struct _EPROCESS// Size=0xb80 (Id=134)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_131 MitigationFlagsValues;// Offset=0x9d0 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x9d4 Size=0x4
        struct _unnamed_132 MitigationFlags2Values;// Offset=0x9d4 Size=0x4
    };
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_133 MitigationFlags3Values;// Offset=0xb70 Size=0x4
    };
};
