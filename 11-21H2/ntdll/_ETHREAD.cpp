...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=544)
{
...
struct _KAPC_STATE// Size=0x30 (Id=494)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=518)
{
...
union _KERNEL_SHADOW_STACK_LIMIT// Size=0x8 (Id=348)
{
...
struct _KTHREAD// Size=0x480 (Id=87)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    ...
    unsigned char Spare31[3];// Offset=0x461 Size=0x3
    unsigned long Spare32;// Offset=0x464 Size=0x4
    unsigned long long EndPadding[3];// Offset=0x468 Size=0x18
};
...
struct _KSEMAPHORE// Size=0x20 (Id=485)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=539)
{
...
struct _KLOCK_ENTRY_LOCK_STATE// Size=0x10 (Id=561)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
union _KLOCK_ENTRY_BOOST_BITMAP// Size=0x8 (Id=335)
{
    unsigned long long AllFields;// Offset=0x0 Size=0x8
...
struct _KLOCK_ENTRY// Size=0x60 (Id=324)
{
    union // Size=0x10 (Id=0)
    {
...
struct _ETHREAD// Size=0x8f0 (Id=125)
{
