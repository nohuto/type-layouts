struct _NT_TIB// Size=0x38 (Id=525)
{
...
union _KPRCBFLAG// Size=0x4 (Id=457)
{
...
struct _KDESCRIPTOR// Size=0x10 (Id=738)
{
...
struct _KSPECIAL_REGISTERS// Size=0xf0 (Id=693)
{
...
struct _CONTEXT// Size=0x4d0 (Id=593)
{
...
union _SLIST_HEADER// Size=0x10 (Id=96)
{
    unsigned long long Alignment;// Offset=0x0 Size=0x8
    unsigned long long Region;// Offset=0x8 Size=0x8
    struct _unnamed_95 HeaderX64;// Offset=0x0 Size=0x10
};
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=420)
{
...
struct _KSTATIC_AFFINITY_BLOCK// Size=0x420 (Id=313)
{
...
struct _KSOFTWARE_INTERRUPT_BATCH// Size=0x110 (Id=432)
{
...
struct _KTIMER_TABLE_ENTRY// Size=0x20 (Id=743)
{
...
struct _KGATE// Size=0x18 (Id=450)
{
...
struct _PROC_IDLE_POLICY// Size=0x6 (Id=730)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=569)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=600)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=607)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=701)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROC_PERF_CHECK_CONTEXT// Size=0x48 (Id=625)
{
...
struct _PROCESSOR_POWER_STATE// Size=0x230 (Id=573)
{
...
struct _KTIMER// Size=0x40 (Id=615)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=482)
{
    unsigned char Level;// Offset=0x0 Size=0x1
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=618)
{
...
struct _unnamed_57// Size=0x38 (Id=57)
{
...
struct _IOP_IRP_STACK_PROFILER// Size=0x54 (Id=591)
{
    unsigned long Profile[20];// Offset=0x0 Size=0x50
    unsigned long TotalIrps;// Offset=0x50 Size=0x4
};

struct _KSECURE_FAULT_INFORMATION// Size=0x18 (Id=404)
{
...
struct _KTIMER_EXPIRATION_TRACE// Size=0x10 (Id=599)
{
...
struct _KCLOCK_TIMER_DEADLINE_ENTRY// Size=0x10 (Id=433)
{
...
struct _KCLOCK_INCREMENT_TRACE// Size=0x20 (Id=631)
{
...
struct _KCLOCK_TIMER_STATE// Size=0x518 (Id=337)
{
...
struct _MACHINE_FRAME// Size=0x28 (Id=729)
{
...
struct _MACHINE_CHECK_CONTEXT// Size=0x50 (Id=548)
{
...
struct _KLOCK_QUEUE_HANDLE// Size=0x18 (Id=526)
{
...
struct _KPRCB// Size=0xbf00 (Id=58)
{
    ...
    union // Size=0x6f0 (Id=0)
    {
        ...
        union // Size=0x1 (Id=0)
        {
            ...
            struct // Size=0x1 (Id=0)
            {
                ...
                unsigned char BpbFeaturesReserved:2;// Offset=0x6e2 Size=0x1 BitOffset=0x6 BitSize=0x2
            };
        };
    ...
    struct _unnamed_57 StibpPairingTrace;// Offset=0x8b38 Size=0x38
    ...
    unsigned long CoresPerPhysicalDie;// Offset=0x9848 Size=0x4
    unsigned long LogicalProcessorsPerModule;// Offset=0x984c Size=0x4
