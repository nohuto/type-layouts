struct _RTL_CRITICAL_SECTION// Size=0x28 (Id=252)
{
...
union _unnamed_253// Size=0x28 (Id=253)
{
    struct _RTL_CRITICAL_SECTION CriticalSection;// Offset=0x0 Size=0x28
};

struct _HEAP_LOCK// Size=0x28 (Id=254)
{
    union _unnamed_253 Lock;// Offset=0x0 Size=0x28
};
