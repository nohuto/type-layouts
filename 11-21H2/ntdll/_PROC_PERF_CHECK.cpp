struct _PROC_PERF_CHECK_SNAP// Size=0x38 (Id=757)
{
...
struct _PROC_PERF_CHECK// Size=0x578 (Id=694)
{
    ...
    unsigned char Class0FloorPerfSelection;// Offset=0xed Size=0x1
    unsigned char Class1MinimumPerfSelection;// Offset=0xee Size=0x1
