struct _RTL_HEAP_MEMORY_LIMIT_DATA// Size=0x20 (Id=341)
{
...
union _RTL_RUN_ONCE// Size=0x8 (Id=377)
{
...
struct _HEAP_OPPORTUNISTIC_LARGE_PAGE_STATS// Size=0x10 (Id=634)
{
...
struct _RTL_HP_SEG_ALLOC_POLICY// Size=0x18 (Id=467)
{
...
struct _HEAP_RUNTIME_MEMORY_STATS// Size=0x58 (Id=297)
{
...
struct _HEAP_SEG_CONTEXT// Size=0xc0 (Id=296)
{
    ...
    union _unnamed_295 Flags;// Offset=0xd Size=0x1
...
struct _HEAP_VS_DELAY_FREE_CONTEXT// Size=0x10 (Id=428)
{
    union _SLIST_HEADER ListHead;// Offset=0x0 Size=0x10
};

struct _HEAP_SUBALLOCATOR_CALLBACKS// Size=0x28 (Id=238)
{
...
struct _RTL_HP_VS_CONFIG// Size=0x4 (Id=380)
{
    struct _unnamed_379 Flags;// Offset=0x0 Size=0x4
};

struct _HEAP_VS_CONTEXT// Size=0xc0 (Id=286)
{
...
struct _RTL_HP_LFH_CONFIG// Size=0x4 (Id=453)
{
...
struct _SEGMENT_HEAP// Size=0x840 (Id=301)
{
