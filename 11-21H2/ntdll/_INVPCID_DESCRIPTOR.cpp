...
union _INVPCID_DESCRIPTOR// Size=0x10 (Id=63)
{
    struct _unnamed_60 IndividualAddress;// Offset=0x0 Size=0x10
    struct _unnamed_61 SingleContext;// Offset=0x0 Size=0x10
    struct _unnamed_62 AllContextAndGlobals;// Offset=0x0 Size=0x10
    struct _unnamed_62 AllContext;// Offset=0x0 Size=0x10
};
