...
union _MCI_STATS// Size=0x8 (Id=769)
{
    struct _unnamed_768 MciStatus;// Offset=0x0 Size=0x8
    unsigned long long QuadPart;// Offset=0x0 Size=0x8
};

union _MCI_ADDR// Size=0x8 (Id=758)
{
...
union _unnamed_668// Size=0x20 (Id=668)
{
    union // Size=0x20 (Id=0)
    {
        struct _unnamed_666 Mca;// Offset=0x0 Size=0x20
        struct _unnamed_667 Mce;// Offset=0x0 Size=0x10
    };
};

struct _MCA_EXCEPTION// Size=0x100 (Id=669)
{
    ...
    union _unnamed_668 u;// Offset=0x18 Size=0x20
