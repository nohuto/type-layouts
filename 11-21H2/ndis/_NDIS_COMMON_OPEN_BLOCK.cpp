...
struct _NDIS_SPIN_LOCK// Size=0x10 (Id=160)
{
...
struct _NDIS_COMMON_OPEN_BLOCK// Size=0x3f8 (Id=524)
{
    union // Size=0x150 (Id=0)
    {
        ...
        struct _QUEUED_CLOSE// Size=0x28 (Id=6050)
        {
    ...
    struct _PKTMON_COMPONENT_CONTEXT PktMonComp;// Offset=0x398 Size=0x38
    struct _PKTMON_EDGE_CONTEXT PktMonEdge;// Offset=0x3d0 Size=0x28
};
