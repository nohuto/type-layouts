struct _NDIS_CLIENT_CHARACTERISTICS// Size=0x98 (Id=850)
{
...
struct _NDIS_REQUEST// Size=0xb0 (Id=814)
{
    union // Size=0x24 (Id=0)
    {
        ...
        union _DATA// Size=0x20 (Id=10454)
        {
            struct _QUERY_INFORMATION// Size=0x20 (Id=10455)
            {
            ...
            struct _SET_INFORMATION// Size=0x20 (Id=10462)
            {
                unsigned long Oid;// Offset=0x0 Size=0x4
                void * InformationBuffer;// Offset=0x8 Size=0x8
                unsigned int InformationBufferLength;// Offset=0x10 Size=0x4
...
struct _NDIS_CO_AF_BLOCK// Size=0x258 (Id=536)
{
