...
struct _NDIS_GFP_TRANSPORT_SRC_AND_DEST_PORT_WILDCARD_MATCH// Size=0x10 (Id=1700)
{
...
struct _NDIS_GFP_HEADER_GROUP_WILDCARD_MATCH// Size=0x78 (Id=1365)
{
    union // Size=0x5e (Id=0)
    {
        ...
        union <unnamed-type-TransportOrEncapsulation>// Size=0x14 (Id=6653)
        {
            struct <unnamed-type-UdpHeader>// Size=0x10 (Id=6654)
            {
            ...
            struct <unnamed-type-TcpHeader>// Size=0x14 (Id=6657)
            {
            ...
            struct <unnamed-type-IcmpHeader>// Size=0x2 (Id=6661)
            {
                unsigned char Type;// Offset=0x0 Size=0x1
            ...
            struct <unnamed-type-Encapsulation>// Size=0x8 (Id=6665)
            {
