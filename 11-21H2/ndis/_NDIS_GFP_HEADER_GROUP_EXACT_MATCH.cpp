...
struct _NDIS_GFP_ETHERNET_HEADER_FIELDS// Size=0x14 (Id=876)
{
...
struct _NDIS_GFP_HEADER_GROUP_EXACT_MATCH// Size=0x58 (Id=1475)
{
    union // Size=0x4e (Id=0)
    {
        ...
        union <unnamed-type-IPAddress>// Size=0x20 (Id=6609)
        {
            struct <unnamed-type-IPv4Address>// Size=0x8 (Id=6610)
            {
            ...
            struct <unnamed-type-IPv6Address>// Size=0x20 (Id=6614)
            {
        ...
        union <unnamed-type-TransportOrEncapsulation>// Size=0x8 (Id=6621)
        {
            struct <unnamed-type-Udp>// Size=0x4 (Id=6622)
            {
            ...
            struct <unnamed-type-Tcp>// Size=0x6 (Id=6626)
            {
                unsigned short SourcePort;// Offset=0x0 Size=0x2
                unsigned short DestinationPort;// Offset=0x2 Size=0x2
            ...
            struct <unnamed-type-Icmp>// Size=0x2 (Id=6631)
            {
                unsigned char Type;// Offset=0x0 Size=0x1
            ...
            struct <unnamed-type-Encapsulation>// Size=0x8 (Id=6635)
            {
