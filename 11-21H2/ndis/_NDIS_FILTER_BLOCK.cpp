...
struct _PENDING_STACK_EXPANSION_FALLBACK_WORK// Size=0x38 (Id=1286)
{
...
struct _NDIS_FILTER_PARTIAL_CHARACTERISTICS// Size=0x30 (Id=810)
{
...
struct _NDIS_FILTER_BLOCK// Size=0x398 (Id=490)
{
    union // Size=0xc0 (Id=0)
    {
        ...
        struct <unnamed-type-StackExpansionFallback>// Size=0x60 (Id=6343)
        {
    ...
    struct _PKTMON_COMPONENT_CONTEXT PktMonComp;// Offset=0x310 Size=0x38
    struct _PKTMON_EDGE_CONTEXT PktMonEdgeLower;// Offset=0x348 Size=0x28
    struct _PKTMON_EDGE_CONTEXT PktMonEdgeUpper;// Offset=0x370 Size=0x28
