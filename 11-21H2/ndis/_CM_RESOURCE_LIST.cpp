...
struct _CM_PARTIAL_RESOURCE_DESCRIPTOR// Size=0x14 (Id=1306)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x10 (Id=2450)
        {
            ...
            struct <unnamed-type-MessageInterrupt>// Size=0x10 (Id=2465)
            {
                struct _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-MessageInterrupt>::_unnamed_1747::<unnamed-type-Raw> Raw;// Offset=0x0 Size=0x10
                struct _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-MessageInterrupt>::_unnamed_1748::<unnamed-type-Translated> Translated;// Offset=0x0 Size=0x10
            };
            ...
            struct <unnamed-type-DmaV3>// Size=0xc (Id=2478)
            {
                unsigned long Channel;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-DevicePrivate>// Size=0xc (Id=2486)
            {
            ...
            struct <unnamed-type-BusNumber>// Size=0xc (Id=2490)
            {
            ...
            struct <unnamed-type-DeviceSpecificData>// Size=0xc (Id=2495)
            {
...
struct _CM_PARTIAL_RESOURCE_LIST// Size=0x1c (Id=1649)
{
...
struct _CM_FULL_RESOURCE_DESCRIPTOR// Size=0x24 (Id=1051)
{
...
struct _CM_RESOURCE_LIST// Size=0x28 (Id=1232)
{
