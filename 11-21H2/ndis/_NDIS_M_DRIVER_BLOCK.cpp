...
struct _NDIS_MINIPORT_DRIVER_CHARACTERISTICS// Size=0xa0 (Id=614)
{
...
struct _NDIS50_MINIPORT_CHARACTERISTICS// Size=0xb8 (Id=1108)
{
...
struct _NDIS51_MINIPORT_CHARACTERISTICS// Size=0xf0 (Id=1219)
{
...
struct _REFERENCE_EX// Size=0x18 (Id=506)
{
...
struct _KMUTANT// Size=0x38 (Id=507)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _NDIS_CO_CALL_MANAGER_OPTIONAL_HANDLERS// Size=0x90 (Id=509)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_M_DRIVER_BLOCK// Size=0x4a0 (Id=521)
{
