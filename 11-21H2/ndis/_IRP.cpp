...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=95)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KAPC// Size=0x58 (Id=1043)
{
...
struct _IRP// Size=0xd0 (Id=102)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=4717)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=4736)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=4737)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=4750)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=4751)
            {
