...
struct _NDIS_OID_REQUEST// Size=0xf8 (Id=349)
{
    union // Size=0x20 (Id=0)
    {
        ...
        union _REQUEST_DATA// Size=0x28 (Id=9292)
        {
            unsigned long Oid;// Offset=0x0 Size=0x4
            struct _QUERY// Size=0x20 (Id=9294)
            {
                unsigned long Oid;// Offset=0x0 Size=0x4
            ...
            struct _METHOD// Size=0x28 (Id=9308)
            {
                unsigned long Oid;// Offset=0x0 Size=0x4
                void * InformationBuffer;// Offset=0x8 Size=0x8
