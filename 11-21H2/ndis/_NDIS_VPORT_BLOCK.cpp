...
struct _NDIS_NDK_CAPABILITIES// Size=0x38 (Id=1737)
{
...
struct _NDIS_NDK_REQUEST_PARAMETERS// Size=0x68 (Id=2075)
{
...
struct _NDIS_NDK_RESPONSE_PARAMETERS// Size=0x40 (Id=2070)
{
...
struct _NDIS_NDK_PARAMETERS// Size=0xa8 (Id=2069)
{
...
struct _NDIS_NIC_SWITCH_VPORT_PARAMETERS// Size=0x2f0 (Id=2052)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
...
struct _NDIS_VPORT_BLOCK// Size=0x388 (Id=1980)
{
