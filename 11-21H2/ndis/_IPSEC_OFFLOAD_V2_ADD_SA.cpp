...
struct _IPSEC_OFFLOAD_V2_ADD_SA// Size=0xb0 (Id=982)
{
    ...
    union // Size=0x8 (Id=0)
    {
        struct _IPSEC_OFFLOAD_V2_ADD_SA::_unnamed_1957::<unnamed-type-IPv4Endpoints> IPv4Endpoints;// Offset=0x18 Size=0x8
        struct _IPSEC_OFFLOAD_V2_ADD_SA::_unnamed_1958::<unnamed-type-IPv6Endpoints> IPv6Endpoints;// Offset=0x18 Size=0x20
    };
