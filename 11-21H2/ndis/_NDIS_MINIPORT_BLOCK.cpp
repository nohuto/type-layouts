...
struct _REFERENCE// Size=0x10 (Id=561)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=884)
{
    union // Size=0x4 (Id=0)
    {
...
union _ULARGE_INTEGER// Size=0x8 (Id=92)
{
    unsigned long LowPart;// Offset=0x0 Size=0x4
    unsigned long HighPart;// Offset=0x4 Size=0x4
    struct <unnamed-type-u>// Size=0x8 (Id=13988)
    {
        unsigned long LowPart;// Offset=0x0 Size=0x4
        unsigned long HighPart;// Offset=0x4 Size=0x4
    };
...
struct _KTIMER// Size=0x40 (Id=1429)
{
...
struct _SINGLE_LIST_ENTRY// Size=0x8 (Id=48)
{
...
struct _NDIS_TIMER// Size=0x80 (Id=562)
{
...
struct _NDIS_PM_WAKE_UP_CAPABILITIES// Size=0xc (Id=1022)
{
...
struct _NDIS_PNP_CAPABILITIES// Size=0x10 (Id=563)
{
    unsigned long Flags;// Offset=0x0 Size=0x4
    struct _NDIS_PM_WAKE_UP_CAPABILITIES WakeUpCapabilities;// Offset=0x4 Size=0xc
};

struct _NDIS_PM_CAPABILITIES// Size=0x3c (Id=565)
{
...
struct _NDIS_PM_PARAMETERS// Size=0x14 (Id=566)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=567)
{
...
struct _KEVENT// Size=0x18 (Id=83)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
};
...
struct _NDIS_MINIPORT_WORK_ITEM// Size=0x18 (Id=1390)
{
...
struct _WORK_QUEUE_ITEM// Size=0x20 (Id=98)
{
...
struct _KBUGCHECK_CALLBACK_RECORD// Size=0x40 (Id=568)
{
...
struct _NDIS_MINIPORT_HANDLERS// Size=0xb8 (Id=569)
{
...
struct _NDIS_RECEIVE_SCALE_CAPABILITIES// Size=0x14 (Id=492)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_RESTART_GENERAL_ATTRIBUTES// Size=0x58 (Id=503)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_M_PERIODIC_RECEIVES// Size=0x88 (Id=572)
{
...
struct _NDIS_PCI_DEVICE_CUSTOM_PROPERTIES// Size=0x34 (Id=573)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_OFFLOAD_REG// Size=0x4 (Id=576)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _NDIS_EVENT// Size=0x18 (Id=577)
{
    struct _KEVENT Event;// Offset=0x0 Size=0x18
};

struct _NDIS_PM_ADMIN_CONFIG// Size=0x4 (Id=578)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _KSEMAPHORE// Size=0x20 (Id=579)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

struct _GUID// Size=0x10 (Id=272)
{
...
union _NET_LUID_LH// Size=0x8 (Id=580)
{
    unsigned long long Value;// Offset=0x0 Size=0x8
    struct <unnamed-type-Info>// Size=0x8 (Id=12111)
    {
...
struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=912)
{
...
struct _IO_REMOVE_LOCK// Size=0x20 (Id=581)
{
...
struct _PROCESSOR_NUMBER// Size=0x4 (Id=582)
{
...
struct _ULONG_REFERENCE// Size=0x10 (Id=583)
{
    unsigned long long SpinLock;// Offset=0x0 Size=0x8
...
struct _VPCI_INVALIDATE_BLOCK_OUTPUT// Size=0x8 (Id=585)
{
    unsigned long long BlockMask;// Offset=0x0 Size=0x8
};

struct _LUID// Size=0x8 (Id=59)
{
    unsigned long LowPart;// Offset=0x0 Size=0x4
    long HighPart;// Offset=0x4 Size=0x4
};

struct _IF_PHYSICAL_ADDRESS_LH// Size=0x22 (Id=591)
{
    unsigned short Length;// Offset=0x0 Size=0x2
...
struct _PKTMON_COMPONENT_CONTEXT// Size=0x38 (Id=593)
{
...
struct _PKTMON_EDGE_CONTEXT// Size=0x28 (Id=594)
{
    struct _LIST_ENTRY ListLink;// Offset=0x0 Size=0x10
...
struct _EXECUTION_CONTEXT_WORK_UNIT_KNOBS// Size=0x8 (Id=1190)
{
    unsigned int AtPassive;// Offset=0x0 Size=0x4
    unsigned int AtDispatch;// Offset=0x4 Size=0x4
};

struct _EXECUTION_CONTEXT_RUNTIME_KNOBS// Size=0x3c (Id=455)
{
...
struct _NDIS_MINIPORT_BLOCK// Size=0x17a8 (Id=488)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    ...
    unsigned long long InvalidateBlockMask;// Offset=0x1208 Size=0x8
    struct _IRP * InvalidateBlockIoctlPf;// Offset=0x1210 Size=0x8
    struct _IRP * InvalidateBlockIoctlVf;// Offset=0x1218 Size=0x8
    struct _VPCI_INVALIDATE_BLOCK_OUTPUT InvalidateBlockVfParams;// Offset=0x1220 Size=0x8
    struct _KEVENT InvalidateBlockEvent;// Offset=0x1228 Size=0x18
    unsigned short InvalidateVfId;// Offset=0x1240 Size=0x2
    unsigned char InvalidateBlockCancelling;// Offset=0x1242 Size=0x1
    struct _NDIS_PF_BLOCK * PFBlock;// Offset=0x1248 Size=0x8
    unsigned long NumSwitches;// Offset=0x1250 Size=0x4
    struct _LIST_ENTRY NicSwitchList;// Offset=0x1258 Size=0x10
    unsigned long NumAllocatedVFs;// Offset=0x1268 Size=0x4
    struct _LIST_ENTRY VFList;// Offset=0x1270 Size=0x10
    unsigned long NumActiveVPorts;// Offset=0x1280 Size=0x4
    struct _LIST_ENTRY VPortList;// Offset=0x1288 Size=0x10
    unsigned char * AllocatedVPortIndices;// Offset=0x1298 Size=0x8
    unsigned long AllocatedVPortIndicesLength;// Offset=0x12a0 Size=0x4
    unsigned long  ( * SetVirtualFunctionData)(void * ,unsigned short ,void * ,unsigned long ,unsigned long );// Offset=0x12a8 Size=0x8
    unsigned long  ( * GetVirtualFunctionData)(void * ,unsigned short ,void * ,unsigned long ,unsigned long );// Offset=0x12b0 Size=0x8
    long  ( * EnableVirtualization)(void * ,unsigned short ,unsigned char ,unsigned char ,unsigned char );// Offset=0x12b8 Size=0x8
    long  ( * GetVirtualDeviceLocation)(void * ,unsigned short ,unsigned short * ,unsigned char * ,unsigned char * );// Offset=0x12c0 Size=0x8
    long  ( * GetVirtualFunctionProbedBars)(void * ,unsigned long * );// Offset=0x12c8 Size=0x8
    void * VirtInterfaceContext;// Offset=0x12d0 Size=0x8
    struct _UNICODE_STRING DevinterfaceVirtSymbolicLinkName;// Offset=0x12d8 Size=0x10
    void  ( * VpciInterfaceDereference)(void * );// Offset=0x12e8 Size=0x8
    long  ( * WriteVfConfigBlock)(void * ,unsigned long ,void * ,unsigned long );// Offset=0x12f0 Size=0x8
    long  ( * ReadVfConfigBlock)(void * ,unsigned long ,void * ,unsigned long );// Offset=0x12f8 Size=0x8
    void * VpciInterfaceContext;// Offset=0x1300 Size=0x8
    unsigned int VfSerialNumber;// Offset=0x1308 Size=0x4
    struct _LUID SriovLuid;// Offset=0x130c Size=0x8
    struct NDIS_REFCOUNT_HANDLE__ * RefCountTracker;// Offset=0x1318 Size=0x8
    struct NDIS_REFCOUNT_HANDLE__ * NsiRefCountTracker;// Offset=0x1320 Size=0x8
    struct _NDIS_QOS_CAPABILITIES * QosHwCapabilities;// Offset=0x1328 Size=0x8
    struct _NDIS_QOS_CAPABILITIES * QosCurrentCapabilities;// Offset=0x1330 Size=0x8
    struct _NDIS_QOS_PARAMETERS * QosOperationalParameters;// Offset=0x1338 Size=0x8
    unsigned long QosOperationalParametersBufferSize;// Offset=0x1340 Size=0x4
    struct _NDIS_QOS_PARAMETERS * QosRemoteParameters;// Offset=0x1348 Size=0x8
    unsigned long QosRemoteParametersBufferSize;// Offset=0x1350 Size=0x4
    unsigned long long DeviceFlags;// Offset=0x1358 Size=0x8
    void * VerifierContext;// Offset=0x1360 Size=0x8
    struct WORKITEM_WITH_IRP SurpriseRemovalWorkItem;// Offset=0x1368 Size=0x28
    struct Ndis::BindStack Bindings;// Offset=0x1390 Size=0x68
    struct Ndis::BindEngine BindEngine;// Offset=0x13f8 Size=0x78
    class Rtl::KNeutralLock<enum NDIS_MINIPORT_POLICY_OWNER> MiniportOwner;// Offset=0x1470 Size=0x28
    bool PmInterruptedByPnp;// Offset=0x1498 Size=0x1
    bool DoNotBlockOnMiniportLock;// Offset=0x1499 Size=0x1
    bool PoFxDStateReportingEnabled;// Offset=0x149a Size=0x1
    struct NDIS_MINIPORT_HOOK_ADAPTER_HANDLE__ * HookAdapterHandle;// Offset=0x14a0 Size=0x8
    struct _WORK_QUEUE_ITEM InterfaceUpdateWorkItem;// Offset=0x14a8 Size=0x20
    bool InterfaceUpdateInProgress;// Offset=0x14c8 Size=0x1
    bool MacAddressUpdateQueued;// Offset=0x14c9 Size=0x1
    bool MtuUpdateQueued;// Offset=0x14ca Size=0x1
    struct _IF_PHYSICAL_ADDRESS_LH PendingMacAddress;// Offset=0x14cc Size=0x22
    unsigned long PendingMtuSize;// Offset=0x14f0 Size=0x4
    wchar_t * PnPInstanceId;// Offset=0x14f8 Size=0x8
    struct WORKITEM_WITH_IRP DevicePowerOnWorkItem;// Offset=0x1500 Size=0x28
    struct WORKITEM_WITH_IRP DevicePowerDownWorkItem;// Offset=0x1528 Size=0x28
    class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,__int64,-1,std::nullptr_t> > > PendingOidWatchdog;// Offset=0x1550 Size=0x8
    class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,__int64,-1,std::nullptr_t> > > HookedOidWatchdog;// Offset=0x1558 Size=0x8
    class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,__int64,-1,std::nullptr_t> > > ReenumerateWatchdog;// Offset=0x1560 Size=0x8
    struct _NDIS_PD_BLOCK * PDBlock;// Offset=0x1568 Size=0x8
    void * PdcHandle;// Offset=0x1570 Size=0x8
    struct _NDIS_TIMER PdcTaskClientDisableTimer;// Offset=0x1578 Size=0x80
    struct _NDIS_WORK_ITEM PdcTaskClientDisableWorkItem;// Offset=0x15f8 Size=0x50
    long PdcTaskClientMode;// Offset=0x1648 Size=0x4
    unsigned long ModernStandbyWoLMagicPacketEnable;// Offset=0x164c Size=0x4
    struct _NDIS_RSS_DPC_WORKER_CONTEXT * RssV2Context;// Offset=0x1650 Size=0x8
    long RssV2CompletionCount;// Offset=0x1658 Size=0x4
    struct _KEVENT RssV2CompletionEvent;// Offset=0x1660 Size=0x18
    unsigned char RssV2Initialized;// Offset=0x1678 Size=0x1
    struct _LIST_ENTRY SynchronousOidCalls;// Offset=0x1680 Size=0x10
    struct _NDIS_TIMESTAMP_CAPABILITIES * HwTimestampCapabilities;// Offset=0x1690 Size=0x8
    struct _NDIS_TIMESTAMP_CAPABILITIES * HwTimestampCurrentConfig;// Offset=0x1698 Size=0x8
    struct _NDIS_TIMESTAMP_CAPABILITIES * TopTimestampConfig;// Offset=0x16a0 Size=0x8
    struct _NDIS_TIMESTAMP_CAPABILITIES * TopHwTimestampCapabilities;// Offset=0x16a8 Size=0x8
    struct _PKTMON_COMPONENT_CONTEXT PktMonComp;// Offset=0x16b0 Size=0x38
    struct _PKTMON_EDGE_CONTEXT PktMonEdge;// Offset=0x16e8 Size=0x28
    class KnobNamespace PollModeConfigKnobsNamespace;// Offset=0x1710 Size=0x48
    class Rtl::KArray<KnobDescriptor,1> PollModeConfigKnobDescriptors;// Offset=0x1758 Size=0x10
    struct _EXECUTION_CONTEXT_RUNTIME_KNOBS PollModeConfigKnobs;// Offset=0x1768 Size=0x3c
    unsigned char WdfCxPowerManagement;// Offset=0x17a4 Size=0x1
