struct Ndis::BindEngine// Size=0x78 (Id=587)
{
    ...
    {
        void ApplyBindChanges(enum CallRunMode ,bool );// Offset=0x0 Size=0xdd
        void SetDirty();
        ...
        void LockBindings();
        void UnlockBindings();
        void UpdateBindings(class KLockThisExclusive & );// Offset=0x0 Size=0x12e
        bool Iterate();// Offset=0x0 Size=0x718
        void ApplyRules();
