struct _NDIS_RESTART_ATTRIBUTES// Size=0x20 (Id=500)
{
...
struct _NDIS_PROTOCOL_RESTART_PARAMETERS// Size=0x38 (Id=493)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct NDIS_RESTART_INFORMATION// Size=0xe0 (Id=491)
{
    union // Size=0xd8 (Id=0)
    {
        ...
        void ~NDIS_RESTART_INFORMATION();// Offset=0x0 Size=0x52
