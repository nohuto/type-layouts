...
struct _unnamed_470// Size=0x4 (Id=470)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};
...
{
    struct _unnamed_469 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_470 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_469 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=472)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_471 Data;// Offset=0x4 Size=0x8
};
