struct PPM_DRIVER_INTERFACE// Size=0x140 (Id=646)
{
    ...
    unsigned long long  ( * PctDiscoverPlatformCtrs)(struct _FDO_DATA * );// Offset=0xe0 Size=0x8
    unsigned short  ( * PctSnapPlatformCtrs)(struct _FDO_DATA * ,unsigned long long );// Offset=0xe8 Size=0x8
    enum ULONG  ( * PctEnumPlatfromCtr)(struct _FDO_DATA * ,enum ULONG ,unsigned long long );// Offset=0xf0 Size=0x8
    long  ( * PctGetPlatformCtr)(struct _FDO_DATA * ,enum ULONG ,unsigned long long * ,unsigned long long * );// Offset=0xf8 Size=0x8
    long  ( * PctGetPlatformCtrInfo)(enum ULONG ,wchar_t ** ,wchar_t ** );// Offset=0x100 Size=0x8
    unsigned long PStateFFHControlRegister;// Offset=0x108 Size=0x4
    unsigned long long PStateFFHControlMask;// Offset=0x110 Size=0x8
    unsigned long TStateFFHControlRegister;// Offset=0x118 Size=0x4
    unsigned long long TStateFFHControlMask;// Offset=0x120 Size=0x8
    long  ( * GetHwDebugRegisters)(struct _PROC_HW_DEBUG_REGISTER_DEFINITION_LIST * );// Offset=0x128 Size=0x8
    long  ( * InitMeasRegisters)(struct _FDO_DATA * );// Offset=0x130 Size=0x8
    long  ( * QueryMeasValues)(unsigned long ,unsigned long * ,void * ,unsigned long );// Offset=0x138 Size=0x8
};
