struct _PEP_PROCESSOR_FEEDBACK_COUNTER// Size=0x8 (Id=695)
{
...
struct _PEP_PERFORMANCE_STATE// Size=0x40 (Id=544)
{
    ...
    unsigned char EppSupported;// Offset=0x20 Size=0x1
    unsigned char StateCount;// Offset=0x21 Size=0x1
