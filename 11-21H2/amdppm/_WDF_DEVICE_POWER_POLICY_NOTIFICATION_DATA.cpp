...
struct _unnamed_438// Size=0x8 (Id=438)
{
...
union _unnamed_440// Size=0x8 (Id=440)
{
    struct _unnamed_438 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_439 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_438 LeaveState;// Offset=0x0 Size=0x8
};
...
struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=264)
{
    ...
    union _unnamed_440 Data;// Offset=0x4 Size=0x8
};
