struct _INTERRUPTER_COUNTER// Size=0x38 (Id=541)
{
...
struct _INTERRUPTER_DATA// Size=0xe8 (Id=480)
{
    ...
    unsigned long long EventRingSpinLock;// Offset=0xd0 Size=0x8
    void * EventRingLock;// Offset=0xd8 Size=0x8
    unsigned char EventRingLockRequiresPassiveLevel;// Offset=0xe0 Size=0x1
};
