...
union _unnamed_318// Size=0x20 (Id=318)
{
    struct _unnamed_98 Create;// Offset=0x0 Size=0x20
    struct _unnamed_315 Read;// Offset=0x0 Size=0x18
    struct _unnamed_315 Write;// Offset=0x0 Size=0x18
    struct _unnamed_316 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_317 Others;// Offset=0x0 Size=0x20
};

struct _WDF_REQUEST_PARAMETERS// Size=0x28 (Id=319)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned char MinorFunction;// Offset=0x2 Size=0x1
    enum _WDF_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    union _unnamed_318 Parameters;// Offset=0x8 Size=0x20
};
