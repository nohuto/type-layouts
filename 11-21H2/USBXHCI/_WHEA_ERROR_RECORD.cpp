union _WHEA_REVISION// Size=0x2 (Id=751)
{
...
union _WHEA_TIMESTAMP// Size=0x8 (Id=893)
{
...
union _WHEA_ERROR_RECORD_HEADER_FLAGS// Size=0x4 (Id=970)
{
    struct // Size=0x4 (Id=0)
    {
...
union _WHEA_PERSISTENCE_INFO// Size=0x8 (Id=910)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WHEA_ERROR_RECORD_HEADER// Size=0x80 (Id=799)
{
...
union _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_VALIDBITS// Size=0x1 (Id=843)
{
...
union _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_FLAGS// Size=0x4 (Id=816)
{
    struct // Size=0x4 (Id=0)
    {
