...
struct _unnamed_294// Size=0xc (Id=294)
{
...
union _unnamed_299// Size=0x18 (Id=299)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_287 Port;// Offset=0x0 Size=0x18
        struct _unnamed_287 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_289 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_290 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_291 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_287 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_292 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_293 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_294 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_295 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_296 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_297 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_298 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=300)
{
    ...
    union _unnamed_299 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=947)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=780)
{
