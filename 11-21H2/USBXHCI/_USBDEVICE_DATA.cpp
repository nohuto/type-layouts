...
struct _USB_DEVICE_PORT_PATH// Size=0x24 (Id=493)
{
...
struct _UCXUSBDEVICE_INFO// Size=0x38 (Id=692)
{
    unsigned long Size;// Offset=0x0 Size=0x4
...
struct _USB_DEVICE_DESCRIPTOR// Size=0x12 (Id=402)
{
...
struct _XIL_DIRECT_USBDEVICE_DATA// Size=0x28 (Id=969)
{
    struct _XILCORE_USBDEVICE_DATA XilCoreUsbDeviceData;// Offset=0x0 Size=0x28
};

struct _XIL_PROXY_USBDEVICE_DATA// Size=0x30 (Id=971)
{
...
struct _XIL_USBDEVICE_DATA// Size=0x60 (Id=867)
{
...
struct _USBDEVICE_DATA// Size=0x2c0 (Id=497)
{
