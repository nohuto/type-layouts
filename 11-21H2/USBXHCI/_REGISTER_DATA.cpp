union _HCSPARAMS1// Size=0x4 (Id=852)
{
...
union _HCSPARAMS2// Size=0x4 (Id=899)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _HCSPARAMS3// Size=0x4 (Id=672)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _HCCPARAMS// Size=0x4 (Id=465)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _HCCPARAMS2// Size=0x4 (Id=705)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _REGISTER_DATA// Size=0x88 (Id=457)
{
    ...
    union _HCSPARAMS1 CachedHcsParams1;// Offset=0x50 Size=0x4
    union _HCSPARAMS2 CachedHcsParams2;// Offset=0x54 Size=0x4
    unsigned long MaxEventRingSegments;// Offset=0x58 Size=0x4
    unsigned long MaxScratchpadBuffers;// Offset=0x5c Size=0x4
    union _HCSPARAMS3 CachedHcsParams3;// Offset=0x60 Size=0x4
    union _HCCPARAMS CachedHccParams1;// Offset=0x64 Size=0x4
    union _HCCPARAMS2 CachedHccParams2;// Offset=0x68 Size=0x4
    union _EXTENDED_CAPABILITY_IDENTIFIER ExtendedCapabilityIdentifier;// Offset=0x6c Size=0x2
    ...
    unsigned char AssignDoorbellsToVTL0InSecureMode;// Offset=0x80 Size=0x1
    unsigned char AssignRuntimeRegistersToVTL0InSecureMode;// Offset=0x81 Size=0x1
};
