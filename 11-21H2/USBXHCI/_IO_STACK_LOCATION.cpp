...
struct _unnamed_123// Size=0x8 (Id=123)
{
...
struct _unnamed_125// Size=0x1 (Id=125)
{
...
struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=764)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=721)
{
...
union _unnamed_141// Size=0x20 (Id=141)
{
    struct _unnamed_98 Create;// Offset=0x0 Size=0x20
    struct _unnamed_99 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_100 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_101 Read;// Offset=0x0 Size=0x18
    struct _unnamed_101 Write;// Offset=0x0 Size=0x18
    struct _unnamed_103 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_104 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_106 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_107 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_108 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_110 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_111 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_112 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_113 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_114 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_115 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_116 MountVolume;// Offset=0x0 Size=0x10
    struct _unnamed_116 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_118 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_120 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_121 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_122 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_123 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_124 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_125 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_127 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_129 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_131 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_133 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_134 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_137 Power;// Offset=0x0 Size=0x20
    struct _unnamed_138 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_139 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_140 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=142)
{
    ...
    union _unnamed_141 Parameters;// Offset=0x8 Size=0x20
