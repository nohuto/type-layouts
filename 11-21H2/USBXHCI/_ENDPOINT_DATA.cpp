union _ENDPOINT_FLAGS// Size=0x4 (Id=507)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=694)
{
    union // Size=0x4 (Id=0)
    {
...
struct _USB_ENDPOINT_DESCRIPTOR// Size=0x7 (Id=592)
{
...
struct _unnamed_624// Size=0x1 (Id=624)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _unnamed_625// Size=0x1 (Id=625)
{
    struct // Size=0x1 (Id=0)
    {
...
union _unnamed_626// Size=0x1 (Id=626)
{
    unsigned char AsUchar;// Offset=0x0 Size=0x1
    struct _unnamed_624 Bulk;// Offset=0x0 Size=0x1
    struct _unnamed_625 Isochronous;// Offset=0x0 Size=0x1
};

struct _USB_SUPERSPEED_ENDPOINT_COMPANION_DESCRIPTOR// Size=0x6 (Id=627)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
    unsigned char bMaxBurst;// Offset=0x2 Size=0x1
    union _unnamed_626 bmAttributes;// Offset=0x3 Size=0x1
    unsigned short wBytesPerInterval;// Offset=0x4 Size=0x2
};

struct _USB_SUPERSPEEDPLUS_ISOCH_ENDPOINT_COMPANION_DESCRIPTOR// Size=0x8 (Id=615)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
...
struct _ENDPOINT_DATA// Size=0x550 (Id=501)
{
