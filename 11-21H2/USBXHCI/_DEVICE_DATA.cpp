...
struct _DEVICE_DATA// Size=0x68 (Id=450)
{
    ...
    struct _DEVICE_CAPABILITIES DeviceCapabilities;// Offset=0x18 Size=0x40
    struct WDFDEVICE__ * WdfDevice;// Offset=0x58 Size=0x8
    struct _SECURE_CHANNEL_DATA * SecureChannelData;// Offset=0x60 Size=0x8
};
