...
{
    struct _unnamed_648 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_649 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_648 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=651)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_650 Data;// Offset=0x4 Size=0x8
};
