union _unnamed_91// Size=0x8 (Id=91)
{
...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=771)
{
...
struct _unnamed_95// Size=0x58 (Id=95)
{
...
union _unnamed_96// Size=0x58 (Id=96)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_95 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=97)
{
    ...
    union _unnamed_91 AssociatedIrp;// Offset=0x18 Size=0x8
