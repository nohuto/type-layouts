...
struct _STOR_CRYPTO_CAPABILITY// Size=0x1c (Id=892)
{
...
struct NVME_ICE_CAPABILITIES_V3// Size=0x58 (Id=1275)
{
    ...
    unsigned short HiberMaxTransferSizeKBytes;// Offset=0x8 Size=0x2
    unsigned short DumpMaxTransferSizeKBytes;// Offset=0xa Size=0x2
    union _unnamed_429 Flags;// Offset=0xc Size=0x4
    unsigned char Reserved[32];// Offset=0x10 Size=0x20
    struct _STOR_CRYPTO_CAPABILITIES_DATA CryptoCapabilitiesData;// Offset=0x30 Size=0x28
};
