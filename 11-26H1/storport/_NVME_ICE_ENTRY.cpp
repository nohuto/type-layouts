...
struct _NVME_ICE_KEY_TABLE// Size=0x28 (Id=976)
{
...
struct _NVME_ICE_ENTRY// Size=0x78 (Id=447)
{
    ...
    struct NVME_ICE_INTERFACE_V3 * NvmeIceInterfaceV3;// Offset=0x38 Size=0x8
    struct _NVME_ICE_KEY_TABLE NvmeIceKeyTable;// Offset=0x40 Size=0x28
    unsigned char SecurityComplianceBitmask;// Offset=0x68 Size=0x1
    struct _STOR_CRYPTO_CAPABILITIES_DATA_INTERNAL * PlatformCryptoCapabilities;// Offset=0x70 Size=0x8
};
