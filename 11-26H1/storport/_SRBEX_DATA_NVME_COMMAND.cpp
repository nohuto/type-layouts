...
struct _unnamed_404// Size=0x40 (Id=404)
{
...
struct _unnamed_405// Size=0x40 (Id=405)
{
...
union _unnamed_406// Size=0x2 (Id=406)
{
...
struct _SRBEX_DATA_NVME_COMMAND// Size=0x70 (Id=407)
{
    ...
    union // Size=0x50 (Id=0)
    {
        ...
        struct _unnamed_404 FabricsCommand;// Offset=0x10 Size=0x40
        struct _unnamed_405 Command;// Offset=0x10 Size=0x40
    };
    ...
    union _unnamed_406 CommandStatus;// Offset=0x56 Size=0x2
