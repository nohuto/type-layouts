...
union _STORAGE_NOTIFICATION_GENERIC_FLAGS// Size=0x8 (Id=1334)
{
...
struct _unnamed_904// Size=0x8 (Id=904)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _STORAGE_NOTIFICATION_PROTOCOL_SPECIFIC_FLAGS// Size=0x8 (Id=905)
{
    union // Size=0x8 (Id=0)
    {
        struct _unnamed_904 NVMe;// Offset=0x0 Size=0x8
        unsigned long long AsUlonglong;// Offset=0x0 Size=0x8
    };
};

struct _STORAGE_NOTIFICATION_FLAGS// Size=0x10 (Id=703)
{
...
struct _IO_CSQ// Size=0x40 (Id=697)
{
...
struct _STOR_NOTIFICATION_CALLER_CONTEXT// Size=0xb0 (Id=696)
{
