...
struct _IDENTIFY_MFND_CAPABILITY_INFORMATION// Size=0x80 (Id=621)
{
    ...
    struct _unnamed_620 Features;// Offset=0x44 Size=0x4
    unsigned char MSCCNC;// Offset=0x48 Size=0x1
    unsigned char MPTGS;// Offset=0x49 Size=0x1
    unsigned char DPTGS;// Offset=0x4a Size=0x1
    unsigned char ROS;// Offset=0x4b Size=0x1
    unsigned char OMSS;// Offset=0x4c Size=0x1
    unsigned char Reserved2[51];// Offset=0x4d Size=0x33
};
