struct NVME_ICE_INTERFACE_V3// Size=0xa8 (Id=902)
{
    ...
    unsigned long  ( * IOStartV2)(void * ,struct NVME_PCI_ADDRESS * ,unsigned char ,struct NVME_ICE_IO_DESCRIPTOR * );// Offset=0x38 Size=0x8
    unsigned long  ( * IOCompleteV2)(void * ,struct NVME_PCI_ADDRESS * ,unsigned char ,void * );// Offset=0x40 Size=0x8
    unsigned long  ( * DumpIOStartV2)(const void * ,struct NVME_PCI_ADDRESS * ,unsigned char ,struct NVME_ICE_IO_DESCRIPTOR * );// Offset=0x48 Size=0x8
    unsigned long  ( * DumpIOCompleteV2)(const void * ,struct NVME_PCI_ADDRESS * ,unsigned char ,const void * );// Offset=0x50 Size=0x8
    ...
    unsigned long  ( * QueryPlatformCapabilitiesV2)(void * ,struct NVME_ICE_CAPABILITIES_V3 * ,unsigned long * );// Offset=0x80 Size=0x8
