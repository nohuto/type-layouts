...
struct _PCI_LINK_INFORMATION// Size=0xc (Id=716)
{
    union _unnamed_715 AvailableLinkSpeeds;// Offset=0x0 Size=0x4
...
union _unnamed_705// Size=0x4 (Id=705)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long DlrmIdleState:1;// Offset=0x0 Size=0x4 BitOffset=0x3 BitSize=0x1
...
struct _DLRM_TELEMETRY// Size=0x88 (Id=1287)
{
    ...
    unsigned long DlrmIdleCount;// Offset=0x74 Size=0x4
    unsigned long long DlrmIdleDetectedTimestamp;// Offset=0x78 Size=0x8
    unsigned long long DlrmIdleDurationCumulative;// Offset=0x80 Size=0x8
};

struct _DLRM_CONTEXT// Size=0x138 (Id=711)
{
    struct _PCI_LINK_INFORMATION LinkInfo;// Offset=0x0 Size=0xc
    union _unnamed_705 Flags;// Offset=0xc Size=0x4
    void * Adapter;// Offset=0x10 Size=0x8
    struct _unnamed_707 LinkRateManagement;// Offset=0x18 Size=0x28
    struct _unnamed_710 Power;// Offset=0x40 Size=0x10
    ...
    struct _DLRM_TELEMETRY Telemetry;// Offset=0xa8 Size=0x88
    unsigned long long AdapterIdleStartTimestamp;// Offset=0x130 Size=0x8
};
