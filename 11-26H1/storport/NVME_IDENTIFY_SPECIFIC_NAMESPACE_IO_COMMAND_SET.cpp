struct _unnamed_1251// Size=0x2 (Id=1251)
{
...
struct _unnamed_1252// Size=0x2 (Id=1252)
{
    struct // Size=0x2 (Id=0)
    {
...
struct NVME_IDENTIFY_SPECIFIC_NAMESPACE_IO_COMMAND_SET// Size=0x1000 (Id=1253)
{
    struct _unnamed_1251 ZOC;// Offset=0x0 Size=0x2
    struct _unnamed_1252 OZCS;// Offset=0x2 Size=0x2
