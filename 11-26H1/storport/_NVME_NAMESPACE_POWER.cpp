...
union _unnamed_557// Size=0x4 (Id=557)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _NVME_NAMESPACE_POWER// Size=0xc0 (Id=558)
{
    ...
    struct _unnamed_556 PendingPowerUpContext;// Offset=0x30 Size=0x10
    ...
    struct _unnamed_422 DFxQueue;// Offset=0x68 Size=0x20
    union _unnamed_557 Flags;// Offset=0x88 Size=0x4
