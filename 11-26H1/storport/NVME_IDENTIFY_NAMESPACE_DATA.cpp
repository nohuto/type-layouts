...
struct _unnamed_538// Size=0x1 (Id=538)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _unnamed_539// Size=0x1 (Id=539)
{
    struct // Size=0x1 (Id=0)
    {
...
struct NVME_IDENTIFY_NAMESPACE_DATA// Size=0x1000 (Id=540)
{
    ...
    struct _unnamed_531 NSFEAT;// Offset=0x18 Size=0x1
    unsigned char NLBAF;// Offset=0x19 Size=0x1
    struct _unnamed_532 FLBAS;// Offset=0x1a Size=0x1
    struct _unnamed_533 MC;// Offset=0x1b Size=0x1
    struct _unnamed_534 DPC;// Offset=0x1c Size=0x1
    struct _unnamed_535 DPS;// Offset=0x1d Size=0x1
    struct _unnamed_536 NMIC;// Offset=0x1e Size=0x1
    union NVM_RESERVATION_CAPABILITIES RESCAP;// Offset=0x1f Size=0x1
    struct _unnamed_537 FPI;// Offset=0x20 Size=0x1
    struct _unnamed_538 DLFEAT;// Offset=0x21 Size=0x1
    ...
    struct _unnamed_539 NSATTR;// Offset=0x63 Size=0x1
