...
struct _NVME_CONTROLLER_RESET_CONTEXT// Size=0x40 (Id=1197)
{
    union _SLIST_HEADER TimeoutNamespaceList;// Offset=0x0 Size=0x10
    struct _NVME_CONTROLLER_RESET_STATISTICS * ControllerResetStatistics;// Offset=0x10 Size=0x8
    struct _KEVENT AllNamespaceResetFinishedEvent;// Offset=0x18 Size=0x18
    unsigned long NamespaceCountToReset;// Offset=0x30 Size=0x4
    unsigned long NamespaceCountOfResetFailure;// Offset=0x34 Size=0x4
    unsigned long Reserved[2];// Offset=0x38 Size=0x8
};
