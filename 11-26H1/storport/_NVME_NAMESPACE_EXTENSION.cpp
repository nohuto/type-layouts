...
union _unnamed_542// Size=0x8 (Id=542)
{
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned long long Reserved:53;// Offset=0x0 Size=0x8 BitOffset=0xb BitSize=0x35
    };
...
union _unnamed_543// Size=0x8 (Id=543)
{
    struct // Size=0x8 (Id=0)
    {
...
union _NVME_NAMESPACE_STATE// Size=0x4 (Id=960)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1112// Size=0x4 (Id=1112)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _NVME_NAMESPACE_QOS// Size=0x20 (Id=1113)
{
    union _unnamed_1112 Flags;// Offset=0x0 Size=0x4
...
struct _NVME_NAMESPACE_EXTENSION// Size=0x2c0 (Id=544)
{
    ...
    unsigned char Reserved0;// Offset=0x3d Size=0x1
    ...
    union _unnamed_542 Flags;// Offset=0x70 Size=0x8
    ...
    union _unnamed_543 Attributes;// Offset=0xc8 Size=0x8
    union _NVME_NAMESPACE_STATE State;// Offset=0xd0 Size=0x4
    struct _STOR_DEVICE_QUEUE * IoQueue;// Offset=0x100 Size=0x8
    unsigned long PagingPathCount;// Offset=0x108 Size=0x4
    unsigned long CrashDumpPathCount;// Offset=0x10c Size=0x4
    unsigned long HiberPathCount;// Offset=0x110 Size=0x4
    unsigned char DumpPowerReady;// Offset=0x114 Size=0x1
    unsigned char StackDumpPowerReady;// Offset=0x115 Size=0x1
    unsigned short Reserved2;// Offset=0x116 Size=0x2
    long  ( * CrashdumpNotifyRoutine)(enum _STORAGE_DUMP_EVENT ,void * );// Offset=0x118 Size=0x8
    struct _KTIMER PendingTimer;// Offset=0x120 Size=0x40
    struct _KDPC PendingDpc;// Offset=0x160 Size=0x40
    unsigned short DefaultTimeout;// Offset=0x1a0 Size=0x2
    unsigned char Reserved3;// Offset=0x1a2 Size=0x1
    unsigned char OptimalIoBoundaryShift;// Offset=0x1a3 Size=0x1
    unsigned long OptimalIoBoundary;// Offset=0x1a4 Size=0x4
    unsigned long long LogicalBlockCount;// Offset=0x1a8 Size=0x8
    struct _UNICODE_STRING ZnsPnpInterfaceName;// Offset=0x1b0 Size=0x10
    struct NVME_IDENTIFY_SPECIFIC_NAMESPACE_IO_COMMAND_SET * IdentifyNamespaceIoCommandSet;// Offset=0x1c0 Size=0x8
    struct _NVME_IDLE_REQUEST_QUEUE ** IdleRequestQueues;// Offset=0x1c8 Size=0x8
    void * SystemThreadHandle;// Offset=0x1d0 Size=0x8
    struct _KEVENT RefillShadowQueueEvent;// Offset=0x1d8 Size=0x18
    struct _NVME_NAMESPACE_ERROR_RECOVERY * ErrorRecovery;// Offset=0x1f0 Size=0x8
