struct _MFND_SET_CHILD_PF_ADMIN_COMMAND_PERMISSION_ENTRY// Size=0x10 (Id=688)
{
...
struct _MFND_SET_CHILD_PF_ADMIN_COMMAND_PERMISSION_ADDITIONAL// Size=0x20 (Id=687)
{
    unsigned short Version;// Offset=0x0 Size=0x2
