...
struct _PROCESSOR_NUMBER// Size=0x4 (Id=202)
{
...
struct _STOR_EVENT_QUEUE_ENTRY// Size=0x38 (Id=291)
{
...
struct _unnamed_362// Size=0x28 (Id=362)
{
...
union _unnamed_363// Size=0x18 (Id=363)
{
...
struct _STOR_CRYPTO_KEY_INFO// Size=0x18 (Id=229)
{
    unsigned long Version;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
    unsigned long KeyIndex;// Offset=0x8 Size=0x4
    unsigned long long Tweak;// Offset=0x10 Size=0x8
};

struct _EXTENDED_REQUEST_BLOCK// Size=0x380 (Id=364)
{
    ...
    struct // Size=0x2 (Id=0)
    {
        ...
        unsigned char IsNvmeAdapter:1;// Offset=0x11 Size=0x1 BitOffset=0x5 BitSize=0x1
        unsigned char DataBufferMapped:1;// Offset=0x11 Size=0x1 BitOffset=0x6 BitSize=0x1
        unsigned char CompletionInProgress:1;// Offset=0x11 Size=0x1 BitOffset=0x7 BitSize=0x1
    };
    union // Size=0x4 (Id=0)
    {
        struct _PROCESSOR_NUMBER InitiatingProcessor;// Offset=0x14 Size=0x4
        unsigned long InitiatingProcessorIndex;// Offset=0x14 Size=0x4
    };
    ...
    struct _unnamed_362 SrbData;// Offset=0xb0 Size=0x28
    union // Size=0x8 (Id=0)
    {
        struct _RAID_ADAPTER_EXTENSION * Adapter;// Offset=0xd8 Size=0x8
        struct _NVME_ADAPTER_EXTENSION * NvmeAdapter;// Offset=0xd8 Size=0x8
    };
    union // Size=0x8 (Id=0)
    {
        struct _RAID_UNIT_EXTENSION * Unit;// Offset=0xe0 Size=0x8
        struct _NVME_NAMESPACE_EXTENSION * Namespace;// Offset=0xe0 Size=0x8
    };
    ...
    union _unnamed_363 u;// Offset=0x298 Size=0x18
    ...
    unsigned short SlotIndex;// Offset=0x30c Size=0x2
    unsigned short CommandId;// Offset=0x30e Size=0x2
    struct _NVME_CONTROLLER * NvmeController;// Offset=0x310 Size=0x8
    struct _STOR_CRYPTO_KEY_INFO * CryptoKeyInfo;// Offset=0x318 Size=0x8
    unsigned long NvmeIceKeyTableIndex;// Offset=0x320 Size=0x4
    union // Size=0x48 (Id=0)
    {
        struct NVME_ICE_IO_DESCRIPTOR NvmeIceIoDescriptor;// Offset=0x328 Size=0x48
        struct _STOR_CRYPTO_KEY_INFO CryptoKeyInfoBuffer;// Offset=0x328 Size=0x18
    };
    unsigned long KeyIndex;// Offset=0x370 Size=0x4
};

struct _IO_RESOURCE_ENTRY// Size=0x4b0 (Id=587)
{
    ...
    unsigned long Padd;// Offset=0x14 Size=0x4
    union _LARGE_INTEGER LogicalAddress;// Offset=0x18 Size=0x8
    void * Gateway;// Offset=0x20 Size=0x8
    struct _EXTENDED_REQUEST_BLOCK Xrb;// Offset=0x30 Size=0x380
    unsigned char SenseInfoBuffer[256];// Offset=0x3b0 Size=0x100
