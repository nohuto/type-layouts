struct _unnamed_1375// Size=0x4 (Id=1375)
{
...
union _NVME_POLLING_HINTS// Size=0x4 (Id=1376)
{
    struct _unnamed_1375 NDH;// Offset=0x0 Size=0x4
    unsigned long AsUlong;// Offset=0x0 Size=0x4
};

struct _NVME_POLLING_CONFIGURATION// Size=0x10 (Id=999)
{
...
union _NVME_POLLING_VERSION// Size=0x2 (Id=1193)
{
...
struct _unnamed_521// Size=0x14 (Id=521)
{
    union _NVME_POLLING_VERSION Version;// Offset=0x0 Size=0x2
    struct _NVME_POLLING_CONFIGURATION Config;// Offset=0x4 Size=0x10
};

struct _NVME_CONTROLLER_POLLING_CONTEXT// Size=0x28 (Id=522)
{
    unsigned char Enabled;// Offset=0x0 Size=0x1
    unsigned char Reserved;// Offset=0x1 Size=0x1
    unsigned short IoCQCountInPollingMode;// Offset=0x2 Size=0x2
    struct _NVME_POLLING_CONFIGURATION CurrentSettings;// Offset=0x4 Size=0x10
    struct _unnamed_521 DeviceSettings;// Offset=0x14 Size=0x14
};
