...
struct _EX_DEVICE_QUEUE_ENTRY// Size=0x18 (Id=351)
{
    struct _LIST_ENTRY DeviceListEntry;// Offset=0x0 Size=0x10
    unsigned long SortKey;// Offset=0x10 Size=0x4
    struct // Size=0x1 (Id=0)
    {
        unsigned char Inserted:1;// Offset=0x14 Size=0x1 BitOffset=0x0 BitSize=0x1
        unsigned char OnSList:1;// Offset=0x14 Size=0x1 BitOffset=0x1 BitSize=0x1
        unsigned char LockedForwardedIo:1;// Offset=0x14 Size=0x1 BitOffset=0x2 BitSize=0x1
    };
