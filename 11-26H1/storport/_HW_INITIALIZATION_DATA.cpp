...
struct _HW_INITIALIZATION_DATA// Size=0xd0 (Id=256)
{
    ...
    union // Size=0x8 (Id=0)
    {
        ...
        enum _NVME_ADAPTER_CONTROL_STATUS  ( * HwNvmeAdapterControl)(void * ,enum _NVME_ADAPTER_CONTROL_TYPE ,void * );// Offset=0x78 Size=0x8
    };
    ...
    union // Size=0x8 (Id=0)
    {
        ...
        enum _NVME_NAMESPACE_CONTROL_STATUS  ( * HwNamespaceControl)(void * ,enum _NVME_NAMESPACE_CONTROL_TYPE ,void * );// Offset=0xc8 Size=0x8
    };
};
