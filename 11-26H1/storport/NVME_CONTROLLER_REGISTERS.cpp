struct _NVME_NVM_SUBSYSTEM_RESET// Size=0x4 (Id=771)
{
    unsigned long NSSRC;// Offset=0x0 Size=0x4
};

struct _NVME_NVM_SUBSYSTEM_SHUTDOWN// Size=0x4 (Id=1053)
{
    unsigned long NSSC;// Offset=0x0 Size=0x4
};

union _NVME_CONTROLLER_READY_TIMEOUTS// Size=0x4 (Id=791)
{
...
struct NVME_CONTROLLER_REGISTERS// Size=0x1000 (Id=501)
{
    ...
    union NVME_BOOT_PARTITION_INFORMATION BPINFO;// Offset=0x40 Size=0x4
    unsigned long Reserved1[8];// Offset=0x44 Size=0x20
