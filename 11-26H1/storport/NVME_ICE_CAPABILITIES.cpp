...
struct NVME_ICE_CAPABILITIES// Size=0x34 (Id=1397)
{
    unsigned short Version;// Offset=0x0 Size=0x2
    unsigned short Size;// Offset=0x2 Size=0x2
    union NVME_ICE_PAGE_SIZE_BITMASK PageSizeBitmask;// Offset=0x4 Size=0x1
    union NVME_ICE_DATA_ALIGNMENT_BITMASK DataTransferAlignmentBitmask;// Offset=0x5 Size=0x1
    union _STORAGE_SECURITY_COMPLIANCE_BITMASK SecurityComplianceBitmask;// Offset=0x6 Size=0x1
    unsigned char Reserved;// Offset=0x7 Size=0x1
    unsigned short MaxTransferSizeKBytes;// Offset=0x8 Size=0x2
    struct _STOR_CRYPTO_CAPABILITIES_DATA CryptoCapabilitiesData;// Offset=0xc Size=0x28
};
