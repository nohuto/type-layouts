...
struct _unnamed_328// Size=0x10 (Id=328)
{
...
struct _unnamed_330// Size=0x10 (Id=330)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_331// Size=0xc (Id=331)
{
...
struct _unnamed_332// Size=0x18 (Id=332)
{
...
struct _unnamed_334// Size=0x18 (Id=334)
{
...
union _unnamed_336// Size=0x18 (Id=336)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_324 Port;// Offset=0x0 Size=0x18
        struct _unnamed_324 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_326 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_327 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_328 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_324 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_329 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_330 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_331 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_332 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_333 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_334 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_335 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=337)
{
    ...
    union _unnamed_336 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=1335)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=1051)
{
