...
union _unnamed_603// Size=0x4 (Id=603)
{
...
struct _RAID_UNIT_POFX// Size=0xb8 (Id=604)
{
    ...
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long F1ForPlaceholderMode:1;// Offset=0x20 Size=0x4 BitOffset=0xc BitSize=0x1
        unsigned long Reserved0:19;// Offset=0x20 Size=0x4 BitOffset=0xd BitSize=0x13
    };
    unsigned long WaitWakeActiveReference;// Offset=0x24 Size=0x4
    unsigned long long MiniportActiveReferences;// Offset=0x28 Size=0x8
    unsigned long long AdaptiveD3IdleTimeoutEngagedCount;// Offset=0x30 Size=0x8
    unsigned long long AdaptiveD3IdleTimeoutCheckedCount;// Offset=0x38 Size=0x8
    union _LARGE_INTEGER LastIdleTimestamp;// Offset=0x40 Size=0x8
    ...
    void * IoCoalescingRegistration;// Offset=0x68 Size=0x8
    void * AcDcRegistration;// Offset=0x70 Size=0x8
    struct _EX_TIMER * PowerCycleCheckTimer;// Offset=0x78 Size=0x8
    struct _EX_TIMER * MaintenanceTimer;// Offset=0x80 Size=0x8
    union _LARGE_INTEGER PreviousMaintenanceTime;// Offset=0x88 Size=0x8
    unsigned long ActiveRefsDuringMaintenanceTime;// Offset=0x90 Size=0x4
    union _unnamed_603 InterlockedFlags;// Offset=0x94 Size=0x4
    unsigned long long MiniportActiveReferenceAcquires;// Offset=0x98 Size=0x8
    unsigned long long MiniportActiveReferenceReleases;// Offset=0xa0 Size=0x8
    unsigned long PerfStateCountFromPEP;// Offset=0xa8 Size=0x4
    struct _STOR_POFX_COMPONENT_PERF_SET * PerfStateFromPEP;// Offset=0xb0 Size=0x8
};
