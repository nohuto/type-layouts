struct _INQUIRYDATA// Size=0x68 (Id=341)
{
    struct // Size=0x2 (Id=0)
    {
        ...
        union // Size=0x2 (Id=0)
        {
            ...
            unsigned char ReservedField1:1;// Offset=0x1 Size=0x1 BitOffset=0x7 BitSize=0x1
            unsigned char ReservedField2:4;// Offset=0x1 Size=0x1 BitOffset=0x0 BitSize=0x4
        };
        unsigned char HotPluggable:2;// Offset=0x1 Size=0x1 BitOffset=0x4 BitSize=0x2
        unsigned char LU_CONG:1;// Offset=0x1 Size=0x1 BitOffset=0x6 BitSize=0x1
