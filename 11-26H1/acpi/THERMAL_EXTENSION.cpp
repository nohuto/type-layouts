struct _unnamed_575// Size=0x4 (Id=575)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long Reserved1:1;// Offset=0x0 Size=0x4 BitOffset=0x5 BitSize=0x1
        unsigned long Notify80:1;// Offset=0x0 Size=0x4 BitOffset=0x6 BitSize=0x1
        unsigned long Notify81:1;// Offset=0x0 Size=0x4 BitOffset=0x7 BitSize=0x1
        unsigned long Throttle:1;// Offset=0x0 Size=0x4 BitOffset=0x8 BitSize=0x1
        unsigned long PendIrp:1;// Offset=0x0 Size=0x4 BitOffset=0x9 BitSize=0x1
        unsigned long Dti:1;// Offset=0x0 Size=0x4 BitOffset=0xa BitSize=0x1
        unsigned long LogTemp:1;// Offset=0x0 Size=0x4 BitOffset=0xb BitSize=0x1
        unsigned long LogRundown:1;// Offset=0x0 Size=0x4 BitOffset=0xc BitSize=0x1
        unsigned long Stop:1;// Offset=0x0 Size=0x4 BitOffset=0xd BitSize=0x1
        unsigned long TempTelemetry:1;// Offset=0x0 Size=0x4 BitOffset=0xe BitSize=0x1
        unsigned long Reserved:11;// Offset=0x0 Size=0x4 BitOffset=0xf BitSize=0xb
        unsigned long TempPending:1;// Offset=0x0 Size=0x4 BitOffset=0x1a BitSize=0x1
...
struct THERMAL_EXTENSION// Size=0x48 (Id=576)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_575 UFlags;// Offset=0x20 Size=0x4
    };
