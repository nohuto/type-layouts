union _unnamed_147// Size=0x8 (Id=147)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=554)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=428)
{
...
struct _unnamed_151// Size=0x58 (Id=151)
{
...
union _unnamed_152// Size=0x58 (Id=152)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_151 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=153)
{
    ...
    union _unnamed_147 AssociatedIrp;// Offset=0x18 Size=0x8
