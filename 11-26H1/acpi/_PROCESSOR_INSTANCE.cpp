...
struct _RTL_RANGE_LIST// Size=0x20 (Id=587)
{
...
struct _HAL_INTERRUPT_TARGET_INFORMATION// Size=0x1c (Id=648)
{
    ...
    struct _unnamed_647 Apic;// Offset=0xc Size=0x10
};
...
struct _PROCESSOR_INSTANCE// Size=0x70 (Id=254)
{
