struct _NT_TIB// Size=0x38 (Id=461)
{
...
union _KPRCBFLAG// Size=0x4 (Id=389)
{
...
struct _KDESCRIPTOR// Size=0x10 (Id=751)
{
...
struct _KSPECIAL_REGISTERS// Size=0x110 (Id=681)
{
...
struct _CONTEXT// Size=0x4d0 (Id=540)
{
...
union _KPRCB_BPB_RETPOLINE_STATE// Size=0x1 (Id=401)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _KSPIN_LOCK_QUEUE// Size=0x10 (Id=102)
{
...
struct _SINGLE_LIST_ENTRY// Size=0x8 (Id=39)
{
...
struct _KAFFINITY_EX// Size=0x108 (Id=93)
{
...
struct _KSTATIC_AFFINITY_BLOCK// Size=0x820 (Id=257)
{
...
struct _KSOFTWARE_INTERRUPT_BATCH// Size=0x210 (Id=367)
{
...
struct _unnamed_108// Size=0x10 (Id=108)
{
...
union _SLIST_HEADER// Size=0x10 (Id=109)
{
    unsigned long long Alignment;// Offset=0x0 Size=0x8
    unsigned long long Region;// Offset=0x8 Size=0x8
    struct _unnamed_108 HeaderX64;// Offset=0x0 Size=0x10
};

struct _KDPC_LIST// Size=0x10 (Id=532)
{
    struct _SINGLE_LIST_ENTRY ListHead;// Offset=0x0 Size=0x8
    struct _SINGLE_LIST_ENTRY * LastEntry;// Offset=0x8 Size=0x8
};

struct _KDPC_DATA// Size=0x30 (Id=265)
{
...
struct _KE_PRCB_RCU_DATA// Size=0x20 (Id=522)
{
...
struct _KTIMER_TABLE// Size=0x4218 (Id=666)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=330)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KGATE// Size=0x18 (Id=381)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
};

struct _KDPC// Size=0x40 (Id=205)
{
    union // Size=0x4 (Id=0)
    {
...
struct _RTL_RB_TREE// Size=0x10 (Id=53)
{
...
struct _KMCE_RECOVERY_CONTEXT// Size=0x10 (Id=387)
{
...
struct _PROC_IDLE_POLICY// Size=0x6 (Id=729)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=602)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=551)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=561)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=694)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROC_PERF_CHECK_CONTEXT// Size=0x48 (Id=598)
{
...
struct _PROCESSOR_POWER_STATE// Size=0x268 (Id=521)
{
    ...
    unsigned long long IdleTimeUnaccountedTickTime;// Offset=0x18 Size=0x8
    unsigned long IdleTimeIdleTicks;// Offset=0x20 Size=0x4
    unsigned long IdleTimeKernelTicks;// Offset=0x24 Size=0x4
    unsigned long long IdleTimeSequenceLast;// Offset=0x28 Size=0x8
    unsigned long long IdleSequenceNumber;// Offset=0x30 Size=0x8
    unsigned long long IdleTimeEntry;// Offset=0x38 Size=0x8
    union // Size=0x8 (Id=0)
    {
        unsigned long long IdleTimeExpiration;// Offset=0x40 Size=0x8
        long long IdleWakeTime;// Offset=0x40 Size=0x8
    };
    unsigned long IdleWakeLatencyLimit;// Offset=0x48 Size=0x4
    unsigned char NonInterruptibleTransition;// Offset=0x4c Size=0x1
    unsigned char PepWokenTransition;// Offset=0x4d Size=0x1
    unsigned char HvTargetState;// Offset=0x4e Size=0x1
    unsigned long TargetIdleState;// Offset=0x50 Size=0x4
    struct _PROC_IDLE_POLICY IdlePolicy;// Offset=0x54 Size=0x6
    union _PPM_IDLE_SYNCHRONIZATION_STATE Synchronization;// Offset=0x5c Size=0x4
    struct _PROC_FEEDBACK PerfFeedback;// Offset=0x60 Size=0x90
    enum _PROC_HYPERVISOR_STATE Hypervisor;// Offset=0xf0 Size=0x4
    unsigned long LastSysTime;// Offset=0xf4 Size=0x4
    unsigned long long WmiDispatchPtr;// Offset=0xf8 Size=0x8
    long WmiInterfaceEnabled;// Offset=0x100 Size=0x4
    struct _PPM_FFH_THROTTLE_STATE_INFO FFHThrottleStateInfo;// Offset=0x108 Size=0x20
    struct _KDPC PerfActionDpc;// Offset=0x128 Size=0x40
    long PerfActionMask;// Offset=0x168 Size=0x4
    struct _PROC_IDLE_SNAP HvIdleCheck;// Offset=0x170 Size=0x10
    struct _PROC_PERF_CHECK_CONTEXT CheckContext;// Offset=0x180 Size=0x48
    struct _PPM_CONCURRENCY_ACCOUNTING * Concurrency;// Offset=0x1c8 Size=0x8
    struct _PPM_CONCURRENCY_ACCOUNTING * ClassConcurrency;// Offset=0x1d0 Size=0x8
    unsigned char ArchitecturalEfficiencyClass;// Offset=0x1d8 Size=0x1
    unsigned char PerformanceSchedulingClass;// Offset=0x1d9 Size=0x1
    unsigned char EfficiencySchedulingClass;// Offset=0x1da Size=0x1
    unsigned char Reserved;// Offset=0x1db Size=0x1
    unsigned char Parked;// Offset=0x1dc Size=0x1
    unsigned char SoftParked;// Offset=0x1dd Size=0x1
    unsigned char LongPriorQosPeriod;// Offset=0x1de Size=0x1
    union // Size=0x8 (Id=0)
    {
        unsigned long long SnapTimeLast;// Offset=0x1e0 Size=0x8
        unsigned long long EnergyConsumed;// Offset=0x1e0 Size=0x8
    };
    unsigned long long ActiveTime;// Offset=0x1e8 Size=0x8
    unsigned long long TotalTime;// Offset=0x1f0 Size=0x8
    struct _POP_FX_DEVICE * FxDevice;// Offset=0x1f8 Size=0x8
    unsigned long long LastQosTransitionTime;// Offset=0x200 Size=0x8
    unsigned long long QosTransitionHysteresis;// Offset=0x208 Size=0x8
    enum _KHETERO_CPU_QOS RequestedQosClass;// Offset=0x210 Size=0x4
    enum _KHETERO_CPU_QOS ResolvedQosClass;// Offset=0x214 Size=0x4
    unsigned short QosEquivalencyMask;// Offset=0x218 Size=0x2
    unsigned short HwFeedbackTableOffset;// Offset=0x21a Size=0x2
    unsigned char HwFeedbackParkHint;// Offset=0x21c Size=0x1
    unsigned char Reserved1;// Offset=0x21d Size=0x1
    unsigned short HwFeedbackTableIndex;// Offset=0x21e Size=0x2
    struct _KHETRO_HWFEEDBACK_TYPE * HwFeedbackClassList;// Offset=0x220 Size=0x8
    struct _PROCESSOR_CYCLES_WORKLOAD_CLASS * EeCyclesWorkloadClassList;// Offset=0x228 Size=0x8
    struct _PROCESSOR_CYCLES_WORKLOAD_CLASS * PerfCyclesWorkloadClassList;// Offset=0x230 Size=0x8
    unsigned char ContainmentGroupType;// Offset=0x238 Size=0x1
    unsigned short HwParkingTableOffset;// Offset=0x23a Size=0x2
    struct _KHETERO_PARKING_TABLE_INFO * HwParkingTable;// Offset=0x240 Size=0x8
    unsigned long ContainmentZoneMask;// Offset=0x248 Size=0x4
    unsigned short FrequencyBucketThresholds[4];// Offset=0x24c Size=0x8
    struct _PROCESSOR_IDLE_LOG_ENTRY * IdleLog;// Offset=0x258 Size=0x8
    unsigned long IdleLogCounter;// Offset=0x260 Size=0x4
};
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=414)
{
    unsigned char Level;// Offset=0x0 Size=0x1
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=586)
{
...
struct _unnamed_66// Size=0x38 (Id=66)
{
...
struct _SYMCRYPT_ENTROPY_ACCUMULATOR_STATE// Size=0x180 (Id=411)
{
...
struct _IOP_IRP_STACK_PROFILER// Size=0x54 (Id=538)
{
    unsigned long Profile[20];// Offset=0x0 Size=0x50
    unsigned long TotalIrps;// Offset=0x50 Size=0x4
};

struct _KSECURE_FAULT_INFORMATION// Size=0x18 (Id=342)
{
...
struct _KTIMER_EXPIRATION_TRACE// Size=0x10 (Id=550)
{
...
struct _KCLOCK_TIMER_DEADLINE_ENTRY// Size=0x10 (Id=368)
{
...
struct _KCLOCK_TICK_TRACE// Size=0x28 (Id=322)
{
...
struct _KCLOCK_INCREMENT_TRACE// Size=0x20 (Id=606)
{
...
struct _KCLOCK_TIMER_STATE// Size=0x518 (Id=279)
{
...
struct _MACHINE_FRAME// Size=0x28 (Id=728)
{
...
struct _MACHINE_CHECK_CONTEXT// Size=0x50 (Id=490)
{
...
union _KCCB_SHADOW_PROCESSOR_STATE// Size=0x1 (Id=529)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _KCORE_CONTROL_BLOCK_SHADOW// Size=0x40 (Id=451)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _KPRCB// Size=0xcf00 (Id=69)
{
    ...
    struct _KSPIN_LOCK_QUEUE LockQueue[17];// Offset=0x730 Size=0x110
    struct _PP_LOOKASIDE_LIST PPLookasideList[16];// Offset=0x840 Size=0x100
    unsigned long long PrcbPad13[1144];// Offset=0x940 Size=0x23c0
    ...
    unsigned long long DpcRuntimeHistoryCleanupTime;// Offset=0x3818 Size=0x8
    ...
    unsigned long WorkSubQueueIndex;// Offset=0x8328 Size=0x4
    unsigned long PrcbPad92[5];// Offset=0x832c Size=0x14
    ...
    struct _PROCESSOR_POWER_STATE PowerState;// Offset=0x8840 Size=0x268
    unsigned long long PrcbPad96[3];// Offset=0x8aa8 Size=0x18
    void * PrcbPad90;// Offset=0x8ac0 Size=0x8
    struct _LIST_ENTRY ScbList;// Offset=0x8ac8 Size=0x10
    struct _LIST_ENTRY ActiveScbList;// Offset=0x8ad8 Size=0x10
    struct _KDPC ForceIdleDpc;// Offset=0x8ae8 Size=0x40
    struct _KDPC DpcWatchdogDpc;// Offset=0x8b28 Size=0x40
    unsigned long long PrcbPad98[5];// Offset=0x8b68 Size=0x28
    void * VmInternal;// Offset=0x8b90 Size=0x8
    struct _CACHE_DESCRIPTOR Cache[5];// Offset=0x8b98 Size=0x3c
    unsigned long CacheCount;// Offset=0x8bd4 Size=0x4
    unsigned long CachedCommit;// Offset=0x8bd8 Size=0x4
    unsigned long CachedResidentAvailable;// Offset=0x8bdc Size=0x4
    void * WheaInfo;// Offset=0x8be0 Size=0x8
    void * EtwSupport;// Offset=0x8be8 Size=0x8
    void * ExSaPageArray;// Offset=0x8bf0 Size=0x8
    unsigned long KeAlignmentFixupCount;// Offset=0x8bf8 Size=0x4
    unsigned long PrcbPad95;// Offset=0x8bfc Size=0x4
    union _SLIST_HEADER HypercallPageList;// Offset=0x8c00 Size=0x10
    unsigned long long * StatisticsPage;// Offset=0x8c10 Size=0x8
    unsigned long long GenerationTarget;// Offset=0x8c18 Size=0x8
    union _LARGE_INTEGER VirtualApicAssistPage;// Offset=0x8c20 Size=0x8
    unsigned char * ApicBackingPage;// Offset=0x8c28 Size=0x8
    void * Ghcb;// Offset=0x8c30 Size=0x8
    unsigned long long PrcbPad85;// Offset=0x8c38 Size=0x8
    void * HypercallCachedPages;// Offset=0x8c40 Size=0x8
    void * VirtualApicAssist;// Offset=0x8c48 Size=0x8
    struct _KAFFINITY_EX PackageProcessorSet;// Offset=0x8c50 Size=0x108
    unsigned long long PrcbPad86[32];// Offset=0x8d58 Size=0x100
    union // Size=0x8e70 (Id=0)
    {
        unsigned long ProcessorId;// Offset=0x8e58 Size=0x4
        unsigned long CoreId;// Offset=0x8e5c Size=0x4
        unsigned long ModuleId;// Offset=0x8e60 Size=0x4
        unsigned long DieId;// Offset=0x8e64 Size=0x4
        unsigned long PackageId;// Offset=0x8e68 Size=0x4
        unsigned long ComplexId;// Offset=0x8e6c Size=0x4
        unsigned long TopologyId[6];// Offset=0x8e58 Size=0x18
    };
    unsigned long PrcbPad101[4];// Offset=0x8e70 Size=0x10
    unsigned long long SharedReadyQueueMask;// Offset=0x8e80 Size=0x8
    struct _KSHARED_READY_QUEUE * SharedReadyQueue;// Offset=0x8e88 Size=0x8
    unsigned long SharedQueueScanOwner;// Offset=0x8e90 Size=0x4
    unsigned long ScanSiblingIndex;// Offset=0x8e94 Size=0x4
    struct _KCORE_CONTROL_BLOCK * CoreControlBlock;// Offset=0x8e98 Size=0x8
    unsigned long long CoreProcessorSet;// Offset=0x8ea0 Size=0x8
    unsigned long long ScanSiblingMask;// Offset=0x8ea8 Size=0x8
    unsigned long long LLCMask;// Offset=0x8eb0 Size=0x8
    unsigned long long GroupModuleProcessorSet;// Offset=0x8eb8 Size=0x8
    struct _KTHREAD * SmtIsolationThread;// Offset=0x8ec0 Size=0x8
    unsigned long long PrcbPad97[2];// Offset=0x8ec8 Size=0x10
    struct _PROCESSOR_PROFILE_CONTROL_AREA * ProcessorProfileControlArea;// Offset=0x8ed8 Size=0x8
    void * ProfileEventIndexAddress;// Offset=0x8ee0 Size=0x8
    void ** DpcWatchdogProfile;// Offset=0x8ee8 Size=0x8
    void ** DpcWatchdogProfileCurrentEmptyCapture;// Offset=0x8ef0 Size=0x8
    void * SchedulerAssist;// Offset=0x8ef8 Size=0x8
    struct _SYNCH_COUNTERS SynchCounters;// Offset=0x8f00 Size=0xb8
    unsigned long long PrcbPad94;// Offset=0x8fb8 Size=0x8
    struct _FILESYSTEM_DISK_COUNTERS FsCounters;// Offset=0x8fc0 Size=0x10
    unsigned char VendorString[13];// Offset=0x8fd0 Size=0xd
    unsigned char PrcbPad100[3];// Offset=0x8fdd Size=0x3
    unsigned long long FeatureBits;// Offset=0x8fe0 Size=0x8
    union _LARGE_INTEGER UpdateSignature;// Offset=0x8fe8 Size=0x8
    unsigned long long PteBitCache;// Offset=0x8ff0 Size=0x8
    unsigned long PteBitOffset;// Offset=0x8ff8 Size=0x4
    unsigned long PrcbPad105;// Offset=0x8ffc Size=0x4
    struct _CONTEXT * Context;// Offset=0x9000 Size=0x8
    unsigned long ContextFlagsInit;// Offset=0x9008 Size=0x4
    unsigned long PrcbPad115;// Offset=0x900c Size=0x4
    struct _XSAVE_AREA * ExtendedState;// Offset=0x9010 Size=0x8
    void * IsrStack;// Offset=0x9018 Size=0x8
    struct _KENTROPY_TIMING_STATE EntropyTimingState;// Offset=0x9020 Size=0x158
    struct _unnamed_66 StibpPairingTrace;// Offset=0x9178 Size=0x38
    struct _SINGLE_LIST_ENTRY AbSelfIoBoostsList;// Offset=0x91b0 Size=0x8
    struct _SINGLE_LIST_ENTRY AbPropagateBoostsList;// Offset=0x91b8 Size=0x8
    struct _KDPC AbDpc;// Offset=0x91c0 Size=0x40
    struct _SYMCRYPT_ENTROPY_ACCUMULATOR_STATE SymCryptEntropyAccumulatorState;// Offset=0x9200 Size=0x180
    struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerCurrent;// Offset=0x9380 Size=0x54
    struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerPrevious;// Offset=0x93d4 Size=0x54
    struct _KSECURE_FAULT_INFORMATION SecureFault;// Offset=0x9428 Size=0x18
    struct _KSHARED_READY_QUEUE * LocalSharedReadyQueue;// Offset=0x9440 Size=0x8
    struct _KI_COOPERATIVE_IDLE_SEARCH_CONTEXT * LocalSearchContexts[2];// Offset=0x9448 Size=0x10
    struct _KI_COOPERATIVE_IDLE_SEARCH_CONTEXT * SearchContexts[2];// Offset=0x9458 Size=0x10
    struct _KI_COOPERATIVE_IDLE_SEARCH_GENERATION * SearchGenerations[2];// Offset=0x9468 Size=0x10
    unsigned long long PrcbPad125[1];// Offset=0x9478 Size=0x8
    unsigned long TimerExpirationTraceCount;// Offset=0x9480 Size=0x4
    unsigned long PrcbPad127;// Offset=0x9484 Size=0x4
    struct _KTIMER_EXPIRATION_TRACE TimerExpirationTrace[16];// Offset=0x9488 Size=0x100
    unsigned long long PrcbPad128[7];// Offset=0x9588 Size=0x38
    struct _KCLOCK_TIMER_STATE ClockTimerState;// Offset=0x95c0 Size=0x518
    struct _KTRAP_FRAME * IpiFrame;// Offset=0x9ad8 Size=0x8
    unsigned char PrcbPad129[32];// Offset=0x9ae0 Size=0x20
    struct _REQUEST_MAILBOX * Mailbox;// Offset=0x9b00 Size=0x8
    unsigned long long PrcbPad130[7];// Offset=0x9b08 Size=0x38
    struct _MACHINE_CHECK_CONTEXT McheckContext[2];// Offset=0x9b40 Size=0xa0
    unsigned long long TransitionShadowStack;// Offset=0x9be0 Size=0x8
    unsigned long long KernelShadowStackInitial;// Offset=0x9be8 Size=0x8
    unsigned long long * IstShadowStacksTable;// Offset=0x9bf0 Size=0x8
    void * HiberSwapShadowStacks[5];// Offset=0x9bf8 Size=0x28
    void * HiberSwapShadowStackBases[5];// Offset=0x9c20 Size=0x28
    void * MmFaultCompletionInfo;// Offset=0x9c48 Size=0x8
    unsigned long long PrcbPad132[6];// Offset=0x9c50 Size=0x30
    struct _KLOCK_QUEUE_HANDLE SelfmapLockHandle[4];// Offset=0x9c80 Size=0x60
    unsigned long long PrcbPad134b[4];// Offset=0x9ce0 Size=0x20
    struct _KAFFINITY_EX DieProcessorSet;// Offset=0x9d00 Size=0x108
    unsigned long long PrcbPad135[32];// Offset=0x9e08 Size=0x100
    unsigned long CoresPerPhysicalDie;// Offset=0x9f08 Size=0x4
    unsigned long LogicalProcessorsPerModule;// Offset=0x9f0c Size=0x4
    unsigned char PrcbPad137[64];// Offset=0x9f10 Size=0x40
    struct _KAFFINITY_EX ModuleProcessorSet;// Offset=0x9f50 Size=0x108
    unsigned long long PrcbPad136[32];// Offset=0xa058 Size=0x100
    struct _KCORE_CONTROL_BLOCK LocalCoreControlBlock;// Offset=0xa158 Size=0x30
    unsigned long long PrcbPad137a;// Offset=0xa188 Size=0x8
    struct _KDPC KstackFreeDpc;// Offset=0xa190 Size=0x40
    struct _KDPC SlistRollbackDpc;// Offset=0xa1d0 Size=0x40
    union _SLIST_HEADER KstackFreeList;// Offset=0xa210 Size=0x10
    unsigned long IsrStackNesting;// Offset=0xa220 Size=0x4
    unsigned char PrcbPad138[3164];// Offset=0xa224 Size=0xc5c
...
struct _KPCR// Size=0xd080 (Id=59)
{
    ...
    struct _KPRCB Prcb;// Offset=0x180 Size=0xcf00
};
