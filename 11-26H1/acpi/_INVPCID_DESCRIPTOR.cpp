...
union _INVPCID_DESCRIPTOR// Size=0x10 (Id=74)
{
    struct _unnamed_71 IndividualAddress;// Offset=0x0 Size=0x10
    struct _unnamed_72 SingleContext;// Offset=0x0 Size=0x10
    struct _unnamed_73 AllContextAndGlobals;// Offset=0x0 Size=0x10
    struct _unnamed_73 AllContext;// Offset=0x0 Size=0x10
};
