...
struct _ACPI_POWER_WAKE_INTERRUPT// Size=0x60 (Id=843)
{
    struct _LIST_ENTRY WakeInterruptList;// Offset=0x0 Size=0x10
    union _unnamed_841 u;// Offset=0x10 Size=0x10
    unsigned long Vector;// Offset=0x20 Size=0x4
    enum _KINTERRUPT_MODE InterruptMode;// Offset=0x24 Size=0x4
    unsigned long long ProcessorEnableMask;// Offset=0x28 Size=0x8
    struct _KINTERRUPT * InterruptObject;// Offset=0x30 Size=0x8
    enum INTERRUPT_CONNECTION_STATE ConnectionState;// Offset=0x38 Size=0x4
    struct _KEVENT ConnectionStateLockEvent;// Offset=0x40 Size=0x18
    unsigned long ReferenceCount;// Offset=0x58 Size=0x4
};
