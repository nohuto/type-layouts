...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=486)
{
...
struct _KAPC_STATE// Size=0x30 (Id=427)
{
...
struct _KTHREAD// Size=0x4c0 (Id=100)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _KSEMAPHORE// Size=0x20 (Id=418)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=481)
{
...
struct _PS_PROPERTY_SET// Size=0x18 (Id=315)
{
...
union _RTL_THREAD_RNG_STATE// Size=0x10 (Id=512)
{
...
struct _ETHREAD// Size=0x798 (Id=127)
{
