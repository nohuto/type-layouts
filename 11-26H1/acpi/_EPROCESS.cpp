...
struct _KAB_UM_PROCESS_CONTEXT// Size=0x10 (Id=295)
{
...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=328)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=95)
{
...
struct _RTL_AVL_TREE// Size=0x8 (Id=55)
{
    struct _RTL_BALANCED_NODE * Root;// Offset=0x0 Size=0x8
};

struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=515)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=454)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x1 (Id=0)
...
struct _MMSUPPORT_INSTANCE// Size=0xc0 (Id=455)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=376)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=132)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WNF_STATE_NAME// Size=0x8 (Id=632)
{
    unsigned long Data[2];// Offset=0x0 Size=0x8
};

struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=357)
{
    unsigned long HighEdgeFilter;// Offset=0x0 Size=0x4
    unsigned long LowEdgeFilter;// Offset=0x4 Size=0x4
};

struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=345)
{
...
struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=364)
{
...
struct _EPROCESS_POWER_THROTTLING_STATE// Size=0x8 (Id=474)
{
    unsigned long ControlMask;// Offset=0x0 Size=0x4
    unsigned long StateMask;// Offset=0x4 Size=0x4
};

struct _EPROCESS// Size=0x840 (Id=137)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_133 MitigationFlagsValues;// Offset=0x750 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x754 Size=0x4
        struct _unnamed_134 MitigationFlags2Values;// Offset=0x754 Size=0x4
    };
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_135 MitigationFlags3Values;// Offset=0x7d8 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_136 SyscallUsageValues;// Offset=0x7e0 Size=0x4
    };
