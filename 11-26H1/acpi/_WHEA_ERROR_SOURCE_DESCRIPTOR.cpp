...
union _XPF_MCE_FLAGS// Size=0x4 (Id=514)
{
...
union _XPF_MC_BANK_FLAGS// Size=0x1 (Id=669)
{
...
struct _WHEA_XPF_MC_BANK_DESCRIPTOR// Size=0x1c (Id=596)
{
...
struct _WHEA_XPF_MCE_DESCRIPTOR// Size=0x398 (Id=352)
{
...
union _WHEA_NOTIFICATION_FLAGS// Size=0x2 (Id=696)
{
...
struct _WHEA_IPF_MCA_DESCRIPTOR// Size=0x4 (Id=370)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
...
struct _WHEA_IPF_CMC_DESCRIPTOR// Size=0x4 (Id=259)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
struct _WHEA_IPF_CPE_DESCRIPTOR// Size=0x4 (Id=511)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
union _unnamed_347// Size=0x4 (Id=347)
{
    struct _unnamed_346 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _WHEA_PCI_SLOT_NUMBER// Size=0x4 (Id=348)
{
    union _unnamed_347 u;// Offset=0x0 Size=0x4
};

union _AER_ROOTPORT_DESCRIPTOR_FLAGS// Size=0x2 (Id=397)
{
    struct // Size=0x2 (Id=0)
    {
...
struct _WHEA_AER_ROOTPORT_DESCRIPTOR// Size=0x24 (Id=380)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
union _AER_ENDPOINT_DESCRIPTOR_FLAGS// Size=0x2 (Id=312)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short UncorrectableErrorMaskRW:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_AER_ENDPOINT_DESCRIPTOR// Size=0x20 (Id=261)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
union _AER_BRIDGE_DESCRIPTOR_FLAGS// Size=0x2 (Id=477)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short UncorrectableErrorMaskRW:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_GENERIC_ERROR_DESCRIPTOR// Size=0x34 (Id=335)
{
    unsigned short Type;// Offset=0x0 Size=0x2
...
struct _WHEA_GENERIC_ERROR_DESCRIPTOR_V2// Size=0x50 (Id=307)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Reserved;// Offset=0x2 Size=0x1
    unsigned char Enabled;// Offset=0x3 Size=0x1
...
struct _WHEA_ERROR_SOURCE_CONFIGURATION_DD// Size=0x18 (Id=563)
{
...
struct _WHEA_DEVICE_DRIVER_DESCRIPTOR// Size=0x74 (Id=498)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
