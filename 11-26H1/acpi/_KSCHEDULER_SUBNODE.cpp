...
struct _flags// Size=0x1 (Id=764)
{
    struct // Size=0x1 (Id=0)
    {
        unsigned char SmtSetsPresent:1;// Offset=0x0 Size=0x1 BitOffset=0x0 BitSize=0x1
        unsigned char MaintainCoreShareCounts:1;// Offset=0x0 Size=0x1 BitOffset=0x1 BitSize=0x1
        unsigned char MaintainModuleShareCounts:1;// Offset=0x0 Size=0x1 BitOffset=0x2 BitSize=0x1
        unsigned char MaintainScuShareCounts:1;// Offset=0x0 Size=0x1 BitOffset=0x3 BitSize=0x1
        unsigned char Fill:4;// Offset=0x0 Size=0x1 BitOffset=0x4 BitSize=0x4
    };
};

union _KQOS_GROUPING_SETS// Size=0x10 (Id=662)
{
    unsigned long long SingleCoreSet;// Offset=0x0 Size=0x8
    unsigned long long SmtSet;// Offset=0x8 Size=0x8
};

union _KRANK_LIST// Size=0x40 (Id=671)
{
    unsigned char Ranks[64];// Offset=0x0 Size=0x40
    unsigned long long AsUlong64s[8];// Offset=0x0 Size=0x40
};

struct _KSCHEDULER_SUBNODE// Size=0x300 (Id=478)
{
    ...
    unsigned short NodeRelativeNumber;// Offset=0x8e Size=0x2
    unsigned long long Spare2;// Offset=0x90 Size=0x8
    ...
    unsigned char MaintainScuShareCountsForType;// Offset=0xba Size=0x1
    unsigned char Spare3[5];// Offset=0xbb Size=0x5
