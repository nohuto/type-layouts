struct _unnamed_577// Size=0x4 (Id=577)
{
...
struct BUTTON_EXTENSION// Size=0x30 (Id=578)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_577 UEvents;// Offset=0x24 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long Capabilities;// Offset=0x28 Size=0x4
        struct _unnamed_577 UCapabilities;// Offset=0x28 Size=0x4
    };
};
