union _unnamed_81// Size=0x8 (Id=81)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=663)
{
    union // Size=0x4 (Id=0)
    {
...
union _unnamed_84// Size=0x10 (Id=84)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_83 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=584)
{
...
struct _unnamed_85// Size=0x58 (Id=85)
{
...
union _unnamed_86// Size=0x58 (Id=86)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_85 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=87)
{
    ...
    union _unnamed_81 AssociatedIrp;// Offset=0x18 Size=0x8
