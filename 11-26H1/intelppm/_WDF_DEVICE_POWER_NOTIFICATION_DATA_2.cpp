...
union _unnamed_490// Size=0x8 (Id=490)
{
    struct _unnamed_488 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_489 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_488 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=491)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_490 Data;// Offset=0x4 Size=0x8
};
