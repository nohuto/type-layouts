...
struct _CPC_RES_PRI_REG_DESC// Size=0x68 (Id=672)
{
...
struct _CPC_RESOURCE_PRIORITIES// Size=0x70 (Id=786)
{
    unsigned long Count;// Offset=0x0 Size=0x4
    struct _CPC_RES_PRI_REG_DESC ResourcePriority[1];// Offset=0x8 Size=0x68
};
