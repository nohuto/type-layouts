struct PPM_DRIVER_INTERFACE// Size=0x180 (Id=679)
{
    ...
    unsigned long  ( * PTStateFlagHandler)(struct _PERF_CONTROL_STATE_SELECTION * );// Offset=0x70 Size=0x8
    ...
    long  ( * GetNativeCppcPerfControlHandler)(struct _FDO_DATA * ,struct _CPC_RUNTIME_STATE * ,void  ( ** )(unsigned long long ,struct _PERF_CONTROL_STATE_SELECTION * ,unsigned char ,unsigned char ),void  ( ** )(unsigned long long ,struct _PERF_CONTROL_STATE_SELECTION * ,unsigned char ,unsigned char ),void  ( ** )(unsigned long long ,struct _PERF_CONTROL_STATE_SELECTION * ,unsigned char ,unsigned char ),void  ( ** )(unsigned long long ,unsigned long long ,struct _PERF_CONTROL_STATE_SELECTION * ),unsigned char * ,unsigned char * ,unsigned char * ,unsigned long * );// Offset=0xc8 Size=0x8
    ...
    unsigned char PctUseCoreCounters;// Offset=0x110 Size=0x1
    unsigned long long  ( * PctDiscoverPlatformCtrs)(struct _FDO_DATA * );// Offset=0x118 Size=0x8
    unsigned short  ( * PctSnapPlatformCtrs)(struct _FDO_DATA * ,unsigned long long );// Offset=0x120 Size=0x8
    enum ULONG  ( * PctEnumPlatfromCtr)(struct _FDO_DATA * ,enum ULONG ,unsigned long long );// Offset=0x128 Size=0x8
    long  ( * PctGetPlatformCtr)(struct _FDO_DATA * ,enum ULONG ,unsigned long long * ,unsigned long long * );// Offset=0x130 Size=0x8
    long  ( * PctGetPlatformCtrInfo)(enum ULONG ,wchar_t ** ,wchar_t ** ,unsigned long * );// Offset=0x138 Size=0x8
    unsigned long PStateFFHControlRegister;// Offset=0x140 Size=0x4
    unsigned long long PStateFFHControlMask;// Offset=0x148 Size=0x8
    unsigned long TStateFFHControlRegister;// Offset=0x150 Size=0x4
    unsigned long long TStateFFHControlMask;// Offset=0x158 Size=0x8
    long  ( * GetHwDebugRegisters)(struct _PROC_HW_DEBUG_REGISTER_DEFINITION_LIST * );// Offset=0x160 Size=0x8
    long  ( * InitMeasRegisters)(struct _FDO_DATA * );// Offset=0x168 Size=0x8
    long  ( * QueryMeasValues)(unsigned long ,unsigned long * ,void * ,unsigned long );// Offset=0x170 Size=0x8
    unsigned short  ( * RegisterResetOnD0Entry)(struct _FDO_DATA * );// Offset=0x178 Size=0x8
};
