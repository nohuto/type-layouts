...
struct _unnamed_788// Size=0x8 (Id=788)
{
...
struct _unnamed_789// Size=0x8 (Id=789)
{
...
struct _unnamed_790// Size=0x8 (Id=790)
{
...
union _HV_PPM_IDLE_STATE_CONFIG// Size=0x8 (Id=792)
{
    ...
    struct _unnamed_788 Hlt;// Offset=0x0 Size=0x8
    struct _unnamed_789 Io;// Offset=0x0 Size=0x8
    struct _unnamed_790 Mwait;// Offset=0x0 Size=0x8
    struct _unnamed_791 Psci;// Offset=0x0 Size=0x8
};

union _HV_INPUT_REQUEST_PROCESSOR_HALT_FLAGS// Size=0x4 (Id=787)
{
...
struct _HV_PPM_IDLE_STATE_REQUEST// Size=0x10 (Id=785)
{
...
struct _RUNTIME_IDLE_STATE// Size=0x58 (Id=619)
{
    ...
    long  ( * Handler)(struct _RUNTIME_IDLE_CONTEXT * ,unsigned long );// Offset=0x18 Size=0x8
    ...
    unsigned char DriverInitiatedWakeSupported;// Offset=0x52 Size=0x1
    unsigned char CStateType;// Offset=0x53 Size=0x1
};

struct _RUNTIME_IDLE_STATES// Size=0x90 (Id=575)
{
    ...
    char * MwaitMonitorAddress;// Offset=0x28 Size=0x8
    unsigned long Count;// Offset=0x30 Size=0x4
    struct _RUNTIME_IDLE_STATE State[1];// Offset=0x38 Size=0x58
};
