...
struct _unnamed_91// Size=0x18 (Id=91)
{
...
struct _unnamed_94// Size=0x10 (Id=94)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_102// Size=0x18 (Id=102)
{
...
struct _unnamed_106// Size=0x18 (Id=106)
{
...
struct _unnamed_107// Size=0x10 (Id=107)
{
    struct _VPB * Vpb;// Offset=0x0 Size=0x8
    struct _DEVICE_OBJECT * DeviceObject;// Offset=0x8 Size=0x8
};

struct _unnamed_109// Size=0x8 (Id=109)
{
...
struct _unnamed_113// Size=0x8 (Id=113)
{
...
struct _unnamed_116// Size=0x1 (Id=116)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _unnamed_118// Size=0x4 (Id=118)
{
...
struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=577)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=543)
{
...
union _unnamed_132// Size=0x20 (Id=132)
{
    struct _unnamed_88 Create;// Offset=0x0 Size=0x20
    struct _unnamed_89 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_90 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_91 Read;// Offset=0x0 Size=0x18
    struct _unnamed_91 Write;// Offset=0x0 Size=0x18
    struct _unnamed_93 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_94 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_96 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_97 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_98 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_100 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_101 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_102 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_103 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_104 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_105 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_106 MountVolume;// Offset=0x0 Size=0x18
    struct _unnamed_107 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_109 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_111 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_112 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_113 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_114 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_115 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_116 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_118 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_120 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_122 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_124 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_125 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_128 Power;// Offset=0x0 Size=0x20
    struct _unnamed_129 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_130 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_131 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=133)
{
    ...
    union _unnamed_132 Parameters;// Offset=0x8 Size=0x20
