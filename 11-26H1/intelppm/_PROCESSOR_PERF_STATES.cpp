...
struct _PROCESSOR_PERF_STATES// Size=0x250 (Id=597)
{
    ...
    unsigned long  ( * PerfTargetHandler)(unsigned long long ,unsigned long ,unsigned long ,unsigned long ,unsigned long ,unsigned long long * );// Offset=0x1c0 Size=0x8
    void  ( * PerfSelectionHandler)(unsigned long long ,unsigned long long ,struct _PERF_CONTROL_STATE_SELECTION * );// Offset=0x1c8 Size=0x8
    long  ( * PerfPriorityHandler)(unsigned long long ,unsigned long ,unsigned long long * );// Offset=0x1d0 Size=0x8
    void  ( * PerfControlHandler)(unsigned long long ,struct _PERF_CONTROL_STATE_SELECTION * ,unsigned char ,unsigned char );// Offset=0x1d8 Size=0x8
    void  ( * PerfControlHandlerHidden)(unsigned long long ,struct _PERF_CONTROL_STATE_SELECTION * ,unsigned char ,unsigned char );// Offset=0x1e0 Size=0x8
    void  ( * DomainPerfControlHandler)(unsigned long long ,struct _PERF_CONTROL_STATE_SELECTION * ,unsigned char ,unsigned char );// Offset=0x1e8 Size=0x8
    void  ( * PerfControlReadFeedback)(void  ( * )());// Offset=0x1f0 Size=0x8
    void  ( * PerfControlAcquirePerformance)(void  ( * )());// Offset=0x1f8 Size=0x8
    void  ( * PerfControlCommitPerformance)(void  ( * )());// Offset=0x200 Size=0x8
    void  ( * PerfUpdateHwDebugData)(unsigned long long ,unsigned long long ,unsigned char );// Offset=0x208 Size=0x8
    unsigned long  ( * PerfQueryProcMeasurementCapabilities)();// Offset=0x210 Size=0x8
    long  ( * PerfQueryProcMeasurementValues)(unsigned long ,unsigned long * ,void * ,unsigned long );// Offset=0x218 Size=0x8
    void  ( * ParkPreference)(unsigned char ,unsigned long long ,unsigned long ,struct _KAFFINITY_EX * ,struct _KAFFINITY_EX * ,struct _KAFFINITY_EX * ,struct _KAFFINITY_EX * ,struct _KAFFINITY_EX * );// Offset=0x220 Size=0x8
    void  ( * ParkMask)(unsigned long long ,struct _KAFFINITY_EX * );// Offset=0x228 Size=0x8
    void  ( * PerfCheckComplete)(unsigned long long ,unsigned long long );// Offset=0x230 Size=0x8
    struct _PROCESSOR_FEEDBACK_COUNTER * FeedbackCounters;// Offset=0x238 Size=0x8
    struct _PROCESSOR_PERF_INFO * Processors;// Offset=0x240 Size=0x8
    unsigned long long * CounterContexts;// Offset=0x248 Size=0x8
};
