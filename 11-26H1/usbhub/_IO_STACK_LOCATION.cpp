struct _unnamed_34// Size=0x20 (Id=34)
{
...
struct _unnamed_37// Size=0x18 (Id=37)
{
...
struct _unnamed_39// Size=0x20 (Id=39)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_42// Size=0x18 (Id=42)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _unnamed_44// Size=0x20 (Id=44)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
...
struct _unnamed_45// Size=0x20 (Id=45)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_46// Size=0x4 (Id=46)
{
    unsigned long Length;// Offset=0x0 Size=0x4
};
...
struct _unnamed_48// Size=0x10 (Id=48)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    enum _FSINFOCLASS FsInformationClass;// Offset=0x8 Size=0x4
};

struct _unnamed_49// Size=0x20 (Id=49)
{
...
struct _unnamed_50// Size=0x18 (Id=50)
{
...
struct _unnamed_51// Size=0x20 (Id=51)
{
    unsigned long OutputBufferLength;// Offset=0x0 Size=0x4
    unsigned long InputBufferLength;// Offset=0x8 Size=0x4
...
struct _unnamed_53// Size=0x10 (Id=53)
{
    unsigned long SecurityInformation;// Offset=0x0 Size=0x4
    void * SecurityDescriptor;// Offset=0x8 Size=0x8
};

struct _unnamed_54// Size=0x18 (Id=54)
{
...
struct _unnamed_55// Size=0x10 (Id=55)
{
    struct _VPB * Vpb;// Offset=0x0 Size=0x8
    struct _DEVICE_OBJECT * DeviceObject;// Offset=0x8 Size=0x8
};

struct _unnamed_57// Size=0x8 (Id=57)
{
...
struct _unnamed_60// Size=0x4 (Id=60)
{
...
struct _unnamed_63// Size=0x8 (Id=63)
{
    struct _DEVICE_CAPABILITIES * Capabilities;// Offset=0x0 Size=0x8
};

struct _unnamed_64// Size=0x8 (Id=64)
{
...
struct _unnamed_66// Size=0x1 (Id=66)
{
...
struct _unnamed_74// Size=0x4 (Id=74)
{
...
struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=376)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=196)
{
...
struct _unnamed_79// Size=0x10 (Id=79)
{
...
union _unnamed_82// Size=0x20 (Id=82)
{
    struct _unnamed_34 Create;// Offset=0x0 Size=0x20
    struct _unnamed_35 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_36 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_37 Read;// Offset=0x0 Size=0x18
    struct _unnamed_37 Write;// Offset=0x0 Size=0x18
    struct _unnamed_39 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_40 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_42 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_43 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_44 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_45 QueryEa;// Offset=0x0 Size=0x20
    struct _unnamed_46 SetEa;// Offset=0x0 Size=0x4
    struct _unnamed_48 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_48 SetVolume;// Offset=0x0 Size=0x10
    struct _unnamed_49 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_50 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_51 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_52 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_53 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_54 MountVolume;// Offset=0x0 Size=0x18
    struct _unnamed_55 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_57 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_58 QueryQuota;// Offset=0x0 Size=0x20
    struct _unnamed_46 SetQuota;// Offset=0x0 Size=0x4
    struct _unnamed_60 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_62 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_63 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_64 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_65 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_66 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_68 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_70 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_72 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_74 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_75 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_78 Power;// Offset=0x0 Size=0x20
    struct _unnamed_79 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_80 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_81 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=83)
{
    ...
    union _unnamed_82 Parameters;// Offset=0x8 Size=0x20
