...
struct _unnamed_483// Size=0x18 (Id=483)
{
...
struct _unnamed_486// Size=0x18 (Id=486)
{
...
struct _unnamed_489// Size=0xc (Id=489)
{
    unsigned long Data[3];// Offset=0x0 Size=0xc
};

struct _unnamed_490// Size=0x10 (Id=490)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_491// Size=0xc (Id=491)
{
...
struct _unnamed_492// Size=0x18 (Id=492)
{
...
struct _unnamed_493// Size=0x18 (Id=493)
{
...
struct _unnamed_494// Size=0x18 (Id=494)
{
...
struct _unnamed_495// Size=0xc (Id=495)
{
...
union _unnamed_496// Size=0x18 (Id=496)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_483 Port;// Offset=0x0 Size=0x18
        struct _unnamed_483 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_486 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_487 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_488 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_483 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_489 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_490 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_491 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_492 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_493 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_494 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_495 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=497)
{
    ...
    union _unnamed_496 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=470)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=386)
{
