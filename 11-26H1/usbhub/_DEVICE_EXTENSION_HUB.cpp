...
struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=340)
{
...
struct _IO_REMOVE_LOCK// Size=0x20 (Id=283)
{
...
union _USBHUB_FDO_FLAGS// Size=0x4 (Id=347)
{
...
union _USBHUB_FDO_FLAGS2// Size=0x4 (Id=419)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USBHUB_ERRATA_FLAGS// Size=0x4 (Id=290)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=296)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    struct // Size=0x4 (Id=0)
...
struct _HUB_GLOBAL_UXD_SETTINGS// Size=0x10 (Id=361)
{
...
struct _USB_TOPOLOGY_ADDRESS// Size=0x20 (Id=424)
{
