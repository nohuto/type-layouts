union _unnamed_468// Size=0x4 (Id=468)
{
...
struct _USB_DEVICE_CAPABILITY_USB20_EXTENSION_DESCRIPTOR// Size=0x7 (Id=469)
{
    ...
    union _unnamed_468 bmAttributes;// Offset=0x3 Size=0x4
};
