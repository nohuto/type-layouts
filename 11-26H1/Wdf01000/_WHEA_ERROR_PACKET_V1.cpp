union _WHEA_ERROR_PACKET_FLAGS// Size=0x4 (Id=2102)
{
...
union _WHEA_PROCESSOR_GENERIC_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=4090)
{
...
struct _WHEA_PROCESSOR_GENERIC_ERROR_SECTION// Size=0xc0 (Id=1231)
{
...
union _WHEA_MEMORY_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=4008)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WHEA_MEMORY_ERROR_SECTION// Size=0x50 (Id=992)
{
...
union _WHEA_NMI_ERROR_SECTION_FLAGS// Size=0x4 (Id=2364)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _WHEA_NMI_ERROR_SECTION// Size=0xc (Id=2535)
{
    unsigned char Data[8];// Offset=0x0 Size=0x8
    union _WHEA_NMI_ERROR_SECTION_FLAGS Flags;// Offset=0x8 Size=0x4
};

union _WHEA_PCIEXPRESS_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=2458)
{
    struct // Size=0x8 (Id=0)
    {
...
union _WHEA_PCIEXPRESS_VERSION// Size=0x4 (Id=1567)
{
...
union _WHEA_PCIEXPRESS_COMMAND_STATUS// Size=0x4 (Id=4017)
{
...
struct _WHEA_PCIEXPRESS_DEVICE_ID// Size=0x10 (Id=1624)
{
...
union _WHEA_PCIEXPRESS_BRIDGE_CONTROL_STATUS// Size=0x4 (Id=1124)
{
...
struct _WHEA_PCIEXPRESS_ERROR_SECTION// Size=0xd0 (Id=3752)
{
...
union _WHEA_PCIXDEVICE_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=2546)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long ErrorStatus:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_PCIXDEVICE_ID// Size=0x10 (Id=1669)
{
    unsigned short VendorId;// Offset=0x0 Size=0x2
    unsigned short DeviceId;// Offset=0x2 Size=0x2
    struct // Size=0x8 (Id=0)
...
struct _WHEA_PCIXDEVICE_ERROR_SECTION// Size=0x38 (Id=3488)
{
...
struct _WHEA_PMEM_PAGE_RANGE// Size=0x18 (Id=2896)
{
...
struct _WHEA_PMEM_ERROR_SECTION// Size=0x70 (Id=3706)
{
...
struct _WHEA_ERROR_PACKET_V1// Size=0x119 (Id=3360)
{
    union // Size=0x40 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0xd0 (Id=27579)
        {
