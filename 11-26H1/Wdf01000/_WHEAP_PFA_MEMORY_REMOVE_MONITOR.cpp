...
struct _WHEAP_PFA_MEMORY_REMOVE_MONITOR// Size=0x30 (Id=3685)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    enum _WHEA_PFA_REMOVE_TRIGGER RemoveTrigger;// Offset=0x20 Size=0x4
    unsigned long TimeInList;// Offset=0x24 Size=0x4
    unsigned long ErrorCount;// Offset=0x28 Size=0x4
    unsigned long Page;// Offset=0x2c Size=0x4
};
