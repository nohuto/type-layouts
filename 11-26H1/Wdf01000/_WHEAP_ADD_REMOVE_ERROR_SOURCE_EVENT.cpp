...
enum _WHEA_EVENT_LOG_ENTRY_ID
{
    ...
    WheaEventLogEntryIdCrashDumpGuid=-2147483539,
    WheaEventLogEntryIdDumpGUIDStatus=-2147483538,
    WheaEventLogEntryIdProcessEINJ2=-2147483537,
    WheaEventLogEntryIdPshedWriteVendorDefined=-2147483536,
    WheaEventLogEntryIdPshedReadVendorDefined=-2147483535,
    WheaEventLogEntryIdImpiOnline=-2147483534,
    WheaEventLogEntryIdImpiSubscribe=-2147483533,
    WheaEventLogEntryIdServerType=-2147483532,
    WheaEventLogEntryIdErrorRecordFull=-2147483531,
    WheaEventLogEntryIdPluginIncorrectBufferRead=-2147483530,
    WheaEventLogEntryIdPshedPiTraceLog=-2147221488
};

union _WHEA_EVENT_LOG_ENTRY_FLAGS// Size=0x4 (Id=3826)
{
...
struct _WHEA_EVENT_LOG_ENTRY_HEADER// Size=0x20 (Id=2149)
{
...
struct _WHEA_EVENT_LOG_ENTRY// Size=0x20 (Id=2561)
{
...
union _XPF_MCE_FLAGS// Size=0x4 (Id=1824)
{
    struct // Size=0x4 (Id=0)
    {
...
union _XPF_MC_BANK_FLAGS// Size=0x1 (Id=941)
{
...
struct _WHEA_XPF_MC_BANK_DESCRIPTOR// Size=0x1c (Id=1007)
{
...
struct _WHEA_XPF_MCE_DESCRIPTOR// Size=0x398 (Id=2613)
{
...
union _WHEA_NOTIFICATION_FLAGS// Size=0x2 (Id=964)
{
...
struct _WHEA_NOTIFICATION_DESCRIPTOR// Size=0x1c (Id=2324)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x18 (Id=28244)
        {
            struct <unnamed-type-Polled>// Size=0x4 (Id=28245)
            {
                unsigned long PollInterval;// Offset=0x0 Size=0x4
            };
            struct _WHEA_NOTIFICATION_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-Polled> Polled;// Offset=0x0 Size=0x4
            struct <unnamed-type-Interrupt>// Size=0x18 (Id=28248)
            {
                unsigned long PollInterval;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-LocalInterrupt>// Size=0x18 (Id=28256)
            {
                unsigned long PollInterval;// Offset=0x0 Size=0x4
                unsigned long Vector;// Offset=0x4 Size=0x4
                unsigned long SwitchToPollingThreshold;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-Sci>// Size=0x18 (Id=28264)
            {
                unsigned long PollInterval;// Offset=0x0 Size=0x4
                unsigned long Vector;// Offset=0x4 Size=0x4
                unsigned long SwitchToPollingThreshold;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-Nmi>// Size=0x18 (Id=28272)
            {
                unsigned long PollInterval;// Offset=0x0 Size=0x4
                unsigned long Vector;// Offset=0x4 Size=0x4
                unsigned long SwitchToPollingThreshold;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-Sea>// Size=0x18 (Id=28280)
            {
                unsigned long PollInterval;// Offset=0x0 Size=0x4
                unsigned long Vector;// Offset=0x4 Size=0x4
                unsigned long SwitchToPollingThreshold;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-Sei>// Size=0x18 (Id=28288)
            {
                unsigned long PollInterval;// Offset=0x0 Size=0x4
                unsigned long Vector;// Offset=0x4 Size=0x4
                unsigned long SwitchToPollingThreshold;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-Gsiv>// Size=0x18 (Id=28296)
            {
                unsigned long PollInterval;// Offset=0x0 Size=0x4
                unsigned long Vector;// Offset=0x4 Size=0x4
                unsigned long SwitchToPollingThreshold;// Offset=0x8 Size=0x4
...
struct _WHEA_XPF_CMC_DESCRIPTOR// Size=0x3a4 (Id=2051)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char NumberOfBanks;// Offset=0x3 Size=0x1
...
struct _WHEA_XPF_NMI_DESCRIPTOR// Size=0x3 (Id=1732)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
};

struct _WHEA_IPF_MCA_DESCRIPTOR// Size=0x4 (Id=2168)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
...
struct _WHEA_IPF_CMC_DESCRIPTOR// Size=0x4 (Id=2243)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
struct _WHEA_IPF_CPE_DESCRIPTOR// Size=0x4 (Id=2372)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
struct _WHEA_PCI_SLOT_NUMBER// Size=0x4 (Id=2604)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=28353)
        {
            struct <unnamed-type-bits>// Size=0x4 (Id=28354)
            {
...
union _AER_ROOTPORT_DESCRIPTOR_FLAGS// Size=0x2 (Id=1468)
{
    struct // Size=0x2 (Id=0)
    {
...
struct _WHEA_AER_ROOTPORT_DESCRIPTOR// Size=0x24 (Id=1864)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
union _AER_ENDPOINT_DESCRIPTOR_FLAGS// Size=0x2 (Id=2045)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short UncorrectableErrorMaskRW:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_AER_ENDPOINT_DESCRIPTOR// Size=0x20 (Id=1689)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
union _AER_BRIDGE_DESCRIPTOR_FLAGS// Size=0x2 (Id=2238)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short UncorrectableErrorMaskRW:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_AER_BRIDGE_DESCRIPTOR// Size=0x2c (Id=3107)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
struct _WHEA_GENERIC_ERROR_DESCRIPTOR// Size=0x34 (Id=2488)
{
    unsigned short Type;// Offset=0x0 Size=0x2
...
struct _WHEA_GENERIC_ERROR_DESCRIPTOR_V2// Size=0x50 (Id=2474)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Reserved;// Offset=0x2 Size=0x1
    unsigned char Enabled;// Offset=0x3 Size=0x1
...
struct _WHEA_ERROR_SOURCE_CONFIGURATION_DD// Size=0x18 (Id=976)
{
...
struct _WHEA_DEVICE_DRIVER_DESCRIPTOR// Size=0x74 (Id=2387)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
struct _WHEA_ERROR_SOURCE_DESCRIPTOR// Size=0x3cc (Id=1882)
{
    union // Size=0x28 (Id=0)
    {
        ...
        union <unnamed-type-Info>// Size=0x3a4 (Id=27728)
        {
...
struct _WHEAP_ADD_REMOVE_ERROR_SOURCE_EVENT// Size=0x3f1 (Id=2925)
{
