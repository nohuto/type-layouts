struct _PCI_SECURITY_INTERFACE2// Size=0x38 (Id=3995)
{
    ...
    long  ( * SetAccessControlServices3)(void * ,unsigned long ,unsigned long ,unsigned long long );// Offset=0x30 Size=0x8
};
