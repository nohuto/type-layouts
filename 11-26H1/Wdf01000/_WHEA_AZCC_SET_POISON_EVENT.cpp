...
struct _WHEA_AZCC_SET_POISON_EVENT// Size=0x27 (Id=3476)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned int Bus;// Offset=0x20 Size=0x4
    unsigned char ReadSuccess;// Offset=0x24 Size=0x1
    unsigned char WriteSuccess;// Offset=0x25 Size=0x1
    unsigned char IsEnable;// Offset=0x26 Size=0x1
};
