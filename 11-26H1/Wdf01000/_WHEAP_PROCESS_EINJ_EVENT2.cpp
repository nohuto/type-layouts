...
struct _WHEAP_PROCESS_EINJ_EVENT2// Size=0x171 (Id=4031)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    char Error[32];// Offset=0x20 Size=0x20
    unsigned char InjectionActionTableValid;// Offset=0x40 Size=0x1
    unsigned long BeginInjectionInstructionCount;// Offset=0x41 Size=0x4
    unsigned long GetTriggerErrorActionTableInstructionCount;// Offset=0x45 Size=0x4
    unsigned long SetErrorTypeInstructionCount;// Offset=0x49 Size=0x4
    unsigned long GetErrorTypeInstructionCount;// Offset=0x4d Size=0x4
    unsigned long EndOperationInstructionCount;// Offset=0x51 Size=0x4
    unsigned long ExecuteOperationInstructionCount;// Offset=0x55 Size=0x4
    unsigned long CheckBusyStatusInstructionCount;// Offset=0x59 Size=0x4
    unsigned long GetCommandStatusInstructionCount;// Offset=0x5d Size=0x4
    unsigned long SetErrorTypeWithAddressInstructionCount;// Offset=0x61 Size=0x4
    unsigned long GetExecuteOperationTimingsInstructionCount;// Offset=0x65 Size=0x4
    unsigned long long SetErrorTypeWithAddressPa;// Offset=0x69 Size=0x8
    unsigned char SetErrorTypeWithAddress[256];// Offset=0x71 Size=0x100
};
