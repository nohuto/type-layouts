union _MEMORY_DEFECT_FLAGS// Size=0x2 (Id=3984)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short RepairedDefectEntry:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _MEMORY_DEFECT// Size=0x24 (Id=3255)
{
    unsigned short Version;// Offset=0x0 Size=0x2
    union _MEMORY_DEFECT_FLAGS Flags;// Offset=0x2 Size=0x2
