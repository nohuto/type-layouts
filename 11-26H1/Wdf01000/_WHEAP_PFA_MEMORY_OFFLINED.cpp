...
struct _WHEAP_PFA_MEMORY_OFFLINED// Size=0x2a (Id=3209)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    enum _WHEAP_PFA_OFFLINE_DECISION_TYPE DecisionType;// Offset=0x20 Size=0x4
    unsigned char ImmediateSuccess;// Offset=0x24 Size=0x1
    unsigned long Page;// Offset=0x25 Size=0x4
    unsigned char NotifyVid;// Offset=0x29 Size=0x1
};
