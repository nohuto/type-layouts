...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=457)
{
...
struct _KAPC_STATE// Size=0x30 (Id=378)
{
...
struct _KTIMER// Size=0x40 (Id=485)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=427)
{
...
struct _KEVENT// Size=0x18 (Id=147)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
};

union _KERNEL_SHADOW_STACK_LIMIT// Size=0x8 (Id=568)
{
...
struct _KTHREAD// Size=0x4c0 (Id=370)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _KSEMAPHORE// Size=0x20 (Id=544)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=479)
{
...
struct _PS_PROPERTY_SET// Size=0x18 (Id=553)
{
...
union _RTL_THREAD_RNG_STATE// Size=0x10 (Id=495)
{
...
struct _ETHREAD// Size=0x798 (Id=456)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long Prefetching:1;// Offset=0x5a0 Size=0x4 BitOffset=0x19 BitSize=0x1
            unsigned long ReservedCrossThreadFlags:6;// Offset=0x5a0 Size=0x4 BitOffset=0x1a BitSize=0x6
        };
    };
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long GenerateDumpOnBadHandleAccess:1;// Offset=0x5a4 Size=0x4 BitOffset=0xb BitSize=0x1
            unsigned long PeriodicTrimmerThread:1;// Offset=0x5a4 Size=0x4 BitOffset=0xc BitSize=0x1
            unsigned long ReservedSameThreadPassiveFlags:19;// Offset=0x5a4 Size=0x4 BitOffset=0xd BitSize=0x13
        };
    };
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x3 (Id=0)
        {
            ...
            unsigned char SpareBit:1;// Offset=0x5a8 Size=0x1 BitOffset=0x6 BitSize=0x1
    ...
    void * SparePointer2;// Offset=0x6b0 Size=0x8
