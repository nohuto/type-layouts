...
struct _WHEAP_CMCI_INITERR_EVENT// Size=0x34 (Id=3379)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned long long Msr;// Offset=0x20 Size=0x8
    unsigned long Type;// Offset=0x28 Size=0x4
    unsigned long Bank;// Offset=0x2c Size=0x4
    unsigned long EpIndex;// Offset=0x30 Size=0x4
};
