...
struct _WHEA_CRASHDUMP_EVENT_LOG_ENTRY_WITH_STATUS// Size=0x2c (Id=3086)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned long SourceLocationId;// Offset=0x20 Size=0x4
    long Status;// Offset=0x24 Size=0x4
    long IOStatus;// Offset=0x28 Size=0x4
};
