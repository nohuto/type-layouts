...
union _PCI_EXPRESS_CXL_DVSEC_CAPABILITY_REGISTER_V11// Size=0x2 (Id=3719)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_CXL_DVSEC_CONTROL_REGISTER// Size=0x2 (Id=3056)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_CXL_DVSEC_STATUS_REGISTER// Size=0x2 (Id=3754)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_CXL_DVSEC_LOCK_REGISTER// Size=0x2 (Id=835)
{
    struct // Size=0x2 (Id=0)
    {
...
struct _PCI_EXPRESS_CXL_DVSEC_RANGE_SIZE_HIGH_REGISTER// Size=0x4 (Id=2496)
{
    unsigned long MemSizeHigh;// Offset=0x0 Size=0x4
};

union _PCI_EXPRESS_CXL_DVSEC_RANGE_SIZE_LOW_REGISTER_V11// Size=0x4 (Id=3709)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PCI_EXPRESS_CXL_DVSEC_RANGE_BASE_HIGH_REGISTER// Size=0x4 (Id=3301)
{
    unsigned long MemBaseHigh;// Offset=0x0 Size=0x4
};

union _PCI_EXPRESS_CXL_DVSEC_RANGE_BASE_LOW_REGISTER// Size=0x4 (Id=2221)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PCI_EXPRESS_CXL_DVSEC_CAPABILITY_V11// Size=0x38 (Id=2756)
{
