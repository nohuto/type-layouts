...
struct POWER_POLICY_EVENT_TARGET_STATE// Size=0x8 (Id=1944)
{
    enum FxPowerPolicyEvent PowerPolicyEvent;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_POLICY_STATE TargetState;// Offset=0x4 Size=0x4
};
