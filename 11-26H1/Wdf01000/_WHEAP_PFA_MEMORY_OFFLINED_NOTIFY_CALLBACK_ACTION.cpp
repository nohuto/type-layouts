...
union _WHEA_RECOVERY_CONTEXT_ACTION_TAKEN_ADDITIONAL_INFO// Size=0x8 (Id=2872)
{
    struct <unnamed-type-Bits>// Size=0x8 (Id=28790)
    {
...
struct _WHEAP_PFA_MEMORY_OFFLINED_NOTIFY_CALLBACK_ACTION// Size=0x38 (Id=1431)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned long Page;// Offset=0x20 Size=0x4
    unsigned long ComponentTag;// Offset=0x24 Size=0x4
    long Status;// Offset=0x28 Size=0x4
    enum _WHEA_RECOVERY_CONTEXT_ACTION_TAKEN ActionTaken;// Offset=0x2c Size=0x4
    union _WHEA_RECOVERY_CONTEXT_ACTION_TAKEN_ADDITIONAL_INFO ActionTakenAdditionalInfo;// Offset=0x30 Size=0x8
};
