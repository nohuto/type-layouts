...
struct _WHEA_SEL_BUGCHECK_PROGRESS// Size=0x28 (Id=4089)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned long BugCheckCode;// Offset=0x20 Size=0x4
    unsigned long BugCheckProgressSummary;// Offset=0x24 Size=0x4
};
