...
struct _PCI_EXPRESS_LINK_IDE_BLOCK// Size=0x8 (Id=4151)
{
    union _PCI_EXPRESS_LINK_IDE_STREAM_CONTROL_REGISTER Control;// Offset=0x0 Size=0x4
    union _PCI_EXPRESS_LINK_IDE_STREAM_STATUS_REGISTER Status;// Offset=0x4 Size=0x4
};
