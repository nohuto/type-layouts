struct _DMA_OPERATIONS// Size=0x150 (Id=3292)
{
    ...
    long  ( * GetDmaAdapterInfo)(struct _DMA_ADAPTER * ,union _DMA_ADAPTER_INFO * );// Offset=0x80 Size=0x8
    ...
    long  ( * CreateCommonBufferFromMdl)(struct _DMA_ADAPTER * ,struct _MDL * ,struct _DMA_COMMON_BUFFER_EXTENDED_CONFIGURATION * ,unsigned long ,union _LARGE_INTEGER * );// Offset=0x138 Size=0x8
    long  ( * RegisterFaultCallback)(struct _DMA_ADAPTER * ,struct _DEVICE_FAULT_CONFIGURATION * );// Offset=0x140 Size=0x8
    long  ( * UnregisterFaultCallback)(struct _DMA_ADAPTER * ,struct _DEVICE_FAULT_CONFIGURATION * );// Offset=0x148 Size=0x8
};
