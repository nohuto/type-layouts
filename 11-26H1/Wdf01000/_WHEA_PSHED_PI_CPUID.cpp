...
struct _WHEA_PSHED_PI_CPUID// Size=0x34 (Id=2089)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned int CpuVendor;// Offset=0x20 Size=0x4
    unsigned int CpuFamily;// Offset=0x24 Size=0x4
    unsigned int CpuModel;// Offset=0x28 Size=0x4
    unsigned int CpuStepping;// Offset=0x2c Size=0x4
    unsigned int NumBanks;// Offset=0x30 Size=0x4
};
