...
union _WHEA_REVISION// Size=0x2 (Id=2366)
{
...
union _WHEA_ERROR_RECORD_HEADER_VALIDBITS// Size=0x4 (Id=2351)
{
    struct // Size=0x4 (Id=0)
    {
...
union _WHEA_TIMESTAMP// Size=0x8 (Id=2205)
{
...
union _WHEA_ERROR_RECORD_HEADER_FLAGS// Size=0x4 (Id=2678)
{
    struct // Size=0x4 (Id=0)
    {
...
union _WHEA_PERSISTENCE_INFO// Size=0x8 (Id=2091)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WHEA_ERROR_RECORD_HEADER// Size=0x80 (Id=1980)
{
    unsigned long Signature;// Offset=0x0 Size=0x4
...
struct _WHEAP_ATTEMPT_RECOVERY_EVENT// Size=0xa6 (Id=4003)
{
