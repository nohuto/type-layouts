...
struct _IOMMU_DMA_LOGICAL_ALLOCATOR_CONFIG// Size=0x8 (Id=2093)
{
    enum _IOMMU_DMA_LOGICAL_ALLOCATOR_TYPE LogicalAllocatorType;// Offset=0x0 Size=0x4
    struct _IOMMU_DMA_LOGICAL_ALLOCATOR_CONFIG::_unnamed_4123::<unnamed-type-BuddyAllocatorConfig> BuddyAllocatorConfig;// Offset=0x4 Size=0x4
};
