...
struct _WHEA_PSHED_PLUGIN_DIMM_MISMATCH// Size=0x32 (Id=623)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned short FirmwareBank;// Offset=0x20 Size=0x2
    unsigned short FirmwareCol;// Offset=0x22 Size=0x2
    unsigned short FirmwareRow;// Offset=0x24 Size=0x2
    unsigned short RetryRdBank;// Offset=0x26 Size=0x2
    unsigned short RetryRdCol;// Offset=0x28 Size=0x2
    unsigned short RetryRdRow;// Offset=0x2a Size=0x2
    unsigned short TaBank;// Offset=0x2c Size=0x2
    unsigned short TaCol;// Offset=0x2e Size=0x2
    unsigned short TaRow;// Offset=0x30 Size=0x2
};
