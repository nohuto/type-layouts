...
struct _WHEAP_PROCESS_HEST_EVENT// Size=0x85 (Id=3851)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    char Error[32];// Offset=0x20 Size=0x20
    char EntryType[32];// Offset=0x40 Size=0x20
    unsigned long EntryIndex;// Offset=0x60 Size=0x4
    unsigned char HestValid;// Offset=0x64 Size=0x1
    unsigned long CmcCount;// Offset=0x65 Size=0x4
    unsigned long MceCount;// Offset=0x69 Size=0x4
    unsigned long NmiCount;// Offset=0x6d Size=0x4
    unsigned long AerRootCount;// Offset=0x71 Size=0x4
    unsigned long AerBridgeCount;// Offset=0x75 Size=0x4
    unsigned long AerEndPointCount;// Offset=0x79 Size=0x4
    unsigned long GenericV1Count;// Offset=0x7d Size=0x4
    unsigned long GenericV2Count;// Offset=0x81 Size=0x4
};
