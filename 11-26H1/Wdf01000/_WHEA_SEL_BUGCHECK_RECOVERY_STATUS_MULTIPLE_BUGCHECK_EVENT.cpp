...
struct _WHEA_SEL_BUGCHECK_RECOVERY_STATUS_MULTIPLE_BUGCHECK_EVENT// Size=0x23 (Id=3700)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned char IsBugcheckOwner;// Offset=0x20 Size=0x1
    unsigned char RecursionCount;// Offset=0x21 Size=0x1
    unsigned char IsBugcheckRecoveryOwner;// Offset=0x22 Size=0x1
};
