...
struct _WHEA_THROTTLE_MEMORY_ADD_OR_REMOVE_EVENT// Size=0x2c (Id=1535)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned int SocketId;// Offset=0x20 Size=0x4
    unsigned int ChannelId;// Offset=0x24 Size=0x4
    unsigned int DimmSlot;// Offset=0x28 Size=0x4
};
