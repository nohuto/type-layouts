...
struct _PCI_ADVANCED_FEATURES_CAPABILITY// Size=0x6 (Id=3713)
{
    union // Size=0x5 (Id=0)
    {
        struct _PCI_CAPABILITIES_HEADER Header;// Offset=0x0 Size=0x2
        unsigned char Length;// Offset=0x2 Size=0x1
        union <unnamed-type-Capabilities>// Size=0x1 (Id=14987)
        {
        ...
        union <unnamed-type-Control>// Size=0x1 (Id=14993)
        {
        ...
        union <unnamed-type-Status>// Size=0x1 (Id=14998)
        {
