struct _WHEA_PRM_NORMALIZED_TO_SPA_PARAM_BUFFER_AMD// Size=0x19 (Id=2359)
{
    ...
    struct _WHEA_PRM_NORMALIZED_TO_SPA_OUT_BUFFER_AMD * OutputBuffer;// Offset=0x11 Size=0x8
};
