...
union _ETW_AUTOBOOST_PROCESS_LOCK_ENTRY_EVENT_STATE// Size=0x4 (Id=1612)
{
...
struct _ETW_AUTOBOOST_PROCESS_LOCK_ENTRY_EVENT// Size=0x10 (Id=843)
{
    void * Lock;// Offset=0x0 Size=0x8
    unsigned long ThreadId;// Offset=0x8 Size=0x4
    union _ETW_AUTOBOOST_PROCESS_LOCK_ENTRY_EVENT_STATE State;// Offset=0xc Size=0x4
};
