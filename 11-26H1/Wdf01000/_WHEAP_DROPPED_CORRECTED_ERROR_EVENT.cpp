...
struct _WHEAP_DROPPED_CORRECTED_ERROR_EVENT// Size=0x28 (Id=2661)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    enum _WHEA_ERROR_SOURCE_TYPE ErrorSourceType;// Offset=0x20 Size=0x4
    unsigned long ErrorSourceId;// Offset=0x24 Size=0x4
};
