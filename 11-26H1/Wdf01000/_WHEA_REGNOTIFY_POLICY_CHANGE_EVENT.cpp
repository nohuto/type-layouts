...
struct _WHEA_REGNOTIFY_POLICY_CHANGE_EVENT// Size=0x48 (Id=3687)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    char PolicyName[32];// Offset=0x20 Size=0x20
    unsigned long PolicyIndex;// Offset=0x40 Size=0x4
    unsigned long PolicyValue;// Offset=0x44 Size=0x4
};
