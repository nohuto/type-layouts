...
enum _WHEA_REGISTRY_ERRORS
{
    WheaRegErrNone=0,
    WheaRegErrFailedToCreateWheaKey=1,
    WheaRegErrFailedToCreatePolicyKey=2,
    WheaRegErrFailedToOpenHandle=3
};

struct _WHEA_REGISTRY_ERROR_EVENT// Size=0x28 (Id=2941)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    enum _WHEA_REGISTRY_ERRORS RegErr;// Offset=0x20 Size=0x4
    unsigned int Status;// Offset=0x24 Size=0x4
};
