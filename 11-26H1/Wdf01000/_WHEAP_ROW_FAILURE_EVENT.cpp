...
struct _WHEAP_ROW_FAILURE_EVENT// Size=0x30 (Id=4144)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned long long LowOrderPage;// Offset=0x20 Size=0x8
    unsigned long long HighOrderPage;// Offset=0x28 Size=0x8
};
