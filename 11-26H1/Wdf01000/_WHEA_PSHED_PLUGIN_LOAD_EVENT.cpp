...
struct _WHEA_PSHED_PLUGIN_LOAD_EVENT// Size=0x68 (Id=1494)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    wchar_t PluginName[32];// Offset=0x20 Size=0x40
    unsigned long MajorVersion;// Offset=0x60 Size=0x4
    unsigned long MinorVersion;// Offset=0x64 Size=0x4
};
