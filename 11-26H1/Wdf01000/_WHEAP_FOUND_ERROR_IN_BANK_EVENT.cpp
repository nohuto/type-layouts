...
struct _WHEAP_FOUND_ERROR_IN_BANK_EVENT// Size=0x34 (Id=2883)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned long EpIndex;// Offset=0x20 Size=0x4
    unsigned long Bank;// Offset=0x24 Size=0x4
    unsigned long long MciStatus;// Offset=0x28 Size=0x8
    unsigned long ErrorType;// Offset=0x30 Size=0x4
};
