...
union FxPnpMachineStateHistory// Size=0x10 (Id=1938)
{
    struct <unnamed-type-S>// Size=0x10 (Id=60685)
    {
        enum _WDF_DEVICE_PNP_STATE State1:16;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x10
        enum _WDF_DEVICE_PNP_STATE State2:16;// Offset=0x0 Size=0x4 BitOffset=0x10 BitSize=0x10
        enum _WDF_DEVICE_PNP_STATE State3:16;// Offset=0x4 Size=0x4 BitOffset=0x0 BitSize=0x10
        enum _WDF_DEVICE_PNP_STATE State4:16;// Offset=0x4 Size=0x4 BitOffset=0x10 BitSize=0x10
        enum _WDF_DEVICE_PNP_STATE State5:16;// Offset=0x8 Size=0x4 BitOffset=0x0 BitSize=0x10
        enum _WDF_DEVICE_PNP_STATE State6:16;// Offset=0x8 Size=0x4 BitOffset=0x10 BitSize=0x10
        enum _WDF_DEVICE_PNP_STATE State7:16;// Offset=0xc Size=0x4 BitOffset=0x0 BitSize=0x10
        enum _WDF_DEVICE_PNP_STATE State8:16;// Offset=0xc Size=0x4 BitOffset=0x10 BitSize=0x10
    };
    struct FxPnpMachineStateHistory::<unnamed-type-S> S;// Offset=0x0 Size=0x10
    unsigned short History[8];// Offset=0x0 Size=0x10
};
