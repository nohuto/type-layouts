...
struct _WHEAP_PSHED_INJECT_ERROR// Size=0x4a (Id=813)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned long ErrorType;// Offset=0x20 Size=0x4
    unsigned long long Parameter1;// Offset=0x24 Size=0x8
    unsigned long long Parameter2;// Offset=0x2c Size=0x8
    unsigned long long Parameter3;// Offset=0x34 Size=0x8
    unsigned long long Parameter4;// Offset=0x3c Size=0x8
    long InjectionStatus;// Offset=0x44 Size=0x4
    unsigned char InjectionAttempted;// Offset=0x48 Size=0x1
    unsigned char InjectionByPlugin;// Offset=0x49 Size=0x1
};
