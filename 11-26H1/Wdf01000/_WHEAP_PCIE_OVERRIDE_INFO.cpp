...
struct _WHEAP_PCIE_OVERRIDE_INFO// Size=0x44 (Id=997)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned int Segment;// Offset=0x20 Size=0x4
    unsigned int Bus;// Offset=0x24 Size=0x4
    unsigned int Device;// Offset=0x28 Size=0x4
    unsigned int Function;// Offset=0x2c Size=0x4
    unsigned char ValidBits;// Offset=0x30 Size=0x1
    unsigned char Reserved[3];// Offset=0x31 Size=0x3
    unsigned int UncorrectableErrorMask;// Offset=0x34 Size=0x4
    unsigned int UncorrectableErrorSeverity;// Offset=0x38 Size=0x4
    unsigned int CorrectableErrorMask;// Offset=0x3c Size=0x4
    unsigned int CapAndControl;// Offset=0x40 Size=0x4
};
