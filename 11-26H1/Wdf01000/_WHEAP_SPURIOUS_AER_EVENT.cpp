...
struct _WHEAP_SPURIOUS_AER_EVENT// Size=0x38 (Id=701)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    enum _WHEA_ERROR_SEVERITY ErrorSeverity;// Offset=0x20 Size=0x4
    unsigned long ErrorHandlerType;// Offset=0x24 Size=0x4
    unsigned long SpuriousErrorSourceId;// Offset=0x28 Size=0x4
    unsigned long RootErrorCommand;// Offset=0x2c Size=0x4
    unsigned long RootErrorStatus;// Offset=0x30 Size=0x4
    unsigned long DeviceAssociationBitmap;// Offset=0x34 Size=0x4
};
