...
struct _WDF_CHILD_RETRIEVE_INFO// Size=0x28 (Id=1071)
{
    unsigned long Size;// Offset=0x0 Size=0x4
    struct _WDF_CHILD_IDENTIFICATION_DESCRIPTION_HEADER * IdentificationDescription;// Offset=0x8 Size=0x8
    struct _WDF_CHILD_ADDRESS_DESCRIPTION_HEADER * AddressDescription;// Offset=0x10 Size=0x8
