...
struct _WHEA_SRAR_DETAIL_EVENT// Size=0x31 (Id=1098)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned int RecoveryContextFlags;// Offset=0x20 Size=0x4
    unsigned long long RecoveryContextPa;// Offset=0x24 Size=0x8
    long PageOfflineStatus;// Offset=0x2c Size=0x4
    unsigned char KernelConsumerError;// Offset=0x30 Size=0x1
};
