...
struct _WHEAP_BAD_HEST_NOTIFY_DATA_EVENT// Size=0x40 (Id=3397)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned short SourceId;// Offset=0x20 Size=0x2
    unsigned short Reserved;// Offset=0x22 Size=0x2
    struct _WHEA_NOTIFICATION_DESCRIPTOR NotifyDesc;// Offset=0x24 Size=0x1c
};
