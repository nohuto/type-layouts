...
struct _WDF_POWER_FRAMEWORK_SETTINGS// Size=0x58 (Id=1659)
{
    ...
    unsigned long long PoFxDeviceFlags;// Offset=0x48 Size=0x8
    enum _WDF_TRI_STATE DirectedPoFxEnabled;// Offset=0x50 Size=0x4
};
