...
union _MCG_STATUS// Size=0x8 (Id=3684)
{
...
struct _MCI_STATUS_BITS_COMMON// Size=0x8 (Id=3211)
{
...
struct _MCI_STATUS_AMD_BITS// Size=0x8 (Id=2029)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long McaErrorCode:16;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x10
...
struct _MCI_STATUS_INTEL_BITS// Size=0x8 (Id=1053)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long McaErrorCode:16;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x10
...
union _MCI_STATUS// Size=0x8 (Id=1643)
{
...
struct _WHEA_AMD_EXTENDED_REGISTERS// Size=0xc0 (Id=2609)
{
...
union _MCG_CAP// Size=0x8 (Id=2209)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _XPF_RECOVERY_INFO// Size=0x14 (Id=859)
{
    union // Size=0x4 (Id=0)
    {
        struct <unnamed-type-FailureReason>// Size=0x4 (Id=29919)
        {
        ...
        struct _XPF_RECOVERY_INFO::<unnamed-type-FailureReason> FailureReason;// Offset=0x0 Size=0x4
        struct <unnamed-type-Action>// Size=0x4 (Id=29933)
        {
    ...
    struct _XPF_RECOVERY_INFO::<unnamed-type-Action> Action;// Offset=0x4 Size=0x4
...
struct _WHEA_XPF_MCA_SECTION// Size=0x828 (Id=3486)
{
    ...
    unsigned long BankNumberEx[64];// Offset=0x128 Size=0x100
    union _MCI_STATUS StatusEx[64];// Offset=0x228 Size=0x200
    unsigned long long AddressEx[64];// Offset=0x428 Size=0x200
    unsigned long long MiscEx[64];// Offset=0x628 Size=0x200
};
