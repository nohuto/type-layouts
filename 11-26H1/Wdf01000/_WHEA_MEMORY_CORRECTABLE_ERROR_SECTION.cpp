struct _WHEA_MEMORY_CORRECTABLE_ERROR_HEADER// Size=0x4 (Id=3742)
{
    unsigned short Version;// Offset=0x0 Size=0x2
    unsigned short Count;// Offset=0x2 Size=0x2
};

union _WHEA_MEMORY_CORRECTABLE_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=2920)
{
...
struct _WHEA_MEMORY_CORRECTABLE_ERROR_DATA// Size=0x18 (Id=1130)
{
...
struct _WHEA_MEMORY_CORRECTABLE_ERROR_SECTION// Size=0x1c (Id=4019)
{
