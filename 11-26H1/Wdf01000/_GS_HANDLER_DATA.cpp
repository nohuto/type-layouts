...
union _unnamed_88// Size=0x4 (Id=88)
{
    struct _unnamed_87 Bits;// Offset=0x0 Size=0x4
    long CookieOffset;// Offset=0x0 Size=0x4
};

struct _GS_HANDLER_DATA// Size=0xc (Id=90)
{
    union _unnamed_88 u;// Offset=0x0 Size=0x4
