union _WHEA_ERROR_INJECTION_CAPABILITIES// Size=0x4 (Id=3305)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long CXLCacheProtocolCorrectable:1;// Offset=0x0 Size=0x4 BitOffset=0xc BitSize=0x1
        unsigned long CXLCacheProtocolUncorrectableNonFatal:1;// Offset=0x0 Size=0x4 BitOffset=0xd BitSize=0x1
        unsigned long CXLCacheProtocolUncorrectableFatal:1;// Offset=0x0 Size=0x4 BitOffset=0xe BitSize=0x1
        unsigned long CXLMemProtocolCorrectable:1;// Offset=0x0 Size=0x4 BitOffset=0xf BitSize=0x1
        unsigned long CXLMemProtocolUncorrectableNonFatal:1;// Offset=0x0 Size=0x4 BitOffset=0x10 BitSize=0x1
        unsigned long CXLMemProtocolUncorrectableFatal:1;// Offset=0x0 Size=0x4 BitOffset=0x11 BitSize=0x1
        unsigned long Reserved:13;// Offset=0x0 Size=0x4 BitOffset=0x12 BitSize=0xd
        unsigned long PlatformVendorDefined:1;// Offset=0x0 Size=0x4 BitOffset=0x1f BitSize=0x1
    };
