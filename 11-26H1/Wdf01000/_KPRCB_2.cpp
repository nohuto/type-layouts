...
struct _KPRCB// Size=0xcf00 (Id=420)
{
    ...
    struct _PROCESSOR_POWER_STATE PowerState;// Offset=0x8840 Size=0x260
    unsigned long long PrcbPad96[4];// Offset=0x8aa0 Size=0x20
    ...
    struct _unnamed_417 StibpPairingTrace;// Offset=0x9178 Size=0x38
