union _WHEA_ARM_CACHE_ERROR_VALID_BITS// Size=0x2 (Id=1207)
{
...
struct _WHEA_ARM_CACHE_ERROR// Size=0xc (Id=2297)
{
...
union _WHEA_ARM_TLB_ERROR_VALID_BITS// Size=0x2 (Id=3708)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short TransactionType:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_ARM_TLB_ERROR// Size=0xc (Id=3572)
{
...
union _WHEA_ARM_BUS_ERROR_VALID_BITS// Size=0x2 (Id=4039)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short TransactionType:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_ARM_BUS_ERROR// Size=0xc (Id=3749)
{
...
union _WHEA_ARM_PROCESSOR_ERROR// Size=0xc (Id=3637)
{
    union // Size=0xc (Id=0)
    {
