...
struct _HEAP_EVENT_COMMIT_DECOMMIT// Size=0x1c (Id=2631)
{
...
struct _HEAP_COMMIT_DECOMMIT// Size=0x3c (Id=3618)
{
    struct _SYSTEM_TRACE_HEADER Header;// Offset=0x0 Size=0x20
    struct _HEAP_EVENT_COMMIT_DECOMMIT Event;// Offset=0x20 Size=0x1c
};
