...
enum _WHEAP_DPC_ERROR_EVENT_TYPE
{
    WheapDpcErrNoErr=0,
    WheapDpcErrBusNotFound=1,
    WheapDpcErrDpcedSubtree=2,
    WheapDpcErrDeviceIdBad=3,
    WheapDpcErrResetFailed=4,
    WheapDpcErrNoChildren=5
};

struct _WHEAP_DPC_ERROR_EVENT// Size=0x34 (Id=3072)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    enum _WHEAP_DPC_ERROR_EVENT_TYPE ErrType;// Offset=0x20 Size=0x4
    unsigned long Bus;// Offset=0x24 Size=0x4
    unsigned long Device;// Offset=0x28 Size=0x4
    unsigned long Function;// Offset=0x2c Size=0x4
    unsigned short DeviceId;// Offset=0x30 Size=0x2
    unsigned short VendorId;// Offset=0x32 Size=0x2
};
