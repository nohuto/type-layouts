...
union _WHEA_IN_USE_PAGE_NOTIFY_FLAGS// Size=0x1 (Id=3704)
{
    struct <unnamed-type-Bits>// Size=0x1 (Id=28021)
    {
...
struct _WHEA_RECOVERY_CONTEXT_PAGE_INFO// Size=0x18 (Id=4128)
{
...
struct _WHEA_RECOVERY_CONTEXT// Size=0x1830 (Id=3351)
{
    union // Size=0x10 (Id=0)
    {
        struct _WHEA_RECOVERY_CONTEXT::_unnamed_3355::<unnamed-type-MemoryError> MemoryError;// Offset=0x0 Size=0x10
        struct _WHEA_RECOVERY_CONTEXT::_unnamed_3353::<unnamed-type-PmemError> PmemError;// Offset=0x0 Size=0x8
