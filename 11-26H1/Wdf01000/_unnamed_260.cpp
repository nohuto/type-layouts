...
struct _unnamed_255// Size=0x10 (Id=255)
{
...
struct _unnamed_258// Size=0x10 (Id=258)
{
    ...
    {
        struct _unnamed_255 Raw;// Offset=0x0 Size=0x10
        struct _unnamed_254 Translated;// Offset=0x0 Size=0x10
    };
};
...
union _unnamed_260// Size=0x10 (Id=260)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_18 Generic;// Offset=0x0 Size=0xc
        struct _unnamed_18 Port;// Offset=0x0 Size=0xc
        struct _unnamed_254 Interrupt;// Offset=0x0 Size=0x10
        struct _unnamed_258 MessageInterrupt;// Offset=0x0 Size=0x10
