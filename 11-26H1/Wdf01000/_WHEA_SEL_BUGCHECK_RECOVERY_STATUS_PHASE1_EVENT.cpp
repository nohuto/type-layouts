...
struct _WHEA_SEL_BUGCHECK_RECOVERY_STATUS_PHASE1_EVENT// Size=0x28 (Id=2039)
{
    union // Size=0x24 (Id=0)
    {
        struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
        unsigned char Success;// Offset=0x20 Size=0x1
        unsigned char Version;// Offset=0x21 Size=0x1
        unsigned short EntryCount;// Offset=0x22 Size=0x2
        struct <unnamed-type-Data>// Size=0x4 (Id=28859)
        {
            unsigned char DumpPolicy;// Offset=0x0 Size=0x1
            unsigned char Reserved[3];// Offset=0x1 Size=0x3
        };
        struct _WHEA_SEL_BUGCHECK_RECOVERY_STATUS_PHASE1_EVENT::<unnamed-type-Data> Data;// Offset=0x24 Size=0x4
    };
};
