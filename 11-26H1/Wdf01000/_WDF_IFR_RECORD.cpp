...
struct _WDF_IFR_RECORD// Size=0x24 (Id=2319)
{
    union // Size=0x1c (Id=0)
    {
        ...
        struct <unnamed-type-TimeStamp>// Size=0x8 (Id=24084)
        {
            unsigned long LowPart;// Offset=0x0 Size=0x4
            long HighPart;// Offset=0x4 Size=0x4
        };
        struct _WDF_IFR_RECORD::<unnamed-type-TimeStamp> TimeStamp;// Offset=0x1c Size=0x8
    };
};
