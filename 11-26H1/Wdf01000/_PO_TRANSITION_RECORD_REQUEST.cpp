enum _POWER_INFORMATION_LEVEL_INTERNAL
{
    ...
    PowerInformationInternalMaximum=99
};

struct _POWER_INFORMATION_INTERNAL_HEADER// Size=0x8 (Id=904)
{
...
struct _PO_TRANSITION_RECORD_REQUEST// Size=0x38 (Id=916)
{
    union // Size=0x2c (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x8 (Id=17604)
        {
