...
struct _WHEA_WRITE_VENDOR_DEFINED_INJECTION_AREA_LOG_ENTRY// Size=0x30 (Id=2077)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned int Offset;// Offset=0x20 Size=0x4
    unsigned int InputLength;// Offset=0x24 Size=0x4
    long Status;// Offset=0x28 Size=0x4
    unsigned int Reason;// Offset=0x2c Size=0x4
};
