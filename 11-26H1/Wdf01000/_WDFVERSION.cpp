struct _WDFFUNCTIONS// Size=0xe50 (Id=1641)
{
    ...
    long  ( * pfnWdfRegistryQueryUnicodeString)(struct _WDF_DRIVER_GLOBALS * ,struct WDFKEY__ * ,struct _UNICODE_STRING * ,unsigned short * ,struct _UNICODE_STRING * );// Offset=0x770 Size=0x8
    ...
    long  ( * pfnWdfUsbTargetDeviceRetrieveConfigDescriptor)(struct _WDF_DRIVER_GLOBALS * ,struct WDFUSBDEVICE__ * ,void * ,unsigned short * );// Offset=0xa28 Size=0x8
    long  ( * pfnWdfUsbTargetDeviceQueryString)(struct _WDF_DRIVER_GLOBALS * ,struct WDFUSBDEVICE__ * ,struct WDFREQUEST__ * ,struct _WDF_REQUEST_SEND_OPTIONS * ,unsigned short * ,unsigned short * ,unsigned char ,unsigned short );// Offset=0xa30 Size=0x8
    long  ( * pfnWdfUsbTargetDeviceAllocAndQueryString)(struct _WDF_DRIVER_GLOBALS * ,struct WDFUSBDEVICE__ * ,struct _WDF_OBJECT_ATTRIBUTES * ,struct WDFMEMORY__ ** ,unsigned short * ,unsigned char ,unsigned short );// Offset=0xa38 Size=0x8
    ...
    void  ( * pfnWdfPdoInitRemovePowerDependencyOnParent)(struct _WDF_DRIVER_GLOBALS * ,struct WDFDEVICE_INIT * );// Offset=0xe28 Size=0x8
    long  ( * pfnWdfCxDeviceInitAllocateContext)(struct _WDF_DRIVER_GLOBALS * ,struct WDFDEVICE_INIT * ,struct _WDF_OBJECT_ATTRIBUTES * ,void ** );// Offset=0xe30 Size=0x8
    void *  ( * pfnWdfCxDeviceInitGetTypedContextWorker)(struct _WDF_DRIVER_GLOBALS * ,struct WDFDEVICE_INIT * ,struct _WDF_OBJECT_CONTEXT_TYPE_INFO * );// Offset=0xe38 Size=0x8
    void  ( * pfnWdfCxDeviceInitSetPowerPolicyEventCallbacks)(struct _WDF_DRIVER_GLOBALS * ,struct WDFCXDEVICE_INIT * ,struct _WDFCX_POWER_POLICY_EVENT_CALLBACKS * );// Offset=0xe40 Size=0x8
    void  ( * pfnWdfDeviceSetDeviceInterfaceStateEx)(struct _WDF_DRIVER_GLOBALS * ,struct WDFDEVICE__ * ,struct _GUID * ,struct _UNICODE_STRING * ,unsigned char );// Offset=0xe48 Size=0x8
};

struct _WDFSTRUCTURES// Size=0x288 (Id=2404)
{
...
struct _WDFVERSION// Size=0x10e8 (Id=2259)
{
    unsigned long Size;// Offset=0x0 Size=0x4
    unsigned long FuncCount;// Offset=0x4 Size=0x4
    struct _WDFFUNCTIONS Functions;// Offset=0x8 Size=0xe50
    unsigned long StructCount;// Offset=0xe58 Size=0x4
    struct _WDFSTRUCTURES Structures;// Offset=0xe60 Size=0x288
};
