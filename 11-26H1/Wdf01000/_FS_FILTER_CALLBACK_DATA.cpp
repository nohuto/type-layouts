...
struct _unnamed_270// Size=0x28 (Id=270)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=271)
{
    struct _unnamed_265 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_266 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_268 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _unnamed_269 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_270 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=263)
{
