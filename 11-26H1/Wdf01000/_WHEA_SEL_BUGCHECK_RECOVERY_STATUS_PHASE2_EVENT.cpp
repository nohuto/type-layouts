...
struct _WHEA_SEL_BUGCHECK_RECOVERY_STATUS_PHASE2_EVENT// Size=0x25 (Id=2120)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned long BootId;// Offset=0x20 Size=0x4
    unsigned char Success;// Offset=0x24 Size=0x1
};
