...
struct _KTRAP_FRAME// Size=0x190 (Id=530)
{
    ...
    union // Size=0x70 (Id=0)
    {
        ...
        unsigned long long VectorMask;// Offset=0x68 Size=0x8
    };
    ...
    union // Size=0x108 (Id=0)
    {
        ...
        unsigned long long ShadowStackFrame;// Offset=0xd8 Size=0x8
        unsigned long long Spare[5];// Offset=0xe0 Size=0x28
    };
    ...
    {
        unsigned long NmiPreviousSpecCtrl;// Offset=0x140 Size=0x4
        unsigned long NmiPreviousSpecCtrlPad;// Offset=0x144 Size=0x4
    ...
    union // Size=0x178 (Id=0)
    {
        ...
        {
            unsigned long long FredCsRsvdZ1:45;// Offset=0x170 Size=0x8 BitOffset=0x0 BitSize=0x2d
            unsigned long long KernelModeWaitForEndbranch:1;// Offset=0x170 Size=0x8 BitOffset=0x2d BitSize=0x1
            unsigned long long InterruptedCsl:2;// Offset=0x170 Size=0x8 BitOffset=0x2e BitSize=0x2
            unsigned long long FredSegCs:16;// Offset=0x170 Size=0x8 BitOffset=0x30 BitSize=0x10
        };
    };
    ...
    union // Size=0x190 (Id=0)
    {
        ...
        unsigned long EventInformation;// Offset=0x188 Size=0x4
        struct // Size=0x8 (Id=0)
        {
            unsigned long InstructionLength:4;// Offset=0x188 Size=0x4 BitOffset=0x0 BitSize=0x4
            unsigned long SegSsRsvdZ4:1;// Offset=0x188 Size=0x4 BitOffset=0x4 BitSize=0x1
            unsigned long NestedException:1;// Offset=0x188 Size=0x4 BitOffset=0x5 BitSize=0x1
            unsigned long LongModeInterruption:1;// Offset=0x188 Size=0x4 BitOffset=0x6 BitSize=0x1
            unsigned long EnclaveInterruption:1;// Offset=0x188 Size=0x4 BitOffset=0x7 BitSize=0x1
            unsigned long SegSsRsvdZ3:4;// Offset=0x188 Size=0x4 BitOffset=0x8 BitSize=0x4
            unsigned long FredEventType:4;// Offset=0x188 Size=0x4 BitOffset=0xc BitSize=0x4
            unsigned long SegSsRsvdZ2:8;// Offset=0x188 Size=0x4 BitOffset=0x10 BitSize=0x8
            unsigned long Vector:8;// Offset=0x188 Size=0x4 BitOffset=0x18 BitSize=0x8
            unsigned long SegSsRsvdZ1:13;// Offset=0x18c Size=0x4 BitOffset=0x0 BitSize=0xd
            unsigned long NmiUnblocking:1;// Offset=0x18c Size=0x4 BitOffset=0xd BitSize=0x1
            unsigned long DbOnTf:1;// Offset=0x18c Size=0x4 BitOffset=0xe BitSize=0x1
            unsigned long StiBlocking:1;// Offset=0x18c Size=0x4 BitOffset=0xf BitSize=0x1
            unsigned long FredSegSs:16;// Offset=0x18c Size=0x4 BitOffset=0x10 BitSize=0x10
        };
    };
};

struct _KFRED_TRAP_FRAME// Size=0x1a0 (Id=3387)
{
    struct _KTRAP_FRAME TrapFrame;// Offset=0x0 Size=0x190
    unsigned long long EventInformation;// Offset=0x190 Size=0x8
    unsigned long long Reserved;// Offset=0x198 Size=0x8
};
