...
struct _WHEAP_GENERIC_ERR_MEM_MAP_EVENT// Size=0x50 (Id=795)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    char MapReason[32];// Offset=0x20 Size=0x20
    unsigned long long PhysicalAddress;// Offset=0x40 Size=0x8
    unsigned long long Length;// Offset=0x48 Size=0x8
};
