...
struct tagWNODE_ALL_DATA// Size=0x48 (Id=3591)
{
    struct _WNODE_HEADER WnodeHeader;// Offset=0x0 Size=0x30
    unsigned long DataBlockOffset;// Offset=0x30 Size=0x4
    unsigned long InstanceCount;// Offset=0x34 Size=0x4
    unsigned long OffsetInstanceNameOffsets;// Offset=0x38 Size=0x4
    unsigned long FixedInstanceSize;// Offset=0x3c Size=0x4
