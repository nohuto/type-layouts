struct HAL_DISPATCH// Size=0xe8 (Id=4062)
{
    ...
    void  ( * HalGetPrmCache)(struct _LIST_ENTRY ** ,struct _LIST_ENTRY ** );// Offset=0xb8 Size=0x8
    long  ( * HalInvokePrmFwHandler)(struct _GUID * ,void * ,void * );// Offset=0xc0 Size=0x8
    long  ( * HalFfaMsgSendDirectReq2)(struct _FFA_MSG_SEND_DIRECT_REQ2_PARAMETERS * );// Offset=0xc8 Size=0x8
    long  ( * HalFfaRunTarget)(struct _FFA_RUN_TARGET_INPUT_PARAMETERS * ,struct _FFA_RUN_TARGET_OUTPUT_PARAMETERS * );// Offset=0xd0 Size=0x8
    long  ( * HalFfaRegisterNotification)(struct _FFA_NOTIFICATION_REGISTRATION_PARAMETERS * ,void ** );// Offset=0xd8 Size=0x8
    long  ( * HalFfaUnregisterNotification)(void * );// Offset=0xe0 Size=0x8
};
