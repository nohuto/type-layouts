...
struct _WDF_IFR_OFFSET// Size=0x4 (Id=894)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=24071)
        {
            struct <unnamed-type-s>// Size=0x4 (Id=24072)
            {
...
struct _WDF_IFR_HEADER// Size=0x48 (Id=1015)
{
    ...
    unsigned char UseTimeStamp;// Offset=0x44 Size=0x1
    unsigned char PreciseTimeStamp;// Offset=0x45 Size=0x1
};
