...
struct _WHEA_XPF_MCE_DESCRIPTOR_V2// Size=0x718 (Id=3764)
{
    ...
    struct _WHEA_XPF_MC_BANK_DESCRIPTOR Banks[64];// Offset=0x18 Size=0x700
};
...
struct _WHEA_XPF_CMC_DESCRIPTOR_V2// Size=0x724 (Id=2840)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char NumberOfBanks;// Offset=0x3 Size=0x1
    ...
    struct _WHEA_XPF_MC_BANK_DESCRIPTOR Banks[64];// Offset=0x24 Size=0x700
};
...
struct _WHEA_ERROR_SOURCE_DESCRIPTOR_V2// Size=0x74c (Id=640)
{
    union // Size=0x28 (Id=0)
    {
        ...
        union <unnamed-type-Info>// Size=0x724 (Id=27752)
        {
            struct _WHEA_XPF_MCE_DESCRIPTOR_V2 XpfMceDescriptorV2;// Offset=0x0 Size=0x718
            struct _WHEA_XPF_CMC_DESCRIPTOR_V2 XpfCmcDescriptorV2;// Offset=0x0 Size=0x724
    ...
    union _WHEA_ERROR_SOURCE_DESCRIPTOR_V2::<unnamed-type-Info> Info;// Offset=0x28 Size=0x724
};
