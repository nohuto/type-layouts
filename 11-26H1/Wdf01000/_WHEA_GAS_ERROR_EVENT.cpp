...
enum _WHEA_GAS_ERRORS
{
    WheaGasErrNone=0,
    WheaGasErrUnexpectedAddressSpaceId=1,
    WheaGasErrInvalidStructFields=2,
    WheaGasErrInvalidAccessSize=3
};

struct _WHEA_GAS_ERROR_EVENT// Size=0x24 (Id=4084)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    enum _WHEA_GAS_ERRORS Error;// Offset=0x20 Size=0x4
};
