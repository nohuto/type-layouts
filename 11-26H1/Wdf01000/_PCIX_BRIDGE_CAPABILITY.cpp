...
struct _PCIX_BRIDGE_CAPABILITY// Size=0x20 (Id=3290)
{
    union // Size=0x10 (Id=0)
    {
        struct _PCI_CAPABILITIES_HEADER Header;// Offset=0x0 Size=0x2
        union <unnamed-type-SecondaryStatus>// Size=0x2 (Id=16549)
        {
        ...
        union <unnamed-type-BridgeStatus>// Size=0x4 (Id=16563)
        {
        ...
        union <unnamed-type-EccControlStatus>// Size=0x4 (Id=16583)
        {
