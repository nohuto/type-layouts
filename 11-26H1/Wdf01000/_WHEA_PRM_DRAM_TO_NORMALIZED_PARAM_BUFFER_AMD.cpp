struct _WHEA_PRM_DRAM_TO_NORMALIZED_PARAM_BUFFER_AMD// Size=0x1c (Id=2997)
{
    ...
    struct _WHEA_PRM_DRAM_TO_NORMALIZED_OUT_BUFFER_AMD * OutputBuffer;// Offset=0x14 Size=0x8
};
