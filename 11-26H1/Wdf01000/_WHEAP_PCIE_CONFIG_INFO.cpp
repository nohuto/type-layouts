...
struct _WHEAP_PCIE_CONFIG_INFO// Size=0x44 (Id=3323)
{
    ...
    unsigned int Offset;// Offset=0x30 Size=0x4
    unsigned int Length;// Offset=0x34 Size=0x4
    unsigned long long Value;// Offset=0x38 Size=0x8
    unsigned char Succeeded;// Offset=0x40 Size=0x1
    unsigned char Reserved[3];// Offset=0x41 Size=0x3
};
