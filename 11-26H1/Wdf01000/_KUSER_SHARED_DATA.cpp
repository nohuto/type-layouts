struct _KSYSTEM_TIME// Size=0xc (Id=555)
{
...
struct _XSTATE_FEATURE// Size=0x8 (Id=1469)
{
    unsigned long Offset;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
};

struct _XSTATE_CONFIGURATION// Size=0x358 (Id=3717)
{
...
struct _KUSER_SHARED_DATA// Size=0xaa0 (Id=3035)
{
    ...
    struct _XSTATE_CONFIGURATION XState;// Offset=0x3d8 Size=0x358
    unsigned long long UserPointerAuthMask;// Offset=0x730 Size=0x8
    unsigned long Reserved10[214];// Offset=0x738 Size=0x358
    struct _KSYSTEM_TIME FeatureConfigurationChangeStamp;// Offset=0xa90 Size=0xc
    unsigned long Spare;// Offset=0xa9c Size=0x4
};
