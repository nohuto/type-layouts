...
struct _WHEAP_PFA_MEMORY_POLICY// Size=0x33 (Id=1400)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned long RegistryKeysPresent;// Offset=0x20 Size=0x4
    unsigned char DisableOffline;// Offset=0x24 Size=0x1
    unsigned char PersistOffline;// Offset=0x25 Size=0x1
    unsigned char PfaDisabled;// Offset=0x26 Size=0x1
    unsigned long PageCount;// Offset=0x27 Size=0x4
    unsigned long ErrorThreshold;// Offset=0x2b Size=0x4
    unsigned long TimeOut;// Offset=0x2f Size=0x4
};
