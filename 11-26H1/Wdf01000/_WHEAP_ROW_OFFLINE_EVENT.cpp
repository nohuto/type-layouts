...
struct _WHEAP_ROW_OFFLINE_EVENT// Size=0x3c (Id=3042)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned long long FirstPage;// Offset=0x20 Size=0x8
    unsigned long long LastPage;// Offset=0x28 Size=0x8
    unsigned int Range;// Offset=0x30 Size=0x4
    long Status;// Offset=0x34 Size=0x4
    enum _WHEA_OFFLINE_ERRS ErrorReason;// Offset=0x38 Size=0x4
};
