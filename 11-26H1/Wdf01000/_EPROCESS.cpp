...
struct _DISPATCHER_HEADER// Size=0x18 (Id=170)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KAB_UM_PROCESS_CONTEXT// Size=0x10 (Id=402)
{
...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=547)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _KGROUP_MASK// Size=0x10 (Id=404)
{
    unsigned long long Masks[2];// Offset=0x0 Size=0x10
};

union _KSTACK_COUNT// Size=0x4 (Id=551)
{
...
union _KPROCESS_SECURE_STATE// Size=0x8 (Id=377)
{
    unsigned long long EntireField;// Offset=0x0 Size=0x8
    struct _unnamed_376 Flags;// Offset=0x0 Size=0x8
    struct // Size=0x8 (Id=0)
    {
...
struct _KPROCESS// Size=0x1c8 (Id=516)
{
    ...
    union // Size=0x64 (Id=0)
    {
        void * AutoBoostState2;// Offset=0x58 Size=0x8
        unsigned long Spare5;// Offset=0x60 Size=0x4
    ...
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long ProcessPpmPolicy:4;// Offset=0x88 Size=0x4 BitOffset=0x7 BitSize=0x4
    ...
    unsigned long Spare0e;// Offset=0xf0 Size=0x4
    ...
    union _KPROCESS_SECURE_STATE SecureState;// Offset=0x170 Size=0x8
...
struct _EX_PUSH_LOCK// Size=0x8 (Id=490)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _EX_RUNDOWN_REF// Size=0x8 (Id=496)
{
    union // Size=0x8 (Id=0)
    {
...
struct _EX_FAST_REF// Size=0x8 (Id=542)
{
    union // Size=0x8 (Id=0)
    {
...
struct _RTL_AVL_TREE// Size=0x8 (Id=534)
{
    struct _RTL_BALANCED_NODE * Root;// Offset=0x0 Size=0x8
};

struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=501)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=394)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x1 (Id=0)
...
struct _MMSUPPORT_INSTANCE// Size=0xc0 (Id=538)
{
...
struct _MMSUPPORT_SHARED// Size=0x80 (Id=472)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=489)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=432)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _unnamed_433// Size=0x4 (Id=433)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _unnamed_434// Size=0x4 (Id=434)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=494)
{
...
struct _unnamed_436// Size=0x4 (Id=436)
{
    struct // Size=0x4 (Id=0)
    {
...
union _PROCESS_EXECUTION_TRANSITION// Size=0x2 (Id=539)
{
...
union _PROCESS_EXECUTION_STATE// Size=0x1 (Id=339)
{
...
union _PROCESS_EXECUTION// Size=0x4 (Id=540)
{
...
struct _EPROCESS_POWER_THROTTLING_STATE// Size=0x8 (Id=422)
{
    unsigned long ControlMask;// Offset=0x0 Size=0x4
    unsigned long StateMask;// Offset=0x4 Size=0x4
};

struct _EPROCESS// Size=0x840 (Id=437)
{
    ...
    unsigned long long MmReserved2;// Offset=0x290 Size=0x8
    ...
    struct _INVERTED_FUNCTION_TABLE_USER_MODE * InvertedFunctionTable;// Offset=0x5c8 Size=0x8
    ...
    unsigned char VirtualTimersPaused;// Offset=0x6ef Size=0x1
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_433 MitigationFlagsValues;// Offset=0x750 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x754 Size=0x4
        struct _unnamed_434 MitigationFlags2Values;// Offset=0x754 Size=0x4
    };
    ...
    void * SyscallProviderReserved[4];// Offset=0x7b8 Size=0x20
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags3;// Offset=0x7d8 Size=0x4
        struct _unnamed_435 MitigationFlags3Values;// Offset=0x7d8 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_436 SyscallUsageValues;// Offset=0x7e0 Size=0x4
    };
    ...
    void * JobCpuPartitionObject;// Offset=0x808 Size=0x8
    struct _LIST_ENTRY FreezeWorkLinks;// Offset=0x810 Size=0x10
    struct _EX_PUSH_LOCK PpmPolicyLock;// Offset=0x820 Size=0x8
    unsigned long BamPpmPolicy;// Offset=0x828 Size=0x4
    struct _EPROCESS_POWER_THROTTLING_STATE ProcessPowerThrottlingState;// Offset=0x82c Size=0x8
    struct _SINGLE_LIST_ENTRY ProcessQosCallbackListEntry;// Offset=0x838 Size=0x8
};
