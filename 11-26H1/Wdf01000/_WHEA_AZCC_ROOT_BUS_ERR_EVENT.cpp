...
struct _WHEA_AZCC_ROOT_BUS_ERR_EVENT// Size=0x22 (Id=769)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    unsigned char MaxBusCountPassed;// Offset=0x20 Size=0x1
    unsigned char InvalidBusMSR;// Offset=0x21 Size=0x1
};
