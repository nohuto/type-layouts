...
enum _WHEA_PSHED_PLUGIN_ENABLE_NOTIFY_ERRORS
{
    ...
    PshedPiEnableNotifyErrorCreateSystemThread=2,
    PshedPiEnableNotifyErrorMax=3
};

struct _WHEA_PSHED_PLUGIN_ENABLE_NOTIFY_FAILED_EVENT// Size=0x24 (Id=2799)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    enum _WHEA_PSHED_PLUGIN_ENABLE_NOTIFY_ERRORS EnableError;// Offset=0x20 Size=0x4
};
