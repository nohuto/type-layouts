...
union _SLIST_HEADER// Size=0x10 (Id=471)
{
    unsigned long long Alignment;// Offset=0x0 Size=0x8
    unsigned long long Region;// Offset=0x8 Size=0x8
    struct _unnamed_470 HeaderX64;// Offset=0x0 Size=0x10
};
...
struct _GENERAL_LOOKASIDE// Size=0x80 (Id=382)
{
...
struct _NPAGED_LOOKASIDE_LIST// Size=0x80 (Id=2043)
{
    struct _GENERAL_LOOKASIDE L;// Offset=0x0 Size=0x80
};

union FxDmaEnabler::<unnamed-type-m_SGList>// Size=0x80 (Id=2970)
{
    union // Size=0x80 (Id=0)
    {
        struct <unnamed-type-ScatterGatherProfile>// Size=0x80 (Id=35969)
        {
            struct _NPAGED_LOOKASIDE_LIST Lookaside;// Offset=0x0 Size=0x80
        };
        struct FxDmaEnabler::<unnamed-type-m_SGList>::<unnamed-type-ScatterGatherProfile> ScatterGatherProfile;// Offset=0x0 Size=0x80
        struct <unnamed-type-SystemProfile>// Size=0x8 (Id=35972)
        {
            struct _SCATTER_GATHER_LIST * List;// Offset=0x0 Size=0x8
        };
        struct FxDmaEnabler::<unnamed-type-m_SGList>::<unnamed-type-SystemProfile> SystemProfile;// Offset=0x0 Size=0x8
    };
};
