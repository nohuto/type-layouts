...
struct _WHEA_PCIE_ADDRESS// Size=0x10 (Id=3937)
{
...
struct _WHEA_THROTTLE_PCIE_ADD_EVENT// Size=0x39 (Id=4137)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    struct _WHEA_PCIE_ADDRESS Address;// Offset=0x20 Size=0x10
    unsigned int Mask;// Offset=0x30 Size=0x4
    unsigned char Updated;// Offset=0x34 Size=0x1
    long Status;// Offset=0x35 Size=0x4
};
