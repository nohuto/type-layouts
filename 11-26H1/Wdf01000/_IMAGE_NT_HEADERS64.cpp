struct _IMAGE_FILE_HEADER// Size=0x14 (Id=1092)
{
...
struct _IMAGE_DATA_DIRECTORY// Size=0x8 (Id=1024)
{
    unsigned long VirtualAddress;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
};

struct _IMAGE_OPTIONAL_HEADER64// Size=0xf0 (Id=1216)
{
...
struct _IMAGE_NT_HEADERS64// Size=0x108 (Id=1128)
{
