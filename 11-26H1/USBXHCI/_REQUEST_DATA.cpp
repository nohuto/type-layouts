...
struct _ENDPOINT_UPDATE_DATA// Size=0x78 (Id=939)
{
...
struct _ENDPOINT_STATIC_STREAMS_CONFIGURE// Size=0x8 (Id=835)
{
    struct _STATIC_STREAMS_DATA * StaticStreamsData;// Offset=0x0 Size=0x8
};

struct _ENDPOINT_RESET_DATA// Size=0x70 (Id=778)
{
    struct _ENDPOINT_DATA * EndpointData;// Offset=0x0 Size=0x8
    struct _XIL_BUFFER_DATA * InputBufferData;// Offset=0x8 Size=0x8
...
struct _USBDEVICE_ENDPOINTS_CONFIGURE_DATA// Size=0x2 (Id=830)
{
...
struct _CONTROL_TRANSFER_DATA// Size=0xf8 (Id=947)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
    ...
    struct _unnamed_703 PreallocatedScatterGatherList;// Offset=0xd0 Size=0x28
};
...
struct _BULK_TRANSFER_DATA// Size=0x160 (Id=800)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
    unsigned char Initialized;// Offset=0x10 Size=0x1
    struct WDFREQUEST__ * WdfRequest;// Offset=0x18 Size=0x8
...
union _REQUEST_DATA// Size=0x300 (Id=568)
{
