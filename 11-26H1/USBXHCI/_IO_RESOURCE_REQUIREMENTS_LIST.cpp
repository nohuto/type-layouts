...
struct _unnamed_291// Size=0x8 (Id=291)
{
...
union _unnamed_300// Size=0x18 (Id=300)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_288 Port;// Offset=0x0 Size=0x18
        struct _unnamed_288 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_290 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_291 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_292 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_288 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_293 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_294 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_295 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_296 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_297 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_298 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_299 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=301)
{
    ...
    union _unnamed_300 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=1048)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=868)
{
