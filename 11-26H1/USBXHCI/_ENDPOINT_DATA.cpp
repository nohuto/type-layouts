union _ENDPOINT_FLAGS// Size=0x4 (Id=556)
{
...
struct _USB_ENDPOINT_DESCRIPTOR// Size=0x7 (Id=654)
{
...
struct _EUSB2_ISOCH_ENDPOINT_COMPANION_DESCRIPTOR// Size=0x8 (Id=785)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
    unsigned short wMaxPacketSize;// Offset=0x2 Size=0x2
...
struct _USB_SUPERSPEED_ENDPOINT_COMPANION_DESCRIPTOR// Size=0x6 (Id=693)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
    unsigned char bMaxBurst;// Offset=0x2 Size=0x1
    union _unnamed_692 bmAttributes;// Offset=0x3 Size=0x1
    unsigned short wBytesPerInterval;// Offset=0x4 Size=0x2
};

struct _USB_SUPERSPEEDPLUS_ISOCH_ENDPOINT_COMPANION_DESCRIPTOR// Size=0x8 (Id=679)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
...
struct _STATE_LOG// Size=0xc (Id=787)
{
...
struct _EVENTS_QUEUE// Size=0x44 (Id=725)
{
...
struct _SM_CONTEXT// Size=0x400 (Id=637)
{
...
struct _ENDPOINT_DATA// Size=0x568 (Id=550)
{
    ...
    unsigned char EnabledForSplitTransactionHSIIWorkaround;// Offset=0x26 Size=0x1
    unsigned char EUSB2v1DoubleIsochCompanionDescriptorPresent;// Offset=0x27 Size=0x1
    ...
    struct _EUSB2_ISOCH_ENDPOINT_COMPANION_DESCRIPTOR EUsb2IsochEndpointCompanionDescriptor;// Offset=0x67 Size=0x8
    struct _USB_SUPERSPEED_ENDPOINT_COMPANION_DESCRIPTOR UsbSuperSpeedEndpointCompanionDescriptor;// Offset=0x6f Size=0x6
    struct _USB_SUPERSPEEDPLUS_ISOCH_ENDPOINT_COMPANION_DESCRIPTOR UsbSuperSpeedPlusIsochEndpointCompanionDescriptor;// Offset=0x75 Size=0x8
    enum _ENDPOINT_TYPE Type;// Offset=0x80 Size=0x4
    struct _STATIC_STREAMS_DATA * DefaultStaticStreamsData;// Offset=0x88 Size=0x8
    struct _STATIC_STREAMS_DATA * StaticStreamsData;// Offset=0x90 Size=0x8
    unsigned long ContextIndex;// Offset=0x98 Size=0x4
    unsigned long MaxBurstSize;// Offset=0x9c Size=0x4
    unsigned long MaxPayloadPerServiceOpportunity;// Offset=0xa0 Size=0x4
    unsigned long StopReissueCount;// Offset=0xa4 Size=0x4
    unsigned long SetDequeuePointerReissueCount;// Offset=0xa8 Size=0x4
    struct _CRB Crb;// Offset=0xb0 Size=0x60
    struct _XIL_BUFFER_DATA * InputBufferData;// Offset=0x110 Size=0x8
    struct _XIL_BUFFER_DATA * PreAllocatedBufferData;// Offset=0x118 Size=0x8
    struct _CLEAR_STALL_CONTEXT * ClearStallContext;// Offset=0x120 Size=0x8
    struct WDFREQUEST__ * EndpointResetRequest;// Offset=0x128 Size=0x8
    long EndpointResetCompletionStatus;// Offset=0x130 Size=0x4
    struct _SM_CONTEXT SmContext;// Offset=0x138 Size=0x400
    struct _XIL_ENDPOINT_DATA XilEndpointData;// Offset=0x538 Size=0x28
    enum _ENDPOINT_OFFLOAD_STATE OffloadState;// Offset=0x560 Size=0x4
    unsigned char RetriedDueToStopEpSuccessInNotStoppedState;// Offset=0x564 Size=0x1
};
