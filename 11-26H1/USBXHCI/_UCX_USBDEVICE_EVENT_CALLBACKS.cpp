struct _UCX_USBDEVICE_EVENT_CALLBACKS// Size=0x70 (Id=460)
{
    ...
    long  ( * EvtUsbDeviceEndpointAddv2)(struct UCXCONTROLLER__ * ,struct UCXUSBDEVICE__ * ,struct _USB_ENDPOINT_DESCRIPTOR * ,unsigned long ,struct _USB_SUPERSPEED_ENDPOINT_COMPANION_DESCRIPTOR * ,struct _EUSB2_ISOCH_ENDPOINT_COMPANION_DESCRIPTOR * ,struct _UCXENDPOINT_INIT * );// Offset=0x68 Size=0x8
};
