...
struct _unnamed_718// Size=0x8 (Id=718)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_719// Size=0x4 (Id=719)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_720// Size=0x8 (Id=720)
{
    struct _unnamed_718 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_719 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_718 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=261)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_720 Data;// Offset=0x4 Size=0x8
};
