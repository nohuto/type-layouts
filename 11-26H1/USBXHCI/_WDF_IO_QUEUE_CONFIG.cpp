...
union _unnamed_342// Size=0x4 (Id=342)
{
    struct _unnamed_341 Parallel;// Offset=0x0 Size=0x4
};

struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=343)
{
    ...
    union _unnamed_342 Settings;// Offset=0x50 Size=0x4
