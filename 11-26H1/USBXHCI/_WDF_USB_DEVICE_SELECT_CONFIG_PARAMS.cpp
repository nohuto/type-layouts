...
struct _unnamed_431// Size=0x10 (Id=431)
{
...
{
    struct _unnamed_429 Descriptor;// Offset=0x0 Size=0x18
    struct _unnamed_430 Urb;// Offset=0x0 Size=0x8
    struct _unnamed_431 SingleInterface;// Offset=0x0 Size=0x10
    struct _unnamed_432 MultiInterface;// Offset=0x0 Size=0x18
};

struct _WDF_USB_DEVICE_SELECT_CONFIG_PARAMS// Size=0x20 (Id=434)
{
    unsigned long Size;// Offset=0x0 Size=0x4
    enum _WdfUsbTargetDeviceSelectConfigType Type;// Offset=0x4 Size=0x4
    union _unnamed_433 Types;// Offset=0x8 Size=0x18
};
