...
struct _CRASHDUMP_BUFFER_DATA// Size=0x18 (Id=574)
{
...
struct _CRASHDUMP_REGISTER_DATA// Size=0x48 (Id=569)
{
...
struct _CRASHDUMP_EVENTRING_DATA// Size=0x80 (Id=582)
{
...
struct _CRASHDUMP_COMMAND_DATA// Size=0x50 (Id=583)
{
    void * DumperHandle;// Offset=0x0 Size=0x8
    void * RegisterHandle;// Offset=0x8 Size=0x8
...
struct _CRASHDUMP_DATA// Size=0x278 (Id=581)
{
    ...
    unsigned char MajorRevision;// Offset=0x273 Size=0x1
    unsigned char MinorRevision;// Offset=0x274 Size=0x1
};
