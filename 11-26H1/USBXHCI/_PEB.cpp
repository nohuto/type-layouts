...
struct _unnamed_26// Size=0x8 (Id=26)
{
    unsigned long LowPart;// Offset=0x0 Size=0x4
    unsigned long HighPart;// Offset=0x4 Size=0x4
};

union _ULARGE_INTEGER// Size=0x8 (Id=180)
{
    unsigned long LowPart;// Offset=0x0 Size=0x4
    unsigned long HighPart;// Offset=0x4 Size=0x4
    struct _unnamed_26 u;// Offset=0x0 Size=0x8
...
struct _PEB// Size=0x7d8 (Id=18)
{
    ...
    struct _RTL_BITMAP * TlsBitmap;// Offset=0x78 Size=0x8
    ...
    struct _RTL_BITMAP * TlsExpansionBitmap;// Offset=0x238 Size=0x8
    ...
    void * PointerIgnoreBits;// Offset=0x320 Size=0x8
    void * MemoryTaggingBitMap;// Offset=0x328 Size=0x8
    void * PatchLoaderData;// Offset=0x330 Size=0x8
    struct _CHPEV2_PROCESS_INFO * ChpeV2ProcessInfo;// Offset=0x338 Size=0x8
    ...
    void * EcCodeBitMap;// Offset=0x368 Size=0x8
    ...
    struct _LEAP_SECOND_DATA * LeapSecondData;// Offset=0x7b8 Size=0x8
    union // Size=0x4 (Id=0)
    {
    ...
    void * Win32ClientProcInfo;// Offset=0x7d0 Size=0x8
};
