...
union _unnamed_675// Size=0x8 (Id=675)
{
    struct _unnamed_673 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_674 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_673 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=262)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_675 Data;// Offset=0x4 Size=0x8
};
