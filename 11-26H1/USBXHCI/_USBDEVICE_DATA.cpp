...
struct _USB_DEVICE_PORT_PATH// Size=0x24 (Id=541)
{
...
struct _UCXUSBDEVICE_INFO// Size=0x40 (Id=766)
{
    unsigned long Size;// Offset=0x0 Size=0x4
    ...
    unsigned long Reserved2;// Offset=0x38 Size=0x4
};
...
struct _USB_DEVICE_DESCRIPTOR// Size=0x12 (Id=447)
{
...
struct _NORMAL_TRB// Size=0x10 (Id=628)
{
...
struct _SETUP_STAGE_TRB// Size=0x10 (Id=790)
{
...
struct _DATA_STAGE_TRB// Size=0x10 (Id=753)
{
    unsigned long long DataBufferPointer;// Offset=0x0 Size=0x8
    struct // Size=0x8 (Id=0)
    {
...
struct _STATUS_STAGE_TRB// Size=0x10 (Id=966)
{
...
struct _ISOCH_TRB// Size=0x10 (Id=652)
{
    unsigned long long DataBufferPointer;// Offset=0x0 Size=0x8
    struct // Size=0x8 (Id=0)
    {
...
struct _TRANSFER_EVENT_TRB// Size=0x10 (Id=606)
{
...
struct _COMMAND_COMPLETION_EVENT_TRB// Size=0x10 (Id=1015)
{
...
struct _PORT_STATUS_CHANGE_EVENT_TRB// Size=0x10 (Id=990)
{
...
struct _HOST_CONTROLLER_EVENT_TRB// Size=0x10 (Id=838)
{
    unsigned long long Reserved0;// Offset=0x0 Size=0x8
    struct // Size=0x8 (Id=0)
    {
...
struct _DEVICE_NOTIFICATION_EVENT_TRB// Size=0x10 (Id=663)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _DEVICE_NOTIFICATION_EVENT_FUNCTION_WAKE_TRB// Size=0x10 (Id=815)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long Reserved0:4;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x4
...
struct _NOOP_COMMAND_TRB// Size=0x10 (Id=807)
{
...
struct _ENABLE_SLOT_COMMAND_TRB// Size=0x10 (Id=935)
{
    unsigned long Reserved0[3];// Offset=0x0 Size=0xc
    struct // Size=0x4 (Id=0)
    {
...
struct _DISABLE_SLOT_COMMAND_TRB// Size=0x10 (Id=831)
{
    unsigned long Reserved0[3];// Offset=0x0 Size=0xc
    struct // Size=0x4 (Id=0)
    {
...
struct _ADDRESS_DEVICE_COMMAND_TRB// Size=0x10 (Id=847)
{
...
struct _CONFIGURE_ENDPOINT_COMMAND_TRB// Size=0x10 (Id=786)
{
    unsigned long long InputContextPointer;// Offset=0x0 Size=0x8
    unsigned long Reserved0;// Offset=0x8 Size=0x4
    struct // Size=0x4 (Id=0)
...
struct _EVALUATE_CONTEXT_COMMAND_TRB// Size=0x10 (Id=755)
{
    unsigned long long InputContextPointer;// Offset=0x0 Size=0x8
    unsigned long Reserved0;// Offset=0x8 Size=0x4
    struct // Size=0x4 (Id=0)
...
struct _RESET_ENDPOINT_COMMAND_TRB// Size=0x10 (Id=623)
{
    unsigned long Reserved0[3];// Offset=0x0 Size=0xc
    struct // Size=0x4 (Id=0)
    {
...
struct _STOP_ENDPOINT_COMMAND_TRB// Size=0x10 (Id=769)
{
    unsigned long Reserved0[3];// Offset=0x0 Size=0xc
    struct // Size=0x4 (Id=0)
    {
...
struct _SET_DEQUEUE_POINTER_COMMAND_TRB// Size=0x10 (Id=894)
{
    union // Size=0x8 (Id=0)
    {
...
struct _RESET_DEVICE_COMMAND_TRB// Size=0x10 (Id=640)
{
    unsigned long Reserved0[3];// Offset=0x0 Size=0xc
    struct // Size=0x4 (Id=0)
    {
...
struct _GET_EXTENDED_PROPERTY_COMMAND_TRB// Size=0x10 (Id=748)
{
    union // Size=0x8 (Id=0)
    {
...
struct _SET_EXTENDED_PROPERTY_COMMAND_TRB// Size=0x10 (Id=1047)
{
...
struct _LINK_TRB// Size=0x10 (Id=809)
{
...
struct _XILCORE_USBDEVICE_DATA// Size=0x28 (Id=1090)
{
...
struct _XIL_DIRECT_USBDEVICE_DATA// Size=0x28 (Id=1072)
{
    struct _XILCORE_USBDEVICE_DATA XilCoreUsbDeviceData;// Offset=0x0 Size=0x28
};

struct _XIL_PROXY_USBDEVICE_DATA// Size=0x30 (Id=1073)
{
...
struct _XIL_USBDEVICE_DATA// Size=0x60 (Id=959)
{
...
struct _USBDEVICE_DATA// Size=0x2c8 (Id=545)
{
    struct UCXUSBDEVICE__ * UcxUsbDevice;// Offset=0x0 Size=0x8
    void * ControllerHandle;// Offset=0x8 Size=0x8
    struct _UCXUSBDEVICE_INFO UsbDeviceInfo;// Offset=0x10 Size=0x40
    struct _LIST_ENTRY DeviceListEntry;// Offset=0x50 Size=0x10
    unsigned long long EndpointListLock;// Offset=0x60 Size=0x8
    struct _LIST_ENTRY EndpointListHead;// Offset=0x68 Size=0x10
    unsigned long EndpointListCount;// Offset=0x78 Size=0x4
    struct _USB_DEVICE_DESCRIPTOR DeviceDescriptor;// Offset=0x7c Size=0x12
    unsigned char SlotEnabled;// Offset=0x8e Size=0x1
    unsigned char SlotId;// Offset=0x8f Size=0x1
    unsigned char IsHub;// Offset=0x90 Size=0x1
    unsigned char IsConnectedToTTHub;// Offset=0x91 Size=0x1
    unsigned long NumberOfPorts;// Offset=0x94 Size=0x4
    unsigned long NumberOfTTs;// Offset=0x98 Size=0x4
    unsigned long TTThinkTime;// Offset=0x9c Size=0x4
    unsigned long ContextEntriesInUse;// Offset=0xa0 Size=0x4
    union _DOORBELL_REGISTER * DoorbellRegister;// Offset=0xa8 Size=0x8
    void * EndpointHandle[32];// Offset=0xb0 Size=0x100
    struct WDFREQUEST__ * WdfRequest;// Offset=0x1b0 Size=0x8
    unsigned char WdfRequestMustSucceed;// Offset=0x1b8 Size=0x1
    struct WDFREQUEST__ * ConfigureEndpointWdfRequest;// Offset=0x1c0 Size=0x8
    long ConfigureEndpointStatus;// Offset=0x1c8 Size=0x4
    unsigned char EndpointsDroppedInCurrentConfigureEndpoint;// Offset=0x1cc Size=0x1
    struct _CRB Crb;// Offset=0x1d0 Size=0x60
    void  ( * CrbCompletionRoutine)(void * ,long );// Offset=0x230 Size=0x8
    void * CrbCompletionContext;// Offset=0x238 Size=0x8
    unsigned char Is20LpmEnabled;// Offset=0x240 Size=0x1
    unsigned char IsRootPortResumeTimeSet;// Offset=0x241 Size=0x1
    unsigned char ConfigurationValue;// Offset=0x242 Size=0x1
    unsigned char InterfaceNumber;// Offset=0x243 Size=0x1
    unsigned char AlternateSetting;// Offset=0x244 Size=0x1
    long LastConfigureEndpointStatus;// Offset=0x248 Size=0x4
    unsigned long NumberOfPendingCommandsForConfigureEndpoint;// Offset=0x24c Size=0x4
    unsigned char CommandsForConfigureEndpointHasFailed;// Offset=0x250 Size=0x1
    struct _ENDPOINTS_CONFIGURE * EndpointsConfigure;// Offset=0x258 Size=0x8
    enum _CONFIGURE_ENDPOINT_STATE ConfigureEndpointState;// Offset=0x260 Size=0x4
    struct _XIL_USBDEVICE_DATA XilUsbDeviceData;// Offset=0x268 Size=0x60
};
