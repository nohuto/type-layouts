...
{
    struct _unnamed_685 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_686 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_685 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=260)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_687 Data;// Offset=0x4 Size=0x8
};
