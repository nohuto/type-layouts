...
struct _unnamed_90// Size=0x20 (Id=90)
{
    struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
    unsigned long Options;// Offset=0x8 Size=0x4
...
struct _unnamed_92// Size=0x18 (Id=92)
{
...
struct _unnamed_97// Size=0x18 (Id=97)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _unnamed_105// Size=0x10 (Id=105)
{
    unsigned long SecurityInformation;// Offset=0x0 Size=0x4
    unsigned long Length;// Offset=0x8 Size=0x4
};

struct _unnamed_106// Size=0x10 (Id=106)
{
    unsigned long SecurityInformation;// Offset=0x0 Size=0x4
...
struct _unnamed_110// Size=0x8 (Id=110)
{
...
struct _unnamed_112// Size=0x4 (Id=112)
{
...
struct _unnamed_117// Size=0x1 (Id=117)
{
...
struct _unnamed_123// Size=0x10 (Id=123)
{
...
struct _unnamed_125// Size=0x4 (Id=125)
{
    enum _SYSTEM_POWER_STATE PowerState;// Offset=0x0 Size=0x4
};

struct _unnamed_126// Size=0x8 (Id=126)
{
    struct _POWER_SEQUENCE * PowerSequence;// Offset=0x0 Size=0x8
};

struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=851)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=801)
{
...
union _unnamed_133// Size=0x20 (Id=133)
{
    struct _unnamed_89 Create;// Offset=0x0 Size=0x20
    struct _unnamed_90 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_91 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_92 Read;// Offset=0x0 Size=0x18
    struct _unnamed_92 Write;// Offset=0x0 Size=0x18
    struct _unnamed_94 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_95 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_97 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_98 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_99 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_101 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_102 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_103 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_104 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_105 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_106 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_107 MountVolume;// Offset=0x0 Size=0x18
    struct _unnamed_108 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_110 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_112 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_113 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_114 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_115 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_116 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_117 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_119 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_121 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_123 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_125 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_126 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_129 Power;// Offset=0x0 Size=0x20
    struct _unnamed_130 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_131 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_132 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=134)
{
    ...
    union _unnamed_133 Parameters;// Offset=0x8 Size=0x20
