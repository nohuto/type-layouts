...
struct _MI_COMBINE_BLOCK_BASE// Size=0x18 (Id=2525)
{
...
union _unnamed_2335// Size=0x18 (Id=2335)
{
...
struct _MI_CLONE_BLOCK_FLAGS// Size=0x8 (Id=1852)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _MMCLONE_BLOCK// Size=0x20 (Id=1853)
{
...
struct _MI_COMBINE_BLOCK// Size=0x48 (Id=2336)
{
    union _unnamed_2335 u1;// Offset=0x0 Size=0x18
    unsigned long long HashValue;// Offset=0x18 Size=0x8
    struct _MMCLONE_BLOCK Clone;// Offset=0x20 Size=0x20
    unsigned long long CombineDomain;// Offset=0x40 Size=0x8
};
