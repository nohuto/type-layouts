...
struct _unnamed_2630// Size=0x18 (Id=2630)
{
...
struct _unnamed_2631// Size=0x20 (Id=2631)
{
...
struct _unnamed_2632// Size=0x28 (Id=2632)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=2633)
{
    struct _unnamed_2627 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_2628 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_2630 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _unnamed_2631 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_2632 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=2613)
{
