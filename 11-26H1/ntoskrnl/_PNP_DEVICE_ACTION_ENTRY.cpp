...
enum _PNP_DEVICE_ACTION_REQUEST
{
    ...
    StartDeferredStartBootDrivers=28,
    NoopEvent=29,
    PnpDeviceActionRequestMax=30
};
...
struct _PNP_DEVICE_ACTION_REQUEST_ARGUMENT// Size=0x10 (Id=1749)
{
    void * PdcActivatorHandle;// Offset=0x0 Size=0x8
    union _unnamed_1748 u;// Offset=0x8 Size=0x8
};
...
struct _PNP_DEVICE_ACTION_ENTRY// Size=0x68 (Id=1629)
{
    ...
    struct _PNP_DEVICE_ACTION_REQUEST_ARGUMENT RequestArgument;// Offset=0x20 Size=0x10
    struct _KEVENT * CompletionEvent;// Offset=0x30 Size=0x8
    long * CompletionStatus;// Offset=0x38 Size=0x8
    struct _GUID ActivityId;// Offset=0x40 Size=0x10
    long RefCount;// Offset=0x50 Size=0x4
    unsigned char Dequeued;// Offset=0x54 Size=0x1
    struct _EX_PUSH_LOCK CancelLock;// Offset=0x58 Size=0x8
    unsigned char CancelRequested;// Offset=0x60 Size=0x1
};
