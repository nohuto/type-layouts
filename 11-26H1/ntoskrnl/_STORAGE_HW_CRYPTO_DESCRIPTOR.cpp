struct _STORAGE_DESCRIPTOR_HEADER// Size=0x8 (Id=1343)
{
...
union _STORAGE_CRYPTO_KEY_TYPE// Size=0x1 (Id=1267)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _STORAGE_HW_CRYPTO_DESCRIPTOR// Size=0x20 (Id=840)
{
