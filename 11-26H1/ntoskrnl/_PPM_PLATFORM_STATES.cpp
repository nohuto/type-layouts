enum _PPM_DEEP_SLEEP_STATE
{
    ...
    PpmDeepSleepStateRestrictedStandby=2
};
...
struct _PPM_VETO_ACCOUNTING// Size=0x28 (Id=2244)
{
...
union _PPM_COORDINATED_SYNCHRONIZATION// Size=0x4 (Id=1632)
{
...
struct _PPM_PLATFORM_STATE// Size=0x1c0 (Id=1633)
{
...
struct _PPM_PLATFORM_STATES// Size=0x200 (Id=865)
{
    unsigned long StateCount;// Offset=0x0 Size=0x4
    unsigned long ProcessorCount;// Offset=0x4 Size=0x4
    unsigned char CoordinatedInterface;// Offset=0x8 Size=0x1
    ...
    enum _PPM_DEEP_SLEEP_STATE DeepSleepState;// Offset=0x38 Size=0x4
    struct _PPM_PLATFORM_STATE State[1];// Offset=0x40 Size=0x1c0
};
