...
struct _unnamed_1928// Size=0x8 (Id=1928)
{
    unsigned long IdleTime;// Offset=0x0 Size=0x4
    unsigned long NonIdleTime;// Offset=0x4 Size=0x4
};

union _unnamed_1929// Size=0x8 (Id=1929)
{
    struct _unnamed_1928 Disk;// Offset=0x0 Size=0x8
};

struct _DEVICE_OBJECT_POWER_EXTENSION// Size=0x68 (Id=1930)
{
    ...
    struct _POP_POWER_LIMIT_EXTENSION * PowerLimitExtension;// Offset=0x48 Size=0x8
    struct _LIST_ENTRY Volume;// Offset=0x50 Size=0x10
    union _unnamed_1929 Specific;// Offset=0x60 Size=0x8
};
