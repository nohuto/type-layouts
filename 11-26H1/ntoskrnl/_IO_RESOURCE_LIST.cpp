...
struct _unnamed_356// Size=0x18 (Id=356)
{
...
struct _unnamed_362// Size=0x10 (Id=362)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
union _unnamed_368// Size=0x18 (Id=368)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_356 Port;// Offset=0x0 Size=0x18
        struct _unnamed_356 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_358 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_359 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_360 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_356 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_361 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_362 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_363 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_364 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_365 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_366 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_367 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=369)
{
    ...
    union _unnamed_368 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=321)
{
