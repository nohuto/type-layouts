...
struct _ALPC_PORT_ATTRIBUTES// Size=0x48 (Id=1294)
{
...
struct _unnamed_1018// Size=0x4 (Id=1018)
{
...
union _unnamed_1019// Size=0x4 (Id=1019)
{
    struct _unnamed_1018 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

struct _ALPC_PORT// Size=0x1d8 (Id=1020)
{
    ...
    struct _KQUEUE * CompletionPort;// Offset=0x20 Size=0x8
    ...
    union _unnamed_1019 u1;// Offset=0x1a0 Size=0x4
