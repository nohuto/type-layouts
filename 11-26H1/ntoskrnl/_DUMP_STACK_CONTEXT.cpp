...
struct _unnamed_2495// Size=0x8 (Id=2495)
{
...
struct _unnamed_2496// Size=0x10 (Id=2496)
{
    struct _GUID DiskId;// Offset=0x0 Size=0x10
};

union _unnamed_2497// Size=0x10 (Id=2497)
{
    struct _unnamed_2495 Mbr;// Offset=0x0 Size=0x8
    struct _unnamed_2496 Gpt;// Offset=0x0 Size=0x10
};

struct _DUMP_INITIALIZATION_CONTEXT// Size=0x108 (Id=2499)
{
    ...
    unsigned char InitDumpStackInvoked;// Offset=0x6b Size=0x1
    ...
    union _unnamed_2497 DiskInfo;// Offset=0x8c Size=0x10
...
struct _DUMP_STACK_CONTEXT// Size=0x178 (Id=2437)
{
    ...
    union // Size=0x8 (Id=0)
    {
        ...
        void * StorageInfo;// Offset=0x110 Size=0x8
    };
    unsigned char UseStorageInfo;// Offset=0x118 Size=0x1
    unsigned long PointersLength;// Offset=0x11c Size=0x4
