struct _PROFILE_PARAMETER_BLOCK// Size=0x10 (Id=2588)
{
...
struct _LOADER_PERFORMANCE_DATA// Size=0x60 (Id=2555)
{
...
struct _LOADER_PARAMETER_HYPERVISOR_EXTENSION// Size=0x40 (Id=2582)
{
...
struct _LOADER_BUGCHECK_PARAMETERS// Size=0x28 (Id=2429)
{
...
struct _OFFLINE_CRASHDUMP_CONFIGURATION_TABLE_V2// Size=0x20 (Id=2514)
{
...
struct _LOADER_HIVE_RECOVERY_INFO// Size=0x14 (Id=2474)
{
...
struct _unnamed_2393// Size=0x10 (Id=2393)
{
    void * CodeBase;// Offset=0x0 Size=0x8
    unsigned long long CodeSize;// Offset=0x8 Size=0x8
};

struct _VSM_PERFORMANCE_DATA// Size=0x40 (Id=2462)
{
...
struct _LOADER_FEATURE_CONFIGURATION_INFORMATION// Size=0x48 (Id=2413)
{
...
enum _TYPE_OF_MEMORY
{
    ...
    LoaderReserve=47,
    LoaderSimulatedFragment=48,
    LoaderMaximum=49
};

struct _OSLOADER_PAGE_TABLE_LOG// Size=0x28 (Id=2577)
{
...
struct _LOADER_BOOT_APPLICATION_SVN_INFORMATION// Size=0x10 (Id=2599)
{
    union _LARGE_INTEGER BootStlCreationTime;// Offset=0x0 Size=0x8
    unsigned long HiberrsmMinSvn;// Offset=0x8 Size=0x4
};

struct _LOADER_PARAMETER_EXTENSION// Size=0x1150 (Id=2395)
{
    ...
    union // Size=0x8 (Id=0)
    {
        ...
        struct // Size=0x8 (Id=0)
        {
            ...
            unsigned long long DbgDeferHwInit:1;// Offset=0xa58 Size=0x8 BitOffset=0x11 BitSize=0x1
            unsigned long long DbgPreBoot:1;// Offset=0xa58 Size=0x8 BitOffset=0x12 BitSize=0x1
        };
    };
    union // Size=0x8 (Id=0)
    {
    ...
    struct _unnamed_2393 MiniExecutive;// Offset=0xdb0 Size=0x10
    ...
    struct _unnamed_2394 InstalledMemory;// Offset=0xeb8 Size=0x10
    ...
    unsigned long Reserved3[4];// Offset=0xee4 Size=0x10
    void * Reserved4;// Offset=0xef8 Size=0x8
    unsigned long Reserved5[2];// Offset=0xf00 Size=0x8
    ...
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long EnableFred:1;// Offset=0xf10 Size=0x4 BitOffset=0x2 BitSize=0x1
        unsigned long BootGraphicsDisabled:1;// Offset=0xf10 Size=0x4 BitOffset=0x3 BitSize=0x1
        unsigned long Unused2:4;// Offset=0xf10 Size=0x4 BitOffset=0x4 BitSize=0x4
    ...
    struct _BOOT_OSL_RAMDISK_INFO_V2 * OslRamdiskInfo;// Offset=0xf60 Size=0x8
    void * Reserved6;// Offset=0xf68 Size=0x8
    unsigned long Reserved7;// Offset=0xf70 Size=0x4
    ...
    struct _PREBOOT_CONTEXT * OslPreBootContext;// Offset=0x1120 Size=0x8
    struct _BOOT_LAYER_INFORMATION * RootBootLayer;// Offset=0x1128 Size=0x8
    void * KernelKsrData;// Offset=0x1130 Size=0x8
    unsigned long long HalEarlyTestHooks;// Offset=0x1138 Size=0x8
    struct _LOADER_BOOT_APPLICATION_SVN_INFORMATION BootAppSvnInfo;// Offset=0x1140 Size=0x10
};
