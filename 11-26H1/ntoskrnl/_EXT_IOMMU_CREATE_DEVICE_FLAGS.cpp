union _EXT_IOMMU_CREATE_DEVICE_FLAGS// Size=0x4 (Id=320)
{
    ...
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned int AlwaysBlockDefaultDma:1;// Offset=0x0 Size=0x4 BitOffset=0x4 BitSize=0x1
        unsigned int Reserved:27;// Offset=0x0 Size=0x4 BitOffset=0x5 BitSize=0x1b
    };
};
