...
struct _HAL_HV_DMA_DOMAIN_CONFIG_ARM64// Size=0x20 (Id=456)
{
    ...
    unsigned char Blocked;// Offset=0x1e Size=0x1
};

struct _HAL_HV_DMA_DOMAIN_CONFIG_X64// Size=0x10 (Id=354)
{
...
struct _HAL_HV_DMA_DOMAIN_CONFIG// Size=0x28 (Id=315)
{
