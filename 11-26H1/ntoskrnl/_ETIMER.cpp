...
struct _ETIMER// Size=0x150 (Id=1876)
{
    struct _KTIMER KeTimer;// Offset=0x0 Size=0x40
    unsigned long long Lock;// Offset=0x40 Size=0x8
    struct _KAPC TimerApc;// Offset=0x48 Size=0x58
    struct _KDPC TimerDpc;// Offset=0xa0 Size=0x40
    struct _LIST_ENTRY ActiveTimerListEntry;// Offset=0xe0 Size=0x10
    unsigned long Period;// Offset=0xf0 Size=0x4
    unsigned long PeriodTimerDelay;// Offset=0xf4 Size=0x4
    unsigned char DueTimeType;// Offset=0xf8 Size=0x1
    unsigned char Spare2[7];// Offset=0xf9 Size=0x7
    struct _DIAGNOSTIC_CONTEXT * WakeReason;// Offset=0x100 Size=0x8
    struct _LIST_ENTRY WakeTimerListEntry;// Offset=0x108 Size=0x10
    void * VirtualizedTimerCookie;// Offset=0x118 Size=0x8
    struct _LIST_ENTRY VirtualizedTimerLinks;// Offset=0x120 Size=0x10
    union // Size=0x1 (Id=0)
    {
        char TimerFlags;// Offset=0x130 Size=0x1
        struct // Size=0x1 (Id=0)
        {
            unsigned char ApcAssociated:1;// Offset=0x130 Size=0x1 BitOffset=0x0 BitSize=0x1
            unsigned char Paused:1;// Offset=0x130 Size=0x1 BitOffset=0x1 BitSize=0x1
            unsigned char WakeImportant:1;// Offset=0x130 Size=0x1 BitOffset=0x2 BitSize=0x1
            unsigned char Spare1:5;// Offset=0x130 Size=0x1 BitOffset=0x3 BitSize=0x5
        };
    };
    unsigned char Spare3[7];// Offset=0x131 Size=0x7
    unsigned long long DueTime;// Offset=0x138 Size=0x8
    unsigned long CoalescingWindow;// Offset=0x140 Size=0x4
    unsigned long Spare4[2];// Offset=0x144 Size=0x8
};
