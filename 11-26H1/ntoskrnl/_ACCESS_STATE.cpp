...
struct _INITIAL_PRIVILEGE_SET// Size=0x2c (Id=431)
{
...
struct _PRIVILEGE_SET// Size=0x14 (Id=430)
{
    unsigned long PrivilegeCount;// Offset=0x0 Size=0x4
    unsigned long Control;// Offset=0x4 Size=0x4
...
union _unnamed_378// Size=0x2c (Id=378)
{
...
struct _ACCESS_STATE// Size=0xa0 (Id=379)
{
    ...
    union _unnamed_378 Privileges;// Offset=0x50 Size=0x2c
