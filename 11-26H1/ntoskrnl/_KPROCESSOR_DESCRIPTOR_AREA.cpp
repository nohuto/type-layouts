...
struct _unnamed_1620// Size=0x4 (Id=1620)
{
...
struct _unnamed_1621// Size=0x4 (Id=1621)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1622// Size=0x4 (Id=1622)
{
    struct _unnamed_1620 Bytes;// Offset=0x0 Size=0x4
    struct _unnamed_1621 Bits;// Offset=0x0 Size=0x4
};

struct _KLDTENTRY// Size=0x8 (Id=1623)
{
    unsigned short LimitLow;// Offset=0x0 Size=0x2
    unsigned short BaseLow;// Offset=0x2 Size=0x2
    union _unnamed_1622 HighWord;// Offset=0x4 Size=0x4
};
...
struct _KPROCESSOR_DESCRIPTOR_AREA// Size=0x5000 (Id=773)
{
