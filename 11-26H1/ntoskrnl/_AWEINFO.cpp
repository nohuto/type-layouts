...
struct _EX_PUSH_LOCK_AUTO_EXPAND_STATE// Size=0x4 (Id=1207)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _EX_PUSH_LOCK_AUTO_EXPAND// Size=0x10 (Id=651)
{
...
struct _AWEINFO// Size=0x80 (Id=2491)
{
    ...
    struct _MI_QUOTA_TRACKER QuotaTracker;// Offset=0x38 Size=0x1
