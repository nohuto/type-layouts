...
struct _unnamed_2051// Size=0x8 (Id=2051)
{
...
struct _unnamed_2052// Size=0x10 (Id=2052)
{
    union _LARGE_INTEGER Base;// Offset=0x0 Size=0x8
    unsigned long long Size;// Offset=0x8 Size=0x8
};

struct _unnamed_2053// Size=0x10 (Id=2053)
{
    unsigned long long * PageFrame;// Offset=0x0 Size=0x8
    unsigned long long NumberOfPages;// Offset=0x8 Size=0x8
};

struct _IOMMU_MAP_PHYSICAL_ADDRESS// Size=0x18 (Id=2054)
{
    enum _IOMMU_MAP_PHYSICAL_ADDRESS_TYPE MapType;// Offset=0x0 Size=0x4
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_2051 Mdl;// Offset=0x8 Size=0x8
        struct _unnamed_2052 ContiguousRange;// Offset=0x8 Size=0x10
        struct _unnamed_2053 PfnArray;// Offset=0x8 Size=0x10
    };
};
