...
struct _LOG_HANDLE_CONTEXT// Size=0x98 (Id=1326)
{
...
struct _CC_VOLUME_TELEMETRY// Size=0x9b0 (Id=2109)
{
...
struct _KE_RCU_WORKITEM// Size=0x30 (Id=1259)
{
    unsigned long long Placeholder[6];// Offset=0x0 Size=0x30
};

struct _VOLUME_CACHE_MAP// Size=0xac8 (Id=884)
{
