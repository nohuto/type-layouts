...
struct _LOADER_PARAMETER_CI_EXTENSION// Size=0x88 (Id=2572)
{
    ...
    unsigned long Reserved2;// Offset=0x7c Size=0x4
    unsigned char SerializedData[1];// Offset=0x80 Size=0x1
};
