struct _unnamed_1007// Size=0x4 (Id=1007)
{
...
union _unnamed_1008// Size=0x4 (Id=1008)
{
    struct _unnamed_1007 s1;// Offset=0x0 Size=0x4
};
...
struct _KALPC_SECTION// Size=0x48 (Id=1009)
{
    ...
    union _unnamed_1008 u1;// Offset=0x30 Size=0x4
