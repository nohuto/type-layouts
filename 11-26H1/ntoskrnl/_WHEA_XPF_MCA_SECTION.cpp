...
struct _MCI_STATUS_BITS_COMMON// Size=0x8 (Id=398)
{
...
struct _MCI_STATUS_AMD_BITS// Size=0x8 (Id=439)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long McaErrorCode:16;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x10
...
struct _MCI_STATUS_INTEL_BITS// Size=0x8 (Id=342)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long McaErrorCode:16;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x10
...
union _MCI_STATUS// Size=0x8 (Id=332)
{
...
struct _WHEA_AMD_EXTENDED_REGISTERS// Size=0xc0 (Id=306)
{
...
union _MCG_CAP// Size=0x8 (Id=268)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WHEA_XPF_MCA_SECTION// Size=0x828 (Id=200)
{
