...
struct _unnamed_517// Size=0x10 (Id=517)
{
    unsigned long long Reserved[2];// Offset=0x0 Size=0x10
};

union _INVPCID_DESCRIPTOR// Size=0x10 (Id=518)
{
    struct _unnamed_515 IndividualAddress;// Offset=0x0 Size=0x10
    struct _unnamed_516 SingleContext;// Offset=0x0 Size=0x10
    struct _unnamed_517 AllContextAndGlobals;// Offset=0x0 Size=0x10
    struct _unnamed_517 AllContext;// Offset=0x0 Size=0x10
};
