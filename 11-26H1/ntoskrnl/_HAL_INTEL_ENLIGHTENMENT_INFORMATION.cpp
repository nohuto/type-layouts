struct _HAL_INTEL_ENLIGHTENMENT_INFORMATION// Size=0x280 (Id=274)
{
    ...
    long  ( * GetMachineCheckContext)(unsigned long ,unsigned int * ,unsigned long long * ,unsigned long long * ,unsigned int * );// Offset=0x98 Size=0x8
    ...
    long  ( * SetPasidAddressSpace)(unsigned long ,unsigned long ,void * );// Offset=0x110 Size=0x8
    ...
    unsigned char  ( * ShouldUseSyntheticClusterIpi)();// Offset=0x270 Size=0x8
    long  ( * GetTrustedIoStatus)(unsigned char * ,unsigned char * );// Offset=0x278 Size=0x8
};
