union _KI_PROCESS_CONCURRENCY_COUNT// Size=0x4 (Id=2374)
{
...
struct _KI_IDEAL_PROCESSOR_ASSIGNMENT_BLOCK// Size=0x1d8 (Id=2009)
{
    ...
    union _unnamed_2008 AssignmentFlags;// Offset=0xc Size=0x4
