...
struct _MMVAD_SHORT// Size=0x48 (Id=707)
{
    union // Size=0x10 (Id=0)
    {
    ...
    union _unnamed_705 u;// Offset=0x30 Size=0x4
    unsigned long CommitCharge;// Offset=0x34 Size=0x4
    union _unnamed_706 u5;// Offset=0x38 Size=0x8
    long SpinLock;// Offset=0x40 Size=0x4
    struct _MI_QUOTA_TRACKER QuotaTracker;// Offset=0x44 Size=0x1
};

struct _MMVAD_FLAGS2// Size=0x4 (Id=2181)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _MMVAD// Size=0x90 (Id=2164)
{
    struct _MMVAD_SHORT Core;// Offset=0x0 Size=0x48
    struct _MMVAD_FLAGS2 VadFlags2;// Offset=0x48 Size=0x4
    struct _SUBSECTION * Subsection;// Offset=0x50 Size=0x8
    struct _MMPTE * FirstPrototypePte;// Offset=0x58 Size=0x8
    struct _MMPTE * LastContiguousPte;// Offset=0x60 Size=0x8
    struct _LIST_ENTRY ViewLinks;// Offset=0x68 Size=0x10
    struct _EPROCESS * VadsProcess;// Offset=0x78 Size=0x8
    union _unnamed_2163 u4;// Offset=0x80 Size=0x8
    struct _FILE_OBJECT * FileObject;// Offset=0x88 Size=0x8
};
