...
struct _RTL_STACKDB_CONTEXT// Size=0x48 (Id=924)
{
    ...
    struct _EX_PUSH_LOCK StackEntryTableLock;// Offset=0x20 Size=0x8
    struct _EX_PUSH_LOCK SegmentTableLock;// Offset=0x28 Size=0x8
