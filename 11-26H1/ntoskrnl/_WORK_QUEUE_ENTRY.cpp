...
struct _unnamed_893// Size=0x30 (Id=893)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
struct _unnamed_894// Size=0x70 (Id=894)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
struct _unnamed_895// Size=0x40 (Id=895)
{
...
union _unnamed_896// Size=0x70 (Id=896)
{
    union // Size=0x70 (Id=0)
    {
        struct _unnamed_889 Read;// Offset=0x0 Size=0x10
        struct _unnamed_890 Write;// Offset=0x0 Size=0x8
        struct _unnamed_891 Event;// Offset=0x0 Size=0x8
        struct _unnamed_892 Notification;// Offset=0x0 Size=0x4
        struct _unnamed_893 LowPriWrite;// Offset=0x0 Size=0x30
        struct _unnamed_894 AsyncRead;// Offset=0x0 Size=0x70
        struct _unnamed_895 AsyncWriteBehind;// Offset=0x0 Size=0x40
    };
};
...
struct _WORK_QUEUE_ENTRY// Size=0xa0 (Id=898)
{
    struct _LIST_ENTRY WorkQueueLinks;// Offset=0x0 Size=0x10
    union _unnamed_896 Parameters;// Offset=0x10 Size=0x70
