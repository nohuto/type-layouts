...
struct _HEAP_LFH_BLOCK_SLIST// Size=0x2 (Id=939)
{
    unsigned short Next;// Offset=0x0 Size=0x2
};

union _HEAP_LFH_BLOCK_LIST// Size=0x4 (Id=938)
{
    unsigned short Next;// Offset=0x0 Size=0x2
...
union _HEAP_LFH_SUBSEGMENT_STATE// Size=0x8 (Id=936)
{
...
union _HEAP_LFH_COMMIT_UNIT_INFO// Size=0x2 (Id=944)
{
...
struct _HEAP_LFH_SUBSEGMENT_ENCODED_OFFSETS// Size=0x4 (Id=941)
{
    union // Size=0x4 (Id=0)
    {
...
union _HEAP_LFH_SUBSEGMENT_UCHAR_FIELDS// Size=0x1 (Id=943)
{
...
struct _HEAP_LFH_SUBSEGMENT// Size=0x48 (Id=940)
{
