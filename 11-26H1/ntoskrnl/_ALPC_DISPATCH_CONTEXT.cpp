...
struct _ALPC_DISPATCH_CONTEXT// Size=0x40 (Id=1030)
{
    ...
    unsigned char SignalCompletion;// Offset=0x38 Size=0x1
    unsigned char PostedToCompletionList;// Offset=0x39 Size=0x1
};
