...
struct _PAGEFAULT_HISTORY// Size=0x40 (Id=1862)
{
    union _PSP_FAULT_COUNTER Faults;// Offset=0x0 Size=0x4
    unsigned long long MissCount;// Offset=0x8 Size=0x8
    struct _KGATE WakeGate;// Offset=0x10 Size=0x18
    struct _PSP_WS_WATCH_INFORMATION WatchInfo[1];// Offset=0x28 Size=0x18
};
