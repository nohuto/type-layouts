...
struct _KAB_UM_PROCESS_CONTEXT// Size=0x10 (Id=1234)
{
...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=1318)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _KGROUP_MASK// Size=0x10 (Id=1199)
{
    unsigned long long Masks[2];// Offset=0x0 Size=0x10
};

union _KSTACK_COUNT// Size=0x4 (Id=536)
{
...
struct _unnamed_538// Size=0x8 (Id=538)
{
...
union _KPROCESS_SECURE_STATE// Size=0x8 (Id=539)
{
    unsigned long long EntireField;// Offset=0x0 Size=0x8
    struct _unnamed_538 Flags;// Offset=0x0 Size=0x8
    struct // Size=0x8 (Id=0)
    {
...
struct _KPROCESS// Size=0x1c8 (Id=537)
{
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=1890)
{
...
struct _ALPC_PROCESS_CONTEXT// Size=0x20 (Id=1559)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=1506)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=1811)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WNF_STATE_NAME// Size=0x8 (Id=1129)
{
    unsigned long Data[2];// Offset=0x0 Size=0x8
};

struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=1440)
{
    unsigned long HighEdgeFilter;// Offset=0x0 Size=0x4
    unsigned long LowEdgeFilter;// Offset=0x4 Size=0x4
};

struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=1411)
{
...
struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=1473)
{
    struct _RTL_AVL_TREE Tree;// Offset=0x0 Size=0x8
    struct _EX_PUSH_LOCK Lock;// Offset=0x8 Size=0x8
};

struct _PSP_SYSCALL_PROVIDER_DISPATCH_CONTEXT// Size=0x8 (Id=1788)
{
...
struct _unnamed_564// Size=0x4 (Id=564)
{
    struct // Size=0x4 (Id=0)
    {
...
union _PROCESS_EXECUTION_TRANSITION// Size=0x2 (Id=2268)
{
...
union _PROCESS_EXECUTION_STATE// Size=0x1 (Id=1739)
{
...
union _PROCESS_EXECUTION// Size=0x4 (Id=1712)
{
...
struct _EPROCESS_POWER_THROTTLING_STATE// Size=0x8 (Id=1823)
{
    unsigned long ControlMask;// Offset=0x0 Size=0x4
    unsigned long StateMask;// Offset=0x4 Size=0x4
};

struct _EPROCESS// Size=0x840 (Id=565)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_560 MitigationFlagsValues;// Offset=0x750 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x754 Size=0x4
        struct _unnamed_561 MitigationFlags2Values;// Offset=0x754 Size=0x4
    };
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_563 MitigationFlags3Values;// Offset=0x7d8 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_564 SyscallUsageValues;// Offset=0x7e0 Size=0x4
    };
