...
struct _KPRIQUEUE// Size=0x2b0 (Id=1718)
{
...
struct _EX_WORK_QUEUE// Size=0x2f0 (Id=1722)
{
    ...
    unsigned long SubQueueIndex;// Offset=0x2d8 Size=0x4
    struct _KEVENT * AllThreadsExitedEvent;// Offset=0x2e0 Size=0x8
    struct _EX_WORK_QUEUE_HEALTH_METRICS * HealthMetrics;// Offset=0x2e8 Size=0x8
};
