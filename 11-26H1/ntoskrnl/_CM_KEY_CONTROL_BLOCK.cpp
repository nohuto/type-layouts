struct _CM_PATH_HASH// Size=0x4 (Id=1300)
{
    unsigned long Hash;// Offset=0x0 Size=0x4
};

struct _CM_KEY_HASH// Size=0x20 (Id=1520)
{
...
struct _CM_KEY_CONTROL_BLOCK// Size=0x138 (Id=721)
{
    ...
    unsigned short TotalLevels;// Offset=0xc Size=0x2
    ...
    union // Size=0x1 (Id=0)
    {
        ...
        unsigned char DelayFlags;// Offset=0x40 Size=0x1
    };
