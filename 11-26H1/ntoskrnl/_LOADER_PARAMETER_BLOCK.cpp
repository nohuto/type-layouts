...
struct _EFI_FIRMWARE_INFORMATION// Size=0x38 (Id=2559)
{
...
struct _PCAT_FIRMWARE_INFORMATION// Size=0x4 (Id=2573)
{
    unsigned long PlaceHolder;// Offset=0x0 Size=0x4
};

union _unnamed_2475// Size=0x38 (Id=2475)
{
...
struct _FIRMWARE_INFORMATION_LOADER_BLOCK// Size=0x40 (Id=2476)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long Reserved2:28;// Offset=0x0 Size=0x4 BitOffset=0x4 BitSize=0x1c
    };
    union _unnamed_2475 u;// Offset=0x8 Size=0x38
};
...
struct _LOADER_PARAMETER_BLOCK// Size=0x170 (Id=2226)
{
    ...
    union _unnamed_2225 u;// Offset=0xf8 Size=0x10
