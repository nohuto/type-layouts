...
union _unnamed_414// Size=0x8 (Id=414)
{
...
struct _GROUP_FAULT_REFERENCE// Size=0x8 (Id=415)
{
    union _unnamed_414 u1;// Offset=0x0 Size=0x8
};

struct _IOMMU_TRACKED_DEVICE// Size=0x1058 (Id=296)
{
