...
struct _KTIMER2// Size=0x88 (Id=1558)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    ...
    union // Size=0x1 (Id=0)
    {
        ...
        struct // Size=0x1 (Id=0)
        {
            ...
            unsigned char RestrictedStandbyResilient:1;// Offset=0x81 Size=0x1 BitOffset=0x5 BitSize=0x1
...
struct _EX_WORK_QUEUE_MANAGER// Size=0x118 (Id=2580)
{
