...
struct _PO_FX_COMPONENT_PERF_SET// Size=0x30 (Id=2619)
{
    ...
    {
        struct _unnamed_2617 Discrete;// Offset=0x20 Size=0x10
        struct _unnamed_2618 Range;// Offset=0x20 Size=0x10
    };
};
