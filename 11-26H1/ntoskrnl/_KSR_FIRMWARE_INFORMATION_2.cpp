union _KSR_CAPABILITIES// Size=0x4 (Id=1728)
{
...
struct _VIRTUAL_EFI_RUNTIME_SERVICES// Size=0x70 (Id=1472)
{
...
union _KSR_FLAGS// Size=0x4 (Id=1685)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _KSR_FIRMWARE_INFORMATION// Size=0x150 (Id=828)
{
