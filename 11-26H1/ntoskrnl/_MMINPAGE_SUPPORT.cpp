...
struct _SLIST_ENTRY// Size=0x10 (Id=547)
{
...
struct _unnamed_695// Size=0x30 (Id=695)
{
    struct _KAPC_STATE ApcState;// Offset=0x0 Size=0x30
};

struct _MI_STORE_INPAGE_COMPLETE_FLAGS// Size=0x4 (Id=2034)
{
    union // Size=0x4 (Id=0)
    {
...
struct _MMINPAGE_FLAGS// Size=0x4 (Id=701)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long GuardedRegionRequired:1;// Offset=0x0 Size=0x4 BitOffset=0x1c BitSize=0x1
...
struct _unnamed_698// Size=0x20 (Id=698)
{
    struct _MMPAGING_FILE * PagingFile;// Offset=0x0 Size=0x8
    struct _RTL_BALANCED_NODE FlowThroughNode;// Offset=0x8 Size=0x18
};

struct _unnamed_699// Size=0x20 (Id=699)
{
    struct _SUBSECTION * Subsection;// Offset=0x0 Size=0x8
    struct _FILE_OBJECT * FilePointer;// Offset=0x8 Size=0x8
    struct _MDL * PrefetchMdl;// Offset=0x10 Size=0x8
    unsigned long ImagePteOffset;// Offset=0x18 Size=0x4
};
...
struct _MMINPAGE_SUPPORT// Size=0x1c0 (Id=700)
{
    ...
    {
        struct _unnamed_695 DuringIo;// Offset=0x68 Size=0x30
        struct _unnamed_696 DuringCompletion;// Offset=0x68 Size=0x10
    };
    ...
    union _unnamed_697 u1;// Offset=0xbc Size=0x4
    union // Size=0x20 (Id=0)
    {
        struct _unnamed_698 Pf;// Offset=0xc0 Size=0x20
        struct _unnamed_699 Fs;// Offset=0xc0 Size=0x20
    };
    void * AutoBoostLock;// Offset=0xe0 Size=0x8
    void * FaultingAddress;// Offset=0xe8 Size=0x8
    struct _MMPTE * PointerPte;// Offset=0xf0 Size=0x8
    struct _MMPTE * BasePte;// Offset=0xf8 Size=0x8
    struct _MMPFN * Pfn;// Offset=0x100 Size=0x8
    ...
    union // Size=0x80 (Id=0)
    {
        ...
        struct _MMINPAGE_SUPPORT_FLOW_THROUGH FlowThrough;// Offset=0x140 Size=0x10
    };
};
