union _KPRCBFLAG// Size=0x4 (Id=1551)
{
...
struct _KDESCRIPTOR// Size=0x10 (Id=388)
{
...
struct _KSPECIAL_REGISTERS// Size=0x110 (Id=327)
{
...
struct _CONTEXT// Size=0x4d0 (Id=257)
{
...
union _KPRCB_BPB_FEATURES// Size=0x1 (Id=1911)
{
...
union _KPRCB_BPB_RETPOLINE_STATE// Size=0x1 (Id=1582)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _PP_LOOKASIDE_LIST// Size=0x10 (Id=544)
{
...
struct _KSTATIC_AFFINITY_BLOCK// Size=0x820 (Id=1130)
{
...
struct _KSOFTWARE_INTERRUPT_BATCH// Size=0x210 (Id=1475)
{
...
struct _KDPC_DATA// Size=0x30 (Id=1144)
{
...
struct _KE_PRCB_RCU_DATA// Size=0x20 (Id=1897)
{
...
struct _KTIMER_TABLE_ENTRY// Size=0x20 (Id=768)
{
...
struct _KMCE_RECOVERY_CONTEXT// Size=0x10 (Id=1550)
{
...
struct _PROC_IDLE_POLICY// Size=0x6 (Id=2408)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=1892)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=2021)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=2043)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=2357)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROC_PERF_CHECK_CONTEXT// Size=0x48 (Id=2122)
{
...
struct _PROCESSOR_POWER_STATE// Size=0x268 (Id=1895)
{
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=1645)
{
    unsigned char Level;// Offset=0x0 Size=0x1
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=746)
{
...
struct _unnamed_513// Size=0x38 (Id=513)
{
...
struct _SYMCRYPT_ENTROPY_ACCUMULATOR_STATE// Size=0x180 (Id=1637)
{
...
struct _IOP_IRP_STACK_PROFILER// Size=0x54 (Id=1978)
{
    unsigned long Profile[20];// Offset=0x0 Size=0x50
    unsigned long TotalIrps;// Offset=0x50 Size=0x4
};

struct _KSECURE_FAULT_INFORMATION// Size=0x18 (Id=1403)
{
...
struct _KTIMER_EXPIRATION_TRACE// Size=0x10 (Id=2015)
{
...
struct _KCLOCK_TIMER_DEADLINE_ENTRY// Size=0x10 (Id=1479)
{
...
struct _KCLOCK_TICK_TRACE// Size=0x28 (Id=1305)
{
...
struct _KCLOCK_INCREMENT_TRACE// Size=0x20 (Id=2135)
{
...
struct _KCLOCK_TIMER_STATE// Size=0x518 (Id=1191)
{
...
struct _MACHINE_FRAME// Size=0x28 (Id=2407)
{
...
struct _MACHINE_CHECK_CONTEXT// Size=0x50 (Id=1854)
{
...
struct _KPRCB// Size=0xcf00 (Id=514)
{
    ...
    struct _unnamed_513 StibpPairingTrace;// Offset=0x9178 Size=0x38
    ...
    struct _KDPC FreezeForRecoveryDpc;// Offset=0x9f10 Size=0x40
