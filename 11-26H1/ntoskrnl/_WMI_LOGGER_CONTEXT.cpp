...
struct _ETW_BUFFER_QUEUE// Size=0x10 (Id=1072)
{
...
struct _ETW_REF_CLOCK// Size=0x10 (Id=1701)
{
...
struct _SECURITY_CLIENT_CONTEXT// Size=0x48 (Id=1452)
{
...
struct _DISALLOWED_GUIDS// Size=0x10 (Id=1688)
{
...
struct _ETW_PARTITION_CONTEXT// Size=0x8 (Id=1240)
{
    struct _EPARTITION * Partition;// Offset=0x0 Size=0x8
};

struct _WMI_LOGGER_CONTEXT// Size=0x650 (Id=1070)
{
