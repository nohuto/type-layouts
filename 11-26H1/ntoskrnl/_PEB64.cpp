...
struct _STRING64// Size=0x10 (Id=1838)
{
...
struct _PEB64// Size=0x7d8 (Id=2030)
{
    ...
    unsigned long long Mutant;// Offset=0x8 Size=0x8
    unsigned long long ImageBaseAddress;// Offset=0x10 Size=0x8
    unsigned long long Ldr;// Offset=0x18 Size=0x8
    unsigned long long ProcessParameters;// Offset=0x20 Size=0x8
    unsigned long long SubSystemData;// Offset=0x28 Size=0x8
    unsigned long long ProcessHeap;// Offset=0x30 Size=0x8
    unsigned long long FastPebLock;// Offset=0x38 Size=0x8
    unsigned long long AtlThunkSListPtr;// Offset=0x40 Size=0x8
    unsigned long long IFEOKey;// Offset=0x48 Size=0x8
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long ProcessImagesHotPatched:1;// Offset=0x50 Size=0x4 BitOffset=0x7 BitSize=0x1
            unsigned long ReservedBits0:24;// Offset=0x50 Size=0x4 BitOffset=0x8 BitSize=0x18
        };
    };
    unsigned char Padding1[4];// Offset=0x54 Size=0x4
    union // Size=0x8 (Id=0)
    {
        unsigned long long KernelCallbackTable;// Offset=0x58 Size=0x8
        unsigned long long UserSharedInfoPtr;// Offset=0x58 Size=0x8
    };
    unsigned long SystemReserved;// Offset=0x60 Size=0x4
    unsigned long AtlThunkSListPtr32;// Offset=0x64 Size=0x4
    unsigned long long ApiSetMap;// Offset=0x68 Size=0x8
    unsigned long TlsExpansionCounter;// Offset=0x70 Size=0x4
    unsigned char Padding2[4];// Offset=0x74 Size=0x4
    unsigned long long TlsBitmap;// Offset=0x78 Size=0x8
    unsigned long TlsBitmapBits[2];// Offset=0x80 Size=0x8
    unsigned long long ReadOnlySharedMemoryBase;// Offset=0x88 Size=0x8
    unsigned long long SharedData;// Offset=0x90 Size=0x8
    unsigned long long ReadOnlyStaticServerData;// Offset=0x98 Size=0x8
    unsigned long long AnsiCodePageData;// Offset=0xa0 Size=0x8
    unsigned long long OemCodePageData;// Offset=0xa8 Size=0x8
    unsigned long long UnicodeCaseTableData;// Offset=0xb0 Size=0x8
    ...
    unsigned long long ProcessHeaps;// Offset=0xf0 Size=0x8
    unsigned long long GdiSharedHandleTable;// Offset=0xf8 Size=0x8
    unsigned long long ProcessStarterHelper;// Offset=0x100 Size=0x8
    unsigned long GdiDCAttributeList;// Offset=0x108 Size=0x4
    unsigned char Padding3[4];// Offset=0x10c Size=0x4
    unsigned long long LoaderLock;// Offset=0x110 Size=0x8
    ...
    unsigned long long PostProcessInitRoutine;// Offset=0x230 Size=0x8
    unsigned long long TlsExpansionBitmap;// Offset=0x238 Size=0x8
    ...
    unsigned long long pShimData;// Offset=0x2d8 Size=0x8
    unsigned long long AppCompatInfo;// Offset=0x2e0 Size=0x8
    struct _STRING64 CSDVersion;// Offset=0x2e8 Size=0x10
    unsigned long long ActivationContextData;// Offset=0x2f8 Size=0x8
    unsigned long long ProcessAssemblyStorageMap;// Offset=0x300 Size=0x8
    unsigned long long SystemDefaultActivationContextData;// Offset=0x308 Size=0x8
    unsigned long long SystemAssemblyStorageMap;// Offset=0x310 Size=0x8
    unsigned long long MinimumStackCommit;// Offset=0x318 Size=0x8
    unsigned long long PointerIgnoreBits;// Offset=0x320 Size=0x8
    unsigned long long MemoryTaggingBitMap;// Offset=0x328 Size=0x8
    unsigned long long PatchLoaderData;// Offset=0x330 Size=0x8
    unsigned long long ChpeV2ProcessInfo;// Offset=0x338 Size=0x8
    unsigned long AppModelFeatureState;// Offset=0x340 Size=0x4
    unsigned long SpareUlongs[2];// Offset=0x344 Size=0x8
    unsigned short ActiveCodePage;// Offset=0x34c Size=0x2
    unsigned short OemCodePage;// Offset=0x34e Size=0x2
    unsigned short UseCaseMapping;// Offset=0x350 Size=0x2
    unsigned short UnusedNlsField;// Offset=0x352 Size=0x2
    unsigned long long WerRegistrationData;// Offset=0x358 Size=0x8
    unsigned long long WerShipAssertPtr;// Offset=0x360 Size=0x8
    unsigned long long EcCodeBitMap;// Offset=0x368 Size=0x8
    unsigned long long pImageHeaderHash;// Offset=0x370 Size=0x8
    union // Size=0x4 (Id=0)
    {
    ...
    struct LIST_ENTRY64 TppWorkerpList;// Offset=0x390 Size=0x10
    unsigned long long WaitOnAddressHashTable[128];// Offset=0x3a0 Size=0x400
    unsigned long long TelemetryCoverageHeader;// Offset=0x7a0 Size=0x8
    unsigned long CloudFileFlags;// Offset=0x7a8 Size=0x4
    unsigned long CloudFileDiagFlags;// Offset=0x7ac Size=0x4
    char PlaceholderCompatibilityMode;// Offset=0x7b0 Size=0x1
    char PlaceholderCompatibilityModeReserved[7];// Offset=0x7b1 Size=0x7
    unsigned long long LeapSecondData;// Offset=0x7b8 Size=0x8
    union // Size=0x4 (Id=0)
    {
        unsigned long LeapSecondFlags;// Offset=0x7c0 Size=0x4
        struct // Size=0x4 (Id=0)
        {
            unsigned long SixtySecondEnabled:1;// Offset=0x7c0 Size=0x4 BitOffset=0x0 BitSize=0x1
            unsigned long Reserved:31;// Offset=0x7c0 Size=0x4 BitOffset=0x1 BitSize=0x1f
        };
    };
    unsigned long NtGlobalFlag2;// Offset=0x7c4 Size=0x4
    unsigned long long ExtendedFeatureDisableMask;// Offset=0x7c8 Size=0x8
    unsigned long long Win32ClientProcInfo;// Offset=0x7d0 Size=0x8
};
