...
struct _PO_DEVICE_NOTIFY// Size=0x68 (Id=1308)
{
...
union _unnamed_818// Size=0x8 (Id=818)
{
...
union _unnamed_819// Size=0x8 (Id=819)
{
    struct _DEVICE_NODE * NextResourceDeviceNode;// Offset=0x0 Size=0x8
};

struct _unnamed_821// Size=0x20 (Id=821)
{
...
struct _PO_DIRECTED_DRIPS_STATE// Size=0x38 (Id=1280)
{
...
struct _DEVICE_NODE// Size=0x388 (Id=823)
{
    ...
    union _unnamed_818 OverUsed1;// Offset=0x210 Size=0x8
    union _unnamed_819 OverUsed2;// Offset=0x218 Size=0x8
    ...
    struct _unnamed_821 DockInfo;// Offset=0x238 Size=0x20
