struct _RTLP_HEAP_COMMIT_LIMIT_DATA// Size=0x10 (Id=2359)
{
...
struct _HEAP_OPPORTUNISTIC_LARGE_PAGE_STATS// Size=0x10 (Id=2156)
{
...
struct _RTL_HP_SEG_ALLOC_POLICY// Size=0x18 (Id=1595)
{
...
struct _HEAP_RUNTIME_MEMORY_STATS// Size=0x60 (Id=956)
{
...
struct _RTL_HP_HEAP_VA_CALLBACKS_ENCODED// Size=0x20 (Id=1372)
{
...
union _HEAP_SEG_CONTEXT_FLAGS// Size=0x1 (Id=965)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _HEAP_SEG_CONTEXT// Size=0xc0 (Id=966)
{
...
struct _HEAP_PG_CONTEXT// Size=0x58 (Id=1140)
{
...
struct _HEAP_LFH_CONFIG// Size=0x8 (Id=1401)
{
...
struct _HEAP_LFH_HEAT_MAP// Size=0x100 (Id=933)
{
...
struct _HEAP_LFH_SLOT_MAP// Size=0x100 (Id=930)
{
    unsigned short Map[128];// Offset=0x0 Size=0x100
};

struct _HEAP_LFH_CONTEXT// Size=0x6c0 (Id=931)
{
    void * BackendCtx;// Offset=0x0 Size=0x8
    struct _HEAP_SUBALLOCATOR_CALLBACKS Callbacks;// Offset=0x8 Size=0x38
...
struct _SEGMENT_HEAP// Size=0xa40 (Id=971)
{
