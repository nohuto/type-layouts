...
union _HEAP_SEG_ALLOC_RANGE_FLAGS// Size=0x4 (Id=1161)
{
...
struct _HEAP_DESCRIPTOR_KEY// Size=0x4 (Id=967)
{
    union // Size=0x4 (Id=0)
    {
...
struct _HEAP_PAGE_RANGE_DESCRIPTOR// Size=0x20 (Id=962)
{
    union // Size=0x18 (Id=0)
    {
        ...
        union _HEAP_SEG_ALLOC_RANGE_FLAGS AllocRangeFlags;// Offset=0x8 Size=0x4
        unsigned char RangeFlags;// Offset=0x18 Size=0x1
    };
    unsigned char CommittedPageCount;// Offset=0x19 Size=0x1
    unsigned char UnitOffset;// Offset=0x1a Size=0x1
    unsigned char SuballocatorState;// Offset=0x1b Size=0x1
    union // Size=0x4 (Id=0)
    {
...
union _HEAP_PAGE_SEGMENT// Size=0x2000 (Id=963)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
    unsigned long long Signature;// Offset=0x10 Size=0x8
    union _HEAP_SEGMENT_MGR_COMMIT_STATE * SegmentCommitState;// Offset=0x18 Size=0x8
    unsigned char UnusedWatermark;// Offset=0x20 Size=0x1
    struct _HEAP_PAGE_RANGE_DESCRIPTOR DescArray[256];// Offset=0x0 Size=0x2000
};
