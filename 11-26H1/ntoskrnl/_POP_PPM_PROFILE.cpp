...
struct _POP_PPM_PROFILE// Size=0x5e0 (Id=867)
{
    ...
    struct _PPM_ENGINE_SETTINGS Settings[2];// Offset=0x28 Size=0x590
    unsigned long long StartTime;// Offset=0x5b8 Size=0x8
    unsigned long long Count;// Offset=0x5c0 Size=0x8
    unsigned long long MaxDuration;// Offset=0x5c8 Size=0x8
    unsigned long long MinDuration;// Offset=0x5d0 Size=0x8
    unsigned long long TotalDuration;// Offset=0x5d8 Size=0x8
};
