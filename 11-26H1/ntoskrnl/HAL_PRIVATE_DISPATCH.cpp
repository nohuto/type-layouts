struct HAL_PRIVATE_DISPATCH// Size=0x528 (Id=1394)
{
    ...
    void  ( * HalSaveAndDisableHvEnlightenment)(unsigned char );// Offset=0x210 Size=0x8
    ...
    long  ( * HalGetProcessorId)(unsigned long ,unsigned long * ,unsigned long * );// Offset=0x238 Size=0x8
    ...
    unsigned long  ( * HalTimerQueryAndResetRtcErrors)(unsigned char ,unsigned char );// Offset=0x3b8 Size=0x8
    ...
    unsigned long long  ( * HalTimerWatchdogQueryDueTime)(unsigned char );// Offset=0x3d8 Size=0x8
    ...
    long  ( * HalIommuBlockDevice)(struct _IOMMU_DMA_DEVICE * );// Offset=0x430 Size=0x8
    long  ( * HalIommuUnblockDevice)(struct _EXT_IOMMU_DEVICE_ID * ,struct _DEVICE_OBJECT * ,struct _IOMMU_DMA_DEVICE ** );// Offset=0x438 Size=0x8
    ...
    long  ( * HalTopologyQueryProcessorRelationships)(unsigned long ,unsigned long ,unsigned char * ,unsigned char * ,unsigned char * ,unsigned long * ,unsigned long * );// Offset=0x458 Size=0x8
    void  ( * HalInitPlatformDebugTriggers)();// Offset=0x460 Size=0x8
    void  ( * HalRunPlatformDebugTriggers)(unsigned char );// Offset=0x468 Size=0x8
    void *  ( * HalTimerGetReferencePage)();// Offset=0x470 Size=0x8
    long  ( * HalGetHiddenProcessorPowerInterface)(struct _HIDDEN_PROCESSOR_POWER_INTERFACE * );// Offset=0x478 Size=0x8
    unsigned long  ( * HalGetHiddenProcessorPackageId)(unsigned long );// Offset=0x480 Size=0x8
    unsigned long  ( * HalGetHiddenPackageProcessorCount)(unsigned long );// Offset=0x488 Size=0x8
    long  ( * HalGetHiddenProcessorApicIdByIndex)(unsigned long ,unsigned long * );// Offset=0x490 Size=0x8
    long  ( * HalRegisterHiddenProcessorIdleState)(unsigned long ,unsigned long long );// Offset=0x498 Size=0x8
    void  ( * HalIommuReportIommuFault)(struct _IOMMU_FAULT_SOURCE_ID * ,unsigned long long ,struct _FAULT_INFORMATION * );// Offset=0x4a0 Size=0x8
    unsigned char  ( * HalIommuDmaRemappingCapable)(struct _EXT_IOMMU_DEVICE_ID * ,unsigned long * );// Offset=0x4a8 Size=0x8
    long  ( * HalAllocatePmcCounterSetEx)(unsigned long ,enum _KPROFILE_SOURCE * ,unsigned long ,unsigned long * ,struct _HAL_PMC_COUNTERS ** ,unsigned long * );// Offset=0x4b0 Size=0x8
    long  ( * HalStartProfileInterruptEx)(enum _KPROFILE_SOURCE ,unsigned long * ,unsigned long * ,enum _HAL_PMU_COUNTER_TYPE * ,struct _HAL_PMC_COUNTERS ** );// Offset=0x4b8 Size=0x8
    long  ( * HalGetIommuInterfaceEx)(unsigned long ,unsigned long long ,struct _DMA_IOMMU_INTERFACE_EX * );// Offset=0x4c0 Size=0x8
    void  ( * HalNotifyIommuDomainPolicyChange)(struct _DEVICE_OBJECT * );// Offset=0x4c8 Size=0x8
    unsigned char  ( * HalPciGetDeviceLocationFromPhysicalAddress)(unsigned long long ,unsigned short * ,unsigned char * ,unsigned char * ,unsigned char * );// Offset=0x4d0 Size=0x8
    void  ( * HalInvokeSmc)(unsigned long long ,unsigned long long ,unsigned long long ,unsigned long long ,unsigned long long ,unsigned long long ,unsigned long long ,unsigned long long * ,unsigned long long * ,unsigned long long * ,unsigned long long * );// Offset=0x4d8 Size=0x8
    void  ( * HalInvokeHvc)(unsigned long long ,unsigned long long ,unsigned long long ,unsigned long long ,unsigned long long ,unsigned long long ,unsigned long long ,unsigned long long * ,unsigned long long * ,unsigned long long * ,unsigned long long * );// Offset=0x4e0 Size=0x8
    union _LARGE_INTEGER  ( * HalGetSoftRebootDatabase)();// Offset=0x4e8 Size=0x8
    long  ( * HalRequestPmuAccess)();// Offset=0x4f0 Size=0x8
    long  ( * HalTopologyQueryProcessorCacheInformation)(unsigned long ,unsigned char ,enum _PROCESSOR_CACHE_TYPE ,enum _PROCESSOR_CACHE_TYPE * ,void ** );// Offset=0x4f8 Size=0x8
    void  ( * HalReleasePmuAccessRequest)();// Offset=0x500 Size=0x8
    unsigned long  ( * HalTimerQueryRtcErrors)();// Offset=0x508 Size=0x8
    long  ( * HalExternalPciConfigSpaceAccess)(unsigned char ,void * ,unsigned short ,unsigned char ,unsigned long ,unsigned long ,unsigned long ,unsigned long ,unsigned char * ,unsigned long * );// Offset=0x510 Size=0x8
    unsigned long long  ( * HalTimerQueryInvariantPlatformCounter)(unsigned long long * );// Offset=0x518 Size=0x8
    long  ( * HalLoadSfsUpdate)(void * );// Offset=0x520 Size=0x8
};
