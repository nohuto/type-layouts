...
struct _DEBUG_IOMMU_EFI_DATA// Size=0x10 (Id=2168)
{
    void * PciIoProtocolHandle;// Offset=0x0 Size=0x8
    void * Mapping;// Offset=0x8 Size=0x8
};

struct _DEBUG_DEVICE_DESCRIPTOR// Size=0x110 (Id=1710)
{
    ...
    union // Size=0x1 (Id=0)
    {
        ...
        struct // Size=0x1 (Id=0)
        {
            ...
            unsigned char DbgHostVisibleAllocated:1;// Offset=0x11 Size=0x1 BitOffset=0x5 BitSize=0x1
        };
    };
    ...
    struct _DEBUG_TRANSPORT_DATA TransportData;// Offset=0xf0 Size=0x10
