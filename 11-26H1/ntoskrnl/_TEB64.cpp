struct _NT_TIB64// Size=0x38 (Id=1512)
{
    unsigned long long ExceptionList;// Offset=0x0 Size=0x8
    unsigned long long StackBase;// Offset=0x8 Size=0x8
    unsigned long long StackLimit;// Offset=0x10 Size=0x8
    unsigned long long SubSystemTib;// Offset=0x18 Size=0x8
    union // Size=0x8 (Id=0)
    {
        unsigned long long FiberData;// Offset=0x20 Size=0x8
        unsigned long Version;// Offset=0x20 Size=0x4
    };
    unsigned long long ArbitraryUserPointer;// Offset=0x28 Size=0x8
    unsigned long long Self;// Offset=0x30 Size=0x8
};

struct _CLIENT_ID64// Size=0x10 (Id=1236)
{
    unsigned long long UniqueProcess;// Offset=0x0 Size=0x8
    unsigned long long UniqueThread;// Offset=0x8 Size=0x8
};

struct _ACTIVATION_CONTEXT_STACK64// Size=0x28 (Id=1891)
{
    unsigned long long ActiveFrame;// Offset=0x0 Size=0x8
    struct LIST_ENTRY64 FrameListCache;// Offset=0x8 Size=0x10
    unsigned long Flags;// Offset=0x18 Size=0x4
    unsigned long NextCookieSequenceNumber;// Offset=0x1c Size=0x4
    unsigned long StackId;// Offset=0x20 Size=0x4
};

struct _GDI_TEB_BATCH64// Size=0x4e8 (Id=1276)
{
...
struct _PROCESSOR_NUMBER// Size=0x4 (Id=1273)
{
...
struct _GROUP_AFFINITY64// Size=0x10 (Id=1257)
{
...
struct _TEB64// Size=0x1870 (Id=759)
{
    ...
    unsigned long long SystemReserved1[22];// Offset=0x190 Size=0xb0
    unsigned long ReservedForHeap;// Offset=0x240 Size=0x4
    unsigned long HeapThreadData;// Offset=0x244 Size=0x4
    unsigned long long HeapPgSamplingCount;// Offset=0x248 Size=0x8
    unsigned long long HeapGlobalLock;// Offset=0x250 Size=0x8
    unsigned long long HeapFlsData;// Offset=0x258 Size=0x8
    unsigned long long RngState[4];// Offset=0x260 Size=0x20
    char PlaceholderCompatibilityMode;// Offset=0x280 Size=0x1
    unsigned char PlaceholderHydrationAlwaysExplicit;// Offset=0x281 Size=0x1
    char PlaceholderReserved[10];// Offset=0x282 Size=0xa
    unsigned long ProxiedProcessId;// Offset=0x28c Size=0x4
    struct _ACTIVATION_CONTEXT_STACK64 _ActivationStack;// Offset=0x290 Size=0x28
    ...
    unsigned char UnalignedLoadStoreExceptions;// Offset=0x2ed Size=0x1
    unsigned char Padding1[2];// Offset=0x2ee Size=0x2
    ...
    unsigned long long ChpeV2CpuAreaInfo;// Offset=0x1788 Size=0x8
    unsigned long long Unused;// Offset=0x1790 Size=0x8
    ...
    unsigned long long SparePVOID;// Offset=0x17b0 Size=0x8
    ...
    union // Size=0x2 (Id=0)
    {
        ...
        struct // Size=0x2 (Id=0)
        {
            ...
            unsigned short SkipLoaderInit:1;// Offset=0x17ee Size=0x2 BitOffset=0xe BitSize=0x1
            unsigned short SkipFileAPIBrokering:1;// Offset=0x17ee Size=0x2 BitOffset=0xf BitSize=0x1
        };
    };
    ...
    unsigned long long LastSleepCounter;// Offset=0x1838 Size=0x8
    unsigned long SpinCallCount;// Offset=0x1840 Size=0x4
    unsigned char Padding8[4];// Offset=0x1844 Size=0x4
    unsigned long long ExtendedFeatureDisableMask;// Offset=0x1848 Size=0x8
    unsigned long long SchedulerSharedDataSlot;// Offset=0x1850 Size=0x8
    struct _GROUP_AFFINITY64 PrimaryGroupAffinity;// Offset=0x1858 Size=0x10
    unsigned long Rcu[2];// Offset=0x1868 Size=0x8
};
