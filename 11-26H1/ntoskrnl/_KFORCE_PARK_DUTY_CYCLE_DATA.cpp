...
struct _KFORCE_PARK_DUTY_CYCLE_DATA// Size=0x158 (Id=1564)
{
    struct _KDPC DutyCycleDpc;// Offset=0x0 Size=0x40
    struct _KTIMER2 StartSingleDutyCycleTimer;// Offset=0x40 Size=0x88
    struct _KTIMER2 StopSingleDutyCycleTimer;// Offset=0xc8 Size=0x88
    enum _KI_FORCE_PARK_DUTY_CYCLE_STATE CurrentState;// Offset=0x150 Size=0x4
    enum _KI_FORCE_PARK_DUTY_CYCLE_TRANSITION DpcTransition;// Offset=0x154 Size=0x4
};
