...
struct _PO_HIBER_PERF// Size=0x2e8 (Id=2414)
{
...
struct PO_MEMORY_IMAGE// Size=0x4e0 (Id=2077)
{
    ...
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long Feature_SrtmAntiRollback_Enabled:1;// Offset=0x464 Size=0x4 BitOffset=0xb BitSize=0x1
        unsigned long Feature_PlutonDynamicUpgrade_Enabled:1;// Offset=0x464 Size=0x4 BitOffset=0xc BitSize=0x1
        unsigned long DevControlInitialized:1;// Offset=0x464 Size=0x4 BitOffset=0xd BitSize=0x1
        unsigned long Reserved:18;// Offset=0x464 Size=0x4 BitOffset=0xe BitSize=0x12
    };
    ...
    unsigned char Feature_HibernateRelaxVBSPolicy_Enabled;// Offset=0x4d7 Size=0x1
    union _unnamed_2076 DevControlPciLocation;// Offset=0x4d8 Size=0x4
};
