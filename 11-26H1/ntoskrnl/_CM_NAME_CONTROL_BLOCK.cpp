struct _CM_COMPONENT_HASH// Size=0x4 (Id=2322)
{
    unsigned long Hash;// Offset=0x0 Size=0x4
};

struct _CM_NAME_HASH// Size=0x18 (Id=1231)
{
...
struct _CM_NAME_CONTROL_BLOCK// Size=0x20 (Id=725)
{
    ...
    union // Size=0x18 (Id=0)
    {
        ...
        union // Size=0x4 (Id=0)
        {
            ...
            {
                unsigned long Compressed:1;// Offset=0xc Size=0x4 BitOffset=0x0 BitSize=0x1
                unsigned long Reserved:31;// Offset=0xc Size=0x4 BitOffset=0x1 BitSize=0x1f
            };
