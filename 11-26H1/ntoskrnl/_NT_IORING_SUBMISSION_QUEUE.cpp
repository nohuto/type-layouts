...
union _NT_IORING_HANDLEREF// Size=0x8 (Id=2440)
{
    union // Size=0x8 (Id=0)
    {
...
struct _NT_IORING_REG_BUFFERS_FLAGS// Size=0x8 (Id=2605)
{
...
struct _NT_IORING_OP_REGISTER_BUFFERS// Size=0x18 (Id=2521)
{
    enum _NT_IORING_OP_FLAGS CommonOpFlags;// Offset=0x0 Size=0x4
...
struct _NT_IORING_OP_CANCEL// Size=0x18 (Id=2612)
{
    enum _NT_IORING_OP_FLAGS CommonOpFlags;// Offset=0x0 Size=0x4
    union _NT_IORING_HANDLEREF File;// Offset=0x8 Size=0x8
...
struct _NT_IORING_OP_WRITE// Size=0x28 (Id=2364)
{
    enum _NT_IORING_OP_FLAGS CommonOpFlags;// Offset=0x0 Size=0x4
...
struct _NT_IORING_OP_FLUSH// Size=0x10 (Id=2566)
{
    enum _NT_IORING_OP_FLAGS CommonOpFlags;// Offset=0x0 Size=0x4
...
struct _NT_IORING_OP_READ_SCATTER// Size=0x30 (Id=2592)
{
    enum _NT_IORING_OP_FLAGS CommonOpFlags;// Offset=0x0 Size=0x4
    unsigned int Padding;// Offset=0x4 Size=0x4
    union _NT_IORING_HANDLEREF File;// Offset=0x8 Size=0x8
...
struct _NT_IORING_OP_WRITE_GATHER// Size=0x30 (Id=2584)
{
    enum _NT_IORING_OP_FLAGS CommonOpFlags;// Offset=0x0 Size=0x4
    enum _NT_WRITE_FLAGS Flags;// Offset=0x4 Size=0x4
    union _NT_IORING_HANDLEREF File;// Offset=0x8 Size=0x8
...
struct _NT_IORING_OP_RESERVED// Size=0x30 (Id=2400)
{
...
struct _NT_IORING_SQE// Size=0x40 (Id=2330)
{
...
struct _NT_IORING_SUBMISSION_QUEUE// Size=0x50 (Id=1936)
{
