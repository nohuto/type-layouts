...
struct _MI_PROCESS_STATE// Size=0x58 (Id=1441)
{
    void * SystemDllBase;// Offset=0x0 Size=0x8
    long RotatingUniprocessorNumber;// Offset=0x8 Size=0x4
...
struct _MI_COMBINE_STATE// Size=0x20 (Id=2103)
{
...
struct _MI_PAGELIST_STATE// Size=0x110 (Id=2129)
{
    long ActiveSpinLock;// Offset=0x0 Size=0x4
    struct _RTL_AVL_TREE ActiveThreadTree;// Offset=0x8 Size=0x8
...
struct _MI_PARTITION_STATE// Size=0x100 (Id=1484)
{
...
struct _MI_RESUME_WORKITEM// Size=0x38 (Id=2447)
{
...
struct _MI_SHUTDOWN_STATE// Size=0xc8 (Id=1878)
{
    ...
    struct _KEVENT ExitZeroingEvent;// Offset=0x10 Size=0x18
    unsigned long MirroringState;// Offset=0x28 Size=0x4
    struct _MI_RESUME_WORKITEM ResumeItem;// Offset=0x30 Size=0x38
    long MirroringHoldPageAllocation;// Offset=0x68 Size=0x4
    struct _ETHREAD * MirrorHoldsPfn;// Offset=0x70 Size=0x8
    struct _RTL_BITMAP_EX MirrorBitMaps[2][2];// Offset=0x78 Size=0x40
    enum _MI_MIRROR_BITMAP_STATE MirrorBitMapState[2];// Offset=0xb8 Size=0x8
    struct _MMPTE * CrashDumpPte;// Offset=0xc0 Size=0x8
};
...
struct _MI_STANDBY_STATE// Size=0x160 (Id=2091)
{
...
struct _GENERAL_LOOKASIDE// Size=0x80 (Id=546)
{
    union // Size=0x10 (Id=0)
    {
...
struct _NPAGED_LOOKASIDE_LIST// Size=0x80 (Id=903)
{
...
struct _MI_ULTRA_VA_CONTEXT// Size=0x40 (Id=1832)
{
    long Lock;// Offset=0x0 Size=0x4
...
struct _MI_HUGE_SYSTEM_VIEW_HEAD// Size=0x10 (Id=2042)
{
...
struct _MI_SYSTEM_PTE_STATE// Size=0x1500 (Id=1775)
{
    ...
    unsigned long long KernelStackCookie;// Offset=0x260 Size=0x8
    struct _MI_ULTRA_VA_CONTEXT UltraSpaceContext;// Offset=0x268 Size=0x40
    unsigned long NumberOfUltraMdlMaps;// Offset=0x2a8 Size=0x4
    struct _MI_ULTRA_MDL_NODE * UltraMdlNodeMappings;// Offset=0x2b0 Size=0x8
    struct _MMPTE * UltraSpaceLowPpe;// Offset=0x2b8 Size=0x8
    struct _MMPTE * UltraSpaceHighPpe;// Offset=0x2c0 Size=0x8
    struct _EX_PUSH_LOCK SystemSpaceViewLock;// Offset=0x2c8 Size=0x8
    struct _RTL_AVL_TREE ViewRoot;// Offset=0x2d0 Size=0x8
    unsigned long ViewCount;// Offset=0x2d8 Size=0x4
    long SystemViewSpinLock;// Offset=0x2dc Size=0x4
...
struct _MI_IO_PAGE_STATE_CELL// Size=0x40 (Id=2576)
{
...
struct _MI_IO_PAGE_STATE// Size=0x100 (Id=2390)
{
    ...
    struct _MI_IO_CACHE_STATS IoCacheStats;// Offset=0xb8 Size=0x18
    long RejectedPermanentRanges;// Offset=0xd0 Size=0x4
};
...
struct _MI_FILLED_COMMON_PAGE_STATE// Size=0x38 (Id=2583)
{
...
struct _MI_COMMON_PAGE_STATE// Size=0x90 (Id=2258)
{
    ...
    unsigned long long TbFlushPage;// Offset=0x80 Size=0x8
    struct _MMPTE * TbFlushVa;// Offset=0x88 Size=0x8
};
...
struct _MI_HOT_PATCH_STATE// Size=0x48 (Id=1681)
{
    ...
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long DriverProxyEnabled:1;// Offset=0x44 Size=0x4 BitOffset=0x1 BitSize=0x1
        unsigned long DriverProxyWithoutHvciEnabled:1;// Offset=0x44 Size=0x4 BitOffset=0x2 BitSize=0x1
        unsigned long Spare:29;// Offset=0x44 Size=0x4 BitOffset=0x3 BitSize=0x1d
    };
};
...
struct _MI_ENCLAVE_STATE// Size=0x48 (Id=1485)
{
...
struct _MI_MEMORY_ENLIGHTENMENT_STATE// Size=0x4 (Id=2340)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long HotHintEnabled:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
        unsigned long ColdHintEnabled:1;// Offset=0x0 Size=0x4 BitOffset=0x1 BitSize=0x1
        unsigned long ColdHintLargeOnlyEnabled:1;// Offset=0x0 Size=0x4 BitOffset=0x2 BitSize=0x1
        unsigned long HibernateZeroPagesEnabled:1;// Offset=0x0 Size=0x4 BitOffset=0x3 BitSize=0x1
    };
};

struct _MM_PAGED_POOL_INFO// Size=0x18 (Id=1329)
{
...
struct _MMSUPPORT_AGGREGATION// Size=0x20 (Id=2484)
{
...
struct _SYSPTES_HEADER// Size=0x118 (Id=2251)
{
...
struct _MI_SYSTEM_VA_ASSIGNMENT// Size=0x10 (Id=2526)
{
    void * BaseAddress;// Offset=0x0 Size=0x8
    unsigned long long NumberOfBytes;// Offset=0x8 Size=0x8
};

struct _MI_VISIBLE_STATE// Size=0x16c0 (Id=2321)
{
    ...
    long DriverCommit;// Offset=0xa8 Size=0x4
    unsigned char PagingLevels;// Offset=0xac Size=0x1
    unsigned long long PfnDatabaseCommit;// Offset=0xb0 Size=0x8
    unsigned long long TotalNodePagesInChildPartitions[64];// Offset=0xb8 Size=0x200
    unsigned long long TotalSpecialPurposeMemoryInChildPartitions[64][2];// Offset=0x2b8 Size=0x400
    ...
    unsigned long long SystemVaTypeCount[21];// Offset=0x13c8 Size=0xa8
    unsigned char SystemVaType[256];// Offset=0x1470 Size=0x100
    struct _MI_SYSTEM_VA_ASSIGNMENT SystemVaRegions[18];// Offset=0x1570 Size=0x120
    unsigned long long SecurePtRoot;// Offset=0x1690 Size=0x8
};

struct _MI_SYSTEM_INFORMATION// Size=0xb740 (Id=1417)
{
    struct _MI_POOL_STATE Pools;// Offset=0x0 Size=0x240
    struct _MI_SECTION_STATE Sections;// Offset=0x240 Size=0xc00
    struct _MI_SYSTEM_IMAGE_STATE SystemImages;// Offset=0xe40 Size=0x240
    struct _MI_PROCESS_STATE Processes;// Offset=0x1080 Size=0x58
    struct _MI_HARDWARE_STATE Hardware;// Offset=0x1100 Size=0x300
    struct _MI_SYSTEM_VA_STATE SystemVa;// Offset=0x1400 Size=0x10c0
    struct _MI_COMBINE_STATE PageCombines;// Offset=0x24c0 Size=0x20
    struct _MI_PAGELIST_STATE PageLists;// Offset=0x24e0 Size=0x110
    struct _MI_PARTITION_STATE Partitions;// Offset=0x2600 Size=0x100
    struct _MI_SHUTDOWN_STATE Shutdowns;// Offset=0x2700 Size=0xc8
    struct _MI_ERROR_STATE Errors;// Offset=0x27c8 Size=0x120
    struct _MI_DEBUGGER_STATE Debugger;// Offset=0x28e8 Size=0x5948
    struct _MI_STANDBY_STATE Standby;// Offset=0x8230 Size=0x160
    struct _MI_SYSTEM_PTE_STATE SystemPtes;// Offset=0x83c0 Size=0x1500
    struct _MI_IO_PAGE_STATE IoPages;// Offset=0x98c0 Size=0x100
    struct _MI_PAGING_IO_STATE PagingIo;// Offset=0x99c0 Size=0xb0
    struct _MI_COMMON_PAGE_STATE CommonPages;// Offset=0x9a70 Size=0x90
    struct _MI_SYSTEM_TRIM_STATE Trims;// Offset=0x9b00 Size=0x80
    struct _MI_SYSTEM_ACCELERATORS Accelerators;// Offset=0x9b80 Size=0x438
    struct _MI_HOT_PATCH_STATE HotPatch;// Offset=0x9fb8 Size=0x48
    struct _MI_ENCLAVE_STATE Enclaves;// Offset=0xa000 Size=0x48
    struct _MI_MEMORY_ENLIGHTENMENT_STATE EnlightenmentState;// Offset=0xa048 Size=0x4
    void * BootRegistryRuns;// Offset=0xa050 Size=0x8
    long ZeroingDisabled;// Offset=0xa058 Size=0x4
    unsigned char FullyInitialized;// Offset=0xa05c Size=0x1
    unsigned char SafeBooted;// Offset=0xa05d Size=0x1
    struct _tlgProvider_t * TraceLogging;// Offset=0xa060 Size=0x8
    struct _MI_VISIBLE_STATE Vs;// Offset=0xa080 Size=0x16c0
};
