...
union _POP_FX_DEVICE_STATUS// Size=0x4 (Id=880)
{
    ...
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long SIrpBlocked:1;// Offset=0x0 Size=0x4 BitOffset=0xa BitSize=0x1
        unsigned long PendSIrpCompletion:1;// Offset=0x0 Size=0x4 BitOffset=0xb BitSize=0x1
        unsigned long DirectedPoweredDown:1;// Offset=0x0 Size=0x4 BitOffset=0xc BitSize=0x1
        unsigned long DirectedTransitionInProgress:1;// Offset=0x0 Size=0x4 BitOffset=0xd BitSize=0x1
        unsigned long DeviceDxAllowed:1;// Offset=0x0 Size=0x4 BitOffset=0xe BitSize=0x1
        unsigned long Reserved:17;// Offset=0x0 Size=0x4 BitOffset=0xf BitSize=0x11
    };
};

struct _POP_FX_DRIVER_CALLBACKS// Size=0x50 (Id=2001)
{
    ...
    void  ( * DripsWatchdogCallback)(void * ,struct _DEVICE_OBJECT * ,unsigned long );// Offset=0x38 Size=0x8
    void  ( * DirectedPowerUpCallback)(void * ,unsigned long );// Offset=0x40 Size=0x8
    void  ( * DirectedPowerDownCallback)(void * ,unsigned long );// Offset=0x48 Size=0x8
};
...
struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=2489)
{
...
struct _IO_REMOVE_LOCK// Size=0x20 (Id=2224)
{
...
struct _POP_FX_WORK_ORDER// Size=0x38 (Id=2126)
{
...
union _POWER_STATE// Size=0x4 (Id=185)
{
...
struct _POP_FX_ACTIVE_TIME_ACCOUNTING// Size=0x60 (Id=2518)
{
...
struct _POP_FX_ACCOUNTING// Size=0xe0 (Id=2198)
{
...
struct _POP_FX_DRIPS_WATCHDOG_CONTEXT// Size=0x28 (Id=2430)
{
...
struct _POP_FX_WORK_ORDER_WATCHDOG_INFO// Size=0xb0 (Id=2285)
{
    struct _LIST_ENTRY Link;// Offset=0x0 Size=0x10
    struct _KTIMER Timer;// Offset=0x10 Size=0x40
    struct _KDPC Dpc;// Offset=0x50 Size=0x40
    struct _POP_FX_WORK_ORDER * WorkOrder;// Offset=0x90 Size=0x8
    struct _PEP_WORK_INFORMATION * CurrentWorkInfo;// Offset=0x98 Size=0x8
    unsigned long long WatchdogStart;// Offset=0xa0 Size=0x8
    struct _KTHREAD * WorkerThread;// Offset=0xa8 Size=0x8
};

struct _POP_FX_DEVICE_DIRECTED_TRANSITION_STATE// Size=0x10 (Id=2212)
{
...
struct _POP_FX_DEVICE// Size=0x528 (Id=1906)
{
    struct _LIST_ENTRY Link;// Offset=0x0 Size=0x10
    ...
    long RemoveLockReferenceCount[10];// Offset=0x110 Size=0x28
    struct _IO_REMOVE_LOCK AcpiRemoveLock;// Offset=0x138 Size=0x20
    struct _POP_FX_WORK_ORDER WorkOrder;// Offset=0x158 Size=0x38
    unsigned long long IdleLock;// Offset=0x190 Size=0x8
    struct _KTIMER IdleTimer;// Offset=0x198 Size=0x40
    struct _KDPC IdleDpc;// Offset=0x1d8 Size=0x40
    unsigned long long IdleTimeout;// Offset=0x218 Size=0x8
    unsigned long long IdleStamp;// Offset=0x220 Size=0x8
    struct _DEVICE_OBJECT * NextIrpDeviceObject[2];// Offset=0x228 Size=0x10
    union _POWER_STATE NextIrpPowerState[2];// Offset=0x238 Size=0x8
    void  ( * NextIrpCallerCompletion)[2];// Offset=0x240 Size=0x10
    void * NextIrpCallerContext[2];// Offset=0x250 Size=0x10
    struct _KEVENT IrpCompleteEvent;// Offset=0x260 Size=0x18
    unsigned char  ( * PowerOnDumpDeviceCallback)(struct _PEP_CRASHDUMP_INFORMATION * );// Offset=0x278 Size=0x8
    struct _POP_FX_ACCOUNTING Accounting;// Offset=0x280 Size=0xe0
    unsigned long Flags;// Offset=0x360 Size=0x4
    unsigned long ComponentCount;// Offset=0x364 Size=0x4
    struct _POP_FX_COMPONENT ** Components;// Offset=0x368 Size=0x8
    unsigned long LogEntries;// Offset=0x370 Size=0x4
    struct _POP_FX_LOG_ENTRY * Log;// Offset=0x378 Size=0x8
    long LogIndex;// Offset=0x380 Size=0x4
    struct _DRIVER_OBJECT * DripsWatchdogDriverObject;// Offset=0x388 Size=0x8
    struct _POP_FX_DRIPS_WATCHDOG_CONTEXT DripsWatchdogContext;// Offset=0x390 Size=0x28
    unsigned long ChildDeviceComponentIndex;// Offset=0x3b8 Size=0x4
    unsigned long DirectedTimeout;// Offset=0x3bc Size=0x4
    struct _POP_FX_WORK_ORDER DirectedWorkOrder;// Offset=0x3c0 Size=0x38
    struct _POP_FX_WORK_ORDER_WATCHDOG_INFO DirectedWorkWatchdogInfo;// Offset=0x3f8 Size=0xb0
    unsigned long long DirectedLock;// Offset=0x4a8 Size=0x8
    long DirectedTransitionCallCount;// Offset=0x4b0 Size=0x4
    struct _POP_FX_DEVICE_DIRECTED_TRANSITION_STATE DirectedTransitionState;// Offset=0x4b8 Size=0x10
    struct _POP_DEVICE_POWER_PROFILE * PowerProfile;// Offset=0x4c8 Size=0x8
    struct _UNICODE_STRING FriendlyName;// Offset=0x4d0 Size=0x10
    struct _WORK_QUEUE_ITEM ReportDevicePoweredOnPassiveWorkItem;// Offset=0x4e0 Size=0x20
    unsigned long long RelationsLock;// Offset=0x500 Size=0x8
    unsigned long IdleProviderCount;// Offset=0x508 Size=0x4
    struct _IRP * PendingDevicePowerIrp;// Offset=0x510 Size=0x8
    struct _LIST_ENTRY ExternalDependencies;// Offset=0x518 Size=0x10
};
