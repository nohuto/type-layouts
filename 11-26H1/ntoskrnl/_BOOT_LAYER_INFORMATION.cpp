...
struct _BOOT_LAYER_INFORMATION// Size=0x38 (Id=2417)
{
    unsigned long LayerType;// Offset=0x0 Size=0x4
    union // Size=0x4 (Id=0)
    {
        unsigned long Flags;// Offset=0x4 Size=0x4
        struct // Size=0x4 (Id=0)
        {
            unsigned long IsRootLayer:1;// Offset=0x4 Size=0x4 BitOffset=0x0 BitSize=0x1
        };
    };
    union _unnamed_2416 u;// Offset=0x8 Size=0x30
};
