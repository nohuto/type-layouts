...
struct _MMPAGING_FILE// Size=0x100 (Id=1962)
{
    ...
    struct _RTL_RB_TREE FlowThroughReadTree;// Offset=0xd0 Size=0x10
    struct _MI_PARTITION * Partition;// Offset=0xe0 Size=0x8
    union // Size=0x18 (Id=0)
    {
        struct _RTL_BALANCED_NODE FileObjectNode;// Offset=0xe8 Size=0x18
        struct _RTL_RB_TREE ExtentsTree;// Offset=0xe8 Size=0x10
    };
};
