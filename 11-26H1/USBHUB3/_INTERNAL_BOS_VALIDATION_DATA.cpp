...
struct _INTERNAL_BOS_VALIDATION_DATA// Size=0x60 (Id=443)
{
    ...
    struct _BOS_DESC_SET_INFO * BOSInfo;// Offset=0x50 Size=0x8
    struct _USB_DEVICE_DESCRIPTOR * DeviceDescriptor;// Offset=0x58 Size=0x8
};
