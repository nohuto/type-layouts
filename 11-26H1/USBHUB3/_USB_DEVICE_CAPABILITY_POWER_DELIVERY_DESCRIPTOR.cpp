union _unnamed_811// Size=0x4 (Id=811)
{
...
struct _USB_DEVICE_CAPABILITY_POWER_DELIVERY_DESCRIPTOR// Size=0x12 (Id=812)
{
    ...
    union _unnamed_811 bmAttributes;// Offset=0x4 Size=0x4
