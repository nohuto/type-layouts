...
struct _VALIDATION_DEVICE_INFO// Size=0x38 (Id=434)
{
...
union _CONFIG_VALIDATION_FLAGS// Size=0x4 (Id=594)
{
    ...
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long ExpectingHSeUSB2Companion:1;// Offset=0x0 Size=0x4 BitOffset=0x4 BitSize=0x1
        unsigned long EndpointCompanionFound:1;// Offset=0x0 Size=0x4 BitOffset=0x5 BitSize=0x1
        unsigned long SSPEndpointCompanionFound:1;// Offset=0x0 Size=0x4 BitOffset=0x6 BitSize=0x1
        unsigned long HSeUSB2CompanionFound:1;// Offset=0x0 Size=0x4 BitOffset=0x7 BitSize=0x1
    };
};

struct _INTERNAL_CONFIG_VALIDATION_DATA// Size=0x108 (Id=439)
{
