...
struct _unnamed_535// Size=0x8 (Id=535)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_536// Size=0x4 (Id=536)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_537// Size=0x8 (Id=537)
{
    struct _unnamed_535 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_536 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_535 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=538)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_537 Data;// Offset=0x4 Size=0x8
};
