union _unnamed_28// Size=0x8 (Id=28)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=773)
{
    union // Size=0x4 (Id=0)
    {
...
struct _unnamed_30// Size=0x10 (Id=30)
{
    union // Size=0x8 (Id=0)
    {
...
union _unnamed_31// Size=0x10 (Id=31)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_30 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=677)
{
...
struct _unnamed_32// Size=0x50 (Id=32)
{
