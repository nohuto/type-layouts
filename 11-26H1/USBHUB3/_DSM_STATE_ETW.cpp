enum _DSM_STATE_ETW
{
    ...
    DsmStateEtwDisablingEndpointsInControllerOnPDORemovedOnDetach=4919,
    ...
    DsmStateEtwFlushingPD0RemovedInConfigured=4920,
    DsmStateEtwFlushingPD0RemovedUnConfigured=4921,
    ...
    DsmStateEtwWaitingForPDOD0RemovedOnDetachInUnConfigured=4923,
    DsmStateEtwWaitingForPDORemovedOnDetachInConfigured=4922,
    DsmStateEtwWaitingForPDOReportedMissing=4255,
    DsmStateEtwWaitingForPortDisableFromHubSuspend=4924,
    ...
    DsmStateEtwReleasingAddressZeroOwnershipOnEnumRetry=4925,
    ...
    DsmStateEtwCheckingIfExemptSecureBioDevice=4917,
    ...
    DsmStateEtwSendingGetDeviceDescriptorRequestForExemptSecureBioDevice=4918,
    ...
    DsmStateEtwCheckingIfDisallowFirmwareUpdateCommandNeedsToBeSent=4913,
    DsmStateEtwCheckingIfDualRoleFeaturesSupported=4902,
    DsmStateEtwCheckingIfFirmwareImageHashNeedsToBeQueried=4914,
    ...
    DsmStateEtwSendingDisallowFirmwareUpdateCommand=4915,
    DsmStateEtwSendingFirmwareImageHashQuery=4916,
    ...
    DsmStateEtwCheckingIfDisableNeededInConfigured=4930,
    DsmStateEtwCheckingIfDisableNeededInUnconfigured=4931,
    ...
    DsmStateEtwDisablingDeviceInControllerOnReEnumerationInConfigured=4929,
    ...
    DsmStateEtwReleasingAddressZeroOwnershipOnRenumRetry=4926,
    ...
    DsmStateEtwDisablingPortForFailedDeviceAfterHubResume=4912,
    ...
    DsmStateEtwWaitingForPortDisableAfterHubSuspendForFailedDevice=4932,
