union _unnamed_691// Size=0x2 (Id=691)
{
...
struct _USB_DEVICE_CAPABILITY_PD_CONSUMER_PORT_DESCRIPTOR// Size=0x18 (Id=692)
{
    ...
    union _unnamed_691 bmCapabilities;// Offset=0x4 Size=0x2
