union _HUB_FLAGS// Size=0x4 (Id=822)
{
...
union _HUB_FLAGS_EXT// Size=0x4 (Id=764)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long UpcUsbCPortCapabilitiesSupported:1;// Offset=0x0 Size=0x4 BitOffset=0x9 BitSize=0x1
        unsigned long UseRelaxedIdleTimeout_1s:1;// Offset=0x0 Size=0x4 BitOffset=0xa BitSize=0x1
        unsigned long UseRelaxedIdleTimeout_5s:1;// Offset=0x0 Size=0x4 BitOffset=0xb BitSize=0x1
    };
};
...
union _USB_20_PORT_STATUS// Size=0x2 (Id=852)
{
...
union _USB_30_PORT_STATUS// Size=0x2 (Id=839)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_PORT_STATUS// Size=0x2 (Id=699)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
...
union _USB_20_PORT_CHANGE// Size=0x2 (Id=832)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_30_PORT_CHANGE// Size=0x2 (Id=814)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_PORT_CHANGE// Size=0x2 (Id=767)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
...
union _USB_PORT_STATUS_AND_CHANGE// Size=0x4 (Id=749)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
...
struct _HUBUCX_ROOTHUB_INFO// Size=0x18 (Id=862)
{
...
struct _HUB_INFORMATION// Size=0x80 (Id=723)
{
...
struct _UCX_CONTROLLER_PCI_INFORMATION// Size=0x18 (Id=829)
{
...
struct _UCX_CONTROLLER_ACPI_INFORMATION// Size=0xf (Id=482)
{
...
struct _UCX_CONTROLLER_MAUSB_INFORMATION// Size=0x18 (Id=878)
{
...
struct _UCX_CONTROLLER_INFO// Size=0x20 (Id=731)
{
...
struct _USB_TOPOLOGY_ADDRESS// Size=0x20 (Id=758)
{
...
struct _HUB_PARENT_INTERFACE// Size=0x90 (Id=694)
{
    ...
    enum _USB_USB4_TUNNEL_STATE Usb4TunnelState;// Offset=0x48 Size=0x4
    void * ConnectorId;// Offset=0x50 Size=0x8
    unsigned short First30PortToMap;// Offset=0x58 Size=0x2
    unsigned short Last30PortToMap;// Offset=0x5a Size=0x2
    void  ( * GetHubSymbolicLinkName)(void * ,struct _UNICODE_STRING * );// Offset=0x60 Size=0x8
    struct _USB_TOPOLOGY_ADDRESS HubTopologyAddress;// Offset=0x68 Size=0x20
    void * HubFdoContext;// Offset=0x88 Size=0x8
};

struct _HUB_CONTROLLERSTACK_INTERFACE// Size=0x108 (Id=421)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
    ...
    long  ( * EndpointCreateV2)(struct UCXUSBDEVICE__ * ,struct UCXUSBDEVICE__ * ,struct _USB_ENDPOINT_DESCRIPTOR * ,unsigned long ,struct _USB_SUPERSPEED_ENDPOINT_COMPANION_DESCRIPTOR * ,struct _EUSB2_ISOCH_ENDPOINT_COMPANION_DESCRIPTOR * ,struct UCXENDPOINT__ ** );// Offset=0x100 Size=0x8
};

struct _USB_BUS_INTERFACE_USBDI_V3// Size=0x60 (Id=619)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=523)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    struct // Size=0x4 (Id=0)
...
union _CONTROLLER_FLAGS// Size=0x4 (Id=766)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_HUB_STATUS// Size=0x2 (Id=695)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_HUB_CHANGE// Size=0x2 (Id=598)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_HUB_STATUS_AND_CHANGE// Size=0x4 (Id=586)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
...
union _USB_DEVICE_STATUS// Size=0x2 (Id=503)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
struct _URB_BULK_OR_INTERRUPT_TRANSFER// Size=0x80 (Id=755)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _HUB_INTERRUPT_REQUEST// Size=0xb8 (Id=687)
{
    struct WDFREQUEST__ * WdfRequest;// Offset=0x0 Size=0x8
...
struct _USB_HUB_DESCRIPTOR// Size=0x47 (Id=790)
{
...
struct _USB_30_HUB_DESCRIPTOR// Size=0xc (Id=806)
{
...
union _HUB_DESCRIPTOR// Size=0x47 (Id=736)
{
...
union _HSM_MUX_FLAGS// Size=0x4 (Id=701)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _HSM_MUX_CONTEXT// Size=0x50 (Id=589)
{
...
struct _USB_RESET_FLAGS// Size=0x4 (Id=609)
{
    struct // Size=0x4 (Id=0)
    {
...
union _PARENT_HUB_FLAGS// Size=0x4 (Id=800)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _HUB_INFO_FROM_PARENT// Size=0x48 (Id=492)
{
...
struct _GENERIC_DROM_HEADER// Size=0x10 (Id=627)
{
...
union _DROM_READ_METADATA// Size=0x4 (Id=788)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _HUB_FDO_CONTEXT// Size=0xaf0 (Id=412)
{
    ...
    struct _HUB_PARENT_INTERFACE HubParentInterface;// Offset=0xd0 Size=0x90
    struct _HUB_CONTROLLERSTACK_INTERFACE HubControllerStackInterface;// Offset=0x160 Size=0x108
    struct _USB_BUS_INTERFACE_USBDI_V3 UsbdBusInterface;// Offset=0x268 Size=0x60
    struct _DEVICE_CAPABILITIES DeviceCapabilities;// Offset=0x2c8 Size=0x40
    union _CONTROLLER_FLAGS ControllerFlags;// Offset=0x308 Size=0x4
    struct _GUID ControllerSessionActivityId;// Offset=0x30c Size=0x10
    union _USB_HUB_STATUS_AND_CHANGE HubStatusAndChange;// Offset=0x31c Size=0x4
    union _USB_HUB_STATUS_AND_CHANGE OldHubStatusAndChange;// Offset=0x320 Size=0x4
    enum _USB_HUB_FEATURE_SELECTOR CurrentFeatureSelector;// Offset=0x324 Size=0x4
    enum _HSM_EVENT CurrentHubChangeEvent;// Offset=0x328 Size=0x4
    union _USB_DEVICE_STATUS HubDeviceStatus;// Offset=0x32c Size=0x2
    struct _CONTROL_REQUEST HubControlRequest;// Offset=0x330 Size=0xa8
    struct _HUB_INTERRUPT_REQUEST StatusChangeInterruptRequest;// Offset=0x3d8 Size=0xb8
    struct _KEVENT PnPPowerEvent;// Offset=0x490 Size=0x18
    long PnPPowerStatus;// Offset=0x4a8 Size=0x4
    union _HUB_DESCRIPTOR HubDescriptor;// Offset=0x4ac Size=0x47
    struct _USB_CONFIGURATION_DESCRIPTOR * ConfigurationDescriptor;// Offset=0x4f8 Size=0x8
    struct _SM_CONTEXT HsmContext;// Offset=0x500 Size=0x420
    struct _HSM_MUX_CONTEXT MuxContext;// Offset=0x920 Size=0x50
    struct WDFQUEUE__ * DeviceControlQueue;// Offset=0x970 Size=0x8
    struct _USB_RESET_FLAGS ResetFlags;// Offset=0x978 Size=0x4
    struct _GUID CurrentActivityId;// Offset=0x97c Size=0x10
    struct _LIST_ENTRY ListEntry;// Offset=0x990 Size=0x10
    struct _HUB_INFO_FROM_PARENT HubInfoFromParent;// Offset=0x9a0 Size=0x48
    struct RECORDER_LOG__ * IfrLog;// Offset=0x9e8 Size=0x8
    struct WDFREQUEST__ * PdoGetPortStatusRequest;// Offset=0x9f0 Size=0x8
    struct WDFWMIINSTANCE__ * WmiNotificationHandle;// Offset=0x9f8 Size=0x8
    struct _UNICODE_STRING HubSymbolicLinkNameUnicode;// Offset=0xa00 Size=0x10
    void * SelectiveSuspendSetting;// Offset=0xa10 Size=0x8
    void * SelectiveSuspendTimeoutPowerSetting;// Offset=0xa18 Size=0x8
    unsigned long CurrentIdleTimeout;// Offset=0xa20 Size=0x4
    unsigned long MinimumIdleTimeout;// Offset=0xa24 Size=0x4
    struct _PORT_CONTEXT * GetPortStatusTargetPortContext;// Offset=0xa28 Size=0x8
    unsigned long HardwareVerifierFlags;// Offset=0xa30 Size=0x4
    unsigned long HubFailureMsgId;// Offset=0xa34 Size=0x4
    enum _WDF_POWER_DEVICE_STATE CurrentWdfPowerDeviceState;// Offset=0xa38 Size=0x4
    unsigned short OldwTotalLength;// Offset=0xa3c Size=0x2
    struct POHANDLE__ * PoHandle;// Offset=0xa40 Size=0x8
    struct SS_COMPONENT__ * SleepstudySelectiveSuspendUnavailable;// Offset=0xa48 Size=0x8
    struct SS_COMPONENT__ * SleepstudySelectiveSuspendDisabled;// Offset=0xa50 Size=0x8
    struct SS_COMPONENT__ * SleepstudySelectiveSuspendDisabledByUser;// Offset=0xa58 Size=0x8
    void * IdleResiliencyHandle;// Offset=0xa60 Size=0x8
    unsigned long IdleResiliencyState;// Offset=0xa68 Size=0x4
    struct WDFDEVICE__ * FirmwareUpdateDevice;// Offset=0xa70 Size=0x8
    struct _GENERIC_DROM_HEADER Usb4DromHeader;// Offset=0xa78 Size=0x10
    unsigned long Usb4DromSizeInDwords;// Offset=0xa88 Size=0x4
    unsigned long Usb4DromSize;// Offset=0xa8c Size=0x4
    unsigned char * Usb4DromBuffer;// Offset=0xa90 Size=0x8
    unsigned long Usb4DromReadIndex;// Offset=0xa98 Size=0x4
    unsigned long GRMailboxIndex;// Offset=0xa9c Size=0x4
    union _OPCODE_STATUS GRMailboxOpcodeStatus;// Offset=0xaa0 Size=0x4
    union _DROM_READ_METADATA GRMailBoxMetaData;// Offset=0xaa4 Size=0x4
    long long GRMailboxReadStatusStartTime;// Offset=0xaa8 Size=0x8
    unsigned short FwUpdateIdVendor;// Offset=0xab0 Size=0x2
    unsigned short FwUpdateIdProduct;// Offset=0xab2 Size=0x2
    unsigned short FwUpdateBcdProductFWRevision;// Offset=0xab4 Size=0x2
    unsigned short FwUpdateProductHWRevision;// Offset=0xab6 Size=0x2
    unsigned char FwUpdateValid;// Offset=0xab8 Size=0x1
    struct WDFCOLLECTION__ * Usb4HostCollection;// Offset=0xac0 Size=0x8
    struct WDFWAITLOCK__ * Usb4HostCollectionLock;// Offset=0xac8 Size=0x8
    void * PnpInterfaceNotificationHandle;// Offset=0xad0 Size=0x8
    struct WDFSTRING__ * Usb4HostNameString;// Offset=0xad8 Size=0x8
    void * LowPowerEpochHandle;// Offset=0xae0 Size=0x8
    unsigned long LowPowerEpochState;// Offset=0xae8 Size=0x4
    unsigned char PowerReferenceReleasedForLPE;// Offset=0xaec Size=0x1
};
