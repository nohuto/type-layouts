...
struct _unnamed_525// Size=0x8 (Id=525)
{
...
struct _unnamed_526// Size=0x4 (Id=526)
{
    enum _WDF_DEVICE_POWER_POLICY_STATE CurrentState;// Offset=0x0 Size=0x4
};
...
{
    struct _unnamed_525 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_526 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_525 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=528)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_527 Data;// Offset=0x4 Size=0x8
};
