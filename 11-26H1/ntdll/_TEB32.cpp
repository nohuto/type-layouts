struct _NT_TIB32// Size=0x1c (Id=666)
{
    unsigned long ExceptionList;// Offset=0x0 Size=0x4
    unsigned long StackBase;// Offset=0x4 Size=0x4
    unsigned long StackLimit;// Offset=0x8 Size=0x4
    unsigned long SubSystemTib;// Offset=0xc Size=0x4
    union // Size=0x4 (Id=0)
    {
        unsigned long FiberData;// Offset=0x10 Size=0x4
        unsigned long Version;// Offset=0x10 Size=0x4
    };
    unsigned long ArbitraryUserPointer;// Offset=0x14 Size=0x4
    unsigned long Self;// Offset=0x18 Size=0x4
};

struct _CLIENT_ID32// Size=0x8 (Id=454)
{
    unsigned long UniqueProcess;// Offset=0x0 Size=0x4
    unsigned long UniqueThread;// Offset=0x4 Size=0x4
};

struct _ACTIVATION_CONTEXT_STACK32// Size=0x18 (Id=376)
{
    unsigned long ActiveFrame;// Offset=0x0 Size=0x4
    struct LIST_ENTRY32 FrameListCache;// Offset=0x4 Size=0x8
    unsigned long Flags;// Offset=0xc Size=0x4
    unsigned long NextCookieSequenceNumber;// Offset=0x10 Size=0x4
    unsigned long StackId;// Offset=0x14 Size=0x4
};

struct _GDI_TEB_BATCH32// Size=0x4e0 (Id=456)
{
    ...
    unsigned long HDC;// Offset=0x4 Size=0x4
    unsigned long Buffer[310];// Offset=0x8 Size=0x4d8
};
...
struct _GROUP_AFFINITY32// Size=0xc (Id=465)
{
...
struct _TEB32// Size=0x1030 (Id=344)
{
    ...
    unsigned long SystemReserved1[17];// Offset=0x10c Size=0x44
    unsigned long ReservedForHeap;// Offset=0x150 Size=0x4
    unsigned long HeapThreadData;// Offset=0x154 Size=0x4
    unsigned long HeapPgSamplingCount;// Offset=0x158 Size=0x4
    unsigned long HeapGlobalLock;// Offset=0x15c Size=0x4
    unsigned long HeapFlsData;// Offset=0x160 Size=0x4
    unsigned long RngState[4];// Offset=0x164 Size=0x10
    ...
    struct _ACTIVATION_CONTEXT_STACK32 _ActivationStack;// Offset=0x184 Size=0x18
    ...
    unsigned long SparePVOID;// Offset=0xfa8 Size=0x4
    ...
    union // Size=0x2 (Id=0)
    {
        ...
        struct // Size=0x2 (Id=0)
        {
            ...
            unsigned short SkipFileAPIBrokering:1;// Offset=0xfca Size=0x2 BitOffset=0xf BitSize=0x1
        };
    };
    ...
    unsigned long long LastSleepCounter;// Offset=0x1000 Size=0x8
    unsigned long SpinCallCount;// Offset=0x1008 Size=0x4
    unsigned long long ExtendedFeatureDisableMask;// Offset=0x1010 Size=0x8
    unsigned long SchedulerSharedDataSlot;// Offset=0x1018 Size=0x4
    struct _GROUP_AFFINITY32 PrimaryGroupAffinity;// Offset=0x101c Size=0xc
    unsigned long Rcu[2];// Offset=0x1028 Size=0x8
};
