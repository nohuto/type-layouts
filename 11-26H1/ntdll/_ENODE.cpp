...
struct _KNODE// Size=0x58 (Id=87)
{
    ...
    struct _unnamed_86 Flags;// Offset=0xa Size=0x1
...
struct _ENODE// Size=0x80 (Id=112)
{
    struct _KNODE Ncb;// Offset=0x0 Size=0x58
    struct _WORK_QUEUE_ITEM HotAddProcessorWorkItem;// Offset=0x58 Size=0x20
    unsigned long SubQueueCount;// Offset=0x78 Size=0x4
    unsigned long SubQueueIndexSeed;// Offset=0x7c Size=0x4
};
