...
union _XPF_MCE_FLAGS// Size=0x4 (Id=646)
{
...
union _XPF_MC_BANK_FLAGS// Size=0x1 (Id=784)
{
...
struct _WHEA_XPF_MC_BANK_DESCRIPTOR// Size=0x1c (Id=721)
{
...
struct _WHEA_XPF_MCE_DESCRIPTOR// Size=0x398 (Id=483)
{
...
union _WHEA_NOTIFICATION_FLAGS// Size=0x2 (Id=808)
{
...
struct _WHEA_NOTIFICATION_DESCRIPTOR// Size=0x1c (Id=577)
{
    unsigned char Type;// Offset=0x0 Size=0x1
    unsigned char Length;// Offset=0x1 Size=0x1
    union _WHEA_NOTIFICATION_FLAGS Flags;// Offset=0x2 Size=0x2
    union _unnamed_576 u;// Offset=0x4 Size=0x18
};

struct _WHEA_XPF_CMC_DESCRIPTOR// Size=0x3a4 (Id=417)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char NumberOfBanks;// Offset=0x3 Size=0x1
...
struct _WHEA_XPF_NMI_DESCRIPTOR// Size=0x3 (Id=727)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
};

struct _WHEA_IPF_MCA_DESCRIPTOR// Size=0x4 (Id=508)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
...
struct _WHEA_IPF_CPE_DESCRIPTOR// Size=0x4 (Id=642)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
struct _unnamed_478// Size=0x4 (Id=478)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_479// Size=0x4 (Id=479)
{
    struct _unnamed_478 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _WHEA_PCI_SLOT_NUMBER// Size=0x4 (Id=480)
{
    union _unnamed_479 u;// Offset=0x0 Size=0x4
};

union _AER_ROOTPORT_DESCRIPTOR_FLAGS// Size=0x2 (Id=536)
{
    struct // Size=0x2 (Id=0)
    {
...
struct _WHEA_AER_ROOTPORT_DESCRIPTOR// Size=0x24 (Id=521)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
union _AER_ENDPOINT_DESCRIPTOR_FLAGS// Size=0x2 (Id=433)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short UncorrectableErrorMaskRW:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_AER_BRIDGE_DESCRIPTOR// Size=0x2c (Id=375)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
struct _WHEA_GENERIC_ERROR_DESCRIPTOR// Size=0x34 (Id=464)
{
    unsigned short Type;// Offset=0x0 Size=0x2
...
struct _WHEA_GENERIC_ERROR_DESCRIPTOR_V2// Size=0x50 (Id=428)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Reserved;// Offset=0x2 Size=0x1
    unsigned char Enabled;// Offset=0x3 Size=0x1
...
struct _WHEA_ERROR_SOURCE_CONFIGURATION_DD// Size=0x18 (Id=702)
{
...
struct _WHEA_DEVICE_DRIVER_DESCRIPTOR// Size=0x74 (Id=638)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
union _unnamed_226// Size=0x3a4 (Id=226)
{
...
struct _WHEA_ERROR_SOURCE_DESCRIPTOR// Size=0x3cc (Id=227)
{
    ...
    union _unnamed_226 Info;// Offset=0x28 Size=0x3a4
};
