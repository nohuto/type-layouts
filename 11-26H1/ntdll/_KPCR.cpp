struct _NT_TIB// Size=0x38 (Id=606)
{
...
union _KPRCBFLAG// Size=0x4 (Id=528)
{
...
struct _KDESCRIPTOR// Size=0x10 (Id=852)
{
...
struct _KSPECIAL_REGISTERS// Size=0x110 (Id=796)
{
...
struct _CONTEXT// Size=0x4d0 (Id=678)
{
...
union _KPRCB_BPB_FEATURES// Size=0x1 (Id=656)
{
...
union _KPRCB_BPB_RETPOLINE_STATE// Size=0x1 (Id=537)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _KSTATIC_AFFINITY_BLOCK// Size=0x820 (Id=364)
{
...
struct _KSOFTWARE_INTERRUPT_BATCH// Size=0x210 (Id=505)
{
...
struct _unnamed_103// Size=0x10 (Id=103)
{
...
union _SLIST_HEADER// Size=0x10 (Id=104)
{
    unsigned long long Alignment;// Offset=0x0 Size=0x8
    unsigned long long Region;// Offset=0x8 Size=0x8
    struct _unnamed_103 HeaderX64;// Offset=0x0 Size=0x10
};

struct _KDPC_LIST// Size=0x10 (Id=667)
{
    struct _SINGLE_LIST_ENTRY ListHead;// Offset=0x0 Size=0x8
    struct _SINGLE_LIST_ENTRY * LastEntry;// Offset=0x8 Size=0x8
};

struct _KDPC_DATA// Size=0x30 (Id=372)
{
...
union _ULARGE_INTEGER// Size=0x8 (Id=242)
{
    unsigned long LowPart;// Offset=0x0 Size=0x4
    unsigned long HighPart;// Offset=0x4 Size=0x4
...
struct _KTIMER_TABLE_ENTRY// Size=0x20 (Id=857)
{
...
struct _KGATE// Size=0x18 (Id=522)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
};

struct _KDPC// Size=0x40 (Id=200)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KMCE_RECOVERY_CONTEXT// Size=0x10 (Id=527)
{
...
struct _PROC_IDLE_POLICY// Size=0x6 (Id=843)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=726)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=689)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=698)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=805)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROC_PERF_CHECK_CONTEXT// Size=0x48 (Id=722)
{
...
struct _PROCESSOR_POWER_STATE// Size=0x268 (Id=653)
{
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=554)
{
    unsigned char Level;// Offset=0x0 Size=0x1
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=710)
{
...
struct _unnamed_61// Size=0x38 (Id=61)
{
...
struct _SYMCRYPT_ENTROPY_ACCUMULATOR_STATE// Size=0x180 (Id=550)
{
...
struct _IOP_IRP_STACK_PROFILER// Size=0x54 (Id=676)
{
    unsigned long Profile[20];// Offset=0x0 Size=0x50
    unsigned long TotalIrps;// Offset=0x50 Size=0x4
};

struct _KSECURE_FAULT_INFORMATION// Size=0x18 (Id=475)
{
...
struct _KTIMER_EXPIRATION_TRACE// Size=0x10 (Id=687)
{
...
struct _KCLOCK_TIMER_DEADLINE_ENTRY// Size=0x10 (Id=506)
{
...
struct _KCLOCK_TICK_TRACE// Size=0x28 (Id=445)
{
...
struct _KCLOCK_INCREMENT_TRACE// Size=0x20 (Id=728)
{
...
struct _KCLOCK_TIMER_STATE// Size=0x518 (Id=393)
{
...
struct _MACHINE_FRAME// Size=0x28 (Id=842)
{
...
struct _MACHINE_CHECK_CONTEXT// Size=0x50 (Id=630)
{
...
struct _KCORE_CONTROL_BLOCK_SHADOW// Size=0x40 (Id=595)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _KPRCB// Size=0xcf00 (Id=64)
{
    ...
    struct _unnamed_61 StibpPairingTrace;// Offset=0x9178 Size=0x38
...
struct _KPCR// Size=0xd080 (Id=54)
{
