...
struct _unnamed_161// Size=0x4 (Id=161)
{
    unsigned long Length;// Offset=0x0 Size=0x4
};
...
struct _unnamed_165// Size=0x18 (Id=165)
{
...
struct _unnamed_175// Size=0x4 (Id=175)
{
...
struct _unnamed_180// Size=0x1 (Id=180)
{
...
struct _unnamed_189// Size=0x8 (Id=189)
{
    struct _POWER_SEQUENCE * PowerSequence;// Offset=0x0 Size=0x8
};

struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=560)
{
    union // Size=0x4 (Id=0)
    {
...
struct _unnamed_192// Size=0x20 (Id=192)
{
    union // Size=0x4 (Id=0)
    {
...
struct _unnamed_195// Size=0x20 (Id=195)
{
...
union _unnamed_196// Size=0x20 (Id=196)
{
    struct _unnamed_149 Create;// Offset=0x0 Size=0x20
    struct _unnamed_150 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_151 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_152 Read;// Offset=0x0 Size=0x18
    struct _unnamed_152 Write;// Offset=0x0 Size=0x18
    struct _unnamed_154 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_155 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_157 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_158 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_159 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_160 QueryEa;// Offset=0x0 Size=0x20
    struct _unnamed_161 SetEa;// Offset=0x0 Size=0x4
    struct _unnamed_163 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_163 SetVolume;// Offset=0x0 Size=0x10
    struct _unnamed_164 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_165 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_166 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_167 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_168 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_169 MountVolume;// Offset=0x0 Size=0x18
    struct _unnamed_170 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_172 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_173 QueryQuota;// Offset=0x0 Size=0x20
    struct _unnamed_161 SetQuota;// Offset=0x0 Size=0x4
    struct _unnamed_175 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_176 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_177 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_178 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_179 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_180 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_182 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_184 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_186 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_188 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_189 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_192 Power;// Offset=0x0 Size=0x20
    struct _unnamed_193 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_194 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_195 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=197)
{
    ...
    union _unnamed_196 Parameters;// Offset=0x8 Size=0x20
