...
struct _HEAP_VS_DELAY_FREE_CONTEXT// Size=0x10 (Id=501)
{
    union _SLIST_HEADER ListHead;// Offset=0x0 Size=0x10
};

struct _HEAP_VS_AFFINITY_SLOT// Size=0x80 (Id=312)
{
    unsigned long long VsContextOffset;// Offset=0x0 Size=0x8
