union _unnamed_142// Size=0x8 (Id=142)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=692)
{
    union // Size=0x4 (Id=0)
    {
...
union _unnamed_145// Size=0x10 (Id=145)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_144 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=569)
{
...
struct _unnamed_146// Size=0x58 (Id=146)
{
...
union _unnamed_147// Size=0x58 (Id=147)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_146 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=148)
{
    ...
    union _unnamed_142 AssociatedIrp;// Offset=0x18 Size=0x8
