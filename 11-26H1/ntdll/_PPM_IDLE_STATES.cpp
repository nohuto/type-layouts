...
struct _PROCESSOR_IDLE_CONSTRAINTS// Size=0x30 (Id=823)
{
...
struct _PPM_SELECTION_MENU// Size=0x10 (Id=869)
{
    unsigned long Count;// Offset=0x0 Size=0x4
    struct _PPM_SELECTION_MENU_ENTRY * Entries;// Offset=0x8 Size=0x8
};

struct _PPM_COORDINATED_SELECTION// Size=0x18 (Id=888)
{
...
struct _PPM_VETO_ACCOUNTING// Size=0x28 (Id=894)
{
...
struct _PPM_IDLE_STATE// Size=0x160 (Id=853)
{
    ...
    unsigned char DriverInitiatedWakeSupported;// Offset=0x158 Size=0x1
};

struct _PPM_IDLE_STATES// Size=0x580 (Id=800)
{
    ...
    unsigned char Reserved2;// Offset=0x40 Size=0x1
    ...
    struct _PPM_IDLE_STATE State[1];// Offset=0x420 Size=0x160
};
