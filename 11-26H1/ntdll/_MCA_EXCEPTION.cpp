...
struct _unnamed_885// Size=0x8 (Id=885)
{
...
union _MCI_STATS// Size=0x8 (Id=886)
{
    struct _unnamed_885 MciStatus;// Offset=0x0 Size=0x8
    unsigned long long QuadPart;// Offset=0x0 Size=0x8
};

union _MCI_ADDR// Size=0x8 (Id=873)
{
...
struct _unnamed_764// Size=0x10 (Id=764)
{
    unsigned long long Address;// Offset=0x0 Size=0x8
    unsigned long long Type;// Offset=0x8 Size=0x8
};

union _unnamed_765// Size=0x20 (Id=765)
{
    union // Size=0x20 (Id=0)
    {
        struct _unnamed_763 Mca;// Offset=0x0 Size=0x20
        struct _unnamed_764 Mce;// Offset=0x0 Size=0x10
    };
};

struct _MCA_EXCEPTION// Size=0x100 (Id=766)
{
    ...
    union _unnamed_765 u;// Offset=0x18 Size=0x20
