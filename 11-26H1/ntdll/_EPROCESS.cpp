...
struct _KAB_UM_PROCESS_CONTEXT// Size=0x10 (Id=410)
{
...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=453)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _KGROUP_MASK// Size=0x10 (Id=396)
{
    unsigned long long Masks[2];// Offset=0x0 Size=0x10
};

union _KSTACK_COUNT// Size=0x4 (Id=90)
{
...
union _KPROCESS_SECURE_STATE// Size=0x8 (Id=94)
{
    unsigned long long EntireField;// Offset=0x0 Size=0x8
    struct _unnamed_93 Flags;// Offset=0x0 Size=0x8
    struct // Size=0x8 (Id=0)
    {
...
struct _KPROCESS// Size=0x1c8 (Id=92)
{
...
struct _EX_FAST_REF// Size=0x8 (Id=116)
{
    union // Size=0x8 (Id=0)
    {
...
struct _RTL_AVL_TREE// Size=0x8 (Id=50)
{
    struct _RTL_BALANCED_NODE * Root;// Offset=0x0 Size=0x8
};

struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=647)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=682)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x1 (Id=0)
...
struct _MMSUPPORT_INSTANCE// Size=0xc0 (Id=599)
{
...
struct _MMSUPPORT_SHARED// Size=0x80 (Id=616)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=512)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=127)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=477)
{
...
struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=502)
{
...
union _PROCESS_EXECUTION_TRANSITION// Size=0x2 (Id=578)
{
...
union _PROCESS_EXECUTION_STATE// Size=0x1 (Id=588)
{
...
union _PROCESS_EXECUTION// Size=0x4 (Id=579)
{
...
struct _EPROCESS_POWER_THROTTLING_STATE// Size=0x8 (Id=617)
{
    unsigned long ControlMask;// Offset=0x0 Size=0x4
    unsigned long StateMask;// Offset=0x4 Size=0x4
};

struct _EPROCESS// Size=0x840 (Id=132)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_128 MitigationFlagsValues;// Offset=0x750 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x754 Size=0x4
        struct _unnamed_129 MitigationFlags2Values;// Offset=0x754 Size=0x4
    };
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_130 MitigationFlags3Values;// Offset=0x7d8 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_131 SyscallUsageValues;// Offset=0x7e0 Size=0x4
    };
