...
struct _OBP_SYSTEM_DOS_DEVICE_STATE// Size=0x6c (Id=881)
{
...
struct _OBJECT_NAMESPACE_LOOKUPTABLE// Size=0x260 (Id=921)
{
...
struct _OBP_SILODRIVERSTATE// Size=0x2e0 (Id=868)
{
...
struct _SEP_SILOSTATE// Size=0x30 (Id=758)
{
...
struct _SEP_RM_LSA_CONNECTION_STATE// Size=0x30 (Id=804)
{
...
struct _WNF_LOCK// Size=0x8 (Id=882)
{
    struct _EX_PUSH_LOCK PushLock;// Offset=0x0 Size=0x8
};

struct _WNF_SILODRIVERSTATE// Size=0x38 (Id=855)
{
...
struct _DBGK_SILOSTATE// Size=0x20 (Id=848)
{
...
struct _RTL_NLS_STATE// Size=0xb8 (Id=806)
{
...
struct _CRITICAL_PROCESS_EXCEPTION_DATA// Size=0x48 (Id=858)
{
...
struct _ESERVERSILO_GLOBALS// Size=0x5b0 (Id=747)
{
