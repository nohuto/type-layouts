struct _PPM_SELECTION_STATISTICS// Size=0x98 (Id=892)
{
...
struct _PROC_IDLE_STATE_BUCKET// Size=0x20 (Id=879)
{
...
struct _PROC_IDLE_STATE_ACCOUNTING// Size=0x400 (Id=860)
{
    unsigned long long TotalTime;// Offset=0x0 Size=0x8
    ...
    struct _PPM_SELECTION_STATISTICS SelectionStatistics;// Offset=0x28 Size=0x98
    struct _PROC_IDLE_STATE_BUCKET IdleTimeBuckets[26];// Offset=0xc0 Size=0x340
};

struct _PROC_IDLE_ACCOUNTING// Size=0x428 (Id=738)
{
    ...
    struct _PROC_IDLE_STATE_ACCOUNTING State[1];// Offset=0x28 Size=0x400
};
