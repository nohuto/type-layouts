...
struct _GENERIC_MAPPING// Size=0x10 (Id=1740)
{
...
struct _OBJECT_TYPE_INITIALIZER// Size=0x78 (Id=789)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    union // Size=0x2 (Id=0)
    {
        ...
        struct // Size=0x2 (Id=0)
        {
            ...
            unsigned char SeTrustConstraintMaskPresent:1;// Offset=0x3 Size=0x1 BitOffset=0x1 BitSize=0x1
            unsigned char CloseReturnsResults:1;// Offset=0x3 Size=0x1 BitOffset=0x2 BitSize=0x1
            unsigned char Reserved:5;// Offset=0x3 Size=0x1 BitOffset=0x3 BitSize=0x5
        };
    };
    ...
    union // Size=0x8 (Id=0)
    {
        ...
        void  ( * CloseProcedure2)(struct _EPROCESS * ,void * ,unsigned long long ,unsigned long long ,struct _OBJECT_CLOSE_RESULT * );// Offset=0x40 Size=0x8
    };
...
struct _OBJECT_TYPE// Size=0xe0 (Id=130)
{
    ...
    unsigned long SeMandatoryLabelMask;// Offset=0xd8 Size=0x4
    unsigned long SeTrustConstraintMask;// Offset=0xdc Size=0x4
};
