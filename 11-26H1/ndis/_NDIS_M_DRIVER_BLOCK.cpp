...
struct _NDIS_MINIPORT_DRIVER_CHARACTERISTICS// Size=0xa0 (Id=706)
{
...
struct _NDIS50_MINIPORT_CHARACTERISTICS// Size=0xb8 (Id=1214)
{
...
struct _NDIS51_MINIPORT_CHARACTERISTICS// Size=0xf0 (Id=1328)
{
...
struct _KMUTANT// Size=0x38 (Id=533)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _NDIS_CO_CALL_MANAGER_OPTIONAL_HANDLERS// Size=0x90 (Id=535)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_M_DRIVER_BLOCK// Size=0x4a8 (Id=552)
{
    ...
    int  ( * AddDeviceHandler)(void * ,void * );// Offset=0x308 Size=0x8
    void  ( * RemoveDeviceHandler)(void * );// Offset=0x310 Size=0x8
    int  ( * FilterResourceRequirementsHandler)(void * ,struct _IRP * );// Offset=0x318 Size=0x8
    int  ( * StartDeviceHandler)(void * ,struct _IRP * );// Offset=0x320 Size=0x8
    int  ( * OpenNDKAdapterHandler)(void * ,struct _NDIS_OPEN_NDK_ADAPTER_PARAMETERS * ,struct _NDK_ADAPTER ** );// Offset=0x328 Size=0x8
    void  ( * CloseNDKAdapterHandler)(void * ,struct _NDK_ADAPTER * );// Offset=0x330 Size=0x8
    void  ( * SysPowerNotifyHandler)(void * ,struct _NDIS_MINIPORT_SYSPOWER_NOTIFY * );// Offset=0x338 Size=0x8
    int  ( * IdleNotificationHandler)(void * ,unsigned char );// Offset=0x340 Size=0x8
    void  ( * CancelIdleNotificationHandler)(void * );// Offset=0x348 Size=0x8
    int  ( * DevicePowerNotifyHandler)(void * ,enum _DEVICE_POWER_STATE );// Offset=0x350 Size=0x8
    void  ( * ReenumerateFailedAdapterHandler)(void * );// Offset=0x358 Size=0x8
    long  ( * LiveDumpCallback)(struct NDIS_MEMORYDUMP_HANDLE__ * ,long  ( * )(struct NDIS_MEMORYDUMP_HANDLE__ * ,struct _GUID * ,void * ,unsigned long ),unsigned long ,unsigned long long ,unsigned long long ,unsigned long long ,unsigned long long ,void * );// Offset=0x360 Size=0x8
    struct _UNICODE_STRING ImageName;// Offset=0x368 Size=0x10
    struct NDIS_MINIPORT_HOOK_DRIVER_HANDLE__ * HookDriverHandle;// Offset=0x378 Size=0x8
    enum _NDIS_MINIPORT_HOOK_DRIVER_TYPE HookType;// Offset=0x380 Size=0x4
    bool HookRegistered;// Offset=0x384 Size=0x1
    int  ( * AllocateNetBufferListForwardingContextHandler)(void * ,struct _NET_BUFFER_LIST * );// Offset=0x388 Size=0x8
    void  ( * FreeNetBufferListForwardingContextHandler)(void * ,struct _NET_BUFFER_LIST * );// Offset=0x390 Size=0x8
    int  ( * AddNetBufferListDestinationHandler)(void * ,struct _NET_BUFFER_LIST * ,struct _NDIS_SWITCH_PORT_DESTINATION * );// Offset=0x398 Size=0x8
    int  ( * SetNetBufferListSourceHandler)(void * ,struct _NET_BUFFER_LIST * ,unsigned int ,unsigned short );// Offset=0x3a0 Size=0x8
    int  ( * GrowNetBufferListDestinationsHandler)(void * ,struct _NET_BUFFER_LIST * ,unsigned int ,struct _NDIS_SWITCH_FORWARDING_DESTINATION_ARRAY ** );// Offset=0x3a8 Size=0x8
    void  ( * GetNetBufferListDestinationsHandler)(void * ,struct _NET_BUFFER_LIST * ,struct _NDIS_SWITCH_FORWARDING_DESTINATION_ARRAY ** );// Offset=0x3b0 Size=0x8
    int  ( * UpdateNetBufferListDestinationsHandler)(void * ,struct _NET_BUFFER_LIST * ,unsigned int ,struct _NDIS_SWITCH_FORWARDING_DESTINATION_ARRAY * );// Offset=0x3b8 Size=0x8
    int  ( * CopyNetBufferListInfoHandler)(void * ,struct _NET_BUFFER_LIST * ,struct _NET_BUFFER_LIST * ,unsigned int );// Offset=0x3c0 Size=0x8
    int  ( * ReferenceSwitchNicHandler)(void * ,unsigned int ,unsigned short );// Offset=0x3c8 Size=0x8
    int  ( * DereferenceSwitchNicHandler)(void * ,unsigned int ,unsigned short );// Offset=0x3d0 Size=0x8
    int  ( * ReferenceSwitchPortHandler)(void * ,unsigned int );// Offset=0x3d8 Size=0x8
    int  ( * DereferenceSwitchPortHandler)(void * ,unsigned int );// Offset=0x3e0 Size=0x8
    void  ( * ReportFilteredNetBufferListsHandler)(void * ,struct _UNICODE_STRING * ,struct _UNICODE_STRING * ,unsigned int ,unsigned int ,unsigned int ,struct _NET_BUFFER_LIST * ,struct _UNICODE_STRING * );// Offset=0x3e8 Size=0x8
    int  ( * SetNetBufferListSwitchContextHandler)(void * ,struct _NET_BUFFER_LIST * ,struct _NDIS_SWITCH_NET_BUFFER_LIST_CONTEXT_TYPE_INFO * ,void * );// Offset=0x3f0 Size=0x8
    void *  ( * GetNetBufferListSwitchContextHandler)(void * ,struct _NET_BUFFER_LIST * ,struct _NDIS_SWITCH_NET_BUFFER_LIST_CONTEXT_TYPE_INFO * );// Offset=0x3f8 Size=0x8
    long  ( * PDExtProviderRegisterClient)(struct NDIS_PD_EXT_PROVIDER_CONTEXT__ * ,struct NDIS_PD_EXT_CLIENT_CONTEXT__ * ,struct _GUID * ,struct _UNICODE_STRING * ,struct _NDIS_PD_EXT_CLIENT_PARAM * ,struct _NDIS_PD_EXT_CLIENT_DISPATCH * );// Offset=0x400 Size=0x8
    void  ( * PDExtProviderDeregisterClient)(struct NDIS_PD_EXT_PROVIDER_CONTEXT__ * ,struct NDIS_PD_EXT_CLIENT_CONTEXT__ * );// Offset=0x408 Size=0x8
    struct _PD_BUFFER *  ( * PDExtProviderGetFreePDBuffer)(struct NDIS_PD_EXT_PROVIDER_CONTEXT__ * ,unsigned int ,unsigned long ,unsigned long );// Offset=0x410 Size=0x8
    void  ( * PDExtProviderReturnPDBuffer)(struct NDIS_PD_EXT_PROVIDER_CONTEXT__ * ,struct _PD_BUFFER * ,unsigned long );// Offset=0x418 Size=0x8
    void  ( * PDExtProviderInjectPDBuffer)(struct NDIS_PD_EXT_PROVIDER_CONTEXT__ * ,struct _PD_BUFFER * ,struct _PD_BUFFER * ,unsigned long );// Offset=0x420 Size=0x8
    long  ( * PDExtProviderCopyPDBufferInfo)(struct NDIS_PD_EXT_PROVIDER_CONTEXT__ * ,struct _PD_BUFFER * ,struct _PD_BUFFER * ,unsigned long );// Offset=0x428 Size=0x8
    void *  ( * PDExtProviderGetPDBufferClientContext)(struct NDIS_PD_EXT_PROVIDER_CONTEXT__ * ,struct _PD_BUFFER * ,unsigned long );// Offset=0x430 Size=0x8
    long  ( * PDExtProviderGetPDBufferDestinations)(struct NDIS_PD_EXT_PROVIDER_CONTEXT__ * ,struct _PD_BUFFER * ,struct _NDIS_SWITCH_FORWARDING_DESTINATION_ARRAY ** );// Offset=0x438 Size=0x8
    long  ( * PDExtProviderAddPDBufferDestination)(struct NDIS_PD_EXT_PROVIDER_CONTEXT__ * ,struct _PD_BUFFER * ,struct _NDIS_SWITCH_PORT_DESTINATION * );// Offset=0x440 Size=0x8
    long  ( * PDExtProviderUpdatePDBufferDestinations)(struct NDIS_PD_EXT_PROVIDER_CONTEXT__ * ,struct _PD_BUFFER * ,unsigned int ,struct _NDIS_SWITCH_FORWARDING_DESTINATION_ARRAY * );// Offset=0x448 Size=0x8
    union _NDIS_SWITCH_FORWARDING_DETAIL_NET_BUFFER_LIST_INFO *  ( * PDExtProviderGetPDBufferForwardingDetail)(struct _PD_BUFFER * );// Offset=0x450 Size=0x8
    void  ( * PDExtProviderSetupBufferFromPDBuffer)(struct _PD_BUFFER * ,struct _PD_BUFFER * ,unsigned long ,unsigned long );// Offset=0x458 Size=0x8
    long  ( * PDExtProviderGrowPDBufferDestinations)(struct NDIS_PD_EXT_PROVIDER_CONTEXT__ * ,struct _PD_BUFFER * ,unsigned int ,struct _NDIS_SWITCH_FORWARDING_DESTINATION_ARRAY ** );// Offset=0x460 Size=0x8
    long  ( * PDExtProviderGetSwitchInfo)(struct NDIS_PD_EXT_PROVIDER_CONTEXT__ * ,unsigned long * );// Offset=0x468 Size=0x8
    long  ( * PDBMCreateDomain)(struct _NDIS_PD_BM_DOMAIN_PARAMETERS * ,struct NDIS_PD_BM_DOMAIN_HANDLE__ ** );// Offset=0x470 Size=0x8
    long  ( * PDBMAddMemberToDomain)(struct NDIS_PD_BM_DOMAIN_HANDLE__ * ,struct _NDIS_PD_BM_DOMAIN_MEMBER_PARAMETERS * ,struct NDIS_PD_BM_DOMAIN_MEMBER_HANDLE__ ** );// Offset=0x478 Size=0x8
    void  ( * PDBMRemoveMemberFromDomain)(struct NDIS_PD_BM_DOMAIN_MEMBER_HANDLE__ * );// Offset=0x480 Size=0x8
    void  ( * PDBMDeleteDomain)(struct NDIS_PD_BM_DOMAIN_HANDLE__ * );// Offset=0x488 Size=0x8
    long  ( * PDBMAllocateCommonBuffer)(struct NDIS_PD_BM_DOMAIN_HANDLE__ * ,unsigned long ,unsigned long ,unsigned long ,union _LARGE_INTEGER * ,void ** );// Offset=0x490 Size=0x8
    void  ( * PDBMFreeCommonBuffer)(struct NDIS_PD_BM_DOMAIN_HANDLE__ * ,unsigned long ,union _LARGE_INTEGER ,void * );// Offset=0x498 Size=0x8
    class wistd::unique_ptr<TriageData,KFreePoolNP<TriageData> > Triage;// Offset=0x4a0 Size=0x8
    void ~_NDIS_M_DRIVER_BLOCK();
