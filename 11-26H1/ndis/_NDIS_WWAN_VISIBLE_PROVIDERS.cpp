...
struct _WWAN_LIST_HEADER// Size=0x8 (Id=886)
{
    enum _WWAN_STRUCT_TYPE ElementType;// Offset=0x0 Size=0x4
    unsigned long ElementCount;// Offset=0x4 Size=0x4
};

struct _NDIS_WWAN_VISIBLE_PROVIDERS// Size=0x10 (Id=1061)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    unsigned long uStatus;// Offset=0x4 Size=0x4
    struct _WWAN_LIST_HEADER VisibleListHeader;// Offset=0x8 Size=0x8
};
