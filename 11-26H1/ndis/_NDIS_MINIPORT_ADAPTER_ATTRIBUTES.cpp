...
struct _NDIS_MINIPORT_ADD_DEVICE_REGISTRATION_ATTRIBUTES// Size=0x18 (Id=1154)
{
...
struct _NDIS_MINIPORT_ADAPTER_REGISTRATION_ATTRIBUTES// Size=0x20 (Id=1118)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES// Size=0xe0 (Id=1538)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_ADAPTER_OFFLOAD_ATTRIBUTES// Size=0x28 (Id=1766)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_ADAPTER_HARDWARE_ASSIST_ATTRIBUTES// Size=0x60 (Id=1071)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_ADAPTER_NDK_ATTRIBUTES// Size=0x10 (Id=1306)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_ADAPTER_PACKET_DIRECT_ATTRIBUTES// Size=0xc (Id=857)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
...
union _NDIS_MINIPORT_ADAPTER_ATTRIBUTES// Size=0xe0 (Id=982)
{
