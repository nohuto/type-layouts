struct _NT_TIB// Size=0x38 (Id=1303)
{
...
struct _CLIENT_ID// Size=0x10 (Id=802)
{
...
struct _ACTIVATION_CONTEXT_STACK// Size=0x28 (Id=891)
{
    struct _RTL_ACTIVATION_CONTEXT_STACK_FRAME * ActiveFrame;// Offset=0x0 Size=0x8
    struct _LIST_ENTRY FrameListCache;// Offset=0x8 Size=0x10
...
struct _GDI_TEB_BATCH// Size=0x4e8 (Id=1313)
{
...
struct _GROUP_AFFINITY// Size=0x10 (Id=761)
{
...
struct _TEB// Size=0x1870 (Id=50)
{
    ...
    void * SystemReserved1[22];// Offset=0x190 Size=0xb0
    ...
    void * HeapGlobalLock;// Offset=0x250 Size=0x8
    void * HeapFlsData;// Offset=0x258 Size=0x8
    ...
    struct _ACTIVATION_CONTEXT_STACK _ActivationStack;// Offset=0x290 Size=0x28
    ...
    struct _CHPEV2_CPUAREA_INFO * ChpeV2CpuAreaInfo;// Offset=0x1788 Size=0x8
    void * Unused;// Offset=0x1790 Size=0x8
    ...
    void * SparePVOID;// Offset=0x17b0 Size=0x8
    ...
    void * SchedulerSharedDataSlot;// Offset=0x1850 Size=0x8
    struct _GROUP_AFFINITY PrimaryGroupAffinity;// Offset=0x1858 Size=0x10
