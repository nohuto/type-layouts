...
struct _RTL_DRIVE_LETTER_CURDIR// Size=0x18 (Id=1347)
{
...
struct _RTL_USER_PROCESS_PARAMETERS// Size=0x448 (Id=1034)
{
    ...
    struct _UNICODE_STRING RedirectionDllName;// Offset=0x410 Size=0x10
    struct _UNICODE_STRING HeapPartitionName;// Offset=0x420 Size=0x10
    unsigned long long * DefaultThreadpoolCpuSetMasks;// Offset=0x430 Size=0x8
    unsigned long DefaultThreadpoolCpuSetMaskCount;// Offset=0x438 Size=0x4
    unsigned long DefaultThreadpoolThreadMaximum;// Offset=0x43c Size=0x4
    unsigned long HeapMemoryTypeMask;// Offset=0x440 Size=0x4
};
