...
struct _CM_PARTIAL_RESOURCE_DESCRIPTOR// Size=0x14 (Id=1422)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x10 (Id=2715)
        {
            ...
            struct <unnamed-type-MessageInterrupt>// Size=0x10 (Id=2730)
            {
                struct _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-MessageInterrupt>::_unnamed_1916::<unnamed-type-Raw> Raw;// Offset=0x0 Size=0x10
                struct _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-MessageInterrupt>::_unnamed_1917::<unnamed-type-Translated> Translated;// Offset=0x0 Size=0x10
            };
            ...
            struct <unnamed-type-DmaV3>// Size=0xc (Id=2743)
            {
                unsigned long Channel;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-DevicePrivate>// Size=0xc (Id=2751)
            {
            ...
            struct <unnamed-type-BusNumber>// Size=0xc (Id=2755)
            {
            ...
            struct <unnamed-type-DeviceSpecificData>// Size=0xc (Id=2760)
            {
...
struct _CM_PARTIAL_RESOURCE_LIST// Size=0x1c (Id=1814)
{
...
struct _CM_FULL_RESOURCE_DESCRIPTOR// Size=0x24 (Id=1158)
{
...
struct _CM_RESOURCE_LIST// Size=0x28 (Id=1341)
{
