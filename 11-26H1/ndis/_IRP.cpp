...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=1516)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=1210)
{
...
struct _KAPC// Size=0x58 (Id=1149)
{
...
struct _IRP// Size=0xd0 (Id=96)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=5114)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=5133)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=5134)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=5147)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=5148)
            {
