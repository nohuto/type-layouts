...
struct _NDIS_GFT_EXACT_MATCH_FLOW_ENTRY// Size=0xa8 (Id=1983)
{
    union // Size=0x2c (Id=0)
    {
        ...
        union <unnamed-type-CounterValueBuffer>// Size=0x8 (Id=7393)
        {
            ...
            struct _NDIS_GFT_PACKET_BYTE_COUNTER_VALUE * PacketByteCounterAddress;// Offset=0x0 Size=0x8
            struct _NDIS_GFT_PACKET_BYTE_COUNTER_VALUE_AND_STATE * PacketByteCounterAndStateAddress;// Offset=0x0 Size=0x8
        };
    ...
    unsigned long TcpSequenceNumber;// Offset=0x84 Size=0x4
    unsigned long HeaderGroupExactMatchArrayOffset;// Offset=0x88 Size=0x4
    unsigned long HeaderGroupExactMatchArrayNumElements;// Offset=0x8c Size=0x4
    unsigned long HeaderGroupExactMatchArrayElementSize;// Offset=0x90 Size=0x4
    unsigned long HeaderGroupTranspositionArrayOffset;// Offset=0x94 Size=0x4
    unsigned long HeaderGroupTranspositionArrayNumElements;// Offset=0x98 Size=0x4
    unsigned long HeaderGroupTranspositionArrayElementSize;// Offset=0x9c Size=0x4
    unsigned long CustomActionOffset;// Offset=0xa0 Size=0x4
};
