...
struct _NDIS_FILTER_DRIVER_CHARACTERISTICS// Size=0xf0 (Id=960)
{
...
struct _NDIS_FILTER_DRIVER_BLOCK// Size=0x170 (Id=557)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    ...
    class KRef<NDIS_BIND_FILTER_DRIVER> Bind;// Offset=0x150 Size=0x8
    struct _UNICODE_STRING ImageName;// Offset=0x158 Size=0x10
    class wistd::unique_ptr<TriageData,KFreePoolNP<TriageData> > Triage;// Offset=0x168 Size=0x8
