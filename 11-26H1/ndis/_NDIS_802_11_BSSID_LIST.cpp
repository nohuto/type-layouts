struct _NDIS_802_11_SSID// Size=0x24 (Id=1010)
{
...
struct _NDIS_802_11_CONFIGURATION_FH// Size=0x10 (Id=1606)
{
...
struct _NDIS_802_11_CONFIGURATION// Size=0x20 (Id=876)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _NDIS_WLAN_BSSID// Size=0x68 (Id=1990)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _NDIS_802_11_BSSID_LIST// Size=0x6c (Id=1666)
{
    unsigned long NumberOfItems;// Offset=0x0 Size=0x4
    struct _NDIS_WLAN_BSSID Bssid[1];// Offset=0x4 Size=0x68
};
