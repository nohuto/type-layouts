union _NDIS_PACKET_8021Q_INFO::_unnamed_1364// Size=0x8 (Id=1364)
{
    struct <unnamed-type-TagHeader>// Size=0x4 (Id=10078)
    {
    ...
    struct _NDIS_PACKET_8021Q_INFO::_unnamed_1365::<unnamed-type-TagHeader> TagHeader;// Offset=0x0 Size=0x4
