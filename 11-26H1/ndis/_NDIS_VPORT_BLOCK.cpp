...
struct _NDIS_NDK_CAPABILITIES// Size=0x38 (Id=1906)
{
...
struct _NDIS_NDK_REQUEST_PARAMETERS// Size=0x68 (Id=2254)
{
...
struct _NDIS_NDK_RESPONSE_PARAMETERS// Size=0x40 (Id=2249)
{
...
struct _NDIS_NDK_PARAMETERS// Size=0xa8 (Id=2248)
{
...
struct _NDIS_NIC_SWITCH_VPORT_PARAMETERS// Size=0x2f0 (Id=2231)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
...
struct _NDIS_VPORT_BLOCK// Size=0x388 (Id=2156)
{
