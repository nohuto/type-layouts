...
struct _NDIS_CONNECTION_INFO// Size=0x30 (Id=1620)
{
    unsigned char MacAddress[6];// Offset=0x0 Size=0x6
    union // Size=0xc (Id=0)
    {
        struct _NDIS_CONNECTION_INFO::_unnamed_1622::<unnamed-type-IPv4Info> IPv4Info;// Offset=0x8 Size=0xc
        struct _NDIS_CONNECTION_INFO::_unnamed_1623::<unnamed-type-IPv6Info> IPv6Info;// Offset=0x8 Size=0x21
    };
    union // Size=0x4 (Id=0)
    {
        struct _NDIS_CONNECTION_INFO::_unnamed_1625::<unnamed-type-TcpPortInfo> TcpPortInfo;// Offset=0x2c Size=0x4
        struct _NDIS_CONNECTION_INFO::_unnamed_1626::<unnamed-type-UdpPortInfo> UdpPortInfo;// Offset=0x2c Size=0x4
    };
};
...
struct _NDIS_RECEIVE_FILTER_PARAMETERS// Size=0x2c (Id=1553)
{
...
struct _NDIS_RECEIVE_FILTER_BLOCK// Size=0xb8 (Id=1289)
{
