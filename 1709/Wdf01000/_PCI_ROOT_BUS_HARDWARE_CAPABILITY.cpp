...
struct _PCI_ROOT_BUS_OSC_SUPPORT_FIELD// Size=0x4 (Id=2191)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=12544)
        {
...
struct _PCI_ROOT_BUS_OSC_CONTROL_FIELD// Size=0x4 (Id=4469)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=12534)
        {
...
struct _PCI_ROOT_BUS_HARDWARE_CAPABILITY// Size=0x24 (Id=1856)
{
