...
struct _WDF_REQUEST_PARAMETERS_V1_5// Size=0x28 (Id=2659)
{
    union // Size=0x8 (Id=0)
    {
        ...
        union <unnamed-type-Parameters>// Size=0x20 (Id=22459)
        {
            struct <unnamed-type-Create>// Size=0x20 (Id=22460)
            {
            ...
            struct <unnamed-type-Read>// Size=0x18 (Id=22467)
            {
            ...
            struct <unnamed-type-Write>// Size=0x18 (Id=22472)
            {
                unsigned long long Length;// Offset=0x0 Size=0x8
                unsigned long Key;// Offset=0x8 Size=0x4
                long long DeviceOffset;// Offset=0x10 Size=0x8
            ...
            struct <unnamed-type-DeviceIoControl>// Size=0x20 (Id=22477)
            {
            ...
            struct <unnamed-type-Others>// Size=0x20 (Id=22483)
            {
