union _WHEA_ARM_CACHE_ERROR_VALID_BITS// Size=0x2 (Id=1766)
{
...
struct _WHEA_ARM_CACHE_ERROR// Size=0xc (Id=2402)
{
...
union _WHEA_ARM_TLB_ERROR_VALID_BITS// Size=0x2 (Id=3820)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short TransactionType:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_ARM_TLB_ERROR// Size=0xc (Id=3591)
{
...
union _WHEA_ARM_BUS_ERROR_VALID_BITS// Size=0x2 (Id=4472)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short TransactionType:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_ARM_BUS_ERROR// Size=0xc (Id=3887)
{
...
union _WHEA_ARM_PROCESSOR_ERROR// Size=0xc (Id=3693)
{
    union // Size=0xc (Id=0)
    {
