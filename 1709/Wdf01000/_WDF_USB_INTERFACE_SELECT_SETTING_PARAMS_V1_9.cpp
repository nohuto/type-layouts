...
struct _WDF_USB_INTERFACE_SELECT_SETTING_PARAMS_V1_9// Size=0x10 (Id=1939)
{
    union // Size=0x8 (Id=0)
    {
        unsigned long Size;// Offset=0x0 Size=0x4
        enum _WdfUsbTargetDeviceSelectSettingType Type;// Offset=0x4 Size=0x4
        union <unnamed-type-Types>// Size=0x8 (Id=23581)
        {
            struct <unnamed-type-Descriptor>// Size=0x8 (Id=23582)
            {
            ...
            struct <unnamed-type-Interface>// Size=0x1 (Id=23585)
            {
            ...
            struct <unnamed-type-Urb>// Size=0x8 (Id=23588)
            {
