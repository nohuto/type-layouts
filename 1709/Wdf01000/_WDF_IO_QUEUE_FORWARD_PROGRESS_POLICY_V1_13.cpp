...
struct _WDF_IO_FORWARD_PROGRESS_RESERVED_POLICY_SETTINGS// Size=0x8 (Id=788)
{
    union // Size=0x8 (Id=0)
    {
        union <unnamed-type-Policy>// Size=0x8 (Id=19850)
        {
            struct <unnamed-type-ExaminePolicy>// Size=0x8 (Id=19851)
            {
...
struct _WDF_IO_QUEUE_FORWARD_PROGRESS_POLICY_V1_13// Size=0x28 (Id=2025)
{
