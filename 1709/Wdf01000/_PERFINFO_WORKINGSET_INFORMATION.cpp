struct _PERFINFO_WORKINGSET_ENTRY// Size=0x44 (Id=2639)
{
    union // Size=0x4 (Id=0)
    {
...
struct _PERFINFO_WORKINGSET_INFORMATION// Size=0x48 (Id=2819)
{
    unsigned long Count;// Offset=0x0 Size=0x4
    struct _PERFINFO_WORKINGSET_ENTRY WsEntry[1];// Offset=0x4 Size=0x44
};
