...
struct _WDF_IO_FORWARD_PROGRESS_RESERVED_POLICY_SETTINGS_V1_21// Size=0x8 (Id=3486)
{
    union // Size=0x8 (Id=0)
    {
        union <unnamed-type-Policy>// Size=0x8 (Id=19863)
        {
            struct <unnamed-type-ExaminePolicy>// Size=0x8 (Id=19864)
            {
...
struct _WDF_IO_QUEUE_FORWARD_PROGRESS_POLICY_V1_21// Size=0x28 (Id=4788)
{
