...
struct _WDF_IFR_OFFSET// Size=0x4 (Id=431)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=19478)
        {
            struct <unnamed-type-s>// Size=0x4 (Id=19479)
            {
...
struct _WDF_IFR_HEADER// Size=0x48 (Id=450)
{
