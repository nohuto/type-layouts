...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=175)
{
...
struct _STACK_DEVICE_CAPABILITIES// Size=0x58 (Id=4898)
{
    struct _DEVICE_CAPABILITIES DeviceCaps;// Offset=0x0 Size=0x40
    enum _DEVICE_WAKE_DEPTH DeepestWakeableDstate[6];// Offset=0x40 Size=0x18
};
