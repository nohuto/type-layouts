...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=2259)
{
...
struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION// Size=0x20 (Id=3467)
{
    ...
    {
        struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION::_unnamed_3469::<unnamed-type-ProcessorCore> ProcessorCore;// Offset=0x10 Size=0x1
        struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION::_unnamed_3468::<unnamed-type-NumaNode> NumaNode;// Offset=0x10 Size=0x4
