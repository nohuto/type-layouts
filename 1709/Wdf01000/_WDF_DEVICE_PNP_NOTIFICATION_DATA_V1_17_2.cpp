...
struct _WDF_DEVICE_PNP_NOTIFICATION_DATA_V1_17// Size=0xc (Id=3653)
{
    union // Size=0x4 (Id=0)
    {
        enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
        union <unnamed-type-Data>// Size=0x8 (Id=17748)
        {
            struct <unnamed-type-EnterState>// Size=0x8 (Id=17749)
            {
            ...
            struct <unnamed-type-PostProcessState>// Size=0x4 (Id=17753)
            {
                enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
            };
            ...
            struct <unnamed-type-LeaveState>// Size=0x8 (Id=17756)
            {
                enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
                enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
            };
