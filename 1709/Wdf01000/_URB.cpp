struct _URB_HEADER// Size=0x18 (Id=670)
{
...
struct _USBD_PIPE_INFORMATION// Size=0x18 (Id=1090)
{
...
struct _USBD_INTERFACE_INFORMATION// Size=0x30 (Id=972)
{
    unsigned short Length;// Offset=0x0 Size=0x2
...
struct _URB_SELECT_INTERFACE// Size=0x50 (Id=1160)
{
...
struct _URB_SELECT_CONFIGURATION// Size=0x58 (Id=1205)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
...
struct _URB_PIPE_REQUEST// Size=0x28 (Id=749)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
...
struct _URB_FRAME_LENGTH_CONTROL// Size=0x18 (Id=1009)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
};

struct _URB_GET_FRAME_LENGTH// Size=0x20 (Id=839)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
...
struct _URB_SET_FRAME_LENGTH// Size=0x20 (Id=1324)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    long FrameLengthDelta;// Offset=0x18 Size=0x4
};

struct _URB_GET_CURRENT_FRAME_NUMBER// Size=0x20 (Id=1347)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    unsigned long FrameNumber;// Offset=0x18 Size=0x4
};

struct _URB_HCD_AREA// Size=0x40 (Id=797)
{
    void * Reserved8[8];// Offset=0x0 Size=0x40
};

struct _URB_CONTROL_TRANSFER// Size=0x88 (Id=985)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
...
struct _URB_CONTROL_TRANSFER_EX// Size=0x88 (Id=1326)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _URB_BULK_OR_INTERRUPT_TRANSFER// Size=0x80 (Id=949)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _USBD_ISO_PACKET_DESCRIPTOR// Size=0xc (Id=417)
{
...
struct _URB_ISOCH_TRANSFER// Size=0x98 (Id=543)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _URB_CONTROL_DESCRIPTOR_REQUEST// Size=0x88 (Id=1118)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
...
struct _URB_CONTROL_GET_STATUS_REQUEST// Size=0x88 (Id=1042)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long Reserved0;// Offset=0x20 Size=0x4
...
struct _URB_CONTROL_FEATURE_REQUEST// Size=0x88 (Id=1307)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
...
struct _URB_CONTROL_VENDOR_OR_CLASS_REQUEST// Size=0x88 (Id=1358)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _URB_CONTROL_GET_CONFIGURATION_REQUEST// Size=0x88 (Id=716)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long Reserved0;// Offset=0x20 Size=0x4
...
struct _URB_OS_FEATURE_DESCRIPTOR_REQUEST// Size=0x88 (Id=825)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long Reserved0;// Offset=0x20 Size=0x4
...
struct _URB_OPEN_STATIC_STREAMS// Size=0x30 (Id=1146)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
...
struct _URB_GET_ISOCH_PIPE_TRANSFER_PATH_DELAYS// Size=0x28 (Id=1308)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
