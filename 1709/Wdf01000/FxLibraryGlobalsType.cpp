struct _OSVERSIONINFOEXW// Size=0x11c (Id=610)
{
...
struct _KBUGCHECK_REASON_CALLBACK_RECORD// Size=0x30 (Id=698)
{
...
struct _FX_DRIVER_TRACKER_CACHE_AWARE// Size=0x18 (Id=1253)
{
    union // Size=0x14b (Id=0)
    {
        struct _FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=8833)
        {
        ...
        struct FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=8847)
        {
        };// Offset=0x0 Size=0x8
        long Initialize();
        void Uninitialize();
...
struct FxLibraryGlobalsType// Size=0x2a0 (Id=1273)
{
    ...
    class FxCompanionLibrary * CompanionLibrary;// Offset=0x290 Size=0x8
    unsigned char IfrDisabled;// Offset=0x298 Size=0x1
    unsigned char SleepStudyDisabled;// Offset=0x299 Size=0x1
