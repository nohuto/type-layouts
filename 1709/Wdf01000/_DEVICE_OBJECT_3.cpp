...
struct _WAIT_CONTEXT_BLOCK// Size=0x48 (Id=164)
{
...
union _unnamed_182// Size=0x48 (Id=182)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
    struct _WAIT_CONTEXT_BLOCK Wcb;// Offset=0x0 Size=0x48
};

struct _KDEVICE_QUEUE// Size=0x28 (Id=113)
{
...
struct _DEVICE_OBJECT// Size=0x150 (Id=721)
{
    union // Size=0x4d (Id=0)
    {
        ...
        union <unnamed-type-Queue>// Size=0x48 (Id=6864)
        {
            struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
            struct _WAIT_CONTEXT_BLOCK Wcb;// Offset=0x0 Size=0x48
        };
