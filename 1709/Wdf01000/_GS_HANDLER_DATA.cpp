...
union _unnamed_313// Size=0x4 (Id=313)
{
    struct _unnamed_312 Bits;// Offset=0x0 Size=0x4
    long CookieOffset;// Offset=0x0 Size=0x4
};

struct _GS_HANDLER_DATA// Size=0xc (Id=314)
{
    union _unnamed_313 u;// Offset=0x0 Size=0x4
