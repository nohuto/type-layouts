...
struct _PCI_ADVANCED_FEATURES_CAPABILITY// Size=0x6 (Id=3828)
{
    union // Size=0x5 (Id=0)
    {
        struct _PCI_CAPABILITIES_HEADER Header;// Offset=0x0 Size=0x2
        unsigned char Length;// Offset=0x2 Size=0x1
        union <unnamed-type-Capabilities>// Size=0x1 (Id=11653)
        {
        ...
        union <unnamed-type-Control>// Size=0x1 (Id=11659)
        {
        ...
        union <unnamed-type-Status>// Size=0x1 (Id=11664)
        {
