struct _PEP_PROCESSOR_IDLE_DEPENDENCY// Size=0x10 (Id=508)
{
    union // Size=0x8 (Id=0)
    {
...
struct _PEP_PLATFORM_IDLE_STATE// Size=0x30 (Id=611)
{
    union // Size=0x8 (Id=0)
    {
...
struct _PEP_PPM_QUERY_PLATFORM_STATE// Size=0x38 (Id=602)
{
    unsigned long StateIndex;// Offset=0x0 Size=0x4
    struct _PEP_PLATFORM_IDLE_STATE State;// Offset=0x8 Size=0x30
};
