...
struct _unnamed_373// Size=0x4 (Id=373)
{
    enum _WDF_DEVICE_POWER_POLICY_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_374// Size=0x8 (Id=374)
{
    struct _unnamed_372 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_373 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_372 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=375)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_374 Data;// Offset=0x4 Size=0x8
};
