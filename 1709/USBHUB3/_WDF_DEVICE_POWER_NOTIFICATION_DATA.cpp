...
struct _unnamed_462// Size=0x4 (Id=462)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};
...
{
    struct _unnamed_461 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_462 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_461 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=464)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_463 Data;// Offset=0x4 Size=0x8
};
