...
struct _unnamed_218// Size=0x18 (Id=218)
{
...
struct _unnamed_221// Size=0x18 (Id=221)
{
...
struct _unnamed_224// Size=0xc (Id=224)
{
    unsigned long Data[3];// Offset=0x0 Size=0xc
};

struct _unnamed_225// Size=0x10 (Id=225)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_226// Size=0xc (Id=226)
{
...
struct _unnamed_227// Size=0x18 (Id=227)
{
...
struct _unnamed_228// Size=0x18 (Id=228)
{
...
union _unnamed_231// Size=0x18 (Id=231)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_218 Port;// Offset=0x0 Size=0x18
        struct _unnamed_218 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_221 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_222 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_223 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_218 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_224 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_225 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_226 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_227 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_228 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_229 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_230 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=232)
{
    ...
    union _unnamed_231 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=692)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=547)
{
