...
struct _unnamed_442// Size=0x8 (Id=442)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_443// Size=0x4 (Id=443)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_444// Size=0x8 (Id=444)
{
    struct _unnamed_442 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_443 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_442 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=445)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_444 Data;// Offset=0x4 Size=0x8
};
