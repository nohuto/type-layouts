...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=623)
{
    union // Size=0x4 (Id=0)
    {
...
union _unnamed_256// Size=0x8 (Id=256)
{
    void * Ptr;// Offset=0x0 Size=0x8
    unsigned long long Value;// Offset=0x0 Size=0x8
};

struct _unnamed_257// Size=0x20 (Id=257)
{
    union _unnamed_256 Argument1;// Offset=0x0 Size=0x8
    union _unnamed_256 Argument2;// Offset=0x8 Size=0x8
    union _unnamed_256 Argument3;// Offset=0x10 Size=0x8
    union _unnamed_256 Argument4;// Offset=0x18 Size=0x8
};

struct _unnamed_259// Size=0x8 (Id=259)
{
    struct _WDF_USB_REQUEST_COMPLETION_PARAMS * Completion;// Offset=0x0 Size=0x8
};

union _unnamed_260// Size=0x30 (Id=260)
{
    union // Size=0x30 (Id=0)
    {
        struct _unnamed_252 Write;// Offset=0x0 Size=0x18
        struct _unnamed_252 Read;// Offset=0x0 Size=0x18
        struct _unnamed_255 Ioctl;// Offset=0x0 Size=0x30
        struct _unnamed_257 Others;// Offset=0x0 Size=0x20
        struct _unnamed_259 Usb;// Offset=0x0 Size=0x8
    };
};

struct _WDF_REQUEST_COMPLETION_PARAMS// Size=0x48 (Id=261)
{
    unsigned long Size;// Offset=0x0 Size=0x4
    enum _WDF_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    struct _IO_STATUS_BLOCK IoStatus;// Offset=0x8 Size=0x10
    union _unnamed_260 Parameters;// Offset=0x18 Size=0x30
};
