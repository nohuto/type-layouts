union _unnamed_551// Size=0x2 (Id=551)
{
...
struct _USB_DEVICE_CAPABILITY_PD_CONSUMER_PORT_DESCRIPTOR// Size=0x18 (Id=552)
{
    ...
    union _unnamed_551 bmCapabilities;// Offset=0x4 Size=0x2
