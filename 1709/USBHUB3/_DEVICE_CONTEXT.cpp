...
struct _USBDEVICE_INFO// Size=0x18 (Id=549)
{
...
union _DEVICE_MUX_FLAGS// Size=0x4 (Id=618)
{
...
struct _DSM_MUX_CONTEXT// Size=0x38 (Id=424)
{
...
struct _URB_HCD_AREA// Size=0x40 (Id=665)
{
    void * Reserved8[8];// Offset=0x0 Size=0x40
};

struct _URB_CONTROL_TRANSFER_EX// Size=0x88 (Id=413)
{
...
struct _URB_PIPE_REQUEST// Size=0x28 (Id=674)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
...
struct _CONTROL_REQUEST// Size=0xa8 (Id=455)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=490)
{
    union // Size=0x4 (Id=0)
    {
...
struct _STATE_LOG// Size=0xc (Id=499)
{
...
struct _EVENT_QUEUE// Size=0x44 (Id=550)
{
...
struct _SM_CONTEXT// Size=0x420 (Id=411)
{
...
union _USB_DEVICE_PROPERTIES// Size=0x4 (Id=451)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_DEVICE_STATE_FLAGS// Size=0x4 (Id=675)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_DEVICE_SQM_PROPERTIES// Size=0x4 (Id=545)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_DEVICE_HACKS// Size=0x4 (Id=594)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _USB_HUB_DEVICE_UXD_SETTINGS// Size=0x44 (Id=458)
{
...
struct _USB_DEVICE_DESCRIPTOR// Size=0x12 (Id=510)
{
...
struct _USB_DEVICE_QUALIFIER_DESCRIPTOR// Size=0xa (Id=503)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
    unsigned short bcdUSB;// Offset=0x2 Size=0x2
...
struct _OS_STRING// Size=0x12 (Id=460)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
...
struct _USB_ID_STRING// Size=0x10 (Id=639)
{
...
struct _USB_SEL_INFO// Size=0x6 (Id=428)
{
...
union _DEVICE_LPM_STATE_FLAGS// Size=0x4 (Id=512)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _LPM_POLICY// Size=0x4 (Id=525)
{
    union // Size=0x4 (Id=0)
    {
        unsigned long AsUlong32;// Offset=0x0 Size=0x4
...
struct _DEVICE_20_LPM_ATTRIBUTES// Size=0x4 (Id=481)
{
    struct // Size=0x4 (Id=0)
    {
...
union _MSOS20_ALT_ENUM_FLAGS// Size=0x4 (Id=698)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _MSOS20_DESCRIPTOR_SET_INFO// Size=0x8 (Id=506)
{
...
struct _MSOS20_INFO// Size=0x60 (Id=530)
{
...
union _USB_DUAL_ROLE_FEATURES// Size=0x4 (Id=326)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct _unnamed_325 features;// Offset=0x0 Size=0x4
};

struct _DEVICE_CONTEXT// Size=0xa88 (Id=328)
{
    ...
    struct _MSOS20_INFO MsOs20Info;// Offset=0x9a0 Size=0x60
    union _USB_DEVICE_CAPABILITY_SUPERSPEEDPLUS_SPEED * SublinkSpeedAttr;// Offset=0xa00 Size=0x8
    unsigned long SublinkSpeedAttrCount;// Offset=0xa08 Size=0x4
    unsigned short RxTpDelay;// Offset=0xa0c Size=0x2
    unsigned short TxTpDelay;// Offset=0xa0e Size=0x2
    unsigned long MaxExitLatencyBasedOnEld;// Offset=0xa10 Size=0x4
    struct _RTL_BITMAP DescriptorValidationBitmapHeader;// Offset=0xa18 Size=0x10
    unsigned long DescriptorValidationBitmap[8];// Offset=0xa28 Size=0x20
    struct _BILLBOARD_INFO * BillboardInfo;// Offset=0xa48 Size=0x8
    struct WDFSTRING__ * BillboardSymbolicName;// Offset=0xa50 Size=0x8
    unsigned char BillboardDeviceInterfaceCreated;// Offset=0xa58 Size=0x1
    union _USB_DUAL_ROLE_FEATURES UsbDualRoleLocalFeatures;// Offset=0xa59 Size=0x4
    union _USB_DUAL_ROLE_FEATURES UsbDualRolePartnerFeatures;// Offset=0xa5d Size=0x4
    unsigned char DualRoleVendorCommand;// Offset=0xa61 Size=0x1
    long ClientInitiatedRecoveryEvents[5];// Offset=0xa64 Size=0x14
    struct _ENDPOINT_PRIORITY_ENTRY * EndpointPriorities;// Offset=0xa78 Size=0x8
    unsigned long EndpointPriorityCount;// Offset=0xa80 Size=0x4
    enum _DEVICE_POWER_STATE LastDeviceDxPowerState;// Offset=0xa84 Size=0x4
};
