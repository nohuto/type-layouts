...
struct _unnamed_435// Size=0x8 (Id=435)
{
...
union _unnamed_437// Size=0x8 (Id=437)
{
    struct _unnamed_435 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_436 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_435 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=438)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_437 Data;// Offset=0x4 Size=0x8
};
