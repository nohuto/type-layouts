...
struct _unnamed_248// Size=0x20 (Id=248)
{
...
union _unnamed_250// Size=0x20 (Id=250)
{
    struct _unnamed_38 Create;// Offset=0x0 Size=0x20
    struct _unnamed_247 Read;// Offset=0x0 Size=0x18
    struct _unnamed_247 Write;// Offset=0x0 Size=0x18
    struct _unnamed_248 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_249 Others;// Offset=0x0 Size=0x20
};

struct _WDF_REQUEST_PARAMETERS// Size=0x28 (Id=251)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned char MinorFunction;// Offset=0x2 Size=0x1
    enum _WDF_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    union _unnamed_250 Parameters;// Offset=0x8 Size=0x20
};
