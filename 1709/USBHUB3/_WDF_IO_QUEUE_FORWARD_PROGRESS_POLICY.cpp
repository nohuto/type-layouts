...
struct _unnamed_660// Size=0x8 (Id=660)
{
    enum _WDF_IO_FORWARD_PROGRESS_ACTION  ( * EvtIoWdmIrpForForwardProgress)(struct WDFQUEUE__ * ,struct _IRP * );// Offset=0x0 Size=0x8
};

union _unnamed_661// Size=0x8 (Id=661)
{
    struct _unnamed_660 ExaminePolicy;// Offset=0x0 Size=0x8
};

struct _WDF_IO_FORWARD_PROGRESS_RESERVED_POLICY_SETTINGS// Size=0x8 (Id=662)
{
    union _unnamed_661 Policy;// Offset=0x0 Size=0x8
};

struct _WDF_IO_QUEUE_FORWARD_PROGRESS_POLICY// Size=0x28 (Id=277)
{
