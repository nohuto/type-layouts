union _unnamed_501// Size=0x4 (Id=501)
{
...
struct _USB_DEVICE_CAPABILITY_USB20_EXTENSION_DESCRIPTOR// Size=0x7 (Id=502)
{
    ...
    union _unnamed_501 bmAttributes;// Offset=0x3 Size=0x4
};
