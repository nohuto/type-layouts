union _HUB_FLAGS// Size=0x4 (Id=663)
{
...
union _HUB_FLAGS_EXT// Size=0x4 (Id=614)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_20_PORT_STATUS// Size=0x2 (Id=688)
{
...
union _USB_30_PORT_STATUS// Size=0x2 (Id=678)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_PORT_STATUS// Size=0x2 (Id=559)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
...
union _USB_20_PORT_CHANGE// Size=0x2 (Id=672)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_30_PORT_CHANGE// Size=0x2 (Id=656)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_PORT_CHANGE// Size=0x2 (Id=617)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
...
union _USB_PORT_STATUS_AND_CHANGE// Size=0x4 (Id=600)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
...
struct _HUBUCX_ROOTHUB_INFO// Size=0x18 (Id=697)
{
...
struct _HUB_INFORMATION// Size=0x78 (Id=579)
{
...
struct _USB_TOPOLOGY_ADDRESS// Size=0x20 (Id=608)
{
...
struct _HUB_PARENT_INTERFACE// Size=0x88 (Id=554)
{
...
struct _HUB_CONTROLLERSTACK_INTERFACE// Size=0x100 (Id=343)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
struct _USB_BUS_INTERFACE_USBDI_V3// Size=0x60 (Id=497)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=433)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    struct // Size=0x4 (Id=0)
...
union _CONTROLLER_FLAGS// Size=0x4 (Id=616)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_HUB_STATUS// Size=0x2 (Id=555)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_HUB_CHANGE// Size=0x2 (Id=477)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_HUB_STATUS_AND_CHANGE// Size=0x4 (Id=470)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
...
union _USB_DEVICE_STATUS// Size=0x2 (Id=414)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
struct _URB_BULK_OR_INTERRUPT_TRANSFER// Size=0x80 (Id=605)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _HUB_INTERRUPT_REQUEST// Size=0xb8 (Id=548)
{
    struct WDFREQUEST__ * WdfRequest;// Offset=0x0 Size=0x8
...
struct _USB_HUB_DESCRIPTOR// Size=0x47 (Id=637)
{
...
struct _USB_30_HUB_DESCRIPTOR// Size=0xc (Id=650)
{
...
union _HUB_DESCRIPTOR// Size=0x47 (Id=589)
{
...
union _HSM_MUX_FLAGS// Size=0x4 (Id=561)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _HSM_MUX_CONTEXT// Size=0x50 (Id=472)
{
...
struct _USB_RESET_FLAGS// Size=0x4 (Id=489)
{
    struct // Size=0x4 (Id=0)
    {
...
union _PARENT_HUB_FLAGS// Size=0x4 (Id=643)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _HUB_INFO_FROM_PARENT// Size=0x48 (Id=407)
{
...
struct _HUB_FDO_CONTEXT// Size=0xa30 (Id=334)
{
    ...
    struct _HUB_INFORMATION HubInformation;// Offset=0x28 Size=0x78
    struct _UCX_CONTROLLER_INFO ControllerInfo;// Offset=0xa0 Size=0x20
    unsigned char ControllerOnHighLatencyMedium;// Offset=0xc0 Size=0x1
    unsigned char ControllerIsMicrosoftMausbhost;// Offset=0xc1 Size=0x1
    struct _HUB_PARENT_INTERFACE HubParentInterface;// Offset=0xc8 Size=0x88
    struct _HUB_CONTROLLERSTACK_INTERFACE HubControllerStackInterface;// Offset=0x150 Size=0x100
    struct _USB_BUS_INTERFACE_USBDI_V3 UsbdBusInterface;// Offset=0x250 Size=0x60
    struct _DEVICE_CAPABILITIES DeviceCapabilities;// Offset=0x2b0 Size=0x40
    union _CONTROLLER_FLAGS ControllerFlags;// Offset=0x2f0 Size=0x4
    struct _GUID ControllerSessionActivityId;// Offset=0x2f4 Size=0x10
    union _USB_HUB_STATUS_AND_CHANGE HubStatusAndChange;// Offset=0x304 Size=0x4
    union _USB_HUB_STATUS_AND_CHANGE OldHubStatusAndChange;// Offset=0x308 Size=0x4
    enum _USB_HUB_FEATURE_SELECTOR CurrentFeatureSelector;// Offset=0x30c Size=0x4
    enum _HSM_EVENT CurrentHubChangeEvent;// Offset=0x310 Size=0x4
    union _USB_DEVICE_STATUS HubDeviceStatus;// Offset=0x314 Size=0x2
    struct _CONTROL_REQUEST HubControlRequest;// Offset=0x318 Size=0xa8
    struct _HUB_INTERRUPT_REQUEST StatusChangeInterruptRequest;// Offset=0x3c0 Size=0xb8
    struct _KEVENT PnPPowerEvent;// Offset=0x478 Size=0x18
    long PnPPowerStatus;// Offset=0x490 Size=0x4
    union _HUB_DESCRIPTOR HubDescriptor;// Offset=0x494 Size=0x47
    struct _USB_CONFIGURATION_DESCRIPTOR * ConfigurationDescriptor;// Offset=0x4e0 Size=0x8
    struct _SM_CONTEXT HsmContext;// Offset=0x4e8 Size=0x420
    struct _HSM_MUX_CONTEXT MuxContext;// Offset=0x908 Size=0x50
    struct WDFQUEUE__ * DeviceControlQueue;// Offset=0x958 Size=0x8
    struct _USB_RESET_FLAGS ResetFlags;// Offset=0x960 Size=0x4
    struct _GUID CurrentActivityId;// Offset=0x964 Size=0x10
    struct _LIST_ENTRY ListEntry;// Offset=0x978 Size=0x10
    struct _HUB_INFO_FROM_PARENT HubInfoFromParent;// Offset=0x988 Size=0x48
    struct RECORDER_LOG__ * IfrLog;// Offset=0x9d0 Size=0x8
    struct WDFREQUEST__ * PdoGetPortStatusRequest;// Offset=0x9d8 Size=0x8
    struct WDFWMIINSTANCE__ * WmiNotificationHandle;// Offset=0x9e0 Size=0x8
    struct _UNICODE_STRING HubSymbolicLinkNameUnicode;// Offset=0x9e8 Size=0x10
    void * SelectiveSuspendSetting;// Offset=0x9f8 Size=0x8
    void * SelectiveSuspendTimeoutPowerSetting;// Offset=0xa00 Size=0x8
    unsigned long CurrentIdleTimeout;// Offset=0xa08 Size=0x4
    struct _PORT_CONTEXT * GetPortStatusTargetPortContext;// Offset=0xa10 Size=0x8
    unsigned long HardwareVerifierFlags;// Offset=0xa18 Size=0x4
    unsigned long HubFailureMsgId;// Offset=0xa1c Size=0x4
    enum _WDF_POWER_DEVICE_STATE CurrentWdfPowerDeviceState;// Offset=0xa20 Size=0x4
    unsigned short OldwTotalLength;// Offset=0xa24 Size=0x2
    struct POHANDLE__ * PoHandle;// Offset=0xa28 Size=0x8
};
