union _unnamed_653// Size=0x4 (Id=653)
{
...
struct _USB_DEVICE_CAPABILITY_POWER_DELIVERY_DESCRIPTOR// Size=0x12 (Id=654)
{
    ...
    union _unnamed_653 bmAttributes;// Offset=0x4 Size=0x4
