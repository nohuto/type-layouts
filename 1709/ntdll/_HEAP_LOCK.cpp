struct _RTL_CRITICAL_SECTION// Size=0x28 (Id=211)
{
...
union _unnamed_209// Size=0x28 (Id=209)
{
    struct _RTL_CRITICAL_SECTION CriticalSection;// Offset=0x0 Size=0x28
};

struct _HEAP_LOCK// Size=0x28 (Id=210)
{
    union _unnamed_209 Lock;// Offset=0x0 Size=0x28
};
