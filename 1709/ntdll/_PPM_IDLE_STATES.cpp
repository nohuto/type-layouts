...
struct _PROCESSOR_IDLE_CONSTRAINTS// Size=0x30 (Id=607)
{
...
struct _PROCESSOR_IDLE_PREPARE_INFO// Size=0x58 (Id=630)
{
...
struct _PPM_SELECTION_MENU// Size=0x10 (Id=621)
{
    unsigned long Count;// Offset=0x0 Size=0x4
    struct _PPM_SELECTION_MENU_ENTRY * Entries;// Offset=0x8 Size=0x8
};

struct _PPM_COORDINATED_SELECTION// Size=0x18 (Id=638)
{
...
struct _PPM_IDLE_STATE// Size=0xf8 (Id=610)
{
...
struct _PPM_IDLE_STATES// Size=0x428 (Id=575)
{
