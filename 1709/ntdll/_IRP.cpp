union _unnamed_113// Size=0x8 (Id=113)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=79)
{
    union // Size=0x4 (Id=0)
    {
...
union _unnamed_115// Size=0x10 (Id=115)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_114 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=412)
{
...
struct _unnamed_116// Size=0x58 (Id=116)
{
...
union _unnamed_117// Size=0x58 (Id=117)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_116 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=118)
{
    ...
    union _unnamed_113 AssociatedIrp;// Offset=0x18 Size=0x8
