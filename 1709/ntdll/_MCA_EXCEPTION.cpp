...
struct _unnamed_634// Size=0x8 (Id=634)
{
...
union _MCI_STATS// Size=0x8 (Id=635)
{
    struct _unnamed_634 MciStatus;// Offset=0x0 Size=0x8
    unsigned long long QuadPart;// Offset=0x0 Size=0x8
};

union _MCI_ADDR// Size=0x8 (Id=624)
{
...
struct _unnamed_551// Size=0x20 (Id=551)
{
...
struct _unnamed_552// Size=0x10 (Id=552)
{
    unsigned long long Address;// Offset=0x0 Size=0x8
    unsigned long long Type;// Offset=0x8 Size=0x8
};

union _unnamed_553// Size=0x20 (Id=553)
{
    union // Size=0x20 (Id=0)
    {
        struct _unnamed_551 Mca;// Offset=0x0 Size=0x20
        struct _unnamed_552 Mce;// Offset=0x0 Size=0x10
    };
};

struct _MCA_EXCEPTION// Size=0x100 (Id=554)
{
    ...
    union _unnamed_553 u;// Offset=0x18 Size=0x20
