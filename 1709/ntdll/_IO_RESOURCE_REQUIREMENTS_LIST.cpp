...
struct _unnamed_591// Size=0x18 (Id=591)
{
...
struct _unnamed_595// Size=0x10 (Id=595)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_596// Size=0xc (Id=596)
{
...
struct _unnamed_597// Size=0x18 (Id=597)
{
...
struct _unnamed_598// Size=0x18 (Id=598)
{
...
struct _unnamed_599// Size=0x18 (Id=599)
{
...
union _unnamed_601// Size=0x18 (Id=601)
{
    ...
    {
        struct _unnamed_589 Port;// Offset=0x0 Size=0x18
        struct _unnamed_589 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_591 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_592 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_593 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_589 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_594 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_595 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_596 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_597 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_598 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_599 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_600 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=602)
{
    ...
    union _unnamed_601 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=571)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=418)
{
