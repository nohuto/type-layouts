...
struct _RTL_HASH_TABLE// Size=0x10 (Id=229)
{
...
struct _RTL_STACKDB_CONTEXT// Size=0x48 (Id=235)
{
...
struct _RTLP_HP_STACKTRACKING_CONTEXT// Size=0x58 (Id=510)
{
    struct _RTL_SRWLOCK Lock;// Offset=0x0 Size=0x8
    unsigned long Flags;// Offset=0x8 Size=0x4
    struct _RTL_STACKDB_CONTEXT StackDbContext;// Offset=0x10 Size=0x48
};
