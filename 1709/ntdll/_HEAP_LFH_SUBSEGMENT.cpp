...
union _HEAP_LFH_SUBSEGMENT_DELAY_FREE// Size=0x8 (Id=485)
{
...
struct _HEAP_LFH_SUBSEGMENT_ENCODED_OFFSETS// Size=0x4 (Id=244)
{
    union // Size=0x4 (Id=0)
    {
...
struct _HEAP_LFH_SUBSEGMENT// Size=0x40 (Id=245)
{
