...
struct _HEAP_DESCRIPTOR_KEY// Size=0x4 (Id=258)
{
    union // Size=0x4 (Id=0)
    {
...
struct _HEAP_PAGE_RANGE_DESCRIPTOR// Size=0x20 (Id=255)
{
...
union _HEAP_PAGE_SEGMENT// Size=0x2000 (Id=254)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
    unsigned long long Signature;// Offset=0x10 Size=0x8
    unsigned char UnusedWatermark;// Offset=0x18 Size=0x1
