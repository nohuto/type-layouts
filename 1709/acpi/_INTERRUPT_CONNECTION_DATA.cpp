...
union _unnamed_665// Size=0xc (Id=665)
{
    struct _unnamed_664 Msi;// Offset=0x0 Size=0xc
};

struct _INTERRUPT_REMAPPING_INFO// Size=0x10 (Id=666)
{
    ...
    union _unnamed_665 u;// Offset=0x4 Size=0xc
};
...
struct _unnamed_581// Size=0x10 (Id=581)
{
...
struct _unnamed_612// Size=0x4 (Id=612)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_613// Size=0x4 (Id=613)
{
    struct _unnamed_612 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_HT_INTR_INFO// Size=0x8 (Id=614)
{
    union _unnamed_611 LowPart;// Offset=0x0 Size=0x4
    union _unnamed_613 HighPart;// Offset=0x4 Size=0x4
};
...
struct _INTERRUPT_VECTOR_DATA// Size=0x58 (Id=584)
{
    ...
    struct _unnamed_580 ControllerInput;// Offset=0x38 Size=0x8
    unsigned long long HvDeviceId;// Offset=0x40 Size=0x8
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_581 XapicMessage;// Offset=0x48 Size=0x10
        struct _unnamed_582 Hypertransport;// Offset=0x48 Size=0x8
        struct _unnamed_581 GenericMessage;// Offset=0x48 Size=0x10
        struct _unnamed_583 MessageRequest;// Offset=0x48 Size=0x4
    };
};

struct _INTERRUPT_CONNECTION_DATA// Size=0x60 (Id=650)
{
