struct _NT_TIB// Size=0x38 (Id=357)
{
...
struct _KDESCRIPTOR// Size=0x10 (Id=589)
{
...
struct _KSPECIAL_REGISTERS// Size=0xf0 (Id=530)
{
...
struct _CONTEXT// Size=0x4d0 (Id=424)
{
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=278)
{
...
struct _KTIMER_TABLE_ENTRY// Size=0x20 (Id=594)
{
...
struct _KTIMER_TABLE// Size=0x2200 (Id=524)
{
...
struct _KGATE// Size=0x18 (Id=295)
{
...
struct _PROC_IDLE_POLICY// Size=0x6 (Id=569)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=401)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=431)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=437)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=541)
{
...
struct _PROCESSOR_POWER_STATE// Size=0x200 (Id=405)
{
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=321)
{
...
struct _KAFFINITY_EX// Size=0xa8 (Id=337)
{
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=458)
{
...
struct _KPRCB// Size=0x7ec0 (Id=43)
{
    ...
    union // Size=0x4 (Id=0)
    {
        long BamFlags;// Offset=0xec Size=0x4
        struct // Size=0x4 (Id=0)
        {
            unsigned long BamQosLevel:2;// Offset=0xec Size=0x4 BitOffset=0x0 BitSize=0x2
            unsigned long PendingQosUpdate:2;// Offset=0xec Size=0x4 BitOffset=0x2 BitSize=0x2
            unsigned long BamFlagsReserved:28;// Offset=0xec Size=0x4 BitOffset=0x4 BitSize=0x1c
        };
    };
    union // Size=0x100 (Id=0)
    {
        ...
        union // Size=0x1 (Id=0)
        {
            ...
            struct // Size=0x1 (Id=0)
            {
                unsigned char BpbIbrsPresent:1;// Offset=0xf8 Size=0x1 BitOffset=0x0 BitSize=0x1
                unsigned char BpbStibpPresent:1;// Offset=0xf8 Size=0x1 BitOffset=0x1 BitSize=0x1
                unsigned char BpbSmepPresent:1;// Offset=0xf8 Size=0x1 BitOffset=0x2 BitSize=0x1
                unsigned char BpbSimulateIbrs:1;// Offset=0xf8 Size=0x1 BitOffset=0x3 BitSize=0x1
                unsigned char BpbSimulateIbpb:1;// Offset=0xf8 Size=0x1 BitOffset=0x4 BitSize=0x1
                unsigned char BpbReserved:3;// Offset=0xf8 Size=0x1 BitOffset=0x5 BitSize=0x3
            };
        };
        unsigned char BpbPad[7];// Offset=0xf9 Size=0x7
        unsigned long long PrcbPad11[2];// Offset=0xf0 Size=0x10
    };
    struct _KPROCESSOR_STATE ProcessorState;// Offset=0x100 Size=0x5c0
    unsigned long long PrcbPad12[6];// Offset=0x6c0 Size=0x30
    ...
    unsigned long long PrcbPad81[3];// Offset=0x5c20 Size=0x18
...
struct _KPCR// Size=0x8040 (Id=42)
{
