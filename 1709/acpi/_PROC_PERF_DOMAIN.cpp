...
struct _PROC_PERF_QOS_CLASS_POLICY// Size=0x18 (Id=549)
{
...
struct _PERF_CONTROL_STATE_SELECTION// Size=0x28 (Id=550)
{
...
struct _PROC_PERF_DOMAIN// Size=0x260 (Id=523)
{
    ...
    struct _PROC_PERF_QOS_CLASS_POLICY QosPolicies[3];// Offset=0x16c Size=0x48
    unsigned long QosDisableReasons[3];// Offset=0x1b4 Size=0xc
    unsigned long QosEquivalencyMasks[3];// Offset=0x1c0 Size=0xc
    unsigned char QosSupported;// Offset=0x1cc Size=0x1
    unsigned long SelectionGeneration;// Offset=0x1d0 Size=0x4
    struct _PERF_CONTROL_STATE_SELECTION QosSelection[3];// Offset=0x1d8 Size=0x78
    unsigned long long PerfChangeTime;// Offset=0x250 Size=0x8
    unsigned long PerfChangeIntervalCount;// Offset=0x258 Size=0x4
    unsigned char Force;// Offset=0x25c Size=0x1
};
