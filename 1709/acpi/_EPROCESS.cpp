...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=258)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=315)
{
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=400)
{
...
struct _MMSUPPORT_FLAGS// Size=0x4 (Id=427)
{
    union // Size=0x2 (Id=0)
    {
...
struct _MMSUPPORT_INSTANCE// Size=0xc8 (Id=350)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=286)
{
    union // Size=0x1 (Id=0)
    {
...
struct _WNF_STATE_NAME// Size=0x8 (Id=495)
{
    unsigned long Data[2];// Offset=0x0 Size=0x8
};

struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=276)
{
    unsigned long HighEdgeFilter;// Offset=0x0 Size=0x4
    unsigned long LowEdgeFilter;// Offset=0x4 Size=0x4
};

struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=269)
{
