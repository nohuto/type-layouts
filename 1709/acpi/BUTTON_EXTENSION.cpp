struct _unnamed_449// Size=0x4 (Id=449)
{
...
struct BUTTON_EXTENSION// Size=0x30 (Id=450)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_449 UEvents;// Offset=0x24 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long Capabilities;// Offset=0x28 Size=0x4
        struct _unnamed_449 UCapabilities;// Offset=0x28 Size=0x4
    };
};
