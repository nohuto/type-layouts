struct _PEBS_DS_SAVE_AREA// Size=0x60 (Id=260)
{
    ...
    unsigned long long PebsCounterReset0;// Offset=0x40 Size=0x8
    unsigned long long PebsCounterReset1;// Offset=0x48 Size=0x8
    unsigned long long PebsCounterReset2;// Offset=0x50 Size=0x8
    unsigned long long PebsCounterReset3;// Offset=0x58 Size=0x8
};

struct _PROCESSOR_PROFILE_CONTROL_AREA// Size=0x60 (Id=231)
{
    struct _PEBS_DS_SAVE_AREA PebsDsSaveArea;// Offset=0x0 Size=0x60
};
