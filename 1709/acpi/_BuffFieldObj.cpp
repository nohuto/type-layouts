...
struct _FieldDesc// Size=0x24 (Id=484)
{
...
struct _BuffFieldObj// Size=0x30 (Id=221)
{
    unsigned char * pbDataBuff;// Offset=0x0 Size=0x8
    unsigned long dwBuffLen;// Offset=0x8 Size=0x4
    struct _FieldDesc FieldDesc;// Offset=0xc Size=0x24
};
