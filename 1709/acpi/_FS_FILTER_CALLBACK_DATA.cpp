...
struct _unnamed_670// Size=0x8 (Id=670)
{
...
struct _unnamed_675// Size=0x20 (Id=675)
{
...
struct _unnamed_676// Size=0x28 (Id=676)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=677)
{
    struct _unnamed_669 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_670 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_672 AcquireForSectionSynchronization;// Offset=0x0 Size=0x10
    struct _unnamed_674 NotifyStreamFileObject;// Offset=0x0 Size=0x10
    struct _unnamed_675 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_676 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=647)
{
