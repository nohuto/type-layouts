...
struct _PROCESSOR_IDLE_CONSTRAINTS// Size=0x30 (Id=585)
{
...
struct _PROCESSOR_IDLE_PREPARE_INFO// Size=0x58 (Id=624)
{
...
struct _PPM_SELECTION_MENU// Size=0x10 (Id=608)
{
    unsigned long Count;// Offset=0x0 Size=0x4
    struct _PPM_SELECTION_MENU_ENTRY * Entries;// Offset=0x8 Size=0x8
};

struct _PPM_COORDINATED_SELECTION// Size=0x18 (Id=639)
{
...
struct _PPM_VETO_ACCOUNTING// Size=0x28 (Id=644)
{
...
struct _PPM_IDLE_STATE// Size=0xf8 (Id=590)
{
...
struct _PPM_IDLE_STATES// Size=0x428 (Id=535)
{
    ...
    long  ( * IdleExecute)(void * ,unsigned long long ,unsigned long ,unsigned long ,unsigned long ,unsigned long * );// Offset=0x1a8 Size=0x8
