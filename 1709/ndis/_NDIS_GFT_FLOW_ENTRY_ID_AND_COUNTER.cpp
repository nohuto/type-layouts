...
struct _NDIS_GFT_PACKET_COUNTER_VALUE// Size=0x10 (Id=939)
{
    unsigned long long Packets;// Offset=0x0 Size=0x8
    union _LARGE_INTEGER LastUpdate;// Offset=0x8 Size=0x8
};

struct _NDIS_GFT_BYTE_COUNTER_VALUE// Size=0x10 (Id=685)
{
    unsigned long long Bytes;// Offset=0x0 Size=0x8
    union _LARGE_INTEGER LastUpdate;// Offset=0x8 Size=0x8
};

struct _NDIS_GFT_PACKET_AND_BYTE_COUNTER_VALUE// Size=0x18 (Id=642)
{
    unsigned long long Packets;// Offset=0x0 Size=0x8
...
struct _NDIS_GFT_COUNTER_VALUE// Size=0x20 (Id=980)
{
    union // Size=0x4 (Id=0)
    {
        enum _NDIS_GFT_COUNTER_TYPE CounterType;// Offset=0x0 Size=0x4
        union <unnamed-type-CounterValue>// Size=0x18 (Id=6755)
        {
...
struct _NDIS_GFT_FLOW_ENTRY_ID_AND_COUNTER// Size=0x28 (Id=816)
{
