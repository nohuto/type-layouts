...
struct _NDIS_WDF_CX_CHARACTERISTICS// Size=0x60 (Id=428)
{
...
struct _NDIS_WDF_CX_DRIVER_BLOCK// Size=0x88 (Id=451)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    ...
    struct _NDIS_WDF_CX_CHARACTERISTICS Chars;// Offset=0x20 Size=0x60
    unsigned long ClientCount;// Offset=0x80 Size=0x4
    enum _NDIS_WDF_CX_DRIVER_STATE State;// Offset=0x84 Size=0x1
};
