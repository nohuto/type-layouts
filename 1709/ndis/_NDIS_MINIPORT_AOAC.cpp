...
struct _NDIS_SS_STOP_FLAGS// Size=0x4 (Id=1141)
{
    union // Size=0x4 (Id=0)
    {
...
struct _NDIS_AOAC_WAKE_FLAGS// Size=0x4 (Id=1120)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _NDIS_AOAC_COMPONENT_REF_TIME// Size=0x10 (Id=1859)
{
    unsigned long long TotalRefTime;// Offset=0x0 Size=0x8
    unsigned long long CurrentRefStartTime;// Offset=0x8 Size=0x8
};

struct _NDIS_MINIPORT_CS_TRAFFIC_STATS// Size=0x30 (Id=1045)
{
...
struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS// Size=0x2c (Id=1233)
{
...
struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX// Size=0x14 (Id=1446)
{
...
struct _NDIS_MINIPORT_AOAC// Size=0x490 (Id=882)
{
    ...
    struct _NDIS_AOAC_WAKE_FLAGS WakeFlags;// Offset=0x17c Size=0x4
    ...
    long ComponentRefCounts[17];// Offset=0x1ec Size=0x44
    struct _NDIS_AOAC_COMPONENT_REF_TIME CsRefTimes[17];// Offset=0x230 Size=0x110
    long CsPowerTransitions;// Offset=0x340 Size=0x4
    unsigned long long TotalCsActiveTime;// Offset=0x348 Size=0x8
    unsigned long long TotalCsResiliencyTime;// Offset=0x350 Size=0x8
    unsigned long long CurrentActiveStartTime;// Offset=0x358 Size=0x8
    unsigned long long CurrentCsResiliencyStartTime;// Offset=0x360 Size=0x8
    unsigned long CsSurpriseWakes;// Offset=0x368 Size=0x4
    unsigned long CsSpuriousWakes;// Offset=0x36c Size=0x4
    struct _NDIS_MINIPORT_CS_TRAFFIC_STATS CsTrafficStats[3];// Offset=0x370 Size=0x90
    struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS CsSpuriousWakeStats;// Offset=0x400 Size=0x2c
    struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX CsSpuriousWakeStatsEx;// Offset=0x42c Size=0x14
    unsigned char DirectedMacPatternPlumbed;// Offset=0x440 Size=0x1
    unsigned char IsInCsResiliency;// Offset=0x441 Size=0x1
    unsigned long LastWakePatternId;// Offset=0x444 Size=0x4
    unsigned long WakeIrpCount;// Offset=0x448 Size=0x4
    unsigned long long WakeIrpStartTime;// Offset=0x450 Size=0x8
    unsigned long long LastWakeIrpLatencyMs;// Offset=0x458 Size=0x8
    unsigned long long MaxWakeIrpLatencyMs;// Offset=0x460 Size=0x8
    unsigned long long TotalWakeIrpLatencyMs;// Offset=0x468 Size=0x8
    unsigned long SetPowerOidCount;// Offset=0x470 Size=0x4
    unsigned long long LastSetPowerOidLatencyMs;// Offset=0x478 Size=0x8
    unsigned long long MaxSetPowerOidLatencyMs;// Offset=0x480 Size=0x8
    unsigned long long TotalSetPowerOidLatencyMs;// Offset=0x488 Size=0x8
