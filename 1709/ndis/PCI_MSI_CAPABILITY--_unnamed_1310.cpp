union PCI_MSI_CAPABILITY::_unnamed_1310// Size=0x10 (Id=1310)
{
    struct <unnamed-type-Option32Bit>// Size=0xc (Id=16585)
    {
    ...
    struct PCI_MSI_CAPABILITY::_unnamed_1311::<unnamed-type-Option32Bit> Option32Bit;// Offset=0x0 Size=0xc
    struct <unnamed-type-Option64Bit>// Size=0x10 (Id=16591)
    {
    ...
    struct PCI_MSI_CAPABILITY::_unnamed_1312::<unnamed-type-Option64Bit> Option64Bit;// Offset=0x0 Size=0x10
};
