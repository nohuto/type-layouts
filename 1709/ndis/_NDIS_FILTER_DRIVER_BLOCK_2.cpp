...
struct _NDIS_FILTER_DRIVER_CHARACTERISTICS// Size=0xf0 (Id=713)
{
...
struct _NDIS_FILTER_DRIVER_BLOCK// Size=0x1f8 (Id=953)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    ...
    void  ( * InitiateOffloadCompleteHandler)(void * ,struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * );// Offset=0x150 Size=0x8
    void  ( * TerminateOffloadCompleteHandler)(void * ,struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * );// Offset=0x158 Size=0x8
    void  ( * UpdateOffloadCompleteHandler)(void * ,struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * );// Offset=0x160 Size=0x8
    void  ( * InvalidateOffloadCompleteHandler)(void * ,struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * );// Offset=0x168 Size=0x8
    void  ( * QueryOffloadCompleteHandler)(void * ,struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * );// Offset=0x170 Size=0x8
    void  ( * IndicateOffloadEventHandler)(void * ,struct _NDIS_PROTOCOL_OFFLOAD_BLOCK_LIST * ,unsigned long );// Offset=0x178 Size=0x8
    void  ( * TcpOffloadSendCompleteHandler)(void * ,struct _NET_BUFFER_LIST * );// Offset=0x180 Size=0x8
    void  ( * TcpOffloadReceiveCompleteHandler)(void * ,struct _NET_BUFFER_LIST * );// Offset=0x188 Size=0x8
    void  ( * TcpOffloadDisconnectCompleteHandler)(void * ,struct _NET_BUFFER_LIST * );// Offset=0x190 Size=0x8
    void  ( * TcpOffloadForwardCompleteHandler)(void * ,struct _NET_BUFFER_LIST * );// Offset=0x198 Size=0x8
    void  ( * TcpOffloadEventHandler)(void * ,unsigned long ,unsigned long );// Offset=0x1a0 Size=0x8
    int  ( * TcpOffloadReceiveIndicateHandler)(void * ,struct _NET_BUFFER_LIST * ,int ,unsigned long * );// Offset=0x1a8 Size=0x8
    void  ( * InitiateOffloadHandler)(void * ,struct _NDIS_MINIPORT_OFFLOAD_BLOCK_LIST * );// Offset=0x1b0 Size=0x8
    void  ( * TerminateOffloadHandler)(void * ,struct _NDIS_MINIPORT_OFFLOAD_BLOCK_LIST * );// Offset=0x1b8 Size=0x8
    void  ( * UpdateOffloadHandler)(void * ,struct _NDIS_MINIPORT_OFFLOAD_BLOCK_LIST * );// Offset=0x1c0 Size=0x8
    void  ( * InvalidateOffloadHandler)(void * ,struct _NDIS_MINIPORT_OFFLOAD_BLOCK_LIST * );// Offset=0x1c8 Size=0x8
    void  ( * QueryOffloadHandler)(void * ,struct _NDIS_MINIPORT_OFFLOAD_BLOCK_LIST * );// Offset=0x1d0 Size=0x8
    int  ( * TcpOffloadReceiveReturnHandler)(void * ,struct _NET_BUFFER_LIST * );// Offset=0x1d8 Size=0x8
    class KRef<NDIS_BIND_FILTER_DRIVER> Bind;// Offset=0x1e0 Size=0x8
    struct _UNICODE_STRING ImageName;// Offset=0x1e8 Size=0x10
