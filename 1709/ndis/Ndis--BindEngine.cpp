struct Ndis::BindEngine// Size=0x78 (Id=495)
{
    ...
    union // Size=0x1bc (Id=0)
    {
        ...
        void ApplyBindChanges(enum CallRunMode ,bool );// Offset=0x0 Size=0x14d
        void SetDirty();
        ...
        void LockBindings();
        void UnlockBindings();
        void UpdateBindings(class KLockThisExclusive & );// Offset=0x0 Size=0x106
        bool Iterate();
        void ApplyRules();// Offset=0x0 Size=0x1bc
        void UpdateBindingsWorkItem();// Offset=0x0 Size=0x8d
