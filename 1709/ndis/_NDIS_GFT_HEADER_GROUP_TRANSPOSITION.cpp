...
struct _NDIS_GFT_HEADER_GROUP_TRANSPOSITION// Size=0x58 (Id=1562)
{
    union // Size=0x4f (Id=0)
    {
        ...
        union <unnamed-type-IPAddress>// Size=0x20 (Id=6889)
        {
            struct <unnamed-type-IPv4Address>// Size=0x8 (Id=6890)
            {
            ...
            struct <unnamed-type-IPv6Address>// Size=0x20 (Id=6894)
            {
        ...
        union <unnamed-type-TransportOrEncapsulation>// Size=0x8 (Id=6902)
        {
            struct <unnamed-type-Udp>// Size=0x4 (Id=6903)
            {
            ...
            struct <unnamed-type-Tcp>// Size=0x4 (Id=6907)
            {
                unsigned short SourcePort;// Offset=0x0 Size=0x2
                unsigned short DestinationPort;// Offset=0x2 Size=0x2
            };
            ...
            struct <unnamed-type-Encapsulation>// Size=0x8 (Id=6911)
            {
