...
struct _NDIS_CO_CLIENT_OPTIONAL_HANDLERS// Size=0xa0 (Id=347)
{
...
struct _NDIS_PROTOCOL_BLOCK// Size=0x3d8 (Id=343)
{
    union // Size=0x3d8 (Id=0)
    {
        struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
        ...
        void NotifyBindComplete();// Offset=0x0 Size=0x293
