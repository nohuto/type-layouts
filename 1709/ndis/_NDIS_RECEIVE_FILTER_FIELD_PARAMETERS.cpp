...
struct _NDIS_RECEIVE_FILTER_FIELD_PARAMETERS// Size=0x38 (Id=1722)
{
    union // Size=0x28 (Id=0)
    {
        ...
        union _HEADER_FIELD// Size=0x4 (Id=10683)
        {
        ...
        union _FIELD_VALUE// Size=0x10 (Id=10690)
        {
        ...
        union _RESULT_VALUE// Size=0x10 (Id=10697)
        {
