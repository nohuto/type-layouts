...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=77)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=947)
{
...
struct _IRP// Size=0xd0 (Id=84)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=4274)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=4292)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=4293)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=4304)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=4305)
            {
