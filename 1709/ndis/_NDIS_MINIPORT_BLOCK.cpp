...
struct _REFERENCE// Size=0x10 (Id=468)
{
...
union _ULARGE_INTEGER// Size=0x8 (Id=74)
{
    unsigned long LowPart;// Offset=0x0 Size=0x4
    unsigned long HighPart;// Offset=0x4 Size=0x4
    struct <unnamed-type-u>// Size=0x8 (Id=14051)
    {
        unsigned long LowPart;// Offset=0x0 Size=0x4
        unsigned long HighPart;// Offset=0x4 Size=0x4
    };
...
struct _KTIMER// Size=0x40 (Id=321)
{
...
struct _NDIS_TIMER// Size=0x80 (Id=470)
{
...
struct _NDIS_PM_WAKE_UP_CAPABILITIES// Size=0xc (Id=863)
{
...
struct _NDIS_PNP_CAPABILITIES// Size=0x10 (Id=471)
{
    unsigned long Flags;// Offset=0x0 Size=0x4
    struct _NDIS_PM_WAKE_UP_CAPABILITIES WakeUpCapabilities;// Offset=0x4 Size=0xc
};

struct _NDIS_PM_CAPABILITIES// Size=0x3c (Id=473)
{
...
struct _NDIS_PM_PARAMETERS// Size=0x14 (Id=474)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=475)
{
    ...
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long Reserved:11;// Offset=0x4 Size=0x4 BitOffset=0x15 BitSize=0xb
    };
...
struct _NDIS_MINIPORT_WORK_ITEM// Size=0x18 (Id=1222)
{
...
struct _WORK_QUEUE_ITEM// Size=0x20 (Id=80)
{
...
struct _KBUGCHECK_CALLBACK_RECORD// Size=0x40 (Id=476)
{
...
struct _NDIS_MINIPORT_HANDLERS// Size=0xb8 (Id=477)
{
...
struct _NDIS_WORK_ITEM// Size=0x50 (Id=478)
{
...
struct _NDIS_RESTART_GENERAL_ATTRIBUTES// Size=0x58 (Id=338)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_M_PERIODIC_RECEIVES// Size=0x90 (Id=480)
{
...
struct _NDIS_PCI_DEVICE_CUSTOM_PROPERTIES// Size=0x34 (Id=481)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_OFFLOAD_REG// Size=0x4 (Id=484)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _NDIS_EVENT// Size=0x18 (Id=485)
{
...
struct _NDIS_PM_ADMIN_CONFIG// Size=0x4 (Id=487)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _KSEMAPHORE// Size=0x20 (Id=489)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
union _NET_LUID_LH// Size=0x8 (Id=396)
{
...
struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=756)
{
...
struct _IO_REMOVE_LOCK// Size=0x20 (Id=324)
{
...
struct _PROCESSOR_NUMBER// Size=0x4 (Id=490)
{
...
struct _ULONG_REFERENCE// Size=0x10 (Id=491)
{
    unsigned long long SpinLock;// Offset=0x0 Size=0x8
...
struct _NDIS_D0_SIGNAL_WORK_ITEM// Size=0x58 (Id=492)
{
...
struct _IF_PHYSICAL_ADDRESS_LH// Size=0x22 (Id=499)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    unsigned char Address[32];// Offset=0x2 Size=0x20
};

struct _NDIS_MINIPORT_BLOCK// Size=0x16a8 (Id=373)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    ...
    struct RECORDER_LOG__ * BlackBoxHandle;// Offset=0x1510 Size=0x8
    struct _KEVENT * PowerCompleteEvent;// Offset=0x1518 Size=0x8
    long PowerCompleteStatus;// Offset=0x1520 Size=0x4
    struct WORKITEM_WITH_IRP DevicePowerOnWorkItem;// Offset=0x1528 Size=0x28
    struct WORKITEM_WITH_IRP DevicePowerDownWorkItem;// Offset=0x1550 Size=0x28
    class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,-1,std::nullptr_t> > > PendingOidWatchdog;// Offset=0x1578 Size=0x8
    class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,-1,std::nullptr_t> > > HookedOidWatchdog;// Offset=0x1580 Size=0x8
    struct _NDIS_PD_BLOCK * PDBlock;// Offset=0x1588 Size=0x8
    void * PdcHandle;// Offset=0x1590 Size=0x8
    struct _NDIS_TIMER PdcTaskClientDisableTimer;// Offset=0x1598 Size=0x80
    struct _NDIS_WORK_ITEM PdcTaskClientDisableWorkItem;// Offset=0x1618 Size=0x50
    long PdcTaskClientMode;// Offset=0x1668 Size=0x4
    unsigned long ModernStandbyWoLMagicPacketEnable;// Offset=0x166c Size=0x4
    struct _NDIS_RSS_DPC_WORKER_CONTEXT * RssV2Context;// Offset=0x1670 Size=0x8
    long RssV2CompletionCount;// Offset=0x1678 Size=0x4
    struct _KEVENT RssV2CompletionEvent;// Offset=0x1680 Size=0x18
    struct _LIST_ENTRY SynchronousOidCalls;// Offset=0x1698 Size=0x10
