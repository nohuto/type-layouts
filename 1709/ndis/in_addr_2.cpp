struct in_addr// Size=0x4 (Id=141)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-S_un>// Size=0x4 (Id=14954)
        {
            struct <unnamed-type-S_un_b>// Size=0x4 (Id=14955)
            {
            ...
            struct <unnamed-type-S_un_w>// Size=0x4 (Id=14961)
            {
