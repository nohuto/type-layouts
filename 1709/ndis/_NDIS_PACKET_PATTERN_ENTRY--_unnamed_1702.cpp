struct _NDIS_PM_PACKET_PATTERN// Size=0x18 (Id=718)
{
...
struct _NDIS_PM_WOL_PATTERN// Size=0xc4 (Id=1500)
{
    union // Size=0x9c (Id=0)
    {
        ...
        union _WOL_PATTERN// Size=0x28 (Id=10228)
        {
            struct _IPV4_TCP_SYN_WOL_PACKET_PARAMETERS// Size=0x10 (Id=10229)
            {
            ...
            struct _IPV6_TCP_SYN_WOL_PACKET_PARAMETERS// Size=0x28 (Id=10236)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
            ...
            struct _EAPOL_REQUEST_ID_MESSAGE_WOL_PACKET_PARAMETERS// Size=0x4 (Id=10243)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
            };
            ...
            struct _WOL_BITMAP_PATTERN// Size=0x14 (Id=10246)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
...
union _NDIS_PACKET_PATTERN_ENTRY::_unnamed_1702// Size=0xf0 (Id=1702)
{
