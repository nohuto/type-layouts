struct _NT_TIB// Size=0x38 (Id=1028)
{
...
struct _KDESCRIPTOR// Size=0x10 (Id=1843)
{
...
struct _KSPECIAL_REGISTERS// Size=0xf0 (Id=1670)
{
...
struct _CONTEXT// Size=0x4d0 (Id=1185)
{
...
struct _KPRCB// Size=0x700 (Id=54)
{
    ...
    void _KPRCB(struct _KPRCB * );
    void _KPRCB(struct _KPRCB & );
    struct _KPRCB & operator=(struct _KPRCB * );
    struct _KPRCB & operator=(struct _KPRCB & );
};

struct _KPCR// Size=0x880 (Id=50)
{
    ...
    void _KPCR(struct _KPCR * );
    void _KPCR(struct _KPCR & );
    struct _KPCR & operator=(struct _KPCR * );
    struct _KPCR & operator=(struct _KPCR & );
};
