...
struct _NDIS_NSI_COMPARTMENT_RW// Size=0x668 (Id=1490)
{
...
struct _NDIS_IF_COMPARTMENT_BLOCK// Size=0x6d0 (Id=606)
{
    ...
    unsigned long JobCount;// Offset=0x6b8 Size=0x4
    struct _LIST_ENTRY JobLink;// Offset=0x6c0 Size=0x10
};
