union _NDIS_PACKET_8021Q_INFO::_unnamed_1084// Size=0x8 (Id=1084)
{
    struct <unnamed-type-TagHeader>// Size=0x4 (Id=9722)
    {
    ...
    struct _NDIS_PACKET_8021Q_INFO::_unnamed_1085::<unnamed-type-TagHeader> TagHeader;// Offset=0x0 Size=0x4
