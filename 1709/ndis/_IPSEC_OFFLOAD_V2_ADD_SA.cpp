...
struct _IPSEC_OFFLOAD_V2_ALGORITHM_INFO// Size=0x10 (Id=879)
{
...
struct _IPSEC_OFFLOAD_V2_SECURITY_ASSOCIATION// Size=0x30 (Id=589)
{
...
struct _IPSEC_OFFLOAD_V2_ADD_SA// Size=0xb0 (Id=828)
{
    ...
    union // Size=0x8 (Id=0)
    {
        struct _IPSEC_OFFLOAD_V2_ADD_SA::_unnamed_1841::<unnamed-type-IPv4Endpoints> IPv4Endpoints;// Offset=0x18 Size=0x8
        struct _IPSEC_OFFLOAD_V2_ADD_SA::_unnamed_1842::<unnamed-type-IPv6Endpoints> IPv6Endpoints;// Offset=0x18 Size=0x20
    };
