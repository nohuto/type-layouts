...
struct _DEBUG_LOG// Size=0x18 (Id=166)
{
...
struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=259)
{
...
struct _IO_REMOVE_LOCK// Size=0x20 (Id=221)
{
...
union _USBHUB_FDO_FLAGS// Size=0x4 (Id=265)
{
...
union _USBHUB_FDO_FLAGS2// Size=0x4 (Id=324)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USBHUB_ERRATA_FLAGS// Size=0x4 (Id=228)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _USB_HUB_DESCRIPTOR// Size=0x47 (Id=337)
{
...
struct _USB_BUS_INTERFACE_HUB_V9// Size=0x148 (Id=149)
{
...
struct _USB_BUS_INTERFACE_USBDI_V3// Size=0x60 (Id=210)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * BusContext;// Offset=0x8 Size=0x8
...
struct _USB_BUS_INTERFACE_HUB_MINIDUMP// Size=0x28 (Id=202)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * BusContext;// Offset=0x8 Size=0x8
...
struct _USB_BUS_INTERFACE_HUB_SELECTIVE_SUSPEND// Size=0x30 (Id=203)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * BusContext;// Offset=0x8 Size=0x8
...
struct _USB_BUS_INTERFACE_HUB_FORWARD_PROGRESS// Size=0x40 (Id=212)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * BusContext;// Offset=0x8 Size=0x8
...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=233)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    struct // Size=0x4 (Id=0)
...
struct _HUB_GLOBAL_UXD_SETTINGS// Size=0x10 (Id=277)
{
...
struct _USB_TOPOLOGY_ADDRESS// Size=0x20 (Id=329)
{
...
struct _DEVICE_EXTENSION_HUB// Size=0x14a0 (Id=148)
{
