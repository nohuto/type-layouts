union _unnamed_283// Size=0x2 (Id=283)
{
...
struct _USB_DEVICE_CAPABILITY_BILLBOARD_DESCRIPTOR// Size=0x30 (Id=285)
{
    ...
    union _unnamed_283 VconnPower;// Offset=0x6 Size=0x2
    unsigned char bmConfigured[32];// Offset=0x8 Size=0x20
    unsigned long bReserved;// Offset=0x28 Size=0x4
    struct _unnamed_284 AlternateMode[1];// Offset=0x2c Size=0x4
};
