...
union _unnamed_389// Size=0x18 (Id=389)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_376 Port;// Offset=0x0 Size=0x18
        struct _unnamed_376 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_379 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_380 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_381 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_376 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_382 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_383 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_384 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_385 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_386 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_387 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_388 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=390)
{
    ...
    union _unnamed_389 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=367)
{
