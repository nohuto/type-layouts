...
union _unnamed_300// Size=0x4 (Id=300)
{
...
struct _RAID_UNIT_POFX// Size=0x90 (Id=301)
{
    ...
    struct _IRP * WaitWakeIrp;// Offset=0x38 Size=0x8
    struct _LIST_ENTRY ActivePendingRequestQueue;// Offset=0x40 Size=0x10
    unsigned long long ActiveLock;// Offset=0x50 Size=0x8
    unsigned long long ActiveReferences;// Offset=0x58 Size=0x8
    ...
    union _unnamed_300 InterlockedFlags;// Offset=0x8c Size=0x4
};
