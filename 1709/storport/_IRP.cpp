...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=497)
{
    union // Size=0x4 (Id=0)
    {
...
struct _unnamed_34// Size=0x10 (Id=34)
{
    union // Size=0x8 (Id=0)
    {
...
union _unnamed_35// Size=0x10 (Id=35)
{
    ...
    {
        struct _unnamed_34 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=203)
{
...
struct _unnamed_36// Size=0x50 (Id=36)
{
...
union _unnamed_37// Size=0x58 (Id=37)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_36 Overlay;// Offset=0x0 Size=0x50
