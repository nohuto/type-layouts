...
struct _PROCESSOR_NUMBER// Size=0x4 (Id=146)
{
...
struct _STOR_EVENT_QUEUE_ENTRY// Size=0x38 (Id=211)
{
...
struct _unnamed_215// Size=0x28 (Id=215)
{
...
union _unnamed_216// Size=0x18 (Id=216)
{
...
struct _EXTENDED_REQUEST_BLOCK// Size=0x320 (Id=217)
{
    ...
    struct _unnamed_215 SrbData;// Offset=0xb0 Size=0x28
    ...
    union _unnamed_216 u;// Offset=0x298 Size=0x18
...
struct _IO_RESOURCE_ENTRY// Size=0x430 (Id=281)
{
    union // Size=0x10 (Id=0)
    {
        struct _SLIST_ENTRY Entry;// Offset=0x0 Size=0x10
        unsigned long HashIndex;// Offset=0x0 Size=0x4
        struct _EXTENDED_REQUEST_BLOCK Xrb;// Offset=0x10 Size=0x320
    };
    unsigned char SenseInfoBuffer[256];// Offset=0x330 Size=0x100
