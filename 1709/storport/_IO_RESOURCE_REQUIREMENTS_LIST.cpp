...
struct _unnamed_586// Size=0x18 (Id=586)
{
...
struct _unnamed_588// Size=0x18 (Id=588)
{
...
struct _unnamed_590// Size=0x10 (Id=590)
{
...
struct _unnamed_591// Size=0x10 (Id=591)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_592// Size=0xc (Id=592)
{
...
struct _unnamed_593// Size=0x18 (Id=593)
{
...
struct _unnamed_594// Size=0x18 (Id=594)
{
...
struct _unnamed_595// Size=0x18 (Id=595)
{
...
union _unnamed_596// Size=0x18 (Id=596)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_586 Port;// Offset=0x0 Size=0x18
        struct _unnamed_586 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_588 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_589 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_590 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_586 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_561 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_591 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_592 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_593 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_594 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_595 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_567 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=597)
{
    ...
    union _unnamed_596 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=554)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=434)
{
