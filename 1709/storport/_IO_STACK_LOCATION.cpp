...
struct _unnamed_51// Size=0x4 (Id=51)
{
    unsigned long Length;// Offset=0x0 Size=0x4
};
...
struct _unnamed_67// Size=0x8 (Id=67)
{
...
struct _unnamed_70// Size=0x1 (Id=70)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _unnamed_72// Size=0x4 (Id=72)
{
...
struct _unnamed_79// Size=0x8 (Id=79)
{
    struct _POWER_SEQUENCE * PowerSequence;// Offset=0x0 Size=0x8
};

struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=425)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=283)
{
...
struct _unnamed_83// Size=0x10 (Id=83)
{
...
union _unnamed_86// Size=0x20 (Id=86)
{
    ...
    struct _unnamed_47 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_48 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_49 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_50 QueryEa;// Offset=0x0 Size=0x20
    struct _unnamed_51 SetEa;// Offset=0x0 Size=0x4
    struct _unnamed_53 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_53 SetVolume;// Offset=0x0 Size=0x10
    struct _unnamed_54 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_55 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_56 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_57 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_58 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_59 MountVolume;// Offset=0x0 Size=0x10
    struct _unnamed_59 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_60 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_62 QueryQuota;// Offset=0x0 Size=0x20
    struct _unnamed_51 SetQuota;// Offset=0x0 Size=0x4
    struct _unnamed_64 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_66 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_67 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_68 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_69 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_70 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_72 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_74 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_76 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_78 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_79 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_82 Power;// Offset=0x0 Size=0x20
    struct _unnamed_83 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_84 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_85 Others;// Offset=0x0 Size=0x20
};
...
struct _IO_STACK_LOCATION// Size=0x48 (Id=87)
{
    ...
    union _unnamed_86 Parameters;// Offset=0x8 Size=0x20
