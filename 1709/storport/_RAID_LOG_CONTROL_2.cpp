struct _unnamed_549// Size=0x8 (Id=549)
{
...
union _unnamed_550// Size=0x8 (Id=550)
{
    struct _unnamed_549 u;// Offset=0x0 Size=0x8
    unsigned long long asUlong64;// Offset=0x0 Size=0x8
};

struct _RAID_LOG_CONTROL// Size=0x10 (Id=551)
{
    unsigned long Revision;// Offset=0x0 Size=0x4
    union _unnamed_550 Enable;// Offset=0x8 Size=0x8
};
