...
enum _STORAGE_DUMP_PHASE
{
    StorageDumpPhaseUnknown=0,
    StorageDumpPhaseStart=1,
    StorageDumpPhaseComplete=15,
    StorageDumpPhaseMax=16
};
...
struct _DUMP_ENTRY// Size=0x10 (Id=422)
{
    struct _DUMP_ENTRY * Flink;// Offset=0x0 Size=0x8
    struct _DUMP_ENTRY * Blink;// Offset=0x8 Size=0x8
};

struct _STORAGE_DUMP_INFO// Size=0x48 (Id=517)
{
    unsigned long Version;// Offset=0x0 Size=0x4
    enum _STORAGE_DUMP_USAGE Usage;// Offset=0x4 Size=0x4
    enum _STORAGE_DUMP_PHASE Phase;// Offset=0x8 Size=0x4
    enum _STORAGE_DUMP_ACTION Action;// Offset=0xc Size=0x4
