...
struct _unnamed_291// Size=0x20 (Id=291)
{
...
union _unnamed_293// Size=0x20 (Id=293)
{
    struct _unnamed_78 Create;// Offset=0x0 Size=0x20
    struct _unnamed_290 Read;// Offset=0x0 Size=0x18
    struct _unnamed_290 Write;// Offset=0x0 Size=0x18
    struct _unnamed_291 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_292 Others;// Offset=0x0 Size=0x20
};

struct _WDF_REQUEST_PARAMETERS// Size=0x28 (Id=294)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned char MinorFunction;// Offset=0x2 Size=0x1
    enum _WDF_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    union _unnamed_293 Parameters;// Offset=0x8 Size=0x20
};
