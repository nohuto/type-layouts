...
struct _unnamed_398// Size=0x8 (Id=398)
{
...
union _unnamed_400// Size=0x8 (Id=400)
{
    struct _unnamed_398 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_399 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_398 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=401)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_400 Data;// Offset=0x4 Size=0x8
};
