struct _unnamed_446// Size=0x4 (Id=446)
{
...
union _KGDTENTRY64// Size=0x10 (Id=448)
{
    unsigned short LimitLow;// Offset=0x0 Size=0x2
    unsigned short BaseLow;// Offset=0x2 Size=0x2
    union // Size=0x4 (Id=0)
    {
        struct _unnamed_446 Bytes;// Offset=0x4 Size=0x4
        struct _unnamed_447 Bits;// Offset=0x4 Size=0x4
    };
