...
struct _PPM_DRIVER_DISPATCH_TABLE// Size=0xf8 (Id=440)
{
...
struct _PCC_INTERFACE_INTERNAL// Size=0x58 (Id=495)
{
...
union _unnamed_524// Size=0x4 (Id=524)
{
...
struct _PCC_INTERFACE_STANDARD// Size=0x80 (Id=525)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
    ...
    union _unnamed_524 Flags;// Offset=0x54 Size=0x4
...
union _PROC_POWER_COORDINATES// Size=0x4 (Id=391)
{
...
struct _PROC_ENERGY_COUNTER// Size=0xc (Id=423)
{
    union // Size=0x4 (Id=0)
    {
...
struct _PROC_ENERGY_MODEL// Size=0x100 (Id=385)
{
...
struct GLOBALS// Size=0x7b8 (Id=360)
{
