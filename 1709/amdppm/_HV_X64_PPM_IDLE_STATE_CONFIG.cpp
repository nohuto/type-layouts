...
union _HV_X64_PPM_IDLE_STATE_CONFIG// Size=0x8 (Id=570)
{
    ...
    struct _unnamed_567 Hlt;// Offset=0x0 Size=0x8
    struct _unnamed_568 Io;// Offset=0x0 Size=0x8
    struct _unnamed_569 Mwait;// Offset=0x0 Size=0x8
};
