struct _PCI_CAPABILITIES_HEADER// Size=0x2 (Id=891)
{
...
struct _PCI_MSI_MESSAGE_ADDRESS// Size=0x4 (Id=898)
{
...
struct PCI_MSI_CAPABILITY// Size=0x18 (Id=846)
{
    ...
    union _unnamed_843 MessageAddressLower;// Offset=0x4 Size=0x4
    union // Size=0xc (Id=0)
    {
        struct _unnamed_844 Option32Bit;// Offset=0x8 Size=0xc
        struct _unnamed_845 Option64Bit;// Offset=0x8 Size=0x10
    };
};
