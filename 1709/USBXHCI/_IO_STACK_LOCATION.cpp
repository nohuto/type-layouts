...
struct _unnamed_86// Size=0x18 (Id=86)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _unnamed_100// Size=0x4 (Id=100)
{
...
struct _unnamed_106// Size=0x1 (Id=106)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _unnamed_108// Size=0x4 (Id=108)
{
...
struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=699)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=659)
{
...
union _unnamed_122// Size=0x20 (Id=122)
{
    struct _unnamed_78 Create;// Offset=0x0 Size=0x20
    struct _unnamed_79 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_80 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_81 Read;// Offset=0x0 Size=0x18
    struct _unnamed_81 Write;// Offset=0x0 Size=0x18
    struct _unnamed_83 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_84 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_86 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_87 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_88 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_90 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_91 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_92 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_93 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_94 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_95 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_96 MountVolume;// Offset=0x0 Size=0x10
    struct _unnamed_96 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_98 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_100 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_102 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_103 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_104 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_105 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_106 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_108 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_110 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_112 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_114 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_115 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_118 Power;// Offset=0x0 Size=0x20
    struct _unnamed_119 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_120 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_121 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=123)
{
    ...
    union _unnamed_122 Parameters;// Offset=0x8 Size=0x20
