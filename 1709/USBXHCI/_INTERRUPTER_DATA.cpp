struct _INTERRUPTER_COUNTER// Size=0x38 (Id=503)
{
...
struct _INTERRUPTER_FLAGS// Size=0x4 (Id=801)
{
...
struct _INTERRUPTER_DATA// Size=0xd8 (Id=445)
{
    ...
    struct _INTERRUPTER_COUNTER Counter;// Offset=0x28 Size=0x38
    struct _INTERRUPTER_FLAGS Flags;// Offset=0x60 Size=0x4
    enum _InterrupterStates State;// Offset=0x64 Size=0x4
    unsigned long SegmentSize;// Offset=0x68 Size=0x4
    unsigned long SegmentCount;// Offset=0x6c Size=0x4
    unsigned long UsedEventRingSegments;// Offset=0x70 Size=0x4
    unsigned long TRBsPerSegment;// Offset=0x74 Size=0x4
    unsigned long CycleState;// Offset=0x78 Size=0x4
    unsigned long DequeueIndex;// Offset=0x7c Size=0x4
    unsigned long DequeueSegment;// Offset=0x80 Size=0x4
    struct _TRB * CurrentRingSegment;// Offset=0x88 Size=0x8
    struct _XIL_BUFFER_DATA * CurrentBufferData;// Offset=0x90 Size=0x8
    struct _XIL_BUFFER_DATA * EventRingTableBufferData;// Offset=0x98 Size=0x8
    struct _LIST_ENTRY BufferDataList;// Offset=0xa0 Size=0x10
    struct _KEVENT WorkItemEvent;// Offset=0xb0 Size=0x18
    struct _IO_WORKITEM * IoWorkItem;// Offset=0xc8 Size=0x8
    unsigned long long EventRingLock;// Offset=0xd0 Size=0x8
};
