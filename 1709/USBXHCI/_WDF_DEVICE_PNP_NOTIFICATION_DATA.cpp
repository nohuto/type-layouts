...
struct _unnamed_577// Size=0x8 (Id=577)
{
...
{
    struct _unnamed_577 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_578 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_577 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=227)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_579 Data;// Offset=0x4 Size=0x8
};
