struct _COMMON_BUFFER_COUNTER// Size=0x10 (Id=520)
{
...
struct _SPIN_LOCK// Size=0x10 (Id=853)
{
...
struct _XIL_COMMON_BUFFER_POLICY// Size=0x10 (Id=785)
{
...
struct _XILCORE_COMMON_BUFFER_SEGMENTER// Size=0x40 (Id=755)
{
...
struct _XILCORECOMMON_BUFFER_COUNTER// Size=0x10 (Id=508)
{
...
struct _XILCORE_COMMON_BUFFER_DATA// Size=0xd8 (Id=401)
{
...
struct _COMMON_BUFFER_DATA// Size=0x128 (Id=434)
{
    ...
    struct _XILCORE_COMMON_BUFFER_DATA XilCoreCommonBufferData;// Offset=0x50 Size=0xd8
};
