...
struct _UCXUSBDEVICE_INFO// Size=0x38 (Id=633)
{
    unsigned long Size;// Offset=0x0 Size=0x4
...
struct _USB_DEVICE_DESCRIPTOR// Size=0x12 (Id=369)
{
...
struct _XILCORE_USBDEVICE_DATA// Size=0x28 (Id=894)
{
...
struct _XIL_DIRECT_USBDEVICE_DATA// Size=0x28 (Id=878)
{
    struct _XILCORE_USBDEVICE_DATA XilCoreUsbDeviceData;// Offset=0x0 Size=0x28
};

struct _XIL_PROXY_USBDEVICE_DATA// Size=0x30 (Id=880)
{
...
struct _XIL_USBDEVICE_DATA// Size=0x40 (Id=788)
{
    ...
    unsigned char IsProxyUsbDevice;// Offset=0x30 Size=0x1
    void * UsbDeviceHandle;// Offset=0x38 Size=0x8
};

struct _USBDEVICE_DATA// Size=0x270 (Id=461)
{
    ...
    struct _CRB Crb;// Offset=0x1b8 Size=0x60
    ...
    struct _XIL_USBDEVICE_DATA XilUsbDeviceData;// Offset=0x230 Size=0x40
};
