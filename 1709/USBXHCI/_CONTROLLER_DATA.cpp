...
struct _PCI_DEVICE_INFORMATION// Size=0x38 (Id=607)
{
...
struct _ACPI_DEVICE_INFORMATION// Size=0xf (Id=807)
{
...
union _FRAME_SNAPSHOT// Size=0x8 (Id=744)
{
...
struct _FRAME_NUMBER_DATA// Size=0x10 (Id=552)
{
...
struct _SECURE_DRIVER_INTERFACE// Size=0x38 (Id=587)
{
...
struct _TIME_SYNC_DATA// Size=0xa8 (Id=418)
{
...
struct _CONTROLLER_DATA// Size=0x2c0 (Id=417)
{
    ...
    unsigned long ResetCount;// Offset=0x150 Size=0x4
    unsigned long ResetInterval;// Offset=0x154 Size=0x4
    long ResetLock;// Offset=0x158 Size=0x4
    enum _SYSTEM_POWER_ACTION SystemPowerAction;// Offset=0x15c Size=0x4
    void * HibernateContext;// Offset=0x160 Size=0x8
    struct _FRAME_NUMBER_DATA FrameNumberData;// Offset=0x168 Size=0x10
    unsigned long long HardwareVerifierFlags;// Offset=0x178 Size=0x8
    struct _XIL_BUFFER_DATA * ScratchTransferBufferData;// Offset=0x180 Size=0x8
    enum _S0IdleStatus ControllerS0IdleStatus;// Offset=0x188 Size=0x4
    unsigned char WaitWakeQueued;// Offset=0x18c Size=0x1
    struct _CONTROLLER_COUNTER Counter;// Offset=0x190 Size=0x8
    struct WDFWORKITEM__ * IdleTimeoutUpdateWorkItem;// Offset=0x198 Size=0x8
    unsigned long LastSetIdleTimeout;// Offset=0x1a0 Size=0x4
    struct POHANDLE__ * PoHandle;// Offset=0x1a8 Size=0x8
    void * LPEEnterExitCallbackHandle;// Offset=0x1b0 Size=0x8
    unsigned char WdfPowerReferenceForDebuggerAcquired;// Offset=0x1b8 Size=0x1
    unsigned char IsSecureDevice;// Offset=0x1b9 Size=0x1
    struct TRUSTLET_OBJECT_HANDLE__ * SecureObjectHandle;// Offset=0x1c0 Size=0x8
    struct _EPROCESS * TrustletProcess;// Offset=0x1c8 Size=0x8
    struct _SECURE_DRIVER_INTERFACE SecureDriverInterface;// Offset=0x1d0 Size=0x38
    unsigned char IsDSMForPortStatusSupported;// Offset=0x208 Size=0x1
    enum _USBD_ENDPOINT_OFFLOAD_MODE UsbEndpointOffloadMode;// Offset=0x20c Size=0x4
    unsigned char IsDSMForKBLWorkaroundsSupported;// Offset=0x210 Size=0x1
    struct _TIME_SYNC_DATA TimeSyncData;// Offset=0x218 Size=0xa8
};
