...
struct _unnamed_568// Size=0x4 (Id=568)
{
    enum _WDF_DEVICE_POWER_POLICY_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_569// Size=0x8 (Id=569)
{
    struct _unnamed_567 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_568 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_567 LeaveState;// Offset=0x0 Size=0x8
};
...
struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=570)
{
    ...
    union _unnamed_569 Data;// Offset=0x4 Size=0x8
};
