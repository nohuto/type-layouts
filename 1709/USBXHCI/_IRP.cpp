union _unnamed_72// Size=0x8 (Id=72)
{
...
union _unnamed_74// Size=0x10 (Id=74)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_73 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=705)
{
...
struct _unnamed_75// Size=0x58 (Id=75)
{
...
union _unnamed_76// Size=0x58 (Id=76)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_75 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=77)
{
    ...
    union _unnamed_72 AssociatedIrp;// Offset=0x18 Size=0x8
