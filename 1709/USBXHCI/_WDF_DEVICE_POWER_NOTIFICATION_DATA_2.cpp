...
struct _unnamed_604// Size=0x4 (Id=604)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_605// Size=0x8 (Id=605)
{
    struct _unnamed_603 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_604 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_603 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=228)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_605 Data;// Offset=0x4 Size=0x8
};
