...
struct _XILCORE_COMMAND_DATA// Size=0x40 (Id=871)
{
    ...
    union _DOORBELL_REGISTER * DoorbellRegister;// Offset=0x38 Size=0x8
};

struct _XIL_DIRECT_COMMAND_DATA// Size=0x40 (Id=795)
{
    struct _XILCORE_COMMAND_DATA XilCoreCommandData;// Offset=0x0 Size=0x40
};

struct _XIL_PROXY_COMMAND_DATA// Size=0x20 (Id=612)
{
...
struct _XIL_COMMAND_DATA// Size=0x50 (Id=571)
{
    unsigned char IsProxyCommandRing;// Offset=0x0 Size=0x1
    void * CommandRingHandle;// Offset=0x8 Size=0x8
    union // Size=0x40 (Id=0)
    {
        struct _XIL_DIRECT_COMMAND_DATA XilDirectCommandData;// Offset=0x10 Size=0x40
        struct _XIL_PROXY_COMMAND_DATA XilProxyCommandData;// Offset=0x10 Size=0x20
    };
};

struct _COMMAND_DATA// Size=0xd8 (Id=450)
{
    ...
    struct _XIL_COMMAND_DATA XilCommandData;// Offset=0x88 Size=0x50
};
