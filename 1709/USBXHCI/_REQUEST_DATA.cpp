...
struct _ENDPOINT_UPDATE_DATA// Size=0x78 (Id=771)
{
...
struct _ENDPOINT_STATIC_STREAMS_CONFIGURE// Size=0x8 (Id=689)
{
    struct _STATIC_STREAMS_DATA * StaticStreamsData;// Offset=0x0 Size=0x8
};

struct _ENDPOINT_RESET_DATA// Size=0x70 (Id=642)
{
    struct _ENDPOINT_DATA * EndpointData;// Offset=0x0 Size=0x8
    struct _XIL_BUFFER_DATA * InputBufferData;// Offset=0x8 Size=0x8
...
struct _USBDEVICE_ENDPOINTS_CONFIGURE_DATA// Size=0x2 (Id=685)
{
...
struct _TRB_RANGE// Size=0x20 (Id=873)
{
...
struct _SCATTER_GATHER_ELEMENT// Size=0x18 (Id=872)
{
...
struct _unnamed_778// Size=0x28 (Id=778)
{
...
struct _CONTROL_TRANSFER_DATA// Size=0xf8 (Id=779)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
    ...
    struct _unnamed_778 PreallocatedScatterGatherList;// Offset=0xd0 Size=0x28
};

struct _STAGE_QUEUE_HEADER// Size=0x8 (Id=851)
{
...
struct _ISOCH_STAGE_DATA// Size=0xd0 (Id=836)
{
    ...
    struct _unnamed_778 PreallocatedScatterGatherList;// Offset=0xa8 Size=0x28
};

struct _ISOCH_STAGE_QUEUE// Size=0x280 (Id=803)
{
    struct _STAGE_QUEUE_HEADER Header;// Offset=0x0 Size=0x8
    struct _ISOCH_STAGE_DATA StageArray[3];// Offset=0x10 Size=0x270
};

struct _ISOCH_TRANSFER_DATA// Size=0x300 (Id=542)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
    unsigned char Initialized;// Offset=0x10 Size=0x1
    struct WDFREQUEST__ * WdfRequest;// Offset=0x18 Size=0x8
...
struct _BULK_STAGE_DATA// Size=0xd0 (Id=875)
{
...
struct _BULK_STAGE_QUEUE// Size=0xe0 (Id=869)
{
    struct _STAGE_QUEUE_HEADER Header;// Offset=0x0 Size=0x8
    struct _BULK_STAGE_DATA StageArray[1];// Offset=0x10 Size=0xd0
};

struct _BULK_TRANSFER_DATA// Size=0x160 (Id=733)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
    unsigned char Initialized;// Offset=0x10 Size=0x1
    struct WDFREQUEST__ * WdfRequest;// Offset=0x18 Size=0x8
...
union _REQUEST_DATA// Size=0x300 (Id=480)
{
