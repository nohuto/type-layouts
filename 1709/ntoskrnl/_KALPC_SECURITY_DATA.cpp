...
union _unnamed_467// Size=0x4 (Id=467)
{
    struct _unnamed_466 s1;// Offset=0x0 Size=0x4
};

struct _KALPC_SECURITY_DATA// Size=0x70 (Id=468)
{
    ...
    union _unnamed_467 u1;// Offset=0x68 Size=0x4
};
