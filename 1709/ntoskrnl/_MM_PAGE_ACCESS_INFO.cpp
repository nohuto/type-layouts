struct _unnamed_806// Size=0x4 (Id=806)
{
...
struct _unnamed_807// Size=0x4 (Id=807)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long FilePointerIndex:9;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x9
...
union _MM_PAGE_ACCESS_INFO_FLAGS// Size=0x4 (Id=808)
{
    struct _unnamed_806 File;// Offset=0x0 Size=0x4
    struct _unnamed_807 Private;// Offset=0x0 Size=0x4
};

struct _MM_PAGE_ACCESS_INFO// Size=0x8 (Id=802)
{
    union // Size=0x8 (Id=0)
    {
