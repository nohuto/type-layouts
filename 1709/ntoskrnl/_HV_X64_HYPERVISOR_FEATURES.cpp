union _HV_PARTITION_PRIVILEGE_MASK// Size=0x8 (Id=300)
{
...
struct _HV_X64_HYPERVISOR_FEATURES// Size=0x10 (Id=299)
{
    ...
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned int Reserved1:7;// Offset=0xc Size=0x4 BitOffset=0x19 BitSize=0x7
    };
};
