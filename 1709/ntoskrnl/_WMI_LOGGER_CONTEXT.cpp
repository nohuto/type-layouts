...
struct _ETW_BUFFER_QUEUE// Size=0x10 (Id=489)
{
...
struct _ETW_REF_CLOCK// Size=0x10 (Id=928)
{
...
struct _SECURITY_QUALITY_OF_SERVICE// Size=0xc (Id=690)
{
...
struct _TOKEN_CONTROL// Size=0x28 (Id=1268)
{
...
struct _SECURITY_CLIENT_CONTEXT// Size=0x48 (Id=767)
{
...
struct _DISALLOWED_GUIDS// Size=0x10 (Id=914)
{
    unsigned short Count;// Offset=0x0 Size=0x2
    struct _GUID * Guids;// Offset=0x8 Size=0x8
};

struct _PERIODIC_CAPTURE_STATE_GUIDS// Size=0x10 (Id=1054)
{
...
struct _WMI_LOGGER_CONTEXT// Size=0x990 (Id=500)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long SpareFlags2:7;// Offset=0x340 Size=0x4 BitOffset=0x19 BitSize=0x7
        };
    };
    union // Size=0x4 (Id=0)
    {
    ...
    struct _ETW_STACK_TRACE_BLOCK StackTraceBlock;// Offset=0x350 Size=0x500
    struct _RTL_BITMAP HookIdMap;// Offset=0x850 Size=0x10
    struct _ETW_STACK_CACHE * StackCache;// Offset=0x860 Size=0x8
    struct _ETW_PMC_SUPPORT * PmcData;// Offset=0x868 Size=0x8
    struct _ETW_LBR_SUPPORT * LbrData;// Offset=0x870 Size=0x8
    struct _LIST_ENTRY BinaryTrackingList;// Offset=0x878 Size=0x10
    struct _WMI_BUFFER_HEADER ** ScratchArray;// Offset=0x888 Size=0x8
    struct _DISALLOWED_GUIDS DisallowedGuids;// Offset=0x890 Size=0x10
    long long RelativeTimerDueTime;// Offset=0x8a0 Size=0x8
    struct _PERIODIC_CAPTURE_STATE_GUIDS PeriodicCaptureStateGuids;// Offset=0x8a8 Size=0x10
    struct _EX_TIMER * PeriodicCaptureStateTimer;// Offset=0x8b8 Size=0x8
    enum _ETW_PERIODIC_TIMER_STATE PeriodicCaptureStateTimerState;// Offset=0x8c0 Size=0x4
    struct _ETW_SOFT_RESTART_CONTEXT * SoftRestartContext;// Offset=0x8c8 Size=0x8
    struct _ETW_SILODRIVERSTATE * SiloState;// Offset=0x8d0 Size=0x8
    struct _WORK_QUEUE_ITEM CompressionWorkItem;// Offset=0x8d8 Size=0x20
    long CompressionWorkItemState;// Offset=0x8f8 Size=0x4
    struct _EX_PUSH_LOCK CompressionLock;// Offset=0x900 Size=0x8
    struct _WMI_BUFFER_HEADER * CompressionTarget;// Offset=0x908 Size=0x8
    void * CompressionWorkspace;// Offset=0x910 Size=0x8
    long CompressionOn;// Offset=0x918 Size=0x4
    unsigned long CompressionRatioGuess;// Offset=0x91c Size=0x4
    unsigned long PartialBufferCompressionLevel;// Offset=0x920 Size=0x4
    enum ETW_COMPRESSION_RESUMPTION_MODE CompressionResumptionMode;// Offset=0x924 Size=0x4
    struct _SINGLE_LIST_ENTRY PlaceholderList;// Offset=0x928 Size=0x8
    struct _KDPC CompressionDpc;// Offset=0x930 Size=0x40
    union _LARGE_INTEGER LastBufferSwitchTime;// Offset=0x970 Size=0x8
    union _LARGE_INTEGER BufferWriteDuration;// Offset=0x978 Size=0x8
    union _LARGE_INTEGER BufferCompressDuration;// Offset=0x980 Size=0x8
};
