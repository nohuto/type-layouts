...
struct _KHETERO_PROCESSOR_SET// Size=0x18 (Id=607)
{
...
struct _KNODE// Size=0x140 (Id=89)
{
    ...
    unsigned long long PpmConfiguredQosSets[3];// Offset=0x128 Size=0x18
};
...
struct _ENODE// Size=0x180 (Id=90)
{
    struct _KNODE Ncb;// Offset=0x0 Size=0x140
    struct _WORK_QUEUE_ITEM HotAddProcessorWorkItem;// Offset=0x140 Size=0x20
};
