union _unnamed_112// Size=0x8 (Id=112)
{
...
union _unnamed_114// Size=0x10 (Id=114)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_113 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=925)
{
...
struct _unnamed_115// Size=0x58 (Id=115)
{
...
union _unnamed_116// Size=0x58 (Id=116)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_115 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=117)
{
    ...
    union _unnamed_112 AssociatedIrp;// Offset=0x18 Size=0x8
