...
union _unnamed_1257// Size=0x4 (Id=1257)
{
...
struct _MMVAD// Size=0x88 (Id=1259)
{
    struct _MMVAD_SHORT Core;// Offset=0x0 Size=0x40
    union _unnamed_1257 u2;// Offset=0x40 Size=0x4
    ...
    union _unnamed_1258 u4;// Offset=0x78 Size=0x8
