...
struct _unnamed_397// Size=0x10 (Id=397)
{
...
struct _unnamed_401// Size=0x30 (Id=401)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
struct _unnamed_402// Size=0x68 (Id=402)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
union _unnamed_403// Size=0x68 (Id=403)
{
    struct _unnamed_397 Read;// Offset=0x0 Size=0x10
    struct _unnamed_398 Write;// Offset=0x0 Size=0x8
    struct _unnamed_399 Event;// Offset=0x0 Size=0x8
    struct _unnamed_400 Notification;// Offset=0x0 Size=0x4
    struct _unnamed_401 LowPriWrite;// Offset=0x0 Size=0x30
    struct _unnamed_402 AsyncRead;// Offset=0x0 Size=0x68
};

struct _WORK_QUEUE_ENTRY// Size=0x88 (Id=404)
{
    struct _LIST_ENTRY WorkQueueLinks;// Offset=0x0 Size=0x10
    union _unnamed_403 Parameters;// Offset=0x10 Size=0x68
