...
struct _ALPC_PORT_ATTRIBUTES// Size=0x48 (Id=654)
{
...
struct _unnamed_450// Size=0x4 (Id=450)
{
...
union _unnamed_451// Size=0x4 (Id=451)
{
    struct _unnamed_450 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

struct _ALPC_PORT// Size=0x1d8 (Id=452)
{
    ...
    union _unnamed_451 u1;// Offset=0x1a0 Size=0x4
