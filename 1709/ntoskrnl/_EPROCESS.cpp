...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=682)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _KPROCESS// Size=0x2d8 (Id=62)
{
    ...
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long PpmPolicy:3;// Offset=0x1b8 Size=0x4 BitOffset=0x6 BitSize=0x3
            unsigned long ActiveGroupsMask:20;// Offset=0x1b8 Size=0x4 BitOffset=0x9 BitSize=0x14
            unsigned long VaSpaceDeleted:1;// Offset=0x1b8 Size=0x4 BitOffset=0x1d BitSize=0x1
            unsigned long ReservedFlags:2;// Offset=0x1b8 Size=0x4 BitOffset=0x1e BitSize=0x2
        };
    ...
    union _unnamed_61 SecureState;// Offset=0x2d0 Size=0x8
};
...
struct _ALPC_PROCESS_CONTEXT// Size=0x20 (Id=835)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=799)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=997)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WNF_STATE_NAME// Size=0x8 (Id=533)
{
    unsigned long Data[2];// Offset=0x0 Size=0x8
};

struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=758)
{
    unsigned long HighEdgeFilter;// Offset=0x0 Size=0x4
    unsigned long LowEdgeFilter;// Offset=0x4 Size=0x4
};

struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=730)
{
...
struct _EPROCESS// Size=0x840 (Id=109)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_107 MitigationFlagsValues;// Offset=0x828 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x82c Size=0x4
        struct _unnamed_108 MitigationFlags2Values;// Offset=0x82c Size=0x4
    };
