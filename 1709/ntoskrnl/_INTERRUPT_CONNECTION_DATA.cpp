...
struct _GROUP_AFFINITY// Size=0x10 (Id=321)
{
...
struct _unnamed_1592// Size=0xc (Id=1592)
{
...
union _unnamed_1593// Size=0xc (Id=1593)
{
    struct _unnamed_1592 Msi;// Offset=0x0 Size=0xc
};

struct _INTERRUPT_REMAPPING_INFO// Size=0x10 (Id=1594)
{
    ...
    union _unnamed_1593 u;// Offset=0x4 Size=0xc
};
...
union _unnamed_1553// Size=0x4 (Id=1553)
{
    struct _unnamed_1552 bits;// Offset=0x0 Size=0x4
...
{
    struct _unnamed_1554 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_HT_INTR_INFO// Size=0x8 (Id=1556)
{
    union _unnamed_1553 LowPart;// Offset=0x0 Size=0x4
    union _unnamed_1555 HighPart;// Offset=0x4 Size=0x4
};

struct _unnamed_1481// Size=0x8 (Id=1481)
{
...
struct _INTERRUPT_VECTOR_DATA// Size=0x58 (Id=1484)
{
    ...
    struct _unnamed_1479 ControllerInput;// Offset=0x38 Size=0x8
    unsigned long long HvDeviceId;// Offset=0x40 Size=0x8
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_1480 XapicMessage;// Offset=0x48 Size=0x10
        struct _unnamed_1481 Hypertransport;// Offset=0x48 Size=0x8
        struct _unnamed_1480 GenericMessage;// Offset=0x48 Size=0x10
        struct _unnamed_1483 MessageRequest;// Offset=0x48 Size=0x4
    };
};

struct _INTERRUPT_CONNECTION_DATA// Size=0x60 (Id=1385)
{
