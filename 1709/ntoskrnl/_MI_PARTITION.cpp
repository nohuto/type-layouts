struct _MI_PARTITION_FLAGS// Size=0x4 (Id=1383)
{
...
struct _MI_PARTITION_CORE// Size=0x1a8 (Id=977)
{
    unsigned short PartitionId;// Offset=0x0 Size=0x2
    union _unnamed_976 u;// Offset=0x4 Size=0x4
    ...
    void * SystemThreadHandles[5];// Offset=0x80 Size=0x28
    struct _EPARTITION * PartitionObject;// Offset=0xa8 Size=0x8
    struct _EX_PUSH_LOCK PartitionSystemThreadsLock;// Offset=0xb0 Size=0x8
    struct _EX_PUSH_LOCK DynamicMemoryPushLock;// Offset=0xb8 Size=0x8
    long DynamicMemoryLock;// Offset=0xc0 Size=0x4
    unsigned char PfnUnmapActive;// Offset=0xc4 Size=0x1
    struct _KEVENT TemporaryMemoryEvent;// Offset=0xc8 Size=0x18
    void * RootDirectory;// Offset=0xe0 Size=0x8
    void * KernelObjectsDirectory;// Offset=0xe8 Size=0x8
    struct _KEVENT * MemoryEvents[11];// Offset=0xf0 Size=0x58
    void * MemoryEventHandles[11];// Offset=0x148 Size=0x58
    unsigned long long NonChargedSecurePages;// Offset=0x1a0 Size=0x8
};

struct _MMPAGE_FILE_EXPANSION_FLAGS// Size=0x4 (Id=1538)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1097// Size=0x4 (Id=1097)
{
    unsigned long LongFlags;// Offset=0x0 Size=0x4
    struct _MMPAGE_FILE_EXPANSION_FLAGS Flags;// Offset=0x0 Size=0x4
};

struct _MMPAGE_FILE_EXPANSION// Size=0x58 (Id=1098)
{
    ...
    union _unnamed_1097 u1;// Offset=0x4c Size=0x4
    void ** ActiveEntry;// Offset=0x50 Size=0x8
};

struct _KGATE// Size=0x18 (Id=816)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
};

struct _MMMOD_WRITER_LISTHEAD// Size=0x28 (Id=1388)
{
...
union _MI_RESERVATION_CLUSTER_INFO// Size=0x4 (Id=1570)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_MODWRITE_DATA// Size=0x40 (Id=1468)
{
...
struct _EX_RUNDOWN_REF// Size=0x8 (Id=187)
{
    union // Size=0x8 (Id=0)
    {
...
struct _MI_PARTITION_MODWRITES// Size=0x2c0 (Id=1282)
{
    ...
    long ClusterWritesDisabled[2];// Offset=0x22c Size=0x8
...
union _unnamed_648// Size=0x4 (Id=648)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_PARTITION_STORES// Size=0x90 (Id=649)
{
    union _unnamed_648 WriteAllStoreHintedPages;// Offset=0x0 Size=0x4
...
struct _MMDEREFERENCE_SEGMENT_HEADER// Size=0x50 (Id=1437)
{
...
struct _KTIMER// Size=0x40 (Id=1193)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _MI_CROSS_PARTITION_CHARGES// Size=0x20 (Id=1463)
{
...
struct _MI_PARTITION_SEGMENTS// Size=0x300 (Id=1062)
{
    ...
    struct _MMPAGE_FILE_EXPANSION AttemptForCantExtend;// Offset=0x50 Size=0x58
    struct _MMDEREFERENCE_SEGMENT_HEADER DereferenceSegmentHeader;// Offset=0xa8 Size=0x50
    struct _LIST_ENTRY DeleteOnCloseList;// Offset=0xf8 Size=0x10
    struct _KTIMER DeleteOnCloseTimer;// Offset=0x108 Size=0x40
    unsigned char DeleteOnCloseTimerActive;// Offset=0x148 Size=0x1
    unsigned char SegmentDereferenceThreadExists;// Offset=0x149 Size=0x1
    unsigned long long UnusedSegmentPagedPool;// Offset=0x150 Size=0x8
    struct _LIST_ENTRY UnusedSegmentList;// Offset=0x158 Size=0x10
    struct _LIST_ENTRY UnusedSubsectionList;// Offset=0x168 Size=0x10
    struct _LIST_ENTRY DeleteSubsectionList;// Offset=0x178 Size=0x10
    struct _KEVENT ControlAreaDeleteEvent;// Offset=0x188 Size=0x18
    struct _SINGLE_LIST_ENTRY ControlAreaDeleteList;// Offset=0x1a0 Size=0x8
    struct _MI_PTE_CHAIN_HEAD FreeSystemCache;// Offset=0x1a8 Size=0x18
    struct _KEVENT CloneDereferenceEvent;// Offset=0x1c0 Size=0x18
    union _SLIST_HEADER CloneProtosSListHead;// Offset=0x1e0 Size=0x10
    struct _EX_PUSH_LOCK SystemCacheInitLock;// Offset=0x1f0 Size=0x8
    unsigned long PagefileExtensionWaiters;// Offset=0x1f8 Size=0x4
    unsigned long PagefileExtensionRequests;// Offset=0x1fc Size=0x4
    struct _KEVENT PagefileExtensionWaitEvent;// Offset=0x200 Size=0x18
    struct _MI_CROSS_PARTITION_CHARGES SharedCharges[5];// Offset=0x218 Size=0xa0
    struct _KEVENT * SharedChargesDrainEvent;// Offset=0x2b8 Size=0x8
    struct _KEVENT * PagefileControlAreasDrainEvent;// Offset=0x2c0 Size=0x8
};
...
struct _MI_PARTITION_COMMIT// Size=0x80 (Id=1171)
{
...
struct _MI_PARTITION_ZEROING// Size=0x68 (Id=1133)
{
    struct _KEVENT PageEvent;// Offset=0x0 Size=0x18
    unsigned char ThreadActive;// Offset=0x18 Size=0x1
    unsigned char ThreadPriorityStatic;// Offset=0x19 Size=0x1
    ...
    struct _MI_ZERO_THREAD_CONTEXT * ThreadContext;// Offset=0x60 Size=0x8
};

struct _MI_COMBINE_WORKITEM// Size=0x28 (Id=996)
{
    void * NextEntry;// Offset=0x0 Size=0x8
    struct _WORK_QUEUE_ITEM WorkItem;// Offset=0x8 Size=0x20
};

struct _MI_COMBINE_PAGE_LISTHEAD// Size=0x10 (Id=1286)
{
    struct _RTL_AVL_TREE Table;// Offset=0x0 Size=0x8
    long Lock;// Offset=0x8 Size=0x4
};

struct _MI_PAGE_COMBINE_STATISTICS// Size=0x28 (Id=1039)
{
...
struct _MI_PAGE_COMBINING_SUPPORT// Size=0x188 (Id=898)
{
...
struct _MMWORKING_SET_EXPANSION_HEAD// Size=0x10 (Id=689)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
};
...
struct _MI_PAGEFILE_TRACES// Size=0x78 (Id=991)
{
    ...
    struct _unnamed_990 MdlHack;// Offset=0x40 Size=0x38
};

struct _MI_VISIBLE_PARTITION// Size=0x1200 (Id=739)
{
...
struct _MI_PARTITION// Size=0x2880 (Id=252)
{
    struct _MI_PARTITION_CORE Core;// Offset=0x0 Size=0x1a8
    struct _MI_PARTITION_MODWRITES Modwriter;// Offset=0x1a8 Size=0x2c0
    struct _MI_PARTITION_STORES Store;// Offset=0x470 Size=0x90
    struct _MI_PARTITION_SEGMENTS Segments;// Offset=0x500 Size=0x300
    struct _MI_PARTITION_PAGE_LISTS PageLists;// Offset=0x800 Size=0xbc0
    struct _MI_PARTITION_COMMIT Commit;// Offset=0x13c0 Size=0x80
    struct _MI_PARTITION_ZEROING Zeroing;// Offset=0x1440 Size=0x68
    struct _MI_PAGE_COMBINING_SUPPORT PageCombine;// Offset=0x14a8 Size=0x188
    void * WorkingSetControl;// Offset=0x1630 Size=0x8
    struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;// Offset=0x1638 Size=0x10
    struct _MI_VISIBLE_PARTITION Vp;// Offset=0x1680 Size=0x1200
};
