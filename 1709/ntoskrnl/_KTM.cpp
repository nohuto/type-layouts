...
struct _RTL_AVL_TABLE// Size=0x68 (Id=1288)
{
...
struct _KTMOBJECT_NAMESPACE// Size=0xa8 (Id=1477)
{
...
struct _unnamed_1332// Size=0x8 (Id=1332)
{
    unsigned int idxRecord;// Offset=0x0 Size=0x4
    unsigned long cidContainer;// Offset=0x4 Size=0x4
};

union _CLS_LSN// Size=0x8 (Id=1333)
{
    struct _unnamed_1332 offset;// Offset=0x0 Size=0x8
...
struct _KTM// Size=0x3c0 (Id=1264)
{
