struct _unnamed_1231// Size=0x8 (Id=1231)
{
...
union _unnamed_1232// Size=0x8 (Id=1232)
{
    struct _unnamed_1231 s1;// Offset=0x0 Size=0x8
    long long Value;// Offset=0x0 Size=0x8
};

struct _ALPC_COMPLETION_LIST_STATE// Size=0x8 (Id=1233)
{
    union _unnamed_1232 u1;// Offset=0x0 Size=0x8
};

struct _RTL_SRWLOCK// Size=0x8 (Id=1104)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _ALPC_COMPLETION_LIST_HEADER// Size=0x180 (Id=1009)
{
