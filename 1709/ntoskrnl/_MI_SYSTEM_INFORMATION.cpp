...
struct _MI_POOL_FAILURE_REASONS// Size=0x2c (Id=1564)
{
...
struct _MI_POOL_STATE// Size=0xe8 (Id=1321)
{
...
struct _MSUBSECTION// Size=0x70 (Id=1417)
{
...
struct _MMSECTION_FLAGS// Size=0x4 (Id=536)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_239// Size=0x4 (Id=239)
{
    unsigned long LongFlags;// Offset=0x0 Size=0x4
...
struct _EX_FAST_REF// Size=0x8 (Id=94)
{
    union // Size=0x8 (Id=0)
    {
...
{
    struct _unnamed_241 e2;// Offset=0x0 Size=0x10
};
...
struct _CONTROL_AREA// Size=0x80 (Id=244)
{
    ...
    union _unnamed_239 u;// Offset=0x38 Size=0x4
    union _unnamed_240 u1;// Offset=0x3c Size=0x4
...
struct _MI_SECTION_STATE// Size=0x280 (Id=840)
{
    ...
    struct _MMPFNLIST PurgingExtentPages;// Offset=0x120 Size=0x28
    struct _MMPFN * DanglingExtentPages;// Offset=0x148 Size=0x8
    struct _WORK_QUEUE_ITEM DanglingExtentsWorkItem;// Offset=0x150 Size=0x20
    unsigned char DanglingExtentsWorkerActive;// Offset=0x170 Size=0x1
    unsigned char PurgingExtentsNeedWatchdog;// Offset=0x171 Size=0x1
    struct _RTL_AVL_TREE PageFileSectionHead;// Offset=0x178 Size=0x8
    long PageFileSectionListSpinLock;// Offset=0x180 Size=0x4
    unsigned long ImageBias;// Offset=0x184 Size=0x4
    struct _EX_PUSH_LOCK RelocateBitmapsLock;// Offset=0x188 Size=0x8
    struct _RTL_BITMAP ImageBitMap;// Offset=0x190 Size=0x10
    unsigned long ImageBias64Low;// Offset=0x1a0 Size=0x4
    unsigned long ImageBias64High;// Offset=0x1a4 Size=0x4
    struct _RTL_BITMAP ImageBitMap64Low;// Offset=0x1a8 Size=0x10
    struct _RTL_BITMAP ImageBitMap64High;// Offset=0x1b8 Size=0x10
    struct _RTL_BITMAP ImageBitMapWow64Dll;// Offset=0x1c8 Size=0x10
    void * ApiSetSection;// Offset=0x1d8 Size=0x8
    void * ApiSetSchema;// Offset=0x1e0 Size=0x8
    unsigned long long ApiSetSchemaSize;// Offset=0x1e8 Size=0x8
    unsigned long LostDataFiles;// Offset=0x1f0 Size=0x4
    unsigned long LostDataPages;// Offset=0x1f4 Size=0x4
    unsigned long ImageFailureReason;// Offset=0x1f8 Size=0x4
    struct _SECTION * CfgBitMapSection32;// Offset=0x200 Size=0x8
    struct _CONTROL_AREA * CfgBitMapControlArea32;// Offset=0x208 Size=0x8
    struct _SECTION * CfgBitMapSection64;// Offset=0x210 Size=0x8
    struct _CONTROL_AREA * CfgBitMapControlArea64;// Offset=0x218 Size=0x8
    struct _RTL_BITMAP_EX KernelCfgBitMap;// Offset=0x220 Size=0x10
    struct _EX_PUSH_LOCK KernelCfgBitMapLock;// Offset=0x230 Size=0x8
    unsigned long ImageCfgFailure;// Offset=0x238 Size=0x4
    unsigned long ImageChecksumBreakpoint;// Offset=0x23c Size=0x4
    unsigned long ImageSizeBreakpoint;// Offset=0x240 Size=0x4
    long ImageValidationFailed;// Offset=0x244 Size=0x4
};
...
struct _MM_SYSTEM_PAGE_COUNTS// Size=0x10 (Id=958)
{
...
struct _MI_SYSTEM_IMAGE_STATE// Size=0xb8 (Id=769)
{
...
struct _MI_HARDWARE_STATE// Size=0x100 (Id=1329)
{
    ...
    unsigned long MediumPageColors;// Offset=0x58 Size=0x4
    unsigned long FlushTbForAttributeChange;// Offset=0x5c Size=0x4
    unsigned long FlushCacheForAttributeChange;// Offset=0x60 Size=0x4
    unsigned long FlushCacheForPageAttributeChange;// Offset=0x64 Size=0x4
    unsigned long CacheFlushPromoteThreshold;// Offset=0x68 Size=0x4
    unsigned long long FlushTbThreshold;// Offset=0x70 Size=0x8
    enum _MI_PFN_CACHE_ATTRIBUTE OptimalZeroingAttribute[4][4];// Offset=0x78 Size=0x40
    unsigned char AttributeChangeRequiresReZero;// Offset=0xb8 Size=0x1
    struct _MI_ZERO_COST_COUNTS ZeroCostCounts[2];// Offset=0xc0 Size=0x20
    unsigned long long PrimaryPfns;// Offset=0xe0 Size=0x8
    unsigned long long HighestPossiblePhysicalPage;// Offset=0xe8 Size=0x8
    struct _RTL_AVL_TREE EnclaveRegions;// Offset=0xf0 Size=0x8
    unsigned long long VsmKernelPageCount;// Offset=0xf8 Size=0x8
};

struct _MI_DYNAMIC_BITMAP// Size=0x48 (Id=1142)
{
...
struct _MMWSL_INSTANCE// Size=0x28 (Id=915)
{
...
struct _MI_SYSTEM_VA_STATE// Size=0x440 (Id=1001)
{
...
struct _MI_COMBINE_STATE// Size=0x18 (Id=1210)
{
...
struct _MI_PAGELIST_STATE// Size=0x10 (Id=1229)
{
    long ActiveSpinLock;// Offset=0x0 Size=0x4
    struct _RTL_AVL_TREE ActiveThreadTree;// Offset=0x8 Size=0x8
};

struct _MI_PARTITION_STATE// Size=0x60 (Id=788)
{
...
struct _MI_BAD_MEMORY_EVENT_ENTRY// Size=0x38 (Id=1429)
{
...
struct _MI_PROBE_RAISE_TRACKER// Size=0x40 (Id=1476)
{
...
struct _MI_ACCESS_LOG_STATE// Size=0x80 (Id=964)
{
...
struct _MI_DEBUGGER_STATE// Size=0x118 (Id=1040)
{
...
struct _MI_STANDBY_STATE// Size=0x70 (Id=1200)
{
...
struct _GENERAL_LOOKASIDE// Size=0x80 (Id=88)
{
    union // Size=0x10 (Id=0)
    {
...
struct _NPAGED_LOOKASIDE_LIST// Size=0x80 (Id=74)
{
...
struct _MI_SYSTEM_PTE_TYPE// Size=0x68 (Id=247)
{
    struct _RTL_BITMAP_EX Bitmap;// Offset=0x0 Size=0x10
...
struct _MI_ULTRA_VA_CONTEXT// Size=0x40 (Id=1014)
{
...
struct _MI_SYSTEM_PTE_STATE// Size=0x240 (Id=975)
{
    ...
    struct _MI_SYSTEM_PTE_TYPE SystemViewPteInfo;// Offset=0xb8 Size=0x68
    struct _MI_SYSTEM_PTE_TYPE KernelStackPteInfo;// Offset=0x120 Size=0x68
    unsigned long StackGrowthFailures;// Offset=0x188 Size=0x4
    unsigned char KernelStackPages;// Offset=0x18c Size=0x1
    unsigned char TrackPtesAborted;// Offset=0x18d Size=0x1
    unsigned char AdjustCounter;// Offset=0x18e Size=0x1
    long ReservedMappingLock;// Offset=0x190 Size=0x4
    struct _RTL_AVL_TREE ReservedMappingTree;// Offset=0x198 Size=0x8
    struct _MMPFN * ReservedMappingPageTablePfns;// Offset=0x1a0 Size=0x8
    struct _RTL_AVL_TREE OutswappedKernelStackRoot;// Offset=0x1a8 Size=0x8
    long OutswappedKernelStackLock;// Offset=0x1b0 Size=0x4
    struct _MI_ULTRA_VA_CONTEXT UltraSpaceContext;// Offset=0x1b8 Size=0x40
    unsigned long NumberOfUltraMdlMaps;// Offset=0x1f8 Size=0x4
    struct _MI_ULTRA_MDL_NODE * UltraMdlNodeMappings;// Offset=0x200 Size=0x8
};

struct _MI_IO_CACHE_STATS// Size=0x28 (Id=1525)
{
...
struct _MI_IO_PAGE_STATE// Size=0x68 (Id=1459)
{
...
struct _MI_PAGING_IO_STATE// Size=0x50 (Id=1198)
{
...
struct _MMPTE_HARDWARE// Size=0x8 (Id=630)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _MMPTE_PROTOTYPE// Size=0x8 (Id=989)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long Valid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _MMPTE_SOFTWARE// Size=0x8 (Id=852)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long Valid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _MMPTE_TIMESTAMP// Size=0x8 (Id=1065)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _MMPTE_TRANSITION// Size=0x8 (Id=1343)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long Valid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _MMPTE_SUBSECTION// Size=0x8 (Id=625)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long Valid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _MMPTE_LIST// Size=0x8 (Id=1147)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long Valid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
union _unnamed_219// Size=0x8 (Id=219)
{
...
struct _MMPTE// Size=0x8 (Id=220)
{
    union _unnamed_219 u;// Offset=0x0 Size=0x8
};

struct _MI_COMMON_PAGE_STATE// Size=0xa8 (Id=1337)
{
...
struct _MI_SYSTEM_TRIM_STATE// Size=0x40 (Id=949)
{
...
struct _MI_PTE_CHAIN_HEAD// Size=0x18 (Id=721)
{
...
struct _MI_SPECIAL_POOL// Size=0x40 (Id=643)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _MM_PAGED_POOL_INFO// Size=0x38 (Id=691)
{
...
union _unnamed_979// Size=0x8 (Id=979)
{
    void * InstancedWorkingSet;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=1137)
{
    union // Size=0x2 (Id=0)
    {
...
struct _MMSUPPORT_INSTANCE// Size=0xc8 (Id=980)
{
...
struct _SYSPTES_HEADER// Size=0x118 (Id=1334)
{
...
struct _MI_SYSTEM_VA_ASSIGNMENT// Size=0x10 (Id=1550)
{
    void * BaseAddress;// Offset=0x0 Size=0x8
    unsigned long long NumberOfBytes;// Offset=0x8 Size=0x8
};

struct _MI_VISIBLE_STATE// Size=0x900 (Id=1412)
{
    ...
    unsigned long long SystemVaTypeCount[16];// Offset=0x690 Size=0x80
    unsigned char SystemVaType[256];// Offset=0x710 Size=0x100
    struct _MI_SYSTEM_VA_ASSIGNMENT SystemVaRegions[14];// Offset=0x810 Size=0xe0
};

struct _MI_SYSTEM_INFORMATION// Size=0x1b80 (Id=736)
{
    struct _MI_POOL_STATE Pools;// Offset=0x0 Size=0xe8
    struct _MI_SECTION_STATE Sections;// Offset=0x100 Size=0x280
    struct _MI_SYSTEM_IMAGE_STATE SystemImages;// Offset=0x380 Size=0xb8
    struct _MI_SESSION_STATE Sessions;// Offset=0x438 Size=0x88
    struct _MI_PROCESS_STATE Processes;// Offset=0x4c0 Size=0x38
    struct _MI_HARDWARE_STATE Hardware;// Offset=0x4f8 Size=0x100
    struct _MI_SYSTEM_VA_STATE SystemVa;// Offset=0x600 Size=0x440
    struct _MI_COMBINE_STATE PageCombines;// Offset=0xa40 Size=0x18
    struct _MI_PAGELIST_STATE PageLists;// Offset=0xa58 Size=0x10
    struct _MI_PARTITION_STATE Partitions;// Offset=0xa68 Size=0x60
    struct _MI_SHUTDOWN_STATE Shutdowns;// Offset=0xac8 Size=0x78
    struct _MI_ERROR_STATE Errors;// Offset=0xb40 Size=0xb8
    struct _MI_ACCESS_LOG_STATE AccessLog;// Offset=0xc00 Size=0x80
    struct _MI_DEBUGGER_STATE Debugger;// Offset=0xc80 Size=0x118
    struct _MI_STANDBY_STATE Standby;// Offset=0xda0 Size=0x70
    struct _MI_SYSTEM_PTE_STATE SystemPtes;// Offset=0xe40 Size=0x240
    struct _MI_IO_PAGE_STATE IoPages;// Offset=0x1080 Size=0x68
    struct _MI_PAGING_IO_STATE PagingIo;// Offset=0x10f0 Size=0x50
    struct _MI_COMMON_PAGE_STATE CommonPages;// Offset=0x1140 Size=0xa8
    struct _MI_SYSTEM_TRIM_STATE Trims;// Offset=0x1200 Size=0x40
    unsigned long long Cookie;// Offset=0x1240 Size=0x8
    void ** BootRegistryRuns;// Offset=0x1248 Size=0x8
    long ZeroingDisabled;// Offset=0x1250 Size=0x4
    unsigned char FullyInitialized;// Offset=0x1254 Size=0x1
    unsigned char SafeBooted;// Offset=0x1255 Size=0x1
    struct _TlgProvider_t * TraceLogging;// Offset=0x1258 Size=0x8
    struct _MI_VISIBLE_STATE Vs;// Offset=0x1280 Size=0x900
};
