...
union _unnamed_443// Size=0x4 (Id=443)
{
    struct _unnamed_442 s1;// Offset=0x0 Size=0x4
};

struct _KALPC_REGION// Size=0x58 (Id=444)
{
    ...
    union _unnamed_443 u1;// Offset=0x30 Size=0x4
