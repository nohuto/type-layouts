struct _MM_SESSION_SPACE_FLAGS// Size=0x4 (Id=631)
{
...
struct _FAST_MUTEX// Size=0x38 (Id=66)
{
...
struct _POOL_DESCRIPTOR// Size=0x1140 (Id=824)
{
...
struct _MI_SESSION_DRIVER_UNLOAD// Size=0x8 (Id=805)
{
    union // Size=0x8 (Id=0)
    {
...
struct _MM_SESSION_SPACE// Size=0x4000 (Id=552)
{
    long ReferenceCount;// Offset=0x0 Size=0x4
    union _unnamed_550 u;// Offset=0x4 Size=0x4
    ...
    struct _MM_PAGED_POOL_INFO PagedPoolInfo;// Offset=0xa0 Size=0x38
    ...
    struct _MMPTE PageDirectory;// Offset=0x1ec8 Size=0x8
    struct _EX_PUSH_LOCK SessionVaLock;// Offset=0x1ed0 Size=0x8
    struct _RTL_BITMAP_EX DynamicVaBitMap;// Offset=0x1ed8 Size=0x10
    unsigned long long DynamicVaHint;// Offset=0x1ee8 Size=0x8
    struct _MI_SPECIAL_POOL SpecialPool;// Offset=0x1ef0 Size=0x40
    struct _EX_PUSH_LOCK SessionPteLock;// Offset=0x1f30 Size=0x8
    long PoolBigEntriesInUse;// Offset=0x1f38 Size=0x4
    unsigned long PagedPoolPdeCount;// Offset=0x1f3c Size=0x4
    unsigned long SpecialPoolPdeCount;// Offset=0x1f40 Size=0x4
    unsigned long DynamicSessionPdeCount;// Offset=0x1f44 Size=0x4
    struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;// Offset=0x1f48 Size=0x68
    void * PoolTrackTableExpansion;// Offset=0x1fb0 Size=0x8
    unsigned long long PoolTrackTableExpansionSize;// Offset=0x1fb8 Size=0x8
    void * PoolTrackBigPages;// Offset=0x1fc0 Size=0x8
    unsigned long long PoolTrackBigPagesSize;// Offset=0x1fc8 Size=0x8
    enum _IO_SESSION_STATE IoState;// Offset=0x1fd0 Size=0x4
    unsigned long IoStateSequence;// Offset=0x1fd4 Size=0x4
    struct _KEVENT IoNotificationEvent;// Offset=0x1fd8 Size=0x18
    struct _EJOB * ServerSilo;// Offset=0x1ff0 Size=0x8
    unsigned long long CreateTime;// Offset=0x1ff8 Size=0x8
    unsigned char PoolTags[8192];// Offset=0x2000 Size=0x2000
};
