...
struct _unnamed_1599// Size=0x10 (Id=1599)
{
...
struct _unnamed_1601// Size=0x10 (Id=1601)
{
...
struct _unnamed_1602// Size=0x20 (Id=1602)
{
...
struct _unnamed_1603// Size=0x28 (Id=1603)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=1604)
{
    struct _unnamed_1596 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_1597 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_1599 AcquireForSectionSynchronization;// Offset=0x0 Size=0x10
    struct _unnamed_1601 NotifyStreamFileObject;// Offset=0x0 Size=0x10
    struct _unnamed_1602 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_1603 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=1584)
{
