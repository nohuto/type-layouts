...
struct _PROC_PERF_QOS_CLASS_POLICY// Size=0x18 (Id=1452)
{
...
struct _PERF_CONTROL_STATE_SELECTION// Size=0x28 (Id=1457)
{
...
struct _PROC_PERF_DOMAIN// Size=0x268 (Id=1336)
{
    ...
    struct _PROC_PERF_QOS_CLASS_POLICY QosPolicies[3];// Offset=0x174 Size=0x48
    unsigned long QosDisableReasons[3];// Offset=0x1bc Size=0xc
    unsigned long QosEquivalencyMasks[3];// Offset=0x1c8 Size=0xc
    unsigned char QosSupported;// Offset=0x1d4 Size=0x1
    unsigned long SelectionGeneration;// Offset=0x1d8 Size=0x4
    struct _PERF_CONTROL_STATE_SELECTION QosSelection[3];// Offset=0x1e0 Size=0x78
