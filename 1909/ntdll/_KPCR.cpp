struct _NT_TIB// Size=0x38 (Id=479)
{
...
union _KPRCBFLAG// Size=0x4 (Id=415)
{
...
struct _KDESCRIPTOR// Size=0x10 (Id=663)
{
...
struct _KSPECIAL_REGISTERS// Size=0xf0 (Id=623)
{
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=382)
{
...
struct _KDPC_DATA// Size=0x28 (Id=297)
{
...
struct _KTIMER_TABLE_ENTRY// Size=0x20 (Id=668)
{
...
struct _KTIMER_TABLE// Size=0x2200 (Id=615)
{
...
struct _KGATE// Size=0x18 (Id=407)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
};

struct _KDPC// Size=0x40 (Id=176)
{
    union // Size=0x4 (Id=0)
    {
...
struct _PROC_IDLE_POLICY// Size=0x6 (Id=656)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=516)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=546)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=553)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=630)
{
...
struct _PROCESSOR_POWER_STATE// Size=0x200 (Id=520)
{
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=439)
{
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=562)
{
...
struct _KSECURE_FAULT_INFORMATION// Size=0x10 (Id=371)
{
    unsigned long long FaultCode;// Offset=0x0 Size=0x8
    unsigned long long FaultVa;// Offset=0x8 Size=0x8
};

struct _KSHARED_READY_QUEUE// Size=0x270 (Id=478)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _MACHINE_CHECK_CONTEXT// Size=0x50 (Id=498)
{
...
struct _KPRCB// Size=0x8f00 (Id=45)
{
    ...
    unsigned char PrcbPad81[6];// Offset=0x5c20 Size=0x6
    unsigned char ExceptionStackActive;// Offset=0x5c26 Size=0x1
    unsigned char TbFlushListActive;// Offset=0x5c27 Size=0x1
    void * ExceptionStack;// Offset=0x5c28 Size=0x8
    unsigned long long PrcbPad82[1];// Offset=0x5c30 Size=0x8
    ...
    struct _anonymous_44 StibpPairingTrace;// Offset=0x6438 Size=0x38
    ...
    unsigned char PrcbPad138[896];// Offset=0x6ac0 Size=0x380
    unsigned char PrcbPad138a[64];// Offset=0x6e40 Size=0x40
    ...
    unsigned long PrcbPad138b;// Offset=0x6e9c Size=0x4
    unsigned long long PrcbPad138c;// Offset=0x6ea0 Size=0x8
    unsigned short PrcbPad138d;// Offset=0x6ea8 Size=0x2
    unsigned short VerwSelector;// Offset=0x6eaa Size=0x2
    unsigned long PrcbPad139;// Offset=0x6eac Size=0x4
    unsigned long DbgMceNestingLevel;// Offset=0x6eb0 Size=0x4
    unsigned long DbgMceFlags;// Offset=0x6eb4 Size=0x4
    unsigned long long PrcbPad140[505];// Offset=0x6eb8 Size=0xfc8
    unsigned long long PrcbPad140a[8];// Offset=0x7e80 Size=0x40
    unsigned long long PrcbPad141[504];// Offset=0x7ec0 Size=0xfc0
    unsigned char PrcbPad141a[64];// Offset=0x8e80 Size=0x40
    struct _REQUEST_MAILBOX RequestMailbox[1];// Offset=0x8ec0 Size=0x40
};

struct _KPCR// Size=0x9080 (Id=43)
{
    ...
    struct _KPRCB Prcb;// Offset=0x180 Size=0x8f00
};
