union _anonymous_120// Size=0x8 (Id=120)
{
...
union _anonymous_122// Size=0x10 (Id=122)
{
    union // Size=0x10 (Id=0)
    {
        struct _anonymous_121 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=452)
{
...
struct _anonymous_123// Size=0x58 (Id=123)
{
...
union _anonymous_124// Size=0x58 (Id=124)
{
    union // Size=0x58 (Id=0)
    {
        struct _anonymous_123 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=125)
{
    ...
    union _anonymous_120 AssociatedIrp;// Offset=0x18 Size=0x8
