...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=494)
{
...
struct _KAPC_STATE// Size=0x30 (Id=451)
{
...
struct _KTIMER// Size=0x40 (Id=559)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=472)
{
...
struct _GROUP_AFFINITY// Size=0x10 (Id=304)
{
...
struct _KLOCK_ENTRY_LOCK_STATE// Size=0x10 (Id=510)
{
    union // Size=0x8 (Id=0)
    {
...
union _KLOCK_ENTRY_BOOST_BITMAP// Size=0x4 (Id=312)
{
...
struct _KLOCK_ENTRY// Size=0x60 (Id=300)
{
...
struct _CLIENT_ID// Size=0x10 (Id=309)
{
    void * UniqueProcess;// Offset=0x0 Size=0x8
    void * UniqueThread;// Offset=0x8 Size=0x8
};

struct _KSEMAPHORE// Size=0x20 (Id=442)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=491)
{
...
struct _PS_PROPERTY_SET// Size=0x18 (Id=342)
{
