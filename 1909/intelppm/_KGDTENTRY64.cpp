struct _anonymous_504// Size=0x4 (Id=504)
{
...
struct _anonymous_505// Size=0x4 (Id=505)
{
...
union _KGDTENTRY64// Size=0x10 (Id=506)
{
    unsigned short LimitLow;// Offset=0x0 Size=0x2
    unsigned short BaseLow;// Offset=0x2 Size=0x2
    union // Size=0x4 (Id=0)
    {
        struct _anonymous_504 Bytes;// Offset=0x4 Size=0x4
        struct _anonymous_505 Bits;// Offset=0x4 Size=0x4
    };
