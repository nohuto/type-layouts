...
struct _PPM_DRIVER_DISPATCH_TABLE// Size=0x110 (Id=498)
{
...
struct _PCC_INTERFACE_INTERNAL// Size=0x58 (Id=558)
{
...
union _anonymous_612// Size=0x4 (Id=612)
{
...
struct _PCC_INTERFACE_STANDARD// Size=0x80 (Id=613)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
    ...
    union _anonymous_612 Flags;// Offset=0x54 Size=0x4
...
union _PROC_POWER_COORDINATES// Size=0x4 (Id=446)
{
...
struct _PROC_ENERGY_COUNTER// Size=0xc (Id=480)
{
    union // Size=0x4 (Id=0)
    {
...
struct _PROC_ENERGY_MODEL// Size=0x100 (Id=439)
{
...
struct GLOBALS// Size=0x7e8 (Id=413)
{
