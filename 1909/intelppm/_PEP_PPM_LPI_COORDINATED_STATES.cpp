...
struct _anonymous_699// Size=0x4 (Id=699)
{
    struct // Size=0x4 (Id=0)
    {
...
union _anonymous_700// Size=0x4 (Id=700)
{
    unsigned long AsUlong;// Offset=0x0 Size=0x4
    struct _anonymous_699 Arm;// Offset=0x0 Size=0x4
};
...
struct _PEP_PPM_LPI_REGISTER// Size=0x10 (Id=708)
{
...
struct _PEP_PPM_COORDINATED_LPI_STATE// Size=0x60 (Id=702)
{
    unsigned long MinResidency;// Offset=0x0 Size=0x4
    unsigned long WakeupLatency;// Offset=0x4 Size=0x4
    union _anonymous_698 Flags;// Offset=0x8 Size=0x4
    union _anonymous_700 ArchContextFlags;// Offset=0xc Size=0x4
    unsigned long ResidencyCounterFrequency;// Offset=0x10 Size=0x4
    unsigned char IntegerEntryMethod;// Offset=0x14 Size=0x1
    union _anonymous_701 EntryMethod;// Offset=0x18 Size=0x10
...
struct _PEP_PPM_LPI_COORDINATED_STATES// Size=0x68 (Id=690)
{
