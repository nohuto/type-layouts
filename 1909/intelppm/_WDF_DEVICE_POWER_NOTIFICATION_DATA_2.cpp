...
struct _anonymous_453// Size=0x8 (Id=453)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _anonymous_454// Size=0x4 (Id=454)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _anonymous_455// Size=0x8 (Id=455)
{
    struct _anonymous_453 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_454 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_453 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=244)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_455 Data;// Offset=0x4 Size=0x8
};
