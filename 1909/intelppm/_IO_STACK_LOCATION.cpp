...
struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=519)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=488)
{
...
struct _IO_STACK_LOCATION// Size=0x48 (Id=125)
{
    ...
    union _anonymous_124 Parameters;// Offset=0x8 Size=0x20
