...
struct _PCC_SUBSPACE_REGISTRATION// Size=0x98 (Id=620)
{
    struct _PCC_INTERFACE_STANDARD PccInterface;// Offset=0x0 Size=0x80
    struct WDFSPINLOCK__ * Mutex;// Offset=0x80 Size=0x8
    void  ( * RuntimeCallback)(long ,unsigned long long );// Offset=0x88 Size=0x8
    unsigned long long RuntimeContext;// Offset=0x90 Size=0x8
};
