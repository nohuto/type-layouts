union _EINFO// Size=0x8 (Id=421)
{
    struct <unnamed-type-s>// Size=0x8 (Id=2427)
    {
...
struct _OBJECTOWNER_S// Size=0x4 (Id=594)
{
...
union _OBJECTOWNER// Size=0x4 (Id=511)
{
    struct _OBJECTOWNER_S Share;// Offset=0x0 Size=0x4
    unsigned long ulObj;// Offset=0x0 Size=0x4
};

union _UPPER_HANDLE_BITS// Size=0x2 (Id=301)
{
    struct <unnamed-type-s>// Size=0x2 (Id=5368)
    {
        unsigned char fullType;// Offset=0x0 Size=0x1
        union <unnamed-type-u>// Size=0x1 (Id=5370)
        {
...
struct _ENTRY// Size=0x18 (Id=289)
{
