...
struct _anonymous_595// Size=0x8 (Id=595)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
};

struct _anonymous_596// Size=0x4 (Id=596)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _anonymous_597// Size=0x8 (Id=597)
{
    struct _anonymous_595 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_596 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_595 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=598)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_597 Data;// Offset=0x4 Size=0x8
};
