...
struct _USBD_PIPE_INFORMATION// Size=0x18 (Id=920)
{
...
struct _USBD_INTERFACE_INFORMATION// Size=0x30 (Id=782)
{
    unsigned short Length;// Offset=0x0 Size=0x2
...
struct _URB_SELECT_INTERFACE// Size=0x50 (Id=677)
{
...
struct _URB_SELECT_CONFIGURATION// Size=0x58 (Id=655)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
...
struct _URB_PIPE_REQUEST// Size=0x28 (Id=867)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
...
struct _URB_FRAME_LENGTH_CONTROL// Size=0x18 (Id=764)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
};

struct _URB_GET_FRAME_LENGTH// Size=0x20 (Id=842)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
...
struct _URB_SET_FRAME_LENGTH// Size=0x20 (Id=560)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    long FrameLengthDelta;// Offset=0x18 Size=0x4
};

struct _URB_GET_CURRENT_FRAME_NUMBER// Size=0x20 (Id=546)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    unsigned long FrameNumber;// Offset=0x18 Size=0x4
};

struct _URB_HCD_AREA// Size=0x40 (Id=856)
{
    void * Reserved8[8];// Offset=0x0 Size=0x40
};

struct _URB_CONTROL_TRANSFER// Size=0x88 (Id=514)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
...
struct _URB_CONTROL_TRANSFER_EX// Size=0x88 (Id=556)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _URB_BULK_OR_INTERRUPT_TRANSFER// Size=0x80 (Id=507)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _USBD_ISO_PACKET_DESCRIPTOR// Size=0xc (Id=821)
{
...
struct _URB_ISOCH_TRANSFER// Size=0x98 (Id=903)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _URB_CONTROL_DESCRIPTOR_REQUEST// Size=0x88 (Id=713)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
...
struct _URB_CONTROL_GET_STATUS_REQUEST// Size=0x88 (Id=746)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long Reserved0;// Offset=0x20 Size=0x4
...
struct _URB_CONTROL_FEATURE_REQUEST// Size=0x88 (Id=579)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
...
struct _URB_CONTROL_VENDOR_OR_CLASS_REQUEST// Size=0x88 (Id=532)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _URB_CONTROL_GET_INTERFACE_REQUEST// Size=0x88 (Id=840)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long Reserved0;// Offset=0x20 Size=0x4
...
struct _URB_CONTROL_GET_CONFIGURATION_REQUEST// Size=0x88 (Id=871)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long Reserved0;// Offset=0x20 Size=0x4
...
struct _URB_OS_FEATURE_DESCRIPTOR_REQUEST// Size=0x88 (Id=849)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long Reserved0;// Offset=0x20 Size=0x4
...
struct _URB_SECURE_BULK_OR_INTERRUPT_TRANSFER// Size=0x80 (Id=783)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _URB_SECURE_ISOCH_TRANSFER// Size=0x98 (Id=742)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _URB_SELECT_INTERFACE_WITH_ENDPOINT_OFFLOAD// Size=0x60 (Id=863)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * ConfigurationHandle;// Offset=0x18 Size=0x8
...
struct _URB_ASYNC_NOTIFICATION_REQUEST_DURING_ENDPOINT_OFFLOAD// Size=0x28 (Id=891)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
...
struct _URB_GET_ISOCH_PIPE_TRANSFER_PATH_DELAYS// Size=0x28 (Id=578)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
