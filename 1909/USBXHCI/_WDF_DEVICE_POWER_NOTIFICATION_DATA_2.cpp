...
struct _anonymous_622// Size=0x4 (Id=622)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _anonymous_623// Size=0x8 (Id=623)
{
    struct _anonymous_621 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_622 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_621 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=239)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_623 Data;// Offset=0x4 Size=0x8
};
