...
struct _anonymous_266// Size=0x18 (Id=266)
{
...
struct _anonymous_268// Size=0x18 (Id=268)
{
...
struct _anonymous_270// Size=0x10 (Id=270)
{
...
struct _anonymous_272// Size=0x10 (Id=272)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_276// Size=0x18 (Id=276)
{
...
union _anonymous_278// Size=0x18 (Id=278)
{
    union // Size=0x18 (Id=0)
    {
        struct _anonymous_266 Port;// Offset=0x0 Size=0x18
        struct _anonymous_266 Memory;// Offset=0x0 Size=0x18
        struct _anonymous_268 Interrupt;// Offset=0x0 Size=0x18
        struct _anonymous_269 Dma;// Offset=0x0 Size=0x8
        struct _anonymous_270 DmaV3;// Offset=0x0 Size=0x10
        struct _anonymous_266 Generic;// Offset=0x0 Size=0x18
        struct _anonymous_271 DevicePrivate;// Offset=0x0 Size=0xc
        struct _anonymous_272 BusNumber;// Offset=0x0 Size=0x10
        struct _anonymous_273 ConfigData;// Offset=0x0 Size=0xc
        struct _anonymous_274 Memory40;// Offset=0x0 Size=0x18
        struct _anonymous_275 Memory48;// Offset=0x0 Size=0x18
        struct _anonymous_276 Memory64;// Offset=0x0 Size=0x18
        struct _anonymous_277 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=279)
{
    ...
    union _anonymous_278 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=893)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=734)
{
