...
struct _anonymous_295// Size=0x20 (Id=295)
{
...
struct _anonymous_296// Size=0x20 (Id=296)
{
...
union _anonymous_297// Size=0x20 (Id=297)
{
    struct _anonymous_80 Create;// Offset=0x0 Size=0x20
    struct _anonymous_294 Read;// Offset=0x0 Size=0x18
    struct _anonymous_294 Write;// Offset=0x0 Size=0x18
    struct _anonymous_295 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _anonymous_296 Others;// Offset=0x0 Size=0x20
};

struct _WDF_REQUEST_PARAMETERS// Size=0x28 (Id=298)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned char MinorFunction;// Offset=0x2 Size=0x1
    enum _WDF_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    union _anonymous_297 Parameters;// Offset=0x8 Size=0x20
};
