...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=583)
{
...
struct _PCI_DEVICE_INFORMATION// Size=0x38 (Id=625)
{
...
struct _ACPI_DEVICE_INFORMATION// Size=0xf (Id=839)
{
...
union _KSE_XHCI_CONTROLLER_FLAGS// Size=0x10 (Id=350)
{
...
union _FRAME_SNAPSHOT// Size=0x8 (Id=770)
{
...
struct _FRAME_NUMBER_DATA// Size=0x10 (Id=569)
{
...
struct _INTERFACE// Size=0x20 (Id=190)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
...
struct _SECURE_DRIVER_INTERFACE// Size=0x38 (Id=605)
{
...
struct _CONTROLLER_DATA// Size=0x350 (Id=429)
{
    ...
    struct _SECURE_DRIVER_INTERFACE SecureDriverInterface;// Offset=0x238 Size=0x38
    unsigned char IsDSMForPortStatusSupported;// Offset=0x270 Size=0x1
    unsigned char IsDSMForKBLWorkaroundsSupported;// Offset=0x271 Size=0x1
    enum _USBD_ENDPOINT_OFFLOAD_MODE UsbEndpointOffloadMode;// Offset=0x274 Size=0x4
    unsigned long NumberOfEndpointsOffloaded;// Offset=0x278 Size=0x4
    void * EndpointsOffloadedCountLock;// Offset=0x280 Size=0x8
    struct _TIME_SYNC_DATA TimeSyncData;// Offset=0x288 Size=0xa8
    struct WDFWORKITEM__ * AudioOffloadWnfStateUpdateWorkItem;// Offset=0x330 Size=0x8
    unsigned char IsAudioOffloadActive;// Offset=0x338 Size=0x1
    struct SS_COMPONENT__ * SleepstudySelectiveSuspendUnsupportedHandle;// Offset=0x340 Size=0x8
    unsigned long RecurringResetRecoveryFrequency;// Offset=0x348 Size=0x4
    unsigned long ImmediateResetRecoveryPending;// Offset=0x34c Size=0x4
};
