...
struct _anonymous_585// Size=0x8 (Id=585)
{
...
struct _anonymous_586// Size=0x4 (Id=586)
{
    enum _WDF_DEVICE_POWER_POLICY_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _anonymous_587// Size=0x8 (Id=587)
{
    struct _anonymous_585 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_586 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_585 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=240)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_587 Data;// Offset=0x4 Size=0x8
};
