union _CONTROLLER_USB_20_HARDWARE_LPM_FLAGS// Size=0x1 (Id=875)
{
...
union _ROOTHUB_PORT_DATA_FLAGS// Size=0x4 (Id=873)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    unsigned long PortOperationPending;// Offset=0x0 Size=0x4
};

struct _ROOTHUB_PORT_ERROR// Size=0x8 (Id=779)
{
    unsigned long RootHubPortInComplianceModeCount;// Offset=0x0 Size=0x4
    unsigned char PortErrorReported;// Offset=0x4 Size=0x1
};

struct _ROOTHUB_PORT_DATA// Size=0x58 (Id=645)
{
    ...
    struct WDFTIMER__ * Timer20PortResumeComplete;// Offset=0x20 Size=0x8
    long ResumeTimeReferenceCount;// Offset=0x28 Size=0x4
    unsigned short ResumeTime;// Offset=0x2c Size=0x2
    unsigned short SpeedsCount;// Offset=0x2e Size=0x2
    union _SUPPPORTED_PROTOCOL_CAPABILITY_SPEED * Speeds;// Offset=0x30 Size=0x8
    union _ROOTHUB_PORT_DATA_FLAGS Flags;// Offset=0x38 Size=0x4
    struct WDFTIMER__ * PortOperationPendingTimer;// Offset=0x40 Size=0x8
    struct WDFTIMER__ * PortOperationRecoveryTimer;// Offset=0x48 Size=0x8
    struct _ROOTHUB_PORT_ERROR PortErrorBookKeeping;// Offset=0x50 Size=0x8
};
