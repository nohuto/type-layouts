...
struct _anonymous_478// Size=0x8 (Id=478)
{
...
union _anonymous_480// Size=0x8 (Id=480)
{
    struct _anonymous_478 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_479 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_478 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=199)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_480 Data;// Offset=0x4 Size=0x8
};
