union _anonymous_33// Size=0x8 (Id=33)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=645)
{
    union // Size=0x4 (Id=0)
    {
...
struct _anonymous_34// Size=0x10 (Id=34)
{
    union // Size=0x8 (Id=0)
    {
...
union _anonymous_35// Size=0x10 (Id=35)
{
    union // Size=0x10 (Id=0)
    {
        struct _anonymous_34 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=559)
{
...
struct _anonymous_36// Size=0x50 (Id=36)
{
    ...
    struct _KTHREAD * Thread;// Offset=0x20 Size=0x8
