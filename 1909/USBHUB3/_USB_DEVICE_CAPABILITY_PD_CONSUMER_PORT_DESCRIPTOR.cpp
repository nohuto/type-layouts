union _anonymous_568// Size=0x2 (Id=568)
{
...
struct _USB_DEVICE_CAPABILITY_PD_CONSUMER_PORT_DESCRIPTOR// Size=0x18 (Id=569)
{
    ...
    union _anonymous_568 bmCapabilities;// Offset=0x4 Size=0x2
