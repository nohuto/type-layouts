...
struct _anonymous_448// Size=0x8 (Id=448)
{
...
union _anonymous_450// Size=0x8 (Id=450)
{
    struct _anonymous_448 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_449 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_448 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=451)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_450 Data;// Offset=0x4 Size=0x8
};
