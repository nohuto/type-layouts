...
struct _anonymous_1924// Size=0x20 (Id=1924)
{
...
struct _anonymous_1925// Size=0x28 (Id=1925)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=1926)
{
    struct _anonymous_1920 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _anonymous_1921 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _anonymous_1923 AcquireForSectionSynchronization;// Offset=0x0 Size=0x10
    struct _anonymous_1924 QueryOpen;// Offset=0x0 Size=0x20
    struct _anonymous_1925 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=1907)
{
