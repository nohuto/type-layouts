...
struct _EXT_IOMMU_DEVICE_ID_PCI// Size=0x10 (Id=1458)
{
    union // Size=0x8 (Id=0)
    {
        ...
        struct // Size=0x2 (Id=0)
        {
            ...
            unsigned short Reserved:5;// Offset=0x2 Size=0x2 BitOffset=0x3 BitSize=0x5
    ...
    wchar_t * DevicePath;// Offset=0x8 Size=0x8
};

struct _EXT_IOMMU_DEVICE_ID_ACPI// Size=0x8 (Id=1224)
{
    char * ObjectName;// Offset=0x0 Size=0x8
};

struct _EXT_IOMMU_DEVICE_ID_TEST// Size=0x8 (Id=1250)
{
    unsigned long long UniqueId;// Offset=0x0 Size=0x8
};

struct _EXT_IOMMU_DEVICE_ID_GIC// Size=0x4 (Id=1389)
{
    unsigned int LineNumber;// Offset=0x0 Size=0x4
};

struct _EXT_IOMMU_DEVICE_ID// Size=0x18 (Id=1094)
{
    ...
    union // Size=0x10 (Id=0)
    {
        ...
        struct _EXT_IOMMU_DEVICE_ID_GIC Gic;// Offset=0x8 Size=0x4
    };
};
