struct _anonymous_1658// Size=0x10 (Id=1658)
{
...
struct _RTLP_RANGE_LIST_ENTRY// Size=0x38 (Id=1660)
{
    unsigned long long Start;// Offset=0x0 Size=0x8
    unsigned long long End;// Offset=0x8 Size=0x8
    union // Size=0x10 (Id=0)
    {
        struct _anonymous_1658 Allocated;// Offset=0x10 Size=0x10
        struct _anonymous_1659 Merged;// Offset=0x10 Size=0x10
    };
