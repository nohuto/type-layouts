...
struct _PO_DEVICE_NOTIFY// Size=0x68 (Id=803)
{
...
union _anonymous_374// Size=0x8 (Id=374)
{
...
union _anonymous_375// Size=0x8 (Id=375)
{
    struct _DEVICE_NODE * NextResourceDeviceNode;// Offset=0x0 Size=0x8
};

struct _anonymous_377// Size=0x20 (Id=377)
{
...
struct _PO_DIRECTED_DRIPS_STATE// Size=0x38 (Id=774)
{
...
struct _DEVICE_NODE// Size=0x310 (Id=379)
{
    ...
    union _anonymous_374 OverUsed1;// Offset=0x210 Size=0x8
    union _anonymous_375 OverUsed2;// Offset=0x218 Size=0x8
    ...
    struct _anonymous_377 DockInfo;// Offset=0x238 Size=0x20
