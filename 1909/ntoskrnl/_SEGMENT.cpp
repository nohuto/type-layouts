struct _SEGMENT_FLAGS// Size=0x4 (Id=1571)
{
    union // Size=0x2 (Id=0)
    {
...
union _anonymous_294// Size=0x8 (Id=294)
{
    union // Size=0x8 (Id=0)
    {
...
struct _SEGMENT// Size=0x48 (Id=296)
{
    ...
    union _anonymous_294 u1;// Offset=0x30 Size=0x8
    union _anonymous_295 u2;// Offset=0x38 Size=0x8
