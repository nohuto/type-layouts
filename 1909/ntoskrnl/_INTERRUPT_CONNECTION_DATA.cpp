...
struct _anonymous_1648// Size=0xc (Id=1648)
{
...
union _anonymous_1649// Size=0xc (Id=1649)
{
    struct _anonymous_1648 Msi;// Offset=0x0 Size=0xc
};

struct _INTERRUPT_REMAPPING_INFO// Size=0x10 (Id=1650)
{
    ...
    union _anonymous_1649 u;// Offset=0x4 Size=0xc
};
...
struct _anonymous_1101// Size=0x10 (Id=1101)
{
...
struct _anonymous_1102// Size=0x8 (Id=1102)
{
...
struct _INTERRUPT_VECTOR_DATA// Size=0x58 (Id=1105)
{
    ...
    struct _anonymous_1100 ControllerInput;// Offset=0x38 Size=0x8
    unsigned long long HvDeviceId;// Offset=0x40 Size=0x8
    union // Size=0x58 (Id=0)
    {
        struct _anonymous_1101 XapicMessage;// Offset=0x48 Size=0x10
        struct _anonymous_1102 Hypertransport;// Offset=0x48 Size=0x8
        struct _anonymous_1101 GenericMessage;// Offset=0x48 Size=0x10
        struct _anonymous_1104 MessageRequest;// Offset=0x48 Size=0x4
    };
};

struct _INTERRUPT_CONNECTION_DATA// Size=0x60 (Id=1647)
{
