struct _HAL_IOMMU_DISPATCH// Size=0x98 (Id=1619)
{
    ...
    long  ( * HalIommuGetLibraryContext)(unsigned long ,unsigned long ,void ** );// Offset=0x10 Size=0x8
    long  ( * HalIommuMapDevice)(void * ,struct _EXT_IOMMU_DEVICE_ID * ,union _IOMMU_SVM_CAPABILITIES * ,void ** );// Offset=0x18 Size=0x8
