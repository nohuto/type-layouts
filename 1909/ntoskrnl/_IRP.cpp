union _anonymous_119// Size=0x8 (Id=119)
{
...
union _anonymous_121// Size=0x10 (Id=121)
{
    union // Size=0x10 (Id=0)
    {
        struct _anonymous_120 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=1133)
{
...
struct _anonymous_122// Size=0x58 (Id=122)
{
...
union _anonymous_123// Size=0x58 (Id=123)
{
    union // Size=0x58 (Id=0)
    {
        struct _anonymous_122 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=124)
{
    ...
    union _anonymous_119 AssociatedIrp;// Offset=0x18 Size=0x8
