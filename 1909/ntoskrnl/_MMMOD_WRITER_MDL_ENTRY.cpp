...
union _anonymous_1654// Size=0x10 (Id=1654)
{
    struct _IO_STATUS_BLOCK IoStatus;// Offset=0x0 Size=0x10
};

struct _MODWRITER_FLAGS// Size=0x4 (Id=1688)
{
...
struct _MMMOD_WRITER_MDL_ENTRY// Size=0x108 (Id=1655)
{
    struct _LIST_ENTRY Links;// Offset=0x0 Size=0x10
    union _anonymous_1654 u;// Offset=0x10 Size=0x10
