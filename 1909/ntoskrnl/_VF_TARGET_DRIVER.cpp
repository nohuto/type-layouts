...
struct _anonymous_1181// Size=0x4 (Id=1181)
{
...
union _anonymous_1182// Size=0x20 (Id=1182)
{
    union // Size=0x20 (Id=0)
    {
        struct _VF_TARGET_ALL_SHARED_EXPORT_THUNKS AllSharedExportThunks;// Offset=0x0 Size=0x20
        struct _anonymous_1181 Flags;// Offset=0x0 Size=0x4
    };
};

struct _VF_TARGET_DRIVER// Size=0x40 (Id=1183)
{
    struct _VF_AVL_TREE_NODE_EX TreeNode;// Offset=0x0 Size=0x18
    union _anonymous_1182 u1;// Offset=0x18 Size=0x20
