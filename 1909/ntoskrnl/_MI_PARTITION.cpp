struct _MI_PARTITION_FLAGS// Size=0x4 (Id=1645)
{
...
union _anonymous_1190// Size=0x4 (Id=1190)
{
...
struct _MI_PARTITION_CORE// Size=0x1b0 (Id=1191)
{
    unsigned short PartitionId;// Offset=0x0 Size=0x2
    union _anonymous_1190 u;// Offset=0x4 Size=0x4
...
struct _MMPAGE_FILE_EXPANSION_FLAGS// Size=0x4 (Id=1844)
{
    struct // Size=0x4 (Id=0)
    {
...
union _anonymous_1343// Size=0x4 (Id=1343)
{
    unsigned long LongFlags;// Offset=0x0 Size=0x4
    struct _MMPAGE_FILE_EXPANSION_FLAGS Flags;// Offset=0x0 Size=0x4
};

struct _MMPAGE_FILE_EXPANSION// Size=0x58 (Id=1344)
{
    ...
    union _anonymous_1343 u1;// Offset=0x4c Size=0x4
...
struct _MMMOD_WRITER_LISTHEAD// Size=0x28 (Id=1653)
{
...
union _MI_RESERVATION_CLUSTER_INFO// Size=0x4 (Id=1748)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_MODWRITE_DATA// Size=0x40 (Id=1749)
{
...
struct _MI_RESTRICTED_MODWRITES// Size=0x3 (Id=1846)
{
...
struct _MI_PARTITION_MODWRITES// Size=0x2c0 (Id=1535)
{
...
struct _MI_PARTITION_STORES// Size=0x90 (Id=780)
{
    union _anonymous_779 WriteAllStoreHintedPages;// Offset=0x0 Size=0x4
...
struct _MMDEREFERENCE_SEGMENT_HEADER// Size=0x50 (Id=1710)
{
...
struct _MI_PTE_CHAIN_HEAD// Size=0x18 (Id=1801)
{
...
struct _MI_CROSS_PARTITION_CHARGES// Size=0x20 (Id=1743)
{
...
struct _MI_PARTITION_SEGMENTS// Size=0x340 (Id=1302)
{
...
struct _MI_DECAY_TIMER_LINKAGE// Size=0x8 (Id=1450)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _MI_DECAY_TIMER_LINK// Size=0x8 (Id=1072)
{
    union _anonymous_1071 u1;// Offset=0x0 Size=0x8
};

struct _MI_LDW_WORK_CONTEXT// Size=0x38 (Id=1267)
{
...
struct _MI_AVAILABLE_PAGE_WAIT_STATES// Size=0x20 (Id=1305)
{
...
struct _MI_LARGE_PAGE_CANDIDATES// Size=0x208 (Id=1245)
{
...
union _anonymous_1447// Size=0x4 (Id=1447)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_SLAB_ALLOCATOR_CONTEXT// Size=0x78 (Id=1448)
{
    ...
    union _anonymous_1447 Flags;// Offset=0x38 Size=0x4
...
struct _MI_PARTITION_PAGE_LISTS// Size=0x13c0 (Id=1070)
{
...
struct _MI_PARTITION_COMMIT// Size=0x80 (Id=1424)
{
...
struct _MI_PARTITION_ZEROING// Size=0x68 (Id=1382)
{
...
struct _MI_PAGE_COMBINING_SUPPORT// Size=0x190 (Id=1090)
{
...
struct _MMWORKING_SET_EXPANSION_HEAD// Size=0x10 (Id=825)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
};
...
struct _anonymous_1203// Size=0x38 (Id=1203)
{
    struct _MDL Mdl;// Offset=0x0 Size=0x30
    unsigned long long Page[1];// Offset=0x30 Size=0x8
};

struct _MI_PAGEFILE_TRACES// Size=0x78 (Id=1204)
{
    ...
    struct _anonymous_1203 MdlHack;// Offset=0x40 Size=0x38
};

struct _MI_VISIBLE_PARTITION// Size=0x1200 (Id=889)
{
