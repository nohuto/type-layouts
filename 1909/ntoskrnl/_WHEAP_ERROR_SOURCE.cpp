...
union _XPF_MCE_FLAGS// Size=0x4 (Id=1282)
{
...
union _XPF_MC_BANK_FLAGS// Size=0x1 (Id=1613)
{
...
struct _WHEA_XPF_MC_BANK_DESCRIPTOR// Size=0x1c (Id=1473)
{
...
struct _WHEA_XPF_MCE_DESCRIPTOR// Size=0x398 (Id=890)
{
...
struct _WHEA_XPF_CMC_DESCRIPTOR// Size=0x3a4 (Id=742)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char NumberOfBanks;// Offset=0x3 Size=0x1
...
struct _WHEA_XPF_NMI_DESCRIPTOR// Size=0x3 (Id=1486)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
};

struct _WHEA_IPF_MCA_DESCRIPTOR// Size=0x4 (Id=950)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
...
struct _WHEA_IPF_CMC_DESCRIPTOR// Size=0x4 (Id=1465)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
struct _WHEA_IPF_CPE_DESCRIPTOR// Size=0x4 (Id=1276)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
struct _WHEA_PCI_SLOT_NUMBER// Size=0x4 (Id=882)
{
    union _anonymous_881 u;// Offset=0x0 Size=0x4
};

union _AER_ROOTPORT_DESCRIPTOR_FLAGS// Size=0x2 (Id=1018)
{
    struct // Size=0x2 (Id=0)
    {
...
struct _WHEA_AER_ROOTPORT_DESCRIPTOR// Size=0x24 (Id=982)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
union _AER_ENDPOINT_DESCRIPTOR_FLAGS// Size=0x2 (Id=1773)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short UncorrectableErrorMaskRW:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_AER_ENDPOINT_DESCRIPTOR// Size=0x20 (Id=1680)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
union _AER_BRIDGE_DESCRIPTOR_FLAGS// Size=0x2 (Id=1230)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short UncorrectableErrorMaskRW:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_AER_BRIDGE_DESCRIPTOR// Size=0x2c (Id=801)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
struct _WHEA_GENERIC_ERROR_DESCRIPTOR// Size=0x34 (Id=856)
{
    unsigned short Type;// Offset=0x0 Size=0x2
...
struct _WHEA_GENERIC_ERROR_DESCRIPTOR_V2// Size=0x50 (Id=766)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Reserved;// Offset=0x2 Size=0x1
    unsigned char Enabled;// Offset=0x3 Size=0x1
...
struct _WHEA_ERROR_SOURCE_CONFIGURATION_DD// Size=0x20 (Id=1430)
{
...
struct _WHEA_DEVICE_DRIVER_DESCRIPTOR// Size=0x24 (Id=1260)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
union _anonymous_712// Size=0x3a4 (Id=712)
{
...
struct _WHEA_ERROR_SOURCE_DESCRIPTOR// Size=0x3cc (Id=713)
{
    ...
    union _anonymous_712 Info;// Offset=0x28 Size=0x3a4
};

struct _WHEAP_ERROR_SOURCE// Size=0x430 (Id=637)
{
