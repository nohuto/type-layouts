...
struct _DBGKD_GET_CONTEXT// Size=0x4 (Id=1237)
{
    unsigned long Unused;// Offset=0x0 Size=0x4
};

struct _DBGKD_SET_CONTEXT// Size=0x4 (Id=768)
{
...
struct _DBGKD_QUERY_SPECIAL_CALLS// Size=0x4 (Id=662)
{
...
struct _DBGKD_GET_VERSION64// Size=0x28 (Id=1433)
{
...
struct _DBGKD_GET_SET_BUS_DATA// Size=0x14 (Id=701)
{
...
struct _DBGKD_FILL_MEMORY// Size=0x10 (Id=1544)
{
...
struct _DBGKD_QUERY_MEMORY// Size=0x18 (Id=776)
{
    unsigned long long Address;// Offset=0x0 Size=0x8
...
struct _DBGKD_SWITCH_PARTITION// Size=0x4 (Id=1404)
{
    unsigned long Partition;// Offset=0x0 Size=0x4
};

struct _DBGKD_CONTEXT_EX// Size=0xc (Id=1455)
{
...
struct _DBGKD_WRITE_CUSTOM_BREAKPOINT// Size=0x18 (Id=775)
{
    unsigned long long BreakPointAddress;// Offset=0x0 Size=0x8
