struct _anonymous_1481// Size=0x8 (Id=1481)
{
...
union _anonymous_1482// Size=0x8 (Id=1482)
{
    struct _anonymous_1481 s1;// Offset=0x0 Size=0x8
    long long Value;// Offset=0x0 Size=0x8
};

struct _ALPC_COMPLETION_LIST_STATE// Size=0x8 (Id=1483)
{
    union _anonymous_1482 u1;// Offset=0x0 Size=0x8
};

struct _RTL_SRWLOCK// Size=0x8 (Id=1154)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _ALPC_COMPLETION_LIST_HEADER// Size=0x180 (Id=1226)
{
