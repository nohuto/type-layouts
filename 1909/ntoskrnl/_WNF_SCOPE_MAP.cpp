struct _WNF_NODE_HEADER// Size=0x4 (Id=640)
{
...
struct _WNF_SCOPE_MAP// Size=0x90 (Id=845)
{
    ...
    struct _WNF_SCOPE_MAP_ENTRY ByDataScope[5];// Offset=0x18 Size=0x78
};
