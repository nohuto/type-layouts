struct _anonymous_1041// Size=0x4 (Id=1041)
{
...
struct _anonymous_1042// Size=0x4 (Id=1042)
{
...
union _KGDTENTRY64// Size=0x10 (Id=1043)
{
    unsigned short LimitLow;// Offset=0x0 Size=0x2
    unsigned short BaseLow;// Offset=0x2 Size=0x2
    union // Size=0x4 (Id=0)
    {
        struct _anonymous_1041 Bytes;// Offset=0x4 Size=0x4
        struct _anonymous_1042 Bits;// Offset=0x4 Size=0x4
    };
