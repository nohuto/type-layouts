...
struct _I386_LOADER_BLOCK// Size=0x10 (Id=1798)
{
...
struct _ARM_LOADER_BLOCK// Size=0x4 (Id=1867)
{
    unsigned long PlaceHolder;// Offset=0x0 Size=0x4
};

union _anonymous_1574// Size=0x10 (Id=1574)
{
...
struct _LOADER_PARAMETER_BLOCK// Size=0x160 (Id=1575)
{
    ...
    union _anonymous_1574 u;// Offset=0xf8 Size=0x10
