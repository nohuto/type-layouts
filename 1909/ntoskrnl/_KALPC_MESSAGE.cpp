...
struct _anonymous_566// Size=0x4 (Id=566)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long InDispatch:1;// Offset=0x0 Size=0x4 BitOffset=0xf BitSize=0x1
        unsigned long InCanceledQueue:1;// Offset=0x0 Size=0x4 BitOffset=0x10 BitSize=0x1
    };
};

union _anonymous_567// Size=0x4 (Id=567)
{
    struct _anonymous_566 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

union _KALPC_DIRECT_EVENT// Size=0x8 (Id=578)
{
...
struct _KALPC_MESSAGE// Size=0x118 (Id=568)
{
    ...
    union _anonymous_567 u1;// Offset=0x28 Size=0x4
