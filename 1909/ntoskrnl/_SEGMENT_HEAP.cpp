struct _RTL_HEAP_MEMORY_LIMIT_DATA// Size=0x20 (Id=717)
{
...
struct _HEAP_OPPORTUNISTIC_LARGE_PAGE_STATS// Size=0x10 (Id=1503)
{
...
struct _RTL_HP_SEG_ALLOC_POLICY// Size=0x18 (Id=1037)
{
...
struct _HEAP_RUNTIME_MEMORY_STATS// Size=0x58 (Id=517)
{
...
union _anonymous_515// Size=0x1 (Id=515)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _HEAP_SEG_CONTEXT// Size=0xc0 (Id=516)
{
    ...
    union _anonymous_515 Flags;// Offset=0xd Size=0x1
...
struct _HEAP_VS_DELAY_FREE_CONTEXT// Size=0x10 (Id=927)
{
    union _SLIST_HEADER ListHead;// Offset=0x0 Size=0x10
};

struct _HEAP_SUBALLOCATOR_CALLBACKS// Size=0x28 (Id=483)
{
...
struct _HEAP_VS_CONTEXT// Size=0xc0 (Id=506)
{
...
struct _SEGMENT_HEAP// Size=0x800 (Id=521)
{
