...
struct _RTLP_HP_ALLOC_TRACKER// Size=0x50 (Id=494)
{
...
struct _RTL_SPARSE_ARRAY// Size=0x50 (Id=487)
{
...
struct _HEAP_VAMGR_VASPACE// Size=0x860 (Id=490)
{
...
struct _HEAP_VAMGR_ALLOCATOR// Size=0x30 (Id=488)
{
...
struct _HEAP_VAMGR_CTX// Size=0x3840 (Id=1138)
{
...
union _RTL_RUN_ONCE// Size=0x8 (Id=792)
{
...
struct _anonymous_795// Size=0x4 (Id=795)
{
...
struct _RTL_HP_VS_CONFIG// Size=0x4 (Id=796)
{
    struct _anonymous_795 Flags;// Offset=0x0 Size=0x4
};

struct _RTL_HP_SUB_ALLOCATOR_CONFIGS// Size=0x8 (Id=1321)
{
    struct _RTL_HP_LFH_CONFIG LfhConfigs;// Offset=0x0 Size=0x4
    struct _RTL_HP_VS_CONFIG VsConfigs;// Offset=0x4 Size=0x4
};

struct _RTLP_HP_HEAP_MANAGER// Size=0x38d0 (Id=493)
{
...
struct _RTL_LOOKASIDE// Size=0x40 (Id=523)
{
...
struct _RTL_DYNAMIC_LOOKASIDE// Size=0x1040 (Id=522)
{
...
struct _EX_POOL_HEAP_MANAGER_STATE// Size=0x86940 (Id=1128)
{
    ...
    struct _SEGMENT_HEAP * SpecialHeaps[3];// Offset=0x86900 Size=0x18
};
