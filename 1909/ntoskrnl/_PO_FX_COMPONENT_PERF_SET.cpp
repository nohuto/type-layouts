...
struct _PO_FX_COMPONENT_PERF_SET// Size=0x30 (Id=1912)
{
    ...
    {
        struct _anonymous_1910 Discrete;// Offset=0x20 Size=0x10
        struct _anonymous_1911 Range;// Offset=0x20 Size=0x10
    };
};
