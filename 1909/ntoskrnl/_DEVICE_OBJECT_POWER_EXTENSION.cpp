...
struct _anonymous_1331// Size=0x8 (Id=1331)
{
    unsigned long IdleTime;// Offset=0x0 Size=0x4
    unsigned long NonIdleTime;// Offset=0x4 Size=0x4
};

union _anonymous_1332// Size=0x8 (Id=1332)
{
    struct _anonymous_1331 Disk;// Offset=0x0 Size=0x8
};

struct _DEVICE_OBJECT_POWER_EXTENSION// Size=0x60 (Id=1333)
{
    ...
    union _anonymous_1332 Specific;// Offset=0x58 Size=0x8
};
