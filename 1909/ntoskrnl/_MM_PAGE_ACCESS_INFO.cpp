struct _anonymous_969// Size=0x4 (Id=969)
{
...
struct _anonymous_970// Size=0x4 (Id=970)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long FilePointerIndex:9;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x9
...
union _MM_PAGE_ACCESS_INFO_FLAGS// Size=0x4 (Id=971)
{
    struct _anonymous_969 File;// Offset=0x0 Size=0x4
    struct _anonymous_970 Private;// Offset=0x0 Size=0x4
};

struct _MM_PAGE_ACCESS_INFO// Size=0x8 (Id=964)
{
    union // Size=0x8 (Id=0)
    {
