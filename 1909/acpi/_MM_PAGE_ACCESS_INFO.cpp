struct _anonymous_302// Size=0x4 (Id=302)
{
...
struct _anonymous_303// Size=0x4 (Id=303)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long FilePointerIndex:9;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x9
...
union _MM_PAGE_ACCESS_INFO_FLAGS// Size=0x4 (Id=304)
{
    struct _anonymous_302 File;// Offset=0x0 Size=0x4
    struct _anonymous_303 Private;// Offset=0x0 Size=0x4
};

struct _MM_PAGE_ACCESS_INFO// Size=0x8 (Id=301)
{
    union // Size=0x8 (Id=0)
    {
