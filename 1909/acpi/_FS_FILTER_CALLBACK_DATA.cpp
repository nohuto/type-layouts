...
struct _anonymous_699// Size=0x10 (Id=699)
{
...
struct _anonymous_700// Size=0x20 (Id=700)
{
...
struct _anonymous_701// Size=0x28 (Id=701)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=702)
{
    struct _anonymous_696 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _anonymous_697 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _anonymous_699 AcquireForSectionSynchronization;// Offset=0x0 Size=0x10
    struct _anonymous_700 QueryOpen;// Offset=0x0 Size=0x20
    struct _anonymous_701 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=674)
{
