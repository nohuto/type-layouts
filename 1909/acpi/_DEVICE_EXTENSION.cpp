struct _anonymous_412// Size=0x8 (Id=412)
{
...
struct _anonymous_631// Size=0x4 (Id=631)
{
...
struct _FDO_DEVICE_EXTENSION// Size=0x80 (Id=632)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _anonymous_631 UPm1Status;// Offset=0x38 Size=0x4
    };
    struct _KDPC InterruptDpc;// Offset=0x40 Size=0x40
};

struct _PCI_FILTER_EXTENSION// Size=0x14 (Id=630)
{
...
struct _FILTER_DEVICE_EXTENSION// Size=0x58 (Id=612)
{
    struct WORK_QUEUE_CONTEXT WorkContext;// Offset=0x0 Size=0x30
...
struct _PDO_DEVICE_EXTENSION// Size=0x30 (Id=629)
{
    struct WORK_QUEUE_CONTEXT WorkContext;// Offset=0x0 Size=0x30
};
...
struct _PROCESSOR_DEVICE_EXTENSION// Size=0x38 (Id=555)
{
...
struct _MODULE_DEVICE_EXTENSION// Size=0x38 (Id=563)
{
    struct EXTENSION_WORKER WorkQueue;// Offset=0x0 Size=0x18
...
struct _EC_DEVICE_EXTENSION// Size=0x20 (Id=526)
{
    struct EXTENSION_WORKER WorkQueue;// Offset=0x0 Size=0x18
...
struct _PCI_ROOT_BUS_DSM_CAPABILITY_STRUCTURE// Size=0x10 (Id=548)
{
...
union _anonymous_600// Size=0x4 (Id=600)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PCI_ROOT_BUS_OSC_CONTROL_FIELD// Size=0x4 (Id=601)
{
    union _anonymous_600 u;// Offset=0x0 Size=0x4
};

struct _PCI_ROOT_EXTENSION// Size=0x98 (Id=516)
{
    struct EXTENSION_WORKER WorkQueue;// Offset=0x0 Size=0x18
...
struct _PROCESSOR_CONTAINER_EXTENSION// Size=0x58 (Id=459)
{
    struct EXTENSION_WORKER WorkQueue;// Offset=0x0 Size=0x18
...
struct _ACPI_POWER_INFO// Size=0xe8 (Id=635)
{
...
struct _anonymous_491// Size=0x8 (Id=491)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _ACPI_DEVICE_INFORMATION// Size=0x28 (Id=492)
{
    union // Size=0x8 (Id=0)
    {
    ...
    union // Size=0x8 (Id=0)
    {
        ...
        struct _anonymous_491 ClassCode;// Offset=0x20 Size=0x8
    };
};
...
struct _WAKE_EVENT_DEVICE_CONTEXT// Size=0x20 (Id=566)
{
...
struct _anonymous_418// Size=0x8 (Id=418)
{
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned long long Cap_Unused:23;// Offset=0x0 Size=0x8 BitOffset=0x29 BitSize=0x17
    };
};

struct _DEVICE_EXTENSION// Size=0x3c0 (Id=419)
{
    struct _ACPI_TRIAGE_INFO * TriageInfo;// Offset=0x0 Size=0x8
    union // Size=0x8 (Id=0)
    {
        unsigned long long Flags;// Offset=0x8 Size=0x8
        struct _anonymous_412 UFlags;// Offset=0x8 Size=0x8
    };
    ...
    union // Size=0x140 (Id=0)
    {
        ...
        struct PEP_EXTENSION Pep;// Offset=0xa0 Size=0x90
        enum _ACPI_DEVICE_STATE DeviceState;// Offset=0x140 Size=0x4
    };
    enum _ACPI_DEVICE_STATE PreviousState;// Offset=0x144 Size=0x4
    struct _ACPI_POWER_INFO PowerInfo;// Offset=0x148 Size=0xe8
    struct _ACPI_DEVICE_INFORMATION DeviceInformation;// Offset=0x230 Size=0x28
    struct _ObjData * FirmwareDependencies;// Offset=0x258 Size=0x8
    struct _THERMAL_COOLING_EXTENSION * CoolingExtension;// Offset=0x260 Size=0x8
    unsigned char CoolingEligible;// Offset=0x268 Size=0x1
    unsigned long OperationRegionMask;// Offset=0x26c Size=0x4
    struct _CM_RESOURCE_LIST * ResourceList;// Offset=0x270 Size=0x8
    struct _CM_RESOURCE_LIST * TranslatedResourceList;// Offset=0x278 Size=0x8
    struct _ObjData * PnpResourceList;// Offset=0x280 Size=0x8
    unsigned long * ForceActiveBothInterrupts;// Offset=0x288 Size=0x8
    unsigned long ForceActiveBothInterruptsCount;// Offset=0x290 Size=0x4
    struct _LIST_ENTRY InterruptPolarityCacheListHead;// Offset=0x298 Size=0x10
    long OutstandingIrpCount;// Offset=0x2a8 Size=0x4
    long ReferenceCount;// Offset=0x2ac Size=0x4
    long HibernatePathCount;// Offset=0x2b0 Size=0x4
    long PagingPathCount;// Offset=0x2b4 Size=0x4
    long SpecialPathCount;// Offset=0x2b8 Size=0x4
    struct _KEVENT * RemoveEvent;// Offset=0x2c0 Size=0x8
    struct _NSObjRef * AcpiObject;// Offset=0x2c8 Size=0x8
    struct _DEVICE_OBJECT * DeviceObject;// Offset=0x2d0 Size=0x8
    struct _DEVICE_OBJECT * TargetDeviceObject;// Offset=0x2d8 Size=0x8
    struct _DEVICE_OBJECT * PhysicalDeviceObject;// Offset=0x2e0 Size=0x8
    struct _DEVICE_EXTENSION * ParentExtension;// Offset=0x2e8 Size=0x8
    struct _LIST_ENTRY ChildDeviceList;// Offset=0x2f0 Size=0x10
    struct _LIST_ENTRY SiblingDeviceList;// Offset=0x300 Size=0x10
    struct _LIST_ENTRY EjectDeviceHead;// Offset=0x310 Size=0x10
    struct _LIST_ENTRY EjectDeviceList;// Offset=0x320 Size=0x10
    struct _LIST_ENTRY NotificationListHead;// Offset=0x330 Size=0x10
    struct _LIST_ENTRY RemovedDevice;// Offset=0x340 Size=0x10
    unsigned long AcpiObjectName;// Offset=0x350 Size=0x4
    struct _KEVENT NotificationDispatchLock;// Offset=0x358 Size=0x18
    struct _WORK_QUEUE_ITEM * NotificationWorkItem;// Offset=0x370 Size=0x8
    unsigned char NotificationWorkerInProgress;// Offset=0x378 Size=0x1
    enum _CCA_METHOD_EVALUATION_STATE CcaEvaluationState;// Offset=0x37c Size=0x4
    void * NativeMethodHandle;// Offset=0x380 Size=0x8
    struct _DEVICE_RESET_CONTEXT * CurrentResetRequest;// Offset=0x388 Size=0x8
    unsigned long long SkDeviceToken;// Offset=0x390 Size=0x8
    struct _WAKE_EVENT_DEVICE_CONTEXT WakeEventDeviceContext;// Offset=0x398 Size=0x20
    union // Size=0x8 (Id=0)
    {
        unsigned long long AuxiliaryFlags;// Offset=0x3b8 Size=0x8
        struct _anonymous_418 AuxiliaryUFlags;// Offset=0x3b8 Size=0x8
    };
};
