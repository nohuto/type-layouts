...
struct _anonymous_426// Size=0x8 (Id=426)
{
...
union _anonymous_428// Size=0x8 (Id=428)
{
    struct _anonymous_426 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_427 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_426 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=429)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_428 Data;// Offset=0x4 Size=0x8
};
