...
struct _anonymous_434// Size=0x8 (Id=434)
{
...
union _anonymous_436// Size=0x8 (Id=436)
{
    struct _anonymous_434 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_435 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_434 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=243)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_436 Data;// Offset=0x4 Size=0x8
};
