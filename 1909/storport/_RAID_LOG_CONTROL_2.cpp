struct _anonymous_571// Size=0x8 (Id=571)
{
...
union _anonymous_572// Size=0x8 (Id=572)
{
    struct _anonymous_571 u;// Offset=0x0 Size=0x8
    unsigned long long asUlong64;// Offset=0x0 Size=0x8
};

struct _RAID_LOG_CONTROL// Size=0x10 (Id=573)
{
    unsigned long Revision;// Offset=0x0 Size=0x4
    union _anonymous_572 Enable;// Offset=0x8 Size=0x8
};
