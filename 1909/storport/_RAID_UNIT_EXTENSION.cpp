...
struct _STOR_ADDR_BTL8// Size=0x10 (Id=242)
{
...
struct _STRING// Size=0x10 (Id=217)
{
...
struct _STOR_SCSI_IDENTITY// Size=0x38 (Id=210)
{
...
struct _anonymous_249// Size=0x8 (Id=249)
{
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned long Reserved:10;// Offset=0x4 Size=0x4 BitOffset=0x0 BitSize=0xa
    };
};

union _anonymous_250// Size=0x4 (Id=250)
{
...
struct _QUEUE_TAG_LIST// Size=0x80 (Id=205)
{
...
struct _EXTENDED_DEVICE_QUEUE// Size=0xa8 (Id=223)
{
...
struct _IO_QUEUE// Size=0xc0 (Id=222)
{
...
struct _anonymous_252// Size=0x190 (Id=252)
{
...
struct _RAID_IO_RESOURCES// Size=0x20 (Id=257)
{
...
struct _RAID_UNIT_REGISTRY_PARAMETERS// Size=0x18 (Id=366)
{
...
struct _RAID_UNIT_ATTRIBUTES// Size=0x4 (Id=521)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _RAID_WORK_ITEM_CONTEXT// Size=0x10 (Id=423)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
    struct _IRP * Irp;// Offset=0x8 Size=0x8
};

struct _STOR_ASYNC_NOTIFY_CONTEXT// Size=0x18 (Id=381)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
...
struct _anonymous_255// Size=0x10 (Id=255)
{
...
struct _anonymous_359// Size=0x4 (Id=359)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _TELEMETRY_UNIT_EXTENSION// Size=0x8 (Id=360)
{
    struct _anonymous_359 Flags;// Offset=0x0 Size=0x4
    unsigned char NvmeCriticalWarning;// Offset=0x4 Size=0x1
};

struct _RAID_TELEMETRY_NODE_COUNTERS// Size=0x18 (Id=354)
{
...
union _anonymous_506// Size=0x4 (Id=506)
{
    unsigned long Quantity;// Offset=0x0 Size=0x4
    unsigned long Position;// Offset=0x0 Size=0x4
};

struct _RAID_TELEMETRY_ERROR_ENTRY// Size=0x28 (Id=507)
{
    ...
    union _anonymous_506 u;// Offset=0x20 Size=0x4
};

struct _RAID_TELEMETRY_SAMPLED_ERROR_LOG// Size=0x1c8 (Id=526)
{
...
struct _RAID_TELEMETRY_UNIQUE_ERROR_LOG// Size=0xc8 (Id=473)
{
...
struct _RAID_UNIT_EXTENSION// Size=0xc00 (Id=256)
{
    ...
    struct _anonymous_249 Flags;// Offset=0x1c0 Size=0x8
    union _anonymous_250 InterlockedFlags;// Offset=0x1c8 Size=0x4
    ...
    struct _IO_QUEUE IoQueue;// Offset=0x280 Size=0xc0
    unsigned long MaxQueueDepth;// Offset=0x340 Size=0x4
    unsigned long LogicalSectorSize;// Offset=0x344 Size=0x4
    enum _STORAGE_POWERUP_REASON_TYPE PowerupReason;// Offset=0x348 Size=0x4
    struct ACPI_INTERFACE_STANDARD2 AcpiInterface;// Offset=0x350 Size=0x58
    long OutstandingCount;// Offset=0x3a8 Size=0x4
    unsigned long PagingPathCount;// Offset=0x3ac Size=0x4
    unsigned long CrashDumpPathCount;// Offset=0x3b0 Size=0x4
    unsigned long HiberPathCount;// Offset=0x3b4 Size=0x4
    struct _KTIMER PendingTimer;// Offset=0x3b8 Size=0x40
    struct _KDPC PendingDpc;// Offset=0x3f8 Size=0x40
    struct _KTIMER PauseTimer;// Offset=0x438 Size=0x40
    struct _KDPC PauseTimerDpc;// Offset=0x478 Size=0x40
    struct _KDPC RestartDpc;// Offset=0x4b8 Size=0x40
    struct _RAID_MEMORY_REGION * CommonBufferVAs;// Offset=0x4f8 Size=0x8
    unsigned long CommonBufferSize;// Offset=0x500 Size=0x4
    unsigned long CommonBufferBlocks;// Offset=0x504 Size=0x4
    unsigned long DefaultTimeout;// Offset=0x508 Size=0x4
    long ResetCount;// Offset=0x50c Size=0x4
    struct _anonymous_252 DeferredList;// Offset=0x510 Size=0x190
    ...
    struct _anonymous_255 PendingPowerUpContext;// Offset=0x778 Size=0x10
    ...
    unsigned long long TotalDeviceQueueIoCount;// Offset=0x858 Size=0x8
    unsigned long long TotalDeviceQueueIoWaitDuration;// Offset=0x860 Size=0x8
    unsigned long long MaxDeviceQueueIoWaitDuration;// Offset=0x868 Size=0x8
    unsigned long long DeviceQueueIoWaitExceededTimeoutCount;// Offset=0x870 Size=0x8
    unsigned long long DeviceQueueIoBusyCount;// Offset=0x878 Size=0x8
    unsigned long long DeviceQueueIoPausedCount;// Offset=0x880 Size=0x8
    unsigned long long DeviceQueueIoUntaggedCommandOutstandingCount;// Offset=0x888 Size=0x8
    unsigned long long DeviceQueueIoPausedForUntaggedCount;// Offset=0x890 Size=0x8
    unsigned long StorpTraceLoggingPerformanceEnabled;// Offset=0x898 Size=0x4
    struct _RAID_TELEMETRY_PERF_BUCKET * TelemetryPerfBuckets;// Offset=0x8a0 Size=0x8
    union _LARGE_INTEGER TelemetryLastPerfCollectionTimeStamp;// Offset=0x8a8 Size=0x8
    struct _RAID_TELEMETRY_PERF_BUCKET * TelemetryPerfPreviousCounters;// Offset=0x8b0 Size=0x8
    struct _RAID_TELEMETRY_NODE_COUNTERS * TelemetryCountersPerNumaNode;// Offset=0x8b8 Size=0x8
    struct _RAID_TELEMETRY_NODE_COUNTERS TelemetryPerfPreviousNodeCounters;// Offset=0x8c0 Size=0x18
    unsigned long long TelemetryMaxFlushLatency;// Offset=0x8d8 Size=0x8
    unsigned long long TelemetryMaxUnmapLatency;// Offset=0x8e0 Size=0x8
    unsigned long long TelemetryLock;// Offset=0x8e8 Size=0x8
    struct _RAID_TELEMETRY_SAMPLED_ERROR_LOG TelemetrySampledErrorLog;// Offset=0x8f0 Size=0x1c8
    struct _RAID_TELEMETRY_UNIQUE_ERROR_LOG TelemetryUniqueErrorLog;// Offset=0xab8 Size=0xc8
    unsigned long long TelemetryBytesWritten;// Offset=0xb80 Size=0x8
    unsigned long long TelemetryStreamBytesWritten;// Offset=0xb88 Size=0x8
    unsigned long PowerCycleCount;// Offset=0xb90 Size=0x4
    union _LARGE_INTEGER InitialTimestamp;// Offset=0xb98 Size=0x8
    struct _RAID_UNIT_QOS Qos;// Offset=0xba0 Size=0x30
    unsigned long long LastHierarchicalResetEndTime;// Offset=0xbd0 Size=0x8
    unsigned long long ZoneSize;// Offset=0xbd8 Size=0x8
    unsigned char * CachedSmartData;// Offset=0xbe0 Size=0x8
};
