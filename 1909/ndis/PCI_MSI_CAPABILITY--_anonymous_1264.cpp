union PCI_MSI_CAPABILITY::_anonymous_1264// Size=0x10 (Id=1264)
{
    struct <unnamed-type-Option32Bit>// Size=0xc (Id=17088)
    {
    ...
    struct PCI_MSI_CAPABILITY::_anonymous_1265::<unnamed-type-Option32Bit> Option32Bit;// Offset=0x0 Size=0xc
    struct <unnamed-type-Option64Bit>// Size=0x10 (Id=17094)
    {
    ...
    struct PCI_MSI_CAPABILITY::_anonymous_1266::<unnamed-type-Option64Bit> Option64Bit;// Offset=0x0 Size=0x10
};
