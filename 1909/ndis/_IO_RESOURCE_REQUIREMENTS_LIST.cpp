...
struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=2078)
{
    union // Size=0x8 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x18 (Id=4034)
        {
            struct <unnamed-type-Port>// Size=0x18 (Id=4035)
            {
            ...
            struct <unnamed-type-Memory>// Size=0x18 (Id=4041)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                unsigned long Alignment;// Offset=0x4 Size=0x4
                union _LARGE_INTEGER MinimumAddress;// Offset=0x8 Size=0x8
            ...
            struct <unnamed-type-Interrupt>// Size=0x18 (Id=4047)
            {
            ...
            struct <unnamed-type-Dma>// Size=0x8 (Id=4055)
            {
            ...
            struct <unnamed-type-DmaV3>// Size=0x10 (Id=4059)
            {
            ...
            struct <unnamed-type-Generic>// Size=0x18 (Id=4065)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                unsigned long Alignment;// Offset=0x4 Size=0x4
                union _LARGE_INTEGER MinimumAddress;// Offset=0x8 Size=0x8
            ...
            struct <unnamed-type-ConfigData>// Size=0xc (Id=4080)
            {
            ...
            struct <unnamed-type-Memory40>// Size=0x18 (Id=4085)
            {
            ...
            struct <unnamed-type-Memory48>// Size=0x18 (Id=4091)
            {
            ...
            struct <unnamed-type-Memory64>// Size=0x18 (Id=4097)
            {
            ...
            struct <unnamed-type-Connection>// Size=0xc (Id=4103)
            {
...
struct _IO_RESOURCE_LIST// Size=0x28 (Id=2068)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=1989)
{
