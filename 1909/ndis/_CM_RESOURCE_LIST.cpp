...
struct _CM_PARTIAL_RESOURCE_DESCRIPTOR// Size=0x14 (Id=1287)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x10 (Id=2329)
        {
            ...
            struct <unnamed-type-MessageInterrupt>// Size=0x10 (Id=2344)
            {
            ...
            struct <unnamed-type-DmaV3>// Size=0xc (Id=2357)
            {
                unsigned long Channel;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-DevicePrivate>// Size=0xc (Id=2365)
            {
            ...
            struct <unnamed-type-BusNumber>// Size=0xc (Id=2369)
            {
            ...
            struct <unnamed-type-DeviceSpecificData>// Size=0xc (Id=2374)
            {
...
struct _CM_PARTIAL_RESOURCE_LIST// Size=0x1c (Id=1624)
{
...
struct _CM_FULL_RESOURCE_DESCRIPTOR// Size=0x24 (Id=996)
{
...
struct _CM_RESOURCE_LIST// Size=0x28 (Id=1171)
{
