...
struct _WWAN_AUTH_SIM_CHALLENGE// Size=0x34 (Id=1923)
{
...
struct _WWAN_AUTH_AKA_CHALLENGE// Size=0x20 (Id=1922)
{
    unsigned char Rand[16];// Offset=0x0 Size=0x10
    unsigned char Autn[16];// Offset=0x10 Size=0x10
};

struct _WWAN_AUTH_AKAP_CHALLENGE// Size=0x124 (Id=1789)
{
    unsigned char Rand[16];// Offset=0x0 Size=0x10
    unsigned char Autn[16];// Offset=0x10 Size=0x10
...
struct _WWAN_AUTH_CHALLENGE// Size=0x128 (Id=1744)
{
    union // Size=0x4 (Id=0)
    {
        enum _WWAN_AUTH_METHOD AuthMethod;// Offset=0x0 Size=0x4
        union <unnamed-type-u>// Size=0x124 (Id=14874)
        {
...
struct _NDIS_WWAN_AUTH_CHALLENGE// Size=0x12c (Id=1703)
{
