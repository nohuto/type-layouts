struct _NDIS_RESTART_ATTRIBUTES// Size=0x20 (Id=350)
{
...
struct _NDIS_PROTOCOL_RESTART_PARAMETERS// Size=0x38 (Id=345)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct NDIS_RESTART_INFORMATION// Size=0xe0 (Id=343)
{
    union // Size=0xd8 (Id=0)
    {
        ...
        class Rtl::KArray<unsigned char,1> FilterInstanceBuffer;// Offset=0xc8 Size=0x10
        void NDIS_RESTART_INFORMATION();
        void ~NDIS_RESTART_INFORMATION();// Offset=0x0 Size=0x58
