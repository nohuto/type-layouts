union _NDIS_TCP_LARGE_SEND_OFFLOAD_NET_BUFFER_LIST_INFO::_anonymous_1346// Size=0x8 (Id=1346)
{
    struct <unnamed-type-Transmit>// Size=0x4 (Id=11666)
    {
    ...
    struct <unnamed-type-LsoV1Transmit>// Size=0x4 (Id=11671)
    {
    ...
    struct <unnamed-type-LsoV1TransmitComplete>// Size=0x4 (Id=11677)
    {
    ...
    struct <unnamed-type-LsoV2Transmit>// Size=0x4 (Id=11682)
    {
        unsigned long MSS:20;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x14
        unsigned long TcpHeaderOffset:10;// Offset=0x0 Size=0x4 BitOffset=0x14 BitSize=0xa
        unsigned long Type:1;// Offset=0x0 Size=0x4 BitOffset=0x1e BitSize=0x1
    ...
    struct <unnamed-type-LsoV2TransmitComplete>// Size=0x4 (Id=11688)
    {
