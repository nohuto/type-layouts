union _SLIST_HEADER// Size=0x10 (Id=71)
{
    ...
    struct <unnamed-type-HeaderX64>// Size=0x10 (Id=13864)
    {
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=69)
{
...
struct _LOOKASIDE_LIST_EX// Size=0x60 (Id=68)
{
    struct _GENERAL_LOOKASIDE_POOL L;// Offset=0x0 Size=0x60
};

struct _NDIS_NPAGED_LOOKASIDE_LIST// Size=0x100 (Id=1441)
{
