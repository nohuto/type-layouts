...
struct PCI_MSI_CAPABILITY// Size=0x18 (Id=548)
{
    union // Size=0x4 (Id=0)
    {
        ...
        struct _PCI_MSI_MESSAGE_CONTROL// Size=0x2 (Id=17071)
        {
        ...
        union <unnamed-type-MessageAddressLower>// Size=0x4 (Id=17079)
        {
            struct _PCI_MSI_MESSAGE_ADDRESS// Size=0x4 (Id=17080)
            {
