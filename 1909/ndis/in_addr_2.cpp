struct in_addr// Size=0x4 (Id=160)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-S_un>// Size=0x4 (Id=15496)
        {
            struct <unnamed-type-S_un_b>// Size=0x4 (Id=15497)
            {
            ...
            struct <unnamed-type-S_un_w>// Size=0x4 (Id=15503)
            {
