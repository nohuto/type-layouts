union _NDIS_OID_REQUEST_RESERVED::_anonymous_1074// Size=0x18 (Id=1074)
{
    ...
    struct <unnamed-type-IovContext>// Size=0x10 (Id=9826)
    {
        struct _NDIS_VF_BLOCK * VFBlock;// Offset=0x0 Size=0x8
        struct _NDIS_VPORT_BLOCK * VPortBlock;// Offset=0x8 Size=0x8
    };
    struct _NDIS_OID_REQUEST_RESERVED::_anonymous_1077::<unnamed-type-IovContext> IovContext;// Offset=0x0 Size=0x10
    struct <unnamed-type-PMContext>// Size=0x18 (Id=9832)
    {
    ...
    struct _NDIS_OID_REQUEST_RESERVED::_anonymous_1078::<unnamed-type-PMContext> PMContext;// Offset=0x0 Size=0x18
};
