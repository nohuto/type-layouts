struct _NDIS_CLIENT_CHARACTERISTICS// Size=0x98 (Id=799)
{
...
struct _NDIS_REQUEST// Size=0xb0 (Id=769)
{
    union // Size=0x24 (Id=0)
    {
        ...
        union _DATA// Size=0x20 (Id=10966)
        {
...
struct _NDIS_CO_AF_BLOCK// Size=0x258 (Id=404)
{
