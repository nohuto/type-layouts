...
struct _MMPAGING_FILE// Size=0x120 (Id=1834)
{
    ...
    struct _MMMOD_WRITER_MDL_ENTRY ** Entry;// Offset=0x40 Size=0x8
    unsigned long NumberOfModWriterEntries;// Offset=0x48 Size=0x4
    ...
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned short BackedBySCM:1;// Offset=0xcc Size=0x2 BitOffset=0xa BitSize=0x1
        unsigned short SpecialPurposeMemory:1;// Offset=0xcc Size=0x2 BitOffset=0xb BitSize=0x1
        unsigned short Spare0:3;// Offset=0xcc Size=0x2 BitOffset=0xc BitSize=0x3
    ...
    struct _MI_PAGE_HASH * PageHash;// Offset=0xd8 Size=0x8
    void * FileHandle;// Offset=0xe0 Size=0x8
    long SpinLock;// Offset=0xe8 Size=0x4
    struct _RTL_AVL_TREE FlowThroughReadRoot;// Offset=0xf0 Size=0x8
    struct _MI_PARTITION * Partition;// Offset=0xf8 Size=0x8
    union // Size=0x18 (Id=0)
    {
        struct _RTL_BALANCED_NODE FileObjectNode;// Offset=0x100 Size=0x18
        struct _RTL_RB_TREE ExtentsTree;// Offset=0x100 Size=0x10
    };
};
