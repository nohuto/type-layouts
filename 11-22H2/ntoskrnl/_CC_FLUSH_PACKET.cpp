...
struct _CC_FLUSH_PACKET// Size=0x108 (Id=1060)
{
    ...
    union _LARGE_INTEGER StartTick;// Offset=0x90 Size=0x8
    union _LARGE_INTEGER EndTick;// Offset=0x98 Size=0x8
    struct _FSRTL_COMMON_FCB_HEADER * FsContext;// Offset=0xa0 Size=0x8
    struct _WORK_QUEUE_ENTRY * WorkEntry;// Offset=0xa8 Size=0x8
    struct _LIST_ENTRY * DeferredWritesList;// Offset=0xb0 Size=0x8
    unsigned char * CoalescingState;// Offset=0xb8 Size=0x8
    unsigned char DoSinglePassFlush;// Offset=0xc0 Size=0x1
    unsigned char RecordedSinglePassStartOffset;// Offset=0xc1 Size=0x1
    union _LARGE_INTEGER SinglePassStartOffset;// Offset=0xc8 Size=0x8
    unsigned long long DirtyPagesAtStart;// Offset=0xd0 Size=0x8
    unsigned long long TotalBytesWritten;// Offset=0xd8 Size=0x8
    union _LARGE_INTEGER LwFlushStart;// Offset=0xe0 Size=0x8
    union _LARGE_INTEGER LwFlushEnd;// Offset=0xe8 Size=0x8
    unsigned long TotalPagesFlushed;// Offset=0xf0 Size=0x4
    unsigned long PagesToWrite;// Offset=0xf4 Size=0x4
    unsigned long RequeueToHeadCount;// Offset=0xf8 Size=0x4
    struct _WORK_QUEUE_ENTRY * WorkQueueEntry;// Offset=0x100 Size=0x8
};
