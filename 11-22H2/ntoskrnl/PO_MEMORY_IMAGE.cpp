...
struct _PO_HIBER_PERF// Size=0x260 (Id=2107)
{
    ...
    unsigned long long Reserved[2];// Offset=0xf8 Size=0x10
    ...
    unsigned long long WinresumeExitTimestamp;// Offset=0x1f8 Size=0x8
    unsigned long long TcbLoaderStartTimestamp;// Offset=0x200 Size=0x8
    unsigned long long TcbLoaderEndTimestamp;// Offset=0x208 Size=0x8
    unsigned long long RemappedPageLookupCycles;// Offset=0x210 Size=0x8
    unsigned long long TcbLaunchPrepareCycles;// Offset=0x218 Size=0x8
    unsigned long long TcbLaunchPrepareDataCycles;// Offset=0x220 Size=0x8
    unsigned long long TcbRestoreStateCycles;// Offset=0x228 Size=0x8
    unsigned long long DecryptVsmPagesPhase0Cycles;// Offset=0x230 Size=0x8
    unsigned long long DecryptVsmPagesPhase1Cycles;// Offset=0x238 Size=0x8
    unsigned long long DecryptVsmPagesPhase2Cycles;// Offset=0x240 Size=0x8
    unsigned long long TcbLoaderAuthenticateCycles;// Offset=0x248 Size=0x8
    unsigned long long TcbLoaderDecryptCycles;// Offset=0x250 Size=0x8
    unsigned long long TcbLoaderValidateCycles;// Offset=0x258 Size=0x8
};

struct PO_MEMORY_IMAGE// Size=0x448 (Id=1796)
{
