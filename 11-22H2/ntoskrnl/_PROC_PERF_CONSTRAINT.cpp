...
struct _PERF_CONTROL_STATE_SELECTION// Size=0x28 (Id=2077)
{
...
struct _PROC_PERF_CONSTRAINT// Size=0x90 (Id=2167)
{
    ...
    unsigned long IncreasePerfCheckCount;// Offset=0x88 Size=0x4
    unsigned long DecreasePerfCheckCount;// Offset=0x8c Size=0x4
};
