...
struct _PO_DEVICE_NOTIFY// Size=0x68 (Id=1164)
{
...
union _unnamed_706// Size=0x8 (Id=706)
{
...
union _unnamed_707// Size=0x8 (Id=707)
{
    struct _DEVICE_NODE * NextResourceDeviceNode;// Offset=0x0 Size=0x8
};

struct _unnamed_709// Size=0x20 (Id=709)
{
...
struct _PO_DIRECTED_DRIPS_STATE// Size=0x38 (Id=1135)
{
...
struct _PNP_PROBLEM_CODE_LOG_ENTRY// Size=0x18 (Id=1720)
{
...
struct _DEVICE_NODE// Size=0x388 (Id=711)
{
    ...
    union _unnamed_706 OverUsed1;// Offset=0x210 Size=0x8
    union _unnamed_707 OverUsed2;// Offset=0x218 Size=0x8
    ...
    struct _unnamed_709 DockInfo;// Offset=0x238 Size=0x20
    ...
    struct _PNP_PROBLEM_CODE_LOG_ENTRY ProblemCodeLog[4];// Offset=0x310 Size=0x60
    unsigned long ProblemCodeLogNextIndex;// Offset=0x370 Size=0x4
    union _LARGE_INTEGER StateTimestamp;// Offset=0x378 Size=0x8
    union _LARGE_INTEGER PreviousStateTimestamp;// Offset=0x380 Size=0x8
};
