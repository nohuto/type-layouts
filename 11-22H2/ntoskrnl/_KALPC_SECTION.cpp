struct _unnamed_883// Size=0x4 (Id=883)
{
...
union _unnamed_884// Size=0x4 (Id=884)
{
    struct _unnamed_883 s1;// Offset=0x0 Size=0x4
};
...
struct _KALPC_SECTION// Size=0x48 (Id=885)
{
    ...
    union _unnamed_884 u1;// Offset=0x30 Size=0x4
