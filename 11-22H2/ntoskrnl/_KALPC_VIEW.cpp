...
struct _unnamed_889// Size=0x4 (Id=889)
{
...
union _unnamed_890// Size=0x4 (Id=890)
{
    struct _unnamed_889 s1;// Offset=0x0 Size=0x4
};

struct _KALPC_VIEW// Size=0x60 (Id=891)
{
    ...
    union _unnamed_890 u1;// Offset=0x48 Size=0x4
