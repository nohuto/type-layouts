struct _PROFILE_PARAMETER_BLOCK// Size=0x10 (Id=2258)
{
...
struct _LOADER_PERFORMANCE_DATA// Size=0x60 (Id=2236)
{
...
struct _BOOT_ENTROPY_SOURCE_LDR_RESULT// Size=0x68 (Id=2292)
{
...
struct _BOOT_ENTROPY_LDR_RESULT// Size=0x868 (Id=2267)
{
...
struct _LOADER_PARAMETER_HYPERVISOR_EXTENSION// Size=0x40 (Id=2255)
{
...
struct _LOADER_BUGCHECK_PARAMETERS// Size=0x28 (Id=2119)
{
...
struct _OFFLINE_CRASHDUMP_CONFIGURATION_TABLE_V2// Size=0x20 (Id=2199)
{
...
struct _LOADER_HIVE_RECOVERY_INFO// Size=0x14 (Id=2163)
{
...
struct _LOADER_FEATURE_CONFIGURATION_DIAGNOSTIC_INFORMATION// Size=0x18 (Id=2225)
{
    ...
    union _unnamed_2224 Flags;// Offset=0x4 Size=0x4
...
struct _LOADER_FEATURE_CONFIGURATION_INFORMATION// Size=0x48 (Id=2106)
{
...
struct _LOADER_PARAMETER_EXTENSION// Size=0xf28 (Id=2086)
{
    ...
    struct _unnamed_2083 MiniExecutive;// Offset=0xdb0 Size=0x10
    ...
    struct _unnamed_2084 InstalledMemory;// Offset=0xeb8 Size=0x10
    ...
    struct _unnamed_2085 CimfsInformation;// Offset=0xee8 Size=0x20
