struct _MI_PARTITION_FLAGS// Size=0x4 (Id=2001)
{
...
union _unnamed_1549// Size=0x4 (Id=1549)
{
...
struct _MI_PARTITION_CORE// Size=0x1e0 (Id=1550)
{
    unsigned short PartitionId;// Offset=0x0 Size=0x2
    union _unnamed_1549 u;// Offset=0x4 Size=0x4
...
struct _MMPAGE_FILE_EXPANSION_FLAGS// Size=0x4 (Id=2197)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1691// Size=0x4 (Id=1691)
{
    unsigned long LongFlags;// Offset=0x0 Size=0x4
    struct _MMPAGE_FILE_EXPANSION_FLAGS Flags;// Offset=0x0 Size=0x4
};

struct _MMPAGE_FILE_EXPANSION// Size=0x58 (Id=1692)
{
    ...
    union _unnamed_1691 u1;// Offset=0x4c Size=0x4
...
struct _MMMOD_WRITER_LISTHEAD// Size=0x28 (Id=2009)
{
...
union _MI_RESERVATION_CLUSTER_INFO// Size=0x4 (Id=2251)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_MODWRITE_DATA// Size=0x40 (Id=2099)
{
...
struct _MI_RESTRICTED_MODWRITES// Size=0x3 (Id=2198)
{
...
struct _MI_PARTITION_MODWRITES// Size=0x2c0 (Id=1899)
{
...
union _unnamed_1141// Size=0x4 (Id=1141)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_PARTITION_STORES// Size=0xb0 (Id=1142)
{
    union _unnamed_1141 WriteAllStoreSwapPages;// Offset=0x0 Size=0x4
...
struct _KSEMAPHORE// Size=0x20 (Id=718)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

struct _MMDEREFERENCE_SEGMENT_HEADER// Size=0x50 (Id=2055)
{
...
struct _MI_DEFERRED_PFNS_TO_FREE// Size=0x20 (Id=2093)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
...
struct _MI_CROSS_PARTITION_CHARGES// Size=0x20 (Id=2089)
{
...
struct _MI_PARTITION_SEGMENTS// Size=0x440 (Id=1649)
{
...
struct _MI_PARTITION_COMMIT// Size=0x40 (Id=1774)
{
...
struct _MI_PARTITION_ZEROING// Size=0x48 (Id=1735)
{
...
struct _MI_PAGE_COMBINING_SUPPORT// Size=0x190 (Id=1450)
{
...
struct _MMWORKING_SET_EXPANSION_HEAD// Size=0x10 (Id=1185)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
};

struct _MI_SPECIAL_PURPOSE_MEMORY_STATE// Size=0x38 (Id=1231)
{
...
struct _unnamed_1562// Size=0x38 (Id=1562)
{
    struct _MDL Mdl;// Offset=0x0 Size=0x30
    unsigned long long Page[1];// Offset=0x30 Size=0x8
};

struct _MI_PAGEFILE_TRACES// Size=0x80 (Id=1563)
{
    ...
    struct _unnamed_1562 MdlHack;// Offset=0x48 Size=0x38
};

struct _MI_VISIBLE_PARTITION// Size=0x1380 (Id=1259)
{
