struct _KSCHEDULING_GROUP_POLICY// Size=0x8 (Id=1913)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KSCB// Size=0x1a8 (Id=1506)
{
    ...
    struct // Size=0x1 (Id=0)
    {
        ...
        unsigned char UnconstrainedMaxQuota:1;// Offset=0x70 Size=0x1 BitOffset=0x4 BitSize=0x1
        unsigned char UnconstrainedMinQuota:1;// Offset=0x70 Size=0x1 BitOffset=0x5 BitSize=0x1
        unsigned char ShareRankOwner:1;// Offset=0x70 Size=0x1 BitOffset=0x6 BitSize=0x1
        unsigned char Spare1:1;// Offset=0x70 Size=0x1 BitOffset=0x7 BitSize=0x1
    };
...
struct _KSCHEDULING_GROUP// Size=0x240 (Id=1079)
{
