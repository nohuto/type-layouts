...
struct _CHILD_LIST// Size=0x8 (Id=1465)
{
    unsigned long Count;// Offset=0x0 Size=0x4
    unsigned long List;// Offset=0x4 Size=0x4
};

struct _CM_KEY_REFERENCE// Size=0x10 (Id=1207)
{
...
struct _CM_KEY_INDEX// Size=0x8 (Id=1978)
{
    unsigned short Signature;// Offset=0x0 Size=0x2
...
struct _CM_BIG_DATA// Size=0x8 (Id=2088)
{
    unsigned short Signature;// Offset=0x0 Size=0x2
    unsigned short Count;// Offset=0x2 Size=0x2
    unsigned long List;// Offset=0x4 Size=0x4
...
struct _CELL_DATA// Size=0x50 (Id=1659)
{
