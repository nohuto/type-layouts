...
struct _unnamed_2004// Size=0xc (Id=2004)
{
...
union _unnamed_2005// Size=0xc (Id=2005)
{
    struct _unnamed_2004 Msi;// Offset=0x0 Size=0xc
};

struct _INTERRUPT_REMAPPING_INFO// Size=0x10 (Id=2006)
{
    ...
    union _unnamed_2005 u;// Offset=0x4 Size=0xc
};

struct _unnamed_1211// Size=0x8 (Id=1211)
{
...
union _unnamed_1460// Size=0x4 (Id=1460)
{
    struct _unnamed_1459 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _unnamed_1461// Size=0x4 (Id=1461)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1462// Size=0x4 (Id=1462)
{
    struct _unnamed_1461 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_HT_INTR_INFO// Size=0x8 (Id=1463)
{
    union _unnamed_1460 LowPart;// Offset=0x0 Size=0x4
    union _unnamed_1462 HighPart;// Offset=0x4 Size=0x4
};
...
struct _unnamed_1215// Size=0x4 (Id=1215)
{
    enum HAL_APIC_DESTINATION_MODE DestinationMode;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_VECTOR_DATA// Size=0x58 (Id=1216)
{
    ...
    struct _unnamed_1211 ControllerInput;// Offset=0x38 Size=0x8
    unsigned long long HvDeviceId;// Offset=0x40 Size=0x8
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_1212 XapicMessage;// Offset=0x48 Size=0x10
        struct _unnamed_1213 Hypertransport;// Offset=0x48 Size=0x8
        struct _unnamed_1212 GenericMessage;// Offset=0x48 Size=0x10
        struct _unnamed_1215 MessageRequest;// Offset=0x48 Size=0x4
    };
};

struct _INTERRUPT_CONNECTION_DATA// Size=0x60 (Id=2003)
{
