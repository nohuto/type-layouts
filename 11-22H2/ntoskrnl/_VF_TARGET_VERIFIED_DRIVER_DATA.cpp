...
struct _VF_TARGET_VERIFIED_DRIVER_DATA// Size=0x130 (Id=1195)
{
    ...
    union _unnamed_1194 u1;// Offset=0x20 Size=0x4
    ...
    unsigned long ExecutePoolTypes;// Offset=0x118 Size=0x4
    unsigned long ExecutePageProtections;// Offset=0x11c Size=0x4
    unsigned long ExecutePageMappings;// Offset=0x120 Size=0x4
    unsigned long ExecuteWriteSections;// Offset=0x124 Size=0x4
    unsigned long SectionAlignmentFailures;// Offset=0x128 Size=0x4
    unsigned long IATInExecutableSection;// Offset=0x12c Size=0x4
};
