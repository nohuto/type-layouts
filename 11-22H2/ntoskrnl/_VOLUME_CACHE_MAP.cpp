...
struct _LOG_HANDLE_CONTEXT// Size=0x98 (Id=1183)
{
...
struct _CC_VOLUME_TELEMETRY// Size=0x9b0 (Id=1822)
{
...
struct _VOLUME_CACHE_MAP// Size=0xa90 (Id=794)
{
    ...
    unsigned long VolumeId;// Offset=0xcc Size=0x4
    struct _LIST_ENTRY PrivateVolumeList;// Offset=0xd0 Size=0x10
    struct _CC_VOLUME_TELEMETRY VolumeTelemetry;// Offset=0xe0 Size=0x9b0
};
