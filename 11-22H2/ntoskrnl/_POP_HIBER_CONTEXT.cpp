...
struct _POP_IO_INFO// Size=0x70 (Id=1856)
{
...
struct _POP_HIBER_CONTEXT// Size=0x1c8 (Id=1766)
{
    ...
    struct _MDL * FirmwareRuntimeInformationMdl;// Offset=0xe0 Size=0x8
    void * FirmwareRuntimeInformationVa;// Offset=0xe8 Size=0x8
    void * ResumeContext;// Offset=0xf0 Size=0x8
    unsigned long ResumeContextPages;// Offset=0xf8 Size=0x4
    unsigned long SecurePages;// Offset=0xfc Size=0x4
    unsigned long ProcessorCount;// Offset=0x100 Size=0x4
    struct _POP_PER_PROCESSOR_CONTEXT * ProcessorContext;// Offset=0x108 Size=0x8
    char * ProdConsBuffer;// Offset=0x110 Size=0x8
    unsigned long ProdConsSize;// Offset=0x118 Size=0x4
    unsigned long MaxDataPages;// Offset=0x11c Size=0x4
    void * ExtraBuffer;// Offset=0x120 Size=0x8
    unsigned long long ExtraBufferSize;// Offset=0x128 Size=0x8
    void * ExtraMapVa;// Offset=0x130 Size=0x8
    unsigned long long BitlockerKeyPFN;// Offset=0x138 Size=0x8
    struct _POP_IO_INFO IoInfo;// Offset=0x140 Size=0x70
    unsigned short * IoChecksums;// Offset=0x1b0 Size=0x8
    unsigned long long IoChecksumsSize;// Offset=0x1b8 Size=0x8
    unsigned long HardwareConfigurationSignature;// Offset=0x1c0 Size=0x4
    unsigned char IumEnabled;// Offset=0x1c4 Size=0x1
    unsigned char SecureBoot;// Offset=0x1c5 Size=0x1
};
