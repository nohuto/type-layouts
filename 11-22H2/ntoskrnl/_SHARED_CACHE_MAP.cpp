...
struct _PRIVATE_CACHE_MAP_FLAGS// Size=0x4 (Id=1813)
{
...
struct _PRIVATE_CACHE_MAP// Size=0x78 (Id=816)
{
    union // Size=0x2 (Id=0)
    {
...
struct _SHARED_CACHE_MAP// Size=0x260 (Id=795)
{
    short NodeTypeCode;// Offset=0x0 Size=0x2
