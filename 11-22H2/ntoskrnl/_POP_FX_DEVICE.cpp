...
union _POP_FX_DEVICE_STATUS// Size=0x4 (Id=787)
{
...
struct _POP_FX_DRIVER_CALLBACKS// Size=0x50 (Id=1737)
{
...
struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=2176)
{
...
struct _IO_REMOVE_LOCK// Size=0x20 (Id=1934)
{
...
struct _POP_FX_WORK_ORDER// Size=0x38 (Id=1839)
{
...
struct _POP_FX_ACTIVE_TIME_ACCOUNTING// Size=0x60 (Id=2202)
{
...
struct _POP_FX_ACCOUNTING// Size=0xe0 (Id=1912)
{
...
struct _POP_FX_DRIPS_WATCHDOG_CONTEXT// Size=0x28 (Id=2120)
{
...
struct _POP_FX_WORK_ORDER_WATCHDOG_INFO// Size=0xb0 (Id=1989)
{
    struct _LIST_ENTRY Link;// Offset=0x0 Size=0x10
...
struct _POP_FX_DEVICE_DIRECTED_TRANSITION_STATE// Size=0x10 (Id=1922)
{
...
struct _POP_FX_DEVICE// Size=0x500 (Id=1658)
{
    struct _LIST_ENTRY Link;// Offset=0x0 Size=0x10
    ...
    struct _WORK_QUEUE_ITEM ReportDevicePoweredOnPassiveWorkItem;// Offset=0x4b8 Size=0x20
    unsigned long long RelationsLock;// Offset=0x4d8 Size=0x8
    unsigned long IdleProviderCount;// Offset=0x4e0 Size=0x4
    struct _IRP * PendingDevicePowerIrp;// Offset=0x4e8 Size=0x8
    struct _LIST_ENTRY ExternalDependencies;// Offset=0x4f0 Size=0x10
};
