...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=1176)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=1643)
{
...
struct _ALPC_PROCESS_CONTEXT// Size=0x20 (Id=1374)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=1329)
{
    union // Size=0x1 (Id=0)
    {
...
struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=1251)
{
...
union _KE_PROCESS_CONCURRENCY_COUNT// Size=0x4 (Id=1983)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _KE_IDEAL_PROCESSOR_ASSIGNMENT_BLOCK// Size=0x118 (Id=1131)
{
    ...
    union _unnamed_1130 AssignmentFlags;// Offset=0xc Size=0x4
    struct _KAFFINITY_EX IdealProcessorSets;// Offset=0x10 Size=0x108
};

struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=1298)
{
    struct _RTL_AVL_TREE Tree;// Offset=0x0 Size=0x8
    struct _EX_PUSH_LOCK Lock;// Offset=0x8 Size=0x8
};

struct _PSP_SYSCALL_PROVIDER_DISPATCH_CONTEXT// Size=0x8 (Id=1558)
{
...
union _PROCESS_EXECUTION_TRANSITION// Size=0x2 (Id=1494)
{
...
union _PROCESS_EXECUTION_STATE// Size=0x1 (Id=1521)
{
...
union _PROCESS_EXECUTION// Size=0x4 (Id=1495)
{
