...
struct _unnamed_2180// Size=0x8 (Id=2180)
{
...
struct _unnamed_2181// Size=0x10 (Id=2181)
{
    struct _GUID DiskId;// Offset=0x0 Size=0x10
};

union _unnamed_2182// Size=0x10 (Id=2182)
{
    struct _unnamed_2180 Mbr;// Offset=0x0 Size=0x8
    struct _unnamed_2181 Gpt;// Offset=0x0 Size=0x10
};

struct _DUMP_INITIALIZATION_CONTEXT// Size=0x108 (Id=2184)
{
    ...
    union _unnamed_2182 DiskInfo;// Offset=0x8c Size=0x10
...
struct _DUMP_STACK_CONTEXT// Size=0x178 (Id=2127)
{
