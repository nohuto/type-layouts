struct _unnamed_1353// Size=0x8 (Id=1353)
{
...
union _unnamed_1358// Size=0x8 (Id=1358)
{
    struct _unnamed_1353 e1;// Offset=0x0 Size=0x8
    struct _unnamed_1354 e2;// Offset=0x0 Size=0x8
    struct _unnamed_1355 OnList;// Offset=0x0 Size=0x8
    struct _unnamed_1356 Active;// Offset=0x0 Size=0x8
    struct _unnamed_1357 Transition;// Offset=0x0 Size=0x8
};

struct _MI_HUGE_PFN// Size=0x8 (Id=1359)
{
    union _unnamed_1358 u1;// Offset=0x0 Size=0x8
};
