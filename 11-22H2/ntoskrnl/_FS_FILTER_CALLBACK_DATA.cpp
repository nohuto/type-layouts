...
struct _unnamed_2299// Size=0x20 (Id=2299)
{
...
struct _unnamed_2300// Size=0x28 (Id=2300)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=2301)
{
    struct _unnamed_2295 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_2296 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_2298 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _unnamed_2299 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_2300 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=2282)
{
