...
struct _EXT_IOMMU_FUNCTION_TABLE_EXTENDED// Size=0xb8 (Id=378)
{
    unsigned char  ( * FindDevice)(void * ,struct _EXT_IOMMU_DEVICE_ID * ,unsigned char ,struct _EXT_IOMMU_OUTPUT_MAPPING * );// Offset=0x0 Size=0x8
    long  ( * SetDeviceSvmCapabilities)(void * ,unsigned long long ,unsigned char );// Offset=0x8 Size=0x8
    void  ( * SetDevicePasidTable)(void * ,unsigned long long ,struct _IOMMU_PASID_TABLE_OBJECT * ,unsigned char );// Offset=0x10 Size=0x8
    long  ( * GrowPasidTable)(void * ,struct _IOMMU_PASID_TABLE_OBJECT * ,unsigned long );// Offset=0x18 Size=0x8
    long  ( * SetPasidAddressSpace)(void * ,struct _IOMMU_PASID_TABLE_OBJECT * ,unsigned long ,unsigned long long ,unsigned char * );// Offset=0x20 Size=0x8
    void  ( * FlushTb)(void * ,unsigned long ,unsigned long long ,void * ,struct _LIST_ENTRY * ,unsigned long ,struct _KTB_FLUSH_VA * );// Offset=0x28 Size=0x8
    ...
    void  ( * MarkHiberRegions)(void * ,void * ,struct _LIST_ENTRY * );// Offset=0x70 Size=0x8
    ...
    void  ( * FreePasidTable)(void * ,struct _IOMMU_PASID_TABLE_OBJECT * ,void * );// Offset=0xa8 Size=0x8
    long  ( * ConfigureAts)(void * ,unsigned long long ,unsigned char );// Offset=0xb0 Size=0x8
};
...
struct _IOMMU_PAGE_HANDLING_DATA// Size=0x28 (Id=368)
{
...
struct _PCI_SLOT_NUMBER// Size=0x4 (Id=350)
{
...
struct _REGISTERED_IOMMU// Size=0x230 (Id=263)
{
    ...
    struct _EXT_IOMMU_FUNCTION_TABLE_EXTENDED FunctionTableExtended;// Offset=0xd0 Size=0xb8
    unsigned long Flags;// Offset=0x188 Size=0x4
    struct _LIST_ENTRY PasidTableListHead;// Offset=0x190 Size=0x10
    struct _IOMMU_PAGE_HANDLING_DATA PageHandling;// Offset=0x1a0 Size=0x28
    unsigned long MaximumDomainIds;// Offset=0x1c8 Size=0x4
    unsigned long long DomainIdBitmapLock;// Offset=0x1d0 Size=0x8
    struct _RTL_BITMAP DomainIdBitmap;// Offset=0x1d8 Size=0x10
    unsigned long Capabilities;// Offset=0x1e8 Size=0x4
    enum _EXT_IOMMU_KNOWN_IOMMU_TYPE KnownType;// Offset=0x1ec Size=0x4
    unsigned long PciSegment;// Offset=0x1f0 Size=0x4
    unsigned long PciBus;// Offset=0x1f4 Size=0x4
    struct _PCI_SLOT_NUMBER PciSlot;// Offset=0x1f8 Size=0x4
    union _LARGE_INTEGER MsiAddress;// Offset=0x200 Size=0x8
    unsigned long long MsiData;// Offset=0x208 Size=0x8
    unsigned long MaximumAsids;// Offset=0x210 Size=0x4
    unsigned long Identifier;// Offset=0x214 Size=0x4
    struct _UNICODE_STRING ResourceId;// Offset=0x218 Size=0x10
    struct _IOMMU_RESERVED_DEVICE_LIST * ReservedDevices;// Offset=0x228 Size=0x8
};
