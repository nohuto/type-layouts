...
union _NT_IORING_HANDLEREF// Size=0x8 (Id=2130)
{
    union // Size=0x8 (Id=0)
    {
...
struct _NT_IORING_REG_FILES_FLAGS// Size=0x8 (Id=2219)
{
...
struct _NT_IORING_OP_REGISTER_FILES// Size=0x18 (Id=2103)
{
    enum _NT_IORING_OP_FLAGS CommonOpFlags;// Offset=0x0 Size=0x4
...
struct _NT_IORING_OP_CANCEL// Size=0x18 (Id=2281)
{
    enum _NT_IORING_OP_FLAGS CommonOpFlags;// Offset=0x0 Size=0x4
    union _NT_IORING_HANDLEREF File;// Offset=0x8 Size=0x8
...
struct _NT_IORING_OP_WRITE// Size=0x28 (Id=2053)
{
    enum _NT_IORING_OP_FLAGS CommonOpFlags;// Offset=0x0 Size=0x4
...
struct _NT_IORING_OP_FLUSH// Size=0x10 (Id=2244)
{
    enum _NT_IORING_OP_FLAGS CommonOpFlags;// Offset=0x0 Size=0x4
...
struct _NT_IORING_OP_RESERVED// Size=0x30 (Id=2090)
{
...
struct _NT_IORING_SQE// Size=0x40 (Id=2029)
{
...
struct _NT_IORING_SUBMISSION_QUEUE// Size=0x50 (Id=1683)
{
