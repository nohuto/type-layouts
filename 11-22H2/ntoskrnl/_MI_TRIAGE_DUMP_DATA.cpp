struct _MI_FLAGS// Size=0x8 (Id=1289)
{
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned long ExceptionHandlingReady:1;// Offset=0x0 Size=0x4 BitOffset=0x15 BitSize=0x1
        unsigned long ShadowStacksSupported:1;// Offset=0x0 Size=0x4 BitOffset=0x16 BitSize=0x1
        unsigned long AccessBitFenceRequired:1;// Offset=0x0 Size=0x4 BitOffset=0x17 BitSize=0x1
        unsigned long AccessBitReplacementCapability:2;// Offset=0x0 Size=0x4 BitOffset=0x18 BitSize=0x2
        unsigned long PfnDatabaseExists:1;// Offset=0x0 Size=0x4 BitOffset=0x1a BitSize=0x1
        unsigned long PfnDatabaseGapsFilled:1;// Offset=0x0 Size=0x4 BitOffset=0x1b BitSize=0x1
        unsigned long SystemPtesReady:1;// Offset=0x0 Size=0x4 BitOffset=0x1c BitSize=0x1
        unsigned long BootImageUnprivilegedPagesUnregistered:1;// Offset=0x0 Size=0x4 BitOffset=0x1d BitSize=0x1
        unsigned long ImageProtectedSlabExecutableOnly:1;// Offset=0x0 Size=0x4 BitOffset=0x1e BitSize=0x1
        unsigned long SpecialReadOnlyProtectedSlabPages:1;// Offset=0x0 Size=0x4 BitOffset=0x1f BitSize=0x1
        unsigned long SlabAllocatorsReady:1;// Offset=0x4 Size=0x4 BitOffset=0x0 BitSize=0x1
        unsigned long KasanEnabled:1;// Offset=0x4 Size=0x4 BitOffset=0x1 BitSize=0x1
    };
};

struct _MI_TRIAGE_DUMP_DATA// Size=0x40 (Id=2073)
{
