...
struct _IMAGE_SECURITY_CONTEXT// Size=0x8 (Id=1802)
{
    union // Size=0x8 (Id=0)
    {
...
union _unnamed_1197// Size=0x8 (Id=1197)
{
...
struct _MI_IMAGE_SECURITY_REFERENCE// Size=0x40 (Id=1198)
{
    ...
    union _unnamed_1197 u1;// Offset=0x30 Size=0x8
