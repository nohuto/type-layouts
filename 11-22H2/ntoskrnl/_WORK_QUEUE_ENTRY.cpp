...
struct _unnamed_803// Size=0x30 (Id=803)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
struct _unnamed_804// Size=0x70 (Id=804)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
struct _unnamed_805// Size=0x40 (Id=805)
{
...
union _unnamed_806// Size=0x70 (Id=806)
{
    union // Size=0x70 (Id=0)
    {
        struct _unnamed_799 Read;// Offset=0x0 Size=0x10
        struct _unnamed_800 Write;// Offset=0x0 Size=0x8
        struct _unnamed_801 Event;// Offset=0x0 Size=0x8
        struct _unnamed_802 Notification;// Offset=0x0 Size=0x4
        struct _unnamed_803 LowPriWrite;// Offset=0x0 Size=0x30
        struct _unnamed_804 AsyncRead;// Offset=0x0 Size=0x70
        struct _unnamed_805 AsyncWriteBehind;// Offset=0x0 Size=0x40
    };
};
...
struct _WORK_QUEUE_ENTRY// Size=0xa0 (Id=808)
{
    struct _LIST_ENTRY WorkQueueLinks;// Offset=0x0 Size=0x10
    union _unnamed_806 Parameters;// Offset=0x10 Size=0x70
