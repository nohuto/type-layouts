...
struct _ALPC_PORT_ATTRIBUTES// Size=0x48 (Id=1150)
{
...
struct _unnamed_894// Size=0x4 (Id=894)
{
...
union _unnamed_895// Size=0x4 (Id=895)
{
    struct _unnamed_894 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

struct _ALPC_PORT// Size=0x1d8 (Id=896)
{
    ...
    union _unnamed_895 u1;// Offset=0x1a0 Size=0x4
