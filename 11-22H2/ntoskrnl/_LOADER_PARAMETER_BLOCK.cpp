...
struct _I386_LOADER_BLOCK// Size=0x10 (Id=2154)
{
...
struct _ARM_LOADER_BLOCK// Size=0x4 (Id=2232)
{
    unsigned long PlaceHolder;// Offset=0x0 Size=0x4
};

union _unnamed_1935// Size=0x10 (Id=1935)
{
...
struct _EFI_FIRMWARE_INFORMATION// Size=0x38 (Id=2239)
{
...
struct _PCAT_FIRMWARE_INFORMATION// Size=0x4 (Id=2249)
{
    unsigned long PlaceHolder;// Offset=0x0 Size=0x4
};

union _unnamed_2164// Size=0x38 (Id=2164)
{
...
struct _FIRMWARE_INFORMATION_LOADER_BLOCK// Size=0x40 (Id=2165)
{
    ...
    union _unnamed_2164 u;// Offset=0x8 Size=0x38
};
...
struct _LOADER_PARAMETER_BLOCK// Size=0x170 (Id=1936)
{
    ...
    union _unnamed_1935 u;// Offset=0xf8 Size=0x10
