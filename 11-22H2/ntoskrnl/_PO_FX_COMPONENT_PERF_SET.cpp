...
struct _PO_FX_COMPONENT_PERF_SET// Size=0x30 (Id=2287)
{
    ...
    {
        struct _unnamed_2285 Discrete;// Offset=0x20 Size=0x10
        struct _unnamed_2286 Range;// Offset=0x20 Size=0x10
    };
};
