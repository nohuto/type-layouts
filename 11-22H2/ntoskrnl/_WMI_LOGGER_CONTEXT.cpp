...
struct _ETW_BUFFER_QUEUE// Size=0x10 (Id=935)
{
...
struct _ETW_REF_CLOCK// Size=0x10 (Id=1482)
{
...
struct _SECURITY_CLIENT_CONTEXT// Size=0x48 (Id=1280)
{
...
struct _DISALLOWED_GUIDS// Size=0x10 (Id=1473)
{
...
struct _ETW_PARTITION_CONTEXT// Size=0x8 (Id=1100)
{
    struct _EPARTITION * Partition;// Offset=0x0 Size=0x8
};

struct _WMI_LOGGER_CONTEXT// Size=0x540 (Id=945)
{
