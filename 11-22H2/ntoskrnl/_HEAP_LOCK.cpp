struct _RTL_CRITICAL_SECTION// Size=0x28 (Id=1385)
{
...
union _unnamed_862// Size=0x68 (Id=862)
{
    struct _RTL_CRITICAL_SECTION CriticalSection;// Offset=0x0 Size=0x28
    struct _ERESOURCE Resource;// Offset=0x0 Size=0x68
};

struct _HEAP_LOCK// Size=0x68 (Id=863)
{
    union _unnamed_862 Lock;// Offset=0x0 Size=0x68
};
