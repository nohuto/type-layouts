...
struct _unnamed_1540// Size=0x4 (Id=1540)
{
...
union _unnamed_1541// Size=0x18 (Id=1541)
{
    union // Size=0x18 (Id=0)
    {
        struct _VF_TARGET_ALL_SHARED_EXPORT_THUNKS AllSharedExportThunks;// Offset=0x0 Size=0x18
        struct _unnamed_1540 Flags;// Offset=0x0 Size=0x4
    };
};

struct _VF_TARGET_DRIVER// Size=0x40 (Id=1542)
{
    struct _VF_AVL_TREE_NODE_EX TreeNode;// Offset=0x0 Size=0x18
    union _unnamed_1541 u1;// Offset=0x18 Size=0x18
