...
struct _INBV_MODE_INFORMATION// Size=0x10 (Id=1606)
{
...
union _unnamed_1386// Size=0x8 (Id=1386)
{
...
struct _INBV_DISPLAY_CONTEXT// Size=0x28 (Id=1387)
{
    ...
    union _unnamed_1386 VideoMemory;// Offset=0x20 Size=0x8
};
