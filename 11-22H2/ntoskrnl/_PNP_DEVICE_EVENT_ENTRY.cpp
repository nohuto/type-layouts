...
struct _unnamed_2148// Size=0x20 (Id=2148)
{
...
union _unnamed_2149// Size=0x20 (Id=2149)
{
    union // Size=0x20 (Id=0)
    {
        struct _unnamed_2140 DeviceClass;// Offset=0x0 Size=0x14
        struct _unnamed_2141 TargetDevice;// Offset=0x0 Size=0x2
        struct _unnamed_2141 InstallDevice;// Offset=0x0 Size=0x2
        struct _unnamed_2142 CustomNotification;// Offset=0x0 Size=0x10
        struct _unnamed_2143 ProfileNotification;// Offset=0x0 Size=0x8
        struct _unnamed_2144 PowerNotification;// Offset=0x0 Size=0x8
        struct _unnamed_2145 VetoNotification;// Offset=0x0 Size=0x8
        struct _unnamed_2146 BlockedDriverNotification;// Offset=0x0 Size=0x10
        struct _unnamed_2147 InvalidIDNotification;// Offset=0x0 Size=0x2
        struct _unnamed_2148 PowerSettingNotification;// Offset=0x0 Size=0x20
        struct _unnamed_2141 PropertyChangeNotification;// Offset=0x0 Size=0x2
        struct _unnamed_2141 DeviceInstanceNotification;// Offset=0x0 Size=0x2
    };
};

struct _PLUGPLAY_EVENT_BLOCK// Size=0x50 (Id=2150)
{
    ...
    union _unnamed_2149 u;// Offset=0x30 Size=0x20
};

struct _PNP_DEVICE_EVENT_ENTRY// Size=0xc0 (Id=1621)
{
