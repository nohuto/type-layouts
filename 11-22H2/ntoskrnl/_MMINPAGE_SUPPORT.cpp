...
union _unnamed_2210// Size=0x4 (Id=2210)
{
...
struct _MMINPAGE_SUPPORT_FLOW_THROUGH// Size=0x38 (Id=2261)
{
...
struct _MMINPAGE_SUPPORT// Size=0x1c0 (Id=2211)
{
    union // Size=0x10 (Id=0)
    {
    ...
    union _unnamed_2208 u2;// Offset=0x68 Size=0x30
    ...
    union _unnamed_2209 u3;// Offset=0xbc Size=0x4
    union _unnamed_2210 u1;// Offset=0xc0 Size=0x4
    union // Size=0x8 (Id=0)
    {
