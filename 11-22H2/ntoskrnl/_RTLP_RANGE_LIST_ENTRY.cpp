struct _unnamed_2013// Size=0x10 (Id=2013)
{
...
struct _unnamed_2014// Size=0x10 (Id=2014)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
};

struct _RTLP_RANGE_LIST_ENTRY// Size=0x38 (Id=2015)
{
    unsigned long long Start;// Offset=0x0 Size=0x8
    unsigned long long End;// Offset=0x8 Size=0x8
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_2013 Allocated;// Offset=0x10 Size=0x10
        struct _unnamed_2014 Merged;// Offset=0x10 Size=0x10
    };
