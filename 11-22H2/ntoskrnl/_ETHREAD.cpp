...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=1604)
{
...
struct _KAPC_STATE// Size=0x30 (Id=1480)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=1553)
{
...
struct _KTHREAD// Size=0x480 (Id=504)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=1594)
{
...
struct _KLOCK_ENTRY_LOCK_STATE// Size=0x10 (Id=1630)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
union _KLOCK_ENTRY_BOOST_BITMAP// Size=0x8 (Id=1047)
{
    unsigned long long AllFields;// Offset=0x0 Size=0x8
...
struct _KLOCK_ENTRY// Size=0x60 (Id=1028)
{
    union // Size=0x10 (Id=0)
    {
...
struct _ETHREAD// Size=0x910 (Id=526)
{
