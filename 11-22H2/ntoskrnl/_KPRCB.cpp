union _KPRCBFLAG// Size=0x4 (Id=1366)
{
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=978)
{
...
struct _KSTATIC_AFFINITY_BLOCK// Size=0x420 (Id=994)
{
...
struct _KSOFTWARE_INTERRUPT_BATCH// Size=0x110 (Id=1300)
{
...
struct _KTIMER_TABLE_ENTRY// Size=0x20 (Id=698)
{
...
struct _PROC_IDLE_POLICY// Size=0x6 (Id=2102)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=1841)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=1753)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=1769)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=2048)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROC_PERF_CHECK_CONTEXT// Size=0x48 (Id=1836)
{
...
struct _PROCESSOR_POWER_STATE// Size=0x238 (Id=1648)
{
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=1436)
{
    unsigned char Level;// Offset=0x0 Size=0x1
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=679)
{
...
struct _unnamed_477// Size=0x38 (Id=477)
{
...
struct _IOP_IRP_STACK_PROFILER// Size=0x54 (Id=1721)
{
    unsigned long Profile[20];// Offset=0x0 Size=0x50
    unsigned long TotalIrps;// Offset=0x50 Size=0x4
};

struct _KSECURE_FAULT_INFORMATION// Size=0x18 (Id=1243)
{
...
struct _KTIMER_EXPIRATION_TRACE// Size=0x10 (Id=1748)
{
...
struct _KCLOCK_TICK_TRACE// Size=0x28 (Id=1161)
{
...
struct _KCLOCK_INCREMENT_TRACE// Size=0x20 (Id=1850)
{
...
struct _KCLOCK_TIMER_STATE// Size=0x518 (Id=1055)
{
...
struct _MACHINE_FRAME// Size=0x28 (Id=2101)
{
...
struct _MACHINE_CHECK_CONTEXT// Size=0x50 (Id=1610)
{
