struct _RTL_HEAP_MEMORY_LIMIT_DATA// Size=0x20 (Id=1071)
{
...
union _RTL_RUN_ONCE// Size=0x8 (Id=1153)
{
...
struct _HEAP_OPPORTUNISTIC_LARGE_PAGE_STATS// Size=0x10 (Id=1866)
{
...
struct _RTL_HP_SEG_ALLOC_POLICY// Size=0x18 (Id=1402)
{
...
struct _HEAP_RUNTIME_MEMORY_STATS// Size=0x58 (Id=852)
{
...
struct _RTL_HP_HEAP_VA_CALLBACKS_ENCODED// Size=0x20 (Id=1223)
{
...
union _unnamed_850// Size=0x1 (Id=850)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _HEAP_SEG_CONTEXT// Size=0xc0 (Id=851)
{
    ...
    union _unnamed_850 Flags;// Offset=0xd Size=0x1
...
struct _HEAP_VS_DELAY_FREE_CONTEXT// Size=0x10 (Id=1293)
{
    union _SLIST_HEADER ListHead;// Offset=0x0 Size=0x10
};

struct _HEAP_SUBALLOCATOR_CALLBACKS// Size=0x28 (Id=818)
{
...
struct _unnamed_1156// Size=0x4 (Id=1156)
{
...
struct _RTL_HP_VS_CONFIG// Size=0x4 (Id=1157)
{
    struct _unnamed_1156 Flags;// Offset=0x0 Size=0x4
};

struct _HEAP_VS_CONTEXT// Size=0xc0 (Id=841)
{
...
struct _RTL_HP_LFH_CONFIG// Size=0x4 (Id=1360)
{
...
struct _SEGMENT_HEAP// Size=0x840 (Id=856)
{
