struct _DBGKD_READ_MEMORY32// Size=0xc (Id=731)
{
...
struct _DBGKD_WRITE_MEMORY32// Size=0xc (Id=733)
{
    unsigned long TargetBaseAddress;// Offset=0x0 Size=0x4
    unsigned long TransferCount;// Offset=0x4 Size=0x4
...
struct _DBGKD_WRITE_BREAKPOINT32// Size=0x8 (Id=735)
{
...
struct _DBGKD_READ_WRITE_IO32// Size=0xc (Id=737)
{
...
struct _DBGKD_READ_WRITE_IO_EXTENDED32// Size=0x18 (Id=739)
{
    unsigned long DataSize;// Offset=0x0 Size=0x4
...
struct _DBGKD_SET_SPECIAL_CALL32// Size=0x4 (Id=740)
{
    unsigned long SpecialCall;// Offset=0x0 Size=0x4
};

struct _DBGKD_SET_INTERNAL_BREAKPOINT32// Size=0x8 (Id=742)
{
    unsigned long BreakpointAddress;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
};

struct _DBGKD_GET_INTERNAL_BREAKPOINT32// Size=0x1c (Id=745)
{
    unsigned long BreakpointAddress;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
...
struct _DBGKD_GET_VERSION32// Size=0x28 (Id=1004)
{
...
struct _DBGKD_MANIPULATE_STATE32// Size=0x34 (Id=749)
{
    ...
    union _unnamed_748 u;// Offset=0xc Size=0x28
};
