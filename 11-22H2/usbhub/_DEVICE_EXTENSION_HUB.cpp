...
struct _DEBUG_LOG// Size=0x18 (Id=176)
{
...
struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=327)
{
...
union _USBHUB_FDO_FLAGS2// Size=0x4 (Id=406)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USBHUB_ERRATA_FLAGS// Size=0x4 (Id=279)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _USB_HUB_DESCRIPTOR// Size=0x47 (Id=419)
{
...
struct _KTIMER// Size=0x40 (Id=418)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _USB_BUS_INTERFACE_HUB_V9// Size=0x148 (Id=160)
{
...
struct _USB_BUS_INTERFACE_HUB_MINIDUMP// Size=0x28 (Id=212)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * BusContext;// Offset=0x8 Size=0x8
...
struct _USB_BUS_INTERFACE_HUB_SELECTIVE_SUSPEND// Size=0x30 (Id=213)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * BusContext;// Offset=0x8 Size=0x8
...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=285)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    struct // Size=0x4 (Id=0)
...
struct _HUB_GLOBAL_UXD_SETTINGS// Size=0x10 (Id=348)
{
...
struct _USB_TOPOLOGY_ADDRESS// Size=0x20 (Id=411)
{
...
struct _DEVICE_EXTENSION_HUB// Size=0x14a0 (Id=159)
{
