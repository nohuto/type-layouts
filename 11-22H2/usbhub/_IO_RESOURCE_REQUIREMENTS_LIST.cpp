...
struct _unnamed_463// Size=0x18 (Id=463)
{
...
struct _unnamed_466// Size=0x18 (Id=466)
{
...
struct _unnamed_470// Size=0x10 (Id=470)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_472// Size=0x18 (Id=472)
{
...
struct _unnamed_473// Size=0x18 (Id=473)
{
...
struct _unnamed_474// Size=0x18 (Id=474)
{
...
union _unnamed_476// Size=0x18 (Id=476)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_463 Port;// Offset=0x0 Size=0x18
        struct _unnamed_463 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_466 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_467 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_468 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_463 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_469 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_470 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_471 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_472 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_473 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_474 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_475 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=477)
{
    ...
    union _unnamed_476 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=453)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=373)
{
