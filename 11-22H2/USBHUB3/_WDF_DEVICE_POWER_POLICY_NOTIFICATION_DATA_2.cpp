...
struct _unnamed_507// Size=0x8 (Id=507)
{
...
union _unnamed_509// Size=0x8 (Id=509)
{
    struct _unnamed_507 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_508 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_507 LeaveState;// Offset=0x0 Size=0x8
};
...
struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=205)
{
    ...
    union _unnamed_509 Data;// Offset=0x4 Size=0x8
};
