...
struct _unnamed_261// Size=0x20 (Id=261)
{
...
union _unnamed_262// Size=0x20 (Id=262)
{
    struct _unnamed_35 Create;// Offset=0x0 Size=0x20
    struct _unnamed_259 Read;// Offset=0x0 Size=0x18
    struct _unnamed_259 Write;// Offset=0x0 Size=0x18
    struct _unnamed_260 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_261 Others;// Offset=0x0 Size=0x20
};

struct _WDF_REQUEST_PARAMETERS// Size=0x28 (Id=263)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned char MinorFunction;// Offset=0x2 Size=0x1
    enum _WDF_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    union _unnamed_262 Parameters;// Offset=0x8 Size=0x20
};
