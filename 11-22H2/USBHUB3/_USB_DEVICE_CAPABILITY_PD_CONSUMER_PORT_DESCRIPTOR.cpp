union _unnamed_666// Size=0x2 (Id=666)
{
...
struct _USB_DEVICE_CAPABILITY_PD_CONSUMER_PORT_DESCRIPTOR// Size=0x18 (Id=667)
{
    ...
    union _unnamed_666 bmCapabilities;// Offset=0x4 Size=0x2
