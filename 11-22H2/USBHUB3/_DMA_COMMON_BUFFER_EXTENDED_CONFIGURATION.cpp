...
struct _DMA_COMMON_BUFFER_EXTENDED_CONFIGURATION// Size=0x28 (Id=552)
{
    enum _DMA_COMMON_BUFFER_EXTENDED_CONFIGURATION_TYPE ConfigType;// Offset=0x0 Size=0x4
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_549 LogicalAddressLimits;// Offset=0x8 Size=0x10
        struct _unnamed_550 SubSection;// Offset=0x8 Size=0x10
