...
struct _unnamed_516// Size=0x8 (Id=516)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_517// Size=0x4 (Id=517)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_518// Size=0x8 (Id=518)
{
    struct _unnamed_516 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_517 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_516 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=519)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_518 Data;// Offset=0x4 Size=0x8
};
