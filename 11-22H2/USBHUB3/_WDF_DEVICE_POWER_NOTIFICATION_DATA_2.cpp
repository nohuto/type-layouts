...
struct _unnamed_542// Size=0x8 (Id=542)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_543// Size=0x4 (Id=543)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_544// Size=0x8 (Id=544)
{
    struct _unnamed_542 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_543 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_542 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=204)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_544 Data;// Offset=0x4 Size=0x8
};
