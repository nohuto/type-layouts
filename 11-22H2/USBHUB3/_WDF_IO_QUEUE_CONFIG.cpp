...
union _unnamed_286// Size=0x4 (Id=286)
{
    struct _unnamed_285 Parallel;// Offset=0x0 Size=0x4
};

struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=287)
{
    ...
    union _unnamed_286 Settings;// Offset=0x50 Size=0x4
