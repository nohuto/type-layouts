...
struct _PROCESSOR_NUMBER// Size=0x4 (Id=154)
{
...
struct _STOR_EVENT_QUEUE_ENTRY// Size=0x38 (Id=248)
{
...
struct _unnamed_252// Size=0x28 (Id=252)
{
...
union _unnamed_253// Size=0x18 (Id=253)
{
...
struct _EXTENDED_REQUEST_BLOCK// Size=0x320 (Id=254)
{
    ...
    struct _unnamed_252 SrbData;// Offset=0xb0 Size=0x28
    ...
    union _unnamed_253 u;// Offset=0x298 Size=0x18
...
struct _IO_RESOURCE_ENTRY// Size=0x450 (Id=342)
{
    ...
    struct _EXTENDED_REQUEST_BLOCK Xrb;// Offset=0x30 Size=0x320
    unsigned char SenseInfoBuffer[256];// Offset=0x350 Size=0x100
