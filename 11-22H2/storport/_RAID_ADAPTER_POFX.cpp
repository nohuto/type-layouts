union _unnamed_363// Size=0x4 (Id=363)
{
...
struct _PO_FX_PERF_STATE_CHANGE// Size=0x10 (Id=664)
{
...
struct _RAID_ADAPTER_POFX// Size=0x90 (Id=364)
{
    ...
    union _unnamed_363 InterlockedFlags;// Offset=0x78 Size=0x4
