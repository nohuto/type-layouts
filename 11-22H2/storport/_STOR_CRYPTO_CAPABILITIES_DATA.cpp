...
struct _STOR_CRYPTO_CAPABILITY// Size=0x14 (Id=585)
{
...
struct _STOR_CRYPTO_CAPABILITIES_DATA// Size=0x20 (Id=177)
{
    unsigned long Version;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
    unsigned short NumKeysSupported;// Offset=0x8 Size=0x2
    unsigned short NumCryptoCapabilities;// Offset=0xa Size=0x2
    struct _STOR_CRYPTO_CAPABILITY CryptoCapabilities[1];// Offset=0xc Size=0x14
};
