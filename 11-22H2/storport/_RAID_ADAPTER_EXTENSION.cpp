...
union _unnamed_303// Size=0x10 (Id=303)
{
    union // Size=0x10 (Id=0)
    {
        ...
        struct // Size=0xd (Id=0)
        {
            ...
            unsigned char ResetInProgress:1;// Offset=0x7 Size=0x1 BitOffset=0x2 BitSize=0x1
            ...
            unsigned long long Reserved:1;// Offset=0x8 Size=0x8 BitOffset=0x0 BitSize=0x1
        };
...
union _unnamed_304// Size=0x8 (Id=304)
{
    struct // Size=0x1 (Id=0)
    {
        unsigned char IsNVMeOverTunneledDevice:1;// Offset=0x0 Size=0x1 BitOffset=0x0 BitSize=0x1
        unsigned char D3InModernStandbyEnabled:1;// Offset=0x0 Size=0x1 BitOffset=0x1 BitSize=0x1
    };
    unsigned long long AsUlonglong;// Offset=0x0 Size=0x8
};

union _unnamed_305// Size=0x4 (Id=305)
{
...
struct _STOR_LOCKED_LIST// Size=0x20 (Id=337)
{
...
struct _RAID_POWER_STATE// Size=0x10 (Id=343)
{
...
struct _RAID_RESOURCE_LIST// Size=0x10 (Id=347)
{
...
struct _MEMORY_REGION// Size=0x18 (Id=742)
{
...
struct _PORT_CONFIGURATION_INFORMATION// Size=0xe0 (Id=335)
{
...
struct _UNIT_CONTROL_LIST// Size=0x14 (Id=876)
{
    unsigned long MaxControlType;// Offset=0x0 Size=0x4
    unsigned char SupportedTypeList[15];// Offset=0x4 Size=0xf
};

struct _ADAPTER_CONTROL_LIST// Size=0x20 (Id=763)
{
    unsigned long MaxControlType;// Offset=0x0 Size=0x4
    unsigned char SupportedTypeList[27];// Offset=0x4 Size=0x1b
};

struct _RAID_MINIPORT// Size=0x140 (Id=339)
{
    ...
    struct _unnamed_338 Flags;// Offset=0xf8 Size=0x1
    struct _UNIT_CONTROL_LIST UnitControlList;// Offset=0xfc Size=0x14
    struct _ADAPTER_CONTROL_LIST AdapterControlList;// Offset=0x110 Size=0x20
    unsigned long FeatureCount;// Offset=0x130 Size=0x4
    unsigned char FeatureList[10];// Offset=0x134 Size=0xa
};

struct _BUS_INTERFACE_STANDARD// Size=0x40 (Id=974)
{
...
struct _RAID_BUS_INTERFACE// Size=0x48 (Id=942)
{
...
struct _unnamed_308// Size=0x50 (Id=308)
{
    struct _RAID_DEFERRED_ELEMENT Timer;// Offset=0x0 Size=0x50
};

struct _unnamed_309// Size=0xb0 (Id=309)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=608)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KTIMER// Size=0x40 (Id=366)
{
...
struct _RAID_ADAPTER_PARAMETERS// Size=0x38 (Id=890)
{
...
struct _unnamed_311// Size=0x1 (Id=311)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _RAID_POWER_CONTEXT// Size=0xb8 (Id=639)
{
...
struct _PCI_HEADER_TYPE_0// Size=0x30 (Id=749)
{
...
struct _PCI_HEADER_TYPE_1// Size=0x30 (Id=945)
{
...
struct _unnamed_966// Size=0x8 (Id=966)
{
    unsigned long Base;// Offset=0x0 Size=0x4
    unsigned long Limit;// Offset=0x4 Size=0x4
};

struct _PCI_HEADER_TYPE_2// Size=0x30 (Id=967)
{
    ...
    unsigned char SubordinateBus;// Offset=0xa Size=0x1
    unsigned char SecondaryLatency;// Offset=0xb Size=0x1
    struct _unnamed_966 Range[4];// Offset=0xc Size=0x20
    unsigned char InterruptLine;// Offset=0x2c Size=0x1
    unsigned char InterruptPin;// Offset=0x2d Size=0x1
    unsigned short BridgeControl;// Offset=0x2e Size=0x2
};

union _unnamed_668// Size=0x30 (Id=668)
{
...
struct _PCI_COMMON_HEADER// Size=0x40 (Id=669)
{
    ...
    union _unnamed_668 u;// Offset=0x10 Size=0x30
};
...
struct _CRASHDUMP_FUNCTIONS_INTERFACE// Size=0x28 (Id=867)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
struct _STOR_ADDRESS// Size=0x10 (Id=150)
{
...
struct _RAID_RPMB_CAPABILITIES// Size=0x38 (Id=593)
{
...
struct _RAID_CRYPTO_KEY_TABLE// Size=0x18 (Id=619)
{
...
struct _unnamed_715// Size=0x4 (Id=715)
{
    struct // Size=0x4 (Id=0)
    {
...
union _DSM_PCI_SSD_LED_STATE// Size=0x4 (Id=716)
{
    struct _unnamed_715 State;// Offset=0x0 Size=0x4
    unsigned long AsUlong;// Offset=0x0 Size=0x4
};

struct _unnamed_299// Size=0x20 (Id=299)
{
...
struct _unnamed_561// Size=0x4 (Id=561)
{
    struct // Size=0x4 (Id=0)
    {
...
union _STORAGE_INDICATOR_STATE// Size=0x4 (Id=562)
{
    struct _unnamed_561 State;// Offset=0x0 Size=0x4
    unsigned long AsUlong;// Offset=0x0 Size=0x4
};

struct _PCI_MSIX_TABLE_CONFIG_INTERFACE// Size=0x48 (Id=688)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
union _unnamed_634// Size=0x4 (Id=634)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _RAID_MINIPORT_SYSTEM_THREAD_CONTEXT// Size=0x10 (Id=635)
{
    union _unnamed_634 StateFlags;// Offset=0x0 Size=0x4
...
struct _unnamed_315// Size=0x4 (Id=315)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _RAID_ADAPTER_EXTENSION// Size=0x17c0 (Id=317)
{
    ...
    union _unnamed_303 Flags;// Offset=0x68 Size=0x10
    union _unnamed_304 Flags2;// Offset=0x78 Size=0x8
    struct _IO_RESOURCE_ENTRY * ReservedScsiMiniportResource;// Offset=0x80 Size=0x8
    union _unnamed_305 InterlockedFlags;// Offset=0x88 Size=0x4
    struct _STOR_LOCKED_LIST UnitList;// Offset=0x90 Size=0x20
    struct _STOR_DICTIONARY UnitDictionary;// Offset=0xb0 Size=0x30
    struct _STOR_LOCKED_LIST ZombieList;// Offset=0xe0 Size=0x20
    ...
    struct _RAID_MINIPORT Miniport;// Offset=0x150 Size=0x140
    struct _RAID_BUS_INTERFACE Bus;// Offset=0x290 Size=0x48
    struct _KINTERRUPT * Interrupt;// Offset=0x2d8 Size=0x8
    unsigned long InterruptIrql;// Offset=0x2e0 Size=0x4
    unsigned long InterruptVersion;// Offset=0x2e4 Size=0x4
    unsigned long long StartIoLock;// Offset=0x2e8 Size=0x8
    enum _STOR_SYNCHRONIZATION_MODEL IoModel;// Offset=0x2f0 Size=0x4
    struct _RAID_DMA_ADAPTER Dma;// Offset=0x2f8 Size=0x20
    struct _RAID_MEMORY_REGION UncachedExtension;// Offset=0x318 Size=0x18
    unsigned long BusNumber;// Offset=0x330 Size=0x4
    unsigned long SlotNumber;// Offset=0x334 Size=0x4
    unsigned long Device;// Offset=0x338 Size=0x4
    unsigned long Function;// Offset=0x33c Size=0x4
    struct _MAPPED_ADDRESS * MappedAddressList;// Offset=0x340 Size=0x8
    struct _STOR_IO_GATEWAY * Gateway;// Offset=0x380 Size=0x8
    unsigned long InUseGatewayCount;// Offset=0x388 Size=0x4
    unsigned long AllocatedGatewayCount;// Offset=0x38c Size=0x4
    unsigned long ProcessorCountPerGateway;// Offset=0x390 Size=0x4
    unsigned long IoResourceReclaimTolerancePeriodLimit;// Offset=0x394 Size=0x4
    unsigned long LowWaterMarkForAdapter;// Offset=0x398 Size=0x4
    unsigned long AdapterPauseCount;// Offset=0x39c Size=0x4
    unsigned long AdapterBusyCount;// Offset=0x3a0 Size=0x4
    unsigned long AdapterSlowPathCount;// Offset=0x3a4 Size=0x4
    struct _RAID_DEFERRED_QUEUE DeferredQueue;// Offset=0x3b0 Size=0x80
    struct _unnamed_308 DeferredList;// Offset=0x430 Size=0x50
    struct _unnamed_309 DeferredPauseResumeContext;// Offset=0x480 Size=0xb0
    struct _RAID_DEFERRED_QUEUE WmiDeferredQueue;// Offset=0x530 Size=0x80
    struct _KDPC TimerDpc;// Offset=0x5b0 Size=0x40
    struct _KTIMER Timer;// Offset=0x5f0 Size=0x40
    struct _KDPC PauseTimerDpc;// Offset=0x630 Size=0x40
    struct _KDPC RestartDpc;// Offset=0x670 Size=0x40
    struct _KTIMER PauseTimer;// Offset=0x6b0 Size=0x40
    void  ( * HwTimerRoutine)(void * );// Offset=0x6f0 Size=0x8
    struct _KDPC CompletionDpc;// Offset=0x6f8 Size=0x40
    struct _KDPC BusChangeDpc;// Offset=0x738 Size=0x40
    struct _UNICODE_STRING PnpInterfaceName;// Offset=0x778 Size=0x10
    unsigned long AdapterNumber;// Offset=0x788 Size=0x4
    void * DriverParameters;// Offset=0x790 Size=0x8
    struct _PORT_REGISTRY_INFO RegistryInfo;// Offset=0x798 Size=0x40
    unsigned long LinkDownTimeoutValue;// Offset=0x7d8 Size=0x4
    unsigned long LinkUp;// Offset=0x7dc Size=0x4
    void * BusKeyArray[255];// Offset=0x7e0 Size=0x7f8
    long ProcessingDeferredItems;// Offset=0xfd8 Size=0x4
    unsigned long DefaultTimeout;// Offset=0xfdc Size=0x4
    unsigned long AdditionalTimers;// Offset=0xfe0 Size=0x4
    struct _KTIMER ResetHoldTimer;// Offset=0xfe8 Size=0x40
    struct _KDPC ResetHoldDpc;// Offset=0x1028 Size=0x40
    union _LARGE_INTEGER LastScanTime;// Offset=0x1068 Size=0x8
    struct _RAID_ADAPTER_PARAMETERS Parameters;// Offset=0x1070 Size=0x38
    unsigned char  ( * HwPassiveInitRoutine)(void * );// Offset=0x10a8 Size=0x8
    enum _INTERRUPT_SYNCHRONIZATION_MODE MsiMode;// Offset=0x10b0 Size=0x4
    unsigned long long MSIInterruptLock;// Offset=0x10b8 Size=0x8
    struct _IO_INTERRUPT_MESSAGE_INFO * MSIMessageInfo;// Offset=0x10c0 Size=0x8
    struct _GROUP_AFFINITY * MSIMessageGroupAffinity;// Offset=0x10c8 Size=0x8
    unsigned char MSISupported;// Offset=0x10d0 Size=0x1
    unsigned char MSIEnabled;// Offset=0x10d1 Size=0x1
    unsigned char Contiguous;// Offset=0x10d2 Size=0x1
    struct _unnamed_311 PerfOptFlags;// Offset=0x10d3 Size=0x1
    struct _DEVICE_RELATIONS * DeviceRelations;// Offset=0x10d8 Size=0x8
    struct _RAID_POWER_CONTEXT PowerContext;// Offset=0x10e0 Size=0xb8
    struct _STORPORT_EXTENDED_FUNCTIONS ExtendedFunctions;// Offset=0x1198 Size=0x58
    unsigned long DeviceNode;// Offset=0x11f0 Size=0x4
    union _RAID_REDIRECTION_SUPPORT RedirectionSupport;// Offset=0x11f4 Size=0x2
    unsigned short InterruptRedirectionGroups;// Offset=0x11f6 Size=0x2
    long ConcurrentChannels;// Offset=0x11f8 Size=0x4
    struct _RAID_CONCURRENT_CHANNEL_TOKEN_LIST * ConcurrentChannelTokens;// Offset=0x1200 Size=0x8
    unsigned char * InterruptRedirectionTable;// Offset=0x1208 Size=0x8
    unsigned long HierarchicalResetSucceededAtBus;// Offset=0x1210 Size=0x4
    unsigned long HierarchicalResetSucceededAtTarget;// Offset=0x1214 Size=0x4
    unsigned long HierarchicalResetSucceededAtLun;// Offset=0x1218 Size=0x4
    unsigned long HierarchicalResetCountInternal;// Offset=0x121c Size=0x4
    unsigned long HierarchicalResetCountApp;// Offset=0x1220 Size=0x4
    unsigned long MaxDpcCompletionCount;// Offset=0x1224 Size=0x4
    unsigned long MaxDpcCompletionTimeTicks;// Offset=0x1228 Size=0x4
    unsigned long CompletionsForLongestDpc;// Offset=0x122c Size=0x4
    wchar_t * MiniportName;// Offset=0x1230 Size=0x8
    wchar_t * AdapterId;// Offset=0x1238 Size=0x8
    struct _PCI_COMMON_HEADER PciConfiguration;// Offset=0x1240 Size=0x40
    struct _STOR_POWER_SETTING_NOTIFICATION PowerSettingNotification;// Offset=0x1280 Size=0x18
    long StateChangeInProgress;// Offset=0x1298 Size=0x4
    unsigned long StateChangedEntity;// Offset=0x129c Size=0x4
    unsigned long StateChangeEntityAttributes;// Offset=0x12a0 Size=0x4
    struct _STOR_ADDRESS * StateChangeAddress;// Offset=0x12a8 Size=0x8
    void  ( * HwStateChange)(void * ,void * ,short ,void * ,unsigned long );// Offset=0x12b0 Size=0x8
    void * StateChangeContext;// Offset=0x12b8 Size=0x8
    struct _RTL_BITMAP BusesWithVmLunsBitmap;// Offset=0x12c0 Size=0x10
    unsigned long * BusesWithVmLunsBitmapBuffer;// Offset=0x12d0 Size=0x8
    unsigned long NumWorkItems;// Offset=0x12d8 Size=0x4
    unsigned char DefaultSenseByteCount;// Offset=0x12dc Size=0x1
    unsigned char DumpPowerReady;// Offset=0x12dd Size=0x1
    unsigned char MaxDumpLevelEnabled;// Offset=0x12de Size=0x1
    unsigned char VendorSpecificLogPageAddress;// Offset=0x12df Size=0x1
    unsigned long MaxDeviceDumpSize;// Offset=0x12e0 Size=0x4
    unsigned long long IoLatencyCap;// Offset=0x12e8 Size=0x8
    unsigned long RaidLogListIndex;// Offset=0x1300 Size=0x4
    unsigned long RaidLogListSize;// Offset=0x1304 Size=0x4
    struct _RAID_LOG_ENTRY * RaidLogList;// Offset=0x1308 Size=0x8
    union _SLIST_HEADER UnitsPendingPowerUpList;// Offset=0x1310 Size=0x10
    struct _RAID_ADAPTER_POFX * PoFx;// Offset=0x1320 Size=0x8
    void * LowPowerEpochHandle;// Offset=0x1328 Size=0x8
    unsigned long D3IdleTimeout;// Offset=0x1330 Size=0x4
    void * CoalescingRegistration;// Offset=0x1338 Size=0x8
    void * MaxPowerHandle;// Offset=0x1340 Size=0x8
    struct _UNICODE_STRING CoolingInterfaceSymlink;// Offset=0x1348 Size=0x10
    struct _RAID_UNIT_EXTENSION * CrashDumpUnit;// Offset=0x1358 Size=0x8
    struct _CRASHDUMP_FUNCTIONS_INTERFACE ParentCrashdumpInterface;// Offset=0x1360 Size=0x28
    struct _GUID AdapterGuid;// Offset=0x1388 Size=0x10
    wchar_t * AdapterSerialNumber;// Offset=0x1398 Size=0x8
    unsigned long CompletionsDuringReset;// Offset=0x13a0 Size=0x4
    struct _unnamed_312 TelemetryHierarchicalResetLunBucket[5];// Offset=0x13a4 Size=0x3c
    struct _unnamed_312 TelemetryHierarchicalResetTargetBucket[5];// Offset=0x13e0 Size=0x3c
    unsigned long long LastCSStateChange;// Offset=0x1420 Size=0x8
    unsigned long long LastIOCoalescingOnStartTime;// Offset=0x1428 Size=0x8
    unsigned long long IOCoalescingOnDuration;// Offset=0x1430 Size=0x8
    unsigned long long FirstDPNRTimeAfterCS;// Offset=0x1438 Size=0x8
    unsigned long long LastDPNRStartTime;// Offset=0x1440 Size=0x8
    unsigned long long DPNRDurationInCS;// Offset=0x1448 Size=0x8
    unsigned long long LastF1StartTime;// Offset=0x1450 Size=0x8
    unsigned long long F1DurationInCS;// Offset=0x1458 Size=0x8
    unsigned long long ActiveReferencesInCS;// Offset=0x1460 Size=0x8
    unsigned long long ActiveReferencesInCoalescing;// Offset=0x1468 Size=0x8
    unsigned long UnitTimeoutsInCS;// Offset=0x1470 Size=0x4
    unsigned long F0TransitionsSinceCSStateChange;// Offset=0x1474 Size=0x4
    unsigned long D0TransitionsSinceCSStateChange;// Offset=0x1478 Size=0x4
    unsigned long F0TransitionsLongSinceCSStateChange;// Offset=0x147c Size=0x4
    unsigned long D0TransitionsLongSinceCSStateChange;// Offset=0x1480 Size=0x4
    unsigned long long FirstDFxPowerDownTimeAfterCS;// Offset=0x1488 Size=0x8
    unsigned long long LastDFxPowerDownStartTime;// Offset=0x1490 Size=0x8
    unsigned long long DFxPowerDownDurationInCS;// Offset=0x1498 Size=0x8
    unsigned char TopologyInfoLogged;// Offset=0x14a0 Size=0x1
    unsigned long PeriodicMaxGatewayQueueDepthAtSwTimeout;// Offset=0x14a4 Size=0x4
    unsigned long PauseCount;// Offset=0x14a8 Size=0x4
    unsigned long BusyCount;// Offset=0x14ac Size=0x4
    unsigned char DisableTelemetryDeviceHealth;// Offset=0x14b0 Size=0x1
    unsigned long MiniportFirmwareDataStructureVersion;// Offset=0x14b4 Size=0x4
    struct _D3COLD_SUPPORT_INTERFACE * D3ColdInterface;// Offset=0x14b8 Size=0x8
    struct _DEVICE_RESET_INTERFACE_STANDARD * ResetInterface;// Offset=0x14c0 Size=0x8
    void * ProtocolCommandEffects;// Offset=0x14c8 Size=0x8
    struct _KTIMER QueueWaitCheckTimer;// Offset=0x14d0 Size=0x40
    struct _KDPC QueueWaitCheckDpc;// Offset=0x1510 Size=0x40
    unsigned long long QosLock;// Offset=0x1550 Size=0x8
    unsigned long QosUnitCountForWaitTimeout;// Offset=0x1558 Size=0x4
    struct _RAID_RPMB_CAPABILITIES Rpmb;// Offset=0x1560 Size=0x38
    struct _STOR_HMB_RANGE * HmbRangeList;// Offset=0x1598 Size=0x8
    unsigned long PowerSrbTimeout;// Offset=0x15a0 Size=0x4
    struct _STOR_CRYPTO_CAPABILITIES_DATA * CryptoCapabilities;// Offset=0x15a8 Size=0x8
    struct _RAID_CRYPTO_KEY_TABLE CryptoKeyTable;// Offset=0x15b0 Size=0x18
    unsigned long ZoneDeviceWriteErrors;// Offset=0x15c8 Size=0x4
    unsigned long ZoneDeviceErrors;// Offset=0x15cc Size=0x4
    unsigned long ZoneWriteOverflowEntries;// Offset=0x15d0 Size=0x4
    unsigned long BusyRetryCount;// Offset=0x15d4 Size=0x4
    unsigned long BusyPauseTimeInMs;// Offset=0x15d8 Size=0x4
    struct _RAID_SHARED_WORK_ITEM_CONTEXT PowerWorkItem;// Offset=0x15e0 Size=0x18
    struct _NPEM_CONTROL_INTERFACE * NpemControlInterface;// Offset=0x15f8 Size=0x8
    unsigned long DsmLedSupportedFunction;// Offset=0x1600 Size=0x4
    union _DSM_PCI_SSD_LED_STATE DsmLedSupportedStates;// Offset=0x1604 Size=0x4
    struct _UNICODE_STRING NonPoFxMiniportInterfaceName;// Offset=0x1608 Size=0x10
    struct _unnamed_299 DFxQueue;// Offset=0x1618 Size=0x20
    union _STORAGE_INDICATOR_STATE LedState;// Offset=0x1638 Size=0x4
    unsigned long PciDeviceType;// Offset=0x163c Size=0x4
    long DeferredUpdateAssociatedUnitsIdentityItems;// Offset=0x1640 Size=0x4
    struct _KTIMER IoResourceReclaimTimer;// Offset=0x1648 Size=0x40
    struct _KDPC IoResourceReclaimTimerDpc;// Offset=0x1688 Size=0x40
    struct _PCI_MSIX_TABLE_CONFIG_INTERFACE MSIXTableConfigInterface;// Offset=0x16c8 Size=0x48
    unsigned short EventCount[3];// Offset=0x1710 Size=0x6
    struct NVME_IDENTIFY_CONTROLLER_DATA * IdentifyControllerData;// Offset=0x1718 Size=0x8
    struct _RAID_MINIPORT_SYSTEM_THREAD_CONTEXT MiniportSystemThreadContext;// Offset=0x1720 Size=0x10
    unsigned long PoFxPlaceHolderD3IdleTimeout;// Offset=0x1730 Size=0x4
    struct _UNICODE_STRING MFNDInterfaceName;// Offset=0x1738 Size=0x10
    enum _MFND_OPERATION_PRIVILEGE MFNDOperationPrivilege;// Offset=0x1748 Size=0x4
    enum _MFND_OPERATION_MODE MFNDOperationMode;// Offset=0x174c Size=0x4
    struct _IDENTIFY_MFND_CAPABILITY_INFORMATION * MFNDCapabilities;// Offset=0x1750 Size=0x8
    unsigned long PoweredDownUnitCount;// Offset=0x1758 Size=0x4
    unsigned long BusSpecificResetTimeoutInSeconds;// Offset=0x175c Size=0x4
    unsigned long PLDRTimeoutInSeconds;// Offset=0x1760 Size=0x4
    void * PdcIdleResiliencyEngagedHandle;// Offset=0x1768 Size=0x8
    struct _REGISTRY_WATCH_CONTEXT * RegWatchContext;// Offset=0x1770 Size=0x8
    unsigned char * TcgContext[6240];// Offset=0x1778 Size=0x8
    struct _TCG_DEVICE_PROPERTIES * TcgProperties;// Offset=0x1780 Size=0x8
    struct _KLOCK_QUEUE_HANDLE * GatewayLockHandleArray;// Offset=0x1788 Size=0x8
    struct NVME_FEATURE_MFND_CHILD_CONTROLLER_PROPERTY * MFNDCCProperty;// Offset=0x1790 Size=0x8
    struct _KEVENT DeviceStartEventForReset;// Offset=0x1798 Size=0x18
    struct _unnamed_316 NVMeDiagnostics;// Offset=0x17b0 Size=0xc
};
