...
struct _OWNER_ENTRY// Size=0x10 (Id=753)
{
...
struct _ERESOURCE// Size=0x68 (Id=659)
{
...
struct _WORK_QUEUE_ITEM// Size=0x20 (Id=22)
{
...
struct _REGISTRY_WATCH_CONTEXT// Size=0xc0 (Id=747)
{
    void * CallbackContext;// Offset=0x0 Size=0x8
    void  ( * CallbackRoutine)(void * );// Offset=0x8 Size=0x8
    ...
    struct _KEVENT StopEvent;// Offset=0xa0 Size=0x18
    unsigned short Count;// Offset=0xb8 Size=0x2
};
