...
struct _QUEUE_TAG_LIST// Size=0x80 (Id=219)
{
...
struct _EX_RUNDOWN_REF// Size=0x8 (Id=783)
{
    union // Size=0x8 (Id=0)
    {
...
struct _EXTENDED_DEVICE_QUEUE// Size=0xc0 (Id=243)
{
...
struct _IO_QUEUE// Size=0xe0 (Id=242)
{
...
struct _RAID_IO_RESOURCES// Size=0x20 (Id=302)
{
...
struct _RAID_UNIT_REGISTRY_PARAMETERS// Size=0x18 (Id=568)
{
...
struct _RAID_UNIT_ATTRIBUTES// Size=0x4 (Id=793)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _RAID_WORK_ITEM_CONTEXT// Size=0x10 (Id=651)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
    struct _IRP * Irp;// Offset=0x8 Size=0x8
};

struct _STOR_ASYNC_NOTIFY_CONTEXT// Size=0x18 (Id=591)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
...
struct _RAID_TELEMETRY_NODE_COUNTERS// Size=0x18 (Id=540)
{
...
struct _RAID_TELEMETRY_SAMPLED_ERROR_LOG// Size=0x1c8 (Id=804)
{
...
struct _RAID_UNIT_QOS// Size=0x30 (Id=939)
{
...
struct _unnamed_298// Size=0x4 (Id=298)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _RAID_UNIT_EXTENSION// Size=0xdc0 (Id=301)
{
    ...
    struct _IO_QUEUE IoQueue;// Offset=0x280 Size=0xe0
    unsigned long MaxQueueDepth;// Offset=0x360 Size=0x4
    unsigned long LogicalSectorSize;// Offset=0x364 Size=0x4
    enum _STORAGE_POWERUP_REASON_TYPE PowerupReason;// Offset=0x368 Size=0x4
    struct ACPI_INTERFACE_STANDARD2 AcpiInterface;// Offset=0x370 Size=0x58
    long OutstandingCount;// Offset=0x3c8 Size=0x4
    unsigned long PagingPathCount;// Offset=0x3cc Size=0x4
    unsigned long CrashDumpPathCount;// Offset=0x3d0 Size=0x4
    unsigned long HiberPathCount;// Offset=0x3d4 Size=0x4
    struct _KTIMER PendingTimer;// Offset=0x3d8 Size=0x40
    struct _KDPC PendingDpc;// Offset=0x418 Size=0x40
    struct _KTIMER PauseTimer;// Offset=0x458 Size=0x40
    struct _KDPC PauseTimerDpc;// Offset=0x498 Size=0x40
    struct _KDPC RestartDpc;// Offset=0x4d8 Size=0x40
    struct _RAID_MEMORY_REGION * CommonBufferVAs;// Offset=0x518 Size=0x8
    unsigned long CommonBufferSize;// Offset=0x520 Size=0x4
    unsigned long CommonBufferBlocks;// Offset=0x524 Size=0x4
    unsigned long DefaultTimeout;// Offset=0x528 Size=0x4
    long OutstandingResetCount;// Offset=0x52c Size=0x4
    unsigned long HierarchicalResetSuccessCount;// Offset=0x530 Size=0x4
    unsigned long long LastHierarchicalResetEndTime;// Offset=0x538 Size=0x8
    struct _unnamed_293 DeferredList;// Offset=0x540 Size=0x190
    struct _RAID_IO_RESOURCES ResetResources;// Offset=0x6d0 Size=0x20
    long ResetResourcesAcquired;// Offset=0x6f0 Size=0x4
    unsigned char SenseInfoSize;// Offset=0x6f4 Size=0x1
    unsigned char CallFreeDumpPtrSRB;// Offset=0x6f5 Size=0x1
    unsigned char DumpPowerReady;// Offset=0x6f6 Size=0x1
    unsigned char StackDumpPowerReady;// Offset=0x6f7 Size=0x1
    struct _EX_RUNDOWN_REF_CACHE_AWARE * PoFxRundownProtection;// Offset=0x6f8 Size=0x8
    struct _RAID_UNIT_POFX * PoFx;// Offset=0x700 Size=0x8
    struct _D3COLD_SUPPORT_INTERFACE * D3ColdInterface;// Offset=0x708 Size=0x8
    long PowerUpRequired;// Offset=0x710 Size=0x4
    long PowerDownRequired;// Offset=0x714 Size=0x4
    struct _IO_WORKITEM * HierarchicalResetWorkItem;// Offset=0x718 Size=0x8
    long HierarchicalResetWorkItemTimeoutCountdown;// Offset=0x720 Size=0x4
    long HierarchicalResetSrbTimeoutCountdown;// Offset=0x724 Size=0x4
    unsigned long HierarchicalResetAbortCount;// Offset=0x728 Size=0x4
    unsigned long long HierarchicalResetWorkItemSpinLock;// Offset=0x730 Size=0x8
    struct _RAID_UNIT_REGISTRY_PARAMETERS RegistryParameters;// Offset=0x738 Size=0x18
    struct _RAID_UNIT_ATTRIBUTES UnitAttributes;// Offset=0x750 Size=0x4
    struct _UNICODE_STRING VmLunPnpInterfaceName;// Offset=0x758 Size=0x10
    struct _RAID_WORK_ITEM_CONTEXT QuiesceDeviceWorkItem;// Offset=0x768 Size=0x10
    struct _STOR_ASYNC_NOTIFY_CONTEXT StorAsyncNotify;// Offset=0x778 Size=0x18
    struct _RAID_SHARED_WORK_ITEM_CONTEXT PowerWorkItem;// Offset=0x790 Size=0x18
    struct _unnamed_296 PendingPowerUpContext;// Offset=0x7a8 Size=0x10
    struct _SLIST_ENTRY PendingPowerUpListEntry;// Offset=0x7c0 Size=0x10
    struct _UNICODE_STRING SesPnpInterfaceName;// Offset=0x7d0 Size=0x10
    unsigned long long IoCountDelayedByLatencyCap;// Offset=0x7e0 Size=0x8
    struct _GUID DeviceGuid;// Offset=0x7e8 Size=0x10
    struct _TELEMETRY_UNIT_EXTENSION TelemetryExtension;// Offset=0x7f8 Size=0x8
    unsigned long long FirstDPNRTimeAfterCS;// Offset=0x800 Size=0x8
    unsigned long long LastF1StartTime;// Offset=0x808 Size=0x8
    unsigned long long F1DurationInCS;// Offset=0x810 Size=0x8
    unsigned long long LastDPNRStartTime;// Offset=0x818 Size=0x8
    unsigned long long DPNRDurationInCS;// Offset=0x820 Size=0x8
    unsigned long long ActiveReferencesInCS;// Offset=0x828 Size=0x8
    unsigned long long ActiveReferencesInCoalescing;// Offset=0x830 Size=0x8
    unsigned long UnitTimeoutsInCS;// Offset=0x838 Size=0x4
    unsigned long F0TransitionsSinceCSStateChange;// Offset=0x83c Size=0x4
    unsigned long D0TransitionsSinceCSStateChange;// Offset=0x840 Size=0x4
    unsigned long F0TransitionsLongSinceCSStateChange;// Offset=0x844 Size=0x4
    unsigned long D0TransitionsLongSinceCSStateChange;// Offset=0x848 Size=0x4
    unsigned long long FirstDFxPowerDownTimeAfterCS;// Offset=0x850 Size=0x8
    unsigned long long LastDFxPowerDownStartTime;// Offset=0x858 Size=0x8
    unsigned long long DFxPowerDownDurationInCS;// Offset=0x860 Size=0x8
    unsigned long long UnresponsiveRequests;// Offset=0x868 Size=0x8
    unsigned long long QosGuaranteeFailures;// Offset=0x870 Size=0x8
    unsigned long long TimeoutsInGateway;// Offset=0x878 Size=0x8
    unsigned long long TimeoutsInLunQueue;// Offset=0x880 Size=0x8
    unsigned long TimeoutsInMiniport;// Offset=0x888 Size=0x4
    unsigned long PeriodicMaxDeviceCountAtSwTimeout;// Offset=0x88c Size=0x4
    unsigned long PauseDeviceCount;// Offset=0x890 Size=0x4
    unsigned long DeviceBusyCount;// Offset=0x894 Size=0x4
    unsigned long BusyCompletionCount;// Offset=0x898 Size=0x4
    unsigned long ZoneDeviceWriteErrors;// Offset=0x89c Size=0x4
    unsigned long ZoneWriteOverflowEntries;// Offset=0x8a0 Size=0x4
    unsigned long long TotalDeviceQueueIoCount;// Offset=0x8a8 Size=0x8
    unsigned long long TotalDeviceQueueIoWaitDuration;// Offset=0x8b0 Size=0x8
    unsigned long long MaxDeviceQueueIoWaitDuration;// Offset=0x8b8 Size=0x8
    unsigned long long DeviceQueueIoWaitExceededTimeoutCount;// Offset=0x8c0 Size=0x8
    unsigned long long DeviceQueueIoBusyCount;// Offset=0x8c8 Size=0x8
    unsigned long long DeviceQueueIoPausedCount;// Offset=0x8d0 Size=0x8
    unsigned long long DeviceQueueIoUntaggedCommandOutstandingCount;// Offset=0x8d8 Size=0x8
    unsigned long long DeviceQueueIoPausedForUntaggedCount;// Offset=0x8e0 Size=0x8
    unsigned long long DeviceQueueIoExceededThresholdCount;// Offset=0x8e8 Size=0x8
    unsigned long HighLatencyIoCount;// Offset=0x8f0 Size=0x4
    unsigned long StorpTraceLoggingPerformanceEnabled;// Offset=0x8f4 Size=0x4
    struct _RAID_TELEMETRY_LATENCY_BUCKET * TelemetryLatencyBuckets;// Offset=0x8f8 Size=0x8
    struct _RAID_TELEMETRY_IO_SIZE_BUCKET * TelemetryIoSizeBuckets;// Offset=0x900 Size=0x8
    union _LARGE_INTEGER TelemetryLastPerfCollectionTimeStamp;// Offset=0x908 Size=0x8
    struct _RAID_TELEMETRY_LATENCY_BUCKET * TelemetryPreviousLatencyBuckets;// Offset=0x910 Size=0x8
    struct _RAID_TELEMETRY_IO_SIZE_BUCKET * TelemetryPreviousIoSizeBuckets;// Offset=0x918 Size=0x8
    struct _RAID_TELEMETRY_NODE_COUNTERS * TelemetryCountersPerNumaNode;// Offset=0x920 Size=0x8
    struct _RAID_TELEMETRY_NODE_COUNTERS TelemetryPerfPreviousNodeCounters;// Offset=0x928 Size=0x18
    unsigned long long TelemetryMaxFlushLatency;// Offset=0x940 Size=0x8
    unsigned long long TelemetryMaxUnmapLatency;// Offset=0x948 Size=0x8
    unsigned long long TelemetryLock;// Offset=0x950 Size=0x8
    struct _RAID_TELEMETRY_SAMPLED_ERROR_LOG TelemetrySampledErrorLog;// Offset=0x958 Size=0x1c8
    struct _RAID_TELEMETRY_UNIQUE_ERROR_LOG TelemetryUniqueErrorLog;// Offset=0xb20 Size=0x190
    unsigned long long TelemetryBytesWritten;// Offset=0xcb0 Size=0x8
    unsigned long long TelemetryStreamBytesWritten;// Offset=0xcb8 Size=0x8
    unsigned long PowerCycleCount;// Offset=0xcc0 Size=0x4
    union _LARGE_INTEGER InitialTimestamp;// Offset=0xcc8 Size=0x8
    struct _RAID_UNIT_QOS Qos;// Offset=0xcd0 Size=0x30
    unsigned long long ZoneSize;// Offset=0xd00 Size=0x8
    unsigned char * CachedSmartData;// Offset=0xd08 Size=0x8
    enum _STORAGE_BUS_TYPE BusType;// Offset=0xd10 Size=0x4
    unsigned char * ZonePendingIoTable;// Offset=0xd18 Size=0x8
    struct _RTL_BITMAP ZoneIoBitMap;// Offset=0xd20 Size=0x10
    union _LARGE_INTEGER LastLogicalBlockAddress;// Offset=0xd30 Size=0x8
    unsigned long ZoneCount;// Offset=0xd38 Size=0x4
    struct _unnamed_297 ZoneDiagnostics;// Offset=0xd3c Size=0x8
    struct _unnamed_298 ZoneFlags;// Offset=0xd44 Size=0x4
    struct _unnamed_299 DFxQueue;// Offset=0xd48 Size=0x20
    long  ( * CrashdumpNotifyRoutine)(enum _STORAGE_DUMP_EVENT ,void * );// Offset=0xd68 Size=0x8
    unsigned short EventCount[3];// Offset=0xd70 Size=0x6
    struct _UNICODE_STRING ZnsPnpInterfaceName;// Offset=0xd78 Size=0x10
    struct NVME_IDENTIFY_NAMESPACE_DATA * IdentifyNamespaceData;// Offset=0xd88 Size=0x8
    struct NVME_IDENTIFY_SPECIFIC_NAMESPACE_IO_COMMAND_SET * IdentifyNamespaceIoCommandSet;// Offset=0xd90 Size=0x8
    struct _REGISTRY_WATCH_CONTEXT * RegWatchContext;// Offset=0xd98 Size=0x8
    unsigned long CountersId;// Offset=0xda0 Size=0x4
    unsigned char * TcgContext[6240];// Offset=0xda8 Size=0x8
    struct _TCG_DEVICE_PROPERTIES * TcgProperties;// Offset=0xdb0 Size=0x8
    unsigned long ActiveReferenceOnAdapter;// Offset=0xdb8 Size=0x4
};
