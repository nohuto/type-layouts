...
struct _unnamed_948// Size=0x18 (Id=948)
{
...
struct _unnamed_950// Size=0x18 (Id=950)
{
...
struct _unnamed_952// Size=0x10 (Id=952)
{
...
struct _unnamed_953// Size=0x10 (Id=953)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_954// Size=0xc (Id=954)
{
...
struct _unnamed_955// Size=0x18 (Id=955)
{
...
struct _unnamed_956// Size=0x18 (Id=956)
{
...
struct _unnamed_957// Size=0x18 (Id=957)
{
...
union _unnamed_958// Size=0x18 (Id=958)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_948 Port;// Offset=0x0 Size=0x18
        struct _unnamed_948 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_950 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_951 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_952 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_948 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_921 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_953 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_954 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_955 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_956 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_957 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_927 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=959)
{
    ...
    union _unnamed_958 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=914)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=699)
{
