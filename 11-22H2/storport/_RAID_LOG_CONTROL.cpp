struct _unnamed_910// Size=0x8 (Id=910)
{
...
union _unnamed_911// Size=0x8 (Id=911)
{
    struct _unnamed_910 u;// Offset=0x0 Size=0x8
    unsigned long long asUlong64;// Offset=0x0 Size=0x8
};

struct _RAID_LOG_CONTROL// Size=0x10 (Id=912)
{
    unsigned long Revision;// Offset=0x0 Size=0x4
    union _unnamed_911 Enable;// Offset=0x8 Size=0x8
};
