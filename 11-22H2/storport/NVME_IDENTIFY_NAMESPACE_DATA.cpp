struct _unnamed_851// Size=0x1 (Id=851)
{
...
struct _unnamed_852// Size=0x1 (Id=852)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _unnamed_853// Size=0x1 (Id=853)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _unnamed_854// Size=0x1 (Id=854)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _unnamed_855// Size=0x1 (Id=855)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _unnamed_856// Size=0x1 (Id=856)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _unnamed_857// Size=0x1 (Id=857)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _unnamed_858// Size=0x1 (Id=858)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _unnamed_859// Size=0x1 (Id=859)
{
    struct // Size=0x1 (Id=0)
    {
...
struct NVME_IDENTIFY_NAMESPACE_DATA// Size=0x1000 (Id=860)
{
    ...
    struct _unnamed_851 NSFEAT;// Offset=0x18 Size=0x1
    unsigned char NLBAF;// Offset=0x19 Size=0x1
    struct _unnamed_852 FLBAS;// Offset=0x1a Size=0x1
    struct _unnamed_853 MC;// Offset=0x1b Size=0x1
    struct _unnamed_854 DPC;// Offset=0x1c Size=0x1
    struct _unnamed_855 DPS;// Offset=0x1d Size=0x1
    struct _unnamed_856 NMIC;// Offset=0x1e Size=0x1
    union NVM_RESERVATION_CAPABILITIES RESCAP;// Offset=0x1f Size=0x1
    struct _unnamed_857 FPI;// Offset=0x20 Size=0x1
    struct _unnamed_858 DLFEAT;// Offset=0x21 Size=0x1
    ...
    struct _unnamed_859 NSATTR;// Offset=0x63 Size=0x1
