...
struct _IDENTIFY_MFND_CAPABILITY_INFORMATION// Size=0x80 (Id=381)
{
    ...
    struct _unnamed_380 Features;// Offset=0x44 Size=0x4
    ...
    unsigned char Reserved2[53];// Offset=0x4b Size=0x35
};
