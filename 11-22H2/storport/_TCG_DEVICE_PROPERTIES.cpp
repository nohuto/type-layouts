...
struct _TPER_PROPERTIES// Size=0x2c (Id=723)
{
...
struct _unnamed_523// Size=0x6 (Id=523)
{
...
struct _unnamed_531// Size=0x10 (Id=531)
{
...
struct _TCG_DEVICE_PROPERTIES// Size=0xa8 (Id=532)
{
    ...
    struct _unnamed_523 LockingFeatureProperties;// Offset=0x34 Size=0x6
    struct _unnamed_525 LockingSpProperties;// Offset=0x40 Size=0x38
    union _unnamed_527 SscProperties;// Offset=0x78 Size=0x8
    struct _unnamed_528 FixedACLProperties;// Offset=0x80 Size=0x8
    struct _unnamed_529 DataStoreTables;// Offset=0x88 Size=0xc
    struct _unnamed_530 BlockSIDProperties;// Offset=0x94 Size=0x4
    struct _unnamed_531 CNLProperties;// Offset=0x98 Size=0x10
};
