...
struct _STOR_LIST_ENTRY// Size=0x10 (Id=176)
{
    struct _STOR_LIST_ENTRY * Flink;// Offset=0x0 Size=0x8
    struct _STOR_LIST_ENTRY * Blink;// Offset=0x8 Size=0x8
};

struct _STOR_DISPATCHER_HEADER// Size=0x18 (Id=803)
{
    union // Size=0x4 (Id=0)
    {
        struct _unnamed_802 Data;// Offset=0x0 Size=0x4
...
struct _STOR_EVENT// Size=0x18 (Id=186)
{
