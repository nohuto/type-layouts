...
struct _unnamed_774// Size=0x8 (Id=774)
{
...
union _MCI_STATS// Size=0x8 (Id=775)
{
    struct _unnamed_774 MciStatus;// Offset=0x0 Size=0x8
    unsigned long long QuadPart;// Offset=0x0 Size=0x8
};

union _MCI_ADDR// Size=0x8 (Id=764)
{
...
struct _unnamed_672// Size=0x20 (Id=672)
{
...
struct _unnamed_673// Size=0x10 (Id=673)
{
    unsigned long long Address;// Offset=0x0 Size=0x8
    unsigned long long Type;// Offset=0x8 Size=0x8
};

union _unnamed_674// Size=0x20 (Id=674)
{
    union // Size=0x20 (Id=0)
    {
        struct _unnamed_672 Mca;// Offset=0x0 Size=0x20
        struct _unnamed_673 Mce;// Offset=0x0 Size=0x10
    };
};

struct _MCA_EXCEPTION// Size=0x100 (Id=675)
{
    ...
    union _unnamed_674 u;// Offset=0x18 Size=0x20
