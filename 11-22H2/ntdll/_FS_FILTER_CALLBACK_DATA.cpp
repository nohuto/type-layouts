...
struct _unnamed_804// Size=0x18 (Id=804)
{
...
struct _unnamed_806// Size=0x28 (Id=806)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=807)
{
    struct _unnamed_801 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_802 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_804 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _unnamed_805 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_806 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=784)
{
