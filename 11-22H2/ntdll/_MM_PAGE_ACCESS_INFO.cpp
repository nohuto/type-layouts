...
union _MM_PAGE_ACCESS_INFO_FLAGS// Size=0x4 (Id=456)
{
    struct _unnamed_454 File;// Offset=0x0 Size=0x4
    struct _unnamed_455 Private;// Offset=0x0 Size=0x4
};

struct _MM_PAGE_ACCESS_INFO// Size=0x8 (Id=451)
{
    union // Size=0x8 (Id=0)
    {
