...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=553)
{
...
struct _KAPC_STATE// Size=0x30 (Id=505)
{
...
struct _KTIMER// Size=0x40 (Id=623)
{
...
union _KERNEL_SHADOW_STACK_LIMIT// Size=0x8 (Id=353)
{
...
struct _KSEMAPHORE// Size=0x20 (Id=495)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=548)
{
...
struct _KLOCK_ENTRY_LOCK_STATE// Size=0x10 (Id=569)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
union _KLOCK_ENTRY_BOOST_BITMAP// Size=0x8 (Id=340)
{
    unsigned long long AllFields;// Offset=0x0 Size=0x8
...
struct _KLOCK_ENTRY// Size=0x60 (Id=331)
{
    union // Size=0x10 (Id=0)
    {
...
struct _ETHREAD// Size=0x900 (Id=124)
{
