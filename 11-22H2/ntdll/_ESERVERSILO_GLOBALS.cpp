...
struct _OBP_SYSTEM_DOS_DEVICE_STATE// Size=0x6c (Id=769)
{
...
struct _OBJECT_NAMESPACE_LOOKUPTABLE// Size=0x260 (Id=809)
{
...
struct _OBP_SILODRIVERSTATE// Size=0x2e0 (Id=759)
{
...
struct _SEP_SILOSTATE// Size=0x30 (Id=665)
{
...
struct _SEP_RM_LSA_CONNECTION_STATE// Size=0x50 (Id=708)
{
...
struct _WNF_LOCK// Size=0x8 (Id=771)
{
    struct _EX_PUSH_LOCK PushLock;// Offset=0x0 Size=0x8
};

struct _WNF_SILODRIVERSTATE// Size=0x38 (Id=749)
{
...
struct _DBGK_SILOSTATE// Size=0x20 (Id=741)
{
...
struct _CPTABLEINFO// Size=0x40 (Id=762)
{
...
struct _RTL_NLS_STATE// Size=0xb8 (Id=710)
{
...
struct _ESERVERSILO_GLOBALS// Size=0x560 (Id=656)
{
