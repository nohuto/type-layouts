struct _RTL_HEAP_MEMORY_LIMIT_DATA// Size=0x20 (Id=346)
{
...
union _RTL_RUN_ONCE// Size=0x8 (Id=384)
{
...
struct _HEAP_OPPORTUNISTIC_LARGE_PAGE_STATS// Size=0x10 (Id=641)
{
...
struct _RTL_HP_SEG_ALLOC_POLICY// Size=0x18 (Id=477)
{
...
struct _HEAP_RUNTIME_MEMORY_STATS// Size=0x58 (Id=301)
{
...
struct _RTL_HP_HEAP_VA_CALLBACKS_ENCODED// Size=0x20 (Id=408)
{
...
union _unnamed_299// Size=0x1 (Id=299)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _HEAP_SEG_CONTEXT// Size=0xc0 (Id=300)
{
    ...
    union _unnamed_299 Flags;// Offset=0xd Size=0x1
...
struct _RTL_HP_LFH_CONFIG// Size=0x4 (Id=463)
{
...
struct _HEAP_LFH_CONTEXT// Size=0x4c0 (Id=282)
{
...
struct _SEGMENT_HEAP// Size=0x840 (Id=305)
{
