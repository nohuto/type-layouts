...
struct _unnamed_166// Size=0x8 (Id=166)
{
...
struct _unnamed_169// Size=0x4 (Id=169)
{
...
struct _unnamed_174// Size=0x1 (Id=174)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _unnamed_176// Size=0x4 (Id=176)
{
...
struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=497)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=469)
{
...
union _unnamed_190// Size=0x20 (Id=190)
{
    ...
    struct _unnamed_164 MountVolume;// Offset=0x0 Size=0x10
    struct _unnamed_164 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_166 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_167 QueryQuota;// Offset=0x0 Size=0x20
    struct _unnamed_156 SetQuota;// Offset=0x0 Size=0x4
    struct _unnamed_169 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_170 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_171 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_172 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_173 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_174 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_176 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_178 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_180 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_182 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_183 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_186 Power;// Offset=0x0 Size=0x20
    struct _unnamed_187 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_188 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_189 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=191)
{
    ...
    union _unnamed_190 Parameters;// Offset=0x8 Size=0x20
