...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=398)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _EX_FAST_REF// Size=0x8 (Id=118)
{
    union // Size=0x8 (Id=0)
    {
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=575)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=606)
{
    union // Size=0x2 (Id=0)
    {
...
struct _MMSUPPORT_INSTANCE// Size=0xc0 (Id=527)
{
...
struct _MMSUPPORT_SHARED// Size=0x80 (Id=544)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=448)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=537)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=415)
{
...
union _KE_PROCESS_CONCURRENCY_COUNT// Size=0x4 (Id=690)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _KE_IDEAL_PROCESSOR_ASSIGNMENT_BLOCK// Size=0x118 (Id=375)
{
    ...
    union _unnamed_374 AssignmentFlags;// Offset=0xc Size=0x4
    struct _KAFFINITY_EX IdealProcessorSets;// Offset=0x10 Size=0x108
};

struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=438)
{
...
struct _unnamed_132// Size=0x4 (Id=132)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long MitigationFlags3Spare:31;// Offset=0x0 Size=0x4 BitOffset=0x1 BitSize=0x1f
    };
};
