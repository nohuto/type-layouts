struct _RTL_CRITICAL_SECTION// Size=0x28 (Id=256)
{
...
union _unnamed_257// Size=0x28 (Id=257)
{
    struct _RTL_CRITICAL_SECTION CriticalSection;// Offset=0x0 Size=0x28
};

struct _HEAP_LOCK// Size=0x28 (Id=258)
{
    union _unnamed_257 Lock;// Offset=0x0 Size=0x28
};
