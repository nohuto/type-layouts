...
struct _unnamed_703// Size=0x4 (Id=703)
{
    unsigned char Reserved[4];// Offset=0x0 Size=0x4
};

union _PCC_OUTPUT_BUFFER// Size=0x4 (Id=704)
{
    struct _unnamed_702 GetAverageFrequency;// Offset=0x0 Size=0x4
    struct _unnamed_703 SetDesiredFrequency;// Offset=0x0 Size=0x4
};
