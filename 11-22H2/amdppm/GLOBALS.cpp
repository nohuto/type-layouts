...
struct _PPM_DRIVER_DISPATCH_TABLE// Size=0x120 (Id=534)
{
    ...
    void  ( * RegisterEnergyEstimation)(void  ( * )(unsigned long ,unsigned long long ,unsigned long long ,unsigned long ,unsigned long long * ),void  ( * )(unsigned long ,unsigned char ,unsigned char ),unsigned char );// Offset=0xb0 Size=0x8
    long  ( * RequestProcessorHalt)(void * );// Offset=0xb8 Size=0x8
    ...
    unsigned long  ( * QueryPhysicalCoreId)(unsigned long );// Offset=0x110 Size=0x8
    unsigned long  ( * QueryPhysicalCoreCount)(unsigned long );// Offset=0x118 Size=0x8
};
...
struct _PCC_INTERFACE_STANDARD// Size=0x80 (Id=637)
{
    ...
    union _unnamed_636 Flags;// Offset=0x54 Size=0x4
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=501)
{
    union // Size=0x4 (Id=0)
    {
...
struct _CPC_COMMAND_COMPLETION// Size=0x18 (Id=578)
{
...
union _PROC_POWER_COORDINATES// Size=0x4 (Id=467)
{
...
struct _PROC_ENERGY_COUNTER// Size=0xc (Id=517)
{
    union // Size=0x4 (Id=0)
    {
...
struct _PROC_ENERGY_MODEL// Size=0x100 (Id=457)
{
...
struct GLOBALS// Size=0x940 (Id=425)
{
    ...
    struct PPM_DRIVER_INTERFACE DrvInterface;// Offset=0x1b0 Size=0x150
    struct _PPM_DRIVER_DISPATCH_TABLE PpmDispatchTable;// Offset=0x300 Size=0x120
    struct _KAFFINITY_EX ProcessorsEnumerated;// Offset=0x420 Size=0x108
    long  ( * RegisterIdleStates)(struct _FDO_DATA * );// Offset=0x528 Size=0x8
    long  ( * RegisterPStates)(struct _FDO_DATA * );// Offset=0x530 Size=0x8
    long  ( * RegisterPerfCap)(struct _FDO_DATA * );// Offset=0x538 Size=0x8
    long  ( * RegisterPerfFeedback)(struct _FDO_DATA * );// Offset=0x540 Size=0x8
    long  ( * RegisterLegacyPcc)(struct _FDO_DATA * );// Offset=0x548 Size=0x8
    long  ( * RegisterCpc)(struct _FDO_DATA * );// Offset=0x550 Size=0x8
    long  ( * RegisterPepPerf)(struct _FDO_DATA * );// Offset=0x558 Size=0x8
    long  ( * GetProcessorIndex)(struct _FDO_DATA * );// Offset=0x560 Size=0x8
    long  ( * RegisterPackage)(struct _FDO_DATA * );// Offset=0x568 Size=0x8
    long  ( * RegisterHiddenProcessorIdleStates)(struct _FDO_DATA * );// Offset=0x570 Size=0x8
    unsigned char SyntheticPsdAllowed;// Offset=0x578 Size=0x1
    enum <unnamed-enum-PerfStatesNative> PerfStatesOwner;// Offset=0x57c Size=0x4
    unsigned char PerfCounterReadOptimize;// Offset=0x580 Size=0x1
    struct _HV_LOGICAL_PROCESSOR_INFO * HvProcessorInfo;// Offset=0x588 Size=0x8
    unsigned long HvProcessorInfoCount;// Offset=0x590 Size=0x4
    unsigned long Errata;// Offset=0x594 Size=0x4
    struct _PCC_INTERFACE_STANDARD PccInterface;// Offset=0x598 Size=0x80
    struct _KEVENT PccSubspacesMutableEvent;// Offset=0x618 Size=0x18
    struct WDFSPINLOCK__ * PccSubspacesSpinLock;// Offset=0x630 Size=0x8
    struct WDFWAITLOCK__ * PccSubspacesMutex;// Offset=0x638 Size=0x8
    struct _LIST_ENTRY PccSubspaces;// Offset=0x640 Size=0x10
    unsigned long PccSubspaceCount;// Offset=0x650 Size=0x4
    unsigned long PccRegisteredProcessors;// Offset=0x654 Size=0x4
    struct WDFSPINLOCK__ * PccMutex;// Offset=0x658 Size=0x8
    struct _IO_WORKITEM * PccCapWorker;// Offset=0x660 Size=0x8
    unsigned long PepRegisteredProcessors;// Offset=0x668 Size=0x4
    unsigned char PccCapUpdated;// Offset=0x66c Size=0x1
    unsigned char PccCapWorkerQueued;// Offset=0x66d Size=0x1
    struct _CPC_COMMAND_COMPLETION CpcCmdCompletion;// Offset=0x670 Size=0x18
    unsigned char AssertsDisabled;// Offset=0x688 Size=0x1
    unsigned long CoordinatedStateCount;// Offset=0x68c Size=0x4
    struct _PLATFORM_IDLE_STATES * PlatformIdleStates;// Offset=0x690 Size=0x8
    struct _COORDINATED_IDLE_STATES * CoordinatedStates;// Offset=0x698 Size=0x8
    struct _COORDINATED_IDLE_STATES * LpiCoordinatedStates;// Offset=0x6a0 Size=0x8
    unsigned long * LpiStateIndexMapping;// Offset=0x6a8 Size=0x8
    struct _RUNTIME_LPI_STATE * LpiRuntimeState;// Offset=0x6b0 Size=0x8
    struct ACPI_PROCESSOR_CONTAINERS * ProcessorContainers;// Offset=0x6b8 Size=0x8
    struct _PREREGISTERED_VETO_LIST * VetoList;// Offset=0x6c0 Size=0x8
    struct _IO_WORKITEM * StateUpdateWorker;// Offset=0x6c8 Size=0x8
    unsigned char StateUpdateWorkerQueued;// Offset=0x6d0 Size=0x1
    unsigned long EfficiencyClasses;// Offset=0x6d4 Size=0x4
    struct _PROC_ENERGY_MODEL EnergyModels[2];// Offset=0x6d8 Size=0x200
    unsigned char EsuValue;// Offset=0x8d8 Size=0x1
    unsigned char EsuMethod;// Offset=0x8d9 Size=0x1
    unsigned long EnergyEnabledProcessors;// Offset=0x8dc Size=0x4
    unsigned long HwDebugEnabledProcessors;// Offset=0x8e0 Size=0x4
    long long QpcFrequency;// Offset=0x8e8 Size=0x8
    unsigned long long CycleCounterFrequency;// Offset=0x8f0 Size=0x8
    enum _PROCESSOR_PRESENCE HiddenProcessorPresence;// Offset=0x8f8 Size=0x4
    unsigned long ProcessorCountIncludingHidden;// Offset=0x8fc Size=0x4
    unsigned char SkipHiddenProcessorPoFxRegistration;// Offset=0x900 Size=0x1
    unsigned char ImplicitPlatformIdle;// Offset=0x901 Size=0x1
    unsigned char RootDrivenIdle;// Offset=0x902 Size=0x1
    struct _PROC_HW_DEBUG_REGISTER_DEFINITION_LIST RegisteryDebugRegisters[2];// Offset=0x908 Size=0x20
    unsigned long MeasurementCapabilities;// Offset=0x928 Size=0x4
    unsigned long MeasurementRegisterGroupTypes;// Offset=0x92c Size=0x4
    struct _LIST_ENTRY MeasurementRegisterGroups;// Offset=0x930 Size=0x10
};
