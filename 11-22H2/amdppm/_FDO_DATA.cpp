...
struct _ACPI_INTERFACE_STANDARD// Size=0x58 (Id=606)
{
...
struct _GEN_ADDR// Size=0xc (Id=497)
{
...
struct _WMILIB_CONTEXT// Size=0x40 (Id=686)
{
...
struct _KTIMER// Size=0x40 (Id=668)
{
...
struct _CAP_LOG_STATE// Size=0x98 (Id=426)
{
...
struct _GROUP_AFFINITY// Size=0x10 (Id=434)
{
...
struct _FDO_DATA// Size=0x4f8 (Id=413)
{
    ...
    struct _PEP_PPM_QUERY_IDLE_STATES * PepIdleStates;// Offset=0x478 Size=0x8
    struct _PEP_PPM_QUERY_IDLE_STATES_V2 * PepIdleStatesV2;// Offset=0x480 Size=0x8
    struct _UNICODE_STRING * IdleStateNames;// Offset=0x488 Size=0x8
    struct _IO_WORKITEM * IdleStateUpdateWorkItem;// Offset=0x490 Size=0x8
    unsigned char IdleStatesWorkerQueued;// Offset=0x498 Size=0x1
    unsigned char IdleStateUpdates;// Offset=0x499 Size=0x1
    long PerformanceStateWorkerQueued;// Offset=0x49c Size=0x4
    struct _IO_WORKITEM * PerformanceStateUpdateWorkItem;// Offset=0x4a0 Size=0x8
    struct _PEP_PERFORMANCE_STATE * PepPerfStates;// Offset=0x4a8 Size=0x8
    struct _PEP_PERF_RUNTIME_STATE * PepPerfRuntimeState;// Offset=0x4b0 Size=0x8
    struct ACPI_xSD * PepDomain;// Offset=0x4b8 Size=0x8
    struct _GROUP_AFFINITY CoreProcessorSet;// Offset=0x4c0 Size=0x10
    struct _PROC_HW_DEBUG_REGISTER_DEFINITION_LIST HwDebugRegisterDefinitions;// Offset=0x4d0 Size=0x10
    struct _PHYSICAL_CORE * PhysicalCore;// Offset=0x4e0 Size=0x8
    unsigned long VisibleCounterBase;// Offset=0x4e8 Size=0x4
    unsigned long VisibleCounterEnd;// Offset=0x4ec Size=0x4
    unsigned short EmiChannelCount;// Offset=0x4f0 Size=0x2
};
