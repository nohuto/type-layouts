...
struct _unnamed_591// Size=0x8 (Id=591)
{
...
{
    struct _unnamed_590 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_591 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_595 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _unnamed_598 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_599 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=584)
{
