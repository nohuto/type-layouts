struct _OB_PRE_CREATE_HANDLE_INFORMATION// Size=0x8 (Id=2003)
{
    unsigned long DesiredAccess;// Offset=0x0 Size=0x4
    unsigned long OriginalDesiredAccess;// Offset=0x4 Size=0x4
};

struct _OB_PRE_DUPLICATE_HANDLE_INFORMATION// Size=0x18 (Id=2571)
{
    unsigned long DesiredAccess;// Offset=0x0 Size=0x4
    unsigned long OriginalDesiredAccess;// Offset=0x4 Size=0x4
...
union _OB_PRE_OPERATION_PARAMETERS// Size=0x18 (Id=1584)
{
