...
struct _OBP_SYSTEM_DOS_DEVICE_STATE// Size=0x6c (Id=613)
{
...
struct _OBJECT_NAMESPACE_LOOKUPTABLE// Size=0x260 (Id=611)
{
...
struct _OBP_SILODRIVERSTATE// Size=0x2e0 (Id=698)
{
...
struct _SEP_SILOSTATE// Size=0x30 (Id=710)
{
...
struct _SEP_RM_LSA_CONNECTION_STATE// Size=0x50 (Id=758)
{
...
struct _WNF_LOCK// Size=0x8 (Id=622)
{
    struct _EX_PUSH_LOCK PushLock;// Offset=0x0 Size=0x8
};

struct _WNF_SILODRIVERSTATE// Size=0x38 (Id=747)
{
...
struct _DBGK_SILOSTATE// Size=0x20 (Id=671)
{
...
struct _CPTABLEINFO// Size=0x40 (Id=667)
{
...
struct _RTL_NLS_STATE// Size=0xb8 (Id=660)
{
...
struct _ESERVERSILO_GLOBALS// Size=0x560 (Id=1085)
{
