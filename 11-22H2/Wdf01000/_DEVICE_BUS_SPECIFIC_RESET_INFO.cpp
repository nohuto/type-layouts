...
union _DEVICE_BUS_SPECIFIC_RESET_TYPE// Size=0x8 (Id=3440)
{
    struct <unnamed-type-Pci>// Size=0x8 (Id=5973)
    {
    ...
    struct <unnamed-type-Acpi>// Size=0x8 (Id=5979)
    {
        unsigned long long FunctionLevelDeviceReset:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
        unsigned long long PlatformLevelDeviceReset:1;// Offset=0x0 Size=0x8 BitOffset=0x1 BitSize=0x1
...
struct _DEVICE_BUS_SPECIFIC_RESET_INFO// Size=0x18 (Id=1866)
{
