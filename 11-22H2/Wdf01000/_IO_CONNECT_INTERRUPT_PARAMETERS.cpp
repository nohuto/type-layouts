...
struct _IO_CONNECT_INTERRUPT_FULLY_SPECIFIED_PARAMETERS// Size=0x48 (Id=596)
{
...
struct _IO_CONNECT_INTERRUPT_LINE_BASED_PARAMETERS// Size=0x30 (Id=1627)
{
    struct _DEVICE_OBJECT * PhysicalDeviceObject;// Offset=0x0 Size=0x8
    struct _KINTERRUPT ** InterruptObject;// Offset=0x8 Size=0x8
    unsigned char  ( * ServiceRoutine)(struct _KINTERRUPT * ,void * );// Offset=0x10 Size=0x8
...
struct _IO_CONNECT_INTERRUPT_MESSAGE_BASED_PARAMETERS// Size=0x38 (Id=579)
{
    union // Size=0x8 (Id=0)
    {
        struct _DEVICE_OBJECT * PhysicalDeviceObject;// Offset=0x0 Size=0x8
        union <unnamed-type-ConnectionContext>// Size=0x8 (Id=9773)
        {
...
struct _IO_CONNECT_INTERRUPT_PARAMETERS// Size=0x50 (Id=1333)
{
