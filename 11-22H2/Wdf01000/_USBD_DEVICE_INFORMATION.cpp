struct _USB_DEVICE_DESCRIPTOR// Size=0x12 (Id=1770)
{
...
struct _USBD_DEVICE_INFORMATION// Size=0x28 (Id=1917)
{
    unsigned long OffsetNext;// Offset=0x0 Size=0x4
    void * UsbdDeviceHandle;// Offset=0x8 Size=0x8
    struct _USB_DEVICE_DESCRIPTOR DeviceDescriptor;// Offset=0x10 Size=0x12
};
