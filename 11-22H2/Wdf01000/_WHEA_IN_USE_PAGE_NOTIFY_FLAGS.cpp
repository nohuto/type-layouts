union _WHEA_IN_USE_PAGE_NOTIFY_FLAGS// Size=0x1 (Id=3150)
{
    struct <unnamed-type-Bits>// Size=0x1 (Id=25070)
    {
        unsigned char PlatformDirected:1;// Offset=0x0 Size=0x1 BitOffset=0x0 BitSize=0x1
        unsigned char Reserved:5;// Offset=0x0 Size=0x1 BitOffset=0x1 BitSize=0x5
