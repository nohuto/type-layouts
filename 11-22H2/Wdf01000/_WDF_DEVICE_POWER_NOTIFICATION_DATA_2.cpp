...
struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=1056)
{
    union // Size=0x4 (Id=0)
    {
        enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
        union <unnamed-type-Data>// Size=0x8 (Id=20758)
        {
            struct <unnamed-type-EnterState>// Size=0x8 (Id=20759)
            {
            ...
            struct <unnamed-type-PostProcessState>// Size=0x4 (Id=20763)
            {
                enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
            };
            ...
            struct <unnamed-type-LeaveState>// Size=0x8 (Id=20766)
            {
                enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
                enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
            };
