struct _OSVERSIONINFOEXW// Size=0x11c (Id=1371)
{
...
struct _KBUGCHECK_REASON_CALLBACK_RECORD// Size=0x30 (Id=1644)
{
...
struct _FX_DRIVER_TRACKER_CACHE_AWARE// Size=0x18 (Id=2945)
{
    union // Size=0x11d (Id=0)
    {
        struct _FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=9016)
        {
            struct _FX_DRIVER_GLOBALS * FxDriverGlobals;// Offset=0x0 Size=0x8
        };
        struct FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=9019)
        {
        };// Offset=0x0 Size=0x8
        long Initialize();
        void Uninitialize();
        long Register(struct _FX_DRIVER_GLOBALS * );// Offset=0x0 Size=0x11d
...
struct _WMI_WDF_NOTIFY_ROUTINES// Size=0x20 (Id=2356)
{
...
struct FxLibraryGlobalsType// Size=0x228 (Id=1247)
{
    ...
    struct _OSVERSIONINFOEXW OsVersionInfo;// Offset=0x30 Size=0x11c
    class MxLockNoDynam FxDriverGlobalsListLock;// Offset=0x150 Size=0x10
    struct _LIST_ENTRY FxDriverGlobalsList;// Offset=0x160 Size=0x10
    unsigned long BugCheckDriverInfoIndex;// Offset=0x170 Size=0x4
    unsigned long BugCheckDriverInfoCount;// Offset=0x174 Size=0x4
    struct _FX_DUMP_DRIVER_INFO_ENTRY * BugCheckDriverInfo;// Offset=0x178 Size=0x8
    struct _KBUGCHECK_REASON_CALLBACK_RECORD BugCheckCallbackRecord;// Offset=0x180 Size=0x30
    unsigned char InternalTracingInitialized;// Offset=0x1b0 Size=0x1
    struct _FX_DRIVER_TRACKER_CACHE_AWARE DriverTracker;// Offset=0x1b8 Size=0x18
    struct _FX_DRIVER_GLOBALS * BestDriverForDumpLog;// Offset=0x1d0 Size=0x8
    unsigned char IsUserModeFramework;// Offset=0x1d8 Size=0x1
    unsigned char StaticallyLinked;// Offset=0x1d9 Size=0x1
    unsigned char MachineSleepStates[3];// Offset=0x1da Size=0x3
    void * VerifierSectionHandle;// Offset=0x1e0 Size=0x8
    long VerifierSectionHandleRefCount;// Offset=0x1e8 Size=0x4
    struct _WMI_WDF_NOTIFY_ROUTINES * PerfTraceRoutines;// Offset=0x1f0 Size=0x8
    struct _WMI_WDF_NOTIFY_ROUTINES DummyPerfTraceRoutines;// Offset=0x1f8 Size=0x20
    class FxCompanionLibrary * CompanionLibrary;// Offset=0x218 Size=0x8
    unsigned char IfrDisabled;// Offset=0x220 Size=0x1
    unsigned char SleepStudyDisabled;// Offset=0x221 Size=0x1
    unsigned char WdfDirectedPowerTransitionEnabled;// Offset=0x222 Size=0x1
};
