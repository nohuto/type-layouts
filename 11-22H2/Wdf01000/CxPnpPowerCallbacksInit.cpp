struct _WDFCX_PNPPOWER_EVENT_CALLBACKS// Size=0x118 (Id=524)
{
...
struct _WDFCX_POWER_POLICY_EVENT_CALLBACKS// Size=0x90 (Id=629)
{
    unsigned long Size;// Offset=0x0 Size=0x4
...
struct CxPnpPowerCallbacksInit// Size=0x1b0 (Id=2011)
{
