...
union _WHEA_XPF_PROCINFO_VALIDBITS// Size=0x8 (Id=3352)
{
...
union _WHEA_XPF_TLB_CHECK// Size=0x8 (Id=933)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long TransactionTypeValid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
union _WHEA_XPF_BUS_CHECK// Size=0x8 (Id=3265)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long TransactionTypeValid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
union _WHEA_XPF_MS_CHECK// Size=0x8 (Id=1637)
{
    struct // Size=0x8 (Id=0)
    {
