...
struct _PCI_ROOT_BUS_OSC_SUPPORT_FIELD// Size=0x4 (Id=1550)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=14233)
        {
...
struct _PCI_ROOT_BUS_OSC_CONTROL_FIELD// Size=0x4 (Id=3487)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=14223)
        {
...
struct _PCI_ROOT_BUS_HARDWARE_CAPABILITY// Size=0x24 (Id=922)
{
