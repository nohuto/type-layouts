...
struct _AsActivatorSubtask// Size=0x10 (Id=1018)
{
    unsigned long ClientId;// Offset=0x0 Size=0x4
    unsigned long Reserved[2];// Offset=0x4 Size=0x8
    unsigned short TaskId;// Offset=0xc Size=0x2
...
struct _AsSocSubsystem// Size=0x10 (Id=1263)
{
...
struct _AsPreVeto// Size=0x10 (Id=1219)
{
...
struct _AsPdcPhaseBlockerGroup// Size=0x10 (Id=800)
{
...
struct _AsPdcPhaseBlockerGroupClient// Size=0x10 (Id=1213)
{
    unsigned long BlockerGroupSignature;// Offset=0x0 Size=0x4
    unsigned char BlockerGroupDesc;// Offset=0x4 Size=0x1
...
union _SLEEPSTUDY_BLOCKER_GUID// Size=0x10 (Id=1147)
{
