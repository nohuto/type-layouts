struct FxRequestBuffer// Size=0x20 (Id=1115)
{
    union // Size=0x43b (Id=0)
    {
        void FxRequestBuffer();// Offset=0x0 Size=0x15
        long ValidateMemoryDescriptor(struct _FX_DRIVER_GLOBALS * ,struct _WDF_MEMORY_DESCRIPTOR * ,unsigned long );// Offset=0x0 Size=0x1f3
        ...
        unsigned long GetBufferLength();// Offset=0x0 Size=0x53
        long GetBuffer(void ** );// Offset=0x0 Size=0x54
        long GetOrAllocateMdl(struct _FX_DRIVER_GLOBALS * ,struct _MDL ** ,struct _MDL ** ,unsigned char * ,enum _LOCK_OPERATION ,unsigned char ,unsigned long long * );// Offset=0x0 Size=0x43b
        ...
        void AssignValues(void ** ,struct _MDL ** ,unsigned long * );// Offset=0x0 Size=0x10a
        enum FxRequestBufferType DataType;// Offset=0x0 Size=0x4
        union <unnamed-type-u>// Size=0x18 (Id=61499)
        {
