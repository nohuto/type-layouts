...
union _PCI_EXPRESS_DESIGNATED_VENDOR_SPECIFIC_HEADER_1// Size=0x4 (Id=1731)
{
...
union _PCI_EXPRESS_DESIGNATED_VENDOR_SPECIFIC_HEADER_2// Size=0x2 (Id=3303)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_CXL_DVSEC_CONTROL_REGISTER// Size=0x2 (Id=2397)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_CXL_DVSEC_STATUS_REGISTER// Size=0x2 (Id=3225)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_CXL_DVSEC_LOCK_REGISTER// Size=0x2 (Id=486)
{
    struct // Size=0x2 (Id=0)
    {
...
struct _PCI_EXPRESS_CXL_DVSEC_RANGE_SIZE_HIGH_REGISTER// Size=0x4 (Id=1932)
{
    unsigned long MemSizeHigh;// Offset=0x0 Size=0x4
};

union _PCI_EXPRESS_CXL_DVSEC_RANGE_SIZE_LOW_REGISTER_V11// Size=0x4 (Id=3160)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PCI_EXPRESS_CXL_DVSEC_RANGE_BASE_HIGH_REGISTER// Size=0x4 (Id=2573)
{
    unsigned long MemBaseHigh;// Offset=0x0 Size=0x4
};

union _PCI_EXPRESS_CXL_DVSEC_RANGE_BASE_LOW_REGISTER// Size=0x4 (Id=1727)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PCI_EXPRESS_CXL_DVSEC_CAPABILITY_V11// Size=0x38 (Id=2146)
{
