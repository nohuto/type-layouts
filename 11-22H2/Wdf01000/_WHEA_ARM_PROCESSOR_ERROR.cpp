union _WHEA_ARM_CACHE_ERROR_VALID_BITS// Size=0x2 (Id=780)
{
...
struct _WHEA_ARM_CACHE_ERROR// Size=0xc (Id=1783)
{
...
union _WHEA_ARM_TLB_ERROR_VALID_BITS// Size=0x2 (Id=3158)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short TransactionType:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_ARM_TLB_ERROR// Size=0xc (Id=2927)
{
...
union _WHEA_ARM_BUS_ERROR_VALID_BITS// Size=0x2 (Id=3490)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short TransactionType:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_ARM_BUS_ERROR// Size=0xc (Id=3218)
{
...
union _WHEA_ARM_PROCESSOR_ERROR// Size=0xc (Id=3047)
{
    union // Size=0xc (Id=0)
    {
