...
struct _DEVICE_DESCRIPTION// Size=0x40 (Id=2426)
{
...
struct _FxDmaDescription// Size=0x60 (Id=2688)
{
    struct _DEVICE_DESCRIPTION DeviceDescription;// Offset=0x0 Size=0x40
    struct _DMA_ADAPTER * AdapterObject;// Offset=0x40 Size=0x8
    unsigned long long PreallocatedSGListSize;// Offset=0x48 Size=0x8
    unsigned long long MaximumFragmentLength;// Offset=0x50 Size=0x8
    unsigned long NumberOfMapRegisters;// Offset=0x58 Size=0x4
};
