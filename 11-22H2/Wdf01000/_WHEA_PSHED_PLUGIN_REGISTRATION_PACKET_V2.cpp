struct _WHEA_PSHED_PLUGIN_CALLBACKS// Size=0x78 (Id=2713)
{
...
struct _WHEA_PSHED_PLUGIN_REGISTRATION_PACKET_V2// Size=0x98 (Id=2200)
{
    ...
    void * PluginHandle;// Offset=0x90 Size=0x8
};
