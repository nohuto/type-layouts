...
struct _WDF_DRIVER_GLOBALS// Size=0x38 (Id=2895)
{
...
struct _FX_DRIVER_GLOBALS// Size=0x200 (Id=804)
{
    ...
    union // Size=0x317 (Id=0)
    {
        ...
        unsigned char IsCorrectVersionRegistered(struct _UNICODE_STRING * );// Offset=0x0 Size=0x1ae
        ...
        void WaitForSignal(class MxEvent * ,char * ,void * ,unsigned long ,unsigned long );// Offset=0x0 Size=0xe2
