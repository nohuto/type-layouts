struct _ACPI_DEBUGGING_DEVICE_IN_USE// Size=0x8 (Id=489)
{
    unsigned long NameSpacePathLength;// Offset=0x0 Size=0x4
    wchar_t NameSpacePath[1];// Offset=0x4 Size=0x2
};

struct _PCI_DEBUGGING_DEVICE_IN_USE// Size=0xc (Id=3485)
{
...
struct _DEBUGGING_DEVICE_IN_USE// Size=0x14 (Id=1021)
{
...
struct _DEBUGGING_DEVICE_IN_USE_INFORMATION// Size=0x18 (Id=924)
{
