...
struct _DMA_COMMON_BUFFER_EXTENDED_CONFIGURATION// Size=0x28 (Id=2855)
{
    enum _DMA_COMMON_BUFFER_EXTENDED_CONFIGURATION_TYPE ConfigType;// Offset=0x0 Size=0x4
    union // Size=0x18 (Id=0)
    {
        struct _DMA_COMMON_BUFFER_EXTENDED_CONFIGURATION::_unnamed_2923::<unnamed-type-LogicalAddressLimits> LogicalAddressLimits;// Offset=0x8 Size=0x10
        struct _DMA_COMMON_BUFFER_EXTENDED_CONFIGURATION::_unnamed_2921::<unnamed-type-SubSection> SubSection;// Offset=0x8 Size=0x10
