...
struct _XSTATE_FEATURE// Size=0x8 (Id=1011)
{
    unsigned long Offset;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
};

struct _XSTATE_CONFIGURATION// Size=0x348 (Id=3174)
{
    ...
    unsigned long Spare;// Offset=0x344 Size=0x4
};

struct _KUSER_SHARED_DATA// Size=0x738 (Id=2376)
{
