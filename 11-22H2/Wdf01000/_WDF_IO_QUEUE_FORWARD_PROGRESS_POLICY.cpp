...
struct _WDF_IO_FORWARD_PROGRESS_RESERVED_POLICY_SETTINGS// Size=0x8 (Id=1864)
{
    union // Size=0x8 (Id=0)
    {
        union <unnamed-type-Policy>// Size=0x8 (Id=21403)
        {
            struct <unnamed-type-ExaminePolicy>// Size=0x8 (Id=21404)
            {
...
struct _WDF_IO_QUEUE_FORWARD_PROGRESS_POLICY// Size=0x28 (Id=3080)
{
