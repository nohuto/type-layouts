struct _USB_DEVICE_CAPABILITY_BILLBOARD_DESCRIPTOR// Size=0x30 (Id=3104)
{
    union // Size=0x2c (Id=0)
    {
        ...
        union <unnamed-type-VconnPower>// Size=0x2 (Id=19856)
        {
        ...
        struct <unnamed-type-AlternateMode>// Size=0x4 (Id=19864)
        {
