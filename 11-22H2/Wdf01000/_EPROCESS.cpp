...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=1238)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=1251)
{
...
struct _unnamed_1186// Size=0x8 (Id=1186)
{
...
union _unnamed_1190// Size=0x8 (Id=1190)
{
    unsigned long long SecureHandle;// Offset=0x0 Size=0x8
    struct _unnamed_1186 Flags;// Offset=0x0 Size=0x8
};

struct _KPROCESS// Size=0x438 (Id=1193)
{
    ...
    union _unnamed_1190 SecureState;// Offset=0x3e0 Size=0x8
...
struct _EX_FAST_REF// Size=0x8 (Id=1233)
{
    union // Size=0x8 (Id=0)
    {
...
struct _RTL_AVL_TREE// Size=0x8 (Id=1223)
{
    struct _RTL_BALANCED_NODE * Root;// Offset=0x0 Size=0x8
};

struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=1157)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=931)
{
    union // Size=0x2 (Id=0)
    {
...
struct _MMSUPPORT_INSTANCE// Size=0xc0 (Id=1226)
{
...
struct _MMSUPPORT_SHARED// Size=0x80 (Id=1094)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=1150)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=1198)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=1068)
{
...
struct _unnamed_997// Size=0x4 (Id=997)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=1151)
{
    struct _RTL_AVL_TREE Tree;// Offset=0x0 Size=0x8
    struct _EX_PUSH_LOCK Lock;// Offset=0x8 Size=0x8
};

struct _unnamed_999// Size=0x4 (Id=999)
{
    struct // Size=0x4 (Id=0)
    {
...
union _PROCESS_EXECUTION_TRANSITION// Size=0x2 (Id=732)
{
...
union _PROCESS_EXECUTION_STATE// Size=0x1 (Id=738)
{
...
union _PROCESS_EXECUTION// Size=0x4 (Id=1229)
{
...
struct _EPROCESS// Size=0xb80 (Id=1001)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_996 MitigationFlagsValues;// Offset=0x9d0 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x9d4 Size=0x4
        struct _unnamed_997 MitigationFlags2Values;// Offset=0x9d4 Size=0x4
    };
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_999 MitigationFlags3Values;// Offset=0xb70 Size=0x4
    };
