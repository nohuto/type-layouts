...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=1065)
{
...
struct _KAPC_STATE// Size=0x30 (Id=874)
{
...
struct _KTIMER// Size=0x40 (Id=2014)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=1858)
{
...
union _KERNEL_SHADOW_STACK_LIMIT// Size=0x8 (Id=1273)
{
...
struct _KTHREAD// Size=0x480 (Id=859)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _KSEMAPHORE// Size=0x20 (Id=3248)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=1118)
{
...
struct _ETHREAD// Size=0x910 (Id=1061)
{
