...
struct _D3DKMDT_GRAPHICS_RENDERING_FORMAT// Size=0x20 (Id=467)
{
...
struct _D3DKMDT_VIDPN_SOURCE_MODE// Size=0x28 (Id=439)
{
    union // Size=0x8 (Id=0)
    {
        unsigned int Id;// Offset=0x0 Size=0x4
        enum _D3DKMDT_VIDPN_SOURCE_MODE_TYPE Type;// Offset=0x4 Size=0x4
        union <unnamed-type-Format>// Size=0x20 (Id=1635)
        {
...
struct _DMM_VIDPNPATHSFROMSOURCE_SERIALIZATION// Size=0x1e8 (Id=186)
{
    struct _D3DKMDT_VIDPN_SOURCE_MODE SourceMode;// Offset=0x0 Size=0x28
    unsigned char NumPathsFromSource;// Offset=0x28 Size=0x1
    struct _DMM_VIDPNPATHANDTARGETMODE_SERIALIZATION PathAndTargetModeSerialization[1];// Offset=0x30 Size=0x1b8
};
