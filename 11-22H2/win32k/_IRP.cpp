...
struct _IRP// Size=0xd0 (Id=100)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=3572)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=3591)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=3592)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=3605)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=3606)
            {
