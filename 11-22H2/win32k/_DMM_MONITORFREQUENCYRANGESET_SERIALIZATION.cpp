...
struct _D3DKMDT_FREQUENCY_RANGE// Size=0x20 (Id=666)
{
...
struct _D3DKMDT_MONITOR_FREQUENCY_RANGE// Size=0x30 (Id=533)
{
    union // Size=0x28 (Id=0)
    {
        ...
        union <unnamed-type-Constraint>// Size=0x8 (Id=1448)
        {
            struct _D3DKMDT_2DREGION ActiveSize;// Offset=0x0 Size=0x8
            unsigned long long MaxPixelRate;// Offset=0x0 Size=0x8
        };
        union _D3DKMDT_MONITOR_FREQUENCY_RANGE::<unnamed-type-Constraint> Constraint;// Offset=0x28 Size=0x8
    };
};

struct _DMM_MONITORFREQUENCYRANGESET_SERIALIZATION// Size=0x38 (Id=195)
{
    unsigned char NumFrequencyRanges;// Offset=0x0 Size=0x1
    struct _D3DKMDT_MONITOR_FREQUENCY_RANGE FrequencyRangeSerialization[1];// Offset=0x8 Size=0x30
};
