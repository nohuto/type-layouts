...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=654)
{
...
struct _PCI_DEVICE_INFORMATION// Size=0x38 (Id=703)
{
...
struct _ACPI_DEVICE_INFORMATION// Size=0xf (Id=952)
{
...
union _KSE_XHCI_CONTROLLER_FLAGS// Size=0x10 (Id=407)
{
...
union _FRAME_SNAPSHOT// Size=0x8 (Id=877)
{
...
struct _FRAME_NUMBER_DATA// Size=0x10 (Id=639)
{
...
struct _TIME_SYNC_DATA// Size=0xa8 (Id=490)
{
...
union _XHCI_TEST_MODE_FLAGS// Size=0x4 (Id=905)
{
...
struct _CONTROLLER_DATA// Size=0x370 (Id=486)
{
    ...
    struct _CONTROLLER_COUNTER Counter;// Offset=0x1d8 Size=0x60
    struct WDFWORKITEM__ * IdleTimeoutUpdateWorkItem;// Offset=0x238 Size=0x8
    unsigned long LastSetIdleTimeout;// Offset=0x240 Size=0x4
    struct POHANDLE__ * PoHandle;// Offset=0x248 Size=0x8
    void * LPEEnterExitCallbackHandle;// Offset=0x250 Size=0x8
    unsigned char WdfPowerReferenceForDebuggerAcquired;// Offset=0x258 Size=0x1
    unsigned char IsSecureDevice;// Offset=0x259 Size=0x1
    unsigned char IsExtendedTBCEnabled;// Offset=0x25a Size=0x1
    unsigned char IsExtendedTBCTRBStatusSupported;// Offset=0x25b Size=0x1
    enum _CONTROLLER_DMA_MODE DMAModeInVSM;// Offset=0x25c Size=0x4
    unsigned long NumberOfDMATargetsInVSM;// Offset=0x260 Size=0x4
    struct TRUSTLET_OBJECT_HANDLE__ * SecureObjectHandle;// Offset=0x268 Size=0x8
    struct _EPROCESS * TrustletProcess;// Offset=0x270 Size=0x8
    unsigned char IsDSMForPortStatusSupported;// Offset=0x278 Size=0x1
    unsigned char IsDSMForKBLWorkaroundsSupported;// Offset=0x279 Size=0x1
    enum _USBD_ENDPOINT_OFFLOAD_MODE UsbEndpointOffloadMode;// Offset=0x27c Size=0x4
    unsigned long NumberOfEndpointsOffloaded;// Offset=0x280 Size=0x4
    void * EndpointsOffloadedCountLock;// Offset=0x288 Size=0x8
    long FullOrLowSpeedNonRHInterruptEpCount;// Offset=0x290 Size=0x4
    struct _TIME_SYNC_DATA TimeSyncData;// Offset=0x298 Size=0xa8
    struct WDFWORKITEM__ * AudioOffloadWnfStateUpdateWorkItem;// Offset=0x340 Size=0x8
    unsigned char IsAudioOffloadActive;// Offset=0x348 Size=0x1
    struct SS_COMPONENT__ * SleepstudySelectiveSuspendUnsupportedHandle;// Offset=0x350 Size=0x8
    unsigned long RecurringResetRecoveryFrequency;// Offset=0x358 Size=0x4
    unsigned long ImmediateResetRecoveryPending;// Offset=0x35c Size=0x4
    struct _XHCI_IRQL_TRACKER * IrqlTrackerArray;// Offset=0x360 Size=0x8
    unsigned long ActiveProcessorCount;// Offset=0x368 Size=0x4
    union _XHCI_TEST_MODE_FLAGS TestFlags;// Offset=0x36c Size=0x4
};
