...
struct _unnamed_421// Size=0x18 (Id=421)
{
...
struct _unnamed_424// Size=0x18 (Id=424)
{
...
union _unnamed_425// Size=0x18 (Id=425)
{
    struct _unnamed_421 Descriptor;// Offset=0x0 Size=0x18
    struct _unnamed_422 Urb;// Offset=0x0 Size=0x8
    struct _unnamed_423 SingleInterface;// Offset=0x0 Size=0x10
    struct _unnamed_424 MultiInterface;// Offset=0x0 Size=0x18
};

struct _WDF_USB_DEVICE_SELECT_CONFIG_PARAMS// Size=0x20 (Id=426)
{
    unsigned long Size;// Offset=0x0 Size=0x4
    enum _WdfUsbTargetDeviceSelectConfigType Type;// Offset=0x4 Size=0x4
    union _unnamed_425 Types;// Offset=0x8 Size=0x18
};
