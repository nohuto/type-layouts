...
struct _unnamed_657// Size=0x4 (Id=657)
{
    enum _WDF_DEVICE_POWER_POLICY_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_658// Size=0x8 (Id=658)
{
    struct _unnamed_656 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_657 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_656 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=659)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_658 Data;// Offset=0x4 Size=0x8
};
