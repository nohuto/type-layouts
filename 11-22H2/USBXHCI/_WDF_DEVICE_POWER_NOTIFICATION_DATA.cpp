...
struct _unnamed_699// Size=0x8 (Id=699)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_700// Size=0x4 (Id=700)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_701// Size=0x8 (Id=701)
{
    struct _unnamed_699 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_700 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_699 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=702)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_701 Data;// Offset=0x4 Size=0x8
};
