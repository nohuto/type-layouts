...
union _unnamed_340// Size=0x4 (Id=340)
{
    struct _unnamed_339 Parallel;// Offset=0x0 Size=0x4
};

struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=341)
{
    ...
    union _unnamed_340 Settings;// Offset=0x50 Size=0x4
