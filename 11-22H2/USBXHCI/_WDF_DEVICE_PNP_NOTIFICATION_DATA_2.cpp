...
struct _unnamed_668// Size=0x8 (Id=668)
{
...
union _unnamed_670// Size=0x8 (Id=670)
{
    struct _unnamed_668 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_669 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_668 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=258)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_670 Data;// Offset=0x4 Size=0x8
};
