...
struct _ENDPOINT_UPDATE_DATA// Size=0x78 (Id=908)
{
...
struct _ENDPOINT_STATIC_STREAMS_CONFIGURE// Size=0x8 (Id=806)
{
    struct _STATIC_STREAMS_DATA * StaticStreamsData;// Offset=0x0 Size=0x8
};

struct _ENDPOINT_RESET_DATA// Size=0x70 (Id=753)
{
    struct _ENDPOINT_DATA * EndpointData;// Offset=0x0 Size=0x8
    struct _XIL_BUFFER_DATA * InputBufferData;// Offset=0x8 Size=0x8
...
struct _USBDEVICE_ENDPOINTS_CONFIGURE_DATA// Size=0x2 (Id=801)
{
...
struct _CONTROL_TRANSFER_DATA// Size=0xf8 (Id=917)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
    ...
    struct _unnamed_916 PreallocatedScatterGatherList;// Offset=0xd0 Size=0x28
};
...
union _REQUEST_DATA// Size=0x300 (Id=556)
{
