union _unnamed_87// Size=0x8 (Id=87)
{
...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=829)
{
...
struct _unnamed_91// Size=0x58 (Id=91)
{
...
union _unnamed_92// Size=0x58 (Id=92)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_91 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=93)
{
    ...
    union _unnamed_87 AssociatedIrp;// Offset=0x18 Size=0x8
