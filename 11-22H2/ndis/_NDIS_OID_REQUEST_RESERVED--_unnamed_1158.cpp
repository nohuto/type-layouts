union _NDIS_OID_REQUEST_RESERVED::_unnamed_1158// Size=0x18 (Id=1158)
{
    union // Size=0x18 (Id=0)
    {
        ...
        struct <unnamed-type-IovContext>// Size=0x10 (Id=9509)
        {
            struct _NDIS_VF_BLOCK * VFBlock;// Offset=0x0 Size=0x8
            struct _NDIS_VPORT_BLOCK * VPortBlock;// Offset=0x8 Size=0x8
        };
        struct _NDIS_OID_REQUEST_RESERVED::_unnamed_1162::<unnamed-type-IovContext> IovContext;// Offset=0x0 Size=0x10
        struct <unnamed-type-PMContext>// Size=0x18 (Id=9515)
        {
        ...
        struct _NDIS_OID_REQUEST_RESERVED::_unnamed_1163::<unnamed-type-PMContext> PMContext;// Offset=0x0 Size=0x18
        struct <unnamed-type-OffloadParamsContext>// Size=0x1 (Id=9522)
        {
            unsigned char SkipRegistryUpdate:1;// Offset=0x0 Size=0x1 BitOffset=0x0 BitSize=0x1
        };
        struct _NDIS_OID_REQUEST_RESERVED::_unnamed_1164::<unnamed-type-OffloadParamsContext> OffloadParamsContext;// Offset=0x0 Size=0x1
    };
};
