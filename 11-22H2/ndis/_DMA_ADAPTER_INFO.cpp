struct _DMA_ADAPTER_INFO_V1// Size=0x14 (Id=1312)
{
...
struct _DEVICE_DESCRIPTION// Size=0x40 (Id=2010)
{
...
struct _DMA_ADAPTER_INFO_CRASHDUMP// Size=0x50 (Id=1646)
{
...
struct _DMA_ADAPTER_INFO// Size=0x58 (Id=1170)
{
    unsigned long Version;// Offset=0x0 Size=0x4
    union // Size=0x14 (Id=0)
    {
        struct _DMA_ADAPTER_INFO_V1 V1;// Offset=0x8 Size=0x14
        struct _DMA_ADAPTER_INFO_CRASHDUMP Crashdump;// Offset=0x8 Size=0x50
    };
};
