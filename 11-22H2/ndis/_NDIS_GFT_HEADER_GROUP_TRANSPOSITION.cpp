...
struct _NDIS_GFT_HEADER_GROUP_TRANSPOSITION// Size=0x58 (Id=1714)
{
    union // Size=0x4f (Id=0)
    {
        ...
        union <unnamed-type-IPAddress>// Size=0x20 (Id=7010)
        {
            struct <unnamed-type-IPv4Address>// Size=0x8 (Id=7011)
            {
            ...
            struct <unnamed-type-IPv6Address>// Size=0x20 (Id=7015)
            {
        ...
        union <unnamed-type-TransportOrEncapsulation>// Size=0x8 (Id=7023)
        {
