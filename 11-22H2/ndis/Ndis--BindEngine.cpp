struct Ndis::BindEngine// Size=0x78 (Id=599)
{
    ...
    union // Size=0x8bc (Id=0)
    {
        void ApplyBindChanges(enum CallRunMode ,bool );// Offset=0x0 Size=0xde
        void SetDirty();
        ...
        void LockBindings();
        void UnlockBindings();
        void UpdateBindings(class KLockThisExclusive & );// Offset=0x0 Size=0x1a0
        bool Iterate(struct _GUID & );// Offset=0x0 Size=0x8bc
        void ApplyRules();
