...
struct _STOR_ADDR_BTL8// Size=0x10 (Id=251)
{
...
struct _STRING// Size=0x10 (Id=226)
{
...
struct _STOR_SCSI_IDENTITY// Size=0x38 (Id=219)
{
...
struct _anonymous_258// Size=0x8 (Id=258)
{
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned long Reserved:4;// Offset=0x4 Size=0x4 BitOffset=0x0 BitSize=0x4
    };
};

union _anonymous_259// Size=0x4 (Id=259)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=420)
{
    union // Size=0x4 (Id=0)
    {
...
struct _RAID_POWER_STATE// Size=0x10 (Id=309)
{
...
struct _QUEUE_TAG_LIST// Size=0x80 (Id=211)
{
...
struct _EXTENDED_DEVICE_QUEUE// Size=0x90 (Id=232)
{
...
struct _IO_QUEUE// Size=0xa8 (Id=231)
{
...
struct _KTIMER// Size=0x40 (Id=331)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _RAID_DEFERRED_HEADER// Size=0x20 (Id=477)
{
...
struct _anonymous_392// Size=0x20 (Id=392)
{
...
struct _anonymous_393// Size=0x4 (Id=393)
{
...
struct _anonymous_396// Size=0x8 (Id=396)
{
    struct _STOR_ASYNC_NOTIFY_CONTEXT * StorAsyncNotify;// Offset=0x0 Size=0x8
};

struct _RAID_DEFERRED_ELEMENT// Size=0x50 (Id=397)
{
    ...
    {
        struct _anonymous_391 Timer;// Offset=0x28 Size=0x10
        struct _anonymous_392 Error;// Offset=0x28 Size=0x20
        struct _anonymous_393 PauseDevice;// Offset=0x28 Size=0x4
        struct _anonymous_394 Busy;// Offset=0x28 Size=0x4
        struct _anonymous_394 DeviceBusy;// Offset=0x28 Size=0x4
        struct _anonymous_395 AdditionalTimer;// Offset=0x28 Size=0x18
        struct _anonymous_396 AsyncNotification;// Offset=0x28 Size=0x8
    };
};
...
struct _RAID_IO_RESOURCES// Size=0x20 (Id=268)
{
...
struct _RAID_UNIT_REGISTRY_PARAMETERS// Size=0x18 (Id=388)
{
...
struct _RAID_UNIT_ATTRIBUTES// Size=0x4 (Id=562)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _UNICODE_STRING// Size=0x10 (Id=343)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    unsigned short MaximumLength;// Offset=0x2 Size=0x2
...
struct _RAID_WORK_ITEM_CONTEXT// Size=0x10 (Id=453)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
    struct _IRP * Irp;// Offset=0x8 Size=0x8
};

struct _STOR_ASYNC_NOTIFY_CONTEXT// Size=0x18 (Id=404)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
...
struct _RAID_SHARED_WORK_ITEM_CONTEXT// Size=0x18 (Id=514)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
    struct _IRP * Irp;// Offset=0x8 Size=0x8
    unsigned long InUse;// Offset=0x10 Size=0x4
...
struct _anonymous_264// Size=0x10 (Id=264)
{
...
struct _anonymous_379// Size=0x4 (Id=379)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _TELEMETRY_UNIT_EXTENSION// Size=0x8 (Id=380)
{
    struct _anonymous_379 Flags;// Offset=0x0 Size=0x4
    unsigned char NvmeCriticalWarning;// Offset=0x4 Size=0x1
    unsigned char DeviceHealthPollCount;// Offset=0x5 Size=0x1
};

struct _RAID_TELEMETRY_NODE_COUNTERS// Size=0x18 (Id=370)
{
...
struct _RAID_TELEMETRY_ERROR_ENTRY// Size=0x28 (Id=547)
{
    ...
    union _anonymous_546 u;// Offset=0x20 Size=0x4
};

struct _RAID_TELEMETRY_SAMPLED_ERROR_LOG// Size=0x1c8 (Id=570)
{
...
struct _RAID_TELEMETRY_UNIQUE_ERROR_LOG// Size=0x190 (Id=509)
{
    struct _RAID_TELEMETRY_ERROR_ENTRY UniqueErrors[10];// Offset=0x0 Size=0x190
};

struct _RAID_UNIT_QOS// Size=0x30 (Id=648)
{
...
struct _RAID_UNIT_EXTENSION// Size=0xd40 (Id=267)
{
    ...
    struct _anonymous_258 Flags;// Offset=0x1c0 Size=0x8
    union _anonymous_259 InterlockedFlags;// Offset=0x1c8 Size=0x4
    ...
    struct _anonymous_261 DeferredList;// Offset=0x510 Size=0x190
    ...
    struct _anonymous_264 PendingPowerUpContext;// Offset=0x778 Size=0x10
    ...
    struct _RAID_TELEMETRY_PERF_BUCKET * TelemetryPerfBuckets;// Offset=0x8c8 Size=0x8
    union _LARGE_INTEGER TelemetryLastPerfCollectionTimeStamp;// Offset=0x8d0 Size=0x8
    struct _RAID_TELEMETRY_PERF_BUCKET * TelemetryPerfPreviousCounters;// Offset=0x8d8 Size=0x8
    struct _RAID_TELEMETRY_NODE_COUNTERS * TelemetryCountersPerNumaNode;// Offset=0x8e0 Size=0x8
    struct _RAID_TELEMETRY_NODE_COUNTERS TelemetryPerfPreviousNodeCounters;// Offset=0x8e8 Size=0x18
    unsigned long long TelemetryMaxFlushLatency;// Offset=0x900 Size=0x8
    unsigned long long TelemetryMaxUnmapLatency;// Offset=0x908 Size=0x8
    unsigned long long TelemetryLock;// Offset=0x910 Size=0x8
    struct _RAID_TELEMETRY_SAMPLED_ERROR_LOG TelemetrySampledErrorLog;// Offset=0x918 Size=0x1c8
    struct _RAID_TELEMETRY_UNIQUE_ERROR_LOG TelemetryUniqueErrorLog;// Offset=0xae0 Size=0x190
    unsigned long long TelemetryBytesWritten;// Offset=0xc70 Size=0x8
    unsigned long long TelemetryStreamBytesWritten;// Offset=0xc78 Size=0x8
    unsigned long PowerCycleCount;// Offset=0xc80 Size=0x4
    union _LARGE_INTEGER InitialTimestamp;// Offset=0xc88 Size=0x8
    struct _RAID_UNIT_QOS Qos;// Offset=0xc90 Size=0x30
    unsigned long long ZoneSize;// Offset=0xcc0 Size=0x8
    unsigned char * CachedSmartData;// Offset=0xcc8 Size=0x8
    enum _STORAGE_BUS_TYPE BusType;// Offset=0xcd0 Size=0x4
    unsigned char * ZonePendingIoTable;// Offset=0xcd8 Size=0x8
    struct _RTL_BITMAP ZoneIoBitMap;// Offset=0xce0 Size=0x10
    union _LARGE_INTEGER LastLogicalBlockAddress;// Offset=0xcf0 Size=0x8
    struct _anonymous_265 DFxQueue;// Offset=0xcf8 Size=0x20
    long  ( * CrashdumpNotifyRoutine)(enum _STORAGE_DUMP_EVENT ,void * );// Offset=0xd18 Size=0x8
};
