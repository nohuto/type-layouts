...
struct _anonymous_656// Size=0x18 (Id=656)
{
...
struct _anonymous_658// Size=0x18 (Id=658)
{
...
struct _anonymous_662// Size=0xc (Id=662)
{
...
struct _anonymous_663// Size=0x18 (Id=663)
{
...
union _anonymous_666// Size=0x18 (Id=666)
{
    union // Size=0x18 (Id=0)
    {
        struct _anonymous_656 Port;// Offset=0x0 Size=0x18
        struct _anonymous_656 Memory;// Offset=0x0 Size=0x18
        struct _anonymous_658 Interrupt;// Offset=0x0 Size=0x18
        struct _anonymous_659 Dma;// Offset=0x0 Size=0x8
        struct _anonymous_660 DmaV3;// Offset=0x0 Size=0x10
        struct _anonymous_656 Generic;// Offset=0x0 Size=0x18
        struct _anonymous_630 DevicePrivate;// Offset=0x0 Size=0xc
        struct _anonymous_661 BusNumber;// Offset=0x0 Size=0x10
        struct _anonymous_662 ConfigData;// Offset=0x0 Size=0xc
        struct _anonymous_663 Memory40;// Offset=0x0 Size=0x18
        struct _anonymous_664 Memory48;// Offset=0x0 Size=0x18
        struct _anonymous_665 Memory64;// Offset=0x0 Size=0x18
...
struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=667)
{
    ...
    union _anonymous_666 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=623)
{
