...
struct _STOR_LOCKED_LIST// Size=0x20 (Id=303)
{
...
struct _RAID_RESOURCE_LIST// Size=0x10 (Id=313)
{
...
struct _MEMORY_REGION// Size=0x18 (Id=523)
{
...
struct _PORT_CONFIGURATION_INFORMATION// Size=0xe0 (Id=301)
{
...
struct _anonymous_304// Size=0x1 (Id=304)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _RAID_MINIPORT// Size=0x130 (Id=305)
{
    ...
    struct _anonymous_304 Flags;// Offset=0xf8 Size=0x1
...
struct _BUS_INTERFACE_STANDARD// Size=0x40 (Id=681)
{
...
struct _RAID_BUS_INTERFACE// Size=0x48 (Id=651)
{
...
struct _IO_CONT_RESOURCE_LIST// Size=0x80 (Id=423)
{
...
struct _STOR_NOTIFICATION_INFO// Size=0x20 (Id=424)
{
...
struct _anonymous_272// Size=0x50 (Id=272)
{
    struct _RAID_DEFERRED_ELEMENT Timer;// Offset=0x0 Size=0x50
};

struct _anonymous_273// Size=0xb0 (Id=273)
{
...
struct _PORT_REGISTRY_INFO// Size=0x40 (Id=478)
{
...
struct _RAID_ADAPTER_PARAMETERS// Size=0x38 (Id=599)
{
...
struct _anonymous_275// Size=0x1 (Id=275)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _SCSI_POWER_REQUEST_BLOCK// Size=0x58 (Id=544)
{
    unsigned short Length;// Offset=0x0 Size=0x2
...
struct _RAID_POWER_CONTEXT// Size=0xb8 (Id=444)
{
...
struct _STORPORT_EXTENDED_FUNCTIONS// Size=0x58 (Id=348)
{
...
union _RAID_REDIRECTION_SUPPORT// Size=0x2 (Id=576)
{
...
struct _PCI_HEADER_TYPE_0// Size=0x30 (Id=528)
{
...
struct _PCI_HEADER_TYPE_1// Size=0x30 (Id=653)
{
...
struct _anonymous_674// Size=0x8 (Id=674)
{
    unsigned long Base;// Offset=0x0 Size=0x4
    unsigned long Limit;// Offset=0x4 Size=0x4
};

struct _PCI_HEADER_TYPE_2// Size=0x30 (Id=675)
{
    ...
    unsigned char SubordinateBus;// Offset=0xa Size=0x1
    unsigned char SecondaryLatency;// Offset=0xb Size=0x1
    struct _anonymous_674 Range[4];// Offset=0xc Size=0x20
    unsigned char InterruptLine;// Offset=0x2c Size=0x1
    unsigned char InterruptPin;// Offset=0x2d Size=0x1
    unsigned short BridgeControl;// Offset=0x2e Size=0x2
};

union _anonymous_466// Size=0x30 (Id=466)
{
...
struct _PCI_COMMON_HEADER// Size=0x40 (Id=467)
{
    ...
    union _anonymous_466 u;// Offset=0x10 Size=0x30
};

struct _STOR_POWER_SETTING_NOTIFICATION// Size=0x18 (Id=577)
{
...
struct _CRASHDUMP_FUNCTIONS_INTERFACE// Size=0x28 (Id=574)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
struct _RAID_RPMB_CAPABILITIES// Size=0x38 (Id=406)
{
...
struct _RAID_CRYPTO_KEY_TABLE// Size=0x18 (Id=427)
{
...
struct _anonymous_502// Size=0x4 (Id=502)
{
...
union _DSM_PCI_SSD_LED_STATE// Size=0x4 (Id=503)
{
    struct _anonymous_502 State;// Offset=0x0 Size=0x4
...
struct _RAID_ADAPTER_EXTENSION// Size=0x1740 (Id=277)
{
    ...
    long AdapterDeviceResetLock;// Offset=0x100 Size=0x4
    struct _EX_RUNDOWN_REF_CACHE_AWARE * RemoveLock;// Offset=0x108 Size=0x8
    struct _RAID_POWER_STATE Power;// Offset=0x110 Size=0x10
    struct _RAID_RESOURCE_LIST ResourceList;// Offset=0x120 Size=0x10
    struct _RAID_MINIPORT Miniport;// Offset=0x130 Size=0x130
    struct _RAID_BUS_INTERFACE Bus;// Offset=0x260 Size=0x48
    struct _KINTERRUPT * Interrupt;// Offset=0x2a8 Size=0x8
    unsigned long InterruptIrql;// Offset=0x2b0 Size=0x4
    unsigned long InterruptVersion;// Offset=0x2b4 Size=0x4
    unsigned long long StartIoLock;// Offset=0x2b8 Size=0x8
    enum _STOR_SYNCHRONIZATION_MODEL IoModel;// Offset=0x2c0 Size=0x4
    struct _RAID_DMA_ADAPTER Dma;// Offset=0x2c8 Size=0x20
    struct _RAID_MEMORY_REGION UncachedExtension;// Offset=0x2e8 Size=0x18
    unsigned long BusNumber;// Offset=0x300 Size=0x4
    unsigned long SlotNumber;// Offset=0x304 Size=0x4
    struct _MAPPED_ADDRESS * MappedAddressList;// Offset=0x308 Size=0x8
    struct _STOR_IO_GATEWAY Gateway;// Offset=0x340 Size=0x140
    struct _RAID_DEFERRED_QUEUE DeferredQueue;// Offset=0x480 Size=0x80
    struct _anonymous_272 DeferredList;// Offset=0x500 Size=0x50
    struct _anonymous_273 DeferredPauseResumeContext;// Offset=0x550 Size=0xb0
    ...
    struct _anonymous_275 PerfOptFlags;// Offset=0x11a3 Size=0x1
    ...
    struct _anonymous_276 TelemetryHierarchicalResetLunBucket[5];// Offset=0x1464 Size=0x3c
    struct _anonymous_276 TelemetryHierarchicalResetTargetBucket[5];// Offset=0x14a0 Size=0x3c
