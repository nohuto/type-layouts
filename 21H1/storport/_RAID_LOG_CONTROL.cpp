struct _anonymous_618// Size=0x8 (Id=618)
{
...
{
    struct _anonymous_618 u;// Offset=0x0 Size=0x8
    unsigned long long asUlong64;// Offset=0x0 Size=0x8
};

struct _RAID_LOG_CONTROL// Size=0x10 (Id=617)
{
    unsigned long Revision;// Offset=0x0 Size=0x4
    union _anonymous_619 Enable;// Offset=0x8 Size=0x8
};
