...
struct _anonymous_631// Size=0x8 (Id=631)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _anonymous_632// Size=0x4 (Id=632)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _anonymous_633// Size=0x8 (Id=633)
{
    struct _anonymous_631 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_632 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_631 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=634)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_633 Data;// Offset=0x4 Size=0x8
};
