...
struct _anonymous_603// Size=0x8 (Id=603)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
};

struct _anonymous_604// Size=0x4 (Id=604)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _anonymous_605// Size=0x8 (Id=605)
{
    struct _anonymous_603 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_604 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_603 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=243)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_605 Data;// Offset=0x4 Size=0x8
};
