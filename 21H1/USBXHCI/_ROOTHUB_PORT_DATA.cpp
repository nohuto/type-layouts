union _CONTROLLER_USB_20_HARDWARE_LPM_FLAGS// Size=0x1 (Id=907)
{
...
union _ROOTHUB_PORT_DATA_FLAGS// Size=0x4 (Id=905)
{
...
struct _ROOTHUB_PORT_DATA// Size=0x68 (Id=660)
{
    ...
    struct _ROOTHUB_PORT_ERROR PortErrorBookKeeping;// Offset=0x58 Size=0x10
};
