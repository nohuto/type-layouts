...
struct _STRING64// Size=0x10 (Id=1723)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    unsigned short MaximumLength;// Offset=0x2 Size=0x2
...
struct _WMI_LOGGER_INFORMATION// Size=0xb0 (Id=2027)
{
    ...
    union // Size=0x8 (Id=0)
    {
        ...
        {
            unsigned long long Wow:1;// Offset=0x50 Size=0x8 BitOffset=0x0 BitSize=0x1
            unsigned long long QpcDeltaTracking:1;// Offset=0x50 Size=0x8 BitOffset=0x1 BitSize=0x1
            unsigned long long LargeMdlPages:1;// Offset=0x50 Size=0x8 BitOffset=0x2 BitSize=0x1
            unsigned long long ExcludeKernelStack:1;// Offset=0x50 Size=0x8 BitOffset=0x3 BitSize=0x1
        };
