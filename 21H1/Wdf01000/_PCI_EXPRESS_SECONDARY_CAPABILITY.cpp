...
struct _PCI_EXPRESS_LINK_CONTROL3// Size=0x4 (Id=2585)
{
    union // Size=0x4 (Id=0)
    {
...
struct _PCI_EXPRESS_LANE_ERROR_STATUS// Size=0x4 (Id=2098)
{
    unsigned long LaneBitmap;// Offset=0x0 Size=0x4
};

struct _PCI_EXPRESS_SECONDARY_CAPABILITY// Size=0xc (Id=2117)
{
