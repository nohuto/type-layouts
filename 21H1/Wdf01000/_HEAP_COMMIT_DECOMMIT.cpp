...
struct _HEAP_EVENT_COMMIT_DECOMMIT// Size=0x20 (Id=2261)
{
    void * HeapHandle;// Offset=0x0 Size=0x8
    void * Block;// Offset=0x8 Size=0x8
    unsigned long long Size;// Offset=0x10 Size=0x8
    unsigned long Caller;// Offset=0x18 Size=0x4
};

struct _HEAP_COMMIT_DECOMMIT// Size=0x40 (Id=2683)
{
    struct _SYSTEM_TRACE_HEADER Header;// Offset=0x0 Size=0x20
    struct _HEAP_EVENT_COMMIT_DECOMMIT Event;// Offset=0x20 Size=0x20
};
