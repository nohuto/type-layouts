...
struct _PCI_EXPRESS_SERIAL_NUMBER_CAPABILITY// Size=0xc (Id=2911)
{
    struct _PCI_EXPRESS_ENHANCED_CAPABILITY_HEADER Header;// Offset=0x0 Size=0x4
    unsigned long LowSerialNumber;// Offset=0x4 Size=0x4
    unsigned long HighSerialNumber;// Offset=0x8 Size=0x4
};
