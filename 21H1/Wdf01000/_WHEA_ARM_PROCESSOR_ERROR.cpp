union _WHEA_ARM_CACHE_ERROR_VALID_BITS// Size=0x2 (Id=1770)
{
...
struct _WHEA_ARM_CACHE_ERROR// Size=0xc (Id=2146)
{
...
struct _WHEA_ARM_TLB_ERROR// Size=0xc (Id=2646)
{
...
union _WHEA_ARM_BUS_ERROR_VALID_BITS// Size=0x2 (Id=2999)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short TransactionType:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
