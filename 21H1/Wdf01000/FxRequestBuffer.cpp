struct FxRequestBuffer// Size=0x20 (Id=1023)
{
    union // Size=0x446 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x18 (Id=58759)
        {
            struct <unnamed-type-Memory>// Size=0x10 (Id=58760)
            {
