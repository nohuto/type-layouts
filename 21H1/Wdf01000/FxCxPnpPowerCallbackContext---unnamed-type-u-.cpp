union FxCxPnpPowerCallbackContext::<unnamed-type-u>// Size=0x18 (Id=1430)
{
    union // Size=0x18 (Id=0)
    {
        struct <unnamed-type-Generic>// Size=0x18 (Id=25546)
        {
        ...
        struct <unnamed-type-PrepareHardware>// Size=0x18 (Id=25551)
        {
        ...
        struct <unnamed-type-ReleaseHardware>// Size=0x10 (Id=25556)
        {
        ...
        struct <unnamed-type-D0Entry>// Size=0x18 (Id=25560)
        {
        ...
        struct <unnamed-type-SmIoRestart>// Size=0x18 (Id=25574)
        {
            long  ( * PreCallback)(struct WDFDEVICE__ * );// Offset=0x0 Size=0x8
            long  ( * PostCallback)(struct WDFDEVICE__ * );// Offset=0x8 Size=0x8
            void  ( * CleanupCallback)(struct WDFDEVICE__ * );// Offset=0x10 Size=0x8
        ...
        struct <unnamed-type-SmIoRestartEx>// Size=0x18 (Id=25579)
        {
            long  ( * PreCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x0 Size=0x8
            long  ( * PostCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x8 Size=0x8
            void  ( * CleanupCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x10 Size=0x8
        ...
        struct <unnamed-type-ArmWakeFromSx>// Size=0x18 (Id=25617)
        {
            long  ( * PreCallback)(struct WDFDEVICE__ * );// Offset=0x0 Size=0x8
            long  ( * PostCallback)(struct WDFDEVICE__ * );// Offset=0x8 Size=0x8
            void  ( * CleanupCallback)(struct WDFDEVICE__ * );// Offset=0x10 Size=0x8
        ...
        struct <unnamed-type-ArmWakeFromSxWithReason>// Size=0x18 (Id=25622)
        {
        ...
        struct <unnamed-type-D0EntryPostHardwareEnabled>// Size=0x18 (Id=25635)
        {
            long  ( * PreCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x0 Size=0x8
            long  ( * PostCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x8 Size=0x8
            void  ( * CleanupCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x10 Size=0x8
        ...
        struct <unnamed-type-D0ExitPreHardwareDisabled>// Size=0x10 (Id=25640)
        {
            long  ( * PreCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x0 Size=0x8
            long  ( * PostCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x8 Size=0x8
        };
