...
union _PCI_EXPRESS_TPH_REQUESTER_CAPABILITY_REGISTER// Size=0x4 (Id=1799)
{
...
union _PCI_EXPRESS_TPH_REQUESTER_CONTROL_REGISTER// Size=0x4 (Id=2367)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PCI_EXPRESS_TPH_REQUESTER_CAPABILITY// Size=0xc (Id=2767)
{
