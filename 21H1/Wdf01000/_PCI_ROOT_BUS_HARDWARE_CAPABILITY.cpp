...
struct _PCI_ROOT_BUS_OSC_SUPPORT_FIELD// Size=0x4 (Id=2030)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=12076)
        {
...
struct _PCI_ROOT_BUS_OSC_CONTROL_FIELD// Size=0x4 (Id=2997)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=12066)
        {
...
struct _PCI_ROOT_BUS_HARDWARE_CAPABILITY// Size=0x24 (Id=1804)
{
