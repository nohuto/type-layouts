...
struct _ETW_TP_EVENT_WORKER_NUMANODE_SWITCH// Size=0x40 (Id=2223)
{
    struct _SYSTEM_TRACE_HEADER Header;// Offset=0x0 Size=0x20
    void * PoolId;// Offset=0x20 Size=0x8
    unsigned long CurrentNode;// Offset=0x28 Size=0x4
    unsigned long NextNode;// Offset=0x2c Size=0x4
    unsigned short CurrentGroup;// Offset=0x30 Size=0x2
    unsigned short NextGroup;// Offset=0x32 Size=0x2
    unsigned long CurrentWorkerCount;// Offset=0x34 Size=0x4
    unsigned long NextWorkerCount;// Offset=0x38 Size=0x4
};
