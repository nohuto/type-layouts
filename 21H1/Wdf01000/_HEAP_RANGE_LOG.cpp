...
struct _HEAP_EVENT_RANGE// Size=0x18 (Id=2115)
{
    void * HeapHandle;// Offset=0x0 Size=0x8
    void * Address;// Offset=0x8 Size=0x8
    unsigned long long Size;// Offset=0x10 Size=0x8
};

struct _HEAP_RANGE_LOG// Size=0x38 (Id=2279)
{
    struct _SYSTEM_TRACE_HEADER Header;// Offset=0x0 Size=0x20
    struct _HEAP_EVENT_RANGE Range;// Offset=0x20 Size=0x18
};
