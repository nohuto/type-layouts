...
struct FxIoTargetRemoveOpenParams// Size=0x48 (Id=1094)
{
    void FxIoTargetRemoveOpenParams();
    union // Size=0x53 (Id=0)
    {
        void Set(struct _WDF_IO_TARGET_OPEN_PARAMS * ,struct _UNICODE_STRING * ,void * ,unsigned long );// Offset=0x0 Size=0x53
        void Clear();// Offset=0x0 Size=0x3a
