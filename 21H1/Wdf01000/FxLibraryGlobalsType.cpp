struct _OSVERSIONINFOEXW// Size=0x11c (Id=569)
{
...
struct _FX_DRIVER_TRACKER_CACHE_AWARE// Size=0x18 (Id=1344)
{
    union // Size=0x1ee (Id=0)
    {
        struct _FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=7935)
        {
        ...
        struct FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=7949)
        {
        };// Offset=0x0 Size=0x8
        long Initialize();
        void Uninitialize();
...
struct _WMI_WDF_NOTIFY_ROUTINES// Size=0x20 (Id=1044)
{
...
struct FxLibraryGlobalsType// Size=0x2a8 (Id=1371)
{
