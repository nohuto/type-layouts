...
union _anonymous_1923// Size=0x20 (Id=1923)
{
    union // Size=0x20 (Id=0)
    {
        struct _anonymous_1914 DeviceClass;// Offset=0x0 Size=0x14
        struct _anonymous_1915 TargetDevice;// Offset=0x0 Size=0x2
        struct _anonymous_1915 InstallDevice;// Offset=0x0 Size=0x2
        struct _anonymous_1916 CustomNotification;// Offset=0x0 Size=0x10
        struct _anonymous_1917 ProfileNotification;// Offset=0x0 Size=0x8
        struct _anonymous_1918 PowerNotification;// Offset=0x0 Size=0x8
        struct _anonymous_1919 VetoNotification;// Offset=0x0 Size=0x8
        struct _anonymous_1920 BlockedDriverNotification;// Offset=0x0 Size=0x10
        struct _anonymous_1921 InvalidIDNotification;// Offset=0x0 Size=0x2
        struct _anonymous_1922 PowerSettingNotification;// Offset=0x0 Size=0x20
        struct _anonymous_1915 PropertyChangeNotification;// Offset=0x0 Size=0x2
        struct _anonymous_1915 DeviceInstanceNotification;// Offset=0x0 Size=0x2
    };
};

struct _PLUGPLAY_EVENT_BLOCK// Size=0x50 (Id=1924)
{
    ...
    union _anonymous_1923 u;// Offset=0x30 Size=0x20
};

struct _PNP_DEVICE_EVENT_ENTRY// Size=0xc0 (Id=1438)
{
