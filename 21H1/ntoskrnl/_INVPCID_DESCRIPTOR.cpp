struct _anonymous_388// Size=0x10 (Id=388)
{
    union // Size=0x8 (Id=0)
    {
...
union _INVPCID_DESCRIPTOR// Size=0x10 (Id=391)
{
    struct _anonymous_388 IndividualAddress;// Offset=0x0 Size=0x10
    struct _anonymous_389 SingleContext;// Offset=0x0 Size=0x10
    struct _anonymous_390 AllContextAndGlobals;// Offset=0x0 Size=0x10
    struct _anonymous_390 AllContext;// Offset=0x0 Size=0x10
};
