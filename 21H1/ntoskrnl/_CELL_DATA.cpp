...
struct _CHILD_LIST// Size=0x8 (Id=1316)
{
...
struct _SECURITY_DESCRIPTOR_RELATIVE// Size=0x14 (Id=1619)
{
...
struct _CM_KEY_SECURITY// Size=0x28 (Id=1730)
{
    unsigned short Signature;// Offset=0x0 Size=0x2
...
struct _CM_KEY_INDEX// Size=0x8 (Id=1773)
{
    unsigned short Signature;// Offset=0x0 Size=0x2
...
struct _CM_BIG_DATA// Size=0x8 (Id=1875)
{
    unsigned short Signature;// Offset=0x0 Size=0x2
    unsigned short Count;// Offset=0x2 Size=0x2
    unsigned long List;// Offset=0x4 Size=0x4
...
struct _CELL_DATA// Size=0x50 (Id=1484)
{
