...
struct _MI_STORE_INPAGE_COMPLETE_FLAGS// Size=0x4 (Id=2015)
{
    union // Size=0x4 (Id=0)
    {
...
struct _MMINPAGE_SUPPORT_FLOW_THROUGH// Size=0x38 (Id=1627)
{
...
struct _MMINPAGE_SUPPORT// Size=0x1c0 (Id=1261)
{
    union // Size=0x10 (Id=0)
    {
    ...
    union _anonymous_1258 u2;// Offset=0x68 Size=0x30
    ...
    union _anonymous_1259 u3;// Offset=0xbc Size=0x4
    union _anonymous_1260 u1;// Offset=0xc0 Size=0x4
    union // Size=0x8 (Id=0)
    {
