struct _MI_PARTITION_FLAGS// Size=0x4 (Id=1795)
{
...
union _anonymous_1380// Size=0x4 (Id=1380)
{
...
struct _MI_PARTITION_CORE// Size=0x1b8 (Id=1381)
{
    unsigned short PartitionId;// Offset=0x0 Size=0x2
    union _anonymous_1380 u;// Offset=0x4 Size=0x4
...
struct _MMPAGE_FILE_EXPANSION_FLAGS// Size=0x4 (Id=1971)
{
    struct // Size=0x4 (Id=0)
    {
...
union _anonymous_1517// Size=0x4 (Id=1517)
{
    unsigned long LongFlags;// Offset=0x0 Size=0x4
    struct _MMPAGE_FILE_EXPANSION_FLAGS Flags;// Offset=0x0 Size=0x4
};

struct _MMPAGE_FILE_EXPANSION// Size=0x58 (Id=1518)
{
    ...
    union _anonymous_1517 u1;// Offset=0x4c Size=0x4
...
struct _MMMOD_WRITER_LISTHEAD// Size=0x28 (Id=1803)
{
...
union _MI_RESERVATION_CLUSTER_INFO// Size=0x4 (Id=2013)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_MODWRITE_DATA// Size=0x40 (Id=1882)
{
...
struct _MI_RESTRICTED_MODWRITES// Size=0x3 (Id=1974)
{
...
struct _MI_PARTITION_MODWRITES// Size=0x2c0 (Id=1700)
{
...
struct _MMDEREFERENCE_SEGMENT_HEADER// Size=0x50 (Id=1841)
{
...
struct _MI_PTE_CHAIN_HEAD// Size=0x18 (Id=1931)
{
...
struct _MI_CROSS_PARTITION_CHARGES// Size=0x20 (Id=1876)
{
...
struct _MI_PARTITION_SEGMENTS// Size=0x340 (Id=1474)
{
...
struct _MI_PARTITION_COMMIT// Size=0x40 (Id=1593)
{
...
struct _MI_WRITE_CALIBRATION// Size=0x20 (Id=1945)
{
...
struct _MI_PARTITION_ZEROING// Size=0xb0 (Id=1556)
{
...
struct _MI_PAGE_COMBINING_SUPPORT// Size=0x190 (Id=1297)
{
...
struct _anonymous_1391// Size=0x38 (Id=1391)
{
    struct _MDL Mdl;// Offset=0x0 Size=0x30
    unsigned long long Page[1];// Offset=0x30 Size=0x8
};

struct _MI_PAGEFILE_TRACES// Size=0x78 (Id=1392)
{
    ...
    struct _anonymous_1391 MdlHack;// Offset=0x40 Size=0x38
};
