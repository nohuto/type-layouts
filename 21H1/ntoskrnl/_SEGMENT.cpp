struct _SEGMENT_FLAGS// Size=0x4 (Id=1737)
{
    union // Size=0x2 (Id=0)
    {
...
struct _SEGMENT// Size=0x48 (Id=544)
{
    ...
    union _anonymous_542 u1;// Offset=0x30 Size=0x8
    union _anonymous_543 u2;// Offset=0x38 Size=0x8
