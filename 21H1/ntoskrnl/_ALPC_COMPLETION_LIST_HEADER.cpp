struct _anonymous_1648// Size=0x8 (Id=1648)
{
...
union _anonymous_1649// Size=0x8 (Id=1649)
{
    struct _anonymous_1648 s1;// Offset=0x0 Size=0x8
    long long Value;// Offset=0x0 Size=0x8
};

struct _ALPC_COMPLETION_LIST_STATE// Size=0x8 (Id=1650)
{
    union _anonymous_1649 u1;// Offset=0x0 Size=0x8
};

struct _RTL_SRWLOCK// Size=0x8 (Id=1345)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _ALPC_COMPLETION_LIST_HEADER// Size=0x180 (Id=1408)
{
