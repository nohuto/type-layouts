struct _anonymous_1207// Size=0x8 (Id=1207)
{
    unsigned long long EntireField;// Offset=0x0 Size=0x8
};

struct _anonymous_1208// Size=0x8 (Id=1208)
{
...
union _anonymous_1209// Size=0x8 (Id=1209)
{
    struct _anonymous_1207 e1;// Offset=0x0 Size=0x8
    struct _anonymous_1208 e2;// Offset=0x0 Size=0x8
};

struct _MI_HUGE_PFN// Size=0x8 (Id=1210)
{
    union _anonymous_1209 u1;// Offset=0x0 Size=0x8
};
