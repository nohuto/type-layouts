struct _DBGKD_READ_MEMORY64// Size=0x10 (Id=640)
{
...
struct _DBGKD_WRITE_MEMORY64// Size=0x10 (Id=642)
{
    unsigned long long TargetBaseAddress;// Offset=0x0 Size=0x8
    unsigned long TransferCount;// Offset=0x8 Size=0x4
...
struct _DBGKD_GET_CONTEXT// Size=0x4 (Id=1418)
{
...
struct _X86_DBGKD_CONTROL_SET// Size=0x10 (Id=1422)
{
    unsigned long TraceFlag;// Offset=0x0 Size=0x4
...
struct _IA64_DBGKD_CONTROL_SET// Size=0x14 (Id=1582)
{
...
struct _ARM_DBGKD_CONTROL_SET// Size=0xc (Id=1294)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
...
struct _ARM64_DBGKD_CONTROL_SET// Size=0x18 (Id=1453)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
...
struct _ARMCE_DBGKD_CONTROL_SET// Size=0xc (Id=1064)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
    unsigned long CurrentSymbolStart;// Offset=0x4 Size=0x4
    unsigned long CurrentSymbolEnd;// Offset=0x8 Size=0x4
...
struct _PPC_DBGKD_CONTROL_SET// Size=0xc (Id=1701)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
    unsigned long CurrentSymbolStart;// Offset=0x4 Size=0x4
    unsigned long CurrentSymbolEnd;// Offset=0x8 Size=0x4
...
struct _DBGKD_CONTINUE2// Size=0x20 (Id=665)
{
    long ContinueStatus;// Offset=0x0 Size=0x4
    union // Size=0x1c (Id=0)
    {
...
struct _DBGKD_READ_WRITE_IO64// Size=0x10 (Id=646)
{
...
struct _DBGKD_READ_WRITE_IO_EXTENDED64// Size=0x20 (Id=648)
{
...
struct _DBGKD_SET_SPECIAL_CALL64// Size=0x8 (Id=651)
{
    unsigned long long SpecialCall;// Offset=0x0 Size=0x8
};

struct _DBGKD_SET_INTERNAL_BREAKPOINT64// Size=0x10 (Id=653)
{
    unsigned long long BreakpointAddress;// Offset=0x0 Size=0x8
    unsigned long Flags;// Offset=0x8 Size=0x4
};

struct _DBGKD_GET_INTERNAL_BREAKPOINT64// Size=0x20 (Id=654)
{
    unsigned long long BreakpointAddress;// Offset=0x0 Size=0x8
    unsigned long Flags;// Offset=0x8 Size=0x4
...
struct _DBGKD_GET_VERSION64// Size=0x28 (Id=1600)
{
...
struct _DBGKD_SEARCH_MEMORY// Size=0x18 (Id=662)
{
    union // Size=0x8 (Id=0)
    {
...
struct _DBGKD_FILL_MEMORY// Size=0x10 (Id=1708)
{
...
struct _DBGKD_SWITCH_PARTITION// Size=0x4 (Id=1575)
{
    unsigned long Partition;// Offset=0x0 Size=0x4
};

struct _DBGKD_CONTEXT_EX// Size=0xc (Id=1622)
{
...
union _anonymous_656// Size=0x28 (Id=656)
{
...
struct _DBGKD_MANIPULATE_STATE64// Size=0x38 (Id=657)
{
    ...
    union _anonymous_656 u;// Offset=0x10 Size=0x28
};
