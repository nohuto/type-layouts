...
struct _anonymous_806// Size=0x4 (Id=806)
{
...
union _anonymous_807// Size=0x4 (Id=807)
{
    struct _anonymous_806 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

union _KALPC_DIRECT_EVENT// Size=0x8 (Id=818)
{
...
struct _KALPC_WORK_ON_BEHALF_DATA// Size=0x8 (Id=1685)
{
    struct _ALPC_WORK_ON_BEHALF_TICKET Ticket;// Offset=0x0 Size=0x8
};

struct _KALPC_MESSAGE_ATTRIBUTES// Size=0x48 (Id=813)
{
...
struct _KALPC_MESSAGE// Size=0x118 (Id=808)
{
    ...
    union _anonymous_807 u1;// Offset=0x28 Size=0x4
