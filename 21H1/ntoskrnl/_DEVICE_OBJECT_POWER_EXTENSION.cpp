...
struct _anonymous_1505// Size=0x8 (Id=1505)
{
    unsigned long IdleTime;// Offset=0x0 Size=0x4
    unsigned long NonIdleTime;// Offset=0x4 Size=0x4
};

union _anonymous_1506// Size=0x8 (Id=1506)
{
    struct _anonymous_1505 Disk;// Offset=0x0 Size=0x8
};

struct _DEVICE_OBJECT_POWER_EXTENSION// Size=0x60 (Id=1507)
{
    ...
    union _anonymous_1506 Specific;// Offset=0x58 Size=0x8
};
