...
struct _I386_LOADER_BLOCK// Size=0x10 (Id=1928)
{
...
struct _ARM_LOADER_BLOCK// Size=0x4 (Id=1997)
{
    unsigned long PlaceHolder;// Offset=0x0 Size=0x4
};

union _anonymous_1740// Size=0x10 (Id=1740)
{
...
struct _EFI_FIRMWARE_INFORMATION// Size=0x38 (Id=2004)
{
...
struct _PCAT_FIRMWARE_INFORMATION// Size=0x4 (Id=2011)
{
    unsigned long PlaceHolder;// Offset=0x0 Size=0x4
};

union _anonymous_1938// Size=0x38 (Id=1938)
{
...
struct _FIRMWARE_INFORMATION_LOADER_BLOCK// Size=0x40 (Id=1939)
{
    ...
    union _anonymous_1938 u;// Offset=0x8 Size=0x38
};

struct _LOADER_PARAMETER_BLOCK// Size=0x160 (Id=1741)
{
    ...
    union _anonymous_1740 u;// Offset=0xf8 Size=0x10
