struct _VF_AVL_TREE_NODE// Size=0x10 (Id=1592)
{
    void * p;// Offset=0x0 Size=0x8
    unsigned long long RangeSize;// Offset=0x8 Size=0x8
};

struct _VF_AVL_TREE_NODE_EX// Size=0x18 (Id=1635)
{
...
struct _VF_TARGET_DRIVER// Size=0x40 (Id=1374)
{
    struct _VF_AVL_TREE_NODE_EX TreeNode;// Offset=0x0 Size=0x18
    union _anonymous_1373 u1;// Offset=0x18 Size=0x20
