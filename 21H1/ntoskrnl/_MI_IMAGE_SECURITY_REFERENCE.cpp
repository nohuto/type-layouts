...
struct _IMAGE_SECURITY_CONTEXT// Size=0x8 (Id=1607)
{
    union // Size=0x8 (Id=0)
    {
...
union _anonymous_1070// Size=0x8 (Id=1070)
{
...
struct _MI_IMAGE_SECURITY_REFERENCE// Size=0x40 (Id=1071)
{
    ...
    union _anonymous_1070 u1;// Offset=0x30 Size=0x8
