...
struct _PO_FX_COMPONENT_PERF_SET// Size=0x30 (Id=2041)
{
    ...
    {
        struct _anonymous_2039 Discrete;// Offset=0x20 Size=0x10
        struct _anonymous_2040 Range;// Offset=0x20 Size=0x10
    };
};
