struct _PROC_IDLE_POLICY// Size=0x6 (Id=1884)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=1645)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=1572)
{
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=1588)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=1836)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROC_PERF_CHECK_CONTEXT// Size=0x40 (Id=1641)
{
...
struct _PROCESSOR_POWER_STATE// Size=0x200 (Id=1473)
{
