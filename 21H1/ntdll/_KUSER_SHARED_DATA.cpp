struct _KSYSTEM_TIME// Size=0xc (Id=413)
{
...
struct _XSTATE_FEATURE// Size=0x8 (Id=640)
{
    unsigned long Offset;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
};

struct _XSTATE_CONFIGURATION// Size=0x338 (Id=425)
{
...
struct _KUSER_SHARED_DATA// Size=0x720 (Id=10)
{
