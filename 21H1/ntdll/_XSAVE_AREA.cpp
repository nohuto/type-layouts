...
struct _XSAVE_FORMAT// Size=0x200 (Id=621)
{
    ...
    struct _M128A XmmRegisters[8];// Offset=0xa0 Size=0x80
    unsigned char Reserved4[224];// Offset=0x120 Size=0xe0
};

struct _XSAVE_AREA_HEADER// Size=0x40 (Id=454)
{
...
struct _XSAVE_AREA// Size=0x240 (Id=298)
{
