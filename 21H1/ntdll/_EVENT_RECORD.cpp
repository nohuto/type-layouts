...
struct _EVENT_DESCRIPTOR// Size=0x10 (Id=179)
{
...
struct _EVENT_HEADER// Size=0x50 (Id=447)
{
...
struct _ETW_BUFFER_CONTEXT// Size=0x4 (Id=578)
{
    union // Size=0x2 (Id=0)
    {
...
struct _EVENT_RECORD// Size=0x68 (Id=182)
{
    ...
    struct _EVENT_HEADER_EXTENDED_DATA_ITEM * ExtendedData;// Offset=0x58 Size=0x4
    void * UserData;// Offset=0x5c Size=0x4
    void * UserContext;// Offset=0x60 Size=0x4
};
