union _PS_TRUSTLET_ATTRIBUTE_ACCESSRIGHTS// Size=0x1 (Id=368)
{
...
struct _PS_TRUSTLET_ATTRIBUTE_TYPE// Size=0x4 (Id=53)
{
    union // Size=0x4 (Id=0)
    {
...
struct _PS_TRUSTLET_ATTRIBUTE_HEADER// Size=0x8 (Id=51)
{
