struct _PPM_SELECTION_STATISTICS// Size=0x80 (Id=720)
{
    ...
    struct _PPM_VETO_ACCOUNTING * PreVetoAccounting;// Offset=0x78 Size=0x4
};

struct _PROC_IDLE_STATE_BUCKET// Size=0x20 (Id=706)
{
...
struct _PROC_IDLE_STATE_ACCOUNTING// Size=0x3e8 (Id=690)
{
    unsigned long long TotalTime;// Offset=0x0 Size=0x8
...
struct _PROC_IDLE_ACCOUNTING// Size=0x410 (Id=593)
{
