...
struct _KTSS// Size=0x20ac (Id=470)
{
    ...
    unsigned long NotUsed1[4];// Offset=0xc Size=0x10
    ...
    unsigned short Reserved2;// Offset=0x4a Size=0x2
    unsigned short Cs;// Offset=0x4c Size=0x2
    unsigned short Reserved3;// Offset=0x4e Size=0x2
    unsigned short Ss;// Offset=0x50 Size=0x2
    unsigned short Reserved4;// Offset=0x52 Size=0x2
    unsigned short Ds;// Offset=0x54 Size=0x2
    unsigned short Reserved5;// Offset=0x56 Size=0x2
    unsigned short Fs;// Offset=0x58 Size=0x2
    unsigned short Reserved6;// Offset=0x5a Size=0x2
    unsigned short Gs;// Offset=0x5c Size=0x2
    unsigned short Reserved7;// Offset=0x5e Size=0x2
    unsigned short LDT;// Offset=0x60 Size=0x2
    unsigned short Reserved8;// Offset=0x62 Size=0x2
