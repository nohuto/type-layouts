...
struct _LUID_AND_ATTRIBUTES// Size=0xc (Id=501)
{
    struct _LUID Luid;// Offset=0x0 Size=0x8
    unsigned long Attributes;// Offset=0x8 Size=0x4
};

struct _INITIAL_PRIVILEGE_SET// Size=0x2c (Id=457)
{
...
struct _PRIVILEGE_SET// Size=0x14 (Id=452)
{
    unsigned long PrivilegeCount;// Offset=0x0 Size=0x4
    unsigned long Control;// Offset=0x4 Size=0x4
...
union _anonymous_95// Size=0x2c (Id=95)
{
...
struct _ACCESS_STATE// Size=0x74 (Id=96)
{
    ...
    union _anonymous_95 Privileges;// Offset=0x34 Size=0x2c
