...
union _USB_EXTENDED_PORT_ATTRIBUTES// Size=0x4 (Id=277)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=276)
{
    union // Size=0x4 (Id=0)
    {
...
struct _WMILIB_CONTEXT// Size=0x40 (Id=382)
{
...
union _USBHUB_PDO_FLAGS// Size=0x4 (Id=267)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _HUBPDO_CLEANUP_FLAGS// Size=0x4 (Id=329)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_DEVICE_FLAGS// Size=0x4 (Id=262)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _IO_CSQ// Size=0x40 (Id=273)
{
...
struct _HUB_TIMER_OBJECT// Size=0x50 (Id=266)
{
...
struct _USB_ID_STRING// Size=0x10 (Id=372)
{
...
struct _USB_INTERFACE_DESCRIPTOR// Size=0x9 (Id=385)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
...
struct _KSEMAPHORE// Size=0x20 (Id=313)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
union _USB_DEVICE_SQM_PROPERTIES// Size=0x4 (Id=318)
{
...
struct _MSOS20_DESCRIPTOR_SET_INFO// Size=0x8 (Id=290)
{
...
struct _D3COLD_SUPPORT_INTERFACE// Size=0x48 (Id=311)
{
