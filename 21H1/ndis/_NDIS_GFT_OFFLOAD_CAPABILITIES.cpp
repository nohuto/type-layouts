...
struct _NDIS_GFT_OFFLOAD_CAPABILITIES// Size=0x54 (Id=1033)
{
    ...
    unsigned long NumPacketByteCounterObjects;// Offset=0x3c Size=0x4
    unsigned long NumPacketByteCounterAndStateObjects;// Offset=0x40 Size=0x4
    unsigned long NumCounterObjectsPerIngressExactMatchFlowEntry;// Offset=0x44 Size=0x4
    unsigned long NumCounterObjectsPerEgressExactMatchFlowEntry;// Offset=0x48 Size=0x4
    unsigned long NumCounterObjectsPerIngressWildcardMatchFlowEntry;// Offset=0x4c Size=0x4
    unsigned long NumCounterObjectsPerEgressWildcardMatchFlowEntry;// Offset=0x50 Size=0x4
};
