...
struct _NDIS_OID_REQUEST_FLAGS// Size=0x4 (Id=891)
{
...
struct _NDIS_OID_REQUEST_RESERVED// Size=0x60 (Id=312)
{
    ...
    union // Size=0x48 (Id=0)
    {
        ...
        struct _NDIS_OID_REQUEST_RESERVED::_anonymous_1061::<unnamed-type-CoNdis> CoNdis;// Offset=0x28 Size=0x20
    };
    union // Size=0x60 (Id=0)
    {
        ...
        struct _NDIS_OID_REQUEST_RESERVED::_anonymous_1066::<unnamed-type-IovContext> IovContext;// Offset=0x48 Size=0x10
        struct _NDIS_OID_REQUEST_RESERVED::_anonymous_1067::<unnamed-type-PMContext> PMContext;// Offset=0x48 Size=0x18
        struct _NDIS_OID_REQUEST_RESERVED::_anonymous_1068::<unnamed-type-OffloadParamsContext> OffloadParamsContext;// Offset=0x48 Size=0x1
    };
};
