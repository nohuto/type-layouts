...
struct _IF_COUNTED_STRING_LH// Size=0x204 (Id=1193)
{
...
struct _GROUP_AFFINITY// Size=0x10 (Id=592)
{
...
struct _NDIS_NDK_RESPONSE_PARAMETERS// Size=0x40 (Id=2013)
{
...
struct _NDIS_NDK_PARAMETERS// Size=0xa8 (Id=2012)
{
...
struct _NDIS_NIC_SWITCH_VPORT_PARAMETERS// Size=0x2f0 (Id=1994)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
...
struct _NDIS_VPORT_BLOCK// Size=0x388 (Id=1921)
{
