union _NDIS_IPSEC_OFFLOAD_V2_NET_BUFFER_LIST_INFO::_anonymous_1734// Size=0x8 (Id=1734)
{
    union // Size=0x8 (Id=0)
    {
        struct <unnamed-type-Transmit>// Size=0x8 (Id=7263)
        {
            void * OffloadHandle;// Offset=0x0 Size=0x8
        };
        struct _NDIS_IPSEC_OFFLOAD_V2_NET_BUFFER_LIST_INFO::_anonymous_1735::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x8
        struct <unnamed-type-Receive>// Size=0x4 (Id=7266)
        {
        ...
        struct _NDIS_IPSEC_OFFLOAD_V2_NET_BUFFER_LIST_INFO::_anonymous_1736::<unnamed-type-Receive> Receive;// Offset=0x0 Size=0x4
    };
};
