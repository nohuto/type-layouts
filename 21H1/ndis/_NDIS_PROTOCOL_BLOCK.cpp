...
struct _REFERENCE_EX// Size=0x18 (Id=461)
{
...
struct _KMUTANT// Size=0x38 (Id=462)
{
...
struct _NDIS_CO_CLIENT_OPTIONAL_HANDLERS// Size=0xa0 (Id=464)
{
...
struct _NDIS_CO_CALL_MANAGER_OPTIONAL_HANDLERS// Size=0x90 (Id=465)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    unsigned long Reserved;// Offset=0x4 Size=0x4
...
struct _NDIS_PROTOCOL_BLOCK// Size=0x378 (Id=460)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
