...
struct _NDIS_FILTER_PARTIAL_CHARACTERISTICS// Size=0x30 (Id=736)
{
...
struct _NDIS_FILTER_BLOCK// Size=0x358 (Id=447)
{
    union // Size=0xc0 (Id=0)
    {
        ...
        struct <unnamed-type-StackExpansionFallback>// Size=0x60 (Id=6219)
        {
