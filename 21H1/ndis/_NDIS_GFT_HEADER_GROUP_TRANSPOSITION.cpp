...
struct _NDIS_GFT_HEADER_GROUP_TRANSPOSITION// Size=0x58 (Id=1626)
{
    union // Size=0x4f (Id=0)
    {
        ...
        union <unnamed-type-IPAddress>// Size=0x20 (Id=6788)
        {
            struct <unnamed-type-IPv4Address>// Size=0x8 (Id=6789)
            {
            ...
            struct <unnamed-type-IPv6Address>// Size=0x20 (Id=6793)
            {
        ...
        union <unnamed-type-TransportOrEncapsulation>// Size=0x8 (Id=6801)
        {
