...
struct _NDIS_TCP_IP_CHECKSUM_OFFLOAD// Size=0x20 (Id=1314)
{
    union // Size=0x18 (Id=0)
    {
        struct <unnamed-type-IPv4Transmit>// Size=0x8 (Id=10797)
        {
        ...
        struct <unnamed-type-IPv4Receive>// Size=0x8 (Id=10805)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
            unsigned long IpOptionsSupported:2;// Offset=0x4 Size=0x4 BitOffset=0x0 BitSize=0x2
            unsigned long TcpOptionsSupported:2;// Offset=0x4 Size=0x4 BitOffset=0x2 BitSize=0x2
        ...
        struct <unnamed-type-IPv6Transmit>// Size=0x8 (Id=10813)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
        ...
        struct <unnamed-type-IPv6Receive>// Size=0x8 (Id=10820)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
            unsigned long IpExtensionHeadersSupported:2;// Offset=0x4 Size=0x4 BitOffset=0x0 BitSize=0x2
            unsigned long TcpOptionsSupported:2;// Offset=0x4 Size=0x4 BitOffset=0x2 BitSize=0x2
...
struct _NDIS_TCP_LARGE_SEND_OFFLOAD_V1// Size=0x10 (Id=1207)
{
    union // Size=0x10 (Id=0)
    {
        struct <unnamed-type-IPv4>// Size=0x10 (Id=10881)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
...
struct _NDIS_IPSEC_OFFLOAD_V1// Size=0x1c (Id=1615)
{
    union // Size=0x18 (Id=0)
    {
        struct <unnamed-type-Supported>// Size=0x14 (Id=7195)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
        ...
        struct <unnamed-type-IPv4AH>// Size=0x4 (Id=7202)
        {
        ...
        struct <unnamed-type-IPv4ESP>// Size=0x4 (Id=7210)
        {
...
struct _NDIS_TCP_LARGE_SEND_OFFLOAD_V2// Size=0x1c (Id=1682)
{
    union // Size=0xc (Id=0)
    {
        struct <unnamed-type-IPv4>// Size=0xc (Id=10888)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
            unsigned long MaxOffLoadSize;// Offset=0x4 Size=0x4
            unsigned long MinSegmentCount;// Offset=0x8 Size=0x4
        ...
        struct <unnamed-type-IPv6>// Size=0x10 (Id=10893)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
            unsigned long MaxOffLoadSize;// Offset=0x4 Size=0x4
            unsigned long MinSegmentCount;// Offset=0x8 Size=0x4
...
struct _NDIS_IPSEC_OFFLOAD_V2// Size=0x20 (Id=1022)
{
    unsigned long Encapsulation;// Offset=0x0 Size=0x4
...
struct _NDIS_TCP_RECV_SEG_COALESCE_OFFLOAD// Size=0x2 (Id=1539)
{
    union // Size=0x1 (Id=0)
    {
        struct <unnamed-type-IPv4>// Size=0x1 (Id=10914)
        {
        ...
        struct <unnamed-type-IPv6>// Size=0x1 (Id=10917)
        {
            unsigned char Enabled;// Offset=0x0 Size=0x1
        };
    };
...
struct _NDIS_ENCAPSULATED_PACKET_TASK_OFFLOAD// Size=0x8 (Id=1856)
{
...
struct _NDIS_ENCAPSULATED_PACKET_TASK_OFFLOAD_V2// Size=0x14 (Id=1900)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x4 (Id=0)
        ...
        unsigned long MaxHeaderSizeSupported;// Offset=0x4 Size=0x4
        union _ENCAPSULATION_PROTOCOL_INFO// Size=0x4 (Id=6103)
        {
            struct _VXLAN_INFO// Size=0x4 (Id=6104)
            {
...
struct _NDIS_RFC6877_464XLAT_OFFLOAD// Size=0x8 (Id=1322)
{
    enum _NDIS_RFC6877_464XLAT_OFFLOAD_OPTIONS XlatOffload;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
};

struct _NDIS_UDP_SEGMENTATION_OFFLOAD// Size=0x1c (Id=1069)
{
    union // Size=0xc (Id=0)
    {
        struct <unnamed-type-IPv4>// Size=0xc (Id=10968)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
            unsigned long MaxOffLoadSize;// Offset=0x4 Size=0x4
        ...
        struct <unnamed-type-IPv6>// Size=0x10 (Id=10975)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
            unsigned long MaxOffLoadSize;// Offset=0x4 Size=0x4
            unsigned long MinSegmentCount:6;// Offset=0x8 Size=0x4 BitOffset=0x0 BitSize=0x6
...
struct _NDIS_OFFLOAD// Size=0xd8 (Id=1014)
{
...
struct _NDIS_TCP_CONNECTION_OFFLOAD// Size=0x14 (Id=1919)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_OFFLOAD// Size=0x538 (Id=1107)
{
