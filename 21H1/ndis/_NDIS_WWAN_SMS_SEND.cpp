...
struct _WWAN_SMS_SEND_PDU// Size=0x16f (Id=1573)
{
...
struct _WWAN_SMS_SEND_CDMA// Size=0xe0 (Id=1243)
{
...
struct _WWAN_SMS_SEND// Size=0x174 (Id=1078)
{
    union // Size=0x4 (Id=0)
    {
        enum _WWAN_SMS_FORMAT SmsFormat;// Offset=0x0 Size=0x4
        union <unnamed-type-u>// Size=0x170 (Id=14782)
        {
...
struct _NDIS_WWAN_SMS_SEND// Size=0x178 (Id=761)
{
