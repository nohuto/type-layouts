union _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-MessageInterrupt>::_anonymous_1688// Size=0x10 (Id=1688)
{
    struct <unnamed-type-Raw>// Size=0x10 (Id=2371)
    {
    ...
    struct <unnamed-type-Translated>// Size=0x10 (Id=2377)
    {
