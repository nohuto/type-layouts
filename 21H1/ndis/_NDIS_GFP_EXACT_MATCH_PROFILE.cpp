...
struct _NDIS_GFP_EXACT_MATCH_PROFILE// Size=0x20 (Id=781)
{
    ...
    unsigned long HeaderGroupExactMatchProfileArrayOffset;// Offset=0x14 Size=0x4
    unsigned long HeaderGroupExactMatchProfileArrayNumElements;// Offset=0x18 Size=0x4
    unsigned long HeaderGroupExactMatchProfileArrayElementSize;// Offset=0x1c Size=0x4
};
