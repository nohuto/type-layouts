union _NDIS_IPSEC_PACKET_INFO::_anonymous_1492// Size=0x10 (Id=1492)
{
    union // Size=0x10 (Id=0)
    {
        struct <unnamed-type-Transmit>// Size=0x10 (Id=7278)
        {
            void * OffloadHandle;// Offset=0x0 Size=0x8
            void * NextOffloadHandle;// Offset=0x8 Size=0x8
        };
        struct _NDIS_IPSEC_PACKET_INFO::_anonymous_1493::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x10
        struct <unnamed-type-Receive>// Size=0x8 (Id=7282)
        {
        ...
        struct _NDIS_IPSEC_PACKET_INFO::_anonymous_1494::<unnamed-type-Receive> Receive;// Offset=0x0 Size=0x8
    };
};
