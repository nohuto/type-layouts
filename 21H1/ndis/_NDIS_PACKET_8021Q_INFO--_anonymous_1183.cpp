union _NDIS_PACKET_8021Q_INFO::_anonymous_1183// Size=0x8 (Id=1183)
{
    struct <unnamed-type-TagHeader>// Size=0x4 (Id=9376)
    {
    ...
    struct _NDIS_PACKET_8021Q_INFO::_anonymous_1184::<unnamed-type-TagHeader> TagHeader;// Offset=0x0 Size=0x4
