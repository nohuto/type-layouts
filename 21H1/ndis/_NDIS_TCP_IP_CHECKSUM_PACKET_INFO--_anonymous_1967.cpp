union _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_anonymous_1967// Size=0x4 (Id=1967)
{
    struct <unnamed-type-Transmit>// Size=0x4 (Id=10830)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_anonymous_1968::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x4
    struct <unnamed-type-Receive>// Size=0x4 (Id=10837)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_anonymous_1969::<unnamed-type-Receive> Receive;// Offset=0x0 Size=0x4
