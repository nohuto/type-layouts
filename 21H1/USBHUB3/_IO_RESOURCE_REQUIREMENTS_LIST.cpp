...
struct _anonymous_231// Size=0x18 (Id=231)
{
...
struct _anonymous_235// Size=0x10 (Id=235)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_236// Size=0xc (Id=236)
{
...
struct _anonymous_237// Size=0x18 (Id=237)
{
...
struct _anonymous_238// Size=0x18 (Id=238)
{
...
struct _anonymous_239// Size=0x18 (Id=239)
{
...
union _anonymous_241// Size=0x18 (Id=241)
{
    union // Size=0x18 (Id=0)
    {
        struct _anonymous_228 Port;// Offset=0x0 Size=0x18
        struct _anonymous_228 Memory;// Offset=0x0 Size=0x18
        struct _anonymous_231 Interrupt;// Offset=0x0 Size=0x18
        struct _anonymous_232 Dma;// Offset=0x0 Size=0x8
        struct _anonymous_233 DmaV3;// Offset=0x0 Size=0x10
        struct _anonymous_228 Generic;// Offset=0x0 Size=0x18
        struct _anonymous_234 DevicePrivate;// Offset=0x0 Size=0xc
        struct _anonymous_235 BusNumber;// Offset=0x0 Size=0x10
        struct _anonymous_236 ConfigData;// Offset=0x0 Size=0xc
        struct _anonymous_237 Memory40;// Offset=0x0 Size=0x18
        struct _anonymous_238 Memory48;// Offset=0x0 Size=0x18
        struct _anonymous_239 Memory64;// Offset=0x0 Size=0x18
        struct _anonymous_240 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=242)
{
    ...
    union _anonymous_241 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=745)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=585)
{
