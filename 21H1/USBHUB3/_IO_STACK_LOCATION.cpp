...
struct _anonymous_42// Size=0x18 (Id=42)
{
...
struct _anonymous_44// Size=0x20 (Id=44)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_45// Size=0x10 (Id=45)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_47// Size=0x18 (Id=47)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _anonymous_49// Size=0x20 (Id=49)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
...
struct _anonymous_51// Size=0x4 (Id=51)
{
    unsigned long Length;// Offset=0x0 Size=0x4
};
...
struct _anonymous_53// Size=0x10 (Id=53)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_67// Size=0x8 (Id=67)
{
...
struct _anonymous_70// Size=0x1 (Id=70)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _anonymous_72// Size=0x4 (Id=72)
{
...
struct _anonymous_78// Size=0x4 (Id=78)
{
    enum _SYSTEM_POWER_STATE PowerState;// Offset=0x0 Size=0x4
};

struct _anonymous_79// Size=0x8 (Id=79)
{
    struct _POWER_SEQUENCE * PowerSequence;// Offset=0x0 Size=0x8
};

struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=573)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=545)
{
...
struct _anonymous_83// Size=0x10 (Id=83)
{
...
struct _anonymous_84// Size=0x20 (Id=84)
{
...
union _anonymous_86// Size=0x20 (Id=86)
{
    struct _anonymous_39 Create;// Offset=0x0 Size=0x20
    struct _anonymous_40 CreatePipe;// Offset=0x0 Size=0x20
    struct _anonymous_41 CreateMailslot;// Offset=0x0 Size=0x20
    struct _anonymous_42 Read;// Offset=0x0 Size=0x18
    struct _anonymous_42 Write;// Offset=0x0 Size=0x18
    struct _anonymous_44 QueryDirectory;// Offset=0x0 Size=0x20
    struct _anonymous_45 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _anonymous_47 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _anonymous_48 QueryFile;// Offset=0x0 Size=0x10
    struct _anonymous_49 SetFile;// Offset=0x0 Size=0x20
    struct _anonymous_50 QueryEa;// Offset=0x0 Size=0x20
    struct _anonymous_51 SetEa;// Offset=0x0 Size=0x4
    struct _anonymous_53 QueryVolume;// Offset=0x0 Size=0x10
    struct _anonymous_53 SetVolume;// Offset=0x0 Size=0x10
    struct _anonymous_54 FileSystemControl;// Offset=0x0 Size=0x20
    struct _anonymous_55 LockControl;// Offset=0x0 Size=0x18
    struct _anonymous_56 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _anonymous_57 QuerySecurity;// Offset=0x0 Size=0x10
    struct _anonymous_58 SetSecurity;// Offset=0x0 Size=0x10
    struct _anonymous_59 MountVolume;// Offset=0x0 Size=0x10
    struct _anonymous_59 VerifyVolume;// Offset=0x0 Size=0x10
    struct _anonymous_61 Scsi;// Offset=0x0 Size=0x8
    struct _anonymous_62 QueryQuota;// Offset=0x0 Size=0x20
    struct _anonymous_51 SetQuota;// Offset=0x0 Size=0x4
    struct _anonymous_64 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _anonymous_66 QueryInterface;// Offset=0x0 Size=0x20
    struct _anonymous_67 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _anonymous_68 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _anonymous_69 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _anonymous_70 SetLock;// Offset=0x0 Size=0x1
    struct _anonymous_72 QueryId;// Offset=0x0 Size=0x4
    struct _anonymous_74 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _anonymous_76 UsageNotification;// Offset=0x0 Size=0x10
    struct _anonymous_78 WaitWake;// Offset=0x0 Size=0x4
    struct _anonymous_79 PowerSequence;// Offset=0x0 Size=0x8
    struct _anonymous_82 Power;// Offset=0x0 Size=0x20
    struct _anonymous_83 StartDevice;// Offset=0x0 Size=0x10
    struct _anonymous_84 WMI;// Offset=0x0 Size=0x20
    struct _anonymous_85 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=87)
{
    ...
    union _anonymous_86 Parameters;// Offset=0x8 Size=0x20
