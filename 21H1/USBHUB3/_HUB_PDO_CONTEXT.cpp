union _PDO_FLAGS// Size=0x4 (Id=670)
{
...
struct _ISM_STATE_LOG// Size=0x8 (Id=551)
{
...
struct _D3COLD_SUPPORT_INTERFACE// Size=0x48 (Id=569)
{
...
struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=524)
{
...
struct _IO_REMOVE_LOCK// Size=0x20 (Id=431)
{
    struct _IO_REMOVE_LOCK_COMMON_BLOCK Common;// Offset=0x0 Size=0x20
};

struct _DEVICE_RESET_INTERFACE_STANDARD// Size=0x38 (Id=477)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
struct _HUB_PDO_CONTEXT// Size=0x210 (Id=363)
{
