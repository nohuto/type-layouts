...
struct _anonymous_485// Size=0x8 (Id=485)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _anonymous_486// Size=0x4 (Id=486)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _anonymous_487// Size=0x8 (Id=487)
{
    struct _anonymous_485 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_486 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_485 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=488)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_487 Data;// Offset=0x4 Size=0x8
};
