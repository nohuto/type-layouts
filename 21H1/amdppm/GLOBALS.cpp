...
struct _KAFFINITY_EX// Size=0xa8 (Id=555)
{
...
struct _PPM_DRIVER_DISPATCH_TABLE// Size=0x110 (Id=520)
{
...
union _anonymous_643// Size=0x4 (Id=643)
{
...
struct _PCC_INTERFACE_STANDARD// Size=0x80 (Id=644)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
    ...
    union _anonymous_643 Flags;// Offset=0x54 Size=0x4
...
struct _CPC_COMMAND_COMPLETION// Size=0x18 (Id=560)
{
...
union _PROC_POWER_COORDINATES// Size=0x4 (Id=460)
{
...
struct _PROC_ENERGY_MODEL// Size=0x100 (Id=450)
{
...
struct GLOBALS// Size=0x820 (Id=421)
{
    ...
    struct PPM_DRIVER_INTERFACE DrvInterface;// Offset=0x128 Size=0xf8
    ...
    struct _EVENT_DESCRIPTOR * Summary2Event;// Offset=0x420 Size=0x8
    struct _EVENT_DESCRIPTOR * IdleStatesErrorEvent;// Offset=0x428 Size=0x8
    struct _EVENT_DESCRIPTOR * PerfStatesErrorEvent;// Offset=0x430 Size=0x8
    struct _EVENT_DESCRIPTOR * ThrottleStatesErrorEvent;// Offset=0x438 Size=0x8
    struct _EVENT_DESCRIPTOR * CapInfoEvent;// Offset=0x440 Size=0x8
    unsigned char SyntheticPsdAllowed;// Offset=0x448 Size=0x1
    enum <unnamed-enum-PerfStatesNative> PerfStatesOwner;// Offset=0x44c Size=0x4
    unsigned long HvDomainCount;// Offset=0x450 Size=0x4
    struct _PCC_INTERFACE_INTERNAL PccInterfaceInternal;// Offset=0x458 Size=0x58
    unsigned long Errata;// Offset=0x4b0 Size=0x4
    struct _PCC_INTERFACE_STANDARD PccInterface;// Offset=0x4b8 Size=0x80
    struct _KEVENT PccSubspacesMutableEvent;// Offset=0x538 Size=0x18
    struct WDFSPINLOCK__ * PccSubspacesSpinLock;// Offset=0x550 Size=0x8
    struct WDFWAITLOCK__ * PccSubspacesMutex;// Offset=0x558 Size=0x8
    struct _LIST_ENTRY PccSubspaces;// Offset=0x560 Size=0x10
    unsigned long PccSubspaceCount;// Offset=0x570 Size=0x4
    unsigned long PccRegisteredProcessors;// Offset=0x574 Size=0x4
    struct WDFSPINLOCK__ * PccMutex;// Offset=0x578 Size=0x8
    struct _IO_WORKITEM * PccCapWorker;// Offset=0x580 Size=0x8
    unsigned long PepRegisteredProcessors;// Offset=0x588 Size=0x4
    unsigned char PccCapUpdated;// Offset=0x58c Size=0x1
    unsigned char PccCapWorkerQueued;// Offset=0x58d Size=0x1
    struct _CPC_COMMAND_COMPLETION CpcCmdCompletion;// Offset=0x590 Size=0x18
    unsigned char AssertsDisabled;// Offset=0x5a8 Size=0x1
    unsigned long CoordinatedStateCount;// Offset=0x5ac Size=0x4
    struct _PLATFORM_IDLE_STATES * PlatformIdleStates;// Offset=0x5b0 Size=0x8
    struct _COORDINATED_IDLE_STATES * CoordinatedStates;// Offset=0x5b8 Size=0x8
    struct _COORDINATED_IDLE_STATES * LpiCoordinatedStates;// Offset=0x5c0 Size=0x8
    unsigned long * LpiStateIndexMapping;// Offset=0x5c8 Size=0x8
    struct _RUNTIME_LPI_STATE * LpiRuntimeState;// Offset=0x5d0 Size=0x8
    struct ACPI_PROCESSOR_CONTAINERS * ProcessorContainers;// Offset=0x5d8 Size=0x8
    struct _PREREGISTERED_VETO_LIST * VetoList;// Offset=0x5e0 Size=0x8
    struct _IO_WORKITEM * StateUpdateWorker;// Offset=0x5e8 Size=0x8
    unsigned char StateUpdateWorkerQueued;// Offset=0x5f0 Size=0x1
    unsigned long EfficiencyClasses;// Offset=0x5f4 Size=0x4
    unsigned long ProcessorCounts[2];// Offset=0x5f8 Size=0x8
    struct _PROC_ENERGY_MODEL EnergyModels[2];// Offset=0x600 Size=0x200
    unsigned long EnergyEnabledProcessors;// Offset=0x800 Size=0x4
    long long QpcFrequency;// Offset=0x808 Size=0x8
    unsigned long long CycleCounterFrequency;// Offset=0x810 Size=0x8
    enum _PROCESSOR_PRESENCE HiddenProcessorPresence;// Offset=0x818 Size=0x4
    unsigned char ImplicitPlatformIdle;// Offset=0x81c Size=0x1
};
