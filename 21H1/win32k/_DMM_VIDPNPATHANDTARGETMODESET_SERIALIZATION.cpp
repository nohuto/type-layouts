...
struct _D3DKMDT_VIDPN_PRESENT_PATH_SCALING_SUPPORT// Size=0x4 (Id=638)
{
...
struct _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION_SUPPORT// Size=0x4 (Id=655)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned int Identity:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
struct _D3DKMDT_VIDPN_PRESENT_PATH_TRANSFORMATION// Size=0x10 (Id=468)
{
...
struct _D3DKMDT_2DREGION// Size=0x8 (Id=469)
{
...
struct _D3DKMDT_COLOR_COEFF_DYNAMIC_RANGES// Size=0x10 (Id=488)
{
...
struct _D3DKMDT_VIDPN_PRESENT_PATH_COPYPROTECTION_SUPPORT// Size=0x4 (Id=636)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _D3DKMDT_VIDPN_PRESENT_PATH_COPYPROTECTION// Size=0x10c (Id=632)
{
...
struct _D3DKMDT_VIDPN_PRESENT_PATH// Size=0x168 (Id=448)
{
...
struct _D3DDDI_RATIONAL// Size=0x8 (Id=625)
{
...
struct _D3DKMDT_VIDEO_SIGNAL_INFO// Size=0x38 (Id=478)
{
    ...
    union // Size=0x4 (Id=0)
    {
        struct _D3DKMDT_VIDEO_SIGNAL_INFO::_anonymous_480::<unnamed-type-AdditionalSignalInfo> AdditionalSignalInfo;// Offset=0x30 Size=0x4
...
union _D3DKMDT_WIRE_FORMAT_AND_PREFERENCE// Size=0x4 (Id=626)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _D3DKMDT_VIDPN_TARGET_MODE// Size=0x48 (Id=392)
{
...
struct _DMM_VIDPNTARGETMODESET_SERIALIZATION// Size=0x50 (Id=249)
{
    unsigned char NumModes;// Offset=0x0 Size=0x1
    struct _D3DKMDT_VIDPN_TARGET_MODE ModeSerialization[1];// Offset=0x8 Size=0x48
};

struct _DMM_VIDPNPATHANDTARGETMODESET_SERIALIZATION// Size=0x1b8 (Id=194)
{
