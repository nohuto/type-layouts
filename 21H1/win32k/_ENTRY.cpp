union _EINFO// Size=0x8 (Id=464)
{
    struct <unnamed-type-s>// Size=0x8 (Id=2526)
    {
...
struct _OBJECTOWNER_S// Size=0x4 (Id=646)
{
...
union _OBJECTOWNER// Size=0x4 (Id=561)
{
...
{
    struct <unnamed-type-s>// Size=0x2 (Id=5537)
    {
        unsigned char fullType;// Offset=0x0 Size=0x1
        union <unnamed-type-u>// Size=0x1 (Id=5539)
        {
