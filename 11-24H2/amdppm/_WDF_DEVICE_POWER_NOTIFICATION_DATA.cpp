...
struct _unnamed_491// Size=0x4 (Id=491)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_492// Size=0x8 (Id=492)
{
    struct _unnamed_490 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_491 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_490 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=493)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_492 Data;// Offset=0x4 Size=0x8
};
