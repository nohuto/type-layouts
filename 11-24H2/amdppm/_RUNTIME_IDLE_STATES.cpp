...
struct _HV_PPM_IDLE_STATE_REQUEST// Size=0x10 (Id=774)
{
...
struct _RUNTIME_IDLE_STATES// Size=0x88 (Id=575)
{
    ...
    struct _RUNTIME_IDLE_STATE State[1];// Offset=0x30 Size=0x58
};
