struct _PEP_PROCESSOR_FEEDBACK_COUNTER// Size=0x8 (Id=721)
{
...
struct _PEP_PERFORMANCE_STATE// Size=0x40 (Id=569)
{
    unsigned char AutonomousCapability;// Offset=0x0 Size=0x1
    unsigned long HighestPerformance;// Offset=0x4 Size=0x4
    unsigned long NominalPerformance;// Offset=0x8 Size=0x4
    unsigned long LowestNonlinearPerformance;// Offset=0xc Size=0x4
    unsigned long LowestPerformance;// Offset=0x10 Size=0x4
    unsigned long NominalFrequency;// Offset=0x14 Size=0x4
    unsigned long HighestPercent;// Offset=0x18 Size=0x4
    unsigned long LowestNonlinearPercent;// Offset=0x1c Size=0x4
    unsigned long LowestPercent;// Offset=0x20 Size=0x4
    unsigned char EppSupported;// Offset=0x24 Size=0x1
    unsigned char StateCount;// Offset=0x25 Size=0x1
