...
struct _PPM_DRIVER_DISPATCH_TABLE// Size=0x118 (Id=551)
{
...
union _unnamed_659// Size=0x4 (Id=659)
{
...
struct _PCC_INTERFACE_STANDARD// Size=0x80 (Id=660)
{
    ...
    union _unnamed_659 Flags;// Offset=0x54 Size=0x4
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=519)
{
    union // Size=0x4 (Id=0)
    {
...
union _PROC_POWER_COORDINATES// Size=0x4 (Id=484)
{
...
struct _PROC_ENERGY_COUNTER// Size=0xc (Id=534)
{
    union // Size=0x4 (Id=0)
    {
...
struct _PROC_ENERGY_MODEL// Size=0x100 (Id=474)
{
...
struct _PROC_HW_DEBUG_REGISTER_DEFINITION_LIST// Size=0x10 (Id=536)
{
...
struct GLOBALS// Size=0x980 (Id=441)
{
    ...
    struct PPM_DRIVER_INTERFACE DrvInterface;// Offset=0x1b0 Size=0x178
    struct _PPM_DRIVER_DISPATCH_TABLE PpmDispatchTable;// Offset=0x328 Size=0x118
    struct _KAFFINITY_EX ProcessorsEnumerated;// Offset=0x440 Size=0x108
    long  ( * RegisterIdleStates)(struct _FDO_DATA * );// Offset=0x548 Size=0x8
    long  ( * RegisterPStates)(struct _FDO_DATA * );// Offset=0x550 Size=0x8
    long  ( * RegisterPerfCap)(struct _FDO_DATA * );// Offset=0x558 Size=0x8
    long  ( * RegisterPerfFeedback)(struct _FDO_DATA * );// Offset=0x560 Size=0x8
    long  ( * RegisterLegacyPcc)(struct _FDO_DATA * );// Offset=0x568 Size=0x8
    long  ( * RegisterCpc)(struct _FDO_DATA * );// Offset=0x570 Size=0x8
    long  ( * RegisterPepPerf)(struct _FDO_DATA * );// Offset=0x578 Size=0x8
    long  ( * GetProcessorIndex)(struct _FDO_DATA * );// Offset=0x580 Size=0x8
    long  ( * RegisterPackage)(struct _FDO_DATA * );// Offset=0x588 Size=0x8
    long  ( * RegisterHiddenProcessorIdleStates)(struct _FDO_DATA * );// Offset=0x590 Size=0x8
    unsigned char SyntheticPsdAllowed;// Offset=0x598 Size=0x1
    enum <unnamed-enum-PerfStatesNative> PerfStatesOwner;// Offset=0x59c Size=0x4
    unsigned char PerfCounterReadOptimize;// Offset=0x5a0 Size=0x1
    struct _HV_LOGICAL_PROCESSOR_INFO * HvProcessorInfo;// Offset=0x5a8 Size=0x8
    unsigned long HvProcessorInfoCount;// Offset=0x5b0 Size=0x4
    unsigned long Errata;// Offset=0x5b4 Size=0x4
    struct _PCC_INTERFACE_STANDARD PccInterface;// Offset=0x5b8 Size=0x80
    struct _KEVENT PccSubspacesMutableEvent;// Offset=0x638 Size=0x18
    struct WDFSPINLOCK__ * PccSubspacesSpinLock;// Offset=0x650 Size=0x8
    struct WDFWAITLOCK__ * PccSubspacesMutex;// Offset=0x658 Size=0x8
    struct _LIST_ENTRY PccSubspaces;// Offset=0x660 Size=0x10
    unsigned long PccSubspaceCount;// Offset=0x670 Size=0x4
    unsigned long PccRegisteredProcessors;// Offset=0x674 Size=0x4
    struct WDFSPINLOCK__ * PccMutex;// Offset=0x678 Size=0x8
    struct _IO_WORKITEM * PccCapWorker;// Offset=0x680 Size=0x8
    unsigned long PepRegisteredProcessors;// Offset=0x688 Size=0x4
    unsigned char PccCapUpdated;// Offset=0x68c Size=0x1
    unsigned char PccCapWorkerQueued;// Offset=0x68d Size=0x1
    struct _CPC_COMMAND_COMPLETION CpcCmdCompletion;// Offset=0x690 Size=0x18
    unsigned char AssertsDisabled;// Offset=0x6a8 Size=0x1
    unsigned long CoordinatedStateCount;// Offset=0x6ac Size=0x4
    unsigned char PlatformStatesRegistered;// Offset=0x6b0 Size=0x1
    struct _PLATFORM_IDLE_STATES * PlatformIdleStates;// Offset=0x6b8 Size=0x8
    struct _COORDINATED_IDLE_STATES * CoordinatedStates;// Offset=0x6c0 Size=0x8
    struct _COORDINATED_IDLE_STATES * LpiCoordinatedStates;// Offset=0x6c8 Size=0x8
    unsigned long * LpiStateIndexMapping;// Offset=0x6d0 Size=0x8
    struct _RUNTIME_LPI_STATE * LpiRuntimeState;// Offset=0x6d8 Size=0x8
    struct ACPI_PROCESSOR_CONTAINERS * ProcessorContainers;// Offset=0x6e0 Size=0x8
    struct _PREREGISTERED_VETO_LIST * VetoList;// Offset=0x6e8 Size=0x8
    struct _IO_WORKITEM * StateUpdateWorker;// Offset=0x6f0 Size=0x8
    unsigned char StateUpdateWorkerQueued;// Offset=0x6f8 Size=0x1
    unsigned long EfficiencyClasses;// Offset=0x6fc Size=0x4
    struct _PROC_ENERGY_MODEL EnergyModels[2];// Offset=0x700 Size=0x200
    unsigned char EsuValue;// Offset=0x900 Size=0x1
    unsigned char EsuMethod;// Offset=0x901 Size=0x1
    unsigned long EnergyEnabledProcessors;// Offset=0x904 Size=0x4
    unsigned long HwDebugEnabledProcessors;// Offset=0x908 Size=0x4
    long long QpcFrequency;// Offset=0x910 Size=0x8
    unsigned long long CycleCounterFrequency;// Offset=0x918 Size=0x8
    enum _PROCESSOR_PRESENCE HiddenProcessorPresence;// Offset=0x920 Size=0x4
    unsigned long ProcessorCountIncludingHidden;// Offset=0x924 Size=0x4
    unsigned char SkipHiddenProcessorPoFxRegistration;// Offset=0x928 Size=0x1
    unsigned char ImplicitPlatformIdle;// Offset=0x929 Size=0x1
    unsigned char RootDrivenIdle;// Offset=0x92a Size=0x1
    struct _PROC_HW_DEBUG_REGISTER_DEFINITION_LIST RegisteryDebugRegisters[2];// Offset=0x930 Size=0x20
    unsigned long MeasurementCapabilities;// Offset=0x950 Size=0x4
    unsigned long MeasurementRegisterGroupTypes;// Offset=0x954 Size=0x4
    struct _LIST_ENTRY MeasurementRegisterGroups;// Offset=0x958 Size=0x10
    unsigned char IsHvLpIndexed;// Offset=0x968 Size=0x1
    struct _PPM_WPS_UPDATE_KERNEL_CONFIG WpsConfig;// Offset=0x970 Size=0x10
};
