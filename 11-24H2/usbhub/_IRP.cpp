union _unnamed_27// Size=0x8 (Id=27)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=428)
{
    union // Size=0x4 (Id=0)
    {
...
struct _unnamed_29// Size=0x10 (Id=29)
{
    union // Size=0x8 (Id=0)
    {
...
union _unnamed_30// Size=0x10 (Id=30)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_29 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=379)
{
...
struct _unnamed_31// Size=0x50 (Id=31)
{
