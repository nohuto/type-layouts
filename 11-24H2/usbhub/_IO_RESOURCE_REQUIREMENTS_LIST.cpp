...
struct _unnamed_478// Size=0x18 (Id=478)
{
...
struct _unnamed_481// Size=0x18 (Id=481)
{
...
struct _unnamed_485// Size=0x10 (Id=485)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_486// Size=0xc (Id=486)
{
...
struct _unnamed_487// Size=0x18 (Id=487)
{
...
struct _unnamed_488// Size=0x18 (Id=488)
{
...
struct _unnamed_489// Size=0x18 (Id=489)
{
...
union _unnamed_491// Size=0x18 (Id=491)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_478 Port;// Offset=0x0 Size=0x18
        struct _unnamed_478 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_481 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_482 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_483 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_478 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_484 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_485 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_486 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_487 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_488 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_489 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_490 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=492)
{
    ...
    union _unnamed_491 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=468)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=387)
{
