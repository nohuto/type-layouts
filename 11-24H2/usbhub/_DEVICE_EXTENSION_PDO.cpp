...
union _USB_EXTENDED_PORT_ATTRIBUTES// Size=0x4 (Id=336)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=335)
{
    union // Size=0x4 (Id=0)
    {
...
struct _WMILIB_CONTEXT// Size=0x40 (Id=444)
{
...
struct _USB_DEVICE_DESCRIPTOR// Size=0x12 (Id=218)
{
...
union _USBHUB_PDO_FLAGS// Size=0x4 (Id=328)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _HUBPDO_CLEANUP_FLAGS// Size=0x4 (Id=391)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_DEVICE_FLAGS// Size=0x4 (Id=323)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _IO_CSQ// Size=0x40 (Id=333)
{
...
struct _HUB_TIMER_OBJECT// Size=0x50 (Id=327)
{
...
struct _USB_ID_STRING// Size=0x10 (Id=435)
{
...
struct _USB_INTERFACE_DESCRIPTOR// Size=0x9 (Id=447)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
...
struct _KSEMAPHORE// Size=0x20 (Id=376)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _USB_HUB_DEVICE_UXD_SETTINGS// Size=0x44 (Id=312)
{
...
struct _USB_PORT_PATH// Size=0x1c (Id=402)
{
...
union _MSOS20_FLAGS// Size=0x4 (Id=401)
{
...
struct _MSOS20_INFO// Size=0x40 (Id=367)
{
...
struct _MSOS20_DESCRIPTOR_SET_INFO// Size=0x8 (Id=351)
{
...
struct _D3COLD_SUPPORT_INTERFACE// Size=0x48 (Id=372)
{
...
struct _unnamed_143// Size=0x4 (Id=143)
{
    struct // Size=0x4 (Id=0)
    {
...
union _USB_DUAL_ROLE_FEATURES// Size=0x4 (Id=144)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct _unnamed_143 features;// Offset=0x0 Size=0x4
};

struct _DEVICE_EXTENSION_PDO// Size=0xbf8 (Id=176)
{
