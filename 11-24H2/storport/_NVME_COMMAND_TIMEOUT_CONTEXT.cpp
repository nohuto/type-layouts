...
struct _NVME_COMMAND_TIMEOUT_CONTEXT// Size=0x100 (Id=524)
{
    union // Size=0x8 (Id=0)
    {
        union _LARGE_INTEGER SampledTimestamp;// Offset=0x0 Size=0x8
        union _LARGE_INTEGER PreciseTimestamp;// Offset=0x0 Size=0x8
    };
    struct _KDPC CommandTimeoutDetectDpc;// Offset=0x40 Size=0x40
    struct _KTIMER CommandTimeoutDetectTimer;// Offset=0x80 Size=0x40
    unsigned long CommandTimeoutDetectTimerState;// Offset=0xc0 Size=0x4
    unsigned long ControllerIdleTimesThresholdForCancelTimer;// Offset=0xc4 Size=0x4
    struct _KEVENT CommandTimeoutDetectEvent;// Offset=0xc8 Size=0x18
    void * CommandTimeoutDetectThread;// Offset=0xe0 Size=0x8
    unsigned long ControllerIdleTimesForCancelTimer;// Offset=0xe8 Size=0x4
    struct _NVME_CONTROLLER_COMMAND_TIMEOUT_STATISTICS * CommandTimeoutStatistics;// Offset=0xf0 Size=0x8
};
