...
struct _STORPORT_DUMP_ADAPTER_DATA// Size=0x140 (Id=424)
{
    ...
    unsigned char * PowerOnReady;// Offset=0x18 Size=0x8
    long  ( * PowerOnRoutine)(void * );// Offset=0x20 Size=0x8
    void * PowerOnContext;// Offset=0x28 Size=0x8
    unsigned long MemoryBlockSize;// Offset=0x30 Size=0x4
    void * MemoryBlock;// Offset=0x38 Size=0x8
    void * MiniportContext;// Offset=0x40 Size=0x8
    struct _PORT_CONFIGURATION_INFORMATION ConfigInfo;// Offset=0x48 Size=0xe0
    void * MappedAddressList;// Offset=0x128 Size=0x8
    unsigned short HiberFileHybridPriority;// Offset=0x130 Size=0x2
    unsigned short Flags;// Offset=0x132 Size=0x2
    struct _DUMP_STORPORT_DEVEXT * DevExt;// Offset=0x138 Size=0x8
};
