union _unnamed_1052// Size=0x4 (Id=1052)
{
...
struct _RAID_DEVICE_RESET_CONTEXT// Size=0x50 (Id=1053)
{
    union _unnamed_1052 Flags;// Offset=0x0 Size=0x4
    unsigned long UnitCountRequestedD3ForPLDR;// Offset=0x4 Size=0x4
    unsigned long PoweredDownUnitCountForPLDR;// Offset=0x8 Size=0x4
    unsigned long UnitCountRequestedD0ForPLDR;// Offset=0xc Size=0x4
    unsigned long PoweredUpUnitCountForPLDR;// Offset=0x10 Size=0x4
    unsigned long PLDRCountInitiatedFromIoctl;// Offset=0x14 Size=0x4
    unsigned long PLDRCountInitiatedFromMiniport;// Offset=0x18 Size=0x4
    struct _KEVENT UnitsPowerDownCompletionEventForPLDR;// Offset=0x20 Size=0x18
    struct _KEVENT UnitsPowerUpCompletionEventForPLDR;// Offset=0x38 Size=0x18
};
