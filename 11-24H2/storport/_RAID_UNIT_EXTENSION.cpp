...
struct _STOR_ADDR_BTL8// Size=0x10 (Id=362)
{
...
struct _unnamed_330// Size=0x2 (Id=330)
{
...
union _unnamed_425// Size=0x8 (Id=425)
{
    union // Size=0x8 (Id=0)
    {
...
struct _QUEUE_TAG_LIST// Size=0x80 (Id=439)
{
...
struct _EX_RUNDOWN_REF// Size=0x8 (Id=1168)
{
    union // Size=0x8 (Id=0)
    {
...
struct _EXTENDED_DEVICE_QUEUE// Size=0xc0 (Id=344)
{
...
struct _IO_QUEUE// Size=0xe0 (Id=343)
{
...
struct _unnamed_428// Size=0x190 (Id=428)
{
...
struct _RAID_UNIT_REGISTRY_PARAMETERS// Size=0x18 (Id=869)
{
...
struct _RAID_UNIT_ATTRIBUTES// Size=0x4 (Id=1181)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _RAID_WORK_ITEM_CONTEXT// Size=0x10 (Id=980)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
    struct _IRP * Irp;// Offset=0x8 Size=0x8
};

struct _STOR_ASYNC_NOTIFY_CONTEXT// Size=0x18 (Id=895)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
...
struct _unnamed_429// Size=0x10 (Id=429)
{
...
struct _TELEMETRY_UNIT_EXTENSION// Size=0x8 (Id=852)
{
    struct _unnamed_851 Flags;// Offset=0x0 Size=0x4
...
struct _RAID_TELEMETRY_ERROR_ENTRY// Size=0x28 (Id=1149)
{
    ...
    union _unnamed_1148 u;// Offset=0x20 Size=0x4
};

struct _RAID_TELEMETRY_SAMPLED_ERROR_LOG// Size=0x1c8 (Id=1195)
{
...
struct _RAID_TELEMETRY_UNIQUE_ERROR_LOG// Size=0x190 (Id=1081)
{
    struct _RAID_TELEMETRY_ERROR_ENTRY UniqueErrors[10];// Offset=0x0 Size=0x190
};

struct _RAID_UNIT_QOS// Size=0x30 (Id=1347)
{
...
struct _unnamed_433// Size=0x10 (Id=433)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _RAID_UNIT_EXTENSION// Size=0xe40 (Id=434)
{
    ...
    union _unnamed_425 Flags;// Offset=0x1f8 Size=0x8
    union _unnamed_426 InterlockedFlags;// Offset=0x200 Size=0x4
    ...
    struct _unnamed_428 DeferredList;// Offset=0x590 Size=0x190
    ...
    struct _unnamed_429 PendingPowerUpContext;// Offset=0x7f8 Size=0x10
    ...
    struct _unnamed_430 ZoneDiagnostics;// Offset=0xd94 Size=0x8
    struct _unnamed_431 ZoneFlags;// Offset=0xd9c Size=0x4
    struct _unnamed_412 DFxQueue;// Offset=0xda0 Size=0x20
    long  ( * CrashdumpNotifyRoutine)(enum _STORAGE_DUMP_EVENT ,void * );// Offset=0xdc0 Size=0x8
    unsigned short EventCount[3];// Offset=0xdc8 Size=0x6
    struct _UNICODE_STRING ZnsPnpInterfaceName;// Offset=0xdd0 Size=0x10
    struct NVME_IDENTIFY_NAMESPACE_DATA * IdentifyNamespaceData;// Offset=0xde0 Size=0x8
    struct NVME_IDENTIFY_SPECIFIC_NAMESPACE_IO_COMMAND_SET * IdentifyNamespaceIoCommandSet;// Offset=0xde8 Size=0x8
    struct _REGISTRY_WATCH_CONTEXT * RegWatchContext;// Offset=0xdf0 Size=0x8
    unsigned long CountersId;// Offset=0xdf8 Size=0x4
    unsigned char * TcgContext[6240];// Offset=0xe00 Size=0x8
    struct _TCG_DEVICE_PROPERTIES * TcgProperties;// Offset=0xe08 Size=0x8
    struct _NVME_ICE_ENTRY * NvmeIceEntry;// Offset=0xe10 Size=0x8
    unsigned long ActiveReferenceOnAdapter;// Offset=0xe18 Size=0x4
    struct _unnamed_415 KsrFlags;// Offset=0xe1c Size=0x4
    struct _unnamed_433 ReadCapacity;// Offset=0xe20 Size=0x10
};
