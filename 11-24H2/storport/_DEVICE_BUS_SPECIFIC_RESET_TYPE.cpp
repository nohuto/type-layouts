struct _unnamed_892// Size=0x8 (Id=892)
{
...
union _DEVICE_BUS_SPECIFIC_RESET_TYPE// Size=0x8 (Id=894)
{
    struct _unnamed_892 Pci;// Offset=0x0 Size=0x8
    struct _unnamed_893 Acpi;// Offset=0x0 Size=0x8
