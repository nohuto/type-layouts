...
struct _IO_CONT_RESOURCE_LIST// Size=0x80 (Id=926)
{
...
struct _STOR_NOTIFICATION_INFO// Size=0x20 (Id=927)
{
...
struct _STOR_IO_GATEWAY// Size=0x140 (Id=401)
{
    ...
    unsigned long BusyStatus;// Offset=0x28 Size=0x4
    ...
    unsigned long Reserved;// Offset=0xc4 Size=0x4
    struct _KEVENT * EmptyEvent;// Offset=0xc8 Size=0x8
    unsigned char PendingEvent;// Offset=0xd0 Size=0x1
    unsigned char PendingForwardIos;// Offset=0xd1 Size=0x1
    ...
    struct _IO_WORKITEM * WaitForForwardIoWorkitem;// Offset=0x138 Size=0x8
};
