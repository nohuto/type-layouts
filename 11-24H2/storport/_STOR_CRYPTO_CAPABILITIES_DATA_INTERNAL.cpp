...
struct _STOR_CRYPTO_CAPABILITY_INTERNAL// Size=0x10 (Id=1032)
{
...
struct _STOR_CRYPTO_CAPABILITIES_DATA_INTERNAL// Size=0x20 (Id=419)
{
    ...
    union _STORAGE_SECURITY_COMPLIANCE_BITMASK SecurityComplianceBitmask;// Offset=0xc Size=0x1
    struct _STOR_CRYPTO_CAPABILITY_INTERNAL CryptoCapabilities[1];// Offset=0x10 Size=0x10
};
