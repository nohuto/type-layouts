...
union _unnamed_474// Size=0x8 (Id=474)
{
...
struct _unnamed_479// Size=0x4 (Id=479)
{
...
union _unnamed_480// Size=0x4 (Id=480)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _unnamed_486// Size=0x8 (Id=486)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _NVME_FIRMWARE_ACTIVATE_RESET_CONTEXT// Size=0x28 (Id=828)
{
...
struct _unnamed_1013// Size=0x1 (Id=1013)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _NVME_CONTROLLER_ASYNC_RESET_CONTEXT// Size=0x10 (Id=1014)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
    enum _NVME_CONTROLLER_RESET_REASON ResetReason;// Offset=0x8 Size=0x4
    struct _unnamed_1013 Flags;// Offset=0xc Size=0x1
    unsigned char Reserved[3];// Offset=0xd Size=0x3
};

struct _NVME_CONTROLLER_QOS_SETTINGS// Size=0x10 (Id=905)
{
...
struct _NVME_CONTROLLER// Size=0x700 (Id=488)
{
    ...
    unsigned short DesiredIoSQCount;// Offset=0x1c Size=0x2
    unsigned short DesiredIoCQCount;// Offset=0x1e Size=0x2
    unsigned short NextIoQueueIndexHint;// Offset=0x20 Size=0x2
    unsigned char Reserved[2];// Offset=0x22 Size=0x2
    unsigned long PreferredNumaNode;// Offset=0x24 Size=0x4
    ...
    union _unnamed_474 Flags;// Offset=0x88 Size=0x8
    ...
    struct _unnamed_479 TelemetryFlags;// Offset=0x3a8 Size=0x4
    ...
    union _unnamed_480 QueueState;// Offset=0x3b4 Size=0x4
    ...
    union _unnamed_485 InterlockedFlags;// Offset=0x430 Size=0x4
    ...
    struct _unnamed_486 PersistSettings;// Offset=0x448 Size=0x8
    ...
    struct _unnamed_464 DbgLogConfig;// Offset=0x538 Size=0x4
