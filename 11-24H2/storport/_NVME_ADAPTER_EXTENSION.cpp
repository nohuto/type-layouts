...
union _unnamed_461// Size=0x8 (Id=461)
{
...
union _unnamed_462// Size=0x4 (Id=462)
{
...
struct _unnamed_463// Size=0x4 (Id=463)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _unnamed_464// Size=0x4 (Id=464)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _unnamed_1287// Size=0x8 (Id=1287)
{
    struct // Size=0x8 (Id=0)
    {
...
union _unnamed_1288// Size=0x8 (Id=1288)
{
    struct _unnamed_1287 u;// Offset=0x0 Size=0x8
    unsigned long long AsUlong64;// Offset=0x0 Size=0x8
};

struct _NVME_DBG_LOG_CONTROL// Size=0x10 (Id=1289)
{
    unsigned long Revision;// Offset=0x0 Size=0x4
    union _unnamed_1288 Enable;// Offset=0x8 Size=0x8
};

struct _unnamed_465// Size=0x18 (Id=465)
{
    struct _unnamed_464 Config;// Offset=0x0 Size=0x4
...
struct _NVME_ADAPTER_EXTENSION// Size=0x590 (Id=466)
{
    ...
    union _unnamed_461 Flags;// Offset=0x90 Size=0x8
    struct _EX_RUNDOWN_REF_CACHE_AWARE * RemoveLock;// Offset=0x98 Size=0x8
    struct _NVME_ADAPTER_POWER * Power;// Offset=0xa0 Size=0x8
    struct _RAID_MINIPORT Miniport;// Offset=0xa8 Size=0x190
    unsigned long BusNumber;// Offset=0x238 Size=0x4
    unsigned long SlotNumber;// Offset=0x23c Size=0x4
    struct _PCI_ADAPTER_PROPERTIES * PciProperties;// Offset=0x240 Size=0x8
    struct _PHYSICAL_ADAPTER_PROPERTIES * PhysicalProperties;// Offset=0x248 Size=0x8
    struct _NVMEOF_ADAPTER_PROPERTIES * NvmeofProperties;// Offset=0x250 Size=0x8
    struct _RAID_DEFERRED_QUEUE DeferredQueue;// Offset=0x260 Size=0x80
    struct _RAID_DEFERRED_QUEUE WmiDeferredQueue;// Offset=0x2e0 Size=0x80
    struct _UNICODE_STRING StorageInterfaceName;// Offset=0x360 Size=0x10
    struct _UNICODE_STRING NvmeofInterfaceName;// Offset=0x370 Size=0x10
    void * DriverParameters;// Offset=0x380 Size=0x8
    struct _PORT_REGISTRY_INFO RegistryInfo;// Offset=0x388 Size=0x40
    unsigned char  ( * HwPassiveInitRoutine)(void * );// Offset=0x3c8 Size=0x8
    union _unnamed_462 PerfOptFlags;// Offset=0x3d0 Size=0x4
    struct _unnamed_463 TelemetryFlags;// Offset=0x3d4 Size=0x4
    unsigned short PathTargetCounter;// Offset=0x3d8 Size=0x2
    unsigned short Reserved1;// Offset=0x3da Size=0x2
    struct _REGISTRY_WATCH_CONTEXT * RegWatchContext;// Offset=0x3e0 Size=0x8
    struct _DEVICE_RELATIONS * DeviceRelations;// Offset=0x3e8 Size=0x8
    unsigned long DeviceNode;// Offset=0x3f0 Size=0x4
    unsigned long StartFailureCode;// Offset=0x3f4 Size=0x4
    wchar_t * MiniportName;// Offset=0x3f8 Size=0x8
    wchar_t * AdapterId;// Offset=0x400 Size=0x8
    struct _GUID AdapterGuid;// Offset=0x408 Size=0x10
    wchar_t * AdapterSerialNumber;// Offset=0x418 Size=0x8
    struct _unnamed_465 ControllerDbgLogSettings;// Offset=0x420 Size=0x18
    unsigned long NumWorkItems;// Offset=0x438 Size=0x4
    unsigned long AdditionalTimers;// Offset=0x43c Size=0x4
    long ProcessingDeferredItems;// Offset=0x440 Size=0x4
    unsigned long DefaultTimeout;// Offset=0x444 Size=0x4
    long AdapterDpcRoutineLock;// Offset=0x448 Size=0x4
    union _SLIST_HEADER CompletedList;// Offset=0x450 Size=0x10
    struct _SLIST_ENTRY * SavedXrbList;// Offset=0x460 Size=0x8
    unsigned short EventCount[3];// Offset=0x468 Size=0x6
    struct _NVME_CONTROLLER * NVMeController;// Offset=0x470 Size=0x8
    struct _RAID_DMA_ADAPTER Dma;// Offset=0x478 Size=0x20
    struct _ERESOURCE StorMQControllerListLock;// Offset=0x498 Size=0x68
    unsigned char StorMQControllerListLockInitialized;// Offset=0x500 Size=0x1
    struct _LIST_ENTRY StorMQControllerListHead;// Offset=0x508 Size=0x10
    long StorMQControllerListCount;// Offset=0x518 Size=0x4
    struct _IO_WORKITEM * PassivePowerUpDownWorkItem;// Offset=0x520 Size=0x8
    struct _RAID_MEMORY_REGION UncachedExtension;// Offset=0x528 Size=0x18
    struct _RAID_ADAPTER_PARAMETERS Parameters;// Offset=0x540 Size=0x38
    struct _MAPPED_ADDRESS * MappedAddressList;// Offset=0x578 Size=0x8
    struct _STOR_HMB_RANGE * HmbRangeList;// Offset=0x580 Size=0x8
    struct _STOR_EVENT_NOTIFICATION_CONTEXT * EventNotificationContext;// Offset=0x588 Size=0x8
};
