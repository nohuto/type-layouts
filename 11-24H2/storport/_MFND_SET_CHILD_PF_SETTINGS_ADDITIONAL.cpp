...
struct _MFND_QOS// Size=0x38 (Id=903)
{
...
struct _MFND_PHYSICAL_FUNCTION_SETTINGS// Size=0x70 (Id=669)
{
    unsigned short Version;// Offset=0x0 Size=0x2
    unsigned short Size;// Offset=0x2 Size=0x2
...
struct _MFND_SET_CHILD_PF_SETTINGS_ADDITIONAL// Size=0x80 (Id=682)
{
    unsigned short Version;// Offset=0x0 Size=0x2
