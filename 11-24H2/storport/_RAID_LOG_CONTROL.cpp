struct _unnamed_1318// Size=0x8 (Id=1318)
{
...
union _unnamed_1319// Size=0x8 (Id=1319)
{
    struct _unnamed_1318 u;// Offset=0x0 Size=0x8
    unsigned long long asUlong64;// Offset=0x0 Size=0x8
};

struct _RAID_LOG_CONTROL// Size=0x10 (Id=1320)
{
    unsigned long Revision;// Offset=0x0 Size=0x4
    union _unnamed_1319 Enable;// Offset=0x8 Size=0x8
};
