...
struct _NVME_NAMESPACE_ERROR_RECOVERY// Size=0xc8 (Id=1279)
{
    ...
    unsigned long NamespaceSanitizeCount;// Offset=0x18 Size=0x4
    unsigned long Reserved;// Offset=0x1c Size=0x4
    struct _NVME_NAMESPACE_IO_FAILURE_STATISTICS IoFailureStatistics;// Offset=0x20 Size=0xa8
};
