...
struct _NVMEOF_ADAPTER_PROPERTIES// Size=0xa8 (Id=473)
{
    struct _LIST_ENTRY HostGatewayList;// Offset=0x0 Size=0x10
    unsigned long HostGatewayCount;// Offset=0x10 Size=0x4
    struct _ERESOURCE HostGatewayListLock;// Offset=0x18 Size=0x68
    struct _STOR_LOCKED_LIST NvmeofIoControllerList;// Offset=0x80 Size=0x20
    unsigned long KeepAliveTimeout;// Offset=0xa0 Size=0x4
};
