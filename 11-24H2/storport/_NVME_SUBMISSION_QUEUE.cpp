...
union _unnamed_496// Size=0x8 (Id=496)
{
...
struct _NVME_SUBMISSION_QUEUE// Size=0xc0 (Id=498)
{
    ...
    union _unnamed_496 Flags;// Offset=0x70 Size=0x8
    ...
    unsigned long SplitIoReference;// Offset=0x9c Size=0x4
};
