...
struct _NVME_COMMAND_ID_CONTEXT// Size=0x80 (Id=512)
{
    ...
    union _unnamed_508 Flags;// Offset=0x3c Size=0x1
    union _unnamed_510 Flags2;// Offset=0x3d Size=0x1
    unsigned char Reserved0[2];// Offset=0x3e Size=0x2
    union _LARGE_INTEGER Timestamp;// Offset=0x40 Size=0x8
    union _LARGE_INTEGER PerfTimestamp;// Offset=0x48 Size=0x8
    void * ExtCommand;// Offset=0x50 Size=0x8
    unsigned long NamespaceId;// Offset=0x58 Size=0x4
    unsigned char Reserved1[36];// Offset=0x5c Size=0x24
};
