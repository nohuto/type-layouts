...
union _unnamed_548// Size=0x4 (Id=548)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_549// Size=0x4 (Id=549)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _NVME_ADAPTER_POWER// Size=0x180 (Id=550)
{
    ...
    struct _unnamed_412 DFxQueue;// Offset=0x90 Size=0x20
    union _unnamed_548 Flags;// Offset=0xb0 Size=0x4
    ...
    union _unnamed_549 InterlockedFlags;// Offset=0xd4 Size=0x4
