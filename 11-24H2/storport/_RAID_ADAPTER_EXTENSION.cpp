...
union _FLAGS2// Size=0x8 (Id=911)
{
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned char TBTD3IdleTimeoutUserOverride:1;// Offset=0x1 Size=0x1 BitOffset=0x2 BitSize=0x1
        unsigned long IsIceEnabled:1;// Offset=0x4 Size=0x4 BitOffset=0x0 BitSize=0x1
    };
    unsigned long long AsUlonglong;// Offset=0x0 Size=0x8
};

union _unnamed_402// Size=0x4 (Id=402)
{
...
struct _STOR_LOCKED_LIST// Size=0x20 (Id=582)
{
...
struct _STOR_DICTIONARY// Size=0x30 (Id=278)
{
...
struct _RAID_POWER_STATE// Size=0x10 (Id=585)
{
...
struct _MEMORY_REGION// Size=0x18 (Id=1112)
{
...
struct _PORT_CONFIGURATION_INFORMATION// Size=0xe0 (Id=580)
{
...
struct _unnamed_455// Size=0x1 (Id=455)
{
    struct // Size=0x1 (Id=0)
    {
        unsigned char IsNvmeAdapter:1;// Offset=0x0 Size=0x1 BitOffset=0x0 BitSize=0x1
        unsigned char InFindAdapter:1;// Offset=0x0 Size=0x1 BitOffset=0x1 BitSize=0x1
        unsigned char InResetBus:1;// Offset=0x0 Size=0x1 BitOffset=0x2 BitSize=0x1
        unsigned char IsVirtual:1;// Offset=0x0 Size=0x1 BitOffset=0x3 BitSize=0x1
        unsigned char UnitControlListPopulated:1;// Offset=0x0 Size=0x1 BitOffset=0x4 BitSize=0x1
        unsigned char AdapterControlListPopulated:1;// Offset=0x0 Size=0x1 BitOffset=0x5 BitSize=0x1
        unsigned char IsStorMQMiniport:1;// Offset=0x0 Size=0x1 BitOffset=0x6 BitSize=0x1
    };
};

struct _UNIT_CONTROL_LIST// Size=0x24 (Id=1272)
{
    unsigned long MaxControlType;// Offset=0x0 Size=0x4
    unsigned char SupportedTypeList[32];// Offset=0x4 Size=0x20
};

struct _ADAPTER_CONTROL_LIST// Size=0x24 (Id=1138)
{
    unsigned long MaxControlType;// Offset=0x0 Size=0x4
...
struct _RAID_MINIPORT// Size=0x190 (Id=456)
{
    struct _RAID_COMMON_EXTENSION * Adapter;// Offset=0x0 Size=0x8
    ...
    struct _unnamed_455 Flags;// Offset=0xf8 Size=0x1
    ...
    unsigned long FeatureCount;// Offset=0x178 Size=0x4
    unsigned char FeatureList[16];// Offset=0x17c Size=0x10
};
...
struct _RAID_DMA_ADAPTER// Size=0x20 (Id=351)
{
...
struct _RAID_MEMORY_REGION// Size=0x18 (Id=288)
{
    unsigned char * VirtualBase;// Offset=0x0 Size=0x8
    union _LARGE_INTEGER PhysicalBase;// Offset=0x8 Size=0x8
    unsigned long Length;// Offset=0x10 Size=0x4
...
struct _RAID_DEFERRED_QUEUE// Size=0x80 (Id=345)
{
...
struct _unnamed_406// Size=0x50 (Id=406)
{
    struct _RAID_DEFERRED_ELEMENT Timer;// Offset=0x0 Size=0x50
};

struct _unnamed_407// Size=0xb0 (Id=407)
{
...
struct _PORT_REGISTRY_INFO// Size=0x40 (Id=1025)
{
    unsigned long Size;// Offset=0x0 Size=0x4
...
struct _RAID_ADAPTER_PARAMETERS// Size=0x38 (Id=1293)
{
...
struct _unnamed_409// Size=0x1 (Id=409)
{
    struct // Size=0x1 (Id=0)
    {
        ...
        unsigned char UnusedFlags:3;// Offset=0x0 Size=0x1 BitOffset=0x5 BitSize=0x3
    };
};
...
struct _SCSI_POWER_REQUEST_BLOCK// Size=0x58 (Id=1145)
{
    unsigned short Length;// Offset=0x0 Size=0x2
...
struct _STORAGE_REQUEST_BLOCK// Size=0x80 (Id=252)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    unsigned char Function;// Offset=0x2 Size=0x1
    unsigned char SrbStatus;// Offset=0x3 Size=0x1
...
struct _RAID_POWER_CONTEXT// Size=0xb8 (Id=964)
{
...
struct _STORPORT_EXTENDED_FUNCTIONS// Size=0x58 (Id=766)
{
...
union _RAID_REDIRECTION_SUPPORT// Size=0x2 (Id=1262)
{
...
struct _PCI_HEADER_TYPE_0// Size=0x30 (Id=1120)
{
...
struct _PCI_HEADER_TYPE_1// Size=0x30 (Id=1356)
{
...
struct _unnamed_1375// Size=0x8 (Id=1375)
{
    unsigned long Base;// Offset=0x0 Size=0x4
    unsigned long Limit;// Offset=0x4 Size=0x4
};

struct _PCI_HEADER_TYPE_2// Size=0x30 (Id=1376)
{
    ...
    unsigned char SubordinateBus;// Offset=0xa Size=0x1
    unsigned char SecondaryLatency;// Offset=0xb Size=0x1
    struct _unnamed_1375 Range[4];// Offset=0xc Size=0x20
    unsigned char InterruptLine;// Offset=0x2c Size=0x1
    unsigned char InterruptPin;// Offset=0x2d Size=0x1
    unsigned short BridgeControl;// Offset=0x2e Size=0x2
};

union _unnamed_1003// Size=0x30 (Id=1003)
{
...
struct _PCI_COMMON_HEADER// Size=0x40 (Id=1004)
{
    ...
    union _unnamed_1003 u;// Offset=0x10 Size=0x30
};

struct _STOR_POWER_SETTING_NOTIFICATION// Size=0x18 (Id=1263)
{
...
struct _unnamed_411// Size=0x4 (Id=411)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _STOR_ADDRESS// Size=0x10 (Id=199)
{
...
struct _RAID_RPMB_CAPABILITIES// Size=0x38 (Id=897)
{
...
struct _RAID_CRYPTO_KEY_TABLE// Size=0x18 (Id=935)
{
...
struct _unnamed_860// Size=0x4 (Id=860)
{
    struct // Size=0x4 (Id=0)
    {
...
union _STORAGE_INDICATOR_STATE// Size=0x4 (Id=861)
{
    struct _unnamed_860 State;// Offset=0x0 Size=0x4
    unsigned long AsUlong;// Offset=0x0 Size=0x4
};

struct _PCI_MSIX_TABLE_CONFIG_INTERFACE// Size=0x48 (Id=1031)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
struct _NVME_DISK_CQ_INTERRUPT_ROUTINE_INFO// Size=0x18 (Id=873)
{
...
struct _unnamed_413// Size=0x4 (Id=413)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _RAID_ADAPTER_EXTENSION// Size=0x1880 (Id=418)
{
    ...
    union _unnamed_402 InterlockedFlags;// Offset=0x80 Size=0x4
    ...
    struct _RAID_MINIPORT Miniport;// Offset=0x178 Size=0x190
    struct _RAID_BUS_INTERFACE Bus;// Offset=0x308 Size=0x48
    struct _KINTERRUPT * Interrupt;// Offset=0x350 Size=0x8
    unsigned long InterruptIrql;// Offset=0x358 Size=0x4
    unsigned long InterruptVersion;// Offset=0x35c Size=0x4
    unsigned long long StartIoLock;// Offset=0x360 Size=0x8
    enum _STOR_SYNCHRONIZATION_MODEL IoModel;// Offset=0x368 Size=0x4
    struct _RAID_DMA_ADAPTER Dma;// Offset=0x370 Size=0x20
    struct _RAID_MEMORY_REGION UncachedExtension;// Offset=0x390 Size=0x18
    unsigned long BusNumber;// Offset=0x3a8 Size=0x4
    unsigned long SlotNumber;// Offset=0x3ac Size=0x4
    unsigned long Device;// Offset=0x3b0 Size=0x4
    unsigned long Function;// Offset=0x3b4 Size=0x4
    struct _MAPPED_ADDRESS * MappedAddressList;// Offset=0x3b8 Size=0x8
    struct _STOR_IO_GATEWAY * Gateway;// Offset=0x3c0 Size=0x8
    unsigned long InUseGatewayCount;// Offset=0x3c8 Size=0x4
    unsigned long AllocatedGatewayCount;// Offset=0x3cc Size=0x4
    unsigned long ProcessorCountPerGateway;// Offset=0x3d0 Size=0x4
    unsigned long IoResourceReclaimTolerancePeriodLimit;// Offset=0x3d4 Size=0x4
    unsigned long LowWaterMarkForAdapter;// Offset=0x3d8 Size=0x4
    unsigned long AdapterPauseCount;// Offset=0x3dc Size=0x4
    unsigned long AdapterBusyCount;// Offset=0x3e0 Size=0x4
    unsigned long AdapterSlowPathCount;// Offset=0x3e4 Size=0x4
    struct _RAID_DEFERRED_QUEUE DeferredQueue;// Offset=0x3f0 Size=0x80
    struct _unnamed_406 DeferredList;// Offset=0x470 Size=0x50
    struct _unnamed_407 DeferredPauseResumeContext;// Offset=0x4c0 Size=0xb0
    struct _RAID_DEFERRED_QUEUE WmiDeferredQueue;// Offset=0x570 Size=0x80
    struct _KDPC TimerDpc;// Offset=0x5f0 Size=0x40
    struct _KTIMER Timer;// Offset=0x630 Size=0x40
    struct _KDPC PauseTimerDpc;// Offset=0x670 Size=0x40
    struct _KDPC RestartDpc;// Offset=0x6b0 Size=0x40
    struct _KTIMER PauseTimer;// Offset=0x6f0 Size=0x40
    void  ( * HwTimerRoutine)(void * );// Offset=0x730 Size=0x8
    struct _KDPC CompletionDpc;// Offset=0x738 Size=0x40
    struct _KDPC BusChangeDpc;// Offset=0x778 Size=0x40
    struct _UNICODE_STRING PnpInterfaceName;// Offset=0x7b8 Size=0x10
    unsigned long AdapterNumber;// Offset=0x7c8 Size=0x4
    void * DriverParameters;// Offset=0x7d0 Size=0x8
    struct _PORT_REGISTRY_INFO RegistryInfo;// Offset=0x7d8 Size=0x40
    unsigned long LinkDownTimeoutValue;// Offset=0x818 Size=0x4
    unsigned long LinkUp;// Offset=0x81c Size=0x4
    void * BusKeyArray[255];// Offset=0x820 Size=0x7f8
    long ProcessingDeferredItems;// Offset=0x1018 Size=0x4
    unsigned long DefaultTimeout;// Offset=0x101c Size=0x4
    unsigned long AdditionalTimers;// Offset=0x1020 Size=0x4
    struct _KTIMER ResetHoldTimer;// Offset=0x1028 Size=0x40
    struct _KDPC ResetHoldDpc;// Offset=0x1068 Size=0x40
    union _LARGE_INTEGER LastScanTime;// Offset=0x10a8 Size=0x8
    struct _RAID_ADAPTER_PARAMETERS Parameters;// Offset=0x10b0 Size=0x38
    unsigned char  ( * HwPassiveInitRoutine)(void * );// Offset=0x10e8 Size=0x8
    enum _INTERRUPT_SYNCHRONIZATION_MODE MsiMode;// Offset=0x10f0 Size=0x4
    unsigned long long MSIInterruptLock;// Offset=0x10f8 Size=0x8
    struct _IO_INTERRUPT_MESSAGE_INFO * MSIMessageInfo;// Offset=0x1100 Size=0x8
    struct _GROUP_AFFINITY * MSIMessageGroupAffinity;// Offset=0x1108 Size=0x8
    unsigned char MSISupported;// Offset=0x1110 Size=0x1
    unsigned char MSIEnabled;// Offset=0x1111 Size=0x1
    unsigned char Contiguous;// Offset=0x1112 Size=0x1
    struct _unnamed_409 PerfOptFlags;// Offset=0x1113 Size=0x1
    struct _DEVICE_RELATIONS * DeviceRelations;// Offset=0x1118 Size=0x8
    struct _RAID_POWER_CONTEXT PowerContext;// Offset=0x1120 Size=0xb8
    struct _STORPORT_EXTENDED_FUNCTIONS ExtendedFunctions;// Offset=0x11d8 Size=0x58
    unsigned long DeviceNode;// Offset=0x1230 Size=0x4
    union _RAID_REDIRECTION_SUPPORT RedirectionSupport;// Offset=0x1234 Size=0x2
    unsigned short InterruptRedirectionGroups;// Offset=0x1236 Size=0x2
    long ConcurrentChannels;// Offset=0x1238 Size=0x4
    struct _RAID_CONCURRENT_CHANNEL_TOKEN_LIST * ConcurrentChannelTokens;// Offset=0x1240 Size=0x8
    unsigned char * InterruptRedirectionTable;// Offset=0x1248 Size=0x8
    unsigned long HierarchicalResetSucceededAtBus;// Offset=0x1250 Size=0x4
    unsigned long HierarchicalResetSucceededAtTarget;// Offset=0x1254 Size=0x4
    unsigned long HierarchicalResetSucceededAtLun;// Offset=0x1258 Size=0x4
    unsigned long HierarchicalResetCountInternal;// Offset=0x125c Size=0x4
    unsigned long HierarchicalResetCountApp;// Offset=0x1260 Size=0x4
    unsigned long MaxDpcCompletionCount;// Offset=0x1264 Size=0x4
    unsigned long MaxDpcCompletionTimeTicks;// Offset=0x1268 Size=0x4
    unsigned long CompletionsForLongestDpc;// Offset=0x126c Size=0x4
    wchar_t * MiniportName;// Offset=0x1270 Size=0x8
    wchar_t * AdapterId;// Offset=0x1278 Size=0x8
    struct _PCI_COMMON_HEADER PciConfiguration;// Offset=0x1280 Size=0x40
    struct _STOR_POWER_SETTING_NOTIFICATION PowerSettingNotification;// Offset=0x12c0 Size=0x18
    long StateChangeInProgress;// Offset=0x12d8 Size=0x4
    unsigned long StateChangedEntity;// Offset=0x12dc Size=0x4
    unsigned long StateChangeEntityAttributes;// Offset=0x12e0 Size=0x4
    struct _STOR_ADDRESS * StateChangeAddress;// Offset=0x12e8 Size=0x8
    void  ( * HwStateChange)(void * ,void * ,short ,void * ,unsigned long );// Offset=0x12f0 Size=0x8
    void * StateChangeContext;// Offset=0x12f8 Size=0x8
    struct _RTL_BITMAP BusesWithVmLunsBitmap;// Offset=0x1300 Size=0x10
    unsigned long * BusesWithVmLunsBitmapBuffer;// Offset=0x1310 Size=0x8
    unsigned long NumWorkItems;// Offset=0x1318 Size=0x4
    unsigned char DefaultSenseByteCount;// Offset=0x131c Size=0x1
    unsigned char DumpPowerReady;// Offset=0x131d Size=0x1
    unsigned char MaxDumpLevelEnabled;// Offset=0x131e Size=0x1
    unsigned char VendorSpecificLogPageAddress;// Offset=0x131f Size=0x1
    unsigned long MaxDeviceDumpSize;// Offset=0x1320 Size=0x4
    unsigned long long IoLatencyCap;// Offset=0x1328 Size=0x8
    unsigned long RaidLogListIndex;// Offset=0x1340 Size=0x4
    unsigned long RaidLogListSize;// Offset=0x1344 Size=0x4
    struct _RAID_LOG_ENTRY * RaidLogList;// Offset=0x1348 Size=0x8
    union _SLIST_HEADER UnitsPendingPowerUpList;// Offset=0x1350 Size=0x10
    struct _RAID_ADAPTER_POFX * PoFx;// Offset=0x1360 Size=0x8
    void * LowPowerEpochHandle;// Offset=0x1368 Size=0x8
    unsigned long D3IdleTimeout;// Offset=0x1370 Size=0x4
    unsigned long TBTD3IdleTimeout;// Offset=0x1374 Size=0x4
    void * CoalescingRegistration;// Offset=0x1378 Size=0x8
    void * MaxPowerHandle;// Offset=0x1380 Size=0x8
    struct _UNICODE_STRING CoolingInterfaceSymlink;// Offset=0x1388 Size=0x10
    struct _RAID_UNIT_EXTENSION * CrashDumpUnit;// Offset=0x1398 Size=0x8
    struct _CRASHDUMP_FUNCTIONS_INTERFACE ParentCrashdumpInterface;// Offset=0x13a0 Size=0x28
    struct _GUID AdapterGuid;// Offset=0x13c8 Size=0x10
    wchar_t * AdapterSerialNumber;// Offset=0x13d8 Size=0x8
    unsigned long CompletionsDuringReset;// Offset=0x13e0 Size=0x4
    struct _unnamed_410 TelemetryHierarchicalResetLunBucket[5];// Offset=0x13e4 Size=0x3c
    struct _unnamed_410 TelemetryHierarchicalResetTargetBucket[5];// Offset=0x1420 Size=0x3c
    unsigned long long LastCSStateChange;// Offset=0x1460 Size=0x8
    unsigned long long LastIOCoalescingOnStartTime;// Offset=0x1468 Size=0x8
    unsigned long long IOCoalescingOnDuration;// Offset=0x1470 Size=0x8
    unsigned long long FirstDPNRTimeAfterCS;// Offset=0x1478 Size=0x8
    unsigned long long LastDPNRStartTime;// Offset=0x1480 Size=0x8
    unsigned long long DPNRDurationInCS;// Offset=0x1488 Size=0x8
    unsigned long long LastF1StartTime;// Offset=0x1490 Size=0x8
    unsigned long long F1DurationInCS;// Offset=0x1498 Size=0x8
    unsigned long long ActiveReferencesInCS;// Offset=0x14a0 Size=0x8
    unsigned long long ActiveReferencesInCoalescing;// Offset=0x14a8 Size=0x8
    unsigned long UnitTimeoutsInCS;// Offset=0x14b0 Size=0x4
    unsigned long F0TransitionsSinceCSStateChange;// Offset=0x14b4 Size=0x4
    unsigned long D0TransitionsSinceCSStateChange;// Offset=0x14b8 Size=0x4
    unsigned long F0TransitionsLongSinceCSStateChange;// Offset=0x14bc Size=0x4
    unsigned long D0TransitionsLongSinceCSStateChange;// Offset=0x14c0 Size=0x4
    unsigned char NvmeCriticalWarning;// Offset=0x14c4 Size=0x1
    unsigned char DeviceHealthPollCount;// Offset=0x14c5 Size=0x1
    unsigned char Reserved[2];// Offset=0x14c6 Size=0x2
    unsigned long long FirstDFxPowerDownTimeAfterCS;// Offset=0x14c8 Size=0x8
    unsigned long long LastDFxPowerDownStartTime;// Offset=0x14d0 Size=0x8
    unsigned long long DFxPowerDownDurationInCS;// Offset=0x14d8 Size=0x8
    struct _unnamed_411 TelemetryFlags;// Offset=0x14e0 Size=0x4
    unsigned long PeriodicMaxGatewayQueueDepthAtSwTimeout;// Offset=0x14e4 Size=0x4
    unsigned long PauseCount;// Offset=0x14e8 Size=0x4
    unsigned long BusyCount;// Offset=0x14ec Size=0x4
    unsigned char DisableTelemetryDeviceHealth;// Offset=0x14f0 Size=0x1
    unsigned long MiniportFirmwareDataStructureVersion;// Offset=0x14f4 Size=0x4
    struct _D3COLD_SUPPORT_INTERFACE * D3ColdInterface;// Offset=0x14f8 Size=0x8
    struct _DEVICE_RESET_INTERFACE_STANDARD * ResetInterface;// Offset=0x1500 Size=0x8
    void * ProtocolCommandEffects;// Offset=0x1508 Size=0x8
    void * ProtocolFeatureEffects;// Offset=0x1510 Size=0x8
    struct _KTIMER QueueWaitCheckTimer;// Offset=0x1518 Size=0x40
    struct _KDPC QueueWaitCheckDpc;// Offset=0x1558 Size=0x40
    unsigned long long QosLock;// Offset=0x1598 Size=0x8
    unsigned long QosUnitCountForWaitTimeout;// Offset=0x15a0 Size=0x4
    struct _RAID_RPMB_CAPABILITIES Rpmb;// Offset=0x15a8 Size=0x38
    struct _STOR_HMB_RANGE * HmbRangeList;// Offset=0x15e0 Size=0x8
    unsigned long PowerSrbTimeout;// Offset=0x15e8 Size=0x4
    struct _STOR_CRYPTO_CAPABILITIES_DATA_INTERNAL * CryptoCapabilitiesInternal;// Offset=0x15f0 Size=0x8
    struct _STOR_CRYPTO_CAPABILITIES_DATA * CryptoCapabilities;// Offset=0x15f8 Size=0x8
    struct _RAID_CRYPTO_KEY_TABLE CryptoKeyTable;// Offset=0x1600 Size=0x18
    unsigned long ZoneDeviceWriteErrors;// Offset=0x1618 Size=0x4
    unsigned long ZoneDeviceErrors;// Offset=0x161c Size=0x4
    unsigned long ZoneWriteOverflowEntries;// Offset=0x1620 Size=0x4
    unsigned long BusyRetryCount;// Offset=0x1624 Size=0x4
    unsigned long BusyPauseTimeInMs;// Offset=0x1628 Size=0x4
    struct _RAID_SHARED_WORK_ITEM_CONTEXT PowerWorkItem;// Offset=0x1630 Size=0x18
    struct _NPEM_CONTROL_INTERFACE * NpemControlInterface;// Offset=0x1648 Size=0x8
    unsigned long AcpiDsdStorageD3PropertyValue;// Offset=0x1650 Size=0x4
    unsigned long DsmLedSupportedFunction;// Offset=0x1654 Size=0x4
    union _DSM_PCI_SSD_LED_STATE DsmLedSupportedStates;// Offset=0x1658 Size=0x4
    struct _UNICODE_STRING NonPoFxMiniportInterfaceName;// Offset=0x1660 Size=0x10
    struct _unnamed_412 DFxQueue;// Offset=0x1670 Size=0x20
    union _STORAGE_INDICATOR_STATE LedState;// Offset=0x1690 Size=0x4
    unsigned long PciDeviceType;// Offset=0x1694 Size=0x4
    long DeferredUpdateAssociatedUnitsIdentityItems;// Offset=0x1698 Size=0x4
    struct _KTIMER IoResourceReclaimTimer;// Offset=0x16a0 Size=0x40
    struct _KDPC IoResourceReclaimTimerDpc;// Offset=0x16e0 Size=0x40
    struct _PCI_MSIX_TABLE_CONFIG_INTERFACE MSIXTableConfigInterface;// Offset=0x1720 Size=0x48
    unsigned short EventCount[3];// Offset=0x1768 Size=0x6
    struct NVME_IDENTIFY_CONTROLLER_DATA * IdentifyControllerData;// Offset=0x1770 Size=0x8
    struct _RAID_MINIPORT_SYSTEM_THREAD_CONTEXT MiniportSystemThreadContext;// Offset=0x1778 Size=0x10
    unsigned long PoFxPlaceHolderD3IdleTimeout;// Offset=0x1788 Size=0x4
    unsigned long PoweredDownUnitCount;// Offset=0x178c Size=0x4
    unsigned long BusSpecificResetTimeoutInSeconds;// Offset=0x1790 Size=0x4
    unsigned long PLDRTimeoutInSeconds;// Offset=0x1794 Size=0x4
    void * PdcIdleResiliencyEngagedHandle;// Offset=0x1798 Size=0x8
    struct _REGISTRY_WATCH_CONTEXT * RegWatchContext;// Offset=0x17a0 Size=0x8
    unsigned char * TcgContext[6240];// Offset=0x17a8 Size=0x8
    struct _TCG_DEVICE_PROPERTIES * TcgProperties;// Offset=0x17b0 Size=0x8
    struct _KLOCK_QUEUE_HANDLE * GatewayLockHandleArray;// Offset=0x17b8 Size=0x8
    struct _NVME_DISK_CQ_INTERRUPT_ROUTINE_INFO NVMeDiskCQISRInfo;// Offset=0x17c0 Size=0x18
    struct _KEVENT DeviceStartEventForReset;// Offset=0x17d8 Size=0x18
    struct _unnamed_414 NVMeDiagnostics;// Offset=0x17f0 Size=0xc
    struct _unnamed_415 KsrFlags;// Offset=0x17fc Size=0x4
    struct _RAID_DEVICE_RESET_CONTEXT * ResetContext;// Offset=0x1800 Size=0x8
    struct _unnamed_416 MFND;// Offset=0x1808 Size=0x10
    union _STORAGE_IO_UNIQUE_TAGGING ** UniqueTagArray;// Offset=0x1818 Size=0x8
    unsigned long FWActivateTimeoutInSeconds;// Offset=0x1820 Size=0x4
    unsigned long IoctlTimeoutCount;// Offset=0x1824 Size=0x4
    unsigned long PnPRequestTimeoutCount;// Offset=0x1828 Size=0x4
    enum _ADAPTER_START_FAILURE_CODE StartFailureCode;// Offset=0x182c Size=0x4
    struct _NVME_ICE_ENTRY * NvmeIceEntry;// Offset=0x1830 Size=0x8
    void * NvmeIcePnpNotificationEntry;// Offset=0x1838 Size=0x8
    struct _STOR_EVENT_NOTIFICATION_CONTEXT * EventNotificationContext;// Offset=0x1840 Size=0x8
    struct _PCI_LINK_CONFIG_INTERFACE_V1 * PciLinkConfigInterface;// Offset=0x1848 Size=0x8
    void * DlrmContext;// Offset=0x1850 Size=0x8
    unsigned short IoCommandTimeout;// Offset=0x1858 Size=0x2
    unsigned short AdminCommandTimeout;// Offset=0x185a Size=0x2
};
