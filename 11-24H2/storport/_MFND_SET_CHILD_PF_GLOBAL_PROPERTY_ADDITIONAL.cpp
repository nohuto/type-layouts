union _unnamed_667// Size=0x1 (Id=667)
{
...
struct _MFND_PHYSICAL_FUNCTION_GLOBAL_PROPERTIES// Size=0x10 (Id=668)
{
    ...
    union _unnamed_667 LBAFormatIndex;// Offset=0xb Size=0x1
    unsigned char Reserved[4];// Offset=0xc Size=0x4
};

struct _MFND_SET_CHILD_PF_GLOBAL_PROPERTY_ADDITIONAL// Size=0x20 (Id=681)
{
    unsigned short Version;// Offset=0x0 Size=0x2
