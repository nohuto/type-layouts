union _unnamed_515// Size=0x4 (Id=515)
{
...
struct NVME_COMPLETION_ENTRY// Size=0x10 (Id=517)
{
    unsigned long DW0;// Offset=0x0 Size=0x4
    unsigned long DW1;// Offset=0x4 Size=0x4
    union _unnamed_515 DW2;// Offset=0x8 Size=0x4
    union _unnamed_516 DW3;// Offset=0xc Size=0x4
};
