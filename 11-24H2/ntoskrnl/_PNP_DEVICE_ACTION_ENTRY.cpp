...
struct _PNP_DEVICE_ACTION_REQUEST_ARGUMENT// Size=0x10 (Id=1671)
{
    void * PdcActivatorHandle;// Offset=0x0 Size=0x8
    union _unnamed_1670 u;// Offset=0x8 Size=0x8
};
...
struct _PNP_DEVICE_ACTION_ENTRY// Size=0x68 (Id=1558)
{
