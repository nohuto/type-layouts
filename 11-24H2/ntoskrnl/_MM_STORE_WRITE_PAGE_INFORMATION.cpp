union _MM_STORE_KEY// Size=0x4 (Id=1511)
{
    unsigned long EntireKey;// Offset=0x0 Size=0x4
};

struct _unnamed_1711// Size=0x4 (Id=1711)
{
...
union _MM_STORE_SUB_KEY_DESCRIPTOR// Size=0x8 (Id=1712)
{
    struct _unnamed_1711 Flags;// Offset=0x0 Size=0x4
    void * VirtualAddress;// Offset=0x0 Size=0x8
};

struct _MM_STORE_KEY_DESCRIPTOR// Size=0x10 (Id=1618)
{
    unsigned long long ContainerKey;// Offset=0x0 Size=0x8
    union _MM_STORE_SUB_KEY_DESCRIPTOR SubKey;// Offset=0x8 Size=0x8
};

struct _MM_STORE_WRITE_PAGE_INFORMATION// Size=0x40 (Id=1478)
{
