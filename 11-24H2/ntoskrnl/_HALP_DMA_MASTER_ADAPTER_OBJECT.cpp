...
struct _HALP_DMA_MASTER_ADAPTER_OBJECT// Size=0xe8 (Id=282)
{
    struct _HALP_DMA_ADAPTER_OBJECT AdapterObject;// Offset=0x0 Size=0xa0
    unsigned long long QueueLock;// Offset=0xa0 Size=0x8
    struct _LIST_ENTRY ContiguousAdapterQueue;// Offset=0xa8 Size=0x10
    struct _LIST_ENTRY ScatterAdapterQueue;// Offset=0xb8 Size=0x10
    unsigned long MapBufferSize;// Offset=0xc8 Size=0x4
    union _LARGE_INTEGER MapBufferPhysicalAddress;// Offset=0xd0 Size=0x8
    unsigned long ContiguousPageCount;// Offset=0xd8 Size=0x4
    unsigned long ContiguousPageLimit;// Offset=0xdc Size=0x4
    unsigned long ScatterPageCount;// Offset=0xe0 Size=0x4
    unsigned long ScatterPageLimit;// Offset=0xe4 Size=0x4
};
