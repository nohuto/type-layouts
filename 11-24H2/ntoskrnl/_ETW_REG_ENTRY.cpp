...
struct _ETW_REG_ENTRY// Size=0x78 (Id=1718)
{
    ...
    unsigned short EnableMask;// Offset=0x64 Size=0x2
    unsigned short GroupEnableMask;// Offset=0x66 Size=0x2
    unsigned short HostEnableMask;// Offset=0x68 Size=0x2
    unsigned short HostGroupEnableMask;// Offset=0x6a Size=0x2
    struct _ETW_PROVIDER_TRAITS * Traits;// Offset=0x70 Size=0x8
};
