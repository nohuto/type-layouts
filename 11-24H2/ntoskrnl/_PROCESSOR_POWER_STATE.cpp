struct _PROC_IDLE_POLICY// Size=0x6 (Id=2299)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=2022)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=1922)
{
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=1942)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=2249)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROC_PERF_CHECK_CONTEXT// Size=0x48 (Id=2017)
{
...
struct _PROCESSOR_POWER_STATE// Size=0x238 (Id=1804)
{
