struct _MI_SEGMENT_SIGNATURE_FLAGS// Size=0x1 (Id=2215)
{
    union // Size=0x1 (Id=0)
    {
...
struct _SEGMENT_FLAGS// Size=0x4 (Id=2115)
{
    union // Size=0x2 (Id=0)
    {
...
union _unnamed_680// Size=0x8 (Id=680)
{
    union // Size=0x8 (Id=0)
    {
...
struct _SEGMENT// Size=0x48 (Id=682)
{
    ...
    union _unnamed_680 u1;// Offset=0x30 Size=0x8
    union _unnamed_681 u2;// Offset=0x38 Size=0x8
