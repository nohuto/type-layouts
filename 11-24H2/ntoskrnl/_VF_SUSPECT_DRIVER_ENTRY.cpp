...
struct _VF_SUSPECT_DRIVER_ENTRY// Size=0x38 (Id=1528)
{
    ...
    struct _UNICODE_STRING FullName;// Offset=0x18 Size=0x10
    struct _UNICODE_STRING BaseName;// Offset=0x28 Size=0x10
};
