...
struct _unnamed_978// Size=0x4 (Id=978)
{
...
union _unnamed_979// Size=0x4 (Id=979)
{
    struct _unnamed_978 s1;// Offset=0x0 Size=0x4
};

struct _KALPC_REGION// Size=0x58 (Id=980)
{
    ...
    union _unnamed_979 u1;// Offset=0x30 Size=0x4
