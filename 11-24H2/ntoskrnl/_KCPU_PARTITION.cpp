...
union _KI_AVAILABLE_CPUS_WORK_STATE// Size=0x4 (Id=1442)
{
...
struct _KI_AVAILABLE_CPUS_WORK_ITEM// Size=0x40 (Id=1398)
{
...
struct _KCPU_PARTITION// Size=0x70 (Id=1218)
{
    struct _KAFFINITY_EX * Affinity;// Offset=0x0 Size=0x8
    unsigned long long Lock;// Offset=0x8 Size=0x8
    struct _LIST_ENTRY ProcessList;// Offset=0x10 Size=0x10
    struct _PS_CPU_PARTITION * CpuPartitionObject;// Offset=0x20 Size=0x8
    struct _KI_AVAILABLE_CPUS_WORK_ITEM AvailableCpusNotificationWorkItem;// Offset=0x28 Size=0x40
