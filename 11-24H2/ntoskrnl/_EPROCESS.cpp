...
struct _KAB_UM_PROCESS_CONTEXT// Size=0x10 (Id=1184)
{
...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=1270)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=529)
{
...
struct _unnamed_530// Size=0x8 (Id=530)
{
...
union _unnamed_531// Size=0x8 (Id=531)
{
    unsigned long long SecureHandle;// Offset=0x0 Size=0x8
    struct _unnamed_530 Flags;// Offset=0x0 Size=0x8
};

struct _KPROCESS// Size=0x1c8 (Id=532)
{
    ...
    union _unnamed_531 SecureState;// Offset=0x170 Size=0x8
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=1799)
{
...
struct _ALPC_PROCESS_CONTEXT// Size=0x20 (Id=1491)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=1443)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=560)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WNF_STATE_NAME// Size=0x8 (Id=1089)
{
    unsigned long Data[2];// Offset=0x0 Size=0x8
};

struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=1381)
{
    unsigned long HighEdgeFilter;// Offset=0x0 Size=0x4
    unsigned long LowEdgeFilter;// Offset=0x4 Size=0x4
};

struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=1356)
{
...
struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=1410)
{
    struct _RTL_AVL_TREE Tree;// Offset=0x0 Size=0x8
    struct _EX_PUSH_LOCK Lock;// Offset=0x8 Size=0x8
};

struct _PSP_SYSCALL_PROVIDER_DISPATCH_CONTEXT// Size=0x8 (Id=1706)
{
...
struct _unnamed_565// Size=0x4 (Id=565)
{
    struct // Size=0x4 (Id=0)
    {
...
union _PROCESS_EXECUTION_TRANSITION// Size=0x2 (Id=1633)
{
...
union _PROCESS_EXECUTION_STATE// Size=0x1 (Id=1661)
{
...
union _PROCESS_EXECUTION// Size=0x4 (Id=1634)
{
...
struct _EPROCESS// Size=0x840 (Id=566)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_561 MitigationFlagsValues;// Offset=0x750 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x754 Size=0x4
        struct _unnamed_562 MitigationFlags2Values;// Offset=0x754 Size=0x4
    };
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_564 MitigationFlags3Values;// Offset=0x7d8 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_565 SyscallUsageValues;// Offset=0x7e0 Size=0x4
    };
