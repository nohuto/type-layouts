struct _unnamed_2024// Size=0x8 (Id=2024)
{
...
union _unnamed_2025// Size=0x8 (Id=2025)
{
    struct _unnamed_2024 s1;// Offset=0x0 Size=0x8
    long long Value;// Offset=0x0 Size=0x8
};

struct _ALPC_COMPLETION_LIST_STATE// Size=0x8 (Id=1735)
{
    union _unnamed_2025 u1;// Offset=0x0 Size=0x8
};

struct _RTL_SRWLOCK// Size=0x8 (Id=1643)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _ALPC_COMPLETION_LIST_HEADER// Size=0x180 (Id=1736)
{
