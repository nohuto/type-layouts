...
struct _HEAP_OPPORTUNISTIC_LARGE_PAGE_STATS// Size=0x10 (Id=2050)
{
...
struct _RTL_HP_SEG_ALLOC_POLICY// Size=0x18 (Id=1525)
{
...
struct _HEAP_RUNTIME_MEMORY_STATS// Size=0x60 (Id=935)
{
...
struct _RTL_HP_HEAP_VA_CALLBACKS_ENCODED// Size=0x20 (Id=1321)
{
...
union _unnamed_940// Size=0x1 (Id=940)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _HEAP_SEG_CONTEXT// Size=0xc0 (Id=941)
{
    ...
    union _unnamed_940 Flags;// Offset=0xd Size=0x1
...
struct _SEGMENT_HEAP// Size=0xa00 (Id=945)
{
