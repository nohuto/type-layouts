...
struct _ALPC_COMPLETION_PACKET_LOOKASIDE_ENTRY// Size=0x18 (Id=1751)
{
...
struct _ALPC_COMPLETION_PACKET_LOOKASIDE// Size=0x50 (Id=1418)
{
    ...
    struct _KQUEUE * CompletionPort;// Offset=0x28 Size=0x8
