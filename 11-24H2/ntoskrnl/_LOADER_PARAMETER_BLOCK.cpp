...
struct _I386_LOADER_BLOCK// Size=0x10 (Id=2350)
{
...
struct _ARM_LOADER_BLOCK// Size=0x4 (Id=2433)
{
    unsigned long PlaceHolder;// Offset=0x0 Size=0x4
};

union _unnamed_2118// Size=0x10 (Id=2118)
{
...
struct _FIRMWARE_INFORMATION_LOADER_BLOCK// Size=0x40 (Id=2361)
{
    ...
    union _unnamed_2360 u;// Offset=0x8 Size=0x38
};
...
struct _LOADER_PARAMETER_BLOCK// Size=0x170 (Id=2119)
{
    ...
    union _unnamed_2118 u;// Offset=0xf8 Size=0x10
