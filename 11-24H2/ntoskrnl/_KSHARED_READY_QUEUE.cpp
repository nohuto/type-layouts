...
union _KPRIORITY_STATE// Size=0x1 (Id=1126)
{
...
union _KHETERO_STATE// Size=0x1 (Id=2405)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _KSHARED_READY_QUEUE_HETERO_STATISTICS// Size=0x380 (Id=2229)
{
    unsigned long long ExpectedRuntimeByClass[7][2][8];// Offset=0x0 Size=0x380
};

struct _KSHARED_READY_QUEUE_AFFINITY_STATISTICS// Size=0x8 (Id=1933)
{
    unsigned long long AffinitySummary;// Offset=0x0 Size=0x8
};

struct _KSHARED_READY_QUEUE// Size=0x700 (Id=1716)
{
