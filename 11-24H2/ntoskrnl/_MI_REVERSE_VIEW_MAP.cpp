...
struct _MI_REVERSE_MAP_VIEW_ATTRIBUTES// Size=0x8 (Id=1880)
{
    union // Size=0x8 (Id=0)
    {
        unsigned long long FullSectionOffset;// Offset=0x0 Size=0x8
...
struct _MI_REVERSE_VIEW_MAP// Size=0x28 (Id=1689)
{
    ...
    struct _MI_REVERSE_MAP_VIEW_ATTRIBUTES Attributes;// Offset=0x20 Size=0x8
};
