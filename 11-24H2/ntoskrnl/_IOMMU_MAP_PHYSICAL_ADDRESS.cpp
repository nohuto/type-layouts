...
struct _unnamed_1950// Size=0x8 (Id=1950)
{
...
struct _unnamed_1951// Size=0x10 (Id=1951)
{
    union _LARGE_INTEGER Base;// Offset=0x0 Size=0x8
    unsigned long long Size;// Offset=0x8 Size=0x8
};

struct _unnamed_1952// Size=0x10 (Id=1952)
{
    unsigned long long * PageFrame;// Offset=0x0 Size=0x8
    unsigned long long NumberOfPages;// Offset=0x8 Size=0x8
};

struct _IOMMU_MAP_PHYSICAL_ADDRESS// Size=0x18 (Id=1953)
{
    enum _IOMMU_MAP_PHYSICAL_ADDRESS_TYPE MapType;// Offset=0x0 Size=0x4
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_1950 Mdl;// Offset=0x8 Size=0x8
        struct _unnamed_1951 ContiguousRange;// Offset=0x8 Size=0x10
        struct _unnamed_1952 PfnArray;// Offset=0x8 Size=0x10
    };
};
