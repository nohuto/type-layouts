...
struct _MI_AWE_ATTRIBUTE_CHANGE_WAIT_BLOCK// Size=0x28 (Id=2501)
{
    struct _MI_AWE_ATTRIBUTE_CHANGE_WAIT_BLOCK * Next;// Offset=0x0 Size=0x8
    struct _MMPFN * BasePfn;// Offset=0x8 Size=0x8
