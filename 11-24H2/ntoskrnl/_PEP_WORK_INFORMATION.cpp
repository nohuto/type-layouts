...
struct _PEP_WORK_ACTIVE_COMPLETE// Size=0x10 (Id=2491)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned long Component;// Offset=0x8 Size=0x4
};

struct _PEP_WORK_IDLE_STATE// Size=0x10 (Id=2440)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned long Component;// Offset=0x8 Size=0x4
...
struct _PEP_WORK_DEVICE_POWER// Size=0x10 (Id=2470)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned char PowerRequired;// Offset=0x8 Size=0x1
};

struct _PEP_WORK_POWER_CONTROL// Size=0x38 (Id=2469)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
...
struct _PEP_WORK_COMPLETE_IDLE_STATE// Size=0x10 (Id=2487)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned long Component;// Offset=0x8 Size=0x4
};

struct _PEP_WORK_COMPLETE_PERF_STATE// Size=0x10 (Id=2436)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned long Component;// Offset=0x8 Size=0x4
...
struct _PEP_WORK_ACPI_NOTIFY// Size=0x10 (Id=2404)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned long NotifyCode;// Offset=0x8 Size=0x4
};

struct _PEP_WORK_ACPI_EVALUATE_CONTROL_METHOD_COMPLETE// Size=0x28 (Id=2396)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
...
struct _PEP_WORK_INFORMATION// Size=0x40 (Id=2389)
{
