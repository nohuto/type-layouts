...
struct _GROUP_FAULT_REFERENCE// Size=0x8 (Id=408)
{
    union _unnamed_407 u1;// Offset=0x0 Size=0x8
};

struct _IOMMU_TRACKED_DEVICE// Size=0x1058 (Id=293)
{
    ...
    struct _LIST_ENTRY ActiveDeviceListHead;// Offset=0x38 Size=0x10
    struct _IOMMU_DMA_DEVICE * DmaDevice;// Offset=0x48 Size=0x8
    unsigned long LastGroupFaultSequenceNumber;// Offset=0x50 Size=0x4
    struct _GROUP_FAULT_REFERENCE GroupFaultReferences[512];// Offset=0x58 Size=0x1000
};
