...
struct _ETW_LAST_ENABLE_INFO// Size=0x10 (Id=2047)
{
...
struct _TRACE_ENABLE_INFO// Size=0x20 (Id=1051)
{
...
struct _ETW_GUID_ENTRY// Size=0x2a8 (Id=1050)
{
...
struct _ETW_HASH_BUCKET// Size=0x38 (Id=1155)
{
...
struct _ETW_PRIV_HANDLE_DEMUX_TABLE// Size=0x20 (Id=1789)
{
...
struct _ETW_COUNTERS// Size=0x10 (Id=1582)
{
...
struct _ETW_SYSTEM_LOGGER// Size=0x2 (Id=1734)
{
    unsigned char LoggerId;// Offset=0x0 Size=0x1
    unsigned char ClockType;// Offset=0x1 Size=0x1
};

struct _PERFINFO_GROUPMASK// Size=0x20 (Id=586)
{
    unsigned long Masks[8];// Offset=0x0 Size=0x20
};

struct _ETW_SYSTEM_LOGGER_SETTINGS// Size=0x174 (Id=1535)
{
...
struct _ETW_SILODRIVERSTATE// Size=0x1348 (Id=1048)
{
