struct _NT_TIB64// Size=0x38 (Id=1448)
{
...
struct _GDI_TEB_BATCH64// Size=0x4e8 (Id=1224)
{
...
struct _PROCESSOR_NUMBER// Size=0x4 (Id=1221)
{
...
struct _GROUP_AFFINITY64// Size=0x10 (Id=1205)
{
...
struct _TEB64// Size=0x1878 (Id=746)
{
    ...
    unsigned long long SystemReserved1[25];// Offset=0x190 Size=0xc8
    ...
    unsigned long HeapData;// Offset=0x17b0 Size=0x4
    ...
    unsigned long long HeapWalkContext;// Offset=0x1858 Size=0x8
    struct _GROUP_AFFINITY64 PrimaryGroupAffinity;// Offset=0x1860 Size=0x10
    unsigned long Rcu[2];// Offset=0x1870 Size=0x8
};
