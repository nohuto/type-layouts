...
struct _PO_DEVICE_NOTIFY// Size=0x68 (Id=1259)
{
...
union _unnamed_763// Size=0x8 (Id=763)
{
...
union _unnamed_764// Size=0x8 (Id=764)
{
...
struct _PO_DIRECTED_DRIPS_STATE// Size=0x38 (Id=1228)
{
...
struct _PNP_PROBLEM_CODE_LOG_ENTRY// Size=0x18 (Id=1882)
{
...
struct _DEVICE_NODE// Size=0x388 (Id=768)
{
    ...
    union _unnamed_763 OverUsed1;// Offset=0x210 Size=0x8
    union _unnamed_764 OverUsed2;// Offset=0x218 Size=0x8
    ...
    struct _unnamed_766 DockInfo;// Offset=0x238 Size=0x20
