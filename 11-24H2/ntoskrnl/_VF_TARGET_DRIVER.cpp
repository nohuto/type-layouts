struct _VF_AVL_TREE_NODE// Size=0x10 (Id=1946)
{
    void * p;// Offset=0x0 Size=0x8
    unsigned long long RangeSize;// Offset=0x8 Size=0x8
};

struct _VF_TARGET_ALL_SHARED_EXPORT_THUNKS// Size=0x18 (Id=2276)
{
...
struct _unnamed_1682// Size=0x4 (Id=1682)
{
...
union _unnamed_1683// Size=0x18 (Id=1683)
{
    union // Size=0x18 (Id=0)
    {
        struct _VF_TARGET_ALL_SHARED_EXPORT_THUNKS AllSharedExportThunks;// Offset=0x0 Size=0x18
        struct _unnamed_1682 Flags;// Offset=0x0 Size=0x4
    };
};

struct _VF_TARGET_DRIVER// Size=0x48 (Id=1684)
{
    struct _VF_AVL_TREE_NODE TreeNode;// Offset=0x0 Size=0x10
    union _unnamed_1683 u1;// Offset=0x10 Size=0x18
