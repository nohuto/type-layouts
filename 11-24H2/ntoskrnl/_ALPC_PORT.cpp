...
struct _ALPC_PORT_ATTRIBUTES// Size=0x48 (Id=1243)
{
...
struct _unnamed_986// Size=0x4 (Id=986)
{
...
union _unnamed_987// Size=0x4 (Id=987)
{
    struct _unnamed_986 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

struct _ALPC_PORT// Size=0x1d8 (Id=988)
{
    ...
    union _unnamed_987 u1;// Offset=0x1a0 Size=0x4
