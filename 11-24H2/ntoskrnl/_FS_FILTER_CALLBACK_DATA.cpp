...
struct _unnamed_2509// Size=0x18 (Id=2509)
{
...
struct _unnamed_2510// Size=0x20 (Id=2510)
{
...
struct _unnamed_2511// Size=0x28 (Id=2511)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=2512)
{
    struct _unnamed_2506 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_2507 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_2509 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _unnamed_2510 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_2511 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=2493)
{
