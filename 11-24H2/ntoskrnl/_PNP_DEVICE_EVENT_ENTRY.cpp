...
union _unnamed_2346// Size=0x20 (Id=2346)
{
    union // Size=0x20 (Id=0)
    {
        struct _unnamed_2337 DeviceClass;// Offset=0x0 Size=0x14
        struct _unnamed_2338 TargetDevice;// Offset=0x0 Size=0x2
        struct _unnamed_2338 InstallDevice;// Offset=0x0 Size=0x2
        struct _unnamed_2339 CustomNotification;// Offset=0x0 Size=0x10
        struct _unnamed_2340 ProfileNotification;// Offset=0x0 Size=0x8
        struct _unnamed_2341 PowerNotification;// Offset=0x0 Size=0x8
        struct _unnamed_2342 VetoNotification;// Offset=0x0 Size=0x8
        struct _unnamed_2343 BlockedDriverNotification;// Offset=0x0 Size=0x10
        struct _unnamed_2344 InvalidIDNotification;// Offset=0x0 Size=0x2
        struct _unnamed_2345 PowerSettingNotification;// Offset=0x0 Size=0x20
        struct _unnamed_2338 PropertyChangeNotification;// Offset=0x0 Size=0x2
        struct _unnamed_2338 DeviceInstanceNotification;// Offset=0x0 Size=0x2
    };
};

struct _PLUGPLAY_EVENT_BLOCK// Size=0x50 (Id=2347)
{
    ...
    union _unnamed_2346 u;// Offset=0x30 Size=0x20
};

struct _PNP_DEVICE_EVENT_ENTRY// Size=0xc8 (Id=1776)
{
    ...
    void * PdcActivatorHandle;// Offset=0x70 Size=0x8
    struct _PLUGPLAY_EVENT_BLOCK Data;// Offset=0x78 Size=0x50
};
