...
union _EXT_IOMMU_DEVICE_ID_FLAGS// Size=0x2 (Id=447)
{
...
struct _EXT_IOMMU_DEVICE_ID_PCI// Size=0x10 (Id=448)
{
    union // Size=0x8 (Id=0)
    {
...
struct _EXT_IOMMU_DEVICE_ID_ACPI// Size=0x8 (Id=434)
{
    char * ObjectName;// Offset=0x0 Size=0x8
};

struct _EXT_IOMMU_DEVICE_ID_TEST// Size=0x8 (Id=436)
{
    unsigned long long UniqueId;// Offset=0x0 Size=0x8
};

struct _EXT_IOMMU_DEVICE_ID// Size=0x18 (Id=419)
{
