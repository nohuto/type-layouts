...
struct _unnamed_1840// Size=0x8 (Id=1840)
{
    unsigned long IdleTime;// Offset=0x0 Size=0x4
    unsigned long NonIdleTime;// Offset=0x4 Size=0x4
};

union _unnamed_1841// Size=0x8 (Id=1841)
{
    struct _unnamed_1840 Disk;// Offset=0x0 Size=0x8
};

struct _DEVICE_OBJECT_POWER_EXTENSION// Size=0x68 (Id=1842)
{
    ...
    union _unnamed_1841 Specific;// Offset=0x60 Size=0x8
};
