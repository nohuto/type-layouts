struct _PEBS_DS_SAVE_AREA32// Size=0x80 (Id=2294)
{
...
struct _PEBS_DS_SAVE_AREA64// Size=0xa0 (Id=1837)
{
...
struct _PEBS_DS_SAVE_AREA// Size=0xa0 (Id=1303)
{
...
struct _PROCESSOR_PROFILE_CONTROL_AREA// Size=0xa0 (Id=1180)
{
    union // Size=0xa0 (Id=0)
    {
        struct _PEBS_DS_SAVE_AREA PebsDsSaveArea;// Offset=0x0 Size=0xa0
        void * RawBuffer;// Offset=0x0 Size=0x8
    };
};
