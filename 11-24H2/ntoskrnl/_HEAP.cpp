struct _HEAP_UNPACKED_ENTRY// Size=0x10 (Id=2189)
{
...
struct _HEAP_EXTENDED_ENTRY// Size=0x10 (Id=2155)
{
...
struct _HEAP_ENTRY// Size=0x10 (Id=957)
{
    union // Size=0x10 (Id=0)
    {
...
struct _HEAP_SEGMENT// Size=0x70 (Id=958)
{
...
union _RTL_RUN_ONCE// Size=0x8 (Id=1248)
{
...
struct _HEAP_COUNTERS// Size=0x80 (Id=1125)
{
    ...
    unsigned long long TotalMemoryReservedInVirtualBlocks;// Offset=0x18 Size=0x8
    unsigned long long TotalMemoryCommittedInVirtualBlocks;// Offset=0x20 Size=0x8
    unsigned long TotalSegments;// Offset=0x28 Size=0x4
    unsigned long TotalUCRs;// Offset=0x2c Size=0x4
    unsigned long CommittOps;// Offset=0x30 Size=0x4
    unsigned long DeCommitOps;// Offset=0x34 Size=0x4
    unsigned long LockAcquires;// Offset=0x38 Size=0x4
    unsigned long LockCollisions;// Offset=0x3c Size=0x4
    unsigned long CommitRate;// Offset=0x40 Size=0x4
    unsigned long DecommittRate;// Offset=0x44 Size=0x4
    unsigned long CommitFailures;// Offset=0x48 Size=0x4
    unsigned long InBlockCommitFailures;// Offset=0x4c Size=0x4
    unsigned long PollIntervalCounter;// Offset=0x50 Size=0x4
    unsigned long DecommitsSinceLastCheck;// Offset=0x54 Size=0x4
    unsigned long HeapPollInterval;// Offset=0x58 Size=0x4
    unsigned long AllocAndFreeOps;// Offset=0x5c Size=0x4
    unsigned long AllocationIndicesActive;// Offset=0x60 Size=0x4
    unsigned long InBlockDeccommits;// Offset=0x64 Size=0x4
    unsigned long long InBlockDeccomitSize;// Offset=0x68 Size=0x8
    unsigned long long HighWatermarkSize;// Offset=0x70 Size=0x8
    unsigned long long LastPolledSize;// Offset=0x78 Size=0x8
};

struct _HEAP_TUNING_PARAMETERS// Size=0x10 (Id=1225)
{
    unsigned long CommittThresholdShift;// Offset=0x0 Size=0x4
    unsigned long long MaxPreCommittThreshold;// Offset=0x8 Size=0x8
};

struct _HEAP// Size=0x2c8 (Id=954)
{
    ...
    struct _HEAP_COUNTERS Counters;// Offset=0x238 Size=0x80
    struct _HEAP_TUNING_PARAMETERS TuningParameters;// Offset=0x2b8 Size=0x10
};
