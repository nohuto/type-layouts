...
struct _IOMMU_DMA_DOMAIN// Size=0x70 (Id=428)
{
    ...
    long AttachedDevicesListLock;// Offset=0x58 Size=0x4
    unsigned long HvReferences;// Offset=0x5c Size=0x4
    unsigned char HvDomainIdAllocated;// Offset=0x60 Size=0x1
