struct _unnamed_262// Size=0x8 (Id=262)
{
...
struct _FAULT_INFORMATION_ARM64_FLAGS// Size=0x4 (Id=449)
{
...
struct _FAULT_INFORMATION_ARM64// Size=0x30 (Id=344)
{
...
struct _FAULT_INFORMATION_X64_FLAGS// Size=0x4 (Id=403)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _FAULT_INFORMATION_X64// Size=0x28 (Id=346)
{
    void * DomainHandle;// Offset=0x0 Size=0x8
    void * FaultAddress;// Offset=0x8 Size=0x8
...
struct _FAULT_INFORMATION// Size=0x38 (Id=295)
{
...
struct _IOMMU_BUS_INTERFACE// Size=0x50 (Id=345)
{
...
struct _unnamed_291// Size=0x4 (Id=291)
{
    struct // Size=0x4 (Id=0)
    {
...
union _IOMMU_SVM_CAPABILITIES// Size=0x4 (Id=292)
{
    struct // Size=0x4 (Id=0)
    {
    ...
    struct _unnamed_289 CapReg;// Offset=0x0 Size=0x4
    struct _unnamed_290 EnabledCaps;// Offset=0x0 Size=0x4
    struct _unnamed_291 DeviceInformation;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _IOMMU_DMA_DEVICE// Size=0x1a8 (Id=265)
{
    ...
    union // Size=0x8 (Id=0)
    {
        struct _unnamed_262 Hypervisor;// Offset=0x20 Size=0x8
        struct _unnamed_263 Native;// Offset=0x20 Size=0x30
    };
    struct _IOMMU_INTERFACE_CALLBACK_RECORD * InterfaceCallbackRecord;// Offset=0x50 Size=0x8
    unsigned char DpptException;// Offset=0x58 Size=0x1
    struct _IOMMU_TRACKED_DEVICE * SvmDevice;// Offset=0x60 Size=0x8
    void  ( * FaultHandler)(void * ,struct _FAULT_INFORMATION * );// Offset=0x68 Size=0x8
    void * FaultContext;// Offset=0x70 Size=0x8
    struct _FAULT_INFORMATION FaultInfo;// Offset=0x78 Size=0x38
    struct _KDPC FaultDpc;// Offset=0xb0 Size=0x40
    struct _WORK_QUEUE_ITEM FaultWorkItem;// Offset=0xf0 Size=0x20
    unsigned char PasidFaultsSuppressed;// Offset=0x110 Size=0x1
    unsigned char PasidTaggedDmaEnabled;// Offset=0x111 Size=0x1
    unsigned char DefaultPasidEnabled;// Offset=0x112 Size=0x1
    struct _IOMMU_BUS_INTERFACE IommuInterface;// Offset=0x118 Size=0x50
    ...
    struct _EX_PUSH_LOCK InterfaceCallbackRecordLock;// Offset=0x1a0 Size=0x8
};
