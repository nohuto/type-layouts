...
struct _INBV_MODE_INFORMATION// Size=0x10 (Id=1762)
{
...
union _unnamed_1507// Size=0x8 (Id=1507)
{
...
struct _INBV_DISPLAY_CONTEXT// Size=0x28 (Id=1508)
{
    ...
    union _unnamed_1507 VideoMemory;// Offset=0x20 Size=0x8
};
