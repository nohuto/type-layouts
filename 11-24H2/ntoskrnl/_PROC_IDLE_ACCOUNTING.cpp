...
struct _PROC_IDLE_STATE_ACCOUNTING// Size=0x3f8 (Id=2367)
{
    unsigned long long TotalTime;// Offset=0x0 Size=0x8
    ...
    struct _PPM_SELECTION_STATISTICS SelectionStatistics;// Offset=0x28 Size=0x90
    struct _PROC_IDLE_STATE_BUCKET IdleTimeBuckets[26];// Offset=0xb8 Size=0x340
};

struct _PROC_IDLE_ACCOUNTING// Size=0x420 (Id=2062)
{
    ...
    struct _PROC_IDLE_STATE_ACCOUNTING State[1];// Offset=0x28 Size=0x3f8
};
