...
struct _unnamed_576// Size=0x58 (Id=576)
{
...
union _unnamed_577// Size=0x58 (Id=577)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_576 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=578)
{
    ...
    union _unnamed_577 Tail;// Offset=0x78 Size=0x58
};
