struct _PPM_SELECTION_STATISTICS// Size=0x90 (Id=2105)
{
    ...
    struct _PPM_VETO_ACCOUNTING * PreVetoAccounting;// Offset=0x88 Size=0x8
};

struct _PROC_IDLE_STATE_BUCKET// Size=0x20 (Id=2351)
{
...
struct _PLATFORM_IDLE_STATE_ACCOUNTING// Size=0x400 (Id=1920)
{
    ...
    unsigned long InvalidBucketIndex;// Offset=0x28 Size=0x4
    struct _PPM_SELECTION_STATISTICS SelectionStatistics;// Offset=0x30 Size=0x90
    struct _PROC_IDLE_STATE_BUCKET IdleTimeBuckets[26];// Offset=0xc0 Size=0x340
};

struct _PLATFORM_IDLE_ACCOUNTING// Size=0x428 (Id=1107)
{
    unsigned long ResetCount;// Offset=0x0 Size=0x4
    unsigned long StateCount;// Offset=0x4 Size=0x4
    unsigned long DeepSleepCount;// Offset=0x8 Size=0x4
    unsigned long long DripsWakeSkipCount;// Offset=0x10 Size=0x8
    enum PPM_IDLE_BUCKET_TIME_TYPE TimeUnit;// Offset=0x18 Size=0x4
    unsigned long long StartTime;// Offset=0x20 Size=0x8
    struct _PLATFORM_IDLE_STATE_ACCOUNTING State[1];// Offset=0x28 Size=0x400
};
