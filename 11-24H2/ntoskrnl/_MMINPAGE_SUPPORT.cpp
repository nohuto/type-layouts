...
struct _SLIST_ENTRY// Size=0x10 (Id=546)
{
...
union _unnamed_1540// Size=0x4 (Id=1540)
{
...
struct _MMINPAGE_SUPPORT_FLOW_THROUGH// Size=0x38 (Id=1998)
{
...
struct _MMINPAGE_SUPPORT// Size=0x1c0 (Id=1541)
{
    union // Size=0x10 (Id=0)
    {
    ...
    union _unnamed_1538 u2;// Offset=0x68 Size=0x30
    ...
    union _unnamed_1539 u3;// Offset=0xbc Size=0x4
    union _unnamed_1540 u1;// Offset=0xc0 Size=0x4
    union // Size=0x8 (Id=0)
    {
