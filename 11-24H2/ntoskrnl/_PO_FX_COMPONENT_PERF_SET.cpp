...
struct _PO_FX_COMPONENT_PERF_SET// Size=0x30 (Id=2498)
{
    ...
    {
        struct _unnamed_2496 Discrete;// Offset=0x20 Size=0x10
        struct _unnamed_2497 Range;// Offset=0x20 Size=0x10
    };
};
