struct _HANDLE_TABLE_ENTRY_INFO// Size=0x8 (Id=549)
{
    unsigned long AuditMask;// Offset=0x0 Size=0x4
    unsigned long MaxRelativeAccessMask;// Offset=0x4 Size=0x4
};

struct _OB_DUPLICATE_OBJECT_STATE// Size=0x28 (Id=2038)
{
...
struct _KALPC_HANDLE_DATA// Size=0x30 (Id=1000)
{
    unsigned long ObjectType;// Offset=0x0 Size=0x4
