...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=674)
{
...
struct _PCI_DEVICE_INFORMATION// Size=0x38 (Id=724)
{
...
struct _ACPI_DEVICE_INFORMATION// Size=0xf (Id=987)
{
...
union _KSE_XHCI_CONTROLLER_FLAGS// Size=0x10 (Id=421)
{
    ...
    struct // Size=0x10 (Id=0)
    {
        ...
        unsigned long long SplitTransactionHSIIWorkaround:1;// Offset=0x8 Size=0x8 BitOffset=0x14 BitSize=0x1
        unsigned long long UseRelaxedIdleTimeout:1;// Offset=0x8 Size=0x8 BitOffset=0x15 BitSize=0x1
        unsigned long long SupportsIntelIsTunneledFlag:1;// Offset=0x8 Size=0x8 BitOffset=0x16 BitSize=0x1
        unsigned long long SupportsAmdIsTunneledFlag:1;// Offset=0x8 Size=0x8 BitOffset=0x17 BitSize=0x1
        unsigned long long AttemptRestartOnClearPortStatusChangeFailure:1;// Offset=0x8 Size=0x8 BitOffset=0x18 BitSize=0x1
        unsigned long long Needs180msDelayPostHcReset:1;// Offset=0x8 Size=0x8 BitOffset=0x19 BitSize=0x1
        unsigned long long AllowSingleBDFDMAMode:1;// Offset=0x8 Size=0x8 BitOffset=0x1a BitSize=0x1
        unsigned long long MultiPageEventRingSegment:1;// Offset=0x8 Size=0x8 BitOffset=0x1b BitSize=0x1
        unsigned long long RequiresIsTunneledDsm:1;// Offset=0x8 Size=0x8 BitOffset=0x1c BitSize=0x1
        unsigned long long UpdateInputSlotContextSpeedField:1;// Offset=0x8 Size=0x8 BitOffset=0x1d BitSize=0x1
        unsigned long long RelaxRestoreTimeout:1;// Offset=0x8 Size=0x8 BitOffset=0x1e BitSize=0x1
    };
};
...
union _FRAME_SNAPSHOT// Size=0x8 (Id=909)
{
...
struct _FRAME_NUMBER_DATA// Size=0x10 (Id=658)
{
...
enum _S0IdleStatus
{
    ...
    S0IdleStatusNotConfiguredDueToRegKeyPresent=3
};

struct _CONTROLLER_COUNTER// Size=0x100 (Id=497)
{
...
struct _TIME_SYNC_DATA// Size=0xa8 (Id=506)
{
...
union _XHCI_TEST_MODE_FLAGS// Size=0x4 (Id=939)
{
...
struct _CONTROLLER_DATA// Size=0x5b0 (Id=502)
{
    ...
    wchar_t DeviceInstanceId[200];// Offset=0xf4 Size=0x190
    enum _UCX_CONTROLLER_PARENT_BUS_TYPE ParentBusType;// Offset=0x284 Size=0x4
    struct _PCI_DEVICE_INFORMATION PciDeviceInfo;// Offset=0x288 Size=0x38
    struct _ACPI_DEVICE_INFORMATION AcpiDeviceInfo;// Offset=0x2c0 Size=0xf
    unsigned char MSELengthUsable;// Offset=0x2cf Size=0x1
    unsigned char MajorVersion;// Offset=0x2d0 Size=0x1
    unsigned char MinorVersion;// Offset=0x2d1 Size=0x1
    unsigned long long FirmwareVersion;// Offset=0x2d8 Size=0x8
    union _KSE_XHCI_CONTROLLER_FLAGS DeviceFlags;// Offset=0x2e0 Size=0x10
    unsigned long long InternalDeviceFlags;// Offset=0x2f0 Size=0x8
    struct WDFTIMER__ * WatchdogTimer;// Offset=0x2f8 Size=0x8
    struct WDFWORKITEM__ * TelemetryReportWorkItem;// Offset=0x300 Size=0x8
    unsigned long long TelemetryHistory;// Offset=0x308 Size=0x8
    unsigned char ForwardProgressEnabled;// Offset=0x310 Size=0x1
    unsigned long SpecialFileStatus;// Offset=0x314 Size=0x4
    enum _WDF_POWER_DEVICE_STATE CurrentWdfPowerDeviceState;// Offset=0x318 Size=0x4
    unsigned char ControllerSaveStateFailed;// Offset=0x31c Size=0x1
    unsigned char ControllerGone;// Offset=0x31d Size=0x1
    unsigned long WatchdogTimerCount;// Offset=0x320 Size=0x4
    unsigned long ResetCount;// Offset=0x324 Size=0x4
    unsigned long NonTestingResetCount;// Offset=0x328 Size=0x4
    unsigned long ResetInterval;// Offset=0x32c Size=0x4
    long ResetLock;// Offset=0x330 Size=0x4
    enum _SYSTEM_POWER_ACTION PreProcessedSystemPowerAction;// Offset=0x334 Size=0x4
    void * HibernateContext;// Offset=0x338 Size=0x8
    struct _FRAME_NUMBER_DATA FrameNumberData;// Offset=0x340 Size=0x10
    unsigned long long HardwareVerifierFlags;// Offset=0x350 Size=0x8
    struct _XIL_BUFFER_DATA * ScratchTransferBufferData;// Offset=0x358 Size=0x8
    enum _S0IdleStatus ControllerS0IdleStatus;// Offset=0x360 Size=0x4
    unsigned char WaitWakeQueued;// Offset=0x364 Size=0x1
    struct _CONTROLLER_COUNTER Counter;// Offset=0x368 Size=0x100
    struct WDFWORKITEM__ * IdleTimeoutUpdateWorkItem;// Offset=0x468 Size=0x8
    unsigned long LastSetIdleTimeout;// Offset=0x470 Size=0x4
    struct POHANDLE__ * PoHandle;// Offset=0x478 Size=0x8
    void * LPEEnterExitCallbackHandle;// Offset=0x480 Size=0x8
    unsigned char WdfPowerReferenceForDebuggerAcquired;// Offset=0x488 Size=0x1
    unsigned char IsSecureDevice;// Offset=0x489 Size=0x1
    unsigned char EnableVTIOV3;// Offset=0x48a Size=0x1
    unsigned char EnableVelocityFor60129681;// Offset=0x48b Size=0x1
    unsigned char EnableVelocityFor60283441;// Offset=0x48c Size=0x1
    unsigned char EnableVelocityFor60982130_RetryStopEpOnSuccessWithStateNotStopped;// Offset=0x48d Size=0x1
    unsigned char EnableVelocityFor60982216_UpgradeIgnoreContextErrorOnEPStopAsDefaultBehavior;// Offset=0x48e Size=0x1
    unsigned char EnableVelocityFor60984843_DropStaleEventsWithEventDataSet;// Offset=0x48f Size=0x1
    unsigned char IgnoreContextErrorOnEPStopWasUpgraded;// Offset=0x490 Size=0x1
    unsigned long SuccessiveRestoreFailureCount;// Offset=0x494 Size=0x4
    unsigned char RelaxRestoreTimeoutWasUpgraded;// Offset=0x498 Size=0x1
    unsigned char IsExtendedTBCEnabled;// Offset=0x499 Size=0x1
    unsigned char IsExtendedTBCTRBStatusSupported;// Offset=0x49a Size=0x1
    enum _CONTROLLER_DMA_MODE DMAModeInVSM;// Offset=0x49c Size=0x4
    unsigned long NumberOfDMATargetsInVSM;// Offset=0x4a0 Size=0x4
    struct TRUSTLET_OBJECT_HANDLE__ * SecureObjectHandle;// Offset=0x4a8 Size=0x8
    struct _EPROCESS * TrustletProcess;// Offset=0x4b0 Size=0x8
    unsigned char IsDSMForPortStatusSupported;// Offset=0x4b8 Size=0x1
    unsigned char IsDSMForKBLWorkaroundsSupported;// Offset=0x4b9 Size=0x1
    enum _USBD_ENDPOINT_OFFLOAD_MODE UsbEndpointOffloadMode;// Offset=0x4bc Size=0x4
    unsigned long NumberOfEndpointsOffloaded;// Offset=0x4c0 Size=0x4
    void * EndpointsOffloadedCountLock;// Offset=0x4c8 Size=0x8
    long FullOrLowSpeedNonRHInterruptEpCount;// Offset=0x4d0 Size=0x4
    struct _TIME_SYNC_DATA TimeSyncData;// Offset=0x4d8 Size=0xa8
    struct WDFWORKITEM__ * AudioOffloadWnfStateUpdateWorkItem;// Offset=0x580 Size=0x8
    unsigned char IsAudioOffloadActive;// Offset=0x588 Size=0x1
    struct SS_COMPONENT__ * SleepstudySelectiveSuspendUnsupportedHandle;// Offset=0x590 Size=0x8
    unsigned long RecurringResetRecoveryFrequency;// Offset=0x598 Size=0x4
    unsigned long ImmediateResetRecoveryPending;// Offset=0x59c Size=0x4
    struct _XHCI_IRQL_TRACKER * IrqlTrackerArray;// Offset=0x5a0 Size=0x8
    unsigned long ActiveProcessorCount;// Offset=0x5a8 Size=0x4
    union _XHCI_TEST_MODE_FLAGS TestFlags;// Offset=0x5ac Size=0x4
};
