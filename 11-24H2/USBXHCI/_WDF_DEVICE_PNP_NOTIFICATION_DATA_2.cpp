...
struct _unnamed_689// Size=0x4 (Id=689)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_690// Size=0x8 (Id=690)
{
    struct _unnamed_688 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_689 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_688 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=691)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_690 Data;// Offset=0x4 Size=0x8
};
