...
{
    struct _unnamed_720 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_721 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_720 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=723)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_722 Data;// Offset=0x4 Size=0x8
};
