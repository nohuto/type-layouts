...
struct _unnamed_424// Size=0x2 (Id=424)
{
    unsigned char LowByte;// Offset=0x0 Size=0x1
    unsigned char HiByte;// Offset=0x1 Size=0x1
};

union _unnamed_425// Size=0x2 (Id=425)
{
    struct _unnamed_424 Bytes;// Offset=0x0 Size=0x2
    unsigned short Value;// Offset=0x0 Size=0x2
};

struct _unnamed_426// Size=0x8 (Id=426)
{
    union _unnamed_423 bm;// Offset=0x0 Size=0x1
    unsigned char bRequest;// Offset=0x1 Size=0x1
    union _unnamed_425 wValue;// Offset=0x2 Size=0x2
    union _unnamed_425 wIndex;// Offset=0x4 Size=0x2
    unsigned short wLength;// Offset=0x6 Size=0x2
};

struct _unnamed_427// Size=0x8 (Id=427)
{
    unsigned char Bytes[8];// Offset=0x0 Size=0x8
};

union _WDF_USB_CONTROL_SETUP_PACKET// Size=0x8 (Id=428)
{
    struct _unnamed_426 Packet;// Offset=0x0 Size=0x8
    struct _unnamed_427 Generic;// Offset=0x0 Size=0x8
};

struct _unnamed_822// Size=0x18 (Id=822)
{
    struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
...
struct _unnamed_823// Size=0x8 (Id=823)
{
    struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
};
...
union _unnamed_824// Size=0x18 (Id=824)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_821 DeviceString;// Offset=0x0 Size=0x10
        struct _unnamed_822 DeviceControlTransfer;// Offset=0x0 Size=0x18
        struct _unnamed_823 DeviceUrb;// Offset=0x0 Size=0x8
        struct _unnamed_325 PipeWrite;// Offset=0x0 Size=0x18
        struct _unnamed_325 PipeRead;// Offset=0x0 Size=0x18
        struct _unnamed_823 PipeUrb;// Offset=0x0 Size=0x8
    };
};

struct _WDF_USB_REQUEST_COMPLETION_PARAMS// Size=0x20 (Id=825)
{
    long UsbdStatus;// Offset=0x0 Size=0x4
    enum _WDF_USB_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    union _unnamed_824 Parameters;// Offset=0x8 Size=0x18
};
