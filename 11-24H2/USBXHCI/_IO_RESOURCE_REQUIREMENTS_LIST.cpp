...
struct _unnamed_292// Size=0x18 (Id=292)
{
...
struct _unnamed_298// Size=0x10 (Id=298)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_301// Size=0x18 (Id=301)
{
...
union _unnamed_304// Size=0x18 (Id=304)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_292 Port;// Offset=0x0 Size=0x18
        struct _unnamed_292 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_294 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_295 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_296 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_292 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_297 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_298 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_299 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_300 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_301 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_302 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_303 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=305)
{
    ...
    union _unnamed_304 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=1046)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=870)
{
