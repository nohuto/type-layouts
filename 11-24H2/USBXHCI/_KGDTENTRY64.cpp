struct _unnamed_827// Size=0x4 (Id=827)
{
...
union _KGDTENTRY64// Size=0x10 (Id=829)
{
    unsigned short LimitLow;// Offset=0x0 Size=0x2
    unsigned short BaseLow;// Offset=0x2 Size=0x2
    union // Size=0x4 (Id=0)
    {
        struct _unnamed_827 Bytes;// Offset=0x4 Size=0x4
        struct _unnamed_828 Bits;// Offset=0x4 Size=0x4
    };
