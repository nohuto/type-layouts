...
union _unnamed_332// Size=0x30 (Id=332)
{
    union // Size=0x30 (Id=0)
    {
        ...
        struct _unnamed_331 Usb;// Offset=0x0 Size=0x8
    };
};

struct _WDF_REQUEST_COMPLETION_PARAMS// Size=0x48 (Id=333)
{
    unsigned long Size;// Offset=0x0 Size=0x4
    enum _WDF_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    struct _IO_STATUS_BLOCK IoStatus;// Offset=0x8 Size=0x10
    union _unnamed_332 Parameters;// Offset=0x18 Size=0x30
};
