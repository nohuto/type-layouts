...
struct _KMUTANT// Size=0x38 (Id=1003)
{
...
struct _XHCI_TELEMETRY_DATA// Size=0x58 (Id=504)
{
    struct _LIST_ENTRY XhciTelemetryDataListHead;// Offset=0x0 Size=0x10
    unsigned long long XhciTelemetryDataListLock;// Offset=0x10 Size=0x8
    struct _KMUTANT XhciTelemetryMutex;// Offset=0x18 Size=0x38
    unsigned long RecoveryActions;// Offset=0x50 Size=0x4
    struct // Size=0x4 (Id=0)
    {
        unsigned long GontrollerGoneDumpGenerated:1;// Offset=0x54 Size=0x4 BitOffset=0x0 BitSize=0x1
        unsigned long ControllerGoneRecoveryActionProcessed:1;// Offset=0x54 Size=0x4 BitOffset=0x1 BitSize=0x1
        unsigned long ControllerGonePnpNotified:1;// Offset=0x54 Size=0x4 BitOffset=0x2 BitSize=0x1
    };
};
