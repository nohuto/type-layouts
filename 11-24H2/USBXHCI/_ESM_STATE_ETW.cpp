enum _ESM_STATE_ETW
{
    ...
    EsmStateEtwCheckingIfFasterRetriesOnStopEpFailuresSet1=123,
    EsmStateEtwCheckingIfFasterRetriesOnStopEpFailuresSet2=124,
    EsmStateEtwCheckingIfIgnoreContextErrorOnEPStopFlagIsSet=73,
    EsmStateEtwCheckingIfSetDequeuePointerReissueCountReached=126,
    ...
    EsmStateEtwResettingStopEndpointReissueCountOnSetDequeuePointerRetry=127,
    ...
    EsmStateEtwStoppingMappingAfterControllerResetInEnabled=122,
    ...
    EsmStateEtwWaitingForControllerResetCompletionInEnabled=121,
    ...
    EsmStateEtwWaitingToReissueStopEndpointCommand3=125
};
