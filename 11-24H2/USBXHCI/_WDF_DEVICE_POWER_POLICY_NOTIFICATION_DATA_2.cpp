...
struct _unnamed_677// Size=0x4 (Id=677)
{
    enum _WDF_DEVICE_POWER_POLICY_STATE CurrentState;// Offset=0x0 Size=0x4
};
...
{
    struct _unnamed_676 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_677 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_676 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=266)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_678 Data;// Offset=0x4 Size=0x8
};
