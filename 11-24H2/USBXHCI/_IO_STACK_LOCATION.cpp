...
struct _unnamed_99// Size=0x18 (Id=99)
{
...
struct _unnamed_102// Size=0x10 (Id=102)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_104// Size=0x18 (Id=104)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _unnamed_110// Size=0x18 (Id=110)
{
...
struct _unnamed_112// Size=0x10 (Id=112)
{
...
struct _unnamed_114// Size=0x18 (Id=114)
{
...
struct _unnamed_117// Size=0x8 (Id=117)
{
...
struct _unnamed_121// Size=0x8 (Id=121)
{
    struct _DEVICE_CAPABILITIES * Capabilities;// Offset=0x0 Size=0x8
};

struct _unnamed_122// Size=0x8 (Id=122)
{
...
struct _unnamed_124// Size=0x1 (Id=124)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _unnamed_126// Size=0x4 (Id=126)
{
...
struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=853)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=803)
{
...
union _unnamed_140// Size=0x20 (Id=140)
{
    struct _unnamed_96 Create;// Offset=0x0 Size=0x20
    struct _unnamed_97 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_98 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_99 Read;// Offset=0x0 Size=0x18
    struct _unnamed_99 Write;// Offset=0x0 Size=0x18
    struct _unnamed_101 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_102 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_104 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_105 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_106 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_108 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_109 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_110 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_111 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_112 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_113 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_114 MountVolume;// Offset=0x0 Size=0x18
    struct _unnamed_115 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_117 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_119 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_120 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_121 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_122 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_123 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_124 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_126 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_128 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_130 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_132 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_133 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_136 Power;// Offset=0x0 Size=0x20
    struct _unnamed_137 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_138 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_139 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=141)
{
    ...
    union _unnamed_140 Parameters;// Offset=0x8 Size=0x20
