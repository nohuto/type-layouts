union _unnamed_89// Size=0x8 (Id=89)
{
...
union _unnamed_92// Size=0x10 (Id=92)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_91 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=861)
{
...
struct _unnamed_93// Size=0x58 (Id=93)
{
...
union _unnamed_94// Size=0x58 (Id=94)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_93 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=95)
{
    ...
    union _unnamed_89 AssociatedIrp;// Offset=0x18 Size=0x8
