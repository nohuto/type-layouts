...
struct _EX_FAST_REF// Size=0x8 (Id=126)
{
    union // Size=0x8 (Id=0)
    {
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=516)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=545)
{
    union // Size=0x4 (Id=0)
    {
...
struct _MMSUPPORT_SHARED// Size=0x80 (Id=473)
{
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=137)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WNF_STATE_NAME// Size=0x8 (Id=627)
{
...
struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=344)
{
...
union _PROCESS_EXECUTION_TRANSITION// Size=0x2 (Id=436)
{
...
union _PROCESS_EXECUTION// Size=0x4 (Id=437)
{
...
struct _EPROCESS// Size=0x840 (Id=142)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_138 MitigationFlagsValues;// Offset=0x750 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x754 Size=0x4
        struct _unnamed_139 MitigationFlags2Values;// Offset=0x754 Size=0x4
    };
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_140 MitigationFlags3Values;// Offset=0x7d8 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_141 SyscallUsageValues;// Offset=0x7e0 Size=0x4
    };
