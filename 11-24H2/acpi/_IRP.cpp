union _unnamed_152// Size=0x8 (Id=152)
{
...
union _unnamed_155// Size=0x10 (Id=155)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_154 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=429)
{
...
struct _unnamed_156// Size=0x58 (Id=156)
{
...
union _unnamed_157// Size=0x58 (Id=157)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_156 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=158)
{
    ...
    union _unnamed_152 AssociatedIrp;// Offset=0x18 Size=0x8
