...
struct _unnamed_167// Size=0x18 (Id=167)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _unnamed_170// Size=0x20 (Id=170)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_171// Size=0x4 (Id=171)
{
    unsigned long Length;// Offset=0x0 Size=0x4
};
...
struct _unnamed_175// Size=0x18 (Id=175)
{
...
struct _unnamed_176// Size=0x20 (Id=176)
{
    unsigned long OutputBufferLength;// Offset=0x0 Size=0x4
    unsigned long InputBufferLength;// Offset=0x8 Size=0x4
...
struct _unnamed_178// Size=0x10 (Id=178)
{
    unsigned long SecurityInformation;// Offset=0x0 Size=0x4
    void * SecurityDescriptor;// Offset=0x8 Size=0x8
};

struct _unnamed_179// Size=0x18 (Id=179)
{
...
struct _unnamed_180// Size=0x10 (Id=180)
{
    struct _VPB * Vpb;// Offset=0x0 Size=0x8
    struct _DEVICE_OBJECT * DeviceObject;// Offset=0x8 Size=0x8
};
...
struct _unnamed_185// Size=0x4 (Id=185)
{
...
struct _unnamed_187// Size=0x8 (Id=187)
{
...
struct _unnamed_190// Size=0x1 (Id=190)
{
...
struct _unnamed_199// Size=0x8 (Id=199)
{
    struct _POWER_SEQUENCE * PowerSequence;// Offset=0x0 Size=0x8
};

struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=421)
{
    union // Size=0x4 (Id=0)
    {
...
struct _unnamed_203// Size=0x10 (Id=203)
{
...
struct _unnamed_204// Size=0x20 (Id=204)
{
...
struct _unnamed_205// Size=0x20 (Id=205)
{
...
union _unnamed_206// Size=0x20 (Id=206)
{
    struct _unnamed_159 Create;// Offset=0x0 Size=0x20
    struct _unnamed_160 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_161 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_162 Read;// Offset=0x0 Size=0x18
    struct _unnamed_162 Write;// Offset=0x0 Size=0x18
    struct _unnamed_164 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_165 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_167 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_168 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_169 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_170 QueryEa;// Offset=0x0 Size=0x20
    struct _unnamed_171 SetEa;// Offset=0x0 Size=0x4
    struct _unnamed_173 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_173 SetVolume;// Offset=0x0 Size=0x10
    struct _unnamed_174 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_175 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_176 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_177 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_178 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_179 MountVolume;// Offset=0x0 Size=0x18
    struct _unnamed_180 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_182 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_183 QueryQuota;// Offset=0x0 Size=0x20
    struct _unnamed_171 SetQuota;// Offset=0x0 Size=0x4
    struct _unnamed_185 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_186 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_187 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_188 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_189 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_190 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_192 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_194 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_196 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_198 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_199 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_202 Power;// Offset=0x0 Size=0x20
    struct _unnamed_203 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_204 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_205 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=207)
{
    ...
    union _unnamed_206 Parameters;// Offset=0x8 Size=0x20
