...
struct _TP_IO// Size=0x120 (Id=470)
{
    struct _TPP_CLEANUP_GROUP_MEMBER CleanupGroupMember;// Offset=0x0 Size=0xc8
    struct _TP_DIRECT Direct;// Offset=0xc8 Size=0x48
    void * File;// Offset=0x110 Size=0x8
    long PendingIrpCount;// Offset=0x118 Size=0x4
};
