...
struct _TP_TASK// Size=0x20 (Id=378)
{
...
struct _TP_WORK// Size=0xf0 (Id=355)
{
    struct _TPP_CLEANUP_GROUP_MEMBER CleanupGroupMember;// Offset=0x0 Size=0xc8
    struct _TP_TASK Task;// Offset=0xc8 Size=0x20
    union _TPP_WORK_STATE WorkState;// Offset=0xe8 Size=0x4
};

struct _TPP_PH_LINKS// Size=0x28 (Id=704)
{
...
struct _TP_TIMER// Size=0x168 (Id=356)
{
    struct _TP_WORK Work;// Offset=0x0 Size=0xf0
    struct _RTL_SRWLOCK Lock;// Offset=0xf0 Size=0x8
    union // Size=0x28 (Id=0)
    {
        struct _TPP_PH_LINKS WindowEndLinks;// Offset=0xf8 Size=0x28
        struct _LIST_ENTRY ExpirationLinks;// Offset=0xf8 Size=0x10
    };
    struct _TPP_PH_LINKS WindowStartLinks;// Offset=0x120 Size=0x28
    long long DueTime;// Offset=0x148 Size=0x8
    struct _TPP_ITE CancelIte;// Offset=0x150 Size=0x8
    unsigned long Window;// Offset=0x158 Size=0x4
    unsigned long Period;// Offset=0x15c Size=0x4
    unsigned char Inserted;// Offset=0x160 Size=0x1
    unsigned char WaitTimer;// Offset=0x161 Size=0x1
    union // Size=0x1 (Id=0)
    {
        unsigned char TimerStatus;// Offset=0x162 Size=0x1
        struct // Size=0x1 (Id=0)
        {
            unsigned char InQueue:1;// Offset=0x162 Size=0x1 BitOffset=0x0 BitSize=0x1
            unsigned char Absolute:1;// Offset=0x162 Size=0x1 BitOffset=0x1 BitSize=0x1
            unsigned char Cancelled:1;// Offset=0x162 Size=0x1 BitOffset=0x2 BitSize=0x1
        };
    };
    unsigned char BlockInsert;// Offset=0x163 Size=0x1
};
...
struct _TP_DIRECT// Size=0x48 (Id=685)
{
...
union _unnamed_515// Size=0x1 (Id=515)
{
...
struct _TP_WAIT// Size=0x1d8 (Id=516)
{
    struct _TP_TIMER Timer;// Offset=0x0 Size=0x168
    void * Handle;// Offset=0x168 Size=0x8
    void * WaitPkt;// Offset=0x170 Size=0x8
    void * NextWaitHandle;// Offset=0x178 Size=0x8
    union _LARGE_INTEGER NextWaitTimeout;// Offset=0x180 Size=0x8
    struct _TP_DIRECT Direct;// Offset=0x188 Size=0x48
    union _unnamed_515 WaitFlags;// Offset=0x1d0 Size=0x1
};
