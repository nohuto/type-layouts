union _unnamed_149// Size=0x8 (Id=149)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=108)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=567)
{
...
struct _unnamed_153// Size=0x58 (Id=153)
{
...
union _unnamed_154// Size=0x58 (Id=154)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_153 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=155)
{
    ...
    union _unnamed_149 AssociatedIrp;// Offset=0x18 Size=0x8
