...
struct _RTLP_PROCESS_HEAP_DESCRIPTOR// Size=0x30 (Id=672)
{
    struct _LIST_ENTRY DescriptorLink;// Offset=0x0 Size=0x10
    void * Heap;// Offset=0x10 Size=0x8
    union _unnamed_670 Flags;// Offset=0x18 Size=0x4
    struct _unnamed_671 PseudoGlobalLock;// Offset=0x20 Size=0x10
};
