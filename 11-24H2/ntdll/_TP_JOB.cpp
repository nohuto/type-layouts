...
struct _TP_JOB// Size=0x128 (Id=711)
{
    struct _TP_DIRECT Direct;// Offset=0x0 Size=0x48
    struct _TPP_CLEANUP_GROUP_MEMBER CleanupGroupMember;// Offset=0x48 Size=0xc8
    void * JobHandle;// Offset=0x110 Size=0x8
    union // Size=0x8 (Id=0)
    {
        long long CompletionState;// Offset=0x118 Size=0x8
        struct // Size=0x8 (Id=0)
        {
            long long Rundown:1;// Offset=0x118 Size=0x8 BitOffset=0x0 BitSize=0x1
            long long CompletionCount:63;// Offset=0x118 Size=0x8 BitOffset=0x1 BitSize=0x3f
        };
    };
    struct _RTL_SRWLOCK RundownLock;// Offset=0x120 Size=0x8
};
