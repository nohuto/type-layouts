...
struct _unnamed_903// Size=0x20 (Id=903)
{
...
struct _unnamed_904// Size=0x28 (Id=904)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=905)
{
    struct _unnamed_899 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_900 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_902 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _unnamed_903 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_904 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=882)
{
