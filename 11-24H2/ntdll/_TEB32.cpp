struct _NT_TIB32// Size=0x1c (Id=664)
{
...
struct _GDI_TEB_BATCH32// Size=0x4e0 (Id=453)
{
...
struct _GROUP_AFFINITY32// Size=0xc (Id=462)
{
...
struct _TEB32// Size=0x1038 (Id=344)
{
    ...
    unsigned long SystemReserved1[21];// Offset=0x10c Size=0x54
    ...
    unsigned long HeapWalkContext;// Offset=0x101c Size=0x4
    struct _GROUP_AFFINITY32 PrimaryGroupAffinity;// Offset=0x1020 Size=0xc
    unsigned long Rcu[2];// Offset=0x102c Size=0x8
};
