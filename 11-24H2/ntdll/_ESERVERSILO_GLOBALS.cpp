...
struct _OBP_SYSTEM_DOS_DEVICE_STATE// Size=0x6c (Id=868)
{
...
struct _OBJECT_NAMESPACE_LOOKUPTABLE// Size=0x260 (Id=907)
{
...
struct _OBP_SILODRIVERSTATE// Size=0x2e0 (Id=857)
{
...
struct _SEP_SILOSTATE// Size=0x30 (Id=750)
{
...
struct _SEP_RM_LSA_CONNECTION_STATE// Size=0x30 (Id=795)
{
...
struct _WNF_LOCK// Size=0x8 (Id=869)
{
    struct _EX_PUSH_LOCK PushLock;// Offset=0x0 Size=0x8
};

struct _WNF_SILODRIVERSTATE// Size=0x38 (Id=846)
{
...
struct _DBGK_SILOSTATE// Size=0x20 (Id=839)
{
...
struct _CRITICAL_PROCESS_EXCEPTION_DATA// Size=0x30 (Id=849)
{
...
struct _ESERVERSILO_GLOBALS// Size=0x598 (Id=741)
{
