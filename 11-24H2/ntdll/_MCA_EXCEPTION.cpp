...
struct _unnamed_872// Size=0x8 (Id=872)
{
...
union _MCI_STATS// Size=0x8 (Id=873)
{
    struct _unnamed_872 MciStatus;// Offset=0x0 Size=0x8
    unsigned long long QuadPart;// Offset=0x0 Size=0x8
};

union _MCI_ADDR// Size=0x8 (Id=862)
{
...
struct _unnamed_755// Size=0x20 (Id=755)
{
...
struct _unnamed_756// Size=0x10 (Id=756)
{
    unsigned long long Address;// Offset=0x0 Size=0x8
    unsigned long long Type;// Offset=0x8 Size=0x8
};

union _unnamed_757// Size=0x20 (Id=757)
{
    union // Size=0x20 (Id=0)
    {
        struct _unnamed_755 Mca;// Offset=0x0 Size=0x20
        struct _unnamed_756 Mce;// Offset=0x0 Size=0x10
    };
};

struct _MCA_EXCEPTION// Size=0x100 (Id=758)
{
    ...
    union _unnamed_757 u;// Offset=0x18 Size=0x20
