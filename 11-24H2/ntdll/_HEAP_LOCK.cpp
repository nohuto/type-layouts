struct _RTL_CRITICAL_SECTION// Size=0x28 (Id=273)
{
...
union _unnamed_274// Size=0x28 (Id=274)
{
    struct _RTL_CRITICAL_SECTION CriticalSection;// Offset=0x0 Size=0x28
};

struct _HEAP_LOCK// Size=0x28 (Id=275)
{
    union _unnamed_274 Lock;// Offset=0x0 Size=0x28
};
