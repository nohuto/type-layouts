...
struct _KAB_UM_PROCESS_CONTEXT// Size=0x10 (Id=405)
{
...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=450)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _KGROUP_MASK// Size=0x10 (Id=393)
{
...
struct _KPROCESS// Size=0x1c8 (Id=94)
{
    ...
    union _unnamed_92 SecureState;// Offset=0x170 Size=0x8
...
struct _EX_PUSH_LOCK// Size=0x8 (Id=114)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _EX_RUNDOWN_REF// Size=0x8 (Id=677)
{
    union // Size=0x8 (Id=0)
    {
...
struct _EX_FAST_REF// Size=0x8 (Id=122)
{
    union // Size=0x8 (Id=0)
    {
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=644)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=679)
{
    union // Size=0x4 (Id=0)
    {
...
struct _MMSUPPORT_INSTANCE// Size=0xc0 (Id=596)
{
...
struct _MMSUPPORT_SHARED// Size=0x80 (Id=613)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=509)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=134)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WNF_STATE_NAME// Size=0x8 (Id=742)
{
    unsigned long Data[2];// Offset=0x0 Size=0x8
};

struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=486)
{
    unsigned long HighEdgeFilter;// Offset=0x0 Size=0x4
    unsigned long LowEdgeFilter;// Offset=0x4 Size=0x4
};

struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=474)
{
...
struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=499)
{
...
struct _unnamed_138// Size=0x4 (Id=138)
{
    struct // Size=0x4 (Id=0)
    {
...
union _PROCESS_EXECUTION_TRANSITION// Size=0x2 (Id=772)
{
...
union _PROCESS_EXECUTION// Size=0x4 (Id=577)
{
...
struct _EPROCESS// Size=0x840 (Id=139)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_135 MitigationFlagsValues;// Offset=0x750 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x754 Size=0x4
        struct _unnamed_136 MitigationFlags2Values;// Offset=0x754 Size=0x4
    };
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_137 MitigationFlags3Values;// Offset=0x7d8 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_138 SyscallUsageValues;// Offset=0x7e0 Size=0x4
    };
