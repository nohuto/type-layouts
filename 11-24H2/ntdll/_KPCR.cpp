struct _NT_TIB// Size=0x38 (Id=603)
{
...
union _KPRCBFLAG// Size=0x4 (Id=525)
{
...
struct _KDESCRIPTOR// Size=0x10 (Id=843)
{
...
struct _KSPECIAL_REGISTERS// Size=0xf0 (Id=788)
{
...
union _KPRCB_BPB_FEATURES// Size=0x1 (Id=654)
{
...
union _KPRCB_BPB_RETPOLINE_STATE// Size=0x1 (Id=534)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _PP_LOOKASIDE_LIST// Size=0x10 (Id=115)
{
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=490)
{
...
struct _KSOFTWARE_INTERRUPT_BATCH// Size=0x210 (Id=502)
{
...
struct _KE_PRCB_RCU_DATA// Size=0x20 (Id=651)
{
...
struct _KTIMER_TABLE_ENTRY// Size=0x20 (Id=848)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=456)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KGATE// Size=0x18 (Id=519)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
};

struct _KDPC// Size=0x40 (Id=207)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KMCE_RECOVERY_CONTEXT// Size=0x10 (Id=524)
{
...
struct _PROC_IDLE_POLICY// Size=0x6 (Id=834)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=720)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=686)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=694)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=796)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROC_PERF_CHECK_CONTEXT// Size=0x48 (Id=717)
{
...
struct _PROCESSOR_POWER_STATE// Size=0x238 (Id=650)
{
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=552)
{
    unsigned char Level;// Offset=0x0 Size=0x1
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=706)
{
...
struct _KENTROPY_TIMING_STATE// Size=0x158 (Id=709)
{
...
struct _SYMCRYPT_ENTROPY_ACCUMULATOR_STATE// Size=0x180 (Id=548)
{
...
struct _IOP_IRP_STACK_PROFILER// Size=0x54 (Id=673)
{
    unsigned long Profile[20];// Offset=0x0 Size=0x50
    unsigned long TotalIrps;// Offset=0x50 Size=0x4
};

struct _KSECURE_FAULT_INFORMATION// Size=0x18 (Id=472)
{
...
struct _KTIMER_EXPIRATION_TRACE// Size=0x10 (Id=684)
{
...
struct _KCLOCK_TIMER_DEADLINE_ENTRY// Size=0x10 (Id=503)
{
...
struct _KCLOCK_TICK_TRACE// Size=0x28 (Id=442)
{
...
struct _KCLOCK_INCREMENT_TRACE// Size=0x20 (Id=722)
{
...
struct _KCLOCK_TIMER_STATE// Size=0x518 (Id=390)
{
...
struct _MACHINE_FRAME// Size=0x28 (Id=833)
{
...
struct _MACHINE_CHECK_CONTEXT// Size=0x50 (Id=626)
{
...
union _KCCB_SHADOW_PROCESSOR_STATE// Size=0x1 (Id=662)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _KCORE_CONTROL_BLOCK_SHADOW// Size=0x40 (Id=592)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _KPRCB// Size=0xcf00 (Id=64)
{
    ...
    struct _unnamed_61 StibpPairingTrace;// Offset=0x9138 Size=0x38
