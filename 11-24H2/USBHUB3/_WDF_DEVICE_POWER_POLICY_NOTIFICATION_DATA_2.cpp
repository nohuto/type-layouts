...
struct _unnamed_528// Size=0x4 (Id=528)
{
    enum _WDF_DEVICE_POWER_POLICY_STATE CurrentState;// Offset=0x0 Size=0x4
};
...
{
    struct _unnamed_527 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_528 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_527 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=207)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_529 Data;// Offset=0x4 Size=0x8
};
