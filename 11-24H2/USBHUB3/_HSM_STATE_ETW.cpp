enum _HSM_STATE_ETW
{
    ...
    HsmStateEtwGetFirmwareUpdateId=2152,
    ...
    HsmStateEtwCheckingIfAllUsb4DromDataRead=2153,
    HsmStateEtwCheckingIfUsb4DromShouldBeRead=2154,
    HsmStateEtwDeinitializingUsb4Drom=2155,
    HsmStateEtwGettingLastOpcode=2169,
    HsmStateEtwGettingUsb4DromBlock=2156,
    HsmStateEtwGettingUsb4DromHeader=2157,
    HsmStateEtwInitializingUsb4Drom=2158,
    HsmStateEtwLoggingLastOpcode=2170,
    HsmStateEtwReturningOperationSuccessInGettingFirmwareUpdateId=2159,
    HsmStateEtwCheckingUsb4DromStatus=2160,
    HsmStateEtwIncrementingAndCheckingMailboxDataIndex=2161,
    HsmStateEtwInitializingUsb4DromStatusRead=2162,
    HsmStateEtwReadingUsb4DromDwordOffset=2163,
    HsmStateEtwReadingUsb4DromStatus=2164,
    HsmStateEtwReturningOperationFailureInReadUsb4DRom=2165,
    HsmStateEtwReturningOperationSuccessInReadUsb4Drom=2166,
    HsmStateEtwWritingUsb4DromMetaData=2167,
    HsmStateEtwWritingUsb4DromReadOpcode=2168
};
