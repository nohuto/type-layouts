...
struct _unnamed_538// Size=0x4 (Id=538)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_539// Size=0x8 (Id=539)
{
    struct _unnamed_537 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_538 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_537 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=540)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_539 Data;// Offset=0x4 Size=0x8
};
