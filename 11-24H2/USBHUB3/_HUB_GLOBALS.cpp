union _HUB_GLOBAL_FLAGS// Size=0x4 (Id=588)
{
    ...
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long EnableUsbLtm:1;// Offset=0x0 Size=0x4 BitOffset=0x12 BitSize=0x1
    };
};
...
struct _HUB_GLOBALS// Size=0x70 (Id=417)
{
    ...
    struct SS_LIBRARY__ * SleepStudyLibraryHandle;// Offset=0x60 Size=0x8
    unsigned short AcpiVersion;// Offset=0x68 Size=0x2
};
