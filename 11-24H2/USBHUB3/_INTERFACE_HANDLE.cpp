...
union _INTERFACE_FLAGS// Size=0x4 (Id=576)
{
...
union _ENDPOINT_FLAGS// Size=0x4 (Id=713)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _PIPE_HANDLE// Size=0x50 (Id=426)
{
    ...
    struct _EUSB2_ISOCH_ENDPOINT_COMPANION_DESCRIPTOR * HSeUsb2IsochEndpointCompanionDescriptor;// Offset=0x40 Size=0x8
    enum _UCX_ENDPOINT_CHARACTERISTIC_PRIORITY Priority;// Offset=0x48 Size=0x4
};

struct _INTERFACE_HANDLE// Size=0x78 (Id=424)
{
    ...
    struct _PIPE_HANDLE PipeHandle[1];// Offset=0x28 Size=0x50
};
