...
struct _USBD_PIPE_INFORMATION// Size=0x18 (Id=872)
{
...
struct _USBD_INTERFACE_INFORMATION// Size=0x30 (Id=746)
{
    unsigned short Length;// Offset=0x0 Size=0x2
...
struct _URB_SELECT_INTERFACE// Size=0x50 (Id=635)
{
...
struct _URB_SELECT_CONFIGURATION// Size=0x58 (Id=609)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
...
struct _URB_FRAME_LENGTH_CONTROL// Size=0x18 (Id=720)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
};

struct _URB_GET_FRAME_LENGTH// Size=0x20 (Id=809)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
...
struct _URB_SET_FRAME_LENGTH// Size=0x20 (Id=507)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    long FrameLengthDelta;// Offset=0x18 Size=0x4
};

struct _URB_GET_CURRENT_FRAME_NUMBER// Size=0x20 (Id=495)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
...
struct _URB_CONTROL_TRANSFER// Size=0x88 (Id=740)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
...
struct _USBD_ISO_PACKET_DESCRIPTOR// Size=0xc (Id=787)
{
...
struct _URB_ISOCH_TRANSFER// Size=0x98 (Id=863)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _URB_CONTROL_DESCRIPTOR_REQUEST// Size=0x88 (Id=660)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
...
struct _URB_CONTROL_GET_STATUS_REQUEST// Size=0x88 (Id=708)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long Reserved0;// Offset=0x20 Size=0x4
...
struct _URB_CONTROL_VENDOR_OR_CLASS_REQUEST// Size=0x88 (Id=479)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _URB_CONTROL_GET_INTERFACE_REQUEST// Size=0x88 (Id=805)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long Reserved0;// Offset=0x20 Size=0x4
...
struct _URB_CONTROL_GET_CONFIGURATION_REQUEST// Size=0x88 (Id=836)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * Reserved;// Offset=0x18 Size=0x8
    unsigned long Reserved0;// Offset=0x20 Size=0x4
...
struct _URB_OPEN_STATIC_STREAMS// Size=0x30 (Id=648)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
...
struct _URB_SECURE_BULK_OR_INTERRUPT_TRANSFER// Size=0x80 (Id=747)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _URB_SECURE_ISOCH_TRANSFER// Size=0x98 (Id=703)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _URB_SELECT_INTERFACE_WITH_ENDPOINT_OFFLOAD// Size=0x60 (Id=829)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * ConfigurationHandle;// Offset=0x18 Size=0x8
...
struct _URB_ASYNC_NOTIFICATION_REQUEST_DURING_ENDPOINT_OFFLOAD// Size=0x28 (Id=854)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
...
struct _URB_GET_ISOCH_PIPE_TRANSFER_PATH_DELAYS// Size=0x28 (Id=520)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
