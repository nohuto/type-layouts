union _unnamed_626// Size=0x4 (Id=626)
{
...
struct _USB_DEVICE_CAPABILITY_USB20_EXTENSION_DESCRIPTOR// Size=0x7 (Id=627)
{
    ...
    union _unnamed_626 bmAttributes;// Offset=0x3 Size=0x4
};
