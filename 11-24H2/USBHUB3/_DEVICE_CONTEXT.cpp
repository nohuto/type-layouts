...
struct _USBDEVICE_INFO// Size=0x20 (Id=690)
{
...
union _DEVICE_MUX_FLAGS// Size=0x4 (Id=769)
{
...
struct _DSM_MUX_CONTEXT// Size=0x38 (Id=515)
{
...
struct _URB_CONTROL_TRANSFER_EX// Size=0x88 (Id=504)
{
...
struct _URB_PIPE_REQUEST// Size=0x28 (Id=832)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
...
struct _CONTROL_REQUEST// Size=0xa8 (Id=557)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=611)
{
    union // Size=0x4 (Id=0)
    {
...
struct _STATE_LOG// Size=0xc (Id=624)
{
...
struct _EVENT_QUEUE// Size=0x44 (Id=691)
{
...
struct _SM_CONTEXT// Size=0x420 (Id=502)
{
...
union _USB_DEVICE_PROPERTIES// Size=0x4 (Id=550)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_DEVICE_STATE_FLAGS// Size=0x4 (Id=833)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long DeviceDisableNeeded:1;// Offset=0x0 Size=0x4 BitOffset=0x14 BitSize=0x1
    };
};

union _USB_DEVICE_SQM_PROPERTIES// Size=0x4 (Id=680)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_DEVICE_HACKS// Size=0x4 (Id=744)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long ResetOnErrorInD2Resume:1;// Offset=0x0 Size=0x4 BitOffset=0x1b BitSize=0x1
    };
};

struct _USB_HUB_DEVICE_UXD_SETTINGS// Size=0x44 (Id=560)
{
...
struct _USB_DEVICE_DESCRIPTOR// Size=0x12 (Id=637)
{
...
struct _USB_DEVICE_QUALIFIER_DESCRIPTOR// Size=0xa (Id=629)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
    unsigned short bcdUSB;// Offset=0x2 Size=0x2
...
struct _OS_STRING// Size=0x12 (Id=562)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
...
struct _USB_ID_STRING// Size=0x10 (Id=795)
{
...
struct _USB_SEL_INFO// Size=0x6 (Id=519)
{
...
union _DEVICE_LPM_STATE_FLAGS// Size=0x4 (Id=639)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _LPM_POLICY// Size=0x4 (Id=656)
{
    union // Size=0x4 (Id=0)
    {
        unsigned long AsUlong32;// Offset=0x0 Size=0x4
...
struct _DEVICE_20_LPM_ATTRIBUTES// Size=0x4 (Id=603)
{
    struct // Size=0x4 (Id=0)
    {
...
union _MSOS20_FLAGS// Size=0x4 (Id=716)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _MSOS20_ALT_ENUM_FLAGS// Size=0x4 (Id=861)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _MSOS20_DESCRIPTOR_SET_INFO// Size=0x8 (Id=632)
{
...
struct _MSOS20_INFO// Size=0x68 (Id=661)
{
...
struct _unnamed_401// Size=0x4 (Id=401)
{
    struct // Size=0x4 (Id=0)
    {
...
union _USB_DUAL_ROLE_FEATURES// Size=0x4 (Id=402)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct _unnamed_401 features;// Offset=0x0 Size=0x4
};

enum _USB_USB4_TUNNEL_STATE
{
    Usb4TunnelUndefined=0,
    Usb4TunnelIncapable=1,
    Usb4TunnelCapable_Tunneled=2,
    Usb4TunnelCapable_Native=3,
    Usb4TunnelCapable_Unknown=4
};

struct _DEVICE_CONTEXT// Size=0xab0 (Id=408)
{
    ...
    struct _USBDEVICE_INFO UsbDeviceInfo;// Offset=0xa8 Size=0x20
    struct _DSM_MUX_CONTEXT MuxContext;// Offset=0xc8 Size=0x38
    struct _CONTROL_REQUEST ControlRequest;// Offset=0x100 Size=0xa8
    struct WDFREQUEST__ * UcxRequest;// Offset=0x1a8 Size=0x8
    struct _IRP * UcxRequestIrp;// Offset=0x1b0 Size=0x8
    struct WDFMEMORY__ * UcxIoctlRequestMemory;// Offset=0x1b8 Size=0x8
    unsigned long UcxIoctl;// Offset=0x1c0 Size=0x4
    struct WDFTIMER__ * BootResetTimer;// Offset=0x1c8 Size=0x8
    struct WDFREQUEST__ * CurrentClientRequest;// Offset=0x1d0 Size=0x8
    struct WDFREQUEST__ * CurrentFdoRequest;// Offset=0x1d8 Size=0x8
    struct _KEVENT QueryDeviceTextEvent;// Offset=0x1e0 Size=0x18
    struct WDFREQUEST__ * PreformattedGetDescriptorRequest;// Offset=0x1f8 Size=0x8
    struct _SM_CONTEXT DsmContext;// Offset=0x200 Size=0x420
    long LastOperationNtStatus;// Offset=0x620 Size=0x4
    long LastOperationUsbdStatus;// Offset=0x624 Size=0x4
    struct WDFDEVICE_INIT * PdoDeviceInit;// Offset=0x628 Size=0x8
    long PnPPowerStatus;// Offset=0x630 Size=0x4
    struct _KEVENT PnPPowerEvent;// Offset=0x638 Size=0x18
    struct _KEVENT PreStartEvent;// Offset=0x650 Size=0x18
    union _USB_DEVICE_PROPERTIES DeviceFlags;// Offset=0x668 Size=0x4
    union _USB_DEVICE_STATE_FLAGS DeviceStateFlags;// Offset=0x66c Size=0x4
    union _USB_DEVICE_SQM_PROPERTIES DeviceSqmFlags;// Offset=0x670 Size=0x4
    union _USB_DEVICE_HACKS DeviceHackFlags;// Offset=0x674 Size=0x4
    unsigned long DeviceAddress;// Offset=0x678 Size=0x4
    struct _PIPE_HANDLE * CurrentTargetPipe;// Offset=0x680 Size=0x8
    struct _USB_HUB_DEVICE_UXD_SETTINGS UxdSettings;// Offset=0x688 Size=0x44
    unsigned char ScratchBuffer[256];// Offset=0x6cc Size=0x100
    struct _USB_DEVICE_DESCRIPTOR DeviceDescriptor;// Offset=0x7cc Size=0x12
    struct _USB_INTERFACE_DESCRIPTOR * CompatIdInterfaceDescriptor;// Offset=0x7e0 Size=0x8
    struct _USB_CONFIGURATION_DESCRIPTOR * ConfigurationDescriptor;// Offset=0x7e8 Size=0x8
    struct _USB_STRING_DESCRIPTOR * LanguageIdDescriptor;// Offset=0x7f0 Size=0x8
    struct _USB_STRING_DESCRIPTOR * ProductIdStringDescriptor;// Offset=0x7f8 Size=0x8
    unsigned short CurrentLanguageId;// Offset=0x800 Size=0x2
    struct _USB_DEVICE_QUALIFIER_DESCRIPTOR DeviceQualifierDescriptor;// Offset=0x802 Size=0xa
    unsigned char MsOsVendorCode;// Offset=0x80c Size=0x1
    struct _USB_BOS_DESCRIPTOR * BOSDescriptor;// Offset=0x810 Size=0x8
    struct _GUID ContainerId;// Offset=0x818 Size=0x10
    struct _OS_STRING MsOsDescriptor;// Offset=0x828 Size=0x12
    struct _MS_EXT_CONFIG_DESC * MsExtConfigDesc;// Offset=0x840 Size=0x8
    struct _MS_EXT_PROP_DESC * MsExtPropertyDesc;// Offset=0x848 Size=0x8
    struct _UNICODE_STRING UxdId;// Offset=0x850 Size=0x10
    struct WDFSTRING__ * SymbolicLinkName;// Offset=0x860 Size=0x8
    struct _USB_ID_STRING SerialNumberId;// Offset=0x868 Size=0x10
    struct _USB_ID_STRING FriendlyNameIdString;// Offset=0x878 Size=0x10
    struct _GUID WdfActivityId;// Offset=0x888 Size=0x10
    unsigned short U1ExitLatency;// Offset=0x898 Size=0x2
    unsigned short U2ExitLatency;// Offset=0x89a Size=0x2
    struct _USB_SEL_INFO UsbSelInfo;// Offset=0x89c Size=0x6
    unsigned short HostInitiatedU1ExitLatency;// Offset=0x8a2 Size=0x2
    unsigned short HostInitiatedU2ExitLatency;// Offset=0x8a4 Size=0x2
    unsigned char LatencyAdjustmentPercentForNoPingError;// Offset=0x8a6 Size=0x1
    unsigned short EffectiveExitLatency;// Offset=0x8a8 Size=0x2
    unsigned short TargetEffectiveExitLatency;// Offset=0x8aa Size=0x2
    unsigned char U1Timeout;// Offset=0x8ac Size=0x1
    unsigned char U2Timeout;// Offset=0x8ad Size=0x1
    unsigned char TargetU1Timeout;// Offset=0x8ae Size=0x1
    unsigned char TargetU2Timeout;// Offset=0x8af Size=0x1
    union _DEVICE_LPM_STATE_FLAGS LPMStateFlags;// Offset=0x8b0 Size=0x4
    union _LPM_POLICY LpmPolicy;// Offset=0x8b4 Size=0x4
    enum _USB_20_LPM_STATUS Usb20LpmStatus;// Offset=0x8b8 Size=0x4
    void * BootDeviceHandle;// Offset=0x8c0 Size=0x8
    long BootDeviceReportedMissing;// Offset=0x8c8 Size=0x4
    struct _CONTROL_REQUEST ControlRequestForBootDevice;// Offset=0x8d0 Size=0xa8
    struct WDFTIMER__ * OutOfBandwidthTimer;// Offset=0x978 Size=0x8
    union _LARGE_INTEGER LastResetTimeStamp;// Offset=0x980 Size=0x8
    unsigned long EnumMsgId;// Offset=0x988 Size=0x4
    unsigned long HardwareVerifierFlags;// Offset=0x98c Size=0x4
    struct _DEVICE_20_LPM_ATTRIBUTES Lpm20Attributes;// Offset=0x990 Size=0x4
    struct _ALTERNATE_SETTING_FILTER * AlternateSettingFilter;// Offset=0x998 Size=0x8
    unsigned char DuplicateSerialNumberRetryCount;// Offset=0x9a0 Size=0x1
    enum _DEVICE_POWER_STATE DevicePowerState;// Offset=0x9a4 Size=0x4
    struct _MSOS20_INFO MsOs20Info;// Offset=0x9a8 Size=0x68
    union _USB_DEVICE_CAPABILITY_SUPERSPEEDPLUS_SPEED * SublinkSpeedAttr;// Offset=0xa10 Size=0x8
    unsigned long SublinkSpeedAttrCount;// Offset=0xa18 Size=0x4
    unsigned short RxTpDelay;// Offset=0xa1c Size=0x2
    unsigned short TxTpDelay;// Offset=0xa1e Size=0x2
    unsigned long MaxExitLatencyBasedOnEld;// Offset=0xa20 Size=0x4
    struct _RTL_BITMAP DescriptorValidationBitmapHeader;// Offset=0xa28 Size=0x10
    unsigned long DescriptorValidationBitmap[9];// Offset=0xa38 Size=0x24
    struct _BILLBOARD_INFO * BillboardInfo;// Offset=0xa60 Size=0x8
    struct WDFSTRING__ * BillboardSymbolicName;// Offset=0xa68 Size=0x8
    unsigned char BillboardDeviceInterfaceCreated;// Offset=0xa70 Size=0x1
    union _USB_DUAL_ROLE_FEATURES UsbDualRoleLocalFeatures;// Offset=0xa71 Size=0x4
    union _USB_DUAL_ROLE_FEATURES UsbDualRolePartnerFeatures;// Offset=0xa75 Size=0x4
    unsigned char DualRoleVendorCommand;// Offset=0xa79 Size=0x1
    long ClientInitiatedRecoveryEvents[5];// Offset=0xa7c Size=0x14
    struct _ENDPOINT_PRIORITY_ENTRY * EndpointPriorities;// Offset=0xa90 Size=0x8
    unsigned long EndpointPriorityCount;// Offset=0xa98 Size=0x4
    enum _DEVICE_POWER_STATE LastDeviceDxPowerState;// Offset=0xa9c Size=0x4
    unsigned char GetFirmwareImageHashSupport;// Offset=0xaa0 Size=0x1
    unsigned char DisallowFirmwareUpdateSupport;// Offset=0xaa1 Size=0x1
    long GetFirmwareHashNtStatus;// Offset=0xaa4 Size=0x4
    long GetFirmwareHashUsbdStatus;// Offset=0xaa8 Size=0x4
    enum _USB_USB4_TUNNEL_STATE Usb4TunnelState;// Offset=0xaac Size=0x4
};
