union _unnamed_692// Size=0x2 (Id=692)
{
...
struct _USB_DEVICE_CAPABILITY_PD_CONSUMER_PORT_DESCRIPTOR// Size=0x18 (Id=693)
{
    ...
    union _unnamed_692 bmCapabilities;// Offset=0x4 Size=0x2
