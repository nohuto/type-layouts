union _unnamed_662// Size=0x2 (Id=662)
{
...
struct _unnamed_663// Size=0x4 (Id=663)
{
...
struct _USB_DEVICE_CAPABILITY_BILLBOARD_DESCRIPTOR// Size=0x30 (Id=664)
{
    ...
    union _unnamed_662 VconnPower;// Offset=0x6 Size=0x2
    unsigned char bmConfigured[32];// Offset=0x8 Size=0x20
    unsigned long bReserved;// Offset=0x28 Size=0x4
    struct _unnamed_663 AlternateMode[1];// Offset=0x2c Size=0x4
};
