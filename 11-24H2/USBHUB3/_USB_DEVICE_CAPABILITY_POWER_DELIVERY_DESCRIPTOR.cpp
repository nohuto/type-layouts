union _unnamed_812// Size=0x4 (Id=812)
{
...
struct _USB_DEVICE_CAPABILITY_POWER_DELIVERY_DESCRIPTOR// Size=0x12 (Id=813)
{
    ...
    union _unnamed_812 bmAttributes;// Offset=0x4 Size=0x4
