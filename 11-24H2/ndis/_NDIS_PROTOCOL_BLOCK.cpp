...
struct _NDIS_CO_CLIENT_OPTIONAL_HANDLERS// Size=0xa0 (Id=540)
{
...
struct _NDIS_PROTOCOL_BLOCK// Size=0x380 (Id=537)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    ...
    void  ( * DirectOidRequestCompleteHandler)(void * ,struct _NDIS_OID_REQUEST * ,int );// Offset=0x308 Size=0x8
    int  ( * AllocateSharedMemoryHandler)(void * ,struct _NDIS_SHARED_MEMORY_PARAMETERS * ,void ** );// Offset=0x310 Size=0x8
    void  ( * FreeSharedMemoryHandler)(void * ,void * );// Offset=0x318 Size=0x8
    void * AllocateSharedMemoryContext;// Offset=0x320 Size=0x8
    struct _UNICODE_STRING ImageName;// Offset=0x328 Size=0x10
    class KRef<NDIS_BIND_PROTOCOL_DRIVER> Bind;// Offset=0x338 Size=0x8
    class KCoalescingWorkItem<_NDIS_PROTOCOL_BLOCK> NotifyBindCompleteWorkItem;// Offset=0x340 Size=0x38
    class wistd::unique_ptr<TriageData,KFreePoolNP<TriageData> > Triage;// Offset=0x378 Size=0x8
