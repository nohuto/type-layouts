struct _NDIS_PM_PACKET_PATTERN// Size=0x18 (Id=972)
{
...
struct _NDIS_PM_COUNTED_STRING// Size=0x84 (Id=2141)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    wchar_t String[65];// Offset=0x2 Size=0x82
};

struct _NDIS_PM_WOL_PATTERN// Size=0xc4 (Id=1784)
{
    union // Size=0x9c (Id=0)
    {
        ...
        union _WOL_PATTERN// Size=0x28 (Id=10462)
        {
            struct _IPV4_TCP_SYN_WOL_PACKET_PARAMETERS// Size=0x10 (Id=10463)
            {
            ...
            struct _IPV6_TCP_SYN_WOL_PACKET_PARAMETERS// Size=0x28 (Id=10470)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
            ...
            struct _EAPOL_REQUEST_ID_MESSAGE_WOL_PACKET_PARAMETERS// Size=0x4 (Id=10477)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
            };
            ...
            struct _WOL_BITMAP_PATTERN// Size=0x14 (Id=10480)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
...
struct _NDIS_PM_PROTOCOL_OFFLOAD// Size=0x100 (Id=1575)
{
    union // Size=0x9c (Id=0)
    {
        struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
        ...
        union _PROTOCOL_OFFLOAD_PARAMETERS// Size=0x60 (Id=10392)
        {
            struct _IPV4_ARP_PARAMETERS// Size=0x14 (Id=10393)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
            ...
            struct _IPV6_NS_PARAMETERS// Size=0x4c (Id=10400)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
            ...
            struct _DOT11_RSN_REKEY_PARAMETERS// Size=0x30 (Id=10408)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
            ...
            struct _DOT11_RSN_REKEY_PARAMETERS_V2// Size=0x60 (Id=10414)
            {
                unsigned long Flags;// Offset=0x0 Size=0x4
...
union _NDIS_PACKET_PATTERN_ENTRY::_unnamed_1981// Size=0x100 (Id=1981)
{
