...
struct _NDIS_ENCAPSULATION_FORMAT// Size=0xc (Id=1182)
{
    union // Size=0x4 (Id=0)
    {
        enum _NDIS_ENCAPSULATION Encapsulation;// Offset=0x0 Size=0x4
        struct <unnamed-type-Flags>// Size=0x4 (Id=6788)
        {
...
struct _NDIS_TASK_OFFLOAD_HEADER// Size=0x1c (Id=1709)
{
    unsigned long Version;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
    unsigned long Reserved;// Offset=0x8 Size=0x4
    unsigned long OffsetFirstTask;// Offset=0xc Size=0x4
    struct _NDIS_ENCAPSULATION_FORMAT EncapsulationFormat;// Offset=0x10 Size=0xc
};
