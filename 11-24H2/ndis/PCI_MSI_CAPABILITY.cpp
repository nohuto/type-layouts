struct _PCI_CAPABILITIES_HEADER// Size=0x2 (Id=1132)
{
    unsigned char CapabilityID;// Offset=0x0 Size=0x1
    unsigned char Next;// Offset=0x1 Size=0x1
};

union _PCI_MSI_MESSAGE_CONTROL// Size=0x2 (Id=1109)
{
...
struct PCI_MSI_CAPABILITY// Size=0x18 (Id=610)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-MessageAddressLower>// Size=0x4 (Id=17607)
        {
            struct _PCI_MSI_MESSAGE_ADDRESS// Size=0x4 (Id=17608)
            {
    ...
    union // Size=0xc (Id=0)
    {
        struct PCI_MSI_CAPABILITY::_unnamed_1566::<unnamed-type-Option32Bit> Option32Bit;// Offset=0x8 Size=0xc
        struct PCI_MSI_CAPABILITY::_unnamed_1567::<unnamed-type-Option64Bit> Option64Bit;// Offset=0x8 Size=0x10
    };
};
