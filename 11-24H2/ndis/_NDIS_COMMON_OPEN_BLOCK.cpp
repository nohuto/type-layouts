...
struct _NDIS_SPIN_LOCK// Size=0x10 (Id=165)
{
...
struct _NDIS_COMMON_OPEN_BLOCK// Size=0x408 (Id=561)
{
    union // Size=0x150 (Id=0)
    {
        ...
        struct _QUEUED_CLOSE// Size=0x28 (Id=6583)
        {
            int Status;// Offset=0x0 Size=0x4
            struct _WORK_QUEUE_ITEM WorkItem;// Offset=0x8 Size=0x20
        };
        struct _NDIS_COMMON_OPEN_BLOCK::_QUEUED_CLOSE QC;// Offset=0x150 Size=0x28
    };
    ...
    enum NDIS_NDIS5_DRIVER_STATE PnPState;// Offset=0x280 Size=0x4
    ...
    struct _PKTMON_COMPONENT_CONTEXT PktMonComp;// Offset=0x398 Size=0x40
    struct _PKTMON_EDGE_CONTEXT PktMonEdge;// Offset=0x3d8 Size=0x28
    class TriageData * Triage;// Offset=0x400 Size=0x8
};
