...
struct _NDIS_WDF_CX_CHARACTERISTICS// Size=0x80 (Id=241)
{
    ...
    void  ( * EvtCxReportStuckOperation)(void * ,enum _NDIS_CX_STUCK_OPERATION_TYPE ,unsigned long long );// Offset=0x78 Size=0x8
};
...
struct _NDIS_WDF_CX_DRIVER_BLOCK// Size=0xa8 (Id=1097)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    ...
    struct _NDIS_WDF_CX_CHARACTERISTICS Chars;// Offset=0x20 Size=0x80
    unsigned long ClientCount;// Offset=0xa0 Size=0x4
    enum _NDIS_WDF_CX_DRIVER_STATE State;// Offset=0xa4 Size=0x1
};
