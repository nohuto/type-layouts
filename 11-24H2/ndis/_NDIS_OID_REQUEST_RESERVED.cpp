...
struct _NDIS_OID_REQUEST_RESERVED// Size=0x70 (Id=369)
{
    ...
    union // Size=0x48 (Id=0)
    {
        ...
        struct _NDIS_OID_REQUEST_RESERVED::_unnamed_1244::<unnamed-type-CoNdis> CoNdis;// Offset=0x28 Size=0x20
    };
    union // Size=0x60 (Id=0)
    {
        ...
        struct _NDIS_OID_REQUEST_RESERVED::_unnamed_1249::<unnamed-type-IovContext> IovContext;// Offset=0x48 Size=0x10
        struct _NDIS_OID_REQUEST_RESERVED::_unnamed_1250::<unnamed-type-PMContext> PMContext;// Offset=0x48 Size=0x18
        struct _NDIS_OID_REQUEST_RESERVED::_unnamed_1251::<unnamed-type-OffloadParamsContext> OffloadParamsContext;// Offset=0x48 Size=0x1
