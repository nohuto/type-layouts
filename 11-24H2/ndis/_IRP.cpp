...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=92)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=1214)
{
...
struct _KAPC// Size=0x58 (Id=1153)
{
...
struct _IRP// Size=0xd0 (Id=102)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=5082)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=5101)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=5102)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=5115)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=5116)
            {
