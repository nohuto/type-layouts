...
struct _DOT11_SUPPORTED_DATA_RATES_VALUE_V2// Size=0x1fe (Id=2179)
{
...
struct DOT11_PHY_ATTRIBUTES// Size=0x444 (Id=2129)
{
    union // Size=0x18 (Id=0)
    {
        ...
        union <unnamed-type-PhySpecificAttributes>// Size=0xc (Id=15960)
        {
