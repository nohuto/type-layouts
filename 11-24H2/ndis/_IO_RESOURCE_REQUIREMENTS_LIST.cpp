...
struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=2237)
{
    union // Size=0x8 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x18 (Id=4666)
        {
            struct <unnamed-type-Port>// Size=0x18 (Id=4667)
            {
            ...
            struct <unnamed-type-Memory>// Size=0x18 (Id=4673)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                unsigned long Alignment;// Offset=0x4 Size=0x4
                union _LARGE_INTEGER MinimumAddress;// Offset=0x8 Size=0x8
            ...
            struct <unnamed-type-Interrupt>// Size=0x18 (Id=4679)
            {
            ...
            struct <unnamed-type-Dma>// Size=0x8 (Id=4687)
            {
            ...
            struct <unnamed-type-DmaV3>// Size=0x10 (Id=4691)
            {
            ...
            struct <unnamed-type-Generic>// Size=0x18 (Id=4697)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                unsigned long Alignment;// Offset=0x4 Size=0x4
                union _LARGE_INTEGER MinimumAddress;// Offset=0x8 Size=0x8
            ...
            struct <unnamed-type-ConfigData>// Size=0xc (Id=4712)
            {
            ...
            struct <unnamed-type-Memory40>// Size=0x18 (Id=4717)
            {
            ...
            struct <unnamed-type-Memory48>// Size=0x18 (Id=4723)
            {
            ...
            struct <unnamed-type-Memory64>// Size=0x18 (Id=4729)
            {
            ...
            struct <unnamed-type-Connection>// Size=0xc (Id=4735)
            {
...
struct _IO_RESOURCE_LIST// Size=0x28 (Id=2228)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=2167)
{
