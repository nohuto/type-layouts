struct in_addr// Size=0x4 (Id=185)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-S_un>// Size=0x4 (Id=16176)
        {
            struct <unnamed-type-S_un_b>// Size=0x4 (Id=16177)
            {
            ...
            struct <unnamed-type-S_un_w>// Size=0x4 (Id=16183)
            {
