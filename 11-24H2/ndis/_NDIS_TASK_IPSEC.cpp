struct _NDIS_TASK_IPSEC// Size=0x18 (Id=1807)
{
    union // Size=0x14 (Id=0)
    {
        struct <unnamed-type-Supported>// Size=0x10 (Id=11345)
        {
        ...
        struct <unnamed-type-V4AH>// Size=0x4 (Id=11351)
        {
        ...
        struct <unnamed-type-V4ESP>// Size=0x4 (Id=11359)
        {
