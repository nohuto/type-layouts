union _NDIS_TCP_IP_CHECKSUM_NET_BUFFER_LIST_INFO::_unnamed_1679// Size=0x8 (Id=1679)
{
    struct <unnamed-type-Transmit>// Size=0x4 (Id=11445)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_NET_BUFFER_LIST_INFO::_unnamed_1680::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x4
    struct <unnamed-type-Receive>// Size=0x4 (Id=11454)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_NET_BUFFER_LIST_INFO::_unnamed_1681::<unnamed-type-Receive> Receive;// Offset=0x0 Size=0x4
