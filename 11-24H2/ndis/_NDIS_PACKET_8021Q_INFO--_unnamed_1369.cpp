union _NDIS_PACKET_8021Q_INFO::_unnamed_1369// Size=0x8 (Id=1369)
{
    struct <unnamed-type-TagHeader>// Size=0x4 (Id=10050)
    {
    ...
    struct _NDIS_PACKET_8021Q_INFO::_unnamed_1370::<unnamed-type-TagHeader> TagHeader;// Offset=0x0 Size=0x4
