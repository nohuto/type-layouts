...
struct _NDIS_GFT_HEADER_TRANSPOSITION_PROFILE// Size=0x20 (Id=1149)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
    enum _NDIS_GFP_TABLE_TYPE TableType;// Offset=0x8 Size=0x4
    unsigned long ProfileId;// Offset=0xc Size=0x4
    unsigned long HeaderGroupTranspositionProfileArrayOffset;// Offset=0x10 Size=0x4
    unsigned long HeaderGroupTranspositionProfileArrayNumElements;// Offset=0x14 Size=0x4
    unsigned long HeaderGroupTranspositionProfileArrayElementSize;// Offset=0x18 Size=0x4
    unsigned long CustomActionProfileOffset;// Offset=0x1c Size=0x4
};
