...
struct _NDIS_GFT_PACKET_COUNTER_VALUE// Size=0x10 (Id=1206)
{
    unsigned long long Packets;// Offset=0x0 Size=0x8
    union _LARGE_INTEGER LastUpdate;// Offset=0x8 Size=0x8
};

struct _NDIS_GFT_BYTE_COUNTER_VALUE// Size=0x10 (Id=935)
{
...
struct _NDIS_GFT_FLOW_STATE// Size=0x8 (Id=2240)
{
    unsigned long TcpSeqNum;// Offset=0x0 Size=0x4
    unsigned long TcpAckNum;// Offset=0x4 Size=0x4
};

struct _NDIS_GFT_PACKET_BYTE_COUNTER_VALUE_AND_STATE// Size=0x20 (Id=1824)
{
...
struct _NDIS_GFT_COUNTER_VALUE// Size=0x28 (Id=1261)
{
    union // Size=0x4 (Id=0)
    {
        enum _NDIS_GFT_COUNTER_TYPE CounterType;// Offset=0x0 Size=0x4
        union <unnamed-type-CounterValue>// Size=0x20 (Id=7311)
        {
...
struct _NDIS_GFT_FLOW_ENTRY_ID_AND_COUNTER// Size=0x30 (Id=1074)
{
