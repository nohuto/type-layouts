...
struct _NDIS_NDK_CAPABILITIES// Size=0x38 (Id=1900)
{
...
struct _NDIS_NDK_REQUEST_PARAMETERS// Size=0x68 (Id=2241)
{
...
struct _NDIS_NDK_RESPONSE_PARAMETERS// Size=0x40 (Id=2236)
{
...
struct _NDIS_NDK_PARAMETERS// Size=0xa8 (Id=2235)
{
...
struct _NDIS_NIC_SWITCH_VPORT_PARAMETERS// Size=0x2f0 (Id=2218)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
...
struct _NDIS_VPORT_BLOCK// Size=0x388 (Id=2144)
{
