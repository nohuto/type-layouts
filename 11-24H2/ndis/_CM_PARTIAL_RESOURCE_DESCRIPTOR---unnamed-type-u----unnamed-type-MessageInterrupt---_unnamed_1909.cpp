union _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-MessageInterrupt>::_unnamed_1909// Size=0x10 (Id=1909)
{
    struct <unnamed-type-Raw>// Size=0x10 (Id=2807)
    {
    ...
    struct <unnamed-type-Translated>// Size=0x10 (Id=2813)
    {
