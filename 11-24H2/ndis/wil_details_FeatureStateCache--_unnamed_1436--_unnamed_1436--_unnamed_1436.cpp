struct wil_details_FeatureStateCache::_unnamed_1436::_unnamed_1436::_unnamed_1436// Size=0x4 (Id=1436)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned int wasUsed:1;// Offset=0x0 Size=0x4 BitOffset=0x12 BitSize=0x1
        unsigned int unused:13;// Offset=0x0 Size=0x4 BitOffset=0x13 BitSize=0xd
    };
};
