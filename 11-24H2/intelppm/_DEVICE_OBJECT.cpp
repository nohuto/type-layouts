...
struct _WAIT_CONTEXT_BLOCK// Size=0x48 (Id=524)
{
...
union _unnamed_142// Size=0x48 (Id=142)
{
...
struct _DEVICE_OBJECT// Size=0x150 (Id=143)
{
    short Type;// Offset=0x0 Size=0x2
    ...
    union _unnamed_142 Queue;// Offset=0x50 Size=0x48
