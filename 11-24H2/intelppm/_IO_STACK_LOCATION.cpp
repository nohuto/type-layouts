...
struct _unnamed_109// Size=0x18 (Id=109)
{
...
struct _unnamed_123// Size=0x1 (Id=123)
{
...
struct _unnamed_132// Size=0x8 (Id=132)
{
...
union _POWER_STATE// Size=0x4 (Id=544)
{
...
union _unnamed_139// Size=0x20 (Id=139)
{
    ...
    struct _unnamed_107 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_108 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_109 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_110 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_111 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_112 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_113 MountVolume;// Offset=0x0 Size=0x18
    struct _unnamed_114 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_116 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_118 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_119 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_120 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_121 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_122 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_123 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_125 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_127 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_129 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_131 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_132 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_135 Power;// Offset=0x0 Size=0x20
    struct _unnamed_136 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_137 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_138 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=140)
{
    ...
    union _unnamed_139 Parameters;// Offset=0x8 Size=0x20
