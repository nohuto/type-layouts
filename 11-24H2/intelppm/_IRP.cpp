...
struct _unnamed_92// Size=0x58 (Id=92)
{
...
union _unnamed_93// Size=0x58 (Id=93)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_92 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=94)
{
    ...
    union _unnamed_88 AssociatedIrp;// Offset=0x18 Size=0x8
