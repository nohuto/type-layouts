...
struct _PCI_FPB_CAPABILITY_HEADER// Size=0x4 (Id=525)
{
    struct _PCI_CAPABILITIES_HEADER Header;// Offset=0x0 Size=0x2
    unsigned short Reserved;// Offset=0x2 Size=0x2
};

union _PCI_FPB_CAPABILITIES_REGISTER// Size=0x4 (Id=2324)
{
...
union _PCI_FPB_RID_VECTOR_CONTROL1_REGISTER// Size=0x4 (Id=3771)
{
    struct // Size=0x4 (Id=0)
    {
...
union _PCI_FPB_RID_VECTOR_CONTROL2_REGISTER// Size=0x4 (Id=2380)
{
    struct // Size=0x4 (Id=0)
    {
...
union _PCI_FPB_MEM_LOW_VECTOR_CONTROL_REGISTER// Size=0x4 (Id=3716)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PCI_FPB_MEM_HIGH_VECTOR_CONTROL2_REGISTER// Size=0x4 (Id=3459)
{
    unsigned long MemHighVectorStartUpper;// Offset=0x0 Size=0x4
};

union _PCI_FPB_VECTOR_ACCESS_CONTROL_REGISTER// Size=0x4 (Id=3552)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PCI_FPB_CAPABILITY// Size=0x24 (Id=3947)
{
