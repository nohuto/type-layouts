...
union _WDF_USB_CONTROL_SETUP_PACKET// Size=0x8 (Id=2165)
{
    struct <unnamed-type-Packet>// Size=0x8 (Id=23858)
    {
        union <unnamed-type-bm>// Size=0x1 (Id=23859)
        {
            struct <unnamed-type-Request>// Size=0x1 (Id=23860)
            {
        ...
        union <unnamed-type-wValue>// Size=0x2 (Id=23869)
        {
            struct <unnamed-type-Bytes>// Size=0x2 (Id=23870)
            {
        ...
        union <unnamed-type-wIndex>// Size=0x2 (Id=23876)
        {
            struct <unnamed-type-Bytes>// Size=0x2 (Id=23877)
            {
                unsigned char LowByte;// Offset=0x0 Size=0x1
                unsigned char HiByte;// Offset=0x1 Size=0x1
            };
    ...
    struct <unnamed-type-Generic>// Size=0x8 (Id=23885)
    {
...
struct _WDF_USB_REQUEST_COMPLETION_PARAMS// Size=0x20 (Id=2535)
{
    union // Size=0x8 (Id=0)
    {
        long UsbdStatus;// Offset=0x0 Size=0x4
        enum _WDF_USB_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
        union <unnamed-type-Parameters>// Size=0x18 (Id=23949)
        {
            struct <unnamed-type-DeviceString>// Size=0x10 (Id=23950)
            {
            ...
            struct <unnamed-type-DeviceControlTransfer>// Size=0x18 (Id=23956)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            ...
            struct <unnamed-type-PipeRead>// Size=0x18 (Id=23969)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
                unsigned long long Length;// Offset=0x8 Size=0x8
                unsigned long long Offset;// Offset=0x10 Size=0x8
            ...
            struct <unnamed-type-PipeUrb>// Size=0x8 (Id=23974)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            };
