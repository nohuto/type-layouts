...
struct _WDF_USB_DEVICE_SELECT_CONFIG_PARAMS// Size=0x20 (Id=2240)
{
    union // Size=0x8 (Id=0)
    {
        unsigned long Size;// Offset=0x0 Size=0x4
        enum _WdfUsbTargetDeviceSelectConfigType Type;// Offset=0x4 Size=0x4
        union <unnamed-type-Types>// Size=0x18 (Id=23896)
        {
            struct <unnamed-type-Descriptor>// Size=0x18 (Id=23897)
            {
            ...
            struct _WDF_USB_DEVICE_SELECT_CONFIG_PARAMS::<unnamed-type-Types>::<unnamed-type-Descriptor> Descriptor;// Offset=0x0 Size=0x18
            struct <unnamed-type-Urb>// Size=0x8 (Id=23902)
            {
                struct _URB * Urb;// Offset=0x0 Size=0x8
            };
            struct _WDF_USB_DEVICE_SELECT_CONFIG_PARAMS::<unnamed-type-Types>::<unnamed-type-Urb> Urb;// Offset=0x0 Size=0x8
            struct <unnamed-type-SingleInterface>// Size=0x10 (Id=23905)
            {
            ...
            struct _WDF_USB_DEVICE_SELECT_CONFIG_PARAMS::<unnamed-type-Types>::<unnamed-type-SingleInterface> SingleInterface;// Offset=0x0 Size=0x10
            struct <unnamed-type-MultiInterface>// Size=0x18 (Id=23910)
            {
            ...
            struct _WDF_USB_DEVICE_SELECT_CONFIG_PARAMS::<unnamed-type-Types>::<unnamed-type-MultiInterface> MultiInterface;// Offset=0x0 Size=0x18
        };
    };
    union _WDF_USB_DEVICE_SELECT_CONFIG_PARAMS::<unnamed-type-Types> Types;// Offset=0x8 Size=0x18
};
