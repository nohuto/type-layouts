struct _LUID// Size=0x8 (Id=46)
{
    unsigned long LowPart;// Offset=0x0 Size=0x4
    long HighPart;// Offset=0x4 Size=0x4
};

struct _SE_EXPORTS// Size=0x260 (Id=576)
{
    ...
    void * SeProcTrustWinTcbSid;// Offset=0x218 Size=0x8
    void * SeTrustedInstallerSid;// Offset=0x220 Size=0x8
    struct _LUID SeDelegateSessionUserImpersonatePrivilege;// Offset=0x228 Size=0x8
    void * SeAppSiloSid;// Offset=0x230 Size=0x8
    void * SeAppSiloVolumeRootMinimalCapabilitySid;// Offset=0x238 Size=0x8
    void * SeAppSiloProfilesRootMinimalCapabilitySid;// Offset=0x240 Size=0x8
    void * SeAppSiloPromptForAccessCapabilitySid;// Offset=0x248 Size=0x8
    void * SeAppSiloAccessToPublisherDirectoryCapabilitySid;// Offset=0x250 Size=0x8
    void * SeAllRestrictedAppPackagesSid;// Offset=0x258 Size=0x8
};
