union _WHEA_ARM_CACHE_ERROR_VALID_BITS// Size=0x2 (Id=1042)
{
...
struct _WHEA_ARM_CACHE_ERROR// Size=0xc (Id=2471)
{
...
union _WHEA_ARM_TLB_ERROR_VALID_BITS// Size=0x2 (Id=3624)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short TransactionType:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_ARM_TLB_ERROR// Size=0xc (Id=3497)
{
...
union _WHEA_ARM_PROCESSOR_ERROR// Size=0xc (Id=3560)
{
    union // Size=0xc (Id=0)
    {
