...
struct _POWER_LIMIT_ATTRIBUTES// Size=0x24 (Id=1628)
{
    union // Size=0x20 (Id=0)
    {
        ...
        union <unnamed-type-Flags>// Size=0x4 (Id=16810)
        {
        ...
        union _POWER_LIMIT_ATTRIBUTES::<unnamed-type-Flags> Flags;// Offset=0x20 Size=0x4
    };
};
