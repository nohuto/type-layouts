...
struct _CM_PARTIAL_RESOURCE_DESCRIPTOR// Size=0x14 (Id=1570)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x10 (Id=5847)
        {
            ...
            struct <unnamed-type-MessageInterrupt>// Size=0x10 (Id=5861)
            {
                struct _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-MessageInterrupt>::_unnamed_1591::<unnamed-type-Raw> Raw;// Offset=0x0 Size=0x10
                struct _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-MessageInterrupt>::_unnamed_1590::<unnamed-type-Translated> Translated;// Offset=0x0 Size=0x10
            };
            ...
            struct <unnamed-type-DmaV3>// Size=0xc (Id=5874)
            {
                unsigned long Channel;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-DevicePrivate>// Size=0xc (Id=5882)
            {
            ...
            struct <unnamed-type-BusNumber>// Size=0xc (Id=5885)
            {
            ...
            struct <unnamed-type-DeviceSpecificData>// Size=0xc (Id=5890)
            {
