...
struct _DISPATCHER_HEADER// Size=0x18 (Id=138)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KAB_UM_PROCESS_CONTEXT// Size=0x10 (Id=1102)
{
    struct _KAB_UM_PROCESS_TREE * Trees;// Offset=0x0 Size=0x8
    unsigned long TreeCount;// Offset=0x8 Size=0x4
};

struct _SINGLE_LIST_ENTRY// Size=0x8 (Id=126)
{
    struct _SINGLE_LIST_ENTRY * Next;// Offset=0x0 Size=0x8
};

union _KEXECUTE_OPTIONS// Size=0x1 (Id=1404)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=1412)
{
...
struct _KPROCESS// Size=0x1c8 (Id=1358)
{
    ...
    union _unnamed_1355 SecureState;// Offset=0x170 Size=0x8
...
struct _EX_PUSH_LOCK// Size=0x8 (Id=1187)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _EX_RUNDOWN_REF// Size=0x8 (Id=3301)
{
    union // Size=0x8 (Id=0)
    {
...
struct _EX_FAST_REF// Size=0x8 (Id=1398)
{
    union // Size=0x8 (Id=0)
    {
...
struct _RTL_AVL_TREE// Size=0x8 (Id=1383)
{
    struct _RTL_BALANCED_NODE * Root;// Offset=0x0 Size=0x8
};

struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=1330)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=1388)
{
    union // Size=0x4 (Id=0)
    {
...
struct _MMSUPPORT_SHARED// Size=0x80 (Id=1259)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=1319)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=1363)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=1124)
{
    unsigned long HighEdgeFilter;// Offset=0x0 Size=0x4
    unsigned long LowEdgeFilter;// Offset=0x4 Size=0x4
};

struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=1228)
{
...
struct _unnamed_1139// Size=0x4 (Id=1139)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _unnamed_1141// Size=0x4 (Id=1141)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=1324)
{
    struct _RTL_AVL_TREE Tree;// Offset=0x0 Size=0x8
    struct _EX_PUSH_LOCK Lock;// Offset=0x8 Size=0x8
};

struct _unnamed_1143// Size=0x4 (Id=1143)
{
    struct // Size=0x4 (Id=0)
    {
...
union _PROCESS_EXECUTION_TRANSITION// Size=0x2 (Id=1391)
{
...
union _PROCESS_EXECUTION_STATE// Size=0x1 (Id=882)
{
...
union _PROCESS_EXECUTION// Size=0x4 (Id=1393)
{
...
struct _EPROCESS// Size=0x840 (Id=1150)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_1139 MitigationFlagsValues;// Offset=0x750 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x754 Size=0x4
        struct _unnamed_1141 MitigationFlags2Values;// Offset=0x754 Size=0x4
    };
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_1143 MitigationFlags3Values;// Offset=0x7d8 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_1145 SyscallUsageValues;// Offset=0x7e0 Size=0x4
    };
    ...
    struct _EX_PUSH_LOCK PpmPolicyLock;// Offset=0x818 Size=0x8
    unsigned long BamPpmPolicy;// Offset=0x820 Size=0x4
};
