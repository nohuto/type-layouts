union _WHEA_ERROR_PACKET_FLAGS// Size=0x4 (Id=1929)
{
...
union _WHEA_PROCESSOR_GENERIC_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=3988)
{
...
struct _WHEA_PROCESSOR_GENERIC_ERROR_SECTION// Size=0xc0 (Id=1058)
{
...
union _WHEA_MEMORY_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=3910)
{
    struct // Size=0x8 (Id=0)
    {
...
union _WHEA_ERROR_STATUS// Size=0x8 (Id=3598)
{
...
struct _WHEA_MEMORY_ERROR_SECTION// Size=0x50 (Id=666)
{
...
union _WHEA_NMI_ERROR_SECTION_FLAGS// Size=0x4 (Id=2519)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _WHEA_NMI_ERROR_SECTION// Size=0xc (Id=2656)
{
    unsigned char Data[8];// Offset=0x0 Size=0x8
    union _WHEA_NMI_ERROR_SECTION_FLAGS Flags;// Offset=0x8 Size=0x4
};

union _WHEA_PCIEXPRESS_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=2592)
{
    struct // Size=0x8 (Id=0)
    {
...
union _WHEA_PCIEXPRESS_VERSION// Size=0x4 (Id=1698)
{
...
union _WHEA_PCIEXPRESS_COMMAND_STATUS// Size=0x4 (Id=3919)
{
...
struct _WHEA_PCIEXPRESS_DEVICE_ID// Size=0x10 (Id=1766)
{
...
union _WHEA_PCIEXPRESS_BRIDGE_CONTROL_STATUS// Size=0x4 (Id=954)
{
...
struct _WHEA_PCIEXPRESS_ERROR_SECTION// Size=0xd0 (Id=3668)
{
...
union _WHEA_PCIXBUS_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=3363)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long ErrorStatus:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
union _WHEA_PCIXBUS_ID// Size=0x2 (Id=2409)
{
...
struct _WHEA_PCIXBUS_ERROR_SECTION// Size=0x48 (Id=2805)
{
...
union _WHEA_PCIXDEVICE_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=2665)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long ErrorStatus:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_PCIXDEVICE_ID// Size=0x10 (Id=1806)
{
    unsigned short VendorId;// Offset=0x0 Size=0x2
    unsigned short DeviceId;// Offset=0x2 Size=0x2
    struct // Size=0x8 (Id=0)
...
struct _WHEA_PCIXDEVICE_ERROR_SECTION// Size=0x38 (Id=3416)
{
...
union _WHEA_PMEM_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=2915)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long ErrorStatus:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_PMEM_PAGE_RANGE// Size=0x18 (Id=2997)
{
...
struct _WHEA_PMEM_ERROR_SECTION// Size=0x70 (Id=3622)
{
...
struct _WHEA_ERROR_PACKET_V1// Size=0x119 (Id=3305)
{
    union // Size=0x40 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0xd0 (Id=26547)
        {
