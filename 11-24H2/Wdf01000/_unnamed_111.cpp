...
struct _unnamed_72// Size=0x20 (Id=72)
{
    unsigned long OutputBufferLength;// Offset=0x0 Size=0x4
    unsigned long InputBufferLength;// Offset=0x8 Size=0x4
...
struct _unnamed_76// Size=0x18 (Id=76)
{
...
struct _unnamed_85// Size=0x4 (Id=85)
{
    enum _DEVICE_RELATION_TYPE Type;// Offset=0x0 Size=0x4
};

struct _unnamed_88// Size=0x20 (Id=88)
{
...
struct _unnamed_92// Size=0x1 (Id=92)
{
...
struct _unnamed_102// Size=0x4 (Id=102)
{
    enum _SYSTEM_POWER_STATE PowerState;// Offset=0x0 Size=0x4
};

struct _unnamed_103// Size=0x8 (Id=103)
{
...
struct _unnamed_107// Size=0x20 (Id=107)
{
    union // Size=0x4 (Id=0)
    {
...
union _unnamed_111// Size=0x20 (Id=111)
{
    ...
    struct _unnamed_72 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_73 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_74 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_76 MountVolume;// Offset=0x0 Size=0x18
    struct _unnamed_77 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_80 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_82 QueryQuota;// Offset=0x0 Size=0x20
    struct _unnamed_66 SetQuota;// Offset=0x0 Size=0x4
    struct _unnamed_85 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_88 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_89 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_90 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_91 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_92 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_95 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_97 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_99 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_102 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_103 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_107 Power;// Offset=0x0 Size=0x20
    struct _unnamed_108 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_109 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_110 Others;// Offset=0x0 Size=0x20
};
