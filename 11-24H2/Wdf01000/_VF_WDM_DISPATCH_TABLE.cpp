...
struct _VF_WDM_DISPATCH_TABLE// Size=0x50 (Id=2852)
{
    ...
    void *  ( * ExAllocatePoolWithTagPriority)(enum _POOL_TYPE ,unsigned long long ,unsigned long ,enum _EX_POOL_PRIORITY ,void * );// Offset=0x30 Size=0x8
