struct _ETW_ALL_POSSIBLE_NOTIFY_ROUTINES// Size=0x78 (Id=2309)
{
    ...
    void  ( * FileNameRoutine)(struct _EPROCESS * ,void * ,struct _UNICODE_STRING * ,struct _EJOB * ,unsigned long ,unsigned short );// Offset=0x20 Size=0x8
    void  ( * FileInitiationRoutine)(struct _ETHREAD * ,struct _EVENT_DATA_DESCRIPTOR * ,unsigned long ,unsigned long ,unsigned short ,struct _GUID * );// Offset=0x28 Size=0x8
    void  ( * FileCompletionRoutine)(struct _ETHREAD * ,struct _EVENT_DATA_DESCRIPTOR * ,unsigned long ,unsigned long ,unsigned short ,struct _GUID * );// Offset=0x30 Size=0x8
