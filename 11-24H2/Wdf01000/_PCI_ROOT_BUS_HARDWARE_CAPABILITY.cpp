...
struct _PCI_ROOT_BUS_OSC_SUPPORT_FIELD// Size=0x4 (Id=2182)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=15483)
        {
...
struct _PCI_ROOT_BUS_OSC_CONTROL_FIELD// Size=0x4 (Id=3937)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=15469)
        {
...
struct _PCI_ROOT_BUS_HARDWARE_CAPABILITY// Size=0x24 (Id=1443)
{
