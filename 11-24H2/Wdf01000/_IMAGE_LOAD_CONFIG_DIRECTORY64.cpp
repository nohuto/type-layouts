struct _IMAGE_LOAD_CONFIG_CODE_INTEGRITY// Size=0xc (Id=4086)
{
...
struct _IMAGE_LOAD_CONFIG_DIRECTORY64// Size=0x148 (Id=4085)
{
    ...
    unsigned long long GuardXFGCheckFunctionPointer;// Offset=0x118 Size=0x8
    unsigned long long GuardXFGDispatchFunctionPointer;// Offset=0x120 Size=0x8
    unsigned long long GuardXFGTableDispatchFunctionPointer;// Offset=0x128 Size=0x8
    unsigned long long CastGuardOsDeterminedFailureMode;// Offset=0x130 Size=0x8
    unsigned long long GuardMemcpyFunctionPointer;// Offset=0x138 Size=0x8
    unsigned long long UmaFunctionPointers;// Offset=0x140 Size=0x8
};
