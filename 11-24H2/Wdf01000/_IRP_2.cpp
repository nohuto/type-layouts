union _unnamed_127// Size=0x8 (Id=127)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=114)
{
    union // Size=0x4 (Id=0)
    {
...
union _unnamed_130// Size=0x10 (Id=130)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_129 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=125)
{
...
struct _unnamed_131// Size=0x50 (Id=131)
{
...
union _unnamed_132// Size=0x58 (Id=132)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_131 Overlay;// Offset=0x0 Size=0x50
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=1987)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=11111)
        {
            struct _IRP * MasterIrp;// Offset=0x0 Size=0x8
            long IrpCount;// Offset=0x0 Size=0x4
            void * SystemBuffer;// Offset=0x0 Size=0x8
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=11129)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=11130)
            {
                void  ( * UserApcRoutine)(void * ,struct _IO_STATUS_BLOCK * ,unsigned long );// Offset=0x0 Size=0x8
                void * IssuingProcess;// Offset=0x0 Size=0x8
                void * UserApcContext;// Offset=0x8 Size=0x8
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=11143)
        {
            struct <unnamed-type-Overlay>// Size=0x50 (Id=11144)
            {
                struct _KDEVICE_QUEUE_ENTRY DeviceQueueEntry;// Offset=0x0 Size=0x18
                void * DriverContext[4];// Offset=0x0 Size=0x20
                struct _ETHREAD * Thread;// Offset=0x20 Size=0x8
