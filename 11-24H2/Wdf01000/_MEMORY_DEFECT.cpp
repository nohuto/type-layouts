union _DIMM_ADDRESS// Size=0x18 (Id=2920)
{
    struct <unnamed-type-Ddr4>// Size=0x18 (Id=6594)
    {
    ...
    struct <unnamed-type-Ddr5>// Size=0x18 (Id=6609)
    {
...
struct _DIMM_ADDR_VALID_BITS_DDR4// Size=0x4 (Id=850)
{
...
struct _DIMM_ADDR_VALID_BITS_DDR5// Size=0x4 (Id=3732)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned int SocketId:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
union _DIMM_ADDR_VALID_BITS// Size=0x4 (Id=2701)
{
...
struct _DIMM_INFO// Size=0x1c (Id=2902)
{
...
struct _MEMORY_DEFECT// Size=0x24 (Id=3237)
{
