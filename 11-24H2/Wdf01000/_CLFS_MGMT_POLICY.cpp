...
struct _CLFS_MGMT_POLICY// Size=0x18 (Id=3179)
{
    union // Size=0x10 (Id=0)
    {
        ...
        union <unnamed-type-PolicyParameters>// Size=0x8 (Id=5616)
        {
            struct <unnamed-type-MaximumSize>// Size=0x4 (Id=5617)
            {
            ...
            struct <unnamed-type-GrowthRate>// Size=0x8 (Id=5626)
            {
            ...
            struct <unnamed-type-LogTail>// Size=0x8 (Id=5630)
            {
            ...
            struct <unnamed-type-AutoShrink>// Size=0x4 (Id=5634)
            {
            ...
            struct <unnamed-type-AutoGrow>// Size=0x4 (Id=5637)
            {
            ...
            struct <unnamed-type-NewContainerPrefix>// Size=0x4 (Id=5640)
            {
            ...
            struct <unnamed-type-NewContainerSuffix>// Size=0x8 (Id=5644)
            {
            ...
            struct <unnamed-type-NewContainerExtension>// Size=0x4 (Id=5647)
            {
