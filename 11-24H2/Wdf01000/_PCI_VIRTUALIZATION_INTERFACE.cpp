struct _PCI_VIRTUALIZATION_INTERFACE// Size=0x50 (Id=3618)
{
    ...
    long  ( * GetLocation)(void * ,unsigned short ,unsigned short * ,unsigned char * ,unsigned char * );// Offset=0x30 Size=0x8
