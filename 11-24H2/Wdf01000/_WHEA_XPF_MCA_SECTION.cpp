...
union _MCG_STATUS// Size=0x8 (Id=3604)
{
...
struct _MCI_STATUS_BITS_COMMON// Size=0x8 (Id=3224)
{
...
struct _MCI_STATUS_AMD_BITS// Size=0x8 (Id=2199)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long McaErrorCode:16;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x10
...
struct _MCI_STATUS_INTEL_BITS// Size=0x8 (Id=768)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long McaErrorCode:16;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x10
...
union _MCI_STATUS// Size=0x8 (Id=1779)
{
...
struct _WHEA_AMD_EXTENDED_REGISTERS// Size=0xc0 (Id=2728)
{
...
union _MCG_CAP// Size=0x8 (Id=2386)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _XPF_RECOVERY_INFO// Size=0x14 (Id=481)
{
    union // Size=0x4 (Id=0)
    {
        struct <unnamed-type-FailureReason>// Size=0x4 (Id=28675)
        {
        ...
        struct <unnamed-type-Action>// Size=0x4 (Id=28689)
        {
...
struct _WHEA_XPF_MCA_SECTION// Size=0x4a8 (Id=3414)
{
