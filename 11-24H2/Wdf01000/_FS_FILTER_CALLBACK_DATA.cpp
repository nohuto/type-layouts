...
struct _unnamed_702// Size=0x8 (Id=702)
{
...
struct _unnamed_708// Size=0x20 (Id=708)
{
...
struct _unnamed_711// Size=0x28 (Id=711)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=714)
{
    struct _unnamed_701 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_702 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_706 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _unnamed_708 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_711 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=696)
{
