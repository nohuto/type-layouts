...
struct _WUDFMESSAGE_TARGET_DEVICE_NOTIFICATION// Size=0x30 (Id=1018)
{
    ...
    unsigned long long TargetContext;// Offset=0x20 Size=0x8
    unsigned long CustomBufferSize;// Offset=0x28 Size=0x4
    unsigned long NameBufferOffset;// Offset=0x2c Size=0x4
