struct _PCI_SLOT_NUMBER// Size=0x4 (Id=4013)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=15520)
        {
            struct <unnamed-type-bits>// Size=0x4 (Id=15521)
            {
...
struct _PCIBUSDATA// Size=0x50 (Id=3083)
{
