...
struct _IO_STACK_LOCATION// Size=0x48 (Id=857)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-Parameters>// Size=0x20 (Id=10761)
        {
            struct <unnamed-type-Create>// Size=0x20 (Id=10762)
            {
            ...
            struct <unnamed-type-CreatePipe>// Size=0x20 (Id=10770)
            {
                struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
                unsigned long Options;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-CreateMailslot>// Size=0x20 (Id=10778)
            {
                struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
                unsigned long Options;// Offset=0x8 Size=0x4
                unsigned short Reserved;// Offset=0x10 Size=0x2
            ...
            struct <unnamed-type-Read>// Size=0x18 (Id=10786)
            {
            ...
            struct <unnamed-type-Write>// Size=0x18 (Id=10792)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                unsigned long Key;// Offset=0x8 Size=0x4
                unsigned long Flags;// Offset=0xc Size=0x4
            ...
            struct <unnamed-type-QueryDirectory>// Size=0x20 (Id=10798)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-NotifyDirectory>// Size=0x10 (Id=10804)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-NotifyDirectoryEx>// Size=0x18 (Id=10808)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                unsigned long CompletionFilter;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-QueryFile>// Size=0x10 (Id=10813)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-SetFile>// Size=0x20 (Id=10817)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-QueryEa>// Size=0x20 (Id=10826)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-SetVolume>// Size=0x10 (Id=10839)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                enum _FSINFOCLASS FsInformationClass;// Offset=0x8 Size=0x4
            };
            struct _IO_STACK_LOCATION::<unnamed-type-Parameters>::<unnamed-type-SetVolume> SetVolume;// Offset=0x0 Size=0x10
            struct <unnamed-type-FileSystemControl>// Size=0x20 (Id=10843)
            {
            ...
            struct <unnamed-type-LockControl>// Size=0x18 (Id=10849)
            {
            ...
            struct <unnamed-type-DeviceIoControl>// Size=0x20 (Id=10854)
            {
                unsigned long OutputBufferLength;// Offset=0x0 Size=0x4
                unsigned long InputBufferLength;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-QuerySecurity>// Size=0x10 (Id=10860)
            {
            ...
            struct <unnamed-type-SetSecurity>// Size=0x10 (Id=10864)
            {
                unsigned long SecurityInformation;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-MountVolume>// Size=0x18 (Id=10868)
            {
            ...
            struct <unnamed-type-QueryQuota>// Size=0x20 (Id=10881)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-SetQuota>// Size=0x4 (Id=10888)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            };
            struct _IO_STACK_LOCATION::<unnamed-type-Parameters>::<unnamed-type-SetQuota> SetQuota;// Offset=0x0 Size=0x4
            struct <unnamed-type-QueryDeviceRelations>// Size=0x4 (Id=10891)
            {
            ...
            struct <unnamed-type-QueryInterface>// Size=0x20 (Id=10894)
            {
            ...
            struct <unnamed-type-DeviceCapabilities>// Size=0x8 (Id=10902)
            {
            ...
            struct <unnamed-type-FilterResourceRequirements>// Size=0x8 (Id=10906)
            {
            ...
            struct <unnamed-type-ReadWriteConfig>// Size=0x20 (Id=10910)
            {
            ...
            struct <unnamed-type-SetLock>// Size=0x1 (Id=10916)
            {
            ...
            struct <unnamed-type-QueryId>// Size=0x4 (Id=10919)
            {
            ...
            struct <unnamed-type-QueryDeviceText>// Size=0x10 (Id=10922)
            {
            ...
            struct <unnamed-type-UsageNotification>// Size=0x10 (Id=10926)
            {
            ...
            struct <unnamed-type-WaitWake>// Size=0x4 (Id=10931)
            {
            ...
            struct <unnamed-type-PowerSequence>// Size=0x8 (Id=10934)
            {
            ...
            struct <unnamed-type-Power>// Size=0x20 (Id=10938)
            {
            ...
            struct <unnamed-type-StartDevice>// Size=0x10 (Id=10945)
            {
            ...
            struct <unnamed-type-WMI>// Size=0x20 (Id=10949)
            {
            ...
            struct <unnamed-type-Others>// Size=0x20 (Id=10955)
            {
