...
union _WHEA_IN_USE_PAGE_NOTIFY_FLAGS// Size=0x1 (Id=3620)
{
    struct <unnamed-type-Bits>// Size=0x1 (Id=26951)
    {
...
union _WHEA_RECOVERY_CONTEXT_ACTION_TAKEN_ADDITIONAL_INFO// Size=0x8 (Id=2980)
{
    struct <unnamed-type-Bits>// Size=0x8 (Id=27586)
    {
...
struct _WHEA_RECOVERY_CONTEXT_PAGE_INFO// Size=0x18 (Id=4025)
{
...
struct _WHEA_RECOVERY_CONTEXT// Size=0x1828 (Id=3297)
{
    union // Size=0x10 (Id=0)
    {
        struct _WHEA_RECOVERY_CONTEXT::_unnamed_3299::<unnamed-type-MemoryError> MemoryError;// Offset=0x0 Size=0x10
        struct _WHEA_RECOVERY_CONTEXT::_unnamed_3298::<unnamed-type-PmemError> PmemError;// Offset=0x0 Size=0x8
