union _DEVICE_RESET_STATUS_FLAGS// Size=0x8 (Id=3394)
{
    struct <unnamed-type-u>// Size=0x8 (Id=6509)
    {
    ...
    struct _DEVICE_RESET_STATUS_FLAGS::<unnamed-type-u> u;// Offset=0x0 Size=0x8
