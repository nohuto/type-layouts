...
struct _unnamed_451// Size=0x8 (Id=451)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_452// Size=0x4 (Id=452)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_453// Size=0x8 (Id=453)
{
    struct _unnamed_451 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_452 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_451 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=242)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_453 Data;// Offset=0x4 Size=0x8
};
