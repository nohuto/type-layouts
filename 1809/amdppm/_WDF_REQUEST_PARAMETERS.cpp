...
union _unnamed_298// Size=0x20 (Id=298)
{
    ...
    struct _unnamed_296 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_297 Others;// Offset=0x0 Size=0x20
};

struct _WDF_REQUEST_PARAMETERS// Size=0x28 (Id=299)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned char MinorFunction;// Offset=0x2 Size=0x1
    enum _WDF_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    union _unnamed_298 Parameters;// Offset=0x8 Size=0x20
};
