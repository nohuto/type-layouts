struct _PEP_PROCESSOR_IDLE_STATE_V2// Size=0xc (Id=686)
{
    union // Size=0x4 (Id=0)
    {
...
struct _PEP_PPM_QUERY_IDLE_STATES_V2// Size=0x10 (Id=587)
{
    unsigned long Count;// Offset=0x0 Size=0x4
    struct _PEP_PROCESSOR_IDLE_STATE_V2 IdleStates[1];// Offset=0x4 Size=0xc
};
