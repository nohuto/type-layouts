...
struct _PPM_DRIVER_DISPATCH_TABLE// Size=0x110 (Id=496)
{
...
struct _PCC_INTERFACE_INTERNAL// Size=0x58 (Id=556)
{
...
union _unnamed_589// Size=0x4 (Id=589)
{
...
struct _PCC_INTERFACE_STANDARD// Size=0x80 (Id=590)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
    ...
    union _unnamed_589 Flags;// Offset=0x54 Size=0x4
...
struct GLOBALS// Size=0x7d0 (Id=411)
{
    ...
    struct _PPM_DRIVER_DISPATCH_TABLE PpmDispatchTable;// Offset=0x210 Size=0x110
    struct _KAFFINITY_EX ProcessorsEnumerated;// Offset=0x320 Size=0xa8
    long  ( * RegisterIdleStates)(struct _FDO_DATA * );// Offset=0x3c8 Size=0x8
    long  ( * RegisterPStates)(struct _FDO_DATA * );// Offset=0x3d0 Size=0x8
    long  ( * RegisterPerfCap)(struct _FDO_DATA * );// Offset=0x3d8 Size=0x8
    long  ( * RegisterPerfFeedback)(struct _FDO_DATA * );// Offset=0x3e0 Size=0x8
    long  ( * RegisterLegacyPcc)(struct _FDO_DATA * );// Offset=0x3e8 Size=0x8
    long  ( * RegisterCpc)(struct _FDO_DATA * );// Offset=0x3f0 Size=0x8
    long  ( * RegisterPepPerf)(struct _FDO_DATA * );// Offset=0x3f8 Size=0x8
    long  ( * GetProcessorIndex)(struct _FDO_DATA * );// Offset=0x400 Size=0x8
    long  ( * RegisterPackage)(struct _FDO_DATA * );// Offset=0x408 Size=0x8
    struct _EVENT_DESCRIPTOR * SummaryEvent;// Offset=0x410 Size=0x8
    struct _EVENT_DESCRIPTOR * Summary2Event;// Offset=0x418 Size=0x8
    struct _EVENT_DESCRIPTOR * IdleStatesErrorEvent;// Offset=0x420 Size=0x8
    struct _EVENT_DESCRIPTOR * PerfStatesErrorEvent;// Offset=0x428 Size=0x8
    struct _EVENT_DESCRIPTOR * ThrottleStatesErrorEvent;// Offset=0x430 Size=0x8
    struct _EVENT_DESCRIPTOR * CapInfoEvent;// Offset=0x438 Size=0x8
    unsigned char SyntheticPsdAllowed;// Offset=0x440 Size=0x1
    enum <unnamed-enum-PerfStatesNative> PerfStatesOwner;// Offset=0x444 Size=0x4
    unsigned long HvDomainCount;// Offset=0x448 Size=0x4
    struct _PCC_INTERFACE_INTERNAL PccInterfaceInternal;// Offset=0x450 Size=0x58
    unsigned long Errata;// Offset=0x4a8 Size=0x4
    struct _PCC_INTERFACE_STANDARD PccInterface;// Offset=0x4b0 Size=0x80
    struct _PCC_SUBSPACE_REGISTRATION * PccSubspace;// Offset=0x530 Size=0x8
    unsigned long PccRegisteredProcessors;// Offset=0x538 Size=0x4
    void  ( * PccCallback)();// Offset=0x540 Size=0x8
    struct WDFSPINLOCK__ * PccMutex;// Offset=0x548 Size=0x8
    struct _IO_WORKITEM * PccCapWorker;// Offset=0x550 Size=0x8
    unsigned long PepRegisteredProcessors;// Offset=0x558 Size=0x4
    unsigned char PccCapUpdated;// Offset=0x55c Size=0x1
    unsigned char PccCapWorkerQueued;// Offset=0x55d Size=0x1
    unsigned char AssertsDisabled;// Offset=0x55e Size=0x1
    unsigned long CoordinatedStateCount;// Offset=0x560 Size=0x4
    struct _PLATFORM_IDLE_STATES * PlatformIdleStates;// Offset=0x568 Size=0x8
    struct _COORDINATED_IDLE_STATES * CoordinatedStates;// Offset=0x570 Size=0x8
    struct _COORDINATED_IDLE_STATES * LpiCoordinatedStates;// Offset=0x578 Size=0x8
    unsigned long * LpiStateIndexMapping;// Offset=0x580 Size=0x8
    struct _RUNTIME_LPI_STATE * LpiRuntimeState;// Offset=0x588 Size=0x8
    struct ACPI_PROCESSOR_CONTAINERS * ProcessorContainers;// Offset=0x590 Size=0x8
    struct _PREREGISTERED_VETO_LIST * VetoList;// Offset=0x598 Size=0x8
    struct _IO_WORKITEM * StateUpdateWorker;// Offset=0x5a0 Size=0x8
    unsigned char StateUpdateWorkerQueued;// Offset=0x5a8 Size=0x1
    unsigned long EfficiencyClasses;// Offset=0x5ac Size=0x4
    unsigned long ProcessorCounts[2];// Offset=0x5b0 Size=0x8
    struct _PROC_ENERGY_MODEL EnergyModels[2];// Offset=0x5b8 Size=0x200
    unsigned long EnergyEnabledProcessors;// Offset=0x7b8 Size=0x4
    long long QpcFrequency;// Offset=0x7c0 Size=0x8
    unsigned long long CycleCounterFrequency;// Offset=0x7c8 Size=0x8
};
