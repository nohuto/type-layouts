...
union _HV_X64_PPM_IDLE_STATE_CONFIG// Size=0x8 (Id=636)
{
    ...
    struct _unnamed_633 Hlt;// Offset=0x0 Size=0x8
    struct _unnamed_634 Io;// Offset=0x0 Size=0x8
    struct _unnamed_635 Mwait;// Offset=0x0 Size=0x8
};
