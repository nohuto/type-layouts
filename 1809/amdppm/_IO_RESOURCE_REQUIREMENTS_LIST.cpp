...
struct _unnamed_275// Size=0x18 (Id=275)
{
...
union _unnamed_279// Size=0x18 (Id=279)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_267 Port;// Offset=0x0 Size=0x18
        struct _unnamed_267 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_269 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_270 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_271 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_267 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_272 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_273 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_274 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_275 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_276 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_277 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_278 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=280)
{
    ...
    union _unnamed_279 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=673)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=528)
{
