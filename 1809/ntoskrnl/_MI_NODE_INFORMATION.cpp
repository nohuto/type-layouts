struct _MI_FREE_LARGE_PAGES// Size=0x110 (Id=1774)
{
...
struct _MI_REBUILD_LARGE_PAGE_TIMER// Size=0x28 (Id=1641)
{
...
struct _MMPFNLIST_SHORT// Size=0x18 (Id=1747)
{
...
struct _MI_PAGE_COLORS// Size=0x10 (Id=1674)
{
    unsigned long PageSize[4];// Offset=0x0 Size=0x10
};

struct _MI_NODE_INFORMATION// Size=0x7c0 (Id=1622)
{
    ...
    struct _unnamed_1621 Flags;// Offset=0x760 Size=0x4
