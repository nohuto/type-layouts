...
struct _unnamed_413// Size=0x10 (Id=413)
{
...
struct _unnamed_415// Size=0x8 (Id=415)
{
...
struct _unnamed_417// Size=0x30 (Id=417)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
struct _unnamed_418// Size=0x68 (Id=418)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
union _unnamed_419// Size=0x68 (Id=419)
{
    struct _unnamed_413 Read;// Offset=0x0 Size=0x10
    struct _unnamed_414 Write;// Offset=0x0 Size=0x8
    struct _unnamed_415 Event;// Offset=0x0 Size=0x8
    struct _unnamed_416 Notification;// Offset=0x0 Size=0x4
    struct _unnamed_417 LowPriWrite;// Offset=0x0 Size=0x30
    struct _unnamed_418 AsyncRead;// Offset=0x0 Size=0x68
};

struct _WORK_QUEUE_ENTRY// Size=0x88 (Id=420)
{
    struct _LIST_ENTRY WorkQueueLinks;// Offset=0x0 Size=0x10
    union _unnamed_419 Parameters;// Offset=0x10 Size=0x68
