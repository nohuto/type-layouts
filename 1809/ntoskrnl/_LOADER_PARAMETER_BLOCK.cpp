...
struct _I386_LOADER_BLOCK// Size=0x10 (Id=1703)
{
...
struct _ARM_LOADER_BLOCK// Size=0x4 (Id=1769)
{
    unsigned long PlaceHolder;// Offset=0x0 Size=0x4
};

union _unnamed_1483// Size=0x10 (Id=1483)
{
...
struct _EFI_FIRMWARE_INFORMATION// Size=0x38 (Id=1776)
{
...
struct _PCAT_FIRMWARE_INFORMATION// Size=0x4 (Id=1782)
{
    unsigned long PlaceHolder;// Offset=0x0 Size=0x4
};

union _unnamed_1712// Size=0x38 (Id=1712)
{
...
struct _FIRMWARE_INFORMATION_LOADER_BLOCK// Size=0x40 (Id=1713)
{
    ...
    union _unnamed_1712 u;// Offset=0x8 Size=0x38
};

struct _LOADER_PARAMETER_BLOCK// Size=0x160 (Id=1484)
{
    ...
    union _unnamed_1483 u;// Offset=0xf8 Size=0x10
