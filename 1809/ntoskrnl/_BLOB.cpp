...
struct _SLIST_ENTRY// Size=0x10 (Id=74)
{
    struct _SLIST_ENTRY * Next;// Offset=0x0 Size=0x8
};

struct _unnamed_493// Size=0x1 (Id=493)
{
...
union _unnamed_494// Size=0x1 (Id=494)
{
    struct _unnamed_493 s1;// Offset=0x0 Size=0x1
...
struct _BLOB// Size=0x30 (Id=495)
{
    ...
    union _unnamed_494 u1;// Offset=0x10 Size=0x1
