...
union _unnamed_1392// Size=0x8 (Id=1392)
{
    struct _unnamed_1391 s1;// Offset=0x0 Size=0x8
    long long Value;// Offset=0x0 Size=0x8
};

struct _ALPC_COMPLETION_LIST_STATE// Size=0x8 (Id=1393)
{
    union _unnamed_1392 u1;// Offset=0x0 Size=0x8
};
...
struct _ALPC_COMPLETION_LIST_HEADER// Size=0x180 (Id=1153)
{
