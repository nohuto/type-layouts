...
struct _unnamed_1730// Size=0x8 (Id=1730)
{
...
struct _unnamed_1731// Size=0x10 (Id=1731)
{
    struct _GUID DiskId;// Offset=0x0 Size=0x10
};

union _unnamed_1732// Size=0x10 (Id=1732)
{
    struct _unnamed_1730 Mbr;// Offset=0x0 Size=0x8
    struct _unnamed_1731 Gpt;// Offset=0x0 Size=0x10
};

struct _DUMP_INITIALIZATION_CONTEXT// Size=0x108 (Id=1734)
{
    ...
    union _unnamed_1732 DiskInfo;// Offset=0x8c Size=0x10
...
struct _DUMP_STACK_CONTEXT// Size=0x178 (Id=1675)
{
