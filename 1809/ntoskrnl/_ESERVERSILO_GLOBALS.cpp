struct _OBP_SYSTEM_DOS_DEVICE_STATE// Size=0x6c (Id=778)
{
...
struct _OBJECT_NAMESPACE_LOOKUPTABLE// Size=0x260 (Id=610)
{
...
struct _OBP_SILODRIVERSTATE// Size=0x2e0 (Id=584)
{
...
struct _SEP_SILOSTATE// Size=0x30 (Id=566)
{
...
struct _SEP_RM_LSA_CONNECTION_STATE// Size=0x50 (Id=757)
{
...
struct _WNF_LOCK// Size=0x8 (Id=1281)
{
    struct _EX_PUSH_LOCK PushLock;// Offset=0x0 Size=0x8
};

struct _WNF_SILODRIVERSTATE// Size=0x38 (Id=780)
{
...
struct _DBGK_SILOSTATE// Size=0x20 (Id=641)
{
...
struct _CRITICAL_PROCESS_EXCEPTION_DATA// Size=0x30 (Id=800)
{
...
struct _ESERVERSILO_GLOBALS// Size=0x4d8 (Id=399)
{
