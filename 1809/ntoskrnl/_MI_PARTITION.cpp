struct _MI_PARTITION_FLAGS// Size=0x4 (Id=1555)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long UseSlabAllocators:1;// Offset=0x0 Size=0x4 BitOffset=0x3 BitSize=0x1
...
union _unnamed_1118// Size=0x4 (Id=1118)
{
...
struct _MI_PARTITION_CORE// Size=0x1a8 (Id=1119)
{
    unsigned short PartitionId;// Offset=0x0 Size=0x2
    union _unnamed_1118 u;// Offset=0x4 Size=0x4
...
struct _MMPAGE_FILE_EXPANSION_FLAGS// Size=0x4 (Id=1746)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1250// Size=0x4 (Id=1250)
{
    unsigned long LongFlags;// Offset=0x0 Size=0x4
    struct _MMPAGE_FILE_EXPANSION_FLAGS Flags;// Offset=0x0 Size=0x4
};

struct _MMPAGE_FILE_EXPANSION// Size=0x58 (Id=1251)
{
    ...
    union _unnamed_1250 u1;// Offset=0x4c Size=0x4
...
struct _MMMOD_WRITER_LISTHEAD// Size=0x28 (Id=1563)
{
...
union _MI_RESERVATION_CLUSTER_INFO// Size=0x4 (Id=1653)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_MODWRITE_DATA// Size=0x40 (Id=1654)
{
...
struct _MI_RESTRICTED_MODWRITES// Size=0x3 (Id=1748)
{
...
struct _MI_PARTITION_MODWRITES// Size=0x2c0 (Id=1446)
{
...
union _unnamed_715// Size=0x4 (Id=715)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_PARTITION_STORES// Size=0x90 (Id=716)
{
    union _unnamed_715 WriteAllStoreHintedPages;// Offset=0x0 Size=0x4
...
struct _KSEMAPHORE// Size=0x20 (Id=332)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

struct _MMDEREFERENCE_SEGMENT_HEADER// Size=0x50 (Id=1618)
{
...
struct _KTIMER// Size=0x40 (Id=1351)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _MI_CROSS_PARTITION_CHARGES// Size=0x20 (Id=1649)
{
...
struct _MI_PARTITION_SEGMENTS// Size=0x340 (Id=1211)
{
...
struct _MI_DECAY_TIMER_LINKAGE// Size=0x8 (Id=1362)
{
    struct // Size=0x8 (Id=0)
    {
...
union _unnamed_1002// Size=0x8 (Id=1002)
{
    unsigned long long Long;// Offset=0x0 Size=0x8
    struct _MI_DECAY_TIMER_LINKAGE e1;// Offset=0x0 Size=0x8
};

struct _MI_DECAY_TIMER_LINK// Size=0x8 (Id=1003)
{
    union _unnamed_1002 u1;// Offset=0x0 Size=0x8
};

struct _MI_LDW_WORK_CONTEXT// Size=0x38 (Id=1188)
{
...
struct _MI_AVAILABLE_PAGE_WAIT_STATES// Size=0x20 (Id=1214)
{
...
struct _MI_LARGE_PAGE_CANDIDATES// Size=0x208 (Id=1170)
{
...
struct _MI_PARTITION_PAGE_LISTS// Size=0x10c0 (Id=1000)
{
    ...
    struct _MI_SLAB_ALLOCATOR_CONTEXT SlabContexts[3];// Offset=0xfb8 Size=0xd8
    struct _RTL_BITMAP_EX SlabPfnBitMap;// Offset=0x1090 Size=0x10
};

struct _MI_PARTITION_COMMIT// Size=0x80 (Id=1327)
{
...
struct _MI_PARTITION_ZEROING// Size=0x68 (Id=1288)
{
...
struct _MI_PAGE_COMBINING_SUPPORT// Size=0x188 (Id=1019)
{
...
struct _MMWORKING_SET_EXPANSION_HEAD// Size=0x10 (Id=760)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
};
...
struct _MI_VISIBLE_PARTITION// Size=0x1200 (Id=825)
{
...
struct _MI_PARTITION// Size=0x2dc0 (Id=259)
{
    ...
    struct _MI_PARTITION_PAGE_LISTS PageLists;// Offset=0x840 Size=0x10c0
    struct _MI_PARTITION_COMMIT Commit;// Offset=0x1900 Size=0x80
    struct _MI_PARTITION_ZEROING Zeroing;// Offset=0x1980 Size=0x68
    struct _MI_PAGE_COMBINING_SUPPORT PageCombine;// Offset=0x19e8 Size=0x188
    void * WorkingSetControl;// Offset=0x1b70 Size=0x8
    struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;// Offset=0x1b78 Size=0x10
    struct _MI_VISIBLE_PARTITION Vp;// Offset=0x1bc0 Size=0x1200
};
