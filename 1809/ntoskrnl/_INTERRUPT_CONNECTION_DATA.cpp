...
struct _unnamed_1558// Size=0xc (Id=1558)
{
...
union _unnamed_1559// Size=0xc (Id=1559)
{
    struct _unnamed_1558 Msi;// Offset=0x0 Size=0xc
};

struct _INTERRUPT_REMAPPING_INFO// Size=0x10 (Id=1560)
{
    ...
    union _unnamed_1559 u;// Offset=0x4 Size=0xc
};

struct _unnamed_1029// Size=0x8 (Id=1029)
{
...
union _unnamed_1036// Size=0x4 (Id=1036)
{
    struct _unnamed_1035 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _unnamed_1037// Size=0x4 (Id=1037)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1038// Size=0x4 (Id=1038)
{
    struct _unnamed_1037 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_HT_INTR_INFO// Size=0x8 (Id=1039)
{
    union _unnamed_1036 LowPart;// Offset=0x0 Size=0x4
    union _unnamed_1038 HighPart;// Offset=0x4 Size=0x4
};
...
struct _unnamed_1033// Size=0x4 (Id=1033)
{
    enum HAL_APIC_DESTINATION_MODE DestinationMode;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_VECTOR_DATA// Size=0x58 (Id=1034)
{
    ...
    struct _unnamed_1029 ControllerInput;// Offset=0x38 Size=0x8
    unsigned long long HvDeviceId;// Offset=0x40 Size=0x8
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_1030 XapicMessage;// Offset=0x48 Size=0x10
        struct _unnamed_1031 Hypertransport;// Offset=0x48 Size=0x8
        struct _unnamed_1030 GenericMessage;// Offset=0x48 Size=0x10
        struct _unnamed_1033 MessageRequest;// Offset=0x48 Size=0x4
    };
};

struct _INTERRUPT_CONNECTION_DATA// Size=0x60 (Id=1557)
{
