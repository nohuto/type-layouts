union _unnamed_114// Size=0x8 (Id=114)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=82)
{
    union // Size=0x4 (Id=0)
    {
...
union _unnamed_116// Size=0x10 (Id=116)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_115 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=1062)
{
...
struct _unnamed_117// Size=0x58 (Id=117)
{
...
union _unnamed_118// Size=0x58 (Id=118)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_117 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=119)
{
    ...
    union _unnamed_114 AssociatedIrp;// Offset=0x18 Size=0x8
