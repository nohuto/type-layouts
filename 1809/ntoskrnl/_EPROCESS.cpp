...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=753)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=1205)
{
...
struct _ALPC_PROCESS_CONTEXT// Size=0x20 (Id=937)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=896)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=1140)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WNF_STATE_NAME// Size=0x8 (Id=591)
{
    unsigned long Data[2];// Offset=0x0 Size=0x8
};

struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=844)
{
    unsigned long HighEdgeFilter;// Offset=0x0 Size=0x4
    unsigned long LowEdgeFilter;// Offset=0x4 Size=0x4
};

struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=814)
{
...
struct _EPROCESS// Size=0x858 (Id=111)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_109 MitigationFlagsValues;// Offset=0x820 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x824 Size=0x4
        struct _unnamed_110 MitigationFlags2Values;// Offset=0x824 Size=0x4
    };
