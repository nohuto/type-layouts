...
{
    struct _unnamed_515 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

union _KALPC_DIRECT_EVENT// Size=0x8 (Id=527)
{
...
struct _KALPC_MESSAGE// Size=0x118 (Id=517)
{
    ...
    union _unnamed_516 u1;// Offset=0x28 Size=0x4
