...
union _unnamed_500// Size=0x4 (Id=500)
{
    struct _unnamed_499 s1;// Offset=0x0 Size=0x4
};

struct _KALPC_REGION// Size=0x58 (Id=501)
{
    ...
    union _unnamed_500 u1;// Offset=0x30 Size=0x4
