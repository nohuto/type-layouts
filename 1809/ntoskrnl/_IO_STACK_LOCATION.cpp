...
struct _unnamed_125// Size=0x20 (Id=125)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_128// Size=0x18 (Id=128)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _unnamed_131// Size=0x20 (Id=131)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_134// Size=0x10 (Id=134)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_136// Size=0x18 (Id=136)
{
...
struct _unnamed_137// Size=0x20 (Id=137)
{
    unsigned long OutputBufferLength;// Offset=0x0 Size=0x4
    unsigned long InputBufferLength;// Offset=0x8 Size=0x4
...
struct _unnamed_142// Size=0x8 (Id=142)
{
    struct _SCSI_REQUEST_BLOCK * Srb;// Offset=0x0 Size=0x8
};

struct _unnamed_143// Size=0x20 (Id=143)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_147// Size=0x8 (Id=147)
{
    struct _DEVICE_CAPABILITIES * Capabilities;// Offset=0x0 Size=0x8
};

struct _unnamed_148// Size=0x8 (Id=148)
{
...
struct _unnamed_150// Size=0x1 (Id=150)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _unnamed_152// Size=0x4 (Id=152)
{
...
struct _unnamed_158// Size=0x4 (Id=158)
{
    enum _SYSTEM_POWER_STATE PowerState;// Offset=0x0 Size=0x4
};

struct _unnamed_159// Size=0x8 (Id=159)
{
    struct _POWER_SEQUENCE * PowerSequence;// Offset=0x0 Size=0x8
};

struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=1044)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=935)
{
...
union _unnamed_166// Size=0x20 (Id=166)
{
    struct _unnamed_120 Create;// Offset=0x0 Size=0x20
    struct _unnamed_121 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_122 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_123 Read;// Offset=0x0 Size=0x18
    struct _unnamed_123 Write;// Offset=0x0 Size=0x18
    struct _unnamed_125 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_126 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_128 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_129 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_130 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_131 QueryEa;// Offset=0x0 Size=0x20
    struct _unnamed_132 SetEa;// Offset=0x0 Size=0x4
    struct _unnamed_134 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_134 SetVolume;// Offset=0x0 Size=0x10
    struct _unnamed_135 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_136 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_137 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_138 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_139 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_140 MountVolume;// Offset=0x0 Size=0x10
    struct _unnamed_140 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_142 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_143 QueryQuota;// Offset=0x0 Size=0x20
    struct _unnamed_132 SetQuota;// Offset=0x0 Size=0x4
    struct _unnamed_145 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_146 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_147 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_148 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_149 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_150 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_152 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_154 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_156 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_158 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_159 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_162 Power;// Offset=0x0 Size=0x20
    struct _unnamed_163 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_164 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_165 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=167)
{
    ...
    union _unnamed_166 Parameters;// Offset=0x8 Size=0x20
