union RTLP_HP_LFH_PERF_FLAGS// Size=0x4 (Id=1264)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long LargePagePreCommit:1;// Offset=0x0 Size=0x4 BitOffset=0x7 BitSize=0x1
        unsigned long OpportunisticLargePreCommit:1;// Offset=0x0 Size=0x4 BitOffset=0x8 BitSize=0x1
        unsigned long LfhForcedAffinity:1;// Offset=0x0 Size=0x4 BitOffset=0x9 BitSize=0x1
        unsigned long LfhCachelinePadding:1;// Offset=0x0 Size=0x4 BitOffset=0xa BitSize=0x1
    };
