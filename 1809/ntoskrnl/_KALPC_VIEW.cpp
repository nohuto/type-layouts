...
union _unnamed_503// Size=0x4 (Id=503)
{
    struct _unnamed_502 s1;// Offset=0x0 Size=0x4
};

struct _KALPC_VIEW// Size=0x60 (Id=504)
{
    ...
    union _unnamed_503 u1;// Offset=0x48 Size=0x4
