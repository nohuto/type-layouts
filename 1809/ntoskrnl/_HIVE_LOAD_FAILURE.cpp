...
struct _unnamed_275// Size=0x8 (Id=275)
{
...
struct _unnamed_280// Size=0x4 (Id=280)
{
    unsigned long FileOffset;// Offset=0x0 Size=0x4
};

struct _HIVE_LOAD_FAILURE// Size=0x160 (Id=281)
{
    ...
    struct _unnamed_273 Locations[8];// Offset=0xc Size=0x60
    struct _unnamed_273 RecoverableLocations[8];// Offset=0x6c Size=0x60
    struct _unnamed_274 RegistryIO;// Offset=0xd0 Size=0x18
    struct _unnamed_275 CheckRegistry2;// Offset=0xe8 Size=0x8
    struct _unnamed_276 CheckKey;// Offset=0xf0 Size=0x20
    struct _unnamed_277 CheckValueList;// Offset=0x110 Size=0x18
    struct _unnamed_278 CheckHive;// Offset=0x128 Size=0x10
    struct _unnamed_278 CheckHive1;// Offset=0x138 Size=0x10
    struct _unnamed_279 CheckBin;// Offset=0x148 Size=0x10
    struct _unnamed_280 RecoverData;// Offset=0x158 Size=0x4
};
