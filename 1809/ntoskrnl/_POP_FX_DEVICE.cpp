...
union _POP_FX_DEVICE_STATUS// Size=0x4 (Id=405)
{
...
struct _POP_FX_DRIVER_CALLBACKS// Size=0x48 (Id=1290)
{
    ...
    void  ( * DirectedPowerTransitionCallback)(void * ,unsigned char ,unsigned long );// Offset=0x40 Size=0x8
};
...
struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=1722)
{
...
struct _IO_REMOVE_LOCK// Size=0x20 (Id=1482)
{
...
struct _POP_FX_WORK_ORDER// Size=0x38 (Id=1387)
{
...
struct _POP_FX_ACTIVE_TIME_ACCOUNTING// Size=0x60 (Id=1752)
{
...
struct _POP_FX_ACCOUNTING// Size=0xe0 (Id=1462)
{
...
struct _POP_FX_DRIPS_WATCHDOG_CONTEXT// Size=0x28 (Id=1668)
{
...
struct _POP_FX_DEVICE// Size=0x3e0 (Id=1220)
{
    struct _LIST_ENTRY Link;// Offset=0x0 Size=0x10
    ...
    struct _POP_FX_DRIVER_CALLBACKS Callbacks;// Offset=0x70 Size=0x48
    void * DriverContext;// Offset=0xb8 Size=0x8
    struct _LIST_ENTRY AcpiLink;// Offset=0xc0 Size=0x10
    struct _UNICODE_STRING DeviceId;// Offset=0xd0 Size=0x10
    struct _IO_REMOVE_LOCK RemoveLock;// Offset=0xe0 Size=0x20
    struct _IO_REMOVE_LOCK AcpiRemoveLock;// Offset=0x100 Size=0x20
    struct _POP_FX_WORK_ORDER WorkOrder;// Offset=0x120 Size=0x38
    unsigned long long IdleLock;// Offset=0x158 Size=0x8
    struct _KTIMER IdleTimer;// Offset=0x160 Size=0x40
    struct _KDPC IdleDpc;// Offset=0x1a0 Size=0x40
    unsigned long long IdleTimeout;// Offset=0x1e0 Size=0x8
    unsigned long long IdleStamp;// Offset=0x1e8 Size=0x8
    struct _DEVICE_OBJECT * NextIrpDeviceObject[2];// Offset=0x1f0 Size=0x10
    union _POWER_STATE NextIrpPowerState[2];// Offset=0x200 Size=0x8
    void  ( * NextIrpCallerCompletion)[2];// Offset=0x208 Size=0x10
    void * NextIrpCallerContext[2];// Offset=0x218 Size=0x10
    struct _KEVENT IrpCompleteEvent;// Offset=0x228 Size=0x18
    unsigned char  ( * PowerOnDumpDeviceCallback)(struct _PEP_CRASHDUMP_INFORMATION * );// Offset=0x240 Size=0x8
    struct _POP_FX_ACCOUNTING Accounting;// Offset=0x248 Size=0xe0
    unsigned long Flags;// Offset=0x328 Size=0x4
    unsigned long ComponentCount;// Offset=0x32c Size=0x4
    struct _POP_FX_COMPONENT ** Components;// Offset=0x330 Size=0x8
    unsigned long LogEntries;// Offset=0x338 Size=0x4
    struct _POP_FX_LOG_ENTRY * Log;// Offset=0x340 Size=0x8
    long LogIndex;// Offset=0x348 Size=0x4
    struct _DRIVER_OBJECT * DripsWatchdogDriverObject;// Offset=0x350 Size=0x8
    struct _POP_FX_DRIPS_WATCHDOG_CONTEXT DripsWatchdogContext;// Offset=0x358 Size=0x28
    unsigned long DirectedTimeout;// Offset=0x380 Size=0x4
    struct _POP_FX_WORK_ORDER DirectedWorkOrder;// Offset=0x388 Size=0x38
    long DirectedTransitionCallCount;// Offset=0x3c0 Size=0x4
    void * DirectedTransitionCompletionContext;// Offset=0x3c8 Size=0x8
    struct _UNICODE_STRING FriendlyName;// Offset=0x3d0 Size=0x10
};
