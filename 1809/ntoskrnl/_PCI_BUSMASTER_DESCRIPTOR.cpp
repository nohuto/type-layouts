...
struct _unnamed_883// Size=0x2 (Id=883)
{
    unsigned char SecondaryBus;// Offset=0x0 Size=0x1
    unsigned char SubordinateBus;// Offset=0x1 Size=0x1
};

struct _PCI_BUSMASTER_DESCRIPTOR// Size=0xc (Id=884)
{
    enum _PCI_BUSMASTER_RID_TYPE Type;// Offset=0x0 Size=0x4
    unsigned long Segment;// Offset=0x4 Size=0x4
    union // Size=0xc (Id=0)
    {
        struct _unnamed_882 DeviceRid;// Offset=0x8 Size=0x4
        struct _unnamed_882 BridgeRid;// Offset=0x8 Size=0x4
        struct _unnamed_883 MultipleBridges;// Offset=0x8 Size=0x2
    };
};
