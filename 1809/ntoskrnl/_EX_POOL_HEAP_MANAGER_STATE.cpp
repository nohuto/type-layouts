...
struct _RTL_LOOKASIDE// Size=0x40 (Id=472)
{
...
struct _RTL_DYNAMIC_LOOKASIDE// Size=0x1040 (Id=471)
{
...
struct _EX_HEAP_POOL_NODE// Size=0x20c0 (Id=1275)
{
    struct _SEGMENT_HEAP * Heaps[4];// Offset=0x0 Size=0x20
    struct _RTL_DYNAMIC_LOOKASIDE Lookasides[2];// Offset=0x40 Size=0x2080
};

struct _EX_POOL_HEAP_MANAGER_STATE// Size=0x86140 (Id=1057)
{
    struct _RTLP_HP_HEAP_MANAGER HeapManager;// Offset=0x0 Size=0x30c8
    unsigned long NumberOfPools;// Offset=0x30c8 Size=0x4
    struct _EX_HEAP_POOL_NODE PoolNode[64];// Offset=0x3100 Size=0x83000
    struct _SEGMENT_HEAP * SpecialHeaps[3];// Offset=0x86100 Size=0x18
};
