...
struct _DBGKD_WRITE_BREAKPOINT64// Size=0x10 (Id=352)
{
...
struct _DBGKD_READ_WRITE_IO64// Size=0x10 (Id=354)
{
...
struct _DBGKD_READ_WRITE_IO_EXTENDED64// Size=0x20 (Id=356)
{
...
struct _DBGKD_SET_SPECIAL_CALL64// Size=0x8 (Id=359)
{
    unsigned long long SpecialCall;// Offset=0x0 Size=0x8
};

struct _DBGKD_SET_INTERNAL_BREAKPOINT64// Size=0x10 (Id=361)
{
    unsigned long long BreakpointAddress;// Offset=0x0 Size=0x8
    unsigned long Flags;// Offset=0x8 Size=0x4
};

struct _DBGKD_GET_INTERNAL_BREAKPOINT64// Size=0x20 (Id=362)
{
    unsigned long long BreakpointAddress;// Offset=0x0 Size=0x8
    unsigned long Flags;// Offset=0x8 Size=0x4
...
struct _DBGKD_GET_VERSION64// Size=0x28 (Id=1334)
{
...
struct _DBGKD_GET_SET_BUS_DATA// Size=0x14 (Id=639)
{
...
struct _DBGKD_FILL_MEMORY// Size=0x10 (Id=1455)
{
...
struct _DBGKD_QUERY_MEMORY// Size=0x18 (Id=713)
{
    unsigned long long Address;// Offset=0x0 Size=0x8
...
struct _DBGKD_SWITCH_PARTITION// Size=0x4 (Id=1309)
{
...
struct _DBGKD_WRITE_CUSTOM_BREAKPOINT// Size=0x18 (Id=712)
{
    unsigned long long BreakPointAddress;// Offset=0x0 Size=0x8
...
union _unnamed_364// Size=0x28 (Id=364)
{
...
struct _DBGKD_MANIPULATE_STATE64// Size=0x38 (Id=365)
{
    ...
    union _unnamed_364 u;// Offset=0x10 Size=0x28
};
