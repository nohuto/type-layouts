...
struct _MI_STORE_INPAGE_COMPLETE_FLAGS// Size=0x4 (Id=1787)
{
    union // Size=0x4 (Id=0)
    {
...
struct _MMINPAGE_FLAGS// Size=0x4 (Id=1225)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_983// Size=0x4 (Id=983)
{
...
struct _MMINPAGE_SUPPORT_FLOW_THROUGH// Size=0x38 (Id=1371)
{
...
struct _MMINPAGE_SUPPORT// Size=0x1c0 (Id=984)
{
    ...
    union _unnamed_981 u2;// Offset=0x68 Size=0x30
    ...
    union _unnamed_982 u3;// Offset=0xbc Size=0x4
    union _unnamed_983 u1;// Offset=0xc0 Size=0x4
