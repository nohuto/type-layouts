...
struct _PEP_WORK_ACTIVE_COMPLETE// Size=0x10 (Id=1808)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned long Component;// Offset=0x8 Size=0x4
};

struct _PEP_WORK_IDLE_STATE// Size=0x10 (Id=1777)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned long Component;// Offset=0x8 Size=0x4
...
struct _PEP_WORK_DEVICE_POWER// Size=0x10 (Id=1794)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned char PowerRequired;// Offset=0x8 Size=0x1
};

struct _PEP_WORK_POWER_CONTROL// Size=0x38 (Id=1793)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
...
struct _PEP_WORK_DEVICE_IDLE// Size=0x10 (Id=1835)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned char IgnoreIdleTimeout;// Offset=0x8 Size=0x1
};

struct _PEP_WORK_COMPLETE_IDLE_STATE// Size=0x10 (Id=1806)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned long Component;// Offset=0x8 Size=0x4
};

struct _PEP_WORK_COMPLETE_PERF_STATE// Size=0x10 (Id=1772)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned long Component;// Offset=0x8 Size=0x4
...
struct _PEP_WORK_ACPI_NOTIFY// Size=0x10 (Id=1753)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned long NotifyCode;// Offset=0x8 Size=0x4
};

struct _PEP_WORK_ACPI_EVALUATE_CONTROL_METHOD_COMPLETE// Size=0x28 (Id=1745)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
...
struct _PEP_WORK_INFORMATION// Size=0x40 (Id=1738)
{
