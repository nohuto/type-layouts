...
struct _MMVAD_FLAGS// Size=0x4 (Id=623)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long PrivateMemory:1;// Offset=0x0 Size=0x4 BitOffset=0xe BitSize=0x1
        unsigned long PrivateFixup:1;// Offset=0x0 Size=0x4 BitOffset=0xf BitSize=0x1
        unsigned long Graphics:1;// Offset=0x0 Size=0x4 BitOffset=0x10 BitSize=0x1
        unsigned long Enclave:1;// Offset=0x0 Size=0x4 BitOffset=0x11 BitSize=0x1
        unsigned long PageSize64K:1;// Offset=0x0 Size=0x4 BitOffset=0x12 BitSize=0x1
        unsigned long ShadowStack:1;// Offset=0x0 Size=0x4 BitOffset=0x13 BitSize=0x1
        unsigned long Spare:6;// Offset=0x0 Size=0x4 BitOffset=0x14 BitSize=0x6
        unsigned long HotPatchAllowed:1;// Offset=0x0 Size=0x4 BitOffset=0x1a BitSize=0x1
        unsigned long NoChange:1;// Offset=0x0 Size=0x4 BitOffset=0x1b BitSize=0x1
        unsigned long ManySubsections:1;// Offset=0x0 Size=0x4 BitOffset=0x1c BitSize=0x1
        unsigned long DeleteInProgress:1;// Offset=0x0 Size=0x4 BitOffset=0x1d BitSize=0x1
        unsigned long LockContended:1;// Offset=0x0 Size=0x4 BitOffset=0x1e BitSize=0x1
        unsigned long Lock:1;// Offset=0x0 Size=0x4 BitOffset=0x1f BitSize=0x1
    };
};

union _unnamed_255// Size=0x4 (Id=255)
{
...
struct _MMVAD_FLAGS1// Size=0x4 (Id=644)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MMVAD_SHORT// Size=0x40 (Id=257)
{
    ...
    union _unnamed_255 u;// Offset=0x30 Size=0x4
    union _unnamed_256 u1;// Offset=0x34 Size=0x4
    struct _MI_VAD_EVENT_BLOCK * EventList;// Offset=0x38 Size=0x8
};

struct _MMVAD_FLAGS2// Size=0x4 (Id=1444)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1421// Size=0x4 (Id=1421)
{
...
struct _MI_VAD_SEQUENTIAL_INFO// Size=0x8 (Id=1751)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _MMVAD// Size=0x88 (Id=1423)
{
    ...
    union _unnamed_1422 u4;// Offset=0x78 Size=0x8
