...
struct _MI_SYSTEM_CACHE_VIEW_ATTRIBUTES// Size=0x10 (Id=1294)
{
    struct // Size=0x10 (Id=0)
    {
        ...
        unsigned long long Spare:2;// Offset=0x0 Size=0x8 BitOffset=0x10 BitSize=0x2
        unsigned long long SectionOffset:48;// Offset=0x8 Size=0x8 BitOffset=0x0 BitSize=0x30
    };
};

struct _MI_REVERSE_VIEW_MAP// Size=0x30 (Id=1116)
{
    ...
    {
        struct _MI_SYSTEM_CACHE_VIEW_ATTRIBUTES SystemCacheAttributes;// Offset=0x20 Size=0x10
