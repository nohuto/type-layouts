...
struct _unnamed_1110// Size=0x4 (Id=1110)
{
...
union _unnamed_1111// Size=0x20 (Id=1111)
{
    union // Size=0x20 (Id=0)
    {
        struct _VF_TARGET_ALL_SHARED_EXPORT_THUNKS AllSharedExportThunks;// Offset=0x0 Size=0x20
        struct _unnamed_1110 Flags;// Offset=0x0 Size=0x4
    };
};

struct _VF_TARGET_DRIVER// Size=0x40 (Id=1112)
{
    struct _VF_AVL_TREE_NODE_EX TreeNode;// Offset=0x0 Size=0x18
    union _unnamed_1111 u1;// Offset=0x18 Size=0x20
