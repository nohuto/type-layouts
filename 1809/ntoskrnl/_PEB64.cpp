...
struct _STRING64// Size=0x10 (Id=1163)
{
...
struct _PEB64// Size=0x7c8 (Id=1313)
{
    ...
    unsigned long long FlsCallback;// Offset=0x320 Size=0x8
    struct LIST_ENTRY64 FlsListHead;// Offset=0x328 Size=0x10
    unsigned long long FlsBitmap;// Offset=0x338 Size=0x8
    ...
    unsigned long long pUnused;// Offset=0x368 Size=0x8
