...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=1169)
{
...
struct _KAPC_STATE// Size=0x30 (Id=1061)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=1122)
{
...
struct _GROUP_AFFINITY// Size=0x10 (Id=334)
{
...
struct _KAPC// Size=0x58 (Id=1010)
{
    unsigned char Type;// Offset=0x0 Size=0x1
...
struct _KLOCK_ENTRY_LOCK_STATE// Size=0x10 (Id=1191)
{
    union // Size=0x8 (Id=0)
    {
...
union _KLOCK_ENTRY_BOOST_BITMAP// Size=0x4 (Id=637)
{
...
struct _KLOCK_ENTRY// Size=0x60 (Id=619)
{
...
struct _KTHREAD// Size=0x5f0 (Id=65)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    ...
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long CetShadowStack:1;// Offset=0x74 Size=0x4 BitOffset=0x14 BitSize=0x1
            unsigned long Reserved:11;// Offset=0x74 Size=0x4 BitOffset=0x15 BitSize=0xb
        };
...
union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=1160)
{
...
struct _ETHREAD// Size=0x810 (Id=104)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long SamplingCoverage:1;// Offset=0x6d0 Size=0x4 BitOffset=0x17 BitSize=0x1
            unsigned long ReservedCrossThreadFlags:8;// Offset=0x6d0 Size=0x4 BitOffset=0x18 BitSize=0x8
        };
    };
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long WorkloadClass:1;// Offset=0x6d4 Size=0x4 BitOffset=0xb BitSize=0x1
            unsigned long ReservedSameThreadPassiveFlags:20;// Offset=0x6d4 Size=0x4 BitOffset=0xc BitSize=0x14
        };
    };
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x2 (Id=0)
        {
            ...
            unsigned char OwnsVadShared:1;// Offset=0x6d9 Size=0x1 BitOffset=0x5 BitSize=0x1
        };
    };
    ...
    unsigned long KernelStackReference;// Offset=0x714 Size=0x4
    ...
    void * CmThreadInfo;// Offset=0x7b8 Size=0x8
    union // Size=0x8 (Id=0)
    {
    ...
    unsigned long HeapData;// Offset=0x7e4 Size=0x4
