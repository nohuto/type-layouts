...
struct _KHETERO_PROCESSOR_SET// Size=0x18 (Id=671)
{
...
struct _KNODE// Size=0x180 (Id=91)
{
    ...
    unsigned long long NonIsrTargetedSet;// Offset=0x58 Size=0x8
    long ParkLock;// Offset=0x60 Size=0x4
    unsigned long Seed;// Offset=0x64 Size=0x4
    ...
    unsigned long long PpmConfiguredQosSets[4];// Offset=0x128 Size=0x20
};
...
struct _ENODE// Size=0x1c0 (Id=92)
{
