...
struct _EXT_IOMMU_DEVICE_ID_PCI// Size=0x10 (Id=1370)
{
    union // Size=0x8 (Id=0)
    {
...
struct _EXT_IOMMU_DEVICE_ID_ACPI// Size=0x8 (Id=1151)
{
    char * ObjectName;// Offset=0x0 Size=0x8
};

struct _EXT_IOMMU_DEVICE_ID_TEST// Size=0x8 (Id=1174)
{
    unsigned long long UniqueId;// Offset=0x0 Size=0x8
};

struct _EXT_IOMMU_DEVICE_ID_GIC// Size=0x4 (Id=1295)
{
    unsigned int LineNumber;// Offset=0x0 Size=0x4
};

struct _EXT_IOMMU_DEVICE_ID// Size=0x18 (Id=1023)
{
