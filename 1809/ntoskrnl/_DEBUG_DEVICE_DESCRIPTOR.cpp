struct _DEBUG_TRANSPORT_DATA// Size=0x8 (Id=1514)
{
    unsigned long HwContextSize;// Offset=0x0 Size=0x4
    unsigned char UseSerialFraming;// Offset=0x4 Size=0x1
    unsigned char ValidUSBCoreId;// Offset=0x5 Size=0x1
    unsigned char USBCoreId;// Offset=0x6 Size=0x1
};

struct _DEBUG_DEVICE_DESCRIPTOR// Size=0xf8 (Id=1071)
{
