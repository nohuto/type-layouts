struct _RTL_CRITICAL_SECTION// Size=0x28 (Id=950)
{
...
union _unnamed_475// Size=0x68 (Id=475)
{
    struct _RTL_CRITICAL_SECTION CriticalSection;// Offset=0x0 Size=0x28
    struct _ERESOURCE Resource;// Offset=0x0 Size=0x68
};

struct _HEAP_LOCK// Size=0x68 (Id=476)
{
    union _unnamed_475 Lock;// Offset=0x0 Size=0x68
};
