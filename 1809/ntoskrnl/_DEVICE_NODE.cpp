...
struct _PO_DEVICE_NOTIFY// Size=0x68 (Id=738)
{
...
struct _unnamed_327// Size=0x20 (Id=327)
{
...
struct _PO_DIRECTED_DRIPS_STATE// Size=0x38 (Id=711)
{
...
struct _DEVICE_NODE// Size=0x310 (Id=329)
{
    ...
    union _unnamed_324 OverUsed1;// Offset=0x210 Size=0x8
    union _unnamed_325 OverUsed2;// Offset=0x218 Size=0x8
    ...
    struct _unnamed_327 DockInfo;// Offset=0x238 Size=0x20
