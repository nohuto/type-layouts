...
struct _DISPATCHER_HEADER// Size=0x18 (Id=358)
{
    union // Size=0x4 (Id=0)
    {
...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=354)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=422)
{
...
struct _KPROCESS// Size=0x2d8 (Id=64)
{
    ...
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long ActiveGroupsMask:20;// Offset=0x1b8 Size=0x4 BitOffset=0xa BitSize=0x14
            unsigned long VaSpaceDeleted:1;// Offset=0x1b8 Size=0x4 BitOffset=0x1e BitSize=0x1
            unsigned long ReservedFlags:1;// Offset=0x1b8 Size=0x4 BitOffset=0x1f BitSize=0x1
        };
        long ProcessFlags;// Offset=0x1b8 Size=0x4
    };
    char BasePriority;// Offset=0x1bc Size=0x1
    char QuantumReset;// Offset=0x1bd Size=0x1
    char Visited;// Offset=0x1be Size=0x1
    ...
    unsigned long ReadyTime;// Offset=0x274 Size=0x4
    ...
    union _unnamed_63 SecureState;// Offset=0x2d0 Size=0x8
};
...
struct _EX_RUNDOWN_REF// Size=0x8 (Id=191)
{
    union // Size=0x8 (Id=0)
    {
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=505)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=533)
{
    union // Size=0x2 (Id=0)
    {
...
struct _MMSUPPORT_INSTANCE// Size=0xc0 (Id=464)
{
...
struct _MMSUPPORT_SHARED// Size=0x50 (Id=483)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=388)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=475)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WNF_STATE_NAME// Size=0x8 (Id=578)
{
    unsigned long Data[2];// Offset=0x0 Size=0x8
};

struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=373)
{
    unsigned long HighEdgeFilter;// Offset=0x0 Size=0x4
    unsigned long LowEdgeFilter;// Offset=0x4 Size=0x4
};

struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=367)
{
...
struct _unnamed_110// Size=0x4 (Id=110)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _unnamed_111// Size=0x4 (Id=111)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long CetShadowStacks:1;// Offset=0x0 Size=0x4 BitOffset=0xe BitSize=0x1
    };
};

struct _EPROCESS// Size=0x858 (Id=112)
{
    ...
    void * Spare0;// Offset=0x3e8 Size=0x8
    ...
    struct // Size=0x1 (Id=0)
    {
        unsigned char HangCount:3;// Offset=0x6cb Size=0x1 BitOffset=0x0 BitSize=0x3
        unsigned char GhostCount:3;// Offset=0x6cb Size=0x1 BitOffset=0x3 BitSize=0x3
        unsigned char PrefilterException:1;// Offset=0x6cb Size=0x1 BitOffset=0x6 BitSize=0x1
    };
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long EnableProcessSuspendResumeLogging:1;// Offset=0x6cc Size=0x4 BitOffset=0x13 BitSize=0x1
            unsigned long EnableThreadSuspendResumeLogging:1;// Offset=0x6cc Size=0x4 BitOffset=0x14 BitSize=0x1
            unsigned long SecurityDomainChanged:1;// Offset=0x6cc Size=0x4 BitOffset=0x15 BitSize=0x1
            unsigned long SecurityFreezeComplete:1;// Offset=0x6cc Size=0x4 BitOffset=0x16 BitSize=0x1
            unsigned long VmProcessorHost:1;// Offset=0x6cc Size=0x4 BitOffset=0x17 BitSize=0x1
        };
    };
    ...
    void * EnclaveTable;// Offset=0x718 Size=0x8
    unsigned long long EnclaveNumber;// Offset=0x720 Size=0x8
    struct _EX_PUSH_LOCK EnclaveLock;// Offset=0x728 Size=0x8
    unsigned long HighPriorityFaultsAllowed;// Offset=0x730 Size=0x4
    struct _PO_PROCESS_ENERGY_CONTEXT * EnergyContext;// Offset=0x738 Size=0x8
    void * VmContext;// Offset=0x740 Size=0x8
    unsigned long long SequenceNumber;// Offset=0x748 Size=0x8
    unsigned long long CreateInterruptTime;// Offset=0x750 Size=0x8
    unsigned long long CreateUnbiasedInterruptTime;// Offset=0x758 Size=0x8
    unsigned long long TotalUnbiasedFrozenTime;// Offset=0x760 Size=0x8
    unsigned long long LastAppStateUpdateTime;// Offset=0x768 Size=0x8
    struct // Size=0x8 (Id=0)
    {
        unsigned long long LastAppStateUptime:61;// Offset=0x770 Size=0x8 BitOffset=0x0 BitSize=0x3d
        unsigned long long LastAppState:3;// Offset=0x770 Size=0x8 BitOffset=0x3d BitSize=0x3
    };
    unsigned long long SharedCommitCharge;// Offset=0x778 Size=0x8
    struct _EX_PUSH_LOCK SharedCommitLock;// Offset=0x780 Size=0x8
    struct _LIST_ENTRY SharedCommitLinks;// Offset=0x788 Size=0x10
    union // Size=0x7a8 (Id=0)
    {
        unsigned long long AllowedCpuSets;// Offset=0x798 Size=0x8
        unsigned long long DefaultCpuSets;// Offset=0x7a0 Size=0x8
        unsigned long long * AllowedCpuSetsIndirect;// Offset=0x798 Size=0x8
        unsigned long long * DefaultCpuSetsIndirect;// Offset=0x7a0 Size=0x8
    };
    void * DiskIoAttribution;// Offset=0x7a8 Size=0x8
    void * DxgProcess;// Offset=0x7b0 Size=0x8
    unsigned long Win32KFilterSet;// Offset=0x7b8 Size=0x4
    union _PS_INTERLOCKED_TIMER_DELAY_VALUES ProcessTimerDelay;// Offset=0x7c0 Size=0x8
    unsigned long KTimerSets;// Offset=0x7c8 Size=0x4
    unsigned long KTimer2Sets;// Offset=0x7cc Size=0x4
    unsigned long ThreadTimerSets;// Offset=0x7d0 Size=0x4
    unsigned long long VirtualTimerListLock;// Offset=0x7d8 Size=0x8
    struct _LIST_ENTRY VirtualTimerListHead;// Offset=0x7e0 Size=0x10
    union // Size=0x8 (Id=0)
    {
        struct _WNF_STATE_NAME WakeChannel;// Offset=0x7f0 Size=0x8
        struct _PS_PROCESS_WAKE_INFORMATION WakeInfo;// Offset=0x7f0 Size=0x30
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags;// Offset=0x820 Size=0x4
        struct _unnamed_110 MitigationFlagsValues;// Offset=0x820 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x824 Size=0x4
        struct _unnamed_111 MitigationFlags2Values;// Offset=0x824 Size=0x4
    };
    void * PartitionObject;// Offset=0x828 Size=0x8
    unsigned long long SecurityDomain;// Offset=0x830 Size=0x8
    unsigned long long ParentSecurityDomain;// Offset=0x838 Size=0x8
    void * CoverageSamplerContext;// Offset=0x840 Size=0x8
    void * MmHotPatchContext;// Offset=0x848 Size=0x8
    unsigned long * PathRedirectionHashes;// Offset=0x850 Size=0x8
};
