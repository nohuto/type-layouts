...
struct _unnamed_420// Size=0x4 (Id=420)
{
...
union _KGDTENTRY64// Size=0x10 (Id=421)
{
    unsigned short LimitLow;// Offset=0x0 Size=0x2
    unsigned short BaseLow;// Offset=0x2 Size=0x2
    union // Size=0x4 (Id=0)
    {
        struct _unnamed_419 Bytes;// Offset=0x4 Size=0x4
        struct _unnamed_420 Bits;// Offset=0x4 Size=0x4
    };
