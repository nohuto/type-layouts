struct _RTL_CRITICAL_SECTION// Size=0x28 (Id=227)
{
...
union _unnamed_225// Size=0x28 (Id=225)
{
    struct _RTL_CRITICAL_SECTION CriticalSection;// Offset=0x0 Size=0x28
};

struct _HEAP_LOCK// Size=0x28 (Id=226)
{
    union _unnamed_225 Lock;// Offset=0x0 Size=0x28
};
