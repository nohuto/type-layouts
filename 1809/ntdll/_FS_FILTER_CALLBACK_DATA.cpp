...
struct _unnamed_708// Size=0x8 (Id=708)
{
...
struct _unnamed_713// Size=0x20 (Id=713)
{
...
struct _unnamed_714// Size=0x28 (Id=714)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=715)
{
    struct _unnamed_707 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_708 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_710 AcquireForSectionSynchronization;// Offset=0x0 Size=0x10
    struct _unnamed_712 NotifyStreamFileObject;// Offset=0x0 Size=0x10
    struct _unnamed_713 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_714 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=690)
{
