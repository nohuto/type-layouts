struct _RTL_HEAP_MEMORY_LIMIT_DATA// Size=0x20 (Id=312)
{
...
union _RTL_RUN_ONCE// Size=0x8 (Id=341)
{
...
struct _HEAP_OPPORTUNISTIC_LARGE_PAGE_STATS// Size=0x10 (Id=563)
{
...
struct _RTL_HP_SEG_ALLOC_POLICY// Size=0x18 (Id=417)
{
...
struct _HEAP_RUNTIME_MEMORY_STATS// Size=0x58 (Id=274)
{
...
union _unnamed_272// Size=0x1 (Id=272)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _HEAP_SEG_CONTEXT// Size=0xc0 (Id=273)
{
    ...
    union _unnamed_272 Flags;// Offset=0xd Size=0x1
...
struct _HEAP_VS_DELAY_FREE_CONTEXT// Size=0x10 (Id=382)
{
    union _SLIST_HEADER ListHead;// Offset=0x0 Size=0x10
};

struct _HEAP_SUBALLOCATOR_CALLBACKS// Size=0x28 (Id=211)
{
...
struct _HEAP_VS_CONTEXT// Size=0xc0 (Id=263)
{
...
struct _SEGMENT_HEAP// Size=0x800 (Id=278)
{
