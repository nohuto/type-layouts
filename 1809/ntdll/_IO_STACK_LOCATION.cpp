...
struct _unnamed_124// Size=0x18 (Id=124)
{
...
struct _unnamed_132// Size=0x20 (Id=132)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_133// Size=0x4 (Id=133)
{
    unsigned long Length;// Offset=0x0 Size=0x4
};
...
struct _unnamed_143// Size=0x8 (Id=143)
{
...
struct _unnamed_149// Size=0x8 (Id=149)
{
...
struct _unnamed_151// Size=0x1 (Id=151)
{
...
struct _unnamed_159// Size=0x4 (Id=159)
{
    enum _SYSTEM_POWER_STATE PowerState;// Offset=0x0 Size=0x4
};

struct _unnamed_160// Size=0x8 (Id=160)
{
    struct _POWER_SEQUENCE * PowerSequence;// Offset=0x0 Size=0x8
};

struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=437)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=410)
{
...
union _unnamed_167// Size=0x20 (Id=167)
{
    struct _unnamed_121 Create;// Offset=0x0 Size=0x20
    struct _unnamed_122 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_123 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_124 Read;// Offset=0x0 Size=0x18
    struct _unnamed_124 Write;// Offset=0x0 Size=0x18
    struct _unnamed_126 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_127 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_129 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_130 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_131 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_132 QueryEa;// Offset=0x0 Size=0x20
    struct _unnamed_133 SetEa;// Offset=0x0 Size=0x4
    struct _unnamed_135 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_135 SetVolume;// Offset=0x0 Size=0x10
    struct _unnamed_136 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_137 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_138 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_139 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_140 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_141 MountVolume;// Offset=0x0 Size=0x10
    struct _unnamed_141 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_143 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_144 QueryQuota;// Offset=0x0 Size=0x20
    struct _unnamed_133 SetQuota;// Offset=0x0 Size=0x4
    struct _unnamed_146 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_147 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_148 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_149 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_150 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_151 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_153 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_155 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_157 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_159 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_160 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_163 Power;// Offset=0x0 Size=0x20
    struct _unnamed_164 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_165 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_166 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=168)
{
    ...
    union _unnamed_167 Parameters;// Offset=0x8 Size=0x20
