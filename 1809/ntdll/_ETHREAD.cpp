...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=487)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=465)
{
...
struct _GROUP_AFFINITY// Size=0x10 (Id=300)
{
...
struct _CLIENT_ID// Size=0x10 (Id=305)
{
    void * UniqueProcess;// Offset=0x0 Size=0x8
    void * UniqueThread;// Offset=0x8 Size=0x8
};

struct _KSEMAPHORE// Size=0x20 (Id=435)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=484)
{
...
struct _PS_PROPERTY_SET// Size=0x18 (Id=337)
{
