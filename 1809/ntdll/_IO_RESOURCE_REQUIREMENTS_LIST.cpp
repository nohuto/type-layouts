...
struct _unnamed_629// Size=0x18 (Id=629)
{
...
struct _unnamed_631// Size=0x18 (Id=631)
{
...
struct _unnamed_633// Size=0x10 (Id=633)
{
...
struct _unnamed_635// Size=0x10 (Id=635)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_636// Size=0xc (Id=636)
{
...
struct _unnamed_637// Size=0x18 (Id=637)
{
...
struct _unnamed_638// Size=0x18 (Id=638)
{
...
struct _unnamed_639// Size=0x18 (Id=639)
{
...
union _unnamed_641// Size=0x18 (Id=641)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_629 Port;// Offset=0x0 Size=0x18
        struct _unnamed_629 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_631 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_632 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_633 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_629 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_634 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_635 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_636 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_637 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_638 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_639 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_640 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=642)
{
    ...
    union _unnamed_641 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=610)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=452)
{
