union _unnamed_373// Size=0x4 (Id=373)
{
...
struct _USB_DEVICE_CAPABILITY_USB20_EXTENSION_DESCRIPTOR// Size=0x7 (Id=374)
{
    ...
    union _unnamed_373 bmAttributes;// Offset=0x3 Size=0x4
};
