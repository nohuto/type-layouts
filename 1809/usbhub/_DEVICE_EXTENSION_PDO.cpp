...
struct _G_STATE_LOG_ENTRY// Size=0x20 (Id=187)
{
...
struct _STATE_CONTEXT// Size=0xb0 (Id=185)
{
...
union _USB_EXTENDED_PORT_ATTRIBUTES// Size=0x4 (Id=262)
{
...
struct _UNICODE_STRING// Size=0x10 (Id=131)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=261)
{
    union // Size=0x4 (Id=0)
    {
...
struct _WMILIB_CONTEXT// Size=0x40 (Id=353)
{
...
struct _USB_DEVICE_DESCRIPTOR// Size=0x12 (Id=211)
{
...
union _USBHUB_PDO_FLAGS// Size=0x4 (Id=256)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _HUBPDO_CLEANUP_FLAGS// Size=0x4 (Id=307)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_DEVICE_FLAGS// Size=0x4 (Id=251)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _IO_CSQ// Size=0x40 (Id=258)
{
...
struct _HUB_TIMER_OBJECT// Size=0x50 (Id=255)
{
...
struct _USB_ID_STRING// Size=0x10 (Id=345)
{
...
struct _USB_INTERFACE_DESCRIPTOR// Size=0x9 (Id=356)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
...
struct _KSEMAPHORE// Size=0x20 (Id=295)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _USB_HUB_DEVICE_UXD_SETTINGS// Size=0x44 (Id=246)
{
...
union _MSOS20_FLAGS// Size=0x4 (Id=318)
{
...
struct _MSOS20_INFO// Size=0x40 (Id=288)
{
...
struct _MSOS20_DESCRIPTOR_SET_INFO// Size=0x8 (Id=274)
{
...
struct _D3COLD_SUPPORT_INTERFACE// Size=0x48 (Id=293)
{
...
union _USB_DUAL_ROLE_FEATURES// Size=0x4 (Id=136)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct _unnamed_135 features;// Offset=0x0 Size=0x4
};

struct _DEVICE_EXTENSION_PDO// Size=0xbf8 (Id=169)
{
    ...
    wchar_t * DevicePersistedUsbRegPath;// Offset=0x478 Size=0x8
    enum _USB_DEVICE_HANDLE_STATE DeviceHandleState;// Offset=0x480 Size=0x4
    void * DeviceHandle;// Offset=0x488 Size=0x8
    enum _USB_DEVICE_SPEED Speed;// Offset=0x490 Size=0x4
    unsigned long CurrentPnpFunc;// Offset=0x494 Size=0x4
    unsigned long CurrentPowerFunc;// Offset=0x498 Size=0x4
    union _USB_EXTENDED_PORT_ATTRIBUTES PortAttributes;// Offset=0x49c Size=0x4
    struct _DEVICE_OBJECT * HubFdo;// Offset=0x4a0 Size=0x8
    enum _SYSTEM_POWER_STATE SystemWake;// Offset=0x4a8 Size=0x4
    struct _UNICODE_STRING SymbolicLinkName;// Offset=0x4b0 Size=0x10
    unsigned long long IoLock;// Offset=0x4c0 Size=0x8
    struct _LIST_ENTRY IoList;// Offset=0x4c8 Size=0x10
    struct _KEVENT IoRemoveEvent;// Offset=0x4d8 Size=0x18
    unsigned long IoRefCountNoRes;// Offset=0x4f0 Size=0x4
    struct _LIST_ENTRY LatchListHead;// Offset=0x4f8 Size=0x10
    unsigned long LatchCountNoRes;// Offset=0x508 Size=0x4
    struct _KEVENT LatchEvent;// Offset=0x510 Size=0x18
    struct _LIST_ENTRY PdoListLink;// Offset=0x528 Size=0x10
    struct _WMILIB_CONTEXT WmiLibInfo;// Offset=0x538 Size=0x40
    struct _USB_DEVICE_DESCRIPTOR DeviceDescriptor;// Offset=0x578 Size=0x12
    union _USBHUB_PDO_FLAGS PdoFlags;// Offset=0x58c Size=0x4
    union _HUBPDO_CLEANUP_FLAGS CleanupFlags;// Offset=0x590 Size=0x4
    unsigned short PortNumber;// Offset=0x594 Size=0x2
    union _USB_DEVICE_FLAGS DeviceFlags;// Offset=0x598 Size=0x4
    unsigned short PowerUpDelay;// Offset=0x59c Size=0x2
    long IdleStatus;// Offset=0x5a0 Size=0x4
    struct _LIST_ENTRY IdleIrpList;// Offset=0x5a8 Size=0x10
    struct _IO_CSQ IdleIrpCsq;// Offset=0x5b8 Size=0x40
    unsigned long long IdleIrpSpin;// Offset=0x5f8 Size=0x8
    enum _USB_IDLE_IRP_STATE IdleIrpState;// Offset=0x600 Size=0x4
    struct _HUB_TIMER_OBJECT IdleRetryTimer;// Offset=0x608 Size=0x50
    struct _HUB_TIMER_OBJECT D0WakeRetryTimer;// Offset=0x658 Size=0x50
    struct _HUB_TIMER_OBJECT DriverNotFoundTimer;// Offset=0x6a8 Size=0x50
    unsigned long IdleReadyState;// Offset=0x6f8 Size=0x4
    unsigned long IdleIrpLogIdx;// Offset=0x6fc Size=0x4
    struct _G_STATE_LOG_ENTRY IdleIrpLog[8];// Offset=0x700 Size=0x100
    unsigned long long IdleIrpStateSpin;// Offset=0x800 Size=0x8
    struct _KEVENT IdleIrpCancelLock;// Offset=0x808 Size=0x18
    struct _USB_ID_STRING PnpDeviceId;// Offset=0x820 Size=0x10
    struct _USB_ID_STRING PnpHardwareId;// Offset=0x830 Size=0x10
    struct _USB_ID_STRING PnpCompatibleId;// Offset=0x840 Size=0x10
    struct _USB_ID_STRING SerialNumberId;// Offset=0x850 Size=0x10
    struct _USB_ID_STRING UniqueId;// Offset=0x860 Size=0x10
    struct _USB_ID_STRING ProductId;// Offset=0x870 Size=0x10
    struct _USB_ID_STRING SupportedLanguageIds;// Offset=0x880 Size=0x10
    struct _USB_ID_STRING GenericDevString;// Offset=0x890 Size=0x10
    struct _USB_ID_STRING FriendlyNameIdString;// Offset=0x8a0 Size=0x10
    struct _USB_ID_STRING TextLocationIdString;// Offset=0x8b0 Size=0x10
    wchar_t * PnPDeviceDescription;// Offset=0x8c0 Size=0x8
    unsigned long PnPDeviceDescriptionLength;// Offset=0x8c8 Size=0x4
    void * ReplicantPdo;// Offset=0x8d0 Size=0x8
    struct _LIST_ENTRY WakeIrpList;// Offset=0x8d8 Size=0x10
    struct _IO_CSQ WakeIrpCsq;// Offset=0x8e8 Size=0x40
    unsigned long long WakeIrpSpin;// Offset=0x928 Size=0x8
    long WakeIrpPending;// Offset=0x930 Size=0x4
    struct _KEVENT DeviceD0Event;// Offset=0x938 Size=0x18
    enum _USB_VBUS_STATE VbusState;// Offset=0x950 Size=0x4
    unsigned long HardErrorCount;// Offset=0x954 Size=0x4
    struct _USB_CONFIGURATION_DESCRIPTOR * CachedConfigDescriptor;// Offset=0x958 Size=0x8
    struct _USB_BOS_DESCRIPTOR * BosDescriptor;// Offset=0x960 Size=0x8
    struct _USB_DEVICE_CAPABILITY_BILLBOARD_DESCRIPTOR * BillboardDescriptor;// Offset=0x968 Size=0x8
    struct _UNICODE_STRING BillboardSymbolicLinkName;// Offset=0x970 Size=0x10
    unsigned char BillboardDeviceInterfaceCreated;// Offset=0x980 Size=0x1
    struct _USB_INTERFACE_DESCRIPTOR CompatIdInterfaceDescriptor;// Offset=0x981 Size=0x9
    wchar_t DeviceDescription[40];// Offset=0x98a Size=0x50
    struct _MS_EXT_CONFIG_DESC * MsExtConfigDesc;// Offset=0x9e0 Size=0x8
    union _LARGE_INTEGER Stat_PdoEnumeratedAt;// Offset=0x9e8 Size=0x8
    union _LARGE_INTEGER Stat_PdoCreatedAt;// Offset=0x9f0 Size=0x8
    union _LARGE_INTEGER Stat_Pdo_SetD0_StartAt;// Offset=0x9f8 Size=0x8
    union _LARGE_INTEGER Stat_Pdo_SetD0_CompleteAt;// Offset=0xa00 Size=0x8
    struct _KSEMAPHORE UxdLock;// Offset=0xa08 Size=0x20
    struct _USB_HUB_DEVICE_UXD_SETTINGS UxdSettings;// Offset=0xa28 Size=0x44
    struct _UNICODE_STRING PhysicalDeviceObjectName;// Offset=0xa70 Size=0x10
    struct _USB_PORT_PATH PortPath;// Offset=0xa80 Size=0x1c
    struct _GUID ContainerID;// Offset=0xa9c Size=0x10
    unsigned char ContainerIDValid;// Offset=0xaac Size=0x1
    unsigned char DeviceSelectiveSuspended;// Offset=0xaad Size=0x1
    unsigned long InPathCount;// Offset=0xab0 Size=0x4
    unsigned char IsBootDevice;// Offset=0xab4 Size=0x1
    unsigned char ResetCompleteWithoutFailingIO;// Offset=0xab5 Size=0x1
    unsigned long BootDeviceConnectChangeBitExpected;// Offset=0xab8 Size=0x4
    unsigned long BootDeviceConnectBitExpected;// Offset=0xabc Size=0x4
    void * ExBootDeviceHandle;// Offset=0xac0 Size=0x8
    struct _KEVENT BootDeviceArrivalEvent;// Offset=0xac8 Size=0x18
    struct _IRP * PendingResetPortAsyncIrp;// Offset=0xae0 Size=0x8
    struct _IRP * PendingResetNotificationRequestIrp;// Offset=0xae8 Size=0x8
    unsigned long HibernateCount;// Offset=0xaf0 Size=0x4
    union _USB_DEVICE_SQM_PROPERTIES SqmProperties;// Offset=0xaf4 Size=0x4
    unsigned long long GlobalListStateLock;// Offset=0xaf8 Size=0x8
    enum _GLOBAL_LIST_ENTRY_STATE GlobalListState;// Offset=0xb00 Size=0x4
    unsigned long EnumFailureMsgId;// Offset=0xb04 Size=0x4
    struct _MSOS20_INFO MsOs20Info;// Offset=0xb08 Size=0x40
    struct _MSOS20_DESCRIPTOR_SET_INFO CachedMsOs20DeviceInfo;// Offset=0xb48 Size=0x8
    struct _KEVENT DriverNotFoundLock;// Offset=0xb50 Size=0x18
    struct _KEVENT D3ColdReconnectEvent;// Offset=0xb68 Size=0x18
    struct _KEVENT D3ColdLock;// Offset=0xb80 Size=0x18
    long D3ColdReconnectTimeout;// Offset=0xb98 Size=0x4
    struct _D3COLD_SUPPORT_INTERFACE D3ColdFilter;// Offset=0xba0 Size=0x48
    union _USB_DUAL_ROLE_FEATURES UsbDualRoleFeatures;// Offset=0xbe8 Size=0x4
    unsigned long long UcmConnectorId;// Offset=0xbf0 Size=0x8
};
