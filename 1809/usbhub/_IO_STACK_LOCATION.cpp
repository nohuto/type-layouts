...
struct _unnamed_46// Size=0x18 (Id=46)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _unnamed_50// Size=0x4 (Id=50)
{
    unsigned long Length;// Offset=0x0 Size=0x4
};
...
struct _unnamed_63// Size=0x4 (Id=63)
{
...
struct _unnamed_69// Size=0x1 (Id=69)
{
...
struct _unnamed_77// Size=0x4 (Id=77)
{
...
struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=296)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=189)
{
...
struct _unnamed_82// Size=0x10 (Id=82)
{
...
union _unnamed_85// Size=0x20 (Id=85)
{
    ...
    struct _unnamed_46 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_47 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_48 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_49 QueryEa;// Offset=0x0 Size=0x20
    struct _unnamed_50 SetEa;// Offset=0x0 Size=0x4
    struct _unnamed_52 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_52 SetVolume;// Offset=0x0 Size=0x10
    struct _unnamed_53 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_54 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_55 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_56 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_57 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_58 MountVolume;// Offset=0x0 Size=0x10
    struct _unnamed_58 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_60 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_61 QueryQuota;// Offset=0x0 Size=0x20
    struct _unnamed_50 SetQuota;// Offset=0x0 Size=0x4
    struct _unnamed_63 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_65 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_66 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_67 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_68 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_69 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_71 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_73 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_75 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_77 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_78 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_81 Power;// Offset=0x0 Size=0x20
    struct _unnamed_82 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_83 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_84 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=86)
{
    ...
    union _unnamed_85 Parameters;// Offset=0x8 Size=0x20
