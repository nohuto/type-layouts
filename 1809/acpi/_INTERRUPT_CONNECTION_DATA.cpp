...
struct _unnamed_596// Size=0x8 (Id=596)
{
...
struct _unnamed_629// Size=0x4 (Id=629)
{
    struct // Size=0x4 (Id=0)
    {
...
{
    struct _unnamed_629 bits;// Offset=0x0 Size=0x4
...
struct _INTERRUPT_HT_INTR_INFO// Size=0x8 (Id=633)
{
    union _unnamed_630 LowPart;// Offset=0x0 Size=0x4
    union _unnamed_632 HighPart;// Offset=0x4 Size=0x4
};
...
struct _INTERRUPT_VECTOR_DATA// Size=0x58 (Id=600)
{
    ...
    struct _unnamed_596 ControllerInput;// Offset=0x38 Size=0x8
    unsigned long long HvDeviceId;// Offset=0x40 Size=0x8
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_597 XapicMessage;// Offset=0x48 Size=0x10
        struct _unnamed_598 Hypertransport;// Offset=0x48 Size=0x8
        struct _unnamed_597 GenericMessage;// Offset=0x48 Size=0x10
        struct _unnamed_599 MessageRequest;// Offset=0x48 Size=0x4
    };
};

struct _INTERRUPT_CONNECTION_DATA// Size=0x60 (Id=672)
{
