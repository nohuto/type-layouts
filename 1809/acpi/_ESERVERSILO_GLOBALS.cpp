struct _OBP_SYSTEM_DOS_DEVICE_STATE// Size=0x6c (Id=643)
{
...
struct _OBJECT_NAMESPACE_LOOKUPTABLE// Size=0x260 (Id=703)
{
...
struct _OBP_SILODRIVERSTATE// Size=0x2e0 (Id=626)
{
...
struct _SEP_SILOSTATE// Size=0x30 (Id=515)
{
...
struct _SEP_RM_LSA_CONNECTION_STATE// Size=0x50 (Id=555)
{
...
struct _WNF_LOCK// Size=0x8 (Id=645)
{
    struct _EX_PUSH_LOCK PushLock;// Offset=0x0 Size=0x8
};

struct _WNF_SILODRIVERSTATE// Size=0x38 (Id=608)
{
...
struct _DBGK_SILOSTATE// Size=0x20 (Id=593)
{
...
struct _CRITICAL_PROCESS_EXCEPTION_DATA// Size=0x30 (Id=612)
{
...
struct _ESERVERSILO_GLOBALS// Size=0x4d8 (Id=506)
{
    ...
    struct _DBGK_SILOSTATE DbgkSiloState;// Offset=0x3c0 Size=0x20
    struct _UNICODE_STRING PsProtectedCurrentDirectory;// Offset=0x3e0 Size=0x10
    struct _UNICODE_STRING PsProtectedEnvironment;// Offset=0x3f0 Size=0x10
    void * ApiSetSection;// Offset=0x400 Size=0x8
    void * ApiSetSchema;// Offset=0x408 Size=0x8
    unsigned char OneCoreForwardersEnabled;// Offset=0x410 Size=0x1
    unsigned char TzVirtualizationSupported;// Offset=0x411 Size=0x1
    void * ImgFileExecOptions;// Offset=0x418 Size=0x8
    struct _EX_TIMEZONE_STATE * ExTimeZoneState;// Offset=0x420 Size=0x8
    struct _UNICODE_STRING NtSystemRoot;// Offset=0x428 Size=0x10
    struct _UNICODE_STRING SiloRootDirectoryName;// Offset=0x438 Size=0x10
    struct _PSP_STORAGE * Storage;// Offset=0x448 Size=0x8
    enum _SERVERSILO_STATE State;// Offset=0x450 Size=0x4
    long ExitStatus;// Offset=0x454 Size=0x4
    struct _KEVENT * DeleteEvent;// Offset=0x458 Size=0x8
    struct _SILO_USER_SHARED_DATA * UserSharedData;// Offset=0x460 Size=0x8
    void * UserSharedSection;// Offset=0x468 Size=0x8
    struct _WORK_QUEUE_ITEM TerminateWorkItem;// Offset=0x470 Size=0x20
    long CriticalProcessExited;// Offset=0x490 Size=0x4
    long CriticalProcessStatus;// Offset=0x494 Size=0x4
    unsigned char CriticalProcessName[15];// Offset=0x498 Size=0xf
    struct _CRITICAL_PROCESS_EXCEPTION_DATA CriticalProcessExceptionData;// Offset=0x4a8 Size=0x30
};
