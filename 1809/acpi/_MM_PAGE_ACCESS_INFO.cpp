struct _unnamed_296// Size=0x4 (Id=296)
{
...
struct _unnamed_297// Size=0x4 (Id=297)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long FilePointerIndex:9;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x9
...
union _MM_PAGE_ACCESS_INFO_FLAGS// Size=0x4 (Id=298)
{
    struct _unnamed_296 File;// Offset=0x0 Size=0x4
    struct _unnamed_297 Private;// Offset=0x0 Size=0x4
};

struct _MM_PAGE_ACCESS_INFO// Size=0x8 (Id=295)
{
    union // Size=0x8 (Id=0)
    {
