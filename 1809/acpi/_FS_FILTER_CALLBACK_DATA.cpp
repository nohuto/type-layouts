struct _unnamed_691// Size=0x10 (Id=691)
{
...
struct _unnamed_697// Size=0x20 (Id=697)
{
...
struct _unnamed_698// Size=0x28 (Id=698)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=699)
{
    struct _unnamed_691 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_692 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_694 AcquireForSectionSynchronization;// Offset=0x0 Size=0x10
    struct _unnamed_696 NotifyStreamFileObject;// Offset=0x0 Size=0x10
    struct _unnamed_697 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_698 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=668)
{
