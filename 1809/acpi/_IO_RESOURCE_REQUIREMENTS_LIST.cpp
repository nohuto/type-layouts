...
struct _unnamed_576// Size=0x10 (Id=576)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_578// Size=0x18 (Id=578)
{
...
struct _unnamed_579// Size=0x18 (Id=579)
{
...
struct _unnamed_580// Size=0x18 (Id=580)
{
...
union _unnamed_582// Size=0x18 (Id=582)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_570 Port;// Offset=0x0 Size=0x18
        struct _unnamed_570 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_572 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_573 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_574 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_570 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_575 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_576 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_577 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_578 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_579 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_580 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_581 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=583)
{
    ...
    union _unnamed_582 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=542)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=351)
{
