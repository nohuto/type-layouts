...
struct _unnamed_649// Size=0x8 (Id=649)
{
...
struct _unnamed_650// Size=0x8 (Id=650)
{
...
struct _ACPI_POWER_WAKE_INTERRUPT_REGISTRATION_ENTRY// Size=0x28 (Id=667)
{
...
union _unnamed_651// Size=0x28 (Id=651)
{
...
struct _unnamed_652// Size=0x58 (Id=652)
{
    enum _SYSTEM_POWER_STATE SystemPowerState;// Offset=0x0 Size=0x4
    ...
    union _unnamed_651 Registrations;// Offset=0x30 Size=0x28
};

struct _unnamed_653// Size=0x4 (Id=653)
{
    enum _SYSTEM_POWER_STATE EjectPowerState;// Offset=0x0 Size=0x4
};

union _unnamed_654// Size=0x58 (Id=654)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_649 DevicePowerRequest;// Offset=0x0 Size=0x8
        struct _unnamed_650 SystemPowerRequest;// Offset=0x0 Size=0x8
        struct _unnamed_652 WaitWakeRequest;// Offset=0x0 Size=0x58
        struct _unnamed_653 EjectPowerRequest;// Offset=0x0 Size=0x4
    };
};
...
struct _ACPI_POWER_REQUEST// Size=0x108 (Id=655)
{
    ...
    union _unnamed_654 u;// Offset=0x68 Size=0x58
