...
{
    struct _unnamed_47 IndividualAddress;// Offset=0x0 Size=0x10
    struct _unnamed_48 SingleContext;// Offset=0x0 Size=0x10
    struct _unnamed_49 AllContextAndGlobals;// Offset=0x0 Size=0x10
    struct _unnamed_49 AllContext;// Offset=0x0 Size=0x10
};
