...
struct _unnamed_278// Size=0x4 (Id=278)
{
...
{
    struct _unnamed_278 Parallel;// Offset=0x0 Size=0x4
};

struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=280)
{
    ...
    union _unnamed_279 Settings;// Offset=0x50 Size=0x4
