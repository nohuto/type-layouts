union _PDO_FLAGS// Size=0x4 (Id=638)
{
...
struct _ISM_STATE_LOG// Size=0x8 (Id=532)
{
...
struct _ISM_CONTEXT// Size=0xc0 (Id=438)
{
...
struct _D3COLD_SUPPORT_INTERFACE// Size=0x48 (Id=550)
{
...
struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=508)
{
...
struct _IO_REMOVE_LOCK// Size=0x20 (Id=424)
{
    struct _IO_REMOVE_LOCK_COMMON_BLOCK Common;// Offset=0x0 Size=0x20
};

struct _DEVICE_RESET_INTERFACE_STANDARD// Size=0x38 (Id=467)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
struct _HUB_PDO_CONTEXT// Size=0x210 (Id=359)
{
    ...
    struct _DEVICE_RESET_INTERFACE_STANDARD ResetInterface;// Offset=0x1c8 Size=0x38
    unsigned char RequestingPlatformLevelDeviceReset;// Offset=0x200 Size=0x1
    struct WDFWORKITEM__ * ResetActionWorkItem;// Offset=0x208 Size=0x8
};
