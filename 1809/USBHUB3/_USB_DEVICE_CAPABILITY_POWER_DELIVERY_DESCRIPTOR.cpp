union _unnamed_669// Size=0x4 (Id=669)
{
...
struct _USB_DEVICE_CAPABILITY_POWER_DELIVERY_DESCRIPTOR// Size=0x12 (Id=670)
{
    ...
    union _unnamed_669 bmAttributes;// Offset=0x4 Size=0x4
