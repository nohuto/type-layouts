...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=639)
{
    union // Size=0x4 (Id=0)
    {
...
union _unnamed_261// Size=0x8 (Id=261)
{
...
{
    union _unnamed_261 Argument1;// Offset=0x0 Size=0x8
    union _unnamed_261 Argument2;// Offset=0x8 Size=0x8
    union _unnamed_261 Argument3;// Offset=0x10 Size=0x8
    union _unnamed_261 Argument4;// Offset=0x18 Size=0x8
};

struct _unnamed_264// Size=0x8 (Id=264)
{
    struct _WDF_USB_REQUEST_COMPLETION_PARAMS * Completion;// Offset=0x0 Size=0x8
};

union _unnamed_265// Size=0x30 (Id=265)
{
    union // Size=0x30 (Id=0)
    {
        struct _unnamed_257 Write;// Offset=0x0 Size=0x18
        struct _unnamed_257 Read;// Offset=0x0 Size=0x18
        struct _unnamed_260 Ioctl;// Offset=0x0 Size=0x30
        struct _unnamed_262 Others;// Offset=0x0 Size=0x20
        struct _unnamed_264 Usb;// Offset=0x0 Size=0x8
    };
};

struct _WDF_REQUEST_COMPLETION_PARAMS// Size=0x48 (Id=266)
{
    unsigned long Size;// Offset=0x0 Size=0x4
    enum _WDF_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    struct _IO_STATUS_BLOCK IoStatus;// Offset=0x8 Size=0x10
    union _unnamed_265 Parameters;// Offset=0x18 Size=0x30
};
