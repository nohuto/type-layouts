union _unnamed_565// Size=0x2 (Id=565)
{
...
struct _USB_DEVICE_CAPABILITY_PD_CONSUMER_PORT_DESCRIPTOR// Size=0x18 (Id=566)
{
    ...
    union _unnamed_565 bmCapabilities;// Offset=0x4 Size=0x2
