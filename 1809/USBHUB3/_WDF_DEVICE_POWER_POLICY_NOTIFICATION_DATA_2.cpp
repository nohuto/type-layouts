...
struct _unnamed_446// Size=0x8 (Id=446)
{
...
union _unnamed_448// Size=0x8 (Id=448)
{
    struct _unnamed_446 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_447 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_446 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=449)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_448 Data;// Offset=0x4 Size=0x8
};
