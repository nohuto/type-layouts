...
struct _unnamed_475// Size=0x8 (Id=475)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_476// Size=0x4 (Id=476)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_477// Size=0x8 (Id=477)
{
    struct _unnamed_475 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_476 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_475 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=478)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_477 Data;// Offset=0x4 Size=0x8
};
