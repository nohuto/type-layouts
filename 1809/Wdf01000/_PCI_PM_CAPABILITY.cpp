...
struct _PCI_PMCSR_BSE// Size=0x1 (Id=4022)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _PCI_PM_CAPABILITY// Size=0x8 (Id=1634)
{
    union // Size=0x6 (Id=0)
    {
        struct _PCI_CAPABILITIES_HEADER Header;// Offset=0x0 Size=0x2
        union <unnamed-type-PMC>// Size=0x2 (Id=13459)
        {
