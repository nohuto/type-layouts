...
struct _FX_DRIVER_TRACKER_CACHE_AWARE// Size=0x18 (Id=1263)
{
    union // Size=0x1e6 (Id=0)
    {
        struct _FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=9670)
        {
        ...
        struct FX_DRIVER_TRACKER_ENTRY// Size=0x8 (Id=9684)
        {
        };// Offset=0x0 Size=0x8
        long Initialize();
        void Uninitialize();
        long Register(struct _FX_DRIVER_GLOBALS * );// Offset=0x0 Size=0x1e6
...
struct _WMI_WDF_NOTIFY_ROUTINES// Size=0x20 (Id=1015)
{
...
struct FxLibraryGlobalsType// Size=0x2a8 (Id=1283)
{
