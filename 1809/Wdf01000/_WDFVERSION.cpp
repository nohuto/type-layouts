...
struct _WDFSTRUCTURES// Size=0x280 (Id=941)
{
...
struct _WDFVERSION// Size=0x10b8 (Id=990)
{
    unsigned long Size;// Offset=0x0 Size=0x4
    unsigned long FuncCount;// Offset=0x4 Size=0x4
    struct _WDFFUNCTIONS Functions;// Offset=0x8 Size=0xe28
    unsigned long StructCount;// Offset=0xe30 Size=0x4
    struct _WDFSTRUCTURES Structures;// Offset=0xe38 Size=0x280
};
