...
struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA_V1_23// Size=0xc (Id=4811)
{
    union // Size=0x4 (Id=0)
    {
        enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
        union <unnamed-type-Data>// Size=0x8 (Id=19818)
        {
            struct <unnamed-type-EnterState>// Size=0x8 (Id=19819)
            {
            ...
            struct <unnamed-type-PostProcessState>// Size=0x4 (Id=19823)
            {
                enum _WDF_DEVICE_POWER_POLICY_STATE CurrentState;// Offset=0x0 Size=0x4
            };
            ...
            struct <unnamed-type-LeaveState>// Size=0x8 (Id=19826)
            {
                enum _WDF_DEVICE_POWER_POLICY_STATE CurrentState;// Offset=0x0 Size=0x4
                enum _WDF_DEVICE_POWER_POLICY_STATE NewState;// Offset=0x4 Size=0x4
            };
