...
struct FxCollectionInternal// Size=0x18 (Id=1150)
{
    union // Size=0x6c (Id=0)
    {
        ...
        void ~FxCollectionInternal();
        class FxCollectionEntry * FindEntry(unsigned long );// Offset=0x0 Size=0x28
        class FxCollectionEntry * FindEntryByObject(class FxObject * );
        unsigned long Count();
        unsigned char Add(struct _FX_DRIVER_GLOBALS * ,class FxObject * );// Offset=0x0 Size=0x6c
        class FxObject * GetItem(unsigned long );
        class FxObject * GetFirstItem();
        class FxObject * GetLastItem();
        long Remove(unsigned long );// Offset=0x0 Size=0x28
