...
struct _WDF_MEMORY_DESCRIPTOR_V1_25// Size=0x18 (Id=3100)
{
    union // Size=0x4 (Id=0)
    {
        enum _WDF_MEMORY_DESCRIPTOR_TYPE Type;// Offset=0x0 Size=0x4
        union <unnamed-type-u>// Size=0x10 (Id=22286)
        {
    ...
    union _WDF_MEMORY_DESCRIPTOR_V1_25::<unnamed-type-u> u;// Offset=0x8 Size=0x10
};
