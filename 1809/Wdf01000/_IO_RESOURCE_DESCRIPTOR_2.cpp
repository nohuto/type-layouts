...
struct _unnamed_31// Size=0x18 (Id=31)
{
...
struct _unnamed_34// Size=0x8 (Id=34)
{
...
struct _unnamed_37// Size=0xc (Id=37)
{
...
union _unnamed_41// Size=0x18 (Id=41)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_31 Port;// Offset=0x0 Size=0x18
        struct _unnamed_31 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_33 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_34 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_35 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_31 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_17 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_36 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_37 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_38 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_39 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_40 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_23 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=657)
{
    union // Size=0x8 (Id=0)
    {
