struct _WDF_CLASS_VERSION_V1_13// Size=0xc (Id=5317)
{
...
struct _WDF_CLASS_LIBRARY_INFO_V1_13// Size=0x30 (Id=2161)
{
    unsigned long Size;// Offset=0x0 Size=0x4
    struct _WDF_CLASS_VERSION_V1_13 Version;// Offset=0x4 Size=0xc
