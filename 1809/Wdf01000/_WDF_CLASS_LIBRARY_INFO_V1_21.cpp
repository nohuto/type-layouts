struct _WDF_CLASS_VERSION_V1_21// Size=0xc (Id=4704)
{
...
struct _WDF_CLASS_LIBRARY_INFO_V1_21// Size=0x30 (Id=3716)
{
    unsigned long Size;// Offset=0x0 Size=0x4
    struct _WDF_CLASS_VERSION_V1_21 Version;// Offset=0x4 Size=0xc
