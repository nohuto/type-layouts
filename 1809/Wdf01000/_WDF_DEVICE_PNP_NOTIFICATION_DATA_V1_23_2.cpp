...
struct _WDF_DEVICE_PNP_NOTIFICATION_DATA_V1_23// Size=0xc (Id=2631)
{
    union // Size=0x4 (Id=0)
    {
        enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
        union <unnamed-type-Data>// Size=0x8 (Id=19058)
        {
            struct <unnamed-type-EnterState>// Size=0x8 (Id=19059)
            {
                enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
                enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
            };
            struct _WDF_DEVICE_PNP_NOTIFICATION_DATA_V1_23::<unnamed-type-Data>::<unnamed-type-EnterState> EnterState;// Offset=0x0 Size=0x8
            struct <unnamed-type-PostProcessState>// Size=0x4 (Id=19063)
            {
                enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
            };
            struct _WDF_DEVICE_PNP_NOTIFICATION_DATA_V1_23::<unnamed-type-Data>::<unnamed-type-PostProcessState> PostProcessState;// Offset=0x0 Size=0x4
            struct <unnamed-type-LeaveState>// Size=0x8 (Id=19066)
            {
                enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
                enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
            };
            struct _WDF_DEVICE_PNP_NOTIFICATION_DATA_V1_23::<unnamed-type-Data>::<unnamed-type-LeaveState> LeaveState;// Offset=0x0 Size=0x8
        };
    };
    union _WDF_DEVICE_PNP_NOTIFICATION_DATA_V1_23::<unnamed-type-Data> Data;// Offset=0x4 Size=0x8
};
