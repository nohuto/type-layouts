struct _VF_COMMON_CONTEXT_HEADER// Size=0x8 (Id=5384)
{
...
struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=1165)
{
    union // Size=0x50 (Id=0)
    {
        ...
        union <unnamed-type-Settings>// Size=0x4 (Id=21488)
        {
            struct <unnamed-type-Parallel>// Size=0x4 (Id=21489)
            {
...
struct _VF_WDFIOQUEUECREATE_CONTEXT// Size=0x68 (Id=5381)
{
