struct _WDF_CLASS_VERSION_V1_17// Size=0xc (Id=2601)
{
...
struct _WDF_CLASS_LIBRARY_INFO_V1_17// Size=0x30 (Id=4715)
{
    unsigned long Size;// Offset=0x0 Size=0x4
    struct _WDF_CLASS_VERSION_V1_17 Version;// Offset=0x4 Size=0xc
