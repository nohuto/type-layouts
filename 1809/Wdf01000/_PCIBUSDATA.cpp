struct _PCI_SLOT_NUMBER// Size=0x4 (Id=5135)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-u>// Size=0x4 (Id=13536)
        {
            struct <unnamed-type-bits>// Size=0x4 (Id=13537)
            {
...
struct _PCIBUSDATA// Size=0x50 (Id=3184)
{
