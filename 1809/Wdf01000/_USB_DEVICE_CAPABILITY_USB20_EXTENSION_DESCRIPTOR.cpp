struct _USB_DEVICE_CAPABILITY_USB20_EXTENSION_DESCRIPTOR// Size=0x7 (Id=4900)
{
    union // Size=0x3 (Id=0)
    {
        ...
        union <unnamed-type-bmAttributes>// Size=0x4 (Id=17562)
        {
    ...
    union _USB_DEVICE_CAPABILITY_USB20_EXTENSION_DESCRIPTOR::<unnamed-type-bmAttributes> bmAttributes;// Offset=0x3 Size=0x4
};
