...
struct _WDF_IO_FORWARD_PROGRESS_RESERVED_POLICY_SETTINGS// Size=0x8 (Id=793)
{
    union // Size=0x8 (Id=0)
    {
        union <unnamed-type-Policy>// Size=0x8 (Id=21439)
        {
            struct <unnamed-type-ExaminePolicy>// Size=0x8 (Id=21440)
            {
...
struct _WDF_IO_QUEUE_FORWARD_PROGRESS_POLICY_V1_11// Size=0x28 (Id=1726)
{
