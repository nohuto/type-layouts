...
union _WHEA_PROCESSOR_GENERIC_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=5039)
{
...
struct _WHEA_PROCESSOR_GENERIC_ERROR_SECTION// Size=0xc0 (Id=1844)
{
...
union _WHEA_MEMORY_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=4816)
{
    struct // Size=0x8 (Id=0)
    {
...
union _WHEA_ERROR_STATUS// Size=0x8 (Id=4079)
{
...
struct _WHEA_MEMORY_ERROR_SECTION// Size=0x50 (Id=1703)
{
...
union _WHEA_NMI_ERROR_SECTION_FLAGS// Size=0x4 (Id=2617)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _WHEA_NMI_ERROR_SECTION// Size=0xc (Id=2759)
{
    unsigned char Data[8];// Offset=0x0 Size=0x8
    union _WHEA_NMI_ERROR_SECTION_FLAGS Flags;// Offset=0x8 Size=0x4
};

union _WHEA_PCIEXPRESS_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=2686)
{
    struct // Size=0x8 (Id=0)
    {
...
union _WHEA_PCIEXPRESS_VERSION// Size=0x4 (Id=2053)
{
...
union _WHEA_PCIEXPRESS_COMMAND_STATUS// Size=0x4 (Id=4846)
{
...
union _WHEA_PCIEXPRESS_BRIDGE_CONTROL_STATUS// Size=0x4 (Id=1798)
{
...
struct _WHEA_PCIEXPRESS_ERROR_SECTION// Size=0xd0 (Id=4222)
{
...
union _WHEA_PCIXBUS_ID// Size=0x2 (Id=2469)
{
...
union _WHEA_PCIXBUS_COMMAND// Size=0x8 (Id=3344)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WHEA_PCIXBUS_ERROR_SECTION// Size=0x48 (Id=2924)
{
...
union _WHEA_PCIXDEVICE_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=2765)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long ErrorStatus:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_PCIXDEVICE_ID// Size=0x10 (Id=2111)
{
    unsigned short VendorId;// Offset=0x0 Size=0x2
    unsigned short DeviceId;// Offset=0x2 Size=0x2
    struct // Size=0x8 (Id=0)
...
struct _WHEA_PCIXDEVICE_ERROR_SECTION// Size=0x38 (Id=3768)
{
...
struct _WHEA_ERROR_PACKET_V1// Size=0x119 (Id=3549)
{
    union // Size=0x40 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0xd0 (Id=29530)
        {
