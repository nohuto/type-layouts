...
struct _RTL_BALANCED_LINKS// Size=0x20 (Id=461)
{
...
struct _RTL_AVL_TABLE// Size=0x68 (Id=450)
{
...
struct _W32PROCESS// Size=0x148 (Id=134)
{
    ...
    int bChangedGdiGammaRamp;// Offset=0x120 Size=0x4
    int bGDILimitReachedAtLeastOnce;// Offset=0x124 Size=0x4
    struct // Size=0x4 (Id=0)
    {
        unsigned int GdiInitializeCalloutExecuted:1;// Offset=0x128 Size=0x4 BitOffset=0x0 BitSize=0x1
    };
    long CHSPUASEGSYMFallbacks[6];// Offset=0x12c Size=0x18
    long ATMFDBackdoorCalls;// Offset=0x144 Size=0x4
};
