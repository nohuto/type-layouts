...
struct _CM_PARTIAL_RESOURCE_DESCRIPTOR// Size=0x14 (Id=623)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x10 (Id=821)
        {
            ...
            struct <unnamed-type-MessageInterrupt>// Size=0x10 (Id=837)
            {
                ...
                struct _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-MessageInterrupt>::_unnamed_631::<unnamed-type-Translated> Translated;// Offset=0x0 Size=0x10
            };
            ...
            struct <unnamed-type-DmaV3>// Size=0xc (Id=850)
            {
                unsigned long Channel;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-DevicePrivate>// Size=0xc (Id=858)
            {
            ...
            struct <unnamed-type-BusNumber>// Size=0xc (Id=862)
            {
            ...
            struct <unnamed-type-DeviceSpecificData>// Size=0xc (Id=867)
            {
...
struct _CM_FULL_RESOURCE_DESCRIPTOR// Size=0x24 (Id=606)
{
