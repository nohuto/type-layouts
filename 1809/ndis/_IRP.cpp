...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=1031)
{
...
struct _IRP// Size=0xd0 (Id=83)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=4391)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=4409)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=4410)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=4421)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=4422)
            {
