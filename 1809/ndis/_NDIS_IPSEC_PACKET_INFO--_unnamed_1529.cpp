union _NDIS_IPSEC_PACKET_INFO::_unnamed_1529// Size=0x10 (Id=1529)
{
    union // Size=0x10 (Id=0)
    {
        struct <unnamed-type-Transmit>// Size=0x10 (Id=7446)
        {
            void * OffloadHandle;// Offset=0x0 Size=0x8
            void * NextOffloadHandle;// Offset=0x8 Size=0x8
        };
        struct _NDIS_IPSEC_PACKET_INFO::_unnamed_391::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x10
        struct <unnamed-type-Receive>// Size=0x8 (Id=7450)
        {
        ...
        struct _NDIS_IPSEC_PACKET_INFO::_unnamed_393::<unnamed-type-Receive> Receive;// Offset=0x0 Size=0x8
    };
};
