struct _NDIS_GLOBAL_TRIAGE_BLOCK// Size=0x1f0 (Id=1435)
{
    union // Size=0x1e0 (Id=0)
    {
        ...
        struct <unnamed-type-MiniportBlockBindings>// Size=0x8 (Id=7118)
        {
        ...
        struct <unnamed-type-BindProtocolLink>// Size=0x8 (Id=7124)
        {
        ...
        struct <unnamed-type-BindFilterLink>// Size=0x8 (Id=7130)
        {
            unsigned short Size;// Offset=0x0 Size=0x2
            unsigned short BindStateOffset;// Offset=0x2 Size=0x2
            unsigned short BindDriverOffset;// Offset=0x4 Size=0x2
        ...
        struct <unnamed-type-BindState>// Size=0x4 (Id=7136)
        {
        ...
        struct <unnamed-type-NdisEventLog>// Size=0x6 (Id=7140)
        {
            unsigned short Size;// Offset=0x0 Size=0x2
