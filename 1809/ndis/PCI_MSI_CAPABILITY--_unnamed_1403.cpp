union PCI_MSI_CAPABILITY::_unnamed_1403// Size=0x10 (Id=1403)
{
    struct <unnamed-type-Option32Bit>// Size=0xc (Id=16632)
    {
    ...
    struct PCI_MSI_CAPABILITY::_unnamed_1404::<unnamed-type-Option32Bit> Option32Bit;// Offset=0x0 Size=0xc
    struct <unnamed-type-Option64Bit>// Size=0x10 (Id=16638)
    {
    ...
    struct PCI_MSI_CAPABILITY::_unnamed_1405::<unnamed-type-Option64Bit> Option64Bit;// Offset=0x0 Size=0x10
};
