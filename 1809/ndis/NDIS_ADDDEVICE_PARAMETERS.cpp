...
struct NDIS_ADDDEVICE_PARAMETERS// Size=0x60 (Id=407)
{
    union // Size=0x60 (Id=0)
    {
        ...
        class wistd::unique_ptr<Rtl::KString,wistd::default_delete<Rtl::KString> > ComponentId;// Offset=0x20 Size=0x8
        class wistd::unique_ptr<Rtl::KString,wistd::default_delete<Rtl::KString> > ExportName;// Offset=0x28 Size=0x8
        class wistd::unique_ptr<Rtl::KString,wistd::default_delete<Rtl::KString> > LegacyImFilterClass;// Offset=0x30 Size=0x8
        bool IsImMiniport;// Offset=0x38 Size=0x1
        bool IsSoftwareEnumerated;// Offset=0x39 Size=0x1
        bool IsVirtual;// Offset=0x3a Size=0x1
        bool IsPhysical;// Offset=0x3b Size=0x1
        bool HideInUi;// Offset=0x3c Size=0x1
        void * MiniportAdapterContext;// Offset=0x40 Size=0x8
        unsigned char IsHardwareLoopbackSupported;// Offset=0x48 Size=0x1
        bool IsLightWeight;// Offset=0x49 Size=0x1
        struct _NDIS_M_DRIVER_BLOCK * MiniBlock;// Offset=0x50 Size=0x8
        class wistd::unique_ptr<Rtl::KString,wistd::default_delete<Rtl::KString> > IfDescr;// Offset=0x58 Size=0x8
        void NDIS_ADDDEVICE_PARAMETERS(struct NDIS_ADDDEVICE_PARAMETERS * );
        void NDIS_ADDDEVICE_PARAMETERS();
        void ~NDIS_ADDDEVICE_PARAMETERS();// Offset=0x0 Size=0x50
