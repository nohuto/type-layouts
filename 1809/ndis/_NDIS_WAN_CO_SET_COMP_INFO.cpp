struct _NDIS_WAN_COMPRESS_INFO// Size=0x34 (Id=1774)
{
    ...
    {
        struct _NDIS_WAN_COMPRESS_INFO::_unnamed_1784::<unnamed-type-Proprietary> Proprietary;// Offset=0x10 Size=0x24
        struct _NDIS_WAN_COMPRESS_INFO::_unnamed_1785::<unnamed-type-Public> Public;// Offset=0x10 Size=0x20
    };
};

struct _NDIS_WAN_CO_SET_COMP_INFO// Size=0x68 (Id=1879)
{
