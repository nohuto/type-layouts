...
struct _NDIS_SS_STOP_FLAGS// Size=0x4 (Id=1230)
{
    union // Size=0x4 (Id=0)
    {
...
struct _NDIS_AOAC_WAKE_FLAGS// Size=0x4 (Id=1209)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _NDIS_AOAC_COMPONENT_REF_TIME// Size=0x10 (Id=1945)
{
    unsigned long long TotalRefTime;// Offset=0x0 Size=0x8
    unsigned long long CurrentRefStartTime;// Offset=0x8 Size=0x8
};

struct _NDIS_MINIPORT_CS_TRAFFIC_STATS// Size=0x30 (Id=1131)
{
...
struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS// Size=0x2c (Id=1326)
{
...
struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX// Size=0x14 (Id=1540)
{
...
struct _NDIS_MINIPORT_AOAC// Size=0x498 (Id=964)
{
