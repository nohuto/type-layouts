...
struct _NDIS_RECEIVE_FILTER_FIELD_PARAMETERS// Size=0x38 (Id=1809)
{
    union // Size=0x28 (Id=0)
    {
        ...
        union _HEADER_FIELD// Size=0x4 (Id=10653)
        {
        ...
        union _FIELD_VALUE// Size=0x10 (Id=10660)
        {
        ...
        union _RESULT_VALUE// Size=0x10 (Id=10667)
        {
