...
struct _CM_PARTIAL_RESOURCE_DESCRIPTOR// Size=0x14 (Id=1222)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x10 (Id=2296)
        {
            ...
            struct <unnamed-type-MessageInterrupt>// Size=0x10 (Id=2311)
            {
                struct _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-MessageInterrupt>::_unnamed_1716::<unnamed-type-Raw> Raw;// Offset=0x0 Size=0x10
                struct _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-MessageInterrupt>::_unnamed_1717::<unnamed-type-Translated> Translated;// Offset=0x0 Size=0x10
            };
            ...
            struct <unnamed-type-DmaV3>// Size=0xc (Id=2324)
            {
                unsigned long Channel;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-DevicePrivate>// Size=0xc (Id=2332)
            {
            ...
            struct <unnamed-type-BusNumber>// Size=0xc (Id=2336)
            {
            ...
            struct <unnamed-type-DeviceSpecificData>// Size=0xc (Id=2341)
            {
...
struct _CM_PARTIAL_RESOURCE_LIST// Size=0x1c (Id=1618)
{
...
struct _CM_FULL_RESOURCE_DESCRIPTOR// Size=0x24 (Id=976)
{
...
struct _CM_RESOURCE_LIST// Size=0x28 (Id=1149)
{
