union _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_unnamed_1994// Size=0x4 (Id=1994)
{
    ...
    struct _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_unnamed_1995::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x4
    struct <unnamed-type-Receive>// Size=0x4 (Id=11480)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_unnamed_1996::<unnamed-type-Receive> Receive;// Offset=0x0 Size=0x4
