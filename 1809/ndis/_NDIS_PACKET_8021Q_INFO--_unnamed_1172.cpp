union _NDIS_PACKET_8021Q_INFO::_unnamed_1172// Size=0x8 (Id=1172)
{
    struct <unnamed-type-TagHeader>// Size=0x4 (Id=9748)
    {
    ...
    struct _NDIS_PACKET_8021Q_INFO::_unnamed_1173::<unnamed-type-TagHeader> TagHeader;// Offset=0x0 Size=0x4
