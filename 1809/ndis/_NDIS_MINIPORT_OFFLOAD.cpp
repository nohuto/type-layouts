...
struct _NDIS_TCP_IP_CHECKSUM_OFFLOAD// Size=0x20 (Id=1293)
{
    union // Size=0x18 (Id=0)
    {
        struct <unnamed-type-IPv4Transmit>// Size=0x8 (Id=11440)
        {
        ...
        struct <unnamed-type-IPv4Receive>// Size=0x8 (Id=11448)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
            unsigned long IpOptionsSupported:2;// Offset=0x4 Size=0x4 BitOffset=0x0 BitSize=0x2
            unsigned long TcpOptionsSupported:2;// Offset=0x4 Size=0x4 BitOffset=0x2 BitSize=0x2
        ...
        struct <unnamed-type-IPv6Transmit>// Size=0x8 (Id=11456)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
        ...
        struct <unnamed-type-IPv6Receive>// Size=0x8 (Id=11463)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
            unsigned long IpExtensionHeadersSupported:2;// Offset=0x4 Size=0x4 BitOffset=0x0 BitSize=0x2
            unsigned long TcpOptionsSupported:2;// Offset=0x4 Size=0x4 BitOffset=0x2 BitSize=0x2
...
struct _NDIS_TCP_LARGE_SEND_OFFLOAD_V1// Size=0x10 (Id=1195)
{
    union // Size=0x10 (Id=0)
    {
        struct <unnamed-type-IPv4>// Size=0x10 (Id=11524)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
...
struct _NDIS_IPSEC_OFFLOAD_V1// Size=0x1c (Id=1646)
{
    union // Size=0x18 (Id=0)
    {
        struct <unnamed-type-Supported>// Size=0x14 (Id=7363)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
        ...
        struct <unnamed-type-IPv4AH>// Size=0x4 (Id=7370)
        {
        ...
        struct <unnamed-type-IPv4ESP>// Size=0x4 (Id=7378)
        {
...
struct _NDIS_TCP_LARGE_SEND_OFFLOAD_V2// Size=0x1c (Id=1709)
{
    union // Size=0xc (Id=0)
    {
        struct <unnamed-type-IPv4>// Size=0xc (Id=11531)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
            unsigned long MaxOffLoadSize;// Offset=0x4 Size=0x4
            unsigned long MinSegmentCount;// Offset=0x8 Size=0x4
        ...
        struct <unnamed-type-IPv6>// Size=0x10 (Id=11536)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
            unsigned long MaxOffLoadSize;// Offset=0x4 Size=0x4
            unsigned long MinSegmentCount;// Offset=0x8 Size=0x4
...
struct _NDIS_IPSEC_OFFLOAD_V2// Size=0x20 (Id=1021)
{
    unsigned long Encapsulation;// Offset=0x0 Size=0x4
...
struct _NDIS_TCP_RECV_SEG_COALESCE_OFFLOAD// Size=0x2 (Id=1564)
{
    union // Size=0x1 (Id=0)
    {
        struct <unnamed-type-IPv4>// Size=0x1 (Id=11557)
        {
        ...
        struct <unnamed-type-IPv6>// Size=0x1 (Id=11560)
        {
            unsigned char Enabled;// Offset=0x0 Size=0x1
        };
    };
...
struct _NDIS_ENCAPSULATED_PACKET_TASK_OFFLOAD// Size=0x8 (Id=1886)
{
...
struct _NDIS_ENCAPSULATED_PACKET_TASK_OFFLOAD_V2// Size=0x14 (Id=1931)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x4 (Id=0)
        ...
        unsigned long MaxHeaderSizeSupported;// Offset=0x4 Size=0x4
        union _ENCAPSULATION_PROTOCOL_INFO// Size=0x4 (Id=6205)
        {
            struct _VXLAN_INFO// Size=0x4 (Id=6206)
            {
...
struct _NDIS_OFFLOAD// Size=0xbc (Id=1013)
{
...
struct _NDIS_OFFLOAD_ENCAPSULATION// Size=0x1c (Id=1543)
{
    union // Size=0x10 (Id=0)
    {
        struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
        struct <unnamed-type-IPv4>// Size=0xc (Id=9519)
        {
        ...
        struct <unnamed-type-IPv6>// Size=0xc (Id=9524)
        {
            unsigned long Enabled;// Offset=0x0 Size=0x4
            unsigned long EncapsulationType;// Offset=0x4 Size=0x4
            unsigned long HeaderSize;// Offset=0x8 Size=0x4
...
struct _NDIS_TCP_CONNECTION_OFFLOAD_PARAMETERS// Size=0x3c (Id=1423)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_OFFLOAD// Size=0x4c8 (Id=1098)
{
