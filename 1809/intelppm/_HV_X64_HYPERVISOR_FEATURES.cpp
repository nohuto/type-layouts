union _HV_PARTITION_PRIVILEGE_MASK// Size=0x8 (Id=355)
{
...
struct _HV_X64_HYPERVISOR_FEATURES// Size=0x10 (Id=354)
{
    ...
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned int Reserved1:5;// Offset=0xc Size=0x4 BitOffset=0x1b BitSize=0x5
    };
};
