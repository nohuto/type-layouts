...
struct _unnamed_608// Size=0x18 (Id=608)
{
...
struct _unnamed_610// Size=0x18 (Id=610)
{
...
struct _unnamed_614// Size=0xc (Id=614)
{
...
struct _unnamed_615// Size=0x18 (Id=615)
{
...
struct _unnamed_617// Size=0x18 (Id=617)
{
...
union _unnamed_618// Size=0x18 (Id=618)
{
    ...
    {
        struct _unnamed_608 Port;// Offset=0x0 Size=0x18
        struct _unnamed_608 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_610 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_611 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_612 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_608 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_583 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_613 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_614 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_615 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_616 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_617 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_589 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=619)
{
    ...
    union _unnamed_618 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=576)
{
