...
struct _unnamed_169// Size=0x8 (Id=169)
{
...
union _unnamed_171// Size=0x10 (Id=171)
{
    struct _unnamed_169 Discrete;// Offset=0x0 Size=0x8
    struct _unnamed_170 Range;// Offset=0x0 Size=0x10
};

struct _STOR_POFX_COMPONENT_PERF_SET// Size=0x28 (Id=172)
{
    ...
    union _unnamed_171 PStates;// Offset=0x18 Size=0x10
};
