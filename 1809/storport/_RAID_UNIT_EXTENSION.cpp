...
struct _STOR_ADDR_BTL8// Size=0x10 (Id=238)
{
...
struct _STOR_SCSI_IDENTITY// Size=0x38 (Id=206)
{
...
struct _unnamed_257// Size=0x8 (Id=257)
{
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned char SMRResourceFailed:1;// Offset=0x2 Size=0x1 BitOffset=0x5 BitSize=0x1
...
union _unnamed_258// Size=0x4 (Id=258)
{
...
struct _QUEUE_TAG_LIST// Size=0x80 (Id=200)
{
...
struct _EXTENDED_DEVICE_QUEUE// Size=0x90 (Id=219)
{
...
struct _IO_QUEUE// Size=0xa8 (Id=218)
{
...
struct _unnamed_260// Size=0x190 (Id=260)
{
...
struct _RAID_IO_RESOURCES// Size=0x20 (Id=265)
{
...
struct _RAID_UNIT_REGISTRY_PARAMETERS// Size=0x18 (Id=364)
{
...
struct _RAID_UNIT_ATTRIBUTES// Size=0x4 (Id=520)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _RAID_WORK_ITEM_CONTEXT// Size=0x10 (Id=421)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
    struct _IRP * Irp;// Offset=0x8 Size=0x8
};

struct _STOR_ASYNC_NOTIFY_CONTEXT// Size=0x18 (Id=379)
{
    struct _IO_WORKITEM * WorkItem;// Offset=0x0 Size=0x8
...
struct _unnamed_358// Size=0x4 (Id=358)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _TELEMETRY_UNIT_EXTENSION// Size=0x8 (Id=359)
{
    struct _unnamed_358 Flags;// Offset=0x0 Size=0x4
    unsigned char NvmeCriticalWarning;// Offset=0x4 Size=0x1
};

struct _RAID_TELEMETRY_NODE_COUNTERS// Size=0x18 (Id=353)
{
...
union _unnamed_504// Size=0x4 (Id=504)
{
    unsigned long Quantity;// Offset=0x0 Size=0x4
    unsigned long Position;// Offset=0x0 Size=0x4
};

struct _RAID_TELEMETRY_ERROR_ENTRY// Size=0x28 (Id=505)
{
    ...
    union _unnamed_504 u;// Offset=0x20 Size=0x4
};

struct _RAID_TELEMETRY_SAMPLED_ERROR_LOG// Size=0x1c8 (Id=525)
{
...
struct _RAID_TELEMETRY_UNIQUE_ERROR_LOG// Size=0x190 (Id=471)
{
    struct _RAID_TELEMETRY_ERROR_ENTRY UniqueErrors[10];// Offset=0x0 Size=0x190
};

struct _RAID_UNIT_QOS// Size=0x30 (Id=601)
{
...
struct _RAID_UNIT_EXTENSION// Size=0xd00 (Id=264)
{
    ...
    struct _STOR_SCSI_ADDRESS Address;// Offset=0x60 Size=0x4
    struct _STOR_SCSI_IDENTITY Identity;// Offset=0x68 Size=0x38
    ...
    struct _unnamed_257 Flags;// Offset=0x1c0 Size=0x8
    union _unnamed_258 InterlockedFlags;// Offset=0x1c8 Size=0x4
    ...
    struct _unnamed_260 DeferredList;// Offset=0x510 Size=0x190
    ...
    struct _unnamed_262 PendingPowerUpContext;// Offset=0x778 Size=0x10
    ...
    unsigned long long UnresponsiveRequests;// Offset=0x820 Size=0x8
    unsigned long long QosGuaranteeFailures;// Offset=0x828 Size=0x8
    unsigned long long TimeoutsInGateway;// Offset=0x830 Size=0x8
    unsigned long long TimeoutsInLunQueue;// Offset=0x838 Size=0x8
    unsigned long TimeoutsInMiniport;// Offset=0x840 Size=0x4
    unsigned long PeriodicMaxDeviceCountAtSwTimeout;// Offset=0x844 Size=0x4
    unsigned long PauseDeviceCount;// Offset=0x848 Size=0x4
    unsigned long DeviceBusyCount;// Offset=0x84c Size=0x4
    unsigned long BusyCompletionCount;// Offset=0x850 Size=0x4
    unsigned long ZoneDeviceWriteErrors;// Offset=0x854 Size=0x4
    unsigned long ZoneWriteOverflowEntries;// Offset=0x858 Size=0x4
    unsigned long long TotalDeviceQueueIoCount;// Offset=0x860 Size=0x8
    unsigned long long TotalDeviceQueueIoWaitDuration;// Offset=0x868 Size=0x8
    unsigned long long MaxDeviceQueueIoWaitDuration;// Offset=0x870 Size=0x8
    unsigned long long DeviceQueueIoWaitExceededTimeoutCount;// Offset=0x878 Size=0x8
    unsigned long long DeviceQueueIoBusyCount;// Offset=0x880 Size=0x8
    unsigned long long DeviceQueueIoPausedCount;// Offset=0x888 Size=0x8
    unsigned long long DeviceQueueIoUntaggedCommandOutstandingCount;// Offset=0x890 Size=0x8
    unsigned long long DeviceQueueIoPausedForUntaggedCount;// Offset=0x898 Size=0x8
    unsigned long long DeviceQueueIoExceededThresholdCount;// Offset=0x8a0 Size=0x8
    unsigned long HighLatencyIoCount;// Offset=0x8a8 Size=0x4
    unsigned long StorpTraceLoggingPerformanceEnabled;// Offset=0x8ac Size=0x4
    struct _RAID_TELEMETRY_PERF_BUCKET * TelemetryPerfBuckets;// Offset=0x8b0 Size=0x8
    union _LARGE_INTEGER TelemetryLastPerfCollectionTimeStamp;// Offset=0x8b8 Size=0x8
    struct _RAID_TELEMETRY_PERF_BUCKET * TelemetryPerfPreviousCounters;// Offset=0x8c0 Size=0x8
    struct _RAID_TELEMETRY_NODE_COUNTERS * TelemetryCountersPerNumaNode;// Offset=0x8c8 Size=0x8
    struct _RAID_TELEMETRY_NODE_COUNTERS TelemetryPerfPreviousNodeCounters;// Offset=0x8d0 Size=0x18
    unsigned long long TelemetryMaxFlushLatency;// Offset=0x8e8 Size=0x8
    unsigned long long TelemetryMaxUnmapLatency;// Offset=0x8f0 Size=0x8
    unsigned long long TelemetryLock;// Offset=0x8f8 Size=0x8
    struct _RAID_TELEMETRY_SAMPLED_ERROR_LOG TelemetrySampledErrorLog;// Offset=0x900 Size=0x1c8
    struct _RAID_TELEMETRY_UNIQUE_ERROR_LOG TelemetryUniqueErrorLog;// Offset=0xac8 Size=0x190
    unsigned long long TelemetryBytesWritten;// Offset=0xc58 Size=0x8
    unsigned long long TelemetryStreamBytesWritten;// Offset=0xc60 Size=0x8
    unsigned long PowerCycleCount;// Offset=0xc68 Size=0x4
    union _LARGE_INTEGER InitialTimestamp;// Offset=0xc70 Size=0x8
    struct _RAID_UNIT_QOS Qos;// Offset=0xc78 Size=0x30
    struct _DUMP_DISK_INFO * CrashDumpInfo;// Offset=0xca8 Size=0x8
    struct _DUMP_DISK_INFO * HiberDumpInfo;// Offset=0xcb0 Size=0x8
    unsigned long long ZoneSize;// Offset=0xcb8 Size=0x8
    unsigned char * CachedSmartData;// Offset=0xcc0 Size=0x8
    enum _STORAGE_BUS_TYPE BusType;// Offset=0xcc8 Size=0x4
    unsigned char * ZonePendingIoTable;// Offset=0xcd0 Size=0x8
    struct _RTL_BITMAP ZoneIoBitMap;// Offset=0xcd8 Size=0x10
    union _LARGE_INTEGER LastLogicalBlockAddress;// Offset=0xce8 Size=0x8
    long  ( * CrashdumpNotifyRoutine)(enum _STORAGE_DUMP_EVENT ,void * );// Offset=0xcf0 Size=0x8
};
