...
struct _unnamed_241// Size=0x7 (Id=241)
{
...
union _unnamed_242// Size=0x4 (Id=242)
{
...
struct _STOR_LOCKED_LIST// Size=0x20 (Id=291)
{
...
struct _STOR_DICTIONARY// Size=0x30 (Id=198)
{
...
struct _RAID_POWER_STATE// Size=0x10 (Id=297)
{
...
struct _RAID_RESOURCE_LIST// Size=0x10 (Id=301)
{
...
struct _MEMORY_REGION// Size=0x18 (Id=483)
{
...
struct _PORT_CONFIGURATION_INFORMATION// Size=0xe0 (Id=289)
{
...
struct _RAID_MINIPORT// Size=0x130 (Id=293)
{
    ...
    struct _unnamed_292 Flags;// Offset=0xf8 Size=0x1
...
struct _BUS_INTERFACE_STANDARD// Size=0x40 (Id=633)
{
...
struct _RAID_BUS_INTERFACE// Size=0x48 (Id=603)
{
...
struct _RAID_MEMORY_REGION// Size=0x18 (Id=203)
{
    unsigned char * VirtualBase;// Offset=0x0 Size=0x8
    union _LARGE_INTEGER PhysicalBase;// Offset=0x8 Size=0x8
    unsigned long Length;// Offset=0x10 Size=0x4
...
struct _IO_CONT_RESOURCE_LIST// Size=0x80 (Id=394)
{
...
struct _STOR_NOTIFICATION_INFO// Size=0x20 (Id=395)
{
...
struct _STOR_IO_GATEWAY// Size=0x140 (Id=239)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _RAID_DEFERRED_QUEUE// Size=0x80 (Id=220)
{
...
struct _RAID_DEFERRED_HEADER// Size=0x20 (Id=445)
{
...
struct _STOR_SCSI_ADDRESS// Size=0x4 (Id=205)
{
...
struct _unnamed_369// Size=0x4 (Id=369)
{
    unsigned long Timeout;// Offset=0x0 Size=0x4
};

struct _unnamed_370// Size=0x4 (Id=370)
{
    unsigned long RequestsToComplete;// Offset=0x0 Size=0x4
};

struct _unnamed_371// Size=0x18 (Id=371)
{
...
struct _unnamed_372// Size=0x8 (Id=372)
{
    struct _STOR_ASYNC_NOTIFY_CONTEXT * StorAsyncNotify;// Offset=0x0 Size=0x8
};

struct _RAID_DEFERRED_ELEMENT// Size=0x50 (Id=373)
{
    ...
    {
        struct _unnamed_367 Timer;// Offset=0x28 Size=0x10
        struct _unnamed_368 Error;// Offset=0x28 Size=0x20
        struct _unnamed_369 PauseDevice;// Offset=0x28 Size=0x4
        struct _unnamed_370 Busy;// Offset=0x28 Size=0x4
        struct _unnamed_370 DeviceBusy;// Offset=0x28 Size=0x4
        struct _unnamed_371 AdditionalTimer;// Offset=0x28 Size=0x18
        struct _unnamed_372 AsyncNotification;// Offset=0x28 Size=0x8
    };
};

struct _unnamed_246// Size=0x50 (Id=246)
{
    struct _RAID_DEFERRED_ELEMENT Timer;// Offset=0x0 Size=0x50
};

struct _unnamed_247// Size=0xb0 (Id=247)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=391)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KTIMER// Size=0x40 (Id=319)
{
...
struct _PORT_REGISTRY_INFO// Size=0x40 (Id=446)
{
...
struct _RAID_ADAPTER_PARAMETERS// Size=0x38 (Id=553)
{
...
struct _unnamed_249// Size=0x1 (Id=249)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _SCSI_POWER_REQUEST_BLOCK// Size=0x58 (Id=502)
{
    unsigned short Length;// Offset=0x0 Size=0x2
...
struct _STORAGE_REQUEST_BLOCK// Size=0x80 (Id=233)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    unsigned char Function;// Offset=0x2 Size=0x1
    unsigned char SrbStatus;// Offset=0x3 Size=0x1
...
struct _RAID_POWER_CONTEXT// Size=0xb8 (Id=413)
{
...
struct _STORPORT_EXTENDED_FUNCTIONS// Size=0x58 (Id=334)
{
...
union _RAID_REDIRECTION_SUPPORT// Size=0x2 (Id=531)
{
...
struct _PCI_HEADER_TYPE_1// Size=0x30 (Id=605)
{
...
struct _unnamed_626// Size=0x8 (Id=626)
{
...
struct _PCI_HEADER_TYPE_2// Size=0x30 (Id=627)
{
    ...
    unsigned char SubordinateBus;// Offset=0xa Size=0x1
    unsigned char SecondaryLatency;// Offset=0xb Size=0x1
    struct _unnamed_626 Range[4];// Offset=0xc Size=0x20
    unsigned char InterruptLine;// Offset=0x2c Size=0x1
    unsigned char InterruptPin;// Offset=0x2d Size=0x1
    unsigned short BridgeControl;// Offset=0x2e Size=0x2
};

union _unnamed_434// Size=0x30 (Id=434)
{
...
struct _PCI_COMMON_HEADER// Size=0x40 (Id=435)
{
    ...
    union _unnamed_434 u;// Offset=0x10 Size=0x30
};

struct _STOR_POWER_SETTING_NOTIFICATION// Size=0x18 (Id=532)
{
...
struct _CRASHDUMP_FUNCTIONS_INTERFACE// Size=0x28 (Id=529)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
struct _RAID_CRYPTO_KEY_TABLE// Size=0x18 (Id=398)
{
...
struct _RAID_SHARED_WORK_ITEM_CONTEXT// Size=0x18 (Id=476)
{
...
struct _RAID_ADAPTER_EXTENSION// Size=0x1700 (Id=251)
{
    ...
    struct _unnamed_241 Flags;// Offset=0x68 Size=0x7
    struct _IO_RESOURCE_ENTRY * ReservedScsiMiniportResource;// Offset=0x70 Size=0x8
    union _unnamed_242 InterlockedFlags;// Offset=0x78 Size=0x4
    ...
    struct _EX_RUNDOWN_REF_CACHE_AWARE * RemoveLock;// Offset=0x110 Size=0x8
    struct _RAID_POWER_STATE Power;// Offset=0x118 Size=0x10
    struct _RAID_RESOURCE_LIST ResourceList;// Offset=0x128 Size=0x10
    struct _RAID_MINIPORT Miniport;// Offset=0x138 Size=0x130
    struct _RAID_BUS_INTERFACE Bus;// Offset=0x268 Size=0x48
    struct _KINTERRUPT * Interrupt;// Offset=0x2b0 Size=0x8
    unsigned long InterruptIrql;// Offset=0x2b8 Size=0x4
    unsigned long InterruptVersion;// Offset=0x2bc Size=0x4
    unsigned long long StartIoLock;// Offset=0x2c0 Size=0x8
    enum _STOR_SYNCHRONIZATION_MODEL IoModel;// Offset=0x2c8 Size=0x4
    struct _RAID_DMA_ADAPTER Dma;// Offset=0x2d0 Size=0x20
    struct _RAID_MEMORY_REGION UncachedExtension;// Offset=0x2f0 Size=0x18
    unsigned long BusNumber;// Offset=0x308 Size=0x4
    unsigned long SlotNumber;// Offset=0x30c Size=0x4
    struct _MAPPED_ADDRESS * MappedAddressList;// Offset=0x310 Size=0x8
    struct _STOR_IO_GATEWAY Gateway;// Offset=0x340 Size=0x140
    struct _RAID_DEFERRED_QUEUE DeferredQueue;// Offset=0x480 Size=0x80
    struct _unnamed_246 DeferredList;// Offset=0x500 Size=0x50
    struct _unnamed_247 DeferredPauseResumeContext;// Offset=0x550 Size=0xb0
    ...
    struct _unnamed_249 PerfOptFlags;// Offset=0x11a3 Size=0x1
    ...
    unsigned long SqmHierarchicalResetSucceededAtBus;// Offset=0x12e0 Size=0x4
    unsigned long SqmHierarchicalResetSucceededAtTarget;// Offset=0x12e4 Size=0x4
    unsigned long SqmHierarchicalResetSucceededAtLun;// Offset=0x12e8 Size=0x4
    unsigned long SqmHierarchicalResetCountInternal;// Offset=0x12ec Size=0x4
    unsigned long SqmHierarchicalResetCountApp;// Offset=0x12f0 Size=0x4
    unsigned long SqmMaxDpcCompletionCount;// Offset=0x12f4 Size=0x4
    unsigned long SqmMaxDpcCompletionTimeTicks;// Offset=0x12f8 Size=0x4
    unsigned long SqmCompletionsForLongestDpc;// Offset=0x12fc Size=0x4
    wchar_t * SqmMiniportName;// Offset=0x1300 Size=0x8
    wchar_t * SqmAdapterId;// Offset=0x1308 Size=0x8
    unsigned long SqmRandomId;// Offset=0x1310 Size=0x4
    unsigned long SqmSaveTotalResourceAllocFailuresLogged;// Offset=0x1314 Size=0x4
    unsigned long SqmSaveHighestOutstandingMaxLogged;// Offset=0x1318 Size=0x4
    struct _PCI_COMMON_HEADER PciConfiguration;// Offset=0x131c Size=0x40
    struct _STOR_POWER_SETTING_NOTIFICATION PowerSettingNotification;// Offset=0x1360 Size=0x18
    long StateChangeInProgress;// Offset=0x1378 Size=0x4
    unsigned long StateChangedEntity;// Offset=0x137c Size=0x4
    unsigned long StateChangeEntityAttributes;// Offset=0x1380 Size=0x4
    struct _STOR_ADDRESS * StateChangeAddress;// Offset=0x1388 Size=0x8
    void  ( * HwStateChange)(void * ,void * ,short ,void * ,unsigned long );// Offset=0x1390 Size=0x8
    void * StateChangeContext;// Offset=0x1398 Size=0x8
    struct _RTL_BITMAP BusesWithVmLunsBitmap;// Offset=0x13a0 Size=0x10
    unsigned long * BusesWithVmLunsBitmapBuffer;// Offset=0x13b0 Size=0x8
    unsigned long NumWorkItems;// Offset=0x13b8 Size=0x4
    unsigned char DefaultSenseByteCount;// Offset=0x13bc Size=0x1
    unsigned char DumpPowerReady;// Offset=0x13bd Size=0x1
    unsigned char MaxDumpLevelEnabled;// Offset=0x13be Size=0x1
    unsigned char VendorSpecificLogPageAddress;// Offset=0x13bf Size=0x1
    unsigned long MaxDeviceDumpSize;// Offset=0x13c0 Size=0x4
    unsigned long long IoLatencyCap;// Offset=0x13c8 Size=0x8
    unsigned long RaidLogListIndex;// Offset=0x1400 Size=0x4
    unsigned long RaidLogListSize;// Offset=0x1404 Size=0x4
    struct _RAID_LOG_ENTRY * RaidLogList;// Offset=0x1408 Size=0x8
    union _SLIST_HEADER UnitsPendingPowerUpList;// Offset=0x1410 Size=0x10
    struct _RAID_ADAPTER_POFX * PoFx;// Offset=0x1420 Size=0x8
    void * LowPowerEpochHandle;// Offset=0x1428 Size=0x8
    unsigned long D3IdleTimeout;// Offset=0x1430 Size=0x4
    void * CoalescingRegistration;// Offset=0x1438 Size=0x8
    void * MaxPowerHandle;// Offset=0x1440 Size=0x8
    struct _UNICODE_STRING CoolingInterfaceSymlink;// Offset=0x1448 Size=0x10
    struct _RAID_UNIT_EXTENSION * CrashDumpUnit;// Offset=0x1458 Size=0x8
    struct _CRASHDUMP_FUNCTIONS_INTERFACE ParentCrashdumpInterface;// Offset=0x1460 Size=0x28
    struct _GUID AdapterGuid;// Offset=0x1488 Size=0x10
    wchar_t * AdapterSerialNumber;// Offset=0x1498 Size=0x8
    unsigned long CompletionsDuringReset;// Offset=0x14a0 Size=0x4
    struct _unnamed_250 TelemetryHierarchicalResetLunBucket[5];// Offset=0x14a4 Size=0x3c
    struct _unnamed_250 TelemetryHierarchicalResetTargetBucket[5];// Offset=0x14e0 Size=0x3c
    unsigned long long LastCSStateChange;// Offset=0x1520 Size=0x8
    unsigned long long LastIOCoalescingOnStartTime;// Offset=0x1528 Size=0x8
    unsigned long long IOCoalescingOnDuration;// Offset=0x1530 Size=0x8
    unsigned long long FirstDPNRTimeAfterCS;// Offset=0x1538 Size=0x8
    unsigned long long LastDPNRStartTime;// Offset=0x1540 Size=0x8
    unsigned long long DPNRDurationInCS;// Offset=0x1548 Size=0x8
    unsigned long long LastF1StartTime;// Offset=0x1550 Size=0x8
    unsigned long long F1DurationInCS;// Offset=0x1558 Size=0x8
    unsigned long long ActiveReferencesInCS;// Offset=0x1560 Size=0x8
    unsigned long long ActiveReferencesInCoalescing;// Offset=0x1568 Size=0x8
    unsigned long UnitTimeoutsInCS;// Offset=0x1570 Size=0x4
    unsigned long F0TransitionsSinceCSStateChange;// Offset=0x1574 Size=0x4
    unsigned long D0TransitionsSinceCSStateChange;// Offset=0x1578 Size=0x4
    unsigned long F0TransitionsLongSinceCSStateChange;// Offset=0x157c Size=0x4
    unsigned long D0TransitionsLongSinceCSStateChange;// Offset=0x1580 Size=0x4
    unsigned char TopologyInfoLogged;// Offset=0x1584 Size=0x1
    unsigned long PeriodicMaxGatewayQueueDepthAtSwTimeout;// Offset=0x1588 Size=0x4
    unsigned long PauseCount;// Offset=0x158c Size=0x4
    unsigned long BusyCount;// Offset=0x1590 Size=0x4
    unsigned char DisableTelemetryDeviceHealth;// Offset=0x1594 Size=0x1
    unsigned long MiniportFirmwareDataStructureVersion;// Offset=0x1598 Size=0x4
    struct _D3COLD_SUPPORT_INTERFACE * D3ColdInterface;// Offset=0x15a0 Size=0x8
    void * ProtocolCommandEffects;// Offset=0x15a8 Size=0x8
    struct _KTIMER QueueWaitCheckTimer;// Offset=0x15b0 Size=0x40
    struct _KDPC QueueWaitCheckDpc;// Offset=0x15f0 Size=0x40
    unsigned long long QosLock;// Offset=0x1630 Size=0x8
    unsigned long QosUnitCountForWaitTimeout;// Offset=0x1638 Size=0x4
    struct _RAID_RPMB_CAPABILITIES Rpmb;// Offset=0x1640 Size=0x38
    struct _MDL * HmbMdlList;// Offset=0x1678 Size=0x8
    unsigned long PowerSrbTimeout;// Offset=0x1680 Size=0x4
    struct _STOR_CRYPTO_CAPABILITIES_DATA * CryptoCapabilities;// Offset=0x1688 Size=0x8
    struct _RAID_CRYPTO_KEY_TABLE CryptoKeyTable;// Offset=0x1690 Size=0x18
    struct _DUMP_ADAPTER_INFO * CrashDumpInfo;// Offset=0x16a8 Size=0x8
    struct _DUMP_ADAPTER_INFO * HiberDumpInfo;// Offset=0x16b0 Size=0x8
    unsigned long ZoneDeviceWriteErrors;// Offset=0x16b8 Size=0x4
    unsigned long ZoneDeviceErrors;// Offset=0x16bc Size=0x4
    unsigned long ZoneWriteOverflowEntries;// Offset=0x16c0 Size=0x4
    unsigned long BusyRetryCount;// Offset=0x16c4 Size=0x4
    unsigned long BusyPauseTimeInMs;// Offset=0x16c8 Size=0x4
    struct _RAID_SHARED_WORK_ITEM_CONTEXT PowerWorkItem;// Offset=0x16d0 Size=0x18
    struct _RAID_SHARED_WORK_ITEM_CONTEXT IoResourceWorkItem;// Offset=0x16e8 Size=0x18
};
