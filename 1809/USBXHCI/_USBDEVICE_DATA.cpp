...
struct _USB_DEVICE_PORT_PATH// Size=0x24 (Id=466)
{
...
struct _UCXUSBDEVICE_INFO// Size=0x38 (Id=645)
{
    unsigned long Size;// Offset=0x0 Size=0x4
...
struct _USB_DEVICE_DESCRIPTOR// Size=0x12 (Id=376)
{
...
struct _USBDEVICE_DATA// Size=0x298 (Id=470)
{
    ...
    unsigned char AlternateSetting;// Offset=0x23b Size=0x1
    unsigned char InterfaceNumber;// Offset=0x23c Size=0x1
    unsigned long NumberOfPendingCommandsForConfigureEndpoint;// Offset=0x240 Size=0x4
    unsigned char CommandsForConfigureEndpointHasFailed;// Offset=0x244 Size=0x1
    struct _ENDPOINTS_CONFIGURE * EndpointsConfigure;// Offset=0x248 Size=0x8
    enum _CONFIGURE_ENDPOINT_STATE ConfigureEndpointState;// Offset=0x250 Size=0x4
    struct _XIL_USBDEVICE_DATA XilUsbDeviceData;// Offset=0x258 Size=0x40
};
