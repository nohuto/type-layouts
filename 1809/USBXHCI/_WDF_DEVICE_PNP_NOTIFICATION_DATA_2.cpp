...
{
    struct _unnamed_588 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_589 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_588 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=591)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_590 Data;// Offset=0x4 Size=0x8
};
