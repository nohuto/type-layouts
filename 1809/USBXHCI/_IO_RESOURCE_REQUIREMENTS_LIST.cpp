...
struct _unnamed_260// Size=0x18 (Id=260)
{
...
struct _unnamed_269// Size=0x18 (Id=269)
{
...
union _unnamed_272// Size=0x18 (Id=272)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_260 Port;// Offset=0x0 Size=0x18
        struct _unnamed_260 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_262 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_263 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_264 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_260 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_265 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_266 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_267 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_268 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_269 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_270 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_271 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=273)
{
    ...
    union _unnamed_272 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=879)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=724)
{
