...
struct _PCI_DEVICE_INFORMATION// Size=0x38 (Id=618)
{
...
struct _ACPI_DEVICE_INFORMATION// Size=0xf (Id=825)
{
...
union _KSE_XHCI_CONTROLLER_FLAGS// Size=0x10 (Id=344)
{
...
union _FRAME_SNAPSHOT// Size=0x8 (Id=759)
{
...
struct _FRAME_NUMBER_DATA// Size=0x10 (Id=562)
{
...
struct _CONTROLLER_COUNTER// Size=0x1c (Id=583)
{
    unsigned long ResetCount;// Offset=0x0 Size=0x4
    unsigned long RestoreStateFailureCount;// Offset=0x4 Size=0x4
    unsigned long RHResumeTimeoutCount;// Offset=0x8 Size=0x4
    unsigned long RHResumeNeededExtendedWaitCount;// Offset=0xc Size=0x4
    unsigned long RHSuspendTimeoutCount;// Offset=0x10 Size=0x4
    unsigned long RHSuspendNeededExtendedWaitCount;// Offset=0x14 Size=0x4
    unsigned long RHPLCClearedOnU0PriorToU3Count;// Offset=0x18 Size=0x4
};
...
struct _INTERFACE// Size=0x20 (Id=184)
{
...
struct _SECURE_DRIVER_INTERFACE// Size=0x38 (Id=598)
{
...
struct _TIME_SYNC_DATA// Size=0xa8 (Id=426)
{
...
struct _CONTROLLER_DATA// Size=0x300 (Id=423)
{
    ...
    enum _UCX_CONTROLLER_PARENT_BUS_TYPE ParentBusType;// Offset=0xb4 Size=0x4
    struct _PCI_DEVICE_INFORMATION PciDeviceInfo;// Offset=0xb8 Size=0x38
    struct _ACPI_DEVICE_INFORMATION AcpiDeviceInfo;// Offset=0xf0 Size=0xf
    unsigned char MSELengthUsable;// Offset=0xff Size=0x1
    unsigned char MajorVersion;// Offset=0x100 Size=0x1
    unsigned char MinorVersion;// Offset=0x101 Size=0x1
    unsigned long long FirmwareVersion;// Offset=0x108 Size=0x8
    union _KSE_XHCI_CONTROLLER_FLAGS DeviceFlags;// Offset=0x110 Size=0x10
    unsigned long long InternalDeviceFlags;// Offset=0x120 Size=0x8
    struct WDFTIMER__ * WatchdogTimer;// Offset=0x128 Size=0x8
    struct WDFWORKITEM__ * TelemetryReportWorkItem;// Offset=0x130 Size=0x8
    unsigned long long TelemetryHistory;// Offset=0x138 Size=0x8
    unsigned char ForwardProgressEnabled;// Offset=0x140 Size=0x1
    unsigned long SpecialFileStatus;// Offset=0x144 Size=0x4
    enum _WDF_POWER_DEVICE_STATE CurrentWdfPowerDeviceState;// Offset=0x148 Size=0x4
    unsigned char ControllerSaveStateFailed;// Offset=0x14c Size=0x1
    unsigned char ControllerGone;// Offset=0x14d Size=0x1
    unsigned long WatchdogTimerCount;// Offset=0x150 Size=0x4
    unsigned long ResetCount;// Offset=0x154 Size=0x4
    unsigned long ResetInterval;// Offset=0x158 Size=0x4
    long ResetLock;// Offset=0x15c Size=0x4
    enum _SYSTEM_POWER_ACTION SystemPowerAction;// Offset=0x160 Size=0x4
    void * HibernateContext;// Offset=0x168 Size=0x8
    struct _FRAME_NUMBER_DATA FrameNumberData;// Offset=0x170 Size=0x10
    unsigned long long HardwareVerifierFlags;// Offset=0x180 Size=0x8
    struct _XIL_BUFFER_DATA * ScratchTransferBufferData;// Offset=0x188 Size=0x8
    enum _S0IdleStatus ControllerS0IdleStatus;// Offset=0x190 Size=0x4
    unsigned char WaitWakeQueued;// Offset=0x194 Size=0x1
    struct _CONTROLLER_COUNTER Counter;// Offset=0x198 Size=0x1c
    struct WDFWORKITEM__ * IdleTimeoutUpdateWorkItem;// Offset=0x1b8 Size=0x8
    unsigned long LastSetIdleTimeout;// Offset=0x1c0 Size=0x4
    struct POHANDLE__ * PoHandle;// Offset=0x1c8 Size=0x8
    void * LPEEnterExitCallbackHandle;// Offset=0x1d0 Size=0x8
    unsigned char WdfPowerReferenceForDebuggerAcquired;// Offset=0x1d8 Size=0x1
    unsigned char IsSecureDevice;// Offset=0x1d9 Size=0x1
    enum _CONTROLLER_DMA_MODE DMAModeInVSM;// Offset=0x1dc Size=0x4
    unsigned long NumberOfDMATargetsInVSM;// Offset=0x1e0 Size=0x4
    struct TRUSTLET_OBJECT_HANDLE__ * SecureObjectHandle;// Offset=0x1e8 Size=0x8
    struct _EPROCESS * TrustletProcess;// Offset=0x1f0 Size=0x8
    struct _SECURE_DRIVER_INTERFACE SecureDriverInterface;// Offset=0x1f8 Size=0x38
    unsigned char IsDSMForPortStatusSupported;// Offset=0x230 Size=0x1
    unsigned char IsDSMForKBLWorkaroundsSupported;// Offset=0x231 Size=0x1
    enum _USBD_ENDPOINT_OFFLOAD_MODE UsbEndpointOffloadMode;// Offset=0x234 Size=0x4
    unsigned long NumberOfEndpointsOffloaded;// Offset=0x238 Size=0x4
    void * EndpointsOffloadedCountLock;// Offset=0x240 Size=0x8
    struct _TIME_SYNC_DATA TimeSyncData;// Offset=0x248 Size=0xa8
    struct WDFWORKITEM__ * AudioOffloadWnfStateUpdateWorkItem;// Offset=0x2f0 Size=0x8
    unsigned char IsAudioOffloadActive;// Offset=0x2f8 Size=0x1
};
