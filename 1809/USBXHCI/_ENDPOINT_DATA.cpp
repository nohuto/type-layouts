union _ENDPOINT_FLAGS// Size=0x4 (Id=480)
{
...
struct _USB_ENDPOINT_DESCRIPTOR// Size=0x7 (Id=561)
{
...
struct _USB_SUPERSPEED_ENDPOINT_COMPANION_DESCRIPTOR// Size=0x6 (Id=595)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
    unsigned char bMaxBurst;// Offset=0x2 Size=0x1
    union _unnamed_594 bmAttributes;// Offset=0x3 Size=0x1
    unsigned short wBytesPerInterval;// Offset=0x4 Size=0x2
};

struct _USB_SUPERSPEEDPLUS_ISOCH_ENDPOINT_COMPANION_DESCRIPTOR// Size=0x8 (Id=584)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
...
struct _STATE_LOG// Size=0xc (Id=659)
{
...
struct _EVENTS_QUEUE// Size=0x44 (Id=621)
{
...
struct _SM_CONTEXT// Size=0x400 (Id=548)
{
...
struct _ENDPOINT_DATA// Size=0x550 (Id=474)
{
