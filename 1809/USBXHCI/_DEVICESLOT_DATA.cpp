struct _XILPROXY_DEVICESLOT_DATA// Size=0x10 (Id=750)
{
...
struct _XILCORE_DEVICESLOT_DATA// Size=0x40 (Id=410)
{
...
struct _XILDIRECT_DEVICESLOT_DATA// Size=0x40 (Id=764)
{
    struct _XILCORE_DEVICESLOT_DATA XilCoreDeviceSlotData;// Offset=0x0 Size=0x40
};

struct _XIL_DEVICESLOT_DATA// Size=0x58 (Id=735)
{
...
struct _DEVICESLOT_DATA// Size=0x68 (Id=465)
{
    void * WdfDeviceSlot;// Offset=0x0 Size=0x8
    void * ControllerHandle;// Offset=0x8 Size=0x8
    struct _XIL_DEVICESLOT_DATA XilDeviceSlotData;// Offset=0x10 Size=0x58
};
