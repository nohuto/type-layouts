...
union _PAGESIZE_REGISTER// Size=0x4 (Id=774)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _CONFIG_REGISTER// Size=0x4 (Id=738)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _OPERATIONAL_REGISTERS// Size=0x3c (Id=433)
{
