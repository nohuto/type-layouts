...
struct _unnamed_614// Size=0x8 (Id=614)
{
...
union _unnamed_616// Size=0x8 (Id=616)
{
    struct _unnamed_614 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_615 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_614 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=617)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_616 Data;// Offset=0x4 Size=0x8
};
