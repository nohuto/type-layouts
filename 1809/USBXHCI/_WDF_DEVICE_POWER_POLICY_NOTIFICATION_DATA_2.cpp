...
struct _unnamed_579// Size=0x4 (Id=579)
{
    enum _WDF_DEVICE_POWER_POLICY_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_580// Size=0x8 (Id=580)
{
    struct _unnamed_578 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_579 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_578 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=581)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_580 Data;// Offset=0x4 Size=0x8
};
