...
union _unnamed_314// Size=0x4 (Id=314)
{
    struct _unnamed_313 Parallel;// Offset=0x0 Size=0x4
};

struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=315)
{
    ...
    union _unnamed_314 Settings;// Offset=0x50 Size=0x4
