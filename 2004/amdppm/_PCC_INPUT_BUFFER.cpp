...
struct _PCC_INPUT_BUFFER// Size=0x4 (Id=702)
{
    unsigned char ControlEnabled;// Offset=0x0 Size=0x1
    union // Size=0x3 (Id=0)
    {
        struct _anonymous_700 GetAverageFrequency;// Offset=0x1 Size=0x3
        struct _anonymous_701 SetDesiredFrequency;// Offset=0x1 Size=0x3
    };
};
