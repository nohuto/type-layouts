...
struct _anonymous_436// Size=0x8 (Id=436)
{
...
union _anonymous_438// Size=0x8 (Id=438)
{
    struct _anonymous_436 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_437 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_436 LeaveState;// Offset=0x0 Size=0x8
};
...
struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=248)
{
    ...
    union _anonymous_438 Data;// Offset=0x4 Size=0x8
};
