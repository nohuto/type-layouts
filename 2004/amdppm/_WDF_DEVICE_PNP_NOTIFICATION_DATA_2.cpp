...
struct _anonymous_446// Size=0x4 (Id=446)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _anonymous_447// Size=0x8 (Id=447)
{
    struct _anonymous_445 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_446 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_445 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=448)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_447 Data;// Offset=0x4 Size=0x8
};
