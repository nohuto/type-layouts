union _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_anonymous_1968// Size=0x4 (Id=1968)
{
    struct <unnamed-type-Transmit>// Size=0x4 (Id=10832)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_anonymous_1969::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x4
    struct <unnamed-type-Receive>// Size=0x4 (Id=10839)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_anonymous_1970::<unnamed-type-Receive> Receive;// Offset=0x0 Size=0x4
