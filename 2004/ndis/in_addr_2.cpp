struct in_addr// Size=0x4 (Id=158)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-S_un>// Size=0x4 (Id=15216)
        {
            struct <unnamed-type-S_un_b>// Size=0x4 (Id=15217)
            {
            ...
            struct <unnamed-type-S_un_w>// Size=0x4 (Id=15223)
            {
