...
struct _NDIS_REFCOUNT_STACK_BLOCK// Size=0x38 (Id=1457)
{
...
struct _NDIS_REFCOUNT_WITH_STACK// Size=0x40 (Id=1121)
{
...
union _NDIS_REFCOUNT_BLOCK::_anonymous_1933// Size=0x40 (Id=1933)
{
    struct _NDIS_REFCOUNT_TAGGED TaggedRefCounts;// Offset=0x0 Size=0x10
    struct _NDIS_REFCOUNT_WITH_STACK RefWithStack[1];// Offset=0x0 Size=0x40
};
