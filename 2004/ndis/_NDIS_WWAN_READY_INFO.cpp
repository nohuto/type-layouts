...
struct _WWAN_READY_INFO// Size=0x60 (Id=1303)
{
    ...
    struct _WWAN_LIST_HEADER TNListHeader;// Offset=0x58 Size=0x8
};

struct _NDIS_WWAN_READY_INFO// Size=0x64 (Id=1231)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    struct _WWAN_READY_INFO ReadyInfo;// Offset=0x4 Size=0x60
};
