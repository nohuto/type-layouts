union _anonymous_403// Size=0x4 (Id=403)
{
...
struct _USB_DEVICE_CAPABILITY_USB20_EXTENSION_DESCRIPTOR// Size=0x7 (Id=404)
{
    ...
    union _anonymous_403 bmAttributes;// Offset=0x3 Size=0x4
};
