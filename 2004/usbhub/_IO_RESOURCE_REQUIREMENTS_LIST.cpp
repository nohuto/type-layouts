...
struct _anonymous_415// Size=0x18 (Id=415)
{
...
struct _anonymous_418// Size=0x18 (Id=418)
{
...
struct _anonymous_419// Size=0x8 (Id=419)
{
...
struct _anonymous_424// Size=0x18 (Id=424)
{
...
struct _anonymous_425// Size=0x18 (Id=425)
{
...
struct _anonymous_426// Size=0x18 (Id=426)
{
...
union _anonymous_428// Size=0x18 (Id=428)
{
    union // Size=0x18 (Id=0)
    {
        struct _anonymous_415 Port;// Offset=0x0 Size=0x18
        struct _anonymous_415 Memory;// Offset=0x0 Size=0x18
        struct _anonymous_418 Interrupt;// Offset=0x0 Size=0x18
        struct _anonymous_419 Dma;// Offset=0x0 Size=0x8
        struct _anonymous_420 DmaV3;// Offset=0x0 Size=0x10
        struct _anonymous_415 Generic;// Offset=0x0 Size=0x18
        struct _anonymous_421 DevicePrivate;// Offset=0x0 Size=0xc
        struct _anonymous_422 BusNumber;// Offset=0x0 Size=0x10
        struct _anonymous_423 ConfigData;// Offset=0x0 Size=0xc
        struct _anonymous_424 Memory40;// Offset=0x0 Size=0x18
        struct _anonymous_425 Memory48;// Offset=0x0 Size=0x18
        struct _anonymous_426 Memory64;// Offset=0x0 Size=0x18
        struct _anonymous_427 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=429)
{
    ...
    union _anonymous_428 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=405)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=325)
{
