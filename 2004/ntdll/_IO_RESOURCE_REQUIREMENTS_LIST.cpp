...
struct _anonymous_679// Size=0x18 (Id=679)
{
...
struct _anonymous_681// Size=0x18 (Id=681)
{
...
struct _anonymous_685// Size=0x10 (Id=685)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_687// Size=0x18 (Id=687)
{
...
struct _anonymous_688// Size=0x18 (Id=688)
{
...
struct _anonymous_689// Size=0x18 (Id=689)
{
...
union _anonymous_691// Size=0x18 (Id=691)
{
    union // Size=0x18 (Id=0)
    {
        struct _anonymous_679 Port;// Offset=0x0 Size=0x18
        struct _anonymous_679 Memory;// Offset=0x0 Size=0x18
        struct _anonymous_681 Interrupt;// Offset=0x0 Size=0x18
        struct _anonymous_682 Dma;// Offset=0x0 Size=0x8
        struct _anonymous_683 DmaV3;// Offset=0x0 Size=0x10
        struct _anonymous_679 Generic;// Offset=0x0 Size=0x18
        struct _anonymous_684 DevicePrivate;// Offset=0x0 Size=0xc
        struct _anonymous_685 BusNumber;// Offset=0x0 Size=0x10
        struct _anonymous_686 ConfigData;// Offset=0x0 Size=0xc
        struct _anonymous_687 Memory40;// Offset=0x0 Size=0x18
        struct _anonymous_688 Memory48;// Offset=0x0 Size=0x18
        struct _anonymous_689 Memory64;// Offset=0x0 Size=0x18
        struct _anonymous_690 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=692)
{
    ...
    union _anonymous_691 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=659)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=484)
{
