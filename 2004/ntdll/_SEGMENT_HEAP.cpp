struct _RTL_HEAP_MEMORY_LIMIT_DATA// Size=0x20 (Id=325)
{
...
union _RTL_RUN_ONCE// Size=0x8 (Id=359)
{
...
struct _HEAP_OPPORTUNISTIC_LARGE_PAGE_STATS// Size=0x10 (Id=607)
{
...
struct _RTL_HP_SEG_ALLOC_POLICY// Size=0x18 (Id=445)
{
...
struct _HEAP_RUNTIME_MEMORY_STATS// Size=0x58 (Id=283)
{
...
union _anonymous_281// Size=0x1 (Id=281)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _HEAP_SEG_CONTEXT// Size=0xc0 (Id=282)
{
    ...
    union _anonymous_281 Flags;// Offset=0xd Size=0x1
...
struct _HEAP_VS_DELAY_FREE_CONTEXT// Size=0x10 (Id=407)
{
    union _SLIST_HEADER ListHead;// Offset=0x0 Size=0x10
};

struct _HEAP_SUBALLOCATOR_CALLBACKS// Size=0x28 (Id=221)
{
...
struct _anonymous_361// Size=0x4 (Id=361)
{
...
struct _RTL_HP_VS_CONFIG// Size=0x4 (Id=362)
{
    struct _anonymous_361 Flags;// Offset=0x0 Size=0x4
};

struct _HEAP_VS_CONTEXT// Size=0xc0 (Id=272)
{
...
struct _RTL_HP_LFH_CONFIG// Size=0x4 (Id=431)
{
...
struct _SEGMENT_HEAP// Size=0x800 (Id=287)
{
