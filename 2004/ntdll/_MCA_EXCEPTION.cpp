...
struct _anonymous_730// Size=0x8 (Id=730)
{
...
union _MCI_STATS// Size=0x8 (Id=731)
{
    struct _anonymous_730 MciStatus;// Offset=0x0 Size=0x8
    unsigned long long QuadPart;// Offset=0x0 Size=0x8
};

union _MCI_ADDR// Size=0x8 (Id=720)
{
...
struct _anonymous_637// Size=0x20 (Id=637)
{
...
struct _anonymous_638// Size=0x10 (Id=638)
{
    unsigned long long Address;// Offset=0x0 Size=0x8
    unsigned long long Type;// Offset=0x8 Size=0x8
};

union _anonymous_639// Size=0x20 (Id=639)
{
    union // Size=0x20 (Id=0)
    {
        struct _anonymous_637 Mca;// Offset=0x0 Size=0x20
        struct _anonymous_638 Mce;// Offset=0x0 Size=0x10
    };
};

struct _MCA_EXCEPTION// Size=0x100 (Id=640)
{
    ...
    union _anonymous_639 u;// Offset=0x18 Size=0x20
