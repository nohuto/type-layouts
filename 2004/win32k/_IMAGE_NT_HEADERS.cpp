struct _IMAGE_FILE_HEADER// Size=0x14 (Id=260)
{
...
struct _IMAGE_DATA_DIRECTORY// Size=0x8 (Id=442)
{
    unsigned long VirtualAddress;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
};

struct _IMAGE_OPTIONAL_HEADER// Size=0xe0 (Id=296)
{
...
struct _IMAGE_NT_HEADERS// Size=0xf8 (Id=44)
{
