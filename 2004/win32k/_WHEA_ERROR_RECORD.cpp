...
union _WHEA_ERROR_RECORD_HEADER_VALIDBITS// Size=0x4 (Id=233)
{
...
union _WHEA_TIMESTAMP// Size=0x8 (Id=215)
{
...
union _WHEA_ERROR_RECORD_HEADER_FLAGS// Size=0x4 (Id=253)
{
    struct // Size=0x4 (Id=0)
    {
...
union _WHEA_PERSISTENCE_INFO// Size=0x8 (Id=326)
{
    struct // Size=0x8 (Id=0)
    {
...
union _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_VALIDBITS// Size=0x1 (Id=396)
{
...
union _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_FLAGS// Size=0x4 (Id=375)
{
    struct // Size=0x4 (Id=0)
    {
