...
struct _CM_PARTIAL_RESOURCE_DESCRIPTOR// Size=0x10 (Id=643)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0xc (Id=882)
        {
            ...
            struct _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-Interrupt> Interrupt;// Offset=0x0 Size=0xc
            struct <unnamed-type-MessageInterrupt>// Size=0xc (Id=897)
            {
            ...
            struct _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-MessageInterrupt> MessageInterrupt;// Offset=0x0 Size=0xc
            struct <unnamed-type-Memory>// Size=0xc (Id=901)
            {
                union _LARGE_INTEGER Start;// Offset=0x0 Size=0x8
                unsigned long Length;// Offset=0x8 Size=0x4
            };
            struct _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-Memory> Memory;// Offset=0x0 Size=0xc
            struct <unnamed-type-Dma>// Size=0xc (Id=905)
            {
            ...
            struct <unnamed-type-DmaV3>// Size=0xc (Id=910)
            {
                unsigned long Channel;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-DevicePrivate>// Size=0xc (Id=918)
            {
            ...
            struct <unnamed-type-BusNumber>// Size=0xc (Id=922)
            {
            ...
            struct <unnamed-type-DeviceSpecificData>// Size=0xc (Id=927)
            {
    ...
    union _CM_PARTIAL_RESOURCE_DESCRIPTOR::<unnamed-type-u> u;// Offset=0x4 Size=0xc
};

struct _CM_PARTIAL_RESOURCE_LIST// Size=0x18 (Id=627)
{
...
struct _CM_FULL_RESOURCE_DESCRIPTOR// Size=0x20 (Id=626)
{
...
struct _CM_RESOURCE_LIST// Size=0x24 (Id=610)
{
