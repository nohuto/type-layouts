...
struct _DEVICE_OBJECT// Size=0xb8 (Id=89)
{
    union // Size=0x31 (Id=0)
    {
        ...
        union <unnamed-type-Queue>// Size=0x28 (Id=1523)
        {
            struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x8
            struct _WAIT_CONTEXT_BLOCK Wcb;// Offset=0x0 Size=0x28
        };
        union _DEVICE_OBJECT::<unnamed-type-Queue> Queue;// Offset=0x34 Size=0x28
    };
