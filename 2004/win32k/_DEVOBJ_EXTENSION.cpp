struct _DEVOBJ_EXTENSION// Size=0x3c (Id=302)
{
    ...
    void * DependencyNode;// Offset=0x2c Size=0x4
    void * InterruptContext;// Offset=0x30 Size=0x4
    long InterruptCount;// Offset=0x34 Size=0x4
    void * VerifierContext;// Offset=0x38 Size=0x4
};
