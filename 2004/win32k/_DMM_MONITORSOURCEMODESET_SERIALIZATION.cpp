...
struct _DMM_MONITOR_SOURCE_MODE_SERIALIZATION// Size=0x50 (Id=349)
{
    struct _D3DKMDT_MONITOR_SOURCE_MODE Info;// Offset=0x0 Size=0x4c
    enum _D3DKMDT_MONITOR_TIMING_TYPE TimingType;// Offset=0x4c Size=0x4
};

struct _DMM_MONITORSOURCEMODESET_SERIALIZATION// Size=0x54 (Id=176)
{
    unsigned int NumModes;// Offset=0x0 Size=0x4
    struct _DMM_MONITOR_SOURCE_MODE_SERIALIZATION ModeSerialization[1];// Offset=0x4 Size=0x50
};
