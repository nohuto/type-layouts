...
union _XPF_MCE_FLAGS// Size=0x4 (Id=393)
{
...
union _XPF_MC_BANK_FLAGS// Size=0x1 (Id=485)
{
...
struct _WHEA_XPF_MC_BANK_DESCRIPTOR// Size=0x1c (Id=435)
{
...
struct _WHEA_XPF_MCE_DESCRIPTOR// Size=0x398 (Id=259)
{
...
union _WHEA_NOTIFICATION_FLAGS// Size=0x2 (Id=517)
{
...
struct _WHEA_NOTIFICATION_DESCRIPTOR// Size=0x1c (Id=336)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x18 (Id=5495)
        {
            struct <unnamed-type-Polled>// Size=0x4 (Id=5496)
            {
                unsigned long PollInterval;// Offset=0x0 Size=0x4
            };
            struct _WHEA_NOTIFICATION_DESCRIPTOR::<unnamed-type-u>::<unnamed-type-Polled> Polled;// Offset=0x0 Size=0x4
            struct <unnamed-type-Interrupt>// Size=0x18 (Id=5499)
            {
                unsigned long PollInterval;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-LocalInterrupt>// Size=0x18 (Id=5507)
            {
                unsigned long PollInterval;// Offset=0x0 Size=0x4
                unsigned long Vector;// Offset=0x4 Size=0x4
                unsigned long SwitchToPollingThreshold;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-Sci>// Size=0x18 (Id=5515)
            {
                unsigned long PollInterval;// Offset=0x0 Size=0x4
                unsigned long Vector;// Offset=0x4 Size=0x4
                unsigned long SwitchToPollingThreshold;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-Nmi>// Size=0x18 (Id=5523)
            {
                unsigned long PollInterval;// Offset=0x0 Size=0x4
                unsigned long Vector;// Offset=0x4 Size=0x4
                unsigned long SwitchToPollingThreshold;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-Sea>// Size=0x18 (Id=5531)
            {
                unsigned long PollInterval;// Offset=0x0 Size=0x4
                unsigned long Vector;// Offset=0x4 Size=0x4
                unsigned long SwitchToPollingThreshold;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-Sei>// Size=0x18 (Id=5539)
            {
                unsigned long PollInterval;// Offset=0x0 Size=0x4
                unsigned long Vector;// Offset=0x4 Size=0x4
                unsigned long SwitchToPollingThreshold;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-Gsiv>// Size=0x18 (Id=5547)
            {
                unsigned long PollInterval;// Offset=0x0 Size=0x4
                unsigned long Vector;// Offset=0x4 Size=0x4
                unsigned long SwitchToPollingThreshold;// Offset=0x8 Size=0x4
...
struct _WHEA_XPF_CMC_DESCRIPTOR// Size=0x3a4 (Id=235)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char NumberOfBanks;// Offset=0x3 Size=0x1
...
struct _WHEA_XPF_NMI_DESCRIPTOR// Size=0x3 (Id=445)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
};

struct _WHEA_IPF_MCA_DESCRIPTOR// Size=0x4 (Id=286)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
...
struct _WHEA_IPF_CMC_DESCRIPTOR// Size=0x4 (Id=209)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
struct _WHEA_IPF_CPE_DESCRIPTOR// Size=0x4 (Id=392)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
union _AER_ROOTPORT_DESCRIPTOR_FLAGS// Size=0x2 (Id=303)
{
    struct // Size=0x2 (Id=0)
    {
...
struct _WHEA_AER_ROOTPORT_DESCRIPTOR// Size=0x24 (Id=291)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
union _AER_ENDPOINT_DESCRIPTOR_FLAGS// Size=0x2 (Id=241)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short UncorrectableErrorMaskRW:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_AER_ENDPOINT_DESCRIPTOR// Size=0x20 (Id=211)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
struct _WHEA_GENERIC_ERROR_DESCRIPTOR// Size=0x34 (Id=118)
{
    unsigned short Type;// Offset=0x0 Size=0x2
...
struct _WHEA_GENERIC_ERROR_DESCRIPTOR_V2// Size=0x50 (Id=238)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Reserved;// Offset=0x2 Size=0x1
    unsigned char Enabled;// Offset=0x3 Size=0x1
...
struct _WHEA_ERROR_SOURCE_CONFIGURATION_DD// Size=0xc (Id=423)
{
...
struct _WHEA_DEVICE_DRIVER_DESCRIPTOR// Size=0x60 (Id=381)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
    ...
    unsigned char * PacketBuffer;// Offset=0x20 Size=0x4
    struct _WHEA_ERROR_SOURCE_CONFIGURATION_DD Config;// Offset=0x24 Size=0xc
    struct _GUID CreatorId;// Offset=0x30 Size=0x10
    struct _GUID PartitionId;// Offset=0x40 Size=0x10
    unsigned long MaxSectionDataLength;// Offset=0x50 Size=0x4
    unsigned long MaxSectionsPerRecord;// Offset=0x54 Size=0x4
    unsigned char * PacketStateBuffer;// Offset=0x58 Size=0x4
    long OpenHandles;// Offset=0x5c Size=0x4
};

struct _WHEA_ERROR_SOURCE_DESCRIPTOR// Size=0x3cc (Id=116)
{
    union // Size=0x28 (Id=0)
    {
        ...
        union <unnamed-type-Info>// Size=0x3a4 (Id=5333)
        {
            ...
            struct _WHEA_DEVICE_DRIVER_DESCRIPTOR DeviceDriverDescriptor;// Offset=0x0 Size=0x60
        };
    };
