...
union _D3DKMDT_WIRE_FORMAT_AND_PREFERENCE// Size=0x4 (Id=580)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _D3DKMDT_VIDPN_TARGET_MODE// Size=0x34 (Id=364)
{
    unsigned int Id;// Offset=0x0 Size=0x4
    struct _D3DKMDT_VIDEO_SIGNAL_INFO VideoSignalInfo;// Offset=0x4 Size=0x2c
    union // Size=0x4 (Id=0)
    {
        union _D3DKMDT_WIRE_FORMAT_AND_PREFERENCE WireFormatAndPreference;// Offset=0x30 Size=0x4
        struct // Size=0x4 (Id=0)
        {
            enum _D3DKMDT_MODE_PREFERENCE Preference:2;// Offset=0x30 Size=0x4 BitOffset=0x0 BitSize=0x2
        };
    };
};

struct _DMM_VIDPNTARGETMODESET_SERIALIZATION// Size=0x38 (Id=240)
{
    unsigned char NumModes;// Offset=0x0 Size=0x1
    struct _D3DKMDT_VIDPN_TARGET_MODE ModeSerialization[1];// Offset=0x4 Size=0x34
};

struct _DMM_VIDPNPATHANDTARGETMODESET_SERIALIZATION// Size=0x194 (Id=184)
{
    struct _D3DKMDT_VIDPN_PRESENT_PATH PathInfo;// Offset=0x0 Size=0x15c
    struct _DMM_VIDPNTARGETMODESET_SERIALIZATION TargetModeSet;// Offset=0x15c Size=0x38
};
