...
struct _SECURITY_SUBJECT_CONTEXT// Size=0x10 (Id=387)
{
...
struct _INITIAL_PRIVILEGE_SET// Size=0x2c (Id=332)
{
...
struct _PRIVILEGE_SET// Size=0x14 (Id=329)
{
    unsigned long PrivilegeCount;// Offset=0x0 Size=0x4
    unsigned long Control;// Offset=0x4 Size=0x4
...
struct _ACCESS_STATE// Size=0x74 (Id=109)
{
    union // Size=0x34 (Id=0)
    {
        ...
        struct _SECURITY_SUBJECT_CONTEXT SubjectSecurityContext;// Offset=0x1c Size=0x10
        void * SecurityDescriptor;// Offset=0x2c Size=0x4
        void * AuxData;// Offset=0x30 Size=0x4
        union <unnamed-type-Privileges>// Size=0x2c (Id=801)
        {
        ...
        union _ACCESS_STATE::<unnamed-type-Privileges> Privileges;// Offset=0x34 Size=0x2c
    };
    unsigned char AuditPrivileges;// Offset=0x60 Size=0x1
    struct _UNICODE_STRING ObjectName;// Offset=0x64 Size=0x8
    struct _UNICODE_STRING ObjectTypeName;// Offset=0x6c Size=0x8
};
