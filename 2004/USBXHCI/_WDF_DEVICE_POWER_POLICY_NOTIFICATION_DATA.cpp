...
struct _anonymous_593// Size=0x8 (Id=593)
{
...
struct _anonymous_594// Size=0x4 (Id=594)
{
    enum _WDF_DEVICE_POWER_POLICY_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _anonymous_595// Size=0x8 (Id=595)
{
    struct _anonymous_593 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_594 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_593 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=246)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_595 Data;// Offset=0x4 Size=0x8
};
