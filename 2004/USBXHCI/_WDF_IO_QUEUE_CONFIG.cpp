...
union _anonymous_326// Size=0x4 (Id=326)
{
    struct _anonymous_325 Parallel;// Offset=0x0 Size=0x4
};

struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=327)
{
    ...
    union _anonymous_326 Settings;// Offset=0x50 Size=0x4
