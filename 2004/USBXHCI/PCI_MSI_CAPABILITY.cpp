struct _PCI_CAPABILITIES_HEADER// Size=0x2 (Id=959)
{
    unsigned char CapabilityID;// Offset=0x0 Size=0x1
    unsigned char Next;// Offset=0x1 Size=0x1
};

union _PCI_MSI_MESSAGE_CONTROL// Size=0x2 (Id=958)
{
...
struct _anonymous_909// Size=0xc (Id=909)
{
...
struct _anonymous_910// Size=0x10 (Id=910)
{
...
struct PCI_MSI_CAPABILITY// Size=0x18 (Id=911)
{
    ...
    union _anonymous_908 MessageAddressLower;// Offset=0x4 Size=0x4
    union // Size=0xc (Id=0)
    {
        struct _anonymous_909 Option32Bit;// Offset=0x8 Size=0xc
        struct _anonymous_910 Option64Bit;// Offset=0x8 Size=0x10
    };
};
