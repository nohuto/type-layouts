...
union _XPF_MC_BANK_FLAGS// Size=0x1 (Id=914)
{
...
struct _WHEA_XPF_MC_BANK_DESCRIPTOR// Size=0x1c (Id=861)
{
...
struct _WHEA_XPF_MCE_DESCRIPTOR// Size=0x398 (Id=659)
{
...
union _WHEA_NOTIFICATION_FLAGS// Size=0x2 (Id=936)
{
...
struct _WHEA_XPF_CMC_DESCRIPTOR// Size=0x3a4 (Id=600)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char NumberOfBanks;// Offset=0x3 Size=0x1
...
struct _WHEA_XPF_NMI_DESCRIPTOR// Size=0x3 (Id=871)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
};
...
struct _WHEA_IPF_CMC_DESCRIPTOR// Size=0x4 (Id=537)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
struct _anonymous_655// Size=0x4 (Id=655)
{
    struct // Size=0x4 (Id=0)
    {
...
union _anonymous_656// Size=0x4 (Id=656)
{
    struct _anonymous_655 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _WHEA_PCI_SLOT_NUMBER// Size=0x4 (Id=657)
{
    union _anonymous_656 u;// Offset=0x0 Size=0x4
};
...
union _AER_ENDPOINT_DESCRIPTOR_FLAGS// Size=0x2 (Id=619)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short UncorrectableErrorMaskRW:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_AER_ENDPOINT_DESCRIPTOR// Size=0x20 (Id=544)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
struct _WHEA_AER_BRIDGE_DESCRIPTOR// Size=0x2c (Id=552)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
struct _WHEA_GENERIC_ERROR_DESCRIPTOR// Size=0x34 (Id=644)
{
    unsigned short Type;// Offset=0x0 Size=0x2
...
struct _WHEA_GENERIC_ERROR_DESCRIPTOR_V2// Size=0x50 (Id=614)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Reserved;// Offset=0x2 Size=0x1
    unsigned char Enabled;// Offset=0x3 Size=0x1
...
struct _WHEA_ERROR_SOURCE_CONFIGURATION_DD// Size=0x18 (Id=849)
{
