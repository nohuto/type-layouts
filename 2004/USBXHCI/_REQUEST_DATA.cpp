...
struct _NORMAL_TRB// Size=0x10 (Id=556)
{
...
struct _DATA_STAGE_TRB// Size=0x10 (Id=658)
{
    unsigned long long DataBufferPointer;// Offset=0x0 Size=0x8
    struct // Size=0x8 (Id=0)
    {
...
struct _ISOCH_TRB// Size=0x10 (Id=574)
{
    unsigned long long DataBufferPointer;// Offset=0x0 Size=0x8
    struct // Size=0x8 (Id=0)
    {
...
struct _TRANSFER_EVENT_TRB// Size=0x10 (Id=535)
{
...
struct _COMMAND_COMPLETION_EVENT_TRB// Size=0x10 (Id=897)
{
...
struct _PORT_STATUS_CHANGE_EVENT_TRB// Size=0x10 (Id=874)
{
...
struct _DEVICE_NOTIFICATION_EVENT_TRB// Size=0x10 (Id=584)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _EVALUATE_CONTEXT_COMMAND_TRB// Size=0x10 (Id=660)
{
    unsigned long long InputContextPointer;// Offset=0x0 Size=0x8
    unsigned long Reserved0;// Offset=0x8 Size=0x4
    struct // Size=0x4 (Id=0)
...
struct _RESET_ENDPOINT_COMMAND_TRB// Size=0x10 (Id=551)
{
    unsigned long Reserved0[3];// Offset=0x0 Size=0xc
    struct // Size=0x4 (Id=0)
    {
...
struct _RESET_DEVICE_COMMAND_TRB// Size=0x10 (Id=565)
{
    unsigned long Reserved0[3];// Offset=0x0 Size=0xc
    struct // Size=0x4 (Id=0)
    {
...
struct _SET_EXTENDED_PROPERTY_COMMAND_TRB// Size=0x10 (Id=924)
{
...
struct _ENDPOINT_UPDATE_DATA// Size=0x78 (Id=827)
{
...
struct _ENDPOINT_STATIC_STREAMS_CONFIGURE// Size=0x8 (Id=729)
{
    struct _STATIC_STREAMS_DATA * StaticStreamsData;// Offset=0x0 Size=0x8
};

struct _ENDPOINT_RESET_DATA// Size=0x70 (Id=679)
{
    struct _ENDPOINT_DATA * EndpointData;// Offset=0x0 Size=0x8
    struct _XIL_BUFFER_DATA * InputBufferData;// Offset=0x8 Size=0x8
...
struct _USBDEVICE_ENDPOINTS_CONFIGURE_DATA// Size=0x2 (Id=724)
{
...
struct _CONTROL_TRANSFER_DATA// Size=0xf8 (Id=836)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
    ...
    struct _anonymous_835 PreallocatedScatterGatherList;// Offset=0xd0 Size=0x28
};

struct _STAGE_QUEUE_HEADER// Size=0x8 (Id=917)
{
...
struct _BULK_STAGE_DATA// Size=0xd0 (Id=943)
{
...
struct _BULK_STAGE_QUEUE// Size=0xe0 (Id=937)
{
    struct _STAGE_QUEUE_HEADER Header;// Offset=0x0 Size=0x8
    struct _BULK_STAGE_DATA StageArray[1];// Offset=0x10 Size=0xd0
};

struct _BULK_TRANSFER_DATA// Size=0x160 (Id=779)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
    unsigned char Initialized;// Offset=0x10 Size=0x1
    struct WDFREQUEST__ * WdfRequest;// Offset=0x18 Size=0x8
...
union _REQUEST_DATA// Size=0x300 (Id=503)
{
