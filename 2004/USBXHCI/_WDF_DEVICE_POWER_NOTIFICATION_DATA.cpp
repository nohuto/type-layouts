...
struct _anonymous_632// Size=0x8 (Id=632)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _anonymous_633// Size=0x4 (Id=633)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _anonymous_634// Size=0x8 (Id=634)
{
    struct _anonymous_632 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_633 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_632 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=245)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_634 Data;// Offset=0x4 Size=0x8
};
