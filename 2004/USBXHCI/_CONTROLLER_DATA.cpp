...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=591)
{
...
struct _PCI_DEVICE_INFORMATION// Size=0x38 (Id=636)
{
...
struct _ACPI_DEVICE_INFORMATION// Size=0xf (Id=868)
{
...
union _KSE_XHCI_CONTROLLER_FLAGS// Size=0x10 (Id=355)
{
...
union _FRAME_SNAPSHOT// Size=0x8 (Id=792)
{
...
struct _FRAME_NUMBER_DATA// Size=0x10 (Id=577)
{
...
struct _CONTROLLER_COUNTER// Size=0x20 (Id=598)
{
...
struct _TIME_SYNC_DATA// Size=0xa8 (Id=438)
{
...
union _XHCI_TEST_MODE_FLAGS// Size=0x4 (Id=824)
{
...
struct _CONTROLLER_DATA// Size=0x328 (Id=434)
{
    ...
    struct _CONTROLLER_COUNTER Counter;// Offset=0x1d8 Size=0x20
    struct WDFWORKITEM__ * IdleTimeoutUpdateWorkItem;// Offset=0x1f8 Size=0x8
    unsigned long LastSetIdleTimeout;// Offset=0x200 Size=0x4
    struct POHANDLE__ * PoHandle;// Offset=0x208 Size=0x8
    void * LPEEnterExitCallbackHandle;// Offset=0x210 Size=0x8
    unsigned char WdfPowerReferenceForDebuggerAcquired;// Offset=0x218 Size=0x1
    unsigned char IsSecureDevice;// Offset=0x219 Size=0x1
    unsigned char IsExtendedTBCEnabled;// Offset=0x21a Size=0x1
    unsigned char IsExtendedTBCTRBStatusSupported;// Offset=0x21b Size=0x1
    enum _CONTROLLER_DMA_MODE DMAModeInVSM;// Offset=0x21c Size=0x4
    unsigned long NumberOfDMATargetsInVSM;// Offset=0x220 Size=0x4
    struct TRUSTLET_OBJECT_HANDLE__ * SecureObjectHandle;// Offset=0x228 Size=0x8
    struct _EPROCESS * TrustletProcess;// Offset=0x230 Size=0x8
    unsigned char IsDSMForPortStatusSupported;// Offset=0x238 Size=0x1
    unsigned char IsDSMForKBLWorkaroundsSupported;// Offset=0x239 Size=0x1
    enum _USBD_ENDPOINT_OFFLOAD_MODE UsbEndpointOffloadMode;// Offset=0x23c Size=0x4
    unsigned long NumberOfEndpointsOffloaded;// Offset=0x240 Size=0x4
    void * EndpointsOffloadedCountLock;// Offset=0x248 Size=0x8
    struct _TIME_SYNC_DATA TimeSyncData;// Offset=0x250 Size=0xa8
    struct WDFWORKITEM__ * AudioOffloadWnfStateUpdateWorkItem;// Offset=0x2f8 Size=0x8
    unsigned char IsAudioOffloadActive;// Offset=0x300 Size=0x1
    struct SS_COMPONENT__ * SleepstudySelectiveSuspendUnsupportedHandle;// Offset=0x308 Size=0x8
    unsigned long RecurringResetRecoveryFrequency;// Offset=0x310 Size=0x4
    unsigned long ImmediateResetRecoveryPending;// Offset=0x314 Size=0x4
    struct _XHCI_IRQL_TRACKER * IrqlTrackerArray;// Offset=0x318 Size=0x8
    unsigned long ActiveProcessorCount;// Offset=0x320 Size=0x4
    union _XHCI_TEST_MODE_FLAGS TestFlags;// Offset=0x324 Size=0x4
};
