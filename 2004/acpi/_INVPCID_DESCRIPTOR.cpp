...
struct _anonymous_50// Size=0x10 (Id=50)
{
    unsigned long long Reserved[2];// Offset=0x0 Size=0x10
};

union _INVPCID_DESCRIPTOR// Size=0x10 (Id=51)
{
    struct _anonymous_48 IndividualAddress;// Offset=0x0 Size=0x10
    struct _anonymous_49 SingleContext;// Offset=0x0 Size=0x10
    struct _anonymous_50 AllContextAndGlobals;// Offset=0x0 Size=0x10
    struct _anonymous_50 AllContext;// Offset=0x0 Size=0x10
};
