...
struct _anonymous_620// Size=0x18 (Id=620)
{
...
struct _anonymous_622// Size=0x18 (Id=622)
{
...
struct _anonymous_627// Size=0xc (Id=627)
{
...
struct _anonymous_628// Size=0x18 (Id=628)
{
...
struct _anonymous_629// Size=0x18 (Id=629)
{
...
struct _anonymous_630// Size=0x18 (Id=630)
{
...
union _anonymous_632// Size=0x18 (Id=632)
{
    union // Size=0x18 (Id=0)
    {
        struct _anonymous_620 Port;// Offset=0x0 Size=0x18
        struct _anonymous_620 Memory;// Offset=0x0 Size=0x18
        struct _anonymous_622 Interrupt;// Offset=0x0 Size=0x18
        struct _anonymous_623 Dma;// Offset=0x0 Size=0x8
        struct _anonymous_624 DmaV3;// Offset=0x0 Size=0x10
        struct _anonymous_620 Generic;// Offset=0x0 Size=0x18
        struct _anonymous_625 DevicePrivate;// Offset=0x0 Size=0xc
        struct _anonymous_626 BusNumber;// Offset=0x0 Size=0x10
        struct _anonymous_627 ConfigData;// Offset=0x0 Size=0xc
        struct _anonymous_628 Memory40;// Offset=0x0 Size=0x18
        struct _anonymous_629 Memory48;// Offset=0x0 Size=0x18
        struct _anonymous_630 Memory64;// Offset=0x0 Size=0x18
        struct _anonymous_631 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=633)
{
    ...
    union _anonymous_632 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=590)
{
