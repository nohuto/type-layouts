struct _KSYSTEM_TIME// Size=0xc (Id=333)
{
...
union _anonymous_10// Size=0x4 (Id=10)
{
...
struct _XSTATE_FEATURE// Size=0x8 (Id=601)
{
    unsigned long Offset;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
};

struct _XSTATE_CONFIGURATION// Size=0x338 (Id=343)
{
...
struct _KUSER_SHARED_DATA// Size=0x720 (Id=11)
{
    ...
    union _anonymous_10 UserCetAvailableEnvironments;// Offset=0x30c Size=0x4
