struct _NT_TIB// Size=0x38 (Id=400)
{
...
union _KPRCBFLAG// Size=0x4 (Id=338)
{
...
struct _KDESCRIPTOR// Size=0x10 (Id=655)
{
...
struct _KSPECIAL_REGISTERS// Size=0xf0 (Id=594)
{
...
union _SLIST_HEADER// Size=0x10 (Id=81)
{
    unsigned long long Alignment;// Offset=0x0 Size=0x8
    unsigned long long Region;// Offset=0x8 Size=0x8
    struct _anonymous_80 HeaderX64;// Offset=0x0 Size=0x10
};
...
struct _GENERAL_LOOKASIDE_POOL// Size=0x60 (Id=312)
{
...
struct _KDPC_LIST// Size=0x10 (Id=478)
{
...
struct _KTIMER_TABLE_ENTRY// Size=0x20 (Id=660)
{
...
struct _KGATE// Size=0x18 (Id=330)
{
...
struct _PROC_IDLE_POLICY// Size=0x6 (Id=636)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=466)
{
...
struct _PROC_FEEDBACK// Size=0x90 (Id=498)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=504)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=605)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROC_PERF_CHECK_CONTEXT// Size=0x40 (Id=522)
{
...
struct _PROCESSOR_POWER_STATE// Size=0x200 (Id=470)
{
...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=360)
{
...
struct _SYNCH_COUNTERS// Size=0xb8 (Id=512)
{
...
struct _KENTROPY_TIMING_STATE// Size=0x150 (Id=516)
{
...
struct _anonymous_45// Size=0x38 (Id=45)
{
...
struct _KSECURE_FAULT_INFORMATION// Size=0x10 (Id=296)
{
    unsigned long long FaultCode;// Offset=0x0 Size=0x8
    unsigned long long FaultVa;// Offset=0x8 Size=0x8
};

struct _KSHARED_READY_QUEUE// Size=0x270 (Id=399)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _KTIMER_EXPIRATION_TRACE// Size=0x10 (Id=497)
{
...
struct _KPRCB// Size=0xaf00 (Id=46)
{
    ...
    struct _anonymous_45 StibpPairingTrace;// Offset=0x8738 Size=0x38
...
struct _KPCR// Size=0xb080 (Id=44)
{
    ...
    struct _KPRCB Prcb;// Offset=0x180 Size=0xaf00
};
