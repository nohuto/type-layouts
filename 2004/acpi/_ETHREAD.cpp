...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=421)
{
...
struct _KAPC_STATE// Size=0x30 (Id=372)
{
...
union _ULARGE_INTEGER// Size=0x8 (Id=87)
{
    unsigned long LowPart;// Offset=0x0 Size=0x4
    unsigned long HighPart;// Offset=0x4 Size=0x4
...
struct _KTIMER// Size=0x40 (Id=509)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=394)
{
...
struct _KEVENT// Size=0x18 (Id=79)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
};

struct _KTHREAD// Size=0x430 (Id=72)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _CLIENT_ID// Size=0x10 (Id=240)
{
    void * UniqueProcess;// Offset=0x0 Size=0x8
    void * UniqueThread;// Offset=0x8 Size=0x8
};

struct _KSEMAPHORE// Size=0x20 (Id=364)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=418)
{
...
struct _KLOCK_ENTRY_LOCK_STATE// Size=0x10 (Id=436)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _RTL_RB_TREE// Size=0x10 (Id=39)
{
...
union _KLOCK_ENTRY_BOOST_BITMAP// Size=0x4 (Id=244)
{
...
struct _KLOCK_ENTRY// Size=0x60 (Id=235)
{
...
struct _ETHREAD// Size=0x898 (Id=112)
{
