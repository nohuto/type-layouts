...
struct _anonymous_740// Size=0x20 (Id=740)
{
...
struct _anonymous_741// Size=0x28 (Id=741)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=742)
{
    struct _anonymous_736 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _anonymous_737 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _anonymous_739 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _anonymous_740 QueryOpen;// Offset=0x0 Size=0x20
    struct _anonymous_741 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=714)
{
