...
struct _ACPI_POWER_REQUEST_DEPENDENCY// Size=0x20 (Id=703)
{
...
struct _anonymous_696// Size=0x8 (Id=696)
{
...
struct _anonymous_697// Size=0x8 (Id=697)
{
...
union _anonymous_698// Size=0x28 (Id=698)
{
...
struct _anonymous_699// Size=0x58 (Id=699)
{
    enum _SYSTEM_POWER_STATE SystemPowerState;// Offset=0x0 Size=0x4
    ...
    union _anonymous_698 Registrations;// Offset=0x30 Size=0x28
};

struct _anonymous_700// Size=0x4 (Id=700)
{
    enum _SYSTEM_POWER_STATE EjectPowerState;// Offset=0x0 Size=0x4
};

union _anonymous_701// Size=0x58 (Id=701)
{
    union // Size=0x58 (Id=0)
    {
        struct _anonymous_696 DevicePowerRequest;// Offset=0x0 Size=0x8
        struct _anonymous_697 SystemPowerRequest;// Offset=0x0 Size=0x8
        struct _anonymous_699 WaitWakeRequest;// Offset=0x0 Size=0x58
        struct _anonymous_700 EjectPowerRequest;// Offset=0x0 Size=0x4
    };
};
...
struct _ACPI_POWER_REQUEST// Size=0x108 (Id=702)
{
    ...
    union _anonymous_701 u;// Offset=0x68 Size=0x58
