struct _OBP_SYSTEM_DOS_DEVICE_STATE// Size=0x6c (Id=690)
{
...
struct _OBJECT_NAMESPACE_LOOKUPTABLE// Size=0x260 (Id=745)
{
...
struct _OBP_SILODRIVERSTATE// Size=0x2e0 (Id=673)
{
...
struct _SEP_SILOSTATE// Size=0x30 (Id=560)
{
...
struct _SEP_RM_LSA_CONNECTION_STATE// Size=0x50 (Id=604)
{
...
struct _WNF_LOCK// Size=0x8 (Id=692)
{
    struct _EX_PUSH_LOCK PushLock;// Offset=0x0 Size=0x8
};

struct _WNF_SILODRIVERSTATE// Size=0x38 (Id=658)
{
...
struct _DBGK_SILOSTATE// Size=0x20 (Id=642)
{
...
struct _ESERVERSILO_GLOBALS// Size=0x490 (Id=550)
{
    ...
    struct _UNICODE_STRING NtSystemRoot;// Offset=0x420 Size=0x10
    struct _UNICODE_STRING SiloRootDirectoryName;// Offset=0x430 Size=0x10
    struct _PSP_STORAGE * Storage;// Offset=0x440 Size=0x8
    enum _SERVERSILO_STATE State;// Offset=0x448 Size=0x4
    long ExitStatus;// Offset=0x44c Size=0x4
    struct _KEVENT * DeleteEvent;// Offset=0x450 Size=0x8
    struct _SILO_USER_SHARED_DATA * UserSharedData;// Offset=0x458 Size=0x8
    void * UserSharedSection;// Offset=0x460 Size=0x8
    struct _WORK_QUEUE_ITEM TerminateWorkItem;// Offset=0x468 Size=0x20
    unsigned char IsDownlevelContainer;// Offset=0x488 Size=0x1
};
