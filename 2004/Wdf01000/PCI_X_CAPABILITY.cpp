...
struct PCI_X_CAPABILITY// Size=0x8 (Id=2744)
{
    union // Size=0x4 (Id=0)
    {
        struct _PCI_CAPABILITIES_HEADER Header;// Offset=0x0 Size=0x2
        union <unnamed-type-Command>// Size=0x2 (Id=68129)
        {
            struct <unnamed-type-bits>// Size=0x2 (Id=68130)
            {
        ...
        union <unnamed-type-Status>// Size=0x4 (Id=68139)
        {
            struct <unnamed-type-bits>// Size=0x4 (Id=68140)
            {
