...
struct _EVENT_TRACE_HEADER// Size=0x30 (Id=2606)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _EVENT_TRACE_HEADER::_anonymous_3087::<unnamed-type-Class> Class;// Offset=0x4 Size=0x4
    };
...
struct _MOF_FIELD// Size=0x10 (Id=2340)
{
    unsigned long long DataPtr;// Offset=0x0 Size=0x8
    unsigned long Length;// Offset=0x8 Size=0x4
    unsigned long DataType;// Offset=0xc Size=0x4
};

struct _TRACE_BUFFER// Size=0xc0 (Id=3091)
{
    struct _EVENT_TRACE_HEADER Header;// Offset=0x0 Size=0x30
    struct _MOF_FIELD MofField[9];// Offset=0x30 Size=0x90
};
