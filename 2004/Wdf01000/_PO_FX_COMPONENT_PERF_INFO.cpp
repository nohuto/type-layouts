...
struct _PO_FX_COMPONENT_PERF_SET// Size=0x30 (Id=1782)
{
    ...
    {
        struct _PO_FX_COMPONENT_PERF_SET::_anonymous_3072::<unnamed-type-Discrete> Discrete;// Offset=0x20 Size=0x10
        struct _PO_FX_COMPONENT_PERF_SET::_anonymous_3071::<unnamed-type-Range> Range;// Offset=0x20 Size=0x10
    };
};

struct _PO_FX_COMPONENT_PERF_INFO// Size=0x38 (Id=2676)
{
