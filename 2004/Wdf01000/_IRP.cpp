...
struct _IRP// Size=0xd0 (Id=870)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=9207)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=9225)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=9226)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=9235)
        {
            struct <unnamed-type-Overlay>// Size=0x50 (Id=9236)
            {
