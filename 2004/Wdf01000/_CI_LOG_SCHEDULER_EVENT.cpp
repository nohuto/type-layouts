...
struct _CI_LOG_SCHEDULER_EVENT// Size=0x40 (Id=2155)
{
    struct _EVENT_TRACE_HEADER Header;// Offset=0x0 Size=0x30
    unsigned long ProcessId;// Offset=0x30 Size=0x4
    unsigned long ThreadId;// Offset=0x34 Size=0x4
    unsigned long Priority;// Offset=0x38 Size=0x4
    unsigned long TaskIndex;// Offset=0x3c Size=0x4
};
