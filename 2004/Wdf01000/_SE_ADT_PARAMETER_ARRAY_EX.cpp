...
struct _SE_ADT_PARAMETER_ARRAY_ENTRY// Size=0x20 (Id=1894)
{
...
struct _SE_ADT_PARAMETER_ARRAY_EX// Size=0x420 (Id=1755)
{
    ...
    unsigned long ParameterCount;// Offset=0xc Size=0x4
    unsigned long Length;// Offset=0x10 Size=0x4
    unsigned short FlatSubCategoryId;// Offset=0x14 Size=0x2
    unsigned short Type;// Offset=0x16 Size=0x2
    unsigned long Flags;// Offset=0x18 Size=0x4
    struct _SE_ADT_PARAMETER_ARRAY_ENTRY Parameters[32];// Offset=0x20 Size=0x400
};
