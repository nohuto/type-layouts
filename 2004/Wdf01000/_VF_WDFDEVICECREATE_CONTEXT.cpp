...
struct _WDF_PNPPOWER_EVENT_CALLBACKS// Size=0x90 (Id=760)
{
...
struct _VF_WDFDEVICECREATE_CONTEXT// Size=0x98 (Id=3108)
{
    struct _VF_COMMON_CONTEXT_HEADER CommonHeader;// Offset=0x0 Size=0x8
    struct _WDF_PNPPOWER_EVENT_CALLBACKS PnpPowerEventCallbacksOriginal;// Offset=0x8 Size=0x90
};
