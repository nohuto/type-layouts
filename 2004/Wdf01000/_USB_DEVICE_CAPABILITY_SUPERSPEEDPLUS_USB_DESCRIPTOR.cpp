union _USB_DEVICE_CAPABILITY_SUPERSPEEDPLUS_SPEED// Size=0x4 (Id=2345)
{
...
struct _USB_DEVICE_CAPABILITY_SUPERSPEEDPLUS_USB_DESCRIPTOR// Size=0x10 (Id=2979)
{
    union // Size=0x8 (Id=0)
    {
        ...
        union <unnamed-type-bmAttributes>// Size=0x4 (Id=16042)
        {
        ...
        union <unnamed-type-wFunctionalitySupport>// Size=0x2 (Id=16048)
        {
