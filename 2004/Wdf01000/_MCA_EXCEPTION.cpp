...
union _MCI_STATS// Size=0x8 (Id=2357)
{
    struct <unnamed-type-MciStatus>// Size=0x8 (Id=10485)
    {
    ...
    struct _MCI_STATS::<unnamed-type-MciStatus> MciStatus;// Offset=0x0 Size=0x8
    unsigned long long QuadPart;// Offset=0x0 Size=0x8
};

union _MCI_ADDR// Size=0x8 (Id=2657)
{
...
struct _MCA_EXCEPTION// Size=0x100 (Id=1742)
{
    union // Size=0x18 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x20 (Id=10430)
        {
            struct <unnamed-type-Mca>// Size=0x20 (Id=10431)
            {
            ...
            struct _MCA_EXCEPTION::<unnamed-type-u>::<unnamed-type-Mca> Mca;// Offset=0x0 Size=0x20
            struct <unnamed-type-Mce>// Size=0x10 (Id=10438)
            {
                unsigned long long Address;// Offset=0x0 Size=0x8
                unsigned long long Type;// Offset=0x8 Size=0x8
            };
            struct _MCA_EXCEPTION::<unnamed-type-u>::<unnamed-type-Mce> Mce;// Offset=0x0 Size=0x10
        };
    };
    union _MCA_EXCEPTION::<unnamed-type-u> u;// Offset=0x18 Size=0x20
