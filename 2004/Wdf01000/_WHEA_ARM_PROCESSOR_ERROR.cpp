union _WHEA_ARM_CACHE_ERROR_VALID_BITS// Size=0x2 (Id=1788)
{
...
struct _WHEA_ARM_CACHE_ERROR// Size=0xc (Id=2158)
{
...
union _WHEA_ARM_TLB_ERROR_VALID_BITS// Size=0x2 (Id=2764)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short TransactionType:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_ARM_TLB_ERROR// Size=0xc (Id=2658)
{
...
union _WHEA_ARM_BUS_ERROR_VALID_BITS// Size=0x2 (Id=3010)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short TransactionType:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_ARM_BUS_ERROR// Size=0xc (Id=2797)
{
...
union _WHEA_ARM_PROCESSOR_ERROR// Size=0xc (Id=2708)
{
    union // Size=0xc (Id=0)
    {
