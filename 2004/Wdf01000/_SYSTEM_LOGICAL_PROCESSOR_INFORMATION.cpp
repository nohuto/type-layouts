...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=2080)
{
...
struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION// Size=0x20 (Id=2586)
{
    ...
    {
        struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION::_anonymous_2588::<unnamed-type-ProcessorCore> ProcessorCore;// Offset=0x10 Size=0x1
        struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION::_anonymous_2587::<unnamed-type-NumaNode> NumaNode;// Offset=0x10 Size=0x4
