...
struct _DUMP_INITIALIZATION_CONTEXT// Size=0x108 (Id=1962)
{
    ...
    union _anonymous_1960 DiskInfo;// Offset=0x8c Size=0x10
...
struct _DUMP_STACK_CONTEXT// Size=0x178 (Id=1906)
{
