...
struct _PROC_IDLE_STATE_ACCOUNTING// Size=0x3e8 (Id=1946)
{
    unsigned long long TotalTime;// Offset=0x0 Size=0x8
    ...
    struct _PPM_SELECTION_STATISTICS SelectionStatistics;// Offset=0x28 Size=0x80
    struct _PROC_IDLE_STATE_BUCKET IdleTimeBuckets[26];// Offset=0xa8 Size=0x340
};

struct _PROC_IDLE_ACCOUNTING// Size=0x410 (Id=1683)
{
    ...
    struct _PROC_IDLE_STATE_ACCOUNTING State[1];// Offset=0x28 Size=0x3e8
};
