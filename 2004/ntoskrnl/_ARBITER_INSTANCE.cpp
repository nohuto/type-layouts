struct _ARBITER_ORDERING_LIST// Size=0x10 (Id=1756)
{
    unsigned short Count;// Offset=0x0 Size=0x2
    unsigned short Maximum;// Offset=0x2 Size=0x2
    struct _ARBITER_ORDERING * Orderings;// Offset=0x8 Size=0x8
};

struct _ARBITER_INSTANCE// Size=0x158 (Id=1140)
{
    unsigned long Signature;// Offset=0x0 Size=0x4
    struct _KEVENT * MutexEvent;// Offset=0x8 Size=0x8
    wchar_t * Name;// Offset=0x10 Size=0x8
    wchar_t * OrderingName;// Offset=0x18 Size=0x8
    ...
    long  ( * DeleteOwnerRanges)(struct _ARBITER_INSTANCE * ,void * );// Offset=0x120 Size=0x8
    unsigned char TransactionInProgress;// Offset=0x128 Size=0x1
    struct _KEVENT * TransactionEvent;// Offset=0x130 Size=0x8
    void * Extension;// Offset=0x138 Size=0x8
    struct _DEVICE_OBJECT * BusDeviceObject;// Offset=0x140 Size=0x8
    void * ConflictCallbackContext;// Offset=0x148 Size=0x8
    unsigned char  ( * ConflictCallback)(void * ,struct _RTL_RANGE * );// Offset=0x150 Size=0x8
};
