...
struct _PO_FX_COMPONENT_PERF_SET// Size=0x30 (Id=2044)
{
    ...
    {
        struct _anonymous_2042 Discrete;// Offset=0x20 Size=0x10
        struct _anonymous_2043 Range;// Offset=0x20 Size=0x10
    };
};
