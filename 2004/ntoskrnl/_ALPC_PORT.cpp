...
struct _ALPC_PORT_ATTRIBUTES// Size=0x48 (Id=1023)
{
...
struct _anonymous_798// Size=0x4 (Id=798)
{
...
union _anonymous_799// Size=0x4 (Id=799)
{
    struct _anonymous_798 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

struct _ALPC_PORT// Size=0x1d8 (Id=800)
{
    ...
    union _anonymous_799 u1;// Offset=0x1a0 Size=0x4
