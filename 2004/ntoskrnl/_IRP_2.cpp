...
struct _anonymous_34// Size=0x50 (Id=34)
{
...
union _anonymous_35// Size=0x58 (Id=35)
{
    union // Size=0x58 (Id=0)
    {
        struct _anonymous_34 Overlay;// Offset=0x0 Size=0x50
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=443)
{
    ...
    union _anonymous_442 Tail;// Offset=0x78 Size=0x58
};
