...
struct _MI_VAD_SEQUENTIAL_INFO// Size=0x8 (Id=1980)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _MMVAD// Size=0x88 (Id=1679)
{
    ...
    union _anonymous_1678 u4;// Offset=0x78 Size=0x8
