...
struct _STRING64// Size=0x10 (Id=1421)
{
...
struct _PEB64// Size=0x7c8 (Id=1581)
{
    ...
    unsigned long long SparePointers[4];// Offset=0x320 Size=0x20
    unsigned long SpareUlongs[5];// Offset=0x340 Size=0x14
