struct _DBGKD_READ_MEMORY32// Size=0xc (Id=641)
{
...
struct _DBGKD_WRITE_MEMORY32// Size=0xc (Id=643)
{
    unsigned long TargetBaseAddress;// Offset=0x0 Size=0x4
    unsigned long TransferCount;// Offset=0x4 Size=0x4
...
struct _DBGKD_WRITE_BREAKPOINT32// Size=0x8 (Id=645)
{
...
struct _DBGKD_READ_WRITE_IO32// Size=0xc (Id=647)
{
...
struct _DBGKD_READ_WRITE_IO_EXTENDED32// Size=0x18 (Id=649)
{
    unsigned long DataSize;// Offset=0x0 Size=0x4
...
struct _DBGKD_SET_SPECIAL_CALL32// Size=0x4 (Id=650)
{
    unsigned long SpecialCall;// Offset=0x0 Size=0x4
};

struct _DBGKD_SET_INTERNAL_BREAKPOINT32// Size=0x8 (Id=652)
{
    unsigned long BreakpointAddress;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
};

struct _DBGKD_GET_INTERNAL_BREAKPOINT32// Size=0x1c (Id=655)
{
    unsigned long BreakpointAddress;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
...
struct _DBGKD_GET_VERSION32// Size=0x28 (Id=898)
{
...
struct _DBGKD_MANIPULATE_STATE32// Size=0x34 (Id=659)
{
    ...
    union _anonymous_658 u;// Offset=0xc Size=0x28
};
