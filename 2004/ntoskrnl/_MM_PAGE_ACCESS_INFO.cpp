struct _anonymous_1191// Size=0x4 (Id=1191)
{
...
struct _anonymous_1192// Size=0x4 (Id=1192)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long FilePointerIndex:9;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x9
...
union _MM_PAGE_ACCESS_INFO_FLAGS// Size=0x4 (Id=1193)
{
    struct _anonymous_1191 File;// Offset=0x0 Size=0x4
    struct _anonymous_1192 Private;// Offset=0x0 Size=0x4
};

struct _MM_PAGE_ACCESS_INFO// Size=0x8 (Id=1186)
{
    union // Size=0x8 (Id=0)
    {
