...
struct _anonymous_570// Size=0xc (Id=570)
{
...
struct _anonymous_571// Size=0x18 (Id=571)
{
...
struct _anonymous_572// Size=0x8 (Id=572)
{
    void * CheckStack;// Offset=0x0 Size=0x8
};

struct _anonymous_573// Size=0x20 (Id=573)
{
...
struct _anonymous_575// Size=0x10 (Id=575)
{
...
struct _CM_PARSE_DEBUG_INFO// Size=0x50 (Id=1489)
{
    ...
    struct _anonymous_1488 FailurePoints[4];// Offset=0x2c Size=0x20
};

struct _HIVE_LOAD_FAILURE// Size=0x1b0 (Id=578)
{
    ...
    struct _anonymous_570 Locations[8];// Offset=0xc Size=0x60
    struct _anonymous_570 RecoverableLocations[8];// Offset=0x6c Size=0x60
    struct _anonymous_571 RegistryIO;// Offset=0xd0 Size=0x18
    struct _anonymous_572 CheckRegistry2;// Offset=0xe8 Size=0x8
    struct _anonymous_573 CheckKey;// Offset=0xf0 Size=0x20
    struct _anonymous_574 CheckValueList;// Offset=0x110 Size=0x18
    struct _anonymous_575 CheckHive;// Offset=0x128 Size=0x10
    struct _anonymous_575 CheckHive1;// Offset=0x138 Size=0x10
    struct _anonymous_576 CheckBin;// Offset=0x148 Size=0x10
    struct _anonymous_577 RecoverData;// Offset=0x158 Size=0x4
