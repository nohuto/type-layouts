...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=1049)
{
    struct // Size=0x1 (Id=0)
    {
...
union _KSTACK_COUNT// Size=0x4 (Id=407)
{
...
struct _anonymous_408// Size=0x8 (Id=408)
{
...
union _anonymous_409// Size=0x8 (Id=409)
{
    unsigned long long SecureHandle;// Offset=0x0 Size=0x8
    struct _anonymous_408 Flags;// Offset=0x0 Size=0x8
};

struct _KPROCESS// Size=0x438 (Id=410)
{
    ...
    union _anonymous_409 SecureState;// Offset=0x3e0 Size=0x8
...
struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=1459)
{
...
struct _ALPC_PROCESS_CONTEXT// Size=0x20 (Id=1225)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=1183)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=435)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=1105)
{
...
struct _anonymous_436// Size=0x4 (Id=436)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=1154)
{
    struct _RTL_AVL_TREE Tree;// Offset=0x0 Size=0x8
    struct _EX_PUSH_LOCK Lock;// Offset=0x8 Size=0x8
};

struct _EPROCESS// Size=0xa40 (Id=438)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _anonymous_436 MitigationFlagsValues;// Offset=0x9d0 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x9d4 Size=0x4
        struct _anonymous_437 MitigationFlags2Values;// Offset=0x9d4 Size=0x4
    };
