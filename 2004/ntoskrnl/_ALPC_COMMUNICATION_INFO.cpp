...
struct _ALPC_COMMUNICATION_INFO// Size=0x48 (Id=796)
{
    ...
    struct _ALPC_HANDLE_TABLE HandleTable;// Offset=0x28 Size=0x18
    struct _KALPC_MESSAGE * CloseMessage;// Offset=0x40 Size=0x8
};
