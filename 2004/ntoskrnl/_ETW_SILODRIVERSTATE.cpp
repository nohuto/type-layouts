...
struct _ETW_LAST_ENABLE_INFO// Size=0x10 (Id=1666)
{
...
struct _TRACE_ENABLE_INFO// Size=0x20 (Id=1362)
{
...
struct _ETW_GUID_ENTRY// Size=0x1a8 (Id=1139)
{
...
struct _ETW_PRIV_HANDLE_DEMUX_TABLE// Size=0x20 (Id=1454)
{
...
struct _ETW_COUNTERS// Size=0x10 (Id=1295)
{
...
struct _ETW_SYSTEM_LOGGER// Size=0x2 (Id=1408)
{
    unsigned char LoggerId;// Offset=0x0 Size=0x1
    unsigned char ClockType;// Offset=0x1 Size=0x1
};

struct _PERFINFO_GROUPMASK// Size=0x20 (Id=455)
{
    unsigned long Masks[8];// Offset=0x0 Size=0x20
};

struct _ETW_SYSTEM_LOGGER_SETTINGS// Size=0x174 (Id=1257)
{
...
struct _KMUTANT// Size=0x38 (Id=1358)
{
