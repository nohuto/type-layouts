struct _MI_PARTITION_FLAGS// Size=0x4 (Id=1798)
{
...
union _anonymous_1382// Size=0x4 (Id=1382)
{
...
struct _MI_PARTITION_CORE// Size=0x1b8 (Id=1383)
{
    unsigned short PartitionId;// Offset=0x0 Size=0x2
    union _anonymous_1382 u;// Offset=0x4 Size=0x4
...
struct _MMDEREFERENCE_SEGMENT_HEADER// Size=0x50 (Id=1844)
{
...
struct _MI_PTE_CHAIN_HEAD// Size=0x18 (Id=1934)
{
...
struct _MI_CROSS_PARTITION_CHARGES// Size=0x20 (Id=1879)
{
...
struct _MI_PARTITION_SEGMENTS// Size=0x340 (Id=1476)
{
...
struct _MI_DECAY_TIMER_LINKAGE// Size=0x8 (Id=1619)
{
    struct // Size=0x8 (Id=0)
    {
...
union _anonymous_1280// Size=0x8 (Id=1280)
{
    unsigned long long Long;// Offset=0x0 Size=0x8
    struct _MI_DECAY_TIMER_LINKAGE e1;// Offset=0x0 Size=0x8
};

struct _MI_DECAY_TIMER_LINK// Size=0x8 (Id=1281)
{
    union _anonymous_1280 u1;// Offset=0x0 Size=0x8
};

struct _MI_LDW_WORK_CONTEXT// Size=0x38 (Id=1445)
{
...
struct _MI_AVAILABLE_PAGE_WAIT_STATES// Size=0x20 (Id=1479)
{
...
union _anonymous_1616// Size=0x4 (Id=1616)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_SLAB_ALLOCATOR_CONTEXT// Size=0x78 (Id=1617)
{
    ...
    union _anonymous_1616 Flags;// Offset=0x38 Size=0x4
...
struct _MI_PARTITION_PAGE_LISTS// Size=0xfc0 (Id=1278)
{
...
struct _MI_PARTITION_COMMIT// Size=0x40 (Id=1595)
{
...
struct _MI_WRITE_CALIBRATION// Size=0x20 (Id=1948)
{
...
struct _MI_PARTITION_ZEROING// Size=0xb0 (Id=1558)
{
...
struct _MI_PAGE_COMBINING_SUPPORT// Size=0x190 (Id=1299)
{
...
struct _MMWORKING_SET_EXPANSION_HEAD// Size=0x10 (Id=1058)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
};
...
struct _anonymous_1393// Size=0x38 (Id=1393)
{
    struct _MDL Mdl;// Offset=0x0 Size=0x30
    unsigned long long Page[1];// Offset=0x30 Size=0x8
};

struct _MI_PAGEFILE_TRACES// Size=0x78 (Id=1394)
{
    ...
    struct _anonymous_1393 MdlHack;// Offset=0x40 Size=0x38
};

struct _MI_VISIBLE_PARTITION// Size=0x1200 (Id=1113)
{
...
struct _MI_PARTITION// Size=0x2d00 (Id=558)
{
