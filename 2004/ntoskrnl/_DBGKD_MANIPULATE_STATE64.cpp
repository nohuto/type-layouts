...
struct _DBGKD_GET_CONTEXT// Size=0x4 (Id=1420)
{
...
struct _X86_DBGKD_CONTROL_SET// Size=0x10 (Id=1424)
{
    unsigned long TraceFlag;// Offset=0x0 Size=0x4
...
struct _IA64_DBGKD_CONTROL_SET// Size=0x14 (Id=1584)
{
...
struct _ARM_DBGKD_CONTROL_SET// Size=0xc (Id=1296)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
...
struct _ARM64_DBGKD_CONTROL_SET// Size=0x18 (Id=1455)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
...
struct _PPC_DBGKD_CONTROL_SET// Size=0xc (Id=1704)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
    unsigned long CurrentSymbolStart;// Offset=0x4 Size=0x4
    unsigned long CurrentSymbolEnd;// Offset=0x8 Size=0x4
...
struct _DBGKD_GET_VERSION64// Size=0x28 (Id=1602)
{
...
struct _DBGKD_FILL_MEMORY// Size=0x10 (Id=1711)
{
...
struct _DBGKD_SWITCH_PARTITION// Size=0x4 (Id=1577)
{
    unsigned long Partition;// Offset=0x0 Size=0x4
};

struct _DBGKD_CONTEXT_EX// Size=0xc (Id=1624)
{
