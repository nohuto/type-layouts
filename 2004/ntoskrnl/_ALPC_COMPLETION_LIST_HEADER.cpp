struct _anonymous_1650// Size=0x8 (Id=1650)
{
...
union _anonymous_1651// Size=0x8 (Id=1651)
{
    struct _anonymous_1650 s1;// Offset=0x0 Size=0x8
    long long Value;// Offset=0x0 Size=0x8
};

struct _ALPC_COMPLETION_LIST_STATE// Size=0x8 (Id=1409)
{
    union _anonymous_1651 u1;// Offset=0x0 Size=0x8
};

struct _RTL_SRWLOCK// Size=0x8 (Id=1347)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _ALPC_COMPLETION_LIST_HEADER// Size=0x180 (Id=1410)
{
