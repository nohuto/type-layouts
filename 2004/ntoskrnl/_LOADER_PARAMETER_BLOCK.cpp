...
struct _I386_LOADER_BLOCK// Size=0x10 (Id=1931)
{
...
struct _ARM_LOADER_BLOCK// Size=0x4 (Id=2000)
{
    unsigned long PlaceHolder;// Offset=0x0 Size=0x4
};

union _anonymous_1743// Size=0x10 (Id=1743)
{
...
struct _EFI_FIRMWARE_INFORMATION// Size=0x38 (Id=2007)
{
...
struct _PCAT_FIRMWARE_INFORMATION// Size=0x4 (Id=2014)
{
    unsigned long PlaceHolder;// Offset=0x0 Size=0x4
};

union _anonymous_1941// Size=0x38 (Id=1941)
{
...
struct _FIRMWARE_INFORMATION_LOADER_BLOCK// Size=0x40 (Id=1942)
{
    ...
    union _anonymous_1941 u;// Offset=0x8 Size=0x38
};

struct _LOADER_PARAMETER_BLOCK// Size=0x160 (Id=1744)
{
    ...
    union _anonymous_1743 u;// Offset=0xf8 Size=0x10
