...
struct _anonymous_1507// Size=0x8 (Id=1507)
{
...
{
    struct _anonymous_1507 Disk;// Offset=0x0 Size=0x8
};

struct _DEVICE_OBJECT_POWER_EXTENSION// Size=0x60 (Id=1509)
{
    ...
    union _anonymous_1508 Specific;// Offset=0x58 Size=0x8
};
