struct _anonymous_1808// Size=0x10 (Id=1808)
{
...
struct _anonymous_1809// Size=0x10 (Id=1809)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
};

struct _RTLP_RANGE_LIST_ENTRY// Size=0x38 (Id=1810)
{
    unsigned long long Start;// Offset=0x0 Size=0x8
    unsigned long long End;// Offset=0x8 Size=0x8
    union // Size=0x10 (Id=0)
    {
        struct _anonymous_1808 Allocated;// Offset=0x10 Size=0x10
        struct _anonymous_1809 Merged;// Offset=0x10 Size=0x10
    };
