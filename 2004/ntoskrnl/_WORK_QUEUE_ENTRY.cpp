...
struct _anonymous_708// Size=0x30 (Id=708)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
struct _anonymous_709// Size=0x68 (Id=709)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
union _anonymous_710// Size=0x68 (Id=710)
{
    struct _anonymous_704 Read;// Offset=0x0 Size=0x10
    struct _anonymous_705 Write;// Offset=0x0 Size=0x8
    struct _anonymous_706 Event;// Offset=0x0 Size=0x8
    struct _anonymous_707 Notification;// Offset=0x0 Size=0x4
    struct _anonymous_708 LowPriWrite;// Offset=0x0 Size=0x30
    struct _anonymous_709 AsyncRead;// Offset=0x0 Size=0x68
};

struct _WORK_QUEUE_ENTRY// Size=0x88 (Id=711)
{
    struct _LIST_ENTRY WorkQueueLinks;// Offset=0x0 Size=0x10
    union _anonymous_710 Parameters;// Offset=0x10 Size=0x68
