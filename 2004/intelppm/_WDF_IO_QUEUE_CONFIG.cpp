...
struct _anonymous_327// Size=0x4 (Id=327)
{
...
{
    struct _anonymous_327 Parallel;// Offset=0x0 Size=0x4
};

struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=329)
{
    ...
    union _anonymous_328 Settings;// Offset=0x50 Size=0x4
