...
struct _PCC_SUBSPACE_REGISTRATION// Size=0xb8 (Id=651)
{
    struct _LIST_ENTRY Link;// Offset=0x0 Size=0x10
    struct _PCC_INTERFACE_STANDARD PccInterface;// Offset=0x10 Size=0x80
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
        {
            unsigned long Acquired:1;// Offset=0x90 Size=0x4 BitOffset=0x0 BitSize=0x1
            unsigned long Reserved:31;// Offset=0x90 Size=0x4 BitOffset=0x1 BitSize=0x1f
        };
        unsigned long Flags;// Offset=0x90 Size=0x4
    };
    struct WDFSPINLOCK__ * Mutex;// Offset=0x98 Size=0x8
    void  ( * RuntimeCallback)(long ,unsigned long long );// Offset=0xa0 Size=0x8
    unsigned long long RuntimeContext;// Offset=0xa8 Size=0x8
    struct _CPC_COMMAND_COMPLETION * CpcCmdCompletion;// Offset=0xb0 Size=0x8
};
