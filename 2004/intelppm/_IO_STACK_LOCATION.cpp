...
struct _anonymous_84// Size=0x18 (Id=84)
{
...
struct _anonymous_89// Size=0x18 (Id=89)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _anonymous_90// Size=0x10 (Id=90)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
};

struct _anonymous_91// Size=0x20 (Id=91)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
...
struct _anonymous_95// Size=0x18 (Id=95)
{
...
struct _anonymous_96// Size=0x20 (Id=96)
{
    unsigned long OutputBufferLength;// Offset=0x0 Size=0x4
    unsigned long InputBufferLength;// Offset=0x8 Size=0x4
...
struct _anonymous_103// Size=0x4 (Id=103)
{
    enum _DEVICE_RELATION_TYPE Type;// Offset=0x0 Size=0x4
};

struct _anonymous_105// Size=0x20 (Id=105)
{
...
struct _anonymous_109// Size=0x1 (Id=109)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _anonymous_111// Size=0x4 (Id=111)
{
...
struct _anonymous_117// Size=0x4 (Id=117)
{
    enum _SYSTEM_POWER_STATE PowerState;// Offset=0x0 Size=0x4
};

struct _anonymous_118// Size=0x8 (Id=118)
{
    struct _POWER_SEQUENCE * PowerSequence;// Offset=0x0 Size=0x8
};

struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=541)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=510)
{
...
struct _anonymous_122// Size=0x10 (Id=122)
{
...
struct _anonymous_124// Size=0x20 (Id=124)
{
...
union _anonymous_125// Size=0x20 (Id=125)
{
    struct _anonymous_81 Create;// Offset=0x0 Size=0x20
    struct _anonymous_82 CreatePipe;// Offset=0x0 Size=0x20
    struct _anonymous_83 CreateMailslot;// Offset=0x0 Size=0x20
    struct _anonymous_84 Read;// Offset=0x0 Size=0x18
    struct _anonymous_84 Write;// Offset=0x0 Size=0x18
    struct _anonymous_86 QueryDirectory;// Offset=0x0 Size=0x20
    struct _anonymous_87 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _anonymous_89 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _anonymous_90 QueryFile;// Offset=0x0 Size=0x10
    struct _anonymous_91 SetFile;// Offset=0x0 Size=0x20
    struct _anonymous_93 QueryVolume;// Offset=0x0 Size=0x10
    struct _anonymous_94 FileSystemControl;// Offset=0x0 Size=0x20
    struct _anonymous_95 LockControl;// Offset=0x0 Size=0x18
    struct _anonymous_96 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _anonymous_97 QuerySecurity;// Offset=0x0 Size=0x10
    struct _anonymous_98 SetSecurity;// Offset=0x0 Size=0x10
    struct _anonymous_99 MountVolume;// Offset=0x0 Size=0x10
    struct _anonymous_99 VerifyVolume;// Offset=0x0 Size=0x10
    struct _anonymous_101 Scsi;// Offset=0x0 Size=0x8
    struct _anonymous_103 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _anonymous_105 QueryInterface;// Offset=0x0 Size=0x20
    struct _anonymous_106 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _anonymous_107 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _anonymous_108 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _anonymous_109 SetLock;// Offset=0x0 Size=0x1
    struct _anonymous_111 QueryId;// Offset=0x0 Size=0x4
    struct _anonymous_113 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _anonymous_115 UsageNotification;// Offset=0x0 Size=0x10
    struct _anonymous_117 WaitWake;// Offset=0x0 Size=0x4
    struct _anonymous_118 PowerSequence;// Offset=0x0 Size=0x8
    struct _anonymous_121 Power;// Offset=0x0 Size=0x20
    struct _anonymous_122 StartDevice;// Offset=0x0 Size=0x10
    struct _anonymous_123 WMI;// Offset=0x0 Size=0x20
    struct _anonymous_124 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=126)
{
    ...
    union _anonymous_125 Parameters;// Offset=0x8 Size=0x20
