...
struct _anonymous_303// Size=0x20 (Id=303)
{
...
union _anonymous_304// Size=0x20 (Id=304)
{
    ...
    struct _anonymous_302 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _anonymous_303 Others;// Offset=0x0 Size=0x20
};

struct _WDF_REQUEST_PARAMETERS// Size=0x28 (Id=305)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned char MinorFunction;// Offset=0x2 Size=0x1
    enum _WDF_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    union _anonymous_304 Parameters;// Offset=0x8 Size=0x20
};
