struct PPM_DRIVER_INTERFACE// Size=0xf8 (Id=596)
{
    ...
    long  ( * GetNativeCppcPerfControlHandler)(struct _CPC_RUNTIME_STATE * ,void  ( ** )(unsigned long long ,struct _PERF_CONTROL_STATE_SELECTION * ,unsigned char ,unsigned char ),void  ( ** )(unsigned long long ,struct _PERF_CONTROL_STATE_SELECTION * ,unsigned char ,unsigned char ),void  ( ** )(unsigned long long ,struct _PERF_CONTROL_STATE_SELECTION * ,unsigned char ,unsigned char ),unsigned long  ( ** )(unsigned long long ,unsigned long ,unsigned long ,unsigned long ,unsigned long ,unsigned long ,unsigned long ,unsigned long * ,unsigned long long * ),unsigned char * ,unsigned long * );// Offset=0xa8 Size=0x8
    void  ( * EnableNativeInterrupt)();// Offset=0xb0 Size=0x8
    long  ( * InitEnergyCounters)();// Offset=0xb8 Size=0x8
    void  ( * UnInitEnergyCounters)();// Offset=0xc0 Size=0x8
    ...
    unsigned long PStateFFHControlRegister;// Offset=0xd8 Size=0x4
    unsigned long long PStateFFHControlMask;// Offset=0xe0 Size=0x8
    unsigned long TStateFFHControlRegister;// Offset=0xe8 Size=0x4
    unsigned long long TStateFFHControlMask;// Offset=0xf0 Size=0x8
};
