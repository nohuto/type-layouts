...
struct _anonymous_437// Size=0x8 (Id=437)
{
...
union _anonymous_439// Size=0x8 (Id=439)
{
    struct _anonymous_437 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_438 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_437 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=249)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_439 Data;// Offset=0x4 Size=0x8
};
