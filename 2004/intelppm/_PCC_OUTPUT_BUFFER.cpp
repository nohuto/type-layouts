struct _anonymous_691// Size=0x4 (Id=691)
{
...
union _PCC_OUTPUT_BUFFER// Size=0x4 (Id=693)
{
    struct _anonymous_691 GetAverageFrequency;// Offset=0x0 Size=0x4
    struct _anonymous_692 SetDesiredFrequency;// Offset=0x0 Size=0x4
};
