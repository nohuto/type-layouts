union _unnamed_141// Size=0x8 (Id=141)
{
...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=106)
{
    union // Size=0x4 (Id=0)
    {
...
union _unnamed_144// Size=0x10 (Id=144)
{
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_143 AsynchronousParameters;// Offset=0x0 Size=0x10
        union _LARGE_INTEGER AllocationSize;// Offset=0x0 Size=0x8
    };
};

struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=565)
{
...
struct _unnamed_145// Size=0x58 (Id=145)
{
...
union _unnamed_146// Size=0x58 (Id=146)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_145 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=147)
{
    ...
    union _unnamed_141 AssociatedIrp;// Offset=0x18 Size=0x8
