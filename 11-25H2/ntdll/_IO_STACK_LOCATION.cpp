struct _unnamed_148// Size=0x20 (Id=148)
{
...
struct _unnamed_151// Size=0x18 (Id=151)
{
...
struct _unnamed_153// Size=0x20 (Id=153)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_156// Size=0x18 (Id=156)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _unnamed_160// Size=0x4 (Id=160)
{
    unsigned long Length;// Offset=0x0 Size=0x4
};
...
struct _unnamed_166// Size=0x10 (Id=166)
{
    unsigned long SecurityInformation;// Offset=0x0 Size=0x4
    unsigned long Length;// Offset=0x8 Size=0x4
};

struct _unnamed_167// Size=0x10 (Id=167)
{
    unsigned long SecurityInformation;// Offset=0x0 Size=0x4
    void * SecurityDescriptor;// Offset=0x8 Size=0x8
};

struct _unnamed_168// Size=0x18 (Id=168)
{
...
struct _unnamed_169// Size=0x10 (Id=169)
{
    struct _VPB * Vpb;// Offset=0x0 Size=0x8
    struct _DEVICE_OBJECT * DeviceObject;// Offset=0x8 Size=0x8
};

struct _unnamed_171// Size=0x8 (Id=171)
{
    struct _SCSI_REQUEST_BLOCK * Srb;// Offset=0x0 Size=0x8
};

struct _unnamed_172// Size=0x20 (Id=172)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_174// Size=0x4 (Id=174)
{
    enum _DEVICE_RELATION_TYPE Type;// Offset=0x0 Size=0x4
};

struct _unnamed_175// Size=0x20 (Id=175)
{
...
struct _unnamed_176// Size=0x8 (Id=176)
{
...
struct _unnamed_179// Size=0x1 (Id=179)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _unnamed_181// Size=0x4 (Id=181)
{
...
struct _unnamed_188// Size=0x8 (Id=188)
{
    struct _POWER_SEQUENCE * PowerSequence;// Offset=0x0 Size=0x8
};

struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=556)
{
    union // Size=0x4 (Id=0)
    {
...
struct _unnamed_193// Size=0x20 (Id=193)
{
...
struct _unnamed_194// Size=0x20 (Id=194)
{
...
union _unnamed_195// Size=0x20 (Id=195)
{
    struct _unnamed_148 Create;// Offset=0x0 Size=0x20
    struct _unnamed_149 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_150 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_151 Read;// Offset=0x0 Size=0x18
    struct _unnamed_151 Write;// Offset=0x0 Size=0x18
    struct _unnamed_153 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_154 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_156 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_157 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_158 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_159 QueryEa;// Offset=0x0 Size=0x20
    struct _unnamed_160 SetEa;// Offset=0x0 Size=0x4
    struct _unnamed_162 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_162 SetVolume;// Offset=0x0 Size=0x10
    struct _unnamed_163 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_164 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_165 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_166 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_167 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_168 MountVolume;// Offset=0x0 Size=0x18
    struct _unnamed_169 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_171 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_172 QueryQuota;// Offset=0x0 Size=0x20
    struct _unnamed_160 SetQuota;// Offset=0x0 Size=0x4
    struct _unnamed_174 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_175 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_176 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_177 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_178 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_179 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_181 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_183 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_185 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_187 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_188 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_191 Power;// Offset=0x0 Size=0x20
    struct _unnamed_192 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_193 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_194 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=196)
{
    ...
    union _unnamed_195 Parameters;// Offset=0x8 Size=0x20
