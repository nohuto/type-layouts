...
struct _unnamed_900// Size=0x18 (Id=900)
{
...
struct _unnamed_901// Size=0x20 (Id=901)
{
...
struct _unnamed_902// Size=0x28 (Id=902)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=903)
{
    struct _unnamed_897 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_898 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_900 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _unnamed_901 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_902 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=880)
{
