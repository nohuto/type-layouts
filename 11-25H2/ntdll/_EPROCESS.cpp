...
struct _KAB_UM_PROCESS_CONTEXT// Size=0x10 (Id=403)
{
...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=448)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _KGROUP_MASK// Size=0x10 (Id=391)
{
    unsigned long long Masks[2];// Offset=0x0 Size=0x10
};

union _KSTACK_COUNT// Size=0x4 (Id=88)
{
...
struct _KPROCESS// Size=0x1c8 (Id=92)
{
    ...
    union _unnamed_90 SecureState;// Offset=0x170 Size=0x8
...
struct _EX_RUNDOWN_REF// Size=0x8 (Id=675)
{
    union // Size=0x8 (Id=0)
    {
...
struct _RTL_AVL_TREE// Size=0x8 (Id=48)
{
    struct _RTL_BALANCED_NODE * Root;// Offset=0x0 Size=0x8
};

struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=641)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=593)
{
    union // Size=0x4 (Id=0)
    {
...
struct _MMSUPPORT_INSTANCE// Size=0xc0 (Id=594)
{
...
struct _MMSUPPORT_SHARED// Size=0x80 (Id=610)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=507)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=603)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WNF_STATE_NAME// Size=0x8 (Id=740)
{
    unsigned long Data[2];// Offset=0x0 Size=0x8
};

struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=484)
{
    unsigned long HighEdgeFilter;// Offset=0x0 Size=0x4
    unsigned long LowEdgeFilter;// Offset=0x4 Size=0x4
};

struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=472)
{
...
struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=497)
{
...
union _PROCESS_EXECUTION_TRANSITION// Size=0x2 (Id=770)
{
...
union _PROCESS_EXECUTION_STATE// Size=0x1 (Id=583)
{
...
union _PROCESS_EXECUTION// Size=0x4 (Id=575)
{
