...
union _unnamed_802// Size=0x4 (Id=802)
{
    struct _unnamed_801 s1;// Offset=0x0 Size=0x4
...
{
    struct _unnamed_803 s2;// Offset=0x0 Size=0x4
...
struct _PORT_MESSAGE// Size=0x28 (Id=805)
{
    union _unnamed_802 u1;// Offset=0x0 Size=0x4
    union _unnamed_804 u2;// Offset=0x4 Size=0x4
