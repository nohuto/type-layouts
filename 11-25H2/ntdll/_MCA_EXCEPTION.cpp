...
union _MCI_STATS// Size=0x8 (Id=871)
{
    struct _unnamed_870 MciStatus;// Offset=0x0 Size=0x8
    unsigned long long QuadPart;// Offset=0x0 Size=0x8
};

union _MCI_ADDR// Size=0x8 (Id=860)
{
...
struct _unnamed_753// Size=0x20 (Id=753)
{
...
struct _unnamed_754// Size=0x10 (Id=754)
{
    unsigned long long Address;// Offset=0x0 Size=0x8
    unsigned long long Type;// Offset=0x8 Size=0x8
};

union _unnamed_755// Size=0x20 (Id=755)
{
    union // Size=0x20 (Id=0)
    {
        struct _unnamed_753 Mca;// Offset=0x0 Size=0x20
        struct _unnamed_754 Mce;// Offset=0x0 Size=0x10
    };
};

struct _MCA_EXCEPTION// Size=0x100 (Id=756)
{
    ...
    union _unnamed_755 u;// Offset=0x18 Size=0x20
