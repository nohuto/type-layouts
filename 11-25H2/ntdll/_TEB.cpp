struct _NT_TIB// Size=0x38 (Id=600)
{
...
struct _CLIENT_ID// Size=0x10 (Id=385)
{
...
struct _ACTIVATION_CONTEXT_STACK// Size=0x28 (Id=445)
{
...
struct _GDI_TEB_BATCH// Size=0x4e8 (Id=609)
{
...
struct _UNICODE_STRING// Size=0x10 (Id=105)
{
...
struct _GROUP_AFFINITY// Size=0x10 (Id=380)
{
...
struct _TEB// Size=0x1878 (Id=29)
{
    ...
    void * SystemReserved1[25];// Offset=0x190 Size=0xc8
    ...
    void * HeapWalkContext;// Offset=0x1858 Size=0x8
    struct _GROUP_AFFINITY PrimaryGroupAffinity;// Offset=0x1860 Size=0x10
