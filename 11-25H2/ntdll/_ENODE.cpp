...
struct _KNODE_SUBNODE_SEARCH_RANKS// Size=0x20 (Id=480)
{
    unsigned char Ranks[32];// Offset=0x0 Size=0x20
};

struct _KNODE// Size=0x178 (Id=85)
{
    ...
    struct _unnamed_84 Flags;// Offset=0xa Size=0x1
...
struct _ENODE// Size=0x1c0 (Id=117)
{
