...
struct _SECURITY_SUBJECT_CONTEXT// Size=0x20 (Id=634)
{
...
struct _PRIVILEGE_SET// Size=0x14 (Id=560)
{
    unsigned long PrivilegeCount;// Offset=0x0 Size=0x4
    unsigned long Control;// Offset=0x4 Size=0x4
...
union _unnamed_123// Size=0x2c (Id=123)
{
...
struct _ACCESS_STATE// Size=0xa0 (Id=124)
{
    ...
    union _unnamed_123 Privileges;// Offset=0x50 Size=0x2c
