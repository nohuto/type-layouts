struct _KSYSTEM_TIME// Size=0xc (Id=251)
{
...
struct _XSTATE_FEATURE// Size=0x8 (Id=791)
{
    unsigned long Offset;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
};

struct _XSTATE_CONFIGURATION// Size=0x348 (Id=528)
{
...
struct _KUSER_SHARED_DATA// Size=0xa80 (Id=20)
{
