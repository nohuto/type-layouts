...
struct _PROCESSOR_IDLE_CONSTRAINTS// Size=0x30 (Id=812)
{
...
struct _PPM_SELECTION_MENU// Size=0x10 (Id=856)
{
    unsigned long Count;// Offset=0x0 Size=0x4
    struct _PPM_SELECTION_MENU_ENTRY * Entries;// Offset=0x8 Size=0x8
};

struct _PPM_COORDINATED_SELECTION// Size=0x18 (Id=873)
{
...
struct _PPM_VETO_ACCOUNTING// Size=0x28 (Id=878)
{
...
struct _PPM_IDLE_STATE// Size=0x158 (Id=842)
{
...
struct _PPM_IDLE_STATES// Size=0x578 (Id=789)
{
