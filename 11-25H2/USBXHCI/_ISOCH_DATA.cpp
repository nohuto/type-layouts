...
struct _COMMON_BUFFER_CALLBACK_DATA// Size=0x30 (Id=702)
{
...
struct _TRANSFERRING_COUNTER// Size=0x28 (Id=599)
{
...
union _ISOCH_DATA_FLAGS// Size=0x4 (Id=1070)
{
...
struct _ISOCH_DATA// Size=0x1c0 (Id=921)
{
    ...
    struct WDFTIMER__ * WdfRingEmptyTimer;// Offset=0x148 Size=0x8
    union _ISOCH_DATA_FLAGS Flags;// Offset=0x150 Size=0x4
    unsigned char DpcRunning;// Offset=0x154 Size=0x1
    unsigned char RingDoorbellOnFirstTD;// Offset=0x155 Size=0x1
    unsigned char IsochPure;// Offset=0x156 Size=0x1
    unsigned long CommonBufferAcquireAttemptCount;// Offset=0x158 Size=0x4
    long ContinueMapping;// Offset=0x15c Size=0x4
    long AttemptMapping;// Offset=0x160 Size=0x4
    long TransferRingEmptyEventReceived;// Offset=0x164 Size=0x4
    long LateDetected;// Offset=0x168 Size=0x4
    unsigned long PacketsPerFrame;// Offset=0x16c Size=0x4
    unsigned long NextTransferStartFrame;// Offset=0x170 Size=0x4
    unsigned long FrameNumberOfLastTDInSchedule;// Offset=0x174 Size=0x4
    struct _ISOCH_STAGE_DATA * CurrentStage;// Offset=0x178 Size=0x8
    unsigned long PendingStageCount;// Offset=0x180 Size=0x4
    struct _LIST_ENTRY PendingTransferList;// Offset=0x188 Size=0x10
    struct _LIST_ENTRY WaitingForCancelCallbackTransferList;// Offset=0x198 Size=0x10
    struct _LIST_ENTRY CompletionTransferList;// Offset=0x1a8 Size=0x10
    unsigned long EstimatedTrbsPerTD;// Offset=0x1b8 Size=0x4
};
