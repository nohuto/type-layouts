...
struct _unnamed_671// Size=0x8 (Id=671)
{
...
struct _unnamed_672// Size=0x4 (Id=672)
{
    enum _WDF_DEVICE_POWER_POLICY_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_673// Size=0x8 (Id=673)
{
    struct _unnamed_671 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_672 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_671 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=264)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_673 Data;// Offset=0x4 Size=0x8
};
