...
struct _XIL_COMMON_BUFFER_PAGE// Size=0x10 (Id=522)
{
...
struct _COMMON_BUFFER_SECURE_DMA_PAGE// Size=0x80 (Id=525)
{
    ...
    struct _unnamed_524 PageMdl;// Offset=0x20 Size=0x38
    struct _MDL * MultiPageMdl;// Offset=0x58 Size=0x8
    struct _SECURE_DMA_MAPPING DmaMapping;// Offset=0x60 Size=0x20
};
