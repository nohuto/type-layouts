...
struct _USBDEVICE_UPDATE_FAILURE_FLAGS// Size=0x4 (Id=1051)
{
...
struct _USBDEVICE_UPDATE_20_HARDWARE_LPM_PARAMETERS// Size=0x4 (Id=982)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _USBDEVICE_UPDATE// Size=0x48 (Id=736)
{
