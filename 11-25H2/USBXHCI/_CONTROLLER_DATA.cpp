...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=669)
{
...
struct _ACPI_DEVICE_INFORMATION// Size=0xf (Id=977)
{
...
union _KSE_XHCI_CONTROLLER_FLAGS// Size=0x10 (Id=419)
{
...
union _FRAME_SNAPSHOT// Size=0x8 (Id=899)
{
...
struct _FRAME_NUMBER_DATA// Size=0x10 (Id=653)
{
...
struct _CONTROLLER_COUNTER// Size=0x60 (Id=677)
{
...
struct _TIME_SYNC_DATA// Size=0xa8 (Id=502)
{
...
union _XHCI_TEST_MODE_FLAGS// Size=0x4 (Id=928)
{
...
struct _CONTROLLER_DATA// Size=0x508 (Id=498)
{
    ...
    struct _CONTROLLER_COUNTER Counter;// Offset=0x368 Size=0x60
    struct WDFWORKITEM__ * IdleTimeoutUpdateWorkItem;// Offset=0x3c8 Size=0x8
    unsigned long LastSetIdleTimeout;// Offset=0x3d0 Size=0x4
    struct POHANDLE__ * PoHandle;// Offset=0x3d8 Size=0x8
    void * LPEEnterExitCallbackHandle;// Offset=0x3e0 Size=0x8
    unsigned char WdfPowerReferenceForDebuggerAcquired;// Offset=0x3e8 Size=0x1
    unsigned char IsSecureDevice;// Offset=0x3e9 Size=0x1
    unsigned char EnableVTIOV3;// Offset=0x3ea Size=0x1
    unsigned char EnableVelocityFor53295795;// Offset=0x3eb Size=0x1
    unsigned char EnableVelocityFor48657796;// Offset=0x3ec Size=0x1
    unsigned char EnableVelocityFor54629802;// Offset=0x3ed Size=0x1
    unsigned char EnableVelocityFor58277313;// Offset=0x3ee Size=0x1
    unsigned char IsExtendedTBCEnabled;// Offset=0x3ef Size=0x1
    unsigned char IsExtendedTBCTRBStatusSupported;// Offset=0x3f0 Size=0x1
    enum _CONTROLLER_DMA_MODE DMAModeInVSM;// Offset=0x3f4 Size=0x4
    unsigned long NumberOfDMATargetsInVSM;// Offset=0x3f8 Size=0x4
    struct TRUSTLET_OBJECT_HANDLE__ * SecureObjectHandle;// Offset=0x400 Size=0x8
    struct _EPROCESS * TrustletProcess;// Offset=0x408 Size=0x8
    unsigned char IsDSMForPortStatusSupported;// Offset=0x410 Size=0x1
    unsigned char IsDSMForKBLWorkaroundsSupported;// Offset=0x411 Size=0x1
    enum _USBD_ENDPOINT_OFFLOAD_MODE UsbEndpointOffloadMode;// Offset=0x414 Size=0x4
    unsigned long NumberOfEndpointsOffloaded;// Offset=0x418 Size=0x4
    void * EndpointsOffloadedCountLock;// Offset=0x420 Size=0x8
    long FullOrLowSpeedNonRHInterruptEpCount;// Offset=0x428 Size=0x4
    struct _TIME_SYNC_DATA TimeSyncData;// Offset=0x430 Size=0xa8
    struct WDFWORKITEM__ * AudioOffloadWnfStateUpdateWorkItem;// Offset=0x4d8 Size=0x8
    unsigned char IsAudioOffloadActive;// Offset=0x4e0 Size=0x1
    struct SS_COMPONENT__ * SleepstudySelectiveSuspendUnsupportedHandle;// Offset=0x4e8 Size=0x8
    unsigned long RecurringResetRecoveryFrequency;// Offset=0x4f0 Size=0x4
    unsigned long ImmediateResetRecoveryPending;// Offset=0x4f4 Size=0x4
    struct _XHCI_IRQL_TRACKER * IrqlTrackerArray;// Offset=0x4f8 Size=0x8
    unsigned long ActiveProcessorCount;// Offset=0x500 Size=0x4
    union _XHCI_TEST_MODE_FLAGS TestFlags;// Offset=0x504 Size=0x4
};
