...
union _BULK_DATA_FLAGS// Size=0x4 (Id=1079)
{
...
struct _BULK_DATA// Size=0x1a8 (Id=1021)
{
    ...
    union _BULK_DATA_FLAGS Flags;// Offset=0x14c Size=0x4
    unsigned char DpcRunning;// Offset=0x150 Size=0x1
    unsigned long CommonBufferAcquireAttemptCount;// Offset=0x154 Size=0x4
    long ContinueMapping;// Offset=0x158 Size=0x4
    long AttemptMapping;// Offset=0x15c Size=0x4
    unsigned long MaxPendingStages;// Offset=0x160 Size=0x4
    unsigned long PendingStageCount;// Offset=0x164 Size=0x4
    unsigned long OutstandingEventCountAfterStop;// Offset=0x168 Size=0x4
    struct _BULK_STAGE_DATA * CurrentStage;// Offset=0x170 Size=0x8
    struct _LIST_ENTRY PendingTransferList;// Offset=0x178 Size=0x10
    struct _LIST_ENTRY WaitingForCancelCallbackTransferList;// Offset=0x188 Size=0x10
    struct _LIST_ENTRY CompletionTransferList;// Offset=0x198 Size=0x10
};
