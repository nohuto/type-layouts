...
union _unnamed_344// Size=0x4 (Id=344)
{
    struct _unnamed_343 Parallel;// Offset=0x0 Size=0x4
};

struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=345)
{
    ...
    union _unnamed_344 Settings;// Offset=0x50 Size=0x4
