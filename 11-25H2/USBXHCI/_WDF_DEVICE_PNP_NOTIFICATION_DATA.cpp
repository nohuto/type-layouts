...
struct _unnamed_684// Size=0x8 (Id=684)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_685// Size=0x4 (Id=685)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_686// Size=0x8 (Id=686)
{
    struct _unnamed_684 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_685 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_684 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=687)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_686 Data;// Offset=0x4 Size=0x8
};
