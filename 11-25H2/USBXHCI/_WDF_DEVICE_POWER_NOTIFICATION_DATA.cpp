...
struct _unnamed_714// Size=0x8 (Id=714)
{
...
union _unnamed_716// Size=0x8 (Id=716)
{
    struct _unnamed_714 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_715 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_714 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=263)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_716 Data;// Offset=0x4 Size=0x8
};
