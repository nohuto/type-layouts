...
struct _unnamed_318// Size=0x18 (Id=318)
{
...
struct _unnamed_319// Size=0x20 (Id=319)
{
...
struct _unnamed_320// Size=0x20 (Id=320)
{
...
union _unnamed_321// Size=0x20 (Id=321)
{
    struct _unnamed_94 Create;// Offset=0x0 Size=0x20
    struct _unnamed_318 Read;// Offset=0x0 Size=0x18
    struct _unnamed_318 Write;// Offset=0x0 Size=0x18
    struct _unnamed_319 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_320 Others;// Offset=0x0 Size=0x20
};

struct _WDF_REQUEST_PARAMETERS// Size=0x28 (Id=322)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned char MinorFunction;// Offset=0x2 Size=0x1
    enum _WDF_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    union _unnamed_321 Parameters;// Offset=0x8 Size=0x20
};
