...
struct _unnamed_293// Size=0x8 (Id=293)
{
...
struct _unnamed_299// Size=0x18 (Id=299)
{
...
union _unnamed_302// Size=0x18 (Id=302)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_290 Port;// Offset=0x0 Size=0x18
        struct _unnamed_290 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_292 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_293 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_294 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_290 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_295 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_296 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_297 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_298 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_299 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_300 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_301 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=303)
{
    ...
    union _unnamed_302 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=1037)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=859)
{
