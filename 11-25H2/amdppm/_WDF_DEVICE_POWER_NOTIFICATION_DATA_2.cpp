...
struct _unnamed_489// Size=0x8 (Id=489)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_490// Size=0x4 (Id=490)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_491// Size=0x8 (Id=491)
{
    struct _unnamed_489 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_490 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_489 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=265)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_491 Data;// Offset=0x4 Size=0x8
};
