...
struct _unnamed_468// Size=0x8 (Id=468)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_469// Size=0x4 (Id=469)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_470// Size=0x8 (Id=470)
{
    struct _unnamed_468 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_469 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_468 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=264)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_470 Data;// Offset=0x4 Size=0x8
};
