...
struct _unnamed_457// Size=0x8 (Id=457)
{
...
union _unnamed_459// Size=0x8 (Id=459)
{
    struct _unnamed_457 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_458 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_457 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=460)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_459 Data;// Offset=0x4 Size=0x8
};
