...
union _unnamed_345// Size=0x4 (Id=345)
{
    struct _unnamed_344 Parallel;// Offset=0x0 Size=0x4
};

struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=346)
{
    ...
    union _unnamed_345 Settings;// Offset=0x50 Size=0x4
