...
struct _PCC_INTERFACE_STANDARD// Size=0x80 (Id=658)
{
    ...
    union _unnamed_657 Flags;// Offset=0x54 Size=0x4
...
struct _CPC_COMMAND_COMPLETION// Size=0x18 (Id=598)
{
...
union _PROC_POWER_COORDINATES// Size=0x4 (Id=483)
{
...
struct _PROC_ENERGY_COUNTER// Size=0xc (Id=533)
{
    union // Size=0x4 (Id=0)
    {
...
struct _PROC_ENERGY_MODEL// Size=0x100 (Id=473)
{
...
struct _PPM_WPS_UPDATE_KERNEL_CONFIG// Size=0x10 (Id=580)
{
...
struct GLOBALS// Size=0x978 (Id=440)
{
    ...
    struct _PLATFORM_IDLE_STATES * PlatformIdleStates;// Offset=0x6b0 Size=0x8
    struct _COORDINATED_IDLE_STATES * CoordinatedStates;// Offset=0x6b8 Size=0x8
    struct _COORDINATED_IDLE_STATES * LpiCoordinatedStates;// Offset=0x6c0 Size=0x8
    unsigned long * LpiStateIndexMapping;// Offset=0x6c8 Size=0x8
    struct _RUNTIME_LPI_STATE * LpiRuntimeState;// Offset=0x6d0 Size=0x8
    struct ACPI_PROCESSOR_CONTAINERS * ProcessorContainers;// Offset=0x6d8 Size=0x8
    struct _PREREGISTERED_VETO_LIST * VetoList;// Offset=0x6e0 Size=0x8
    struct _IO_WORKITEM * StateUpdateWorker;// Offset=0x6e8 Size=0x8
    unsigned char StateUpdateWorkerQueued;// Offset=0x6f0 Size=0x1
    unsigned long EfficiencyClasses;// Offset=0x6f4 Size=0x4
    struct _PROC_ENERGY_MODEL EnergyModels[2];// Offset=0x6f8 Size=0x200
    unsigned char EsuValue;// Offset=0x8f8 Size=0x1
    unsigned char EsuMethod;// Offset=0x8f9 Size=0x1
    unsigned long EnergyEnabledProcessors;// Offset=0x8fc Size=0x4
    unsigned long HwDebugEnabledProcessors;// Offset=0x900 Size=0x4
    long long QpcFrequency;// Offset=0x908 Size=0x8
    unsigned long long CycleCounterFrequency;// Offset=0x910 Size=0x8
    enum _PROCESSOR_PRESENCE HiddenProcessorPresence;// Offset=0x918 Size=0x4
    unsigned long ProcessorCountIncludingHidden;// Offset=0x91c Size=0x4
    unsigned char SkipHiddenProcessorPoFxRegistration;// Offset=0x920 Size=0x1
    unsigned char ImplicitPlatformIdle;// Offset=0x921 Size=0x1
    unsigned char RootDrivenIdle;// Offset=0x922 Size=0x1
    struct _PROC_HW_DEBUG_REGISTER_DEFINITION_LIST RegisteryDebugRegisters[2];// Offset=0x928 Size=0x20
    unsigned long MeasurementCapabilities;// Offset=0x948 Size=0x4
    unsigned long MeasurementRegisterGroupTypes;// Offset=0x94c Size=0x4
    struct _LIST_ENTRY MeasurementRegisterGroups;// Offset=0x950 Size=0x10
    unsigned char IsHvLpIndexed;// Offset=0x960 Size=0x1
    struct _PPM_WPS_UPDATE_KERNEL_CONFIG WpsConfig;// Offset=0x968 Size=0x10
};
