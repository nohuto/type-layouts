struct _unnamed_89// Size=0x1 (Id=89)
{
...
struct _KNODE_SUBNODE_SEARCH_RANKS// Size=0x20 (Id=353)
{
    unsigned char Ranks[32];// Offset=0x0 Size=0x20
};

struct _KNODE// Size=0x178 (Id=90)
{
    ...
    struct _unnamed_89 Flags;// Offset=0xa Size=0x1
...
struct _ENODE// Size=0x1c0 (Id=122)
{
