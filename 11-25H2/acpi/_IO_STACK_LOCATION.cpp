...
struct _unnamed_165// Size=0x4 (Id=165)
{
    unsigned long Length;// Offset=0x0 Size=0x4
};
...
struct _unnamed_169// Size=0x18 (Id=169)
{
...
struct _unnamed_173// Size=0x18 (Id=173)
{
...
struct _unnamed_177// Size=0x20 (Id=177)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_179// Size=0x4 (Id=179)
{
...
struct _unnamed_181// Size=0x8 (Id=181)
{
...
struct _unnamed_184// Size=0x1 (Id=184)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _unnamed_186// Size=0x4 (Id=186)
{
...
struct _unnamed_193// Size=0x8 (Id=193)
{
...
struct _unnamed_196// Size=0x20 (Id=196)
{
    union // Size=0x4 (Id=0)
    {
...
struct _unnamed_198// Size=0x20 (Id=198)
{
...
union _unnamed_200// Size=0x20 (Id=200)
{
    struct _unnamed_153 Create;// Offset=0x0 Size=0x20
    struct _unnamed_154 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_155 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_156 Read;// Offset=0x0 Size=0x18
    struct _unnamed_156 Write;// Offset=0x0 Size=0x18
    struct _unnamed_158 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_159 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_161 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_162 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_163 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_164 QueryEa;// Offset=0x0 Size=0x20
    struct _unnamed_165 SetEa;// Offset=0x0 Size=0x4
    struct _unnamed_167 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_167 SetVolume;// Offset=0x0 Size=0x10
    struct _unnamed_168 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_169 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_170 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_171 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_172 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_173 MountVolume;// Offset=0x0 Size=0x18
    struct _unnamed_174 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_176 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_177 QueryQuota;// Offset=0x0 Size=0x20
    struct _unnamed_165 SetQuota;// Offset=0x0 Size=0x4
    struct _unnamed_179 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_180 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_181 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_182 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_183 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_184 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_186 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_188 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_190 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_192 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_193 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_196 Power;// Offset=0x0 Size=0x20
    struct _unnamed_197 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_198 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_199 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=201)
{
    ...
    union _unnamed_200 Parameters;// Offset=0x8 Size=0x20
