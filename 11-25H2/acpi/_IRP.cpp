union _unnamed_146// Size=0x8 (Id=146)
{
...
union _unnamed_149// Size=0x10 (Id=149)
{
    ...
    {
        struct _unnamed_148 AsynchronousParameters;// Offset=0x0 Size=0x10
...
struct _unnamed_150// Size=0x58 (Id=150)
{
...
union _unnamed_151// Size=0x58 (Id=151)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_150 Overlay;// Offset=0x0 Size=0x58
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=152)
{
    ...
    union _unnamed_146 AssociatedIrp;// Offset=0x18 Size=0x8
