...
struct _unnamed_706// Size=0x18 (Id=706)
{
...
struct _unnamed_709// Size=0x8 (Id=709)
{
...
struct _unnamed_712// Size=0x10 (Id=712)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _unnamed_713// Size=0xc (Id=713)
{
...
struct _unnamed_714// Size=0x18 (Id=714)
{
...
struct _unnamed_716// Size=0x18 (Id=716)
{
...
union _unnamed_718// Size=0x18 (Id=718)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_706 Port;// Offset=0x0 Size=0x18
        struct _unnamed_706 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_708 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_709 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_710 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_706 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_711 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_712 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_713 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_714 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_715 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_716 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_717 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=719)
{
    ...
    union _unnamed_718 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=672)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=439)
{
