...
struct _unnamed_826// Size=0x8 (Id=826)
{
...
struct _unnamed_829// Size=0x20 (Id=829)
{
...
struct _unnamed_830// Size=0x28 (Id=830)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=831)
{
    struct _unnamed_825 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_826 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_828 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _unnamed_829 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_830 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=803)
{
