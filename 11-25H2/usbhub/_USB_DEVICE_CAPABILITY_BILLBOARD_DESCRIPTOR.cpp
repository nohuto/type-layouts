union _unnamed_363// Size=0x2 (Id=363)
{
...
struct _unnamed_364// Size=0x4 (Id=364)
{
...
struct _USB_DEVICE_CAPABILITY_BILLBOARD_DESCRIPTOR// Size=0x30 (Id=365)
{
    ...
    union _unnamed_363 VconnPower;// Offset=0x6 Size=0x2
    unsigned char bmConfigured[32];// Offset=0x8 Size=0x20
    unsigned long bReserved;// Offset=0x28 Size=0x4
    struct _unnamed_364 AlternateMode[1];// Offset=0x2c Size=0x4
};
