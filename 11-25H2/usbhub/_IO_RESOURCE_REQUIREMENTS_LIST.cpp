...
struct _unnamed_476// Size=0x18 (Id=476)
{
...
struct _unnamed_481// Size=0xc (Id=481)
{
...
struct _unnamed_482// Size=0x18 (Id=482)
{
...
struct _unnamed_484// Size=0x18 (Id=484)
{
...
union _unnamed_486// Size=0x18 (Id=486)
{
    union // Size=0x18 (Id=0)
    {
        struct _unnamed_473 Port;// Offset=0x0 Size=0x18
        struct _unnamed_473 Memory;// Offset=0x0 Size=0x18
        struct _unnamed_476 Interrupt;// Offset=0x0 Size=0x18
        struct _unnamed_477 Dma;// Offset=0x0 Size=0x8
        struct _unnamed_478 DmaV3;// Offset=0x0 Size=0x10
        struct _unnamed_473 Generic;// Offset=0x0 Size=0x18
        struct _unnamed_479 DevicePrivate;// Offset=0x0 Size=0xc
        struct _unnamed_480 BusNumber;// Offset=0x0 Size=0x10
        struct _unnamed_481 ConfigData;// Offset=0x0 Size=0xc
        struct _unnamed_482 Memory40;// Offset=0x0 Size=0x18
        struct _unnamed_483 Memory48;// Offset=0x0 Size=0x18
        struct _unnamed_484 Memory64;// Offset=0x0 Size=0x18
        struct _unnamed_485 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=487)
{
    ...
    union _unnamed_486 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=463)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=382)
{
