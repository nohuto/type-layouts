...
union _unnamed_715// Size=0x8 (Id=715)
{
    struct _unnamed_714 ExaminePolicy;// Offset=0x0 Size=0x8
};

struct _WDF_IO_FORWARD_PROGRESS_RESERVED_POLICY_SETTINGS// Size=0x8 (Id=716)
{
    union _unnamed_715 Policy;// Offset=0x0 Size=0x8
};

struct _WDF_IO_QUEUE_FORWARD_PROGRESS_POLICY// Size=0x28 (Id=348)
{
