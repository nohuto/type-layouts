...
struct _unnamed_101// Size=0x18 (Id=101)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _unnamed_108// Size=0x20 (Id=108)
{
    unsigned long OutputBufferLength;// Offset=0x0 Size=0x4
    unsigned long InputBufferLength;// Offset=0x8 Size=0x4
...
struct _unnamed_116// Size=0x4 (Id=116)
{
...
struct _unnamed_121// Size=0x1 (Id=121)
{
...
struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=576)
{
    union // Size=0x4 (Id=0)
    {
...
union _unnamed_137// Size=0x20 (Id=137)
{
    struct _unnamed_93 Create;// Offset=0x0 Size=0x20
    struct _unnamed_94 CreatePipe;// Offset=0x0 Size=0x20
    struct _unnamed_95 CreateMailslot;// Offset=0x0 Size=0x20
    struct _unnamed_96 Read;// Offset=0x0 Size=0x18
    struct _unnamed_96 Write;// Offset=0x0 Size=0x18
    struct _unnamed_98 QueryDirectory;// Offset=0x0 Size=0x20
    struct _unnamed_99 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _unnamed_101 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _unnamed_102 QueryFile;// Offset=0x0 Size=0x10
    struct _unnamed_103 SetFile;// Offset=0x0 Size=0x20
    struct _unnamed_105 QueryVolume;// Offset=0x0 Size=0x10
    struct _unnamed_106 FileSystemControl;// Offset=0x0 Size=0x20
    struct _unnamed_107 LockControl;// Offset=0x0 Size=0x18
    struct _unnamed_108 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _unnamed_109 QuerySecurity;// Offset=0x0 Size=0x10
    struct _unnamed_110 SetSecurity;// Offset=0x0 Size=0x10
    struct _unnamed_111 MountVolume;// Offset=0x0 Size=0x18
    struct _unnamed_112 VerifyVolume;// Offset=0x0 Size=0x10
    struct _unnamed_114 Scsi;// Offset=0x0 Size=0x8
    struct _unnamed_116 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _unnamed_117 QueryInterface;// Offset=0x0 Size=0x20
    struct _unnamed_118 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _unnamed_119 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _unnamed_120 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _unnamed_121 SetLock;// Offset=0x0 Size=0x1
    struct _unnamed_123 QueryId;// Offset=0x0 Size=0x4
    struct _unnamed_125 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _unnamed_127 UsageNotification;// Offset=0x0 Size=0x10
    struct _unnamed_129 WaitWake;// Offset=0x0 Size=0x4
    struct _unnamed_130 PowerSequence;// Offset=0x0 Size=0x8
    struct _unnamed_133 Power;// Offset=0x0 Size=0x20
    struct _unnamed_134 StartDevice;// Offset=0x0 Size=0x10
    struct _unnamed_135 WMI;// Offset=0x0 Size=0x20
    struct _unnamed_136 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=138)
{
    ...
    union _unnamed_137 Parameters;// Offset=0x8 Size=0x20
