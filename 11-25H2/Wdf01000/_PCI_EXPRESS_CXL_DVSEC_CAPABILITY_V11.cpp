...
union _PCI_EXPRESS_CXL_DVSEC_CAPABILITY_REGISTER_V11// Size=0x2 (Id=3616)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_CXL_DVSEC_CONTROL_REGISTER// Size=0x2 (Id=2960)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_CXL_DVSEC_STATUS_REGISTER// Size=0x2 (Id=3651)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_CXL_DVSEC_LOCK_REGISTER// Size=0x2 (Id=460)
{
    struct // Size=0x2 (Id=0)
    {
...
struct _PCI_EXPRESS_CXL_DVSEC_RANGE_SIZE_HIGH_REGISTER// Size=0x4 (Id=2439)
{
...
struct _PCI_EXPRESS_CXL_DVSEC_RANGE_BASE_HIGH_REGISTER// Size=0x4 (Id=3158)
{
    unsigned long MemBaseHigh;// Offset=0x0 Size=0x4
};

union _PCI_EXPRESS_CXL_DVSEC_RANGE_BASE_LOW_REGISTER// Size=0x4 (Id=2200)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PCI_EXPRESS_CXL_DVSEC_CAPABILITY_V11// Size=0x38 (Id=2678)
{
