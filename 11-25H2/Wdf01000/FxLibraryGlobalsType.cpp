...
struct _KBUGCHECK_REASON_CALLBACK_RECORD// Size=0x30 (Id=1872)
{
...
struct _WMI_WDF_NOTIFY_ROUTINES// Size=0x20 (Id=2488)
{
...
struct FxLibraryGlobalsType// Size=0x230 (Id=3099)
{
    ...
    unsigned char Feature_SteelixInlineNvmeCryptoEngine_Enabled;// Offset=0x223 Size=0x1
    unsigned char Feature_WdfCD2_Enabled;// Offset=0x224 Size=0x1
    struct FxObjectExcessiveAllocationConfig ObjectExcessiveAllocation;// Offset=0x228 Size=0x8
};
