...
union _PCI_EXPRESS_USB4_DESIGNATED_VENDOR_SPECIFIC_HEADER// Size=0x2 (Id=3978)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_USB4_DESIGNATED_VENDOR_SPECIFIC_PORT_ATTRIBUTES// Size=0x8 (Id=3450)
{
    union // Size=0x8 (Id=0)
    {
        struct _PCI_EXPRESS_USB4_DESIGNATED_VENDOR_SPECIFIC_PORT_ATTRIBUTES::_unnamed_3860::<unnamed-type-type0> type0;// Offset=0x0 Size=0x8
        struct _PCI_EXPRESS_USB4_DESIGNATED_VENDOR_SPECIFIC_PORT_ATTRIBUTES::_unnamed_3859::<unnamed-type-type1> type1;// Offset=0x0 Size=0x8
        struct _PCI_EXPRESS_USB4_DESIGNATED_VENDOR_SPECIFIC_PORT_ATTRIBUTES::_unnamed_3858::<unnamed-type-type2> type2;// Offset=0x0 Size=0x4
        unsigned long AsULONG;// Offset=0x0 Size=0x4
    };
};

struct _PCI_EXPRESS_USB4_DESIGNATED_VENDOR_SPECIFIC_CAPABILITY// Size=0x14 (Id=2901)
{
