struct _unnamed_738// Size=0x10 (Id=738)
{
...
struct _unnamed_745// Size=0x18 (Id=745)
{
...
struct _unnamed_747// Size=0x20 (Id=747)
{
...
struct _unnamed_750// Size=0x28 (Id=750)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=751)
{
    struct _unnamed_738 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_742 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_745 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _unnamed_747 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_750 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=734)
{
