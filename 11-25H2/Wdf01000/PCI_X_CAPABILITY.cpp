...
struct PCI_X_CAPABILITY// Size=0x8 (Id=3300)
{
    union // Size=0x4 (Id=0)
    {
        struct _PCI_CAPABILITIES_HEADER Header;// Offset=0x0 Size=0x2
        union <unnamed-type-Command>// Size=0x2 (Id=73133)
        {
            struct <unnamed-type-bits>// Size=0x2 (Id=73134)
            {
        ...
        union <unnamed-type-Status>// Size=0x4 (Id=73143)
        {
            struct <unnamed-type-bits>// Size=0x4 (Id=73144)
            {
