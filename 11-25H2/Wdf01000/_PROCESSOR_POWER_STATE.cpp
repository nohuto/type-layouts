struct _PROC_IDLE_POLICY// Size=0x6 (Id=989)
{
...
union _PPM_IDLE_SYNCHRONIZATION_STATE// Size=0x4 (Id=1639)
{
...
struct _PPM_FFH_THROTTLE_STATE_INFO// Size=0x20 (Id=1053)
{
...
struct _PROC_IDLE_SNAP// Size=0x10 (Id=880)
{
    unsigned long long Time;// Offset=0x0 Size=0x8
    unsigned long long Idle;// Offset=0x8 Size=0x8
};

struct _PROC_PERF_CHECK_CONTEXT// Size=0x48 (Id=948)
{
...
struct _PROCESSOR_POWER_STATE// Size=0x238 (Id=1644)
{
