struct _unnamed_1115// Size=0x1 (Id=1115)
{
...
struct _KNODE_SUBNODE_SEARCH_RANKS// Size=0x20 (Id=1440)
{
    unsigned char Ranks[32];// Offset=0x0 Size=0x20
};

struct _KNODE// Size=0x178 (Id=1118)
{
    ...
    struct _unnamed_1115 Flags;// Offset=0xa Size=0x1
    ...
    unsigned long ActiveTopologyElements[5];// Offset=0x120 Size=0x14
    struct _KNODE_SUBNODE_SEARCH_RANKS PerformanceSearchRanks[1];// Offset=0x134 Size=0x20
    struct _KNODE_SUBNODE_SEARCH_RANKS EfficiencySearchRanks[1];// Offset=0x154 Size=0x20
};
...
struct _ENODE// Size=0x1c0 (Id=1711)
{
    struct _KNODE Ncb;// Offset=0x0 Size=0x178
    struct _WORK_QUEUE_ITEM HotAddProcessorWorkItem;// Offset=0x178 Size=0x20
};
