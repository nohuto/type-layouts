...
struct _KSCHEDULER_SUBNODE// Size=0x300 (Id=1225)
{
    ...
    unsigned long long ThreadQosGroupingSet;// Offset=0x30 Size=0x8
    unsigned long long Spare1[1];// Offset=0x38 Size=0x8
