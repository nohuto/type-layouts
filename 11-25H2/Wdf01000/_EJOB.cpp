...
struct _KEVENT// Size=0x18 (Id=115)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
};

struct _OWNER_ENTRY// Size=0x10 (Id=142)
{
...
struct _ERESOURCE// Size=0x68 (Id=151)
{
...
struct _KAFFINITY_EX// Size=0x108 (Id=1662)
{
...
struct _PROCESS_DISK_COUNTERS// Size=0x28 (Id=1168)
{
...
struct _PROCESS_NETWORK_COUNTERS// Size=0x10 (Id=582)
{
...
struct _PS_JOB_WAKE_INFORMATION// Size=0x48 (Id=1328)
{
...
struct _EPROCESS_VALUES// Size=0x68 (Id=1312)
{
...
struct _RTL_BALANCED_NODE// Size=0x18 (Id=1608)
{
...
struct _PS_IO_CONTROL_ENTRY// Size=0x38 (Id=1754)
{
...
struct _RTL_RB_TREE// Size=0x10 (Id=1617)
{
...
struct _WORK_QUEUE_ITEM// Size=0x20 (Id=3047)
{
...
union _JOBOBJECT_ENERGY_TRACKING_STATE// Size=0x8 (Id=1248)
{
    unsigned long long Value;// Offset=0x0 Size=0x8
...
struct _EJOB// Size=0x728 (Id=1458)
{
    ...
    union // Size=0x8 (Id=0)
    {
        struct _WNF_STATE_NAME WakeChannel;// Offset=0x458 Size=0x8
        struct _PS_JOB_WAKE_INFORMATION WakeInfo;// Offset=0x458 Size=0x48
    };
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long WakeNotificationAllocated:1;// Offset=0x610 Size=0x4 BitOffset=0xb BitSize=0x1
