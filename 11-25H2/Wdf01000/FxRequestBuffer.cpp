struct FxRequestBuffer// Size=0x20 (Id=1152)
{
    union // Size=0x44d (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0x18 (Id=64008)
        {
            struct <unnamed-type-Memory>// Size=0x10 (Id=64009)
            {
