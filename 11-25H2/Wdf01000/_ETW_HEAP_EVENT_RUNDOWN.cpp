...
struct _ETW_HEAP_EVENT_RUNDOWN_RANGE// Size=0x10 (Id=3927)
{
    void * Address;// Offset=0x0 Size=0x8
    unsigned long long Size;// Offset=0x8 Size=0x8
};

struct _ETW_HEAP_EVENT_RUNDOWN// Size=0x4c (Id=3257)
{
    ...
    unsigned long ProcessId;// Offset=0x2c Size=0x4
    unsigned long RangeCount;// Offset=0x30 Size=0x4
    unsigned long long HeapTag;// Offset=0x34 Size=0x8
    struct _ETW_HEAP_EVENT_RUNDOWN_RANGE Ranges[1];// Offset=0x3c Size=0x10
};
