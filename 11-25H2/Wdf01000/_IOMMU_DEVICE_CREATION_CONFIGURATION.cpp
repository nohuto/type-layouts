...
struct _IOMMU_DEVICE_CREATION_CONFIGURATION_ACPI// Size=0x8 (Id=3516)
{
...
struct _IOMMU_DEVICE_CREATION_CONFIGURATION_PASID// Size=0x8 (Id=3549)
{
    enum _IOMMU_PASID_CONFIGURATION_TYPE ConfigType;// Offset=0x0 Size=0x4
    unsigned char SuppressPasidFaults;// Offset=0x4 Size=0x1
};

struct _IOMMU_DEVICE_CREATION_CONFIGURATION// Size=0x20 (Id=2810)
{
