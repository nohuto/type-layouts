...
struct _KAB_UM_PROCESS_CONTEXT// Size=0x10 (Id=1208)
{
...
union _KEXECUTE_OPTIONS// Size=0x1 (Id=1737)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _KGROUP_MASK// Size=0x10 (Id=1216)
{
    unsigned long long Masks[2];// Offset=0x0 Size=0x10
};

union _KSTACK_COUNT// Size=0x4 (Id=1748)
{
...
struct _KPROCESS// Size=0x1c8 (Id=1674)
{
    ...
    union _unnamed_1671 SecureState;// Offset=0x170 Size=0x8
...
struct _EX_PUSH_LOCK// Size=0x8 (Id=1337)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _EX_RUNDOWN_REF// Size=0x8 (Id=3232)
{
    union // Size=0x8 (Id=0)
    {
...
struct _EX_FAST_REF// Size=0x8 (Id=1730)
{
    union // Size=0x8 (Id=0)
    {
...
struct _RTL_AVL_TREE// Size=0x8 (Id=1628)
{
    struct _RTL_BALANCED_NODE * Root;// Offset=0x0 Size=0x8
};

struct _SE_AUDIT_PROCESS_CREATION_INFO// Size=0x8 (Id=1624)
{
    struct _OBJECT_NAME_INFORMATION * ImageFileName;// Offset=0x0 Size=0x8
};

struct _MMSUPPORT_FLAGS// Size=0x4 (Id=1718)
{
    union // Size=0x4 (Id=0)
    {
...
struct _MMSUPPORT_INSTANCE// Size=0xc0 (Id=1720)
{
...
struct _MMSUPPORT_SHARED// Size=0x80 (Id=1444)
{
...
struct _PS_PROTECTION// Size=0x1 (Id=1606)
{
    union // Size=0x1 (Id=0)
    {
...
union _PS_INTERLOCKED_TIMER_DELAY_VALUES// Size=0x8 (Id=1284)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WNF_STATE_NAME// Size=0x8 (Id=669)
{
    unsigned long Data[2];// Offset=0x0 Size=0x8
};

struct _JOBOBJECT_WAKE_FILTER// Size=0x8 (Id=1245)
{
    unsigned long HighEdgeFilter;// Offset=0x0 Size=0x4
    unsigned long LowEdgeFilter;// Offset=0x4 Size=0x4
};

struct _PS_PROCESS_WAKE_INFORMATION// Size=0x30 (Id=1392)
{
...
struct _unnamed_1287// Size=0x4 (Id=1287)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES// Size=0x10 (Id=1616)
{
    struct _RTL_AVL_TREE Tree;// Offset=0x0 Size=0x8
    struct _EX_PUSH_LOCK Lock;// Offset=0x8 Size=0x8
};

struct _unnamed_1290// Size=0x4 (Id=1290)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _unnamed_1292// Size=0x4 (Id=1292)
{
    struct // Size=0x4 (Id=0)
    {
...
union _PROCESS_EXECUTION_TRANSITION// Size=0x2 (Id=962)
{
...
union _PROCESS_EXECUTION_STATE// Size=0x1 (Id=973)
{
...
union _PROCESS_EXECUTION// Size=0x4 (Id=1726)
{
...
struct _EPROCESS// Size=0x840 (Id=1297)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_1285 MitigationFlagsValues;// Offset=0x750 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long MitigationFlags2;// Offset=0x754 Size=0x4
        struct _unnamed_1287 MitigationFlags2Values;// Offset=0x754 Size=0x4
    };
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_1290 MitigationFlags3Values;// Offset=0x7d8 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _unnamed_1292 SyscallUsageValues;// Offset=0x7e0 Size=0x4
    };
