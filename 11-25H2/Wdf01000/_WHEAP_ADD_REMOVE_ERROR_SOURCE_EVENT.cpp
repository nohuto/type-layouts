...
struct _WHEA_ERROR_SOURCE_DESCRIPTOR// Size=0x3cc (Id=1844)
{
    union // Size=0x28 (Id=0)
    {
        ...
        union <unnamed-type-Info>// Size=0x3a4 (Id=26417)
        {
...
struct _WHEAP_ADD_REMOVE_ERROR_SOURCE_EVENT// Size=0x3f1 (Id=2833)
{
