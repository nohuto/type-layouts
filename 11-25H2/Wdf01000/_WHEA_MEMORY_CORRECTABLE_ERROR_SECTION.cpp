struct _WHEA_MEMORY_CORRECTABLE_ERROR_HEADER// Size=0x4 (Id=3639)
{
    unsigned short Version;// Offset=0x0 Size=0x2
    unsigned short Count;// Offset=0x2 Size=0x2
};

union _WHEA_MEMORY_CORRECTABLE_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=2832)
{
...
struct _WHEA_MEMORY_CORRECTABLE_ERROR_DATA// Size=0x18 (Id=785)
{
...
struct _WHEA_MEMORY_CORRECTABLE_ERROR_SECTION// Size=0x1c (Id=3899)
{
