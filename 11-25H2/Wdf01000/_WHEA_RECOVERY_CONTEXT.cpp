...
struct _WHEA_RECOVERY_CONTEXT// Size=0x1828 (Id=3224)
{
    union // Size=0x10 (Id=0)
    {
        struct _WHEA_RECOVERY_CONTEXT::_unnamed_3227::<unnamed-type-MemoryError> MemoryError;// Offset=0x0 Size=0x10
        struct _WHEA_RECOVERY_CONTEXT::_unnamed_3225::<unnamed-type-PmemError> PmemError;// Offset=0x0 Size=0x8
