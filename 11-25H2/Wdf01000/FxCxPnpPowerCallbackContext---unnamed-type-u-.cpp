union FxCxPnpPowerCallbackContext::<unnamed-type-u>// Size=0x18 (Id=3197)
{
    union // Size=0x18 (Id=0)
    {
        struct <unnamed-type-Generic>// Size=0x18 (Id=31535)
        {
        ...
        struct <unnamed-type-PrepareHardware>// Size=0x18 (Id=31540)
        {
        ...
        struct <unnamed-type-ReleaseHardware>// Size=0x10 (Id=31545)
        {
        ...
        struct <unnamed-type-D0Entry>// Size=0x18 (Id=31549)
        {
        ...
        struct <unnamed-type-SmIoRestart>// Size=0x18 (Id=31563)
        {
            long  ( * PreCallback)(struct WDFDEVICE__ * );// Offset=0x0 Size=0x8
            long  ( * PostCallback)(struct WDFDEVICE__ * );// Offset=0x8 Size=0x8
            void  ( * CleanupCallback)(struct WDFDEVICE__ * );// Offset=0x10 Size=0x8
        ...
        struct <unnamed-type-SmIoRestartEx>// Size=0x18 (Id=31568)
        {
            long  ( * PreCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x0 Size=0x8
            long  ( * PostCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x8 Size=0x8
            void  ( * CleanupCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x10 Size=0x8
        ...
        struct <unnamed-type-ArmWakeFromSx>// Size=0x18 (Id=31606)
        {
            long  ( * PreCallback)(struct WDFDEVICE__ * );// Offset=0x0 Size=0x8
            long  ( * PostCallback)(struct WDFDEVICE__ * );// Offset=0x8 Size=0x8
            void  ( * CleanupCallback)(struct WDFDEVICE__ * );// Offset=0x10 Size=0x8
        ...
        struct <unnamed-type-ArmWakeFromSxWithReason>// Size=0x18 (Id=31611)
        {
        ...
        struct <unnamed-type-D0EntryPostHardwareEnabled>// Size=0x18 (Id=31624)
        {
            long  ( * PreCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x0 Size=0x8
            long  ( * PostCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x8 Size=0x8
            void  ( * CleanupCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x10 Size=0x8
        ...
        struct <unnamed-type-D0ExitPreHardwareDisabled>// Size=0x10 (Id=31629)
        {
            long  ( * PreCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x0 Size=0x8
            long  ( * PostCallback)(struct WDFDEVICE__ * ,enum _WDF_POWER_DEVICE_STATE );// Offset=0x8 Size=0x8
        };
