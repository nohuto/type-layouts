union _DIMM_ADDRESS// Size=0x18 (Id=2735)
{
    struct <unnamed-type-Ddr4>// Size=0x18 (Id=6526)
    {
    ...
    struct <unnamed-type-Ddr5>// Size=0x18 (Id=6541)
    {
...
struct _DIMM_ADDR_VALID_BITS_DDR4// Size=0x4 (Id=752)
{
...
struct _DIMM_ADDR_VALID_BITS_DDR5// Size=0x4 (Id=3711)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned int SocketId:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
union _DIMM_ADDR_VALID_BITS// Size=0x4 (Id=2519)
{
...
struct _MEMORY_DEFECT// Size=0x24 (Id=3113)
{
    unsigned int Version;// Offset=0x0 Size=0x4
    struct _DIMM_INFO DimmInfo;// Offset=0x4 Size=0x1c
    enum _PAGE_OFFLINE_ERROR_TYPES ErrType;// Offset=0x20 Size=0x4
};
