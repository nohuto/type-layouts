union _PS_TRUSTLET_ATTRIBUTE_ACCESSRIGHTS// Size=0x1 (Id=1064)
{
...
struct _PS_TRUSTLET_ATTRIBUTE_TYPE// Size=0x4 (Id=1398)
{
    union // Size=0x4 (Id=0)
    {
...
struct _PS_TRUSTLET_ATTRIBUTE_HEADER// Size=0x8 (Id=1395)
{
...
struct _PS_TRUSTLET_ATTRIBUTE_DATA// Size=0x10 (Id=1595)
{
    struct _PS_TRUSTLET_ATTRIBUTE_HEADER Header;// Offset=0x0 Size=0x8
    unsigned long long Data[1];// Offset=0x8 Size=0x8
};

struct _PS_TRUSTLET_CREATE_ATTRIBUTES// Size=0x18 (Id=1462)
{
    unsigned long long TrustletIdentity;// Offset=0x0 Size=0x8
    struct _PS_TRUSTLET_ATTRIBUTE_DATA Attributes[1];// Offset=0x8 Size=0x10
};
