...
struct POWER_EVENT_TARGET_STATE// Size=0x8 (Id=1708)
{
    enum FxPowerEvent PowerEvent;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE TargetState;// Offset=0x4 Size=0x4
};
