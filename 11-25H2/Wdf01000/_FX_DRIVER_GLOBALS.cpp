...
struct _WDF_DRIVER_GLOBALS// Size=0x38 (Id=3005)
{
...
struct _FX_DRIVER_GLOBALS// Size=0x200 (Id=861)
{
    ...
    union // Size=0x268 (Id=0)
    {
        ...
        unsigned char IsCorrectVersionRegistered(struct _UNICODE_STRING * );// Offset=0x0 Size=0x1f4
