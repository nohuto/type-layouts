...
struct _PCI_FPB_CAPABILITY_HEADER// Size=0x4 (Id=503)
{
    struct _PCI_CAPABILITIES_HEADER Header;// Offset=0x0 Size=0x2
    unsigned short Reserved;// Offset=0x2 Size=0x2
};

union _PCI_FPB_CAPABILITIES_REGISTER// Size=0x4 (Id=2134)
{
...
union _PCI_FPB_RID_VECTOR_CONTROL1_REGISTER// Size=0x4 (Id=3750)
{
    struct // Size=0x4 (Id=0)
    {
...
union _PCI_FPB_RID_VECTOR_CONTROL2_REGISTER// Size=0x4 (Id=2187)
{
    struct // Size=0x4 (Id=0)
    {
...
union _PCI_FPB_MEM_LOW_VECTOR_CONTROL_REGISTER// Size=0x4 (Id=3696)
{
    struct // Size=0x4 (Id=0)
    {
...
union _PCI_FPB_MEM_HIGH_VECTOR_CONTROL1_REGISTER// Size=0x4 (Id=2058)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PCI_FPB_MEM_HIGH_VECTOR_CONTROL2_REGISTER// Size=0x4 (Id=3430)
{
    unsigned long MemHighVectorStartUpper;// Offset=0x0 Size=0x4
};

union _PCI_FPB_VECTOR_ACCESS_CONTROL_REGISTER// Size=0x4 (Id=3533)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _PCI_FPB_VECTOR_ACCESS_DATA_REGISTER// Size=0x4 (Id=1572)
{
    unsigned long VectorAccessData;// Offset=0x0 Size=0x4
};

struct _PCI_FPB_CAPABILITY// Size=0x24 (Id=3925)
{
