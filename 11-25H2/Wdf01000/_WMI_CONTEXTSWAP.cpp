struct _WMI_CONTEXTSWAP// Size=0x1c (Id=2882)
{
    ...
    union // Size=0x1 (Id=0)
    {
        struct // Size=0x1 (Id=0)
        {
            unsigned char OldThreadApcDisabled:1;// Offset=0x18 Size=0x1 BitOffset=0x0 BitSize=0x1
            unsigned char OldThreadAllApcDisabled:1;// Offset=0x18 Size=0x1 BitOffset=0x1 BitSize=0x1
            unsigned char NewThreadApcDisabled:1;// Offset=0x18 Size=0x1 BitOffset=0x2 BitSize=0x1
            unsigned char NewThreadAllApcDisabled:1;// Offset=0x18 Size=0x1 BitOffset=0x3 BitSize=0x1
            unsigned char Flags2Reserved:4;// Offset=0x18 Size=0x1 BitOffset=0x4 BitSize=0x4
        };
        unsigned char Flags2;// Offset=0x18 Size=0x1
    };
    unsigned char Spare[3];// Offset=0x19 Size=0x3
};
