union _KLOCK_ENTRY_LOCK_STATE// Size=0x8 (Id=842)
{
...
union _KLOCK_ENTRY_BOOST_BITMAP// Size=0x8 (Id=800)
{
...
struct _KLOCK_ENTRY// Size=0x58 (Id=853)
{
    union // Size=0x8 (Id=0)
    {
...
struct _KLOCK_ENTRIES// Size=0x68 (Id=1150)
{
    struct _KTHREAD * Thread;// Offset=0x0 Size=0x8
    unsigned short AvailableEntryBitmap;// Offset=0x8 Size=0x2
    unsigned short OrphanedEntryBitmap;// Offset=0xa Size=0x2
    unsigned char EntryCount;// Offset=0xc Size=0x1
    unsigned char Padding0[3];// Offset=0xd Size=0x3
    struct _KLOCK_ENTRY Entries[1];// Offset=0x10 Size=0x58
};
