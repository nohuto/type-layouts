...
struct _ETW_HEAP_EVENT_REALLOC// Size=0x4c (Id=3571)
{
    struct _SYSTEM_TRACE_HEADER Header;// Offset=0x0 Size=0x20
    void * HeapHandle;// Offset=0x20 Size=0x8
    void * NewAddress;// Offset=0x28 Size=0x8
    void * OldAddress;// Offset=0x30 Size=0x8
    unsigned long long NewSize;// Offset=0x38 Size=0x8
    unsigned long long OldSize;// Offset=0x40 Size=0x8
    unsigned long Source;// Offset=0x48 Size=0x4
};
