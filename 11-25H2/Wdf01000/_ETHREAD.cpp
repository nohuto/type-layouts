...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=1385)
{
...
struct _KAPC_STATE// Size=0x30 (Id=1128)
{
...
struct _KTIMER// Size=0x40 (Id=2158)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=2345)
{
...
union _KERNEL_SHADOW_STACK_LIMIT// Size=0x8 (Id=1770)
{
...
struct _KTHREAD// Size=0x4c0 (Id=1106)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _KSEMAPHORE// Size=0x20 (Id=3670)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=1466)
{
...
union _RTL_THREAD_RNG_STATE// Size=0x10 (Id=1618)
{
...
struct _ETHREAD// Size=0x798 (Id=1380)
{
