...
struct _OBP_SYSTEM_DOS_DEVICE_STATE// Size=0x6c (Id=763)
{
...
struct _OBJECT_NAMESPACE_LOOKUPTABLE// Size=0x260 (Id=760)
{
...
struct _OBP_SILODRIVERSTATE// Size=0x2e0 (Id=905)
{
...
struct _SEP_SILOSTATE// Size=0x30 (Id=934)
{
...
struct _SEP_RM_LSA_CONNECTION_STATE// Size=0x30 (Id=996)
{
...
struct _WNF_LOCK// Size=0x8 (Id=769)
{
    struct _EX_PUSH_LOCK PushLock;// Offset=0x0 Size=0x8
};

struct _WNF_SILODRIVERSTATE// Size=0x38 (Id=981)
{
...
struct _DBGK_SILOSTATE// Size=0x20 (Id=838)
{
...
struct _CPTABLEINFO// Size=0x40 (Id=831)
{
...
struct _RTL_NLS_STATE// Size=0xb8 (Id=822)
{
...
struct _CRITICAL_PROCESS_EXCEPTION_DATA// Size=0x30 (Id=954)
{
...
struct _ESERVERSILO_GLOBALS// Size=0x598 (Id=1432)
{
    ...
    struct _CRITICAL_PROCESS_EXCEPTION_DATA CriticalProcessExceptionData;// Offset=0x558 Size=0x30
    unsigned long RtlFunctionalityCache[4];// Offset=0x588 Size=0x10
};
