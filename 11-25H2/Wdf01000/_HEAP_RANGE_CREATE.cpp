...
struct _HEAP_EVENT_RANGE_CREATE// Size=0x18 (Id=3561)
{
    void * HeapHandle;// Offset=0x0 Size=0x8
    unsigned long long FirstRangeSize;// Offset=0x8 Size=0x8
    unsigned long Flags;// Offset=0x10 Size=0x4
};

struct _HEAP_RANGE_CREATE// Size=0x38 (Id=3698)
{
    struct _SYSTEM_TRACE_HEADER Header;// Offset=0x0 Size=0x20
    struct _HEAP_EVENT_RANGE_CREATE Event;// Offset=0x20 Size=0x18
};
