...
struct _PHYSICAL_COUNTER_EVENT_BUFFER_CONFIGURATION// Size=0x10 (Id=2866)
{
...
struct _PHYSICAL_COUNTER_RESOURCE_DESCRIPTOR// Size=0x18 (Id=2124)
{
    union // Size=0x8 (Id=0)
    {
        enum _PHYSICAL_COUNTER_RESOURCE_DESCRIPTOR_TYPE Type;// Offset=0x0 Size=0x4
        unsigned long Flags;// Offset=0x4 Size=0x4
        union <unnamed-type-u>// Size=0x10 (Id=16240)
        {
            unsigned long CounterIndex;// Offset=0x0 Size=0x4
            struct <unnamed-type-Range>// Size=0x8 (Id=16242)
            {
...
struct _PHYSICAL_COUNTER_RESOURCE_LIST// Size=0x20 (Id=3483)
{
