union _WHEA_ERROR_PACKET_FLAGS// Size=0x4 (Id=2041)
{
...
union _WHEA_PROCESSOR_GENERIC_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=3965)
{
...
struct _WHEA_PROCESSOR_GENERIC_ERROR_SECTION// Size=0xc0 (Id=866)
{
...
union _WHEA_MEMORY_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=3888)
{
    struct // Size=0x8 (Id=0)
    {
...
union _WHEA_ERROR_STATUS// Size=0x8 (Id=3579)
{
...
struct _WHEA_MEMORY_ERROR_SECTION// Size=0x50 (Id=554)
{
...
union _WHEA_NMI_ERROR_SECTION_FLAGS// Size=0x4 (Id=2317)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _WHEA_NMI_ERROR_SECTION// Size=0xc (Id=2476)
{
    unsigned char Data[8];// Offset=0x0 Size=0x8
    union _WHEA_NMI_ERROR_SECTION_FLAGS Flags;// Offset=0x8 Size=0x4
};

union _WHEA_PCIEXPRESS_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=2402)
{
    struct // Size=0x8 (Id=0)
    {
...
union _WHEA_PCIEXPRESS_VERSION// Size=0x4 (Id=1373)
{
...
union _WHEA_PCIEXPRESS_COMMAND_STATUS// Size=0x4 (Id=3897)
{
...
struct _WHEA_PCIEXPRESS_DEVICE_ID// Size=0x10 (Id=1475)
{
...
union _WHEA_PCIEXPRESS_BRIDGE_CONTROL_STATUS// Size=0x4 (Id=779)
{
...
struct _WHEA_PCIEXPRESS_ERROR_SECTION// Size=0xd0 (Id=3649)
{
...
union _WHEA_PCIXBUS_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=3319)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long ErrorStatus:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
union _WHEA_PCIXBUS_ID// Size=0x2 (Id=2208)
{
...
union _WHEA_PCIXBUS_COMMAND// Size=0x8 (Id=3048)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WHEA_PCIXBUS_ERROR_SECTION// Size=0x48 (Id=2626)
{
...
union _WHEA_PCIXDEVICE_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=2489)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long ErrorStatus:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_PCIXDEVICE_ERROR_SECTION// Size=0x38 (Id=3387)
{
...
union _WHEA_PMEM_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=2731)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long ErrorStatus:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_PMEM_PAGE_RANGE// Size=0x18 (Id=2813)
{
...
struct _WHEA_PMEM_ERROR_SECTION// Size=0x70 (Id=3603)
{
...
struct _WHEA_ERROR_PACKET_V1// Size=0x119 (Id=3237)
{
    union // Size=0x40 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0xd0 (Id=26268)
        {
