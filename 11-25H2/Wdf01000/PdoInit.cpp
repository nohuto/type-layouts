struct _WDF_PDO_EVENT_CALLBACKS// Size=0x40 (Id=2338)
{
...
struct PdoInit// Size=0xb0 (Id=3175)
{
    void PdoInit();
    union // Size=0xb0 (Id=0)
    {
        ...
        unsigned char NoPowerDependencyOnParent;// Offset=0xaf Size=0x1
        void ~PdoInit();// Offset=0x0 Size=0x22
