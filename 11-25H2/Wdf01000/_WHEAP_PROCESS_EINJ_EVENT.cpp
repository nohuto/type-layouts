...
union _WHEA_EVENT_LOG_ENTRY_FLAGS// Size=0x4 (Id=1901)
{
...
struct _WHEA_EVENT_LOG_ENTRY_HEADER// Size=0x20 (Id=2089)
{
...
struct _WHEA_EVENT_LOG_ENTRY// Size=0x20 (Id=2505)
{
    struct _WHEA_EVENT_LOG_ENTRY_HEADER Header;// Offset=0x0 Size=0x20
};

struct _WHEAP_PROCESS_EINJ_EVENT// Size=0x69 (Id=429)
{
