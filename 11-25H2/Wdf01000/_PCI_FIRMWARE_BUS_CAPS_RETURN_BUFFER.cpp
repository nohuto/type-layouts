struct _PCI_FIRMWARE_BUS_CAPS// Size=0x10 (Id=3800)
{
...
struct _PCI_FIRMWARE_BUS_CAPS_RETURN_BUFFER// Size=0x18 (Id=1461)
{
    unsigned short Version;// Offset=0x0 Size=0x2
    unsigned short Status;// Offset=0x2 Size=0x2
    unsigned long Length;// Offset=0x4 Size=0x4
    struct _PCI_FIRMWARE_BUS_CAPS Caps;// Offset=0x8 Size=0x10
};
