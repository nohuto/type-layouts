struct _unnamed_524// Size=0x1 (Id=524)
{
...
struct _KNODE_SUBNODE_SEARCH_RANKS// Size=0x20 (Id=1371)
{
    unsigned char Ranks[32];// Offset=0x0 Size=0x20
};

struct _KNODE// Size=0x338 (Id=525)
{
    ...
    struct _unnamed_524 Flags;// Offset=0xa Size=0x1
    ...
    struct _KNODE_SUBNODE_SEARCH_RANKS PerformanceSearchRanks[8];// Offset=0x134 Size=0x100
    struct _KNODE_SUBNODE_SEARCH_RANKS EfficiencySearchRanks[8];// Offset=0x234 Size=0x100
};
...
struct _ENODE// Size=0x380 (Id=545)
{
