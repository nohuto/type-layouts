...
struct _INBV_MODE_INFORMATION// Size=0x10 (Id=1758)
{
...
union _unnamed_1504// Size=0x8 (Id=1504)
{
...
struct _INBV_DISPLAY_CONTEXT// Size=0x28 (Id=1505)
{
    ...
    union _unnamed_1504 VideoMemory;// Offset=0x20 Size=0x8
};
