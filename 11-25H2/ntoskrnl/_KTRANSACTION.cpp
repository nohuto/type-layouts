...
struct _KTMOBJECT_NAMESPACE_LINK// Size=0x28 (Id=2170)
{
...
struct _unnamed_2141// Size=0x8 (Id=2141)
{
    unsigned int idxRecord;// Offset=0x0 Size=0x4
    unsigned long cidContainer;// Offset=0x4 Size=0x4
};

union _CLS_LSN// Size=0x8 (Id=2142)
{
    struct _unnamed_2141 offset;// Offset=0x0 Size=0x8
