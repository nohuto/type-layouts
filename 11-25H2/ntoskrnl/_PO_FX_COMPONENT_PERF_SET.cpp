...
struct _PO_FX_COMPONENT_PERF_SET// Size=0x30 (Id=2495)
{
    ...
    {
        struct _unnamed_2493 Discrete;// Offset=0x20 Size=0x10
        struct _unnamed_2494 Range;// Offset=0x20 Size=0x10
    };
};
