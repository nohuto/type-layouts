...
struct _PRIVATE_VOLUME_CACHEMAP// Size=0x680 (Id=876)
{
    ...
    struct _LIST_ENTRY EnhancedExternalCacheList;// Offset=0x4f0 Size=0x10
    unsigned long ThroughputIdx;// Offset=0x500 Size=0x4
    unsigned long long AvgPagesPerSecond;// Offset=0x508 Size=0x8
    unsigned long long ThroughputHistory[32];// Offset=0x510 Size=0x100
    unsigned long DirtyThresholdInSeconds;// Offset=0x610 Size=0x4
    unsigned long DirtyPageTargetInSeconds;// Offset=0x614 Size=0x4
    struct _LIST_ENTRY QuickLWSThreadList;// Offset=0x618 Size=0x10
    struct _KEVENT QuickLazyScanEvent;// Offset=0x628 Size=0x18
    union _LARGE_INTEGER PrevLazyWriteScanTime;// Offset=0x640 Size=0x8
    unsigned long AsyncLazywriteQueueDepth;// Offset=0x648 Size=0x4
    unsigned long MaxAsyncLazywriteCompletionWorkers;// Offset=0x64c Size=0x4
    unsigned long Flags;// Offset=0x650 Size=0x4
    union _LARGE_INTEGER DelayedDelTimestamp;// Offset=0x658 Size=0x8
};
