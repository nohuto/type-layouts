...
struct _PO_DEVICE_NOTIFY// Size=0x68 (Id=1256)
{
...
union _unnamed_760// Size=0x8 (Id=760)
{
...
union _unnamed_761// Size=0x8 (Id=761)
{
    struct _DEVICE_NODE * NextResourceDeviceNode;// Offset=0x0 Size=0x8
};

struct _unnamed_763// Size=0x20 (Id=763)
{
...
struct _PO_DIRECTED_DRIPS_STATE// Size=0x38 (Id=1225)
{
...
struct _PNP_PROBLEM_CODE_LOG_ENTRY// Size=0x18 (Id=1879)
{
...
struct _DEVICE_NODE// Size=0x388 (Id=765)
{
    ...
    union _unnamed_760 OverUsed1;// Offset=0x210 Size=0x8
    union _unnamed_761 OverUsed2;// Offset=0x218 Size=0x8
    ...
    struct _unnamed_763 DockInfo;// Offset=0x238 Size=0x20
