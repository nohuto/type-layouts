...
struct _MI_STORE_MODWRITER_EXTENSION// Size=0x68 (Id=2231)
{
    struct _KAPC WriteCompletionApc;// Offset=0x0 Size=0x58
    unsigned long WriteRefCount;// Offset=0x58 Size=0x4
    unsigned long PadSpare;// Offset=0x5c Size=0x4
    struct _MMPTE PagefileInfo[1];// Offset=0x60 Size=0x8
};
