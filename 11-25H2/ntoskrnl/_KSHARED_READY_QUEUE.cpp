...
union _KPRIORITY_STATE// Size=0x1 (Id=1123)
{
...
union _KHETERO_STATE// Size=0x1 (Id=2402)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _KSHARED_READY_QUEUE_HETERO_STATISTICS// Size=0x380 (Id=2226)
{
    unsigned long long ExpectedRuntimeByClass[7][2][8];// Offset=0x0 Size=0x380
};

struct _KSHARED_READY_QUEUE_AFFINITY_STATISTICS// Size=0x8 (Id=1930)
{
    unsigned long long AffinitySummary;// Offset=0x0 Size=0x8
};

struct _KSHARED_READY_QUEUE// Size=0x700 (Id=1712)
{
