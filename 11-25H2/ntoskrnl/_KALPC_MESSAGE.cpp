...
struct _unnamed_991// Size=0x4 (Id=991)
{
...
union _unnamed_992// Size=0x4 (Id=992)
{
    struct _unnamed_991 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

union _KALPC_DIRECT_EVENT// Size=0x8 (Id=1003)
{
...
struct _PORT_MESSAGE// Size=0x28 (Id=964)
{
...
struct _KALPC_MESSAGE// Size=0x118 (Id=993)
{
    ...
    union _unnamed_992 u1;// Offset=0x28 Size=0x4
