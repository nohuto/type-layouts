...
struct _WNF_SCOPE_INSTANCE// Size=0x50 (Id=1077)
{
    ...
    struct _WNF_PERMANENT_DATA_STORE * PermanentDataStore;// Offset=0x40 Size=0x8
    struct _WNF_PERMANENT_DATA_STORE * VolatilePermanentDataStore;// Offset=0x48 Size=0x8
};
