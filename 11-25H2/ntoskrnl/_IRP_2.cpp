...
struct _unnamed_28// Size=0x50 (Id=28)
{
...
union _unnamed_29// Size=0x58 (Id=29)
{
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_28 Overlay;// Offset=0x0 Size=0x50
        struct _KAPC Apc;// Offset=0x0 Size=0x58
        void * CompletionKey;// Offset=0x0 Size=0x8
    };
};

struct _IRP// Size=0xd0 (Id=570)
{
    ...
    union _unnamed_569 Tail;// Offset=0x78 Size=0x58
};
