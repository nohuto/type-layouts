...
struct _EXT_IOMMU_FUNCTION_TABLE// Size=0x98 (Id=308)
{
...
struct _EXT_IOMMU_FUNCTION_TABLE_EXTENDED// Size=0xb8 (Id=399)
{
    ...
    long  ( * SetDeviceSvmCapabilities)(void * ,struct _EXT_IOMMU_DEVICE * ,unsigned char );// Offset=0x8 Size=0x8
    void  ( * SetDevicePasidTable)(void * ,struct _EXT_IOMMU_DEVICE * ,unsigned char ,unsigned char );// Offset=0x10 Size=0x8
    long  ( * GrowPasidTable)(void * ,struct _EXT_IOMMU_DEVICE * ,unsigned long ,unsigned long ,enum _IOMMU_PASID_SETTING ,enum _IOMMU_ATS_SETTING );// Offset=0x18 Size=0x8
    long  ( * SetPasidAddressSpace)(void * ,struct _EXT_IOMMU_DEVICE * ,unsigned long ,unsigned long long ,unsigned char * );// Offset=0x20 Size=0x8
    ...
    long  ( * SetDeviceSvmCapabilitiesLegacy)(void * ,unsigned long long ,unsigned char );// Offset=0xb0 Size=0x8
};
...
struct _IOMMU_PAGE_HANDLING_DATA// Size=0x28 (Id=387)
{
...
struct _PCI_SLOT_NUMBER// Size=0x4 (Id=369)
{
...
struct _REGISTERED_IOMMU// Size=0x220 (Id=281)
{
    ...
    unsigned long Identifier;// Offset=0x204 Size=0x4
    struct _UNICODE_STRING ResourceId;// Offset=0x208 Size=0x10
    struct _IOMMU_RESERVED_DEVICE_LIST * ReservedDevices;// Offset=0x218 Size=0x8
};
