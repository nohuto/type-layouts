...
struct _MMSECURE_FLAGS// Size=0x4 (Id=2374)
{
...
union _unnamed_2175// Size=0x8 (Id=2175)
{
...
struct _MMADDRESS_LIST// Size=0x10 (Id=2176)
{
    union _unnamed_2175 u1;// Offset=0x0 Size=0x8
...
struct _MI_WRITE_WATCH_BLOCK// Size=0x18 (Id=1709)
{
    long Lock;// Offset=0x0 Size=0x4
    struct _RTL_BITMAP_EX BitMap;// Offset=0x8 Size=0x10
};

struct _MI_LARGEPAGE_VAD_INFO// Size=0x18 (Id=2218)
{
...
union _unnamed_2094// Size=0x8 (Id=2094)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_PHYSICAL_VIEW// Size=0x48 (Id=2095)
{
    ...
    union _unnamed_2094 u1;// Offset=0x28 Size=0x8
...
struct _MI_VAD_EVENT_BLOCK// Size=0x58 (Id=1258)
{
    ...
    union // Size=0x50 (Id=0)
    {
        ...
        struct _RTL_BITMAP_EX BitMap;// Offset=0x8 Size=0x10
        struct _MI_WRITE_WATCH_BLOCK WriteWatch;// Offset=0x8 Size=0x18
        struct _MMINPAGE_SUPPORT * InPageSupport;// Offset=0x8 Size=0x8
        struct _MI_LARGEPAGE_VAD_INFO LargePage;// Offset=0x8 Size=0x18
        struct _MI_PHYSICAL_VIEW AweView;// Offset=0x8 Size=0x48
        struct _ETHREAD * CreatingThread;// Offset=0x8 Size=0x8
        struct _MI_SUB64K_FREE_RANGES PebTeb;// Offset=0x8 Size=0x38
        struct _MMVAD_SHORT * PlaceholderVad;// Offset=0x8 Size=0x8
        void * HotPatchEntry;// Offset=0x8 Size=0x8
        unsigned long WaitReason;// Offset=0x50 Size=0x4
    };
    unsigned long CaseSpecificFlags;// Offset=0x54 Size=0x4
};
