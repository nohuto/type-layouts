...
struct _KI_RESCHEDULE_CONTEXT_ENTRY// Size=0x28 (Id=2441)
{
...
struct _KI_SHARED_READY_QUEUE_LOCK_HANDLE// Size=0x10 (Id=2311)
{
    struct _KSPIN_LOCK_QUEUE Queue;// Offset=0x0 Size=0x10
};

struct _KI_RESCHEDULE_CONTEXT// Size=0xf0 (Id=1928)
{
