...
struct _LOG_HANDLE_CONTEXT// Size=0x98 (Id=1274)
{
...
struct _CC_VOLUME_TELEMETRY// Size=0x9b0 (Id=2002)
{
...
struct _KE_RCU_WORKITEM// Size=0x30 (Id=1204)
{
    unsigned long long Placeholder[6];// Offset=0x0 Size=0x30
};

struct _VOLUME_CACHE_MAP// Size=0xac8 (Id=861)
{
    short NodeTypeCode;// Offset=0x0 Size=0x2
    short NodeByteCode;// Offset=0x2 Size=0x2
    long long UseCount;// Offset=0x8 Size=0x8
    struct _DEVICE_OBJECT * DeviceObject;// Offset=0x10 Size=0x8
    struct _LIST_ENTRY VolumeCacheMapLinks;// Offset=0x18 Size=0x10
    unsigned long long DirtyPages;// Offset=0x28 Size=0x8
    struct _LOG_HANDLE_CONTEXT LogHandleContext;// Offset=0x30 Size=0x98
    unsigned long Flags;// Offset=0xc8 Size=0x4
    unsigned long PagesQueuedToDisk;// Offset=0xcc Size=0x4
    unsigned long LoggedPagesQueuedToDisk;// Offset=0xd0 Size=0x4
    unsigned long VolumeId;// Offset=0xd4 Size=0x4
    struct _LIST_ENTRY PrivateVolumeList;// Offset=0xd8 Size=0x10
    struct _CC_VOLUME_TELEMETRY VolumeTelemetry;// Offset=0xe8 Size=0x9b0
    struct _KE_RCU_WORKITEM RcuContext;// Offset=0xa98 Size=0x30
};
