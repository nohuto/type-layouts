struct _unnamed_1954// Size=0x4 (Id=1954)
{
...
struct _unnamed_1955// Size=0x4 (Id=1955)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long FilePointerIndex:9;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x9
...
union _MM_PAGE_ACCESS_INFO_FLAGS// Size=0x4 (Id=1956)
{
    struct _unnamed_1954 File;// Offset=0x0 Size=0x4
    struct _unnamed_1955 Private;// Offset=0x0 Size=0x4
};

struct _MM_PAGE_ACCESS_INFO// Size=0x8 (Id=1706)
{
    union // Size=0x8 (Id=0)
    {
