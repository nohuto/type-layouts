...
struct _ETW_BUFFER_QUEUE// Size=0x10 (Id=1034)
{
...
struct _ETW_REF_CLOCK// Size=0x10 (Id=1621)
{
...
struct _KTIMER// Size=0x40 (Id=1975)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
...
struct _SECURITY_QUALITY_OF_SERVICE// Size=0xc (Id=238)
{
...
struct _SECURITY_CLIENT_CONTEXT// Size=0x48 (Id=1387)
{
...
struct _ETW_APC_POOL// Size=0xc0 (Id=2126)
{
...
struct _ETW_STACK_TRACE_BLOCK// Size=0xd0 (Id=1846)
{
...
struct _DISALLOWED_GUIDS// Size=0x10 (Id=1609)
{
...
struct _ETW_PARTITION_CONTEXT// Size=0x8 (Id=1187)
{
    struct _EPARTITION * Partition;// Offset=0x0 Size=0x8
};

struct _WMI_LOGGER_CONTEXT// Size=0x650 (Id=1033)
{
    ...
    unsigned long long GetCpuClock;// Offset=0x18 Size=0x8
    struct _ETHREAD * LoggerThread;// Offset=0x20 Size=0x8
    long LoggerStatus;// Offset=0x28 Size=0x4
    unsigned long FailureReason;// Offset=0x2c Size=0x4
    struct _ETW_BUFFER_QUEUE BufferQueue;// Offset=0x30 Size=0x10
    struct _ETW_BUFFER_QUEUE OverflowQueue;// Offset=0x40 Size=0x10
    struct _LIST_ENTRY GlobalList;// Offset=0x50 Size=0x10
    struct _LIST_ENTRY DebugIdTrackingList;// Offset=0x60 Size=0x10
    struct _ETW_DECODE_CONTROL_ENTRY * DecodeControlList;// Offset=0x70 Size=0x8
    unsigned long DecodeControlCount;// Offset=0x78 Size=0x4
    union // Size=0x8 (Id=0)
    {
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct // Size=0x4 (Id=0)
        {
            ...
            unsigned long LastBranchTracing:1;// Offset=0x330 Size=0x4 BitOffset=0xf BitSize=0x1
            ...
            unsigned long ProviderTracking:1;// Offset=0x330 Size=0x4 BitOffset=0x19 BitSize=0x1
            unsigned long ProcessorTrace:1;// Offset=0x330 Size=0x4 BitOffset=0x1a BitSize=0x1
            unsigned long QpcDeltaTracking:1;// Offset=0x330 Size=0x4 BitOffset=0x1b BitSize=0x1
            unsigned long MarkerBufferSaved:1;// Offset=0x330 Size=0x4 BitOffset=0x1c BitSize=0x1
            unsigned long LargeMdlPages:1;// Offset=0x330 Size=0x4 BitOffset=0x1d BitSize=0x1
            unsigned long ExcludeKernelStack:1;// Offset=0x330 Size=0x4 BitOffset=0x1e BitSize=0x1
            unsigned long BootLogger:1;// Offset=0x330 Size=0x4 BitOffset=0x1f BitSize=0x1
        };
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long Flags2;// Offset=0x334 Size=0x4
        struct // Size=0x4 (Id=0)
        {
            unsigned long UnifiedStackCaching:1;// Offset=0x334 Size=0x4 BitOffset=0x0 BitSize=0x1
        };
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long RequestFlag;// Offset=0x338 Size=0x4
        struct // Size=0x4 (Id=0)
        {
            unsigned long DbgRequestNewFile:1;// Offset=0x338 Size=0x4 BitOffset=0x0 BitSize=0x1
            unsigned long DbgRequestUpdateFile:1;// Offset=0x338 Size=0x4 BitOffset=0x1 BitSize=0x1
            unsigned long DbgRequestFlush:1;// Offset=0x338 Size=0x4 BitOffset=0x2 BitSize=0x1
            unsigned long DbgRequestDisableRealtime:1;// Offset=0x338 Size=0x4 BitOffset=0x3 BitSize=0x1
            unsigned long DbgRequestDisconnectConsumer:1;// Offset=0x338 Size=0x4 BitOffset=0x4 BitSize=0x1
            unsigned long DbgRequestConnectConsumer:1;// Offset=0x338 Size=0x4 BitOffset=0x5 BitSize=0x1
            unsigned long DbgRequestNotifyConsumer:1;// Offset=0x338 Size=0x4 BitOffset=0x6 BitSize=0x1
            unsigned long DbgRequestUpdateHeader:1;// Offset=0x338 Size=0x4 BitOffset=0x7 BitSize=0x1
            unsigned long DbgRequestDeferredFlush:1;// Offset=0x338 Size=0x4 BitOffset=0x8 BitSize=0x1
            unsigned long DbgRequestDeferredFlushTimer:1;// Offset=0x338 Size=0x4 BitOffset=0x9 BitSize=0x1
            unsigned long DbgRequestFlushTimer:1;// Offset=0x338 Size=0x4 BitOffset=0xa BitSize=0x1
            unsigned long DbgRequestUpdateDebugger:1;// Offset=0x338 Size=0x4 BitOffset=0xb BitSize=0x1
            unsigned long DbgSpareRequestFlags:20;// Offset=0x338 Size=0x4 BitOffset=0xc BitSize=0x14
        };
    };
    struct _ETW_STACK_TRACE_BLOCK StackTraceBlock;// Offset=0x340 Size=0xd0
    struct _RTL_BITMAP StackHookIdMap;// Offset=0x410 Size=0x10
    struct _ETW_STACK_CACHE * StackCache;// Offset=0x420 Size=0x8
    struct _ETW_PMC_SUPPORT * PmcData;// Offset=0x428 Size=0x8
    struct _ETW_LBR_SUPPORT * LbrData;// Offset=0x430 Size=0x8
    struct _ETW_IPT_SUPPORT * IptData;// Offset=0x438 Size=0x8
    struct _ETW_APC_POOL ContextRegisterLoggingApcPool;// Offset=0x440 Size=0xc0
    unsigned long ContextRegisterTypes;// Offset=0x500 Size=0x4
    unsigned long ContextRegisterHookCount;// Offset=0x504 Size=0x4
    unsigned short ContextRegisterHookIdMap[8];// Offset=0x508 Size=0x10
    struct _LIST_ENTRY BinaryTrackingList;// Offset=0x518 Size=0x10
    struct _WMI_BUFFER_HEADER ** ScratchArray;// Offset=0x528 Size=0x8
    struct _DISALLOWED_GUIDS DisallowedGuids;// Offset=0x530 Size=0x10
    struct PERIODIC_CAPTURE_STATE_CONTEXT * PeriodicCaptureStateContext;// Offset=0x540 Size=0x8
    struct _ETW_SOFT_RESTART_CONTEXT * SoftRestartContext;// Offset=0x548 Size=0x8
    struct _ETW_SILODRIVERSTATE * SiloState;// Offset=0x550 Size=0x8
    struct _WORK_QUEUE_ITEM CompressionWorkItem;// Offset=0x558 Size=0x20
    long CompressionWorkItemState;// Offset=0x578 Size=0x4
    struct _EX_PUSH_LOCK CompressionLock;// Offset=0x580 Size=0x8
    struct _WMI_BUFFER_HEADER * CompressionTarget;// Offset=0x588 Size=0x8
    void * CompressionWorkspace;// Offset=0x590 Size=0x8
    long CompressionOn;// Offset=0x598 Size=0x4
    unsigned long CompressionRatioGuess;// Offset=0x59c Size=0x4
    unsigned long PartialBufferCompressionLevel;// Offset=0x5a0 Size=0x4
    enum ETW_COMPRESSION_RESUMPTION_MODE CompressionResumptionMode;// Offset=0x5a4 Size=0x4
    struct _SINGLE_LIST_ENTRY PlaceholderList;// Offset=0x5a8 Size=0x8
    struct _KDPC CompressionDpc;// Offset=0x5b0 Size=0x40
    union _LARGE_INTEGER LastBufferSwitchTime;// Offset=0x5f0 Size=0x8
    union _LARGE_INTEGER BufferWriteDuration;// Offset=0x5f8 Size=0x8
    union _LARGE_INTEGER BufferCompressDuration;// Offset=0x600 Size=0x8
    long long ReferenceQpcDelta;// Offset=0x608 Size=0x8
    struct _ETW_EVENT_CALLBACK_CONTEXT * CallbackContext;// Offset=0x610 Size=0x8
    union _LARGE_INTEGER * LastDroppedTime;// Offset=0x618 Size=0x8
    union _LARGE_INTEGER * FlushingLastDroppedTime;// Offset=0x620 Size=0x8
    long long FlushingSequenceNumber;// Offset=0x628 Size=0x8
    struct _ETW_PARTITION_CONTEXT PartitionContext;// Offset=0x630 Size=0x8
    struct _MDL * BufferMdl;// Offset=0x638 Size=0x8
    unsigned long long * PfnArray;// Offset=0x640 Size=0x8
};
