...
union _WHEA_NOTIFICATION_FLAGS// Size=0x2 (Id=337)
{
...
struct _WHEA_XPF_NMI_DESCRIPTOR// Size=0x3 (Id=279)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
};
...
struct _WHEA_ERROR_SOURCE_CONFIGURATION_DD// Size=0x18 (Id=267)
{
...
struct _WHEAP_ERROR_SOURCE// Size=0x430 (Id=1069)
{
