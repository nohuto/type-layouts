...
struct _IO_ADAPTER_CRYPTO_PARAMETERS// Size=0x10 (Id=1622)
{
...
struct _IOP_IRP_EXTENSION// Size=0x50 (Id=1015)
{
    ...
    union _unnamed_1014 DriverFlags;// Offset=0x38 Size=0x8
