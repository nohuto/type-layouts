...
struct _OPLOCK_ACK_TIMEOUT// Size=0xb8 (Id=1903)
{
    ...
    struct _NONOPAQUE_OPLOCK * Oplock;// Offset=0xa0 Size=0x8
    struct _FILE_OBJECT * OplockRequestFileObject;// Offset=0xa8 Size=0x8
    unsigned long OplockOwnerIntegrityLevel;// Offset=0xb0 Size=0x4
    unsigned char TimerSet;// Offset=0xb4 Size=0x1
    unsigned char AckDone;// Offset=0xb5 Size=0x1
};
