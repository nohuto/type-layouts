...
struct _unnamed_335// Size=0x1 (Id=335)
{
...
struct _unnamed_366// Size=0x10 (Id=366)
{
...
struct _EXT_IOMMU_DOMAIN_SETTINGS// Size=0x20 (Id=367)
{
    struct _EXT_IOMMU_S1_X64_DOMAIN_SETTINGS S1;// Offset=0x0 Size=0x10
    struct _unnamed_366 S2;// Offset=0x10 Size=0x10
};
...
struct _EXT_ENV_SPINLOCK// Size=0x20 (Id=430)
{
...
struct _EXT_IOMMU_DOMAIN// Size=0x70 (Id=336)
{
    ...
    struct _unnamed_335 Flags;// Offset=0x8 Size=0x1
