...
union _unnamed_1905// Size=0x4 (Id=1905)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _KI_IDEAL_PROCESSOR_ASSIGNMENT_BLOCK// Size=0x1d8 (Id=1906)
{
    ...
    union _unnamed_1905 AssignmentFlags;// Offset=0xc Size=0x4
