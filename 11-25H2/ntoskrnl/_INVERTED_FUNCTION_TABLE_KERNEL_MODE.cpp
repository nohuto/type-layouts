struct _INVERTED_FUNCTION_TABLE_ENTRY// Size=0x18 (Id=2099)
{
    union // Size=0x8 (Id=0)
    {
...
struct _INVERTED_FUNCTION_TABLE_KERNEL_MODE// Size=0x1810 (Id=1701)
{
    ...
    struct _INVERTED_FUNCTION_TABLE_ENTRY TableEntry[256];// Offset=0x10 Size=0x1800
};
