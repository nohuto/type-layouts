...
struct _unnamed_2506// Size=0x18 (Id=2506)
{
...
struct _unnamed_2507// Size=0x20 (Id=2507)
{
...
struct _unnamed_2508// Size=0x28 (Id=2508)
{
...
union _FS_FILTER_PARAMETERS// Size=0x28 (Id=2509)
{
    struct _unnamed_2503 AcquireForModifiedPageWriter;// Offset=0x0 Size=0x10
    struct _unnamed_2504 ReleaseForModifiedPageWriter;// Offset=0x0 Size=0x8
    struct _unnamed_2506 AcquireForSectionSynchronization;// Offset=0x0 Size=0x18
    struct _unnamed_2507 QueryOpen;// Offset=0x0 Size=0x20
    struct _unnamed_2508 Others;// Offset=0x0 Size=0x28
};

struct _FS_FILTER_CALLBACK_DATA// Size=0x40 (Id=2490)
{
