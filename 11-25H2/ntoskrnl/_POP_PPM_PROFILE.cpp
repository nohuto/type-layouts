...
union _PPM_POLICY_SETTINGS_MASK// Size=0x10 (Id=839)
{
...
struct _PPM_ENGINE_SETTINGS// Size=0x1e8 (Id=845)
{
...
struct _POP_PPM_PROFILE// Size=0x420 (Id=843)
{
    ...
    struct _PPM_ENGINE_SETTINGS Settings[2];// Offset=0x28 Size=0x3d0
    unsigned long long StartTime;// Offset=0x3f8 Size=0x8
    unsigned long long Count;// Offset=0x400 Size=0x8
    unsigned long long MaxDuration;// Offset=0x408 Size=0x8
    unsigned long long MinDuration;// Offset=0x410 Size=0x8
    unsigned long long TotalDuration;// Offset=0x418 Size=0x8
};
