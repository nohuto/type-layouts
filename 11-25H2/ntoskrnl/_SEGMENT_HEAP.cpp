struct _RTLP_HEAP_COMMIT_LIMIT_DATA// Size=0x10 (Id=2248)
{
...
struct _RTL_HP_HEAP_VA_CALLBACKS_ENCODED// Size=0x20 (Id=1318)
{
...
union _unnamed_937// Size=0x1 (Id=937)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _HEAP_SEG_CONTEXT// Size=0xc0 (Id=938)
{
    ...
    union _unnamed_937 Flags;// Offset=0xd Size=0x1
...
struct _HEAP_AFFINITY_MGR// Size=0x10 (Id=890)
{
...
struct _HEAP_VS_CONTEXT// Size=0x60 (Id=923)
{
...
struct _HEAP_LFH_CONFIG// Size=0x8 (Id=1343)
{
...
struct _SEGMENT_HEAP// Size=0xa00 (Id=942)
{
