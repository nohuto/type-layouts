struct _PROFILE_PARAMETER_BLOCK// Size=0x10 (Id=2465)
{
...
struct _LOADER_PERFORMANCE_DATA// Size=0x60 (Id=2434)
{
...
struct _BOOT_ENTROPY_SOURCE_LDR_RESULT// Size=0x68 (Id=2501)
{
...
struct _BOOT_ENTROPY_LDR_RESULT// Size=0x868 (Id=2475)
{
...
struct _LOADER_PARAMETER_HYPERVISOR_EXTENSION// Size=0x40 (Id=2459)
{
...
struct _LOADER_BUGCHECK_PARAMETERS// Size=0x28 (Id=2314)
{
...
struct _OFFLINE_CRASHDUMP_CONFIGURATION_TABLE_V2// Size=0x20 (Id=2396)
{
...
struct _LOADER_HIVE_RECOVERY_INFO// Size=0x14 (Id=2356)
{
...
struct _unnamed_2279// Size=0x10 (Id=2279)
{
    void * CodeBase;// Offset=0x0 Size=0x8
    unsigned long long CodeSize;// Offset=0x8 Size=0x8
};

struct _VSM_PERFORMANCE_DATA// Size=0x40 (Id=2345)
{
...
struct _LOADER_FEATURE_CONFIGURATION_DIAGNOSTIC_INFORMATION// Size=0x18 (Id=2420)
{
    ...
    union _unnamed_2419 Flags;// Offset=0x4 Size=0x4
...
struct _LOADER_FEATURE_CONFIGURATION_INFORMATION// Size=0x48 (Id=2301)
{
...
struct _OSLOADER_PAGE_TABLE_LOG// Size=0x28 (Id=2452)
{
...
struct _LOADER_BOOT_APPLICATION_SVN_INFORMATION// Size=0x10 (Id=2476)
{
    union _LARGE_INTEGER BootStlCreationTime;// Offset=0x0 Size=0x8
    unsigned long HiberrsmMinSvn;// Offset=0x8 Size=0x4
};

struct _LOADER_PARAMETER_EXTENSION// Size=0x1130 (Id=2283)
{
    ...
    struct _unnamed_2279 MiniExecutive;// Offset=0xdb0 Size=0x10
    ...
    struct _unnamed_2280 InstalledMemory;// Offset=0xeb8 Size=0x10
    ...
    struct _unnamed_2281 CimfsInformation;// Offset=0xee8 Size=0x20
    ...
    struct _unnamed_2282 CompositefsInformation;// Offset=0xf68 Size=0x10
