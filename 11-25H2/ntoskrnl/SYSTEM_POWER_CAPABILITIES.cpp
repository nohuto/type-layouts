...
struct SYSTEM_POWER_CAPABILITIES// Size=0x4c (Id=1410)
{
    ...
    unsigned char Hiberboot;// Offset=0x12 Size=0x1
    unsigned char WakeAlarmPresent;// Offset=0x13 Size=0x1
    unsigned char AoAc;// Offset=0x14 Size=0x1
    unsigned char DiskSpinDown;// Offset=0x15 Size=0x1
    unsigned char HiberFileType;// Offset=0x16 Size=0x1
    unsigned char AoAcConnectivitySupported;// Offset=0x17 Size=0x1
    unsigned char spare3[6];// Offset=0x18 Size=0x6
