...
struct _IOP_MC_BE_PAGE_NODE// Size=0x20 (Id=1735)
{
    struct _RTL_BALANCED_NODE Node;// Offset=0x0 Size=0x18
    unsigned int PageIndex;// Offset=0x18 Size=0x4
};

struct _IOP_MC_BUFFER_ENTRY// Size=0x80 (Id=1146)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned short Reserved;// Offset=0x2 Size=0x2
    unsigned int Size;// Offset=0x4 Size=0x4
    long ReferenceCount;// Offset=0x8 Size=0x4
    enum _IOP_MC_BUFFER_ENTRY_FLAGS Flags;// Offset=0xc Size=0x4
    struct _LIST_ENTRY GlobalDataLink;// Offset=0x10 Size=0x10
    void * Address;// Offset=0x20 Size=0x8
    unsigned int Length;// Offset=0x28 Size=0x4
    char AccessMode;// Offset=0x2c Size=0x1
    long MdlRef;// Offset=0x30 Size=0x4
    struct _MDL * Mdl;// Offset=0x38 Size=0x8
    struct _KEVENT MdlRundownEvent;// Offset=0x40 Size=0x18
    unsigned long long * PfnArray;// Offset=0x58 Size=0x8
    struct _IOP_MC_BE_PAGE_NODE PageNodes[1];// Offset=0x60 Size=0x20
};
