...
struct _I386_LOADER_BLOCK// Size=0x10 (Id=2347)
{
...
struct _ARM_LOADER_BLOCK// Size=0x4 (Id=2430)
{
    unsigned long PlaceHolder;// Offset=0x0 Size=0x4
};

union _unnamed_2115// Size=0x10 (Id=2115)
{
...
struct _EFI_FIRMWARE_INFORMATION// Size=0x38 (Id=2436)
{
...
struct _PCAT_FIRMWARE_INFORMATION// Size=0x4 (Id=2448)
{
    unsigned long PlaceHolder;// Offset=0x0 Size=0x4
};

union _unnamed_2357// Size=0x38 (Id=2357)
{
...
struct _FIRMWARE_INFORMATION_LOADER_BLOCK// Size=0x40 (Id=2358)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long SoftRebootMpwrResume:1;// Offset=0x0 Size=0x4 BitOffset=0x4 BitSize=0x1
        unsigned long Reserved2:27;// Offset=0x0 Size=0x4 BitOffset=0x5 BitSize=0x1b
    };
    union _unnamed_2357 u;// Offset=0x8 Size=0x38
};
...
struct _LOADER_PARAMETER_BLOCK// Size=0x170 (Id=2116)
{
    ...
    union _unnamed_2115 u;// Offset=0xf8 Size=0x10
