...
union _WHEAP_ERROR_RECORD_WRAPPER_FLAGS// Size=0x4 (Id=1499)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long Preallocated:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
        unsigned long FromPersistentStore:1;// Offset=0x0 Size=0x4 BitOffset=0x1 BitSize=0x1
        unsigned long PlatformPfaControl:1;// Offset=0x0 Size=0x4 BitOffset=0x2 BitSize=0x1
        unsigned long PlatformDirectedOffline:1;// Offset=0x0 Size=0x4 BitOffset=0x3 BitSize=0x1
        unsigned long Reserved:28;// Offset=0x0 Size=0x4 BitOffset=0x4 BitSize=0x1c
    };
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

union _WHEA_REVISION// Size=0x2 (Id=196)
{
...
union _WHEA_ERROR_RECORD_HEADER_VALIDBITS// Size=0x4 (Id=136)
{
    struct // Size=0x4 (Id=0)
    {
...
union _WHEA_TIMESTAMP// Size=0x8 (Id=131)
{
...
union _WHEA_ERROR_RECORD_HEADER_FLAGS// Size=0x4 (Id=162)
{
    struct // Size=0x4 (Id=0)
    {
...
union _WHEA_PERSISTENCE_INFO// Size=0x8 (Id=202)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WHEA_ERROR_RECORD_HEADER// Size=0x80 (Id=113)
{
...
union _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_VALIDBITS// Size=0x1 (Id=254)
{
...
union _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR_FLAGS// Size=0x4 (Id=114)
{
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long FruTextByPlugin:1;// Offset=0x0 Size=0x4 BitOffset=0x7 BitSize=0x1
        unsigned long Reserved:24;// Offset=0x0 Size=0x4 BitOffset=0x8 BitSize=0x18
    };
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _WHEA_ERROR_RECORD_SECTION_DESCRIPTOR// Size=0x48 (Id=111)
{
...
struct _WHEA_ERROR_RECORD// Size=0xc8 (Id=110)
{
...
struct _WHEAP_ERROR_RECORD_WRAPPER// Size=0xf0 (Id=1070)
{
    struct _LIST_ENTRY WorkEntry;// Offset=0x0 Size=0x10
    unsigned long Length;// Offset=0x10 Size=0x4
    unsigned long ProcessorNumber;// Offset=0x14 Size=0x4
    union _WHEAP_ERROR_RECORD_WRAPPER_FLAGS Flags;// Offset=0x18 Size=0x4
    long InUse;// Offset=0x1c Size=0x4
    struct _WHEAP_ERROR_SOURCE * ErrorSource;// Offset=0x20 Size=0x8
    struct _WHEA_ERROR_RECORD ErrorRecord;// Offset=0x28 Size=0xc8
};
