...
struct _MI_PARTITION_CORE// Size=0x1e0 (Id=1694)
{
...
struct _MMPAGE_FILE_EXPANSION_FLAGS// Size=0x4 (Id=2394)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MMPAGE_FILE_EXPANSION// Size=0x58 (Id=1853)
{
    ...
    union _unnamed_1852 u1;// Offset=0x4c Size=0x4
    void * ActiveEntry;// Offset=0x50 Size=0x8
};

struct _MMMOD_WRITER_LISTHEAD// Size=0x28 (Id=2201)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
    struct _KEVENT Event;// Offset=0x10 Size=0x18
};

union _MI_RESERVATION_CLUSTER_INFO// Size=0x4 (Id=2450)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_MODWRITE_DATA// Size=0x40 (Id=2293)
{
...
struct _MI_RESTRICTED_MODWRITES// Size=0x3 (Id=2395)
{
...
struct _MI_PARTITION_MODWRITES// Size=0x2c8 (Id=2077)
{
...
union _unnamed_1231// Size=0x4 (Id=1231)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_PARTITION_STORES// Size=0x210 (Id=1232)
{
    union _unnamed_1231 WriteAllStoreSwapPages;// Offset=0x0 Size=0x4
...
struct _MMDEREFERENCE_SEGMENT_HEADER// Size=0x48 (Id=2255)
{
...
struct _MI_DEFERRED_PFNS_TO_FREE// Size=0x20 (Id=2288)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
...
struct _MI_CROSS_PARTITION_CHARGES// Size=0x20 (Id=2286)
{
...
struct _MI_PARTITION_SEGMENTS// Size=0x480 (Id=1801)
{
...
struct _MI_DECAY_TIMER_LINKAGE// Size=0x8 (Id=1985)
{
    struct // Size=0x8 (Id=0)
    {
...
union _unnamed_1564// Size=0x8 (Id=1564)
{
    unsigned long long Long;// Offset=0x0 Size=0x8
    struct _MI_DECAY_TIMER_LINKAGE e1;// Offset=0x0 Size=0x8
};

struct _MI_DECAY_TIMER_LINK// Size=0x8 (Id=1565)
{
    union _unnamed_1564 u1;// Offset=0x0 Size=0x8
};

struct _MI_LDW_WORK_CONTEXT// Size=0x38 (Id=1777)
{
...
struct _MI_AVAILABLE_PAGE_WAIT_STATES// Size=0x20 (Id=1805)
{
    struct _KEVENT Event;// Offset=0x0 Size=0x18
...
struct _MI_LARGE_PAGE_COALESCE_WORKER_CONTEXT// Size=0x30 (Id=2066)
{
...
struct _MI_PARTITION_PAGE_LISTS// Size=0x3680 (Id=1561)
{
...
struct _MI_PARTITION_ZEROING// Size=0x48 (Id=1896)
{
...
struct _MI_PAGE_COMBINING_SUPPORT// Size=0x190 (Id=1583)
{
...
struct _MI_ACCESS_LOG_STATE// Size=0xc0 (Id=1675)
{
...
struct _MMWORKING_SET_EXPANSION_HEAD// Size=0x10 (Id=1277)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
};

struct _MI_SPECIAL_PURPOSE_MEMORY_STATE// Size=0x38 (Id=1328)
{
...
struct _MI_PARTITION_SLABS// Size=0x2c0 (Id=1275)
{
...
struct _MI_PARTITION_WORKING_SET// Size=0x1c0 (Id=1925)
{
...
struct _unnamed_1710// Size=0x38 (Id=1710)
{
    struct _MDL Mdl;// Offset=0x0 Size=0x30
    unsigned long long Page[1];// Offset=0x30 Size=0x8
};

struct _MI_PAGEFILE_TRACES// Size=0x80 (Id=1711)
{
    ...
    struct _unnamed_1710 LocalMdl;// Offset=0x48 Size=0x38
};

struct _MI_VISIBLE_PARTITION// Size=0x1500 (Id=1363)
{
...
struct _MI_PARTITION// Size=0x5d40 (Id=695)
{
