...
struct _unnamed_2377// Size=0x8 (Id=2377)
{
...
struct _unnamed_2378// Size=0x10 (Id=2378)
{
    struct _GUID DiskId;// Offset=0x0 Size=0x10
};

union _unnamed_2379// Size=0x10 (Id=2379)
{
    struct _unnamed_2377 Mbr;// Offset=0x0 Size=0x8
    struct _unnamed_2378 Gpt;// Offset=0x0 Size=0x10
};

struct _DUMP_INITIALIZATION_CONTEXT// Size=0x108 (Id=2381)
{
    ...
    union _unnamed_2379 DiskInfo;// Offset=0x8c Size=0x10
...
struct _DUMP_STACK_CONTEXT// Size=0x178 (Id=2321)
{
