...
struct _unnamed_2196// Size=0xc (Id=2196)
{
...
union _unnamed_2197// Size=0xc (Id=2197)
{
    struct _unnamed_2196 Msi;// Offset=0x0 Size=0xc
};

struct _INTERRUPT_REMAPPING_INFO// Size=0x10 (Id=2198)
{
    ...
    union _unnamed_2197 u;// Offset=0x4 Size=0xc
};

struct _unnamed_1304// Size=0x8 (Id=1304)
{
...
union _unnamed_1593// Size=0x4 (Id=1593)
{
    struct _unnamed_1592 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _unnamed_1594// Size=0x4 (Id=1594)
{
    struct // Size=0x4 (Id=0)
    {
...
union _unnamed_1595// Size=0x4 (Id=1595)
{
    struct _unnamed_1594 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_HT_INTR_INFO// Size=0x8 (Id=1596)
{
    union _unnamed_1593 LowPart;// Offset=0x0 Size=0x4
    union _unnamed_1595 HighPart;// Offset=0x4 Size=0x4
};

struct _unnamed_1306// Size=0x8 (Id=1306)
{
    struct _INTERRUPT_HT_INTR_INFO IntrInfo;// Offset=0x0 Size=0x8
};

struct _unnamed_1308// Size=0x4 (Id=1308)
{
    enum HAL_APIC_DESTINATION_MODE DestinationMode;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_VECTOR_DATA// Size=0x58 (Id=1309)
{
    ...
    struct _unnamed_1304 ControllerInput;// Offset=0x38 Size=0x8
    unsigned long long HvDeviceId;// Offset=0x40 Size=0x8
    union // Size=0x58 (Id=0)
    {
        struct _unnamed_1305 XapicMessage;// Offset=0x48 Size=0x10
        struct _unnamed_1306 Hypertransport;// Offset=0x48 Size=0x8
        struct _unnamed_1305 GenericMessage;// Offset=0x48 Size=0x10
        struct _unnamed_1308 MessageRequest;// Offset=0x48 Size=0x4
    };
};

struct _INTERRUPT_CONNECTION_DATA// Size=0x60 (Id=2195)
{
