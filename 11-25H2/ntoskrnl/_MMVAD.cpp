...
struct _MMVAD_FLAGS// Size=0x4 (Id=1121)
{
    union // Size=0x4 (Id=0)
    {
...
struct _MM_PRIVATE_VAD_FLAGS// Size=0x4 (Id=1148)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long Lock:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
struct _MM_GRAPHICS_VAD_FLAGS// Size=0x4 (Id=1271)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long Lock:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
struct _MM_SHARED_VAD_FLAGS// Size=0x4 (Id=1450)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long Lock:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
union _unnamed_692// Size=0x4 (Id=692)
{
...
struct _MMVAD_SHORT// Size=0x40 (Id=694)
{
    union // Size=0x10 (Id=0)
    {
    ...
    union _unnamed_692 u;// Offset=0x30 Size=0x4
    unsigned long CommitCharge;// Offset=0x34 Size=0x4
    union _unnamed_693 u5;// Offset=0x38 Size=0x8
};
...
struct _MI_VAD_SEQUENTIAL_INFO// Size=0x8 (Id=2399)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _MMVAD// Size=0x88 (Id=2054)
{
    ...
    union _unnamed_2053 u4;// Offset=0x78 Size=0x8
