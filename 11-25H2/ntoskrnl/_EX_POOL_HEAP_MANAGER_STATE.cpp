struct _RTL_CSPARSE_BITMAP// Size=0x40 (Id=891)
{
...
struct _RTLP_HP_ALLOC_TRACKER// Size=0x50 (Id=900)
{
...
struct _RTL_SPARSE_ARRAY// Size=0x50 (Id=893)
{
...
struct _HEAP_VAMGR_VASPACE// Size=0x860 (Id=897)
{
...
struct _HEAP_VAMGR_ALLOCATOR// Size=0x30 (Id=894)
{
...
struct _HEAP_VAMGR_CTX// Size=0x3840 (Id=1624)
{
...
union _RTL_RUN_ONCE// Size=0x8 (Id=1245)
{
...
struct _unnamed_1248// Size=0x1 (Id=1248)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _RTL_HP_VS_CONFIG// Size=0x1 (Id=1249)
{
    struct _unnamed_1248 Flags;// Offset=0x0 Size=0x1
};

struct _RTL_HP_SUB_ALLOCATOR_CONFIGS// Size=0x8 (Id=1823)
{
    union _RTL_HP_LFH_CONFIG LfhConfigs;// Offset=0x0 Size=0x4
    struct _RTL_HP_VS_CONFIG VsConfigs;// Offset=0x4 Size=0x1
};

struct _RTLP_HP_HEAP_MANAGER// Size=0x38e0 (Id=899)
{
...
struct _RTL_LOOKASIDE// Size=0x40 (Id=944)
{
...
struct _RTL_DYNAMIC_LOOKASIDE// Size=0x1040 (Id=943)
{
...
struct _EX_HEAP_POOL_NODE// Size=0x20c0 (Id=1881)
{
    struct _SEGMENT_HEAP * Heaps[4];// Offset=0x0 Size=0x20
    struct _RTL_DYNAMIC_LOOKASIDE Lookasides[2];// Offset=0x40 Size=0x2080
};

struct _EX_POOL_HEAP_MANAGER_STATE// Size=0x86980 (Id=1616)
{
    struct _RTLP_HP_HEAP_MANAGER HeapManager;// Offset=0x0 Size=0x38e0
    struct _EX_PUSH_LOCK PrivatePoolListLock;// Offset=0x38e0 Size=0x8
    struct _LIST_ENTRY PrivatePools[2];// Offset=0x38e8 Size=0x20
    unsigned long long PrivatePoolContextCookie;// Offset=0x3908 Size=0x8
    unsigned long NumberOfPools;// Offset=0x3910 Size=0x4
    struct _EX_HEAP_POOL_NODE PoolNode[64];// Offset=0x3940 Size=0x83000
    struct _SEGMENT_HEAP * SpecialHeaps[4];// Offset=0x86940 Size=0x20
};
