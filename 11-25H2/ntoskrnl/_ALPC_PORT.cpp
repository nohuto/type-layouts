...
struct _ALPC_PORT_ATTRIBUTES// Size=0x48 (Id=1240)
{
...
struct _unnamed_983// Size=0x4 (Id=983)
{
...
union _unnamed_984// Size=0x4 (Id=984)
{
    struct _unnamed_983 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

struct _ALPC_PORT// Size=0x1d8 (Id=985)
{
    ...
    union _unnamed_984 u1;// Offset=0x1a0 Size=0x4
