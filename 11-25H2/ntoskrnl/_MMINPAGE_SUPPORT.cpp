...
struct _KAPC_STATE// Size=0x30 (Id=1619)
{
...
union _unnamed_1536// Size=0x4 (Id=1536)
{
...
struct _MMINPAGE_SUPPORT_FLOW_THROUGH// Size=0x38 (Id=1995)
{
    ...
    unsigned long PageFileOffset;// Offset=0x18 Size=0x4
    struct _RTL_BALANCED_NODE Node;// Offset=0x20 Size=0x18
};

struct _MMINPAGE_SUPPORT// Size=0x1c0 (Id=1538)
{
    union // Size=0x10 (Id=0)
    {
    ...
    union _unnamed_1535 u2;// Offset=0x68 Size=0x30
    ...
    union _unnamed_1536 u3;// Offset=0xbc Size=0x4
    union _unnamed_1537 u1;// Offset=0xc0 Size=0x4
    union // Size=0x8 (Id=0)
    {
    ...
    void * AutoBoostLock;// Offset=0xd8 Size=0x8
