struct _unnamed_2203// Size=0x10 (Id=2203)
{
...
struct _unnamed_2204// Size=0x10 (Id=2204)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
};

struct _RTLP_RANGE_LIST_ENTRY// Size=0x38 (Id=2205)
{
    unsigned long long Start;// Offset=0x0 Size=0x8
    unsigned long long End;// Offset=0x8 Size=0x8
    union // Size=0x10 (Id=0)
    {
        struct _unnamed_2203 Allocated;// Offset=0x10 Size=0x10
        struct _unnamed_2204 Merged;// Offset=0x10 Size=0x10
    };
