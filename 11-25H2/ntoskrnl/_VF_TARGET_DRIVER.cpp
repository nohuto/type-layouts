struct _VF_AVL_TREE_NODE// Size=0x10 (Id=1943)
{
    void * p;// Offset=0x0 Size=0x8
    unsigned long long RangeSize;// Offset=0x8 Size=0x8
};

struct _VF_TARGET_ALL_SHARED_EXPORT_THUNKS// Size=0x18 (Id=2273)
{
...
struct _unnamed_1679// Size=0x4 (Id=1679)
{
...
union _unnamed_1680// Size=0x18 (Id=1680)
{
    union // Size=0x18 (Id=0)
    {
        struct _VF_TARGET_ALL_SHARED_EXPORT_THUNKS AllSharedExportThunks;// Offset=0x0 Size=0x18
        struct _unnamed_1679 Flags;// Offset=0x0 Size=0x4
    };
};

struct _VF_TARGET_DRIVER// Size=0x48 (Id=1681)
{
    struct _VF_AVL_TREE_NODE TreeNode;// Offset=0x0 Size=0x10
    union _unnamed_1680 u1;// Offset=0x10 Size=0x18
