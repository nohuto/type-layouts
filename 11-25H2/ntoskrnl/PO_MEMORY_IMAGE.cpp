...
struct _PO_HIBER_PERF// Size=0x2e8 (Id=2302)
{
...
struct PO_MEMORY_IMAGE// Size=0x4d8 (Id=1970)
{
    ...
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long Reserved:23;// Offset=0x464 Size=0x4 BitOffset=0x9 BitSize=0x17
    };
