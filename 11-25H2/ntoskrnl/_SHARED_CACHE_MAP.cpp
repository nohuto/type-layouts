...
struct _PRIVATE_CACHE_MAP_FLAGS// Size=0x4 (Id=885)
{
    union // Size=0x4 (Id=0)
    {
...
struct _PRIVATE_CACHE_MAP// Size=0x78 (Id=883)
{
    union // Size=0x2 (Id=0)
    {
...
struct _SHARED_CACHE_MAP// Size=0x268 (Id=862)
{
    short NodeTypeCode;// Offset=0x0 Size=0x2
    ...
    unsigned long Flags2;// Offset=0x9c Size=0x4
    long Status;// Offset=0xa0 Size=0x4
    struct _MBCB * Mbcb;// Offset=0xa8 Size=0x8
    void * Section;// Offset=0xb0 Size=0x8
    struct _KEVENT * CreateEvent;// Offset=0xb8 Size=0x8
    struct _KEVENT * WaitOnActiveCount;// Offset=0xc0 Size=0x8
    unsigned long PagesToWrite;// Offset=0xc8 Size=0x4
    long long BeyondLastFlush;// Offset=0xd0 Size=0x8
    union // Size=0x8 (Id=0)
    {
        struct _CACHE_MANAGER_CALLBACKS * Callbacks;// Offset=0xd8 Size=0x8
        struct _CACHE_MANAGER_CALLBACKS_EX * CallbacksEx;// Offset=0xd8 Size=0x8
    };
    void * LazyWriteContext;// Offset=0xe0 Size=0x8
    struct _LIST_ENTRY PrivateList;// Offset=0xe8 Size=0x10
    union // Size=0x10 (Id=0)
    {
        struct _LOGGED_STREAM_CALLBACK_V1 V1;// Offset=0xf8 Size=0x10
        struct _LOGGED_STREAM_CALLBACK_V2 V2;// Offset=0xf8 Size=0x8
    };
    union _LARGE_INTEGER LargestLSN;// Offset=0x108 Size=0x8
    unsigned long DirtyPageThreshold;// Offset=0x110 Size=0x4
    unsigned long LazyWritePassCount;// Offset=0x114 Size=0x4
    struct _CACHE_UNINITIALIZE_EVENT * UninitializeEvent;// Offset=0x118 Size=0x8
    struct _FAST_MUTEX BcbLock;// Offset=0x120 Size=0x38
    union _LARGE_INTEGER LastUnmapBehindOffset;// Offset=0x158 Size=0x8
    struct _KEVENT Event;// Offset=0x160 Size=0x18
    union _LARGE_INTEGER HighWaterMappingOffset;// Offset=0x178 Size=0x8
    struct _PRIVATE_CACHE_MAP PrivateCacheMap;// Offset=0x180 Size=0x78
    void * WriteBehindWorkQueueEntry;// Offset=0x1f8 Size=0x8
    struct _VOLUME_CACHE_MAP * VolumeCacheMap;// Offset=0x200 Size=0x8
    unsigned long ProcImagePathHash;// Offset=0x208 Size=0x4
    unsigned long WritesInProgress;// Offset=0x20c Size=0x4
    unsigned long AsyncReadRequestCount;// Offset=0x210 Size=0x4
    struct _CC_PARTITION * Partition;// Offset=0x218 Size=0x8
    unsigned long InternalRefCount;// Offset=0x220 Size=0x4
    unsigned long NumMappedVacb;// Offset=0x224 Size=0x4
    unsigned long NumActiveVacb;// Offset=0x228 Size=0x4
    unsigned long IdealNodeForWriteBehind;// Offset=0x22c Size=0x4
    unsigned long IdealNodeNumber;// Offset=0x230 Size=0x4
    struct _LIST_ENTRY VolSharedCacheMapLinks;// Offset=0x238 Size=0x10
    struct _LIST_ENTRY VolLoggedStreamLinks;// Offset=0x248 Size=0x10
    struct _PRIVATE_VOLUME_CACHEMAP * PrivateVolumeCacheMap;// Offset=0x258 Size=0x8
    unsigned long SectionSizeIncrement;// Offset=0x260 Size=0x4
};
