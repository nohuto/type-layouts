...
struct _unnamed_870// Size=0x30 (Id=870)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
struct _unnamed_871// Size=0x70 (Id=871)
{
    struct _SHARED_CACHE_MAP * SharedCacheMap;// Offset=0x0 Size=0x8
...
struct _unnamed_872// Size=0x40 (Id=872)
{
...
union _unnamed_873// Size=0x70 (Id=873)
{
    union // Size=0x70 (Id=0)
    {
        struct _unnamed_866 Read;// Offset=0x0 Size=0x10
        struct _unnamed_867 Write;// Offset=0x0 Size=0x8
        struct _unnamed_868 Event;// Offset=0x0 Size=0x8
        struct _unnamed_869 Notification;// Offset=0x0 Size=0x4
        struct _unnamed_870 LowPriWrite;// Offset=0x0 Size=0x30
        struct _unnamed_871 AsyncRead;// Offset=0x0 Size=0x70
        struct _unnamed_872 AsyncWriteBehind;// Offset=0x0 Size=0x40
    };
};
...
struct _WORK_QUEUE_ENTRY// Size=0xa0 (Id=875)
{
    struct _LIST_ENTRY WorkQueueLinks;// Offset=0x0 Size=0x10
    union _unnamed_873 Parameters;// Offset=0x10 Size=0x70
