...
struct _SHARED_CACHE_MAP_LIST_CURSOR// Size=0x18 (Id=884)
{
...
struct _LAZY_WRITER// Size=0x48 (Id=1090)
{
...
struct _DIRTY_PAGE_STATISTICS// Size=0x18 (Id=1184)
{
...
struct _DIRTY_PAGE_THRESHOLDS// Size=0x38 (Id=1311)
{
...
union _unnamed_1339// Size=0x8 (Id=1339)
{
...
struct _CC_PARTITION// Size=0x640 (Id=865)
{
    ...
    struct _LIST_ENTRY DelayDeleteVolumeList;// Offset=0x70 Size=0x10
    struct _CC_NUMA_NODE * NumaNodeBlock[64];// Offset=0x80 Size=0x200
    struct _LIST_ENTRY CleanSharedCacheMapList;// Offset=0x280 Size=0x10
    struct _LIST_ENTRY CleanSharedCacheMapWithLogHandleList;// Offset=0x290 Size=0x10
    struct _SHARED_CACHE_MAP_LIST_CURSOR DirtySharedCacheMapList;// Offset=0x2a0 Size=0x18
    struct _SHARED_CACHE_MAP_LIST_CURSOR LazyWriteCursor;// Offset=0x2b8 Size=0x18
    struct _LIST_ENTRY DirtySharedCacheMapWithLogHandleList;// Offset=0x2d0 Size=0x10
    ...
    struct _KTIMER PVCMDelayedDeleteTimer;// Offset=0x560 Size=0x40
    struct _KDPC PVCMDelayedDeleteTimerDpc;// Offset=0x5a0 Size=0x40
    unsigned char PVCMDelayedDeleteTimerArmed;// Offset=0x5e0 Size=0x1
    struct _WORK_QUEUE_ITEM PVCMDelayedDeleteWorkItem;// Offset=0x5e8 Size=0x20
};
