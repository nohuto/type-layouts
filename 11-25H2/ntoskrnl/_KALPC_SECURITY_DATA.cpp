...
union _unnamed_1000// Size=0x4 (Id=1000)
{
    struct _unnamed_999 s1;// Offset=0x0 Size=0x4
};

struct _KALPC_SECURITY_DATA// Size=0x70 (Id=1001)
{
    ...
    union _unnamed_1000 u1;// Offset=0x68 Size=0x4
};
