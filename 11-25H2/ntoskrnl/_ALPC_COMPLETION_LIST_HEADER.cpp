struct _unnamed_2021// Size=0x8 (Id=2021)
{
...
union _unnamed_2022// Size=0x8 (Id=2022)
{
    struct _unnamed_2021 s1;// Offset=0x0 Size=0x8
    long long Value;// Offset=0x0 Size=0x8
};

struct _ALPC_COMPLETION_LIST_STATE// Size=0x8 (Id=2023)
{
    union _unnamed_2022 u1;// Offset=0x0 Size=0x8
};

struct _RTL_SRWLOCK// Size=0x8 (Id=1640)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _ALPC_COMPLETION_LIST_HEADER// Size=0x180 (Id=1732)
{
