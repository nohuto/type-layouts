...
struct _IO_INTERRUPT_MESSAGE_INFO_ENTRY// Size=0x30 (Id=2053)
{
...
struct _IO_INTERRUPT_MESSAGE_INFO// Size=0x38 (Id=1333)
{
    unsigned char UnifiedIrql;// Offset=0x0 Size=0x1
    unsigned long MessageCount;// Offset=0x4 Size=0x4
    struct _IO_INTERRUPT_MESSAGE_INFO_ENTRY MessageInfo[1];// Offset=0x8 Size=0x30
};
