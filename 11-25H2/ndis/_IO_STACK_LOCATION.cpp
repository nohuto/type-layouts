...
struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=2113)
{
    union // Size=0x4 (Id=0)
    {
...
struct _IO_STACK_LOCATION// Size=0x48 (Id=103)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-Parameters>// Size=0x20 (Id=4608)
        {
            struct <unnamed-type-Create>// Size=0x20 (Id=4609)
            {
            ...
            struct <unnamed-type-CreatePipe>// Size=0x20 (Id=4617)
            {
                struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
                unsigned long Options;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-CreateMailslot>// Size=0x20 (Id=4625)
            {
                struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
                unsigned long Options;// Offset=0x8 Size=0x4
                unsigned short Reserved;// Offset=0x10 Size=0x2
            ...
            struct <unnamed-type-Read>// Size=0x18 (Id=4633)
            {
            ...
            struct <unnamed-type-Write>// Size=0x18 (Id=4639)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                unsigned long Key;// Offset=0x8 Size=0x4
                unsigned long Flags;// Offset=0xc Size=0x4
            ...
            struct <unnamed-type-QueryDirectory>// Size=0x20 (Id=4645)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-NotifyDirectory>// Size=0x10 (Id=4651)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-NotifyDirectoryEx>// Size=0x18 (Id=4655)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                unsigned long CompletionFilter;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-QueryFile>// Size=0x10 (Id=4660)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-SetFile>// Size=0x20 (Id=4664)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-QueryVolume>// Size=0x10 (Id=4673)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-FileSystemControl>// Size=0x20 (Id=4677)
            {
            ...
            struct <unnamed-type-LockControl>// Size=0x18 (Id=4683)
            {
            ...
            struct <unnamed-type-DeviceIoControl>// Size=0x20 (Id=4688)
            {
                unsigned long OutputBufferLength;// Offset=0x0 Size=0x4
                unsigned long InputBufferLength;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-QuerySecurity>// Size=0x10 (Id=4694)
            {
            ...
            struct <unnamed-type-SetSecurity>// Size=0x10 (Id=4698)
            {
                unsigned long SecurityInformation;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-MountVolume>// Size=0x18 (Id=4702)
            {
            ...
            struct <unnamed-type-QueryDeviceRelations>// Size=0x4 (Id=4715)
            {
            ...
            struct <unnamed-type-QueryInterface>// Size=0x20 (Id=4718)
            {
            ...
            struct <unnamed-type-DeviceCapabilities>// Size=0x8 (Id=4726)
            {
            ...
            struct <unnamed-type-FilterResourceRequirements>// Size=0x8 (Id=4730)
            {
            ...
            struct <unnamed-type-ReadWriteConfig>// Size=0x20 (Id=4734)
            {
            ...
            struct <unnamed-type-SetLock>// Size=0x1 (Id=4740)
            {
            ...
            struct <unnamed-type-QueryId>// Size=0x4 (Id=4743)
            {
            ...
            struct <unnamed-type-QueryDeviceText>// Size=0x10 (Id=4746)
            {
            ...
            struct <unnamed-type-UsageNotification>// Size=0x10 (Id=4750)
            {
            ...
            struct <unnamed-type-WaitWake>// Size=0x4 (Id=4755)
            {
            ...
            struct <unnamed-type-PowerSequence>// Size=0x8 (Id=4758)
            {
            ...
            struct <unnamed-type-Power>// Size=0x20 (Id=4762)
            {
            ...
            struct <unnamed-type-StartDevice>// Size=0x10 (Id=4769)
            {
            ...
            struct <unnamed-type-WMI>// Size=0x20 (Id=4774)
            {
            ...
            struct <unnamed-type-Others>// Size=0x20 (Id=4780)
            {
