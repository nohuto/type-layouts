union _NDIS_OID_REQUEST_RESERVED::_unnamed_1221// Size=0x18 (Id=1221)
{
    union // Size=0x18 (Id=0)
    {
        ...
        struct <unnamed-type-IovContext>// Size=0x10 (Id=9754)
        {
            struct _NDIS_VF_BLOCK * VFBlock;// Offset=0x0 Size=0x8
            struct _NDIS_VPORT_BLOCK * VPortBlock;// Offset=0x8 Size=0x8
        };
        struct _NDIS_OID_REQUEST_RESERVED::_unnamed_1225::<unnamed-type-IovContext> IovContext;// Offset=0x0 Size=0x10
        struct <unnamed-type-PMContext>// Size=0x18 (Id=9760)
        {
        ...
        struct _NDIS_OID_REQUEST_RESERVED::_unnamed_1226::<unnamed-type-PMContext> PMContext;// Offset=0x0 Size=0x18
        struct <unnamed-type-OffloadParamsContext>// Size=0x1 (Id=9767)
        {
            unsigned char SkipRegistryUpdate:1;// Offset=0x0 Size=0x1 BitOffset=0x0 BitSize=0x1
        };
        struct _NDIS_OID_REQUEST_RESERVED::_unnamed_1227::<unnamed-type-OffloadParamsContext> OffloadParamsContext;// Offset=0x0 Size=0x1
    };
};
