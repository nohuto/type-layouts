...
struct _WWAN_SINGLE_NSSAI// Size=0x10 (Id=2086)
{
...
struct _WWAN_OFFSET_SIZE_ELEMENT// Size=0x8 (Id=2136)
{
    unsigned long Offset;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
};

struct _WWAN_SET_CONTEXT_STATE// Size=0x504 (Id=1768)
{
...
struct _NDIS_WWAN_SET_CONTEXT_STATE// Size=0x508 (Id=1467)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    struct _WWAN_SET_CONTEXT_STATE SetContextState;// Offset=0x4 Size=0x504
};
