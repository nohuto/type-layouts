...
struct _NDIS_GFT_VPORT_PARAMETERS// Size=0x168 (Id=1712)
{
    ...
    union // Size=0x8 (Id=0)
    {
        void * CustomProviderReservedPointer;// Offset=0x160 Size=0x8
        unsigned long long CustomProviderReservedValue;// Offset=0x160 Size=0x8
    };
};
