struct _PCI_CAPABILITIES_HEADER// Size=0x2 (Id=1108)
{
    unsigned char CapabilityID;// Offset=0x0 Size=0x1
    unsigned char Next;// Offset=0x1 Size=0x1
};

union _PCI_MSI_MESSAGE_CONTROL// Size=0x2 (Id=1085)
{
...
struct PCI_MSI_CAPABILITY// Size=0x18 (Id=600)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-MessageAddressLower>// Size=0x4 (Id=17367)
        {
            struct _PCI_MSI_MESSAGE_ADDRESS// Size=0x4 (Id=17368)
            {
    ...
    union // Size=0xc (Id=0)
    {
        struct PCI_MSI_CAPABILITY::_unnamed_1534::<unnamed-type-Option32Bit> Option32Bit;// Offset=0x8 Size=0xc
        struct PCI_MSI_CAPABILITY::_unnamed_1535::<unnamed-type-Option64Bit> Option64Bit;// Offset=0x8 Size=0x10
    };
};
