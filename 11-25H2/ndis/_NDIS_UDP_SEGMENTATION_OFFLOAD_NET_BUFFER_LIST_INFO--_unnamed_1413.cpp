union _NDIS_UDP_SEGMENTATION_OFFLOAD_NET_BUFFER_LIST_INFO::_unnamed_1413// Size=0x8 (Id=1413)
{
    struct <unnamed-type-Transmit>// Size=0x4 (Id=11432)
    {
    ...
    struct _NDIS_UDP_SEGMENTATION_OFFLOAD_NET_BUFFER_LIST_INFO::_unnamed_1414::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x4
