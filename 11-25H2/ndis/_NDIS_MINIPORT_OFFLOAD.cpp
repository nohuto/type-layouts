...
struct _NDIS_OFFLOAD_ENCAPSULATION// Size=0x1c (Id=1692)
{
    union // Size=0x10 (Id=0)
    {
        struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
        struct <unnamed-type-IPv4>// Size=0xc (Id=9618)
        {
        ...
        struct <unnamed-type-IPv6>// Size=0xc (Id=9623)
        {
            unsigned long Enabled;// Offset=0x0 Size=0x4
            unsigned long EncapsulationType;// Offset=0x4 Size=0x4
            unsigned long HeaderSize;// Offset=0x8 Size=0x4
...
struct _NDIS_TCP_CONNECTION_OFFLOAD// Size=0x14 (Id=2096)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_TCP_CONNECTION_OFFLOAD_PARAMETERS// Size=0x3c (Id=1555)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_OFFLOAD// Size=0x548 (Id=1266)
{
