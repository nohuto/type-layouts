...
union _DMA_COMMON_BUFFER_EXTENDED_CONFIGURATION::_unnamed_899// Size=0x20 (Id=899)
{
    struct <unnamed-type-LogicalAddressLimits>// Size=0x10 (Id=3296)
    {
        union _LARGE_INTEGER MinimumAddress;// Offset=0x0 Size=0x8
        union _LARGE_INTEGER MaximumAddress;// Offset=0x8 Size=0x8
    };
    struct _DMA_COMMON_BUFFER_EXTENDED_CONFIGURATION::_unnamed_900::<unnamed-type-LogicalAddressLimits> LogicalAddressLimits;// Offset=0x0 Size=0x10
    struct <unnamed-type-SubSection>// Size=0x10 (Id=3300)
    {
        unsigned long long Offset;// Offset=0x0 Size=0x8
        unsigned long Length;// Offset=0x8 Size=0x4
    };
    struct _DMA_COMMON_BUFFER_EXTENDED_CONFIGURATION::_unnamed_901::<unnamed-type-SubSection> SubSection;// Offset=0x0 Size=0x10
