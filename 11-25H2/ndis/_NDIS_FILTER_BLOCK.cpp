...
struct _PENDING_STACK_EXPANSION_FALLBACK_WORK// Size=0x38 (Id=1373)
{
...
struct _NDIS_FILTER_PARTIAL_CHARACTERISTICS// Size=0x30 (Id=884)
{
...
struct _NBL_CONTEXT_VERIFIER_CONTEXT// Size=0x20 (Id=1509)
{
...
struct _NDIS_SRIOV_CAPABILITIES// Size=0xc (Id=838)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
...
struct _NDIS_NIC_SWITCH_CAPABILITIES// Size=0x84 (Id=797)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
...
struct _NDIS_RECEIVE_FILTER_CAPABILITIES// Size=0x54 (Id=833)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
    unsigned long Flags;// Offset=0x4 Size=0x4
...
struct _NDIS_FILTER_BLOCK// Size=0x588 (Id=516)
{
    union // Size=0xc0 (Id=0)
    {
        ...
        struct <unnamed-type-StackExpansionFallback>// Size=0x60 (Id=6670)
        {
