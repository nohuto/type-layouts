union PCI_MSI_CAPABILITY::_unnamed_1533// Size=0x10 (Id=1533)
{
    struct <unnamed-type-Option32Bit>// Size=0xc (Id=17376)
    {
    ...
    struct PCI_MSI_CAPABILITY::_unnamed_1534::<unnamed-type-Option32Bit> Option32Bit;// Offset=0x0 Size=0xc
    struct <unnamed-type-Option64Bit>// Size=0x10 (Id=17382)
    {
    ...
    struct PCI_MSI_CAPABILITY::_unnamed_1535::<unnamed-type-Option64Bit> Option64Bit;// Offset=0x0 Size=0x10
};
