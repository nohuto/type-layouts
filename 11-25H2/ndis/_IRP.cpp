...
struct _IO_STATUS_BLOCK// Size=0x10 (Id=91)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=1190)
{
...
struct _KAPC// Size=0x58 (Id=1129)
{
...
struct _IRP// Size=0xd0 (Id=100)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=4923)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=4942)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=4943)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=4956)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=4957)
            {
