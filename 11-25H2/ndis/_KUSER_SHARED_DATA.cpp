struct _KSYSTEM_TIME// Size=0xc (Id=1032)
{
...
struct _XSTATE_FEATURE// Size=0x8 (Id=1932)
{
    unsigned long Offset;// Offset=0x0 Size=0x4
    unsigned long Size;// Offset=0x4 Size=0x4
};

struct _XSTATE_CONFIGURATION// Size=0x348 (Id=1052)
{
...
struct _KUSER_SHARED_DATA// Size=0xa80 (Id=34)
{
    ...
    unsigned short CyclesPerYield;// Offset=0x2d6 Size=0x2
    ...
    unsigned long Reserved2;// Offset=0x30c Size=0x4
    unsigned long long FullNumberOfPhysicalPages;// Offset=0x310 Size=0x8
    unsigned long long SystemCallPad[1];// Offset=0x318 Size=0x8
    union // Size=0x328 (Id=0)
    {
    ...
    unsigned char QpcReserved;// Offset=0x3c7 Size=0x1
    ...
    struct _XSTATE_CONFIGURATION XState;// Offset=0x3d8 Size=0x348
    struct _KSYSTEM_TIME FeatureConfigurationChangeStamp;// Offset=0x720 Size=0xc
    unsigned long Spare;// Offset=0x72c Size=0x4
    unsigned long long UserPointerAuthMask;// Offset=0x730 Size=0x8
    unsigned long Reserved10[210];// Offset=0x738 Size=0x348
};
