...
struct _WAIT_CONTEXT_BLOCK// Size=0x48 (Id=1001)
{
...
struct _KDEVICE_QUEUE// Size=0x28 (Id=1077)
{
...
struct _DEVICE_OBJECT// Size=0x150 (Id=105)
{
    union // Size=0x4d (Id=0)
    {
        ...
        union <unnamed-type-Queue>// Size=0x48 (Id=2907)
        {
