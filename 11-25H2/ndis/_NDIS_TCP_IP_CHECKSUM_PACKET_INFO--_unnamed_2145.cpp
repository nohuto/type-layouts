union _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_unnamed_2145// Size=0x4 (Id=2145)
{
    struct <unnamed-type-Transmit>// Size=0x4 (Id=11286)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_unnamed_2146::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x4
    struct <unnamed-type-Receive>// Size=0x4 (Id=11293)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_unnamed_2147::<unnamed-type-Receive> Receive;// Offset=0x0 Size=0x4
