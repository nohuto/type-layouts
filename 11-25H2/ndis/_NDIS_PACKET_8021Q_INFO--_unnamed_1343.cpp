union _NDIS_PACKET_8021Q_INFO::_unnamed_1343// Size=0x8 (Id=1343)
{
    struct <unnamed-type-TagHeader>// Size=0x4 (Id=9838)
    {
    ...
    struct _NDIS_PACKET_8021Q_INFO::_unnamed_1344::<unnamed-type-TagHeader> TagHeader;// Offset=0x0 Size=0x4
