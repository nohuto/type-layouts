...
union _unnamed_543// Size=0x1 (Id=543)
{
    unsigned char AsUchar;// Offset=0x0 Size=0x1
    struct _unnamed_541 Bulk;// Offset=0x0 Size=0x1
    struct _unnamed_542 Isochronous;// Offset=0x0 Size=0x1
};

struct _USB_SUPERSPEED_ENDPOINT_COMPANION_DESCRIPTOR// Size=0x6 (Id=544)
{
    ...
    union _unnamed_543 bmAttributes;// Offset=0x3 Size=0x1
