union _PDO_FLAGS// Size=0x4 (Id=770)
{
...
struct _ISM_STATE_LOG// Size=0x8 (Id=644)
{
...
struct _ISM_CONTEXT// Size=0xc0 (Id=517)
{
...
struct _D3COLD_SUPPORT_INTERFACE// Size=0x48 (Id=665)
{
...
struct _IO_REMOVE_LOCK_COMMON_BLOCK// Size=0x20 (Id=615)
{
...
struct _IO_REMOVE_LOCK// Size=0x20 (Id=502)
{
    struct _IO_REMOVE_LOCK_COMMON_BLOCK Common;// Offset=0x0 Size=0x20
};

struct _DEVICE_RESET_INTERFACE_STANDARD// Size=0x50 (Id=555)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
struct _HUB_PDO_CONTEXT// Size=0x228 (Id=427)
{
