union _unnamed_809// Size=0x4 (Id=809)
{
...
struct _USB_DEVICE_CAPABILITY_POWER_DELIVERY_DESCRIPTOR// Size=0x12 (Id=810)
{
    ...
    union _unnamed_809 bmAttributes;// Offset=0x4 Size=0x4
