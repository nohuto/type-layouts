union _unnamed_689// Size=0x2 (Id=689)
{
...
struct _USB_DEVICE_CAPABILITY_PD_CONSUMER_PORT_DESCRIPTOR// Size=0x18 (Id=690)
{
    ...
    union _unnamed_689 bmCapabilities;// Offset=0x4 Size=0x2
