union _unnamed_624// Size=0x4 (Id=624)
{
...
struct _USB_DEVICE_CAPABILITY_USB20_EXTENSION_DESCRIPTOR// Size=0x7 (Id=625)
{
    ...
    union _unnamed_624 bmAttributes;// Offset=0x3 Size=0x4
};
