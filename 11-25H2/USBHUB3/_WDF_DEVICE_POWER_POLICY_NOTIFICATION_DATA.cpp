...
struct _unnamed_527// Size=0x4 (Id=527)
{
    enum _WDF_DEVICE_POWER_POLICY_STATE CurrentState;// Offset=0x0 Size=0x4
};
...
{
    struct _unnamed_526 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_527 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_526 LeaveState;// Offset=0x0 Size=0x8
};
...
struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=207)
{
    ...
    union _unnamed_528 Data;// Offset=0x4 Size=0x8
};
