union _HUB_FLAGS// Size=0x4 (Id=819)
{
...
union _HUB_FLAGS_EXT// Size=0x4 (Id=762)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_20_PORT_STATUS// Size=0x2 (Id=847)
{
...
union _USB_30_PORT_STATUS// Size=0x2 (Id=834)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_PORT_STATUS// Size=0x2 (Id=697)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
...
union _USB_20_PORT_CHANGE// Size=0x2 (Id=827)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_30_PORT_CHANGE// Size=0x2 (Id=812)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_PORT_CHANGE// Size=0x2 (Id=765)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
...
union _USB_PORT_STATUS_AND_CHANGE// Size=0x4 (Id=747)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
...
struct _HUBUCX_ROOTHUB_INFO// Size=0x18 (Id=857)
{
...
struct _HUB_INFORMATION// Size=0x80 (Id=721)
{
...
struct _UCX_CONTROLLER_PCI_INFORMATION// Size=0x18 (Id=824)
{
...
struct _UCX_CONTROLLER_ACPI_INFORMATION// Size=0xf (Id=483)
{
...
struct _UCX_CONTROLLER_MAUSB_INFORMATION// Size=0x18 (Id=870)
{
...
struct _UCX_CONTROLLER_INFO// Size=0x20 (Id=729)
{
...
struct _USB_TOPOLOGY_ADDRESS// Size=0x20 (Id=756)
{
...
struct _HUB_PARENT_INTERFACE// Size=0x90 (Id=692)
{
...
struct _HUB_CONTROLLERSTACK_INTERFACE// Size=0x100 (Id=422)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
struct _DEVICE_CAPABILITIES// Size=0x40 (Id=524)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    struct // Size=0x4 (Id=0)
...
union _CONTROLLER_FLAGS// Size=0x4 (Id=764)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_HUB_STATUS// Size=0x2 (Id=693)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
union _USB_DEVICE_STATUS// Size=0x2 (Id=504)
{
    unsigned short AsUshort16;// Offset=0x0 Size=0x2
    struct // Size=0x2 (Id=0)
    {
...
struct _URB_BULK_OR_INTERRUPT_TRANSFER// Size=0x80 (Id=753)
{
    struct _URB_HEADER Hdr;// Offset=0x0 Size=0x18
    void * PipeHandle;// Offset=0x18 Size=0x8
    unsigned long TransferFlags;// Offset=0x20 Size=0x4
...
struct _HUB_INTERRUPT_REQUEST// Size=0xb8 (Id=686)
{
    struct WDFREQUEST__ * WdfRequest;// Offset=0x0 Size=0x8
...
struct _USB_HUB_DESCRIPTOR// Size=0x47 (Id=788)
{
...
struct _USB_30_HUB_DESCRIPTOR// Size=0xc (Id=804)
{
...
union _HUB_DESCRIPTOR// Size=0x47 (Id=734)
{
...
union _PARENT_HUB_FLAGS// Size=0x4 (Id=798)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _HUB_INFO_FROM_PARENT// Size=0x48 (Id=493)
{
...
union _OPCODE_STATUS// Size=0x4 (Id=706)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _DROM_READ_METADATA// Size=0x4 (Id=786)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _HUB_FDO_CONTEXT// Size=0xae8 (Id=413)
{
    ...
    struct _HUB_CONTROLLERSTACK_INTERFACE HubControllerStackInterface;// Offset=0x160 Size=0x100
    struct _USB_BUS_INTERFACE_USBDI_V3 UsbdBusInterface;// Offset=0x260 Size=0x60
    struct _DEVICE_CAPABILITIES DeviceCapabilities;// Offset=0x2c0 Size=0x40
    union _CONTROLLER_FLAGS ControllerFlags;// Offset=0x300 Size=0x4
    struct _GUID ControllerSessionActivityId;// Offset=0x304 Size=0x10
    union _USB_HUB_STATUS_AND_CHANGE HubStatusAndChange;// Offset=0x314 Size=0x4
    union _USB_HUB_STATUS_AND_CHANGE OldHubStatusAndChange;// Offset=0x318 Size=0x4
    enum _USB_HUB_FEATURE_SELECTOR CurrentFeatureSelector;// Offset=0x31c Size=0x4
    enum _HSM_EVENT CurrentHubChangeEvent;// Offset=0x320 Size=0x4
    union _USB_DEVICE_STATUS HubDeviceStatus;// Offset=0x324 Size=0x2
    struct _CONTROL_REQUEST HubControlRequest;// Offset=0x328 Size=0xa8
    struct _HUB_INTERRUPT_REQUEST StatusChangeInterruptRequest;// Offset=0x3d0 Size=0xb8
    struct _KEVENT PnPPowerEvent;// Offset=0x488 Size=0x18
    long PnPPowerStatus;// Offset=0x4a0 Size=0x4
    union _HUB_DESCRIPTOR HubDescriptor;// Offset=0x4a4 Size=0x47
    struct _USB_CONFIGURATION_DESCRIPTOR * ConfigurationDescriptor;// Offset=0x4f0 Size=0x8
    struct _SM_CONTEXT HsmContext;// Offset=0x4f8 Size=0x420
    struct _HSM_MUX_CONTEXT MuxContext;// Offset=0x918 Size=0x50
    struct WDFQUEUE__ * DeviceControlQueue;// Offset=0x968 Size=0x8
    struct _USB_RESET_FLAGS ResetFlags;// Offset=0x970 Size=0x4
    struct _GUID CurrentActivityId;// Offset=0x974 Size=0x10
    struct _LIST_ENTRY ListEntry;// Offset=0x988 Size=0x10
    struct _HUB_INFO_FROM_PARENT HubInfoFromParent;// Offset=0x998 Size=0x48
    struct RECORDER_LOG__ * IfrLog;// Offset=0x9e0 Size=0x8
    struct WDFREQUEST__ * PdoGetPortStatusRequest;// Offset=0x9e8 Size=0x8
    struct WDFWMIINSTANCE__ * WmiNotificationHandle;// Offset=0x9f0 Size=0x8
    struct _UNICODE_STRING HubSymbolicLinkNameUnicode;// Offset=0x9f8 Size=0x10
    void * SelectiveSuspendSetting;// Offset=0xa08 Size=0x8
    void * SelectiveSuspendTimeoutPowerSetting;// Offset=0xa10 Size=0x8
    unsigned long CurrentIdleTimeout;// Offset=0xa18 Size=0x4
    unsigned long MinimumIdleTimeout;// Offset=0xa1c Size=0x4
    struct _PORT_CONTEXT * GetPortStatusTargetPortContext;// Offset=0xa20 Size=0x8
    unsigned long HardwareVerifierFlags;// Offset=0xa28 Size=0x4
    unsigned long HubFailureMsgId;// Offset=0xa2c Size=0x4
    enum _WDF_POWER_DEVICE_STATE CurrentWdfPowerDeviceState;// Offset=0xa30 Size=0x4
    unsigned short OldwTotalLength;// Offset=0xa34 Size=0x2
    struct POHANDLE__ * PoHandle;// Offset=0xa38 Size=0x8
    struct SS_COMPONENT__ * SleepstudySelectiveSuspendUnavailable;// Offset=0xa40 Size=0x8
    struct SS_COMPONENT__ * SleepstudySelectiveSuspendDisabled;// Offset=0xa48 Size=0x8
    struct SS_COMPONENT__ * SleepstudySelectiveSuspendDisabledByUser;// Offset=0xa50 Size=0x8
    void * IdleResiliencyHandle;// Offset=0xa58 Size=0x8
    unsigned long IdleResiliencyState;// Offset=0xa60 Size=0x4
    struct WDFDEVICE__ * FirmwareUpdateDevice;// Offset=0xa68 Size=0x8
    struct _GENERIC_DROM_HEADER Usb4DromHeader;// Offset=0xa70 Size=0x10
    unsigned long Usb4DromSizeInDwords;// Offset=0xa80 Size=0x4
    unsigned long Usb4DromSize;// Offset=0xa84 Size=0x4
    unsigned char * Usb4DromBuffer;// Offset=0xa88 Size=0x8
    unsigned long Usb4DromReadIndex;// Offset=0xa90 Size=0x4
    unsigned long GRMailboxIndex;// Offset=0xa94 Size=0x4
    union _OPCODE_STATUS GRMailboxOpcodeStatus;// Offset=0xa98 Size=0x4
    union _DROM_READ_METADATA GRMailBoxMetaData;// Offset=0xa9c Size=0x4
    long long GRMailboxReadStatusStartTime;// Offset=0xaa0 Size=0x8
    unsigned short FwUpdateIdVendor;// Offset=0xaa8 Size=0x2
    unsigned short FwUpdateIdProduct;// Offset=0xaaa Size=0x2
    unsigned short FwUpdateBcdProductFWRevision;// Offset=0xaac Size=0x2
    unsigned short FwUpdateProductHWRevision;// Offset=0xaae Size=0x2
    unsigned char FwUpdateValid;// Offset=0xab0 Size=0x1
    struct WDFCOLLECTION__ * Usb4HostCollection;// Offset=0xab8 Size=0x8
    struct WDFWAITLOCK__ * Usb4HostCollectionLock;// Offset=0xac0 Size=0x8
    void * PnpInterfaceNotificationHandle;// Offset=0xac8 Size=0x8
    struct WDFSTRING__ * Usb4HostNameString;// Offset=0xad0 Size=0x8
    void * LowPowerEpochHandle;// Offset=0xad8 Size=0x8
    unsigned long LowPowerEpochState;// Offset=0xae0 Size=0x4
    unsigned char PowerReferenceReleasedForLPE;// Offset=0xae4 Size=0x1
};
