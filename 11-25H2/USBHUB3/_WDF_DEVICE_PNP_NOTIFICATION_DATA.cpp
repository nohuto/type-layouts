...
struct _unnamed_536// Size=0x8 (Id=536)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
};

struct _unnamed_537// Size=0x4 (Id=537)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _unnamed_538// Size=0x8 (Id=538)
{
    struct _unnamed_536 EnterState;// Offset=0x0 Size=0x8
    struct _unnamed_537 PostProcessState;// Offset=0x0 Size=0x4
    struct _unnamed_536 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=205)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _unnamed_538 Data;// Offset=0x4 Size=0x8
};
