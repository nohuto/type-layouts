...
union _USB_PORT_EXT_STATUS// Size=0x4 (Id=838)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
...
union _USB_PORT_EXT_STATUS_AND_CHANGE// Size=0x8 (Id=755)
{
...
union _PORT_FLAGS// Size=0x4 (Id=787)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long PortFlagU1U2DisabledByAcpi:1;// Offset=0x0 Size=0x4 BitOffset=0xa BitSize=0x1
        unsigned long PortFlagUsb4Tunnel:1;// Offset=0x0 Size=0x4 BitOffset=0xb BitSize=0x1
        unsigned long PortFlagTypeC:1;// Offset=0x0 Size=0x4 BitOffset=0xc BitSize=0x1
    };
};
...
struct _PORT_INFORMATION// Size=0x28 (Id=733)
{
...
union _PORT_MUX_FLAGS// Size=0x4 (Id=748)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _PSM_MUX_CONTEXT// Size=0x18 (Id=650)
{
...
union _USB_PORT_FLAGS// Size=0x4 (Id=554)
{
    unsigned long AsUlong32;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
        ...
        unsigned long ExtendedEnumeration:1;// Offset=0x0 Size=0x4 BitOffset=0x7 BitSize=0x1
    };
};

union _ACPI_UPC_USB_C_PORT_CAPABILITIES// Size=0x4 (Id=807)
{
...
struct _ACPI_UPC_PACKAGE// Size=0xc (Id=704)
{
...
struct _ACPI_PLD_BUFFER// Size=0x10 (Id=326)
{
...
struct _CONNECTOR_ID// Size=0x38 (Id=551)
{
...
struct _PORT_CONTEXT// Size=0x5d8 (Id=410)
{
    ...
    struct WDFSTRING__ * Usb4HostNameString;// Offset=0x5b8 Size=0x8
    unsigned char PortPLDRTestTriggerEnabled;// Offset=0x5c0 Size=0x1
    unsigned short PortPLDRRecoveryAttempts;// Offset=0x5c2 Size=0x2
    unsigned char PortPLDRRecoveryFailed;// Offset=0x5c4 Size=0x1
    struct _GUID PortPLDRRecoveryActivityId;// Offset=0x5c8 Size=0x10
};
