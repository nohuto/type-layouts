...
struct _anonymous_425// Size=0x8 (Id=425)
{
...
union _anonymous_427// Size=0x8 (Id=427)
{
    struct _anonymous_425 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_426 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_425 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_POLICY_NOTIFICATION_DATA// Size=0xc (Id=428)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_427 Data;// Offset=0x4 Size=0x8
};
