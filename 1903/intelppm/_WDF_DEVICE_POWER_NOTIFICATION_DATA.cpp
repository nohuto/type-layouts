...
struct _anonymous_452// Size=0x8 (Id=452)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_POWER_STATE NewState;// Offset=0x4 Size=0x4
};

struct _anonymous_453// Size=0x4 (Id=453)
{
    enum _WDF_DEVICE_POWER_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _anonymous_454// Size=0x8 (Id=454)
{
    struct _anonymous_452 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_453 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_452 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_POWER_NOTIFICATION_DATA// Size=0xc (Id=243)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_454 Data;// Offset=0x4 Size=0x8
};
