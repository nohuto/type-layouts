...
struct _anonymous_82// Size=0x18 (Id=82)
{
...
struct _anonymous_85// Size=0x10 (Id=85)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_87// Size=0x18 (Id=87)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _anonymous_88// Size=0x10 (Id=88)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
};

struct _anonymous_89// Size=0x20 (Id=89)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
...
struct _anonymous_92// Size=0x20 (Id=92)
{
...
struct _anonymous_93// Size=0x18 (Id=93)
{
...
struct _anonymous_94// Size=0x20 (Id=94)
{
    unsigned long OutputBufferLength;// Offset=0x0 Size=0x4
    unsigned long InputBufferLength;// Offset=0x8 Size=0x4
...
struct _anonymous_95// Size=0x10 (Id=95)
{
...
struct _anonymous_99// Size=0x8 (Id=99)
{
...
struct _anonymous_101// Size=0x4 (Id=101)
{
    enum _DEVICE_RELATION_TYPE Type;// Offset=0x0 Size=0x4
};

struct _anonymous_103// Size=0x20 (Id=103)
{
...
struct _anonymous_104// Size=0x8 (Id=104)
{
...
struct _anonymous_106// Size=0x20 (Id=106)
{
...
struct _anonymous_107// Size=0x1 (Id=107)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _anonymous_109// Size=0x4 (Id=109)
{
    enum BUS_QUERY_ID_TYPE IdType;// Offset=0x0 Size=0x4
};

struct _anonymous_111// Size=0x10 (Id=111)
{
...
struct _anonymous_113// Size=0x10 (Id=113)
{
...
struct _anonymous_116// Size=0x8 (Id=116)
{
    struct _POWER_SEQUENCE * PowerSequence;// Offset=0x0 Size=0x8
};

struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=518)
{
    union // Size=0x4 (Id=0)
    {
...
struct _anonymous_121// Size=0x20 (Id=121)
{
...
union _anonymous_123// Size=0x20 (Id=123)
{
    struct _anonymous_79 Create;// Offset=0x0 Size=0x20
    struct _anonymous_80 CreatePipe;// Offset=0x0 Size=0x20
    struct _anonymous_81 CreateMailslot;// Offset=0x0 Size=0x20
    struct _anonymous_82 Read;// Offset=0x0 Size=0x18
    struct _anonymous_82 Write;// Offset=0x0 Size=0x18
    struct _anonymous_84 QueryDirectory;// Offset=0x0 Size=0x20
    struct _anonymous_85 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _anonymous_87 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _anonymous_88 QueryFile;// Offset=0x0 Size=0x10
    struct _anonymous_89 SetFile;// Offset=0x0 Size=0x20
    struct _anonymous_91 QueryVolume;// Offset=0x0 Size=0x10
    struct _anonymous_92 FileSystemControl;// Offset=0x0 Size=0x20
    struct _anonymous_93 LockControl;// Offset=0x0 Size=0x18
    struct _anonymous_94 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _anonymous_95 QuerySecurity;// Offset=0x0 Size=0x10
    struct _anonymous_96 SetSecurity;// Offset=0x0 Size=0x10
    struct _anonymous_97 MountVolume;// Offset=0x0 Size=0x10
    struct _anonymous_97 VerifyVolume;// Offset=0x0 Size=0x10
    struct _anonymous_99 Scsi;// Offset=0x0 Size=0x8
    struct _anonymous_101 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _anonymous_103 QueryInterface;// Offset=0x0 Size=0x20
    struct _anonymous_104 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _anonymous_105 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _anonymous_106 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _anonymous_107 SetLock;// Offset=0x0 Size=0x1
    struct _anonymous_109 QueryId;// Offset=0x0 Size=0x4
    struct _anonymous_111 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _anonymous_113 UsageNotification;// Offset=0x0 Size=0x10
    struct _anonymous_115 WaitWake;// Offset=0x0 Size=0x4
    struct _anonymous_116 PowerSequence;// Offset=0x0 Size=0x8
    struct _anonymous_119 Power;// Offset=0x0 Size=0x20
    struct _anonymous_120 StartDevice;// Offset=0x0 Size=0x10
    struct _anonymous_121 WMI;// Offset=0x0 Size=0x20
    struct _anonymous_122 Others;// Offset=0x0 Size=0x20
};
...
struct _IO_STACK_LOCATION// Size=0x48 (Id=124)
{
    ...
    union _anonymous_123 Parameters;// Offset=0x8 Size=0x20
