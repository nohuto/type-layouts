...
struct _anonymous_270// Size=0x18 (Id=270)
{
...
struct _anonymous_271// Size=0x8 (Id=271)
{
...
struct _anonymous_274// Size=0x10 (Id=274)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_275// Size=0xc (Id=275)
{
...
union _anonymous_280// Size=0x18 (Id=280)
{
    union // Size=0x18 (Id=0)
    {
        struct _anonymous_268 Port;// Offset=0x0 Size=0x18
        struct _anonymous_268 Memory;// Offset=0x0 Size=0x18
        struct _anonymous_270 Interrupt;// Offset=0x0 Size=0x18
        struct _anonymous_271 Dma;// Offset=0x0 Size=0x8
        struct _anonymous_272 DmaV3;// Offset=0x0 Size=0x10
        struct _anonymous_268 Generic;// Offset=0x0 Size=0x18
        struct _anonymous_273 DevicePrivate;// Offset=0x0 Size=0xc
        struct _anonymous_274 BusNumber;// Offset=0x0 Size=0x10
        struct _anonymous_275 ConfigData;// Offset=0x0 Size=0xc
        struct _anonymous_276 Memory40;// Offset=0x0 Size=0x18
        struct _anonymous_277 Memory48;// Offset=0x0 Size=0x18
        struct _anonymous_278 Memory64;// Offset=0x0 Size=0x18
        struct _anonymous_279 Connection;// Offset=0x0 Size=0xc
    };
};

struct _IO_RESOURCE_DESCRIPTOR// Size=0x20 (Id=281)
{
    ...
    union _anonymous_280 u;// Offset=0x8 Size=0x18
};

struct _IO_RESOURCE_LIST// Size=0x28 (Id=674)
{
...
struct _IO_RESOURCE_REQUIREMENTS_LIST// Size=0x48 (Id=529)
{
