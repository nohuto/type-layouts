...
struct _IO_STACK_LOCATION// Size=0x48 (Id=491)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-Parameters>// Size=0x20 (Id=11479)
        {
            struct <unnamed-type-Create>// Size=0x20 (Id=11480)
            {
            ...
            struct <unnamed-type-CreatePipe>// Size=0x20 (Id=11487)
            {
                struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
                unsigned long Options;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-CreateMailslot>// Size=0x20 (Id=11494)
            {
                struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
                unsigned long Options;// Offset=0x8 Size=0x4
                unsigned short Reserved;// Offset=0x10 Size=0x2
            ...
            struct <unnamed-type-Read>// Size=0x18 (Id=11501)
            {
            ...
            struct <unnamed-type-Write>// Size=0x18 (Id=11507)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                unsigned long Key;// Offset=0x8 Size=0x4
                unsigned long Flags;// Offset=0xc Size=0x4
            ...
            struct <unnamed-type-QueryDirectory>// Size=0x20 (Id=11513)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-NotifyDirectory>// Size=0x10 (Id=11519)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-NotifyDirectoryEx>// Size=0x18 (Id=11523)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                unsigned long CompletionFilter;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-QueryFile>// Size=0x10 (Id=11528)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-SetFile>// Size=0x20 (Id=11532)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-QueryEa>// Size=0x20 (Id=11541)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-SetVolume>// Size=0x10 (Id=11554)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                enum _FSINFOCLASS FsInformationClass;// Offset=0x8 Size=0x4
            };
            struct _IO_STACK_LOCATION::<unnamed-type-Parameters>::<unnamed-type-SetVolume> SetVolume;// Offset=0x0 Size=0x10
            struct <unnamed-type-FileSystemControl>// Size=0x20 (Id=11558)
            {
            ...
            struct <unnamed-type-LockControl>// Size=0x18 (Id=11564)
            {
            ...
            struct <unnamed-type-DeviceIoControl>// Size=0x20 (Id=11569)
            {
                unsigned long OutputBufferLength;// Offset=0x0 Size=0x4
                unsigned long InputBufferLength;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-QuerySecurity>// Size=0x10 (Id=11575)
            {
            ...
            struct <unnamed-type-SetSecurity>// Size=0x10 (Id=11579)
            {
                unsigned long SecurityInformation;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-MountVolume>// Size=0x10 (Id=11583)
            {
            ...
            struct <unnamed-type-QueryQuota>// Size=0x20 (Id=11594)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-SetQuota>// Size=0x4 (Id=11600)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            };
            struct _IO_STACK_LOCATION::<unnamed-type-Parameters>::<unnamed-type-SetQuota> SetQuota;// Offset=0x0 Size=0x4
            struct <unnamed-type-QueryDeviceRelations>// Size=0x4 (Id=11603)
            {
            ...
            struct <unnamed-type-QueryInterface>// Size=0x20 (Id=11606)
            {
            ...
            struct <unnamed-type-DeviceCapabilities>// Size=0x8 (Id=11613)
            {
            ...
            struct <unnamed-type-FilterResourceRequirements>// Size=0x8 (Id=11616)
            {
            ...
            struct <unnamed-type-ReadWriteConfig>// Size=0x20 (Id=11619)
            {
            ...
            struct <unnamed-type-SetLock>// Size=0x1 (Id=11625)
            {
            ...
            struct <unnamed-type-QueryId>// Size=0x4 (Id=11628)
            {
            ...
            struct <unnamed-type-QueryDeviceText>// Size=0x10 (Id=11631)
            {
            ...
            struct <unnamed-type-UsageNotification>// Size=0x10 (Id=11635)
            {
            ...
            struct <unnamed-type-WaitWake>// Size=0x4 (Id=11640)
            {
            ...
            struct <unnamed-type-PowerSequence>// Size=0x8 (Id=11643)
            {
            ...
            struct <unnamed-type-Power>// Size=0x20 (Id=11646)
            {
            ...
            struct <unnamed-type-StartDevice>// Size=0x10 (Id=11653)
            {
            ...
            struct <unnamed-type-WMI>// Size=0x20 (Id=11657)
            {
            ...
            struct <unnamed-type-Others>// Size=0x20 (Id=11663)
            {
