struct _USB_DEVICE_CAPABILITY_POWER_DELIVERY_DESCRIPTOR// Size=0x12 (Id=4325)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-bmAttributes>// Size=0x4 (Id=18141)
        {
    ...
    union _USB_DEVICE_CAPABILITY_POWER_DELIVERY_DESCRIPTOR::<unnamed-type-bmAttributes> bmAttributes;// Offset=0x4 Size=0x4
