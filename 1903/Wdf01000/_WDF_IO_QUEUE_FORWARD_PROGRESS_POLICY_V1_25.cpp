...
struct _WDF_IO_FORWARD_PROGRESS_RESERVED_POLICY_SETTINGS_V1_25// Size=0x8 (Id=2025)
{
    union // Size=0x8 (Id=0)
    {
        union <unnamed-type-Policy>// Size=0x8 (Id=22377)
        {
...
struct _WDF_IO_QUEUE_FORWARD_PROGRESS_POLICY_V1_25// Size=0x28 (Id=2129)
{
    ...
    struct _WDF_IO_FORWARD_PROGRESS_RESERVED_POLICY_SETTINGS_V1_25 ForwardProgressReservePolicySettings;// Offset=0x10 Size=0x8
