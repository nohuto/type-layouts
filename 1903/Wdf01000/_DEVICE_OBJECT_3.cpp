...
struct _WAIT_CONTEXT_BLOCK// Size=0x48 (Id=165)
{
...
union _anonymous_184// Size=0x48 (Id=184)
{
    struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
    struct _WAIT_CONTEXT_BLOCK Wcb;// Offset=0x0 Size=0x48
};

struct _KDEVICE_QUEUE// Size=0x28 (Id=114)
{
...
struct _KEVENT// Size=0x18 (Id=613)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
};

struct _DEVICE_OBJECT// Size=0x150 (Id=736)
{
    union // Size=0x4d (Id=0)
    {
        ...
        union <unnamed-type-Queue>// Size=0x48 (Id=8373)
        {
            struct _LIST_ENTRY ListEntry;// Offset=0x0 Size=0x10
            struct _WAIT_CONTEXT_BLOCK Wcb;// Offset=0x0 Size=0x48
        };
    ...
    void _DEVICE_OBJECT(struct _DEVICE_OBJECT * );
    void _DEVICE_OBJECT(struct _DEVICE_OBJECT & );
    struct _DEVICE_OBJECT & operator=(struct _DEVICE_OBJECT * );
    struct _DEVICE_OBJECT & operator=(struct _DEVICE_OBJECT & );
};
