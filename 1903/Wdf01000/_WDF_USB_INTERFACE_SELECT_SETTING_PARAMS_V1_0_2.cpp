...
struct _WDF_USB_INTERFACE_SELECT_SETTING_PARAMS_V1_0// Size=0x10 (Id=2912)
{
    union // Size=0x8 (Id=0)
    {
        unsigned long Size;// Offset=0x0 Size=0x4
        enum _WdfUsbTargetDeviceSelectSettingType Type;// Offset=0x4 Size=0x4
        union <unnamed-type-Types>// Size=0x8 (Id=26885)
        {
            struct <unnamed-type-Descriptor>// Size=0x8 (Id=26886)
            {
            ...
            struct <unnamed-type-Interface>// Size=0x1 (Id=26889)
            {
            ...
            struct <unnamed-type-Urb>// Size=0x8 (Id=26892)
            {
