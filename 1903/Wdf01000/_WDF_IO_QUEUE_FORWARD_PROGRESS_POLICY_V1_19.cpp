...
struct _WDF_IO_FORWARD_PROGRESS_RESERVED_POLICY_SETTINGS_V1_19// Size=0x8 (Id=2889)
{
    union // Size=0x8 (Id=0)
    {
        union <unnamed-type-Policy>// Size=0x8 (Id=22362)
        {
            struct <unnamed-type-ExaminePolicy>// Size=0x8 (Id=22363)
            {
...
struct _WDF_IO_QUEUE_FORWARD_PROGRESS_POLICY_V1_19// Size=0x28 (Id=2735)
{
    ...
    struct _WDF_IO_FORWARD_PROGRESS_RESERVED_POLICY_SETTINGS_V1_19 ForwardProgressReservePolicySettings;// Offset=0x10 Size=0x8
