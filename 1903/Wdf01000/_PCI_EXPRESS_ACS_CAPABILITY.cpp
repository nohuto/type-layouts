...
union _PCI_EXPRESS_ACS_CAPABILITY_REGISTER// Size=0x2 (Id=2444)
{
    struct // Size=0x2 (Id=0)
    {
...
union _PCI_EXPRESS_ACS_CONTROL// Size=0x2 (Id=1783)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short SourceValidation:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _PCI_EXPRESS_ACS_CAPABILITY// Size=0xc (Id=4615)
{
