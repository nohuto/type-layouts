...
struct _WDF_IO_FORWARD_PROGRESS_RESERVED_POLICY_SETTINGS_V1_27// Size=0x8 (Id=1983)
{
    union // Size=0x8 (Id=0)
    {
        union <unnamed-type-Policy>// Size=0x8 (Id=22382)
        {
            struct <unnamed-type-ExaminePolicy>// Size=0x8 (Id=22383)
            {
                enum _WDF_IO_FORWARD_PROGRESS_ACTION  ( * EvtIoWdmIrpForForwardProgress)(struct WDFQUEUE__ * ,struct _IRP * );// Offset=0x0 Size=0x8
            };
            struct _WDF_IO_FORWARD_PROGRESS_RESERVED_POLICY_SETTINGS_V1_27::<unnamed-type-Policy>::<unnamed-type-ExaminePolicy> ExaminePolicy;// Offset=0x0 Size=0x8
        };
        union _WDF_IO_FORWARD_PROGRESS_RESERVED_POLICY_SETTINGS_V1_27::<unnamed-type-Policy> Policy;// Offset=0x0 Size=0x8
    };
};

struct _WDF_IO_QUEUE_FORWARD_PROGRESS_POLICY_V1_27// Size=0x28 (Id=1649)
{
    ...
    struct _WDF_IO_FORWARD_PROGRESS_RESERVED_POLICY_SETTINGS_V1_27 ForwardProgressReservePolicySettings;// Offset=0x10 Size=0x8
