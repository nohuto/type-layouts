...
struct _WHEA_RECOVERY_CONTEXT// Size=0x20 (Id=3709)
{
    union // Size=0x10 (Id=0)
    {
        struct _WHEA_RECOVERY_CONTEXT::_anonymous_3711::<unnamed-type-MemoryError> MemoryError;// Offset=0x0 Size=0x10
        struct _WHEA_RECOVERY_CONTEXT::_anonymous_3710::<unnamed-type-PmemError> PmemError;// Offset=0x0 Size=0x8
