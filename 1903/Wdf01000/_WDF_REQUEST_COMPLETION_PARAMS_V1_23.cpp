...
struct _WDF_REQUEST_COMPLETION_PARAMS_V1_23// Size=0x48 (Id=3345)
{
    union // Size=0x18 (Id=0)
    {
        ...
        union <unnamed-type-Parameters>// Size=0x30 (Id=24855)
        {
            struct <unnamed-type-Write>// Size=0x18 (Id=24856)
            {
            ...
            struct <unnamed-type-Read>// Size=0x18 (Id=24861)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
                unsigned long long Length;// Offset=0x8 Size=0x8
                unsigned long long Offset;// Offset=0x10 Size=0x8
            ...
            struct <unnamed-type-Ioctl>// Size=0x30 (Id=24866)
            {
            ...
            struct <unnamed-type-Others>// Size=0x20 (Id=24878)
            {
                union <unnamed-type-Argument1>// Size=0x8 (Id=24879)
                {
                ...
                union <unnamed-type-Argument2>// Size=0x8 (Id=24883)
                {
                    void * Ptr;// Offset=0x0 Size=0x8
                    unsigned long long Value;// Offset=0x0 Size=0x8
                };
                ...
                union <unnamed-type-Argument3>// Size=0x8 (Id=24887)
                {
                    void * Ptr;// Offset=0x0 Size=0x8
                    unsigned long long Value;// Offset=0x0 Size=0x8
                };
                ...
                union <unnamed-type-Argument4>// Size=0x8 (Id=24891)
                {
                    void * Ptr;// Offset=0x0 Size=0x8
                    unsigned long long Value;// Offset=0x0 Size=0x8
                };
            ...
            struct <unnamed-type-Usb>// Size=0x8 (Id=24896)
            {
    ...
    union _WDF_REQUEST_COMPLETION_PARAMS_V1_23::<unnamed-type-Parameters> Parameters;// Offset=0x18 Size=0x30
};
