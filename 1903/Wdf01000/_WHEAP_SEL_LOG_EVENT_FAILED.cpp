...
struct _WHEAP_SEL_LOG_EVENT_FAILED// Size=0x28 (Id=2791)
{
    struct _WHEA_EVENT_LOG_ENTRY WheaEventLogEntry;// Offset=0x0 Size=0x20
    long Status;// Offset=0x20 Size=0x4
    unsigned char HighIrqlPath;// Offset=0x24 Size=0x1
    unsigned char LoggerInited;// Offset=0x25 Size=0x1
    unsigned char LogFailed;// Offset=0x26 Size=0x1
    unsigned char GotLock;// Offset=0x27 Size=0x1
};
