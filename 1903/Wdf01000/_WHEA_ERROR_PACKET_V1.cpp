union _WHEA_ERROR_PACKET_FLAGS// Size=0x4 (Id=808)
{
...
union _WHEA_PROCESSOR_GENERIC_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=5294)
{
...
struct _WHEA_PROCESSOR_GENERIC_ERROR_SECTION// Size=0xc0 (Id=1895)
{
...
union _WHEA_MEMORY_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=5060)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WHEA_MEMORY_ERROR_SECTION// Size=0x50 (Id=1743)
{
...
union _WHEA_NMI_ERROR_SECTION_FLAGS// Size=0x4 (Id=2702)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _WHEA_NMI_ERROR_SECTION// Size=0xc (Id=2856)
{
    unsigned char Data[8];// Offset=0x0 Size=0x8
    union _WHEA_NMI_ERROR_SECTION_FLAGS Flags;// Offset=0x8 Size=0x4
};

union _WHEA_PCIEXPRESS_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=2780)
{
    struct // Size=0x8 (Id=0)
    {
...
union _WHEA_PCIEXPRESS_VERSION// Size=0x4 (Id=2118)
{
...
union _WHEA_PCIEXPRESS_COMMAND_STATUS// Size=0x4 (Id=5092)
{
...
struct _WHEA_PCIEXPRESS_DEVICE_ID// Size=0x10 (Id=2163)
{
...
union _WHEA_PCIEXPRESS_BRIDGE_CONTROL_STATUS// Size=0x4 (Id=1843)
{
...
struct _WHEA_PCIEXPRESS_ERROR_SECTION// Size=0xd0 (Id=4420)
{
...
union _WHEA_PCIXBUS_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=3836)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long ErrorStatus:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
union _WHEA_PCIXBUS_ID// Size=0x2 (Id=2550)
{
...
union _WHEA_PCIXBUS_COMMAND// Size=0x8 (Id=3495)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _WHEA_PCIXBUS_ERROR_SECTION// Size=0x48 (Id=3030)
{
...
union _WHEA_PMEM_ERROR_SECTION_VALIDBITS// Size=0x8 (Id=3151)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long ErrorStatus:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_PMEM_PAGE_RANGE// Size=0x18 (Id=3248)
{
...
struct _WHEA_PMEM_ERROR_SECTION// Size=0x70 (Id=4333)
{
...
struct _WHEA_ERROR_PACKET_V1// Size=0x119 (Id=3718)
{
    union // Size=0x40 (Id=0)
    {
        ...
        union <unnamed-type-u>// Size=0xd0 (Id=30918)
        {
