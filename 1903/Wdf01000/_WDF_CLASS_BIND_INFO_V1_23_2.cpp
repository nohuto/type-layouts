struct _WDF_CLASS_VERSION_V1_23// Size=0xc (Id=2725)
{
...
struct _WDF_CLASS_BIND_INFO_V1_23// Size=0x50 (Id=4732)
{
    unsigned long Size;// Offset=0x0 Size=0x4
    wchar_t * ClassName;// Offset=0x8 Size=0x8
    struct _WDF_CLASS_VERSION_V1_23 Version;// Offset=0x10 Size=0xc
