...
struct _WDF_USB_DEVICE_SELECT_CONFIG_PARAMS_V1_21// Size=0x20 (Id=4129)
{
    union // Size=0x8 (Id=0)
    {
        unsigned long Size;// Offset=0x0 Size=0x4
        enum _WdfUsbTargetDeviceSelectConfigType Type;// Offset=0x4 Size=0x4
        union <unnamed-type-Types>// Size=0x18 (Id=26715)
        {
            struct <unnamed-type-Descriptor>// Size=0x18 (Id=26716)
            {
            ...
            struct <unnamed-type-Urb>// Size=0x8 (Id=26721)
            {
            ...
            struct <unnamed-type-SingleInterface>// Size=0x10 (Id=26724)
            {
            ...
            struct <unnamed-type-MultiInterface>// Size=0x18 (Id=26728)
            {
    ...
    union _WDF_USB_DEVICE_SELECT_CONFIG_PARAMS_V1_21::<unnamed-type-Types> Types;// Offset=0x8 Size=0x18
};
