...
struct _WDF_USB_REQUEST_COMPLETION_PARAMS_V1_11// Size=0x20 (Id=3684)
{
    union // Size=0x8 (Id=0)
    {
        long UsbdStatus;// Offset=0x0 Size=0x4
        enum _WDF_USB_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
        union <unnamed-type-Parameters>// Size=0x18 (Id=27300)
        {
            struct <unnamed-type-DeviceString>// Size=0x10 (Id=27301)
            {
            ...
            struct <unnamed-type-DeviceControlTransfer>// Size=0x18 (Id=27307)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            ...
            struct <unnamed-type-DeviceUrb>// Size=0x8 (Id=27312)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            };
            ...
            struct <unnamed-type-PipeWrite>// Size=0x18 (Id=27315)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            ...
            struct <unnamed-type-PipeRead>// Size=0x18 (Id=27320)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
                unsigned long long Length;// Offset=0x8 Size=0x8
                unsigned long long Offset;// Offset=0x10 Size=0x8
            ...
            struct <unnamed-type-PipeUrb>// Size=0x8 (Id=27325)
            {
                struct WDFMEMORY__ * Buffer;// Offset=0x0 Size=0x8
            };
