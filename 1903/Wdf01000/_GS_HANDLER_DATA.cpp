struct _anonymous_317// Size=0x4 (Id=317)
{
...
union _anonymous_318// Size=0x4 (Id=318)
{
    struct _anonymous_317 Bits;// Offset=0x0 Size=0x4
    long CookieOffset;// Offset=0x0 Size=0x4
};

struct _GS_HANDLER_DATA// Size=0xc (Id=319)
{
    union _anonymous_318 u;// Offset=0x0 Size=0x4
