struct _anonymous_56// Size=0x20 (Id=56)
{
...
struct _anonymous_58// Size=0x20 (Id=58)
{
    struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
    unsigned long Options;// Offset=0x8 Size=0x4
    unsigned short Reserved;// Offset=0x10 Size=0x2
...
struct _anonymous_59// Size=0x18 (Id=59)
{
...
struct _anonymous_61// Size=0x20 (Id=61)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_62// Size=0x10 (Id=62)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_64// Size=0x18 (Id=64)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _anonymous_65// Size=0x10 (Id=65)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
};

struct _anonymous_66// Size=0x20 (Id=66)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
...
struct _anonymous_68// Size=0x4 (Id=68)
{
    unsigned long Length;// Offset=0x0 Size=0x4
};
...
struct _anonymous_71// Size=0x20 (Id=71)
{
...
struct _anonymous_72// Size=0x18 (Id=72)
{
...
struct _anonymous_73// Size=0x20 (Id=73)
{
    unsigned long OutputBufferLength;// Offset=0x0 Size=0x4
    unsigned long InputBufferLength;// Offset=0x8 Size=0x4
...
struct _anonymous_74// Size=0x10 (Id=74)
{
...
struct _anonymous_81// Size=0x4 (Id=81)
{
...
struct _anonymous_84// Size=0x8 (Id=84)
{
    struct _DEVICE_CAPABILITIES * Capabilities;// Offset=0x0 Size=0x8
};

struct _anonymous_85// Size=0x8 (Id=85)
{
...
struct _anonymous_87// Size=0x1 (Id=87)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _anonymous_89// Size=0x4 (Id=89)
{
    enum BUS_QUERY_ID_TYPE IdType;// Offset=0x0 Size=0x4
};

struct _anonymous_91// Size=0x10 (Id=91)
{
...
struct _anonymous_93// Size=0x10 (Id=93)
{
...
struct _anonymous_95// Size=0x4 (Id=95)
{
    enum _SYSTEM_POWER_STATE PowerState;// Offset=0x0 Size=0x4
};

struct _anonymous_96// Size=0x8 (Id=96)
{
...
struct _anonymous_99// Size=0x20 (Id=99)
{
    union // Size=0x4 (Id=0)
    {
...
struct _anonymous_100// Size=0x10 (Id=100)
{
...
struct _anonymous_101// Size=0x20 (Id=101)
{
...
struct _anonymous_102// Size=0x20 (Id=102)
{
...
union _anonymous_103// Size=0x20 (Id=103)
{
    struct _anonymous_56 Create;// Offset=0x0 Size=0x20
    struct _anonymous_57 CreatePipe;// Offset=0x0 Size=0x20
    struct _anonymous_58 CreateMailslot;// Offset=0x0 Size=0x20
    struct _anonymous_59 Read;// Offset=0x0 Size=0x18
    struct _anonymous_59 Write;// Offset=0x0 Size=0x18
    struct _anonymous_61 QueryDirectory;// Offset=0x0 Size=0x20
    struct _anonymous_62 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _anonymous_64 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _anonymous_65 QueryFile;// Offset=0x0 Size=0x10
    struct _anonymous_66 SetFile;// Offset=0x0 Size=0x20
    struct _anonymous_67 QueryEa;// Offset=0x0 Size=0x20
    struct _anonymous_68 SetEa;// Offset=0x0 Size=0x4
    struct _anonymous_70 QueryVolume;// Offset=0x0 Size=0x10
    struct _anonymous_70 SetVolume;// Offset=0x0 Size=0x10
    struct _anonymous_71 FileSystemControl;// Offset=0x0 Size=0x20
    struct _anonymous_72 LockControl;// Offset=0x0 Size=0x18
    struct _anonymous_73 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _anonymous_74 QuerySecurity;// Offset=0x0 Size=0x10
    struct _anonymous_75 SetSecurity;// Offset=0x0 Size=0x10
    struct _anonymous_76 MountVolume;// Offset=0x0 Size=0x10
    struct _anonymous_76 VerifyVolume;// Offset=0x0 Size=0x10
    struct _anonymous_78 Scsi;// Offset=0x0 Size=0x8
    struct _anonymous_79 QueryQuota;// Offset=0x0 Size=0x20
    struct _anonymous_68 SetQuota;// Offset=0x0 Size=0x4
    struct _anonymous_81 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _anonymous_83 QueryInterface;// Offset=0x0 Size=0x20
    struct _anonymous_84 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _anonymous_85 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _anonymous_86 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _anonymous_87 SetLock;// Offset=0x0 Size=0x1
    struct _anonymous_89 QueryId;// Offset=0x0 Size=0x4
    struct _anonymous_91 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _anonymous_93 UsageNotification;// Offset=0x0 Size=0x10
    struct _anonymous_95 WaitWake;// Offset=0x0 Size=0x4
    struct _anonymous_96 PowerSequence;// Offset=0x0 Size=0x8
    struct _anonymous_99 Power;// Offset=0x0 Size=0x20
    struct _anonymous_100 StartDevice;// Offset=0x0 Size=0x10
    struct _anonymous_101 WMI;// Offset=0x0 Size=0x20
    struct _anonymous_102 Others;// Offset=0x0 Size=0x20
};
