...
struct _WDF_REQUEST_PARAMETERS_V1_25// Size=0x28 (Id=4330)
{
    union // Size=0x8 (Id=0)
    {
        ...
        union <unnamed-type-Parameters>// Size=0x20 (Id=25592)
        {
            struct <unnamed-type-Create>// Size=0x20 (Id=25593)
            {
            ...
            struct _WDF_REQUEST_PARAMETERS_V1_25::<unnamed-type-Parameters>::<unnamed-type-Create> Create;// Offset=0x0 Size=0x20
            struct <unnamed-type-Read>// Size=0x18 (Id=25600)
            {
            ...
            struct _WDF_REQUEST_PARAMETERS_V1_25::<unnamed-type-Parameters>::<unnamed-type-Read> Read;// Offset=0x0 Size=0x18
            struct <unnamed-type-Write>// Size=0x18 (Id=25605)
            {
                unsigned long long Length;// Offset=0x0 Size=0x8
                unsigned long Key;// Offset=0x8 Size=0x4
                long long DeviceOffset;// Offset=0x10 Size=0x8
            };
            struct _WDF_REQUEST_PARAMETERS_V1_25::<unnamed-type-Parameters>::<unnamed-type-Write> Write;// Offset=0x0 Size=0x18
            struct <unnamed-type-DeviceIoControl>// Size=0x20 (Id=25610)
            {
            ...
            struct _WDF_REQUEST_PARAMETERS_V1_25::<unnamed-type-Parameters>::<unnamed-type-DeviceIoControl> DeviceIoControl;// Offset=0x0 Size=0x20
            struct <unnamed-type-Others>// Size=0x20 (Id=25616)
            {
            ...
            struct _WDF_REQUEST_PARAMETERS_V1_25::<unnamed-type-Parameters>::<unnamed-type-Others> Others;// Offset=0x0 Size=0x20
        };
    };
    union _WDF_REQUEST_PARAMETERS_V1_25::<unnamed-type-Parameters> Parameters;// Offset=0x8 Size=0x20
};
