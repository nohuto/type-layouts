...
struct _KBUGCHECK_REASON_CALLBACK_RECORD// Size=0x30 (Id=712)
{
...
struct _WDF_DRIVER_GLOBALS// Size=0x38 (Id=1252)
{
...
struct _FX_DRIVER_GLOBALS// Size=0x1f0 (Id=827)
{
    ...
    union // Size=0x31a (Id=0)
    {
        ...
        unsigned char IsVersionGreaterThanOrEqualTo(unsigned long ,unsigned long );// Offset=0x0 Size=0x1b
        unsigned char IsCorrectVersionRegistered(struct _UNICODE_STRING * );// Offset=0x0 Size=0x1f2
        void RegisterClientVersion(struct _UNICODE_STRING * );// Offset=0x0 Size=0x31a
