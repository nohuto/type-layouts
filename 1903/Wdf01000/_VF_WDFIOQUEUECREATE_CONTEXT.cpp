struct _VF_COMMON_CONTEXT_HEADER// Size=0x8 (Id=5665)
{
    struct _WDF_DRIVER_GLOBALS * DriverGlobals;// Offset=0x0 Size=0x8
};
...
struct _WDF_IO_QUEUE_CONFIG// Size=0x60 (Id=1172)
{
    union // Size=0x50 (Id=0)
    {
        ...
        union <unnamed-type-Settings>// Size=0x4 (Id=22408)
        {
            struct <unnamed-type-Parallel>// Size=0x4 (Id=22409)
            {
                unsigned long NumberOfPresentedRequests;// Offset=0x0 Size=0x4
            };
            struct _WDF_IO_QUEUE_CONFIG::<unnamed-type-Settings>::<unnamed-type-Parallel> Parallel;// Offset=0x0 Size=0x4
        };
        union _WDF_IO_QUEUE_CONFIG::<unnamed-type-Settings> Settings;// Offset=0x50 Size=0x4
    };
    struct WDFDRIVER__ * Driver;// Offset=0x58 Size=0x8
};

struct _VF_WDFIOQUEUECREATE_CONTEXT// Size=0x68 (Id=5662)
{
    struct _VF_COMMON_CONTEXT_HEADER CommonHeader;// Offset=0x0 Size=0x8
    struct _WDF_IO_QUEUE_CONFIG IoQueueConfigOriginal;// Offset=0x8 Size=0x60
};
