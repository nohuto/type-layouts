...
struct _CACHE_DESCRIPTOR// Size=0xc (Id=2443)
{
...
struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION// Size=0x20 (Id=3905)
{
    ...
    {
        struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION::_anonymous_3907::<unnamed-type-ProcessorCore> ProcessorCore;// Offset=0x10 Size=0x1
        struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION::_anonymous_3906::<unnamed-type-NumaNode> NumaNode;// Offset=0x10 Size=0x4
