union _anonymous_674// Size=0x4 (Id=674)
{
...
struct _USB_DEVICE_CAPABILITY_POWER_DELIVERY_DESCRIPTOR// Size=0x12 (Id=675)
{
    ...
    union _anonymous_674 bmAttributes;// Offset=0x4 Size=0x4
