...
struct _anonymous_455// Size=0x8 (Id=455)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
    enum _WDF_DEVICE_PNP_STATE NewState;// Offset=0x4 Size=0x4
};

struct _anonymous_456// Size=0x4 (Id=456)
{
    enum _WDF_DEVICE_PNP_STATE CurrentState;// Offset=0x0 Size=0x4
};

union _anonymous_457// Size=0x8 (Id=457)
{
    struct _anonymous_455 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_456 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_455 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=458)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_457 Data;// Offset=0x4 Size=0x8
};
