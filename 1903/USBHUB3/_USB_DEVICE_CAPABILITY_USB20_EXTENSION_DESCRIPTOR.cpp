union _anonymous_519// Size=0x4 (Id=519)
{
...
struct _USB_DEVICE_CAPABILITY_USB20_EXTENSION_DESCRIPTOR// Size=0x7 (Id=520)
{
    ...
    union _anonymous_519 bmAttributes;// Offset=0x3 Size=0x4
};
