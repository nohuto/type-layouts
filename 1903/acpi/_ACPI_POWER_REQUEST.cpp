...
struct _ACPI_POWER_REQUEST_DEPENDENCY// Size=0x20 (Id=663)
{
...
struct _anonymous_656// Size=0x8 (Id=656)
{
...
struct _anonymous_657// Size=0x8 (Id=657)
{
...
struct _ACPI_POWER_WAKE_INTERRUPT_REGISTRATION_ENTRY// Size=0x28 (Id=673)
{
...
struct _anonymous_659// Size=0x58 (Id=659)
{
    enum _SYSTEM_POWER_STATE SystemPowerState;// Offset=0x0 Size=0x4
    ...
    union _anonymous_658 Registrations;// Offset=0x30 Size=0x28
};
...
union _anonymous_661// Size=0x58 (Id=661)
{
    union // Size=0x58 (Id=0)
    {
        struct _anonymous_656 DevicePowerRequest;// Offset=0x0 Size=0x8
        struct _anonymous_657 SystemPowerRequest;// Offset=0x0 Size=0x8
        struct _anonymous_659 WaitWakeRequest;// Offset=0x0 Size=0x58
        struct _anonymous_660 EjectPowerRequest;// Offset=0x0 Size=0x4
    };
};
...
struct _ACPI_POWER_REQUEST// Size=0x108 (Id=662)
{
    ...
    union _anonymous_661 u;// Offset=0x68 Size=0x58
