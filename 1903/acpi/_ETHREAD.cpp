...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=395)
{
...
struct _KAPC_STATE// Size=0x30 (Id=351)
{
...
struct _KTIMER// Size=0x40 (Id=477)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=369)
{
...
struct _GROUP_AFFINITY// Size=0x10 (Id=227)
{
...
struct _KLOCK_ENTRY_LOCK_STATE// Size=0x10 (Id=409)
{
    union // Size=0x8 (Id=0)
    {
...
union _KLOCK_ENTRY_BOOST_BITMAP// Size=0x4 (Id=233)
{
...
struct _KLOCK_ENTRY// Size=0x60 (Id=224)
{
...
struct _CLIENT_ID// Size=0x10 (Id=229)
{
    void * UniqueProcess;// Offset=0x0 Size=0x8
    void * UniqueThread;// Offset=0x8 Size=0x8
};

struct _KSEMAPHORE// Size=0x20 (Id=343)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=392)
{
...
struct _ETHREAD// Size=0x820 (Id=108)
{
