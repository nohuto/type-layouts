...
union _anonymous_692// Size=0xc (Id=692)
{
    struct _anonymous_691 Msi;// Offset=0x0 Size=0xc
};

struct _INTERRUPT_REMAPPING_INFO// Size=0x10 (Id=693)
{
    ...
    union _anonymous_692 u;// Offset=0x4 Size=0xc
};

struct _anonymous_606// Size=0x8 (Id=606)
{
...
union _anonymous_637// Size=0x4 (Id=637)
{
    struct _anonymous_636 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _anonymous_638// Size=0x4 (Id=638)
{
    struct // Size=0x4 (Id=0)
    {
...
{
    struct _anonymous_638 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_HT_INTR_INFO// Size=0x8 (Id=640)
{
    union _anonymous_637 LowPart;// Offset=0x0 Size=0x4
    union _anonymous_639 HighPart;// Offset=0x4 Size=0x4
};

struct _anonymous_608// Size=0x8 (Id=608)
{
    struct _INTERRUPT_HT_INTR_INFO IntrInfo;// Offset=0x0 Size=0x8
};

struct _anonymous_609// Size=0x4 (Id=609)
{
    enum HAL_APIC_DESTINATION_MODE DestinationMode;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_VECTOR_DATA// Size=0x58 (Id=610)
{
    ...
    struct _anonymous_606 ControllerInput;// Offset=0x38 Size=0x8
    unsigned long long HvDeviceId;// Offset=0x40 Size=0x8
    union // Size=0x58 (Id=0)
    {
        struct _anonymous_607 XapicMessage;// Offset=0x48 Size=0x10
        struct _anonymous_608 Hypertransport;// Offset=0x48 Size=0x8
        struct _anonymous_607 GenericMessage;// Offset=0x48 Size=0x10
        struct _anonymous_609 MessageRequest;// Offset=0x48 Size=0x4
    };
};

struct _INTERRUPT_CONNECTION_DATA// Size=0x60 (Id=677)
{
