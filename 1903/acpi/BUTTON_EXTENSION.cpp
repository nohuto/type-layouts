struct _anonymous_431// Size=0x4 (Id=431)
{
...
struct BUTTON_EXTENSION// Size=0x30 (Id=432)
{
    ...
    union // Size=0x4 (Id=0)
    {
        ...
        struct _anonymous_431 UEvents;// Offset=0x24 Size=0x4
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long Capabilities;// Offset=0x28 Size=0x4
        struct _anonymous_431 UCapabilities;// Offset=0x28 Size=0x4
    };
};
