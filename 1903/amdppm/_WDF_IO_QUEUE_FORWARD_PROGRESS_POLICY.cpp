...
union _anonymous_646// Size=0x8 (Id=646)
{
    struct _anonymous_645 ExaminePolicy;// Offset=0x0 Size=0x8
};

struct _WDF_IO_FORWARD_PROGRESS_RESERVED_POLICY_SETTINGS// Size=0x8 (Id=647)
{
    union _anonymous_646 Policy;// Offset=0x0 Size=0x8
};

struct _WDF_IO_QUEUE_FORWARD_PROGRESS_POLICY// Size=0x28 (Id=326)
{
