...
struct _anonymous_296// Size=0x18 (Id=296)
{
...
struct _anonymous_297// Size=0x20 (Id=297)
{
...
union _anonymous_299// Size=0x20 (Id=299)
{
    struct _anonymous_79 Create;// Offset=0x0 Size=0x20
    struct _anonymous_296 Read;// Offset=0x0 Size=0x18
    struct _anonymous_296 Write;// Offset=0x0 Size=0x18
    struct _anonymous_297 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _anonymous_298 Others;// Offset=0x0 Size=0x20
};

struct _WDF_REQUEST_PARAMETERS// Size=0x28 (Id=300)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned char MinorFunction;// Offset=0x2 Size=0x1
    enum _WDF_REQUEST_TYPE Type;// Offset=0x4 Size=0x4
    union _anonymous_299 Parameters;// Offset=0x8 Size=0x20
};
