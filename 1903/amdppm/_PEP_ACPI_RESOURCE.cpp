...
struct _PEP_ACPI_IO_MEMORY_RESOURCE// Size=0x20 (Id=164)
{
...
union _PEP_ACPI_RESOURCE_FLAGS// Size=0x4 (Id=524)
{
...
struct _PEP_ACPI_INTERRUPT_RESOURCE// Size=0x20 (Id=167)
{
    enum _PEP_ACPI_RESOURCE_TYPE Type;// Offset=0x0 Size=0x4
...
struct _PEP_ACPI_GPIO_RESOURCE// Size=0x48 (Id=170)
{
    enum _PEP_ACPI_RESOURCE_TYPE Type;// Offset=0x0 Size=0x4
...
struct _PEP_ACPI_SPB_RESOURCE// Size=0x28 (Id=410)
{
    enum _PEP_ACPI_RESOURCE_TYPE Type;// Offset=0x0 Size=0x4
    union _PEP_ACPI_RESOURCE_FLAGS Flags;// Offset=0x4 Size=0x4
...
struct _PEP_ACPI_SPB_I2C_RESOURCE// Size=0x30 (Id=171)
{
...
struct _PEP_ACPI_SPB_SPI_RESOURCE// Size=0x38 (Id=173)
{
    struct _PEP_ACPI_SPB_RESOURCE SpbCommon;// Offset=0x0 Size=0x28
    unsigned long ConnectionSpeed;// Offset=0x28 Size=0x4
...
struct _PEP_ACPI_SPB_UART_RESOURCE// Size=0x38 (Id=172)
{
    struct _PEP_ACPI_SPB_RESOURCE SpbCommon;// Offset=0x0 Size=0x28
...
struct _PEP_ACPI_EXTENDED_ADDRESS// Size=0x48 (Id=174)
{
    enum _PEP_ACPI_RESOURCE_TYPE Type;// Offset=0x0 Size=0x4
    union _PEP_ACPI_RESOURCE_FLAGS Flags;// Offset=0x4 Size=0x4
...
union _PEP_ACPI_RESOURCE// Size=0x48 (Id=163)
{
    enum _PEP_ACPI_RESOURCE_TYPE Type;// Offset=0x0 Size=0x4
