...
struct _anonymous_433// Size=0x8 (Id=433)
{
...
union _anonymous_435// Size=0x8 (Id=435)
{
    struct _anonymous_433 EnterState;// Offset=0x0 Size=0x8
    struct _anonymous_434 PostProcessState;// Offset=0x0 Size=0x4
    struct _anonymous_433 LeaveState;// Offset=0x0 Size=0x8
};

struct _WDF_DEVICE_PNP_NOTIFICATION_DATA// Size=0xc (Id=242)
{
    enum _WDF_STATE_NOTIFICATION_TYPE Type;// Offset=0x0 Size=0x4
    union _anonymous_435 Data;// Offset=0x4 Size=0x8
};
