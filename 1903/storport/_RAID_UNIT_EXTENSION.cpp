...
struct _RAID_UNIT_EXTENSION// Size=0xb00 (Id=256)
{
    ...
    struct _anonymous_249 Flags;// Offset=0xa0 Size=0x8
    union _anonymous_250 InterlockedFlags;// Offset=0xa8 Size=0x4
    struct _KEVENT ZeroOutstandingEvent;// Offset=0xb0 Size=0x18
    struct _RAID_POWER_STATE Power;// Offset=0xc8 Size=0x10
    struct _STOR_EVENT_QUEUE * PendingQueue;// Offset=0xd8 Size=0x8
    ...
    struct _anonymous_252 DeferredList;// Offset=0x410 Size=0x190
    ...
    struct _anonymous_255 PendingPowerUpContext;// Offset=0x678 Size=0x10
    ...
    unsigned long long TotalDeviceQueueIoCount;// Offset=0x758 Size=0x8
    unsigned long long TotalDeviceQueueIoWaitDuration;// Offset=0x760 Size=0x8
    unsigned long long MaxDeviceQueueIoWaitDuration;// Offset=0x768 Size=0x8
    unsigned long long DeviceQueueIoWaitExceededTimeoutCount;// Offset=0x770 Size=0x8
    unsigned long long DeviceQueueIoBusyCount;// Offset=0x778 Size=0x8
    unsigned long long DeviceQueueIoPausedCount;// Offset=0x780 Size=0x8
    unsigned long long DeviceQueueIoUntaggedCommandOutstandingCount;// Offset=0x788 Size=0x8
    unsigned long long DeviceQueueIoPausedForUntaggedCount;// Offset=0x790 Size=0x8
    unsigned long StorpTraceLoggingPerformanceEnabled;// Offset=0x798 Size=0x4
    struct _RAID_TELEMETRY_PERF_BUCKET * TelemetryPerfBuckets;// Offset=0x7a0 Size=0x8
    union _LARGE_INTEGER TelemetryLastPerfCollectionTimeStamp;// Offset=0x7a8 Size=0x8
    struct _RAID_TELEMETRY_PERF_BUCKET * TelemetryPerfPreviousCounters;// Offset=0x7b0 Size=0x8
    struct _RAID_TELEMETRY_NODE_COUNTERS * TelemetryCountersPerNumaNode;// Offset=0x7b8 Size=0x8
    struct _RAID_TELEMETRY_NODE_COUNTERS TelemetryPerfPreviousNodeCounters;// Offset=0x7c0 Size=0x18
    unsigned long long TelemetryMaxFlushLatency;// Offset=0x7d8 Size=0x8
    unsigned long long TelemetryMaxUnmapLatency;// Offset=0x7e0 Size=0x8
    unsigned long long TelemetryLock;// Offset=0x7e8 Size=0x8
    struct _RAID_TELEMETRY_SAMPLED_ERROR_LOG TelemetrySampledErrorLog;// Offset=0x7f0 Size=0x1c8
    struct _RAID_TELEMETRY_UNIQUE_ERROR_LOG TelemetryUniqueErrorLog;// Offset=0x9b8 Size=0xc8
    unsigned long long TelemetryBytesWritten;// Offset=0xa80 Size=0x8
    unsigned long long TelemetryStreamBytesWritten;// Offset=0xa88 Size=0x8
    unsigned long PowerCycleCount;// Offset=0xa90 Size=0x4
    union _LARGE_INTEGER InitialTimestamp;// Offset=0xa98 Size=0x8
    struct _RAID_UNIT_QOS Qos;// Offset=0xaa0 Size=0x30
    unsigned long long LastHierarchicalResetEndTime;// Offset=0xad0 Size=0x8
    unsigned long long ZoneSize;// Offset=0xad8 Size=0x8
    unsigned char * CachedSmartData;// Offset=0xae0 Size=0x8
};
