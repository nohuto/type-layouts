...
struct _anonymous_258// Size=0x7 (Id=258)
{
...
struct _STOR_LOCKED_LIST// Size=0x20 (Id=292)
{
...
struct _STOR_DICTIONARY// Size=0x30 (Id=203)
{
...
struct _RAID_POWER_STATE// Size=0x10 (Id=298)
{
...
struct _RAID_RESOURCE_LIST// Size=0x10 (Id=302)
{
...
struct _MEMORY_REGION// Size=0x18 (Id=485)
{
...
struct _PORT_CONFIGURATION_INFORMATION// Size=0xe0 (Id=290)
{
...
struct _anonymous_293// Size=0x1 (Id=293)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _RAID_MINIPORT// Size=0x128 (Id=294)
{
    ...
    struct _anonymous_293 Flags;// Offset=0xf8 Size=0x1
...
struct _RAID_DMA_ADAPTER// Size=0x20 (Id=231)
{
...
struct _RAID_MEMORY_REGION// Size=0x18 (Id=208)
{
    unsigned char * VirtualBase;// Offset=0x0 Size=0x8
    union _LARGE_INTEGER PhysicalBase;// Offset=0x8 Size=0x8
    unsigned long Length;// Offset=0x10 Size=0x4
...
struct _IO_CONT_RESOURCE_LIST// Size=0x80 (Id=396)
{
...
struct _STOR_NOTIFICATION_INFO// Size=0x20 (Id=397)
{
...
struct _STOR_IO_GATEWAY// Size=0x140 (Id=243)
{
    unsigned long long Lock;// Offset=0x0 Size=0x8
...
struct _RAID_DEFERRED_QUEUE// Size=0x80 (Id=224)
{
...
struct _anonymous_261// Size=0x50 (Id=261)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=393)
{
    union // Size=0x4 (Id=0)
    {
...
struct _KTIMER// Size=0x40 (Id=320)
{
...
struct _PORT_REGISTRY_INFO// Size=0x40 (Id=448)
{
...
struct _anonymous_264// Size=0x1 (Id=264)
{
    struct // Size=0x1 (Id=0)
    {
...
struct _SCSI_POWER_REQUEST_BLOCK// Size=0x58 (Id=504)
{
    unsigned short Length;// Offset=0x0 Size=0x2
...
struct _STORAGE_REQUEST_BLOCK// Size=0x80 (Id=237)
{
    unsigned short Length;// Offset=0x0 Size=0x2
    unsigned char Function;// Offset=0x2 Size=0x1
    unsigned char SrbStatus;// Offset=0x3 Size=0x1
...
struct _RAID_POWER_CONTEXT// Size=0xb8 (Id=415)
{
...
struct _STORPORT_EXTENDED_FUNCTIONS// Size=0x58 (Id=336)
{
...
union _RAID_REDIRECTION_SUPPORT// Size=0x2 (Id=532)
{
...
struct _PCI_HEADER_TYPE_0// Size=0x30 (Id=490)
{
...
union _anonymous_436// Size=0x30 (Id=436)
{
...
struct _PCI_COMMON_HEADER// Size=0x40 (Id=437)
{
    ...
    union _anonymous_436 u;// Offset=0x10 Size=0x30
};

struct _STOR_POWER_SETTING_NOTIFICATION// Size=0x18 (Id=533)
{
...
struct _CRASHDUMP_FUNCTIONS_INTERFACE// Size=0x28 (Id=530)
{
    unsigned short Size;// Offset=0x0 Size=0x2
    unsigned short Version;// Offset=0x2 Size=0x2
    void * Context;// Offset=0x8 Size=0x8
...
struct _anonymous_265// Size=0xc (Id=265)
{
...
struct _STOR_ADDRESS// Size=0x10 (Id=149)
{
...
struct _RAID_RPMB_CAPABILITIES// Size=0x38 (Id=383)
{
...
struct _RAID_CRYPTO_KEY_TABLE// Size=0x18 (Id=400)
{
...
struct _RAID_SHARED_WORK_ITEM_CONTEXT// Size=0x18 (Id=478)
{
...
struct _RAID_ADAPTER_EXTENSION// Size=0x1680 (Id=266)
{
    ...
    struct _anonymous_258 Flags;// Offset=0x68 Size=0x7
    ...
    struct _anonymous_261 DeferredList;// Offset=0x4c0 Size=0x50
    struct _anonymous_262 DeferredPauseResumeContext;// Offset=0x510 Size=0xb0
    ...
    struct _anonymous_264 PerfOptFlags;// Offset=0x1163 Size=0x1
    ...
    unsigned long HierarchicalResetSucceededAtBus;// Offset=0x12a0 Size=0x4
    unsigned long HierarchicalResetSucceededAtTarget;// Offset=0x12a4 Size=0x4
    unsigned long HierarchicalResetSucceededAtLun;// Offset=0x12a8 Size=0x4
    unsigned long HierarchicalResetCountInternal;// Offset=0x12ac Size=0x4
    unsigned long HierarchicalResetCountApp;// Offset=0x12b0 Size=0x4
    unsigned long MaxDpcCompletionCount;// Offset=0x12b4 Size=0x4
    unsigned long MaxDpcCompletionTimeTicks;// Offset=0x12b8 Size=0x4
    unsigned long CompletionsForLongestDpc;// Offset=0x12bc Size=0x4
    wchar_t * MiniportName;// Offset=0x12c0 Size=0x8
    wchar_t * AdapterId;// Offset=0x12c8 Size=0x8
    struct _PCI_COMMON_HEADER PciConfiguration;// Offset=0x12d0 Size=0x40
    struct _STOR_POWER_SETTING_NOTIFICATION PowerSettingNotification;// Offset=0x1310 Size=0x18
    long StateChangeInProgress;// Offset=0x1328 Size=0x4
    unsigned long StateChangedEntity;// Offset=0x132c Size=0x4
    unsigned long StateChangeEntityAttributes;// Offset=0x1330 Size=0x4
    struct _STOR_ADDRESS * StateChangeAddress;// Offset=0x1338 Size=0x8
    void  ( * HwStateChange)(void * ,void * ,short ,void * ,unsigned long );// Offset=0x1340 Size=0x8
    void * StateChangeContext;// Offset=0x1348 Size=0x8
    struct _RTL_BITMAP BusesWithVmLunsBitmap;// Offset=0x1350 Size=0x10
    unsigned long * BusesWithVmLunsBitmapBuffer;// Offset=0x1360 Size=0x8
    unsigned long NumWorkItems;// Offset=0x1368 Size=0x4
    unsigned char DefaultSenseByteCount;// Offset=0x136c Size=0x1
    unsigned char DumpPowerReady;// Offset=0x136d Size=0x1
    unsigned char MaxDumpLevelEnabled;// Offset=0x136e Size=0x1
    unsigned char VendorSpecificLogPageAddress;// Offset=0x136f Size=0x1
    unsigned long MaxDeviceDumpSize;// Offset=0x1370 Size=0x4
    unsigned long long IoLatencyCap;// Offset=0x1378 Size=0x8
    ...
    unsigned long CompletionsDuringReset;// Offset=0x1418 Size=0x4
    struct _anonymous_265 TelemetryHierarchicalResetLunBucket[5];// Offset=0x141c Size=0x3c
    struct _anonymous_265 TelemetryHierarchicalResetTargetBucket[5];// Offset=0x1458 Size=0x3c
    unsigned long long LastCSStateChange;// Offset=0x1498 Size=0x8
    unsigned long long LastIOCoalescingOnStartTime;// Offset=0x14a0 Size=0x8
    unsigned long long IOCoalescingOnDuration;// Offset=0x14a8 Size=0x8
    unsigned long long FirstDPNRTimeAfterCS;// Offset=0x14b0 Size=0x8
    unsigned long long LastDPNRStartTime;// Offset=0x14b8 Size=0x8
    unsigned long long DPNRDurationInCS;// Offset=0x14c0 Size=0x8
    unsigned long long LastF1StartTime;// Offset=0x14c8 Size=0x8
    unsigned long long F1DurationInCS;// Offset=0x14d0 Size=0x8
    unsigned long long ActiveReferencesInCS;// Offset=0x14d8 Size=0x8
    unsigned long long ActiveReferencesInCoalescing;// Offset=0x14e0 Size=0x8
    unsigned long UnitTimeoutsInCS;// Offset=0x14e8 Size=0x4
    unsigned long F0TransitionsSinceCSStateChange;// Offset=0x14ec Size=0x4
    unsigned long D0TransitionsSinceCSStateChange;// Offset=0x14f0 Size=0x4
    unsigned long F0TransitionsLongSinceCSStateChange;// Offset=0x14f4 Size=0x4
    unsigned long D0TransitionsLongSinceCSStateChange;// Offset=0x14f8 Size=0x4
    unsigned char TopologyInfoLogged;// Offset=0x14fc Size=0x1
    unsigned long PeriodicMaxGatewayQueueDepthAtSwTimeout;// Offset=0x1500 Size=0x4
    unsigned long PauseCount;// Offset=0x1504 Size=0x4
    unsigned long BusyCount;// Offset=0x1508 Size=0x4
    unsigned char DisableTelemetryDeviceHealth;// Offset=0x150c Size=0x1
    unsigned long MiniportFirmwareDataStructureVersion;// Offset=0x1510 Size=0x4
    struct _D3COLD_SUPPORT_INTERFACE * D3ColdInterface;// Offset=0x1518 Size=0x8
    void * ProtocolCommandEffects;// Offset=0x1520 Size=0x8
    struct _KTIMER QueueWaitCheckTimer;// Offset=0x1528 Size=0x40
    struct _KDPC QueueWaitCheckDpc;// Offset=0x1568 Size=0x40
    unsigned long long QosLock;// Offset=0x15a8 Size=0x8
    unsigned long QosUnitCountForWaitTimeout;// Offset=0x15b0 Size=0x4
    struct _RAID_RPMB_CAPABILITIES Rpmb;// Offset=0x15b8 Size=0x38
    struct _STOR_HMB_RANGE * HmbRangeList;// Offset=0x15f0 Size=0x8
    unsigned long PowerSrbTimeout;// Offset=0x15f8 Size=0x4
    struct _STOR_CRYPTO_CAPABILITIES_DATA * CryptoCapabilities;// Offset=0x1600 Size=0x8
    struct _RAID_CRYPTO_KEY_TABLE CryptoKeyTable;// Offset=0x1608 Size=0x18
    unsigned long ZoneOutOfOrderWriteCount;// Offset=0x1620 Size=0x4
    unsigned long ZoneDeviceErrors;// Offset=0x1624 Size=0x4
    unsigned long BusyRetryCount;// Offset=0x1628 Size=0x4
    unsigned long BusyPauseTimeInMs;// Offset=0x162c Size=0x4
    struct _RAID_SHARED_WORK_ITEM_CONTEXT PowerWorkItem;// Offset=0x1630 Size=0x18
    struct _RAID_SHARED_WORK_ITEM_CONTEXT IoResourceWorkItem;// Offset=0x1648 Size=0x18
};
