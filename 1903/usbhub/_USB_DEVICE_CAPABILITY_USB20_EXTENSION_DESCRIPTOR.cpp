union _anonymous_375// Size=0x4 (Id=375)
{
...
struct _USB_DEVICE_CAPABILITY_USB20_EXTENSION_DESCRIPTOR// Size=0x7 (Id=376)
{
    ...
    union _anonymous_375 bmAttributes;// Offset=0x3 Size=0x4
};
