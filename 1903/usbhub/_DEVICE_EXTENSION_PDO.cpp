...
struct _G_STATE_LOG_ENTRY// Size=0x20 (Id=189)
{
...
struct _STATE_CONTEXT// Size=0xb0 (Id=187)
{
...
union _USB_EXTENDED_PORT_ATTRIBUTES// Size=0x4 (Id=264)
{
...
struct _UNICODE_STRING// Size=0x10 (Id=133)
{
...
struct _DISPATCHER_HEADER// Size=0x18 (Id=263)
{
    union // Size=0x4 (Id=0)
    {
...
struct _WMILIB_CONTEXT// Size=0x40 (Id=355)
{
...
struct _USB_DEVICE_DESCRIPTOR// Size=0x12 (Id=213)
{
...
union _HUBPDO_CLEANUP_FLAGS// Size=0x4 (Id=309)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
union _USB_DEVICE_FLAGS// Size=0x4 (Id=253)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _HUB_TIMER_OBJECT// Size=0x50 (Id=257)
{
...
struct _USB_ID_STRING// Size=0x10 (Id=347)
{
...
struct _USB_INTERFACE_DESCRIPTOR// Size=0x9 (Id=358)
{
    unsigned char bLength;// Offset=0x0 Size=0x1
    unsigned char bDescriptorType;// Offset=0x1 Size=0x1
...
struct _KSEMAPHORE// Size=0x20 (Id=297)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

struct _GUID// Size=0x10 (Id=129)
{
...
struct _USB_HUB_DEVICE_UXD_SETTINGS// Size=0x44 (Id=248)
{
...
union _MSOS20_FLAGS// Size=0x4 (Id=320)
{
...
struct _MSOS20_INFO// Size=0x40 (Id=290)
{
...
struct _MSOS20_DESCRIPTOR_SET_INFO// Size=0x8 (Id=276)
{
...
struct _D3COLD_SUPPORT_INTERFACE// Size=0x48 (Id=295)
{
...
union _USB_DUAL_ROLE_FEATURES// Size=0x4 (Id=138)
{
    unsigned long ul;// Offset=0x0 Size=0x4
    struct _anonymous_137 features;// Offset=0x0 Size=0x4
};

struct _DEVICE_EXTENSION_PDO// Size=0xbf8 (Id=171)
{
