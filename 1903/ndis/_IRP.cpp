...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=1051)
{
...
struct _IRP// Size=0xd0 (Id=86)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=4449)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=4467)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=4468)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=4479)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=4480)
            {
