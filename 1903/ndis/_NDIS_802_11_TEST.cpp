...
struct _NDIS_802_11_STATUS_INDICATION// Size=0x4 (Id=781)
{
    enum _NDIS_802_11_STATUS_TYPE StatusType;// Offset=0x0 Size=0x4
};

struct _NDIS_802_11_AUTHENTICATION_REQUEST// Size=0x10 (Id=1827)
{
...
struct _NDIS_802_11_AUTHENTICATION_EVENT// Size=0x14 (Id=1161)
{
...
struct _NDIS_802_11_TEST// Size=0x1c (Id=1376)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long Type;// Offset=0x4 Size=0x4
    union // Size=0x14 (Id=0)
    {
        struct _NDIS_802_11_AUTHENTICATION_EVENT AuthenticationEvent;// Offset=0x8 Size=0x14
        long RssiTrigger;// Offset=0x8 Size=0x4
    };
};
