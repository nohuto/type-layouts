struct in_addr// Size=0x4 (Id=151)
{
    union // Size=0x4 (Id=0)
    {
        union <unnamed-type-S_un>// Size=0x4 (Id=15488)
        {
            struct <unnamed-type-S_un_b>// Size=0x4 (Id=15489)
            {
            ...
            struct <unnamed-type-S_un_w>// Size=0x4 (Id=15495)
            {
