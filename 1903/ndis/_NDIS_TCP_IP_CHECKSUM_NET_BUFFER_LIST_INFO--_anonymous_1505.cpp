union _NDIS_TCP_IP_CHECKSUM_NET_BUFFER_LIST_INFO::_anonymous_1505// Size=0x8 (Id=1505)
{
    struct <unnamed-type-Transmit>// Size=0x4 (Id=11589)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_NET_BUFFER_LIST_INFO::_anonymous_1506::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x4
    struct <unnamed-type-Receive>// Size=0x4 (Id=11598)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_NET_BUFFER_LIST_INFO::_anonymous_1507::<unnamed-type-Receive> Receive;// Offset=0x0 Size=0x4
