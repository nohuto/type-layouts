...
struct _WWAN_SMS_SEND_PDU// Size=0x16f (Id=1607)
{
...
struct _WWAN_SMS_SEND_CDMA// Size=0xe0 (Id=1283)
{
...
struct _WWAN_SMS_SEND// Size=0x174 (Id=1090)
{
    union // Size=0x4 (Id=0)
    {
        enum _WWAN_SMS_FORMAT SmsFormat;// Offset=0x0 Size=0x4
        union <unnamed-type-u>// Size=0x170 (Id=15079)
        {
...
struct _NDIS_WWAN_SMS_SEND// Size=0x178 (Id=789)
{
