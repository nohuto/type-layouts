union _NDIS_PACKET_8021Q_INFO::_anonymous_1194// Size=0x8 (Id=1194)
{
    struct <unnamed-type-TagHeader>// Size=0x4 (Id=9918)
    {
    ...
    struct _NDIS_PACKET_8021Q_INFO::_anonymous_1195::<unnamed-type-TagHeader> TagHeader;// Offset=0x0 Size=0x4
