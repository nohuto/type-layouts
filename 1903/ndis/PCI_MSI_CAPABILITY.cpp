...
struct PCI_MSI_CAPABILITY// Size=0x18 (Id=548)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-MessageAddressLower>// Size=0x4 (Id=17071)
        {
            struct _PCI_MSI_MESSAGE_ADDRESS// Size=0x4 (Id=17072)
            {
    ...
    union // Size=0xc (Id=0)
    {
        struct PCI_MSI_CAPABILITY::_anonymous_1265::<unnamed-type-Option32Bit> Option32Bit;// Offset=0x8 Size=0xc
        struct PCI_MSI_CAPABILITY::_anonymous_1266::<unnamed-type-Option64Bit> Option64Bit;// Offset=0x8 Size=0x10
    };
};
