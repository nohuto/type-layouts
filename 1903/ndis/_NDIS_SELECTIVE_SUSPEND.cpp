...
struct _NDIS_IRP_WORK_ITEM// Size=0x30 (Id=972)
{
...
struct _NDIS_SS_IDLE_FLAGS// Size=0x4 (Id=892)
{
    union // Size=0x4 (Id=0)
    {
...
struct _NDIS_SS_CONTROL_OPS// Size=0x4 (Id=899)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _NBL_QUEUE// Size=0x10 (Id=191)
{
...
struct _NDIS_SELECTIVE_SUSPEND// Size=0x650 (Id=887)
{
    ...
    long PendingBindChangesCount;// Offset=0x21c Size=0x4
