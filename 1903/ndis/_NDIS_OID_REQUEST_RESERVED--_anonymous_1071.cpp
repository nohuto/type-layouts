...
union _NDIS_OID_REQUEST_RESERVED::_anonymous_1071// Size=0x20 (Id=1071)
{
    struct _KEVENT Event;// Offset=0x0 Size=0x18
    void * NdisVcHandle;// Offset=0x18 Size=0x8
    struct <unnamed-type-CoNdis>// Size=0x20 (Id=9811)
    {
    ...
    struct _NDIS_OID_REQUEST_RESERVED::_anonymous_1073::<unnamed-type-CoNdis> CoNdis;// Offset=0x0 Size=0x20
};
