...
struct _NDIS_GFP_ETHERNET_HEADER_FIELDS// Size=0x14 (Id=825)
{
...
struct _NDIS_GFP_IPV4_SRC_AND_DEST_ADDRESS_WILDCARD_MATCH// Size=0x18 (Id=1135)
{
...
struct _NDIS_GFP_IPV6_ADDRESS_WILDCARD_MATCH// Size=0x18 (Id=1705)
{
    union // Size=0x14 (Id=0)
    {
        enum _NDIS_GFP_WILDCARD_MATCH_TYPE MatchType;// Offset=0x0 Size=0x4
        struct in6_addr IPAddress;// Offset=0x4 Size=0x10
        union <unnamed-type-MatchValue>// Size=0x4 (Id=6848)
        {
            unsigned long PrefixLength;// Offset=0x0 Size=0x4
            unsigned long RangeSize;// Offset=0x0 Size=0x4
        };
...
struct _NDIS_GFP_IPV6_SRC_AND_DEST_ADDRESS_WILDCARD_MATCH// Size=0x30 (Id=1497)
{
...
union _NDIS_GFP_IP_SRC_AND_DEST_ADDRESS_WILDCARD_MATCH// Size=0x30 (Id=1553)
{
...
struct _NDIS_GFP_TRANSPORT_PORT_WILDCARD_MATCH// Size=0x8 (Id=1089)
{
    enum _NDIS_GFP_WILDCARD_MATCH_TYPE MatchType;// Offset=0x0 Size=0x4
...
struct _NDIS_GFP_TRANSPORT_SRC_AND_DEST_PORT_WILDCARD_MATCH// Size=0x10 (Id=1673)
{
...
struct _NDIS_GFP_HEADER_GROUP_WILDCARD_MATCH// Size=0x78 (Id=1352)
{
    union // Size=0x5e (Id=0)
    {
        ...
        union <unnamed-type-TransportOrEncapsulation>// Size=0x14 (Id=6808)
        {
            struct <unnamed-type-UdpHeader>// Size=0x10 (Id=6809)
            {
            ...
            struct <unnamed-type-TcpHeader>// Size=0x14 (Id=6812)
            {
            ...
            struct <unnamed-type-IcmpHeader>// Size=0x2 (Id=6816)
            {
                unsigned char Type;// Offset=0x0 Size=0x1
            ...
            struct <unnamed-type-Encapsulation>// Size=0x8 (Id=6820)
            {
