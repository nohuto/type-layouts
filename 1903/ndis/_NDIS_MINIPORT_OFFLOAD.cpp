...
struct _NDIS_TCP_IP_CHECKSUM_OFFLOAD// Size=0x20 (Id=1356)
{
    union // Size=0x18 (Id=0)
    {
        struct <unnamed-type-IPv4Transmit>// Size=0x8 (Id=11610)
        {
        ...
        struct <unnamed-type-IPv4Receive>// Size=0x8 (Id=11618)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
            unsigned long IpOptionsSupported:2;// Offset=0x4 Size=0x4 BitOffset=0x0 BitSize=0x2
            unsigned long TcpOptionsSupported:2;// Offset=0x4 Size=0x4 BitOffset=0x2 BitSize=0x2
        ...
        struct <unnamed-type-IPv6Transmit>// Size=0x8 (Id=11626)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
        ...
        struct <unnamed-type-IPv6Receive>// Size=0x8 (Id=11633)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
            unsigned long IpExtensionHeadersSupported:2;// Offset=0x4 Size=0x4 BitOffset=0x0 BitSize=0x2
            unsigned long TcpOptionsSupported:2;// Offset=0x4 Size=0x4 BitOffset=0x2 BitSize=0x2
...
struct _NDIS_TCP_LARGE_SEND_OFFLOAD_V1// Size=0x10 (Id=1217)
{
    union // Size=0x10 (Id=0)
    {
        struct <unnamed-type-IPv4>// Size=0x10 (Id=11694)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
...
struct _NDIS_IPSEC_OFFLOAD_V1// Size=0x1c (Id=1652)
{
    union // Size=0x18 (Id=0)
    {
        struct <unnamed-type-Supported>// Size=0x14 (Id=7534)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
        ...
        struct <unnamed-type-IPv4AH>// Size=0x4 (Id=7541)
        {
        ...
        struct <unnamed-type-IPv4ESP>// Size=0x4 (Id=7549)
        {
...
struct _NDIS_TCP_LARGE_SEND_OFFLOAD_V2// Size=0x1c (Id=1721)
{
    union // Size=0xc (Id=0)
    {
        struct <unnamed-type-IPv4>// Size=0xc (Id=11701)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
            unsigned long MaxOffLoadSize;// Offset=0x4 Size=0x4
            unsigned long MinSegmentCount;// Offset=0x8 Size=0x4
        ...
        struct <unnamed-type-IPv6>// Size=0x10 (Id=11706)
        {
            unsigned long Encapsulation;// Offset=0x0 Size=0x4
            unsigned long MaxOffLoadSize;// Offset=0x4 Size=0x4
            unsigned long MinSegmentCount;// Offset=0x8 Size=0x4
...
struct _NDIS_IPSEC_OFFLOAD_V2// Size=0x20 (Id=1041)
{
    unsigned long Encapsulation;// Offset=0x0 Size=0x4
...
struct _NDIS_TCP_RECV_SEG_COALESCE_OFFLOAD// Size=0x2 (Id=1569)
{
    union // Size=0x1 (Id=0)
    {
        struct <unnamed-type-IPv4>// Size=0x1 (Id=11727)
        {
        ...
        struct <unnamed-type-IPv6>// Size=0x1 (Id=11730)
        {
            unsigned char Enabled;// Offset=0x0 Size=0x1
        };
    };
...
struct _NDIS_ENCAPSULATED_PACKET_TASK_OFFLOAD// Size=0x8 (Id=1898)
{
...
struct _NDIS_ENCAPSULATED_PACKET_TASK_OFFLOAD_V2// Size=0x14 (Id=1946)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x4 (Id=0)
        ...
        unsigned long MaxHeaderSizeSupported;// Offset=0x4 Size=0x4
        union _ENCAPSULATION_PROTOCOL_INFO// Size=0x4 (Id=6378)
        {
            struct _VXLAN_INFO// Size=0x4 (Id=6379)
            {
...
struct _NDIS_RFC6877_464XLAT_OFFLOAD// Size=0x8 (Id=1365)
{
...
struct _NDIS_OFFLOAD// Size=0xd8 (Id=1033)
{
...
struct _NDIS_OFFLOAD_ENCAPSULATION// Size=0x1c (Id=1548)
{
    union // Size=0x10 (Id=0)
    {
        struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
        struct <unnamed-type-IPv4>// Size=0xc (Id=9689)
        {
        ...
        struct <unnamed-type-IPv6>// Size=0xc (Id=9694)
        {
            unsigned long Enabled;// Offset=0x0 Size=0x4
            unsigned long EncapsulationType;// Offset=0x4 Size=0x4
            unsigned long HeaderSize;// Offset=0x8 Size=0x4
...
struct _NDIS_TCP_CONNECTION_OFFLOAD// Size=0x14 (Id=1968)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_TCP_CONNECTION_OFFLOAD_PARAMETERS// Size=0x3c (Id=1426)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
...
struct _NDIS_MINIPORT_OFFLOAD// Size=0x538 (Id=1121)
{
