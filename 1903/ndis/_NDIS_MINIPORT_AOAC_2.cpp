...
struct _NDIS_SS_STOP_FLAGS// Size=0x4 (Id=1294)
{
    union // Size=0x4 (Id=0)
    {
...
struct _NDIS_AOAC_WAKE_FLAGS// Size=0x4 (Id=1274)
{
    union // Size=0x4 (Id=0)
    {
        struct // Size=0x4 (Id=0)
...
struct _NDIS_AOAC_COMPONENT_REF_TIME// Size=0x10 (Id=1960)
{
    unsigned long long TotalRefTime;// Offset=0x0 Size=0x8
    unsigned long long CurrentRefStartTime;// Offset=0x8 Size=0x8
};

struct _NDIS_MINIPORT_CS_TRAFFIC_STATS// Size=0x30 (Id=1154)
{
...
struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS// Size=0x2c (Id=1387)
{
...
struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX// Size=0x14 (Id=1545)
{
...
struct _NDIS_MINIPORT_AOAC// Size=0x498 (Id=984)
{
    ...
    long PendingPnPOpCount;// Offset=0x38 Size=0x4
    long PendingBindChangesCount;// Offset=0x3c Size=0x4
    enum _NDIS_TMP_REF_REASON TempRefReason;// Offset=0x40 Size=0x4
    struct _NDIS_TIMER TempRefTimer;// Offset=0x48 Size=0x80
    struct _NDIS_WORK_ITEM TempRefWorkItem;// Offset=0xc8 Size=0x50
    unsigned char TempDerefInProgress;// Offset=0x118 Size=0x1
    unsigned long DerefTimeoutMilliseconds;// Offset=0x11c Size=0x4
    unsigned char WakeWorkItemScheduled;// Offset=0x120 Size=0x1
    enum _NDIS_MINIPORT_EVENT WakeWorkItemWakeReason;// Offset=0x122 Size=0x2
    struct _NDIS_WORK_ITEM WakeWorkItem;// Offset=0x128 Size=0x50
    enum _NDIS_NIC_ACTIVE_STATE ActiveState;// Offset=0x178 Size=0x4
    struct _NDIS_SS_STOP_FLAGS StopFlags;// Offset=0x17c Size=0x4
    unsigned char SSIdleConfirmed;// Offset=0x180 Size=0x1
    unsigned char SSIdleConfirmInProgress;// Offset=0x181 Size=0x1
    unsigned char RemoteWakeEnabled;// Offset=0x182 Size=0x1
    unsigned char DeviceGone;// Offset=0x183 Size=0x1
    struct _NDIS_AOAC_WAKE_FLAGS WakeFlags;// Offset=0x184 Size=0x4
    struct _KEVENT PowerSuspendCompleteEvent;// Offset=0x188 Size=0x18
    struct _KEVENT WdfAoAcDisengagedEvent;// Offset=0x1a0 Size=0x18
    unsigned char WdfAoAcTransition;// Offset=0x1b8 Size=0x1
    struct _KEVENT NicQuietCheckCompleteEvent;// Offset=0x1c0 Size=0x18
    unsigned long long StartTime;// Offset=0x1d8 Size=0x8
    unsigned short LastUnexpectedFailureLine[2];// Offset=0x1e0 Size=0x4
    unsigned char TakeStartToRefTime;// Offset=0x1e4 Size=0x1
    union _LARGE_INTEGER LastWakeTime;// Offset=0x1e8 Size=0x8
    unsigned char TakeWakeToRefTime;// Offset=0x1f0 Size=0x1
    long ComponentRefCounts[17];// Offset=0x1f4 Size=0x44
    struct _NDIS_AOAC_COMPONENT_REF_TIME CsRefTimes[17];// Offset=0x238 Size=0x110
    long CsPowerTransitions;// Offset=0x348 Size=0x4
    unsigned long long TotalCsActiveTime;// Offset=0x350 Size=0x8
    unsigned long long TotalCsResiliencyTime;// Offset=0x358 Size=0x8
    unsigned long long CurrentActiveStartTime;// Offset=0x360 Size=0x8
    unsigned long long CurrentCsResiliencyStartTime;// Offset=0x368 Size=0x8
    unsigned long CsSurpriseWakes;// Offset=0x370 Size=0x4
    unsigned long CsSpuriousWakes;// Offset=0x374 Size=0x4
    struct _NDIS_MINIPORT_CS_TRAFFIC_STATS CsTrafficStats[3];// Offset=0x378 Size=0x90
    struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS CsSpuriousWakeStats;// Offset=0x408 Size=0x2c
    struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX CsSpuriousWakeStatsEx;// Offset=0x434 Size=0x14
    unsigned char DirectedMacPatternPlumbed;// Offset=0x448 Size=0x1
    unsigned char IsInCsResiliency;// Offset=0x449 Size=0x1
    unsigned long LastWakePatternId;// Offset=0x44c Size=0x4
    unsigned long WakeIrpCount;// Offset=0x450 Size=0x4
    unsigned long long WakeIrpStartTime;// Offset=0x458 Size=0x8
    unsigned long long LastWakeIrpLatencyMs;// Offset=0x460 Size=0x8
    unsigned long long MaxWakeIrpLatencyMs;// Offset=0x468 Size=0x8
    unsigned long long TotalWakeIrpLatencyMs;// Offset=0x470 Size=0x8
    unsigned long SetPowerOidCount;// Offset=0x478 Size=0x4
    unsigned long long LastSetPowerOidLatencyMs;// Offset=0x480 Size=0x8
    unsigned long long MaxSetPowerOidLatencyMs;// Offset=0x488 Size=0x8
    unsigned long long TotalSetPowerOidLatencyMs;// Offset=0x490 Size=0x8
