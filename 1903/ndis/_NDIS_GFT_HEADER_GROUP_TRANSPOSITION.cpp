...
struct _NDIS_GFT_HEADER_GROUP_TRANSPOSITION// Size=0x58 (Id=1663)
{
    union // Size=0x4f (Id=0)
    {
        ...
        union <unnamed-type-IPAddress>// Size=0x20 (Id=7055)
        {
        ...
        union <unnamed-type-TransportOrEncapsulation>// Size=0x8 (Id=7068)
        {
            struct <unnamed-type-Udp>// Size=0x4 (Id=7069)
            {
            ...
            struct <unnamed-type-Tcp>// Size=0x4 (Id=7073)
            {
                unsigned short SourcePort;// Offset=0x0 Size=0x2
                unsigned short DestinationPort;// Offset=0x2 Size=0x2
            };
            ...
            struct <unnamed-type-Encapsulation>// Size=0x8 (Id=7077)
            {
