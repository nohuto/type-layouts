union _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_anonymous_2032// Size=0x4 (Id=2032)
{
    struct <unnamed-type-Transmit>// Size=0x4 (Id=11643)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_anonymous_2033::<unnamed-type-Transmit> Transmit;// Offset=0x0 Size=0x4
    struct <unnamed-type-Receive>// Size=0x4 (Id=11650)
    {
    ...
    struct _NDIS_TCP_IP_CHECKSUM_PACKET_INFO::_anonymous_2034::<unnamed-type-Receive> Receive;// Offset=0x0 Size=0x4
