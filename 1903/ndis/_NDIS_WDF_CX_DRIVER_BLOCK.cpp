...
struct _NDIS_WDF_CX_CHARACTERISTICS// Size=0x80 (Id=443)
{
    ...
    long  ( * EvtCxGetWmiEventGuid)(void * ,long ,struct _NDIS_GUID ** );// Offset=0x78 Size=0x8
};
...
struct _NDIS_WDF_CX_DRIVER_BLOCK// Size=0xa8 (Id=465)
{
    struct _NDIS_OBJECT_HEADER Header;// Offset=0x0 Size=0x4
