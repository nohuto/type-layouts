...
union _D3DKMDT_VIDEO_SIGNAL_INFO::_anonymous_433// Size=0x4 (Id=433)
{
    struct <unnamed-type-AdditionalSignalInfo>// Size=0x4 (Id=1303)
    {
    ...
    struct _D3DKMDT_VIDEO_SIGNAL_INFO::_anonymous_434::<unnamed-type-AdditionalSignalInfo> AdditionalSignalInfo;// Offset=0x0 Size=0x4
