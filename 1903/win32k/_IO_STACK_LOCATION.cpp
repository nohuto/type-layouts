union _LARGE_INTEGER// Size=0x8 (Id=75)
{
    ...
    struct <unnamed-type-u>// Size=0x8 (Id=4062)
    {
        unsigned long LowPart;// Offset=0x0 Size=0x4
        long HighPart;// Offset=0x4 Size=0x4
    };
...
struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=596)
{
    union // Size=0x4 (Id=0)
    {
...
union _POWER_STATE// Size=0x4 (Id=588)
{
...
struct _IO_STACK_LOCATION// Size=0x48 (Id=89)
{
    union // Size=0x4 (Id=0)
    {
        ...
        union <unnamed-type-Parameters>// Size=0x20 (Id=3128)
        {
            struct <unnamed-type-Create>// Size=0x20 (Id=3129)
            {
            ...
            struct <unnamed-type-CreatePipe>// Size=0x20 (Id=3137)
            {
                struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
                unsigned long Options;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-CreateMailslot>// Size=0x20 (Id=3145)
            {
                struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
                unsigned long Options;// Offset=0x8 Size=0x4
                unsigned short Reserved;// Offset=0x10 Size=0x2
            ...
            struct <unnamed-type-Read>// Size=0x18 (Id=3153)
            {
            ...
            struct <unnamed-type-Write>// Size=0x18 (Id=3159)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                unsigned long Key;// Offset=0x8 Size=0x4
                unsigned long Flags;// Offset=0xc Size=0x4
            ...
            struct <unnamed-type-QueryDirectory>// Size=0x20 (Id=3165)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-NotifyDirectory>// Size=0x10 (Id=3171)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-NotifyDirectoryEx>// Size=0x18 (Id=3175)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                unsigned long CompletionFilter;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-QueryFile>// Size=0x10 (Id=3180)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-SetFile>// Size=0x20 (Id=3184)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
                enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-QueryVolume>// Size=0x10 (Id=3193)
            {
                unsigned long Length;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-FileSystemControl>// Size=0x20 (Id=3197)
            {
            ...
            struct <unnamed-type-LockControl>// Size=0x18 (Id=3203)
            {
            ...
            struct <unnamed-type-DeviceIoControl>// Size=0x20 (Id=3208)
            {
                unsigned long OutputBufferLength;// Offset=0x0 Size=0x4
                unsigned long InputBufferLength;// Offset=0x8 Size=0x4
            ...
            struct <unnamed-type-QuerySecurity>// Size=0x10 (Id=3214)
            {
            ...
            struct <unnamed-type-SetSecurity>// Size=0x10 (Id=3218)
            {
                unsigned long SecurityInformation;// Offset=0x0 Size=0x4
            ...
            struct <unnamed-type-MountVolume>// Size=0x10 (Id=3222)
            {
            ...
            struct <unnamed-type-QueryDeviceRelations>// Size=0x4 (Id=3234)
            {
            ...
            struct <unnamed-type-QueryInterface>// Size=0x20 (Id=3237)
            {
            ...
            struct <unnamed-type-DeviceCapabilities>// Size=0x8 (Id=3246)
            {
            ...
            struct <unnamed-type-FilterResourceRequirements>// Size=0x8 (Id=3250)
            {
            ...
            struct <unnamed-type-ReadWriteConfig>// Size=0x20 (Id=3254)
            {
            ...
            struct <unnamed-type-SetLock>// Size=0x1 (Id=3260)
            {
            ...
            struct <unnamed-type-QueryId>// Size=0x4 (Id=3263)
            {
            ...
            struct <unnamed-type-QueryDeviceText>// Size=0x10 (Id=3266)
            {
            ...
            struct <unnamed-type-UsageNotification>// Size=0x10 (Id=3270)
            {
            ...
            struct <unnamed-type-WaitWake>// Size=0x4 (Id=3276)
            {
            ...
            struct <unnamed-type-PowerSequence>// Size=0x8 (Id=3279)
            {
            ...
            struct <unnamed-type-Power>// Size=0x20 (Id=3283)
            {
            ...
            struct <unnamed-type-StartDevice>// Size=0x10 (Id=3290)
            {
            ...
            struct <unnamed-type-WMI>// Size=0x20 (Id=3295)
            {
            ...
            struct <unnamed-type-Others>// Size=0x20 (Id=3301)
            {
