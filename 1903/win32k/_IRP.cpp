...
struct _KDEVICE_QUEUE_ENTRY// Size=0x18 (Id=329)
{
...
struct _IRP// Size=0xd0 (Id=86)
{
    union // Size=0x78 (Id=0)
    {
        ...
        union <unnamed-type-AssociatedIrp>// Size=0x8 (Id=3333)
        {
        ...
        union <unnamed-type-Overlay>// Size=0x10 (Id=3351)
        {
            struct <unnamed-type-AsynchronousParameters>// Size=0x10 (Id=3352)
            {
        ...
        union <unnamed-type-Tail>// Size=0x58 (Id=3363)
        {
            struct <unnamed-type-Overlay>// Size=0x58 (Id=3364)
            {
