struct _anonymous_125// Size=0x20 (Id=125)
{
...
struct _anonymous_126// Size=0x20 (Id=126)
{
    struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
    unsigned long Options;// Offset=0x8 Size=0x4
...
struct _anonymous_127// Size=0x20 (Id=127)
{
    struct _IO_SECURITY_CONTEXT * SecurityContext;// Offset=0x0 Size=0x8
    unsigned long Options;// Offset=0x8 Size=0x4
    unsigned short Reserved;// Offset=0x10 Size=0x2
...
struct _anonymous_128// Size=0x18 (Id=128)
{
...
struct _anonymous_130// Size=0x20 (Id=130)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_133// Size=0x18 (Id=133)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    unsigned long CompletionFilter;// Offset=0x8 Size=0x4
...
struct _anonymous_134// Size=0x10 (Id=134)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
};

struct _anonymous_135// Size=0x20 (Id=135)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    enum _FILE_INFORMATION_CLASS FileInformationClass;// Offset=0x8 Size=0x4
...
struct _anonymous_136// Size=0x20 (Id=136)
{
    unsigned long Length;// Offset=0x0 Size=0x4
...
struct _anonymous_139// Size=0x10 (Id=139)
{
    unsigned long Length;// Offset=0x0 Size=0x4
    enum _FSINFOCLASS FsInformationClass;// Offset=0x8 Size=0x4
};

struct _anonymous_140// Size=0x20 (Id=140)
{
...
struct _anonymous_141// Size=0x18 (Id=141)
{
...
struct _anonymous_142// Size=0x20 (Id=142)
{
    unsigned long OutputBufferLength;// Offset=0x0 Size=0x4
    unsigned long InputBufferLength;// Offset=0x8 Size=0x4
...
struct _anonymous_143// Size=0x10 (Id=143)
{
...
struct _anonymous_150// Size=0x4 (Id=150)
{
    enum _DEVICE_RELATION_TYPE Type;// Offset=0x0 Size=0x4
};

struct _anonymous_151// Size=0x20 (Id=151)
{
...
struct _anonymous_155// Size=0x1 (Id=155)
{
    unsigned char Lock;// Offset=0x0 Size=0x1
};

struct _anonymous_157// Size=0x4 (Id=157)
{
...
struct _anonymous_161// Size=0x10 (Id=161)
{
...
struct _anonymous_163// Size=0x4 (Id=163)
{
    enum _SYSTEM_POWER_STATE PowerState;// Offset=0x0 Size=0x4
};

struct _anonymous_164// Size=0x8 (Id=164)
{
    struct _POWER_SEQUENCE * PowerSequence;// Offset=0x0 Size=0x8
};

struct _SYSTEM_POWER_STATE_CONTEXT// Size=0x4 (Id=1113)
{
    union // Size=0x4 (Id=0)
    {
...
struct _anonymous_168// Size=0x10 (Id=168)
{
...
struct _anonymous_169// Size=0x20 (Id=169)
{
...
struct _anonymous_170// Size=0x20 (Id=170)
{
...
union _anonymous_171// Size=0x20 (Id=171)
{
    struct _anonymous_125 Create;// Offset=0x0 Size=0x20
    struct _anonymous_126 CreatePipe;// Offset=0x0 Size=0x20
    struct _anonymous_127 CreateMailslot;// Offset=0x0 Size=0x20
    struct _anonymous_128 Read;// Offset=0x0 Size=0x18
    struct _anonymous_128 Write;// Offset=0x0 Size=0x18
    struct _anonymous_130 QueryDirectory;// Offset=0x0 Size=0x20
    struct _anonymous_131 NotifyDirectory;// Offset=0x0 Size=0x10
    struct _anonymous_133 NotifyDirectoryEx;// Offset=0x0 Size=0x18
    struct _anonymous_134 QueryFile;// Offset=0x0 Size=0x10
    struct _anonymous_135 SetFile;// Offset=0x0 Size=0x20
    struct _anonymous_136 QueryEa;// Offset=0x0 Size=0x20
    struct _anonymous_137 SetEa;// Offset=0x0 Size=0x4
    struct _anonymous_139 QueryVolume;// Offset=0x0 Size=0x10
    struct _anonymous_139 SetVolume;// Offset=0x0 Size=0x10
    struct _anonymous_140 FileSystemControl;// Offset=0x0 Size=0x20
    struct _anonymous_141 LockControl;// Offset=0x0 Size=0x18
    struct _anonymous_142 DeviceIoControl;// Offset=0x0 Size=0x20
    struct _anonymous_143 QuerySecurity;// Offset=0x0 Size=0x10
    struct _anonymous_144 SetSecurity;// Offset=0x0 Size=0x10
    struct _anonymous_145 MountVolume;// Offset=0x0 Size=0x10
    struct _anonymous_145 VerifyVolume;// Offset=0x0 Size=0x10
    struct _anonymous_147 Scsi;// Offset=0x0 Size=0x8
    struct _anonymous_148 QueryQuota;// Offset=0x0 Size=0x20
    struct _anonymous_137 SetQuota;// Offset=0x0 Size=0x4
    struct _anonymous_150 QueryDeviceRelations;// Offset=0x0 Size=0x4
    struct _anonymous_151 QueryInterface;// Offset=0x0 Size=0x20
    struct _anonymous_152 DeviceCapabilities;// Offset=0x0 Size=0x8
    struct _anonymous_153 FilterResourceRequirements;// Offset=0x0 Size=0x8
    struct _anonymous_154 ReadWriteConfig;// Offset=0x0 Size=0x20
    struct _anonymous_155 SetLock;// Offset=0x0 Size=0x1
    struct _anonymous_157 QueryId;// Offset=0x0 Size=0x4
    struct _anonymous_159 QueryDeviceText;// Offset=0x0 Size=0x10
    struct _anonymous_161 UsageNotification;// Offset=0x0 Size=0x10
    struct _anonymous_163 WaitWake;// Offset=0x0 Size=0x4
    struct _anonymous_164 PowerSequence;// Offset=0x0 Size=0x8
    struct _anonymous_167 Power;// Offset=0x0 Size=0x20
    struct _anonymous_168 StartDevice;// Offset=0x0 Size=0x10
    struct _anonymous_169 WMI;// Offset=0x0 Size=0x20
    struct _anonymous_170 Others;// Offset=0x0 Size=0x20
};

struct _IO_STACK_LOCATION// Size=0x48 (Id=172)
{
    ...
    union _anonymous_171 Parameters;// Offset=0x8 Size=0x20
