struct _MI_PARTITION_FLAGS// Size=0x4 (Id=1642)
{
...
union _anonymous_1188// Size=0x4 (Id=1188)
{
...
struct _MI_PARTITION_CORE// Size=0x1b0 (Id=1189)
{
    unsigned short PartitionId;// Offset=0x0 Size=0x2
    union _anonymous_1188 u;// Offset=0x4 Size=0x4
    ...
    unsigned long long TotalHugeIoRanges;// Offset=0x1a0 Size=0x8
    unsigned long long NonChargedSecurePages;// Offset=0x1a8 Size=0x8
};

struct _MMPAGE_FILE_EXPANSION_FLAGS// Size=0x4 (Id=1840)
{
    struct // Size=0x4 (Id=0)
    {
...
union _anonymous_1341// Size=0x4 (Id=1341)
{
    unsigned long LongFlags;// Offset=0x0 Size=0x4
    struct _MMPAGE_FILE_EXPANSION_FLAGS Flags;// Offset=0x0 Size=0x4
};

struct _MMPAGE_FILE_EXPANSION// Size=0x58 (Id=1342)
{
    ...
    union _anonymous_1341 u1;// Offset=0x4c Size=0x4
...
struct _MMMOD_WRITER_LISTHEAD// Size=0x28 (Id=1650)
{
...
union _MI_RESERVATION_CLUSTER_INFO// Size=0x4 (Id=1744)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_MODWRITE_DATA// Size=0x40 (Id=1745)
{
...
struct _MI_RESTRICTED_MODWRITES// Size=0x3 (Id=1842)
{
...
struct _MI_PARTITION_MODWRITES// Size=0x2c0 (Id=1532)
{
...
struct _MI_PARTITION_STORES// Size=0x90 (Id=782)
{
    union _anonymous_781 WriteAllStoreHintedPages;// Offset=0x0 Size=0x4
...
struct _MMDEREFERENCE_SEGMENT_HEADER// Size=0x50 (Id=1707)
{
...
struct _MI_PTE_CHAIN_HEAD// Size=0x18 (Id=1797)
{
...
struct _MI_CROSS_PARTITION_CHARGES// Size=0x20 (Id=1739)
{
...
struct _MI_PARTITION_SEGMENTS// Size=0x340 (Id=1300)
{
...
struct _MI_DECAY_TIMER_LINKAGE// Size=0x8 (Id=1448)
{
    struct // Size=0x8 (Id=0)
    {
...
union _anonymous_1069// Size=0x8 (Id=1069)
{
    unsigned long long Long;// Offset=0x0 Size=0x8
    struct _MI_DECAY_TIMER_LINKAGE e1;// Offset=0x0 Size=0x8
};

struct _MI_DECAY_TIMER_LINK// Size=0x8 (Id=1070)
{
    union _anonymous_1069 u1;// Offset=0x0 Size=0x8
};

struct _MI_LDW_WORK_CONTEXT// Size=0x38 (Id=1265)
{
...
struct _MI_AVAILABLE_PAGE_WAIT_STATES// Size=0x20 (Id=1303)
{
...
struct _MI_LARGE_PAGE_CANDIDATES// Size=0x208 (Id=1243)
{
    unsigned short Hand;// Offset=0x0 Size=0x2
    unsigned short ActiveEntryCount;// Offset=0x2 Size=0x2
    unsigned char Overflowed;// Offset=0x4 Size=0x1
    unsigned long long PageFrames[64];// Offset=0x8 Size=0x200
};
...
union _anonymous_1445// Size=0x4 (Id=1445)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MI_SLAB_ALLOCATOR_CONTEXT// Size=0x78 (Id=1446)
{
    ...
    union _anonymous_1445 Flags;// Offset=0x38 Size=0x4
...
struct _MI_PARTITION_PAGE_LISTS// Size=0x13c0 (Id=1068)
{
    ...
    unsigned char RebuildLargePageCandidates;// Offset=0xfa0 Size=0x1
    unsigned char RebuildLargePageActive;// Offset=0xfa1 Size=0x1
    ...
    struct _MI_SLAB_ALLOCATOR_CONTEXT SlabContexts[2][4];// Offset=0xfb8 Size=0x3c0
    struct _RTL_BITMAP_EX SlabPfnBitMap;// Offset=0x1378 Size=0x10
    void * HugePfnLists;// Offset=0x1388 Size=0x8
    unsigned long long AvailableHugeIoRanges;// Offset=0x1390 Size=0x8
};

struct _MI_PARTITION_COMMIT// Size=0x80 (Id=1422)
{
...
struct _MI_PARTITION_ZEROING// Size=0x68 (Id=1380)
{
...
struct _MI_PAGE_COMBINING_SUPPORT// Size=0x190 (Id=1088)
{
...
struct _MMWORKING_SET_EXPANSION_HEAD// Size=0x10 (Id=827)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
};
...
struct _anonymous_1201// Size=0x38 (Id=1201)
{
    struct _MDL Mdl;// Offset=0x0 Size=0x30
    unsigned long long Page[1];// Offset=0x30 Size=0x8
};

struct _MI_PAGEFILE_TRACES// Size=0x78 (Id=1202)
{
    ...
    struct _anonymous_1201 MdlHack;// Offset=0x40 Size=0x38
};

struct _MI_VISIBLE_PARTITION// Size=0x1200 (Id=888)
{
...
struct _MI_PARTITION// Size=0x30c0 (Id=310)
{
    struct _MI_PARTITION_CORE Core;// Offset=0x0 Size=0x1b0
    struct _MI_PARTITION_MODWRITES Modwriter;// Offset=0x1b0 Size=0x2c0
    struct _MI_PARTITION_STORES Store;// Offset=0x470 Size=0x90
    struct _MI_PARTITION_SEGMENTS Segments;// Offset=0x500 Size=0x340
    struct _MI_PARTITION_PAGE_LISTS PageLists;// Offset=0x840 Size=0x13c0
    struct _MI_PARTITION_COMMIT Commit;// Offset=0x1c00 Size=0x80
    struct _MI_PARTITION_ZEROING Zeroing;// Offset=0x1c80 Size=0x68
    struct _MI_PAGE_COMBINING_SUPPORT PageCombine;// Offset=0x1ce8 Size=0x190
    void * WorkingSetControl;// Offset=0x1e78 Size=0x8
    struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;// Offset=0x1e80 Size=0x10
    unsigned long SessionDetachTimeStamp;// Offset=0x1e90 Size=0x4
    struct _MI_VISIBLE_PARTITION Vp;// Offset=0x1ec0 Size=0x1200
};
