...
struct _PO_FX_COMPONENT_PERF_SET// Size=0x30 (Id=1908)
{
    ...
    {
        struct _anonymous_1906 Discrete;// Offset=0x20 Size=0x10
        struct _anonymous_1907 Range;// Offset=0x20 Size=0x10
    };
};
