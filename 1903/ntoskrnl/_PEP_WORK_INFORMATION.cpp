...
struct _PEP_WORK_ACTIVE_COMPLETE// Size=0x10 (Id=1901)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned long Component;// Offset=0x8 Size=0x4
};

struct _PEP_WORK_IDLE_STATE// Size=0x10 (Id=1870)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned long Component;// Offset=0x8 Size=0x4
...
struct _PEP_WORK_DEVICE_POWER// Size=0x10 (Id=1887)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned char PowerRequired;// Offset=0x8 Size=0x1
};

struct _PEP_WORK_POWER_CONTROL// Size=0x38 (Id=1886)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
...
struct _PEP_WORK_DEVICE_IDLE// Size=0x10 (Id=1926)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned char IgnoreIdleTimeout;// Offset=0x8 Size=0x1
};

struct _PEP_WORK_COMPLETE_IDLE_STATE// Size=0x10 (Id=1899)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned long Component;// Offset=0x8 Size=0x4
};

struct _PEP_WORK_COMPLETE_PERF_STATE// Size=0x10 (Id=1865)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned long Component;// Offset=0x8 Size=0x4
...
struct _PEP_WORK_ACPI_NOTIFY// Size=0x10 (Id=1847)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
    unsigned long NotifyCode;// Offset=0x8 Size=0x4
};

struct _PEP_WORK_ACPI_EVALUATE_CONTROL_METHOD_COMPLETE// Size=0x28 (Id=1839)
{
    struct POHANDLE__ * DeviceHandle;// Offset=0x0 Size=0x8
...
struct _PEP_WORK_INFORMATION// Size=0x40 (Id=1832)
{
