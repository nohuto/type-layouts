...
union _PPM_POLICY_SETTINGS_MASK// Size=0x8 (Id=724)
{
    ...
    struct // Size=0x8 (Id=0)
    {
        ...
        unsigned long Spare:12;// Offset=0x4 Size=0x4 BitOffset=0x14 BitSize=0xc
    };
};
...
struct _PPM_ENGINE_SETTINGS// Size=0xaa8 (Id=446)
{
    ...
    unsigned char AllowScaling;// Offset=0x90 Size=0x1
    unsigned char IdleDisabled;// Offset=0x91 Size=0x1
    unsigned long IdleTimeCheck;// Offset=0x94 Size=0x4
    unsigned char IdleDemotePercent;// Offset=0x98 Size=0x1
    unsigned char IdlePromotePercent;// Offset=0x99 Size=0x1
    unsigned char IdleStateMax;// Offset=0x9a Size=0x1
    unsigned char HeteroDecreaseTime;// Offset=0x9b Size=0x1
    unsigned char HeteroIncreaseTime;// Offset=0x9c Size=0x1
    unsigned char HeteroDecreaseThreshold[1280];// Offset=0x9d Size=0x500
    unsigned char HeteroIncreaseThreshold[1280];// Offset=0x59d Size=0x500
    unsigned char Class0FloorPerformance;// Offset=0xa9d Size=0x1
    unsigned char Class1InitialPerformance;// Offset=0xa9e Size=0x1
    enum _KHETERO_CPU_POLICY ThreadPolicies[2];// Offset=0xaa0 Size=0x8
};

struct _POP_PPM_PROFILE// Size=0x15a0 (Id=445)
{
    ...
    struct _PPM_ENGINE_SETTINGS Settings[2];// Offset=0x28 Size=0x1550
    unsigned long long StartTime;// Offset=0x1578 Size=0x8
    unsigned long long Count;// Offset=0x1580 Size=0x8
    unsigned long long MaxDuration;// Offset=0x1588 Size=0x8
    unsigned long long MinDuration;// Offset=0x1590 Size=0x8
    unsigned long long TotalDuration;// Offset=0x1598 Size=0x8
};
