struct _DBGKD_READ_MEMORY64// Size=0x10 (Id=398)
{
...
struct _DBGKD_WRITE_MEMORY64// Size=0x10 (Id=400)
{
    unsigned long long TargetBaseAddress;// Offset=0x0 Size=0x8
    unsigned long TransferCount;// Offset=0x8 Size=0x4
...
struct _X86_DBGKD_CONTROL_SET// Size=0x10 (Id=1239)
{
    unsigned long TraceFlag;// Offset=0x0 Size=0x4
...
struct _IA64_DBGKD_CONTROL_SET// Size=0x14 (Id=1410)
{
...
struct _ARM_DBGKD_CONTROL_SET// Size=0xc (Id=1085)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
...
struct _ARM64_DBGKD_CONTROL_SET// Size=0x18 (Id=1277)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
...
struct _ARMCE_DBGKD_CONTROL_SET// Size=0xc (Id=834)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
    unsigned long CurrentSymbolStart;// Offset=0x4 Size=0x4
    unsigned long CurrentSymbolEnd;// Offset=0x8 Size=0x4
...
struct _PPC_DBGKD_CONTROL_SET// Size=0xc (Id=1533)
{
    unsigned long Continue;// Offset=0x0 Size=0x4
    unsigned long CurrentSymbolStart;// Offset=0x4 Size=0x4
    unsigned long CurrentSymbolEnd;// Offset=0x8 Size=0x4
...
struct _DBGKD_ANY_CONTROL_SET// Size=0x1c (Id=686)
{
...
struct _DBGKD_READ_WRITE_IO64// Size=0x10 (Id=404)
{
...
struct _DBGKD_READ_WRITE_IO_EXTENDED64// Size=0x20 (Id=406)
{
...
struct _DBGKD_QUERY_SPECIAL_CALLS// Size=0x4 (Id=664)
{
    unsigned long NumberOfSpecialCalls;// Offset=0x0 Size=0x4
};

struct _DBGKD_SET_SPECIAL_CALL64// Size=0x8 (Id=409)
{
    unsigned long long SpecialCall;// Offset=0x0 Size=0x8
};

struct _DBGKD_SET_INTERNAL_BREAKPOINT64// Size=0x10 (Id=411)
{
    unsigned long long BreakpointAddress;// Offset=0x0 Size=0x8
    unsigned long Flags;// Offset=0x8 Size=0x4
};

struct _DBGKD_GET_INTERNAL_BREAKPOINT64// Size=0x20 (Id=412)
{
    unsigned long long BreakpointAddress;// Offset=0x0 Size=0x8
    unsigned long Flags;// Offset=0x8 Size=0x4
...
struct _DBGKD_GET_VERSION64// Size=0x28 (Id=1431)
{
...
struct _DBGKD_SEARCH_MEMORY// Size=0x18 (Id=420)
{
    union // Size=0x8 (Id=0)
    {
...
struct _DBGKD_GET_SET_BUS_DATA// Size=0x14 (Id=703)
{
...
struct _DBGKD_FILL_MEMORY// Size=0x10 (Id=1541)
{
...
struct _DBGKD_QUERY_MEMORY// Size=0x18 (Id=778)
{
    unsigned long long Address;// Offset=0x0 Size=0x8
...
struct _DBGKD_SWITCH_PARTITION// Size=0x4 (Id=1402)
{
    unsigned long Partition;// Offset=0x0 Size=0x4
};

struct _DBGKD_CONTEXT_EX// Size=0xc (Id=1453)
{
...
struct _DBGKD_WRITE_CUSTOM_BREAKPOINT// Size=0x18 (Id=777)
{
    unsigned long long BreakPointAddress;// Offset=0x0 Size=0x8
...
union _anonymous_414// Size=0x28 (Id=414)
{
...
struct _DBGKD_MANIPULATE_STATE64// Size=0x38 (Id=415)
{
    ...
    union _anonymous_414 u;// Offset=0x10 Size=0x28
};
