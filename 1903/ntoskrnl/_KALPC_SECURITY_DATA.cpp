...
struct _anonymous_574// Size=0x4 (Id=574)
{
...
union _anonymous_575// Size=0x4 (Id=575)
{
    struct _anonymous_574 s1;// Offset=0x0 Size=0x4
};

struct _KALPC_SECURITY_DATA// Size=0x70 (Id=576)
{
    ...
    union _anonymous_575 u1;// Offset=0x68 Size=0x4
};
