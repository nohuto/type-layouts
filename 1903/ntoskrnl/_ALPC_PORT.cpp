...
struct _ALPC_PORT_ATTRIBUTES// Size=0x48 (Id=790)
{
...
struct _anonymous_558// Size=0x4 (Id=558)
{
...
union _anonymous_559// Size=0x4 (Id=559)
{
    struct _anonymous_558 s1;// Offset=0x0 Size=0x4
    unsigned long State;// Offset=0x0 Size=0x4
};

struct _ALPC_PORT// Size=0x1d8 (Id=560)
{
    ...
    union _anonymous_559 u1;// Offset=0x1a0 Size=0x4
