...
struct _anonymous_1645// Size=0xc (Id=1645)
{
...
union _anonymous_1646// Size=0xc (Id=1646)
{
    struct _anonymous_1645 Msi;// Offset=0x0 Size=0xc
};

struct _INTERRUPT_REMAPPING_INFO// Size=0x10 (Id=1647)
{
    ...
    union _anonymous_1646 u;// Offset=0x4 Size=0xc
};

struct _anonymous_1098// Size=0x8 (Id=1098)
{
...
struct _anonymous_1104// Size=0x4 (Id=1104)
{
    struct // Size=0x4 (Id=0)
    {
...
union _anonymous_1105// Size=0x4 (Id=1105)
{
    struct _anonymous_1104 bits;// Offset=0x0 Size=0x4
...
struct _INTERRUPT_HT_INTR_INFO// Size=0x8 (Id=1108)
{
    union _anonymous_1105 LowPart;// Offset=0x0 Size=0x4
    union _anonymous_1107 HighPart;// Offset=0x4 Size=0x4
};

struct _anonymous_1100// Size=0x8 (Id=1100)
{
    struct _INTERRUPT_HT_INTR_INFO IntrInfo;// Offset=0x0 Size=0x8
};

struct _anonymous_1102// Size=0x4 (Id=1102)
{
    enum HAL_APIC_DESTINATION_MODE DestinationMode;// Offset=0x0 Size=0x4
};

struct _INTERRUPT_VECTOR_DATA// Size=0x58 (Id=1103)
{
    ...
    struct _anonymous_1098 ControllerInput;// Offset=0x38 Size=0x8
    unsigned long long HvDeviceId;// Offset=0x40 Size=0x8
    union // Size=0x58 (Id=0)
    {
        struct _anonymous_1099 XapicMessage;// Offset=0x48 Size=0x10
        struct _anonymous_1100 Hypertransport;// Offset=0x48 Size=0x8
        struct _anonymous_1099 GenericMessage;// Offset=0x48 Size=0x10
        struct _anonymous_1102 MessageRequest;// Offset=0x48 Size=0x4
    };
};

struct _INTERRUPT_CONNECTION_DATA// Size=0x60 (Id=1644)
{
