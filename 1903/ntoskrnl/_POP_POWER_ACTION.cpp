...
struct _anonymous_1369// Size=0x18 (Id=1369)
{
...
struct _POP_POWER_ACTION// Size=0x1c0 (Id=1371)
{
    ...
    struct _anonymous_1369 WakeAlarm[3];// Offset=0x68 Size=0x48
    ...
    struct _KDPC WatchdogDpc;// Offset=0x118 Size=0x40
    struct _KTIMER WatchdogTimer;// Offset=0x158 Size=0x40
    unsigned char WatchdogInitialized;// Offset=0x198 Size=0x1
    enum _POP_POWER_ACTION_WATCHDOG_STATE WatchdogState;// Offset=0x19c Size=0x4
    unsigned long long WatchdogStartTime;// Offset=0x1a0 Size=0x8
    struct _KTHREAD * ActionWorkerThread;// Offset=0x1a8 Size=0x8
    struct _KTHREAD * PromoteActionWorkerThread;// Offset=0x1b0 Size=0x8
    struct _KTHREAD * UnlockAfterSleepWorkerThread;// Offset=0x1b8 Size=0x8
};
