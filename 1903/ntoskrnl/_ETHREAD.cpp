...
union _KWAIT_STATUS_REGISTER// Size=0x1 (Id=1242)
{
...
struct _KAPC_STATE// Size=0x30 (Id=1130)
{
...
struct _KTIMER// Size=0x40 (Id=1437)
{
...
struct _KWAIT_BLOCK// Size=0x30 (Id=1192)
{
...
struct _GROUP_AFFINITY// Size=0x10 (Id=384)
{
...
struct _KLOCK_ENTRY_LOCK_STATE// Size=0x10 (Id=1268)
{
    union // Size=0x8 (Id=0)
    {
...
union _KLOCK_ENTRY_BOOST_BITMAP// Size=0x4 (Id=701)
{
...
struct _KLOCK_ENTRY// Size=0x60 (Id=683)
{
...
struct _KTHREAD// Size=0x600 (Id=69)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    ...
    unsigned long long TracingPrivate[1];// Offset=0x5e8 Size=0x8
    void * SchedulerAssist;// Offset=0x5f0 Size=0x8
    void * AbWaitObject;// Offset=0x5f8 Size=0x8
};
...
struct _CLIENT_ID// Size=0x10 (Id=697)
{
    void * UniqueProcess;// Offset=0x0 Size=0x8
    void * UniqueThread;// Offset=0x8 Size=0x8
};

struct _KSEMAPHORE// Size=0x20 (Id=382)
{
    struct _DISPATCHER_HEADER Header;// Offset=0x0 Size=0x18
    long Limit;// Offset=0x18 Size=0x4
};

union _PS_CLIENT_SECURITY_CONTEXT// Size=0x8 (Id=1233)
{
...
struct _PS_PROPERTY_SET// Size=0x18 (Id=783)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
    unsigned long long Lock;// Offset=0x10 Size=0x8
};

struct _ETHREAD// Size=0x820 (Id=109)
{
    struct _KTHREAD Tcb;// Offset=0x0 Size=0x600
    union _LARGE_INTEGER CreateTime;// Offset=0x600 Size=0x8
    union // Size=0x8 (Id=0)
    {
        union _LARGE_INTEGER ExitTime;// Offset=0x608 Size=0x8
        struct _LIST_ENTRY KeyedWaitChain;// Offset=0x608 Size=0x10
    };
    union // Size=0x10 (Id=0)
    {
        struct _LIST_ENTRY PostBlockList;// Offset=0x618 Size=0x10
        void * ForwardLinkShadow;// Offset=0x618 Size=0x8
    };
    void * StartAddress;// Offset=0x620 Size=0x8
    union // Size=0x630 (Id=0)
    {
        struct _TERMINATION_PORT * TerminationPort;// Offset=0x628 Size=0x8
        struct _ETHREAD * ReaperLink;// Offset=0x628 Size=0x8
        void * KeyedWaitValue;// Offset=0x628 Size=0x8
    };
    unsigned long long ActiveTimerListLock;// Offset=0x630 Size=0x8
    struct _LIST_ENTRY ActiveTimerListHead;// Offset=0x638 Size=0x10
    struct _CLIENT_ID Cid;// Offset=0x648 Size=0x10
    union // Size=0x20 (Id=0)
    {
        struct _KSEMAPHORE KeyedWaitSemaphore;// Offset=0x658 Size=0x20
        struct _KSEMAPHORE AlpcWaitSemaphore;// Offset=0x658 Size=0x20
    };
    union _PS_CLIENT_SECURITY_CONTEXT ClientSecurity;// Offset=0x678 Size=0x8
    struct _LIST_ENTRY IrpList;// Offset=0x680 Size=0x10
    unsigned long long TopLevelIrp;// Offset=0x690 Size=0x8
    struct _DEVICE_OBJECT * DeviceToVerify;// Offset=0x698 Size=0x8
    void * Win32StartAddress;// Offset=0x6a0 Size=0x8
    void * ChargeOnlySession;// Offset=0x6a8 Size=0x8
    void * LegacyPowerObject;// Offset=0x6b0 Size=0x8
    struct _LIST_ENTRY ThreadListEntry;// Offset=0x6b8 Size=0x10
    struct _EX_RUNDOWN_REF RundownProtect;// Offset=0x6c8 Size=0x8
    struct _EX_PUSH_LOCK ThreadLock;// Offset=0x6d0 Size=0x8
    unsigned long ReadClusterSize;// Offset=0x6d8 Size=0x4
    long MmLockOrdering;// Offset=0x6dc Size=0x4
    union // Size=0x4 (Id=0)
    {
        unsigned long CrossThreadFlags;// Offset=0x6e0 Size=0x4
        struct // Size=0x4 (Id=0)
        {
            unsigned long Terminated:1;// Offset=0x6e0 Size=0x4 BitOffset=0x0 BitSize=0x1
            unsigned long ThreadInserted:1;// Offset=0x6e0 Size=0x4 BitOffset=0x1 BitSize=0x1
            unsigned long HideFromDebugger:1;// Offset=0x6e0 Size=0x4 BitOffset=0x2 BitSize=0x1
            unsigned long ActiveImpersonationInfo:1;// Offset=0x6e0 Size=0x4 BitOffset=0x3 BitSize=0x1
            unsigned long HardErrorsAreDisabled:1;// Offset=0x6e0 Size=0x4 BitOffset=0x4 BitSize=0x1
            unsigned long BreakOnTermination:1;// Offset=0x6e0 Size=0x4 BitOffset=0x5 BitSize=0x1
            unsigned long SkipCreationMsg:1;// Offset=0x6e0 Size=0x4 BitOffset=0x6 BitSize=0x1
            unsigned long SkipTerminationMsg:1;// Offset=0x6e0 Size=0x4 BitOffset=0x7 BitSize=0x1
            unsigned long CopyTokenOnOpen:1;// Offset=0x6e0 Size=0x4 BitOffset=0x8 BitSize=0x1
            unsigned long ThreadIoPriority:3;// Offset=0x6e0 Size=0x4 BitOffset=0x9 BitSize=0x3
            unsigned long ThreadPagePriority:3;// Offset=0x6e0 Size=0x4 BitOffset=0xc BitSize=0x3
            unsigned long RundownFail:1;// Offset=0x6e0 Size=0x4 BitOffset=0xf BitSize=0x1
            unsigned long UmsForceQueueTermination:1;// Offset=0x6e0 Size=0x4 BitOffset=0x10 BitSize=0x1
            unsigned long IndirectCpuSets:1;// Offset=0x6e0 Size=0x4 BitOffset=0x11 BitSize=0x1
            unsigned long DisableDynamicCodeOptOut:1;// Offset=0x6e0 Size=0x4 BitOffset=0x12 BitSize=0x1
            unsigned long ExplicitCaseSensitivity:1;// Offset=0x6e0 Size=0x4 BitOffset=0x13 BitSize=0x1
            unsigned long PicoNotifyExit:1;// Offset=0x6e0 Size=0x4 BitOffset=0x14 BitSize=0x1
            unsigned long DbgWerUserReportActive:1;// Offset=0x6e0 Size=0x4 BitOffset=0x15 BitSize=0x1
            unsigned long ForcedSelfTrimActive:1;// Offset=0x6e0 Size=0x4 BitOffset=0x16 BitSize=0x1
            unsigned long SamplingCoverage:1;// Offset=0x6e0 Size=0x4 BitOffset=0x17 BitSize=0x1
            unsigned long ReservedCrossThreadFlags:8;// Offset=0x6e0 Size=0x4 BitOffset=0x18 BitSize=0x8
        };
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long SameThreadPassiveFlags;// Offset=0x6e4 Size=0x4
        struct // Size=0x4 (Id=0)
        {
            unsigned long ActiveExWorker:1;// Offset=0x6e4 Size=0x4 BitOffset=0x0 BitSize=0x1
            unsigned long MemoryMaker:1;// Offset=0x6e4 Size=0x4 BitOffset=0x1 BitSize=0x1
            unsigned long StoreLockThread:2;// Offset=0x6e4 Size=0x4 BitOffset=0x2 BitSize=0x2
            unsigned long ClonedThread:1;// Offset=0x6e4 Size=0x4 BitOffset=0x4 BitSize=0x1
            unsigned long KeyedEventInUse:1;// Offset=0x6e4 Size=0x4 BitOffset=0x5 BitSize=0x1
            unsigned long SelfTerminate:1;// Offset=0x6e4 Size=0x4 BitOffset=0x6 BitSize=0x1
            unsigned long RespectIoPriority:1;// Offset=0x6e4 Size=0x4 BitOffset=0x7 BitSize=0x1
            unsigned long ActivePageLists:1;// Offset=0x6e4 Size=0x4 BitOffset=0x8 BitSize=0x1
            unsigned long SecureContext:1;// Offset=0x6e4 Size=0x4 BitOffset=0x9 BitSize=0x1
            unsigned long ZeroPageThread:1;// Offset=0x6e4 Size=0x4 BitOffset=0xa BitSize=0x1
            unsigned long WorkloadClass:1;// Offset=0x6e4 Size=0x4 BitOffset=0xb BitSize=0x1
            unsigned long ReservedSameThreadPassiveFlags:20;// Offset=0x6e4 Size=0x4 BitOffset=0xc BitSize=0x14
        };
    };
    union // Size=0x4 (Id=0)
    {
        unsigned long SameThreadApcFlags;// Offset=0x6e8 Size=0x4
        struct // Size=0x2 (Id=0)
        {
            unsigned char OwnsProcessAddressSpaceExclusive:1;// Offset=0x6e8 Size=0x1 BitOffset=0x0 BitSize=0x1
            unsigned char OwnsProcessAddressSpaceShared:1;// Offset=0x6e8 Size=0x1 BitOffset=0x1 BitSize=0x1
            unsigned char HardFaultBehavior:1;// Offset=0x6e8 Size=0x1 BitOffset=0x2 BitSize=0x1
            unsigned char StartAddressInvalid:1;// Offset=0x6e8 Size=0x1 BitOffset=0x3 BitSize=0x1
            unsigned char EtwCalloutActive:1;// Offset=0x6e8 Size=0x1 BitOffset=0x4 BitSize=0x1
            unsigned char SuppressSymbolLoad:1;// Offset=0x6e8 Size=0x1 BitOffset=0x5 BitSize=0x1
            unsigned char Prefetching:1;// Offset=0x6e8 Size=0x1 BitOffset=0x6 BitSize=0x1
            unsigned char OwnsVadExclusive:1;// Offset=0x6e8 Size=0x1 BitOffset=0x7 BitSize=0x1
            unsigned char SystemPagePriorityActive:1;// Offset=0x6e9 Size=0x1 BitOffset=0x0 BitSize=0x1
            unsigned char SystemPagePriority:3;// Offset=0x6e9 Size=0x1 BitOffset=0x1 BitSize=0x3
            unsigned char AllowUserWritesToExecutableMemory:1;// Offset=0x6e9 Size=0x1 BitOffset=0x4 BitSize=0x1
            unsigned char AllowKernelWritesToExecutableMemory:1;// Offset=0x6e9 Size=0x1 BitOffset=0x5 BitSize=0x1
            unsigned char OwnsVadShared:1;// Offset=0x6e9 Size=0x1 BitOffset=0x6 BitSize=0x1
        };
    };
    unsigned char CacheManagerActive;// Offset=0x6ec Size=0x1
    unsigned char DisablePageFaultClustering;// Offset=0x6ed Size=0x1
    unsigned char ActiveFaultCount;// Offset=0x6ee Size=0x1
    unsigned char LockOrderState;// Offset=0x6ef Size=0x1
    unsigned long long AlpcMessageId;// Offset=0x6f0 Size=0x8
    union // Size=0x8 (Id=0)
    {
        void * AlpcMessage;// Offset=0x6f8 Size=0x8
        unsigned long AlpcReceiveAttributeSet;// Offset=0x6f8 Size=0x4
    };
    struct _LIST_ENTRY AlpcWaitListEntry;// Offset=0x700 Size=0x10
    long ExitStatus;// Offset=0x710 Size=0x4
    unsigned long CacheManagerCount;// Offset=0x714 Size=0x4
    unsigned long IoBoostCount;// Offset=0x718 Size=0x4
    unsigned long IoQoSBoostCount;// Offset=0x71c Size=0x4
    unsigned long IoQoSThrottleCount;// Offset=0x720 Size=0x4
    unsigned long KernelStackReference;// Offset=0x724 Size=0x4
    struct _LIST_ENTRY BoostList;// Offset=0x728 Size=0x10
    struct _LIST_ENTRY DeboostList;// Offset=0x738 Size=0x10
    unsigned long long BoostListLock;// Offset=0x748 Size=0x8
    unsigned long long IrpListLock;// Offset=0x750 Size=0x8
    void * ReservedForSynchTracking;// Offset=0x758 Size=0x8
    struct _SINGLE_LIST_ENTRY CmCallbackListHead;// Offset=0x760 Size=0x8
    struct _GUID * ActivityId;// Offset=0x768 Size=0x8
    struct _SINGLE_LIST_ENTRY SeLearningModeListHead;// Offset=0x770 Size=0x8
    void * VerifierContext;// Offset=0x778 Size=0x8
    void * AdjustedClientToken;// Offset=0x780 Size=0x8
    void * WorkOnBehalfThread;// Offset=0x788 Size=0x8
    struct _PS_PROPERTY_SET PropertySet;// Offset=0x790 Size=0x18
    void * PicoContext;// Offset=0x7a8 Size=0x8
    unsigned long long UserFsBase;// Offset=0x7b0 Size=0x8
    unsigned long long UserGsBase;// Offset=0x7b8 Size=0x8
    struct _THREAD_ENERGY_VALUES * EnergyValues;// Offset=0x7c0 Size=0x8
    void * CmDbgInfo;// Offset=0x7c8 Size=0x8
    union // Size=0x8 (Id=0)
    {
        unsigned long long SelectedCpuSets;// Offset=0x7d0 Size=0x8
        unsigned long long * SelectedCpuSetsIndirect;// Offset=0x7d0 Size=0x8
    };
    struct _EJOB * Silo;// Offset=0x7d8 Size=0x8
    struct _UNICODE_STRING * ThreadName;// Offset=0x7e0 Size=0x8
    struct _CONTEXT * SetContextState;// Offset=0x7e8 Size=0x8
    unsigned long LastExpectedRunTime;// Offset=0x7f0 Size=0x4
    unsigned long HeapData;// Offset=0x7f4 Size=0x4
    struct _LIST_ENTRY OwnerEntryListHead;// Offset=0x7f8 Size=0x10
    unsigned long long DisownedOwnerEntryListLock;// Offset=0x808 Size=0x8
    struct _LIST_ENTRY DisownedOwnerEntryListHead;// Offset=0x810 Size=0x10
};
