...
union _XPF_MCE_FLAGS// Size=0x4 (Id=1280)
{
...
union _XPF_MC_BANK_FLAGS// Size=0x1 (Id=1610)
{
...
struct _WHEA_XPF_MC_BANK_DESCRIPTOR// Size=0x1c (Id=1470)
{
...
struct _WHEA_XPF_MCE_DESCRIPTOR// Size=0x398 (Id=889)
{
...
union _WHEA_NOTIFICATION_FLAGS// Size=0x2 (Id=1703)
{
...
struct _WHEA_NOTIFICATION_DESCRIPTOR// Size=0x1c (Id=1144)
{
    unsigned char Type;// Offset=0x0 Size=0x1
    unsigned char Length;// Offset=0x1 Size=0x1
    union _WHEA_NOTIFICATION_FLAGS Flags;// Offset=0x2 Size=0x2
    union _anonymous_1143 u;// Offset=0x4 Size=0x18
};

struct _WHEA_XPF_CMC_DESCRIPTOR// Size=0x3a4 (Id=744)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char NumberOfBanks;// Offset=0x3 Size=0x1
...
struct _WHEA_XPF_NMI_DESCRIPTOR// Size=0x3 (Id=1483)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
};

struct _WHEA_IPF_MCA_DESCRIPTOR// Size=0x4 (Id=949)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
...
struct _WHEA_IPF_CMC_DESCRIPTOR// Size=0x4 (Id=1463)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
struct _WHEA_IPF_CPE_DESCRIPTOR// Size=0x4 (Id=1274)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
struct _anonymous_879// Size=0x4 (Id=879)
{
    struct // Size=0x4 (Id=0)
    {
...
union _anonymous_880// Size=0x4 (Id=880)
{
    struct _anonymous_879 bits;// Offset=0x0 Size=0x4
    unsigned long AsULONG;// Offset=0x0 Size=0x4
};

struct _WHEA_PCI_SLOT_NUMBER// Size=0x4 (Id=881)
{
    union _anonymous_880 u;// Offset=0x0 Size=0x4
};

union _AER_ROOTPORT_DESCRIPTOR_FLAGS// Size=0x2 (Id=1016)
{
    struct // Size=0x2 (Id=0)
    {
...
struct _WHEA_AER_ROOTPORT_DESCRIPTOR// Size=0x24 (Id=980)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
union _AER_ENDPOINT_DESCRIPTOR_FLAGS// Size=0x2 (Id=1769)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short UncorrectableErrorMaskRW:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_AER_ENDPOINT_DESCRIPTOR// Size=0x20 (Id=1677)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
union _AER_BRIDGE_DESCRIPTOR_FLAGS// Size=0x2 (Id=1228)
{
    struct // Size=0x2 (Id=0)
    {
        unsigned short UncorrectableErrorMaskRW:1;// Offset=0x0 Size=0x2 BitOffset=0x0 BitSize=0x1
...
struct _WHEA_AER_BRIDGE_DESCRIPTOR// Size=0x2c (Id=803)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Enabled;// Offset=0x2 Size=0x1
    unsigned char Reserved;// Offset=0x3 Size=0x1
...
struct _WHEA_GENERIC_ERROR_DESCRIPTOR// Size=0x34 (Id=858)
{
    unsigned short Type;// Offset=0x0 Size=0x2
...
struct _WHEA_GENERIC_ERROR_DESCRIPTOR_V2// Size=0x50 (Id=768)
{
    unsigned short Type;// Offset=0x0 Size=0x2
    unsigned char Reserved;// Offset=0x2 Size=0x1
    unsigned char Enabled;// Offset=0x3 Size=0x1
...
union _anonymous_714// Size=0x3a4 (Id=714)
{
...
struct _WHEA_ERROR_SOURCE_DESCRIPTOR// Size=0x3cc (Id=715)
{
    ...
    union _anonymous_714 Info;// Offset=0x28 Size=0x3a4
};

struct _WHEAP_ERROR_SOURCE// Size=0x430 (Id=639)
{
