...
struct _MMVAD_FLAGS// Size=0x4 (Id=687)
{
...
struct _MM_PRIVATE_VAD_FLAGS// Size=0x4 (Id=709)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long Lock:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
struct _MM_GRAPHICS_VAD_FLAGS// Size=0x4 (Id=824)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long Lock:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
        ...
        unsigned long GraphicsPageProtection:3;// Offset=0x0 Size=0x4 BitOffset=0x1a BitSize=0x3
    };
};

struct _MM_SHARED_VAD_FLAGS// Size=0x4 (Id=971)
{
    struct // Size=0x4 (Id=0)
    {
        unsigned long Lock:1;// Offset=0x0 Size=0x4 BitOffset=0x0 BitSize=0x1
...
union _anonymous_306// Size=0x4 (Id=306)
{
...
struct _MMVAD_FLAGS1// Size=0x4 (Id=708)
{
    struct // Size=0x4 (Id=0)
    {
...
struct _MMVAD_SHORT// Size=0x40 (Id=308)
{
    ...
    union _anonymous_306 u;// Offset=0x30 Size=0x4
    union _anonymous_307 u1;// Offset=0x34 Size=0x4
    struct _MI_VAD_EVENT_BLOCK * EventList;// Offset=0x38 Size=0x8
};

struct _MMVAD_FLAGS2// Size=0x4 (Id=1530)
{
    struct // Size=0x4 (Id=0)
    {
...
union _anonymous_1507// Size=0x4 (Id=1507)
{
...
struct _MI_VAD_SEQUENTIAL_INFO// Size=0x8 (Id=1845)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _MMVAD// Size=0x88 (Id=1509)
{
    ...
    union _anonymous_1508 u4;// Offset=0x78 Size=0x8
