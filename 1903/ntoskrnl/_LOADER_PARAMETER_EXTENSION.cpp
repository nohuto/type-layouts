struct _PROFILE_PARAMETER_BLOCK// Size=0x10 (Id=1885)
{
...
struct _LOADER_PERFORMANCE_DATA// Size=0x60 (Id=1866)
{
...
struct _BOOT_ENTROPY_SOURCE_LDR_RESULT// Size=0x68 (Id=1913)
{
...
struct _BOOT_ENTROPY_LDR_RESULT// Size=0x868 (Id=1892)
{
...
struct _LOADER_PARAMETER_HYPERVISOR_EXTENSION// Size=0x40 (Id=1882)
{
...
struct _LOADER_BUGCHECK_PARAMETERS// Size=0x28 (Id=1757)
{
...
struct _OFFLINE_CRASHDUMP_CONFIGURATION_TABLE_V2// Size=0x20 (Id=1843)
{
...
struct _LOADER_HIVE_RECOVERY_INFO// Size=0x14 (Id=1803)
{
...
struct _anonymous_1735// Size=0x10 (Id=1735)
{
    void * CodeBase;// Offset=0x0 Size=0x8
    unsigned long long CodeSize;// Offset=0x8 Size=0x8
};

struct _VSM_PERFORMANCE_DATA// Size=0x40 (Id=1791)
{
    unsigned long long LaunchVsmMark[8];// Offset=0x0 Size=0x40
};

struct _LOADER_PARAMETER_EXTENSION// Size=0xdd0 (Id=1736)
{
    ...
    struct _anonymous_1735 MiniExecutive;// Offset=0xd80 Size=0x10
