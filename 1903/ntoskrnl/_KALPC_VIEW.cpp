...
struct _anonymous_553// Size=0x4 (Id=553)
{
...
{
    struct _anonymous_553 s1;// Offset=0x0 Size=0x4
};

struct _KALPC_VIEW// Size=0x60 (Id=555)
{
    ...
    union _anonymous_554 u1;// Offset=0x48 Size=0x4
