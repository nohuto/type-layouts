struct _anonymous_986// Size=0x8 (Id=986)
{
    unsigned long long EntireField;// Offset=0x0 Size=0x8
};

struct _anonymous_987// Size=0x8 (Id=987)
{
...
union _anonymous_988// Size=0x8 (Id=988)
{
    struct _anonymous_986 e1;// Offset=0x0 Size=0x8
    struct _anonymous_987 e2;// Offset=0x0 Size=0x8
};

struct _MI_HUGE_PFN// Size=0x8 (Id=989)
{
    union _anonymous_988 u1;// Offset=0x0 Size=0x8
};
