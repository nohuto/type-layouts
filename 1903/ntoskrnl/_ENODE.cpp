...
struct _KHETERO_PROCESSOR_SET// Size=0x18 (Id=736)
{
...
struct _KNODE// Size=0x180 (Id=96)
{
    ...
    unsigned long long PpmConfiguredQosSets[4];// Offset=0x130 Size=0x20
    union _KQOS_GROUPING_SETS QosGroupingSets;// Offset=0x150 Size=0x10
    unsigned long long LLCLeaders;// Offset=0x160 Size=0x8
};
...
struct _ENODE// Size=0x1c0 (Id=97)
{
