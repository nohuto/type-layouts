...
struct _anonymous_1784// Size=0x8 (Id=1784)
{
...
struct _anonymous_1786// Size=0x2 (Id=1786)
{
    wchar_t ParentId[1];// Offset=0x0 Size=0x2
};

struct _anonymous_1787// Size=0x20 (Id=1787)
{
...
union _anonymous_1788// Size=0x20 (Id=1788)
{
    union // Size=0x20 (Id=0)
    {
        struct _anonymous_1779 DeviceClass;// Offset=0x0 Size=0x14
        struct _anonymous_1780 TargetDevice;// Offset=0x0 Size=0x2
        struct _anonymous_1780 InstallDevice;// Offset=0x0 Size=0x2
        struct _anonymous_1781 CustomNotification;// Offset=0x0 Size=0x10
        struct _anonymous_1782 ProfileNotification;// Offset=0x0 Size=0x8
        struct _anonymous_1783 PowerNotification;// Offset=0x0 Size=0x8
        struct _anonymous_1784 VetoNotification;// Offset=0x0 Size=0x8
        struct _anonymous_1785 BlockedDriverNotification;// Offset=0x0 Size=0x10
        struct _anonymous_1786 InvalidIDNotification;// Offset=0x0 Size=0x2
        struct _anonymous_1787 PowerSettingNotification;// Offset=0x0 Size=0x20
        struct _anonymous_1780 PropertyChangeNotification;// Offset=0x0 Size=0x2
        struct _anonymous_1780 DeviceInstanceNotification;// Offset=0x0 Size=0x2
    };
};

struct _PLUGPLAY_EVENT_BLOCK// Size=0x50 (Id=1789)
{
    ...
    union _anonymous_1788 u;// Offset=0x30 Size=0x20
};

struct _PNP_DEVICE_EVENT_ENTRY// Size=0xc0 (Id=1260)
{
