struct _ARBITER_TEST_ALLOCATION_PARAMETERS// Size=0x18 (Id=1696)
{
...
struct _ARBITER_RETEST_ALLOCATION_PARAMETERS// Size=0x18 (Id=998)
{
    struct _LIST_ENTRY * ArbitrationList;// Offset=0x0 Size=0x8
    unsigned long AllocateFromCount;// Offset=0x8 Size=0x4
    struct _CM_PARTIAL_RESOURCE_DESCRIPTOR * AllocateFrom;// Offset=0x10 Size=0x8
...
struct _ARBITER_BOOT_ALLOCATION_PARAMETERS// Size=0x8 (Id=1612)
{
    struct _LIST_ENTRY * ArbitrationList;// Offset=0x0 Size=0x8
};

struct _ARBITER_QUERY_ALLOCATED_RESOURCES_PARAMETERS// Size=0x8 (Id=1801)
{
    struct _CM_PARTIAL_RESOURCE_LIST ** AllocatedResources;// Offset=0x0 Size=0x8
};

struct _ARBITER_QUERY_CONFLICT_PARAMETERS// Size=0x20 (Id=1349)
{
...
struct _ARBITER_ADD_RESERVED_PARAMETERS// Size=0x8 (Id=1649)
{
    struct _DEVICE_OBJECT * ReserveDevice;// Offset=0x0 Size=0x8
};

union _anonymous_1621// Size=0x20 (Id=1621)
{
...
struct _ARBITER_PARAMETERS// Size=0x20 (Id=1622)
{
    union _anonymous_1621 Parameters;// Offset=0x0 Size=0x20
};
