...
struct _anonymous_692// Size=0x20 (Id=692)
{
...
struct _anonymous_693// Size=0x10 (Id=693)
{
...
struct _POP_IRP_DATA// Size=0x100 (Id=695)
{
    ...
    unsigned char WatchdogEnabled;// Offset=0xc4 Size=0x1
    ...
    {
        struct _anonymous_692 Device;// Offset=0xd8 Size=0x20
        struct _anonymous_693 System;// Offset=0xd8 Size=0x10
    };
    enum _POP_PEP_NOTIFY_DEVICE_DSTATE_REASON DStateReason;// Offset=0xf8 Size=0x4
};
