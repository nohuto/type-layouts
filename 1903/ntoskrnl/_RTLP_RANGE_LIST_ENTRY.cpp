struct _anonymous_1655// Size=0x10 (Id=1655)
{
...
struct _anonymous_1656// Size=0x10 (Id=1656)
{
    struct _LIST_ENTRY ListHead;// Offset=0x0 Size=0x10
};

struct _RTLP_RANGE_LIST_ENTRY// Size=0x38 (Id=1657)
{
    unsigned long long Start;// Offset=0x0 Size=0x8
    unsigned long long End;// Offset=0x8 Size=0x8
    union // Size=0x10 (Id=0)
    {
        struct _anonymous_1655 Allocated;// Offset=0x10 Size=0x10
        struct _anonymous_1656 Merged;// Offset=0x10 Size=0x10
    };
