...
struct _MI_ACCESS_VIOLATION_RANGE// Size=0x28 (Id=1837)
{
...
struct _MI_POOL_STATE// Size=0xa0 (Id=1577)
{
    ...
    struct _SINGLE_LIST_ENTRY BadPoolHead;// Offset=0x10 Size=0x8
...
struct _MMSUBSECTION_FLAGS// Size=0x4 (Id=1535)
{
...
struct _SUBSECTION// Size=0x38 (Id=812)
{
    ...
    union _anonymous_810 u;// Offset=0x20 Size=0x4
    ...
    union _anonymous_811 u1;// Offset=0x30 Size=0x4
    struct // Size=0x4 (Id=0)
    {
...
struct _anonymous_1080// Size=0x8 (Id=1080)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _anonymous_1081// Size=0x8 (Id=1081)
{
    unsigned long long PrototypePtesFlags;// Offset=0x0 Size=0x8
};

union _anonymous_1082// Size=0x8 (Id=1082)
{
    struct _anonymous_1080 e1;// Offset=0x0 Size=0x8
    struct _anonymous_1081 e2;// Offset=0x0 Size=0x8
};

struct _MI_PROTOTYPE_PTES_NODE// Size=0x20 (Id=1083)
{
    struct _RTL_BALANCED_NODE Node;// Offset=0x0 Size=0x18
    union _anonymous_1082 u1;// Offset=0x18 Size=0x8
};

struct _MSUBSECTION// Size=0x90 (Id=1681)
{
...
struct _MMSECTION_FLAGS// Size=0x4 (Id=656)
{
    struct // Size=0x4 (Id=0)
    {
...
union _anonymous_297// Size=0x4 (Id=297)
{
    unsigned long LongFlags;// Offset=0x0 Size=0x4
    struct _MMSECTION_FLAGS Flags;// Offset=0x0 Size=0x4
};

struct _MMSECTION_FLAGS2// Size=0x4 (Id=860)
{
...
union _anonymous_298// Size=0x4 (Id=298)
{
    unsigned long LongFlags;// Offset=0x0 Size=0x4
...
struct _anonymous_299// Size=0x10 (Id=299)
{
    union // Size=0x4 (Id=0)
    {
...
union _anonymous_300// Size=0x10 (Id=300)
{
    struct _anonymous_299 e2;// Offset=0x0 Size=0x10
};

union _anonymous_301// Size=0x8 (Id=301)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _CONTROL_AREA// Size=0x80 (Id=302)
{
    ...
    union _anonymous_297 u;// Offset=0x38 Size=0x4
    union _anonymous_298 u1;// Offset=0x3c Size=0x4
...
struct _MMPFNLIST// Size=0x28 (Id=285)
{
...
struct _MI_SECTION_WOW_STATE// Size=0x40 (Id=1324)
{
...
struct _MI_SECTION_STATE// Size=0x340 (Id=1015)
{
    ...
    unsigned long ImageBreakpointEnabled;// Offset=0x30c Size=0x4
    unsigned long ImageBreakpointChecksum;// Offset=0x310 Size=0x4
    unsigned long ImageBreakpointSize;// Offset=0x314 Size=0x4
    long ImageValidationFailed;// Offset=0x318 Size=0x4
...
struct _MM_SYSTEM_PAGE_COUNTS// Size=0x10 (Id=1170)
{
...
struct _MI_SYSTEM_IMAGE_STATE// Size=0xa0 (Id=919)
{
    ...
    unsigned long long PageCount;// Offset=0x78 Size=0x8
    struct _MM_SYSTEM_PAGE_COUNTS PageCounts;// Offset=0x80 Size=0x10
    struct _EX_PUSH_LOCK CollidedLock;// Offset=0x90 Size=0x8
    struct _RTL_AVL_TREE ImageTree;// Offset=0x98 Size=0x8
};
...
struct _MI_HUGE_SYSTEM_VIEW_HEAD// Size=0x10 (Id=1416)
{
...
struct _MI_SESSION_STATE// Size=0x1088 (Id=1012)
{
...
struct _MI_DYNAMIC_BITMAP// Size=0x48 (Id=1390)
{
...
struct _MMWSL_INSTANCE// Size=0x28 (Id=1121)
{
...
struct _MI_SYSTEM_VA_STATE// Size=0x480 (Id=1215)
{
    ...
    void * HalPrivateVaStart;// Offset=0x1c0 Size=0x8
    unsigned long long HalPrivateVaSize;// Offset=0x1c8 Size=0x8
    unsigned long SystemVaAssignment[8];// Offset=0x1d0 Size=0x20
    unsigned long SystemVaAssignmentHint;// Offset=0x1f0 Size=0x4
    unsigned long TopLevelPteLockBits[32];// Offset=0x1f4 Size=0x80
    long DeleteKvaLock;// Offset=0x274 Size=0x4
    struct _MI_WSLE * WsleArrays[8];// Offset=0x278 Size=0x40
    void * PagableHyperSpace;// Offset=0x2b8 Size=0x8
    void * HyperSpaceEnd;// Offset=0x2c0 Size=0x8
    unsigned long long PagableHyperSpaceBytes;// Offset=0x2c8 Size=0x8
    unsigned long long PageTableCommitmentOffset[2];// Offset=0x2d0 Size=0x10
    struct _KEVENT FreeSystemCacheVa;// Offset=0x2e0 Size=0x18
    unsigned long long SystemVaLock;// Offset=0x2f8 Size=0x8
    unsigned long long SystemCacheViewLock;// Offset=0x300 Size=0x8
    struct _MMWSL_INSTANCE SystemWorkingSetList[8];// Offset=0x308 Size=0x140
    unsigned long long SelfmapLock[4];// Offset=0x448 Size=0x20
};

struct _MI_COMBINE_STATE// Size=0x20 (Id=1458)
{
...
struct _MI_PARTITION_STATE// Size=0xc0 (Id=940)
{
...
struct _MI_BAD_MEMORY_EVENT_ENTRY// Size=0x38 (Id=1697)
{
...
struct _MI_PROBE_RAISE_TRACKER// Size=0x44 (Id=1755)
{
...
struct _MI_DEBUGGER_STATE// Size=0x118 (Id=1267)
{
...
struct _MI_STANDBY_STATE// Size=0x90 (Id=1447)
{
...
struct _MI_ULTRA_VA_CONTEXT// Size=0x40 (Id=1231)
{
...
struct _MI_SYSTEM_PTE_STATE// Size=0x200 (Id=1187)
{
...
struct _MI_IO_CACHE_STATS// Size=0x28 (Id=1821)
{
...
struct _MI_IO_PAGE_STATE// Size=0x68 (Id=1732)
{
...
struct _MI_PAGING_IO_STATE// Size=0x50 (Id=1442)
{
...
struct _MMPTE_HARDWARE// Size=0x8 (Id=761)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _MMPTE_PROTOTYPE// Size=0x8 (Id=1200)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long Valid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _MMPTE_SOFTWARE// Size=0x8 (Id=1027)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long Valid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _MMPTE_TIMESTAMP// Size=0x8 (Id=1304)
{
    struct // Size=0x8 (Id=0)
    {
...
struct _MMPTE_TRANSITION// Size=0x8 (Id=1601)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long Valid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _MMPTE_SUBSECTION// Size=0x8 (Id=755)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long Valid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _MMPTE_LIST// Size=0x8 (Id=1395)
{
    struct // Size=0x8 (Id=0)
    {
        unsigned long long Valid:1;// Offset=0x0 Size=0x8 BitOffset=0x0 BitSize=0x1
...
struct _MI_COMMON_PAGE_STATE// Size=0xa8 (Id=1593)
{
...
struct _MI_SYSTEM_TRIM_STATE// Size=0x40 (Id=1159)
{
...
struct _MM_PAGED_POOL_INFO// Size=0x18 (Id=829)
{
...
struct _MMSUPPORT_AGGREGATION// Size=0x20 (Id=908)
{
...
struct _SYSPTES_HEADER// Size=0x118 (Id=1590)
{
...
struct _MI_SYSTEM_VA_ASSIGNMENT// Size=0x10 (Id=1850)
{
    void * BaseAddress;// Offset=0x0 Size=0x8
    unsigned long long NumberOfBytes;// Offset=0x8 Size=0x8
};

struct _MI_VISIBLE_STATE// Size=0xc80 (Id=1676)
{
    ...
    unsigned long long SystemVaTypeCount[15];// Offset=0xa48 Size=0x78
    unsigned char SystemVaType[256];// Offset=0xac0 Size=0x100
    struct _MI_SYSTEM_VA_ASSIGNMENT SystemVaRegions[12];// Offset=0xbc0 Size=0xc0
};

struct _MI_SYSTEM_INFORMATION// Size=0x3100 (Id=884)
{
    struct _MI_POOL_STATE Pools;// Offset=0x0 Size=0xa0
    struct _MI_SECTION_STATE Sections;// Offset=0xc0 Size=0x340
    struct _MI_SYSTEM_IMAGE_STATE SystemImages;// Offset=0x400 Size=0xa0
    struct _MI_SESSION_STATE Sessions;// Offset=0x4a0 Size=0x1088
    struct _MI_PROCESS_STATE Processes;// Offset=0x1528 Size=0x48
    struct _MI_HARDWARE_STATE Hardware;// Offset=0x1580 Size=0x1c0
    struct _MI_SYSTEM_VA_STATE SystemVa;// Offset=0x1740 Size=0x480
    struct _MI_COMBINE_STATE PageCombines;// Offset=0x1bc0 Size=0x20
    struct _MI_PAGELIST_STATE PageLists;// Offset=0x1be0 Size=0x28
    struct _MI_PARTITION_STATE Partitions;// Offset=0x1c40 Size=0xc0
    struct _MI_SHUTDOWN_STATE Shutdowns;// Offset=0x1d00 Size=0x78
    struct _MI_ERROR_STATE Errors;// Offset=0x1d78 Size=0xc8
    struct _MI_ACCESS_LOG_STATE AccessLog;// Offset=0x1e40 Size=0x80
    struct _MI_DEBUGGER_STATE Debugger;// Offset=0x1ec0 Size=0x118
    struct _MI_STANDBY_STATE Standby;// Offset=0x1fe0 Size=0x90
    struct _MI_SYSTEM_PTE_STATE SystemPtes;// Offset=0x2080 Size=0x200
    struct _MI_IO_PAGE_STATE IoPages;// Offset=0x2280 Size=0x68
    struct _MI_PAGING_IO_STATE PagingIo;// Offset=0x22f0 Size=0x50
    struct _MI_COMMON_PAGE_STATE CommonPages;// Offset=0x2340 Size=0xa8
    struct _MI_SYSTEM_TRIM_STATE Trims;// Offset=0x2400 Size=0x40
    unsigned long long Cookie;// Offset=0x2440 Size=0x8
    void ** BootRegistryRuns;// Offset=0x2448 Size=0x8
    long ZeroingDisabled;// Offset=0x2450 Size=0x4
    unsigned char FullyInitialized;// Offset=0x2454 Size=0x1
    unsigned char SafeBooted;// Offset=0x2455 Size=0x1
    struct _TlgProvider_t * TraceLogging;// Offset=0x2458 Size=0x8
    struct _MI_VISIBLE_STATE Vs;// Offset=0x2480 Size=0xc80
};
