struct _anonymous_1478// Size=0x8 (Id=1478)
{
...
union _anonymous_1479// Size=0x8 (Id=1479)
{
    struct _anonymous_1478 s1;// Offset=0x0 Size=0x8
    long long Value;// Offset=0x0 Size=0x8
};

struct _ALPC_COMPLETION_LIST_STATE// Size=0x8 (Id=1223)
{
    union _anonymous_1479 u1;// Offset=0x0 Size=0x8
};

struct _RTL_SRWLOCK// Size=0x8 (Id=1152)
{
    union // Size=0x8 (Id=0)
    {
        struct // Size=0x8 (Id=0)
...
struct _ALPC_COMPLETION_LIST_HEADER// Size=0x180 (Id=1224)
{
