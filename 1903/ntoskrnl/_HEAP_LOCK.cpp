struct _RTL_CRITICAL_SECTION// Size=0x28 (Id=1022)
{
...
union _anonymous_526// Size=0x68 (Id=526)
{
    struct _RTL_CRITICAL_SECTION CriticalSection;// Offset=0x0 Size=0x28
    struct _ERESOURCE Resource;// Offset=0x0 Size=0x68
};

struct _HEAP_LOCK// Size=0x68 (Id=527)
{
    union _anonymous_526 Lock;// Offset=0x0 Size=0x68
};
