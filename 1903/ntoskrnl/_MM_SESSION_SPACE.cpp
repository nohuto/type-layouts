struct _MM_SESSION_SPACE_FLAGS// Size=0x4 (Id=762)
{
...
union _anonymous_670// Size=0x4 (Id=670)
{
...
struct _POOL_DESCRIPTOR// Size=0x100 (Id=996)
{
...
struct _MI_SESSION_DRIVER_UNLOAD// Size=0x8 (Id=965)
{
    union // Size=0x8 (Id=0)
    {
...
struct _MM_SESSION_SPACE// Size=0x5000 (Id=672)
{
    long ReferenceCount;// Offset=0x0 Size=0x4
    union _anonymous_670 u;// Offset=0x4 Size=0x4
    ...
    struct _POOL_DESCRIPTOR PagedPool;// Offset=0x2c0 Size=0x100
    struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;// Offset=0x3c0 Size=0x8
    unsigned long TopLevelPteLockBits[32];// Offset=0x3c8 Size=0x80
    struct _MMPTE PageDirectory;// Offset=0x448 Size=0x8
    struct _EX_PUSH_LOCK SessionVaLock;// Offset=0x450 Size=0x8
    struct _RTL_BITMAP_EX DynamicVaBitMap;// Offset=0x458 Size=0x10
    unsigned long long DynamicVaHint;// Offset=0x468 Size=0x8
    struct _EX_PUSH_LOCK SessionPteLock;// Offset=0x470 Size=0x8
    long PoolBigEntriesInUse;// Offset=0x478 Size=0x4
    long PagedPoolPdeCount;// Offset=0x47c Size=0x4
    unsigned long DynamicSessionPdeCount;// Offset=0x480 Size=0x4
    struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;// Offset=0x488 Size=0x60
    void * PoolTrackTableExpansion;// Offset=0x4e8 Size=0x8
    unsigned long long PoolTrackTableExpansionSize;// Offset=0x4f0 Size=0x8
    void * PoolTrackBigPages;// Offset=0x4f8 Size=0x8
    unsigned long long PoolTrackBigPagesSize;// Offset=0x500 Size=0x8
    struct _RTL_AVL_TREE PermittedFaultsTree;// Offset=0x508 Size=0x8
    enum _IO_SESSION_STATE IoState;// Offset=0x510 Size=0x4
    unsigned long IoStateSequence;// Offset=0x514 Size=0x4
    struct _KEVENT IoNotificationEvent;// Offset=0x518 Size=0x18
    struct _EJOB * ServerSilo;// Offset=0x530 Size=0x8
    unsigned long long CreateTime;// Offset=0x538 Size=0x8
